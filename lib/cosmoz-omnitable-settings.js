...
import { useHostFocus, usePosition, defaultPlacement } from '@neovici/cosmoz-dropdown';
const settingsStyles = `
	...
	useSettings = host => {
		usePosition({ anchor: host.anchor, host, placement: ['bottom-right', ...defaultPlacement]});
	...
	Settings = host => {
		...
		return html`
		  ...
		  <button class="anchor" @mousedown=${ preventDefault } @click=${ onToggle }>
			...
			${ active
		? html`<cosmoz-omnitable-settings-ui
