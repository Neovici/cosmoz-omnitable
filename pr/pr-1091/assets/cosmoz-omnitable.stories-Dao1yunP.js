import{e as c,D as He,t as S,A as Ge}from"./iframe-CPlrGsI6.js";import{t as j,c as O,g as A,n as F,P as I,s as ln,a as Ft,r as sn,e as un,D as cn,b as dn,d as mn,i as ke,h as kt,m as pn,u as R,f as _t,j as Et,k as gn,l as Z,p as P,o as je,q as It,v as _e,w as bn,x as Ee,y as _,z as M,A as lt,B as Ie,C as Mt,E as st,F as ut,G as z,H as fn,I as hn,J as Ot,K as Ke,L as Lt,M as xn,N as Dt,O as yn,Q as ct,R as vn,S as $n,T as Cn,U as Tt,V as We,W as Je,X as wn,Y as Rt,Z as Ue,_ as U,$ as zn,a0 as Sn}from"./cosmoz-collapse-CFSypbg3.js";import"./preload-helper-PPVm8Dsz.js";const An=j`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,Pn=n=>{const{label:e,value:t,slot:i}=n,a=c`<div
	...
	`},Vt=n=>n?typeof n.close=="function"?n:Vt(n.parentElement):null,Xe=n=>class extends n{static get properties(){return{disabled:{type:Boolean,value:!1},filter:{type:Object,notify:!0},values:{type:Array,value(){return[]}},headerFocused:{type:Boolean,notify:!0},min:{type:Number,value:null},max:{type:Number,value:null},limits:{type:Function},autoupdate:{type:String,value:!0},locale:{type:String,value:null},align:{type:String,value:"left"},_filterInput:{type:Object,value(){return{min:null,max:null}}},_range:{type:Object,computed:"_computeRange(values.*)"},_limit:{type:Object,computed:"_computeLimit(_range, _filterInput.*, min, max)",value(){return{}}},_tooltip:{type:String,computed:"_computeTooltip(title, _filterText)"},_fromClasses:{type:String,computed:"_computeInputClasses(_filterInput.min)"},_toClasses:{type:String,computed:"_computeInputClasses(_filterInput.max)"}}}static get observers(){return["_filterInputChanged(_filterInput.*, autoupdate)","_filterChanged(filter.*)","_updateLimits(limits, headerFocused)"]}disconnectedCallback(){this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),super.disconnectedCallback()}_computeInputClasses(e){return e!=null&&e!==""?"has-value":""}toNumber(e,t,i){if(e==null||e==="")return;const a=typeof e=="number"?e:Number(e);if(Number.isNaN(a))return;if(i==null||t==null)return a;const o=this.toNumber(t);return o==null?a:i(a,o)}toValue(){return this.toNumber.apply(this,arguments)}getComparableValue(e,t){if(e==null)return;let i=e;return t!=null&&(i=this.get(t,e)),this.toValue(i)}renderValue(){}getInputString(e,t=this.valuePath){const i=this.toValue(this.get(t,e));return this._toInputString(i)}_computeRange(e){const t=e.base,i=Array.isArray(t)&&t.length&&t.map(a=>this.toValue(a)).filter(a=>a!=null);return!i||i.length<1?{min:null,max:null}:i.reduce((a,o)=>({min:this.toValue(o,a.min,Math.min),max:this.toValue(o,a.max,Math.max)}),{})}_computeLimit(e,t,i,a){if(!e)return;const o=t.base,r=this.toValue(i),l=this.toValue(a),s=r??this.toValue(e.min),u=l??this.toValue(e.max);return{fromMin:s,fromMax:this.toValue(u,this._fromInputString(o.max,"max"),Math.min),toMin:this.toValue(s,this._fromInputString(o.min,"min"),Math.max),toMax:u}}_computeFilterText(e){if(e.base==null)return;const t=e.base,i=this.toValue(t.min),a=this.toValue(t.max),o=[];return i!=null&&o.push(this.renderValue(i)),o.push(" - "),a!=null&&o.push(this.renderValue(a)),o.length>1?o.join(""):void 0}_computeTooltip(e,t){return t==null?e:`${e}: ${t}`}_fromInputString(e){return this.toValue(e)}_toInputString(e){const t=this.toValue(e);return t??null}_getDefaultFilter(){return{min:null,max:null}}_filterInputChanged(e,t){const i=e.path.split(".")[1];this.__inputChangePath=i||null,t&&(this._limitInputDebouncer=cn.debounce(this._limitInputDebouncer,dn.after(600),()=>{this._limitInput(),this._updateFilter()}),mn(this._limitInputDebouncer))}_clearFrom(){this.set("_filterInput.min",null),this._updateFilter()}_clearTo(){this.set("_filterInput.max",null),this._updateFilter()}_onBlur(){this._limitInput(),this._updateFilter()}_onKeyDown(e){const t=e.currentTarget,i=Array.from(t.parentElement.querySelectorAll("cosmoz-input")),a=i[i.findIndex(l=>l===t)+1],o=!a,r=i[0]===t;switch(e.keyCode){case 13:if(e.preventDefault(),!o)a.focus();else{const l=this._limitInput();this._updateFilter(),l||this._closeParent(t)}break;case 9:(o&&!e.shiftKey||r&&e.shiftKey)&&this._closeParent(t)}}_closeParent(e){const t=Vt(e);t&&t.close()}_onDropdownOpenedChanged({currentTarget:e,type:t,detail:i}){(t==="focus"||i?.value===!0)&&setTimeout(()=>{e.querySelector("cosmoz-input:focus")||e.querySelector("cosmoz-input")?.focus()},100)}_limitInput(){const e=this._filterInput,t=this.__inputChangePath,i=t?this._fromInputString(this.get(t,e),t):null;if(this.__inputChangePath=null,i==null)return!1;const a=this._limit,o=t==="min"?"from":"to",r=this.get(o+"Min",a),l=this.get(o+"Max",a),s=this.toValue(i,r,Math.max),u=this.toValue(s,l,Math.min);return this.getComparableValue(i)!==this.getComparableValue(u)?(this.set(["_filterInput",t],this._toInputString(u,t)),this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),!0):!1}_updateFilter(){const e=this._filterInput,t=this.filter,i=this._fromInputString(e.min,"min"),a=this._fromInputString(e.max,"max");this.getComparableValue(i)===this.getComparableValue(t,"min")&&this.getComparableValue(a)===this.getComparableValue(t,"max")||this.set("filter",{min:i,max:a})}_filterChanged(e){if(this._filterInput==null)return;const t=this._filterInput,i=e.base,a=this._fromInputString(t.min,"min"),o=this._fromInputString(t.max,"max");this.getComparableValue(a)===this.getComparableValue(i,"min")&&this.getComparableValue(o)===this.getComparableValue(i,"max")||(this.set("_filterInput",{min:this._toInputString(i.min),max:this._toInputString(i.max)}),this._limitInputDebouncer&&this._limitInputDebouncer.cancel())}hasFilter(){const e=this.filter;return e==null?!1:this.toValue(e.min)!=null||this.toValue(e.max)!=null}resetFilter(){this.filter=this._getDefaultFilter()}_updateLimits(e,t){e&&Promise.resolve(ke(e,{active:t})).then(i=>{const{min:a,max:o}=i??{};Object.assign(this,{...a!=null?{min:a}:{},...o!=null?{max:o}:{}})})}},me=n=>class extends n{static get template(){return kt`<div id="output" style="position:relative;"></div>`}connectedCallback(){super.connectedCallback();const e=this;He(e.render(),e.$.output)}_propertiesChanged(e,t,i){super._propertiesChanged(e,t,i);const a=this;requestAnimationFrame(()=>He(a.render(),a.$.output))}};class Bn extends Xe(me(I)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return c`
		...
		</cosmoz-input>`}renderHeader({title:e,min:t,max:i,limits:a,locale:o,rates:r,currency:l,autoupdate:s,autodetect:u,disabledFiltering:d,headerAlign:m,align:g},{filter:p},b,y){return c`<cosmoz-omnitable-amount-range-input
			.title=${e}
			?disabled=${d}
			.filter=${p}
			.values=${y}
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return pe(e,t)}}customElements.define("cosmoz-omnitable-column-date",_i);class Ei extends et(me(I)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return c`
			<style>
		...
		></cosmoz-omnitable-datetime-range-input>`}computeSource(e,t){return pe(e,t)}}customElements.define(Ct.is,Ct);class Oi extends De(T(I)){renderCell({valuePath:e,textProperty:t},{item:i}){const a=Qe(i,e,t).map(o=>c`<li>${o}</li>`);return c`
			<style>
				ul {
					padding: 0;
					display: inline;
...
`,Di=({items:n})=>{const[e,t]=R(!1),i=Array.isArray(n)?n:[],a=_(()=>Math.max(0,i.length-1),[i]);if(i.length===0)return null;const o=i.length>2,r=i[0],l=o&&!e?[]:i.slice(1),s=u=>{u.stopPropagation(),u.preventDefault(),t(d=>!d)};return c`
		<ul>
			<li>
				<span>${r}</span>
			</li>
	...
	`};customElements.define("cosmoz-omnitable-column-list-data",O(Di,{styleSheets:[Ee(Li)]}));class Ti extends De(T(I)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:i}){return c`<cosmoz-omnitable-column-list-data
		...
		`}_computeFormatter(e,t,i){const a={localeMatcher:"best fit"};return t!==null&&(a.minimumFractionDigits=t),i!==null&&(a.maximumFractionDigits=i),new Intl.NumberFormat(e||void 0,a)}getComparableValue(e,t){if(e==null)return;let i=e;if(t!=null&&(i=this.get(t,e)),i=this.toValue(i),i==null)return;const a=this.maximumFractionDigits;return a!==null?this.toValue(i.toFixed(a)):i}renderValue(e,t=this.formatter){const i=this.toNumber(e);if(i!=null)return t.format(i)}}customElements.define("cosmoz-omnitable-number-range-input",Ri);class Vi extends T(I){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},autoupdate:{type:Boolean,value:!1,notify:!0},cellClass:{type:String,value:"number-cell"},width:{type:String,value:"30px"},minWidth:{type:String,value:"30px"},headerCellClass:{type:String,value:"number-header-cell"},maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null},align:{type:String,value:"right"}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const i=X({...e,valuePath:"min"},t),a=X({...e,valuePath:"max"},t);if(!(i==null&&a==null))return jn(e,t)}getString(e,t){return mt(e,t)}toXlsxValue({valuePath:e},t){return A(t,e)}getComparableValue(e,t){return X(e,t)}serializeFilter(e,t){if(t==null)return;const i=L(t.min),a=L(t.max);if(!(i==null&&a==null))return dt(i)+"~"+dt(a)}deserializeFilter(e,t){if(typeof t!="string"||t==="")return null;const i=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(i)?{min:L(i[1]),max:L(i[2])}:null}renderCell(e,{item:t}){return c`<div class="omnitable-cell-number">
			...
			@change=${o=>i(o.target.value)}
			.value=${Hn(e,t)}
		></cosmoz-input>`}renderHeader({title:e,min:t,max:i,limits:a,locale:o,maximumFractionDigits:r,minimumFractionDigits:l,autoupdate:s,disabledFiltering:u,headerAlign:d,align:m},{filter:g},p,b){return c`<cosmoz-omnitable-number-range-input
			.title=${e}
			?disabled=${u}
			.filter=${g}
			.values=${b}
...
`);r.unshift(o),Dt(new File(r,t,{type:"text/csv;charset=utf-8"}))},ma=(n,e)=>{const t=n.map(a=>a.title),i=e.map(a=>n.map(o=>{const r=o.toXlsxValue(o,a);return r??""}));return i.unshift(t),i},pa=(n,e,t,i)=>{const a=ma(n,e),o=new yn(t).addSheetFromData(a,i).generate();Dt(new File([o],t,{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}))},Se=Symbol("index"),D=Symbol("All"),ga=(n,e)=>{if(typeof n.findLastIndex=="function")return n.findLastIndex(e);for(let t=n.length-1;t>=0;t--)if(e(n[t],t,n))return t;return-1},ba=({columns:n,selectedItems:e,setSelectedItems:t,csvFilename:i,xlsxFilename:a,xlsxSheetname:o,topPlacement:r,enableSelectAll:l,allSelected:s,allItemsCount:u})=>{const d=e===D,m=d||e.length>0,g=e!==D&&l&&s,p=y=>c`<cosmoz-dropdown-menu
		...
		</cosmoz-dropdown-menu>`,b=F(d,()=>u!==void 0?S("All {count} items selected",{count:u}):S("All items selected"),()=>S("{count} selected item",{count:e===D?0:e.length}));return c`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${m}
		part="bottomBar"
...
`;customElements.define("cosmoz-omnitable-settings",O(Aa,{styleSheets:[Ee($a)]}));const Ae=["sortOn","descending","groupOn","groupOnDescending"],Ce=n=>e=>typeof e=="object"&&e!==null&&"name"in e&&e.name===n,qa=(n=[],e=[],t=[])=>{const i=e.filter(r=>n.some(Ce(r.name))),a=n.filter(r=>r.name!=null&&!e.some(Ce(r.name))&&!t.some(Ce(r.name))),o=t.filter(r=>!e.some(Ce(r.name)));return[...i,...o.flatMap(r=>{const l=n.find(s=>s.name===r.name);return l?{...r,title:l.title??r.title??"",minWidth:parseInt(l.minWidth??"0",10)}:[]}),...a.map(r=>{const{name:l,title:s,priority:u,minWidth:d,width:m,flex:g}=r;return{name:l??"",title:s??"",priority:u??0,minWidth:parseInt(d??"0",10),width:parseInt(m??"0",10),flex:parseInt(g??"0",10)}})]},Fa=(n,e)=>({...e,...We(Array.from(Ae))(n),columns:n.columns?.map(We(["name","priority","width","flex","disabled"]))}),ka=({columns:n,settings:e,savedSettings:t,initial:i})=>({...Object.fromEntries(Ae.flatMap(o=>i?.[o]!=null?[[o,i[o]]]:[])),...t?We(Array.from(Ae))(t):{},...e,columns:qa(n,e?.columns,t?.columns)}),_a=({prefix:n="omnitable-"}={})=>({write:async(t,i)=>{const a=n+t;try{i?localStorage.setItem(a,JSON.stringify(i)):localStorage.removeItem(a)}catch(o){console.error(o)}},read:async t=>{if(!t)return null;try{const i=localStorage.getItem(n+t);return i==null?null:JSON.parse(i)}catch(i){return console.error(i),null}}}),Ea=Ot(_a),Ia=()=>{const n=Ke(Ea);return _(()=>n(),[n])},Ma=(n,e,t,i)=>{const[a,o]=R(n?void 0:null),{read:r,write:l}=Ia();return M(async()=>{n&&o(await r(n))},[n,r]),{settingsId:n,savedSettings:a,onSave:z(async()=>{if(!n)return;const s=Fa(e,a);await l(n,s),t(),o(s)},[e,a]),onReset:z(async s=>{t(),s.shiftKey&&(await l(n),o(null)),i?.()},[i]),hasChanges:e!=null}},Oa=({settingsId:n,host:e})=>{const t=_(()=>Object.fromEntries(Ae.map(x=>[x,e[x]])),[]),i=Je(),a=z(()=>{i.current?.(t)},[t]),[o,r]=R(),[l,s]=R({columns:!0,sort:!0}),{savedSettings:u,...d}=Ma(n,o,r,a),{enabledColumns:m,disabledFiltering:g}=e,p=ni(e,{enabledColumns:m,disabledFiltering:g}),b=_(()=>ka({columns:p,settings:o,savedSettings:u??void 0,initial:t}),[p,o,u]),y=_(()=>b.columns.map(x=>p.find(f=>f.name===x.name)).filter(x=>x!==void 0),[p,...b.columns.map(x=>x.name)]);return{...d,savedSettings:u,opened:l,setOpened:s,settings:b,columns:y,setSettings:r,resetRef:i}},At=n=>Number.isFinite(n)?n:0,La=(n,e)=>{const t=[];let[i,a]=n.reduce(([d,m],{width:g,flex:p})=>[d+g,m+p],[0,0]),o=e-i,r=At(o/a),l=0,s=0,u=0;for(let d=0;d<n.length;d++){const{width:m,minWidth:g,flex:p}=n[d],b=o>=0?r*p:m*o/i;if(g>m+b){l+=m,s+=g,u+=p,t[d]=g;continue}if(p===0){l+=m,s+=m,t[d]=m;continue}}i-=l,o=e-s-i,a-=u,r=At(o/a);for(let d=0;d<n.length;d++){if(t[d]!=null)continue;const{width:m,flex:g}=n[d],p=o>=0?r*g:m*o/i;t[d]=m+p}return t},Da=(n,e)=>{const t=ga(n,r=>r!=null&&r>0),i=(r,l)=>`.cell[name="${r}"], cosmoz-omnitable-skeleton::part(cell-${r}){width: ${Math.floor(l)}px;padding: 0 min(3px, ${l/2}px)}`,a=r=>`cosmoz-omnitable-resize-nub[name="${r}"]{display:none}`,o=r=>`cosmoz-omnitable-resize-nub[name="${r}"], .cell[name="${r}"]{display:none}`;return e.map((r,l)=>{const s=n[l];if(s==null||s===0)return o(r.name);const u=i(r.name,s);return l===t?`${u}
${a(r.name)}`:u}).join(`
`)},Zt=(n,e,t)=>{const i=n.filter(l=>!l.hidden),a=i.reduce((l,{width:s})=>l+s,0);if(i.length>1&&a>e)return Zt(i.slice(1),e,t);const o=i.reduce(([l,s],u,d)=>[Math.max(l,u.index),u.index>l?d:s],[-1,-1])[1];return o!==-1&&(i[o].flex=1),La(i,e).reduce((l,s,u)=>(l[i[u].index]=s,l),new Array(t).fill(void 0))},Ta=(n,e)=>n.length===0?".cell {display: none;}":Da(n,e),Ra=20,Va=44,Na=24,en=Ra+Va+Na,Pa=(n,e)=>M(()=>{const t=([a])=>{a.contentRect?.width!==0&&e(a.contentRect.width-en)},i=new ResizeObserver(t);return i.observe(n),()=>i.unobserve(n)},[]),Ba=n=>{const[e,t]=R(()=>n.getBoundingClientRect().width-en);return Pa(n,t),e},Ha=({canvasWidth:n,groupOnColumn:e,config:t,miniColumn:i})=>_(()=>{if(!Array.isArray(t)||n==null||n===0)return[];const a=t.map((o,r)=>({minWidth:o.minWidth,width:o.width,flex:o.flex,priority:o.priority,name:o.name,index:r,hidden:o.name===e?.name||o.disabled})).map(o=>i?{...o,hidden:i.name!==o.name}:o).sort(({index:o,priority:r},{index:l,priority:s})=>r===s?l-o:r-s);return Zt(a,n,a.length)},[n,e,t]),Ga=({host:n,canvasWidth:e,columns:t})=>{const i=n.miniBreakpoint??480,a=_(()=>e<=i,[e,i]),o=_(()=>a?t?.filter(u=>u.mini!=null).sort((u,d)=>(u.mini??0)-(d.mini??0)):[],[t,a]),[r,...l]=o??[],s=!!r;return M(()=>{n.toggleAttribute("mini",s)},[s]),{isMini:s&&a,miniColumn:r,miniColumns:l}},ja=({host:n,canvasWidth:e,layout:t,setSettings:i,requestTween:a})=>{const o=Je();o.current=r=>{a(),i(l=>{const s=l.columns,{detail:{newWidth:u,column:d}}=r,m=s.findIndex(b=>b.name===d.name),g=[],p=s.reduce((b,y)=>Math.max(b,y.priority),-1/0);for(let b=0;b<t.length;b++)if(g[b]={...s[b]},b<m&&t[b]&&(g[b].width=t[b],g[b].flex=0,g[b].priority=p),b===m){const y=t.reduce((x,f,v)=>v<m&&f?x-f:x,e);g[b].width=Math.min(y,Math.max(u,s[b].minWidth)),g[b].flex=0,g[b].priority=p}return{...l,columns:g}})},M(()=>{const r=l=>o.current?.(l);return n.addEventListener("column-resize",r),()=>n.removeEventListener("column-resize",r)},[])},Wa=(n,e)=>{const t=_(()=>{let i=!1,a;const o=()=>{if(!i)return;a=requestAnimationFrame(o),n()&&(i=!1)};return{start:()=>{i=!0,cancelAnimationFrame(a),a=requestAnimationFrame(o)},stop:()=>{i=!1,cancelAnimationFrame(a)}}},[]);M(()=>{t.start()},e),M(()=>()=>t.stop(),[])},Ua=(n=0,e=0)=>Math.abs(n-e)<.1,Ka=(n,e=1.9,t=wn,i)=>{const a=Ie({target:n,speedFactor:e,onConverge:i}),o=z(()=>{if(!a.tween)return a.tween=a.target,t(a.tween),a.onConverge?.(),!0;if(a.target.every((r,l)=>a.tween[l]===r))return t(a.tween),a.onConverge?.(),!0;if(a.tween=a.target.map((r,l)=>Ua(a.tween[l],r)?r:(a.tween[l]??0)+((r??0)-(a.tween[l]??0))/a.speedFactor||0),t(a.tween),a.tween.every((r,l)=>r===a.target[l]))return a.onConverge?.(),!0},[]);Wa(o,[n])},Ja=n=>{const e=_(()=>new CSSStyleSheet,[]);return M(()=>{n.shadowRoot.adoptedStyleSheets=[...n.shadowRoot.adoptedStyleSheets,e]},[]),e},Xa=({host:n,columns:e,settings:t,setSettings:i,resizeSpeedFactor:a,sortAndGroupOptions:o})=>{const r=Ba(n),{isMini:l,miniColumn:s,miniColumns:u}=Ga({host:n,canvasWidth:r,columns:e}),{groupOnColumn:d}=o,m=Ha({canvasWidth:r,groupOnColumn:d,miniColumn:s,config:t.columns}),g=Ja(n),p=_(()=>t.columns.reduce((C,h,$)=>m[$]!=null||h.name===d?.name||h.disabled?C:[...C,e.find(w=>w.name===h.name)],[]),[e,t,m]),[b,y]=R(1),x=z(()=>y(a??1.9),[a]),f=z(()=>y(1),[]),v=Ie({columns:t.columns});return Ka(m,b,C=>{const h=Ta(C,v.columns);g.replace(h)},f),ja({host:n,canvasWidth:r,layout:m,setSettings:C=>i(C(t)),requestTween:x}),{isMini:l,collapsedColumns:p,miniColumns:u,requestTween:x}},Qa=({host:n,...e})=>{const{csvFilename:t="omnitable.csv",xlsxFilename:i="omnitable.xlsx",xlsxSheetname:a="Omnitable",topPlacement:o="top-end"}=n;return{csvFilename:t,xlsxFilename:i,xlsxSheetname:a,topPlacement:o,...e}},Ya=({host:n,selectedItems:e,data:t,sortAndGroupOptions:i,collapsedColumns:a,settings:o,filterFunctions:r,settingS:l,filters:s,requestTween:u,...d})=>{const m=e===D||!!t&&t.length>0&&Array.isArray(e)&&e.length===t.length,g=x=>{if(!(x.target instanceof HTMLInputElement))return;const f=n.shadowRoot.querySelector("#groupedList");x.target.checked?f.selectAll():f.deselectAll()},{groupOnColumn:p}=i,b=_(()=>[p,...a,...o.columns.filter(x=>x.disabled)].some(x=>!!x&&!!x.name&&Object.keys(r).includes(x.name)),[r,o,a]),y=_(()=>({...l,collapsed:a,badge:b,filters:s,requestTween:u}),[l,a,b,s,u]);return M(()=>{const x=n.shadowRoot.querySelector("#tableContent"),f=new ResizeObserver(v=>requestAnimationFrame(()=>{n.style.setProperty("--ot-height",(v[0]?.contentRect.height??0)+"px")}));return f.observe(x),()=>f.unobserve(x)},[]),{allSelected:m,onAllCheckboxChange:g,data:t,settingsConfig:y,filters:s,groupOnColumn:p,sortAndGroup:i.sortAndGroup,...d}},tn=c`
	<svg
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
...
`,Za=n=>n?"groupRow groupRow-folded":"groupRow",eo=({item:n,index:e})=>t=>F(t?.length>0,()=>c`
			...
			`),to=({columns:n,collapsedColumns:e,miniColumns:t,onItemClick:i,onCheckboxChange:a,dataIsValid:o,groupOnColumn:r,onItemChange:l,rowPartFn:s})=>(u,d,{selected:m,expanded:g,toggleCollapse:p})=>c`
		<div
			?selected=${m}
	...
	`,no=({onCheckboxChange:n,dataIsValid:e,groupOnColumn:t})=>(i,a,{selected:o,folded:r,toggleFold:l})=>c` <div
		...
		</div>`,io=({host:n,error:e,dataIsValid:t,processedItems:i,columns:a,collapsedColumns:o,miniColumns:r,sortAndGroupOptions:l,rowPartFn:s,...u})=>{const{loading:d=!1,displayEmptyGroups:m=!1,compareItemsFn:g}=n,p=Je({shiftKey:!1,ctrlKey:!1}),b=z(v=>{const C=v.target.dataItem,h=v.target.checked;p.current.shiftKey?n.shadowRoot.querySelector("#groupedList").toggleSelectTo(C,h):p.current.ctrlKey?(v.target.checked=!0,n.shadowRoot.querySelector("#groupedList").selectOnly(C)):n.shadowRoot.querySelector("#groupedList").toggleSelect(C,h),v.preventDefault(),v.stopPropagation()},[]);M(()=>{const v=({shiftKey:C,ctrlKey:h})=>{p.current={shiftKey:C,ctrlKey:h}};return window.addEventListener("keydown",v),window.addEventListener("keyup",v),()=>{window.removeEventListener("keydown",v),window.removeEventListener("keyup",v)}},[]);const y=z(v=>{const C=v.composedPath();C.slice(0,C.indexOf(v.currentTarget)).find($=>$.matches?.("a, .checkbox, .expand"))||n.dispatchEvent(new window.CustomEvent("omnitable-item-click",{bubbles:!0,composed:!0,detail:{item:v.currentTarget.dataItem,index:v.currentTarget.dataIndex}}))},[]),{groupOnColumn:x}=l,f=z((v,C)=>h=>ii(n,v,C,h),[]);return{...u,processedItems:i,dataIsValid:t,filterIsTooStrict:t&&i.length<1,loading:d,compareItemsFn:g,displayEmptyGroups:m,error:e,renderItem:_(()=>to({columns:a,collapsedColumns:o,miniColumns:r,onItemClick:y,onCheckboxChange:b,dataIsValid:t,groupOnColumn:x,onItemChange:f,rowPartFn:s}),[a,o,y,b,t,x,f,s]),renderGroup:_(()=>no({onCheckboxChange:b,dataIsValid:t,groupOnColumn:x}),[b,t,x])}},ao=(n,e)=>{if(n===e)return 0;if(n==null)return-1;if(e==null)return 1;const t=typeof n,i=typeof e;return t==="object"&&i==="object"?n.toString()<e.toString()?-1:1:t==="number"&&i==="number"?n-e:t==="string"&&i==="string"?n<e?-1:1:t==="boolean"&&i==="boolean"?n?-1:1:(console.warn("unsupported sort",t,n,i,e),0)},Pe=(n,e)=>(t,i)=>ao(n(t),n(i))*(e?-1:1),oo=n=>n.replace(/([a-z0-9])([A-Z])/gu,"$1-$2").toLowerCase(),qt=(n,e)=>{!n||!e||Object.entries(e).forEach(([t,i])=>{n[V].__ownChange=!0,n[V][t]=i,n[V].__ownChange=!1,n[V].dispatchEvent(new CustomEvent(`${oo(t)}-changed`,{bubbles:!0,detail:{value:i}}))})},Be=(n,e)=>Object.assign(n,{[Se]:e}),we=Symbol("unparsed"),ro=({data:n,columns:e,hashParam:t,sortAndGroupOptions:i,noLocalSort:a,noLocalFilter:o})=>{const{groupOnColumn:r,groupOnDescending:l,sortOnColumn:s,descending:u}=i,d=z(([h,$])=>{const w=e.find(({name:q})=>q===h);return w==null?[h,void 0]:[h,$.filter&&w.serializeFilter(w,$.filter)]},[e]),m=z(([h,$])=>{const w=e.find(({name:k})=>k===h);if(w==null)return[h,{[we]:$}];const q={filter:w.deserializeFilter(w,$)};return qt(w,q),[h,q]},[e]),[g,p]=te({},t,{multi:!0,suffix:"-filter--",write:d,read:m}),b=z((h,$)=>p(w=>{const q=ke($,w[h]);return qt(e.find(k=>k.name===h),q),{...w,[h]:{...w[h],...q}}}),[e,p]),y=_(()=>Object.values(g).map(h=>h.filter),[g]),x=_(()=>Object.fromEntries(e.map(h=>[h.name,!h.noLocalFilter&&h.getFilterFn(h,g[h.name]?.filter)]).filter(([,h])=>!!h)),[e,...y]),f=_(()=>!Array.isArray(n)||n.length===0?[]:Object.entries(x).length===0||o?n.slice():n.filter(h=>Object.values(x).every($=>$(h))),[n,x,o]),v=_(()=>{if(!a&&!r&&s!=null&&s.sortOn!=null)return f.slice().sort(Pe(h=>s.getComparableValue({...s,valuePath:s.sortOn},h),u));if(r!=null&&r.groupOn!=null){const h=f.reduce(($,w)=>{const q=r.getComparableValue({...r,valuePath:r.groupOn},w);if(q===void 0)return $;let k=$.find(W=>W.id===q);return k?(k.items.push(w),$):(k={id:q,name:q,items:[w]},[...$,k])},[]);return h.sort(Pe($=>r.getComparableValue({...r,valuePath:r.groupOn},$.items[0]),l)),!s||a?h:h.filter($=>Array.isArray($.items)).map($=>($.items.sort(Pe(w=>s.getComparableValue({...s,valuePath:s.sortOn},w),u)),$))}return f},[f,r,l,s,u,a]),C=_(()=>{let h=0,$=0;const w=[];return v.forEach(q=>{if(Array.isArray(q.items)){Be(q,$++),q.items.forEach(k=>{Be(k,h++),w.push(k)});return}return Be(q,h++),w.push(q)},[]),w},[v]);return M(()=>{p(h=>Object.values(h).some(w=>w[we]!=null)?Object.fromEntries(Object.entries(h).map(([w,q])=>q[we]==null?[w,q]:m([w,q[we]]))):h)},[m]),{processedItems:v,visibleData:C,filters:g,filterFunctions:x,setFilterState:b}},lo=n=>{const e=i=>{const a=n.data.indexOf(i);if(a<0)return null;const o=n.data.splice(a,1);if(n.data=n.data.slice(),Array.isArray(o)&&o.length>0)return o[0]},t=(i,a)=>{n.data.splice(i,1,a),n.data=n.data.slice()};return{removeItem:e,removeItems(i){const a=[];for(let o=i.length-1;o>=0;o-=1){const r=n.removeItem(i[o]);r!=null&&a.push(r)}return a},replaceItemAtIndex:t,replaceItem(i,a){const o=n.data.indexOf(i);o>-1&&t(o,a)},selectItem(i){n.shadowRoot.querySelector("#groupedList").select(i)},selectAll(){n.shadowRoot.querySelector("#groupedList").selectAll()},deselectAll(){n.shadowRoot.querySelector("#groupedList").deselectAll()},deselectItem(i){n.shadowRoot.querySelector("#groupedList").deselect(i)},isItemSelected(i){return n.shadowRoot.querySelector("#groupedList").isItemSelected(i)}}},so=({host:n,visibleData:e,filters:t,...i})=>{const{setFilterState:a}=i,o=_(()=>lo(n),[]),[r,l]=Rt("selectedItems",[]);Ue(i,Object.values(i)),Ue(o,Object.values(o)),M(()=>{const u=d=>{if(!(d instanceof CustomEvent))return;const m=d.detail;a(m.name,g=>({...typeof g=="object"&&g!==null?g:{},...m.state}))};return n.addEventListener("legacy-filter-changed",u),()=>n.removeEventListener("legacy-filter-changed",u)},[]),U("visibleData",e),U("sortedFilteredGroupedItems",i.sortedFilteredGroupedItems),U("sortOn",i.sortOn),U("descending",i.descending),U("isMini",i.isMini);const s=_(()=>Object.fromEntries(Object.entries(t).filter(([,{filter:u}])=>u!==void 0).map(([u,{filter:d}])=>[u,d])),[t]);return U("filters",s,Object.values(s)),{selectedItems:r,setSelectedItems:l}},uo=n=>{const{hashParam:e,settingsId:t,data:i,resizeSpeedFactor:a,noLocal:o,noLocalSort:r=o,noLocalFilter:l=o,error:s,rowPartFn:u}=n,d=Oa({settingsId:t,host:n}),{settings:m,setSettings:g,columns:p,resetRef:b,savedSettings:y}=d,x=y!==void 0,f=na(p,e,{settings:m,setSettings:g,resetRef:b,ready:x}),{processedItems:v,visibleData:C,filters:h,setFilterState:$,filterFunctions:w}=ro({data:i,columns:p,hashParam:e,sortAndGroupOptions:f,noLocalSort:r,noLocalFilter:l}),{isMini:q,collapsedColumns:k,miniColumns:W,requestTween:H}=Xa({host:n,columns:p,settings:m,setSettings:g,resizeSpeedFactor:a,sortAndGroupOptions:f}),at=i&&Array.isArray(i)&&i.length>0,{selectedItems:Re,setSelectedItems:ot}=so({host:n,visibleData:C,sortedFilteredGroupedItems:v,columns:p,filters:h,setFilterState:$,isMini:q,...f}),rt=Ya({host:n,selectedItems:Re,sortAndGroupOptions:f,dataIsValid:at,data:i,columns:p,filters:h,collapsedColumns:k,settings:m,filterFunctions:w,settingS:d,setFilterState:$,hideSelectAll:n.hideSelectAll===!0,requestTween:H});return{header:rt,list:io({host:n,error:s,dataIsValid:at,processedItems:v,selectedItems:Re,setSelectedItems:ot,columns:p,collapsedColumns:k,miniColumns:W,sortAndGroupOptions:f,rowPartFn:u}),footer:Qa({host:n,selectedItems:Re,allSelected:rt.allSelected,setSelectedItems:ot,columns:p,enableSelectAll:n.enableSelectAll,allItemsCount:n.allItemsCount})}};customElements.define("cosmoz-grouped-list-row",class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||He(this._renderFn(this._item,this._index),this)}});const co={group:Symbol("group")},Te=(n,e)=>(e.has(n)||e.set(n,{}),e.get(n)),mo=(n,e)=>!!Te(n,e).expanded,po=(n,e)=>!!Te(n,e).folded,qe=n=>n?n.items instanceof Array:!1,go=n=>{if(!Array.isArray(n)||n.length===0)return;const e=Array.isArray(n[0]?.items);if(!n.every(i=>Array.isArray(i.items)===e))throw new Error("Data must be homogeneous.")},bo=(n,e,t)=>Array.isArray(n)?(go(n),n.reduce((a,o)=>{const r=o;return r.items?r.items.length?Te(o,t).folded?a.concat(o):a.concat(o,r.items.map(l=>Object.assign(l,{[co.group]:o}))):e?a.concat(o):a:a.concat(o)},[])):void 0,fo=(n,...e)=>typeof n=="function"?n(...e):n,ho=(n,e)=>n===e,xo=()=>{const[n,e]=R(()=>[new WeakMap]);return{setItemState:z((i,a)=>e(([o])=>{const r=Te(i,o);return Object.assign(r,fo(a,r)),[o]}),[]),state:n[0],signal:n}},yo=()=>{const{setItemState:n,state:e,signal:t}=xo(),i=z((o,r)=>{qe(o)&&n(o,l=>({folded:r!==void 0?r:!l.folded}))},[]),a=z((o,r)=>{qe(o)||n(o,l=>({expanded:r!==void 0?!r:!l.expanded}))},[]);return{state:e,signal:t,toggleFold:i,toggleCollapse:a}},vo=({compareItemsFn:n,data:e,flatData:t})=>{const[i,a]=Rt("selectedItems",()=>[]),[o,r]=R(),l=z(f=>i===D||i.includes(f),[i]),s=z(f=>i===D||(f?.items?.every(l)??!1),[i,l]),u=z(f=>l(f)||s(f),[l,s]),d=z(f=>{const C=f.items??[f];a(h=>h===D?h:[...h,...C.filter($=>!h.includes($))]),r(f)},[]),m=z(f=>{const C=f.items??[f];a(h=>h===D?(t??[]).filter($=>!qe($)).filter($=>!C.includes($)):h.filter($=>!C.includes($))),r(f)},[t]),g=z(f=>{a(f.items?.slice()||[f]),r(f)},[]),p=z(()=>{a(e.flatMap(f=>f.items||f)),r(void 0)},[e]),b=z(()=>{a([]),r(void 0)},[]),y=z((f,v=!u(f))=>v?d(f):m(f),[u]),x=z((f,v)=>{if(!t)return;const C=o?t.findIndex(w=>n(w,o)):-1;if(C<0)return y(f,v);const[h,$]=[C,t.indexOf(f)].sort((w,q)=>w-q);t.slice(h,$+1).forEach((w,q,k)=>{q>0&&q<k.length-1&&qe(w)||y(w,v)}),r(f)},[t,n,y]);return M(()=>a(f=>f!==D&&f.length>0&&t?t.filter(v=>f.find(C=>n(v,C))):f),[t]),{selectedItems:i,isItemSelected:l,isGroupSelected:s,isSelected:u,select:d,deselect:m,selectOnly:g,selectAll:p,deselectAll:b,toggleSelect:y,toggleSelectTo:x}},$o={host:{position:"relative",display:"flex",flexDirection:"column"}},Co=n=>{const{data:e,renderItem:t,renderGroup:i,displayEmptyGroups:a,compareItemsFn:o=ho}=n,{toggleFold:r,toggleCollapse:l,state:s,signal:u}=yo(),d=_(()=>bo(e,a,s),[e,a,u]),{selectedItems:m,isItemSelected:g,isGroupSelected:p,isSelected:b,select:y,deselect:x,selectOnly:f,selectAll:v,deselectAll:C,toggleSelect:h,toggleSelectTo:$}=vo({compareItemsFn:o,data:e,flatData:d}),w=z((k,W)=>Array.isArray(k.items)?i(k,W,{selected:p(k),folded:po(k,s),toggleSelect:H=>h(k,typeof H=="boolean"?H:void 0),toggleFold:()=>r(k)}):t(k,W,{selected:g(k),expanded:mo(k,s),toggleSelect:H=>h(k,typeof H=="boolean"?H:void 0),toggleCollapse:()=>l(k)}),[t,i,m,h,u]);_t(()=>{Object.assign(n.style,$o.host)},[]);const q={toggleFold:r,toggleCollapse:l,isItemSelected:g,isGroupSelected:p,isSelected:b,select:y,deselect:x,selectOnly:f,selectAll:v,deselectAll:C,toggleSelect:h,toggleSelectTo:$};return Ue(q,Object.values(q)),{renderRow:w,flatData:d}},wo=({renderRow:n,flatData:e})=>zn({items:e,renderItem:(t,i)=>c`<cosmoz-grouped-list-row
				.item=${t}
				.index=${i}
				.renderFn=${n}
			></cosmoz-grouped-list-row>`}),zo=n=>wo(Co(n));customElements.define("cosmoz-grouped-list",O(zo,{useShadowDOM:!1}));const So=n=>window.ShadyCSS?.ApplyShim?.transformCssText?.(n)||n,Ao=n=>{const{header:e,list:t,footer:i}=uo(n);return c`
		<style>
			${Sn([],()=>So(ca))}
		</style>
