import{e as c,D as He,t as S,A as Ge}from"./iframe-Byf9_7Uo.js";import{t as j,c as O,g as A,n as F,P as I,s as ln,a as Ft,r as sn,e as un,D as cn,b as dn,d as mn,i as ke,h as kt,m as pn,u as R,f as _t,j as Et,k as gn,l as Z,p as P,o as je,q as It,v as _e,w as bn,x as Ee,y as _,z as M,A as lt,B as Ie,C as Mt,E as st,F as ut,G as z,H as fn,I as hn,J as Ot,K as Ke,L as Lt,M as xn,N as Dt,O as yn,Q as ct,R as vn,S as $n,T as Cn,U as Tt,V as We,W as Je,X as wn,Y as Rt,Z as Ue,_ as U,$ as zn,a0 as Sn}from"./cosmoz-collapse-Cb5gTXg4.js";import"./preload-helper-PPVm8Dsz.js";const An=j`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,Pn=n=>{const{label:e,value:t,slot:i}=n,a=c`<div
	...
	`},Vt=n=>n?typeof n.close=="function"?n:Vt(n.parentElement):null,Xe=n=>class extends n{static get properties(){return{disabled:{type:Boolean,value:!1},filter:{type:Object,notify:!0},values:{type:Array,value(){return[]}},headerFocused:{type:Boolean,notify:!0},min:{type:Number,value:null},max:{type:Number,value:null},limits:{type:Function},autoupdate:{type:String,value:!0},locale:{type:String,value:null},align:{type:String,value:"left"},_filterInput:{type:Object,value(){return{min:null,max:null}}},_range:{type:Object,computed:"_computeRange(values.*)"},_limit:{type:Object,computed:"_computeLimit(_range, _filterInput.*, min, max)",value(){return{}}},_tooltip:{type:String,computed:"_computeTooltip(title, _filterText)"},_fromClasses:{type:String,computed:"_computeInputClasses(_filterInput.min)"},_toClasses:{type:String,computed:"_computeInputClasses(_filterInput.max)"}}}static get observers(){return["_filterInputChanged(_filterInput.*, autoupdate)","_filterChanged(filter.*)","_updateLimits(limits, headerFocused)"]}disconnectedCallback(){this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),super.disconnectedCallback()}_computeInputClasses(e){return e!=null&&e!==""?"has-value":""}toNumber(e,t,i){if(e==null||e==="")return;const a=typeof e=="number"?e:Number(e);if(Number.isNaN(a))return;if(i==null||t==null)return a;const o=this.toNumber(t);return o==null?a:i(a,o)}toValue(){return this.toNumber.apply(this,arguments)}getComparableValue(e,t){if(e==null)return;let i=e;return t!=null&&(i=this.get(t,e)),this.toValue(i)}renderValue(){}getInputString(e,t=this.valuePath){const i=this.toValue(this.get(t,e));return this._toInputString(i)}_computeRange(e){const t=e.base,i=Array.isArray(t)&&t.length&&t.map(a=>this.toValue(a)).filter(a=>a!=null);return!i||i.length<1?{min:null,max:null}:i.reduce((a,o)=>({min:this.toValue(o,a.min,Math.min),max:this.toValue(o,a.max,Math.max)}),{})}_computeLimit(e,t,i,a){if(!e)return;const o=t.base,r=this.toValue(i),l=this.toValue(a),s=r??this.toValue(e.min),u=l??this.toValue(e.max);return{fromMin:s,fromMax:this.toValue(u,this._fromInputString(o.max,"max"),Math.min),toMin:this.toValue(s,this._fromInputString(o.min,"min"),Math.max),toMax:u}}_computeFilterText(e){if(e.base==null)return;const t=e.base,i=this.toValue(t.min),a=this.toValue(t.max),o=[];return i!=null&&o.push(this.renderValue(i)),o.push(" - "),a!=null&&o.push(this.renderValue(a)),o.length>1?o.join(""):void 0}_computeTooltip(e,t){return t==null?e:`${e}: ${t}`}_fromInputString(e){return this.toValue(e)}_toInputString(e){const t=this.toValue(e);return t??null}_getDefaultFilter(){return{min:null,max:null}}_filterInputChanged(e,t){const i=e.path.split(".")[1];this.__inputChangePath=i||null,t&&(this._limitInputDebouncer=cn.debounce(this._limitInputDebouncer,dn.after(600),()=>{this._limitInput(),this._updateFilter()}),mn(this._limitInputDebouncer))}_clearFrom(){this.set("_filterInput.min",null),this._updateFilter()}_clearTo(){this.set("_filterInput.max",null),this._updateFilter()}_onBlur(){this._limitInput(),this._updateFilter()}_onKeyDown(e){const t=e.currentTarget,i=Array.from(t.parentElement.querySelectorAll("cosmoz-input")),a=i[i.findIndex(l=>l===t)+1],o=!a,r=i[0]===t;switch(e.keyCode){case 13:if(e.preventDefault(),!o)a.focus();else{const l=this._limitInput();this._updateFilter(),l||this._closeParent(t)}break;case 9:(o&&!e.shiftKey||r&&e.shiftKey)&&this._closeParent(t)}}_closeParent(e){const t=Vt(e);t&&t.close()}_onDropdownOpenedChanged({currentTarget:e,type:t,detail:i}){(t==="focus"||i?.value===!0)&&setTimeout(()=>{e.querySelector("cosmoz-input:focus")||e.querySelector("cosmoz-input")?.focus()},100)}_limitInput(){const e=this._filterInput,t=this.__inputChangePath,i=t?this._fromInputString(this.get(t,e),t):null;if(this.__inputChangePath=null,i==null)return!1;const a=this._limit,o=t==="min"?"from":"to",r=this.get(o+"Min",a),l=this.get(o+"Max",a),s=this.toValue(i,r,Math.max),u=this.toValue(s,l,Math.min);return this.getComparableValue(i)!==this.getComparableValue(u)?(this.set(["_filterInput",t],this._toInputString(u,t)),this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),!0):!1}_updateFilter(){const e=this._filterInput,t=this.filter,i=this._fromInputString(e.min,"min"),a=this._fromInputString(e.max,"max");this.getComparableValue(i)===this.getComparableValue(t,"min")&&this.getComparableValue(a)===this.getComparableValue(t,"max")||this.set("filter",{min:i,max:a})}_filterChanged(e){if(this._filterInput==null)return;const t=this._filterInput,i=e.base,a=this._fromInputString(t.min,"min"),o=this._fromInputString(t.max,"max");this.getComparableValue(a)===this.getComparableValue(i,"min")&&this.getComparableValue(o)===this.getComparableValue(i,"max")||(this.set("_filterInput",{min:this._toInputString(i.min),max:this._toInputString(i.max)}),this._limitInputDebouncer&&this._limitInputDebouncer.cancel())}hasFilter(){const e=this.filter;return e==null?!1:this.toValue(e.min)!=null||this.toValue(e.max)!=null}resetFilter(){this.filter=this._getDefaultFilter()}_updateLimits(e,t){e&&Promise.resolve(ke(e,{active:t})).then(i=>{const{min:a,max:o}=i??{};Object.assign(this,{...a!=null?{min:a}:{},...o!=null?{max:o}:{}})})}},me=n=>class extends n{static get template(){return kt`<div id="output" style="position:relative;"></div>`}connectedCallback(){super.connectedCallback();const e=this;He(e.render(),e.$.output)}_propertiesChanged(e,t,i){super._propertiesChanged(e,t,i);const a=this;requestAnimationFrame(()=>He(a.render(),a.$.output))}};class Bn extends Xe(me(I)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return c`
		...
		>
			...
			.autodetect=${u}
			.align=${m??g}
			@filter-changed=${({detail:{value:$}})=>f(h=>({...h,filter:$}))}
			@header-focused-changed=${({detail:{value:$}})=>f(h=>({...h,headerFocused:$}))}
...
`,Di=({items:n})=>{const[e,t]=R(!1),i=Array.isArray(n)?n:[],a=_(()=>Math.max(0,i.length-1),[i]);if(i.length===0)return null;const o=i.length>2,r=i[0],l=o&&!e?[]:i.slice(1),s=u=>{u.stopPropagation(),u.preventDefault(),t(d=>!d)};return c`
	...
	`};customElements.define("cosmoz-omnitable-column-list-data",O(Di,{styleSheets:[Ee(Li)]}));class Ti extends De(T(I)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:i}){return c`<cosmoz-omnitable-column-list-data
		...
		></cosmoz-input>`}renderHeader({title:e,min:t,max:i,limits:a,locale:o,maximumFractionDigits:r,minimumFractionDigits:l,autoupdate:s,disabledFiltering:u,headerAlign:d,align:m},{filter:g},p,f){return c`<cosmoz-omnitable-number-range-input
			...
			.autoupdate=${s}
			.align=${d??m}
			@filter-changed=${({detail:{value:y}})=>p($=>({...$,filter:y}))}
			@header-focused-changed=${({detail:{value:y}})=>p($=>({...$,headerFocused:y}))}
...
`);r.unshift(o),Dt(new File(r,t,{type:"text/csv;charset=utf-8"}))},ma=(n,e)=>{const t=n.map(a=>a.title),i=e.map(a=>n.map(o=>{const r=o.toXlsxValue(o,a);return r??""}));return i.unshift(t),i},pa=(n,e,t,i)=>{const a=ma(n,e),o=new yn(t).addSheetFromData(a,i).generate();Dt(new File([o],t,{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}))},Se=Symbol("index"),D=Symbol("All"),ga=(n,e)=>{if(typeof n.findLastIndex=="function")return n.findLastIndex(e);for(let t=n.length-1;t>=0;t--)if(e(n[t],t,n))return t;return-1},ba=({columns:n,selectedItems:e,setSelectedItems:t,csvFilename:i,xlsxFilename:a,xlsxSheetname:o,topPlacement:r,enableSelectAll:l,allSelected:s,allItemsCount:u})=>{const d=e===D,m=d||e.length>0,g=e!==D&&l&&s,p=y=>c`<cosmoz-dropdown-menu
		...
		</cosmoz-dropdown-menu>`,f=F(d,()=>u!==void 0?S("All {count} items selected",{count:u}):S("All items selected"),()=>S("{count} selected item",{count:e===D?0:e.length}));return c`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${m}
		part="bottomBar"
...
`,Za=n=>n?"groupRow groupRow-folded":"groupRow",eo=({item:n,index:e})=>t=>F(t?.length>0,()=>c`
	...
	`,no=({onCheckboxChange:n,dataIsValid:e,groupOnColumn:t})=>(i,a,{selected:o,folded:r,toggleFold:l})=>c` <div
		...
		</div>`,io=({host:n,error:e,dataIsValid:t,processedItems:i,columns:a,collapsedColumns:o,miniColumns:r,sortAndGroupOptions:l,rowPartFn:s,...u})=>{const{loading:d=!1,displayEmptyGroups:m=!1,compareItemsFn:g}=n,p=Je({shiftKey:!1,ctrlKey:!1}),f=z(v=>{const C=v.target.dataItem,b=v.target.checked;p.current.shiftKey?n.shadowRoot.querySelector("#groupedList").toggleSelectTo(C,b):p.current.ctrlKey?(v.target.checked=!0,n.shadowRoot.querySelector("#groupedList").selectOnly(C)):n.shadowRoot.querySelector("#groupedList").toggleSelect(C,b),v.preventDefault(),v.stopPropagation()},[]);M(()=>{const v=({shiftKey:C,ctrlKey:b})=>{p.current={shiftKey:C,ctrlKey:b}};return window.addEventListener("keydown",v),window.addEventListener("keyup",v),()=>{window.removeEventListener("keydown",v),window.removeEventListener("keyup",v)}},[]);const y=z(v=>{const C=v.composedPath();C.slice(0,C.indexOf(v.currentTarget)).find(x=>x.matches?.("a, .checkbox, .expand"))||n.dispatchEvent(new window.CustomEvent("omnitable-item-click",{bubbles:!0,composed:!0,detail:{item:v.currentTarget.dataItem,index:v.currentTarget.dataIndex}}))},[]),{groupOnColumn:$}=l,h=z((v,C)=>b=>ii(n,v,C,b),[]);return{...u,processedItems:i,dataIsValid:t,filterIsTooStrict:t&&i.length<1,loading:d,compareItemsFn:g,displayEmptyGroups:m,error:e,renderItem:_(()=>to({columns:a,collapsedColumns:o,miniColumns:r,onItemClick:y,onCheckboxChange:f,dataIsValid:t,groupOnColumn:$,onItemChange:h,rowPartFn:s}),[a,o,y,f,t,$,h,s]),renderGroup:_(()=>no({onCheckboxChange:f,dataIsValid:t,groupOnColumn:$}),[f,t,$])}},ao=(n,e)=>{if(n===e)return 0;if(n==null)return-1;if(e==null)return 1;const t=typeof n,i=typeof e;return t==="object"&&i==="object"?n.toString()<e.toString()?-1:1:t==="number"&&i==="number"?n-e:t==="string"&&i==="string"?n<e?-1:1:t==="boolean"&&i==="boolean"?n?-1:1:(console.warn("unsupported sort",t,n,i,e),0)},Pe=(n,e)=>(t,i)=>ao(n(t),n(i))*(e?-1:1),oo=n=>n.replace(/([a-z0-9])([A-Z])/gu,"$1-$2").toLowerCase(),qt=(n,e)=>{!n||!e||Object.entries(e).forEach(([t,i])=>{n[V].__ownChange=!0,n[V][t]=i,n[V].__ownChange=!1,n[V].dispatchEvent(new CustomEvent(`${oo(t)}-changed`,{bubbles:!0,detail:{value:i}}))})},Be=(n,e)=>Object.assign(n,{[Se]:e}),we=Symbol("unparsed"),ro=({data:n,columns:e,hashParam:t,sortAndGroupOptions:i,noLocalSort:a,noLocalFilter:o})=>{const{groupOnColumn:r,groupOnDescending:l,sortOnColumn:s,descending:u}=i,d=z(([b,x])=>{const w=e.find(({name:q})=>q===b);return w==null?[b,void 0]:[b,x.filter&&w.serializeFilter(w,x.filter)]},[e]),m=z(([b,x])=>{const w=e.find(({name:k})=>k===b);if(w==null)return[b,{[we]:x}];const q={filter:w.deserializeFilter(w,x)};return qt(w,q),[b,q]},[e]),[g,p]=te({},t,{multi:!0,suffix:"-filter--",write:d,read:m}),f=z((b,x)=>p(w=>{const q=ke(x,w[b]);return qt(e.find(k=>k.name===b),q),{...w,[b]:{...w[b],...q}}}),[e,p]),y=_(()=>Object.values(g).map(b=>b.filter),[g]),$=_(()=>Object.fromEntries(e.map(b=>[b.name,!b.noLocalFilter&&b.getFilterFn(b,g[b.name]?.filter)]).filter(([,b])=>!!b)),[e,...y]),h=_(()=>!Array.isArray(n)||n.length===0?[]:Object.entries($).length===0||o?n.slice():n.filter(b=>Object.values($).every(x=>x(b))),[n,$,o]),v=_(()=>{if(!a&&!r&&s!=null&&s.sortOn!=null)return h.slice().sort(Pe(b=>s.getComparableValue({...s,valuePath:s.sortOn},b),u));if(r!=null&&r.groupOn!=null){const b=h.reduce((x,w)=>{const q=r.getComparableValue({...r,valuePath:r.groupOn},w);if(q===void 0)return x;let k=x.find(W=>W.id===q);return k?(k.items.push(w),x):(k={id:q,name:q,items:[w]},[...x,k])},[]);return b.sort(Pe(x=>r.getComparableValue({...r,valuePath:r.groupOn},x.items[0]),l)),!s||a?b:b.filter(x=>Array.isArray(x.items)).map(x=>(x.items.sort(Pe(w=>s.getComparableValue({...s,valuePath:s.sortOn},w),u)),x))}return h},[h,r,l,s,u,a]),C=_(()=>{let b=0,x=0;const w=[];return v.forEach(q=>{if(Array.isArray(q.items)){Be(q,x++),q.items.forEach(k=>{Be(k,b++),w.push(k)});return}return Be(q,b++),w.push(q)},[]),w},[v]);return M(()=>{p(b=>Object.values(b).some(w=>w[we]!=null)?Object.fromEntries(Object.entries(b).map(([w,q])=>q[we]==null?[w,q]:m([w,q[we]]))):b)},[m]),{processedItems:v,visibleData:C,filters:g,filterFunctions:$,setFilterState:f}},lo=n=>{const e=i=>{const a=n.data.indexOf(i);if(a<0)return null;const o=n.data.splice(a,1);if(n.data=n.data.slice(),Array.isArray(o)&&o.length>0)return o[0]},t=(i,a)=>{n.data.splice(i,1,a),n.data=n.data.slice()};return{removeItem:e,removeItems(i){const a=[];for(let o=i.length-1;o>=0;o-=1){const r=e(i[o]);r!=null&&a.push(r)}return a},replaceItemAtIndex:t,replaceItem(i,a){const o=n.data.indexOf(i);o>-1&&t(o,a)},selectItem(i){n.shadowRoot.querySelector("#groupedList").select(i)},selectAll(){n.shadowRoot.querySelector("#groupedList").selectAll()},deselectAll(){n.shadowRoot.querySelector("#groupedList").deselectAll()},deselectItem(i){n.shadowRoot.querySelector("#groupedList").deselect(i)},isItemSelected(i){return n.shadowRoot.querySelector("#groupedList").isItemSelected(i)}}},so=({host:n,visibleData:e,filters:t,...i})=>{const{setFilterState:a}=i,o=_(()=>lo(n),[]),[r,l]=Rt("selectedItems",[]);Ue(i,Object.values(i)),Ue(o,Object.values(o)),M(()=>{const u=d=>{if(!(d instanceof CustomEvent))return;const m=d.detail;a(m.name,g=>({...typeof g=="object"&&g!==null?g:{},...m.state}))};return n.addEventListener("legacy-filter-changed",u),()=>n.removeEventListener("legacy-filter-changed",u)},[]),U("visibleData",e),U("sortedFilteredGroupedItems",i.sortedFilteredGroupedItems),U("sortOn",i.sortOn),U("descending",i.descending),U("isMini",i.isMini);const s=_(()=>Object.fromEntries(Object.entries(t).filter(([,{filter:u}])=>u!==void 0).map(([u,{filter:d}])=>[u,d])),[t]);return U("filters",s,Object.values(s)),{selectedItems:r,setSelectedItems:l}},uo=n=>{const{hashParam:e,settingsId:t,data:i,resizeSpeedFactor:a,noLocal:o,noLocalSort:r=o,noLocalFilter:l=o,error:s,rowPartFn:u}=n,d=Oa({settingsId:t,host:n}),{settings:m,setSettings:g,columns:p,resetRef:f,savedSettings:y}=d,$=y!==void 0,h=na(p,e,{settings:m,setSettings:g,resetRef:f,ready:$}),{processedItems:v,visibleData:C,filters:b,setFilterState:x,filterFunctions:w}=ro({data:i,columns:p,hashParam:e,sortAndGroupOptions:h,noLocalSort:r,noLocalFilter:l}),{isMini:q,collapsedColumns:k,miniColumns:W,requestTween:H}=Xa({host:n,columns:p,settings:m,setSettings:g,resizeSpeedFactor:a,sortAndGroupOptions:h}),at=i&&Array.isArray(i)&&i.length>0,{selectedItems:Re,setSelectedItems:ot}=so({host:n,visibleData:C,sortedFilteredGroupedItems:v,columns:p,filters:b,setFilterState:x,isMini:q,...h}),rt=Ya({host:n,selectedItems:Re,sortAndGroupOptions:h,dataIsValid:at,data:i,columns:p,filters:b,collapsedColumns:k,settings:m,filterFunctions:w,settingS:d,setFilterState:x,hideSelectAll:n.hideSelectAll===!0,requestTween:H});return{header:rt,list:io({host:n,error:s,dataIsValid:at,processedItems:v,selectedItems:Re,setSelectedItems:ot,columns:p,collapsedColumns:k,miniColumns:W,sortAndGroupOptions:h,rowPartFn:u}),footer:Qa({host:n,selectedItems:Re,allSelected:rt.allSelected,setSelectedItems:ot,columns:p,enableSelectAll:n.enableSelectAll,allItemsCount:n.allItemsCount})}};customElements.define("cosmoz-grouped-list-row",class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||He(this._renderFn(this._item,this._index),this)}});const co={group:Symbol("group")},Te=(n,e)=>(e.has(n)||e.set(n,{}),e.get(n)),mo=(n,e)=>!!Te(n,e).expanded,po=(n,e)=>!!Te(n,e).folded,qe=n=>n?n.items instanceof Array:!1,go=n=>{if(!Array.isArray(n)||n.length===0)return;const e=Array.isArray(n[0]?.items);if(!n.every(i=>Array.isArray(i.items)===e))throw new Error("Data must be homogeneous.")},bo=(n,e,t)=>Array.isArray(n)?(go(n),n.reduce((a,o)=>{const r=o;return r.items?r.items.length?Te(o,t).folded?a.concat(o):a.concat(o,r.items.map(l=>Object.assign(l,{[co.group]:o}))):e?a.concat(o):a:a.concat(o)},[])):void 0,fo=(n,...e)=>typeof n=="function"?n(...e):n,ho=(n,e)=>n===e,xo=()=>{const[n,e]=R(()=>[new WeakMap]);return{setItemState:z((i,a)=>e(([o])=>{const r=Te(i,o);return Object.assign(r,fo(a,r)),[o]}),[]),state:n[0],signal:n}},yo=()=>{const{setItemState:n,state:e,signal:t}=xo(),i=z((o,r)=>{qe(o)&&n(o,l=>({folded:r!==void 0?r:!l.folded}))},[]),a=z((o,r)=>{qe(o)||n(o,l=>({expanded:r!==void 0?!r:!l.expanded}))},[]);return{state:e,signal:t,toggleFold:i,toggleCollapse:a}},vo=({compareItemsFn:n,data:e,flatData:t})=>{const[i,a]=Rt("selectedItems",()=>[]),[o,r]=R(),l=z(h=>i===D||i.includes(h),[i]),s=z(h=>i===D||(h?.items?.every(l)??!1),[i,l]),u=z(h=>l(h)||s(h),[l,s]),d=z(h=>{const C=h.items??[h];a(b=>b===D?b:[...b,...C.filter(x=>!b.includes(x))]),r(h)},[]),m=z(h=>{const C=h.items??[h];a(b=>b===D?(t??[]).filter(x=>!qe(x)).filter(x=>!C.includes(x)):b.filter(x=>!C.includes(x))),r(h)},[t]),g=z(h=>{a(h.items?.slice()||[h]),r(h)},[]),p=z(()=>{a(e.flatMap(h=>h.items||h)),r(void 0)},[e]),f=z(()=>{a([]),r(void 0)},[]),y=z((h,v=!u(h))=>v?d(h):m(h),[u]),$=z((h,v)=>{if(!t)return;const C=o?t.findIndex(w=>n(w,o)):-1;if(C<0)return y(h,v);const[b,x]=[C,t.indexOf(h)].sort((w,q)=>w-q);t.slice(b,x+1).forEach((w,q,k)=>{q>0&&q<k.length-1&&qe(w)||y(w,v)}),r(h)},[t,n,y]);return M(()=>a(h=>h!==D&&h.length>0&&t?t.filter(v=>h.find(C=>n(v,C))):h),[t]),{selectedItems:i,isItemSelected:l,isGroupSelected:s,isSelected:u,select:d,deselect:m,selectOnly:g,selectAll:p,deselectAll:f,toggleSelect:y,toggleSelectTo:$}},$o={host:{position:"relative",display:"flex",flexDirection:"column"}},Co=n=>{const{data:e,renderItem:t,renderGroup:i,displayEmptyGroups:a,compareItemsFn:o=ho}=n,{toggleFold:r,toggleCollapse:l,state:s,signal:u}=yo(),d=_(()=>bo(e,a,s),[e,a,u]),{selectedItems:m,isItemSelected:g,isGroupSelected:p,isSelected:f,select:y,deselect:$,selectOnly:h,selectAll:v,deselectAll:C,toggleSelect:b,toggleSelectTo:x}=vo({compareItemsFn:o,data:e,flatData:d}),w=z((k,W)=>Array.isArray(k.items)?i(k,W,{selected:p(k),folded:po(k,s),toggleSelect:H=>b(k,typeof H=="boolean"?H:void 0),toggleFold:()=>r(k)}):t(k,W,{selected:g(k),expanded:mo(k,s),toggleSelect:H=>b(k,typeof H=="boolean"?H:void 0),toggleCollapse:()=>l(k)}),[t,i,m,b,u]);_t(()=>{Object.assign(n.style,$o.host)},[]);const q={toggleFold:r,toggleCollapse:l,isItemSelected:g,isGroupSelected:p,isSelected:f,select:y,deselect:$,selectOnly:h,selectAll:v,deselectAll:C,toggleSelect:b,toggleSelectTo:x};return Ue(q,Object.values(q)),{renderRow:w,flatData:d}},wo=({renderRow:n,flatData:e})=>zn({items:e,renderItem:(t,i)=>c`<cosmoz-grouped-list-row
				.item=${t}
				.index=${i}
				.renderFn=${n}
