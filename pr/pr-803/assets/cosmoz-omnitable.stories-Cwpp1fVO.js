import{x as d,B as _e,E as xt}from"./iframe-CUelvW6i.js";import{t as K,c as O,g as C,P as I,u as T,a as yt,m as vt,s as Nt,D as Bt,b as Gt,e as Ht,i as $e,h as Oe,d as jt,f as $t,r as Wt,j as Ut,k as A,l as Kt,n as we,p as he,o as _,q as Jt,v as Ce,w as Xt,x as Qt,y as Yt,T as Zt,z as M,A as Ye,B as ei,C as ti,E as ii,F as $,G as ai,H as ni,I as wt,J as Le,K as F,L as Ct,M as De,N as oi,O as St,Q as ri,R as Te,S as Ze,U as li,V as Ve,W as si,X as ui,Y as Ee,Z as Pe,_ as ci,$ as Ie,a0 as R,a1 as di,a2 as ze,a3 as mi}from"./cosmoz-collapse-BmI-TWoI.js";import"./preload-helper-PPVm8Dsz.js";const pi=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`;customElements.define("cosmoz-omnitable-item-expand-line",O(Ba,{styleSheets:[De(Na)]}));const Ga=({columns:i,item:e,selected:t,expanded:a,groupOnColumn:n})=>oi(i,o=>d`<cosmoz-omnitable-item-expand-line
			...
			>`);customElements.define("cosmoz-omnitable-item-expand",O(Ga,{useShadowDOM:!1}));const Ha=(i,e,t)=>i.editable?i.renderEditCell(i,e,t(i,e.item)):i.renderCell(i,e),ja=({columns:i,groupOnColumn:e,item:t,index:a,selected:n,expanded:o,onItemChange:r})=>Ct(i,l=>l.name,l=>d`<div
...
`,Za=({settingsConfig:i})=>{const{columns:e,collapsed:t}=i,a=e.filter(n=>!t.some(o=>o.name===n.name));return d`<div class="skeleton">
	...
	</div>`};customElements.define("cosmoz-omnitable-skeleton",O(Za,{styleSheets:[Ya]}));const en=(i,e)=>{const{settingsConfig:t}=i,{processedItems:a,dataIsValid:n,filterIsTooStrict:o,loading:r,displayEmptyGroups:l,compareItemsFn:u,setSelectedItems:s,renderItem:c,renderGroup:m,error:b}=e;return d`${_(!r&&!n&&!b,()=>d`<div class="tableContent-empty">
