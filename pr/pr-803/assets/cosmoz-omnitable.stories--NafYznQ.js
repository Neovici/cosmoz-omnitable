import{x as c,B as _e,E as xt}from"./iframe-DhWJegHA.js";import{t as K,c as O,g as C,P as I,u as T,a as yt,m as vt,s as Nt,D as Bt,b as Gt,e as Ht,i as $e,h as Oe,d as jt,f as $t,r as Wt,j as Ut,k as A,l as Kt,n as we,p as he,o as _,q as Jt,v as Ce,w as Xt,x as Qt,y as Yt,T as Zt,z as M,A as Ye,B as ei,C as ti,E as ii,F as $,G as ai,H as ni,I as wt,J as Le,K as F,L as Ct,M as De,N as oi,O as St,Q as ri,R as Te,S as Ze,U as li,V as Ve,W as si,X as ui,Y as Ee,Z as Pe,_ as di,$ as Ie,a0 as R,a1 as ci,a2 as ze,a3 as mi}from"./cosmoz-collapse-_6t3USXs.js";import"./preload-helper-PPVm8Dsz.js";const pi=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,Dt=i=>(e,t,a=ei)=>{const n=ni(),o=new URLSearchParams(n.hash.replace("#",""));return i(e,t,a,o),"#!"+Object.assign(n,{hash:o}).href.replace(location.origin,"")},Tt=i=>i==null||i==="",La=Dt((i,e,t,a)=>Tt(t(e))?a.delete(i):a.set(i,t(e))),Da=Dt((i,e,t,a)=>Object.entries(e).map(t).forEach(([n,o])=>Tt(o)?a.delete(i+n):a.set(i+n,o))),J=(i,e,{suffix:t="",read:a,write:n,multi:o}={})=>{const[r,l]=o?[Da,ti]:[La,ii],[u,s]=T(()=>e==null?i:l(e+t,a)??i),d=$(m=>s(b=>{const p=$e(m,b);return e!=null&&ai(r(e+t,p,n),null,{notify:!1}),p}),[e,t,r,n]);return[u,d]},Ta=i=>[!0,"true",1,"yes","on"].includes(i),ce=i=>i===""||(i==null?void 0:Ta(i)),me=(i,e,t)=>$(a=>{i(a),t(n=>({...n,[e]:a}))},[i,e,t]),Va=(i,e,t,a,n)=>{const[o,r]=J(t.sortOn,e,{suffix:"-sortOn"}),[l,u]=J(ce(t.descending),e,{suffix:"-descending",read:ce}),[s,d]=J(t.groupOn,e,{suffix:"-groupOn"}),[m,b]=J(ce(t.groupOnDescending),e,{suffix:"-groupOnDescending",read:ce}),p=F(()=>i.find(g=>g.name===o),[i,o]),z=F(()=>i.find(g=>g.name===s),[i,s]),h={groupOn:s,setGroupOn:me(d,"groupOn",a),groupOnDescending:m,setGroupOnDescending:me(b,"groupOnDescending",a),sortOn:o,setSortOn:me(r,"sortOn",a),descending:l,setDescending:me(u,"descending",a),columns:i},v=F(()=>h,Object.values(h)),k=$(g=>{r(g.sortOn),d(g.groupOn),u(g.descending),b(g.groupOnDescending)},[]);return M(()=>void(n.current=k),[]),{...v,sortAndGroup:v,groupOnColumn:z,sortOnColumn:p}},Qe=wt();customElements.define("sort-and-group-provider",Qe.Provider);customElements.define("sort-and-group-consumer",O(({render:i})=>i(Le(Qe)),{useShadowDOM:!1}));const Pa=({data:i,columns:e,groupOnColumn:t,filters:a,setFilterState:n,sortAndGroup:{sortOn:o,setSortOn:r,descending:l,setDescending:u}={}})=>Ct(e,s=>s.name,s=>[c`<div
			...
			>
				...
				${_(!s.noSort,()=>Ot({on:o,setOn:r,descending:l,setDescending:u,column:s}))}
...
`,Mn=i=>i?"groupRow groupRow-folded":"groupRow",On=({item:i,index:e})=>t=>_(t?.length>0,()=>c`
