...
`);i.unshift(r),Ke(new File(i,n,{type:`text/csv;charset=utf-8`}))}})),zi,Bi,Vi=e((()=>{We(),Se(),zi=(e,t)=>{let n=e.map(e=>e.title),r=t.map(t=>e.map(e=>e.toXlsxValue(e,t)??``));return r.unshift(n),r},Bi=(e,t,n,r)=>{let i=zi(e,t),a=new Qe(n).addSheetFromData(i,r).generate();Ke(new File([a],n,{type:`application/vnd.openxmlformats-officedocument.spreadsheetml.sheet`}))}})),Hi,Ui=e((()=>{s(),o(),r(),Ri(),Vi(),Hi=({columns:e,selectedItems:t,csvFilename:r,xlsxFilename:i,xlsxSheetname:o,topPlacement:s})=>n`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!Ae(t.length)}
		part="bottomBar"
	...
	</cosmoz-bottom-bar>`})),Wi,Gi=e((()=>{r(),A(),Wi=({allSelected:e,onAllCheckboxChange:t,sortAndGroup:r,dataIsValid:i,data:a,columns:o,filters:s,groupOnColumn:c,setFilterState:l,settingsConfig:u,hideSelectAll:d})=>n`<sort-and-group-provider .value=${r}>
...
`,qi=({settingsConfig:e})=>{let{columns:t,collapsed:r}=e,i=t.filter(e=>!r.some(t=>t.name===e.name));return n`<div class="skeleton">
	...
	</div>`},customElements.define(`cosmoz-omnitable-skeleton`,m(qi,{styleSheets:[Ki]}))})),Yi,Xi=e((()=>{g(),Ji(),ve(),o(),r(),A(),Yi=(e,t)=>{let{settingsConfig:r}=e,{processedItems:i,dataIsValid:o,filterIsTooStrict:s,loading:c,displayEmptyGroups:l,compareItemsFn:u,selectedItems:d,setSelectedItems:f,renderItem:p,renderGroup:m,error:h}=t;return n`${j(!c&&!o&&!h,()=>n`<div class="tableContent-empty">
...
`})),ea,ta,na=e((()=>{at(),g(),ea=e=>{let t=parseInt(e,10);return isFinite(t)?t:void 0},ta=e=>{let{config:t}=e,{settings:n,setSettings:r,collapsed:i,requestTween:a}=t,o=dt({collapsed:i,settings:n.columns,requestTween:a,setSettings:u(e=>r(t=>({...t,columns:e})),[r])});return{...t,onDown:u(e=>{e.target.closest(`.pull`)&&(o.handle=e.currentTarget)},[o]),onDragStart:u(e=>{let{target:t}=e,n=ea(t.dataset.index);if(!o.handle?.contains(t)||n==null)return e.preventDefault();o.handle=null,e.dataTransfer.effectAllowed=`move`,e.dataTransfer.setData(`omnitable/sort-index`,n),e.dataTransfer.setData(`text/plain`,n),setTimeout(()=>t.classList.add(`drag`),0),t.addEventListener(`dragend`,e=>e.target.classList.remove(`drag`),{once:!0})},[o]),onDragEnter:u(e=>{let t=e.currentTarget;t===e.target&&(e.preventDefault(),e.dataTransfer.dropEffect=`move`,t.classList.add(`dragover`))},[]),onDragOver:u(e=>{e.preventDefault(),e.currentTarget.classList.add(`dragover`)},[]),onDragLeave:u(e=>{let t=e.currentTarget;t.contains(e.relatedTarget)||t.classList.remove(`dragover`)},[]),onDrop:u(e=>{let t=ea(e.dataTransfer.getData(`omnitable/sort-index`)),n=ea(e.currentTarget.dataset.index),{settings:r,setSettings:i,requestTween:a}=o;e.currentTarget.classList.remove(`dragover`),e.preventDefault();let s=r.slice();s.splice(n+(t>=n?0:-1),0,s.splice(t,1)[0]),a?.(),i(s)},[o]),onToggle:u(e=>{let{settings:t,setSettings:n,requestTween:r}=o,i=t.map(e=>({...e,disabled:e.disabled||o.collapsed?.some(t=>t.name===e.name)})),a=ea(e.target.closest(`[data-index]`)?.dataset.index);i.splice(a,1,{...t[a],disabled:!e.target.checked,priority:e.target.checked?t.reduce((e,t)=>Math.max(e,t.priority),0)+1:t[a].priority}),r?.(),n(i)},[o])}}})),ra,ia,aa,oa,sa=e((()=>{nt(),lt(),v(),s(),g(),o(),A(),ii(),li(),$i(),na(),ra=[f({apply({availableHeight:e,elements:t}){Object.assign(t.floating.style,{maxHeight:`${Math.max(0,e)}px`})}}),...Te],ia=({onDragStart:e,onDragEnter:t,onDragOver:r,onDragLeave:i,onDrop:a,onDown:o,onToggle:s,collapsed:c,filters:l})=>(u,d)=>{let f=!!c?.find(e=>e.name===u.name),p=!u.disabled&&!f;return n` <div
		...
		>
			...
			<input
				...
				.indeterminate=${f}
			/>
		</div>`},aa=e=>{let{settings:t,settingsId:r,onSave:i,onReset:o,hasChanges:s,opened:c,setOpened:l,...u}=ta(e);return n` <div class="headline">
			${a(`Sort and filter`)}
			<button
				class="close"
