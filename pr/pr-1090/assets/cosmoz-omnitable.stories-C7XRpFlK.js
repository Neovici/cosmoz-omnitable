import{e as c,D as He,t as S,A as Ge}from"./iframe-Cb_UWdmM.js";import{t as W,c as O,g as A,n as F,P as I,s as ln,a as Ft,r as sn,e as un,D as cn,b as dn,d as mn,i as ke,h as kt,m as pn,u as R,f as _t,j as Et,k as gn,l as Z,p as P,o as We,q as It,v as _e,w as bn,x as Ee,y as _,z as M,A as lt,B as Ie,C as Mt,E as st,F as ut,G as z,H as fn,I as hn,J as Ot,K as Ke,L as Lt,M as xn,N as Dt,O as yn,Q as ct,R as vn,S as $n,T as Cn,U as Tt,V as je,W as Je,X as wn,Y as Rt,Z as Ue,_ as U,$ as zn,a0 as Sn}from"./cosmoz-collapse-BwiwrMBL.js";import"./preload-helper-PPVm8Dsz.js";const An=W`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,Xt=n=>(e,t,i=Mt)=>{const a=hn(),o=new URLSearchParams(a.hash.replace("#",""));return n(e,t,i,o),"#!"+Object.assign(a,{hash:o}).href.replace(location.origin,"")},Qt=n=>n==null||n==="",Zi=Xt((n,e,t,i)=>Qt(t(e))?i.delete(n):i.set(n,t(e))),ea=Xt((n,e,t,i)=>{const a=Object.entries(e),o=a.map(t).filter(([,l])=>l!==void 0);if(o.length===0&&a.length>0)return;const r=n;Array.from(i.keys()).filter(l=>l.startsWith(r)).forEach(l=>i.delete(l)),o.forEach(([l,s])=>Qt(s)?i.delete(n+l):i.set(n+l,s))});function te(n,e,{suffix:t="",read:i,write:a,ready:o=!0,multi:r}={}){const l=r?ea:Zi,s=Ie({param:e,suffix:t,link:l,write:a??Mt}),u=_(()=>{if(e==null)return!1;if(r){const p=st(e+t);return Object.keys(p).length>0}return ut(e+t)!==void 0},[]),[d,m]=R(()=>{if(e==null)return n;if(r){const b=st(e+t,i);return Object.keys(b).length>0?b:n}return ut(e+t,i)??n}),g=z(p=>m(b=>{const y=ke(p,b);return s.param!=null&&fn(s.link(s.param+s.suffix,y,s.write),null,{notify:!1}),y}),[]);return M(()=>{s.param==null||!o||u||n!=null&&g(n)},[o]),[d,g]}const ta=n=>[!0,"true",1,"yes","on"].includes(n),ye=n=>n===""||(n==null?void 0:ta(n)),ve=(n,e,t)=>z(i=>{n(i),t(a=>({...a,[e]:i}))},[n,e,t]),na=(n,e,{settings:t,setSettings:i,resetRef:a,ready:o=!0})=>{const[r,l]=te(t.sortOn,e,{suffix:"-sortOn",ready:o}),[s,u]=te(ye(t.descending),e,{suffix:"-descending",read:ye,ready:o}),[d,m]=te(t.groupOn,e,{suffix:"-groupOn",ready:o}),[g,p]=te(ye(t.groupOnDescending),e,{suffix:"-groupOnDescending",read:ye,ready:o}),b=_(()=>n.find(C=>C.name===r),[n,r]),y=_(()=>n.find(C=>C.name===d),[n,d]),x={groupOn:d,setGroupOn:ve(m,"groupOn",i),groupOnDescending:g,setGroupOnDescending:ve(p,"groupOnDescending",i),sortOn:r,setSortOn:ve(l,"sortOn",i),descending:s,setDescending:ve(u,"descending",i),columns:n},h=_(()=>x,Object.values(x)),v=z(C=>{l(C.sortOn),m(C.groupOn),u(C.descending),p(C.groupOnDescending)},[]);return M(()=>{a.current=v},[]),{...h,sortAndGroup:h,groupOnColumn:y,sortOnColumn:b}},it=Ot();customElements.define("sort-and-group-provider",it.Provider);customElements.define("sort-and-group-consumer",O(({render:n})=>n(Ke(it)),{useShadowDOM:!1}));const ia=({data:n,columns:e,groupOnColumn:t,filters:i,setFilterState:a,sortAndGroup:{sortOn:o,setSortOn:r,descending:l,setDescending:s}={}})=>Lt(e,u=>u.name,u=>[c`<div
				...
				data-align="${u.headerAlign??u.align??"left"}"
