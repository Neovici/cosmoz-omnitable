import{b as d,D as Fe,A as bt,w as Pt}from"./iframe-1PJrSEEW.js";import{t as K,c as E,g as C,P as A,u as M,a as xt,m as vt,s as Bt,D as Gt,b as Ht,e as Wt,i as ye,h as Ae,d as qt,f as yt,r as Xt,j as Ut,k,l as Kt,n as $e,p as he,o as D,q as Jt,v as we,w as Qt,x as Yt,y as Zt,T as en,z as T,A as fe,B as tn,C as nn,E as on,F as w,G as rn,H as an,I as $t,J as Ee,K as I,L as wt,M as Te,N as ln,O as zt,Q as sn,R as Le,S as Qe,U as un,V as Re,W as cn,X as dn,Y as Oe,Z as Me,_ as mn,$ as De,a0 as P,a1 as pn,a2 as Ce,a3 as gn}from"./cosmoz-collapse-DgCrSMSf.js";import"./preload-helper-PPVm8Dsz.js";const hn=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,se=n=>{const e=parseInt(n,10);return isFinite(e)?e:void 0},lr=n=>{const{config:e}=n,{settings:t,setSettings:o,collapsed:r}=e,i=Re({collapsed:r,settings:t.columns,setSettings:w(a=>o(l=>({...l,columns:a})),[o])});return{...e,onDown:w(a=>{a.target.closest(".pull")&&(i.handle=a.currentTarget)},[i]),onDragStart:w(a=>{const{target:l}=a,u=se(l.dataset.index);if(!i.handle?.contains(l)||u==null)return a.preventDefault();i.handle=null,a.dataTransfer.effectAllowed="move",a.dataTransfer.setData("omnitable/sort-index",u),a.dataTransfer.setData("text/plain",u),setTimeout(()=>l.classList.add("drag"),0),l.addEventListener("dragend",s=>s.target.classList.remove("drag"),{once:!0})},[i]),onDragEnter:w(a=>{const l=a.currentTarget;l===a.target&&(a.preventDefault(),a.dataTransfer.dropEffect="move",l.classList.add("dragover"))},[]),onDragOver:w(a=>{a.preventDefault(),a.currentTarget.classList.add("dragover")},[]),onDragLeave:w(a=>{const l=a.currentTarget;l.contains(a.relatedTarget)||l.classList.remove("dragover")},[]),onDrop:w(a=>{const l=se(a.dataTransfer.getData("omnitable/sort-index")),u=se(a.currentTarget.dataset.index),{settings:s,setSettings:c}=i;a.currentTarget.classList.remove("dragover"),a.preventDefault();const m=s.slice();m.splice(u+(l>=u?0:-1),0,m.splice(l,1)[0]),c(m)},[i]),onToggle:w(a=>{const{settings:l,setSettings:u}=i,s=l.map(m=>({...m,disabled:m.disabled||i.collapsed?.some(h=>h.name===m.name)})),c=se(a.target.closest("[data-index]")?.dataset.index);s.splice(c,1,{...l[c],disabled:!a.target.checked,priority:a.target.checked?l.reduce((m,h)=>Math.max(m,h.priority),0)+1:l[c].priority}),u(s)},[i])}},sr=[cn({apply({availableHeight:n,elements:e}){Object.assign(e.floating.style,{maxHeight:`${Math.max(0,n)}px`})}}),...dn],ur=({onDragStart:n,onDragEnter:e,onDragOver:t,onDragLeave:o,onDrop:r,onDown:i,onToggle:a,collapsed:l,filters:u})=>(s,c)=>{const m=!!l?.find(p=>p.name===s.name),h=!s.disabled&&!m;return d` <div
			class="item"
			data-index=${c}
			@mousedown=${i}
			draggable="true"
