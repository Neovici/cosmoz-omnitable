import{n as e}from"./chunk-BneVvdWh.js";import{J as t,Q as n,Y as r,Z as i}from"./iframe-1Ptrfym4.js";import{$ as a,A as o,At as s,B as c,Bt as l,C as u,Ct as d,D as f,Dt as p,E as m,Et as h,F as g,Ft as _,G as v,Gt as ee,H as te,Ht as y,I as ne,It as b,J as re,K as ie,L as ae,Lt as oe,M as se,Mt as ce,N as le,Nt as x,O as ue,Ot as de,P as fe,Pt as S,Q as pe,R as C,Rt as me,S as w,St as he,T as ge,Tt as _e,U as T,Ut as E,V as ve,Vt as ye,W as be,Wt as xe,X as D,Y as Se,Z as Ce,_ as we,_t as Te,a as Ee,at as O,b as De,bt as Oe,c as ke,ct as Ae,d as je,dt as k,et as Me,f as Ne,ft as A,g as Pe,gt as Fe,h as Ie,ht as Le,i as Re,it as ze,j as Be,jt as j,k as Ve,kt as He,l as Ue,lt as We,m as Ge,mt as Ke,n as qe,nt as Je,o as Ye,ot as M,p as Xe,pt as Ze,q as Qe,r as $e,rt as et,s as tt,st as nt,t as rt,tt as it,u as at,ut as ot,v as st,vt as ct,w as lt,wt as ut,x as dt,xt as ft,y as N,yt as pt,z as P,zt as mt}from"./dist-CjE76LPv.js";var ht,gt=e((()=>{h(),ht=()=>i`<style>
	@keyframes rotating {
		100% {
...
</style>`,customElements.define(`cz-spinner`,p(ht))})),_t,vt,F=e((()=>{Qe(),h(),_t=D`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,customElements.define(`cosmoz-clear-button`,p(vt))})),I,yt,bt,xt,St,L,R=e((()=>{A(),I=({valuePath:e},t)=>k(t,e),yt=I,bt=I,xt=({valuePath:e},t)=>n=>{let r=k(n,e);return r==null?!1:r.toString().toLowerCase().trim().includes(t.toLowerCase().trim())},St=(e,t)=>t===``||t==null?null:t,L=e=>class extends e{static get properties(){return{isOmnitableColumn:{type:Boolean,value:!0},title:{type:String},valuePath:{type:String,notify:!0},values:{type:Array,notify:!0},filter:{type:Object},noLocalFilter:{type:Boolean},disabled:{type:Boolean,value:!1,notify:!0},editable:{type:Boolean,notify:!0},loading:{type:Boolean,value:!1,notify:!0},externalValues:{type:Boolean,value:!1,notify:!0},name:{type:String},sortOn:{type:String},groupOn:{type:String},noSort:{type:Boolean,value:!1},disabledFiltering:{type:Boolean,value:!1},width:{type:String,value:`75px`},minWidth:{type:String,value:`40px`},flex:{type:String,value:`1`},cellClass:{type:String,value:`default-cell`},headerCellClass:{type:String,value:`default-header-cell`},priority:{type:Number,value:0},hidden:{type:Boolean,notify:!0},preferredDropdownHorizontalAlign:{type:String,value:`right`},renderHeader:{type:Function},renderCell:{type:Function},renderEditCell:{type:Function},renderGroup:{type:Function},mini:{type:Number,value:null},renderMini:{type:Function}}}static get observers(){return[`notifyFilterChange(filter)`]}notifyFilterChange(e){this.__ownChange||this.dispatchEvent(new CustomEvent(`legacy-filter-changed`,{detail:{name:this.name,state:this.legacyFilterToState(e)},bubbles:!0}))}legacyFilterToState(e){return{filter:e}}getFilterFn(){}getString(e,t){return I(e,t)}toXlsxValue(e,t){return yt(e,t)}cellTitleFn(e,t){return this.getString(e,t)}headerTitleFn(e){return e.title}serializeFilter(e,t){return St(e,t)}deserializeFilter(e,t){return t==null?null:typeof t==`string`?window.decodeURIComponent(t):t}getComparableValue(e,t){return bt(e,t)}computeSource(e,t){return t}_propertiesChanged(e,t,n){super._propertiesChanged(e,t,n),this.dispatchEvent(new CustomEvent(`cosmoz-column-prop-changed`,{bubbles:!0}))}}})),Ct,wt,Tt,Et,Dt,Ot,kt,At=e((()=>{c(),F(),M(),n(),y(),R(),Ct=e=>t=>e(n=>{if(n.inputValue===void 0&&t.target.value===``)return n;clearTimeout(n.t);let r=setTimeout(()=>e(e=>({...e,filter:e.inputValue})),1e3);return{...n,inputValue:t.target.value,t:r}}),wt=e=>()=>e(e=>({...e,filter:e.inputValue})),Tt=e=>t=>{t.keyCode===13&&(t.preventDefault(),e(e=>({...e,filter:e.inputValue})))},Et=e=>t=>e(e=>({...e,headerFocused:t.detail.value})),Dt=e=>()=>e(e=>({...e,filter:null,inputValue:null})),Ot=e=>e!=null&&e!==``,kt=class extends L(O){static get properties(){return{minWidth:{type:String,value:`55px`},editMinWidth:{type:String,value:`55px`},inputValue:{type:Object,notify:!0}}}getFilterFn(e,t){if(!(t==null||t===``))return xt(e,t)}renderCell(e,{item:t}){return i`<span class="default-column">${I(e,t)}</span>`}renderEditCell(e,{item:t},n){return i`<cosmoz-input
		...
		>
			${E(!e.disabledFiltering,()=>i`<cosmoz-clear-button
						...
						@click=${Dt(a)}
					></cosmoz-clear-button>`)}
		</cosmoz-input>`}legacyFilterToState(e){return{filter:e,inputValue:e}}},customElements.define(`cosmoz-omnitable-column`,kt)})),jt,Mt,Nt,z=e((()=>{c(),h(),n(),jt=[`label`,`value`,`slot`,`always-float-label`,`disabled`],Mt=oe`
	${ie}
...
`,Nt=e=>{let{label:t,value:n,slot:r}=e;return et(i`<div
	...
	>
		${n||``}
	</div>`,{label:t})},customElements.define(`cosmoz-omnitable-dropdown-input`,p(Nt,{observedAttributes:jt,styleSheets:[Mt]}))})),B,Pt=e((()=>{ct(),n(),ae(),z(),B=({title:e,tooltip:t=``,filterText:n=``,onOpenedChanged:r,content:a,horizontalAlign:o=`left`,externalValues:s=null})=>i`
		<style>
			.dropdown {
				outline: none;
			}
	...
	`})),Ft,It,Lt=e((()=>{Le(),We(),g(),se(),Ft=e=>e?typeof e.close==`function`?e:Ft(e.parentElement):null,It=e=>class extends e{static get properties(){return{disabled:{type:Boolean,value:!1},filter:{type:Object,notify:!0},values:{type:Array,value(){return[]}},headerFocused:{type:Boolean,notify:!0},min:{type:Number,value:null},max:{type:Number,value:null},limits:{type:Function},autoupdate:{type:String,value:!0},locale:{type:String,value:null},_filterInput:{type:Object,value(){return{min:null,max:null}}},_range:{type:Object,computed:`_computeRange(values.*)`},_limit:{type:Object,computed:`_computeLimit(_range, _filterInput.*, min, max)`,value(){return{}}},_tooltip:{type:String,computed:`_computeTooltip(title, _filterText)`},_fromClasses:{type:String,computed:`_computeInputClasses(_filterInput.min)`},_toClasses:{type:String,computed:`_computeInputClasses(_filterInput.max)`}}}static get observers(){return[`_filterInputChanged(_filterInput.*, autoupdate)`,`_filterChanged(filter.*)`,`_updateLimits(limits, headerFocused)`]}disconnectedCallback(){this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),super.disconnectedCallback()}_computeInputClasses(e){return e!=null&&e!==``?`has-value`:``}toNumber(e,t,n){if(e==null||e===``)return;let r=typeof e==`number`?e:Number(e);if(Number.isNaN(r))return;if(n==null||t==null)return r;let i=this.toNumber(t);return i==null?r:n(r,i)}toValue(){return this.toNumber.apply(this,arguments)}getComparableValue(e,t){if(e==null)return;let n=e;return t!=null&&(n=this.get(t,e)),this.toValue(n)}renderValue(){}getInputString(e,t=this.valuePath){let n=this.toValue(this.get(t,e));return this._toInputString(n)}_computeRange(e){let t=e.base,n=Array.isArray(t)&&t.length&&t.map(e=>this.toValue(e)).filter(e=>e!=null);return!n||n.length<1?{min:null,max:null}:n.reduce((e,t)=>({min:this.toValue(t,e.min,Math.min),max:this.toValue(t,e.max,Math.max)}),{})}_computeLimit(e,t,n,r){if(!e)return;let i=t.base,a=this.toValue(n),o=this.toValue(r),s=a??this.toValue(e.min),c=o??this.toValue(e.max);return{fromMin:s,fromMax:this.toValue(c,this._fromInputString(i.max,`max`),Math.min),toMin:this.toValue(s,this._fromInputString(i.min,`min`),Math.max),toMax:c}}_computeFilterText(e){if(e.base==null)return;let t=e.base,n=this.toValue(t.min),r=this.toValue(t.max),i=[];return n!=null&&i.push(this.renderValue(n)),i.push(` - `),r!=null&&i.push(this.renderValue(r)),i.length>1?i.join(``):void 0}_computeTooltip(e,t){return t==null?e:`${e}: ${t}`}_fromInputString(e){return this.toValue(e)}_toInputString(e){return this.toValue(e)??null}_getDefaultFilter(){return{min:null,max:null}}_filterInputChanged(e,t){this.__inputChangePath=e.path.split(`.`)[1]||null,t&&(this._limitInputDebouncer=le.debounce(this._limitInputDebouncer,ot.after(600),()=>{this._limitInput(),this._updateFilter()}),fe(this._limitInputDebouncer))}_clearFrom(){this.set(`_filterInput.min`,null),this._updateFilter()}_clearTo(){this.set(`_filterInput.max`,null),this._updateFilter()}_onBlur(){this._limitInput(),this._updateFilter()}_onKeyDown(e){let t=e.currentTarget,n=Array.from(t.parentElement.querySelectorAll(`cosmoz-input`)),r=n[n.findIndex(e=>e===t)+1],i=!r,a=n[0]===t;switch(e.keyCode){case 13:if(e.preventDefault(),!i)r.focus();else{let e=this._limitInput();this._updateFilter(),e||this._closeParent(t)}break;case 9:(i&&!e.shiftKey||a&&e.shiftKey)&&this._closeParent(t)}}_closeParent(e){let t=Ft(e);t&&t.close()}_onDropdownOpenedChanged({currentTarget:e,type:t,detail:n}){(t===`focus`||n?.value===!0)&&setTimeout(()=>{e.querySelector(`cosmoz-input:focus`)||e.querySelector(`cosmoz-input`)?.focus()},100)}_limitInput(){let e=this._filterInput,t=this.__inputChangePath,n=t?this._fromInputString(this.get(t,e),t):null;if(this.__inputChangePath=null,n==null)return!1;let r=this._limit,i=t===`min`?`from`:`to`,a=this.get(i+`Min`,r),o=this.get(i+`Max`,r),s=this.toValue(n,a,Math.max),c=this.toValue(s,o,Math.min);return this.getComparableValue(n)===this.getComparableValue(c)?!1:(this.set([`_filterInput`,t],this._toInputString(c,t)),this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),!0)}_updateFilter(){let e=this._filterInput,t=this.filter,n=this._fromInputString(e.min,`min`),r=this._fromInputString(e.max,`max`);this.getComparableValue(n)===this.getComparableValue(t,`min`)&&this.getComparableValue(r)===this.getComparableValue(t,`max`)||this.set(`filter`,{min:n,max:r})}_filterChanged(e){if(this._filterInput==null)return;let t=this._filterInput,n=e.base,r=this._fromInputString(t.min,`min`),i=this._fromInputString(t.max,`max`);this.getComparableValue(r)===this.getComparableValue(n,`min`)&&this.getComparableValue(i)===this.getComparableValue(n,`max`)||(this.set(`_filterInput`,{min:this._toInputString(n.min),max:this._toInputString(n.max)}),this._limitInputDebouncer&&this._limitInputDebouncer.cancel())}hasFilter(){let e=this.filter;return e==null?!1:this.toValue(e.min)!=null||this.toValue(e.max)!=null}resetFilter(){this.filter=this._getDefaultFilter()}_updateLimits(e,t){e&&Promise.resolve(Fe(e,{active:t})).then(e=>{let{min:t,max:n}=e??{};Object.assign(this,{...t==null?{}:{min:t},...n==null?{}:{max:n}})})}}})),V,Rt=e((()=>{M(),n(),V=e=>class extends e{static get template(){return nt`<div id="output" style="position:relative;"></div>`}connectedCallback(){super.connectedCallback(),r(this.render(),this.$.output)}_propertiesChanged(e,t,n){super._propertiesChanged(e,t,n),requestAnimationFrame(()=>r(this.render(),this.$.output))}}})),zt,Bt=e((()=>{c(),M(),C(),n(),y(),Pt(),z(),Lt(),Rt(),zt=class extends It(V(O)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:`_computeFilterText(filter.*, _formatters)`},headerFocused:{type:Boolean,value:!1}}}static get observers(){return[`_valuesChanged(autodetect, currency, values)`]}render(){let e=e=>{this.headerFocused=e.type===`focus`,this._onDropdownOpenedChanged(e)};return i`
		...
		>`}getComparableValue(e,t){return An(e,t)}getFilterFn(e,t){if(!(!t||!Array.isArray(t)||t.length===0))return jn(e,t)}},customElements.define(`cosmoz-omnitable-column-autocomplete-excluding`,Mn)})),Pn,Fn,In=e((()=>{st(),we(),M(),n(),y(),De(),dt(),kn(),R(),A(),dn(),Pn=({valuePath:e,textProperty:t,valueProperty:n},r)=>{let i=t?lt(t):w(n),a=N(e&&k(r,e)).map(i);return a.length>1?a.filter(Boolean).join(`,`):a[0]},Fn=class extends On(L(O)){static get properties(){return{headerCellClass:{type:String,value:`autocomplete-header-cell`},minWidth:{type:String,value:`55px`},editMinWidth:{type:String,value:`55px`},keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},showSingle:{type:Boolean},preserveOrder:{type:Boolean},limit:{type:Number},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,showSingle:e.showSingle,preserveOrder:e.preserveOrder,limit:e.limit,textual:e.textual}}renderCell(e,{item:t}){return i`<span class="default-column"
			>${e.getString(e,t)}</span
		>`}renderEditCell(e,{item:t},n){return i`<cosmoz-input
			no-label-float
			type="text"
		...
		>`}getComparableValue(e,t){return Pn(e,t)}},customElements.define(`cosmoz-omnitable-column-autocomplete`,Fn)})),Ln,Rn,zn,Bn,Vn,Hn,Un,Wn,Gn,Kn,qn,Jn,Yn,Xn,Zn=e((()=>{M(),R(),st(),Ve(),A(),n(),y(),Ln=(e,t)=>t.find(({value:t})=>e===t),Rn=(e,t,n)=>{let r=Ln(t,n);return r?r.text:e},zn=(e,t,n,r)=>Rn(e,k(t,n),r),Bn=({valuePath:e},t,n)=>Ln(k(t,e),n),Vn=e=>t=>{e(e=>({...e,filter:t?.[0]?.value??null}))},Hn=e=>t=>{e(e=>({...e,headerFocused:t}))},Un=e=>t=>{e(e=>({...e,query:t}))},Wn=e=>t=>e(t?.[0]?.value),Gn=({valuePath:e,trueLabel:t,falseLabel:n},r)=>k(r,e)?t:n,Kn=({valuePath:e},t)=>n=>k(n,e)===t,qn=o((e,t)=>[{text:e,value:!0},{text:t,value:!1}]),Jn=({valuePath:e,trueLabel:t,falseLabel:n},r)=>e?k(r,e)?t:n:``,Yn=(e,t)=>{try{return JSON.parse(t)}catch{return null}},Xn=class extends L(O){static get properties(){return{trueLabel:{type:String,value:`True`},falseLabel:{type:String,value:`False`},flex:{type:String,value:`0`},cellClass:{type:String,value:`boolean-cell`}}}getString(e,t){return Gn(e,t)}renderCell(e,{item:t}){return Gn(e,t)}renderEditCell(e,{item:t},n){let{trueLabel:r,falseLabel:a}=e;return i`<cosmoz-autocomplete
			no-label-float
			...
			${E(this.disabled,()=>i`
				...
				`,()=>i`
					...
					${B({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:i`
						...
						`})}
				`)}
		`}_fromInputString(e,t){let n=this.toDate(e);if(n!=null)return t===`min`&&n.setHours(0,0,0,0),t===`max`&&n.setHours(23,59,59),n}_filterInputChanged(e,t){let n=e.path.split(`.`)[1]&&e.value;if(n&&n.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}},customElements.define(`cosmoz-omnitable-date-range-input`,er)})),nr,rr,ir,J,Y,ar,or,sr,cr,lr,ur,dr,fr,pr,mr,hr=e((()=>{pe(),A(),qt(),nr=e=>{let t=-new Date(e).getTimezoneOffset()/60;return(t<0?`-`:`+`)+[`0`,Math.abs(t)].join(``).substr(-2)+`:00`},rr=e=>e.length===19?e+nr(e):e,ir=e=>{if(e==null||e===``)return;let t=e;return!(t instanceof Date)&&(typeof e==`string`&&(t=rr(t)),t=Ce(t),!t)||Number.isNaN(t.getTime())?null:t},J=({valuePath:e},t)=>{if(t==null)return;let n=t;e!=null&&(n=k(t,e));let r=ir(n);if(r!=null)return H(r.getTime())},Y=(e,t,n)=>{let r=ir(e);if(r==null)return null;if(n==null||t==null)return r;let i=Y(t);if(i==null)return r;let a=J({},r),o=J({},i);return a==null||o==null||n(a,o)===a?r:i},ar=(e,t)=>{if(t==null)return;let n=Y(e);if(n!=null)return t.format(n)},or={},sr=e=>{let t=e||``;return or[t]||(or[t]=new Intl.DateTimeFormat(e||void 0)),or[t]},cr=({valuePath:e,locale:t},n)=>{let r=k(n,e||``);return r===void 0?``:(r=Y(r),r===null?`Invalid Date`:ar(r,sr(t)))},lr=e=>{let t=Y(e);if(t==null)return null;let n=a(t);return n==null?null:n.slice(0,10)},ur=({valuePath:e},t)=>lr(k(t,e||``)),dr=(e,t)=>{let n=Y(e);if(n!=null)return t===`min`&&n.setHours(0,0,0,0),t===`max`&&n.setHours(23,59,59),n},fr=e=>lr(e)??``,pr=({valuePath:e},t)=>{if(!e)return``;let n=Y(k(t,e));if(!n)return``;let r=Y(a(n));return r?(r.setHours(0,0,0,0),r):``},mr=(e,t)=>n=>{let r=J(e,n);if(r==null)return!1;let i=J({...e,valuePath:`min`},t),a=J({...e,valuePath:`max`},t);return!(r<(i??-1/0)||r>(a??1/0))}})),gr,_r=e((()=>{c(),M(),n(),R(),tr(),q(),hr(),F(),gr=class extends L(O){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:`date-header-cell`},width:{type:String,value:`100px`},minWidth:{type:String,value:`82px`},flex:{type:String,value:`0`}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){let n=J({...e,valuePath:`min`},t),r=J({...e,valuePath:`max`},t);if(!(n==null&&r==null))return mr(e,t)}getString(e,t){return cr(e,t)}toXlsxValue(e,t){return pr(e,t)}getComparableValue(e,t){return J(e,t)}serializeFilter(e,t){if(t==null)return;let n=Y(t.min),r=Y(t.max);if(!(n==null&&r==null))return fr(n)+`~`+fr(r)}deserializeFilter(e,t){if(t==null||t===``)return null;let n=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(n)?{min:Y(n[1]),max:Y(n[2])}:null}renderCell(e,{item:t}){return i`<div class="omnitable-cell-date">
			${cr(e,t)}
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return pn(e,t)}},customElements.define(`cosmoz-omnitable-column-date`,gr)})),vr,yr=e((()=>{M(),C(),n(),y(),$n(),Pt(),z(),Rt(),vr=class extends Qn(V(O)){render(){let e=e=>{this.headerFocused=e.type===`focus`};return i`
			<style>
		...
		></cosmoz-omnitable-datetime-range-input>`}computeSource(e,t){return pn(e,t)}},customElements.define(Dr.is,Dr)})),kr,Ar=e((()=>{st(),we(),M(),n(),y(),kn(),R(),kr=class extends On(L(O)){renderCell({valuePath:e,textProperty:t},{item:n}){return i`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		`}renderEditCell(){return`not implemented`}renderHeader(e,{filter:t,query:n},r,a){return i`<cosmoz-autocomplete-ui
			...
			.onText=${Tn(r)}
			>${E(e.loading,()=>i`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}},customElements.define(`cosmoz-omnitable-column-list-horizontal`,kr)})),jr,Mr=e((()=>{Ge(),Qe(),M(),Ae(),window.Cosmoz=window.Cosmoz||{},jr=class extends Ie(re(Je,O)){static get template(){return nt`
			<style>
				:host {
					display: block;
				}
		...
		`}static get is(){return`cosmoz-omnitable-column-list-data`}static get properties(){return{items:{type:Array},_expanded:{type:Boolean,value:!1},_othersCount:{type:Number,computed:`_computeOthersCount(items)`}}}static get observers(){return[`_itemsLengthChanged(items.length)`]}_itemsLengthChanged(){requestAnimationFrame(()=>this.dispatchEvent(new CustomEvent(`expand`,{bubbles:!0})))}_firstItem(e){if(e!=null&&e.length>0)return e[0]}_hideExpand(e,t){return e!==void 0&&e.length!==null?e.length<=2||t:!0}_hideCollapse(e,t){return e!==void 0&&e.length!==null?e.length<=2||!t:!0}_otherItems(e,t){if(e!=null&&(e.length<=2||t))return e.slice(1)}_computeOthersCount(e){if(e!=null)return e.length-1}_toggleExpand(e){this._expanded=!this._expanded,e.stopPropagation(),e.preventDefault()}},customElements.define(jr.is,jr)})),Nr,Pr=e((()=>{Mr(),M(),n(),y(),st(),kn(),R(),dn(),Nr=class extends On(L(O)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:n}){return i`<cosmoz-omnitable-column-list-data
			.items=${yn(n,e,t)}
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:n},r,a){return i`<cosmoz-autocomplete-ui
			...
			.onText=${Tn(r)}
			>${E(e.loading,()=>i`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}},customElements.define(`cosmoz-omnitable-column-list`,Nr)})),Fr,Ir=e((()=>{c(),M(),C(),n(),y(),Pt(),z(),Lt(),Rt(),Fr=class extends It(V(O)){static get properties(){return{maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null},formatter:{type:Object,computed:`_computeFormatter(locale, minimumFractionDigits, maximumFractionDigits)`},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:`_computeFilterText(filter.*, formatter)`},headerFocused:{type:Boolean,value:!1}}}render(){let e=e=>{this.headerFocused=e.type===`focus`,this._onDropdownOpenedChanged(e)};return i`
			<style>
				cosmoz-input[type='number'] {
					background: var(--cosmoz-omnitable-amount-input-background, #ffffff);
					border-radius: 6px;
		...
		></cosmoz-omnitable-number-range-input>`}computeSource(e,t){return pn(e,t)}},customElements.define(`cosmoz-omnitable-column-number`,Lr)})),zr,Br=e((()=>{c(),M(),C(),n(),y(),$n(),Pt(),z(),Rt(),zr=class extends Qn(V(O)){render(){let e=e=>{this.headerFocused=e.type===`focus`};return i`
			${E(this.disabled,()=>i`
					<cosmoz-omnitable-dropdown-input
						disabled
						.label=${this.title}
				...
				`,()=>i`
					...
					${B({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:i`
						...
						`})}
				`)}
		`}get _fixedDate(){return`1970-01-01`}toDate(e,t,n){let r=typeof e==`string`&&e.length>3&&e.length<=9?this.getAbsoluteISOString(this._fixedDate+`T`+e):e;return super.toDate(r,t,n)}_toInputString(e){let t=this.toValue(e);return t==null?null:this._toLocalISOString(t).slice(11,19)}getComparableValue(e,t){if(e==null)return;let n=this._toInputString(t==null?e:this.get(t,e));if(n!=null&&(n=this.toValue(this.getAbsoluteISOString(this._fixedDate+`T`+n)),n!=null))return this.toNumber(n.getTime())}_timeValueChanged(e){let t=e.target.value,n=e.model.item,r=this.toDate(n.date),i=this.toDate(r==null?t:r.toISOString().slice(0,10)+`T`+t);i??(this.set(this.valuePath,i,n),this._fireItemChangeEvent(n,this.valuePath,r,(e=>e).bind(this)))}_computeFormatter(e){return new Intl.DateTimeFormat(e||void 0,{hour:`numeric`,minute:`numeric`,second:`numeric`})}},customElements.define(`cosmoz-omnitable-time-range-input`,zr)})),Vr,X,Hr,Ur,Wr,Gr,Kr,Z,qr,Jr,Yr,Xr=e((()=>{pe(),A(),hr(),qt(),Vr=`1970-01-01`,X=(e,t,n)=>Y(typeof e==`string`&&e.length>3&&e.length<=9?rr(Vr+`T`+e):e,t,n),Hr={},Ur=e=>{let t=e||``;return Hr[t]||(Hr[t]=new Intl.DateTimeFormat(e||void 0,{hour:`numeric`,minute:`numeric`,second:`numeric`})),Hr[t]},Wr=({valuePath:e,locale:t},n)=>{let r=X(k(n,e||``));return r===void 0?``:r===null?`Invalid Date`:ar(r,Ur(t))},Gr=(e,t)=>e.valuePath?Wr(e,t):``,Kr=e=>{let t=X(e);if(t==null)return null;let n=a(t);return n&&n.slice(11,19)},Z=({valuePath:e},t)=>{if(t==null)return;let n=Kr(e==null?t:k(t,e));if(n==null)return;let r=X(rr(Vr+`T`+n));return r==null?r:H(r.getTime())},qr=(e,t)=>n=>{let r=Z(e,n);if(r==null)return!1;let i=Z({...e,valuePath:`min`},t),a=Z({...e,valuePath:`max`},t);return i==null||a==null?!1:!(r<i||r>a)},Jr=e=>{let t=X(e);return t==null?``:t.toISOString().slice(11,19).replace(/:/gu,`.`)},Yr=e=>{if(!(e==null||e===``))return X(typeof e==`string`?e.replace(/\./gu,`:`)+`Z`:e)}})),Zr,Qr=e((()=>{c(),F(),M(),n(),R(),Br(),q(),Xr(),Zr=class extends L(O){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:`time-header-cell`},minWidth:{type:String,value:`63px`},width:{type:String,value:`210px`},flex:{type:String,value:`0`},filterStep:{type:String,value:`1`}}}getFilterFn(e,t){let n=Z({...e,valuePath:`min`},t),r=Z({...e,valuePath:`max`},t);if(!(n==null&&r==null))return qr(e,t)}getString(e,t){return Wr(e,t)}toXlsxValue(e,t){return Gr(e,t)}getComparableValue(e,t){return Z(e,t)}serializeFilter(e,t){if(t==null)return;let n=X(t.min),r=X(t.max);if(!(n==null&&r==null))return Jr(n)+`~`+Jr(r)}deserializeFilter(e,t){if(t==null||t===``)return null;let n=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(n)?{min:Yr(n[1]),max:Yr(n[2])}:null}renderCell(e,{item:t}){return Wr(e,t)}renderEditCell(e,{item:t},n){return i`<cosmoz-input
			no-label-float
			type="text"
			@change=${e=>n(e.target.value)}
			.value=${Wr(e,t)}
		></cosmoz-input>`}renderHeader({title:e,min:t,max:n,locale:r,filterStep:a,disabledFiltering:o},{filter:s},c,l){return i`<cosmoz-omnitable-time-range-input
			...
			@filter-changed=${({detail:{value:e}})=>c(t=>({...t,filter:e}))}
			@header-focused-changed=${({detail:{value:e}})=>c(t=>({...t,headerFocused:e}))}
		></cosmoz-omnitable-time-range-input>`}computeSource(e,t){return pn(e,t)}},customElements.define(`cosmoz-omnitable-column-time`,Zr)})),$r=e((()=>{gn(),Nn(),In(),Zn(),_r(),Or(),Ar(),Pr(),Rr(),Qr()})),ei,ti=e((()=>{h(),n(),ei=({column:e,item:n,selected:r,folded:i,group:a})=>e?(e.renderGroup??e.renderCell)(e,{item:n,selected:r,folded:i,group:a}):t,customElements.define(`cosmoz-omnitable-group-row`,p(ei,{useShadowDOM:!1}))})),ni,ri=e((()=>{h(),n(),ni=e=>{let{column:n}=e;return b(()=>{let t=0,r=0,i=i=>{e.dispatchEvent(new CustomEvent(`column-resize`,{bubbles:!0,composed:!0,detail:{newWidth:Math.ceil(r+i.pageX-t),column:n}}))},a=()=>{document.removeEventListener(`pointermove`,i),document.removeEventListener(`pointerup`,a)},o=n=>{t=n.pageX,r=e.previousElementSibling.getBoundingClientRect().width,document.addEventListener(`pointermove`,i),document.addEventListener(`pointerup`,a)};return e.addEventListener(`pointerdown`,o),()=>e.removeEventListener(`pointerdown`,o)},[n]),t},customElements.define(`cosmoz-omnitable-resize-nub`,p(ni))})),ii,ai,oi,si,ci=e((()=>{n(),ii=i`<svg
	width="10"
	height="9"
	viewBox="0 0 10 9"
	stroke="currentColor"
...
>
	...
	/>
</svg> `})),li,ui,di,fi,pi=e((()=>{h(),xe(),ci(),li=({column:e,on:t,descending:n,setOn:r,setDescending:a})=>{let{name:o,title:s}=e??{};return i`<button
		class="sg"
		title=${ee(s)}
	...
	>
		<span>${s}</span> ${si}
	</button>`},ui=({columns:e,...t})=>e?.map(e=>li({column:e,...t})),di=()=>i`
...
`}));function mi(e,t,{suffix:n=``,read:r,write:i,multi:a}={}){let o=Oe({param:t,suffix:n,link:a?vi:_i,write:i??Ke}),s=S(()=>{if(t==null)return!1;if(a){let e=at(t+n);return Object.keys(e).length>0}return je(t+n)!==void 0},[]),[c,l]=j(()=>{if(t==null)return e;if(a){let i=at(t+n,r);return Object.keys(i).length>0?i:e}return je(t+n,r)??e}),u=x(e=>l(t=>{let n=Fe(e,t);return o.param!=null&&Xe(o.link(o.param+o.suffix,n,o.write),null,{notify:!1}),n}),[]);return b(()=>{o.param==null||s||typeof e==`object`&&e&&Object.keys(e).length===0||e!=null&&u(e)},[s,...typeof e==`object`&&e?Object.values(e):[e]]),[c,u]}var hi,gi,_i,vi,yi=e((()=>{Ne(),Le(),pt(),Ue(),h(),hi=e=>(t,n,r=Ke)=>{let i=ke(),a=new URLSearchParams(i.hash.replace(`#`,``));return e(t,n,r,a),`#!`+Object.assign(i,{hash:a}).href.replace(location.origin,``)},gi=e=>e==null||e===``,_i=hi((e,t,n,r)=>gi(n(t))?r.delete(e):r.set(e,n(t))),vi=hi((e,t,n,r)=>{let i=Object.entries(t),a=i.map(n).filter(([,e])=>e!==void 0);if(a.length===0&&i.length>0)return;let o=e;Array.from(r.keys()).filter(e=>e.startsWith(o)).forEach(e=>r.delete(e)),a.forEach(([t,n])=>gi(n)?r.delete(e+t):r.set(e+t,n))})})),bi,xi,Si,Ci,wi,Ti=e((()=>{h(),yi(),bi=e=>[!0,`true`,1,`yes`,`on`].includes(e),xi=e=>e===``||(e==null?void 0:bi(e)),Si=(e,t,n)=>x(r=>{e(r),n(e=>({...e,[t]:r}))},[e,t,n]),Ci=(e,t,n,r,i)=>{let[a,o]=mi(n.sortOn,t,{suffix:`-sortOn`}),[s,c]=mi(xi(n.descending),t,{suffix:`-descending`,read:xi}),[l,u]=mi(n.groupOn,t,{suffix:`-groupOn`}),[d,f]=mi(xi(n.groupOnDescending),t,{suffix:`-groupOnDescending`,read:xi}),p=S(()=>e.find(e=>e.name===a),[e,a]),m=S(()=>e.find(e=>e.name===l),[e,l]),h={groupOn:l,setGroupOn:Si(u,`groupOn`,r),groupOnDescending:d,setGroupOnDescending:Si(f,`groupOnDescending`,r),sortOn:a,setSortOn:Si(o,`sortOn`,r),descending:s,setDescending:Si(c,`descending`,r),columns:e},g=S(()=>h,Object.values(h)),_=x(e=>{o(e.sortOn),u(e.groupOn),c(e.descending),f(e.groupOnDescending)},[]);return b(()=>void(i.current=_),[]),{...g,sortAndGroup:g,groupOnColumn:m,sortOnColumn:p}},wi=de(),customElements.define(`sort-and-group-provider`,wi.Provider),customElements.define(`sort-and-group-consumer`,p(({render:e})=>e(_(wi)),{useShadowDOM:!1}))})),Ei,Di,Oi=e((()=>{h(),ue(),ri(),pi(),y(),Ti(),Ei=({data:e,columns:t,groupOnColumn:n,filters:r,setFilterState:a,sortAndGroup:{sortOn:o,setSortOn:s,descending:c,setDescending:l}={}})=>f(t,e=>e.name,t=>[i`<div
			...
			>
				...
				.column="${t}"
				name="${t.name}"
			></cosmoz-omnitable-resize-nub>`]),Di=({columns:e,settingsConfig:t,hideSelectAll:n,...r})=>{let a=_(wi);return i`
		${E(e,e=>Ei({columns:e,sortAndGroup:a,...r}))}
		${E(!n,()=>i` <cosmoz-omnitable-settings
					.config=${t}
					part="settings"
				></cosmoz-omnitable-settings>`)}
	`},customElements.define(`cosmoz-omnitable-header-row`,p(Di,{useShadowDOM:!1}))})),ki,Ai,ji=e((()=>{h(),Qe(),ki=D`
	:host {
		display: flex;
		align-items: center;
		flex-wrap: wrap;
...
`,customElements.define(`cosmoz-omnitable-item-expand-line`,p(Ai,{styleSheets:[Se(ki)]}))})),Mi,Ni=e((()=>{h(),n(),Ye(),ji(),Mi=({columns:e,item:t,selected:n,expanded:r,groupOnColumn:a})=>tt(e,e=>i`<cosmoz-omnitable-item-expand-line
				.column=${e}
				?hidden=${e===a}
				exportparts="item-expand-label, item-expand-value"
				>${e.renderCell(e,{item:t,selected:n,expanded:r})}</cosmoz-omnitable-item-expand-line
			>`),customElements.define(`cosmoz-omnitable-item-expand`,p(Mi,{useShadowDOM:!1}))})),Pi,Fi,Ii=e((()=>{h(),ue(),Pi=(e,t,n)=>e.editable?e.renderEditCell(e,t,n(e,t.item)):e.renderCell(e,t),Fi=({columns:e,groupOnColumn:t,item:n,index:r,selected:a,expanded:o,onItemChange:s})=>f(e,e=>e.name,e=>i`<div
				...
				name="${e.name}"
			>
				${Pi(e,{item:n,index:r,selected:a,expanded:o},s)}
			</div>`),customElements.define(`cosmoz-omnitable-item-row`,p(Fi,{useShadowDOM:!1}))})),Li,Ri,zi=e((()=>{Qe(),Li=D`
	.checkbox {
		box-sizing: border-box;
		width: 18px;
		height: 18px;
...
`})),Bi,Vi,Hi=e((()=>{Re(),Bi=e=>{let t=e.replace(/"/gu,`""`);return t.search(/("|,|\n)/gu)>=0?`"`+t+`"`:e},Vi=(e,t,n)=>{let r=e.map(e=>Bi(e.title)).join(`;`)+`
`,i=t.map(t=>e.map(e=>{let n=e.getString(e,t);return n==null?``:Bi(String(n))}).join(`;`)+`
`);i.unshift(r),Ee(new File(i,n,{type:`text/csv;charset=utf-8`}))}})),Ui,Wi,Gi=e((()=>{Re(),qe(),Ui=(e,t)=>{let n=e.map(e=>e.title),r=t.map(t=>e.map(e=>e.toXlsxValue(e,t)??``));return r.unshift(n),r},Wi=(e,t,n,r)=>{let i=Ui(e,t),a=new $e(n).addSheetFromData(i,r).generate();Ee(new File([a],n,{type:`application/vnd.openxmlformats-officedocument.spreadsheetml.sheet`}))}})),Ki,qi=e((()=>{Me(),C(),n(),Hi(),Gi(),Ki=({columns:e,selectedItems:t,csvFilename:n,xlsxFilename:r,xlsxSheetname:a,topPlacement:o})=>i`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!it(t.length)}
		part="bottomBar"
	...
	</cosmoz-bottom-bar>`})),Ji,Yi=e((()=>{n(),y(),Ji=({allSelected:e,onAllCheckboxChange:t,sortAndGroup:n,dataIsValid:r,data:a,columns:o,filters:s,groupOnColumn:c,setFilterState:l,settingsConfig:u,hideSelectAll:d})=>i`<sort-and-group-provider .value=${n}>
	...
	</sort-and-group-provider>`})),Xi,Zi,Qi=e((()=>{h(),Xi=oe`
	:host {
		max-width: 100%;
		overflow-x: hidden;
		padding: 0 12px;
...
`,Zi=({settingsConfig:e})=>{let{columns:t,collapsed:n}=e,r=t.filter(e=>!n.some(t=>t.name===e.name));return i`<div class="skeleton">
...
`})),ia,aa,oa=e((()=>{h(),pt(),ia=e=>{let t=parseInt(e,10);return isFinite(t)?t:void 0},aa=e=>{let{config:t}=e,{settings:n,setSettings:r,collapsed:i}=t,a=Oe({collapsed:i,settings:n.columns,setSettings:x(e=>r(t=>({...t,columns:e})),[r])});return{...t,onDown:x(e=>{e.target.closest(`.pull`)&&(a.handle=e.currentTarget)},[a]),onDragStart:x(e=>{let{target:t}=e,n=ia(t.dataset.index);if(!a.handle?.contains(t)||n==null)return e.preventDefault();a.handle=null,e.dataTransfer.effectAllowed=`move`,e.dataTransfer.setData(`omnitable/sort-index`,n),e.dataTransfer.setData(`text/plain`,n),setTimeout(()=>t.classList.add(`drag`),0),t.addEventListener(`dragend`,e=>e.target.classList.remove(`drag`),{once:!0})},[a]),onDragEnter:x(e=>{let t=e.currentTarget;t===e.target&&(e.preventDefault(),e.dataTransfer.dropEffect=`move`,t.classList.add(`dragover`))},[]),onDragOver:x(e=>{e.preventDefault(),e.currentTarget.classList.add(`dragover`)},[]),onDragLeave:x(e=>{let t=e.currentTarget;t.contains(e.relatedTarget)||t.classList.remove(`dragover`)},[]),onDrop:x(e=>{let t=ia(e.dataTransfer.getData(`omnitable/sort-index`)),n=ia(e.currentTarget.dataset.index),{settings:r,setSettings:i}=a;e.currentTarget.classList.remove(`dragover`),e.preventDefault();let o=r.slice();o.splice(n+(t>=n?0:-1),0,o.splice(t,1)[0]),i(o)},[a]),onToggle:x(e=>{let{settings:t,setSettings:n}=a,r=t.map(e=>({...e,disabled:e.disabled||a.collapsed?.some(t=>t.name===e.name)})),i=ia(e.target.closest(`[data-index]`)?.dataset.index);r.splice(i,1,{...t[i],disabled:!e.target.checked,priority:e.target.checked?t.reduce((e,t)=>Math.max(e,t.priority),0)+1:t[i].priority}),n(r)},[a])}}})),sa,ca,la,ua,da=e((()=>{rt(),he(),Qe(),Me(),h(),C(),y(),ci(),pi(),ra(),oa(),sa=[d({apply({availableHeight:e,elements:t}){Object.assign(t.floating.style,{maxHeight:`${Math.max(0,e)}px`})}}),...ft],ca=({onDragStart:e,onDragEnter:t,onDragOver:n,onDragLeave:r,onDrop:a,onDown:o,onToggle:s,collapsed:c,filters:l})=>(u,d)=>{let f=!!c?.find(e=>e.name===u.name),p=!u.disabled&&!f;return i` <div
			class="item"
			data-index=${d}
			@mousedown=${o}
			draggable="true"
		...
		>
			...
			<input
				...
				.indeterminate=${f}
			/>
		</div>`},la=e=>{let{settings:t,settingsId:n,onSave:r,onReset:a,hasChanges:o,opened:s,setOpened:c,...l}=aa(e);return i` <div class="headline">
			${P(`Sort and filter`)}
			<button
				class="close"
		...
		${E(n,()=>i`<div class="buttons">
				...
				</div>`)}`},customElements.define(`cosmoz-omnitable-settings-ui`,p(la,{styleSheets:[Se(ta)]})),ua=({config:e,newLayout:t})=>i`
	<cosmoz-dropdown
...
`,customElements.define(`cosmoz-omnitable-settings`,p(ua,{styleSheets:[Se(na)]}))})),fa,pa,ma,ha,ga,_a=e((()=>{dt(),fa=[`sortOn`,`descending`,`groupOn`,`groupOnDescending`],pa=e=>t=>typeof t==`object`&&!!t&&`name`in t&&t.name===e,ma=(e=[],t=[],n=[])=>{let r=t.filter(t=>e.some(pa(t.name))),i=e.filter(e=>e.name!=null&&!t.some(pa(e.name))&&!n.some(pa(e.name))),a=n.filter(e=>!t.some(pa(e.name)));return[...r,...a.flatMap(t=>{let n=e.find(e=>e.name===t.name);return n?{...t,title:n.title??t.title??``,minWidth:parseInt(n.minWidth??`0`,10)}:[]}),...i.map(e=>{let{name:t,title:n,priority:r,minWidth:i,width:a,flex:o}=e;return{name:t??``,title:n??``,priority:r??0,minWidth:parseInt(i??`0`,10),width:parseInt(a??`0`,10),flex:parseInt(o??`0`,10)}})]},ha=(e,t)=>({...t,...u(Array.from(fa))(e),columns:e.columns?.map(u([`name`,`priority`,`width`,`flex`,`disabled`]))}),ga=({columns:e,settings:t,savedSettings:n,initial:r})=>({...Object.fromEntries(fa.flatMap(e=>r?.[e]==null?[]:[[e,r[e]]])),...n?u(Array.from(fa))(n):{},...t,columns:ma(e,t?.columns,n?.columns)})})),va,ya=e((()=>{va=({prefix:e=`omnitable-`}={})=>({write:async(t,n)=>{let r=e+t;try{n?localStorage.setItem(r,JSON.stringify(n)):localStorage.removeItem(r)}catch(e){console.error(e)}},read:async t=>{if(t)try{let n=localStorage.getItem(e+t);return n==null?void 0:JSON.parse(n)}catch(e){console.error(e)}}})})),ba,xa,Sa=e((()=>{h(),ya(),ba=de(va),xa=()=>{let e=_(ba);return S(()=>e(),[e])}})),Ca=e((()=>{Sa()})),wa,Ta=e((()=>{h(),_a(),Ca(),wa=(e,t,n,r)=>{let[i,a]=j(),{read:o,write:s}=xa();return b(async()=>{e&&a(await o(e))},[e,o]),{settingsId:e,savedSettings:i,onSave:x(async()=>{if(!e)return;let r=ha(t,i);await s(e,r),n(),a(r)},[t,i]),onReset:x(async t=>{n(),t.shiftKey&&(await s(e),a()),r?.()},[r]),hasChanges:t!=null}}})),Ea,Da=e((()=>{h(),dn(),_a(),Ta(),Ea=({settingsId:e,host:t})=>{let n=S(()=>Object.fromEntries(fa.map(e=>[e,t[e]])),[]),r=He(),i=x(()=>{r.current?.(n)},[n]),[a,o]=j(),[s,c]=j({columns:!0,sort:!0}),{savedSettings:l,...u}=wa(e,a,o,i),{enabledColumns:d,disabledFiltering:f}=t,p=un(t,{enabledColumns:d,disabledFiltering:f}),m=S(()=>ga({columns:p,settings:a,savedSettings:l,initial:n}),[p,a,l]),h=S(()=>m.columns.map(e=>p.find(t=>t.name===e.name)).filter(Boolean),[p,...m.columns.map(e=>e.name)]);return{...u,opened:s,setOpened:c,settings:m,columns:h,setSettings:o,resetRef:r}}})),Oa=e((()=>{da(),Da()})),ka,Aa,ja=e((()=>{ka=e=>Number.isFinite(e)?e:0,Aa=(e,t)=>{let n=[],[r,i]=e.reduce(([e,t],{width:n,flex:r})=>[e+n,t+r],[0,0]),a=t-r,o=ka(a/i),s=0,c=0,l=0;for(let t=0;t<e.length;t++){let{width:i,minWidth:u,flex:d}=e[t];if(u>i+(a>=0?o*d:i*a/r)){s+=i,c+=u,l+=d,n[t]=u;continue}if(d===0){s+=i,c+=i,n[t]=i;continue}}r-=s,a=t-c-r,i-=l,o=ka(a/i);for(let t=0;t<e.length;t++){if(n[t]!=null)continue;let{width:i,flex:s}=e[t];n[t]=i+(a>=0?o*s:i*a/r)}return n}})),Ma,Na,Pa=e((()=>{Ma=Symbol(`index`),Na=(e,t)=>{if(typeof e.findLastIndex==`function`)return e.findLastIndex(t);for(let n=e.length-1;n>=0;n--)if(t(e[n],n,e))return n;return-1}})),Fa,Ia,La,Ra=e((()=>{ja(),Pa(),Fa=(e,t)=>{let n=Na(e,e=>e!=null&&e>0),r=(e,t)=>`.cell[name="${e}"], cosmoz-omnitable-skeleton::part(cell-${e}){width: ${Math.floor(t)}px;padding: 0 min(3px, ${t/2}px)}`,i=e=>`cosmoz-omnitable-resize-nub[name="${e}"]{display:none}`,a=e=>`cosmoz-omnitable-resize-nub[name="${e}"], .cell[name="${e}"]{display:none}`;return t.map((t,o)=>{let s=e[o];if(s==null||s===0)return a(t.name);let c=r(t.name,s);return o===n?`${c}\n${i(t.name)}`:c}).join(`
`)},Ia=(e,t,n)=>{let r=e.filter(e=>!e.hidden),i=r.reduce((e,{width:t})=>e+t,0);if(r.length>1&&i>t)return Ia(r.slice(1),t,n);let a=r.reduce(([e,t],n,r)=>[Math.max(e,n.index),n.index>e?r:t],[-1,-1])[1];return a!==-1&&(r[a].flex=1),Aa(r,t).reduce((e,t,n)=>(e[r[n].index]=t,e),Array(n).fill(void 0))},La=(e,t)=>e.length===0?`.cell {display: none;}`:Fa(e,t)})),za,Ba=e((()=>{h(),za=({host:e,canvasWidth:t,layout:n,setSettings:r})=>{let i=He();i.current=e=>r(r=>{let i=r.columns,{detail:{newWidth:a,column:o}}=e,s=i.findIndex(e=>e.name===o.name),c=[],l=i.reduce((e,t)=>Math.max(e,t.priority),-1/0);for(let e=0;e<n.length;e++)if(c[e]={...i[e]},e<s&&n[e]&&(c[e].width=n[e],c[e].flex=0,c[e].priority=l),e===s){let r=n.reduce((e,t,n)=>n<s&&t?e-t:e,t);c[e].width=Math.min(r,Math.max(a,i[e].minWidth)),c[e].flex=0,c[e].priority=l}return{...r,columns:c}}),b(()=>{let t=e=>i.current?.(e);return e.addEventListener(`column-resize`,t),()=>e.removeEventListener(`column-resize`,t)},[])}})),Va,Ha,Ua=e((()=>{h(),Va=88,Ha=(e,t)=>b(()=>{let n=new ResizeObserver(([e])=>{e.contentRect?.width!==0&&requestAnimationFrame(()=>t(e.contentRect?.width-Va))});return n.observe(e),()=>n.unobserve(e)},[])})),Wa,Ga=e((()=>{h(),Ua(),Wa=e=>{let[t,n]=j(()=>e.getBoundingClientRect().width-Va);return Ha(e,n),t}})),Ka,qa,Ja,Ya=e((()=>{h(),pt(),Le(),Ka=(e,t)=>{let n=S(()=>{let t=!1,n,r=()=>{t&&(n=requestAnimationFrame(r),e()&&(t=!1))};return{start:()=>{t=!0,cancelAnimationFrame(n),n=requestAnimationFrame(r)},stop:()=>{t=!1,cancelAnimationFrame(n)}}},[]);b(()=>{n.start()},t),b(()=>()=>n.stop(),[])},qa=(e=0,t=0)=>Math.abs(e-t)<.1,Ja=(e,t=1.9,n=Te)=>{let r=Oe({target:e});Ka(x(()=>{if(!r.tween)return r.tween=r.target,n(r.tween),!0;if(r.target.every((e,t)=>r.tween[t]===e))return n(r.tween),!0;r.tween=r.target.map((e,n)=>qa(r.tween[n],e)?e:(r.tween[n]??0)+((e??0)-(r.tween[n]??0))/t||0),n(r.tween)},[]),[e])}})),Xa,Za=e((()=>{h(),Ra(),Xa=({canvasWidth:e,groupOnColumn:t,config:n,miniColumn:r})=>S(()=>{if(!Array.isArray(n)||e==null||e===0)return[];let i=n.map((e,n)=>({minWidth:e.minWidth,width:e.width,flex:e.flex,priority:e.priority,name:e.name,index:n,hidden:e.name===t?.name||e.disabled})).map(e=>r?{...e,hidden:r.name!==e.name}:e).sort(({index:e,priority:t},{index:n,priority:r})=>t===r?n-e:t-r);return Ia(i,e,i.length)},[e,t,n])})),Qa,$a=e((()=>{h(),Qa=({host:e,canvasWidth:t,columns:n})=>{let r=e.miniBreakpoint??480,i=S(()=>t<=r,[t,r]),[a,...o]=S(()=>i?n?.filter(e=>e.mini!=null).sort((e,t)=>(e.mini??0)-(t.mini??0)):[],[n,i])??[],s=!!a;return b(()=>{e.toggleAttribute(`mini`,s)},[s]),{isMini:s&&i,miniColumn:a,miniColumns:o}}})),eo,to,no=e((()=>{h(),Ra(),Ba(),Ga(),Ya(),Za(),$a(),pt(),eo=e=>{let t=S(()=>new CSSStyleSheet,[]);return b(()=>{e.shadowRoot.adoptedStyleSheets=[...e.shadowRoot.adoptedStyleSheets,t]},[]),t},to=({host:e,columns:t,settings:n,setSettings:r,resizeSpeedFactor:i,sortAndGroupOptions:a})=>{let o=Wa(e),{isMini:s,miniColumn:c,miniColumns:l}=Qa({host:e,canvasWidth:o,columns:t}),{groupOnColumn:u}=a,d=Xa({canvasWidth:o,groupOnColumn:u,miniColumn:c,config:n.columns}),f=eo(e),p=S(()=>n.columns.reduce((e,n,r)=>d[r]!=null||n.name===u?.name||n.disabled?e:[...e,t.find(e=>e.name===n.name)],[]),[t,n,d]),m=Oe({columns:n.columns});return Ja(d,i,e=>{let t=La(e,m.columns);f.replace(t)}),za({host:e,canvasWidth:o,layout:d,setSettings:e=>r(e(n))}),{isMini:s,collapsedColumns:p,miniColumns:l}}})),ro,io=e((()=>{ro=({host:e,...t})=>{let{csvFilename:n=`omnitable.csv`,xlsxFilename:r=`omnitable.xlsx`,xlsxSheetname:i=`Omnitable`,topPlacement:a=`top-end`}=e;return{csvFilename:n,xlsxFilename:r,xlsxSheetname:i,topPlacement:a,...t}}})),ao,oo=e((()=>{h(),ao=({host:e,selectedItems:t,data:n,sortAndGroupOptions:r,collapsedColumns:i,settings:a,filterFunctions:o,settingS:s,filters:c,...l})=>{let u=n&&n.length>0&&t.length===n.length,d=t=>{t.target.checked?e.shadowRoot.querySelector(`#groupedList`).selectAll():e.shadowRoot.querySelector(`#groupedList`).deselectAll()},{groupOnColumn:f}=r,p=S(()=>[f,...i,...a.columns.filter(e=>e.disabled)].some(e=>e&&Object.keys(o).includes(e.name)),[o,a,i]),m=S(()=>({...s,collapsed:i,badge:p,filters:c}),[s,i,p,c]);return b(()=>{let t=e.shadowRoot.querySelector(`#tableContent`),n=new ResizeObserver(t=>requestAnimationFrame(()=>{e.style.setProperty(`--ot-height`,t[0]?.contentRect.height+`px`)}));return n.observe(t),()=>n.unobserve(t)},[]),{allSelected:u,onAllCheckboxChange:d,data:n,settingsConfig:m,filters:c,groupOnColumn:f,sortAndGroup:r.sortAndGroup,...l}}})),so,co,lo,uo,fo,po,mo=e((()=>{h(),y(),Me(),Pa(),q(),so=i`
	<svg
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
...
`,co=e=>e?`groupRow groupRow-folded`:`groupRow`,lo=({item:e,index:t})=>n=>E(n?.length>0,()=>i`
			...
			`),uo=({columns:e,collapsedColumns:t,miniColumns:n,onItemClick:r,onCheckboxChange:a,dataIsValid:o,groupOnColumn:s,onItemChange:c,rowPartFn:l})=>(u,d,{selected:f,expanded:p,toggleCollapse:m})=>i`
		<div
			?selected=${f}
	...
	`,fo=({onCheckboxChange:e,dataIsValid:t,groupOnColumn:n})=>(r,a,{selected:o,folded:s,toggleFold:c})=>i` <div
			class="${co(s)}"
		...
		</div>`,po=({host:e,error:t,dataIsValid:n,processedItems:r,columns:i,collapsedColumns:a,miniColumns:o,sortAndGroupOptions:s,rowPartFn:c,...l})=>{let{loading:u=!1,displayEmptyGroups:d=!1,compareItemsFn:f}=e,p=He({shiftKey:!1,ctrlKey:!1}),m=x(t=>{let n=t.target.dataItem,r=t.target.checked;p.current.shiftKey?e.shadowRoot.querySelector(`#groupedList`).toggleSelectTo(n,r):p.current.ctrlKey?(t.target.checked=!0,e.shadowRoot.querySelector(`#groupedList`).selectOnly(n)):e.shadowRoot.querySelector(`#groupedList`).toggleSelect(n,r),t.preventDefault(),t.stopPropagation()},[]);b(()=>{let e=({shiftKey:e,ctrlKey:t})=>{p.current={shiftKey:e,ctrlKey:t}};return window.addEventListener(`keydown`,e),window.addEventListener(`keyup`,e),()=>{window.removeEventListener(`keydown`,e),window.removeEventListener(`keyup`,e)}},[]);let h=x(t=>{let n=t.composedPath();n.slice(0,n.indexOf(t.currentTarget)).find(e=>e.matches?.(`a, .checkbox, .expand`))||e.dispatchEvent(new window.CustomEvent(`omnitable-item-click`,{bubbles:!0,composed:!0,detail:{item:t.currentTarget.dataItem,index:t.currentTarget.dataIndex}}))},[]),{groupOnColumn:g}=s,_=x((t,n)=>r=>mn(e,t,n,r),[]);return{...l,processedItems:r,dataIsValid:n,filterIsTooStrict:n&&r.length<1,loading:u,compareItemsFn:f,displayEmptyGroups:d,error:t,renderItem:S(()=>uo({columns:i,collapsedColumns:a,miniColumns:o,onItemClick:h,onCheckboxChange:m,dataIsValid:n,groupOnColumn:g,onItemChange:_,rowPartFn:c}),[i,a,h,m,n,g,_,c]),renderGroup:S(()=>fo({onCheckboxChange:m,dataIsValid:n,groupOnColumn:g}),[m,n,g])}}})),ho,go=e((()=>{ho=(e,t)=>{if(e===t)return 0;if(e==null)return-1;if(t==null)return 1;let n=typeof e,r=typeof t;return n===`object`&&r===`object`?e.toString()<t.toString()?-1:1:n===`number`&&r===`number`?e-t:n===`string`&&r===`string`?e<t?-1:1:n===`boolean`&&r===`boolean`?e?-1:1:(console.warn(`unsupported sort`,n,e,r,t),0)}})),_o,vo,yo,bo,xo,So,Co=e((()=>{h(),Le(),go(),dn(),yi(),Pa(),_o=(e,t)=>(n,r)=>ho(e(n),e(r))*(t?-1:1),vo=e=>e.replace(/([a-z0-9])([A-Z])/gu,`$1-$2`).toLowerCase(),yo=(e,t)=>{!e||!t||Object.entries(t).forEach(([t,n])=>{e[K].__ownChange=!0,e[K][t]=n,e[K].__ownChange=!1,e[K].dispatchEvent(new CustomEvent(`${vo(t)}-changed`,{bubbles:!0,detail:{value:n}}))})},bo=(e,t)=>Object.assign(e,{[Ma]:t}),xo=Symbol(`unparsed`),So=({data:e,columns:t,hashParam:n,sortAndGroupOptions:r,noLocalSort:i,noLocalFilter:a})=>{let{groupOnColumn:o,groupOnDescending:s,sortOnColumn:c,descending:l}=r,u=x(([e,n])=>{let r=t.find(({name:t})=>t===e);return r==null?[e,void 0]:[e,n.filter&&r.serializeFilter(r,n.filter)]},[t]),d=x(([e,n])=>{let r=t.find(({name:t})=>t===e);if(r==null)return[e,{[xo]:n}];let i={filter:r.deserializeFilter(r,n)};return yo(r,i),[e,i]},[t]),[f,p]=mi({},n,{multi:!0,suffix:`-filter--`,write:u,read:d}),m=x((e,n)=>p(r=>{let i=Fe(n,r[e]);return yo(t.find(t=>t.name===e),i),{...r,[e]:{...r[e],...i}}}),[t,p]),h=S(()=>Object.fromEntries(t.map(e=>[e.name,!e.noLocalFilter&&e.getFilterFn(e,f[e.name]?.filter)]).filter(([,e])=>!!e)),[t,...S(()=>Object.values(f).map(e=>e.filter),[f])]),g=S(()=>!Array.isArray(e)||e.length===0?[]:Object.entries(h).length===0||a?e.slice():e.filter(e=>Object.values(h).every(t=>t(e))),[e,h,a]),_=S(()=>{if(!i&&!o&&c!=null&&c.sortOn!=null)return g.slice().sort(_o(e=>c.getComparableValue({...c,valuePath:c.sortOn},e),l));if(o!=null&&o.groupOn!=null){let e=g.reduce((e,t)=>{let n=o.getComparableValue({...o,valuePath:o.groupOn},t);if(n===void 0)return e;let r=e.find(e=>e.id===n);return r?(r.items.push(t),e):(r={id:n,name:n,items:[t]},[...e,r])},[]);return e.sort(_o(e=>o.getComparableValue({...o,valuePath:o.groupOn},e.items[0]),s)),!c||i?e:e.filter(e=>Array.isArray(e.items)).map(e=>(e.items.sort(_o(e=>c.getComparableValue({...c,valuePath:c.sortOn},e),l)),e))}return g},[g,o,s,c,l,i]),v=S(()=>{let e=0,t=0,n=[];return _.forEach(r=>{if(Array.isArray(r.items)){bo(r,t++),r.items.forEach(t=>{bo(t,e++),n.push(t)});return}return bo(r,e++),n.push(r)},[]),n},[_]);return b(()=>{p(e=>Object.values(e).some(e=>e[xo]!=null)?Object.fromEntries(Object.entries(e).map(([e,t])=>t[xo]==null?[e,t]:d([e,t[xo]]))):e)},[d]),{processedItems:_,visibleData:v,filters:f,filterFunctions:h,setFilterState:m}}})),wo,To,Eo=e((()=>{be(),h(),ve(),wo=e=>{let t=t=>{let n=e.data.indexOf(t);if(n<0)return null;let r=e.data.splice(n,1);if(e.data=e.data.slice(),Array.isArray(r)&&r.length>0)return r[0]},n=(t,n)=>{e.data.splice(t,1,n),e.data=e.data.slice()};return{removeItem:t,removeItems(t){let n=[];for(let r=t.length-1;r>=0;--r){let i=e.removeItem(t[r]);i!=null&&n.push(i)}return n},replaceItemAtIndex:n,replaceItem(t,r){let i=e.data.indexOf(t);if(i>-1)return n(i,r)},selectItem(t){e.shadowRoot.querySelector(`#groupedList`).select(t)},selectAll(){e.shadowRoot.querySelector(`#groupedList`).selectAll()},deselectAll(){e.shadowRoot.querySelector(`#groupedList`).deselectAll()},deselectItem(t){e.shadowRoot.querySelector(`#groupedList`).deselect(t)},isItemSelected(t){return e.shadowRoot.querySelector(`#groupedList`).isItemSelected(t)}}},To=({host:e,visibleData:t,filters:n,...r})=>{let{setFilterState:i}=r,a=S(()=>wo(e),[]);v(r,Object.values(r)),v(a,Object.values(a)),b(()=>{let t=e=>i(e.detail.name,t=>({...t,...e.detail.state}));return e.addEventListener(`legacy-filter-changed`,t),()=>e.removeEventListener(`legacy-filter-changed`,t)},[]),T(`visibleData`,t),T(`sortedFilteredGroupedItems`,r.sortedFilteredGroupedItems),T(`selectedItems`,r.selectedItems),T(`sortOn`,r.sortOn),T(`descending`,r.descending),T(`isMini`,r.isMini);let o=S(()=>Object.fromEntries(Object.entries(n).filter(([,{filter:e}])=>e!==void 0).map(([e,{filter:t}])=>[e,t])),[n]);T(`filters`,o,Object.values(o))}})),Do,Oo=e((()=>{h(),Oa(),no(),io(),oo(),mo(),Co(),Eo(),Ti(),Do=e=>{let{hashParam:t,settingsId:n,data:r,resizeSpeedFactor:i,noLocal:a,noLocalSort:o=a,noLocalFilter:s=a,error:c,rowPartFn:l}=e,u=Ea({settingsId:n,host:e}),{settings:d,setSettings:f,columns:p,resetRef:m}=u,h=Ci(p,t,d,f,m),{processedItems:g,visibleData:_,filters:v,setFilterState:ee,filterFunctions:te}=So({data:r,columns:p,hashParam:t,sortAndGroupOptions:h,noLocalSort:o,noLocalFilter:s}),{isMini:y,collapsedColumns:ne,miniColumns:b}=to({host:e,columns:p,settings:d,setSettings:f,resizeSpeedFactor:i,sortAndGroupOptions:h}),re=r&&Array.isArray(r)&&r.length>0,[ie,ae]=j([]);return To({host:e,visibleData:_,sortedFilteredGroupedItems:g,columns:p,filters:v,setFilterState:ee,selectedItems:ie,isMini:y,...h}),{header:ao({host:e,selectedItems:ie,sortAndGroupOptions:h,dataIsValid:re,data:r,columns:p,filters:v,collapsedColumns:ne,settings:d,filterFunctions:te,settingS:u,setFilterState:ee,hideSelectAll:e.hideSelectAll===!0}),list:po({host:e,error:c,dataIsValid:re,processedItems:g,setSelectedItems:ae,columns:p,collapsedColumns:ne,miniColumns:b,sortAndGroupOptions:h,rowPartFn:l}),footer:ro({host:e,selectedItems:ie,columns:p})}}})),ko=e((()=>{n(),customElements.define(`cosmoz-grouped-list-row`,class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||r(this._renderFn(this._item,this._index),this)}})})),Ao,jo,Mo,No,Po,Fo,Io,Lo,Ro,zo=e((()=>{Ao={group:Symbol(`group`)},jo=(e,t)=>(t.has(e)||t.set(e,{}),t.get(e)),Mo=(e,t)=>!!jo(e,t).expanded,No=(e,t)=>!!jo(e,t).folded,Po=e=>e?e.items instanceof Array:!1,Fo=e=>{if(!Array.isArray(e)||e.length===0)return;let t=Array.isArray(e[0]?.items);if(!e.every(e=>Array.isArray(e.items)===t))throw Error(`Data must be homogeneous.`)},Io=(e,t,n)=>{if(Array.isArray(e))return Fo(e),e.reduce((e,r)=>{let i=r;return i.items?i.items.length?jo(r,n).folded?e.concat(r):e.concat(r,i.items.map(e=>Object.assign(e,{[Ao.group]:r}))):t?e.concat(r):e:e.concat(r)},[])},Lo=(e,...t)=>typeof e==`function`?e(...t):e,Ro=(e,t)=>e===t})),Bo,Vo=e((()=>{h(),zo(),Bo=()=>{let[e,t]=j(()=>[new WeakMap]);return{setItemState:x((e,n)=>t(([t])=>{let r=jo(e,t);return Object.assign(r,Lo(n,r)),[t]}),[]),state:e[0],signal:e}}})),Ho,Uo=e((()=>{h(),Vo(),zo(),Ho=()=>{let{setItemState:e,state:t,signal:n}=Bo();return{state:t,signal:n,toggleFold:x((t,n)=>{Po(t)&&e(t,e=>({folded:n===void 0?!e.folded:n}))},[]),toggleCollapse:x((t,n)=>{Po(t)||e(t,e=>({expanded:n===void 0?!e.expanded:!n}))},[])}}})),Wo,Go=e((()=>{h(),zo(),Wo=({initial:e,compareItemsFn:t,data:n,flatData:r})=>{let[i,a]=j(e),[o,s]=j(),c=x(e=>i.includes(e),[i]),l=x(e=>e?.items?.every(c)??!1,[c]),u=x(e=>c(e)||l(e),[c,l]),d=x(e=>{let t=e.items??[e];a(e=>[...e,...t.filter(t=>!e.includes(t))]),s(e)},[]),f=x(e=>{let t=e.items??[e];a(e=>e.filter(e=>!t.includes(e))),s(e)},[]),p=x(e=>{a(e.items?.slice()||[e]),s(e)},[]),m=x(()=>{a(n.flatMap(e=>e.items||e)),s(void 0)},[n]),h=x(()=>{a([]),s(void 0)},[]),g=x((e,t=!u(e))=>t?d(e):f(e),[u]),_=x((e,n)=>{if(!r)return;let i=o?r.findIndex(e=>t(e,o)):-1;if(i<0)return g(e,n);let[a,c]=[i,r.indexOf(e)].sort((e,t)=>e-t);r.slice(a,c+1).forEach((e,t,r)=>{t>0&&t<r.length-1&&Po(e)||g(e,n)}),s(e)},[r,t,g]);return b(()=>a(e=>e.length>0&&r?r.filter(n=>e.find(e=>t(n,e))):e),[r]),{selectedItems:i,isItemSelected:c,isGroupSelected:l,isSelected:u,select:d,deselect:f,selectOnly:p,selectAll:m,deselectAll:h,toggleSelect:g,toggleSelectTo:_}}})),Ko,qo,Jo,Yo=e((()=>{be(),ve(),h(),n(),ko(),Uo(),Go(),zo(),ge(),Ko={host:{position:`relative`,display:`flex`,flexDirection:`column`}},qo=e=>{let{data:t,renderItem:n,renderGroup:r,displayEmptyGroups:i,compareItemsFn:a=Ro}=e,{toggleFold:o,toggleCollapse:s,state:c,signal:l}=Ho(),u=S(()=>Io(t,i,c),[t,i,l]),{selectedItems:d,isItemSelected:f,isGroupSelected:p,isSelected:m,select:h,deselect:g,selectOnly:_,selectAll:ee,deselectAll:te,toggleSelect:y,toggleSelectTo:ne}=Wo({initial:[],compareItemsFn:a,data:t,flatData:u}),b=x((e,t)=>Array.isArray(e.items)?r(e,t,{selected:p(e),folded:No(e,c),toggleSelect:t=>y(e,typeof t==`boolean`?t:void 0),toggleFold:()=>o(e)}):n(e,t,{selected:d.includes(e),expanded:Mo(e,c),toggleSelect:t=>y(e,typeof t==`boolean`?t:void 0),toggleCollapse:()=>s(e)}),[n,r,d,y,l]);ce(()=>{Object.assign(e.style,Ko.host)},[]),T(`selectedItems`,d);let re={toggleFold:o,toggleCollapse:s,isItemSelected:f,isGroupSelected:p,isSelected:m,select:h,deselect:g,selectOnly:_,selectAll:ee,deselectAll:te,toggleSelect:y,toggleSelectTo:ne};return v(re,Object.values(re)),{renderRow:b,flatData:u}},Jo=({renderRow:e,flatData:t})=>m({items:t,renderItem:(t,n)=>i`<cosmoz-grouped-list-row
				.item=${t}
				.index=${n}
				.renderFn=${e}
			></cosmoz-grouped-list-row>`})})),Xo,Zo=e((()=>{Yo(),h(),Xo=e=>Jo(qo(e)),customElements.define(`cosmoz-grouped-list`,p(Xo,{useShadowDOM:!1}))})),Qo=e((()=>{Zo()})),$o,es,ts,ns=e((()=>{ze(),At(),$r(),ti(),Oi(),Ni(),Ii(),ve(),h(),Ae(),n(),_e(),zi(),qi(),Yi(),ea(),Oo(),Qo(),$o=e=>window.ShadyCSS?.ApplyShim?.transformCssText?.(e)||e,es=e=>{let{header:t,list:n,footer:r}=Do(e);return i`
		<style>
			${ut([],()=>$o(Ri))}
		</style>
...
`,i(Object.assign([ts],{raw:[ts]})),nt(Object.assign([ts],{raw:[ts]}))})),rs,Q,is,as,os,ss=e((()=>{rs=(e,t,n)=>{let r=String(e),i=-1,a=!n&&n!==0?` `:n,o=t-r.length;for(;++i<o;)r=a+r;return r},Q=(e,t)=>Math.floor(Math.random()*(t-e+1))+e,is=()=>`2015-`+rs(Q(1,12),2,`0`)+`-`+rs(Q(1,28),2,`0`),as=()=>{let e=Q(0,20);return e===1?new Date(2015,3,2,14,26,10,299):e===2?new Date(2016,4,2,10,9,10,444):e===3?new Date(2016,4,2,10,9,10,443):e===4?new Date(2016,4,2,10,9,10,442):new Date(Q(2014,2017),Q(1,12),Q(1,28),Q(0,23),Q(0,59),Q(0,59),Q(0,999))},os=(e,t,n)=>{let r=Q(e,t),i=[],a=[`Lorem ipsum dolor sit amet`,`Nunc tristique`,`Curabitur vestibulum`,`Cras laoreet`,`Himenaeos`,`maximus diam purus at mauris`],o=[`SEK`,`USD`,`EUR`,`AUD`],s=0;for(let e=0;e<r;e+=1){let t=`Group `+e,r=e*2+1;for(let e=0;e<r;e+=1){let r=[],c=[],l=[],u=s%10;for(let e=0;e<u;e+=1)r.push(`Item `+e),c.push({name:`Item `+e,value:`item-value-`+e}),l.push({value:`cat-`+e,label:`Category `+e});i.push({id:s,name:t+` item `+e,value:Q(0,1e4),bool:Q(0,100)>50,object:{value:Q(0,1e4),label:`Random string `+Q(1,n)},sub:{subProp:a[s%a.length]},randomString:`Random string `+Q(1,n),randomString2:`Random string 2 `+Q(1,n),randomString3:`Random string 3 `+Q(1,n),randomString4:`Random string 4 `+Q(1,n),date:as(),dateJSON:is(),amount:{amount:Q(10,100),currency:o[s%o.length]},group:t,list:r,objectList:c,categories:s%7==0?null:l}),s+=1}}return i}})),cs,ls,us,$,ds;e((()=>{n(),me(),gt(),ns(),ss(),cs={title:`Components/ComsmozOmnitableFullDemo`,component:`cosmoz-omnitable`,tags:[`autodocs`],args:{loading:!1,locale:`en`,sortOn:``,groupOn:``,descending:!1,groupOnDescending:!1,hashParam:``,settingsId:``,selectedItems:[],disabledFiltering:!1},argTypes:{loading:{control:`boolean`,description:`Show loading state`,table:{defaultValue:{summary:`false`}}},locale:{control:`select`,options:[`en`,`fr`,`sv`],description:`Language locale`,table:{defaultValue:{summary:`en`}}},selectedItems:{control:`object`,description:`Show selected items`},data:{control:`object`,description:`Show specified items`},sortOn:{control:`text`,description:`Column property name to sort on (e.g., "amount", "date", "id")`},groupOn:{control:`text`,description:`Column property name to group on (e.g., "amount", "date", "id")`},descending:{control:`boolean`,description:`Sort on descending`},groupOnDescending:{control:`boolean`,description:`Group on descending`},hashParam:{control:`text`,description:`Hash parameter for URL state management`},settingsId:{control:`text`,description:`ID for storing table settings`},disabledFiltering:{control:`boolean`,description:`Disable filter inputs in all column headers`,table:{defaultValue:{summary:`false`}}}},render:e=>i`
        ...
        `,play:async()=>{console.log(`Current hash:`,window.location.hash)}},ls={args:{data:os(10,10,10)}},us={args:{data:os(2,2,10)}},$={args:{data:[]}},ls.parameters={...ls.parameters,docs:{...ls.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...us.parameters?.docs?.source}}},$.parameters={...$.parameters,docs:{...$.parameters?.docs,source:{originalSource:`{
  args: {
    data: []
  }
}`,...$.parameters?.docs?.source}}},ds=[`TableWithLargeData`,`TableWithSmallData`,`TableWithNoData`]}))();export{ls as TableWithLargeData,$ as TableWithNoData,us as TableWithSmallData,ds as __namedExportsOrder,cs as default};