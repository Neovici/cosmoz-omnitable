import{n as e}from"./chunk-BneVvdWh.js";import{J as t,Q as n,Y as r,Z as i}from"./iframe-Cohi6gbw.js";import{$ as a,A as o,At as s,B as c,C as l,Ct as u,D as d,Dt as f,E as p,Et as m,F as h,Ft as g,G as _,Gt as ee,H as te,Ht as v,I as ne,It as y,J as re,K as ie,L as ae,Lt as oe,M as se,Mt as ce,N as le,Nt as b,O as ue,Ot as de,P as fe,Pt as x,Q as pe,R as S,Rt as me,S as C,St as he,T as ge,Tt as _e,U as w,Ut as T,V as ve,Vt as ye,W as be,Wt as xe,X as E,Y as Se,Z as Ce,_ as we,_t as Te,a as Ee,at as D,b as De,bt as Oe,c as ke,ct as Ae,d as je,dt as O,et as Me,f as Ne,ft as k,g as Pe,gt as Fe,h as Ie,ht as Le,i as Re,it as ze,j as Be,jt as A,k as Ve,kt as He,l as Ue,lt as We,m as Ge,mt as Ke,n as qe,nt as Je,o as Ye,ot as j,p as Xe,pt as Ze,q as Qe,r as $e,rt as et,s as tt,st as nt,t as rt,tt as it,u as at,ut as ot,v as st,vt as ct,w as lt,wt as ut,x as dt,xt as ft,y as pt,yt as mt,z as M,zt as ht}from"./dist-CCBv0-gO.js";var gt,_t,N=e((()=>{Qe(),m(),gt=E`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,Mt=e=>{let{label:t,value:n,slot:r}=e;return et(i`<div
		id="input"
		part="input"
		role="button"
		class="control"
	...
	>
		${n||``}
	</div>`,{label:t})},customElements.define(`cosmoz-omnitable-dropdown-input`,f(Mt,{observedAttributes:At,styleSheets:[jt]}))})),Pt,Ft=e((()=>{ct(),n(),ae(),Nt(),Pt=({title:e,tooltip:t=``,filterText:n=``,onOpenedChanged:r,content:a,horizontalAlign:o=`left`,externalValues:s=null})=>i`
		<style>
			.dropdown {
				outline: none;
			}
	...
	`})),It,Lt,Rt=e((()=>{Le(),We(),h(),se(),It=e=>e?typeof e.close==`function`?e:It(e.parentElement):null,Lt=e=>class extends e{static get properties(){return{disabled:{type:Boolean,value:!1},filter:{type:Object,notify:!0},values:{type:Array,value(){return[]}},headerFocused:{type:Boolean,notify:!0},min:{type:Number,value:null},max:{type:Number,value:null},limits:{type:Function},autoupdate:{type:String,value:!0},locale:{type:String,value:null},_filterInput:{type:Object,value(){return{min:null,max:null}}},_range:{type:Object,computed:`_computeRange(values.*)`},_limit:{type:Object,computed:`_computeLimit(_range, _filterInput.*, min, max)`,value(){return{}}},_tooltip:{type:String,computed:`_computeTooltip(title, _filterText)`},_fromClasses:{type:String,computed:`_computeInputClasses(_filterInput.min)`},_toClasses:{type:String,computed:`_computeInputClasses(_filterInput.max)`}}}static get observers(){return[`_filterInputChanged(_filterInput.*, autoupdate)`,`_filterChanged(filter.*)`,`_updateLimits(limits, headerFocused)`]}disconnectedCallback(){this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),super.disconnectedCallback()}_computeInputClasses(e){return e!=null&&e!==``?`has-value`:``}toNumber(e,t,n){if(e==null||e===``)return;let r=typeof e==`number`?e:Number(e);if(Number.isNaN(r))return;if(n==null||t==null)return r;let i=this.toNumber(t);return i==null?r:n(r,i)}toValue(){return this.toNumber.apply(this,arguments)}getComparableValue(e,t){if(e==null)return;let n=e;return t!=null&&(n=this.get(t,e)),this.toValue(n)}renderValue(){}getInputString(e,t=this.valuePath){let n=this.toValue(this.get(t,e));return this._toInputString(n)}_computeRange(e){let t=e.base,n=Array.isArray(t)&&t.length&&t.map(e=>this.toValue(e)).filter(e=>e!=null);return!n||n.length<1?{min:null,max:null}:n.reduce((e,t)=>({min:this.toValue(t,e.min,Math.min),max:this.toValue(t,e.max,Math.max)}),{})}_computeLimit(e,t,n,r){if(!e)return;let i=t.base,a=this.toValue(n),o=this.toValue(r),s=a??this.toValue(e.min),c=o??this.toValue(e.max);return{fromMin:s,fromMax:this.toValue(c,this._fromInputString(i.max,`max`),Math.min),toMin:this.toValue(s,this._fromInputString(i.min,`min`),Math.max),toMax:c}}_computeFilterText(e){if(e.base==null)return;let t=e.base,n=this.toValue(t.min),r=this.toValue(t.max),i=[];return n!=null&&i.push(this.renderValue(n)),i.push(` - `),r!=null&&i.push(this.renderValue(r)),i.length>1?i.join(``):void 0}_computeTooltip(e,t){return t==null?e:`${e}: ${t}`}_fromInputString(e){return this.toValue(e)}_toInputString(e){return this.toValue(e)??null}_getDefaultFilter(){return{min:null,max:null}}_filterInputChanged(e,t){this.__inputChangePath=e.path.split(`.`)[1]||null,t&&(this._limitInputDebouncer=le.debounce(this._limitInputDebouncer,ot.after(600),()=>{this._limitInput(),this._updateFilter()}),fe(this._limitInputDebouncer))}_clearFrom(){this.set(`_filterInput.min`,null),this._updateFilter()}_clearTo(){this.set(`_filterInput.max`,null),this._updateFilter()}_onBlur(){this._limitInput(),this._updateFilter()}_onKeyDown(e){let t=e.currentTarget,n=Array.from(t.parentElement.querySelectorAll(`cosmoz-input`)),r=n[n.findIndex(e=>e===t)+1],i=!r,a=n[0]===t;switch(e.keyCode){case 13:if(e.preventDefault(),!i)r.focus();else{let e=this._limitInput();this._updateFilter(),e||this._closeParent(t)}break;case 9:(i&&!e.shiftKey||a&&e.shiftKey)&&this._closeParent(t)}}_closeParent(e){let t=It(e);t&&t.close()}_onDropdownOpenedChanged({currentTarget:e,type:t,detail:n}){(t===`focus`||n?.value===!0)&&setTimeout(()=>{e.querySelector(`cosmoz-input:focus`)||e.querySelector(`cosmoz-input`)?.focus()},100)}_limitInput(){let e=this._filterInput,t=this.__inputChangePath,n=t?this._fromInputString(this.get(t,e),t):null;if(this.__inputChangePath=null,n==null)return!1;let r=this._limit,i=t===`min`?`from`:`to`,a=this.get(i+`Min`,r),o=this.get(i+`Max`,r),s=this.toValue(n,a,Math.max),c=this.toValue(s,o,Math.min);return this.getComparableValue(n)===this.getComparableValue(c)?!1:(this.set([`_filterInput`,t],this._toInputString(c,t)),this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),!0)}_updateFilter(){let e=this._filterInput,t=this.filter,n=this._fromInputString(e.min,`min`),r=this._fromInputString(e.max,`max`);this.getComparableValue(n)===this.getComparableValue(t,`min`)&&this.getComparableValue(r)===this.getComparableValue(t,`max`)||this.set(`filter`,{min:n,max:r})}_filterChanged(e){if(this._filterInput==null)return;let t=this._filterInput,n=e.base,r=this._fromInputString(t.min,`min`),i=this._fromInputString(t.max,`max`);this.getComparableValue(r)===this.getComparableValue(n,`min`)&&this.getComparableValue(i)===this.getComparableValue(n,`max`)||(this.set(`_filterInput`,{min:this._toInputString(n.min),max:this._toInputString(n.max)}),this._limitInputDebouncer&&this._limitInputDebouncer.cancel())}hasFilter(){let e=this.filter;return e==null?!1:this.toValue(e.min)!=null||this.toValue(e.max)!=null}resetFilter(){this.filter=this._getDefaultFilter()}_updateLimits(e,t){e&&Promise.resolve(Fe(e,{active:t})).then(e=>{let{min:t,max:n}=e??{};Object.assign(this,{...t==null?{}:{min:t},...n==null?{}:{max:n}})})}}})),zt,Bt=e((()=>{j(),n(),zt=e=>class extends e{static get template(){return nt`<div id="output" style="position:relative;"></div>`}connectedCallback(){super.connectedCallback(),r(this.render(),this.$.output)}_propertiesChanged(e,t,n){super._propertiesChanged(e,t,n),requestAnimationFrame(()=>r(this.render(),this.$.output))}}})),Vt,Ht=e((()=>{c(),j(),S(),n(),v(),Ft(),Nt(),Rt(),Bt(),Vt=class extends Lt(zt(D)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:`_computeFilterText(filter.*, _formatters)`},headerFocused:{type:Boolean,value:!1}}}static get observers(){return[`_valuesChanged(autodetect, currency, values)`]}render(){let e=e=>{this.headerFocused=e.type===`focus`,this._onDropdownOpenedChanged(e)};return i`
			...
			${T(this.disabled,()=>i`
				...
				`,()=>i`
					...
					></cosmoz-clear-button>
					${Pt({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:i`
		...
		>`}getComparableValue(e,t){return In(e,t)}},customElements.define(`cosmoz-omnitable-column-autocomplete`,Ln)})),zn,Bn,Vn,Hn,Un,Wn,Gn,Kn,qn,Jn,Yn,Xn,Zn,Qn,$n=e((()=>{j(),I(),st(),Ve(),k(),n(),v(),zn=(e,t)=>t.find(({value:t})=>e===t),Bn=(e,t,n)=>{let r=zn(t,n);return r?r.text:e},Vn=(e,t,n,r)=>Bn(e,O(t,n),r),Hn=({valuePath:e},t,n)=>zn(O(t,e),n),Un=e=>t=>{e(e=>({...e,filter:t?.[0]?.value??null}))},Wn=e=>t=>{e(e=>({...e,headerFocused:t}))},Gn=e=>t=>{e(e=>({...e,query:t}))},Kn=e=>t=>e(t?.[0]?.value),qn=({valuePath:e,trueLabel:t,falseLabel:n},r)=>O(r,e)?t:n,Jn=({valuePath:e},t)=>n=>O(n,e)===t,Yn=o((e,t)=>[{text:e,value:!0},{text:t,value:!1}]),Xn=({valuePath:e,trueLabel:t,falseLabel:n},r)=>e?O(r,e)?t:n:``,Zn=(e,t)=>{try{return JSON.parse(t)}catch{return null}},Qn=class extends F(D){static get properties(){return{trueLabel:{type:String,value:`True`},falseLabel:{type:String,value:`False`},flex:{type:String,value:`0`},cellClass:{type:String,value:`boolean-cell`}}}getString(e,t){return qn(e,t)}renderCell(e,{item:t}){return qn(e,t)}renderEditCell(e,{item:t},n){let{trueLabel:r,falseLabel:a}=e;return i`<cosmoz-autocomplete
			no-label-float
			...
			${T(this.disabled,()=>i`
				...
				`,()=>i`
					...
					${Pt({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:i`
						...
						`})}
				`)}
		`}_fromInputString(e,t){let n=this.toDate(e);if(n!=null)return t===`min`&&n.setHours(0,0,0,0),t===`max`&&n.setHours(23,59,59),n}_filterInputChanged(e,t){let n=e.path.split(`.`)[1]&&e.value;if(n&&n.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}},customElements.define(`cosmoz-omnitable-date-range-input`,nr)})),ir,ar,or,U,W,sr,cr,lr,ur,dr,fr,pr,mr,hr,gr,_r=e((()=>{pe(),k(),Yt(),ir=e=>{let t=-new Date(e).getTimezoneOffset()/60;return(t<0?`-`:`+`)+[`0`,Math.abs(t)].join(``).substr(-2)+`:00`},ar=e=>e.length===19?e+ir(e):e,or=e=>{if(e==null||e===``)return;let t=e;return!(t instanceof Date)&&(typeof e==`string`&&(t=ar(t)),t=Ce(t),!t)||Number.isNaN(t.getTime())?null:t},U=({valuePath:e},t)=>{if(t==null)return;let n=t;e!=null&&(n=O(t,e));let r=or(n);if(r!=null)return L(r.getTime())},W=(e,t,n)=>{let r=or(e);if(r==null)return null;if(n==null||t==null)return r;let i=W(t);if(i==null)return r;let a=U({},r),o=U({},i);return a==null||o==null||n(a,o)===a?r:i},sr=(e,t)=>{if(t==null)return;let n=W(e);if(n!=null)return t.format(n)},cr={},lr=e=>{let t=e||``;return cr[t]||(cr[t]=new Intl.DateTimeFormat(e||void 0)),cr[t]},ur=({valuePath:e,locale:t},n)=>{let r=O(n,e||``);return r===void 0?``:(r=W(r),r===null?`Invalid Date`:sr(r,lr(t)))},dr=e=>{let t=W(e);if(t==null)return null;let n=a(t);return n==null?null:n.slice(0,10)},fr=({valuePath:e},t)=>dr(O(t,e||``)),pr=(e,t)=>{let n=W(e);if(n!=null)return t===`min`&&n.setHours(0,0,0,0),t===`max`&&n.setHours(23,59,59),n},mr=e=>dr(e)??``,hr=({valuePath:e},t)=>{if(!e)return``;let n=W(O(t,e));if(!n)return``;let r=W(a(n));return r?(r.setHours(0,0,0,0),r):``},gr=(e,t)=>n=>{let r=U(e,n);if(r==null)return!1;let i=U({...e,valuePath:`min`},t),a=U({...e,valuePath:`max`},t);return!(r<(i??-1/0)||r>(a??1/0))}})),vr,yr=e((()=>{c(),j(),n(),I(),rr(),H(),_r(),N(),vr=class extends F(D){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:`date-header-cell`},width:{type:String,value:`100px`},minWidth:{type:String,value:`82px`},flex:{type:String,value:`0`}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){let n=U({...e,valuePath:`min`},t),r=U({...e,valuePath:`max`},t);if(!(n==null&&r==null))return gr(e,t)}getString(e,t){return ur(e,t)}toXlsxValue(e,t){return hr(e,t)}getComparableValue(e,t){return U(e,t)}serializeFilter(e,t){if(t==null)return;let n=W(t.min),r=W(t.max);if(!(n==null&&r==null))return mr(n)+`~`+mr(r)}deserializeFilter(e,t){if(t==null||t===``)return null;let n=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(n)?{min:W(n[1]),max:W(n[2])}:null}renderCell(e,{item:t}){return i`<div class="omnitable-cell-date">
			${ur(e,t)}
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return hn(e,t)}},customElements.define(`cosmoz-omnitable-column-date`,vr)})),br,xr=e((()=>{j(),S(),n(),v(),tr(),Ft(),Nt(),Bt(),br=class extends er(zt(D)){render(){let e=e=>{this.headerFocused=e.type===`focus`};return i`
			<style>
		...
		></cosmoz-omnitable-datetime-range-input>`}computeSource(e,t){return hn(e,t)}},customElements.define(kr.is,kr)})),jr,Mr=e((()=>{st(),we(),j(),n(),v(),jn(),I(),jr=class extends An(F(D)){renderCell({valuePath:e,textProperty:t},{item:n}){return i`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		`}renderEditCell(){return`not implemented`}renderHeader(e,{filter:t,query:n},r,a){return i`<cosmoz-autocomplete-ui
			...
			.onText=${Dn(r)}
			>${T(e.loading,()=>i`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}},customElements.define(`cosmoz-omnitable-column-list-horizontal`,jr)})),Nr,Pr=e((()=>{Ge(),Qe(),j(),Ae(),window.Cosmoz=window.Cosmoz||{},Nr=class extends Ie(re(Je,D)){static get template(){return nt`
			<style>
				:host {
					display: block;
				}
		...
		`}static get is(){return`cosmoz-omnitable-column-list-data`}static get properties(){return{items:{type:Array},_expanded:{type:Boolean,value:!1},_othersCount:{type:Number,computed:`_computeOthersCount(items)`}}}static get observers(){return[`_itemsLengthChanged(items.length)`]}_itemsLengthChanged(){requestAnimationFrame(()=>this.dispatchEvent(new CustomEvent(`expand`,{bubbles:!0})))}_firstItem(e){if(e!=null&&e.length>0)return e[0]}_hideExpand(e,t){return e!==void 0&&e.length!==null?e.length<=2||t:!0}_hideCollapse(e,t){return e!==void 0&&e.length!==null?e.length<=2||!t:!0}_otherItems(e,t){if(e!=null&&(e.length<=2||t))return e.slice(1)}_computeOthersCount(e){if(e!=null)return e.length-1}_toggleExpand(e){this._expanded=!this._expanded,e.stopPropagation(),e.preventDefault()}},customElements.define(Nr.is,Nr)})),Fr,Ir=e((()=>{Pr(),j(),n(),v(),st(),jn(),I(),pn(),Fr=class extends An(F(D)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:n}){return i`<cosmoz-omnitable-column-list-data
			.items=${xn(n,e,t)}
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:n},r,a){return i`<cosmoz-autocomplete-ui
			...
			.onText=${Dn(r)}
			>${T(e.loading,()=>i`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}},customElements.define(`cosmoz-omnitable-column-list`,Fr)})),Lr,Rr=e((()=>{c(),j(),S(),n(),v(),Ft(),Nt(),Rt(),Bt(),Lr=class extends Lt(zt(D)){static get properties(){return{maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null},formatter:{type:Object,computed:`_computeFormatter(locale, minimumFractionDigits, maximumFractionDigits)`},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:`_computeFilterText(filter.*, formatter)`},headerFocused:{type:Boolean,value:!1}}}render(){let e=e=>{this.headerFocused=e.type===`focus`,this._onDropdownOpenedChanged(e)};return i`
			<style>
				cosmoz-input[type='number'] {
					background: var(--cosmoz-omnitable-amount-input-background, #ffffff);
					border-radius: 6px;
			...
			${T(this.disabled,()=>i`
				...
				`,()=>i`
					<cosmoz-clear-button
						...
						?visible=${this.hasFilter()}
					></cosmoz-clear-button>
					${Pt({title:this.title,tooltip:this._tooltip,filterText:this._filterText,horizontalAlign:`right`,externalValues:this.externalValues,onOpenedChanged:e,content:i`
							<h3>${this.title}</h3>
							<cosmoz-input
								class=${this._fromClasses}
								type="number"
		...
		></cosmoz-omnitable-number-range-input>`}computeSource(e,t){return hn(e,t)}},customElements.define(`cosmoz-omnitable-column-number`,zr)})),Vr,Hr=e((()=>{c(),j(),S(),n(),v(),tr(),Ft(),Nt(),Bt(),Vr=class extends er(zt(D)){render(){let e=e=>{this.headerFocused=e.type===`focus`};return i`
			${T(this.disabled,()=>i`
					<cosmoz-omnitable-dropdown-input
						disabled
						.label=${this.title}
...
`}));function gi(e,t,{suffix:n=``,read:r,write:i,multi:a}={}){let o=a?bi:yi,s=x(()=>{if(t==null)return!1;if(a){let e=at(t+n);return Object.keys(e).length>0}return je(t+n)!==void 0},[]),[c,l]=A(()=>{if(t==null)return e;if(a){let i=at(t+n,r);return Object.keys(i).length>0?i:e}return je(t+n,r)??e}),u=b(e=>l(r=>{let a=Fe(e,r);return t!=null&&Xe(o(t+n,a,i??Ke),null,{notify:!1}),a}),[t,n,o,i]);return y(()=>{t!=null&&(s||typeof e==`object`&&e&&Object.keys(e).length===0||e!=null&&u(e))},[...Object.values(e??{}),t,s,u]),[c,u]}var _i,vi,yi,bi,xi=e((()=>{Ne(),Le(),Ue(),m(),_i=e=>(t,n,r=Ke)=>{let i=ke(),a=new URLSearchParams(i.hash.replace(`#`,``));return e(t,n,r,a),`#!`+Object.assign(i,{hash:a}).href.replace(location.origin,``)},vi=e=>e==null||e===``,yi=_i((e,t,n,r)=>vi(n(t))?r.delete(e):r.set(e,n(t))),bi=_i((e,t,n,r)=>{let i=Object.entries(t),a=i.map(n).filter(([,e])=>e!==void 0);if(a.length===0&&i.length>0)return;let o=e;Array.from(r.keys()).filter(e=>e.startsWith(o)).forEach(e=>r.delete(e)),a.forEach(([t,n])=>vi(n)?r.delete(e+t):r.set(e+t,n))})})),Si,Ci,wi,Ti,Ei,Di=e((()=>{m(),xi(),Si=e=>[!0,`true`,1,`yes`,`on`].includes(e),Ci=e=>e===``||(e==null?void 0:Si(e)),wi=(e,t,n)=>b(r=>{e(r),n(e=>({...e,[t]:r}))},[e,t,n]),Ti=(e,t,n,r,i)=>{let[a,o]=gi(n.sortOn,t,{suffix:`-sortOn`}),[s,c]=gi(Ci(n.descending),t,{suffix:`-descending`,read:Ci}),[l,u]=gi(n.groupOn,t,{suffix:`-groupOn`}),[d,f]=gi(Ci(n.groupOnDescending),t,{suffix:`-groupOnDescending`,read:Ci}),p=x(()=>e.find(e=>e.name===a),[e,a]),m=x(()=>e.find(e=>e.name===l),[e,l]),h={groupOn:l,setGroupOn:wi(u,`groupOn`,r),groupOnDescending:d,setGroupOnDescending:wi(f,`groupOnDescending`,r),sortOn:a,setSortOn:wi(o,`sortOn`,r),descending:s,setDescending:wi(c,`descending`,r),columns:e},g=x(()=>h,Object.values(h)),_=b(e=>{o(e.sortOn),u(e.groupOn),c(e.descending),f(e.groupOnDescending)},[]);return y(()=>void(i.current=_),[]),{...g,sortAndGroup:g,groupOnColumn:m,sortOnColumn:p}},Ei=de(),customElements.define(`sort-and-group-provider`,Ei.Provider),customElements.define(`sort-and-group-consumer`,f(({render:e})=>e(g(Ei)),{useShadowDOM:!1}))})),Oi,ki,Ai=e((()=>{m(),ue(),ai(),hi(),v(),Di(),Oi=({data:e,columns:t,groupOnColumn:n,filters:r,setFilterState:a,sortAndGroup:{sortOn:o,setSortOn:s,descending:c,setDescending:l}={}})=>d(t,e=>e.name,t=>[i`<div
	...
	`},customElements.define(`cosmoz-omnitable-header-row`,f(ki,{useShadowDOM:!1}))})),ji,Mi,Ni=e((()=>{m(),Qe(),ji=E`
	:host {
		display: flex;
		align-items: center;
		flex-wrap: wrap;
...
`,customElements.define(`cosmoz-omnitable-item-expand-line`,f(Mi,{styleSheets:[Se(ji)]}))})),Pi,Fi=e((()=>{m(),n(),Ye(),Ni(),Pi=({columns:e,item:t,selected:n,expanded:r,groupOnColumn:a})=>tt(e,e=>i`<cosmoz-omnitable-item-expand-line
				.column=${e}
				?hidden=${e===a}
			...
			</div>`),customElements.define(`cosmoz-omnitable-item-row`,f(Li,{useShadowDOM:!1}))})),zi,Bi,Vi=e((()=>{Qe(),zi=E`
	.checkbox {
		box-sizing: border-box;
		width: 18px;
		height: 18px;
...
`})),Hi,Ui,Wi=e((()=>{Re(),Hi=e=>{let t=e.replace(/"/gu,`""`);return t.search(/("|,|\n)/gu)>=0?`"`+t+`"`:e},Ui=(e,t,n)=>{let r=e.map(e=>Hi(e.title)).join(`;`)+`
`,i=t.map(t=>e.map(e=>{let n=e.getString(e,t);return n==null?``:Hi(String(n))}).join(`;`)+`
`);i.unshift(r),Ee(new File(i,n,{type:`text/csv;charset=utf-8`}))}})),Gi,Ki,qi=e((()=>{Re(),qe(),Gi=(e,t)=>{let n=e.map(e=>e.title),r=t.map(t=>e.map(e=>e.toXlsxValue(e,t)??``));return r.unshift(n),r},Ki=(e,t,n,r)=>{let i=Gi(e,t),a=new $e(n).addSheetFromData(i,r).generate();Ee(new File([a],n,{type:`application/vnd.openxmlformats-officedocument.spreadsheetml.sheet`}))}})),Ji,Yi=e((()=>{Me(),S(),n(),Wi(),qi(),Ji=({columns:e,selectedItems:t,csvFilename:n,xlsxFilename:r,xlsxSheetname:a,topPlacement:o})=>i`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!it(t.length)}
		part="bottomBar"
...
`})),oa,sa,ca=e((()=>{m(),mt(),oa=e=>{let t=parseInt(e,10);return isFinite(t)?t:void 0},sa=e=>{let{config:t}=e,{settings:n,setSettings:r,collapsed:i}=t,a=Oe({collapsed:i,settings:n.columns,setSettings:b(e=>r(t=>({...t,columns:e})),[r])});return{...t,onDown:b(e=>{e.target.closest(`.pull`)&&(a.handle=e.currentTarget)},[a]),onDragStart:b(e=>{let{target:t}=e,n=oa(t.dataset.index);if(!a.handle?.contains(t)||n==null)return e.preventDefault();a.handle=null,e.dataTransfer.effectAllowed=`move`,e.dataTransfer.setData(`omnitable/sort-index`,n),e.dataTransfer.setData(`text/plain`,n),setTimeout(()=>t.classList.add(`drag`),0),t.addEventListener(`dragend`,e=>e.target.classList.remove(`drag`),{once:!0})},[a]),onDragEnter:b(e=>{let t=e.currentTarget;t===e.target&&(e.preventDefault(),e.dataTransfer.dropEffect=`move`,t.classList.add(`dragover`))},[]),onDragOver:b(e=>{e.preventDefault(),e.currentTarget.classList.add(`dragover`)},[]),onDragLeave:b(e=>{let t=e.currentTarget;t.contains(e.relatedTarget)||t.classList.remove(`dragover`)},[]),onDrop:b(e=>{let t=oa(e.dataTransfer.getData(`omnitable/sort-index`)),n=oa(e.currentTarget.dataset.index),{settings:r,setSettings:i}=a;e.currentTarget.classList.remove(`dragover`),e.preventDefault();let o=r.slice();o.splice(n+(t>=n?0:-1),0,o.splice(t,1)[0]),i(o)},[a]),onToggle:b(e=>{let{settings:t,setSettings:n}=a,r=t.map(e=>({...e,disabled:e.disabled||a.collapsed?.some(t=>t.name===e.name)})),i=oa(e.target.closest(`[data-index]`)?.dataset.index);r.splice(i,1,{...t[i],disabled:!e.target.checked,priority:e.target.checked?t.reduce((e,t)=>Math.max(e,t.priority),0)+1:t[i].priority}),n(r)},[a])}}})),la,ua,da,fa,pa=e((()=>{rt(),he(),Qe(),Me(),m(),S(),v(),ui(),hi(),aa(),ca(),la=[u({apply({availableHeight:e,elements:t}){Object.assign(t.floating.style,{maxHeight:`${Math.max(0,e)}px`})}}),...ft],ua=({onDragStart:e,onDragEnter:t,onDragOver:n,onDragLeave:r,onDrop:a,onDown:o,onToggle:s,collapsed:c,filters:l})=>(u,d)=>{let f=!!c?.find(e=>e.name===u.name),p=!u.disabled&&!f;return i` <div
		...
		${T(n,()=>i`<div class="buttons">
				...
				</div>`)}`},customElements.define(`cosmoz-omnitable-settings-ui`,f(da,{styleSheets:[Se(ra)]})),fa=({config:e,newLayout:t})=>i`
	<cosmoz-dropdown
