import{x as d,B as ke,E as gt,b as Mt}from"./iframe-Bv3jJO0g.js";import{t as K,c as E,g as C,P as A,u as M,a as ht,m as ft,s as Nt,D as jt,b as Pt,e as Bt,i as be,h as Oe,d as Gt,f as bt,r as Ht,j as Wt,k as _,l as qt,n as xe,p as me,o as V,q as Xt,v as ye,w as Ut,x as Kt,y as Jt,T as Qt,z as T,A as pe,B as Yt,C as Zt,E as en,F as $,G as tn,H as nn,I as xt,J as Ve,K as I,L as yt,M as De,N as on,O as vt,Q as rn,R as Ae,S as Ue,U as ln,V as Ee,W as an,X as sn,Y as _e,Z as Te,_ as un,$ as Ie,a0 as P,a1 as cn,a2 as $e,a3 as dn}from"./cosmoz-collapse-DrwPstBZ.js";const mn=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`);l.unshift(i),vt(new File(l,t,{type:"text/csv;charset=utf-8"}))},Uo=(n,e)=>{const t=n.map(r=>r.title),o=e.map(r=>n.map(i=>{const l=i.toXlsxValue(i,r);return l??""}));return o.unshift(t),o},Ko=(n,e,t,o)=>{const r=Uo(n,e),i=new rn(t).addSheetFromData(r,o).generate();vt(new File([i],t,{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}))},Jo=({columns:n,selectedItems:e,csvFilename:t,xlsxFilename:o,xlsxSheetname:r,topPlacement:i,skipBottomBarAnimationOnMount:l})=>d`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!Ae(e.length)}
		?skip-animation-on-mount=${l}
		part="bottomBar"
...
`,Ar=n=>n?"groupRow groupRow-folded":"groupRow",Er=({item:n,index:e})=>t=>V(t?.length>0,()=>d`
