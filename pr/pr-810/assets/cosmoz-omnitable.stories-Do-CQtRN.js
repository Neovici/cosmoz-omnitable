import{x as c,B as qe,E as pt}from"./iframe-Bv3jJO0g.js";import{t as K,c as O,g as C,P as M,u as T,a as gt,m as ft,s as Dt,D as Tt,b as Vt,e as Nt,i as be,h as _e,d as Pt,f as bt,r as Rt,j as Bt,k as z,l as Gt,n as he,p as me,o as k,q as Ht,v as xe,w as jt,x as Wt,y as Ut,T as Kt,z as E,A as Ue,B as Jt,C as Xt,E as Qt,F as $,G as Yt,H as Zt,I as ht,J as ke,K as F,L as xt,M as Ie,N as ei,O as vt,Q as ti,R as Me,S as Ke,U as ii,V as Ee,W as ai,X as ni,Y as Ae,Z as Oe,_ as oi,$ as ze,a0 as P,a1 as ri,a2 as ye,a3 as li}from"./cosmoz-collapse-DrwPstBZ.js";const si=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`);r.unshift(o),vt(new File(r,t,{type:"text/csv;charset=utf-8"}))},Ga=(i,e)=>{const t=i.map(n=>n.title),a=e.map(n=>i.map(o=>{const r=o.toXlsxValue(o,n);return r??""}));return a.unshift(t),a},Ha=(i,e,t,a)=>{const n=Ga(i,e),o=new ti(t).addSheetFromData(n,a).generate();vt(new File([o],t,{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}))},ja=({columns:i,selectedItems:e,csvFilename:t,xlsxFilename:a,xlsxSheetname:n,topPlacement:o,skipBottomBarAnimationOnMount:r})=>c`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!Me(e.length)}
		?skip-animation-on-mount=${r}
		part="bottomBar"
...
`,Fn=i=>i?"groupRow groupRow-folded":"groupRow",_n=({item:i,index:e})=>t=>k(t?.length>0,()=>c`
			...
			`),kn=({columns:i,collapsedColumns:e,miniColumns:t,onItemClick:a,onCheckboxChange:n,dataIsValid:o,groupOnColumn:r,onItemChange:l,rowPartFn:u})=>(s,d,{selected:m,expanded:f,toggleCollapse:p})=>c`
		<div
			?selected=${m}
	...
	`};customElements.define("cosmoz-omnitable",class extends O(eo,{observedAttributes:["hash-param","sort-on","group-on","descending","group-on-descending","hide-select-all","settings-id","no-local","no-local-sort","no-local-filter","loading","mini-breakpoint","skip-bottom-bar-animation-on-mount"]}){connectedCallback(){super.connectedCallback(),ye(this,"selectedItems",[]),ye(this,"visibleData",[]),ye(this,"sortedFilteredGroupedItems",[])}});const fe=`
