import{e as m,w as Jt,D as Me,t as C,A as Re}from"./iframe-CSaTWcOi.js";import{A as xe,n as I,c as V,t as q,g as k,P as T,s as Yt,a as wt,r as Zt,e as en,D as tn,b as nn,d as on,i as ze,h as zt,m as rn,u as N,f as St,j as Ct,k as ln,l as Y,p as B,o as Ne,q as kt,v as Se,w as an,x as Ce,y as O,z as E,B as ke,C as _t,E as tt,F as nt,G as S,H as sn,I as un,J as It,K as Be,L as Ft,M as cn,N as Ot,O as dn,Q as ot,R as mn,S as pn,T as gn,U as Dt,V as je,W as He,X as hn,Y as At,Z as Pe,_ as U,$ as fn,a0 as bn}from"./cosmoz-collapse-9X-9fy8w.js";import"./preload-helper-PPVm8Dsz.js";const xn=({slot:n,title:e,className:t,width:o="24",height:r="24",styles:i}={})=>m`
  <svg
    slot=${xe(n)}
    class=${`delete-icon ${t??""}`}
    viewBox="0 0 24 24"
...
`;customElements.define("cosmoz-clear-button",V($n));const W=({valuePath:n},e)=>k(e,n),wn=W,zn=W,Sn=({valuePath:n},e)=>t=>{const o=k(t,n);return o==null?!1:o.toString().toLowerCase().trim().includes(e.toLowerCase().trim())},Cn=(n,e)=>e===""||e==null?null:e,R=n=>class extends n{static get properties(){return{isOmnitableColumn:{type:Boolean,value:!0},title:{type:String},valuePath:{type:String,notify:!0},values:{type:Array,notify:!0},filter:{type:Object},noLocalFilter:{type:Boolean},disabled:{type:Boolean,value:!1,notify:!0},editable:{type:Boolean,notify:!0},loading:{type:Boolean,value:!1,notify:!0},externalValues:{type:Boolean,value:!1,notify:!0},name:{type:String},sortOn:{type:String},groupOn:{type:String},noSort:{type:Boolean,value:!1},disabledFiltering:{type:Boolean,value:!1},width:{type:String,value:"75px"},minWidth:{type:String,value:"40px"},flex:{type:String,value:"1"},cellClass:{type:String,value:"default-cell"},headerCellClass:{type:String,value:"default-header-cell"},priority:{type:Number,value:0},hidden:{type:Boolean,notify:!0},preferredDropdownHorizontalAlign:{type:String,value:"right"},renderHeader:{type:Function},renderCell:{type:Function},renderEditCell:{type:Function},renderGroup:{type:Function},mini:{type:Number,value:null},renderMini:{type:Function}}}static get observers(){return["notifyFilterChange(filter)"]}notifyFilterChange(e){this.__ownChange||this.dispatchEvent(new CustomEvent("legacy-filter-changed",{detail:{name:this.name,state:this.legacyFilterToState(e)},bubbles:!0}))}legacyFilterToState(e){return{filter:e}}getFilterFn(){}getString(e,t){return W(e,t)}toXlsxValue(e,t){return wn(e,t)}cellTitleFn(e,t){return this.getString(e,t)}headerTitleFn(e){return e.title}serializeFilter(e,t){return Cn(e,t)}deserializeFilter(e,t){if(t==null)return null;if(typeof t=="string")try{return window.decodeURIComponent(t)}catch{return null}return t}getComparableValue(e,t){return zn(e,t)}computeSource(e,t){return t}_propertiesChanged(e,t,o){super._propertiesChanged(e,t,o),this.dispatchEvent(new CustomEvent("cosmoz-column-prop-changed",{bubbles:!0}))}},kn=n=>e=>n(t=>{if(t.inputValue===void 0&&e.target.value==="")return t;clearTimeout(t.t);const o=setTimeout(()=>n(r=>({...r,filter:r.inputValue})),1e3);return{...t,inputValue:e.target.value,t:o}}),_n=n=>()=>n(e=>({...e,filter:e.inputValue})),In=n=>e=>{e.keyCode===13&&(e.preventDefault(),n(t=>({...t,filter:t.inputValue})))},Fn=n=>e=>n(t=>({...t,headerFocused:e.detail.value})),On=n=>()=>n(e=>({...e,filter:null,inputValue:null})),Dn=n=>n!=null&&n!=="";class An extends R(T){static get properties(){return{minWidth:{type:String,value:"55px"},editMinWidth:{type:String,value:"55px"},inputValue:{type:Object,notify:!0}}}getFilterFn(e,t){if(!(t==null||t===""))return Sn(e,t)}renderCell(e,{item:t}){return m`<span class="default-column">${W(e,t)}</span>`}renderEditCell(e,{item:t},o){return m`<cosmoz-input
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,inputValue:o,headerFocused:r},i){return m`<cosmoz-input
			...
			@blur=${_n(i)}
		>
			${I(!e.disabledFiltering,()=>m`<cosmoz-clear-button
						suffix
						slot="suffix"
						?visible=${Dn(t)}
						light
						@click=${On(i)}
					></cosmoz-clear-button>`)}
		</cosmoz-input>`}legacyFilterToState(e){return{filter:e,inputValue:e}}}customElements.define("cosmoz-omnitable-column",An);const Vn=["label","value","slot","always-float-label","disabled"],Tn=wt`
	${Yt}
...
`,En=n=>{const{label:e,value:t,slot:o}=n,r=m`<div
		id="input"
		part="input"
		role="button"
		class="control"
	...
	>
		${t||""}
	</div>`;return Zt(r,{label:e})};customElements.define("cosmoz-omnitable-dropdown-input",V(En,{observedAttributes:Vn,styleSheets:[Tn]}));const te=({title:n,tooltip:e="",filterText:t="",onOpenedChanged:o,content:r,horizontalAlign:i="left",externalValues:l=null})=>{const a={filtered:!!t,...l!=null&&{[`external-values-${l}`]:!0}};return m`
		<style>
			.dropdown {
				outline: none;
			}
	...
	`},Vt=n=>n?typeof n.close=="function"?n:Vt(n.parentElement):null,Ge=n=>class extends n{static get properties(){return{disabled:{type:Boolean,value:!1},filter:{type:Object,notify:!0},values:{type:Array,value(){return[]}},headerFocused:{type:Boolean,notify:!0},min:{type:Number,value:null},max:{type:Number,value:null},limits:{type:Function},autoupdate:{type:String,value:!0},locale:{type:String,value:null},_filterInput:{type:Object,value(){return{min:null,max:null}}},_range:{type:Object,computed:"_computeRange(values.*)"},_limit:{type:Object,computed:"_computeLimit(_range, _filterInput.*, min, max)",value(){return{}}},_tooltip:{type:String,computed:"_computeTooltip(title, _filterText)"},_fromClasses:{type:String,computed:"_computeInputClasses(_filterInput.min)"},_toClasses:{type:String,computed:"_computeInputClasses(_filterInput.max)"}}}static get observers(){return["_filterInputChanged(_filterInput.*, autoupdate)","_filterChanged(filter.*)","_updateLimits(limits, headerFocused)"]}disconnectedCallback(){this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),super.disconnectedCallback()}_computeInputClasses(e){return e!=null&&e!==""?"has-value":""}toNumber(e,t,o){if(e==null||e==="")return;const r=typeof e=="number"?e:Number(e);if(Number.isNaN(r))return;if(o==null||t==null)return r;const i=this.toNumber(t);return i==null?r:o(r,i)}toValue(){return this.toNumber.apply(this,arguments)}getComparableValue(e,t){if(e==null)return;let o=e;return t!=null&&(o=this.get(t,e)),this.toValue(o)}renderValue(){}getInputString(e,t=this.valuePath){const o=this.toValue(this.get(t,e));return this._toInputString(o)}_computeRange(e){const t=e.base,o=Array.isArray(t)&&t.length&&t.map(r=>this.toValue(r)).filter(r=>r!=null);return!o||o.length<1?{min:null,max:null}:o.reduce((r,i)=>({min:this.toValue(i,r.min,Math.min),max:this.toValue(i,r.max,Math.max)}),{})}_computeLimit(e,t,o,r){if(!e)return;const i=t.base,l=this.toValue(o),a=this.toValue(r),s=l??this.toValue(e.min),u=a??this.toValue(e.max);return{fromMin:s,fromMax:this.toValue(u,this._fromInputString(i.max,"max"),Math.min),toMin:this.toValue(s,this._fromInputString(i.min,"min"),Math.max),toMax:u}}_computeFilterText(e){if(e.base==null)return;const t=e.base,o=this.toValue(t.min),r=this.toValue(t.max),i=[];return o!=null&&i.push(this.renderValue(o)),i.push(" - "),r!=null&&i.push(this.renderValue(r)),i.length>1?i.join(""):void 0}_computeTooltip(e,t){return t==null?e:`${e}: ${t}`}_fromInputString(e){return this.toValue(e)}_toInputString(e){const t=this.toValue(e);return t??null}_getDefaultFilter(){return{min:null,max:null}}_filterInputChanged(e,t){const o=e.path.split(".")[1];this.__inputChangePath=o||null,t&&(this._limitInputDebouncer=tn.debounce(this._limitInputDebouncer,nn.after(600),()=>{this._limitInput(),this._updateFilter()}),on(this._limitInputDebouncer))}_clearFrom(){this.set("_filterInput.min",null),this._updateFilter()}_clearTo(){this.set("_filterInput.max",null),this._updateFilter()}_onBlur(){this._limitInput(),this._updateFilter()}_onKeyDown(e){const t=e.currentTarget,o=Array.from(t.parentElement.querySelectorAll("cosmoz-input")),r=o[o.findIndex(a=>a===t)+1],i=!r,l=o[0]===t;switch(e.keyCode){case 13:if(e.preventDefault(),!i)r.focus();else{const a=this._limitInput();this._updateFilter(),a||this._closeParent(t)}break;case 9:(i&&!e.shiftKey||l&&e.shiftKey)&&this._closeParent(t)}}_closeParent(e){const t=Vt(e);t&&t.close()}_onDropdownOpenedChanged({currentTarget:e,type:t,detail:o}){(t==="focus"||o?.value===!0)&&setTimeout(()=>{e.querySelector("cosmoz-input:focus")||e.querySelector("cosmoz-input")?.focus()},100)}_limitInput(){const e=this._filterInput,t=this.__inputChangePath,o=t?this._fromInputString(this.get(t,e),t):null;if(this.__inputChangePath=null,o==null)return!1;const r=this._limit,i=t==="min"?"from":"to",l=this.get(i+"Min",r),a=this.get(i+"Max",r),s=this.toValue(o,l,Math.max),u=this.toValue(s,a,Math.min);return this.getComparableValue(o)!==this.getComparableValue(u)?(this.set(["_filterInput",t],this._toInputString(u,t)),this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),!0):!1}_updateFilter(){const e=this._filterInput,t=this.filter,o=this._fromInputString(e.min,"min"),r=this._fromInputString(e.max,"max");this.getComparableValue(o)===this.getComparableValue(t,"min")&&this.getComparableValue(r)===this.getComparableValue(t,"max")||this.set("filter",{min:o,max:r})}_filterChanged(e){if(this._filterInput==null)return;const t=this._filterInput,o=e.base,r=this._fromInputString(t.min,"min"),i=this._fromInputString(t.max,"max");this.getComparableValue(r)===this.getComparableValue(o,"min")&&this.getComparableValue(i)===this.getComparableValue(o,"max")||(this.set("_filterInput",{min:this._toInputString(o.min),max:this._toInputString(o.max)}),this._limitInputDebouncer&&this._limitInputDebouncer.cancel())}hasFilter(){const e=this.filter;return e==null?!1:this.toValue(e.min)!=null||this.toValue(e.max)!=null}resetFilter(){this.filter=this._getDefaultFilter()}_updateLimits(e,t){e&&Promise.resolve(ze(e,{active:t})).then(o=>{const{min:r,max:i}=o??{};Object.assign(this,{...r!=null?{min:r}:{},...i!=null?{max:i}:{}})})}},ne=n=>class extends n{static get template(){return zt`<div id="output" style="position:relative;"></div>`}connectedCallback(){super.connectedCallback();const e=this;Me(e.render(),e.$.output)}_propertiesChanged(e,t,o){super._propertiesChanged(e,t,o);const r=this;requestAnimationFrame(()=>Me(r.render(),r.$.output))}};class Ln extends Ge(ne(T)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return m`
			...
			${I(this.disabled,()=>m`
				...
				`,()=>m`
					...
					></cosmoz-clear-button>
					${te({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:m`
		...
		</cosmoz-input>`}renderHeader({title:e,min:t,max:o,limits:r,locale:i,rates:l,currency:a,autoupdate:s,autodetect:u,disabledFiltering:c},{filter:d},g,p){return m`<cosmoz-omnitable-amount-range-input
			.title=${e}
			?disabled=${c}
			.filter=${d}
			.values=${p}
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:o},r,i){return m`<cosmoz-autocomplete-excluding
			...
			>${I(e.loading,()=>m`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-excluding
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:o},r,i){return m`<cosmoz-autocomplete-ui
			...
			@opened-changed=${l=>Ie(r)(l.detail.value)}
			.onText=${Fe(r)}
			>${I(e.loading,()=>m`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}getComparableValue(e,t){return ao(e,t)}}customElements.define("cosmoz-omnitable-column-autocomplete",so);const Xe=(n,e)=>e.find(({value:t})=>n===t),uo=(n,e,t)=>{const o=Xe(e,t);return o?o.text:n},ut=(n,e,t,o)=>uo(n,k(e,t),o),co=({valuePath:n},e,t)=>Xe(k(e,n),t),mo=n=>e=>{n(t=>({...t,filter:e?.[0]?.value??null}))},po=n=>e=>{n(t=>({...t,headerFocused:e}))},go=n=>e=>{n(t=>({...t,query:e}))},ho=n=>e=>n(e?.[0]?.value),ct=({valuePath:n,trueLabel:e,falseLabel:t},o)=>k(o,n)?e:t,fo=({valuePath:n},e)=>t=>k(t,n)===e,ie=Ct((n,e)=>[{text:n,value:!0},{text:e,value:!1}]),bo=({valuePath:n,trueLabel:e,falseLabel:t},o)=>n?k(o,n)?e:t:"",xo=(n,e)=>{try{return JSON.parse(e)}catch{return null}};class vo extends R(T){static get properties(){return{trueLabel:{type:String,value:"True"},falseLabel:{type:String,value:"False"},flex:{type:String,value:"0"},cellClass:{type:String,value:"boolean-cell"}}}getString(e,t){return ct(e,t)}renderCell(e,{item:t}){return ct(e,t)}renderEditCell(e,{item:t},o){const{trueLabel:r,falseLabel:i}=e;return m`<cosmoz-autocomplete
			...
			.onChange=${ho(o)}
			.limit=${1}
			>${I(e.loading,()=>m`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete
			...
			${I(this.disabled,()=>m`
				...
				`,()=>m`
					...
					${te({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:m`
						...
						`})}
				`)}
		`}_fromInputString(e,t){const o=this.toDate(e);if(o!=null)return t==="min"&&o.setHours(0,0,0,0),t==="max"&&o.setHours(23,59,59),o}_filterInputChanged(e,t){const o=e.path.split(".")[1],r=o&&e.value;if(r&&r.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}}customElements.define("cosmoz-omnitable-date-range-input",yo);const $o=n=>{const e=-new Date(n).getTimezoneOffset()/60;return(e<0?"-":"+")+["0",Math.abs(e)].join("").substr(-2)+":00"},Ke=n=>n.length===19?n+$o(n):n,Mt=n=>{if(n==null||n==="")return;let e=n;return!(e instanceof Date)&&(typeof n=="string"&&(e=Ke(e)),e=an(e),!e)||Number.isNaN(e.getTime())?null:e},P=({valuePath:n},e)=>{if(e==null)return;let t=e;n!=null&&(t=k(e,n));const o=Mt(t);if(o!=null)return L(o.getTime())},A=(n,e,t)=>{const o=Mt(n);return o??null},Qe=(n,e)=>{if(e==null)return;const t=A(n);if(t!=null)return e.format(t)},le={},wo=n=>{const e=n||"";return le[e]||(le[e]=new Intl.DateTimeFormat(n||void 0)),le[e]},dt=({valuePath:n,locale:e},t)=>{let o=k(t,n||"");return o===void 0?"":(o=A(o),o===null?"Invalid Date":Qe(o,wo(e)))},Rt=n=>{const e=A(n);if(e==null)return null;const t=Se(e);return t==null?null:t.slice(0,10)},zo=({valuePath:n},e)=>Rt(k(e,n||"")),Nt=(n,e)=>{const t=A(n);if(t!=null)return t},mt=n=>{const e=Rt(n);return e??""},So=({valuePath:n},e)=>{if(!n)return"";const t=A(k(e,n));if(!t)return"";const o=A(Se(t));return o?(o.setHours(0,0,0,0),o):""},jt=(n,e)=>t=>{const o=P(n,t);if(o==null)return!1;const r=P({...n,valuePath:"min"},e),i=P({...n,valuePath:"max"},e);return!(o<(r??-1/0)||o>(i??1/0))};class Co extends R(T){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"date-header-cell"},width:{type:String,value:"100px"},minWidth:{type:String,value:"82px"},flex:{type:String,value:"0"}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const o=P({...e,valuePath:"min"},t),r=P({...e,valuePath:"max"},t);if(!(o==null&&r==null))return jt(e,t)}getString(e,t){return dt(e,t)}toXlsxValue(e,t){return So(e,t)}getComparableValue(e,t){return P(e,t)}serializeFilter(e,t){if(t==null)return;const o=A(t.min),r=A(t.max);if(!(o==null&&r==null))return mt(o)+"~"+mt(r)}deserializeFilter(e,t){if(typeof t!="string"||t==="")return null;const o=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(o)?{min:A(o[1]),max:A(o[2])}:null}renderCell(e,{item:t}){return m`<div class="omnitable-cell-date">
			${dt(e,t)}
			...
			.value=${zo(e,t)}
		></cosmoz-input>`}renderHeader({title:e,min:t,max:o,limits:r,locale:i,disabledFiltering:l},{filter:a},s,u){return m`<cosmoz-omnitable-date-range-input
			.title=${e}
			?disabled=${l}
			.filter=${a}
			.values=${u}
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return oe(e,t)}}customElements.define("cosmoz-omnitable-column-date",Co);class ko extends Ue(ne(T)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return m`
			<style>
			...
			${I(this.disabled,()=>m`
				...
				`,()=>m`
					...
					${te({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:m`
						...
						`})}
				`)}
		`}_toInputString(e){const t=this.toValue(e);if(t!=null)return this._toLocalISOString(t).slice(0,19)}_computeFormatter(e){const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return new Intl.DateTimeFormat(e||void 0,t)}}customElements.define("cosmoz-omnitable-datetime-range-input",ko);const ae={},_o=n=>{const e=n||"";if(ae[e])return ae[e];const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return ae[e]=new Intl.DateTimeFormat(n||void 0,t),ae[e]},Ve=({valuePath:n,locale:e},t)=>{const o=A(k(t,n||""));return o===void 0?"":o===null?"Invalid Date":Qe(o,_o(e))},Io=({valuePath:n},e)=>n?k(e,n):"",pt=n=>{const e=A(n);return e==null?"":e.toISOString().slice(0,19).replace(/:/gu,".")},gt=n=>{if(!(n==null||n==="")&&typeof n=="string")return A(n.replace(/\./gu,":")+"Z")};class ht extends R(T){static get is(){return"cosmoz-omnitable-column-datetime"}static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"datetime-header-cell"},width:{type:String,value:"210px"},minWidth:{type:String,value:"128px"},flex:{type:String,value:"0"},filterStep:{type:Number,value:1}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const o=P({...e,valuePath:"min"},t),r=P({...e,valuePath:"max"},t);if(!(o==null&&r==null))return jt(e,t)}getString(e,t){return Ve(e,t)}toXlsxValue(e,t){return Io(e,t)}getComparableValue(e,t){return P(e,t)}serializeFilter(e,t){if(t==null)return;const o=A(t.min),r=A(t.max);if(!(o==null&&r==null))return pt(o)+"~"+pt(r)}deserializeFilter(e,t){if(typeof t!="string"||t==="")return null;const o=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(o)?{min:gt(o[1]),max:gt(o[2])}:null}renderCell(e,{item:t}){return Ve(e,t)}renderEditCell(e,{item:t},o){return m`<cosmoz-input
			no-label-float
			type="text"
			@change=${i=>o(Nt(i.target.value))}
			.value=${Ve(e,t)}
		></cosmoz-input>`}renderHeader({title:e,min:t,max:o,limits:r,locale:i,filterStep:l,disabledFiltering:a},{filter:s},u,c){return m`<cosmoz-omnitable-datetime-range-input
			.title=${e}
			?disabled=${a}
			.filter=${s}
			.values=${c}
		...
		></cosmoz-omnitable-datetime-range-input>`}computeSource(e,t){return oe(e,t)}}customElements.define(ht.is,ht);class Fo extends Oe(R(T)){renderCell({valuePath:e,textProperty:t},{item:o}){const r=We(o,e,t).map(i=>m`<li>${i}</li>`);return m`
			<style>
				ul {
					padding: 0;
					display: inline;
...
`,Do=({items:n})=>{const[e,t]=N(!1),o=Array.isArray(n)?n:[],r=O(()=>Math.max(0,o.length-1),[o]);if(o.length===0)return null;const i=o.length>2,l=o[0],a=i&&!e?[]:o.slice(1),s=u=>{u.stopPropagation(),u.preventDefault(),t(c=>!c)};return m`
		<ul>
			<li>
				<span>${l}</span>
			</li>
	...
	`};customElements.define("cosmoz-omnitable-column-list-data",V(Do,{styleSheets:[Ce(Oo)]}));class Ao extends Oe(R(T)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:o}){return m`<cosmoz-omnitable-column-list-data
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:o},r,i){return m`<cosmoz-autocomplete-ui
			...
			.onText=${Fe(r)}
			>${I(e.loading,()=>m`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}}customElements.define("cosmoz-omnitable-column-list",Ao);class Vo extends Ge(ne(T)){static get properties(){return{maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null},formatter:{type:Object,computed:"_computeFormatter(locale, minimumFractionDigits, maximumFractionDigits)"},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, formatter)"},headerFocused:{type:Boolean,value:!1}}}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return m`
			<style>
				cosmoz-input[type='number'] {
					background: var(--cosmoz-omnitable-amount-input-background, #ffffff);
					border-radius: 6px;
			...
			${I(this.disabled,()=>m`
				...
				`,()=>m`
					<cosmoz-clear-button
						...
						?visible=${this.hasFilter()}
					></cosmoz-clear-button>
					${te({title:this.title,tooltip:this._tooltip,filterText:this._filterText,horizontalAlign:"right",externalValues:this.externalValues,onOpenedChanged:e,content:m`
							<h3>${this.title}</h3>
							<cosmoz-input
								class=${this._fromClasses}
								type="number"
		...
		`}_computeFormatter(e,t,o){const r={localeMatcher:"best fit"};return t!==null&&(r.minimumFractionDigits=t),o!==null&&(r.maximumFractionDigits=o),new Intl.NumberFormat(e||void 0,r)}getComparableValue(e,t){if(e==null)return;let o=e;if(t!=null&&(o=this.get(t,e)),o=this.toValue(o),o==null)return;const r=this.maximumFractionDigits;return r!==null?this.toValue(o.toFixed(r)):o}renderValue(e,t=this.formatter){const o=this.toNumber(e);if(o!=null)return t.format(o)}}customElements.define("cosmoz-omnitable-number-range-input",Vo);class To extends R(T){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},autoupdate:{type:Boolean,value:!1,notify:!0},cellClass:{type:String,value:"number-cell align-right"},width:{type:String,value:"30px"},minWidth:{type:String,value:"30px"},headerCellClass:{type:String,value:"number-header-cell"},maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const o=K({...e,valuePath:"min"},t),r=K({...e,valuePath:"max"},t);if(!(o==null&&r==null))return Nn(e,t)}getString(e,t){return it(e,t)}toXlsxValue({valuePath:e},t){return k(t,e)}getComparableValue(e,t){return K(e,t)}serializeFilter(e,t){if(t==null)return;const o=L(t.min),r=L(t.max);if(!(o==null&&r==null))return rt(o)+"~"+rt(r)}deserializeFilter(e,t){if(typeof t!="string"||t==="")return null;const o=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(o)?{min:L(o[1]),max:L(o[2])}:null}renderCell(e,{item:t}){return m`<div class="omnitable-cell-number">
			...
			@change=${i=>o(i.target.value)}
			.value=${Mn(e,t)}
		></cosmoz-input>`}renderHeader({title:e,min:t,max:o,limits:r,locale:i,maximumFractionDigits:l,minimumFractionDigits:a,autoupdate:s,disabledFiltering:u},{filter:c},d,g){return m`<cosmoz-omnitable-number-range-input
			.title=${e}
			?disabled=${u}
			.filter=${c}
			.values=${g}
		...
		></cosmoz-omnitable-number-range-input>`}computeSource(e,t){return oe(e,t)}}customElements.define("cosmoz-omnitable-column-number",To);class Eo extends Ue(ne(T)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return m`
			${I(this.disabled,()=>m`
					<cosmoz-omnitable-dropdown-input
						disabled
						.label=${this.title}
...
>
	...
	/>
</svg> `,Bt=({column:n,on:e,descending:t,setOn:o,setDescending:r})=>{const{name:i,title:l}=n??{};return m`<button
		class="sg"
		title=${xe(l)}
	...
	>
		<span>${l}</span> ${Wo}
	</button>`},Ht=({columns:n,...e})=>n?.map(t=>Bt({column:t,...e})),qo=()=>m`
...
`,Gt=n=>(e,t,o=_t)=>{const r=un(),i=new URLSearchParams(r.hash.replace("#",""));return n(e,t,o,i),"#!"+Object.assign(r,{hash:i}).href.replace(location.origin,"")},Wt=n=>n==null||n==="",Uo=Gt((n,e,t,o)=>Wt(t(e))?o.delete(n):o.set(n,t(e))),Ko=Gt((n,e,t,o)=>{const r=Object.entries(e),i=r.map(t).filter(([,a])=>a!==void 0);if(i.length===0&&r.length>0)return;const l=n;Array.from(o.keys()).filter(a=>a.startsWith(l)).forEach(a=>o.delete(a)),i.forEach(([a,s])=>Wt(s)?o.delete(n+a):o.set(n+a,s))});function Z(n,e,{suffix:t="",read:o,write:r,ready:i=!0,multi:l}={}){const a=l?Ko:Uo,s=ke({param:e,suffix:t,link:a,write:r??_t}),u=O(()=>{if(e==null)return!1;if(l){const p=tt(e+t);return Object.keys(p).length>0}return nt(e+t)!==void 0},[]),[c,d]=N(()=>{if(e==null)return n;if(l){const h=tt(e+t,o);return Object.keys(h).length>0?h:n}return nt(e+t,o)??n}),g=S(p=>d(h=>{const v=ze(p,h);return s.param!=null&&sn(s.link(s.param+s.suffix,v,s.write),null,{notify:!1}),v}),[]);return E(()=>{s.param==null||!i||u||n!=null&&g(n)},[i]),[c,g]}const Qo=n=>[!0,"true",1,"yes","on"].includes(n),ue=n=>n===""||(n==null?void 0:Qo(n)),ce=(n,e,t)=>S(o=>{n(o),t(r=>({...r,[e]:o}))},[n,e,t]),Jo=(n,e,{settings:t,setSettings:o,resetRef:r,ready:i=!0})=>{const[l,a]=Z(t.sortOn,e,{suffix:"-sortOn",ready:i}),[s,u]=Z(ue(t.descending),e,{suffix:"-descending",read:ue,ready:i}),[c,d]=Z(t.groupOn,e,{suffix:"-groupOn",ready:i}),[g,p]=Z(ue(t.groupOnDescending),e,{suffix:"-groupOnDescending",read:ue,ready:i}),h=O(()=>n.find(w=>w.name===l),[n,l]),v=O(()=>n.find(w=>w.name===c),[n,c]),x={groupOn:c,setGroupOn:ce(d,"groupOn",o),groupOnDescending:g,setGroupOnDescending:ce(p,"groupOnDescending",o),sortOn:l,setSortOn:ce(a,"sortOn",o),descending:s,setDescending:ce(u,"descending",o),columns:n},b=O(()=>x,Object.values(x)),y=S(w=>{a(w.sortOn),d(w.groupOn),u(w.descending),p(w.groupOnDescending)},[]);return E(()=>{r.current=y},[]),{...b,sortAndGroup:b,groupOnColumn:v,sortOnColumn:h}},Je=It();customElements.define("sort-and-group-provider",Je.Provider);customElements.define("sort-and-group-consumer",V(({render:n})=>n(Be(Je)),{useShadowDOM:!1}));const Yo=({data:n,columns:e,groupOnColumn:t,filters:o,setFilterState:r,sortAndGroup:{sortOn:i,setSortOn:l,descending:a,setDescending:s}={}})=>Ft(e,u=>u.name,u=>[m`<div
			...
			>
				...
				.column="${u}"
				name="${u.name}"
			></cosmoz-omnitable-resize-nub>`]),Zo=({columns:n,settingsConfig:e,hideSelectAll:t,...o})=>{const r=Be(Je);return m`
		${I(n,i=>Yo({columns:i,sortAndGroup:r,...o}))}
		${I(!t,()=>m` <cosmoz-omnitable-settings
					.config=${e}
					part="settings"
				></cosmoz-omnitable-settings>`)}
	`};customElements.define("cosmoz-omnitable-header-row",V(Zo,{useShadowDOM:!1}));const er=q`
	:host {
		display: flex;
		align-items: center;
		flex-wrap: wrap;
...
`;customElements.define("cosmoz-omnitable-item-expand-line",V(tr,{styleSheets:[Ce(er)]}));const nr=({columns:n,item:e,selected:t,expanded:o,groupOnColumn:r})=>cn(n,i=>m`<cosmoz-omnitable-item-expand-line
				.column=${i}
				?hidden=${i===r}
				exportparts="item-expand-label, item-expand-value"
				>${i.renderCell(i,{item:e,selected:t,expanded:o})}</cosmoz-omnitable-item-expand-line
			>`);customElements.define("cosmoz-omnitable-item-expand",V(nr,{useShadowDOM:!1}));const or=(n,e,t)=>n.editable?n.renderEditCell(n,e,t(n,e.item)):n.renderCell(n,e),rr=({columns:n,groupOnColumn:e,item:t,index:o,selected:r,expanded:i,onItemChange:l})=>Ft(n,a=>a.name,a=>m`<div
			...
			</div>`);customElements.define("cosmoz-omnitable-item-row",V(rr,{useShadowDOM:!1}));const qt=q`
	.checkbox {
		box-sizing: border-box;
		width: 18px;
		height: 18px;
...
`);l.unshift(i),Ot(new File(l,t,{type:"text/csv;charset=utf-8"}))},ar=(n,e)=>{const t=n.map(r=>r.title),o=e.map(r=>n.map(i=>{const l=i.toXlsxValue(i,r);return l??""}));return o.unshift(t),o},sr=(n,e,t,o)=>{const r=ar(n,e),i=new dn(t).addSheetFromData(r,o).generate();Ot(new File([i],t,{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}))},ve=Symbol("index"),M=Symbol("All"),ur=(n,e)=>{if(typeof n.findLastIndex=="function")return n.findLastIndex(e);for(let t=n.length-1;t>=0;t--)if(e(n[t],t,n))return t;return-1},cr=({columns:n,selectedItems:e,setSelectedItems:t,csvFilename:o,xlsxFilename:r,xlsxSheetname:i,topPlacement:l,enableSelectAll:a,allSelected:s,allItemsCount:u})=>{const c=e===M,d=c||e.length>0,g=e!==M&&a&&s,p=v=>m`<cosmoz-dropdown-menu
		...
		</cosmoz-dropdown-menu>`,h=I(c,()=>u!==void 0?C("All {count} items selected",{count:u}):C("All items selected"),()=>C("{count} selected item",{count:e===M?0:e.length}));return m`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${d}
		part="bottomBar"
	...
	>
		...
		${I(e!==M,()=>p(e))}
	</cosmoz-bottom-bar>`},dr=({allSelected:n,onAllCheckboxChange:e,sortAndGroup:t,dataIsValid:o,data:r,columns:i,filters:l,groupOnColumn:a,setFilterState:s,settingsConfig:u,hideSelectAll:c})=>m`<sort-and-group-provider .value=${t}>
		<div class="header" id="header" part="header">
			${I(!c,()=>m`<input
						...
						part="all"
					/>`)}
			${I(c,()=>m` <cosmoz-omnitable-settings
						.newLayout="${!0}"
						.config=${u}
					></cosmoz-omnitable-settings>`)}
...
`,pr=({settingsConfig:n})=>{const{columns:e,collapsed:t}=n,o=e.filter(r=>!t.some(i=>i.name===r.name));return m`<div class="skeleton">
	...
	</div>`};customElements.define("cosmoz-omnitable-skeleton",V(pr,{styleSheets:[mr]}));const gr=(n,e)=>{const{settingsConfig:t}=n,{processedItems:o,dataIsValid:r,filterIsTooStrict:i,loading:l,displayEmptyGroups:a,compareItemsFn:s,selectedItems:u,setSelectedItems:c,renderItem:d,renderGroup:g,error:p}=e;return m`${I(!l&&!r&&!p,()=>m`<div class="tableContent-empty">
		...
		${I(i,()=>m`<div class="tableContent-empty">
					${ot({width:"96px",height:"96px",styles:"margin-right: 24px; fill: currentColor;"})}
					<div>
		...
		${I(l&&!o.length,()=>m`<div class="tableContent-empty overlay">
					<cosmoz-omnitable-skeleton
						.settingsConfig=${t}
					></cosmoz-omnitable-skeleton>
				</div>`)}
		${I(l&&o.length,()=>m`<div class="tableContent-empty overlay spinner">
					<cz-spinner></cz-spinner>
				</div>`)}
		${I(p,()=>m`<div class="tableContent-empty overlay">
...
`,de=n=>{const e=parseInt(n??"",10);return isFinite(e)?e:void 0},br=n=>{const{config:e}=n,{settings:t,setSettings:o,collapsed:r,requestTween:i}=e,l=ke({collapsed:r,settings:t.columns,requestTween:i,setSettings:S(a=>o(s=>({...s,columns:a})),[o])});return{...e,onDown:S(a=>{const s=a.target instanceof Element?a.target:null;!s||!s.closest(".pull")||(l.handle=a.currentTarget instanceof HTMLElement?a.currentTarget:null)},[l]),onDragStart:S(a=>{const s=a.target instanceof HTMLElement?a.target:null,u=de(s?.dataset.index);if(!s||!l.handle?.contains(s)||u==null)return a.preventDefault();l.handle=null,a.dataTransfer.effectAllowed="move",a.dataTransfer.setData("omnitable/sort-index",String(u)),a.dataTransfer.setData("text/plain",String(u)),setTimeout(()=>s.classList.add("drag"),0),s.addEventListener("dragend",c=>{(c.target instanceof HTMLElement?c.target:null)?.classList.remove("drag")},{once:!0})},[l]),onDragEnter:S(a=>{const s=a.currentTarget instanceof HTMLElement?a.currentTarget:null;!s||s!==a.target||(a.preventDefault(),a.dataTransfer.dropEffect="move",s.classList.add("dragover"))},[]),onDragOver:S(a=>{a.preventDefault(),a.currentTarget instanceof HTMLElement&&a.currentTarget.classList.add("dragover")},[]),onDragLeave:S(a=>{const s=a.currentTarget instanceof HTMLElement?a.currentTarget:null;s&&(a.relatedTarget instanceof Node&&s.contains(a.relatedTarget)||s.classList.remove("dragover"))},[]),onDrop:S(a=>{const s=de(a.dataTransfer?.getData("omnitable/sort-index")),u=a.currentTarget instanceof HTMLElement?a.currentTarget:null,c=de(u?.dataset.index),{settings:d,setSettings:g,requestTween:p}=l;u?.classList.remove("dragover"),a.preventDefault();const h=d.slice();h.splice(c+(s>=c?0:-1),0,h.splice(s,1)[0]),p?.(),g(h)},[l]),onToggle:S(a=>{const{settings:s,setSettings:u,requestTween:c}=l,d=s.map(h=>({...h,disabled:h.disabled||l.collapsed?.some(v=>v.name===h.name)})),g=a.target instanceof HTMLInputElement?a.target:null,p=de((a.target instanceof Element?a.target:null)?.closest("[data-index]")?.getAttribute("data-index"));p!=null&&(d.splice(p,1,{...s[p],disabled:!g?.checked,priority:g?.checked?s.reduce((h,v)=>Math.max(h,v.priority??0),0)+1:s[p]?.priority}),c?.(),u(d))},[l])}},xr=[gn({apply({availableHeight:n,elements:e}){Object.assign(e.floating.style,{maxHeight:`${Math.max(0,n)}px`})}}),...pn],vr=({onDragStart:n,onDragEnter:e,onDragOver:t,onDragLeave:o,onDrop:r,onDown:i,onToggle:l,collapsed:a,filters:s})=>(u,c)=>{const d=!!a?.find(p=>p.name===u.name),g=!u.disabled&&!d;return m` <div
			class="item"
			data-index=${c}
			@mousedown=${i}
			draggable="true"
		...
		>
			...
			<input
				...
				.indeterminate=${d}
			/>
		</div>`},yr=n=>{const e={...br(n),...n.config},{settings:t,settingsId:o,onSave:r,onReset:i,hasChanges:l,opened:a,setOpened:s,...u}=e;return m` <div class="headline">
			${C("Sort and filter")}
			<button
				class="close"
				@click=${c=>{const d=c.currentTarget instanceof HTMLElement?c.currentTarget:null;d?.focus(),d?.blur()}}
			>
				${Ho}
			</button>
		</div>
		...
		<div class="contents">
			...
			>
				<div class="list">${t.columns?.map(vr(u))}</div>
			</cosmoz-collapse>
			...
			<cosmoz-collapse ?opened=${a.sort}> ${Xo()} </cosmoz-collapse>
		...
		${I(o,()=>m`<div class="buttons">
					...
					<button class="button" @click=${r} ?disabled=${!l}>
						${C("Save")}
					</button>
				</div>`)}`};customElements.define("cosmoz-omnitable-settings-ui",V(yr,{styleSheets:[Ce(hr)]}));const $r=({config:n,newLayout:e})=>m`
	<cosmoz-dropdown
		.placement="${e?"bottom-start":"bottom-end"}"
		.middleware="${xr}"
	>
		<div title="${C("Sort and filter")}" slot="button">
			${I(e,()=>m`<div class="headerDots">...</div>`,()=>m` <svg viewBox="0 0 24 24" width="24" fill="currentColor">
						<circle cx="10" cy="18" r="2"></circle>
						<circle cx="10" cy="12" r="2"></circle>
						<circle cx="10" cy="6" r="2"></circle>
					</svg>`)}
			${I(n?.badge,()=>m`<div class="badge"></div>`)}
		</div>
		<cosmoz-omnitable-settings-ui
...
`;customElements.define("cosmoz-omnitable-settings",V($r,{styleSheets:[Ce(fr)]}));const ye=["sortOn","descending","groupOn","groupOnDescending"],me=n=>e=>typeof e=="object"&&e!==null&&"name"in e&&e.name===n,wr=(n=[],e=[],t=[])=>{const o=e.filter(l=>n.some(me(l.name))),r=n.filter(l=>l.name!=null&&!e.some(me(l.name))&&!t.some(me(l.name))),i=t.filter(l=>!e.some(me(l.name)));return[...o,...i.flatMap(l=>{const a=n.find(s=>s.name===l.name);return a?{...l,title:a.title??l.title??"",minWidth:parseInt(a.minWidth??"0",10)}:[]}),...r.map(l=>{const{name:a,title:s,priority:u,minWidth:c,width:d,flex:g}=l;return{name:a??"",title:s??"",priority:u??0,minWidth:parseInt(c??"0",10),width:parseInt(d??"0",10),flex:parseInt(g??"0",10)}})]},zr=(n,e)=>({...e,...je(Array.from(ye))(n),columns:n.columns?.map(je(["name","priority","width","flex","disabled"]))}),Sr=({columns:n,settings:e,savedSettings:t,initial:o})=>({...Object.fromEntries(ye.flatMap(i=>o?.[i]!=null?[[i,o[i]]]:[])),...t?je(Array.from(ye))(t):{},...e,columns:wr(n,e?.columns,t?.columns)}),Cr=({prefix:n="omnitable-"}={})=>({write:async(t,o)=>{const r=n+t;try{o?localStorage.setItem(r,JSON.stringify(o)):localStorage.removeItem(r)}catch(i){console.error(i)}},read:async t=>{if(!t)return null;try{const o=localStorage.getItem(n+t);return o==null?null:JSON.parse(o)}catch(o){return console.error(o),null}}}),kr=It(Cr),_r=()=>{const n=Be(kr);return O(()=>n(),[n])},Ir=(n,e,t,o)=>{const[r,i]=N(n?void 0:null),{read:l,write:a}=_r();return E(async()=>{n&&i(await l(n))},[n,l]),{settingsId:n,savedSettings:r,onSave:S(async()=>{if(!n)return;const s=zr(e,r);await a(n,s),t(),i(s)},[e,r]),onReset:S(async s=>{t(),s.shiftKey&&(await a(n),i(null)),o?.()},[o]),hasChanges:e!=null}},Fr=({settingsId:n,host:e})=>{const t=O(()=>Object.fromEntries(ye.map(x=>[x,e[x]])),[]),o=He(),r=S(()=>{o.current?.(t)},[t]),[i,l]=N(),[a,s]=N({columns:!0,sort:!0}),{savedSettings:u,...c}=Ir(n,i,l,r),{enabledColumns:d,disabledFiltering:g}=e,p=Qn(e,{enabledColumns:d,disabledFiltering:g}),h=O(()=>Sr({columns:p,settings:i,savedSettings:u??void 0,initial:t}),[p,i,u]),v=O(()=>h.columns.map(x=>p.find(b=>b.name===x.name)).filter(x=>x!==void 0),[p,...h.columns.map(x=>x.name)]);return{...c,savedSettings:u,opened:a,setOpened:s,settings:h,columns:v,setSettings:l,resetRef:o}},vt=n=>Number.isFinite(n)?n:0,Or=(n,e)=>{const t=[];let[o,r]=n.reduce(([c,d],{width:g,flex:p})=>[c+g,d+p],[0,0]),i=e-o,l=vt(i/r),a=0,s=0,u=0;for(let c=0;c<n.length;c++){const{width:d,minWidth:g,flex:p}=n[c],h=i>=0?l*p:d*i/o;if(g>d+h){a+=d,s+=g,u+=p,t[c]=g;continue}if(p===0){a+=d,s+=d,t[c]=d;continue}}o-=a,i=e-s-o,r-=u,l=vt(i/r);for(let c=0;c<n.length;c++){if(t[c]!=null)continue;const{width:d,flex:g}=n[c],p=i>=0?l*g:d*i/o;t[c]=d+p}return t},Dr=(n,e)=>{const t=ur(n,l=>l!=null&&l>0),o=(l,a)=>`.cell[name="${l}"], cosmoz-omnitable-skeleton::part(cell-${l}){width: ${Math.floor(a)}px;padding: 0 min(3px, ${a/2}px)}`,r=l=>`cosmoz-omnitable-resize-nub[name="${l}"]{display:none}`,i=l=>`cosmoz-omnitable-resize-nub[name="${l}"], .cell[name="${l}"]{display:none}`;return e.map((l,a)=>{const s=n[a];if(s==null||s===0)return i(l.name);const u=o(l.name,s);return a===t?`${u}
${r(l.name)}`:u}).join(`
`)},Xt=(n,e,t)=>{const o=n.filter(a=>!a.hidden),r=o.reduce((a,{width:s})=>a+s,0);if(o.length>1&&r>e)return Xt(o.slice(1),e,t);const i=o.reduce(([a,s],u,c)=>[Math.max(a,u.index),u.index>a?c:s],[-1,-1])[1];return i!==-1&&(o[i].flex=1),Or(o,e).reduce((a,s,u)=>(a[o[u].index]=s,a),new Array(t).fill(void 0))},Ar=(n,e)=>n.length===0?".cell {display: none;}":Dr(n,e),Vr=20,Tr=44,Er=24,Ut=Vr+Tr+Er,Lr=(n,e)=>E(()=>{const t=([r])=>{r.contentRect?.width!==0&&e(r.contentRect.width-Ut)},o=new ResizeObserver(t);return o.observe(n),()=>o.unobserve(n)},[]),Mr=n=>{const[e,t]=N(()=>n.getBoundingClientRect().width-Ut);return Lr(n,t),e},Rr=({canvasWidth:n,groupOnColumn:e,config:t,miniColumn:o})=>O(()=>{if(!Array.isArray(t)||n==null||n===0)return[];const r=t.map((i,l)=>({minWidth:i.minWidth,width:i.width,flex:i.flex,priority:i.priority,name:i.name,index:l,hidden:i.name===e?.name||i.disabled})).map(i=>o?{...i,hidden:o.name!==i.name}:i).sort(({index:i,priority:l},{index:a,priority:s})=>l===s?a-i:l-s);return Xt(r,n,r.length)},[n,e,t]),Nr=({host:n,canvasWidth:e,columns:t})=>{const o=n.miniBreakpoint??480,r=O(()=>e<=o,[e,o]),i=O(()=>r?t?.filter(u=>u.mini!=null).sort((u,c)=>(u.mini??0)-(c.mini??0)):[],[t,r]),[l,...a]=i??[],s=!!l;return E(()=>{n.toggleAttribute("mini",s)},[s]),{isMini:s&&r,miniColumn:l,miniColumns:a}},jr=({host:n,canvasWidth:e,layout:t,setSettings:o,requestTween:r})=>{const i=He();i.current=l=>{r(),o(a=>{const s=a.columns,{detail:{newWidth:u,column:c}}=l,d=s.findIndex(h=>h.name===c.name),g=[],p=s.reduce((h,v)=>Math.max(h,v.priority),-1/0);for(let h=0;h<t.length;h++)if(g[h]={...s[h]},h<d&&t[h]&&(g[h].width=t[h],g[h].flex=0,g[h].priority=p),h===d){const v=t.reduce((x,b,y)=>y<d&&b?x-b:x,e);g[h].width=Math.min(v,Math.max(u,s[h].minWidth)),g[h].flex=0,g[h].priority=p}return{...a,columns:g}})},E(()=>{const l=a=>i.current?.(a);return n.addEventListener("column-resize",l),()=>n.removeEventListener("column-resize",l)},[])},Pr=(n,e)=>{const t=O(()=>{let o=!1,r;const i=()=>{if(!o)return;r=requestAnimationFrame(i),n()&&(o=!1)};return{start:()=>{o=!0,cancelAnimationFrame(r),r=requestAnimationFrame(i)},stop:()=>{o=!1,cancelAnimationFrame(r)}}},[]);E(()=>{t.start()},e),E(()=>()=>t.stop(),[])},Br=(n=0,e=0)=>Math.abs(n-e)<.1,Hr=(n,e=1.9,t=hn,o)=>{const r=ke({target:n,speedFactor:e,onConverge:o}),i=S(()=>{if(!r.tween)return r.tween=r.target,t(r.tween),r.onConverge?.(),!0;if(r.target.every((l,a)=>r.tween[a]===l))return t(r.tween),r.onConverge?.(),!0;if(r.tween=r.target.map((l,a)=>Br(r.tween[a],l)?l:(r.tween[a]??0)+((l??0)-(r.tween[a]??0))/r.speedFactor||0),t(r.tween),r.tween.every((l,a)=>l===r.target[a]))return r.onConverge?.(),!0},[]);Pr(i,[n])},Gr=n=>{const e=O(()=>new CSSStyleSheet,[]);return E(()=>{n.shadowRoot.adoptedStyleSheets=[...n.shadowRoot.adoptedStyleSheets,e]},[]),e},Wr=({host:n,columns:e,settings:t,setSettings:o,resizeSpeedFactor:r,sortAndGroupOptions:i})=>{const l=Mr(n),{isMini:a,miniColumn:s,miniColumns:u}=Nr({host:n,canvasWidth:l,columns:e}),{groupOnColumn:c}=i,d=Rr({canvasWidth:l,groupOnColumn:c,miniColumn:s,config:t.columns}),g=Gr(n),p=O(()=>t.columns.reduce((w,f,$)=>d[$]!=null||f.name===c?.name||f.disabled?w:[...w,e.find(z=>z.name===f.name)],[]),[e,t,d]),[h,v]=N(1),x=S(()=>v(r??1.9),[r]),b=S(()=>v(1),[]),y=ke({columns:t.columns});return Hr(d,h,w=>{const f=Ar(w,y.columns);g.replace(f)},b),jr({host:n,canvasWidth:l,layout:d,setSettings:w=>o(w(t)),requestTween:x}),{isMini:a,collapsedColumns:p,miniColumns:u,requestTween:x}},qr=({host:n,...e})=>{const{csvFilename:t="omnitable.csv",xlsxFilename:o="omnitable.xlsx",xlsxSheetname:r="Omnitable",topPlacement:i="top-end"}=n;return{csvFilename:t,xlsxFilename:o,xlsxSheetname:r,topPlacement:i,...e}},Xr=({host:n,selectedItems:e,data:t,sortAndGroupOptions:o,collapsedColumns:r,settings:i,filterFunctions:l,settingS:a,filters:s,requestTween:u,...c})=>{const d=e===M||t&&t.length>0&&e.length===t.length,g=x=>{x.target.checked?n.shadowRoot.querySelector("#groupedList").selectAll():n.shadowRoot.querySelector("#groupedList").deselectAll()},{groupOnColumn:p}=o,h=O(()=>[p,...r,...i.columns.filter(x=>x.disabled)].some(x=>x&&Object.keys(l).includes(x.name)),[l,i,r]),v=O(()=>({...a,collapsed:r,badge:h,filters:s,requestTween:u}),[a,r,h,s,u]);return E(()=>{const x=n.shadowRoot.querySelector("#tableContent"),b=new ResizeObserver(y=>requestAnimationFrame(()=>{n.style.setProperty("--ot-height",y[0]?.contentRect.height+"px")}));return b.observe(x),()=>b.unobserve(x)},[]),{allSelected:d,onAllCheckboxChange:g,data:t,settingsConfig:v,filters:s,groupOnColumn:p,sortAndGroup:o.sortAndGroup,...c}},Kt=m`
	<svg
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
...
`,Ur=n=>n?"groupRow groupRow-folded":"groupRow",Kr=({item:n,index:e})=>t=>I(t?.length>0,()=>m`
			...
			`),Qr=({columns:n,collapsedColumns:e,miniColumns:t,onItemClick:o,onCheckboxChange:r,dataIsValid:i,groupOnColumn:l,onItemChange:a,rowPartFn:s})=>(u,c,{selected:d,expanded:g,toggleCollapse:p})=>m`
		<div
			?selected=${d}
	...
	`,Jr=({onCheckboxChange:n,dataIsValid:e,groupOnColumn:t})=>(o,r,{selected:i,folded:l,toggleFold:a})=>m` <div
			class="${Ur(l)}"
		...
		</div>`,Yr=({host:n,error:e,dataIsValid:t,processedItems:o,columns:r,collapsedColumns:i,miniColumns:l,sortAndGroupOptions:a,rowPartFn:s,...u})=>{const{loading:c=!1,displayEmptyGroups:d=!1,compareItemsFn:g}=n,p=He({shiftKey:!1,ctrlKey:!1}),h=S(y=>{const w=y.target.dataItem,f=y.target.checked;p.current.shiftKey?n.shadowRoot.querySelector("#groupedList").toggleSelectTo(w,f):p.current.ctrlKey?(y.target.checked=!0,n.shadowRoot.querySelector("#groupedList").selectOnly(w)):n.shadowRoot.querySelector("#groupedList").toggleSelect(w,f),y.preventDefault(),y.stopPropagation()},[]);E(()=>{const y=({shiftKey:w,ctrlKey:f})=>{p.current={shiftKey:w,ctrlKey:f}};return window.addEventListener("keydown",y),window.addEventListener("keyup",y),()=>{window.removeEventListener("keydown",y),window.removeEventListener("keyup",y)}},[]);const v=S(y=>{const w=y.composedPath();w.slice(0,w.indexOf(y.currentTarget)).find($=>$.matches?.("a, .checkbox, .expand"))||n.dispatchEvent(new window.CustomEvent("omnitable-item-click",{bubbles:!0,composed:!0,detail:{item:y.currentTarget.dataItem,index:y.currentTarget.dataIndex}}))},[]),{groupOnColumn:x}=a,b=S((y,w)=>f=>Jn(n,y,w,f),[]);return{...u,processedItems:o,dataIsValid:t,filterIsTooStrict:t&&o.length<1,loading:c,compareItemsFn:g,displayEmptyGroups:d,error:e,renderItem:O(()=>Qr({columns:r,collapsedColumns:i,miniColumns:l,onItemClick:v,onCheckboxChange:h,dataIsValid:t,groupOnColumn:x,onItemChange:b,rowPartFn:s}),[r,i,v,h,t,x,b,s]),renderGroup:O(()=>Jr({onCheckboxChange:h,dataIsValid:t,groupOnColumn:x}),[h,t,x])}},Zr=(n,e)=>{if(n===e)return 0;if(n==null)return-1;if(e==null)return 1;const t=typeof n,o=typeof e;return t==="object"&&o==="object"?n.toString()<e.toString()?-1:1:t==="number"&&o==="number"?n-e:t==="string"&&o==="string"?n<e?-1:1:t==="boolean"&&o==="boolean"?n?-1:1:(console.warn("unsupported sort",t,n,o,e),0)},Ee=(n,e)=>(t,o)=>Zr(n(t),n(o))*(e?-1:1),ei=n=>n.replace(/([a-z0-9])([A-Z])/gu,"$1-$2").toLowerCase(),yt=(n,e)=>{!n||!e||Object.entries(e).forEach(([t,o])=>{n[j].__ownChange=!0,n[j][t]=o,n[j].__ownChange=!1,n[j].dispatchEvent(new CustomEvent(`${ei(t)}-changed`,{bubbles:!0,detail:{value:o}}))})},Le=(n,e)=>Object.assign(n,{[ve]:e}),pe=Symbol("unparsed"),ti=({data:n,columns:e,hashParam:t,sortAndGroupOptions:o,noLocalSort:r,noLocalFilter:i})=>{const{groupOnColumn:l,groupOnDescending:a,sortOnColumn:s,descending:u}=o,c=S(([f,$])=>{const z=e.find(({name:_})=>_===f);return z==null?[f,void 0]:[f,$.filter&&z.serializeFilter(z,$.filter)]},[e]),d=S(([f,$])=>{const z=e.find(({name:F})=>F===f);if(z==null)return[f,{[pe]:$}];const _={filter:z.deserializeFilter(z,$)};return yt(z,_),[f,_]},[e]),[g,p]=Z({},t,{multi:!0,suffix:"-filter--",write:c,read:d}),h=S((f,$)=>p(z=>{const _=ze($,z[f]);return yt(e.find(F=>F.name===f),_),{...z,[f]:{...z[f],..._}}}),[e,p]),v=O(()=>Object.values(g).map(f=>f.filter),[g]),x=O(()=>Object.fromEntries(e.map(f=>[f.name,!f.noLocalFilter&&f.getFilterFn(f,g[f.name]?.filter)]).filter(([,f])=>!!f)),[e,...v]),b=O(()=>!Array.isArray(n)||n.length===0?[]:Object.entries(x).length===0||i?n.slice():n.filter(f=>Object.values(x).every($=>$(f))),[n,x,i]),y=O(()=>{if(!r&&!l&&s!=null&&s.sortOn!=null)return b.slice().sort(Ee(f=>s.getComparableValue({...s,valuePath:s.sortOn},f),u));if(l!=null&&l.groupOn!=null){const f=b.reduce(($,z)=>{const _=l.getComparableValue({...l,valuePath:l.groupOn},z);if(_===void 0)return $;let F=$.find(X=>X.id===_);return F?(F.items.push(z),$):(F={id:_,name:_,items:[z]},[...$,F])},[]);return f.sort(Ee($=>l.getComparableValue({...l,valuePath:l.groupOn},$.items[0]),a)),!s||r?f:f.filter($=>Array.isArray($.items)).map($=>($.items.sort(Ee(z=>s.getComparableValue({...s,valuePath:s.sortOn},z),u)),$))}return b},[b,l,a,s,u,r]),w=O(()=>{let f=0,$=0;const z=[];return y.forEach(_=>{if(Array.isArray(_.items)){Le(_,$++),_.items.forEach(F=>{Le(F,f++),z.push(F)});return}return Le(_,f++),z.push(_)},[]),z},[y]);return E(()=>{p(f=>Object.values(f).some(z=>z[pe]!=null)?Object.fromEntries(Object.entries(f).map(([z,_])=>_[pe]==null?[z,_]:d([z,_[pe]]))):f)},[d]),{processedItems:y,visibleData:w,filters:g,filterFunctions:x,setFilterState:h}},ni=n=>{const e=o=>{const r=n.data.indexOf(o);if(r<0)return null;const i=n.data.splice(r,1);if(n.data=n.data.slice(),Array.isArray(i)&&i.length>0)return i[0]},t=(o,r)=>{n.data.splice(o,1,r),n.data=n.data.slice()};return{removeItem:e,removeItems(o){const r=[];for(let i=o.length-1;i>=0;i-=1){const l=n.removeItem(o[i]);l!=null&&r.push(l)}return r},replaceItemAtIndex:t,replaceItem(o,r){const i=n.data.indexOf(o);if(i>-1)return t(i,r)},selectItem(o){n.shadowRoot.querySelector("#groupedList").select(o)},selectAll(){n.shadowRoot.querySelector("#groupedList").selectAll()},deselectAll(){n.shadowRoot.querySelector("#groupedList").deselectAll()},deselectItem(o){n.shadowRoot.querySelector("#groupedList").deselect(o)},isItemSelected(o){return n.shadowRoot.querySelector("#groupedList").isItemSelected(o)}}},oi=({host:n,visibleData:e,filters:t,...o})=>{const{setFilterState:r}=o,i=O(()=>ni(n),[]),[l,a]=At("selectedItems",[]);Pe(o,Object.values(o)),Pe(i,Object.values(i)),E(()=>{const u=c=>r(c.detail.name,d=>({...d,...c.detail.state}));return n.addEventListener("legacy-filter-changed",u),()=>n.removeEventListener("legacy-filter-changed",u)},[]),U("visibleData",e),U("sortedFilteredGroupedItems",o.sortedFilteredGroupedItems),U("sortOn",o.sortOn),U("descending",o.descending),U("isMini",o.isMini);const s=O(()=>Object.fromEntries(Object.entries(t).filter(([,{filter:u}])=>u!==void 0).map(([u,{filter:c}])=>[u,c])),[t]);return U("filters",s,Object.values(s)),{selectedItems:l,setSelectedItems:a}},ri=n=>{const{hashParam:e,settingsId:t,data:o,resizeSpeedFactor:r,noLocal:i,noLocalSort:l=i,noLocalFilter:a=i,error:s,rowPartFn:u}=n,c=Fr({settingsId:t,host:n}),{settings:d,setSettings:g,columns:p,resetRef:h,savedSettings:v}=c,x=v!==void 0,b=Jo(p,e,{settings:d,setSettings:g,resetRef:h,ready:x}),{processedItems:y,visibleData:w,filters:f,setFilterState:$,filterFunctions:z}=ti({data:o,columns:p,hashParam:e,sortAndGroupOptions:b,noLocalSort:l,noLocalFilter:a}),{isMini:_,collapsedColumns:F,miniColumns:X,requestTween:G}=Wr({host:n,columns:p,settings:d,setSettings:g,resizeSpeedFactor:r,sortAndGroupOptions:b}),Ye=o&&Array.isArray(o)&&o.length>0,{selectedItems:Ae,setSelectedItems:Ze}=oi({host:n,visibleData:w,sortedFilteredGroupedItems:y,columns:p,filters:f,setFilterState:$,isMini:_,...b}),et=Xr({host:n,selectedItems:Ae,sortAndGroupOptions:b,dataIsValid:Ye,data:o,columns:p,filters:f,collapsedColumns:F,settings:d,filterFunctions:z,settingS:c,setFilterState:$,hideSelectAll:n.hideSelectAll===!0,requestTween:G});return{header:et,list:Yr({host:n,error:s,dataIsValid:Ye,processedItems:y,selectedItems:Ae,setSelectedItems:Ze,columns:p,collapsedColumns:F,miniColumns:X,sortAndGroupOptions:b,rowPartFn:u}),footer:qr({host:n,selectedItems:Ae,allSelected:et.allSelected,setSelectedItems:Ze,columns:p,enableSelectAll:n.enableSelectAll,allItemsCount:n.allItemsCount})}};customElements.define("cosmoz-grouped-list-row",class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||Me(this._renderFn(this._item,this._index),this)}});const ii={group:Symbol("group")},De=(n,e)=>(e.has(n)||e.set(n,{}),e.get(n)),li=(n,e)=>!!De(n,e).expanded,ai=(n,e)=>!!De(n,e).folded,$e=n=>n?n.items instanceof Array:!1,si=n=>{if(!Array.isArray(n)||n.length===0)return;const e=Array.isArray(n[0]?.items);if(!n.every(o=>Array.isArray(o.items)===e))throw new Error("Data must be homogeneous.")},ui=(n,e,t)=>Array.isArray(n)?(si(n),n.reduce((r,i)=>{const l=i;return l.items?l.items.length?De(i,t).folded?r.concat(i):r.concat(i,l.items.map(a=>Object.assign(a,{[ii.group]:i}))):e?r.concat(i):r:r.concat(i)},[])):void 0,ci=(n,...e)=>typeof n=="function"?n(...e):n,di=(n,e)=>n===e,mi=()=>{const[n,e]=N(()=>[new WeakMap]);return{setItemState:S((o,r)=>e(([i])=>{const l=De(o,i);return Object.assign(l,ci(r,l)),[i]}),[]),state:n[0],signal:n}},pi=()=>{const{setItemState:n,state:e,signal:t}=mi(),o=S((i,l)=>{$e(i)&&n(i,a=>({folded:l!==void 0?l:!a.folded}))},[]),r=S((i,l)=>{$e(i)||n(i,a=>({expanded:l!==void 0?!l:!a.expanded}))},[]);return{state:e,signal:t,toggleFold:o,toggleCollapse:r}},gi=({compareItemsFn:n,data:e,flatData:t})=>{const[o,r]=At("selectedItems",()=>[]),[i,l]=N(),a=S(b=>o===M||o.includes(b),[o]),s=S(b=>o===M||(b?.items?.every(a)??!1),[o,a]),u=S(b=>a(b)||s(b),[a,s]),c=S(b=>{const w=b.items??[b];r(f=>f===M?f:[...f,...w.filter($=>!f.includes($))]),l(b)},[]),d=S(b=>{const w=b.items??[b];r(f=>f===M?(t??[]).filter($=>!$e($)).filter($=>!w.includes($)):f.filter($=>!w.includes($))),l(b)},[t]),g=S(b=>{r(b.items?.slice()||[b]),l(b)},[]),p=S(()=>{r(e.flatMap(b=>b.items||b)),l(void 0)},[e]),h=S(()=>{r([]),l(void 0)},[]),v=S((b,y=!u(b))=>y?c(b):d(b),[u]),x=S((b,y)=>{if(!t)return;const w=i?t.findIndex(z=>n(z,i)):-1;if(w<0)return v(b,y);const[f,$]=[w,t.indexOf(b)].sort((z,_)=>z-_);t.slice(f,$+1).forEach((z,_,F)=>{_>0&&_<F.length-1&&$e(z)||v(z,y)}),l(b)},[t,n,v]);return E(()=>r(b=>b!==M&&b.length>0&&t?t.filter(y=>b.find(w=>n(y,w))):b),[t]),{selectedItems:o,isItemSelected:a,isGroupSelected:s,isSelected:u,select:c,deselect:d,selectOnly:g,selectAll:p,deselectAll:h,toggleSelect:v,toggleSelectTo:x}},hi={host:{position:"relative",display:"flex",flexDirection:"column"}},fi=n=>{const{data:e,renderItem:t,renderGroup:o,displayEmptyGroups:r,compareItemsFn:i=di}=n,{toggleFold:l,toggleCollapse:a,state:s,signal:u}=pi(),c=O(()=>ui(e,r,s),[e,r,u]),{selectedItems:d,isItemSelected:g,isGroupSelected:p,isSelected:h,select:v,deselect:x,selectOnly:b,selectAll:y,deselectAll:w,toggleSelect:f,toggleSelectTo:$}=gi({compareItemsFn:i,data:e,flatData:c}),z=S((F,X)=>Array.isArray(F.items)?o(F,X,{selected:p(F),folded:ai(F,s),toggleSelect:G=>f(F,typeof G=="boolean"?G:void 0),toggleFold:()=>l(F)}):t(F,X,{selected:g(F),expanded:li(F,s),toggleSelect:G=>f(F,typeof G=="boolean"?G:void 0),toggleCollapse:()=>a(F)}),[t,o,d,f,u]);St(()=>{Object.assign(n.style,hi.host)},[]);const _={toggleFold:l,toggleCollapse:a,isItemSelected:g,isGroupSelected:p,isSelected:h,select:v,deselect:x,selectOnly:b,selectAll:y,deselectAll:w,toggleSelect:f,toggleSelectTo:$};return Pe(_,Object.values(_)),{renderRow:z,flatData:c}},bi=({renderRow:n,flatData:e})=>fn({items:e,renderItem:(t,o)=>m`<cosmoz-grouped-list-row
				.item=${t}
				.index=${o}
				.renderFn=${n}
			></cosmoz-grouped-list-row>`}),xi=n=>bi(fi(n));customElements.define("cosmoz-grouped-list",V(xi,{useShadowDOM:!1}));const vi=n=>window.ShadyCSS?.ApplyShim?.transformCssText?.(n)||n,yi=n=>{const{header:e,list:t,footer:o}=ri(n);return m`
		<style>
			${bn([],()=>vi(ir))}
		</style>
