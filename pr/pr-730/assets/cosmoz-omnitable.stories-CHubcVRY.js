import{x as c,B as _e,E as Le}from"./iframe-DyBE-ih9.js";import{t as K,c as O,g as C,P as I,u as T,a as ht,m as xt,s as Vt,D as Nt,b as Rt,e as Bt,i as ye,h as Oe,o as $e,d as A,f as Gt,j as we,p as fe,n as _,k as Ht,l as Ce,q as jt,r as Wt,v as Ut,T as Kt,w as Jt,x as M,y as Xt,z as Qt,A as Yt,B as $,C as Zt,E as ei,F as vt,G as De,H as F,I as yt,J as Te,K as ti,L as $t,N as ii,M as ai,O as Pe,Q as ni,R as Ve,S as oi,U as ri,V as Ee,W as Ne,X as li,Y as Ie,Z as N,_ as si,$ as ze,a0 as ui}from"./cosmoz-collapse-CPWc2Muf.js";import"./preload-helper-D9Z9MdNV.js";const di=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`;customElements.define("cosmoz-clear-button",O(ci));const U=({valuePath:i},e)=>C(e,i),mi=U,pi=U,gi=({valuePath:i},e)=>t=>{const a=C(t,i);return a==null?!1:a.toString().toLowerCase().trim().includes(e.toLowerCase().trim())},bi=(i,e)=>e===""||e==null?null:e,P=i=>class extends i{static get properties(){return{isOmnitableColumn:{type:Boolean,value:!0},title:{type:String},valuePath:{type:String,notify:!0},values:{type:Array,notify:!0},filter:{type:Object},noLocalFilter:{type:Boolean},disabled:{type:Boolean,value:!1,notify:!0},editable:{type:Boolean,notify:!0},loading:{type:Boolean,value:!1,notify:!0},externalValues:{type:Boolean,value:!1,notify:!0},name:{type:String},sortOn:{type:String},groupOn:{type:String},width:{type:String,value:"75px"},minWidth:{type:String,value:"40px"},flex:{type:String,value:"1"},cellClass:{type:String,value:"default-cell"},headerCellClass:{type:String,value:"default-header-cell"},priority:{type:Number,value:0},hidden:{type:Boolean,notify:!0},preferredDropdownHorizontalAlign:{type:String,value:"right"},renderHeader:{type:Function},renderCell:{type:Function},renderEditCell:{type:Function},renderGroup:{type:Function},mini:{type:Number,value:null},renderMini:{type:Function}}}static get observers(){return["notifyFilterChange(filter)"]}notifyFilterChange(e){this.__ownChange||this.dispatchEvent(new CustomEvent("legacy-filter-changed",{detail:{name:this.name,state:this.legacyFilterToState(e)},bubbles:!0}))}legacyFilterToState(e){return{filter:e}}getFilterFn(){}getString(e,t){return U(e,t)}toXlsxValue(e,t){return mi(e,t)}cellTitleFn(e,t){return this.getString(e,t)}headerTitleFn(e){return e.title}serializeFilter(e,t){return bi(e,t)}deserializeFilter(e,t){return t==null?null:typeof t=="string"?window.decodeURIComponent(t):t}getComparableValue(e,t){return pi(e,t)}computeSource(e,t){return t}_propertiesChanged(e,t,a){super._propertiesChanged(e,t,a),this.dispatchEvent(new CustomEvent("cosmoz-column-prop-changed",{bubbles:!0}))}},fi=i=>e=>i(t=>{if(t.inputValue===void 0&&e.target.value==="")return t;clearTimeout(t.t);const a=setTimeout(()=>i(n=>({...n,filter:n.inputValue})),1e3);return{...t,inputValue:e.target.value,t:a}}),hi=i=>()=>i(e=>({...e,filter:e.inputValue})),xi=i=>e=>{e.keyCode===13&&(e.preventDefault(),i(t=>({...t,filter:t.inputValue})))},vi=i=>e=>i(t=>({...t,headerFocused:e.detail.value})),yi=i=>()=>i(e=>({...e,filter:null,inputValue:null})),$i=i=>i!=null&&i!=="";class wi extends P(I){static get properties(){return{minWidth:{type:String,value:"55px"},editMinWidth:{type:String,value:"55px"},inputValue:{type:Object,notify:!0}}}getFilterFn(e,t){if(!(t==null||t===""))return gi(e,t)}renderCell(e,{item:t}){return c`<span class="default-column">${U(e,t)}</span>`}renderEditCell(e,{item:t},a){return c`<cosmoz-input
		...
		`}_fromInputString(e,t){const a=this.toDate(e);if(a!=null)return t==="min"&&a.setHours(0,0,0,0),t==="max"&&a.setHours(23,59,59),a}_filterInputChanged(e,t){const a=e.path.split(".")[1],n=a&&e.value;if(n&&n.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}}customElements.define("cosmoz-omnitable-date-range-input",aa);const na=i=>{const e=-new Date(i).getTimezoneOffset()/60;return(e<0?"-":"+")+["0",Math.abs(e)].join("").substr(-2)+":00"},Xe=i=>i.length===19?i+na(i):i,qt=i=>{if(i==null||i==="")return;let e=i;return!(e instanceof Date)&&(typeof i=="string"&&(e=Xe(e)),e=jt(e),!e)||Number.isNaN(e.getTime())?null:e},V=({valuePath:i},e)=>{if(e==null)return;let t=e;i!=null&&(t=C(e,i));const a=qt(t);if(a!=null)return L(a.getTime())},E=(i,e,t)=>{const a=qt(i);return a??null},Qe=(i,e)=>{if(e==null)return;const t=E(i);if(t!=null)return e.format(t)},le={},oa=i=>{const e=i||"";return le[e]||(le[e]=new Intl.DateTimeFormat(i||void 0)),le[e]},rt=({valuePath:i,locale:e},t)=>{let a=C(t,i||"");return a===void 0?"":(a=E(a),a===null?"Invalid Date":Qe(a,oa(e)))},At=i=>{const e=E(i);if(e==null)return null;const t=Ce(e);return t==null?null:t.slice(0,10)},ra=({valuePath:i},e)=>At(C(e,i||"")),Ft=(i,e)=>{const t=E(i);if(t!=null)return t},lt=i=>{const e=At(i);return e??""},la=({valuePath:i},e)=>{if(!i)return"";const t=E(C(e,i));if(!t)return"";const a=E(Ce(t));return a?(a.setHours(0,0,0,0),a):""},kt=(i,e)=>t=>{const a=V(i,t);if(a==null)return!1;const n=V({...i,valuePath:"min"},e),o=V({...i,valuePath:"max"},e);return!(a<(n??-1/0)||a>(o??1/0))};class sa extends P(I){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"date-header-cell"},width:{type:String,value:"100px"},minWidth:{type:String,value:"82px"},flex:{type:String,value:"0"}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const a=V({...e,valuePath:"min"},t),n=V({...e,valuePath:"max"},t);if(!(a==null&&n==null))return kt(e,t)}getString(e,t){return rt(e,t)}toXlsxValue(e,t){return la(e,t)}getComparableValue(e,t){return V(e,t)}serializeFilter(e,t){if(t==null)return;const a=E(t.min),n=E(t.max);if(!(a==null&&n==null))return lt(a)+"~"+lt(n)}deserializeFilter(e,t){if(t==null||t==="")return null;const a=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(a)?{min:E(a[1]),max:E(a[2])}:null}renderCell(e,{item:t}){return c`<div class="omnitable-cell-date">
			${rt(e,t)}
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:a},n,o){return c`<cosmoz-autocomplete-ui
			...
			.onText=${We(n)}
			>${_(e.loading,()=>c`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}}customElements.define("cosmoz-omnitable-column-list",da);const _t=({title:i,tooltip:e="",filterText:t="",headerFocused:a=!1,onOpenedChanged:n,content:o,horizontalAlign:r="left"})=>c`
		<style>
			.dropdown-content h3 {
				font-weight: 500;
				font-size: 13px;
		...
		<cosmoz-dropdown
			@focus=${n}
			@focusout=${n}
			class=${Jt({focused:a,filtered:!!t,left:r==="left",right:r==="right",center:r==="center"})}
			title=${e||""}
		>
	...
	`;class ca extends Re(ae(I)){static get properties(){return{maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null},formatter:{type:Object,computed:"_computeFormatter(locale, minimumFractionDigits, maximumFractionDigits)"},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, formatter)"},headerFocused:{type:Boolean,value:!1}}}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return c`
			...
			${_t({title:this.title,tooltip:this._tooltip,filterText:this._filterText,headerFocused:this.headerFocused,horizontalAlign:"right",onOpenedChanged:e,content:c`
					<h3>${this.title}</h3>
					<cosmoz-input
						class=${this._fromClasses}
						type="number"
