import{b as d,D as ke,A as xt}from"./iframe-D_BheyCa.js";import{t as K,c as O,g as w,P as E,u as T,a as yt,m as vt,s as Rt,D as Bt,b as Gt,e as Ht,i as $e,h as Oe,d as jt,f as $t,r as Wt,j as Ut,k as A,l as Kt,n as Ce,p as he,o as k,q as Jt,v as we,w as Xt,x as Qt,y as Yt,T as Zt,z as M,A as Ye,B as ei,C as ti,E as ii,F as $,G as ai,H as ni,I as Ct,J as Le,K as F,L as wt,M as De,N as oi,O as St,Q as ri,R as Te,S as Ze,U as li,V as Pe,W as si,X as ui,Y as Ie,Z as Ve,_ as ci,$ as Ee,a0 as N,a1 as di,a2 as ze,a3 as mi}from"./cosmoz-collapse-CMPgVQc0.js";import"./preload-helper-PPVm8Dsz.js";const pi=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,Li=i=>{const{label:e,value:t,slot:a}=i,n=d`<div
	...
	`};class Di extends Ne(ae(E)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return d`
		...
		</cosmoz-input>`}renderHeader({title:e,min:t,max:a,limits:n,locale:o,rates:r,currency:l,autoupdate:u,autodetect:s},{filter:c},m,f){return d`<cosmoz-omnitable-amount-range-input
			.title=${e}
			.filter=${c}
			.values=${f}
			.rates=${r}
		...
		>`}getComparableValue(e,t){return Qi(e,t)}}customElements.define("cosmoz-omnitable-column-autocomplete",Yi);const Ue=(i,e)=>e.find(({value:t})=>i===t),Zi=(i,e,t)=>{const a=Ue(e,t);return a?a.text:i},ot=(i,e,t,a)=>Zi(i,w(e,t),a),ea=({valuePath:i},e,t)=>Ue(w(e,i),t),ta=i=>e=>{i(t=>({...t,filter:e?.[0]?.value??null}))},ia=i=>e=>{i(t=>({...t,headerFocused:e}))},aa=i=>e=>{i(t=>({...t,query:e}))},na=i=>e=>i(e?.[0]?.value),rt=({valuePath:i,trueLabel:e,falseLabel:t},a)=>w(a,i)?e:t,oa=({valuePath:i},e)=>t=>w(t,i)===e,le=vt((i,e)=>[{text:i,value:!0},{text:e,value:!1}]),ra=({valuePath:i,trueLabel:e,falseLabel:t},a)=>i?w(a,i)?e:t:"",la=(i,e)=>{try{return JSON.parse(e)}catch{return null}};class sa extends P(E){static get properties(){return{trueLabel:{type:String,value:"True"},falseLabel:{type:String,value:"False"},flex:{type:String,value:"0"},cellClass:{type:String,value:"boolean-cell"}}}getString(e,t){return rt(e,t)}renderCell(e,{item:t}){return rt(e,t)}renderEditCell(e,{item:t},a){const{trueLabel:n,falseLabel:o}=e;return d`<cosmoz-autocomplete
			no-label-float
		...
		></cosmoz-input>`}renderHeader({title:e,min:t,max:a,limits:n,locale:o,maximumFractionDigits:r,minimumFractionDigits:l,autoupdate:u},{filter:s},c,m){return d`<cosmoz-omnitable-number-range-input
			...
			.autoupdate=${u}
			@filter-changed=${({detail:{value:f}})=>c(p=>({...p,filter:f}))}
			@header-focused-changed=${({detail:{value:f}})=>c(p=>({...p,headerFocused:f}))}
		...
		></cosmoz-input>`}renderHeader({title:e,min:t,max:a,locale:n,filterStep:o},{filter:r},l,u){return d`<cosmoz-omnitable-time-range-input
			...
			@filter-changed=${({detail:{value:s}})=>l(c=>({...c,filter:s}))}
			@header-focused-changed=${({detail:{value:s}})=>l(c=>({...c,headerFocused:s}))}
		></cosmoz-omnitable-time-range-input>`}computeSource(e,t){return ie(e,t)}}customElements.define("cosmoz-omnitable-column-time",Sa);const ce={},za=i=>{const e=i||"";if(ce[e])return ce[e];const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return ce[e]=new Intl.DateTimeFormat(i||void 0,t),ce[e]},qe=({valuePath:i,locale:e},t)=>{const a=I(w(t,i||""));return a===void 0?"":a===null?"Invalid Date":Xe(a,za(e))},qa=({valuePath:i},e)=>i?w(e,i):"",mt=i=>{const e=I(i);return e==null?"":e.toISOString().slice(0,19).replace(/:/gu,".")},pt=i=>{if(!(i==null||i==="")&&typeof i=="string")return I(i.replace(/\./gu,":")+"Z")};class Aa extends Ke(ae(E)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return d`
			<style>
...
`,Dt=i=>(e,t,a=ei)=>{const n=ni(),o=new URLSearchParams(n.hash.replace("#",""));return i(e,t,a,o),"#!"+Object.assign(n,{hash:o}).href.replace(location.origin,"")},Tt=i=>i==null||i==="",La=Dt((i,e,t,a)=>Tt(t(e))?a.delete(i):a.set(i,t(e))),Da=Dt((i,e,t,a)=>Object.entries(e).map(t).forEach(([n,o])=>Tt(o)?a.delete(i+n):a.set(i+n,o))),J=(i,e,{suffix:t="",read:a,write:n,multi:o}={})=>{const[r,l]=o?[Da,ti]:[La,ii],[u,s]=T(()=>e==null?i:l(e+t,a)??i),c=$(m=>s(f=>{const p=$e(m,f);return e!=null&&ai(r(e+t,p,n),null,{notify:!1}),p}),[e,t,r,n]);return[u,c]},Ta=i=>[!0,"true",1,"yes","on"].includes(i),de=i=>i===""||(i==null?void 0:Ta(i)),me=(i,e,t)=>$(a=>{i(a),t(n=>({...n,[e]:a}))},[i,e,t]),Pa=(i,e,t,a,n)=>{const[o,r]=J(t.sortOn,e,{suffix:"-sortOn"}),[l,u]=J(de(t.descending),e,{suffix:"-descending",read:de}),[s,c]=J(t.groupOn,e,{suffix:"-groupOn"}),[m,f]=J(de(t.groupOnDescending),e,{suffix:"-groupOnDescending",read:de}),p=F(()=>i.find(g=>g.name===o),[i,o]),z=F(()=>i.find(g=>g.name===s),[i,s]),h={groupOn:s,setGroupOn:me(c,"groupOn",a),groupOnDescending:m,setGroupOnDescending:me(f,"groupOnDescending",a),sortOn:o,setSortOn:me(r,"sortOn",a),descending:l,setDescending:me(u,"descending",a),columns:i},v=F(()=>h,Object.values(h)),_=$(g=>{r(g.sortPath),c(g.groupOn),u(g.descending),f(g.groupOnDescending)},[]);return M(()=>void(n.current=_),[]),{...v,sortAndGroup:v,groupOnColumn:z,sortOnColumn:p}},Qe=Ct();customElements.define("sort-and-group-provider",Qe.Provider);customElements.define("sort-and-group-consumer",O(({render:i})=>i(Le(Qe)),{useShadowDOM:!1}));const Va=({data:i,columns:e,groupOnColumn:t,filters:a,setFilterState:n,sortAndGroup:{sortOn:o,setSortOn:r,descending:l,setDescending:u}={}})=>wt(e,s=>s.name,s=>[d`<div
...
`,Za=({settingsConfig:i})=>{const{columns:e,collapsed:t}=i,a=e.filter(n=>!t.some(o=>o.name===n.name));return d`<div class="skeleton">
	...
	</div>`};customElements.define("cosmoz-omnitable-skeleton",O(Za,{styleSheets:[Ya]}));const en=(i,e)=>{const{settingsConfig:t}=i,{processedItems:a,dataIsValid:n,filterIsTooStrict:o,loading:r,displayEmptyGroups:l,compareItemsFn:u,setSelectedItems:s,renderItem:c,renderGroup:m,error:f}=e;return d`${k(!r&&!n&&!f,()=>d`<div class="tableContent-empty">
		...
		${k(f,()=>d`<div class="tableContent-empty overlay">
...
`,pe=i=>{const e=parseInt(i,10);return isFinite(e)?e:void 0},nn=i=>{const{config:e}=i,{settings:t,setSettings:a,collapsed:n}=e,o=Pe({collapsed:n,settings:t.columns,setSettings:$(r=>a(l=>({...l,columns:r})),[a])});return{...e,onDown:$(r=>{r.target.closest(".pull")&&(o.handle=r.currentTarget)},[o]),onDragStart:$(r=>{const{target:l}=r,u=pe(l.dataset.index);if(!o.handle?.contains(l)||u==null)return r.preventDefault();o.handle=null,r.dataTransfer.effectAllowed="move",r.dataTransfer.setData("omnitable/sort-index",u),r.dataTransfer.setData("text/plain",u),setTimeout(()=>l.classList.add("drag"),0),l.addEventListener("dragend",s=>s.target.classList.remove("drag"),{once:!0})},[o]),onDragEnter:$(r=>{const l=r.currentTarget;l===r.target&&(r.preventDefault(),r.dataTransfer.dropEffect="move",l.classList.add("dragover"))},[]),onDragOver:$(r=>{r.preventDefault(),r.currentTarget.classList.add("dragover")},[]),onDragLeave:$(r=>{const l=r.currentTarget;l.contains(r.relatedTarget)||l.classList.remove("dragover")},[]),onDrop:$(r=>{const l=pe(r.dataTransfer.getData("omnitable/sort-index")),u=pe(r.currentTarget.dataset.index),{settings:s,setSettings:c}=o;r.currentTarget.classList.remove("dragover"),r.preventDefault();const m=s.slice();m.splice(u+(l>=u?0:-1),0,m.splice(l,1)[0]),c(m)},[o]),onToggle:$(r=>{const{settings:l,setSettings:u}=o,s=l.map(m=>({...m,disabled:m.disabled||o.collapsed?.some(f=>f.name===m.name)})),c=pe(r.target.closest("[data-index]")?.dataset.index);s.splice(c,1,{...l[c],disabled:!r.target.checked,priority:r.target.checked?l.reduce((m,f)=>Math.max(m,f.priority),0)+1:l[c].priority}),u(s)},[o])}},on=[si({apply({availableHeight:i,elements:e}){Object.assign(e.floating.style,{maxHeight:`${Math.max(0,i)}px`})}}),...ui],rn=({onDragStart:i,onDragEnter:e,onDragOver:t,onDragLeave:a,onDrop:n,onDown:o,onToggle:r,collapsed:l,filters:u})=>(s,c)=>{const m=!!l?.find(p=>p.name===s.name),f=!s.disabled&&!m;return d` <div
			class="item"
			data-index=${c}
			@mousedown=${o}
			draggable="true"
...
`;customElements.define("cosmoz-omnitable-settings",O(sn,{styleSheets:[De(an)]}));const xe=["sortOn","descending","groupOn","groupOnDescending"],ge=i=>e=>typeof e=="object"&&e!==null&&"name"in e&&e.name===i,un=(i=[],e=[],t=[])=>{const a=e.filter(r=>i.some(ge(r.name))),n=i.filter(r=>r.name!=null&&!e.some(ge(r.name))&&!t.some(ge(r.name))),o=t.filter(r=>!e.some(ge(r.name)));return[...a,...o.flatMap(r=>{const l=i.find(u=>u.name===r.name);return l?{...r,title:l.title??r.title??"",minWidth:parseInt(l.minWidth??"0",10)}:[]}),...n.map(r=>{const{name:l,title:u,priority:s,minWidth:c,width:m,flex:f}=r;return{name:l??"",title:u??"",priority:s??0,minWidth:parseInt(c??"0",10),width:parseInt(m??"0",10),flex:parseInt(f??"0",10)}})]},cn=(i,e)=>({...e,...Ie(Array.from(xe))(i),columns:i.columns?.map(Ie(["name","priority","width","flex","disabled"]))}),dn=({columns:i,settings:e,savedSettings:t,initial:a})=>({...Object.fromEntries(xe.flatMap(o=>a?.[o]!=null?[[o,a[o]]]:[])),...t?Ie(Array.from(xe))(t):{},...e,columns:un(i,e?.columns,t?.columns)}),mn=({prefix:i="omnitable-"}={})=>({write:async(t,a)=>{const n=i+t;try{a?localStorage.setItem(n,JSON.stringify(a)):localStorage.removeItem(n)}catch(o){console.error(o)}},read:async t=>{if(t)try{const a=localStorage.getItem(i+t);return a==null?void 0:JSON.parse(a)}catch(a){console.error(a)}}}),pn=Ct(mn),gn=()=>{const i=Le(pn);return F(()=>i(),[i])},bn=(i,e,t,a)=>{const[n,o]=T(),{read:r,write:l}=gn();return M(async()=>{i&&o(await r(i))},[i,r]),{settingsId:i,savedSettings:n,onSave:$(async()=>{if(!i)return;const u=cn(e,n);await l(i,u),t(),o(u)},[e,n]),onReset:$(async u=>{t(),u.shiftKey&&(await l(i),o()),a?.()},[a]),hasChanges:e!=null}},fn=({settingsId:i,host:e})=>{const t=F(()=>Object.fromEntries(xe.map(h=>[h,e[h]])),[]),a=Ve(),n=$(()=>{a.current?.(t)},[t]),[o,r]=T(),[l,u]=T({columns:!0,sort:!0}),{savedSettings:s,...c}=bn(i,o,r,n),{enabledColumns:m}=e,f=Ii(e,{enabledColumns:m}),p=F(()=>dn({columns:f,settings:o,savedSettings:s,initial:t}),[f,o,s]),z=F(()=>p.columns.map(h=>f.find(v=>v.name===h.name)).filter(Boolean),[f,...p.columns.map(h=>h.name)]);return{...c,opened:l,setOpened:u,settings:p,columns:z,setSettings:r,resetRef:a}},ft=i=>Number.isFinite(i)?i:0,hn=(i,e)=>{const t=[];let[a,n]=i.reduce(([c,m],{width:f,flex:p})=>[c+f,m+p],[0,0]),o=e-a,r=ft(o/n),l=0,u=0,s=0;for(let c=0;c<i.length;c++){const{width:m,minWidth:f,flex:p}=i[c],z=o>=0?r*p:m*o/a;if(f>m+z){l+=m,u+=f,s+=p,t[c]=f;continue}if(p===0){l+=m,u+=m,t[c]=m;continue}}a-=l,o=e-u-a,n-=s,r=ft(o/n);for(let c=0;c<i.length;c++){if(t[c]!=null)continue;const{width:m,flex:f}=i[c],p=o>=0?r*f:m*o/a;t[c]=m+p}return t},ye=Symbol("index"),xn=(i,e)=>{if(typeof i.findLastIndex=="function")return i.findLastIndex(e);for(let t=i.length-1;t>=0;t--)if(e(i[t],t,i))return t;return-1},yn=(i,e)=>{const t=xn(i,r=>r!=null&&r>0),a=(r,l)=>`.cell[name="${r}"], cosmoz-omnitable-skeleton::part(cell-${r}){width: ${Math.floor(l)}px;padding: 0 min(3px, ${l/2}px)}`,n=r=>`cosmoz-omnitable-resize-nub[name="${r}"]{display:none}`,o=r=>`cosmoz-omnitable-resize-nub[name="${r}"], .cell[name="${r}"]{display:none}`;return e.map((r,l)=>{const u=i[l];if(u==null||u===0)return o(r.name);const s=a(r.name,u);return l===t?`${s}
${n(r.name)}`:s}).join(`
`)},Vt=(i,e,t)=>{const a=i.filter(l=>!l.hidden),n=a.reduce((l,{width:u})=>l+u,0);if(a.length>1&&n>e)return Vt(a.slice(1),e,t);const o=a.reduce(([l,u],s,c)=>[Math.max(l,s.index),s.index>l?c:u],[-1,-1])[1];return o!==-1&&(a[o].flex=1),hn(a,e).reduce((l,u,s)=>(l[a[s].index]=u,l),new Array(t).fill(void 0))},vn=(i,e)=>i.length===0?".cell {display: none;}":yn(i,e),$n=({host:i,canvasWidth:e,layout:t,setSettings:a})=>{const n=Ve();n.current=o=>a(r=>{const l=r.columns,{detail:{newWidth:u,column:s}}=o,c=l.findIndex(p=>p.name===s.name),m=[],f=l.reduce((p,z)=>Math.max(p,z.priority),-1/0);for(let p=0;p<t.length;p++)if(m[p]={...l[p]},p<c&&t[p]!=null&&(m[p].width=t[p],m[p].flex=0,m[p].priority=f),p===c){const z=t.reduce((h,v,_)=>_<c&&v?h-v:h,e);m[p].width=Math.min(z,Math.max(u,l[p].minWidth)),m[p].flex=0,m[p].priority=f}return{...r,columns:m}}),M(()=>{const o=r=>n.current?.(r);return i.addEventListener("column-resize",o),()=>i.removeEventListener("column-resize",o)},[])},Cn=(i,e)=>M(()=>{const t=([n])=>{n.contentRect?.width!==0&&requestAnimationFrame(()=>e(n.contentRect.width-20-44-24))},a=new ResizeObserver(t);return a.observe(i),()=>a.unobserve(i)},[]),wn=i=>{const[e,t]=T(()=>i.getBoundingClientRect().width);return Cn(i,t),e},Sn=(i,e)=>{const t=F(()=>{let a=!1,n;const o=()=>{if(!a)return;n=requestAnimationFrame(o),i()&&(a=!1)};return{start:()=>{a=!0,cancelAnimationFrame(n),n=requestAnimationFrame(o)},stop:()=>{a=!1,cancelAnimationFrame(n)}}},[]);M(()=>{t.start()},e),M(()=>()=>t.stop(),[])},zn=(i=0,e=0)=>Math.abs((i??0)-(e??0))<.1,qn=(i,e=1.9,t=ci)=>{const a=Pe({target:i}),n=$(()=>{if(a.tween||(a.tween=a.target),a.target.every((o,r)=>a.tween[r]===o))return t(a.tween),!0;a.tween=a.target.map((o,r)=>zn(a.tween[r],o)?o:(a.tween[r]??0)+((o??0)-(a.tween[r]??0))/e||0),t(a.tween)},[]);Sn(n,[i])},An=({canvasWidth:i,groupOnColumn:e,config:t,miniColumn:a})=>F(()=>{if(!Array.isArray(t)||i==null||i===0)return[];const n=t.map((o,r)=>({minWidth:o.minWidth,width:o.width,flex:o.flex,priority:o.priority,name:o.name,index:r,hidden:o.name===e?.name||o.disabled})).map(o=>a?{...o,hidden:a.name!==o.name}:o).sort(({index:o,priority:r},{index:l,priority:u})=>r===u?l-o:r-u);return Vt(n,i,n.length)},[i,e,t]),Fn=({host:i,canvasWidth:e,columns:t})=>{const a=i.miniBreakpoint??480,n=F(()=>e<=a,[e,a]),o=F(()=>n?t?.filter(s=>s.mini!=null).sort((s,c)=>(s.mini??0)-(c.mini??0)):[],[t,n]),[r,...l]=o??[],u=!!r;return M(()=>{i.toggleAttribute("mini",u)},[u]),{isMini:u&&n,miniColumn:r,miniColumns:l}},_n=i=>{const e=F(()=>new CSSStyleSheet,[]);return M(()=>{i.shadowRoot.adoptedStyleSheets=[...i.shadowRoot.adoptedStyleSheets,e]},[]),e},kn=({host:i,columns:e,settings:t,setSettings:a,resizeSpeedFactor:n,sortAndGroupOptions:o})=>{const r=wn(i),{isMini:l,miniColumn:u,miniColumns:s}=Fn({host:i,canvasWidth:r,columns:e}),{groupOnColumn:c}=o,m=An({canvasWidth:r,groupOnColumn:c,miniColumn:u,config:t.columns}),f=_n(i),p=F(()=>t.columns.reduce((h,v,_)=>m[_]!=null||v.name===c?.name||v.disabled?h:[...h,e.find(g=>g.name===v.name)].filter(g=>g!=null),[]),[e,t,m,c]),z=Pe({columns:t.columns});return qn(m,n,h=>{const v=vn(h,z.columns);f.replace(v)}),$n({host:i,canvasWidth:r,layout:m,setSettings:h=>a(h(t))}),{isMini:l,collapsedColumns:p,miniColumns:s}},In=({host:i,...e})=>{const{csvFilename:t="omnitable.csv",xlsxFilename:a="omnitable.xlsx",xlsxSheetname:n="Omnitable",topPlacement:o="top-end"}=i;return{csvFilename:t,xlsxFilename:a,xlsxSheetname:n,topPlacement:o,...e}},En=({host:i,selectedItems:e,data:t,sortAndGroupOptions:a,collapsedColumns:n,settings:o,filterFunctions:r,settingS:l,filters:u,...s})=>{const c=t&&t.length>0&&e.length===t.length,m=h=>{h.target.checked?i.shadowRoot.querySelector("#groupedList").selectAll():i.shadowRoot.querySelector("#groupedList").deselectAll()},{groupOnColumn:f}=a,p=F(()=>[f,...n,...o.columns.filter(h=>h.disabled)].some(h=>h&&Object.keys(r).includes(h.name)),[r,o,n]),z=F(()=>({...l,collapsed:n,badge:p,filters:u}),[l,n,p,u]);return M(()=>{const h=i.shadowRoot.querySelector("#tableContent"),v=new ResizeObserver(_=>requestAnimationFrame(()=>{i.style.setProperty("--ot-height",_[0]?.contentRect.height+"px")}));return v.observe(h),()=>v.unobserve(h)},[]),{allSelected:c,onAllCheckboxChange:m,data:t,settingsConfig:z,filters:u,groupOnColumn:f,sortAndGroup:a.sortAndGroup,...s}},Nt=d`
	<svg
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
...
`,Mn=i=>i?"groupRow groupRow-folded":"groupRow",On=({item:i,index:e})=>t=>k((t?.length??0)>0,()=>d`
			...
			`),Ln=({columns:i,collapsedColumns:e,miniColumns:t,onItemClick:a,onCheckboxChange:n,dataIsValid:o,groupOnColumn:r,onItemChange:l,rowPartFn:u})=>(s,c,{selected:m,expanded:f,toggleCollapse:p})=>d`
		<div
			?selected=${m}
