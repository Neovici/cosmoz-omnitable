import{x as c,B as qe,E as pt}from"./iframe-CWNceNQ3.js";import{t as K,c as O,g as C,P as M,u as T,a as gt,m as ft,s as Dt,D as Tt,b as Vt,e as Pt,i as be,h as _e,d as Nt,f as bt,r as Rt,j as Bt,k as z,l as Gt,n as he,p as me,o as k,q as Ht,v as xe,w as jt,x as Wt,y as Ut,T as Kt,z as E,A as Ue,B as Jt,C as Xt,E as Qt,F as $,G as Yt,H as Zt,I as ht,J as ke,K as F,L as xt,M as Ie,N as ei,O as vt,Q as ti,R as Me,S as Ke,U as ii,V as Ee,W as ai,X as ni,Y as Ae,Z as Oe,_ as oi,$ as ze,a0 as N,a1 as ri,a2 as ye,a3 as li}from"./cosmoz-collapse-BLyjJhGr.js";const si=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`;customElements.define("cosmoz-omnitable-item-expand-line",O(Ta,{styleSheets:[Ie(Da)]}));const Va=({columns:i,item:e,selected:t,expanded:a,groupOnColumn:n})=>ei(i,o=>c`<cosmoz-omnitable-item-expand-line
			...
			>`);customElements.define("cosmoz-omnitable-item-expand",O(Va,{useShadowDOM:!1}));const Pa=(i,e,t)=>i.editable?i.renderEditCell(i,e,t(i,e.item)):i.renderCell(i,e),Na=({columns:i,groupOnColumn:e,item:t,index:a,selected:n,expanded:o,onItemChange:r})=>xt(i,l=>l.name,l=>c`<div
				...
				name="${l.name}"
			>
				${Pa(l,{item:t,index:a,selected:n,expanded:o},r)}
			</div>`);customElements.define("cosmoz-omnitable-item-row",O(Na,{useShadowDOM:!1}));const Et=K`
	.checkbox {
		box-sizing: border-box;
		width: 18px;
		height: 18px;
