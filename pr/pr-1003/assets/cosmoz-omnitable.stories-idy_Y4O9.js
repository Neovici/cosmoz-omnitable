import{n as e}from"./chunk-BneVvdWh.js";import{$ as t,X as n,Z as r,et as i,n as a,t as o}from"./iframe-BqcOBB9r.js";import{$ as s,A as c,At as l,B as u,C as d,Ct as f,D as p,Dt as m,E as h,Et as g,F as _,Ft as v,G as y,H as b,I as x,It as ee,J as te,K as ne,L as re,Lt as ie,M as ae,N as oe,Nt as se,O as ce,Ot as S,P as le,Pt as C,Q as ue,R as de,S as fe,St as w,T as pe,Tt as T,U as me,V as he,W as ge,X as E,Y as _e,Z as D,_ as ve,_t as O,a as ye,at as be,b as k,bt as xe,c as Se,ct as Ce,d as we,dt as Te,et as Ee,f as De,ft as Oe,g as ke,gt as Ae,h as je,ht as Me,i as Ne,it as Pe,j as Fe,jt as Ie,k as Le,kt as Re,l as ze,lt as Be,m as Ve,mt as He,n as Ue,nt as A,o as We,ot as Ge,p as Ke,pt as qe,q as Je,r as Ye,rt as j,s as Xe,st as Ze,t as Qe,tt as $e,u as et,ut as tt,v as nt,vt as M,w as rt,wt as it,x as at,xt as ot,y as st,yt as ct,z as lt}from"./dist-BUZHXlGj.js";var ut,dt,ft=e((()=>{u(),O(),ut=b`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`}));function di(e,t,{suffix:n=``,read:r,write:i,ready:a=!0,multi:o}={}){let s=Te({param:t,suffix:n,link:o?hi:mi,write:i??be}),c=g(()=>{if(t==null)return!1;if(o){let e=et(t+n);return Object.keys(e).length>0}return we(t+n)!==void 0},[]),[l,u]=f(()=>{if(t==null)return e;if(o){let i=et(t+n,r);return Object.keys(i).length>0?i:e}return we(t+n,r)??e}),d=T(e=>u(t=>{let n=Ze(e,t);return s.param!=null&&Ke(s.link(s.param+s.suffix,n,s.write),null,{notify:!1}),n}),[]);return S(()=>{s.param==null||!a||c||e!=null&&d(e)},[a]),[l,d]}var fi,pi,mi,hi,gi=e((()=>{De(),Ge(),tt(),ze(),O(),fi=e=>(t,n,r=be)=>{let i=Se(),a=new URLSearchParams(i.hash.replace(`#`,``));return e(t,n,r,a),`#!`+Object.assign(i,{hash:a}).href.replace(location.origin,``)},pi=e=>e==null||e===``,mi=fi((e,t,n,r)=>pi(n(t))?r.delete(e):r.set(e,n(t))),hi=fi((e,t,n,r)=>{let i=Object.entries(t),a=i.map(n).filter(([,e])=>e!==void 0);if(a.length===0&&i.length>0)return;let o=e;Array.from(r.keys()).filter(e=>e.startsWith(o)).forEach(e=>r.delete(e)),a.forEach(([t,n])=>pi(n)?r.delete(e+t):r.set(e+t,n))})})),_i,vi,yi,bi,xi,Si=e((()=>{O(),gi(),_i=e=>[!0,`true`,1,`yes`,`on`].includes(e),vi=e=>e===``||(e==null?void 0:_i(e)),yi=(e,t,n)=>T(r=>{e(r),n(e=>({...e,[t]:r}))},[e,t,n]),bi=(e,t,{settings:n,setSettings:r,resetRef:i,ready:a=!0})=>{let[o,s]=di(n.sortOn,t,{suffix:`-sortOn`,ready:a}),[c,l]=di(vi(n.descending),t,{suffix:`-descending`,read:vi,ready:a}),[u,d]=di(n.groupOn,t,{suffix:`-groupOn`,ready:a}),[f,p]=di(vi(n.groupOnDescending),t,{suffix:`-groupOnDescending`,read:vi,ready:a}),m=g(()=>e.find(e=>e.name===o),[e,o]),h=g(()=>e.find(e=>e.name===u),[e,u]),_={groupOn:u,setGroupOn:yi(d,`groupOn`,r),groupOnDescending:f,setGroupOnDescending:yi(p,`groupOnDescending`,r),sortOn:o,setSortOn:yi(s,`sortOn`,r),descending:c,setDescending:yi(l,`descending`,r),columns:e},v=g(()=>_,Object.values(_)),y=T(e=>{s(e.sortOn),d(e.groupOn),l(e.descending),p(e.groupOnDescending)},[]);return S(()=>void(i.current=y),[]),{...v,sortAndGroup:v,groupOnColumn:h,sortOnColumn:m}},xi=ct(),customElements.define(`sort-and-group-provider`,xi.Provider),customElements.define(`sort-and-group-consumer`,M(({render:e})=>e(m(xi)),{useShadowDOM:!1}))})),Ci,wi,Ti=e((()=>{O(),h(),ei(),ui(),C(),Si(),Ci=({data:e,columns:n,groupOnColumn:r,filters:i,setFilterState:a,sortAndGroup:{sortOn:o,setSortOn:s,descending:c,setDescending:l}={}})=>pe(n,e=>e.name,n=>[t`<div
	...
	`},customElements.define(`cosmoz-omnitable-header-row`,M(wi,{useShadowDOM:!1}))})),Ei,Di,Oi=e((()=>{O(),u(),Ei=b`
	:host {
		display: flex;
		align-items: center;
		flex-wrap: wrap;
