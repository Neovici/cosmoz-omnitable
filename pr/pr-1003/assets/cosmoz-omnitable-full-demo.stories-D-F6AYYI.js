import{n as e}from"./chunk-BneVvdWh.js";import{$ as t,X as n,Z as r,et as i,n as a,t as o}from"./iframe-BD2b9Unr.js";import{$ as s,A as c,At as l,B as u,C as d,Ct as f,D as p,Dt as m,E as h,Et as g,F as _,Ft as v,G as y,H as b,I as x,It as ee,J as te,K as ne,L as re,Lt as ie,M as ae,Mt as oe,N as se,Nt as ce,O as le,Ot as S,P as ue,Pt as C,Q as de,R as fe,S as pe,St as w,T as me,Tt as T,U as he,V as ge,W as _e,X as E,Y as ve,Z as D,_ as O,_t as k,a as ye,at as be,b as A,bt as xe,c as Se,ct as Ce,d as we,dt as Te,et as Ee,f as De,ft as Oe,g as ke,gt as Ae,h as je,ht as Me,i as Ne,it as Pe,j as Fe,jt as Ie,k as Le,kt as Re,l as ze,lt as Be,m as Ve,mt as He,n as Ue,nt as j,o as We,ot as Ge,p as Ke,pt as qe,q as Je,r as Ye,rt as M,s as Xe,st as Ze,t as Qe,tt as $e,u as et,ut as tt,v as nt,vt as N,w as rt,wt as it,x as at,xt as ot,y as st,yt as ct,z as lt}from"./dist-DpkP_60k.js";var ut,dt=e((()=>{k(),ut=()=>t`<style>
	@keyframes rotating {
		100% {
...
`}));function ci(e,t,{suffix:n=``,read:r,write:i,ready:a=!0,multi:o}={}){let s=Te({param:t,suffix:n,link:o?fi:di,write:i??be}),c=g(()=>{if(t==null)return!1;if(o){let e=et(t+n);return Object.keys(e).length>0}return we(t+n)!==void 0},[]),[l,u]=f(()=>{if(t==null)return e;if(o){let i=et(t+n,r);return Object.keys(i).length>0?i:e}return we(t+n,r)??e}),d=T(e=>u(t=>{let n=Ze(e,t);return s.param!=null&&Ke(s.link(s.param+s.suffix,n,s.write),null,{notify:!1}),n}),[]);return S(()=>{s.param==null||!a||c||e!=null&&d(e)},[a]),[l,d]}var li,ui,di,fi,pi=e((()=>{De(),Ge(),tt(),ze(),k(),li=e=>(t,n,r=be)=>{let i=Se(),a=new URLSearchParams(i.hash.replace(`#`,``));return e(t,n,r,a),`#!`+Object.assign(i,{hash:a}).href.replace(location.origin,``)},ui=e=>e==null||e===``,di=li((e,t,n,r)=>ui(n(t))?r.delete(e):r.set(e,n(t))),fi=li((e,t,n,r)=>{let i=Object.entries(t),a=i.map(n).filter(([,e])=>e!==void 0);if(a.length===0&&i.length>0)return;let o=e;Array.from(r.keys()).filter(e=>e.startsWith(o)).forEach(e=>r.delete(e)),a.forEach(([t,n])=>ui(n)?r.delete(e+t):r.set(e+t,n))})})),mi,hi,gi,_i,vi,yi=e((()=>{k(),pi(),mi=e=>[!0,`true`,1,`yes`,`on`].includes(e),hi=e=>e===``||(e==null?void 0:mi(e)),gi=(e,t,n)=>T(r=>{e(r),n(e=>({...e,[t]:r}))},[e,t,n]),_i=(e,t,{settings:n,setSettings:r,resetRef:i,ready:a=!0})=>{let[o,s]=ci(n.sortOn,t,{suffix:`-sortOn`,ready:a}),[c,l]=ci(hi(n.descending),t,{suffix:`-descending`,read:hi,ready:a}),[u,d]=ci(n.groupOn,t,{suffix:`-groupOn`,ready:a}),[f,p]=ci(hi(n.groupOnDescending),t,{suffix:`-groupOnDescending`,read:hi,ready:a}),m=g(()=>e.find(e=>e.name===o),[e,o]),h=g(()=>e.find(e=>e.name===u),[e,u]),_={groupOn:u,setGroupOn:gi(d,`groupOn`,r),groupOnDescending:f,setGroupOnDescending:gi(p,`groupOnDescending`,r),sortOn:o,setSortOn:gi(s,`sortOn`,r),descending:c,setDescending:gi(l,`descending`,r),columns:e},v=g(()=>_,Object.values(_)),y=T(e=>{s(e.sortOn),d(e.groupOn),l(e.descending),p(e.groupOnDescending)},[]);return S(()=>void(i.current=y),[]),{...v,sortAndGroup:v,groupOnColumn:h,sortOnColumn:m}},vi=ct(),customElements.define(`sort-and-group-provider`,vi.Provider),customElements.define(`sort-and-group-consumer`,N(({render:e})=>e(m(vi)),{useShadowDOM:!1}))})),bi,xi,Si=e((()=>{k(),h(),Zr(),si(),C(),yi(),bi=({data:e,columns:n,groupOnColumn:r,filters:i,setFilterState:a,sortAndGroup:{sortOn:o,setSortOn:s,descending:c,setDescending:l}={}})=>me(n,e=>e.name,n=>[t`<div
	...
	`},customElements.define(`cosmoz-omnitable-header-row`,N(xi,{useShadowDOM:!1}))})),Ci,wi,Ti=e((()=>{k(),u(),Ci=b`
	:host {
		display: flex;
		align-items: center;
		flex-wrap: wrap;
...
`})),Qi,$i,ea=e((()=>{k(),tt(),Qi=e=>{let t=parseInt(e,10);return isFinite(t)?t:void 0},$i=e=>{let{config:t}=e,{settings:n,setSettings:r,collapsed:i}=t,a=Te({collapsed:i,settings:n.columns,setSettings:T(e=>r(t=>({...t,columns:e})),[r])});return{...t,onDown:T(e=>{e.target.closest(`.pull`)&&(a.handle=e.currentTarget)},[a]),onDragStart:T(e=>{let{target:t}=e,n=Qi(t.dataset.index);if(!a.handle?.contains(t)||n==null)return e.preventDefault();a.handle=null,e.dataTransfer.effectAllowed=`move`,e.dataTransfer.setData(`omnitable/sort-index`,n),e.dataTransfer.setData(`text/plain`,n),setTimeout(()=>t.classList.add(`drag`),0),t.addEventListener(`dragend`,e=>e.target.classList.remove(`drag`),{once:!0})},[a]),onDragEnter:T(e=>{let t=e.currentTarget;t===e.target&&(e.preventDefault(),e.dataTransfer.dropEffect=`move`,t.classList.add(`dragover`))},[]),onDragOver:T(e=>{e.preventDefault(),e.currentTarget.classList.add(`dragover`)},[]),onDragLeave:T(e=>{let t=e.currentTarget;t.contains(e.relatedTarget)||t.classList.remove(`dragover`)},[]),onDrop:T(e=>{let t=Qi(e.dataTransfer.getData(`omnitable/sort-index`)),n=Qi(e.currentTarget.dataset.index),{settings:r,setSettings:i}=a;e.currentTarget.classList.remove(`dragover`),e.preventDefault();let o=r.slice();o.splice(n+(t>=n?0:-1),0,o.splice(t,1)[0]),i(o)},[a]),onToggle:T(e=>{let{settings:t,setSettings:n}=a,r=t.map(e=>({...e,disabled:e.disabled||a.collapsed?.some(t=>t.name===e.name)})),i=Qi(e.target.closest(`[data-index]`)?.dataset.index);r.splice(i,1,{...t[i],disabled:!e.target.checked,priority:e.target.checked?t.reduce((e,t)=>Math.max(e,t.priority),0)+1:t[i].priority}),n(r)},[a])}}})),ta,na,ra,ia,aa=e((()=>{Qe(),qe(),u(),ne(),k(),o(),C(),ni(),si(),Zi(),ea(),ta=[He({apply({availableHeight:e,elements:t}){Object.assign(t.floating.style,{maxHeight:`${Math.max(0,e)}px`})}}),...Oe],na=({onDragStart:e,onDragEnter:n,onDragOver:r,onDragLeave:i,onDrop:a,onDown:o,onToggle:s,collapsed:c,filters:l})=>(u,d)=>{let f=!!c?.find(e=>e.name===u.name),p=!u.disabled&&!f;return t` <div
			class="item"
			data-index=${d}
			@mousedown=${o}
			draggable="true"
...
`)},Aa=(e,t,n)=>{let r=e.filter(e=>!e.hidden),i=r.reduce((e,{width:t})=>e+t,0);if(r.length>1&&i>t)return Aa(r.slice(1),t,n);let a=r.reduce(([e,t],n,r)=>[Math.max(e,n.index),n.index>e?r:t],[-1,-1])[1];return a!==-1&&(r[a].flex=1),wa(r,t).reduce((e,t,n)=>(e[r[n].index]=t,e),Array(n).fill(void 0))},ja=(e,t)=>e.length===0?`.cell {display: none;}`:ka(e,t)})),Na,Pa=e((()=>{k(),Na=({host:e,canvasWidth:t,layout:n,setSettings:r})=>{let i=xe();i.current=e=>r(r=>{let i=r.columns,{detail:{newWidth:a,column:o}}=e,s=i.findIndex(e=>e.name===o.name),c=[],l=i.reduce((e,t)=>Math.max(e,t.priority),-1/0);for(let e=0;e<n.length;e++)if(c[e]={...i[e]},e<s&&n[e]&&(c[e].width=n[e],c[e].flex=0,c[e].priority=l),e===s){let r=n.reduce((e,t,n)=>n<s&&t?e-t:e,t);c[e].width=Math.min(r,Math.max(a,i[e].minWidth)),c[e].flex=0,c[e].priority=l}return{...r,columns:c}}),S(()=>{let t=e=>i.current?.(e);return e.addEventListener(`column-resize`,t),()=>e.removeEventListener(`column-resize`,t)},[])}})),Fa,Ia,La=e((()=>{k(),Fa=88,Ia=(e,t)=>S(()=>{let n=new ResizeObserver(([e])=>{e.contentRect?.width!==0&&requestAnimationFrame(()=>t(e.contentRect?.width-Fa))});return n.observe(e),()=>n.unobserve(e)},[])})),Ra,za=e((()=>{k(),La(),Ra=e=>{let[t,n]=f(()=>e.getBoundingClientRect().width-Fa);return Ia(e,n),t}})),Ba,Va,Ha,Ua=e((()=>{k(),tt(),Ge(),Ba=(e,t)=>{let n=g(()=>{let t=!1,n,r=()=>{t&&(n=requestAnimationFrame(r),e()&&(t=!1))};return{start:()=>{t=!0,cancelAnimationFrame(n),n=requestAnimationFrame(r)},stop:()=>{t=!1,cancelAnimationFrame(n)}}},[]);S(()=>{n.start()},t),S(()=>()=>n.stop(),[])},Va=(e=0,t=0)=>Math.abs(e-t)<.1,Ha=(e,t=1.9,n=Ce)=>{let r=Te({target:e});Ba(T(()=>{if(!r.tween)return r.tween=r.target,n(r.tween),!0;if(r.target.every((e,t)=>r.tween[t]===e))return n(r.tween),!0;r.tween=r.target.map((e,n)=>Va(r.tween[n],e)?e:(r.tween[n]??0)+((e??0)-(r.tween[n]??0))/t||0),n(r.tween)},[]),[e])}})),Wa,Ga=e((()=>{k(),Ma(),Wa=({canvasWidth:e,groupOnColumn:t,config:n,miniColumn:r})=>g(()=>{if(!Array.isArray(n)||e==null||e===0)return[];let i=n.map((e,n)=>({minWidth:e.minWidth,width:e.width,flex:e.flex,priority:e.priority,name:e.name,index:n,hidden:e.name===t?.name||e.disabled})).map(e=>r?{...e,hidden:r.name!==e.name}:e).sort(({index:e,priority:t},{index:n,priority:r})=>t===r?n-e:t-r);return Aa(i,e,i.length)},[e,t,n])})),Ka,qa=e((()=>{k(),Ka=({host:e,canvasWidth:t,columns:n})=>{let r=e.miniBreakpoint??480,i=g(()=>t<=r,[t,r]),[a,...o]=g(()=>i?n?.filter(e=>e.mini!=null).sort((e,t)=>(e.mini??0)-(t.mini??0)):[],[n,i])??[],s=!!a;return S(()=>{e.toggleAttribute(`mini`,s)},[s]),{isMini:s&&i,miniColumn:a,miniColumns:o}}})),Ja,Ya,Xa=e((()=>{k(),Ma(),Pa(),za(),Ua(),Ga(),qa(),tt(),Ja=e=>{let t=g(()=>new CSSStyleSheet,[]);return S(()=>{e.shadowRoot.adoptedStyleSheets=[...e.shadowRoot.adoptedStyleSheets,t]},[]),t},Ya=({host:e,columns:t,settings:n,setSettings:r,resizeSpeedFactor:i,sortAndGroupOptions:a})=>{let o=Ra(e),{isMini:s,miniColumn:c,miniColumns:l}=Ka({host:e,canvasWidth:o,columns:t}),{groupOnColumn:u}=a,d=Wa({canvasWidth:o,groupOnColumn:u,miniColumn:c,config:n.columns}),f=Ja(e),p=g(()=>n.columns.reduce((e,n,r)=>d[r]!=null||n.name===u?.name||n.disabled?e:[...e,t.find(e=>e.name===n.name)],[]),[t,n,d]),m=Te({columns:n.columns});return Ha(d,i,e=>{let t=ja(e,m.columns);f.replace(t)}),Na({host:e,canvasWidth:o,layout:d,setSettings:e=>r(e(n))}),{isMini:s,collapsedColumns:p,miniColumns:l}}})),Za,Qa=e((()=>{Za=({host:e,...t})=>{let{csvFilename:n=`omnitable.csv`,xlsxFilename:r=`omnitable.xlsx`,xlsxSheetname:i=`Omnitable`,topPlacement:a=`top-end`}=e;return{csvFilename:n,xlsxFilename:r,xlsxSheetname:i,topPlacement:a,...t}}})),$a,eo=e((()=>{k(),$a=({host:e,selectedItems:t,data:n,sortAndGroupOptions:r,collapsedColumns:i,settings:a,filterFunctions:o,settingS:s,filters:c,...l})=>{let u=n&&n.length>0&&t.length===n.length,d=t=>{t.target.checked?e.shadowRoot.querySelector(`#groupedList`).selectAll():e.shadowRoot.querySelector(`#groupedList`).deselectAll()},{groupOnColumn:f}=r,p=g(()=>[f,...i,...a.columns.filter(e=>e.disabled)].some(e=>e&&Object.keys(o).includes(e.name)),[o,a,i]),m=g(()=>({...s,collapsed:i,badge:p,filters:c}),[s,i,p,c]);return S(()=>{let t=e.shadowRoot.querySelector(`#tableContent`),n=new ResizeObserver(t=>requestAnimationFrame(()=>{e.style.setProperty(`--ot-height`,t[0]?.contentRect.height+`px`)}));return n.observe(t),()=>n.unobserve(t)},[]),{allSelected:u,onAllCheckboxChange:d,data:n,settingsConfig:m,filters:c,groupOnColumn:f,sortAndGroup:r.sortAndGroup,...l}}})),to,no,ro,io,ao,oo,so=e((()=>{k(),C(),ne(),Oa(),J(),to=t`
	<svg
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
