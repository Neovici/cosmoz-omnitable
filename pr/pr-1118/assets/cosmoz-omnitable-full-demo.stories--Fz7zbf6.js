...
`,Rn=n=>{const{label:e,value:t,slot:r}=n;n.toggleAttribute("has-value",!!t);const o=c`<div
		id="input"
		part="input"
		role="button"
		class="control"
