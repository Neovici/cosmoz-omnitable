import{x as Gt,g as _,P as V,e as qt,D as Wt,t as Xt,a as Kt,h as bt,m as Ut,b as xt,s as Qt,c as ye,d as Yt,f as Jt,i as Qe,j as Ye,n as Zt,k as en,o as tn,l as yt,N as nn,p as rn,q as Je,r as on,u as ln,v as an,w as sn,y as un,z as vt}from"./cosmoz-collapse-BGtPenM4.js";import{C as q,g as T,b as d,n as F,D as cn,f as $t,F as dn,G as ve,H as Ve,I as C,k as R,x as zt,J,K as P,L as Ee,M as wt,N as $e,l as O,A as Te,u as E,o as Ze,O as K,p as ze,B as St,q as S,P as Ct,Q as Me,R as _t,S as mn,T as De,m as Re,U as pn,V as It,W as Le,X,Y as gn,s as hn}from"./iframe-CTCPQAZu.js";const fn=q`
	:host {
		display: flex;
		cursor: pointer;
	}
...
`,An=n=>{const{label:e,value:t,slot:r}=n;n.toggleAttribute("has-value",!!t);const i=d`<div
		id="input"
		part="input"
		role="button"
		class="control"
