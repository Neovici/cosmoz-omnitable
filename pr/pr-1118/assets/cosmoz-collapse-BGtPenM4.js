import{o as C,n as U,w as K,b as x,f as Q,g as D,h as sr,u as j,A as wt,i as ar,j as lr,t as cr,E as dr,k as _t,l as nt,m as ie,p as Zr,q as et,r as Se,s as ur,v as Kr,x as Qr,y as Te,z as to,B as fr}from"./iframe-CTCPQAZu.js";const ds=t=>!!(t==null||Array.isArray(t)&&t.length===0||typeof t=="string"&&t.length===0||typeof t=="number"&&t===0),eo={isoBasic:/^\d{4}-\d{2}-\d{2}$/iu},ro=t=>typeof t=="string"&&eo.isoBasic.test(t)?new Date(`${t}T00:00`):new Date(t),us=t=>{if(t==null)return;if(t instanceof Date&&!isNaN(t.getTime()))return t;if(!(typeof t=="number"||typeof t=="string"))return;const e=ro(t);if(!(e instanceof Date&&isNaN(e.getTime())))return e},dt=t=>t<10?"0"+t:t,fs=t=>t instanceof Date?t.getFullYear()+"-"+dt(t.getMonth()+1)+"-"+dt(t.getDate())+"T"+dt(t.getHours())+":"+dt(t.getMinutes())+":"+dt(t.getSeconds())+"."+(t.getMilliseconds()/1e3).toFixed(3).slice(2,5):null,hs=({slot:t,title:e,className:i,width:o="24",height:r="24",styles:n}={})=>x`
  <svg
    slot=${C(t)}
