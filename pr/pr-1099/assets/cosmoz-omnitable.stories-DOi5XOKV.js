import{e as c,D as He,t as S,A as Ge}from"./iframe-B8eWsxy7.js";import{t as j,c as O,g as A,n as F,P as I,s as ln,a as Ft,r as sn,e as un,D as cn,b as dn,d as mn,i as ke,h as kt,m as pn,u as R,f as Et,j as _t,k as gn,l as Z,p as P,o as je,q as It,v as Ee,w as bn,x as _e,y as E,z as M,A as lt,B as Ie,C as Mt,E as st,F as ut,G as z,H as fn,I as hn,J as Ot,K as Ke,L as Lt,M as xn,N as Tt,O as yn,Q as ct,R as vn,S as $n,T as Cn,U as Dt,V as We,W as Je,X as wn,Y as Rt,Z as Ue,_ as U,$ as zn,a0 as Sn}from"./cosmoz-collapse-B1IbmeUX.js";import"./preload-helper-PPVm8Dsz.js";const An=j`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`;customElements.define("cosmoz-clear-button",O(qn));const G=({valuePath:n},e)=>A(e,n),Fn=G,kn=G,En=({valuePath:n},e)=>t=>{const i=A(t,n);return i==null?!1:i.toString().toLowerCase().trim().includes(e.toLowerCase().trim())},_n=(n,e)=>e===""||e==null?null:e,D=n=>class extends n{static get properties(){return{isOmnitableColumn:{type:Boolean,value:!0},title:{type:String},valuePath:{type:String,notify:!0},values:{type:Array,notify:!0},filter:{type:Object},noLocalFilter:{type:Boolean},disabled:{type:Boolean,value:!1,notify:!0},editable:{type:Boolean,notify:!0},loading:{type:Boolean,value:!1,notify:!0},externalValues:{type:Boolean,value:!1,notify:!0},name:{type:String},sortOn:{type:String},groupOn:{type:String},noSort:{type:Boolean,value:!1},disabledFiltering:{type:Boolean,value:!1},width:{type:String,value:"75px"},minWidth:{type:String,value:"40px"},flex:{type:String,value:"1"},cellClass:{type:String,value:"default-cell"},headerCellClass:{type:String,value:"default-header-cell"},priority:{type:Number,value:0},hidden:{type:Boolean,notify:!0},align:{type:String,value:"left"},headerAlign:{type:String,value:null},renderHeader:{type:Function},renderCell:{type:Function},renderEditCell:{type:Function},renderGroup:{type:Function},mini:{type:Number,value:null},renderMini:{type:Function}}}static get observers(){return["notifyFilterChange(filter)"]}notifyFilterChange(e){this.__ownChange||this.dispatchEvent(new CustomEvent("legacy-filter-changed",{detail:{name:this.name,state:this.legacyFilterToState(e)},bubbles:!0}))}legacyFilterToState(e){return{filter:e}}getFilterFn(){}getString(e,t){return G(e,t)}toXlsxValue(e,t){return Fn(e,t)}cellTitleFn(e,t){return this.getString(e,t)}headerTitleFn(e){return e.title}serializeFilter(e,t){return _n(e,t)}deserializeFilter(e,t){if(t==null)return null;if(typeof t=="string")try{return window.decodeURIComponent(t)}catch{return null}return t}getComparableValue(e,t){return kn(e,t)}computeSource(e,t){return t}_propertiesChanged(e,t,i){super._propertiesChanged(e,t,i),this.dispatchEvent(new CustomEvent("cosmoz-column-prop-changed",{bubbles:!0}))}},In=n=>e=>n(t=>{if(t.inputValue===void 0&&e.target.value==="")return t;clearTimeout(t.t);const i=setTimeout(()=>n(a=>({...a,filter:a.inputValue})),1e3);return{...t,inputValue:e.target.value,t:i}}),Mn=n=>()=>n(e=>({...e,filter:e.inputValue})),On=n=>e=>{e.keyCode===13&&(e.preventDefault(),n(t=>({...t,filter:t.inputValue})))},Ln=n=>e=>n(t=>({...t,headerFocused:e.detail.value})),Tn=n=>()=>n(e=>({...e,filter:null,inputValue:null})),Dn=n=>n!=null&&n!=="";class Rn extends D(I){static get properties(){return{minWidth:{type:String,value:"55px"},editMinWidth:{type:String,value:"55px"},inputValue:{type:Object,notify:!0}}}getFilterFn(e,t){if(!(t==null||t===""))return En(e,t)}renderCell(e,{item:t}){return c`<span class="default-column">${G(e,t)}</span>`}renderEditCell(e,{item:t},i){return c`<cosmoz-input
		...
		>
			${F(!e.disabledFiltering,()=>c`<cosmoz-clear-button
						...
						@click=${Tn(o)}
					></cosmoz-clear-button>`)}
		</cosmoz-input>`}legacyFilterToState(e){return{filter:e,inputValue:e}}}customElements.define("cosmoz-omnitable-column",Rn);const Vn=["label","value","slot","always-float-label","disabled"],Nn=Ft`
	${ln}
...
`,Pn=n=>{const{label:e,value:t,slot:i}=n,a=c`<div
	...
	>
		${t||""}
	</div>`;return sn(a,{label:e})};customElements.define("cosmoz-omnitable-dropdown-input",O(Pn,{observedAttributes:Vn,styleSheets:[Nn]}));const de=({title:n,tooltip:e="",filterText:t="",onOpenedChanged:i,content:a,align:o="left",externalValues:r=null})=>{const l={filtered:!!t,...r!=null&&{[`external-values-${r}`]:!0}};return c`
		<style>
			.dropdown {
				outline: none;
			}
	...
	`},Vt=n=>n?typeof n.close=="function"?n:Vt(n.parentElement):null,Xe=n=>class extends n{static get properties(){return{disabled:{type:Boolean,value:!1},filter:{type:Object,notify:!0},values:{type:Array,value(){return[]}},headerFocused:{type:Boolean,notify:!0},min:{type:Number,value:null},max:{type:Number,value:null},limits:{type:Function},autoupdate:{type:String,value:!0},locale:{type:String,value:null},align:{type:String,value:"left"},_filterInput:{type:Object,value(){return{min:null,max:null}}},_range:{type:Object,computed:"_computeRange(values.*)"},_limit:{type:Object,computed:"_computeLimit(_range, _filterInput.*, min, max)",value(){return{}}},_tooltip:{type:String,computed:"_computeTooltip(title, _filterText)"},_fromClasses:{type:String,computed:"_computeInputClasses(_filterInput.min)"},_toClasses:{type:String,computed:"_computeInputClasses(_filterInput.max)"}}}static get observers(){return["_filterInputChanged(_filterInput.*, autoupdate)","_filterChanged(filter.*)","_updateLimits(limits, headerFocused)"]}disconnectedCallback(){this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),super.disconnectedCallback()}_computeInputClasses(e){return e!=null&&e!==""?"has-value":""}toNumber(e,t,i){if(e==null||e==="")return;const a=typeof e=="number"?e:Number(e);if(Number.isNaN(a))return;if(i==null||t==null)return a;const o=this.toNumber(t);return o==null?a:i(a,o)}toValue(){return this.toNumber.apply(this,arguments)}getComparableValue(e,t){if(e==null)return;let i=e;return t!=null&&(i=this.get(t,e)),this.toValue(i)}renderValue(){}getInputString(e,t=this.valuePath){const i=this.toValue(this.get(t,e));return this._toInputString(i)}_computeRange(e){const t=e.base,i=Array.isArray(t)&&t.length&&t.map(a=>this.toValue(a)).filter(a=>a!=null);return!i||i.length<1?{min:null,max:null}:i.reduce((a,o)=>({min:this.toValue(o,a.min,Math.min),max:this.toValue(o,a.max,Math.max)}),{})}_computeLimit(e,t,i,a){if(!e)return;const o=t.base,r=this.toValue(i),l=this.toValue(a),s=r??this.toValue(e.min),u=l??this.toValue(e.max);return{fromMin:s,fromMax:this.toValue(u,this._fromInputString(o.max,"max"),Math.min),toMin:this.toValue(s,this._fromInputString(o.min,"min"),Math.max),toMax:u}}_computeFilterText(e){if(e.base==null)return;const t=e.base,i=this.toValue(t.min),a=this.toValue(t.max),o=[];return i!=null&&o.push(this.renderValue(i)),o.push(" - "),a!=null&&o.push(this.renderValue(a)),o.length>1?o.join(""):void 0}_computeTooltip(e,t){return t==null?e:`${e}: ${t}`}_fromInputString(e){return this.toValue(e)}_toInputString(e){const t=this.toValue(e);return t??null}_getDefaultFilter(){return{min:null,max:null}}_filterInputChanged(e,t){const i=e.path.split(".")[1];this.__inputChangePath=i||null,t&&(this._limitInputDebouncer=cn.debounce(this._limitInputDebouncer,dn.after(600),()=>{this._limitInput(),this._updateFilter()}),mn(this._limitInputDebouncer))}_clearFrom(){this.set("_filterInput.min",null),this._updateFilter()}_clearTo(){this.set("_filterInput.max",null),this._updateFilter()}_onBlur(){this._limitInput(),this._updateFilter()}_onKeyDown(e){const t=e.currentTarget,i=Array.from(t.parentElement.querySelectorAll("cosmoz-input")),a=i[i.findIndex(l=>l===t)+1],o=!a,r=i[0]===t;switch(e.keyCode){case 13:if(e.preventDefault(),!o)a.focus();else{const l=this._limitInput();this._updateFilter(),l||this._closeParent(t)}break;case 9:(o&&!e.shiftKey||r&&e.shiftKey)&&this._closeParent(t)}}_closeParent(e){const t=Vt(e);t&&t.close()}_onDropdownOpenedChanged({currentTarget:e,type:t,detail:i}){(t==="focus"||i?.value===!0)&&setTimeout(()=>{e.querySelector("cosmoz-input:focus")||e.querySelector("cosmoz-input")?.focus()},100)}_limitInput(){const e=this._filterInput,t=this.__inputChangePath,i=t?this._fromInputString(this.get(t,e),t):null;if(this.__inputChangePath=null,i==null)return!1;const a=this._limit,o=t==="min"?"from":"to",r=this.get(o+"Min",a),l=this.get(o+"Max",a),s=this.toValue(i,r,Math.max),u=this.toValue(s,l,Math.min);return this.getComparableValue(i)!==this.getComparableValue(u)?(this.set(["_filterInput",t],this._toInputString(u,t)),this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),!0):!1}_updateFilter(){const e=this._filterInput,t=this.filter,i=this._fromInputString(e.min,"min"),a=this._fromInputString(e.max,"max");this.getComparableValue(i)===this.getComparableValue(t,"min")&&this.getComparableValue(a)===this.getComparableValue(t,"max")||this.set("filter",{min:i,max:a})}_filterChanged(e){if(this._filterInput==null)return;const t=this._filterInput,i=e.base,a=this._fromInputString(t.min,"min"),o=this._fromInputString(t.max,"max");this.getComparableValue(a)===this.getComparableValue(i,"min")&&this.getComparableValue(o)===this.getComparableValue(i,"max")||(this.set("_filterInput",{min:this._toInputString(i.min),max:this._toInputString(i.max)}),this._limitInputDebouncer&&this._limitInputDebouncer.cancel())}hasFilter(){const e=this.filter;return e==null?!1:this.toValue(e.min)!=null||this.toValue(e.max)!=null}resetFilter(){this.filter=this._getDefaultFilter()}_updateLimits(e,t){e&&Promise.resolve(ke(e,{active:t})).then(i=>{const{min:a,max:o}=i??{};Object.assign(this,{...a!=null?{min:a}:{},...o!=null?{max:o}:{}})})}},me=n=>class extends n{static get template(){return kt`<div id="output" style="position:relative;"></div>`}connectedCallback(){super.connectedCallback();const e=this;He(e.render(),e.$.output)}_propertiesChanged(e,t,i){super._propertiesChanged(e,t,i);const a=this;requestAnimationFrame(()=>He(a.render(),a.$.output))}};class Bn extends Xe(me(I)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return c`
		...
		</cosmoz-input>`}renderHeader({title:e,min:t,max:i,limits:a,locale:o,rates:r,currency:l,autoupdate:s,autodetect:u,disabledFiltering:d,headerAlign:m,align:b},{filter:p},f,v){return c`<cosmoz-omnitable-amount-range-input
			.title=${e}
			?disabled=${d}
			.filter=${p}
			.values=${v}
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:i},a,o){return c`<cosmoz-autocomplete-excluding
			...
			.text=${i}
			.limit=${e.limit}
			@opened-changed=${r=>Oe(a)(r.detail.value)}
			@value-changed=${je(Me(a))}
			@text-changed=${je(Le(a))}
			>${F(e.loading,()=>c`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-excluding
		>`}getComparableValue(e,t){return ci(e,t)}getFilterFn(e,t){if(!(!t||!Array.isArray(t)||t.length===0))return di(e,t)}};customElements.define("cosmoz-omnitable-column-autocomplete-excluding",mi);const pi=({valuePath:n,textProperty:e,valueProperty:t},i)=>{const a=e?It(e):P(t),o=Z(n&&A(i,n)).map(a);return o.length>1?o.filter(Boolean).join(","):o[0]};class gi extends Te(D(I)){static get properties(){return{headerCellClass:{type:String,value:"autocomplete-header-cell"},minWidth:{type:String,value:"55px"},editMinWidth:{type:String,value:"55px"},keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},showSingle:{type:Boolean},preserveOrder:{type:Boolean},limit:{type:Number},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,showSingle:e.showSingle,preserveOrder:e.preserveOrder,limit:e.limit,textual:e.textual}}renderCell(e,{item:t}){return c`<span class="default-column"
			>${e.getString(e,t)}</span
		>`}renderEditCell(e,{item:t},i){return c`<cosmoz-input
			no-label-float
			type="text"
		...
		>`}getComparableValue(e,t){return pi(e,t)}}customElements.define("cosmoz-omnitable-column-autocomplete",gi);const Ze=(n,e)=>e.find(({value:t})=>n===t),bi=(n,e,t)=>{const i=Ze(e,t);return i?i.text:n},ft=(n,e,t,i)=>bi(n,A(e,t),i),fi=({valuePath:n},e,t)=>Ze(A(e,n),t),hi=n=>e=>{n(t=>({...t,filter:e?.[0]?.value??null}))},xi=n=>e=>{n(t=>({...t,headerFocused:e}))},yi=n=>e=>{n(t=>({...t,query:e}))},vi=n=>e=>n(e?.[0]?.value),ht=({valuePath:n,trueLabel:e,falseLabel:t},i)=>A(i,n)?e:t,$i=({valuePath:n},e)=>t=>A(t,n)===e,be=_t((n,e)=>[{text:n,value:!0},{text:e,value:!1}]),Ci=({valuePath:n,trueLabel:e,falseLabel:t},i)=>n?A(i,n)?e:t:"",wi=(n,e)=>{try{return JSON.parse(e)}catch{return null}};class zi extends D(I){static get properties(){return{trueLabel:{type:String,value:"True"},falseLabel:{type:String,value:"False"},flex:{type:String,value:"0"},cellClass:{type:String,value:"boolean-cell"}}}getString(e,t){return ht(e,t)}renderCell(e,{item:t}){return ht(e,t)}renderEditCell(e,{item:t},i){const{trueLabel:a,falseLabel:o}=e;return c`<cosmoz-autocomplete
			no-label-float
		...
		></cosmoz-omnitable-datetime-range-input>`}computeSource(e,t){return pe(e,t)}}customElements.define(Ct.is,Ct);class Oi extends Te(D(I)){renderCell({valuePath:e,textProperty:t},{item:i}){const a=Qe(i,e,t).map(o=>c`<li>${o}</li>`);return c`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		`}renderEditCell(){return"not implemented"}renderHeader(e,{filter:t,query:i},a,o){return c`<cosmoz-autocomplete-ui
			...
			.onText=${Le(a)}
			>${F(e.loading,()=>c`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}}customElements.define("cosmoz-omnitable-column-list-horizontal",Oi);const Li=j`
	:host {
		display: block;
	}
...
`,Ti=({items:n})=>{const[e,t]=R(!1),i=Array.isArray(n)?n:[],a=E(()=>Math.max(0,i.length-1),[i]);if(i.length===0)return null;const o=i.length>2,r=i[0],l=o&&!e?[]:i.slice(1),s=u=>{u.stopPropagation(),u.preventDefault(),t(d=>!d)};return c`
		<ul>
			<li>
				<span>${r}</span>
			</li>
	...
	`};customElements.define("cosmoz-omnitable-column-list-data",O(Ti,{styleSheets:[_e(Li)]}));class Di extends Te(D(I)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:i}){return c`<cosmoz-omnitable-column-list-data
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:i},a,o){return c`<cosmoz-autocomplete-ui
			...
			.onText=${Le(a)}
			>${F(e.loading,()=>c`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}}customElements.define("cosmoz-omnitable-column-list",Di);class Ri extends Xe(me(I)){static get properties(){return{maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null},formatter:{type:Object,computed:"_computeFormatter(locale, minimumFractionDigits, maximumFractionDigits)"},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, formatter)"},headerFocused:{type:Boolean,value:!1}}}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return c`
			<style>
				cosmoz-input[type='number'] {
					background: var(--cosmoz-omnitable-amount-input-background, #ffffff);
					border-radius: 6px;
		...
		></cosmoz-input>`}renderHeader({title:e,min:t,max:i,limits:a,locale:o,maximumFractionDigits:r,minimumFractionDigits:l,autoupdate:s,disabledFiltering:u,headerAlign:d,align:m},{filter:b},p,f){return c`<cosmoz-omnitable-number-range-input
			...
			.autoupdate=${s}
			.align=${d??m}
			@filter-changed=${({detail:{value:v}})=>p(C=>({...C,filter:v}))}
			@header-focused-changed=${({detail:{value:v}})=>p(C=>({...C,headerFocused:v}))}
		></cosmoz-omnitable-number-range-input>`}computeSource(e,t){return pe(e,t)}}customElements.define("cosmoz-omnitable-column-number",Vi);class Ni extends et(me(I)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return c`
			${F(this.disabled,()=>c`
					<cosmoz-omnitable-dropdown-input
						disabled
						text-align=${this.align}
...
`,Xt=n=>(e,t,i=Mt)=>{const a=hn(),o=new URLSearchParams(a.hash.replace("#",""));return n(e,t,i,o),"#!"+Object.assign(a,{hash:o}).href.replace(location.origin,"")},Qt=n=>n==null||n==="",Zi=Xt((n,e,t,i)=>Qt(t(e))?i.delete(n):i.set(n,t(e))),ea=Xt((n,e,t,i)=>{const a=Object.entries(e),o=a.map(t).filter(([,l])=>l!==void 0);if(o.length===0&&a.length>0)return;const r=n;Array.from(i.keys()).filter(l=>l.startsWith(r)).forEach(l=>i.delete(l)),o.forEach(([l,s])=>Qt(s)?i.delete(n+l):i.set(n+l,s))});function te(n,e,{suffix:t="",read:i,write:a,ready:o=!0,multi:r}={}){const l=r?ea:Zi,s=Ie({param:e,suffix:t,link:l,write:a??Mt}),u=E(()=>{if(e==null)return!1;if(r){const p=st(e+t);return Object.keys(p).length>0}return ut(e+t)!==void 0},[]),[d,m]=R(()=>{if(e==null)return n;if(r){const f=st(e+t,i);return Object.keys(f).length>0?f:n}return ut(e+t,i)??n}),b=z(p=>m(f=>{const v=ke(p,f);return s.param!=null&&fn(s.link(s.param+s.suffix,v,s.write),null,{notify:!1}),v}),[]);return M(()=>{s.param==null||!o||u||n!=null&&b(n)},[o]),[d,b]}const ta=n=>[!0,"true",1,"yes","on"].includes(n),ye=n=>n===""||(n==null?void 0:ta(n)),ve=(n,e,t)=>z(i=>{n(i),t(a=>({...a,[e]:i}))},[n,e,t]),na=(n,e,{settings:t,setSettings:i,resetRef:a,ready:o=!0})=>{const[r,l]=te(t.sortOn,e,{suffix:"-sortOn",ready:o}),[s,u]=te(ye(t.descending),e,{suffix:"-descending",read:ye,ready:o}),[d,m]=te(t.groupOn,e,{suffix:"-groupOn",ready:o}),[b,p]=te(ye(t.groupOnDescending),e,{suffix:"-groupOnDescending",read:ye,ready:o}),f=E(()=>n.find($=>$.name===r),[n,r]),v=E(()=>n.find($=>$.name===d),[n,d]),C={groupOn:d,setGroupOn:ve(m,"groupOn",i),groupOnDescending:b,setGroupOnDescending:ve(p,"groupOnDescending",i),sortOn:r,setSortOn:ve(l,"sortOn",i),descending:s,setDescending:ve(u,"descending",i),columns:n},h=E(()=>C,Object.values(C)),w=z($=>{l($.sortOn),m($.groupOn),u($.descending),p($.groupOnDescending)},[]);return M(()=>{a.current=w},[]),{...h,sortAndGroup:h,groupOnColumn:v,sortOnColumn:f}},it=Ot();customElements.define("sort-and-group-provider",it.Provider);customElements.define("sort-and-group-consumer",O(({render:n})=>n(Ke(it)),{useShadowDOM:!1}));const ia=({data:n,columns:e,groupOnColumn:t,filters:i,setFilterState:a,sortAndGroup:{sortOn:o,setSortOn:r,descending:l,setDescending:s}={}})=>Lt(e,u=>u.name,u=>[c`<div
	...
	`};customElements.define("cosmoz-omnitable-header-row",O(aa,{useShadowDOM:!1}));const oa=j`
	:host {
		display: flex;
		align-items: center;
		flex-wrap: wrap;
...
`;customElements.define("cosmoz-omnitable-item-expand-line",O(ra,{styleSheets:[_e(oa)]}));const la=({columns:n,item:e,selected:t,expanded:i,groupOnColumn:a})=>xn(n,o=>c`<cosmoz-omnitable-item-expand-line
				.column=${o}
				?hidden=${o===a}
			...
			</div>`);customElements.define("cosmoz-omnitable-item-row",O(ua,{useShadowDOM:!1}));const Yt=j`
	.checkbox {
		box-sizing: border-box;
		width: 18px;
		height: 18px;
...
`);r.unshift(o),Tt(new File(r,t,{type:"text/csv;charset=utf-8"}))},ma=(n,e)=>{const t=n.map(a=>a.title),i=e.map(a=>n.map(o=>{const r=o.toXlsxValue(o,a);return r??""}));return i.unshift(t),i},pa=(n,e,t,i)=>{const a=ma(n,e),o=new yn(t).addSheetFromData(a,i).generate();Tt(new File([o],t,{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}))},Se=Symbol("index"),T=Symbol("All"),ga=(n,e)=>{if(typeof n.findLastIndex=="function")return n.findLastIndex(e);for(let t=n.length-1;t>=0;t--)if(e(n[t],t,n))return t;return-1},ba=({columns:n,selectedItems:e,setSelectedItems:t,csvFilename:i,xlsxFilename:a,xlsxSheetname:o,topPlacement:r,enableSelectAll:l,allSelected:s,allItemsCount:u})=>{const d=e===T,m=d||e.length>0,b=e!==T&&l&&s,p=v=>c`<cosmoz-dropdown-menu
			part="extra"
			slot="extra"
			.placement=${r}
		>
		...
		</cosmoz-dropdown-menu>`,f=F(d,()=>u!==void 0?S("All {count} items selected",{count:u}):S("All items selected"),()=>S("{count} selected item",{count:e===T?0:e.length}));return c`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${m}
		part="bottomBar"
...
`,xa=({settingsConfig:n})=>{const{columns:e,collapsed:t}=n,i=e.filter(a=>!t.some(o=>o.name===a.name));return c`<div class="skeleton">
	...
	</div>`};customElements.define("cosmoz-omnitable-skeleton",O(xa,{styleSheets:[ha]}));const ya=(n,e)=>{const{settingsConfig:t}=n,{processedItems:i,dataIsValid:a,filterIsTooStrict:o,loading:r,displayEmptyGroups:l,compareItemsFn:s,selectedItems:u,setSelectedItems:d,renderItem:m,renderGroup:b,error:p}=e;return c`${F(!r&&!a&&!p,()=>c`<div class="tableContent-empty">
...
`,$e=n=>{const e=parseInt(n??"",10);return isFinite(e)?e:void 0},Ca=n=>{const{config:e}=n,{settings:t,setSettings:i,collapsed:a,requestTween:o}=e,r=Ie({collapsed:a,settings:t.columns,requestTween:o,setSettings:z(l=>i(s=>({...s,columns:l})),[i])});return{...e,onDown:z(l=>{const s=l.target instanceof Element?l.target:null;!s||!s.closest(".pull")||(r.handle=l.currentTarget instanceof HTMLElement?l.currentTarget:null)},[r]),onDragStart:z(l=>{const s=l.target instanceof HTMLElement?l.target:null,u=$e(s?.dataset.index);if(!s||!r.handle?.contains(s)||u==null)return l.preventDefault();r.handle=null,l.dataTransfer.effectAllowed="move",l.dataTransfer.setData("omnitable/sort-index",String(u)),l.dataTransfer.setData("text/plain",String(u)),setTimeout(()=>s.classList.add("drag"),0),s.addEventListener("dragend",d=>{(d.target instanceof HTMLElement?d.target:null)?.classList.remove("drag")},{once:!0})},[r]),onDragEnter:z(l=>{const s=l.currentTarget instanceof HTMLElement?l.currentTarget:null;!s||s!==l.target||(l.preventDefault(),l.dataTransfer.dropEffect="move",s.classList.add("dragover"))},[]),onDragOver:z(l=>{l.preventDefault(),l.currentTarget instanceof HTMLElement&&l.currentTarget.classList.add("dragover")},[]),onDragLeave:z(l=>{const s=l.currentTarget instanceof HTMLElement?l.currentTarget:null;s&&(l.relatedTarget instanceof Node&&s.contains(l.relatedTarget)||s.classList.remove("dragover"))},[]),onDrop:z(l=>{const s=$e(l.dataTransfer?.getData("omnitable/sort-index")),u=l.currentTarget instanceof HTMLElement?l.currentTarget:null,d=$e(u?.dataset.index),{settings:m,setSettings:b,requestTween:p}=r;u?.classList.remove("dragover"),l.preventDefault();const f=m.slice();f.splice(d+(s>=d?0:-1),0,f.splice(s,1)[0]),p?.(),b(f)},[r]),onToggle:z(l=>{const{settings:s,setSettings:u,requestTween:d}=r,m=s.map(f=>({...f,disabled:f.disabled||r.collapsed?.some(v=>v.name===f.name)})),b=l.target instanceof HTMLInputElement?l.target:null,p=$e((l.target instanceof Element?l.target:null)?.closest("[data-index]")?.getAttribute("data-index"));p!=null&&(m.splice(p,1,{...s[p],disabled:!b?.checked,priority:b?.checked?s.reduce((f,v)=>Math.max(f,v.priority??0),0)+1:s[p]?.priority}),d?.(),u(m))},[r])}},wa=[Cn({apply({availableHeight:n,elements:e}){Object.assign(e.floating.style,{maxHeight:`${Math.max(0,n)}px`})}}),...$n],za=({onDragStart:n,onDragEnter:e,onDragOver:t,onDragLeave:i,onDrop:a,onDown:o,onToggle:r,collapsed:l,filters:s})=>(u,d)=>{const m=!!l?.find(p=>p.name===u.name),b=!u.disabled&&!m;return c` <div
		...
		${F(t,()=>c`<div class="buttons">
				...
				</div>`)}`};customElements.define("cosmoz-omnitable-settings-ui",O(Sa,{styleSheets:[_e(va)]}));const Aa=({config:n,newLayout:e})=>c`
	<cosmoz-dropdown
...
`;customElements.define("cosmoz-omnitable-settings",O(Aa,{styleSheets:[_e($a)]}));const Ae=["sortOn","descending","groupOn","groupOnDescending"],Ce=n=>e=>typeof e=="object"&&e!==null&&"name"in e&&e.name===n,qa=(n=[],e=[],t=[])=>{const i=e.filter(r=>n.some(Ce(r.name))),a=n.filter(r=>r.name!=null&&!e.some(Ce(r.name))&&!t.some(Ce(r.name))),o=t.filter(r=>!e.some(Ce(r.name)));return[...i,...o.flatMap(r=>{const l=n.find(s=>s.name===r.name);return l?{...r,title:l.title??r.title??"",minWidth:parseInt(l.minWidth??"0",10)}:[]}),...a.map(r=>{const{name:l,title:s,priority:u,minWidth:d,width:m,flex:b}=r;return{name:l??"",title:s??"",priority:u??0,minWidth:parseInt(d??"0",10),width:parseInt(m??"0",10),flex:parseInt(b??"0",10)}})]},Fa=(n,e)=>({...e,...We(Array.from(Ae))(n),columns:n.columns?.map(We(["name","priority","width","flex","disabled"]))}),ka=({columns:n,settings:e,savedSettings:t,initial:i})=>({...Object.fromEntries(Ae.flatMap(o=>i?.[o]!=null?[[o,i[o]]]:[])),...t?We(Array.from(Ae))(t):{},...e,columns:qa(n,e?.columns,t?.columns)}),Ea=({prefix:n="omnitable-"}={})=>({write:async(t,i)=>{const a=n+t;try{i?localStorage.setItem(a,JSON.stringify(i)):localStorage.removeItem(a)}catch(o){console.error(o)}},read:async t=>{if(!t)return null;try{const i=localStorage.getItem(n+t);return i==null?null:JSON.parse(i)}catch(i){return console.error(i),null}}}),_a=Ot(Ea),Ia=()=>{const n=Ke(_a);return E(()=>n(),[n])},Ma=(n,e,t,i)=>{const[a,o]=R(n?void 0:null),{read:r,write:l}=Ia();return M(async()=>{n&&o(await r(n))},[n,r]),{settingsId:n,savedSettings:a,onSave:z(async()=>{if(!n)return;const s=Fa(e,a);await l(n,s),t(),o(s)},[e,a]),onReset:z(async s=>{t(),s.shiftKey&&(await l(n),o(null)),i?.()},[i]),hasChanges:e!=null}},Oa=({settingsId:n,host:e})=>{const t=E(()=>Object.fromEntries(Ae.map(C=>[C,e[C]])),[]),i=Je(),a=z(()=>{i.current?.(t)},[t]),[o,r]=R(),[l,s]=R({columns:!0,sort:!0}),{savedSettings:u,...d}=Ma(n,o,r,a),{enabledColumns:m,disabledFiltering:b}=e,p=ni(e,{enabledColumns:m,disabledFiltering:b}),f=E(()=>ka({columns:p,settings:o,savedSettings:u??void 0,initial:t}),[p,o,u]),v=E(()=>f.columns.map(C=>p.find(h=>h.name===C.name)).filter(C=>C!==void 0),[p,...f.columns.map(C=>C.name)]);return{...d,savedSettings:u,opened:l,setOpened:s,settings:f,columns:v,setSettings:r,resetRef:i}},At=n=>Number.isFinite(n)?n:0,La=(n,e)=>{const t=[];let[i,a]=n.reduce(([d,m],{width:b,flex:p})=>[d+b,m+p],[0,0]),o=e-i,r=At(o/a),l=0,s=0,u=0;for(let d=0;d<n.length;d++){const{width:m,minWidth:b,flex:p}=n[d],f=o>=0?r*p:m*o/i;if(b>m+f){l+=m,s+=b,u+=p,t[d]=b;continue}if(p===0){l+=m,s+=m,t[d]=m;continue}}i-=l,o=e-s-i,a-=u,r=At(o/a);for(let d=0;d<n.length;d++){if(t[d]!=null)continue;const{width:m,flex:b}=n[d],p=o>=0?r*b:m*o/i;t[d]=m+p}return t},Ta=(n,e)=>{const t=ga(n,r=>r!=null&&r>0),i=(r,l)=>`.cell[name="${r}"], cosmoz-omnitable-skeleton::part(cell-${r}){width: ${Math.floor(l)}px;padding: 0 min(3px, ${l/2}px)}`,a=r=>`cosmoz-omnitable-resize-nub[name="${r}"]{display:none}`,o=r=>`cosmoz-omnitable-resize-nub[name="${r}"], .cell[name="${r}"]{display:none}`;return e.map((r,l)=>{const s=n[l];if(s==null||s===0)return o(r.name);const u=i(r.name,s);return l===t?`${u}
${a(r.name)}`:u}).join(`
`)},Zt=(n,e,t)=>{const i=n.filter(l=>!l.hidden),a=i.reduce((l,{width:s})=>l+s,0);if(i.length>1&&a>e)return Zt(i.slice(1),e,t);const o=i.reduce(([l,s],u,d)=>[Math.max(l,u.index),u.index>l?d:s],[-1,-1])[1];return o!==-1&&(i[o].flex=1),La(i,e).reduce((l,s,u)=>(l[i[u].index]=s,l),new Array(t).fill(void 0))},Da=(n,e)=>n.length===0?".cell {display: none;}":Ta(n,e),Ra=20,Va=44,Na=24,en=Ra+Va+Na,Pa=(n,e)=>M(()=>{const t=([a])=>{a.contentRect?.width!==0&&e(a.contentRect.width-en)},i=new ResizeObserver(t);return i.observe(n),()=>i.unobserve(n)},[]),Ba=n=>{const[e,t]=R(()=>n.getBoundingClientRect().width-en);return Pa(n,t),e},Ha=({canvasWidth:n,groupOnColumn:e,config:t,miniColumn:i})=>E(()=>{if(!Array.isArray(t)||n==null||n===0)return[];const a=t.map((o,r)=>({minWidth:o.minWidth,width:o.width,flex:o.flex,priority:o.priority,name:o.name,index:r,hidden:o.name===e?.name||o.disabled})).map(o=>i?{...o,hidden:i.name!==o.name}:o).sort(({index:o,priority:r},{index:l,priority:s})=>r===s?l-o:r-s);return Zt(a,n,a.length)},[n,e,t]),Ga=({host:n,canvasWidth:e,columns:t})=>{const i=n.miniBreakpoint??480,a=E(()=>e<=i,[e,i]),o=E(()=>a?t?.filter(u=>u.mini!=null).sort((u,d)=>(u.mini??0)-(d.mini??0)):[],[t,a]),[r,...l]=o??[],s=!!r;return M(()=>{n.toggleAttribute("mini",s)},[s]),{isMini:s&&a,miniColumn:r,miniColumns:l}},ja=({host:n,canvasWidth:e,layout:t,setSettings:i,requestTween:a})=>{const o=Je();o.current=r=>{a(),i(l=>{const s=l.columns,{detail:{newWidth:u,column:d}}=r,m=s.findIndex(f=>f.name===d.name),b=[],p=s.reduce((f,v)=>Math.max(f,v.priority),-1/0);for(let f=0;f<t.length;f++)if(b[f]={...s[f]},f<m&&t[f]&&(b[f].width=t[f],b[f].flex=0,b[f].priority=p),f===m){const v=t.reduce((C,h,w)=>w<m&&h?C-h:C,e);b[f].width=Math.min(v,Math.max(u,s[f].minWidth)),b[f].flex=0,b[f].priority=p}return{...l,columns:b}})},M(()=>{const r=l=>o.current?.(l);return n.addEventListener("column-resize",r),()=>n.removeEventListener("column-resize",r)},[])},Wa=(n,e)=>{const t=E(()=>{let i=!1,a;const o=()=>{if(!i)return;a=requestAnimationFrame(o),n()&&(i=!1)};return{start:()=>{i=!0,cancelAnimationFrame(a),a=requestAnimationFrame(o)},stop:()=>{i=!1,cancelAnimationFrame(a)}}},[]);M(()=>{t.start()},e),M(()=>()=>t.stop(),[])},Ua=(n=0,e=0)=>Math.abs(n-e)<.1,Ka=(n,e=1.9,t=wn,i)=>{const a=Ie({target:n,speedFactor:e,onConverge:i}),o=z(()=>{if(!a.tween)return a.tween=a.target,t(a.tween),a.onConverge?.(),!0;if(a.target.every((r,l)=>a.tween[l]===r))return t(a.tween),a.onConverge?.(),!0;if(a.tween=a.target.map((r,l)=>Ua(a.tween[l],r)?r:(a.tween[l]??0)+((r??0)-(a.tween[l]??0))/a.speedFactor||0),t(a.tween),a.tween.every((r,l)=>r===a.target[l]))return a.onConverge?.(),!0},[]);Wa(o,[n])},Ja=n=>{const e=E(()=>new CSSStyleSheet,[]);return M(()=>{n.shadowRoot.adoptedStyleSheets=[...n.shadowRoot.adoptedStyleSheets,e]},[]),e},Xa=({host:n,columns:e,settings:t,setSettings:i,resizeSpeedFactor:a,sortAndGroupOptions:o})=>{const r=Ba(n),{isMini:l,miniColumn:s,miniColumns:u}=Ga({host:n,canvasWidth:r,columns:e}),{groupOnColumn:d}=o,m=Ha({canvasWidth:r,groupOnColumn:d,miniColumn:s,config:t.columns}),b=Ja(n),p=E(()=>t.columns.reduce(($,g,x)=>m[x]!=null||g.name===d?.name||g.disabled?$:[...$,e.find(y=>y.name===g.name)],[]),[e,t,m]),[f,v]=R(1),C=z(()=>v(a??1.9),[a]),h=z(()=>v(1),[]),w=Ie({columns:t.columns});return Ka(m,f,$=>{const g=Da($,w.columns);b.replace(g)},h),ja({host:n,canvasWidth:r,layout:m,setSettings:$=>i($(t)),requestTween:C}),{isMini:l,collapsedColumns:p,miniColumns:u,requestTween:C}},Qa=({host:n,...e})=>{const{csvFilename:t="omnitable.csv",xlsxFilename:i="omnitable.xlsx",xlsxSheetname:a="Omnitable",topPlacement:o="top-end"}=n;return{csvFilename:t,xlsxFilename:i,xlsxSheetname:a,topPlacement:o,...e}},Ya=({host:n,selectedItems:e,data:t,dataIsValid:i,columns:a,sortAndGroupOptions:o,collapsedColumns:r,settings:l,filterFunctions:s,settingS:u,filters:d,setFilterState:m,hideSelectAll:b,requestTween:p,...f})=>{const v=e===T||!!t&&t.length>0&&Array.isArray(e)&&e.length===t.length,C=g=>{if(!(g.target instanceof HTMLInputElement))return;const x=n.shadowRoot.querySelector("#groupedList");g.target.checked?x.selectAll():x.deselectAll()},{groupOnColumn:h}=o,w=E(()=>[h,...r,...l.columns.filter(g=>g.disabled)].some(g=>!!g&&!!g.name&&Object.keys(s).includes(g.name)),[s,l,r]),$=E(()=>({...u,collapsed:r,badge:w,filters:d,requestTween:p}),[u,r,w,d,p]);return M(()=>{const g=n.shadowRoot.querySelector("#tableContent"),x=new ResizeObserver(y=>requestAnimationFrame(()=>{n.style.setProperty("--ot-height",y[0]?.contentRect.height+"px")}));return x.observe(g),()=>x.unobserve(g)},[]),{allSelected:v,onAllCheckboxChange:C,data:t,dataIsValid:i,columns:a,settingsConfig:$,filters:d,groupOnColumn:h,setFilterState:m,hideSelectAll:b,sortAndGroup:o.sortAndGroup,...f}},Za=n=>n instanceof HTMLInputElement,eo=n=>n instanceof HTMLElement,tn=c`
	<svg
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
...
`,to=n=>n?"groupRow groupRow-folded":"groupRow",no=({item:n,index:e})=>t=>F((t?.length??0)>0,()=>c`
		...
		<div
			?selected=${m}
			part="${["itemRow",`itemRow-${u[Se]}`,s?.(u,d)].filter(Boolean).join(" ")}"
			.dataIndex=${u[Se]}
			.dataItem=${u}
			class="itemRow"
			@click=${i}
	...
	`,ao=({onCheckboxChange:n,dataIsValid:e,groupOnColumn:t})=>(i,a,{selected:o,folded:r,toggleFold:l})=>c` <div
		...
		</div>`,oo=({host:n,error:e,dataIsValid:t,processedItems:i,columns:a,collapsedColumns:o,miniColumns:r,sortAndGroupOptions:l,rowPartFn:s,...u})=>{const{loading:d=!1,displayEmptyGroups:m=!1,compareItemsFn:b}=n,p=Je({shiftKey:!1,ctrlKey:!1}),f=z(w=>{if(!Za(w.target))return;const $=w.target,g=$.dataItem,x=$.checked,y=n.shadowRoot.querySelector("#groupedList");p.current.shiftKey?y.toggleSelectTo(g,x):p.current.ctrlKey?($.checked=!0,y.selectOnly(g)):y.toggleSelect(g,x),w.preventDefault(),w.stopPropagation()},[]);M(()=>{const w=({shiftKey:$,ctrlKey:g})=>{p.current={shiftKey:$,ctrlKey:g}};return window.addEventListener("keydown",w),window.addEventListener("keyup",w),()=>{window.removeEventListener("keydown",w),window.removeEventListener("keyup",w)}},[]);const v=z(w=>{if(!eo(w.currentTarget))return;const $=w.currentTarget,g=w.composedPath();g.slice(0,g.indexOf($)).some(y=>y instanceof Element&&y.matches("a, .checkbox, .expand"))||n.dispatchEvent(new window.CustomEvent("omnitable-item-click",{bubbles:!0,composed:!0,detail:{item:$.dataItem,index:$.dataIndex}}))},[]),{groupOnColumn:C}=l,h=z((w,$)=>g=>ii(n,w,$,g),[]);return{...u,processedItems:i,dataIsValid:t,filterIsTooStrict:t&&i.length<1,loading:d,compareItemsFn:b,displayEmptyGroups:m,error:e,renderItem:E(()=>io({columns:a,collapsedColumns:o,miniColumns:r,onItemClick:v,onCheckboxChange:f,dataIsValid:t,groupOnColumn:C,onItemChange:h,rowPartFn:s}),[a,o,v,f,t,C,h,s]),renderGroup:E(()=>ao({onCheckboxChange:f,dataIsValid:t,groupOnColumn:C}),[f,t,C])}},ro=(n,e)=>{if(n===e)return 0;if(n==null)return-1;if(e==null)return 1;const t=typeof n,i=typeof e;return t==="object"&&i==="object"?n.toString()<e.toString()?-1:1:t==="number"&&i==="number"?n-e:t==="string"&&i==="string"?n<e?-1:1:t==="boolean"&&i==="boolean"?n?-1:1:(console.warn("unsupported sort",t,n,i,e),0)},Pe=(n,e)=>(t,i)=>ro(n(t),n(i))*(e?-1:1),lo=n=>n.replace(/([a-z0-9])([A-Z])/gu,"$1-$2").toLowerCase(),qt=(n,e)=>{!n||!e||Object.entries(e).forEach(([t,i])=>{n[V].__ownChange=!0,n[V][t]=i,n[V].__ownChange=!1,n[V].dispatchEvent(new CustomEvent(`${lo(t)}-changed`,{bubbles:!0,detail:{value:i}}))})},Be=(n,e)=>Object.assign(n,{[Se]:e}),we=Symbol("unparsed"),so=({data:n,columns:e,hashParam:t,sortAndGroupOptions:i,noLocalSort:a,noLocalFilter:o})=>{const{groupOnColumn:r,groupOnDescending:l,sortOnColumn:s,descending:u}=i,d=z(([g,x])=>{const y=e.find(({name:q})=>q===g);return y==null?[g,void 0]:[g,x.filter&&y.serializeFilter(y,x.filter)]},[e]),m=z(([g,x])=>{const y=e.find(({name:k})=>k===g);if(y==null)return[g,{[we]:x}];const q={filter:y.deserializeFilter(y,x)};return qt(y,q),[g,q]},[e]),[b,p]=te({},t,{multi:!0,suffix:"-filter--",write:d,read:m}),f=z((g,x)=>p(y=>{const q=ke(x,y[g]);return qt(e.find(k=>k.name===g),q),{...y,[g]:{...y[g],...q}}}),[e,p]),v=E(()=>Object.values(b).map(g=>g.filter),[b]),C=E(()=>Object.fromEntries(e.map(g=>[g.name,!g.noLocalFilter&&g.getFilterFn(g,b[g.name]?.filter)]).filter(([,g])=>!!g)),[e,...v]),h=E(()=>!Array.isArray(n)||n.length===0?[]:Object.entries(C).length===0||o?n.slice():n.filter(g=>Object.values(C).every(x=>x(g))),[n,C,o]),w=E(()=>{if(!a&&!r&&s!=null&&s.sortOn!=null)return h.slice().sort(Pe(g=>s.getComparableValue({...s,valuePath:s.sortOn},g),u));if(r!=null&&r.groupOn!=null){const g=h.reduce((x,y)=>{const q=r.getComparableValue({...r,valuePath:r.groupOn},y);if(q===void 0)return x;let k=x.find(W=>W.id===q);return k?(k.items.push(y),x):(k={id:q,name:q,items:[y]},[...x,k])},[]);return g.sort(Pe(x=>r.getComparableValue({...r,valuePath:r.groupOn},x.items[0]),l)),!s||a?g:g.filter(x=>Array.isArray(x.items)).map(x=>(x.items.sort(Pe(y=>s.getComparableValue({...s,valuePath:s.sortOn},y),u)),x))}return h},[h,r,l,s,u,a]),$=E(()=>{let g=0,x=0;const y=[];return w.forEach(q=>{if(Array.isArray(q.items)){Be(q,x++),q.items.forEach(k=>{Be(k,g++),y.push(k)});return}return Be(q,g++),y.push(q)},[]),y},[w]);return M(()=>{p(g=>Object.values(g).some(y=>y[we]!=null)?Object.fromEntries(Object.entries(g).map(([y,q])=>q[we]==null?[y,q]:m([y,q[we]]))):g)},[m]),{processedItems:w,visibleData:$,filters:b,filterFunctions:C,setFilterState:f}},uo=n=>{const e=i=>{const a=n.data.indexOf(i);if(a<0)return null;const o=n.data.splice(a,1);if(n.data=n.data.slice(),Array.isArray(o)&&o.length>0)return o[0]},t=(i,a)=>{n.data.splice(i,1,a),n.data=n.data.slice()};return{removeItem:e,removeItems(i){const a=[];for(let o=i.length-1;o>=0;o-=1){const r=e(i[o]);r!=null&&a.push(r)}return a},replaceItemAtIndex:t,replaceItem(i,a){const o=n.data.indexOf(i);o>-1&&t(o,a)},selectItem(i){n.shadowRoot.querySelector("#groupedList").select(i)},selectAll(){n.shadowRoot.querySelector("#groupedList").selectAll()},deselectAll(){n.shadowRoot.querySelector("#groupedList").deselectAll()},deselectItem(i){n.shadowRoot.querySelector("#groupedList").deselect(i)},isItemSelected(i){return n.shadowRoot.querySelector("#groupedList").isItemSelected(i)}}},co=({host:n,visibleData:e,filters:t,...i})=>{const{setFilterState:a}=i,o=E(()=>uo(n),[]),[r,l]=Rt("selectedItems",[]);Ue(i,Object.values(i)),Ue(o,Object.values(o)),M(()=>{const u=d=>{if(!(d instanceof CustomEvent))return;const m=d.detail;a(m.name,b=>({...typeof b=="object"&&b!==null?b:{},...m.state}))};return n.addEventListener("legacy-filter-changed",u),()=>n.removeEventListener("legacy-filter-changed",u)},[]),U("visibleData",e),U("sortedFilteredGroupedItems",i.sortedFilteredGroupedItems),U("sortOn",i.sortOn),U("descending",i.descending),U("isMini",i.isMini);const s=E(()=>Object.fromEntries(Object.entries(t).filter(([,{filter:u}])=>u!==void 0).map(([u,{filter:d}])=>[u,d])),[t]);return U("filters",s,Object.values(s)),{selectedItems:r,setSelectedItems:l}},mo=n=>{const{hashParam:e,settingsId:t,data:i,resizeSpeedFactor:a,noLocal:o,noLocalSort:r=o,noLocalFilter:l=o,error:s,rowPartFn:u}=n,d=Oa({settingsId:t,host:n}),{settings:m,setSettings:b,columns:p,resetRef:f,savedSettings:v}=d,C=v!==void 0,h=na(p,e,{settings:m,setSettings:b,resetRef:f,ready:C}),{processedItems:w,visibleData:$,filters:g,setFilterState:x,filterFunctions:y}=so({data:i,columns:p,hashParam:e,sortAndGroupOptions:h,noLocalSort:r,noLocalFilter:l}),{isMini:q,collapsedColumns:k,miniColumns:W,requestTween:H}=Xa({host:n,columns:p,settings:m,setSettings:b,resizeSpeedFactor:a,sortAndGroupOptions:h}),at=i&&Array.isArray(i)&&i.length>0,{selectedItems:Re,setSelectedItems:ot}=co({host:n,visibleData:$,sortedFilteredGroupedItems:w,columns:p,filters:g,setFilterState:x,isMini:q,...h}),rt=Ya({host:n,selectedItems:Re,sortAndGroupOptions:h,dataIsValid:at,data:i,columns:p,filters:g,collapsedColumns:k,settings:m,filterFunctions:y,settingS:d,setFilterState:x,hideSelectAll:n.hideSelectAll===!0,requestTween:H});return{header:rt,list:oo({host:n,error:s,dataIsValid:at,processedItems:w,selectedItems:Re,setSelectedItems:ot,columns:p,collapsedColumns:k,miniColumns:W,sortAndGroupOptions:h,rowPartFn:u}),footer:Qa({host:n,selectedItems:Re,allSelected:rt.allSelected,setSelectedItems:ot,columns:p,enableSelectAll:n.enableSelectAll,allItemsCount:n.allItemsCount})}};customElements.define("cosmoz-grouped-list-row",class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||He(this._renderFn(this._item,this._index),this)}});const po={group:Symbol("group")},De=(n,e)=>(e.has(n)||e.set(n,{}),e.get(n)),go=(n,e)=>!!De(n,e).expanded,bo=(n,e)=>!!De(n,e).folded,qe=n=>n?n.items instanceof Array:!1,fo=n=>{if(!Array.isArray(n)||n.length===0)return;const e=Array.isArray(n[0]?.items);if(!n.every(i=>Array.isArray(i.items)===e))throw new Error("Data must be homogeneous.")},ho=(n,e,t)=>Array.isArray(n)?(fo(n),n.reduce((a,o)=>{const r=o;return r.items?r.items.length?De(o,t).folded?a.concat(o):a.concat(o,r.items.map(l=>Object.assign(l,{[po.group]:o}))):e?a.concat(o):a:a.concat(o)},[])):void 0,xo=(n,...e)=>typeof n=="function"?n(...e):n,yo=(n,e)=>n===e,vo=()=>{const[n,e]=R(()=>[new WeakMap]);return{setItemState:z((i,a)=>e(([o])=>{const r=De(i,o);return Object.assign(r,xo(a,r)),[o]}),[]),state:n[0],signal:n}},$o=()=>{const{setItemState:n,state:e,signal:t}=vo(),i=z((o,r)=>{qe(o)&&n(o,l=>({folded:r!==void 0?r:!l.folded}))},[]),a=z((o,r)=>{qe(o)||n(o,l=>({expanded:r!==void 0?!r:!l.expanded}))},[]);return{state:e,signal:t,toggleFold:i,toggleCollapse:a}},Co=({compareItemsFn:n,data:e,flatData:t})=>{const[i,a]=Rt("selectedItems",()=>[]),[o,r]=R(),l=z(h=>i===T||i.includes(h),[i]),s=z(h=>i===T||(h?.items?.every(l)??!1),[i,l]),u=z(h=>l(h)||s(h),[l,s]),d=z(h=>{const $=h.items??[h];a(g=>g===T?g:[...g,...$.filter(x=>!g.includes(x))]),r(h)},[]),m=z(h=>{const $=h.items??[h];a(g=>g===T?(t??[]).filter(x=>!qe(x)).filter(x=>!$.includes(x)):g.filter(x=>!$.includes(x))),r(h)},[t]),b=z(h=>{a(h.items?.slice()||[h]),r(h)},[]),p=z(()=>{a(e.flatMap(h=>h.items||h)),r(void 0)},[e]),f=z(()=>{a([]),r(void 0)},[]),v=z((h,w=!u(h))=>w?d(h):m(h),[u]),C=z((h,w)=>{if(!t)return;const $=o?t.findIndex(y=>n(y,o)):-1;if($<0)return v(h,w);const[g,x]=[$,t.indexOf(h)].sort((y,q)=>y-q);t.slice(g,x+1).forEach((y,q,k)=>{q>0&&q<k.length-1&&qe(y)||v(y,w)}),r(h)},[t,n,v]);return M(()=>a(h=>h!==T&&h.length>0&&t?t.filter(w=>h.find($=>n(w,$))):h),[t]),{selectedItems:i,isItemSelected:l,isGroupSelected:s,isSelected:u,select:d,deselect:m,selectOnly:b,selectAll:p,deselectAll:f,toggleSelect:v,toggleSelectTo:C}},wo={host:{position:"relative",display:"flex",flexDirection:"column"}},zo=n=>{const{data:e,renderItem:t,renderGroup:i,displayEmptyGroups:a,compareItemsFn:o=yo}=n,{toggleFold:r,toggleCollapse:l,state:s,signal:u}=$o(),d=E(()=>ho(e,a,s),[e,a,u]),{selectedItems:m,isItemSelected:b,isGroupSelected:p,isSelected:f,select:v,deselect:C,selectOnly:h,selectAll:w,deselectAll:$,toggleSelect:g,toggleSelectTo:x}=Co({compareItemsFn:o,data:e,flatData:d}),y=z((k,W)=>Array.isArray(k.items)?i(k,W,{selected:p(k),folded:bo(k,s),toggleSelect:H=>g(k,typeof H=="boolean"?H:void 0),toggleFold:()=>r(k)}):t(k,W,{selected:b(k),expanded:go(k,s),toggleSelect:H=>g(k,typeof H=="boolean"?H:void 0),toggleCollapse:()=>l(k)}),[t,i,m,g,u]);Et(()=>{Object.assign(n.style,wo.host)},[]);const q={toggleFold:r,toggleCollapse:l,isItemSelected:b,isGroupSelected:p,isSelected:f,select:v,deselect:C,selectOnly:h,selectAll:w,deselectAll:$,toggleSelect:g,toggleSelectTo:x};return Ue(q,Object.values(q)),{renderRow:y,flatData:d}},So=({renderRow:n,flatData:e})=>zn({items:e,renderItem:(t,i)=>c`<cosmoz-grouped-list-row
				.item=${t}
				.index=${i}
				.renderFn=${n}
	...
	`};customElements.define("cosmoz-omnitable",O(Fo,{observedAttributes:["hash-param","sort-on","group-on","descending","group-on-descending","hide-select-all","settings-id","no-local","no-local-sort","no-local-filter","disabled-filtering","loading","mini-breakpoint","inline","enable-select-all"]}));const Fe=`
