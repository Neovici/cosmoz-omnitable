import{n as e}from"./chunk-BneVvdWh.js";import{Q as t,Z as n,et as r,r as i,t as a,tt as o}from"./iframe-Cw1AIwAY.js";import{$ as s,A as c,At as l,B as u,Bt as d,C as f,Ct as p,D as m,Dt as h,E as g,Et as _,F as v,Ft as y,G as b,H as x,Ht as S,I as ee,It as te,J as ne,K as re,L as ie,Lt as C,M as ae,Mt as w,N as oe,Nt as T,O as se,Ot as E,P as ce,Pt as le,Q as ue,R as de,Rt as fe,S as pe,St as me,T as he,Tt as ge,U as _e,Ut as ve,V as ye,Vt as be,W as xe,X as Se,Y as Ce,Z as we,_ as Te,_t as Ee,a as De,at as Oe,b as ke,bt as Ae,c as je,ct as Me,d as Ne,dt as Pe,et as Fe,f as Ie,ft as Le,g as Re,gt as D,h as ze,ht as O,it as Be,j as Ve,jt as He,k as Ue,kt as k,l as We,lt as A,m as Ge,mt as Ke,n as qe,nt as Je,o as Ye,ot as Xe,p as Ze,pt as Qe,q as $e,r as et,rt as tt,s as nt,st as rt,t as it,tt as at,u as ot,ut as j,v as st,vt as ct,w as lt,wt as ut,x as dt,xt as ft,y as pt,yt as mt,z as ht,zt as M}from"./dist-Dsc3p4qA.js";var gt,_t,vt=e((()=>{Ce(),w(),gt=ue`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,customElements.define(`cosmoz-clear-button`,T(_t))})),N,yt,bt,xt,St,P,F=e((()=>{D(),N=({valuePath:e},t)=>O(t,e),yt=N,bt=N,xt=({valuePath:e},t)=>n=>{let r=O(n,e);return r==null?!1:r.toString().toLowerCase().trim().includes(t.toLowerCase().trim())},St=(e,t)=>t===``||t==null?null:t,P=e=>class extends e{static get properties(){return{isOmnitableColumn:{type:Boolean,value:!0},title:{type:String},valuePath:{type:String,notify:!0},values:{type:Array,notify:!0},filter:{type:Object},noLocalFilter:{type:Boolean},disabled:{type:Boolean,value:!1,notify:!0},editable:{type:Boolean,notify:!0},loading:{type:Boolean,value:!1,notify:!0},externalValues:{type:Boolean,value:!1,notify:!0},name:{type:String},sortOn:{type:String},groupOn:{type:String},noSort:{type:Boolean,value:!1},disabledFiltering:{type:Boolean,value:!1},width:{type:String,value:`75px`},minWidth:{type:String,value:`40px`},flex:{type:String,value:`1`},cellClass:{type:String,value:`default-cell`},headerCellClass:{type:String,value:`default-header-cell`},priority:{type:Number,value:0},hidden:{type:Boolean,notify:!0},preferredDropdownHorizontalAlign:{type:String,value:`right`},renderHeader:{type:Function},renderCell:{type:Function},renderEditCell:{type:Function},renderGroup:{type:Function},mini:{type:Number,value:null},renderMini:{type:Function}}}static get observers(){return[`notifyFilterChange(filter)`]}notifyFilterChange(e){this.__ownChange||this.dispatchEvent(new CustomEvent(`legacy-filter-changed`,{detail:{name:this.name,state:this.legacyFilterToState(e)},bubbles:!0}))}legacyFilterToState(e){return{filter:e}}getFilterFn(){}getString(e,t){return N(e,t)}toXlsxValue(e,t){return yt(e,t)}cellTitleFn(e,t){return this.getString(e,t)}headerTitleFn(e){return e.title}serializeFilter(e,t){return St(e,t)}deserializeFilter(e,t){return t==null?null:typeof t==`string`?window.decodeURIComponent(t):t}getComparableValue(e,t){return bt(e,t)}computeSource(e,t){return t}_propertiesChanged(e,t,n){super._propertiesChanged(e,t,n),this.dispatchEvent(new CustomEvent(`cosmoz-column-prop-changed`,{bubbles:!0}))}}})),Ct,wt,Tt,Et,Dt,Ot,kt,At=e((()=>{x(),vt(),j(),o(),E(),F(),Ct=e=>t=>e(n=>{if(n.inputValue===void 0&&t.target.value===``)return n;clearTimeout(n.t);let r=setTimeout(()=>e(e=>({...e,filter:e.inputValue})),1e3);return{...n,inputValue:t.target.value,t:r}}),wt=e=>()=>e(e=>({...e,filter:e.inputValue})),Tt=e=>t=>{t.keyCode===13&&(t.preventDefault(),e(e=>({...e,filter:e.inputValue})))},Et=e=>t=>e(e=>({...e,headerFocused:t.detail.value})),Dt=e=>()=>e(e=>({...e,filter:null,inputValue:null})),Ot=e=>e!=null&&e!==``,kt=class extends P(A){static get properties(){return{minWidth:{type:String,value:`55px`},editMinWidth:{type:String,value:`55px`},inputValue:{type:Object,notify:!0}}}getFilterFn(e,t){if(!(t==null||t===``))return xt(e,t)}renderCell(e,{item:t}){return r`<span class="default-column">${N(e,t)}</span>`}renderEditCell(e,{item:t},n){return r`<cosmoz-input
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,inputValue:n,headerFocused:i},a){return r`<cosmoz-input
			...
			@blur=${wt(a)}
		>
			${k(!e.disabledFiltering,()=>r`<cosmoz-clear-button
						suffix
						slot="suffix"
						?visible=${Ot(t)}
						light
						@click=${Dt(a)}
					></cosmoz-clear-button>`)}
		</cosmoz-input>`}legacyFilterToState(e){return{filter:e,inputValue:e}}},customElements.define(`cosmoz-omnitable-column`,kt)})),jt,Mt,Nt,Pt=e((()=>{x(),w(),o(),jt=[`label`,`value`,`slot`,`always-float-label`,`disabled`],Mt=ve`
	${ne}
...
`,Nt=e=>{let{label:t,value:n,slot:i}=e;return Oe(r`<div
		id="input"
		part="input"
		role="button"
		class="control"
	...
	>
		${n||``}
	</div>`,{label:t})},customElements.define(`cosmoz-omnitable-dropdown-input`,T(Nt,{observedAttributes:jt,styleSheets:[Mt]}))})),Ft,It=e((()=>{me(),o(),ye(),Pt(),Ft=({title:e,tooltip:t=``,filterText:n=``,onOpenedChanged:i,content:a,horizontalAlign:o=`left`,externalValues:s=null})=>r`
		<style>
			.dropdown {
				outline: none;
			}
	...
	`})),Lt,Rt,zt=e((()=>{mt(),Qe(),ht(),ee(),Lt=e=>e?typeof e.close==`function`?e:Lt(e.parentElement):null,Rt=e=>class extends e{static get properties(){return{disabled:{type:Boolean,value:!1},filter:{type:Object,notify:!0},values:{type:Array,value(){return[]}},headerFocused:{type:Boolean,notify:!0},min:{type:Number,value:null},max:{type:Number,value:null},limits:{type:Function},autoupdate:{type:String,value:!0},locale:{type:String,value:null},_filterInput:{type:Object,value(){return{min:null,max:null}}},_range:{type:Object,computed:`_computeRange(values.*)`},_limit:{type:Object,computed:`_computeLimit(_range, _filterInput.*, min, max)`,value(){return{}}},_tooltip:{type:String,computed:`_computeTooltip(title, _filterText)`},_fromClasses:{type:String,computed:`_computeInputClasses(_filterInput.min)`},_toClasses:{type:String,computed:`_computeInputClasses(_filterInput.max)`}}}static get observers(){return[`_filterInputChanged(_filterInput.*, autoupdate)`,`_filterChanged(filter.*)`,`_updateLimits(limits, headerFocused)`]}disconnectedCallback(){this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),super.disconnectedCallback()}_computeInputClasses(e){return e!=null&&e!==``?`has-value`:``}toNumber(e,t,n){if(e==null||e===``)return;let r=typeof e==`number`?e:Number(e);if(Number.isNaN(r))return;if(n==null||t==null)return r;let i=this.toNumber(t);return i==null?r:n(r,i)}toValue(){return this.toNumber.apply(this,arguments)}getComparableValue(e,t){if(e==null)return;let n=e;return t!=null&&(n=this.get(t,e)),this.toValue(n)}renderValue(){}getInputString(e,t=this.valuePath){let n=this.toValue(this.get(t,e));return this._toInputString(n)}_computeRange(e){let t=e.base,n=Array.isArray(t)&&t.length&&t.map(e=>this.toValue(e)).filter(e=>e!=null);return!n||n.length<1?{min:null,max:null}:n.reduce((e,t)=>({min:this.toValue(t,e.min,Math.min),max:this.toValue(t,e.max,Math.max)}),{})}_computeLimit(e,t,n,r){if(!e)return;let i=t.base,a=this.toValue(n),o=this.toValue(r),s=a??this.toValue(e.min),c=o??this.toValue(e.max);return{fromMin:s,fromMax:this.toValue(c,this._fromInputString(i.max,`max`),Math.min),toMin:this.toValue(s,this._fromInputString(i.min,`min`),Math.max),toMax:c}}_computeFilterText(e){if(e.base==null)return;let t=e.base,n=this.toValue(t.min),r=this.toValue(t.max),i=[];return n!=null&&i.push(this.renderValue(n)),i.push(` - `),r!=null&&i.push(this.renderValue(r)),i.length>1?i.join(``):void 0}_computeTooltip(e,t){return t==null?e:`${e}: ${t}`}_fromInputString(e){return this.toValue(e)}_toInputString(e){return this.toValue(e)??null}_getDefaultFilter(){return{min:null,max:null}}_filterInputChanged(e,t){this.__inputChangePath=e.path.split(`.`)[1]||null,t&&(this._limitInputDebouncer=ie.debounce(this._limitInputDebouncer,Ke.after(600),()=>{this._limitInput(),this._updateFilter()}),de(this._limitInputDebouncer))}_clearFrom(){this.set(`_filterInput.min`,null),this._updateFilter()}_clearTo(){this.set(`_filterInput.max`,null),this._updateFilter()}_onBlur(){this._limitInput(),this._updateFilter()}_onKeyDown(e){let t=e.currentTarget,n=Array.from(t.parentElement.querySelectorAll(`cosmoz-input`)),r=n[n.findIndex(e=>e===t)+1],i=!r,a=n[0]===t;switch(e.keyCode){case 13:if(e.preventDefault(),!i)r.focus();else{let e=this._limitInput();this._updateFilter(),e||this._closeParent(t)}break;case 9:(i&&!e.shiftKey||a&&e.shiftKey)&&this._closeParent(t)}}_closeParent(e){let t=Lt(e);t&&t.close()}_onDropdownOpenedChanged({currentTarget:e,type:t,detail:n}){(t===`focus`||n?.value===!0)&&setTimeout(()=>{e.querySelector(`cosmoz-input:focus`)||e.querySelector(`cosmoz-input`)?.focus()},100)}_limitInput(){let e=this._filterInput,t=this.__inputChangePath,n=t?this._fromInputString(this.get(t,e),t):null;if(this.__inputChangePath=null,n==null)return!1;let r=this._limit,i=t===`min`?`from`:`to`,a=this.get(i+`Min`,r),o=this.get(i+`Max`,r),s=this.toValue(n,a,Math.max),c=this.toValue(s,o,Math.min);return this.getComparableValue(n)===this.getComparableValue(c)?!1:(this.set([`_filterInput`,t],this._toInputString(c,t)),this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),!0)}_updateFilter(){let e=this._filterInput,t=this.filter,n=this._fromInputString(e.min,`min`),r=this._fromInputString(e.max,`max`);this.getComparableValue(n)===this.getComparableValue(t,`min`)&&this.getComparableValue(r)===this.getComparableValue(t,`max`)||this.set(`filter`,{min:n,max:r})}_filterChanged(e){if(this._filterInput==null)return;let t=this._filterInput,n=e.base,r=this._fromInputString(t.min,`min`),i=this._fromInputString(t.max,`max`);this.getComparableValue(r)===this.getComparableValue(n,`min`)&&this.getComparableValue(i)===this.getComparableValue(n,`max`)||(this.set(`_filterInput`,{min:this._toInputString(n.min),max:this._toInputString(n.max)}),this._limitInputDebouncer&&this._limitInputDebouncer.cancel())}hasFilter(){let e=this.filter;return e==null?!1:this.toValue(e.min)!=null||this.toValue(e.max)!=null}resetFilter(){this.filter=this._getDefaultFilter()}_updateLimits(e,t){e&&Promise.resolve(Ae(e,{active:t})).then(e=>{let{min:t,max:n}=e??{};Object.assign(this,{...t==null?{}:{min:t},...n==null?{}:{max:n}})})}}})),Bt,Vt=e((()=>{j(),o(),Bt=e=>class extends e{static get template(){return Pe`<div id="output" style="position:relative;"></div>`}connectedCallback(){super.connectedCallback(),t(this.render(),this.$.output)}_propertiesChanged(e,n,r){super._propertiesChanged(e,n,r),requestAnimationFrame(()=>t(this.render(),this.$.output))}}})),Ht,Ut=e((()=>{x(),j(),a(),o(),E(),It(),Pt(),zt(),Vt(),Ht=class extends Rt(Bt(A)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:`_computeFilterText(filter.*, _formatters)`},headerFocused:{type:Boolean,value:!1}}}static get observers(){return[`_valuesChanged(autodetect, currency, values)`]}render(){let e=e=>{this.headerFocused=e.type===`focus`,this._onDropdownOpenedChanged(e)};return r`
			${k(this.disabled,()=>r`
				...
				`,()=>r`
					...
					></cosmoz-clear-button>
					${Ft({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:r`
		...
		></cosmoz-omnitable-amount-range-input>`}computeSource(e,t){return V(e,t)}},customElements.define(`cosmoz-omnitable-column-amount`,_n)})),yn,bn,xn,Sn,Cn,wn,Tn,En,Dn,On,kn,An,jn=e((()=>{lt(),mt(),he(),D(),H(),yn=(e,t)=>{if(!Array.isArray(e))return;let n=[];return e.reduce((e,t)=>Array.isArray(t)?(t.forEach(t=>{e.push(t)}),e):(e.push(t),e),[]).filter((e,r,i)=>{if(i.indexOf(e)!==r)return!1;if(t){let r=O(e,t);if(n.indexOf(r)!==-1)return!1;n.push(r)}return!0})},bn=(e,t,n)=>{if(e==null)return[];if(Array.isArray(e)){let r=yn(e,t);if(!r?.length)return r;let i=n??`label`,a=e=>String(typeof e==`object`&&e?O(e,i)??``:e??``);return r.sort((e,t)=>a(e).localeCompare(a(t)))}if(typeof e==`object`){let r=t??`id`,i=n??`label`;return Object.entries(e).map(([e,t])=>({[r]:e,[i]:t})).sort((e,t)=>String(e[i]??``).localeCompare(String(t[i]??``)))}return[]},xn=(e,t,n)=>f(t&&O(e,t)).map(g(n)),Sn=({valuePath:e,textProperty:t},n)=>xn(n,e,t).filter(e=>e!=null).join(`, `),Cn=Sn,wn=({valueProperty:e,valuePath:t,emptyValue:n,emptyProperty:r},i)=>a=>{let o=g(e),s=f(O(a,t));return i.some(t=>s.length===0&&g(r||e)(t)===n||s.some(e=>o(e)===o(t)))},Tn=e=>t=>e(e=>({...e,filter:t})),En=e=>t=>e(e=>({...e,headerFocused:t})),Dn=e=>t=>e(e=>({...e,query:t})),On=({emptyValue:e,emptyLabel:t,emptyProperty:n,textProperty:r,valueProperty:i},a)=>{let o=bn(a,i,r);return!t||e===void 0||!r||!(n||i)||!o?o:[{[r]:t,[n||i]:e},...o]},kn=(e,t)=>On(e,hn(t,e.valuePath)),An=e=>class extends e{static get properties(){return{textProperty:{type:String},valueProperty:{type:String},emptyLabel:{type:String},emptyValue:{type:Object},emptyProperty:{type:String}}}getConfig(e){return{emptyProperty:e.emptyProperty}}getString(e,t){return Sn(e,t)}toXlsxValue(e,t){return Cn(e,t)}getComparableValue({valuePath:e,valueProperty:t},n){let r=O(n,e);return t==null?r:f(r).reduce((e,n)=>(e.push(O(n,t)),e),[]).sort().join(` `)}getFilterFn(e,t){if(!(!t||!Array.isArray(t)||t.length===0))return wn(e,t)}serializeFilter(e,t){return t.length===0?null:JSON.stringify(t)}deserializeFilter(e,t){return JSON.parse(decodeURIComponent(t))}computeSource(e,t){return e.externalValues||typeof e.values==`function`?async(...t)=>On(e,await Promise.resolve(Ae(e.values,...t))):kn(e,t)}}})),Mn,Nn,Pn,Fn=e((()=>{pe(),dt(),j(),o(),E(),lt(),he(),jn(),F(),w(),D(),mn(),Mn=({valuePath:e,textProperty:t,valueProperty:n},r)=>{let i=t?se(t):g(n),a=f(e&&O(r,e)).map(i);return a.length>1?a.filter(Boolean).join(`,`):a[0]},Nn=({valueProperty:e,valuePath:t,emptyValue:n,emptyProperty:r},i)=>{let a=g(e),o=g(r||e),s=new Set(i.filter(e=>e.excluded).map(e=>a(e.item))),c=new Set(i.filter(e=>!e.excluded).map(e=>a(e.item))),l=i.some(e=>e.excluded&&o(e.item)===n),u=i.some(e=>!e.excluded&&o(e.item)===n);return e=>{let n=f(O(e,t)).map(a);return n.length===0?!l&&(u||c.size===0):!n.some(e=>s.has(e))&&(c.size===0||n.some(e=>c.has(e)))}},Pn=class extends An(P(A)){static get properties(){return{headerCellClass:{type:String,value:`autocomplete-header-cell`},minWidth:{type:String,value:`55px`},editMinWidth:{type:String,value:`55px`},keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},showSingle:{type:Boolean},preserveOrder:{type:Boolean},limit:{type:Number},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,showSingle:e.showSingle,preserveOrder:e.preserveOrder,limit:e.limit,textual:e.textual}}renderCell(e,{item:t}){return r`<span class="default-column"
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:n},i,a){return r`<cosmoz-autocomplete-excluding
			...
			.text=${n}
			.limit=${e.limit}
			@opened-changed=${e=>En(i)(e.detail.value)}
			@value-changed=${te(Tn(i))}
			@text-changed=${te(Dn(i))}
			>${k(e.loading,()=>r`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-excluding
		>`}getComparableValue(e,t){return Mn(e,t)}getFilterFn(e,t){if(!(!t||!Array.isArray(t)||t.length===0))return Nn(e,t)}},customElements.define(`cosmoz-omnitable-column-autocomplete-excluding`,Pn)})),In,Ln,Rn=e((()=>{pe(),dt(),j(),o(),E(),lt(),he(),jn(),F(),D(),mn(),In=({valuePath:e,textProperty:t,valueProperty:n},r)=>{let i=t?se(t):g(n),a=f(e&&O(r,e)).map(i);return a.length>1?a.filter(Boolean).join(`,`):a[0]},Ln=class extends An(P(A)){static get properties(){return{headerCellClass:{type:String,value:`autocomplete-header-cell`},minWidth:{type:String,value:`55px`},editMinWidth:{type:String,value:`55px`},keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},showSingle:{type:Boolean},preserveOrder:{type:Boolean},limit:{type:Number},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,showSingle:e.showSingle,preserveOrder:e.preserveOrder,limit:e.limit,textual:e.textual}}renderCell(e,{item:t}){return r`<span class="default-column"
			>${e.getString(e,t)}</span
		>`}renderEditCell(e,{item:t},n){return r`<cosmoz-input
			no-label-float
			type="text"
		...
		>`}getComparableValue(e,t){return In(e,t)}},customElements.define(`cosmoz-omnitable-column-autocomplete`,Ln)})),zn,Bn,Vn,Hn,Un,Wn,Gn,Kn,qn,Jn,Yn,Xn,Zn,Qn,$n=e((()=>{j(),F(),pe(),oe(),D(),o(),E(),zn=(e,t)=>t.find(({value:t})=>e===t),Bn=(e,t,n)=>{let r=zn(t,n);return r?r.text:e},Vn=(e,t,n,r)=>Bn(e,O(t,n),r),Hn=({valuePath:e},t,n)=>zn(O(t,e),n),Un=e=>t=>{e(e=>({...e,filter:t?.[0]?.value??null}))},Wn=e=>t=>{e(e=>({...e,headerFocused:t}))},Gn=e=>t=>{e(e=>({...e,query:t}))},Kn=e=>t=>e(t?.[0]?.value),qn=({valuePath:e,trueLabel:t,falseLabel:n},r)=>O(r,e)?t:n,Jn=({valuePath:e},t)=>n=>O(n,e)===t,Yn=ce((e,t)=>[{text:e,value:!0},{text:t,value:!1}]),Xn=({valuePath:e,trueLabel:t,falseLabel:n},r)=>e?O(r,e)?t:n:``,Zn=(e,t)=>{try{return JSON.parse(t)}catch{return null}},Qn=class extends P(A){static get properties(){return{trueLabel:{type:String,value:`True`},falseLabel:{type:String,value:`False`},flex:{type:String,value:`0`},cellClass:{type:String,value:`boolean-cell`}}}getString(e,t){return qn(e,t)}renderCell(e,{item:t}){return qn(e,t)}renderEditCell(e,{item:t},n){let{trueLabel:i,falseLabel:a}=e;return r`<cosmoz-autocomplete
			variant="inline"
			.title=${Vn(e.title,t,e.valuePath,Yn(i,a))}
			.source=${Yn(i,a)}
			.textProperty=${`text`}
			.value=${Hn(e,t,Yn(i,a))}
			.onChange=${Kn(n)}
			...
			${k(this.disabled,()=>r`
				...
				`,()=>r`
					...
					${Ft({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:r`
						...
						`})}
				`)}
		`}_fromInputString(e,t){let n=this.toDate(e);if(n!=null)return t===`min`&&n.setHours(0,0,0,0),t===`max`&&n.setHours(23,59,59),n}_filterInputChanged(e,t){let n=e.path.split(`.`)[1]&&e.value;if(n&&n.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}},customElements.define(`cosmoz-omnitable-date-range-input`,nr)})),ir,ar,or,U,W,sr,cr,lr,ur,dr,fr,pr,mr,hr,gr,_r=e((()=>{Fe(),D(),Xt(),ir=e=>{let t=-new Date(e).getTimezoneOffset()/60;return(t<0?`-`:`+`)+[`0`,Math.abs(t)].join(``).substr(-2)+`:00`},ar=e=>e.length===19?e+ir(e):e,or=e=>{if(e==null||e===``)return;let t=e;return!(t instanceof Date)&&(typeof e==`string`&&(t=ar(t)),t=s(t),!t)||Number.isNaN(t.getTime())?null:t},U=({valuePath:e},t)=>{if(t==null)return;let n=t;e!=null&&(n=O(t,e));let r=or(n);if(r!=null)return I(r.getTime())},W=(e,t,n)=>{let r=or(e);if(r==null)return null;if(n==null||t==null)return r;let i=W(t);if(i==null)return r;let a=U({},r),o=U({},i);return a==null||o==null||n(a,o)===a?r:i},sr=(e,t)=>{if(t==null)return;let n=W(e);if(n!=null)return t.format(n)},cr={},lr=e=>{let t=e||``;return cr[t]||(cr[t]=new Intl.DateTimeFormat(e||void 0)),cr[t]},ur=({valuePath:e,locale:t},n)=>{let r=O(n,e||``);return r===void 0?``:(r=W(r),r===null?`Invalid Date`:sr(r,lr(t)))},dr=e=>{let t=W(e);if(t==null)return null;let n=at(t);return n==null?null:n.slice(0,10)},fr=({valuePath:e},t)=>dr(O(t,e||``)),pr=(e,t)=>{let n=W(e);if(n!=null)return t===`min`&&n.setHours(0,0,0,0),t===`max`&&n.setHours(23,59,59),n},mr=e=>dr(e)??``,hr=({valuePath:e},t)=>{if(!e)return``;let n=W(O(t,e));if(!n)return``;let r=W(at(n));return r?(r.setHours(0,0,0,0),r):``},gr=(e,t)=>n=>{let r=U(e,n);if(r==null)return!1;let i=U({...e,valuePath:`min`},t),a=U({...e,valuePath:`max`},t);return!(r<(i??-1/0)||r>(a??1/0))}})),vr,yr=e((()=>{x(),j(),o(),F(),rr(),H(),_r(),vt(),vr=class extends P(A){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:`date-header-cell`},width:{type:String,value:`100px`},minWidth:{type:String,value:`82px`},flex:{type:String,value:`0`}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){let n=U({...e,valuePath:`min`},t),r=U({...e,valuePath:`max`},t);if(!(n==null&&r==null))return gr(e,t)}getString(e,t){return ur(e,t)}toXlsxValue(e,t){return hr(e,t)}getComparableValue(e,t){return U(e,t)}serializeFilter(e,t){if(t==null)return;let n=W(t.min),r=W(t.max);if(!(n==null&&r==null))return mr(n)+`~`+mr(r)}deserializeFilter(e,t){if(t==null||t===``)return null;let n=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(n)?{min:W(n[1]),max:W(n[2])}:null}renderCell(e,{item:t}){return r`<div class="omnitable-cell-date">
			${ur(e,t)}
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return V(e,t)}},customElements.define(`cosmoz-omnitable-column-date`,vr)})),br,xr=e((()=>{j(),a(),o(),E(),tr(),It(),Pt(),Vt(),br=class extends er(Bt(A)){render(){let e=e=>{this.headerFocused=e.type===`focus`};return r`
			<style>
		...
		></cosmoz-omnitable-datetime-range-input>`}computeSource(e,t){return V(e,t)}},customElements.define(kr.is,kr)})),jr,Mr=e((()=>{pe(),dt(),j(),o(),E(),jn(),F(),jr=class extends An(P(A)){renderCell({valuePath:e,textProperty:t},{item:n}){return r`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		`}renderEditCell(){return`not implemented`}renderHeader(e,{filter:t,query:n},i,a){return r`<cosmoz-autocomplete-ui
			...
			.onText=${Dn(i)}
			>${k(e.loading,()=>r`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}},customElements.define(`cosmoz-omnitable-column-list-horizontal`,jr)})),Nr,Pr=e((()=>{st(),Ce(),j(),Le(),window.Cosmoz=window.Cosmoz||{},Nr=class extends pt(Se(Be,A)){static get template(){return Pe`
			<style>
				:host {
					display: block;
				}
		...
		`}static get is(){return`cosmoz-omnitable-column-list-data`}static get properties(){return{items:{type:Array},_expanded:{type:Boolean,value:!1},_othersCount:{type:Number,computed:`_computeOthersCount(items)`}}}static get observers(){return[`_itemsLengthChanged(items.length)`]}_itemsLengthChanged(){requestAnimationFrame(()=>this.dispatchEvent(new CustomEvent(`expand`,{bubbles:!0})))}_firstItem(e){if(e!=null&&e.length>0)return e[0]}_hideExpand(e,t){return e!==void 0&&e.length!==null?e.length<=2||t:!0}_hideCollapse(e,t){return e!==void 0&&e.length!==null?e.length<=2||!t:!0}_otherItems(e,t){if(e!=null&&(e.length<=2||t))return e.slice(1)}_computeOthersCount(e){if(e!=null)return e.length-1}_toggleExpand(e){this._expanded=!this._expanded,e.stopPropagation(),e.preventDefault()}},customElements.define(Nr.is,Nr)})),Fr,Ir=e((()=>{Pr(),j(),o(),E(),pe(),jn(),F(),mn(),Fr=class extends An(P(A)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:n}){return r`<cosmoz-omnitable-column-list-data
			.items=${xn(n,e,t)}
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:n},i,a){return r`<cosmoz-autocomplete-ui
			...
			.onText=${Dn(i)}
			>${k(e.loading,()=>r`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}},customElements.define(`cosmoz-omnitable-column-list`,Fr)})),Lr,Rr=e((()=>{x(),j(),a(),o(),E(),It(),Pt(),zt(),Vt(),Lr=class extends Rt(Bt(A)){static get properties(){return{maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null},formatter:{type:Object,computed:`_computeFormatter(locale, minimumFractionDigits, maximumFractionDigits)`},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:`_computeFilterText(filter.*, formatter)`},headerFocused:{type:Boolean,value:!1}}}render(){let e=e=>{this.headerFocused=e.type===`focus`,this._onDropdownOpenedChanged(e)};return r`
			<style>
			...
			${k(this.disabled,()=>r`
				...
				`,()=>r`
					<cosmoz-clear-button
						...
						?visible=${this.hasFilter()}
					></cosmoz-clear-button>
					${Ft({title:this.title,tooltip:this._tooltip,filterText:this._filterText,horizontalAlign:`right`,externalValues:this.externalValues,onOpenedChanged:e,content:r`
							<h3>${this.title}</h3>
							<cosmoz-input
								class=${this._fromClasses}
								type="number"
		...
		></cosmoz-omnitable-number-range-input>`}computeSource(e,t){return V(e,t)}},customElements.define(`cosmoz-omnitable-column-number`,zr)})),Vr,Hr=e((()=>{x(),j(),a(),o(),E(),tr(),It(),Pt(),Vt(),Vr=class extends er(Bt(A)){render(){let e=e=>{this.headerFocused=e.type===`focus`};return r`
			${k(this.disabled,()=>r`
					<cosmoz-omnitable-dropdown-input
						disabled
						.label=${this.title}
		...
		></cosmoz-input>`}renderHeader({title:e,min:t,max:n,locale:i,filterStep:a,disabledFiltering:o},{filter:s},c,l){return r`<cosmoz-omnitable-time-range-input
			...
			@filter-changed=${({detail:{value:e}})=>c(t=>({...t,filter:e}))}
			@header-focused-changed=${({detail:{value:e}})=>c(t=>({...t,headerFocused:e}))}
		></cosmoz-omnitable-time-range-input>`}computeSource(e,t){return V(e,t)}},customElements.define(`cosmoz-omnitable-column-time`,$r)})),ti=e((()=>{vn(),Fn(),Rn(),$n(),yr(),Ar(),Mr(),Ir(),Br(),ei()})),ni,ri=e((()=>{w(),o(),ni=({column:e,item:t,selected:r,folded:i,group:a})=>e?(e.renderGroup??e.renderCell)(e,{item:t,selected:r,folded:i,group:a}):n,customElements.define(`cosmoz-omnitable-group-row`,T(ni,{useShadowDOM:!1}))})),ii,ai=e((()=>{w(),o(),ii=e=>{let{column:t}=e;return S(()=>{let n=0,r=0,i=i=>{e.dispatchEvent(new CustomEvent(`column-resize`,{bubbles:!0,composed:!0,detail:{newWidth:Math.ceil(r+i.pageX-n),column:t}}))},a=()=>{document.removeEventListener(`pointermove`,i),document.removeEventListener(`pointerup`,a)},o=t=>{n=t.pageX,r=e.previousElementSibling.getBoundingClientRect().width,document.addEventListener(`pointermove`,i),document.addEventListener(`pointerup`,a)};return e.addEventListener(`pointerdown`,o),()=>e.removeEventListener(`pointerdown`,o)},[t]),n},customElements.define(`cosmoz-omnitable-resize-nub`,T(ii))})),oi,si,ci,li,ui=e((()=>{o(),oi=r`<svg
	width="10"
	height="9"
	viewBox="0 0 10 9"
	stroke="currentColor"
...
>
	...
	/>
</svg> `})),di,fi,pi,mi,hi=e((()=>{w(),Xe(),ui(),di=({column:e,on:t,descending:n,setOn:i,setDescending:a})=>{let{name:o,title:s}=e??{};return r`<button
		class="sg"
		title=${rt(s)}
	...
	>
		<span>${s}</span> ${li}
	</button>`},fi=({columns:e,...t})=>e?.map(e=>di({column:e,...t})),pi=()=>r`
...
`})),gi,_i,vi,yi,bi,xi=e((()=>{w(),Re(),mt(),Ze(),gi=e=>(t,n,r=ct)=>{let i=Ie(),a=new URLSearchParams(i.hash.replace(`#`,``));return e(t,n,r,a),`#!`+Object.assign(i,{hash:a}).href.replace(location.origin,``)},_i=e=>e==null||e===``,vi=gi((e,t,n,r)=>_i(n(t))?r.delete(e):r.set(e,n(t))),yi=gi((e,t,n,r)=>Object.entries(t).map(n).forEach(([t,n])=>_i(n)?r.delete(e+t):r.set(e+t,n))),bi=(e,t,{suffix:n=``,read:r,write:i,multi:a}={})=>{let[o,s]=a?[yi,Ge]:[vi,ze],c=d(()=>t!=null&&s(t+n,r)!=null,[]),[l,u]=C(()=>t==null?e:s(t+n,r)??e),f=M(e=>u(r=>{let a=Ae(e,r);return t!=null&&Te(o(t+n,a,i),null,{notify:!1}),a}),[t,n,o,i]);return S(()=>{t!=null&&(c||e!=null&&f(e))},[e,t,c,f]),[l,f]}})),Si,Ci,wi,Ti,Ei,Di=e((()=>{w(),xi(),Si=e=>[!0,`true`,1,`yes`,`on`].includes(e),Ci=e=>e===``||(e==null?void 0:Si(e)),wi=(e,t,n)=>M(r=>{e(r),n(e=>({...e,[t]:r}))},[e,t,n]),Ti=(e,t,n,r,i)=>{let[a,o]=bi(n.sortOn,t,{suffix:`-sortOn`}),[s,c]=bi(Ci(n.descending),t,{suffix:`-descending`,read:Ci}),[l,u]=bi(n.groupOn,t,{suffix:`-groupOn`}),[f,p]=bi(Ci(n.groupOnDescending),t,{suffix:`-groupOnDescending`,read:Ci}),m=d(()=>e.find(e=>e.name===a),[e,a]),h=d(()=>e.find(e=>e.name===l),[e,l]),g={groupOn:l,setGroupOn:wi(u,`groupOn`,r),groupOnDescending:f,setGroupOnDescending:wi(p,`groupOnDescending`,r),sortOn:a,setSortOn:wi(o,`sortOn`,r),descending:s,setDescending:wi(c,`descending`,r),columns:e},_=d(()=>g,Object.values(g)),v=M(e=>{o(e.sortOn),u(e.groupOn),c(e.descending),p(e.groupOnDescending)},[]);return S(()=>void(i.current=v),[]),{..._,sortAndGroup:_,groupOnColumn:h,sortOnColumn:m}},Ei=le(),customElements.define(`sort-and-group-provider`,Ei.Provider),customElements.define(`sort-and-group-consumer`,T(({render:e})=>e(be(Ei)),{useShadowDOM:!1}))})),Oi,ki,Ai=e((()=>{w(),ae(),ai(),hi(),E(),Di(),Oi=({data:e,columns:t,groupOnColumn:n,filters:i,setFilterState:a,sortAndGroup:{sortOn:o,setSortOn:s,descending:c,setDescending:l}={}})=>Ve(t,e=>e.name,t=>[r`<div
			...
			>
				...
				${k(!t.noSort,()=>di({on:o,setOn:s,descending:c,setDescending:l,column:t}))}
			</div>`,r`<cosmoz-omnitable-resize-nub
				.column="${t}"
				name="${t.name}"
			></cosmoz-omnitable-resize-nub>`]),ki=({columns:e,settingsConfig:t,hideSelectAll:n,...i})=>{let a=be(Ei);return r`
		${k(e,e=>Oi({columns:e,sortAndGroup:a,...i}))}
		${k(!n,()=>r` <cosmoz-omnitable-settings
					.config=${t}
					part="settings"
				></cosmoz-omnitable-settings>`)}
	`},customElements.define(`cosmoz-omnitable-header-row`,T(ki,{useShadowDOM:!1}))})),ji,Mi,Ni=e((()=>{w(),Ce(),ji=ue`
	:host {
		display: flex;
		align-items: center;
		flex-wrap: wrap;
...
`,customElements.define(`cosmoz-omnitable-item-expand-line`,T(Mi,{styleSheets:[we(ji)]}))})),Pi,Fi=e((()=>{w(),o(),ot(),Ni(),Pi=({columns:e,item:t,selected:n,expanded:i,groupOnColumn:a})=>Ne(e,e=>r`<cosmoz-omnitable-item-expand-line
				.column=${e}
				?hidden=${e===a}
				exportparts="item-expand-label, item-expand-value"
				>${e.renderCell(e,{item:t,selected:n,expanded:i})}</cosmoz-omnitable-item-expand-line
			>`),customElements.define(`cosmoz-omnitable-item-expand`,T(Pi,{useShadowDOM:!1}))})),Ii,Li,Ri=e((()=>{w(),ae(),Ii=(e,t,n)=>e.editable?e.renderEditCell(e,t,n(e,t.item)):e.renderCell(e,t),Li=({columns:e,groupOnColumn:t,item:n,index:i,selected:a,expanded:o,onItemChange:s})=>Ve(e,e=>e.name,e=>r`<div
			...
			</div>`),customElements.define(`cosmoz-omnitable-item-row`,T(Li,{useShadowDOM:!1}))})),zi,Bi,Vi=e((()=>{Ce(),zi=ue`
	.checkbox {
		box-sizing: border-box;
...
`})),Hi,Ui,Wi=e((()=>{je(),Hi=e=>{let t=e.replace(/"/gu,`""`);return t.search(/("|,|\n)/gu)>=0?`"`+t+`"`:e},Ui=(e,t,n)=>{let r=e.map(e=>Hi(e.title)).join(`;`)+`
`,i=t.map(t=>e.map(e=>{let n=e.getString(e,t);return n==null?``:Hi(String(n))}).join(`;`)+`
`);i.unshift(r),We(new File(i,n,{type:`text/csv;charset=utf-8`}))}})),Gi,Ki,qi=e((()=>{je(),Ye(),Gi=(e,t)=>{let n=e.map(e=>e.title),r=t.map(t=>e.map(e=>e.toXlsxValue(e,t)??``));return r.unshift(n),r},Ki=(e,t,n,r)=>{let i=Gi(e,t),a=new nt(n).addSheetFromData(i,r).generate();We(new File([a],n,{type:`application/vnd.openxmlformats-officedocument.spreadsheetml.sheet`}))}})),Ji,Yi=e((()=>{Je(),a(),o(),Wi(),qi(),Ji=({columns:e,selectedItems:t,csvFilename:n,xlsxFilename:a,xlsxSheetname:o,topPlacement:s})=>r`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!tt(t.length)}
		part="bottomBar"
	...
	</cosmoz-bottom-bar>`})),Xi,Zi=e((()=>{o(),E(),Xi=({allSelected:e,onAllCheckboxChange:t,sortAndGroup:n,dataIsValid:i,data:a,columns:o,filters:s,groupOnColumn:c,setFilterState:l,settingsConfig:u,hideSelectAll:d})=>r`<sort-and-group-provider .value=${n}>
	...
	</sort-and-group-provider>`})),Qi,$i,ea=e((()=>{w(),Qi=ve`
	:host {
		max-width: 100%;
		overflow-x: hidden;
		padding: 0 12px;
...
`,$i=({settingsConfig:e})=>{let{columns:t,collapsed:n}=e,i=t.filter(e=>!n.some(t=>t.name===e.name));return r`<div class="skeleton">
	...
	</div>`},customElements.define(`cosmoz-omnitable-skeleton`,T($i,{styleSheets:[Qi]}))})),ta,na=e((()=>{ea(),a(),o(),E(),qe(),ta=(e,t)=>{let{settingsConfig:n}=e,{processedItems:a,dataIsValid:o,filterIsTooStrict:s,loading:c,displayEmptyGroups:l,compareItemsFn:u,setSelectedItems:d,renderItem:f,renderGroup:p,error:m}=t;return r`${k(!c&&!o&&!m,()=>r`<div class="tableContent-empty">
...
`})),oa,sa,ca=e((()=>{w(),p(),oa=e=>{let t=parseInt(e,10);return isFinite(t)?t:void 0},sa=e=>{let{config:t}=e,{settings:n,setSettings:r,collapsed:i}=t,a=ut({collapsed:i,settings:n.columns,setSettings:M(e=>r(t=>({...t,columns:e})),[r])});return{...t,onDown:M(e=>{e.target.closest(`.pull`)&&(a.handle=e.currentTarget)},[a]),onDragStart:M(e=>{let{target:t}=e,n=oa(t.dataset.index);if(!a.handle?.contains(t)||n==null)return e.preventDefault();a.handle=null,e.dataTransfer.effectAllowed=`move`,e.dataTransfer.setData(`omnitable/sort-index`,n),e.dataTransfer.setData(`text/plain`,n),setTimeout(()=>t.classList.add(`drag`),0),t.addEventListener(`dragend`,e=>e.target.classList.remove(`drag`),{once:!0})},[a]),onDragEnter:M(e=>{let t=e.currentTarget;t===e.target&&(e.preventDefault(),e.dataTransfer.dropEffect=`move`,t.classList.add(`dragover`))},[]),onDragOver:M(e=>{e.preventDefault(),e.currentTarget.classList.add(`dragover`)},[]),onDragLeave:M(e=>{let t=e.currentTarget;t.contains(e.relatedTarget)||t.classList.remove(`dragover`)},[]),onDrop:M(e=>{let t=oa(e.dataTransfer.getData(`omnitable/sort-index`)),n=oa(e.currentTarget.dataset.index),{settings:r,setSettings:i}=a;e.currentTarget.classList.remove(`dragover`),e.preventDefault();let o=r.slice();o.splice(n+(t>=n?0:-1),0,o.splice(t,1)[0]),i(o)},[a]),onToggle:M(e=>{let{settings:t,setSettings:n}=a,r=t.map(e=>({...e,disabled:e.disabled||a.collapsed?.some(t=>t.name===e.name)})),i=oa(e.target.closest(`[data-index]`)?.dataset.index);r.splice(i,1,{...t[i],disabled:!e.target.checked,priority:e.target.checked?t.reduce((e,t)=>Math.max(e,t.priority),0)+1:t[i].priority}),n(r)},[a])}}})),la,ua,da,fa,pa=e((()=>{it(),_(),Ce(),Je(),w(),a(),E(),ui(),hi(),aa(),ca(),la=[h({apply({availableHeight:e,elements:t}){Object.assign(t.floating.style,{maxHeight:`${Math.max(0,e)}px`})}}),...ge],ua=({onDragStart:e,onDragEnter:t,onDragOver:n,onDragLeave:i,onDrop:a,onDown:o,onToggle:s,collapsed:c,filters:l})=>(u,d)=>{let f=!!c?.find(e=>e.name===u.name),p=!u.disabled&&!f;return r` <div
			class="item"
			data-index=${d}
			@mousedown=${o}
			draggable="true"
		...
		>
			...
			<input
				...
				.indeterminate=${f}
			/>
		</div>`},da=e=>{let{settings:t,settingsId:n,onSave:a,onReset:o,hasChanges:s,opened:c,setOpened:l,...u}=sa(e);return r` <div class="headline">
			${i(`Sort and filter`)}
			<button
				class="close"
		...
		<div class="contents">
			...
			<cosmoz-collapse ?opened=${c.sort}> ${mi()} </cosmoz-collapse>
		...
		${k(n,()=>r`<div class="buttons">
				...
				</div>`)}`},customElements.define(`cosmoz-omnitable-settings-ui`,T(da,{styleSheets:[we(ra)]})),fa=({config:e,newLayout:t})=>r`
	<cosmoz-dropdown
...
`,customElements.define(`cosmoz-omnitable-settings`,T(fa,{styleSheets:[we(ia)]}))})),ma,ha,ga,_a,va,ya=e((()=>{he(),ma=[`sortOn`,`descending`,`groupOn`,`groupOnDescending`],ha=e=>t=>typeof t==`object`&&!!t&&`name`in t&&t.name===e,ga=(e=[],t=[],n=[])=>{let r=t.filter(t=>e.some(ha(t.name))),i=e.filter(e=>e.name!=null&&!t.some(ha(e.name))&&!n.some(ha(e.name))),a=n.filter(e=>!t.some(ha(e.name)));return[...r,...a.flatMap(t=>{let n=e.find(e=>e.name===t.name);return n?{...t,title:n.title??t.title??``,minWidth:parseInt(n.minWidth??`0`,10)}:[]}),...i.map(e=>{let{name:t,title:n,priority:r,minWidth:i,width:a,flex:o}=e;return{name:t??``,title:n??``,priority:r??0,minWidth:parseInt(i??`0`,10),width:parseInt(a??`0`,10),flex:parseInt(o??`0`,10)}})]},_a=(e,t)=>({...t,...m(Array.from(ma))(e),columns:e.columns?.map(m([`name`,`priority`,`width`,`flex`,`disabled`]))}),va=({columns:e,settings:t,savedSettings:n,initial:r})=>({...Object.fromEntries(ma.flatMap(e=>r?.[e]==null?[]:[[e,r[e]]])),...n?m(Array.from(ma))(n):{},...t,columns:ga(e,t?.columns,n?.columns)})})),ba,xa=e((()=>{ba=({prefix:e=`omnitable-`}={})=>({write:async(t,n)=>{let r=e+t;try{n?localStorage.setItem(r,JSON.stringify(n)):localStorage.removeItem(r)}catch(e){console.error(e)}},read:async t=>{if(t)try{let n=localStorage.getItem(e+t);return n==null?void 0:JSON.parse(n)}catch(e){console.error(e)}}})})),Sa,Ca,wa=e((()=>{w(),xa(),Sa=le(ba),Ca=()=>{let e=be(Sa);return d(()=>e(),[e])}})),Ta=e((()=>{wa()})),Ea,Da=e((()=>{w(),ya(),Ta(),Ea=(e,t,n,r)=>{let[i,a]=C(),{read:o,write:s}=Ca();return S(async()=>{e&&a(await o(e))},[e,o]),{settingsId:e,savedSettings:i,onSave:M(async()=>{if(!e)return;let r=_a(t,i);await s(e,r),n(),a(r)},[t,i]),onReset:M(async t=>{n(),t.shiftKey&&(await s(e),a()),r?.()},[r]),hasChanges:t!=null}}})),Oa,ka=e((()=>{w(),mn(),ya(),Da(),Oa=({settingsId:e,host:t})=>{let n=d(()=>Object.fromEntries(ma.map(e=>[e,t[e]])),[]),r=y(),i=M(()=>{r.current?.(n)},[n]),[a,o]=C(),[s,c]=C({columns:!0,sort:!0}),{savedSettings:l,...u}=Ea(e,a,o,i),{enabledColumns:f,disabledFiltering:p}=t,m=pn(t,{enabledColumns:f,disabledFiltering:p}),h=d(()=>va({columns:m,settings:a,savedSettings:l,initial:n}),[m,a,l]),g=d(()=>h.columns.map(e=>m.find(t=>t.name===e.name)).filter(Boolean),[m,...h.columns.map(e=>e.name)]);return{...u,opened:s,setOpened:c,settings:h,columns:g,setSettings:o,resetRef:r}}})),Aa=e((()=>{pa(),ka()})),ja,Ma,Na=e((()=>{ja=e=>Number.isFinite(e)?e:0,Ma=(e,t)=>{let n=[],[r,i]=e.reduce(([e,t],{width:n,flex:r})=>[e+n,t+r],[0,0]),a=t-r,o=ja(a/i),s=0,c=0,l=0;for(let t=0;t<e.length;t++){let{width:i,minWidth:u,flex:d}=e[t];if(u>i+(a>=0?o*d:i*a/r)){s+=i,c+=u,l+=d,n[t]=u;continue}if(d===0){s+=i,c+=i,n[t]=i;continue}}r-=s,a=t-c-r,i-=l,o=ja(a/i);for(let t=0;t<e.length;t++){if(n[t]!=null)continue;let{width:i,flex:s}=e[t];n[t]=i+(a>=0?o*s:i*a/r)}return n}})),Pa,Fa,Ia=e((()=>{Pa=Symbol(`index`),Fa=(e,t)=>{if(typeof e.findLastIndex==`function`)return e.findLastIndex(t);for(let n=e.length-1;n>=0;n--)if(t(e[n],n,e))return n;return-1}})),La,Ra,za,Ba=e((()=>{Na(),Ia(),La=(e,t)=>{let n=Fa(e,e=>e!=null&&e>0),r=(e,t)=>`.cell[name="${e}"], cosmoz-omnitable-skeleton::part(cell-${e}){width: ${Math.floor(t)}px;padding: 0 min(3px, ${t/2}px)}`,i=e=>`cosmoz-omnitable-resize-nub[name="${e}"]{display:none}`,a=e=>`cosmoz-omnitable-resize-nub[name="${e}"], .cell[name="${e}"]{display:none}`;return t.map((t,o)=>{let s=e[o];if(s==null||s===0)return a(t.name);let c=r(t.name,s);return o===n?`${c}\n${i(t.name)}`:c}).join(`
`)},Ra=(e,t,n)=>{let r=e.filter(e=>!e.hidden),i=r.reduce((e,{width:t})=>e+t,0);if(r.length>1&&i>t)return Ra(r.slice(1),t,n);let a=r.reduce(([e,t],n,r)=>[Math.max(e,n.index),n.index>e?r:t],[-1,-1])[1];return a!==-1&&(r[a].flex=1),Ma(r,t).reduce((e,t,n)=>(e[r[n].index]=t,e),Array(n).fill(void 0))},za=(e,t)=>e.length===0?`.cell {display: none;}`:La(e,t)})),Va,Ha=e((()=>{w(),Va=({host:e,canvasWidth:t,layout:n,setSettings:r})=>{let i=y();i.current=e=>r(r=>{let i=r.columns,{detail:{newWidth:a,column:o}}=e,s=i.findIndex(e=>e.name===o.name),c=[],l=i.reduce((e,t)=>Math.max(e,t.priority),-1/0);for(let e=0;e<n.length;e++)if(c[e]={...i[e]},e<s&&n[e]&&(c[e].width=n[e],c[e].flex=0,c[e].priority=l),e===s){let r=n.reduce((e,t,n)=>n<s&&t?e-t:e,t);c[e].width=Math.min(r,Math.max(a,i[e].minWidth)),c[e].flex=0,c[e].priority=l}return{...r,columns:c}}),S(()=>{let t=e=>i.current?.(e);return e.addEventListener(`column-resize`,t),()=>e.removeEventListener(`column-resize`,t)},[])}})),Ua,Wa,Ga=e((()=>{w(),Ua=88,Wa=(e,t)=>S(()=>{let n=new ResizeObserver(([e])=>{e.contentRect?.width!==0&&requestAnimationFrame(()=>t(e.contentRect?.width-Ua))});return n.observe(e),()=>n.unobserve(e)},[])})),Ka,qa=e((()=>{w(),Ga(),Ka=e=>{let[t,n]=C(()=>e.getBoundingClientRect().width-Ua);return Wa(e,n),t}})),Ja,Ya,Xa,Za=e((()=>{w(),p(),mt(),Ja=(e,t)=>{let n=d(()=>{let t=!1,n,r=()=>{t&&(n=requestAnimationFrame(r),e()&&(t=!1))};return{start:()=>{t=!0,cancelAnimationFrame(n),n=requestAnimationFrame(r)},stop:()=>{t=!1,cancelAnimationFrame(n)}}},[]);S(()=>{n.start()},t),S(()=>()=>n.stop(),[])},Ya=(e=0,t=0)=>Math.abs(e-t)<.1,Xa=(e,t=1.9,n=ft)=>{let r=ut({target:e});Ja(M(()=>{if(!r.tween)return r.tween=r.target,n(r.tween),!0;if(r.target.every((e,t)=>r.tween[t]===e))return n(r.tween),!0;r.tween=r.target.map((e,n)=>Ya(r.tween[n],e)?e:(r.tween[n]??0)+((e??0)-(r.tween[n]??0))/t||0),n(r.tween)},[]),[e])}})),Qa,$a=e((()=>{w(),Ba(),Qa=({canvasWidth:e,groupOnColumn:t,config:n,miniColumn:r})=>d(()=>{if(!Array.isArray(n)||e==null||e===0)return[];let i=n.map((e,n)=>({minWidth:e.minWidth,width:e.width,flex:e.flex,priority:e.priority,name:e.name,index:n,hidden:e.name===t?.name||e.disabled})).map(e=>r?{...e,hidden:r.name!==e.name}:e).sort(({index:e,priority:t},{index:n,priority:r})=>t===r?n-e:t-r);return Ra(i,e,i.length)},[e,t,n])})),eo,to=e((()=>{w(),eo=({host:e,canvasWidth:t,columns:n})=>{let r=e.miniBreakpoint??480,i=d(()=>t<=r,[t,r]),[a,...o]=d(()=>i?n?.filter(e=>e.mini!=null).sort((e,t)=>(e.mini??0)-(t.mini??0)):[],[n,i])??[],s=!!a;return S(()=>{e.toggleAttribute(`mini`,s)},[s]),{isMini:s&&i,miniColumn:a,miniColumns:o}}})),no,ro,io=e((()=>{w(),Ba(),Ha(),qa(),Za(),$a(),to(),p(),no=e=>{let t=d(()=>new CSSStyleSheet,[]);return S(()=>{e.shadowRoot.adoptedStyleSheets=[...e.shadowRoot.adoptedStyleSheets,t]},[]),t},ro=({host:e,columns:t,settings:n,setSettings:r,resizeSpeedFactor:i,sortAndGroupOptions:a})=>{let o=Ka(e),{isMini:s,miniColumn:c,miniColumns:l}=eo({host:e,canvasWidth:o,columns:t}),{groupOnColumn:u}=a,f=Qa({canvasWidth:o,groupOnColumn:u,miniColumn:c,config:n.columns}),p=no(e),m=d(()=>n.columns.reduce((e,n,r)=>f[r]!=null||n.name===u?.name||n.disabled?e:[...e,t.find(e=>e.name===n.name)],[]),[t,n,f]),h=ut({columns:n.columns});return Xa(f,i,e=>{let t=za(e,h.columns);p.replace(t)}),Va({host:e,canvasWidth:o,layout:f,setSettings:e=>r(e(n))}),{isMini:s,collapsedColumns:m,miniColumns:l}}})),ao,oo=e((()=>{ao=({host:e,...t})=>{let{csvFilename:n=`omnitable.csv`,xlsxFilename:r=`omnitable.xlsx`,xlsxSheetname:i=`Omnitable`,topPlacement:a=`top-end`}=e;return{csvFilename:n,xlsxFilename:r,xlsxSheetname:i,topPlacement:a,...t}}})),so,co=e((()=>{w(),so=({host:e,selectedItems:t,data:n,sortAndGroupOptions:r,collapsedColumns:i,settings:a,filterFunctions:o,settingS:s,filters:c,...l})=>{let u=n&&n.length>0&&t.length===n.length,f=t=>{t.target.checked?e.shadowRoot.querySelector(`#groupedList`).selectAll():e.shadowRoot.querySelector(`#groupedList`).deselectAll()},{groupOnColumn:p}=r,m=d(()=>[p,...i,...a.columns.filter(e=>e.disabled)].some(e=>e&&Object.keys(o).includes(e.name)),[o,a,i]),h=d(()=>({...s,collapsed:i,badge:m,filters:c}),[s,i,m,c]);return S(()=>{let t=e.shadowRoot.querySelector(`#tableContent`),n=new ResizeObserver(t=>requestAnimationFrame(()=>{e.style.setProperty(`--ot-height`,t[0]?.contentRect.height+`px`)}));return n.observe(t),()=>n.unobserve(t)},[]),{allSelected:u,onAllCheckboxChange:f,data:n,settingsConfig:h,filters:c,groupOnColumn:p,sortAndGroup:r.sortAndGroup,...l}}})),lo,uo,fo,po,mo,ho,go=e((()=>{w(),E(),Je(),Ia(),H(),lo=r`
	<svg
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
...
`,uo=e=>e?`groupRow groupRow-folded`:`groupRow`,fo=({item:e,index:t})=>n=>k(n?.length>0,()=>r`
			...
			`),po=({columns:e,collapsedColumns:t,miniColumns:n,onItemClick:i,onCheckboxChange:a,dataIsValid:o,groupOnColumn:s,onItemChange:c,rowPartFn:l})=>(u,d,{selected:f,expanded:p,toggleCollapse:m})=>r`
		<div
			?selected=${f}
	...
	`,mo=({onCheckboxChange:e,dataIsValid:t,groupOnColumn:n})=>(i,a,{selected:o,folded:s,toggleFold:c})=>r` <div
			class="${uo(s)}"
			part="groupRow groupRow-${i[Pa]}"
		>
			<input
				class="checkbox"
				type="checkbox"
		...
		</div>`,ho=({host:e,error:t,dataIsValid:n,processedItems:r,columns:i,collapsedColumns:a,miniColumns:o,sortAndGroupOptions:s,rowPartFn:c,...l})=>{let{loading:u=!1,displayEmptyGroups:f=!1,compareItemsFn:p}=e,m=y({shiftKey:!1,ctrlKey:!1}),h=M(t=>{let n=t.target.dataItem,r=t.target.checked;m.current.shiftKey?e.shadowRoot.querySelector(`#groupedList`).toggleSelectTo(n,r):m.current.ctrlKey?(t.target.checked=!0,e.shadowRoot.querySelector(`#groupedList`).selectOnly(n)):e.shadowRoot.querySelector(`#groupedList`).toggleSelect(n,r),t.preventDefault(),t.stopPropagation()},[]);S(()=>{let e=({shiftKey:e,ctrlKey:t})=>{m.current={shiftKey:e,ctrlKey:t}};return window.addEventListener(`keydown`,e),window.addEventListener(`keyup`,e),()=>{window.removeEventListener(`keydown`,e),window.removeEventListener(`keyup`,e)}},[]);let g=M(t=>{let n=t.composedPath();n.slice(0,n.indexOf(t.currentTarget)).find(e=>e.matches?.(`a, .checkbox, .expand`))||e.dispatchEvent(new window.CustomEvent(`omnitable-item-click`,{bubbles:!0,composed:!0,detail:{item:t.currentTarget.dataItem,index:t.currentTarget.dataIndex}}))},[]),{groupOnColumn:_}=s,v=M((t,n)=>r=>gn(e,t,n,r),[]);return{...l,processedItems:r,dataIsValid:n,filterIsTooStrict:n&&r.length<1,loading:u,compareItemsFn:p,displayEmptyGroups:f,error:t,renderItem:d(()=>po({columns:i,collapsedColumns:a,miniColumns:o,onItemClick:g,onCheckboxChange:h,dataIsValid:n,groupOnColumn:_,onItemChange:v,rowPartFn:c}),[i,a,g,h,n,_,v,c]),renderGroup:d(()=>mo({onCheckboxChange:h,dataIsValid:n,groupOnColumn:_}),[h,n,_])}}})),_o,vo=e((()=>{_o=(e,t)=>{if(e===t)return 0;if(e==null)return-1;if(t==null)return 1;let n=typeof e,r=typeof t;return n===`object`&&r===`object`?e.toString()<t.toString()?-1:1:n===`number`&&r===`number`?e-t:n===`string`&&r===`string`?e<t?-1:1:n===`boolean`&&r===`boolean`?e?-1:1:(console.warn(`unsupported sort`,n,e,r,t),0)}})),yo,bo,xo,So,Co,wo,To=e((()=>{w(),mt(),vo(),mn(),xi(),Ia(),yo=(e,t)=>(n,r)=>_o(e(n),e(r))*(t?-1:1),bo=e=>e.replace(/([a-z0-9])([A-Z])/gu,`$1-$2`).toLowerCase(),xo=(e,t)=>{!e||!t||Object.entries(t).forEach(([t,n])=>{e[B].__ownChange=!0,e[B][t]=n,e[B].__ownChange=!1,e[B].dispatchEvent(new CustomEvent(`${bo(t)}-changed`,{bubbles:!0,detail:{value:n}}))})},So=(e,t)=>Object.assign(e,{[Pa]:t}),Co=Symbol(`unparsed`),wo=({data:e,columns:t,hashParam:n,sortAndGroupOptions:r,noLocalSort:i,noLocalFilter:a})=>{let{groupOnColumn:o,groupOnDescending:s,sortOnColumn:c,descending:l}=r,u=M(([e,n])=>{let r=t.find(({name:t})=>t===e);return r==null?[e,void 0]:[e,n.filter&&r.serializeFilter(r,n.filter)]},[t]),f=M(([e,n])=>{let r=t.find(({name:t})=>t===e);if(r==null)return[e,{[Co]:n}];let i={filter:r.deserializeFilter(r,n)};return xo(r,i),[e,i]},[t]),[p,m]=bi({},n,{multi:!0,suffix:`-filter--`,write:u,read:f}),h=M((e,n)=>m(r=>{let i=Ae(n,r[e]);return xo(t.find(t=>t.name===e),i),{...r,[e]:{...r[e],...i}}}),[t,m]),g=d(()=>Object.fromEntries(t.map(e=>[e.name,!e.noLocalFilter&&e.getFilterFn(e,p[e.name]?.filter)]).filter(([,e])=>!!e)),[t,...d(()=>Object.values(p).map(e=>e.filter),[p])]),_=d(()=>!Array.isArray(e)||e.length===0?[]:Object.entries(g).length===0||a?e.slice():e.filter(e=>Object.values(g).every(t=>t(e))),[e,g,a]),v=d(()=>{if(!i&&!o&&c!=null&&c.sortOn!=null)return _.slice().sort(yo(e=>c.getComparableValue({...c,valuePath:c.sortOn},e),l));if(o!=null&&o.groupOn!=null){let e=_.reduce((e,t)=>{let n=o.getComparableValue({...o,valuePath:o.groupOn},t);if(n===void 0)return e;let r=e.find(e=>e.id===n);return r?(r.items.push(t),e):(r={id:n,name:n,items:[t]},[...e,r])},[]);return e.sort(yo(e=>o.getComparableValue({...o,valuePath:o.groupOn},e.items[0]),s)),!c||i?e:e.filter(e=>Array.isArray(e.items)).map(e=>(e.items.sort(yo(e=>c.getComparableValue({...c,valuePath:c.sortOn},e),l)),e))}return _},[_,o,s,c,l,i]),y=d(()=>{let e=0,t=0,n=[];return v.forEach(r=>{if(Array.isArray(r.items)){So(r,t++),r.items.forEach(t=>{So(t,e++),n.push(t)});return}return So(r,e++),n.push(r)},[]),n},[v]);return S(()=>{m(e=>Object.values(e).some(e=>e[Co]!=null)?Object.fromEntries(Object.entries(e).map(([e,t])=>t[Co]==null?[e,t]:f([e,t[Co]]))):e)},[f]),{processedItems:v,visibleData:y,filters:p,filterFunctions:g,setFilterState:h}}})),Eo,Do,Oo=e((()=>{re(),w(),_e(),Eo=e=>{let t=t=>{let n=e.data.indexOf(t);if(n<0)return null;let r=e.data.splice(n,1);if(e.data=e.data.slice(),Array.isArray(r)&&r.length>0)return r[0]},n=(t,n)=>{e.data.splice(t,1,n),e.data=e.data.slice()};return{removeItem:t,removeItems(t){let n=[];for(let r=t.length-1;r>=0;--r){let i=e.removeItem(t[r]);i!=null&&n.push(i)}return n},replaceItemAtIndex:n,replaceItem(t,r){let i=e.data.indexOf(t);if(i>-1)return n(i,r)},selectItem(t){e.shadowRoot.querySelector(`#groupedList`).select(t)},selectAll(){e.shadowRoot.querySelector(`#groupedList`).selectAll()},deselectAll(){e.shadowRoot.querySelector(`#groupedList`).deselectAll()},deselectItem(t){e.shadowRoot.querySelector(`#groupedList`).deselect(t)},isItemSelected(t){return e.shadowRoot.querySelector(`#groupedList`).isItemSelected(t)}}},Do=({host:e,visibleData:t,filters:n,...r})=>{let{setFilterState:i}=r,a=d(()=>Eo(e),[]);$e(r,Object.values(r)),$e(a,Object.values(a)),S(()=>{let t=e=>i(e.detail.name,t=>({...t,...e.detail.state}));return e.addEventListener(`legacy-filter-changed`,t),()=>e.removeEventListener(`legacy-filter-changed`,t)},[]),b(`visibleData`,t),b(`sortedFilteredGroupedItems`,r.sortedFilteredGroupedItems),b(`selectedItems`,r.selectedItems),b(`sortOn`,r.sortOn),b(`descending`,r.descending),b(`isMini`,r.isMini);let o=d(()=>Object.fromEntries(Object.entries(n).filter(([,{filter:e}])=>e!==void 0).map(([e,{filter:t}])=>[e,t])),[n]);b(`filters`,o,Object.values(o))}})),ko,Ao=e((()=>{w(),Aa(),io(),oo(),co(),go(),To(),Oo(),Di(),ko=e=>{let{hashParam:t,settingsId:n,data:r,resizeSpeedFactor:i,noLocal:a,noLocalSort:o=a,noLocalFilter:s=a,error:c,rowPartFn:l}=e,u=Oa({settingsId:n,host:e}),{settings:d,setSettings:f,columns:p,resetRef:m}=u,h=Ti(p,t,d,f,m),{processedItems:g,visibleData:_,filters:v,setFilterState:y,filterFunctions:b}=wo({data:r,columns:p,hashParam:t,sortAndGroupOptions:h,noLocalSort:o,noLocalFilter:s}),{isMini:x,collapsedColumns:S,miniColumns:ee}=ro({host:e,columns:p,settings:d,setSettings:f,resizeSpeedFactor:i,sortAndGroupOptions:h}),te=r&&Array.isArray(r)&&r.length>0,[ne,re]=C([]);return Do({host:e,visibleData:_,sortedFilteredGroupedItems:g,columns:p,filters:v,setFilterState:y,selectedItems:ne,isMini:x,...h}),{header:so({host:e,selectedItems:ne,sortAndGroupOptions:h,dataIsValid:te,data:r,columns:p,filters:v,collapsedColumns:S,settings:d,filterFunctions:b,settingS:u,setFilterState:y,hideSelectAll:e.hideSelectAll===!0}),list:ho({host:e,error:c,dataIsValid:te,processedItems:g,setSelectedItems:re,columns:p,collapsedColumns:S,miniColumns:ee,sortAndGroupOptions:h,rowPartFn:l}),footer:ao({host:e,selectedItems:ne,columns:p})}}})),jo=e((()=>{o(),customElements.define(`cosmoz-grouped-list-row`,class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||t(this._renderFn(this._item,this._index),this)}})})),Mo,No,Po,Fo,Io,Lo,Ro,zo,Bo,Vo=e((()=>{Mo={group:Symbol(`group`)},No=(e,t)=>(t.has(e)||t.set(e,{}),t.get(e)),Po=(e,t)=>!!No(e,t).expanded,Fo=(e,t)=>!!No(e,t).folded,Io=e=>e?e.items instanceof Array:!1,Lo=e=>{if(!Array.isArray(e)||e.length===0)return;let t=Array.isArray(e[0]?.items);if(!e.every(e=>Array.isArray(e.items)===t))throw Error(`Data must be homogeneous.`)},Ro=(e,t,n)=>{if(Array.isArray(e))return Lo(e),e.reduce((e,r)=>{let i=r;return i.items?i.items.length?No(r,n).folded?e.concat(r):e.concat(r,i.items.map(e=>Object.assign(e,{[Mo.group]:r}))):t?e.concat(r):e:e.concat(r)},[])},zo=(e,...t)=>typeof e==`function`?e(...t):e,Bo=(e,t)=>e===t})),Ho,Uo=e((()=>{w(),Vo(),Ho=()=>{let[e,t]=C(()=>[new WeakMap]);return{setItemState:M((e,n)=>t(([t])=>{let r=No(e,t);return Object.assign(r,zo(n,r)),[t]}),[]),state:e[0],signal:e}}})),Wo,Go=e((()=>{w(),Uo(),Vo(),Wo=()=>{let{setItemState:e,state:t,signal:n}=Ho();return{state:t,signal:n,toggleFold:M((t,n)=>{Io(t)&&e(t,e=>({folded:n===void 0?!e.folded:n}))},[]),toggleCollapse:M((t,n)=>{Io(t)||e(t,e=>({expanded:n===void 0?!e.expanded:!n}))},[])}}})),Ko,qo=e((()=>{w(),Vo(),Ko=({initial:e,compareItemsFn:t,data:n,flatData:r})=>{let[i,a]=C(e),[o,s]=C(),c=M(e=>i.includes(e),[i]),l=M(e=>e?.items?.every(c)??!1,[c]),u=M(e=>c(e)||l(e),[c,l]),d=M(e=>{let t=e.items??[e];a(e=>[...e,...t.filter(t=>!e.includes(t))]),s(e)},[]),f=M(e=>{let t=e.items??[e];a(e=>e.filter(e=>!t.includes(e))),s(e)},[]),p=M(e=>{a(e.items?.slice()||[e]),s(e)},[]),m=M(()=>{a(n.flatMap(e=>e.items||e)),s(void 0)},[n]),h=M(()=>{a([]),s(void 0)},[]),g=M((e,t=!u(e))=>t?d(e):f(e),[u]),_=M((e,n)=>{if(!r)return;let i=o?r.findIndex(e=>t(e,o)):-1;if(i<0)return g(e,n);let[a,c]=[i,r.indexOf(e)].sort((e,t)=>e-t);r.slice(a,c+1).forEach((e,t,r)=>{t>0&&t<r.length-1&&Io(e)||g(e,n)}),s(e)},[r,t,g]);return S(()=>a(e=>e.length>0&&r?r.filter(n=>e.find(e=>t(n,e))):e),[r]),{selectedItems:i,isItemSelected:c,isGroupSelected:l,isSelected:u,select:d,deselect:f,selectOnly:p,selectAll:m,deselectAll:h,toggleSelect:g,toggleSelectTo:_}}})),Jo,Yo,Xo,Zo=e((()=>{re(),_e(),w(),o(),jo(),Go(),qo(),Vo(),Ue(),Jo={host:{position:`relative`,display:`flex`,flexDirection:`column`}},Yo=e=>{let{data:t,renderItem:n,renderGroup:r,displayEmptyGroups:i,compareItemsFn:a=Bo}=e,{toggleFold:o,toggleCollapse:s,state:c,signal:l}=Wo(),u=d(()=>Ro(t,i,c),[t,i,l]),{selectedItems:f,isItemSelected:p,isGroupSelected:m,isSelected:h,select:g,deselect:_,selectOnly:v,selectAll:y,deselectAll:x,toggleSelect:S,toggleSelectTo:ee}=Ko({initial:[],compareItemsFn:a,data:t,flatData:u}),te=M((e,t)=>Array.isArray(e.items)?r(e,t,{selected:m(e),folded:Fo(e,c),toggleSelect:t=>S(e,typeof t==`boolean`?t:void 0),toggleFold:()=>o(e)}):n(e,t,{selected:f.includes(e),expanded:Po(e,c),toggleSelect:t=>S(e,typeof t==`boolean`?t:void 0),toggleCollapse:()=>s(e)}),[n,r,f,S,l]);fe(()=>{Object.assign(e.style,Jo.host)},[]),b(`selectedItems`,f);let ne={toggleFold:o,toggleCollapse:s,isItemSelected:p,isGroupSelected:m,isSelected:h,select:g,deselect:_,selectOnly:v,selectAll:y,deselectAll:x,toggleSelect:S,toggleSelectTo:ee};return $e(ne,Object.values(ne)),{renderRow:te,flatData:u}},Xo=({renderRow:e,flatData:t})=>c({items:t,renderItem:(t,n)=>r`<cosmoz-grouped-list-row
				.item=${t}
				.index=${n}
				.renderFn=${e}
			></cosmoz-grouped-list-row>`})})),Qo,$o=e((()=>{Zo(),w(),Qo=e=>Xo(Yo(e)),customElements.define(`cosmoz-grouped-list`,T(Qo,{useShadowDOM:!1}))})),es=e((()=>{$o()})),ts,ns,rs,is=e((()=>{Me(),At(),ti(),ri(),Ai(),Fi(),Ri(),_e(),w(),Le(),o(),He(),Vi(),Yi(),Zi(),na(),Ao(),es(),ts=e=>window.ShadyCSS?.ApplyShim?.transformCssText?.(e)||e,ns=e=>{let{header:t,list:n,footer:i}=ko(e);return r`
		<style>
			${l([],()=>ts(Bi))}
		</style>
