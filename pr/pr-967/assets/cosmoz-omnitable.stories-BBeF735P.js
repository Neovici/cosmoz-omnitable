...
`,Vt=e=>{let{label:t,value:n,slot:r}=e;return g(w`<div
	...
	>
		${n||``}
	</div>`,{label:t})},customElements.define(`cosmoz-omnitable-dropdown-input`,D(Vt,{observedAttributes:zt,styleSheets:[Bt]}))})),Ut,Wt=e((()=>{Ke(),T(),He(),Ht(),Ut=({title:e,tooltip:t=``,filterText:n=``,onOpenedChanged:r,content:i,horizontalAlign:a=`left`,externalValues:o=null})=>w`
		<style>
			.dropdown {
				outline: none;
			}
		...
		<cosmoz-dropdown
			@focus=${r}
			class=${Ze({filtered:!!n,...o!=null&&{[`external-values-${o}`]:!0},dropdown:!0})}
			title=${t||``}
		>
	...
	`})),Gt,Kt,qt=e((()=>{Ce(),qe(),bt(),xt(),Gt=e=>e?typeof e.close==`function`?e:Gt(e.parentElement):null,Kt=e=>class extends e{static get properties(){return{disabled:{type:Boolean,value:!1},filter:{type:Object,notify:!0},values:{type:Array,value(){return[]}},headerFocused:{type:Boolean,notify:!0},min:{type:Number,value:null},max:{type:Number,value:null},limits:{type:Function},autoupdate:{type:String,value:!0},locale:{type:String,value:null},_filterInput:{type:Object,value(){return{min:null,max:null}}},_range:{type:Object,computed:`_computeRange(values.*)`},_limit:{type:Object,computed:`_computeLimit(_range, _filterInput.*, min, max)`,value(){return{}}},_tooltip:{type:String,computed:`_computeTooltip(title, _filterText)`},_fromClasses:{type:String,computed:`_computeInputClasses(_filterInput.min)`},_toClasses:{type:String,computed:`_computeInputClasses(_filterInput.max)`}}}static get observers(){return[`_filterInputChanged(_filterInput.*, autoupdate)`,`_filterChanged(filter.*)`,`_updateLimits(limits, headerFocused)`]}disconnectedCallback(){this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),super.disconnectedCallback()}_computeInputClasses(e){return e!=null&&e!==``?`has-value`:``}toNumber(e,t,n){if(e==null||e===``)return;let r=typeof e==`number`?e:Number(e);if(Number.isNaN(r))return;if(n==null||t==null)return r;let i=this.toNumber(t);return i==null?r:n(r,i)}toValue(){return this.toNumber.apply(this,arguments)}getComparableValue(e,t){if(e==null)return;let n=e;return t!=null&&(n=this.get(t,e)),this.toValue(n)}renderValue(){}getInputString(e,t=this.valuePath){let n=this.toValue(this.get(t,e));return this._toInputString(n)}_computeRange(e){let t=e.base,n=Array.isArray(t)&&t.length&&t.map(e=>this.toValue(e)).filter(e=>e!=null);return!n||n.length<1?{min:null,max:null}:n.reduce((e,t)=>({min:this.toValue(t,e.min,Math.min),max:this.toValue(t,e.max,Math.max)}),{})}_computeLimit(e,t,n,r){if(!e)return;let i=t.base,a=this.toValue(n),o=this.toValue(r),s=a??this.toValue(e.min),c=o??this.toValue(e.max);return{fromMin:s,fromMax:this.toValue(c,this._fromInputString(i.max,`max`),Math.min),toMin:this.toValue(s,this._fromInputString(i.min,`min`),Math.max),toMax:c}}_computeFilterText(e){if(e.base==null)return;let t=e.base,n=this.toValue(t.min),r=this.toValue(t.max),i=[];return n!=null&&i.push(this.renderValue(n)),i.push(` - `),r!=null&&i.push(this.renderValue(r)),i.length>1?i.join(``):void 0}_computeTooltip(e,t){return t==null?e:`${e}: ${t}`}_fromInputString(e){return this.toValue(e)}_toInputString(e){return this.toValue(e)??null}_getDefaultFilter(){return{min:null,max:null}}_filterInputChanged(e,t){this.__inputChangePath=e.path.split(`.`)[1]||null,t&&(this._limitInputDebouncer=Xe.debounce(this._limitInputDebouncer,Je.after(600),()=>{this._limitInput(),this._updateFilter()}),Be(this._limitInputDebouncer))}_clearFrom(){this.set(`_filterInput.min`,null),this._updateFilter()}_clearTo(){this.set(`_filterInput.max`,null),this._updateFilter()}_onBlur(){this._limitInput(),this._updateFilter()}_onKeyDown(e){let t=e.currentTarget,n=Array.from(t.parentElement.querySelectorAll(`cosmoz-input`)),r=n[n.findIndex(e=>e===t)+1],i=!r,a=n[0]===t;switch(e.keyCode){case 13:if(e.preventDefault(),!i)r.focus();else{let e=this._limitInput();this._updateFilter(),e||this._closeParent(t)}break;case 9:(i&&!e.shiftKey||a&&e.shiftKey)&&this._closeParent(t)}}_closeParent(e){let t=Gt(e);t&&t.close()}_onDropdownOpenedChanged({currentTarget:e,type:t,detail:n}){(t===`focus`||n?.value===!0)&&setTimeout(()=>{e.querySelector(`cosmoz-input:focus`)||e.querySelector(`cosmoz-input`)?.focus()},100)}_limitInput(){let e=this._filterInput,t=this.__inputChangePath,n=t?this._fromInputString(this.get(t,e),t):null;if(this.__inputChangePath=null,n==null)return!1;let r=this._limit,i=t===`min`?`from`:`to`,a=this.get(i+`Min`,r),o=this.get(i+`Max`,r),s=this.toValue(n,a,Math.max),c=this.toValue(s,o,Math.min);return this.getComparableValue(n)===this.getComparableValue(c)?!1:(this.set([`_filterInput`,t],this._toInputString(c,t)),this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),!0)}_updateFilter(){let e=this._filterInput,t=this.filter,n=this._fromInputString(e.min,`min`),r=this._fromInputString(e.max,`max`);this.getComparableValue(n)===this.getComparableValue(t,`min`)&&this.getComparableValue(r)===this.getComparableValue(t,`max`)||this.set(`filter`,{min:n,max:r})}_filterChanged(e){if(this._filterInput==null)return;let t=this._filterInput,n=e.base,r=this._fromInputString(t.min,`min`),i=this._fromInputString(t.max,`max`);this.getComparableValue(r)===this.getComparableValue(n,`min`)&&this.getComparableValue(i)===this.getComparableValue(n,`max`)||(this.set(`_filterInput`,{min:this._toInputString(n.min),max:this._toInputString(n.max)}),this._limitInputDebouncer&&this._limitInputDebouncer.cancel())}hasFilter(){let e=this.filter;return e==null?!1:this.toValue(e.min)!=null||this.toValue(e.max)!=null}resetFilter(){this.filter=this._getDefaultFilter()}_updateLimits(e,t){e&&Promise.resolve(ve(e,{active:t})).then(e=>{let{min:t,max:n}=e??{};Object.assign(this,{...t==null?{}:{min:t},...n==null?{}:{max:n}})})}}})),Jt,Yt=e((()=>{N(),T(),Jt=e=>class extends e{static get template(){return Re`<div id="output" style="position:relative;"></div>`}connectedCallback(){super.connectedCallback(),_e(this.render(),this.$.output)}_propertiesChanged(e,t,n){super._propertiesChanged(e,t,n),requestAnimationFrame(()=>_e(this.render(),this.$.output))}}})),Xt,Zt=e((()=>{o(),N(),O(),T(),c(),Wt(),Ht(),qt(),Yt(),Xt=class extends Kt(Jt(j)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:`_computeFilterText(filter.*, _formatters)`},headerFocused:{type:Boolean,value:!1}}}static get observers(){return[`_valuesChanged(autodetect, currency, values)`]}render(){let e=e=>{this.headerFocused=e.type===`focus`,this._onDropdownOpenedChanged(e)};return w`
		...
		>`}getComparableValue(e,t){return Vn(e,t)}getFilterFn(e,t){if(!(!t||!Array.isArray(t)||t.length===0))return Hn(e,t)}},customElements.define(`cosmoz-omnitable-column-autocomplete-excluding`,Un)})),Gn,Kn,qn=e((()=>{ke(),et(),N(),T(),c(),Te(),ae(),Bn(),I(),A(),Sn(),Gn=({valuePath:e,textProperty:t,valueProperty:n},r)=>{let i=t?se(t):E(n),a=ye(e&&M(r,e)).map(i);return a.length>1?a.filter(Boolean).join(`,`):a[0]},Kn=class extends zn(F(j)){static get properties(){return{headerCellClass:{type:String,value:`autocomplete-header-cell`},minWidth:{type:String,value:`55px`},editMinWidth:{type:String,value:`55px`},keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},showSingle:{type:Boolean},preserveOrder:{type:Boolean},limit:{type:Number},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,showSingle:e.showSingle,preserveOrder:e.preserveOrder,limit:e.limit,textual:e.textual}}renderCell(e,{item:t}){return w`<span class="default-column"
			>${e.getString(e,t)}</span
		>`}renderEditCell(e,{item:t},n){return w`<cosmoz-input
			type="text"
			@change=${e=>n(e.target.value)}
		...
		>`}getComparableValue(e,t){return Gn(e,t)}},customElements.define(`cosmoz-omnitable-column-autocomplete`,Kn)})),Jn,Yn,Xn,Zn,Qn,$n,er,tr,nr,rr,ir,ar,or,sr,cr=e((()=>{N(),I(),ke(),yt(),A(),T(),c(),Jn=(e,t)=>t.find(({value:t})=>e===t),Yn=(e,t,n)=>{let r=Jn(t,n);return r?r.text:e},Xn=(e,t,n,r)=>Yn(e,M(t,n),r),Zn=({valuePath:e},t,n)=>Jn(M(t,e),n),Qn=e=>t=>{e(e=>({...e,filter:t?.[0]?.value??null}))},$n=e=>t=>{e(e=>({...e,headerFocused:t}))},er=e=>t=>{e(e=>({...e,query:t}))},tr=e=>t=>e(t?.[0]?.value),nr=({valuePath:e,trueLabel:t,falseLabel:n},r)=>M(r,e)?t:n,rr=({valuePath:e},t)=>n=>M(n,e)===t,ir=St((e,t)=>[{text:e,value:!0},{text:t,value:!1}]),ar=({valuePath:e,trueLabel:t,falseLabel:n},r)=>e?M(r,e)?t:n:``,or=(e,t)=>{try{return JSON.parse(t)}catch{return null}},sr=class extends F(j){static get properties(){return{trueLabel:{type:String,value:`True`},falseLabel:{type:String,value:`False`},flex:{type:String,value:`0`},cellClass:{type:String,value:`boolean-cell`}}}getString(e,t){return nr(e,t)}renderCell(e,{item:t}){return nr(e,t)}renderEditCell(e,{item:t},n){let{trueLabel:r,falseLabel:i}=e;return w`<cosmoz-autocomplete
			variant="inline"
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return wn(e,t)}},customElements.define(`cosmoz-omnitable-column-date`,Dr)})),kr,Ar=e((()=>{N(),O(),T(),c(),ur(),Wt(),Ht(),Yt(),kr=class extends lr(Jt(j)){render(){let e=e=>{this.headerFocused=e.type===`focus`};return w`
			${d(this.disabled,()=>w`
					<cosmoz-omnitable-dropdown-input
						disabled
						.label=${this.title}
		...
		></cosmoz-omnitable-datetime-range-input>`}computeSource(e,t){return wn(e,t)}},customElements.define(Rr.is,Rr)})),Br,Vr=e((()=>{ke(),et(),N(),T(),c(),Bn(),I(),Br=class extends zn(F(j)){renderCell({valuePath:e,textProperty:t},{item:n}){return w`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		`}renderEditCell(){return`not implemented`}renderHeader(e,{filter:t,query:n},r,i){return w`<cosmoz-autocomplete-ui
			...
			.onText=${In(r)}
			>${d(e.loading,()=>w`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}},customElements.define(`cosmoz-omnitable-column-list-horizontal`,Br)})),Hr,Ur=e((()=>{dt(),_(),lt(),N(),window.Cosmoz=window.Cosmoz||{},Hr=class extends st(t(Oe,j)){static get template(){return Re`
			<style>
				:host {
					display: block;
				}
		...
		`}static get is(){return`cosmoz-omnitable-column-list-data`}static get properties(){return{items:{type:Array},_expanded:{type:Boolean,value:!1},_othersCount:{type:Number,computed:`_computeOthersCount(items)`}}}static get observers(){return[`_itemsLengthChanged(items.length)`]}_itemsLengthChanged(){requestAnimationFrame(()=>this.dispatchEvent(new CustomEvent(`expand`,{bubbles:!0})))}_firstItem(e){if(e!=null&&e.length>0)return e[0]}_hideExpand(e,t){return e!==void 0&&e.length!==null?e.length<=2||t:!0}_hideCollapse(e,t){return e!==void 0&&e.length!==null?e.length<=2||!t:!0}_otherItems(e,t){if(e!=null&&(e.length<=2||t))return e.slice(1)}_computeOthersCount(e){if(e!=null)return e.length-1}_toggleExpand(e){this._expanded=!this._expanded,e.stopPropagation(),e.preventDefault()}},customElements.define(Hr.is,Hr)})),Wr,Gr=e((()=>{Ur(),N(),T(),c(),ke(),Bn(),I(),Sn(),Wr=class extends zn(F(j)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:n}){return w`<cosmoz-omnitable-column-list-data
			.items=${An(n,e,t)}
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:n},r,i){return w`<cosmoz-autocomplete-ui
			...
			.onText=${In(r)}
			>${d(e.loading,()=>w`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}},customElements.define(`cosmoz-omnitable-column-list`,Wr)})),Kr,qr=e((()=>{o(),N(),O(),T(),c(),Wt(),Ht(),qt(),Yt(),Kr=class extends Kt(Jt(j)){static get properties(){return{maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null},formatter:{type:Object,computed:`_computeFormatter(locale, minimumFractionDigits, maximumFractionDigits)`},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:`_computeFilterText(filter.*, formatter)`},headerFocused:{type:Boolean,value:!1}}}render(){let e=e=>{this.headerFocused=e.type===`focus`,this._onDropdownOpenedChanged(e)};return w`
			${d(this.disabled,()=>w`
					<cosmoz-omnitable-dropdown-input
						disabled
						.label=${this.title}
		...
		></cosmoz-omnitable-number-range-input>`}computeSource(e,t){return wn(e,t)}},customElements.define(`cosmoz-omnitable-column-number`,Jr)})),Xr,Zr=e((()=>{o(),N(),O(),T(),c(),ur(),Wt(),Ht(),Yt(),Xr=class extends lr(Jt(j)){render(){let e=e=>{this.headerFocused=e.type===`focus`};return w`
			${d(this.disabled,()=>w`
					<cosmoz-omnitable-dropdown-input
						disabled
						.label=${this.title}
...
`,customElements.define(`cosmoz-omnitable-item-expand-line`,D(Ii,{styleSheets:[ce(Fi)]}))})),Ri,zi=e((()=>{C(),T(),pt(),Li(),Ri=({columns:e,item:t,selected:n,expanded:r,groupOnColumn:i})=>gt(e,e=>w`<cosmoz-omnitable-item-expand-line
				.column=${e}
				?hidden=${e===i}
...
`})),Ki,qi,Ji=e((()=>{ct(),Ki=e=>{let t=e.replace(/"/gu,`""`);return t.search(/("|,|\n)/gu)>=0?`"`+t+`"`:e},qi=(e,t,n)=>{let r=e.map(e=>Ki(e.title)).join(`;`)+`
`,i=t.map(t=>e.map(e=>{let n=e.getString(e,t);return n==null?``:Ki(String(n))}).join(`;`)+`
`);i.unshift(r),tt(new File(i,n,{type:`text/csv;charset=utf-8`}))}})),Yi,Xi,Zi=e((()=>{ct(),ft(),Yi=(e,t)=>{let n=e.map(e=>e.title),r=t.map(t=>e.map(e=>e.toXlsxValue(e,t)??``));return r.unshift(n),r},Xi=(e,t,n,r)=>{let i=Yi(e,t),a=new ht(n).addSheetFromData(i,r).generate();tt(new File([a],n,{type:`application/vnd.openxmlformats-officedocument.spreadsheetml.sheet`}))}})),Qi,$i=e((()=>{Ke(),f(),ie(),O(),T(),Ji(),Zi(),Qi=({columns:e,selectedItems:t,csvFilename:n,xlsxFilename:r,xlsxSheetname:i,topPlacement:a})=>w`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!Se(t.length)}
		part="bottomBar"
	...
	`,_o=({onCheckboxChange:e,dataIsValid:t,groupOnColumn:n})=>(r,i,{selected:a,folded:o,toggleFold:s})=>w` <div
		...
		>
			...
			<button class="expand" ?aria-expanded="${o}" @click=${s}>
				...
				.index=${n}
				.renderFn=${e}
			></cosmoz-grouped-list-row>`})})),ts,ns=e((()=>{es(),C(),ts=e=>$o(Qo(e)),customElements.define(`cosmoz-grouped-list`,D(ts,{useShadowDOM:!1}))})),rs=e((()=>{ns()})),is,as,os,ss=e((()=>{Ve(),Rt(),ui(),fi(),Pi(),zi(),Hi(),h(),C(),lt(),T(),i(),Gi(),$i(),ta(),oa(),No(),rs(),is=e=>window.ShadyCSS?.ApplyShim?.transformCssText?.(e)||e,as=e=>{let{header:t,list:n,footer:r}=Mo(e);return w`
		<style>
			${te([],()=>is(Wi))}
		</style>
