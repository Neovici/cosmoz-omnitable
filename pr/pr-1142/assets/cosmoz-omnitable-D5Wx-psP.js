import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{$ as t,Bt as n,C as r,D as i,Dt as a,Et as o,F as s,Ft as c,H as l,I as u,K as d,Kt as f,L as p,Lt as m,M as h,N as g,Nt as _,O as v,S as y,V as b,W as ee,Xt as x,Y as S,Yt as C,Z as te,_ as ne,_t as re,a as ie,at as ae,b as oe,d as se,f as ce,ft as le,g as ue,gt as w,h as de,ht as T,i as fe,it as E,j as D,jt as pe,k as O,kt as k,m as A,mt as j,ot as me,p as he,q as ge,qt as _e,t as ve,tt as ye,ut as be,v as xe,w as Se,wt as Ce,x as we,y as Te,z as Ee,zt as M}from"./dist-CgCceko7.js";import{$ as De,A as Oe,C as ke,D as Ae,E as je,F as N,H as Me,I as Ne,L as Pe,M as Fe,N as Ie,O as P,P as F,Q as Le,R as Re,S as ze,T as Be,U as Ve,V as He,X as Ue,Y as We,Z as Ge,_ as Ke,a as qe,b as Je,c as Ye,d as Xe,et as Ze,f as Qe,g as $e,h as et,j as tt,k as I,l as nt,n as rt,o as it,p as at,q as ot,r as st,t as ct,u as lt,v as ut,w as dt,x as ft,y as pt,z as mt}from"./dist-bbs6yPsi.js";var ht,gt;function L(){return(L=e((()=>{l(),be(),T(),ht=j`
	:host {
		display: flex;
		cursor: pointer;
	}
...
`,customElements.define(`cosmoz-clear-button`,w(gt))})))()}var R,_t,vt,yt,bt,z;function B(){return(B=e((()=>{N(),R=({valuePath:e},t)=>F(t,e),_t=R,vt=R,yt=({valuePath:e},t)=>n=>{let r=F(n,e);return r!=null&&r.toString().toLowerCase().trim().includes(t.toLowerCase().trim())},bt=(e,t)=>t===``||t==null?null:t,z=e=>class extends e{static get properties(){return{isOmnitableColumn:{type:Boolean,value:!0},title:{type:String},valuePath:{type:String,notify:!0},values:{type:Array,notify:!0},filter:{type:Object},noLocalFilter:{type:Boolean},disabled:{type:Boolean,value:!1,notify:!0},editable:{type:Boolean,notify:!0},primary:{type:Boolean,value:!1},loading:{type:Boolean,value:!1,notify:!0},externalValues:{type:Boolean,value:!1,notify:!0},name:{type:String},sortOn:{type:String},groupOn:{type:String},noSort:{type:Boolean,value:!1},disabledFiltering:{type:Boolean,value:!1},width:{type:String,value:`75px`},minWidth:{type:String,value:`40px`},flex:{type:String,value:`1`},cellClass:{type:String,value:`default-cell`},headerCellClass:{type:String,value:`default-header-cell`},priority:{type:Number,value:0},hidden:{type:Boolean,notify:!0},align:{type:String,value:`left`},headerAlign:{type:String,value:null},renderHeader:{type:Function},renderCell:{type:Function},renderEditCell:{type:Function},renderGroup:{type:Function},mini:{type:Number,value:null},renderMini:{type:Function}}}static get observers(){return[`notifyFilterChange(filter)`]}notifyFilterChange(e){this.__ownChange||this.dispatchEvent(new CustomEvent(`legacy-filter-changed`,{detail:{name:this.name,state:this.legacyFilterToState(e)},bubbles:!0}))}legacyFilterToState(e){return{filter:e}}getFilterFn(){}getString(e,t){return R(e,t)}toXlsxValue(e,t){return _t(e,t)}cellTitleFn(e,t){return this.getString(e,t)}headerTitleFn(e){return e.title}serializeFilter(e,t){return bt(e,t)}deserializeFilter(e,t){if(t==null)return null;if(typeof t==`string`)try{return window.decodeURIComponent(t)}catch{return null}return t}getComparableValue(e,t){return vt(e,t)}computeSource(e,t){return t}_propertiesChanged(e,t,n){super._propertiesChanged(e,t,n),this.dispatchEvent(new CustomEvent(`cosmoz-column-prop-changed`,{bubbles:!0}))}}})))()}var xt,St,Ct,wt,Tt,Et,Dt;function Ot(){return(Ot=e((()=>{h(),L(),I(),x(),B(),xt=e=>t=>e(n=>{if(n.inputValue===void 0&&t.target.value===``)return n;clearTimeout(n.t);let r=setTimeout(()=>e(e=>({...e,filter:e.inputValue})),1e3);return{...n,inputValue:t.target.value,t:r}}),St=e=>()=>e(e=>({...e,filter:e.inputValue})),Ct=e=>t=>{t.keyCode===13&&(t.preventDefault(),e(e=>({...e,filter:e.inputValue})))},wt=e=>t=>e(e=>({...e,headerFocused:t.detail.value})),Tt=e=>()=>e(e=>({...e,filter:null,inputValue:null})),Et=e=>e!=null&&e!==``,Dt=class extends z(P){static get properties(){return{minWidth:{type:String,value:`55px`},editMinWidth:{type:String,value:`55px`},inputValue:{type:Object,notify:!0}}}getFilterFn(e,t){if(t!=null&&t!==``)return yt(e,t)}renderCell(e,{item:t}){return C`<span class="default-column">${R(e,t)}</span>`}renderEditCell(e,{item:t},n){return C`<cosmoz-input
		...
		>
			${E(!e.disabledFiltering,()=>C`<cosmoz-clear-button
						...
						@click=${Tt(i)}
					></cosmoz-clear-button>`)}
		</cosmoz-input>`}legacyFilterToState(e){return{filter:e,inputValue:e}}},customElements.define(`cosmoz-omnitable-column`,Dt)})))()}var kt,At,jt;function V(){return(V=e((()=>{h(),T(),x(),kt=[`label`,`value`,`slot`,`always-float-label`,`disabled`,`variant`],At=n`
	${Ee}
...
`,jt=e=>{let{label:t,value:n,slot:r}=e;e.toggleAttribute(`has-value`,!!n);let i=C`<div
	...
	>
		${n||``}
	</div>`;return b(i,{label:t})},customElements.define(`cosmoz-omnitable-dropdown-input`,w(jt,{observedAttributes:kt,styleSheets:[At]}))})))()}var Mt;function Nt(){return(Nt=e((()=>{Pe(),x(),je(),V(),Mt=({title:e,tooltip:t=``,filterText:n=``,onOpenedChanged:r,content:i,align:a=`left`,externalValues:o=null})=>{let s={filtered:!!n,...o!=null&&{[`external-values-${o}`]:!0}};return C`
		<style>
			.dropdown {
				outline: none;
			}
	...
	`}})))()}var Pt,Ft;function It(){return(It=e((()=>{xe(),Fe(),dt(),ft(),Pt=e=>e?typeof e.close==`function`?e:Pt(e.parentElement):null,Ft=e=>class extends e{static get properties(){return{disabled:{type:Boolean,value:!1},filter:{type:Object,notify:!0},values:{type:Array,value(){return[]}},headerFocused:{type:Boolean,notify:!0},min:{type:Number,value:null},max:{type:Number,value:null},limits:{type:Function},autoupdate:{type:String,value:!0},locale:{type:String,value:null},align:{type:String,value:`left`},_filterInput:{type:Object,value(){return{min:null,max:null}}},_range:{type:Object,computed:`_computeRange(values.*)`},_limit:{type:Object,computed:`_computeLimit(_range, _filterInput.*, min, max)`,value(){return{}}},_tooltip:{type:String,computed:`_computeTooltip(title, _filterText)`},_fromClasses:{type:String,computed:`_computeInputClasses(_filterInput.min)`},_toClasses:{type:String,computed:`_computeInputClasses(_filterInput.max)`}}}static get observers(){return[`_filterInputChanged(_filterInput.*, autoupdate)`,`_filterChanged(filter.*)`,`_updateLimits(limits, headerFocused)`]}disconnectedCallback(){this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),super.disconnectedCallback()}_computeInputClasses(e){return e!=null&&e!==``?`has-value`:``}toNumber(e,t,n){if(e==null||e===``)return;let r=typeof e==`number`?e:Number(e);if(Number.isNaN(r))return;if(n==null||t==null)return r;let i=this.toNumber(t);return i==null?r:n(r,i)}toValue(){return this.toNumber.apply(this,arguments)}getComparableValue(e,t){if(e==null)return;let n=e;return t!=null&&(n=this.get(t,e)),this.toValue(n)}renderValue(){}getInputString(e,t=this.valuePath){let n=this.toValue(this.get(t,e));return this._toInputString(n)}_computeRange(e){let t=e.base,n=Array.isArray(t)&&t.length&&t.map(e=>this.toValue(e)).filter(e=>e!=null);return!n||n.length<1?{min:null,max:null}:n.reduce((e,t)=>({min:this.toValue(t,e.min,Math.min),max:this.toValue(t,e.max,Math.max)}),{})}_computeLimit(e,t,n,r){if(!e)return;let i=t.base,a=this.toValue(n),o=this.toValue(r),s=a??this.toValue(e.min),c=o??this.toValue(e.max);return{fromMin:s,fromMax:this.toValue(c,this._fromInputString(i.max,`max`),Math.min),toMin:this.toValue(s,this._fromInputString(i.min,`min`),Math.max),toMax:c}}_computeFilterText(e){if(e.base==null)return;let t=e.base,n=this.toValue(t.min),r=this.toValue(t.max),i=[];return n!=null&&i.push(this.renderValue(n)),i.push(` - `),r!=null&&i.push(this.renderValue(r)),i.length>1?i.join(``):void 0}_computeTooltip(e,t){return t==null?e:`${e}: ${t}`}_fromInputString(e){return this.toValue(e)}_toInputString(e){return this.toValue(e)??null}_getDefaultFilter(){return{min:null,max:null}}_filterInputChanged(e,t){let n=e.path.split(`.`)[1];this.__inputChangePath=n||null,t&&(this._limitInputDebouncer=ze.debounce(this._limitInputDebouncer,Ie.after(600),()=>{this._limitInput(),this._updateFilter()}),ke(this._limitInputDebouncer))}_clearFrom(){this.set(`_filterInput.min`,null),this._updateFilter()}_clearTo(){this.set(`_filterInput.max`,null),this._updateFilter()}_onBlur(){this._limitInput(),this._updateFilter()}_onKeyDown(e){let t=e.currentTarget,n=Array.from(t.parentElement.querySelectorAll(`cosmoz-input`)),r=n[n.findIndex(e=>e===t)+1],i=!r,a=n[0]===t;switch(e.keyCode){case 13:if(e.preventDefault(),!i)r.focus();else{let e=this._limitInput();this._updateFilter(),e||this._closeParent(t)}break;case 9:(i&&!e.shiftKey||a&&e.shiftKey)&&this._closeParent(t)}}_closeParent(e){let t=Pt(e);t&&t.close()}_onDropdownOpenedChanged({currentTarget:e,type:t,detail:n}){(t===`focus`||n?.value===!0)&&setTimeout(()=>{e.querySelector(`cosmoz-input:focus`)||e.querySelector(`cosmoz-input`)?.focus()},100)}_limitInput(){let e=this._filterInput,t=this.__inputChangePath,n=t?this._fromInputString(this.get(t,e),t):null;if(this.__inputChangePath=null,n==null)return!1;let r=this._limit,i=t===`min`?`from`:`to`,a=this.get(i+`Min`,r),o=this.get(i+`Max`,r),s=this.toValue(n,a,Math.max),c=this.toValue(s,o,Math.min);return this.getComparableValue(n)!==this.getComparableValue(c)&&(this.set([`_filterInput`,t],this._toInputString(c,t)),this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),!0)}_updateFilter(){let e=this._filterInput,t=this.filter,n=this._fromInputString(e.min,`min`),r=this._fromInputString(e.max,`max`);(this.getComparableValue(n)!==this.getComparableValue(t,`min`)||this.getComparableValue(r)!==this.getComparableValue(t,`max`))&&this.set(`filter`,{min:n,max:r})}_filterChanged(e){if(this._filterInput==null)return;let t=this._filterInput,n=e.base,r=this._fromInputString(t.min,`min`),i=this._fromInputString(t.max,`max`);(this.getComparableValue(r)!==this.getComparableValue(n,`min`)||this.getComparableValue(i)!==this.getComparableValue(n,`max`))&&(this.set(`_filterInput`,{min:this._toInputString(n.min),max:this._toInputString(n.max)}),this._limitInputDebouncer&&this._limitInputDebouncer.cancel())}hasFilter(){let e=this.filter;return e==null?!1:this.toValue(e.min)!=null||this.toValue(e.max)!=null}resetFilter(){this.filter=this._getDefaultFilter()}_updateLimits(e,t){e&&Promise.resolve(Te(e,{active:t})).then(e=>{let{min:t,max:n}=e??{};Object.assign(this,{...t==null?{}:{min:t},...n==null?{}:{max:n}})})}}})))()}var Lt;function Rt(){return(Rt=e((()=>{I(),x(),Lt=e=>class extends e{static get template(){return Oe`<div id="output" style="position:relative;"></div>`}connectedCallback(){super.connectedCallback();let e=this;_e(e.render(),e.$.output)}_propertiesChanged(e,t,n){super._propertiesChanged(e,t,n);let r=this;requestAnimationFrame(()=>_e(r.render(),r.$.output))}}})))()}var zt;function Bt(){return(Bt=e((()=>{h(),I(),O(),x(),Nt(),V(),It(),Rt(),zt=class extends Ft(Lt(P)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:`_computeFilterText(filter.*, _formatters)`},headerFocused:{type:Boolean,value:!1}}}static get observers(){return[`_valuesChanged(autodetect, currency, values)`]}render(){let e=e=>{this.headerFocused=e.type===`focus`,this._onDropdownOpenedChanged(e)};return C`
		...
		></cosmoz-omnitable-amount-range-input>`}computeSource(e,t){return fn(e,t)}},customElements.define(`cosmoz-omnitable-column-amount`,mn)})))()}var gn,_n,vn,yn,bn,xn,Sn,Cn,wn,Tn,En,Dn;function On(){return(On=e((()=>{ie(),xe(),he(),N(),J(),gn=(e,t)=>{if(!Array.isArray(e))return;let n=[];return e.reduce((e,t)=>Array.isArray(t)?(t.forEach(t=>{e.push(t)}),e):(e.push(t),e),[]).filter((e,r,i)=>{if(i.indexOf(e)!==r)return!1;if(t){let r=F(e,t);if(n.indexOf(r)!==-1)return!1;n.push(r)}return!0})},_n=(e,t,n)=>{if(e==null)return[];if(Array.isArray(e)){let r=gn(e,t);if(!r?.length)return[];let i=n??`label`,a=e=>String(typeof e==`object`&&e?F(e,i??``)??``:e??``);return r.sort((e,t)=>a(e).localeCompare(a(t)))}if(typeof e==`object`){let r=t??`id`,i=n??`label`;return Object.entries(e).map(([e,t])=>({[r]:e,[i]:t})).sort((e,t)=>String(e[i]??``).localeCompare(String(t[i]??``)))}return[]},vn=(e,t,n)=>fe(t&&F(e,t)).map(A(n)),yn=({valuePath:e,textProperty:t},n)=>vn(n,e,t).filter(e=>e!=null).join(`, `),bn=yn,xn=({valueProperty:e,valuePath:t,emptyValue:n,emptyProperty:r},i)=>a=>{let o=A(e),s=fe(F(a,t));return i.some(t=>s.length===0&&A(r||e)(t)===n||s.some(e=>o(e)===o(t)))},Sn=e=>t=>e(e=>({...e,filter:t})),Cn=e=>t=>e(e=>({...e,headerFocused:t})),wn=e=>t=>e(e=>({...e,query:t})),Tn=({emptyValue:e,emptyLabel:t,emptyProperty:n,textProperty:r,valueProperty:i},a)=>{let o=_n(a,i,r);return!t||e===void 0||!r||!(n||i)||!o?o:[{[r]:t,[n||i]:e},...o]},En=(e,t)=>Tn(e,dn(t,e.valuePath)),Dn=e=>class extends e{static get properties(){return{textProperty:{type:String},valueProperty:{type:String},emptyLabel:{type:String},emptyValue:{type:Object},emptyProperty:{type:String}}}getConfig(e){return{emptyProperty:e.emptyProperty}}getString(e,t){return yn(e,t)}toXlsxValue(e,t){return bn(e,t)}getComparableValue({valuePath:e,valueProperty:t},n){let r=F(n,e);return t==null?r:fe(r).map(A(t)).sort().join(` `)}getFilterFn(e,t){if(t&&Array.isArray(t)&&t.length!==0)return xn(e,t)}serializeFilter(e,t){return Array.isArray(t)&&t.length===0?null:JSON.stringify(t)}deserializeFilter(e,t){if(t==null)return null;try{return JSON.parse(decodeURIComponent(t))}catch(e){let n=e;return console.error(`Failed to deserialize filter value:`,{error:n?.name,message:n?.message,filterLength:typeof t==`string`?t.length:null}),null}}computeSource(e,t){return e.externalValues||typeof e.values==`function`?async(...t)=>Tn(e,await Promise.resolve(Te(e.values,...t))):En(e,t)}}})))()}var kn,An,jn;function Mn(){return(Mn=e((()=>{ve(),Ke(),I(),x(),ie(),he(),On(),B(),T(),N(),q(),kn=({valuePath:e,textProperty:t,valueProperty:n},r)=>{let i=t?ue(t):A(n),a=fe(e&&F(r,e)).map(i);return a.length>1?a.filter(Boolean).join(`,`):a[0]},An=({valueProperty:e,valuePath:t,emptyValue:n,emptyProperty:r},i)=>{let a=A(e),o=A(r||e),s=new Set(i.filter(e=>e.excluded).map(e=>a(e.item))),c=new Set(i.filter(e=>!e.excluded).map(e=>a(e.item))),l=i.some(e=>e.excluded&&o(e.item)===n),u=i.some(e=>!e.excluded&&o(e.item)===n);return e=>{let n=fe(F(e,t)).map(a);return n.length===0?!l&&(u||c.size===0):!n.some(e=>s.has(e))&&(c.size===0||n.some(e=>c.has(e)))}},jn=class extends Dn(z(P)){static get properties(){return{headerCellClass:{type:String,value:`autocomplete-header-cell`},minWidth:{type:String,value:`55px`},editMinWidth:{type:String,value:`55px`},keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},showSingle:{type:Boolean},preserveOrder:{type:Boolean},limit:{type:Number},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,showSingle:e.showSingle,preserveOrder:e.preserveOrder,limit:e.limit,textual:e.textual}}renderCell(e,{item:t}){return C`<span class="default-column"
		...
		>`}getComparableValue(e,t){return kn(e,t)}getFilterFn(e,t){if(t&&Array.isArray(t)&&t.length!==0)return An(e,t)}},customElements.define(`cosmoz-omnitable-column-autocomplete-excluding`,jn)})))()}var Nn,Pn;function Fn(){return(Fn=e((()=>{ve(),Ke(),I(),x(),ie(),he(),On(),B(),N(),q(),Nn=({valuePath:e,textProperty:t,valueProperty:n},r)=>{let i=t?ue(t):A(n),a=fe(e&&F(r,e)).map(i);return a.length>1?a.filter(Boolean).join(`,`):a[0]},Pn=class extends Dn(z(P)){static get properties(){return{headerCellClass:{type:String,value:`autocomplete-header-cell`},minWidth:{type:String,value:`55px`},editMinWidth:{type:String,value:`55px`},keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},showSingle:{type:Boolean},preserveOrder:{type:Boolean},limit:{type:Number},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,showSingle:e.showSingle,preserveOrder:e.preserveOrder,limit:e.limit,textual:e.textual}}renderCell(e,{item:t}){return C`<span class="default-column"
			>${e.getString(e,t)}</span
		>`}renderEditCell(e,{item:t},n){return C`<cosmoz-input
			type="text"
			@change=${e=>n(e.target.value)}
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return fn(e,t)}},customElements.define(`cosmoz-omnitable-column-date`,hr)})))()}var _r;function vr(){return(vr=e((()=>{I(),O(),x(),Qn(),Nt(),V(),Rt(),_r=class extends Zn(Lt(P)){render(){let e=e=>{this.headerFocused=e.type===`focus`};return C`
			${E(this.disabled,()=>C`
					<cosmoz-omnitable-dropdown-input
						variant="inline"
						disabled
		...
		></cosmoz-omnitable-datetime-range-input>`}computeSource(e,t){return fn(e,t)}},customElements.define(Er.is,Er)})))()}var Or;function kr(){return(kr=e((()=>{ve(),Ke(),I(),x(),On(),B(),Or=class extends Dn(z(P)){renderCell({valuePath:e,textProperty:t},{item:n}){let r=vn(n,e,t).map(e=>C`<li>${e}</li>`);return C`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		`}renderEditCell(){return`not implemented`}renderHeader(e,{filter:t,query:n},r,i){return C`<cosmoz-autocomplete-ui
			...
			.onText=${wn(r)}
			>${E(e.loading,()=>C`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}},customElements.define(`cosmoz-omnitable-column-list-horizontal`,Or)})))()}var Ar,jr;function Mr(){return(Mr=e((()=>{be(),T(),O(),Ar=j`
	:host {
		display: block;
	}
...
`,jr=({items:e})=>{let[t,n]=k(!1),r=Array.isArray(e)?e:[],i=c(()=>Math.max(0,r.length-1),[r]);if(r.length===0)return null;let a=r.length>2,o=r[0],s=a&&!t?[]:r.slice(1),l=e=>{e.stopPropagation(),e.preventDefault(),n(e=>!e)};return C`
		<ul>
			<li>
				<span>${o}</span>
			</li>
	...
	`},customElements.define(`cosmoz-omnitable-column-list-data`,w(jr,{styleSheets:[le(Ar)]}))})))()}var Nr;function Pr(){return(Pr=e((()=>{Mr(),I(),x(),ve(),On(),B(),q(),Nr=class extends Dn(z(P)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:n}){return C`<cosmoz-omnitable-column-list-data
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:n},r,i){return C`<cosmoz-autocomplete-ui
			...
			.onText=${wn(r)}
			>${E(e.loading,()=>C`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}},customElements.define(`cosmoz-omnitable-column-list`,Nr)})))()}var Fr;function Ir(){return(Ir=e((()=>{h(),I(),O(),x(),Nt(),V(),It(),Rt(),Fr=class extends Ft(Lt(P)){static get properties(){return{maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null},formatter:{type:Object,computed:`_computeFormatter(locale, minimumFractionDigits, maximumFractionDigits)`},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:`_computeFilterText(filter.*, formatter)`},headerFocused:{type:Boolean,value:!1}}}render(){let e=e=>{this.headerFocused=e.type===`focus`,this._onDropdownOpenedChanged(e)};return C`
			${E(this.disabled,()=>C`
					<cosmoz-omnitable-dropdown-input
						variant="inline"
						disabled
		...
		></cosmoz-omnitable-number-range-input>`}computeSource(e,t){return fn(e,t)}},customElements.define(`cosmoz-omnitable-column-number`,Lr)})))()}var zr;function Br(){return(Br=e((()=>{h(),I(),O(),x(),Qn(),Nt(),V(),Rt(),zr=class extends Zn(Lt(P)){render(){let e=e=>{this.headerFocused=e.type===`focus`};return C`
			${E(this.disabled,()=>C`
					<cosmoz-omnitable-dropdown-input
						variant="inline"
						disabled
	...
	</button>`},ii=({columns:e,...t})=>e?.map(e=>ri({column:e,...t})),ai=()=>C`
...
`})))()}function ci(e,t,{suffix:n=``,read:r,write:i,ready:a=!0,multi:o}={}){let s=ce({param:t,suffix:n,link:o?fi:di,write:i??ne}),l=c(()=>{if(t==null)return!1;if(o){let e=Xe(t+n);return Object.keys(e).length>0}return Qe(t+n)!==void 0},[]),[u,d]=k(()=>{if(t==null)return e;if(o){let i=Xe(t+n,r);return Object.keys(i).length>0?i:e}return Qe(t+n,r)??e}),f=_(e=>d(t=>{let n=Te(e,t);return s.param!=null&&et(s.link(s.param+s.suffix,n,s.write),null,{notify:!1}),n}),[]);return M(()=>{s.param!=null&&a&&!l&&e!=null&&f(e)},[a]),[u,f]}var li,ui,di,fi;function pi(){return(pi=e((()=>{at(),xe(),se(),lt(),T(),li=e=>(t,n,r=ne)=>{let i=nt(),a=new URLSearchParams(i.hash.replace(`#`,``));return e(t,n,r,a),`#!`+Object.assign(i,{hash:a}).href.replace(location.origin,``)},ui=e=>e==null||e===``,di=li((e,t,n,r)=>ui(n(t))?r.delete(e):r.set(e,n(t))),fi=li((e,t,n,r)=>{let i=Object.entries(t),a=i.map(n).filter(([,e])=>e!==void 0);if(a.length===0&&i.length>0)return;let o=e;Array.from(r.keys()).filter(e=>e.startsWith(o)).forEach(e=>r.delete(e)),a.forEach(([t,n])=>ui(n)?r.delete(e+t):r.set(e+t,n))})})))()}var mi,hi,gi,_i,vi;function yi(){return(yi=e((()=>{T(),pi(),mi=e=>[!0,`true`,1,`yes`,`on`].includes(e),hi=e=>e===``||(e==null?void 0:mi(e)),gi=(e,t,n)=>_(r=>{e(r),n(e=>({...e,[t]:r}))},[e,t,n]),_i=(e,t,{settings:n,setSettings:r,resetRef:i,ready:a=!0})=>{let[o,s]=ci(n.sortOn,t,{suffix:`-sortOn`,ready:a}),[l,u]=ci(hi(n.descending),t,{suffix:`-descending`,read:hi,ready:a}),[d,f]=ci(n.groupOn,t,{suffix:`-groupOn`,ready:a}),[p,m]=ci(hi(n.groupOnDescending),t,{suffix:`-groupOnDescending`,read:hi,ready:a}),h=c(()=>e.find(e=>e.name===o),[e,o]),g=c(()=>e.find(e=>e.name===d),[e,d]),v={groupOn:d,setGroupOn:gi(f,`groupOn`,r),groupOnDescending:p,setGroupOnDescending:gi(m,`groupOnDescending`,r),sortOn:o,setSortOn:gi(s,`sortOn`,r),descending:l,setDescending:gi(u,`descending`,r),columns:e},y=c(()=>v,Object.values(v)),b=_(e=>{s(typeof e.sortOn==`string`?e.sortOn:void 0),f(typeof e.groupOn==`string`?e.groupOn:void 0),u(typeof e.descending==`boolean`?e.descending:void 0),m(typeof e.groupOnDescending==`boolean`?e.groupOnDescending:void 0)},[]);return M(()=>void(i.current=b),[]),{...y,sortAndGroup:y,groupOnColumn:g,sortOnColumn:h}},vi=re(void 0),customElements.define(`sort-and-group-provider`,vi.Provider),customElements.define(`sort-and-group-consumer`,w(({render:e})=>e(m(vi)),{useShadowDOM:!1}))})))()}var bi,xi;function Si(){return(Si=e((()=>{T(),Se(),ni(),si(),yi(),bi=({data:e,columns:t,groupOnColumn:n,filters:i,setFilterState:a,sortAndGroup:{sortOn:o,setSortOn:s,descending:c,setDescending:l}={}})=>r(t,e=>e.name,t=>[C`<div
			...
			>
				...
				${E(!t.noSort,()=>ri({on:o,setOn:s,descending:c,setDescending:l,column:t}))}
			</div>`,C`<cosmoz-omnitable-resize-nub
				.column="${t}"
				name="${t.name}"
			></cosmoz-omnitable-resize-nub>`]),xi=({columns:e,settingsConfig:t,hideSelectAll:n,...r})=>{let i=m(vi);return C`
		${E(e,e=>bi({columns:e,sortAndGroup:i,...r}))}
		${E(!n,()=>C` <cosmoz-omnitable-settings
					.config=${t}
					part="settings"
				></cosmoz-omnitable-settings>`)}
	`},customElements.define(`cosmoz-omnitable-header-row`,w(xi,{useShadowDOM:!1}))})))()}var Ci,wi;function Ti(){return(Ti=e((()=>{be(),T(),Ci=j`
	:host {
		display: flex;
		align-items: center;
		flex-wrap: wrap;
...
`,customElements.define(`cosmoz-omnitable-item-expand-line`,w(wi,{styleSheets:[le(Ci)]}))})))()}var Ei;function Di(){return(Di=e((()=>{T(),x(),Ti(),Ei=({columns:e,item:t,selected:n,expanded:r,groupOnColumn:i})=>Ye(e,e=>C`<cosmoz-omnitable-item-expand-line
				.column=${e}
				?hidden=${e===i}
				exportparts="item-expand-label, item-expand-value"
				>${e.renderCell(e,{item:t,selected:n,expanded:r})}</cosmoz-omnitable-item-expand-line
			>`),customElements.define(`cosmoz-omnitable-item-expand`,w(Ei,{useShadowDOM:!1}))})))()}var Oi,ki;function Ai(){return(Ai=e((()=>{T(),Se(),Oi=(e,t,n)=>e.editable?e.renderEditCell(e,t,n(e,t.item)):e.renderCell(e,t),ki=({columns:e,groupOnColumn:t,item:n,index:i,selected:a,expanded:o,onItemChange:s})=>r(e,e=>e.name,e=>C`<div
			...
			</div>`),customElements.define(`cosmoz-omnitable-item-row`,w(ki,{useShadowDOM:!1}))})))()}var ji,Mi;function Ni(){return(Ni=e((()=>{be(),ji=j`
	.checkbox {
		box-sizing: border-box;
...
`})))()}var Pi,Fi;function Ii(){return(Ii=e((()=>{qe(),Pi=e=>{let t=e.replace(/"/gu,`""`);return t.search(/("|,|\n)/gu)>=0?`"`+t+`"`:e},Fi=(e,t,n)=>{let r=e.map(e=>Pi(e.title)).join(`;`)+`
`,i=t.map(t=>e.map(e=>{let n=e.getString(e,t);return n==null?``:Pi(String(n))}).join(`;`)+`
`);i.unshift(r),it(new File(i,n,{type:`text/csv;charset=utf-8`}))}})))()}var Li,Ri;function zi(){return(zi=e((()=>{rt(),qe(),Li=(e,t)=>{let n=e.map(e=>e.title),r=t.map(t=>e.map(e=>e.toXlsxValue(e,t)??``));return r.unshift(n),r},Ri=(e,t,n,r)=>{let i=Li(e,t),a=new st(n).addSheetFromData(i,r).generate();it(new File([a],n,{type:`application/vnd.openxmlformats-officedocument.spreadsheetml.sheet`}))}})))()}var Bi,$,Vi;function Hi(){return(Hi=e((()=>{Bi=Symbol(`index`),$=Symbol(`All`),Vi=(e,t)=>{if(typeof e.findLastIndex==`function`)return e.findLastIndex(t);for(let n=e.length-1;n>=0;n--)if(t(e[n],n,e))return n;return-1}})))()}var Ui;function Wi(){return(Wi=e((()=>{Pe(),l(),O(),x(),Ii(),zi(),Hi(),Ui=({columns:e,selectedItems:t,setSelectedItems:n,csvFilename:r,xlsxFilename:i,xlsxSheetname:a,topPlacement:o,enableSelectAll:s,allSelected:c,allItemsCount:l})=>{let u=t===$,d=u||t.length>0,f=t!==$&&s&&c,p=t=>C`<cosmoz-dropdown-menu
			part="extra"
			slot="extra"
			.placement=${o}
		>
	...
	>
		...
		${E(t!==$,()=>p(t))}
	</cosmoz-bottom-bar>`}})))()}var Gi;function Ki(){return(Ki=e((()=>{x(),Gi=({allSelected:e,onAllCheckboxChange:t,sortAndGroup:n,dataIsValid:r,data:i,columns:a,filters:o,groupOnColumn:s,setFilterState:c,settingsConfig:l,hideSelectAll:u})=>C`<sort-and-group-provider .value=${n}>
	...
	</sort-and-group-provider>`})))()}var qi,Ji;function Yi(){return(Yi=e((()=>{T(),qi=n`
	:host {
		max-width: 100%;
		overflow-x: hidden;
...
`,Ji=({settingsConfig:e})=>{let{columns:t,collapsed:n}=e,r=t.filter(e=>!n.some(t=>t.name===e.name));return C`<div class="skeleton">
		...
		</div>`}})))()}var Qi,$i;function ea(){return(ea=e((()=>{be(),Ni(),Qi=j`
	:host {
		box-sizing: border-box;
		display: flex;
		flex-direction: column;
...
`})))()}var ta,na;function ra(){return(ra=e((()=>{se(),T(),ta=e=>{let t=parseInt(e??``,10);return isFinite(t)?t:void 0},na=e=>{let{config:t}=e,{settings:n,setSettings:r,collapsed:i,requestTween:a}=t,o=ce({collapsed:i,settings:n.columns,requestTween:a,setSettings:_(e=>r(t=>({...t,columns:e})),[r])});return{...t,onDown:_(e=>{let t=e.target instanceof Element?e.target:null;t&&t.closest(`.pull`)&&(o.handle=e.currentTarget instanceof HTMLElement?e.currentTarget:null)},[o]),onDragStart:_(e=>{let t=e.target instanceof HTMLElement?e.target:null,n=ta(t?.dataset.index);if(!t||!o.handle?.contains(t)||n==null)return e.preventDefault();o.handle=null,e.dataTransfer.effectAllowed=`move`,e.dataTransfer.setData(`omnitable/sort-index`,String(n)),e.dataTransfer.setData(`text/plain`,String(n)),setTimeout(()=>t.classList.add(`drag`),0),t.addEventListener(`dragend`,e=>{(e.target instanceof HTMLElement?e.target:null)?.classList.remove(`drag`)},{once:!0})},[o]),onDragEnter:_(e=>{let t=e.currentTarget instanceof HTMLElement?e.currentTarget:null;t&&t===e.target&&(e.preventDefault(),e.dataTransfer.dropEffect=`move`,t.classList.add(`dragover`))},[]),onDragOver:_(e=>{e.preventDefault(),e.currentTarget instanceof HTMLElement&&e.currentTarget.classList.add(`dragover`)},[]),onDragLeave:_(e=>{let t=e.currentTarget instanceof HTMLElement?e.currentTarget:null;t&&(e.relatedTarget instanceof Node&&t.contains(e.relatedTarget)||t.classList.remove(`dragover`))},[]),onDrop:_(e=>{let t=ta(e.dataTransfer?.getData(`omnitable/sort-index`)),n=e.currentTarget instanceof HTMLElement?e.currentTarget:null,r=ta(n?.dataset.index),{settings:i,setSettings:a,requestTween:s}=o;n?.classList.remove(`dragover`),e.preventDefault();let c=i.slice();c.splice(r+(t>=r?0:-1),0,c.splice(t,1)[0]),s?.(),a(c)},[o]),onToggle:_(e=>{let{settings:t,setSettings:n,requestTween:r}=o,i=t.map(e=>({...e,disabled:e.disabled||o.collapsed?.some(t=>t.name===e.name)})),a=e.target instanceof HTMLInputElement?e.target:null,s=ta((e.target instanceof Element?e.target:null)?.closest(`[data-index]`)?.getAttribute(`data-index`));s!=null&&(i.splice(s,1,{...t[s],disabled:!a?.checked,priority:a?.checked?t.reduce((e,t)=>Math.max(e,t.priority??0),0)+1:t[s]?.priority}),r?.(),n(i))},[o])}}})))()}var ia,aa,oa,sa;function ca(){return(ca=e((()=>{We(),ct(),mt(),l(),be(),De(),T(),O(),si(),ea(),ra(),ia=[He({apply({availableHeight:e,elements:t}){Object.assign(t.floating.style,{maxHeight:`${Math.max(0,e)}px`})}}),...Re],aa=({onDragStart:e,onDragEnter:t,onDragOver:n,onDragLeave:r,onDrop:i,onDown:a,onToggle:o,collapsed:s,filters:c})=>(l,u)=>{let d=!!s?.find(e=>e.name===l.name),f=!l.disabled&&!d;return C` <div
		...
		>
			...
			<input
				...
				.indeterminate=${d}
			/>
		</div>`},oa=e=>{let{settings:t,settingsId:n,onSave:r,onReset:i,hasChanges:a,canReset:o,opened:s,setOpened:c,...l}=na(e);return C` <div class="headline">
		...
		${E(n,()=>C`<div class="buttons">
				...
				</div>`)}`},customElements.define(`cosmoz-omnitable-settings-ui`,w(oa,{styleSheets:[le(Qi)]})),sa=({config:e,newLayout:t})=>C`
	<cosmoz-dropdown
...
`,customElements.define(`cosmoz-omnitable-settings`,w(sa,{styleSheets:[le($i)]}))})))()}var la,ua,da,fa,pa;function ma(){return(ma=e((()=>{he(),la=[`sortOn`,`descending`,`groupOn`,`groupOnDescending`],ua=e=>t=>typeof t==`object`&&!!t&&`name`in t&&t.name===e,da=(e=[],t=[],n=[])=>{let r=t.filter(t=>e.some(ua(t.name))),i=e.filter(e=>e.name!=null&&!t.some(ua(e.name))&&!n.some(ua(e.name))),a=n.filter(e=>!t.some(ua(e.name)));return[...r,...a.flatMap(t=>{let n=e.find(e=>e.name===t.name);return n?{...t,title:n.title??t.title??``,minWidth:parseInt(n.minWidth??`0`,10)}:[]}),...i.map(e=>{let{name:t,title:n,priority:r,minWidth:i,width:a,flex:o}=e;return{name:t??``,title:n??``,priority:r??0,minWidth:parseInt(i??`0`,10),width:parseInt(a??`0`,10),flex:parseInt(o??`0`,10)}})]},fa=(e,t)=>({...t,...de(Array.from(la))(e),columns:e.columns?.map(de([`name`,`priority`,`width`,`flex`,`disabled`]))??t?.columns}),pa=({columns:e,settings:t,savedSettings:n,initial:r})=>({...Object.fromEntries(la.flatMap(e=>r?.[e]==null?[]:[[e,r[e]]])),...n?de(Array.from(la))(n):{},...t,columns:da(e,t?.columns,n?.columns)})})))()}var ha;function ga(){return(ga=e((()=>{ha=({prefix:e=`omnitable-`}={})=>({write:async(t,n)=>{let r=e+t;try{n?localStorage.setItem(r,JSON.stringify(n)):localStorage.removeItem(r)}catch(e){console.error(e)}},read:async t=>{if(!t)return null;try{let n=localStorage.getItem(e+t);return n==null?null:JSON.parse(n)}catch(e){return console.error(e),null}}})})))()}var _a,va;function ya(){return(ya=e((()=>{T(),ga(),_a=re(ha),va=()=>{let e=m(_a);return c(()=>e(),[e])}})))()}function ba(){return(ba=e((()=>{ya()})))()}var xa;function Sa(){return(Sa=e((()=>{T(),ba(),ma(),xa=(e,t,n,r)=>{let[i,a]=k(e?void 0:null),{read:o,write:s}=va();return M(async()=>{e&&a(await o(e))},[e,o]),{settingsId:e,savedSettings:i,onSave:_(async()=>{if(!e)return;let r=fa(t,i);await s(e,r),n(),a(r)},[t,i]),onReset:_(async()=>{n(),e&&i!=null&&(await s(e),a(null)),r?.()},[e,i,s,r]),hasChanges:t!=null,canReset:t!=null||i!=null}}})))()}var Ca;function wa(){return(wa=e((()=>{T(),q(),ma(),Sa(),Ca=({settingsId:e,host:t})=>{let n=c(()=>Object.fromEntries(la.map(e=>[e,t[e]])),[]),r=Ce(),i=_(()=>{r.current?.(n)},[n]),[a,o]=k(),[s,l]=k({columns:!0,sort:!0}),{savedSettings:u,...d}=xa(e,a,o,i),{enabledColumns:f,disabledFiltering:p}=t,m=un(t,{enabledColumns:f,disabledFiltering:p}),h=c(()=>pa({columns:m,settings:a,savedSettings:u??void 0,initial:n}),[m,a,u]),g=c(()=>h.columns.map(e=>m.find(t=>t.name===e.name)).filter(e=>e!==void 0),[m,...h.columns.map(e=>e.name)]);return{...d,savedSettings:u,opened:s,setOpened:l,settings:h,columns:g,setSettings:o,resetRef:r}}})))()}function Ta(){return(Ta=e((()=>{ca(),wa()})))()}var Ea,Da;function Oa(){return(Oa=e((()=>{Ea=e=>Number.isFinite(e)?e:0,Da=(e,t)=>{let n=[],[r,i]=e.reduce(([e,t],{width:n,flex:r})=>[e+n,t+r],[0,0]),a=t-r,o=Ea(a/i),s=0,c=0,l=0;for(let t=0;t<e.length;t++){let{width:i,minWidth:u,flex:d}=e[t];if(u>i+(a>=0?o*d:i*a/r)){s+=i,c+=u,l+=d,n[t]=u;continue}if(d===0){s+=i,c+=i,n[t]=i;continue}}r-=s,a=t-c-r,i-=l,o=Ea(a/i);for(let t=0;t<e.length;t++){if(n[t]!=null)continue;let{width:i,flex:s}=e[t],c=a>=0?o*s:i*a/r;n[t]=i+c}return n}})))()}var ka,Aa,ja;function Ma(){return(Ma=e((()=>{Oa(),Hi(),ka=(e,t)=>{let n=Vi(e,e=>e!=null&&e>0),r=(e,t)=>`.cell[name="${e}"], cosmoz-omnitable-skeleton::part(cell-${e}){width: ${t}px;padding: 0 min(3px, ${t/2}px)}`,i=e=>`cosmoz-omnitable-resize-nub[name="${e}"]{display:none}`,a=e=>`cosmoz-omnitable-resize-nub[name="${e}"], .cell[name="${e}"]{display:none}`,o=0,s=0;return t.map((t,c)=>{let l=e[c];if(l==null||l===0)return a(t.name);o+=l;let u=Math.round(o),d=u-s;s=u;let f=r(t.name,d);return c===n?`${f}\n${i(t.name)}`:f}).join(`
`)},Aa=(e,t,n)=>{let r=e.filter(e=>!e.hidden),i=r.reduce((e,{width:t})=>e+t,0);if(r.length>1&&i>t)return Aa(r.slice(1),t,n);let a=r.reduce(([e,t],n,r)=>[Math.max(e,n.index),n.index>e?r:t],[-1,-1])[1];return a!==-1&&(r[a].flex=1),Da(r,t).reduce((e,t,n)=>(e[r[n].index]=t,e),Array(n).fill(void 0))},ja=(e,t)=>e.length===0?`.cell {display: none;}`:ka(e,t)})))()}var Na;function Pa(){return(Pa=e((()=>{T(),Na=(e,t)=>M(()=>{let n=new ResizeObserver(([e])=>{e.contentRect?.width!==0&&t(e.contentRect.width-88)});return n.observe(e),()=>n.unobserve(e)},[])})))()}var Fa;function Ia(){return(Ia=e((()=>{T(),Pa(),Fa=e=>{let[t,n]=k(()=>e.getBoundingClientRect().width-88);return Na(e,n),t}})))()}var La;function Ra(){return(Ra=e((()=>{T(),Ma(),La=({canvasWidth:e,groupOnColumn:t,config:n,miniColumn:r})=>c(()=>{if(!Array.isArray(n)||e==null||e===0)return[];let i=n.map((e,n)=>({minWidth:e.minWidth,width:e.width,flex:e.flex,priority:e.priority,name:e.name,index:n,hidden:e.name===t?.name||e.disabled})).map(e=>r?{...e,hidden:r.name!==e.name}:e).sort(({index:e,priority:t},{index:n,priority:r})=>t===r?n-e:t-r);return Aa(i,e,i.length)},[e,t,n])})))()}var za;function Ba(){return(Ba=e((()=>{T(),za=({host:e,canvasWidth:t,columns:n})=>{let r=e.miniBreakpoint??480,i=c(()=>t<=r,[t,r]),[a,...o]=c(()=>i?n?.filter(e=>e.mini!=null).sort((e,t)=>(e.mini??0)-(t.mini??0)):[],[n,i])??[],s=!!a;return M(()=>{e.toggleAttribute(`mini`,s)},[s]),{isMini:s&&i,miniColumn:a,miniColumns:o}}})))()}var Va;function Ha(){return(Ha=e((()=>{T(),Va=({host:e,canvasWidth:t,layout:n,setSettings:r,requestTween:i})=>{let a=Ce();a.current=e=>{i(),r(r=>{let i=r.columns,{detail:{newWidth:a,column:o}}=e,s=i.findIndex(e=>e.name===o.name),c=[],l=i.reduce((e,t)=>Math.max(e,t.priority),-1/0);for(let e=0;e<n.length;e++)if(c[e]={...i[e]},e<s&&n[e]&&(c[e].width=n[e],c[e].flex=0,c[e].priority=l),e===s){let r=n.reduce((e,t,n)=>n<s&&t?e-t:e,t);c[e].width=Math.min(r,Math.max(a,i[e].minWidth)),c[e].flex=0,c[e].priority=l}return{...r,columns:c}})},M(()=>{let t=e=>a.current?.(e);return e.addEventListener(`column-resize`,t),()=>e.removeEventListener(`column-resize`,t)},[])}})))()}var Ua,Wa,Ga;function Ka(){return(Ka=e((()=>{xe(),se(),T(),Ua=(e,t)=>{let n=c(()=>{let t=!1,n,r=()=>{t&&(n=requestAnimationFrame(r),e()&&(t=!1))};return{start:()=>{t=!0,cancelAnimationFrame(n),n=requestAnimationFrame(r)},stop:()=>{t=!1,cancelAnimationFrame(n)}}},[]);M(()=>{n.start()},t),M(()=>()=>n.stop(),[])},Wa=(e=0,t=0)=>Math.abs(e-t)<.1,Ga=(e,t=1.9,n=oe,r)=>{let i=ce({target:e,speedFactor:t,onConverge:r}),a=_(()=>{if(!i.tween)return i.tween=i.target,n(i.tween),i.onConverge?.(),!0;if(i.target.every((e,t)=>i.tween[t]===e))return n(i.tween),i.onConverge?.(),!0;if(i.tween=i.target.map((e,t)=>Wa(i.tween[t],e)?e:(i.tween[t]??0)+((e??0)-(i.tween[t]??0))/i.speedFactor||0),n(i.tween),i.tween.every((e,t)=>e===i.target[t]))return i.onConverge?.(),!0},[]);Ua(a,[e])}})))()}var qa,Ja;function Ya(){return(Ya=e((()=>{se(),T(),Ma(),Ia(),Ra(),Ba(),Ha(),Ka(),qa=e=>{let t=c(()=>new CSSStyleSheet,[]);return M(()=>{e.shadowRoot.adoptedStyleSheets=[...e.shadowRoot.adoptedStyleSheets,t]},[]),t},Ja=({host:e,columns:t,settings:n,setSettings:r,resizeSpeedFactor:i,sortAndGroupOptions:a})=>{let o=Fa(e),{isMini:s,miniColumn:l,miniColumns:u}=za({host:e,canvasWidth:o,columns:t}),{groupOnColumn:d}=a,f=La({canvasWidth:o,groupOnColumn:d,miniColumn:l,config:n.columns}),p=qa(e),m=c(()=>n.columns.reduce((e,n,r)=>f[r]!=null||n.name===d?.name||n.disabled?e:[...e,t.find(e=>e.name===n.name)],[]),[t,n,f]),[h,g]=k(1),v=_(()=>g(i??1.9),[i]),y=_(()=>g(1),[]),b=ce({columns:n.columns});return Ga(f,h,e=>{let t=ja(e,b.columns);p.replaceSync(t)},y),Va({host:e,canvasWidth:o,layout:f,setSettings:e=>r(e(n)),requestTween:v}),{isMini:s,collapsedColumns:m,miniColumns:u,requestTween:v}}})))()}var Xa;function Za(){return(Za=e((()=>{Xa=({host:e,...t})=>{let{csvFilename:n=`omnitable.csv`,xlsxFilename:r=`omnitable.xlsx`,xlsxSheetname:i=`Omnitable`,topPlacement:a=`top-end`}=e;return{csvFilename:n,xlsxFilename:r,xlsxSheetname:i,topPlacement:a,...t}}})))()}var Qa;function $a(){return($a=e((()=>{T(),Hi(),Qa=({host:e,selectedItems:t,data:n,dataIsValid:r,columns:i,sortAndGroupOptions:a,collapsedColumns:o,settings:s,filterFunctions:l,settingS:u,filters:d,setFilterState:f,hideSelectAll:p,requestTween:m,...h})=>{let g=t===$||!!n&&n.length>0&&Array.isArray(t)&&t.length===n.length,_=t=>{if(!(t.target instanceof HTMLInputElement))return;let n=e.shadowRoot.querySelector(`#groupedList`);t.target.checked?n.selectAll():n.deselectAll()},{groupOnColumn:v}=a,y=c(()=>[v,...o,...s.columns.filter(e=>e.disabled)].some(e=>!!e&&!!e.name&&Object.keys(l).includes(e.name)),[l,s,o]),b=c(()=>({...u,collapsed:o,badge:y,filters:d,requestTween:m}),[u,o,y,d,m]);return M(()=>{let t=e.shadowRoot.querySelector(`#tableContent`),n=new ResizeObserver(t=>requestAnimationFrame(()=>{e.style.setProperty(`--ot-height`,t[0]?.contentRect.height+`px`)}));return n.observe(t),()=>n.unobserve(t)},[]),{allSelected:g,onAllCheckboxChange:_,data:n,dataIsValid:r,columns:i,settingsConfig:b,filters:d,groupOnColumn:v,setFilterState:f,hideSelectAll:p,sortAndGroup:a.sortAndGroup,...h}}})))()}var eo,to,no,ro,io,ao,oo;function so(){return(so=e((()=>{l(),De(),T(),Hi(),J(),eo=e=>e instanceof HTMLInputElement,to=e=>e instanceof HTMLElement,no=e=>e?`groupRow groupRow-folded`:`groupRow`,ro=({item:e,index:t})=>n=>E((n?.length??0)>0,()=>C`
			...
			<div
				?selected=${d}
				part="${[`itemRow`,`itemRow-${l[Bi]}`,c?.(l,u)].filter(Boolean).join(` `)}"
				.dataIndex=${l[Bi]}
				.dataItem=${l}
				class="itemRow"
				@click=${r}
		...
		</div>`,oo=({host:e,error:t,dataIsValid:n,processedItems:r,columns:i,collapsedColumns:a,miniColumns:o,sortAndGroupOptions:s,rowPartFn:l,...u})=>{let{loading:d=!1,displayEmptyGroups:f=!1,compareItemsFn:p}=e,m=Ce({shiftKey:!1,ctrlKey:!1}),h=_(t=>{if(!eo(t.target))return;let n=t.target,r=n.dataItem,i=n.checked,a=e.shadowRoot.querySelector(`#groupedList`);m.current.shiftKey?a.toggleSelectTo(r,i):m.current.ctrlKey?(n.checked=!0,a.selectOnly(r)):a.toggleSelect(r,i),t.preventDefault(),t.stopPropagation()},[]);M(()=>{let e=({shiftKey:e,ctrlKey:t})=>{m.current={shiftKey:e,ctrlKey:t}};return window.addEventListener(`keydown`,e),window.addEventListener(`keyup`,e),()=>{window.removeEventListener(`keydown`,e),window.removeEventListener(`keyup`,e)}},[]);let g=_(t=>{if(!to(t.currentTarget))return;let n=t.currentTarget,r=t.composedPath();r.slice(0,r.indexOf(n)).some(e=>e instanceof Element&&e.matches(`a, .checkbox, .expand`))||e.dispatchEvent(new window.CustomEvent(`omnitable-item-click`,{bubbles:!0,composed:!0,detail:{item:n.dataItem,index:n.dataIndex}}))},[]),{groupOnColumn:v}=s,y=_((t,n)=>r=>pn(e,t,n,r),[]);return{...u,processedItems:r,dataIsValid:n,filterIsTooStrict:n&&r.length<1,loading:d,compareItemsFn:p,displayEmptyGroups:f,error:t,renderItem:c(()=>io({columns:i,collapsedColumns:a,miniColumns:o,onItemClick:g,onCheckboxChange:h,dataIsValid:n,groupOnColumn:v,onItemChange:y,rowPartFn:l}),[i,a,g,h,n,v,y,l]),renderGroup:c(()=>ao({onCheckboxChange:h,dataIsValid:n,groupOnColumn:v}),[h,n,v])}}})))()}var co;function lo(){return(lo=e((()=>{co=(e,t)=>{if(e===t)return 0;if(e==null)return-1;if(t==null)return 1;let n=typeof e,r=typeof t;return n===`object`&&r===`object`?e.toString()<t.toString()?-1:1:n===`number`&&r===`number`?e-t:n===`string`&&r===`string`?e<t?-1:1:n===`boolean`&&r===`boolean`?e?-1:1:(console.warn(`unsupported sort`,n,e,r,t),0)}})))()}var uo,fo,po,mo,ho,go;function _o(){return(_o=e((()=>{xe(),T(),lo(),q(),pi(),Hi(),uo=(e,t)=>(n,r)=>co(e(n),e(r))*(t?-1:1),fo=e=>e.replace(/([a-z0-9])([A-Z])/gu,`$1-$2`).toLowerCase(),po=(e,t)=>{e&&t&&Object.entries(t).forEach(([t,n])=>{let r=e[K];r.__ownChange=!0,Object.assign(r,{[t]:n}),r.__ownChange=!1,r.dispatchEvent(new CustomEvent(`${fo(t)}-changed`,{bubbles:!0,detail:{value:n}}))})},mo=(e,t)=>Object.assign(e,{[Bi]:t}),ho=Symbol(`unparsed`),go=({data:e,columns:t,hashParam:n,sortAndGroupOptions:r,noLocalSort:i,noLocalFilter:a})=>{let{groupOnColumn:o,groupOnDescending:s,sortOnColumn:l,descending:u}=r,d=_(([e,n])=>{let r=t.find(({name:t})=>t===e);return r==null?[e,void 0]:[e,n.filter&&r.serializeFilter(r,n.filter)]},[t]),f=_(([e,n])=>{let r=t.find(({name:t})=>t===e);if(r==null)return[e,{[ho]:n}];let i={filter:r.deserializeFilter(r,n)};return po(r,i),[e,i]},[t]),[p,m]=ci({},n,{multi:!0,suffix:`-filter--`,write:d,read:f}),h=_((e,n)=>m(r=>{let i=Te(n,r[e]);return po(t.find(t=>t.name===e),i),{...r,[e]:{...r[e],...i}}}),[t,m]),g=c(()=>Object.values(p).map(e=>e.filter),[p]),v=c(()=>Object.fromEntries(t.map(e=>[e.name,!e.noLocalFilter&&e.getFilterFn(e,p[e.name]?.filter)]).filter(e=>!!e[1])),[t,...g]),y=c(()=>!Array.isArray(e)||e.length===0?[]:Object.entries(v).length===0||a?e.slice():e.filter(e=>Object.values(v).every(t=>t(e))),[e,v,a]),b=c(()=>{if(!i&&!o&&l!=null&&l.sortOn!=null)return y.slice().sort(uo(e=>l.getComparableValue({...l,valuePath:l.sortOn},e),u));if(o!=null&&o.groupOn!=null){let e=y.reduce((e,t)=>{let n=o.getComparableValue({...o,valuePath:o.groupOn},t);if(n===void 0)return e;let r=e.find(e=>e.id===n);return r?(r.items.push(t),e):(r={id:n,name:n,items:[t]},[...e,r])},[]);return e.sort(uo(e=>o.getComparableValue({...o,valuePath:o.groupOn},e.items[0]),s)),!l||i?e:e.filter(e=>Array.isArray(e.items)).map(e=>(e.items.sort(uo(e=>l.getComparableValue({...l,valuePath:l.sortOn},e),u)),e))}return y},[y,o,s,l,u,i]),ee=c(()=>{let e=0,t=0,n=[];return b.forEach(r=>{if(`items`in r&&Array.isArray(r.items)){mo(r,t++),r.items.forEach(t=>{mo(t,e++),n.push(t)});return}return mo(r,e++),n.push(r)},[]),n},[b]);return M(()=>{m(e=>Object.values(e).some(e=>e[ho]!=null)?Object.fromEntries(Object.entries(e).map(([e,t])=>{let n=t[ho];return n==null?[e,t]:f([e,n])})):e)},[f]),{processedItems:b,visibleData:ee,filters:p,filterFunctions:v,setFilterState:h}}})))()}var vo,yo;function bo(){return(bo=e((()=>{u(),g(),T(),vo=e=>{let t=t=>{let n=e.data.indexOf(t);if(n<0)return null;let r=e.data.splice(n,1);if(e.data=e.data.slice(),Array.isArray(r)&&r.length>0)return r[0]},n=(t,n)=>{e.data.splice(t,1,n),e.data=e.data.slice()};return{removeItem:t,removeItems(e){let n=[];for(let r=e.length-1;r>=0;--r){let i=t(e[r]);i!=null&&n.push(i)}return n},replaceItemAtIndex:n,replaceItem(t,r){let i=e.data.indexOf(t);i>-1&&n(i,r)},selectItem(t){e.shadowRoot.querySelector(`#groupedList`).select(t)},selectAll(){e.shadowRoot.querySelector(`#groupedList`).selectAll()},deselectAll(){e.shadowRoot.querySelector(`#groupedList`).deselectAll()},deselectItem(t){e.shadowRoot.querySelector(`#groupedList`).deselect(t)},isItemSelected(t){return e.shadowRoot.querySelector(`#groupedList`).isItemSelected(t)}}},yo=({host:e,visibleData:t,filters:n,...r})=>{let{setFilterState:i}=r,o=c(()=>vo(e),[]),[l,u]=a(`selectedItems`,[]);p(r,Object.values(r)),p(o,Object.values(o)),M(()=>{let t=e=>{if(!(e instanceof CustomEvent))return;let t=e.detail;i(t.name,e=>({...typeof e==`object`&&e?e:{},...t.state}))};return e.addEventListener(`legacy-filter-changed`,t),()=>e.removeEventListener(`legacy-filter-changed`,t)},[]),s(`visibleData`,t),s(`sortedFilteredGroupedItems`,r.sortedFilteredGroupedItems),s(`sortOn`,r.sortOn),s(`descending`,r.descending),s(`isMini`,r.isMini);let d=c(()=>Object.fromEntries(Object.entries(n).filter(([,{filter:e}])=>e!==void 0).map(([e,{filter:t}])=>[e,t])),[n]);return s(`filters`,d,Object.values(d)),{selectedItems:l,setSelectedItems:u}}})))()}var xo;function So(){return(So=e((()=>{Ta(),Ya(),Za(),$a(),so(),_o(),bo(),yi(),xo=e=>{let{hashParam:t,settingsId:n,data:r,resizeSpeedFactor:i,noLocal:a,noLocalSort:o=a,noLocalFilter:s=a,error:c,rowPartFn:l}=e,u=Ca({settingsId:n,host:e}),{settings:d,setSettings:f,columns:p,resetRef:m,savedSettings:h}=u,g=_i(p,t,{settings:d,setSettings:f,resetRef:m,ready:h!==void 0}),{processedItems:_,visibleData:v,filters:y,setFilterState:b,filterFunctions:ee}=go({data:r,columns:p,hashParam:t,sortAndGroupOptions:g,noLocalSort:o,noLocalFilter:s}),{isMini:x,collapsedColumns:S,miniColumns:C,requestTween:te}=Ja({host:e,columns:p,settings:d,setSettings:f,resizeSpeedFactor:i,sortAndGroupOptions:g}),ne=r&&Array.isArray(r)&&r.length>0,{selectedItems:re,setSelectedItems:ie}=yo({host:e,visibleData:v,sortedFilteredGroupedItems:_,columns:p,filters:y,setFilterState:b,isMini:x,...g}),ae=Qa({host:e,selectedItems:re,sortAndGroupOptions:g,dataIsValid:ne,data:r,columns:p,filters:y,collapsedColumns:S,settings:d,filterFunctions:ee,settingS:u,setFilterState:b,hideSelectAll:e.hideSelectAll===!0,requestTween:te});return{header:ae,list:oo({host:e,error:c,dataIsValid:ne,processedItems:_,selectedItems:re,setSelectedItems:ie,columns:p,collapsedColumns:S,miniColumns:C,sortAndGroupOptions:g,rowPartFn:l}),footer:Xa({host:e,selectedItems:re,allSelected:ae.allSelected,setSelectedItems:ie,columns:p,enableSelectAll:e.enableSelectAll,allItemsCount:e.allItemsCount})}}})))()}function Co(){return(Co=e((()=>{x(),customElements.define(`cosmoz-grouped-list-row`,class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item!=null&&this._index!=null&&this._renderFn!=null&&_e(this._renderFn(this._item,this._index),this)}})})))()}var wo,To,Eo,Do,Oo,ko,Ao,jo,Mo;function No(){return(No=e((()=>{wo={group:Symbol(`group`)},To=(e,t)=>(t.has(e)||t.set(e,{}),t.get(e)),Eo=(e,t)=>!!To(e,t).expanded,Do=(e,t)=>!!To(e,t).folded,Oo=e=>e?e.items instanceof Array:!1,ko=e=>{if(!Array.isArray(e)||e.length===0)return;let t=Array.isArray(e[0]?.items);if(!e.every(e=>Array.isArray(e.items)===t))throw Error(`Data must be homogeneous.`)},Ao=(e,t,n)=>{if(Array.isArray(e))return ko(e),e.reduce((e,r)=>{let i=r;return i.items?i.items.length?To(r,n).folded?e.concat(r):e.concat(r,i.items.map(e=>Object.assign(e,{[wo.group]:r}))):t?e.concat(r):e:e.concat(r)},[])},jo=(e,...t)=>typeof e==`function`?e(...t):e,Mo=(e,t)=>e===t})))()}var Po;function Fo(){return(Fo=e((()=>{T(),No(),Po=()=>{let[e,t]=k(()=>[new WeakMap]);return{setItemState:_((e,n)=>t(([t])=>{let r=To(e,t);return Object.assign(r,jo(n,r)),[t]}),[]),state:e[0],signal:e}}})))()}var Io;function Lo(){return(Lo=e((()=>{T(),Fo(),No(),Io=()=>{let{setItemState:e,state:t,signal:n}=Po();return{state:t,signal:n,toggleFold:_((t,n)=>{Oo(t)&&e(t,e=>({folded:n===void 0?!e.folded:n}))},[]),toggleCollapse:_((t,n)=>{Oo(t)||e(t,e=>({expanded:n===void 0?!e.expanded:!n}))},[])}}})))()}var Ro;function zo(){return(zo=e((()=>{T(),Hi(),No(),Ro=({compareItemsFn:e,data:t,flatData:n})=>{let[r,i]=a(`selectedItems`,()=>[]),[o,s]=k(),c=_(e=>r===$||r.includes(e),[r]),l=_(e=>r===$||(e?.items?.every(c)??!1),[r,c]),u=_(e=>c(e)||l(e),[c,l]),d=_(e=>{let t=e.items??[e];i(e=>e===$?e:[...e,...t.filter(t=>!e.includes(t))]),s(e)},[]),f=_(e=>{let t=e.items??[e];i(e=>e===$?(n??[]).filter(e=>!Oo(e)).filter(e=>!t.includes(e)):e.filter(e=>!t.includes(e))),s(e)},[n]),p=_(e=>{i(e.items?.slice()||[e]),s(e)},[]),m=_(()=>{i(t.flatMap(e=>e.items||e)),s(void 0)},[t]),h=_(()=>{i([]),s(void 0)},[]),g=_((e,t=!u(e))=>t?d(e):f(e),[u]),v=_((t,r)=>{if(!n)return;let i=o?n.findIndex(t=>e(t,o)):-1;if(i<0)return g(t,r);let[a,c]=[i,n.indexOf(t)].sort((e,t)=>e-t);n.slice(a,c+1).forEach((e,t,n)=>{t>0&&t<n.length-1&&Oo(e)||g(e,r)}),s(t)},[n,e,g]);return M(()=>i(t=>t!==$&&t.length>0&&n?n.filter(n=>t.find(t=>e(n,t))):t),[n]),{selectedItems:r,isItemSelected:c,isGroupSelected:l,isSelected:u,select:d,deselect:f,selectOnly:p,selectAll:m,deselectAll:h,toggleSelect:g,toggleSelectTo:v}}})))()}var Bo,Vo,Ho;function Uo(){return(Uo=e((()=>{we(),u(),T(),x(),Co(),Lo(),zo(),No(),Bo={host:{position:`relative`,display:`flex`,flexDirection:`column`}},Vo=e=>{let{data:t,renderItem:n,renderGroup:r,displayEmptyGroups:i,compareItemsFn:a=Mo}=e,{toggleFold:o,toggleCollapse:s,state:l,signal:u}=Io(),d=c(()=>Ao(t,i,l),[t,i,u]),{selectedItems:f,isItemSelected:m,isGroupSelected:h,isSelected:g,select:v,deselect:y,selectOnly:b,selectAll:ee,deselectAll:x,toggleSelect:S,toggleSelectTo:C}=Ro({compareItemsFn:a,data:t,flatData:d}),te=_((e,t)=>Array.isArray(e.items)?r(e,t,{selected:h(e),folded:Do(e,l),toggleSelect:t=>S(e,typeof t==`boolean`?t:void 0),toggleFold:()=>o(e)}):n(e,t,{selected:m(e),expanded:Eo(e,l),toggleSelect:t=>S(e,typeof t==`boolean`?t:void 0),toggleCollapse:()=>s(e)}),[n,r,f,S,u]);pe(()=>{Object.assign(e.style,Bo.host)},[]);let ne={toggleFold:o,toggleCollapse:s,isItemSelected:m,isGroupSelected:h,isSelected:g,select:v,deselect:y,selectOnly:b,selectAll:ee,deselectAll:x,toggleSelect:S,toggleSelectTo:C};return p(ne,Object.values(ne)),{renderRow:te,flatData:d}},Ho=({renderRow:e,flatData:t})=>y({items:t,renderItem:(t,n)=>C`<cosmoz-grouped-list-row
				.item=${t}
				.index=${n}
				.renderFn=${e}
			></cosmoz-grouped-list-row>`})})))()}var Wo;function Go(){return(Go=e((()=>{T(),Uo(),Wo=e=>Ho(Vo(e)),customElements.define(`cosmoz-grouped-list`,w(Wo,{useShadowDOM:!1}))})))()}function Ko(){return(Ko=e((()=>{Go()})))()}var qo,Jo,Yo;function Xo(){return(Xo=e((()=>{Ae(),Ot(),Qr(),ei(),Si(),Di(),Ai(),T(),tt(),x(),v(),Ni(),Wi(),Ki(),Zi(),So(),Ko(),qo=e=>window.ShadyCSS?.ApplyShim?.transformCssText?.(e)||e,Jo=e=>{let{header:t,list:n,footer:r}=xo(e);return C`
		<style>
			${i([],()=>qo(Mi))}
		</style>
	...
	`},customElements.define(`cosmoz-omnitable`,w(Jo,{observedAttributes:[`hash-param`,`sort-on`,`group-on`,`descending`,`group-on-descending`,`hide-select-all`,`settings-id`,`no-local`,`no-local-sort`,`no-local-filter`,`disabled-filtering`,`loading`,`mini-breakpoint`,`inline`,`enable-select-all`]})),Yo=`
