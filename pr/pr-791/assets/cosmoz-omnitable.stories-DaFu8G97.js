import{x as c,B as ke,E as xt}from"./iframe-B80kSn9M.js";import{t as K,c as O,g as S,P as I,u as T,a as yt,m as vt,s as Rt,D as Bt,b as Ht,e as Gt,i as $e,h as Oe,d as jt,f as Wt,j as Ut,k as $,n as Kt,l as Jt,o as $t,p as Le,q as F,r as M,v as Ye,w as Xt,x as wt,y as Qt,z as Yt,A,B as Zt,C as we,E as he,F as k,G as ei,H as Ce,I as ti,J as ii,K as ai,T as ni,L as Ct,M as De,N as oi,O as St,Q as ri,R as Te,S as Ze,U as li,V as Ve,W as si,X as ui,Y as Ee,Z as Pe,_ as ci,$ as Ie,a0 as N,a1 as di,a2 as ze,a3 as mi}from"./cosmoz-collapse-D5Hn-w1n.js";import"./preload-helper-PPVm8Dsz.js";const pi=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
>
	...
	/>
</svg> `,_t=({column:i,on:e,descending:t,setOn:a,setDescending:n})=>{const{name:o,title:r}=i??{};return c`<button
		class="sg"
		title=${Ye(r)}
	...
	>
		<span>${r}</span> ${Pi}
	</button>`},kt=({columns:i,...e})=>i?.map(t=>_t({column:t,...e})),Ni=()=>c`
	<sort-and-group-consumer
		class="sgs"
		.render=${({columns:i,groupOn:e,setGroupOn:t,groupOnDescending:a,setGroupOnDescending:n}={})=>kt({columns:i?.filter?.(o=>o.groupOn),on:e,setOn:t,descending:a,setDescending:n})}
	>
	</sort-and-group-consumer>
`,Ri=()=>c`
	<sort-and-group-consumer
		class="sgs"
		.render=${({columns:i,sortOn:e,setSortOn:t,descending:a,setDescending:n}={})=>kt({columns:i?.filter?.(o=>o.sortOn&&!o.noSort),on:e,setOn:t,descending:a,setDescending:n})}
	>
	</sort-and-group-consumer>
`,Bi=["label","value","slot","always-float-label","column"],Hi=wt`
	${Xt}
...
`,Gi=(i,e)=>c`<div id="input" part="input" role="button" class="control" slot=${e}>
	...
	`};class Ui extends Ne(ae(I)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1},column:{type:Object,value:null}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return c`
		...
		>`}getComparableValue(e,t){return sa(e,t)}}customElements.define("cosmoz-omnitable-column-autocomplete",ua);const Ke=(i,e)=>e.find(({value:t})=>i===t),ca=(i,e,t)=>{const a=Ke(e,t);return a?a.text:i},ot=(i,e,t,a)=>ca(i,S(e,t),a),da=({valuePath:i},e,t)=>Ke(S(e,i),t),ma=i=>e=>{i(t=>({...t,filter:e?.[0]?.value??null}))},pa=i=>e=>{i(t=>({...t,headerFocused:e}))},ga=i=>e=>{i(t=>({...t,query:e}))},ba=i=>e=>i(e?.[0]?.value),rt=({valuePath:i,trueLabel:e,falseLabel:t},a)=>S(a,i)?e:t,fa=({valuePath:i},e)=>t=>S(t,i)===e,ue=vt((i,e)=>[{text:i,value:!0},{text:e,value:!1}]),ha=({valuePath:i,trueLabel:e,falseLabel:t},a)=>i?S(a,i)?e:t:"",xa=(i,e)=>{try{return JSON.parse(e)}catch{return null}};class ya extends V(I){static get properties(){return{trueLabel:{type:String,value:"True"},falseLabel:{type:String,value:"False"},flex:{type:String,value:"0"},cellClass:{type:String,value:"boolean-cell"}}}getString(e,t){return rt(e,t)}renderCell(e,{item:t}){return rt(e,t)}renderEditCell(e,{item:t},a){const{trueLabel:n,falseLabel:o}=e;return c`<cosmoz-autocomplete
			no-label-float
			.title=${ot(e.title,t,e.valuePath,ue(n,o))}
			.source=${ue(n,o)}
			.textProperty=${"text"}
			.value=${da(e,t,ue(n,o))}
			.onChange=${ba(a)}
		...
		>`}computeSource({trueLabel:e,falseLabel:t}){return ue(e,t)}getFilterFn(e,t){if(t!=null)return fa(e,t)}toXlsxValue(e,t){return ha(e,t)}deserializeFilter(e,t){return xa(e,t)}}customElements.define("cosmoz-omnitable-column-boolean",ya);const Je=i=>class extends Ne(i){static get properties(){return{max:{type:Date,value:null},min:{type:Date,value:null},_filterText:{type:String,computed:"_computeFilterText(filter.*, formatter)"},formatter:{type:Object,computed:"_computeFormatter(locale)"},headerFocused:{type:Boolean,value:!1},column:{type:Object,value:null}}}toDate(e,t,a){if(e==null||e==="")return;let n=e;if(n instanceof Date||(typeof e=="string"&&(n=this.getAbsoluteISOString(n)),n=new Date(n)),Number.isNaN(n.getTime()))return null;if(a==null||t==null)return n;const o=this.toDate(t);if(o==null)return n;const r=this.getComparableValue(n),l=this.getComparableValue(o);return a(r,l)===r?n:o}toValue(){return this.toDate.apply(this,arguments)}getComparableValue(e,t){const a=super.getComparableValue(e,t);if(a!=null)return this.toNumber(a.getTime())}getString(e,t=this.valuePath,a=this.formatter){const n=this.toValue(this.get(t,e));return n===void 0?"":n===null?"Invalid Date":this.renderValue(n,a)}getAbsoluteISOString(e){return e.length===19?e+this._getTimezoneString(e):e}_getTimezoneString(e){const t=-new Date(e).getTimezoneOffset()/60;return(t<0?"-":"+")+["0",Math.abs(t)].join("").substr(-2)+":00"}renderValue(e,t=this.formatter){if(t==null)return;const a=this.toValue(e);if(a!=null)return t.format(a)}_computeFormatter(e){return new Intl.DateTimeFormat(e||void 0)}_toInputString(e){const t=this.toValue(e);return t==null?null:this._toLocalISOString(t).slice(0,10)}_dateValueChanged(e){const t=e.currentTarget,a=t.value,n=e.model.item,o=this.get(this.valuePath,n),r=this._fromInputString(a);this.set(this.valuePath,r,n),this._fireItemChangeEvent(n,this.valuePath,o,this.renderValue.bind(this))}_toLocalISOString(e){return Ce(e)}};class va extends Je(ae(I)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return c`
			...
			${ne({title:this.title,tooltip:this._tooltip,filterText:this._filterText,headerFocused:this.headerFocused,horizontalAlign:"right",externalValues:this.externalValues,onOpenedChanged:e,column:this.column,content:c`
					...
					></cosmoz-input>
				`})}
		`}_fromInputString(e,t){const a=this.toDate(e);if(a!=null)return t==="min"&&a.setHours(0,0,0,0),t==="max"&&a.setHours(23,59,59),a}_filterInputChanged(e,t){const a=e.path.split(".")[1],n=a&&e.value;if(n&&n.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}}customElements.define("cosmoz-omnitable-date-range-input",va);const $a=i=>{const e=-new Date(i).getTimezoneOffset()/60;return(e<0?"-":"+")+["0",Math.abs(e)].join("").substr(-2)+":00"},Xe=i=>i.length===19?i+$a(i):i,Mt=i=>{if(i==null||i==="")return;let e=i;return!(e instanceof Date)&&(typeof i=="string"&&(e=Xe(e)),e=ti(e),!e)||Number.isNaN(e.getTime())?null:e},P=({valuePath:i},e)=>{if(e==null)return;let t=e;i!=null&&(t=S(e,i));const a=Mt(t);if(a!=null)return L(a.getTime())},E=(i,e,t)=>{const a=Mt(i);return a??null},Qe=(i,e)=>{if(e==null)return;const t=E(i);if(t!=null)return e.format(t)},ce={},wa=i=>{const e=i||"";return ce[e]||(ce[e]=new Intl.DateTimeFormat(i||void 0)),ce[e]},lt=({valuePath:i,locale:e},t)=>{let a=S(t,i||"");return a===void 0?"":(a=E(a),a===null?"Invalid Date":Qe(a,wa(e)))},Ot=i=>{const e=E(i);if(e==null)return null;const t=Ce(e);return t==null?null:t.slice(0,10)},Ca=({valuePath:i},e)=>Ot(S(e,i||"")),Lt=(i,e)=>{const t=E(i);if(t!=null)return t},st=i=>{const e=Ot(i);return e??""},Sa=({valuePath:i},e)=>{if(!i)return"";const t=E(S(e,i));if(!t)return"";const a=E(Ce(t));return a?(a.setHours(0,0,0,0),a):""},Dt=(i,e)=>t=>{const a=P(i,t);if(a==null)return!1;const n=P({...i,valuePath:"min"},e),o=P({...i,valuePath:"max"},e);return!(a<(n??-1/0)||a>(o??1/0))};class za extends V(I){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"date-header-cell"},width:{type:String,value:"100px"},minWidth:{type:String,value:"82px"},flex:{type:String,value:"0"}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const a=P({...e,valuePath:"min"},t),n=P({...e,valuePath:"max"},t);if(!(a==null&&n==null))return Dt(e,t)}getString(e,t){return lt(e,t)}toXlsxValue(e,t){return Sa(e,t)}getComparableValue(e,t){return P(e,t)}serializeFilter(e,t){if(t==null)return;const a=E(t.min),n=E(t.max);if(!(a==null&&n==null))return st(a)+"~"+st(n)}deserializeFilter(e,t){if(t==null||t==="")return null;const a=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(a)?{min:E(a[1]),max:E(a[2])}:null}renderCell(e,{item:t}){return c`<div class="omnitable-cell-date">
			${lt(e,t)}
		</div>`}renderEditCell(e,{item:t},a){return c`<cosmoz-input
			no-label-float
			type="date"
			@change=${o=>a(Lt(o.target.value))}
			.value=${Ca(e,t)}
		...
		`}renderEditCell(){return"not implemented"}renderHeader(e,{filter:t,query:a},n,o){return c`<cosmoz-autocomplete-ui
			...
			.onText=${We(n)}
			>${k(e.loading,()=>c`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}}customElements.define("cosmoz-omnitable-column-list-horizontal",qa);window.Cosmoz=window.Cosmoz||{};class ut extends ii(ai(ni,I)){static get template(){return Oe`
			<style>
				:host {
					display: block;
				}
		...
		`}static get is(){return"cosmoz-omnitable-column-list-data"}static get properties(){return{items:{type:Array},_expanded:{type:Boolean,value:!1},_othersCount:{type:Number,computed:"_computeOthersCount(items)"}}}static get observers(){return["_itemsLengthChanged(items.length)"]}_itemsLengthChanged(){requestAnimationFrame(()=>this.dispatchEvent(new CustomEvent("expand",{bubbles:!0})))}_firstItem(e){if(e!=null&&e.length>0)return e[0]}_hideExpand(e,t){return e!==void 0&&e.length!==null?e.length<=2||t:!0}_hideCollapse(e,t){return e!==void 0&&e.length!==null?e.length<=2||!t:!0}_otherItems(e,t){if(e!=null&&(e.length<=2||t))return e.slice(1)}_computeOthersCount(e){if(e!=null)return e.length-1}_toggleExpand(e){this._expanded=!this._expanded,e.stopPropagation(),e.preventDefault()}}customElements.define(ut.is,ut);class Aa extends Ue(V(I)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:a}){return c`<cosmoz-omnitable-column-list-data
			.items=${Be(a,e,t)}
		...
		></cosmoz-omnitable-number-range-input>`}computeSource(e,t){return ie(e,t)}}customElements.define("cosmoz-omnitable-column-number",_a);const Tt="1970-01-01",B=(i,e,t)=>{const a=typeof i=="string"&&i.length>3&&i.length<=9?Xe(Tt+"T"+i):i;return E(a)},de={},ka=i=>{const e=i||"";if(de[e])return de[e];const t={hour:"numeric",minute:"numeric",second:"numeric"};return de[e]=new Intl.DateTimeFormat(i||void 0,t),de[e]},fe=({valuePath:i,locale:e},t)=>{const a=B(S(t,i||""));return a===void 0?"":a===null?"Invalid Date":Qe(a,ka(e))},Ea=(i,e)=>i.valuePath?fe(i,e):"",Ia=i=>{const e=B(i);if(e==null)return null;const t=Ce(e);return t&&t.slice(11,19)},W=({valuePath:i},e)=>{if(e==null)return;const t=Ia(i==null?e:S(e,i));if(t==null)return;const a=B(Xe(Tt+"T"+t));return a==null?a:L(a.getTime())},Ma=(i,e)=>t=>{const a=W(i,t);if(a==null)return!1;const n=W({...i,valuePath:"min"},e),o=W({...i,valuePath:"max"},e);return n==null||o==null?!1:!(a<n||a>o)},ct=i=>{const e=B(i);return e==null?"":e.toISOString().slice(11,19).replace(/:/gu,".")},dt=i=>{if(!(i==null||i===""))return B(typeof i=="string"?i.replace(/\./gu,":")+"Z":i)};class Oa extends Je(ae(I)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return c`
			<cosmoz-clear-button
				@click=${()=>this.resetFilter()}
				?visible=${this.hasFilter()}
			></cosmoz-clear-button>
		...
		></cosmoz-input>`}renderHeader({title:e,min:t,max:a,locale:n,filterStep:o,noSort:r,name:l},{filter:s},u,m){return c`<cosmoz-omnitable-time-range-input
			...
			@filter-changed=${({detail:{value:d}})=>u(g=>({...g,filter:d}))}
			@header-focused-changed=${({detail:{value:d}})=>u(g=>({...g,headerFocused:d}))}
		></cosmoz-omnitable-time-range-input>`}computeSource(e,t){return ie(e,t)}}customElements.define("cosmoz-omnitable-column-time",La);const me={},Da=i=>{const e=i||"";if(me[e])return me[e];const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return me[e]=new Intl.DateTimeFormat(i||void 0,t),me[e]},Ae=({valuePath:i,locale:e},t)=>{const a=E(S(t,i||""));return a===void 0?"":a===null?"Invalid Date":Qe(a,Da(e))},Ta=({valuePath:i},e)=>i?S(e,i):"",mt=i=>{const e=E(i);return e==null?"":e.toISOString().slice(0,19).replace(/:/gu,".")},pt=i=>{if(!(i==null||i==="")&&typeof i=="string")return E(i.replace(/\./gu,":")+"Z")};class Va extends Je(ae(I)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return c`
			<style>
			...
			${ne({title:this.title,tooltip:this._tooltip,filterText:this._filterText,headerFocused:this.headerFocused,horizontalAlign:"right",externalValues:this.externalValues,onOpenedChanged:e,column:this.column,content:c`
					...
					></cosmoz-datetime-input>
				`})}
		`}_toInputString(e){const t=this.toValue(e);if(t!=null)return this._toLocalISOString(t).slice(0,19)}_computeFormatter(e){const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return new Intl.DateTimeFormat(e||void 0,t)}}customElements.define("cosmoz-omnitable-datetime-range-input",Va);class gt extends V(I){static get is(){return"cosmoz-omnitable-column-datetime"}static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"datetime-header-cell"},width:{type:String,value:"210px"},minWidth:{type:String,value:"128px"},flex:{type:String,value:"0"},filterStep:{type:Number,value:1}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const a=P({...e,valuePath:"min"},t),n=P({...e,valuePath:"max"},t);if(!(a==null&&n==null))return Dt(e,t)}getString(e,t){return Ae(e,t)}toXlsxValue(e,t){return Ta(e,t)}getComparableValue(e,t){return P(e,t)}serializeFilter(e,t){if(t==null)return;const a=E(t.min),n=E(t.max);if(!(a==null&&n==null))return mt(a)+"~"+mt(n)}deserializeFilter(e,t){if(t==null||t==="")return null;const a=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(a)?{min:pt(a[1]),max:pt(a[2])}:null}renderCell(e,{item:t}){return Ae(e,t)}renderEditCell(e,{item:t},a){return c`<cosmoz-input
			no-label-float
			type="text"
			@change=${o=>a(Lt(o.target.value))}
			.value=${Ae(e,t)}
...
`;customElements.define("cosmoz-omnitable-item-expand-line",O(Ga,{styleSheets:[De(Ha)]}));const ja=({columns:i,item:e,selected:t,expanded:a,groupOnColumn:n})=>oi(i,o=>c`<cosmoz-omnitable-item-expand-line
			...
			>`);customElements.define("cosmoz-omnitable-item-expand",O(ja,{useShadowDOM:!1}));const Wa=(i,e,t)=>i.editable?i.renderEditCell(i,e,t(i,e.item)):i.renderCell(i,e),Ua=({columns:i,groupOnColumn:e,item:t,index:a,selected:n,expanded:o,onItemChange:r})=>Ct(i,l=>l.name,l=>c`<div
			...
			</div>`);customElements.define("cosmoz-omnitable-item-row",O(Ua,{useShadowDOM:!1}));const Vt=K`
	.checkbox {
		box-sizing: border-box;
		width: 18px;
		height: 18px;
...
`,bt=i=>{const e=i.replace(/"/gu,'""');return e.search(/("|,|\n)/gu)>=0?'"'+e+'"':i},Ja=(i,e,t)=>{const o=i.map(l=>bt(l.title)).join(";")+`
`,r=e.map(l=>i.map(s=>{const u=s.getString(s,l);return u==null?"":bt(String(u))}).join(";")+`
`);r.unshift(o),St(new File(r,t,{type:"text/csv;charset=utf-8"}))},Xa=(i,e)=>{const t=i.map(n=>n.title),a=e.map(n=>i.map(o=>{const r=o.toXlsxValue(o,n);return r??""}));return a.unshift(t),a},Qa=(i,e,t,a)=>{const n=Xa(i,e),o=new ri(t).addSheetFromData(n,a).generate();St(new File([o],t,{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}))},Ya=({columns:i,selectedItems:e,csvFilename:t,xlsxFilename:a,xlsxSheetname:n,topPlacement:o})=>c`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!Te(e.length)}
		part="bottomBar"
