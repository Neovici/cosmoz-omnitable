import{x as d,B as ze,E as gt}from"./iframe-BwBUM8zk.js";import{t as K,c as O,g as S,P as M,u as T,a as bt,m as ft,s as Tt,D as Vt,b as Pt,e as Nt,i as fe,h as Ie,d as Rt,f as Bt,j as Ht,k as $,n as Gt,l as jt,o as ht,p as he,q as F,r as E,v as Ke,w as Wt,x as Me,y as Ut,z as Kt,A as z,B as Jt,C as xe,E as me,F as k,G as Xt,H as ve,I as Qt,J as Yt,K as Zt,T as ei,L as xt,M as Ee,N as ti,O as vt,Q as ii,R as Oe,S as Je,U as ai,V as Le,W as ni,X as oi,Y as Fe,Z as De,_ as ri,$ as _e,a0 as N,a1 as li,a2 as we,a3 as si}from"./cosmoz-collapse-iJ9Ra0yp.js";const ui=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
>
	<path
		...
		stroke-linejoin="round"
	/>
</svg>`,St=({column:i,on:e,descending:t,setOn:a,setDescending:n})=>{const{name:o,title:r}=i??{};return d`<button
		class="sg"
		title=${Ke(r)}
		data-on=${Ke(o===e&&(t?"desc":"asc")||void 0)}
		@click=${l=>{l.stopPropagation();const u=l.currentTarget?.dataset.on;u||(a(o),n(!1)),u==="asc"?n(!0):u==="desc"&&(a(),n(!1))}}
	>
		<span>${r}</span> ${Li}
	</button>`},qt=({columns:i,...e})=>i?.map(t=>St({column:t,...e})),Di=()=>d`
	<sort-and-group-consumer
		class="sgs"
		.render=${({columns:i,groupOn:e,setGroupOn:t,groupOnDescending:a,setGroupOnDescending:n}={})=>qt({columns:i?.filter?.(o=>o.groupOn),on:e,setOn:t,descending:a,setDescending:n})}
	>
	</sort-and-group-consumer>
`,Ti=()=>d`
	<sort-and-group-consumer
		class="sgs"
		.render=${({columns:i,sortOn:e,setSortOn:t,descending:a,setDescending:n}={})=>qt({columns:i?.filter?.(o=>o.sortPath&&!o.noSort),on:e,setOn:t,descending:a,setDescending:n})}
	>
	</sort-and-group-consumer>
`,Vi=["label","value","slot","always-float-label","column"],Pi=Me`
	${Wt}
...
`,Ri=(i,e)=>d`<div id="input" part="input" role="button" class="control" slot=${e}>
		${i||""}
	</div>`,At=(i,e,t)=>{if(!e||e.noSort||!t)return i;const{sortOn:a,setSortOn:n,descending:o,setDescending:r}=t,l=St({column:e,on:a,setOn:n,descending:o,setDescending:r});return d`<style>
			${Ni}
		</style>
		${l} ${i}`},Bi=({label:i,value:e,slot:t,column:a})=>{const n=he(ye);return Ut(Ri(e,t),{label:At(i,a,n)})};customElements.define("cosmoz-omnitable-dropdown-input",O(Bi,{observedAttributes:Vi,styleSheets:[Pi]}));const Z=({title:i,tooltip:e="",filterText:t="",onOpenedChanged:a,content:n,horizontalAlign:o="left",externalValues:r=null,column:l=null})=>{const s={filtered:!!t,...r!=null&&{[`external-values-${r}`]:!0}};return d`
		<style>
			.dropdown {
				outline: none;
			}
	...
	`};class Hi extends Te(Y(M)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1},column:{type:Object,value:null}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return d`
			<style>
			...
			${Z({title:this.title,tooltip:this._tooltip,filterText:this._filterText,headerFocused:this.headerFocused,externalValues:this.externalValues,onOpenedChanged:e,column:this.column,content:d`
		...
		></cosmoz-omnitable-amount-range-input>`}computeSource(e,t){return Q(e,t)}}customElements.define("cosmoz-omnitable-column-amount",Yi);const Zi=(i,e)=>{if(!Array.isArray(i))return;const t=[];return i.reduce((a,n)=>Array.isArray(n)?(n.forEach(o=>{a.push(o)}),a):(a.push(n),a),[]).filter((a,n,o)=>{if(o.indexOf(a)!==n)return!1;if(e){const r=S(a,e);if(t.indexOf(r)!==-1)return!1;t.push(r)}return!0})},ea=(i,e,t)=>{if(i==null)return[];if(Array.isArray(i))return Zi(i,e);if(typeof i=="object"){const a=e??"id",n=t??"label";return Object.entries(i).map(([o,r])=>({[a]:o,[n]:r})).sort((o,r)=>o[n]<r[n]?-1:o[n]>r[n]?1:0)}return[]},Ve=(i,e,t)=>xe(e&&S(i,e)).map(me(t)),Pe=({valuePath:i,textProperty:e},t)=>Ve(t,i,e).filter(a=>a!=null).join(", "),ta=Pe,ia=({valueProperty:i,valuePath:e,emptyValue:t,emptyProperty:a},n)=>o=>{const r=me(i),l=xe(S(o,e));return n.some(s=>l.length===0&&me(a||i)(s)===t||l.some(u=>r(u)===r(s)))},Ne=i=>e=>i(t=>({...t,filter:e})),Re=i=>e=>i(t=>({...t,headerFocused:e})),Be=i=>e=>i(t=>({...t,query:e})),Ft=({emptyValue:i,emptyLabel:e,emptyProperty:t,textProperty:a,valueProperty:n},o)=>{const r=ea(o,n,a);return!e||i===void 0||!a||!(t||n)||!r?r:[{[a]:e,[t||n]:i},...r]},aa=(i,e)=>Ft(i,yt(e,i.valuePath)),He=i=>class extends i{static get properties(){return{textProperty:{type:String},valueProperty:{type:String},emptyLabel:{type:String},emptyValue:{type:Object},emptyProperty:{type:String}}}getConfig(e){return{emptyProperty:e.emptyProperty}}getString(e,t){return Pe(e,t)}toXlsxValue(e,t){return ta(e,t)}getComparableValue({valuePath:e,valueProperty:t},a){const n=S(a,e);return t==null?n:xe(n).reduce((r,l)=>(r.push(S(l,t)),r),[]).sort().join(" ")}getFilterFn(e,t){if(!(!t||!Array.isArray(t)||t.length===0))return ia(e,t)}serializeFilter(e,t){return t.length===0?null:JSON.stringify(t)}deserializeFilter(e,t){return JSON.parse(decodeURIComponent(t))}computeSource(e,t){return e.externalValues||typeof e.values=="function"?async(...a)=>Ft(e,await Promise.resolve(fe(e.values,...a))):aa(e,t)}},na=({valuePath:i,textProperty:e,valueProperty:t},a)=>{const n=e?Xt(e):me(t),o=xe(i&&S(a,i)).map(n);return o.length>1?o.filter(Boolean).join(","):o[0]};class oa extends He(V(M)){static get properties(){return{headerCellClass:{type:String,value:"autocomplete-header-cell"},minWidth:{type:String,value:"55px"},editMinWidth:{type:String,value:"55px"},keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},showSingle:{type:Boolean},preserveOrder:{type:Boolean},limit:{type:Number},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,showSingle:e.showSingle,preserveOrder:e.preserveOrder,limit:e.limit,textual:e.textual}}renderCell(e,{item:t}){return d`<span class="default-column"
		...
		>`}getComparableValue(e,t){return na(e,t)}}customElements.define("cosmoz-omnitable-column-autocomplete",oa);const Ge=(i,e)=>e.find(({value:t})=>i===t),ra=(i,e,t)=>{const a=Ge(e,t);return a?a.text:i},tt=(i,e,t,a)=>ra(i,S(e,t),a),la=({valuePath:i},e,t)=>Ge(S(e,i),t),sa=i=>e=>{i(t=>({...t,filter:e?.[0]?.value??null}))},ua=i=>e=>{i(t=>({...t,headerFocused:e}))},da=i=>e=>{i(t=>({...t,query:e}))},ca=i=>e=>i(e?.[0]?.value),it=({valuePath:i,trueLabel:e,falseLabel:t},a)=>S(a,i)?e:t,ma=({valuePath:i},e)=>t=>S(t,i)===e,ne=ft((i,e)=>[{text:i,value:!0},{text:e,value:!1}]),pa=({valuePath:i,trueLabel:e,falseLabel:t},a)=>i?S(a,i)?e:t:"",ga=(i,e)=>{try{return JSON.parse(e)}catch{return null}};class ba extends V(M){static get properties(){return{trueLabel:{type:String,value:"True"},falseLabel:{type:String,value:"False"},flex:{type:String,value:"0"},cellClass:{type:String,value:"boolean-cell"}}}getString(e,t){return it(e,t)}renderCell(e,{item:t}){return it(e,t)}renderEditCell(e,{item:t},a){const{trueLabel:n,falseLabel:o}=e;return d`<cosmoz-autocomplete
			no-label-float
			.title=${tt(e.title,t,e.valuePath,ne(n,o))}
			.source=${ne(n,o)}
			.textProperty=${"text"}
			.value=${la(e,t,ne(n,o))}
			.onChange=${ca(a)}
		...
		>`}renderHeader(e,{filter:t,query:a},n,o,r){return d` <cosmoz-autocomplete-ui
			.label=${At(e.title,e,r)}
			.title=${tt(e.title,t,e.valuePath,o)}
			.source=${o}
			.textProperty=${"text"}
			.value=${Ge(t,o)}
			.text=${a}
		...
		>`}computeSource({trueLabel:e,falseLabel:t}){return ne(e,t)}getFilterFn(e,t){if(t!=null)return ma(e,t)}toXlsxValue(e,t){return pa(e,t)}deserializeFilter(e,t){return ga(e,t)}}customElements.define("cosmoz-omnitable-column-boolean",ba);const je=i=>class extends Te(i){static get properties(){return{max:{type:Date,value:null},min:{type:Date,value:null},_filterText:{type:String,computed:"_computeFilterText(filter.*, formatter)"},formatter:{type:Object,computed:"_computeFormatter(locale)"},headerFocused:{type:Boolean,value:!1},column:{type:Object,value:null}}}toDate(e,t,a){if(e==null||e==="")return;let n=e;if(n instanceof Date||(typeof e=="string"&&(n=this.getAbsoluteISOString(n)),n=new Date(n)),Number.isNaN(n.getTime()))return null;if(a==null||t==null)return n;const o=this.toDate(t);if(o==null)return n;const r=this.getComparableValue(n),l=this.getComparableValue(o);return a(r,l)===r?n:o}toValue(){return this.toDate.apply(this,arguments)}getComparableValue(e,t){const a=super.getComparableValue(e,t);if(a!=null)return this.toNumber(a.getTime())}getString(e,t=this.valuePath,a=this.formatter){const n=this.toValue(this.get(t,e));return n===void 0?"":n===null?"Invalid Date":this.renderValue(n,a)}getAbsoluteISOString(e){return e.length===19?e+this._getTimezoneString(e):e}_getTimezoneString(e){const t=-new Date(e).getTimezoneOffset()/60;return(t<0?"-":"+")+["0",Math.abs(t)].join("").substr(-2)+":00"}renderValue(e,t=this.formatter){if(t==null)return;const a=this.toValue(e);if(a!=null)return t.format(a)}_computeFormatter(e){return new Intl.DateTimeFormat(e||void 0)}_toInputString(e){const t=this.toValue(e);return t==null?null:this._toLocalISOString(t).slice(0,10)}_dateValueChanged(e){const t=e.currentTarget,a=t.value,n=e.model.item,o=this.get(this.valuePath,n),r=this._fromInputString(a);this.set(this.valuePath,r,n),this._fireItemChangeEvent(n,this.valuePath,o,this.renderValue.bind(this))}_toLocalISOString(e){return ve(e)}};class fa extends je(Y(M)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return d`
			...
			${Z({title:this.title,tooltip:this._tooltip,filterText:this._filterText,headerFocused:this.headerFocused,externalValues:this.externalValues,onOpenedChanged:e,column:this.column,content:d`
					...
					></cosmoz-input>
				`})}
		`}_fromInputString(e,t){const a=this.toDate(e);if(a!=null)return t==="min"&&a.setHours(0,0,0,0),t==="max"&&a.setHours(23,59,59),a}_filterInputChanged(e,t){const a=e.path.split(".")[1],n=a&&e.value;if(n&&n.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}}customElements.define("cosmoz-omnitable-date-range-input",fa);const ha=i=>{const e=-new Date(i).getTimezoneOffset()/60;return(e<0?"-":"+")+["0",Math.abs(e)].join("").substr(-2)+":00"},We=i=>i.length===19?i+ha(i):i,_t=i=>{if(i==null||i==="")return;let e=i;return!(e instanceof Date)&&(typeof i=="string"&&(e=We(e)),e=Qt(e),!e)||Number.isNaN(e.getTime())?null:e},P=({valuePath:i},e)=>{if(e==null)return;let t=e;i!=null&&(t=S(e,i));const a=_t(t);if(a!=null)return L(a.getTime())},I=(i,e,t)=>{const a=_t(i);return a??null},Ue=(i,e)=>{if(e==null)return;const t=I(i);if(t!=null)return e.format(t)},oe={},xa=i=>{const e=i||"";return oe[e]||(oe[e]=new Intl.DateTimeFormat(i||void 0)),oe[e]},at=({valuePath:i,locale:e},t)=>{let a=S(t,i||"");return a===void 0?"":(a=I(a),a===null?"Invalid Date":Ue(a,xa(e)))},kt=i=>{const e=I(i);if(e==null)return null;const t=ve(e);return t==null?null:t.slice(0,10)},va=({valuePath:i},e)=>kt(S(e,i||"")),It=(i,e)=>{const t=I(i);if(t!=null)return t},nt=i=>{const e=kt(i);return e??""},ya=({valuePath:i},e)=>{if(!i)return"";const t=I(S(e,i));if(!t)return"";const a=I(ve(t));return a?(a.setHours(0,0,0,0),a):""},Mt=(i,e)=>t=>{const a=P(i,t);if(a==null)return!1;const n=P({...i,valuePath:"min"},e),o=P({...i,valuePath:"max"},e);return!(a<(n??-1/0)||a>(o??1/0))};class $a extends V(M){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"date-header-cell"},width:{type:String,value:"100px"},minWidth:{type:String,value:"82px"},flex:{type:String,value:"0"}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const a=P({...e,valuePath:"min"},t),n=P({...e,valuePath:"max"},t);if(!(a==null&&n==null))return Mt(e,t)}getString(e,t){return at(e,t)}toXlsxValue(e,t){return ya(e,t)}getComparableValue(e,t){return P(e,t)}serializeFilter(e,t){if(t==null)return;const a=I(t.min),n=I(t.max);if(!(a==null&&n==null))return nt(a)+"~"+nt(n)}deserializeFilter(e,t){if(t==null||t==="")return null;const a=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(a)?{min:I(a[1]),max:I(a[2])}:null}renderCell(e,{item:t}){return d`<div class="omnitable-cell-date">
			${at(e,t)}
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return Q(e,t)}}customElements.define("cosmoz-omnitable-column-date",$a);class wa extends He(V(M)){renderCell({valuePath:e,textProperty:t},{item:a}){const n=Ve(a,e,t).map(o=>d`<li>${o}</li>`);return d`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		`}renderEditCell(){return"not implemented"}renderHeader(e,{filter:t,query:a},n,o){return d`<cosmoz-autocomplete-ui
			...
			.onText=${Be(n)}
			>${k(e.loading,()=>d`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}}customElements.define("cosmoz-omnitable-column-list-horizontal",wa);window.Cosmoz=window.Cosmoz||{};class ot extends Yt(Zt(ei,M)){static get template(){return Ie`
			<style>
				:host {
					display: block;
				}
		...
		`}static get is(){return"cosmoz-omnitable-column-list-data"}static get properties(){return{items:{type:Array},_expanded:{type:Boolean,value:!1},_othersCount:{type:Number,computed:"_computeOthersCount(items)"}}}static get observers(){return["_itemsLengthChanged(items.length)"]}_itemsLengthChanged(){requestAnimationFrame(()=>this.dispatchEvent(new CustomEvent("expand",{bubbles:!0})))}_firstItem(e){if(e!=null&&e.length>0)return e[0]}_hideExpand(e,t){return e!==void 0&&e.length!==null?e.length<=2||t:!0}_hideCollapse(e,t){return e!==void 0&&e.length!==null?e.length<=2||!t:!0}_otherItems(e,t){if(e!=null&&(e.length<=2||t))return e.slice(1)}_computeOthersCount(e){if(e!=null)return e.length-1}_toggleExpand(e){this._expanded=!this._expanded,e.stopPropagation(),e.preventDefault()}}customElements.define(ot.is,ot);class Ca extends He(V(M)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:a}){return d`<cosmoz-omnitable-column-list-data
			.items=${Ve(a,e,t)}
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:a},n,o){return d`<cosmoz-autocomplete-ui
			...
			.onText=${Be(n)}
			>${k(e.loading,()=>d`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}}customElements.define("cosmoz-omnitable-column-list",Ca);class Sa extends Te(Y(M)){static get properties(){return{maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null},formatter:{type:Object,computed:"_computeFormatter(locale, minimumFractionDigits, maximumFractionDigits)"},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, formatter)"},headerFocused:{type:Boolean,value:!1},column:{type:Object,value:null}}}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return d`
			<style>
				cosmoz-input[type='number'] {
					background: var(--cosmoz-omnitable-amount-input-background, #ffffff);
					border-radius: 6px;
			...
			${Z({title:this.title,tooltip:this._tooltip,filterText:this._filterText,headerFocused:this.headerFocused,horizontalAlign:"right",externalValues:this.externalValues,onOpenedChanged:e,column:this.column,content:d`
					<h3>${this.title}</h3>
					<cosmoz-input
						class=${this._fromClasses}
						type="number"
		...
		></cosmoz-omnitable-number-range-input>`}computeSource(e,t){return Q(e,t)}}customElements.define("cosmoz-omnitable-column-number",qa);const Et="1970-01-01",B=(i,e,t)=>{const a=typeof i=="string"&&i.length>3&&i.length<=9?We(Et+"T"+i):i;return I(a)},re={},Aa=i=>{const e=i||"";if(re[e])return re[e];const t={hour:"numeric",minute:"numeric",second:"numeric"};return re[e]=new Intl.DateTimeFormat(i||void 0,t),re[e]},ce=({valuePath:i,locale:e},t)=>{const a=B(S(t,i||""));return a===void 0?"":a===null?"Invalid Date":Ue(a,Aa(e))},za=(i,e)=>i.valuePath?ce(i,e):"",Fa=i=>{const e=B(i);if(e==null)return null;const t=ve(e);return t&&t.slice(11,19)},W=({valuePath:i},e)=>{if(e==null)return;const t=Fa(i==null?e:S(e,i));if(t==null)return;const a=B(We(Et+"T"+t));return a==null?a:L(a.getTime())},_a=(i,e)=>t=>{const a=W(i,t);if(a==null)return!1;const n=W({...i,valuePath:"min"},e),o=W({...i,valuePath:"max"},e);return n==null||o==null?!1:!(a<n||a>o)},rt=i=>{const e=B(i);return e==null?"":e.toISOString().slice(11,19).replace(/:/gu,".")},lt=i=>{if(!(i==null||i===""))return B(typeof i=="string"?i.replace(/\./gu,":")+"Z":i)};class ka extends je(Y(M)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return d`
			<cosmoz-clear-button
				@click=${()=>this.resetFilter()}
				?visible=${this.hasFilter()}
			></cosmoz-clear-button>
		...
		></cosmoz-input>`}renderHeader({title:e,min:t,max:a,locale:n,filterStep:o,noSort:r,name:l},{filter:s},u,m){return d`<cosmoz-omnitable-time-range-input
			...
			@filter-changed=${({detail:{value:c}})=>u(g=>({...g,filter:c}))}
			@header-focused-changed=${({detail:{value:c}})=>u(g=>({...g,headerFocused:c}))}
		></cosmoz-omnitable-time-range-input>`}computeSource(e,t){return Q(e,t)}}customElements.define("cosmoz-omnitable-column-time",Ia);const le={},Ma=i=>{const e=i||"";if(le[e])return le[e];const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return le[e]=new Intl.DateTimeFormat(i||void 0,t),le[e]},Se=({valuePath:i,locale:e},t)=>{const a=I(S(t,i||""));return a===void 0?"":a===null?"Invalid Date":Ue(a,Ma(e))},Ea=({valuePath:i},e)=>i?S(e,i):"",st=i=>{const e=I(i);return e==null?"":e.toISOString().slice(0,19).replace(/:/gu,".")},ut=i=>{if(!(i==null||i==="")&&typeof i=="string")return I(i.replace(/\./gu,":")+"Z")};class Oa extends je(Y(M)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return d`
			<style>
			...
			${Z({title:this.title,tooltip:this._tooltip,filterText:this._filterText,headerFocused:this.headerFocused,externalValues:this.externalValues,onOpenedChanged:e,column:this.column,content:d`
					...
					></cosmoz-datetime-input>
				`})}
		`}_toInputString(e){const t=this.toValue(e);if(t!=null)return this._toLocalISOString(t).slice(0,19)}_computeFormatter(e){const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return new Intl.DateTimeFormat(e||void 0,t)}}customElements.define("cosmoz-omnitable-datetime-range-input",Oa);class dt extends V(M){static get is(){return"cosmoz-omnitable-column-datetime"}static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"datetime-header-cell"},width:{type:String,value:"210px"},minWidth:{type:String,value:"128px"},flex:{type:String,value:"0"},filterStep:{type:Number,value:1}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const a=P({...e,valuePath:"min"},t),n=P({...e,valuePath:"max"},t);if(!(a==null&&n==null))return Mt(e,t)}getString(e,t){return Se(e,t)}toXlsxValue(e,t){return Ea(e,t)}getComparableValue(e,t){return P(e,t)}serializeFilter(e,t){if(t==null)return;const a=I(t.min),n=I(t.max);if(!(a==null&&n==null))return st(a)+"~"+st(n)}deserializeFilter(e,t){if(t==null||t==="")return null;const a=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(a)?{min:ut(a[1]),max:ut(a[2])}:null}renderCell(e,{item:t}){return Se(e,t)}renderEditCell(e,{item:t},a){return d`<cosmoz-input
			no-label-float
			type="text"
			@change=${o=>a(It(o.target.value))}
			.value=${Se(e,t)}
		...
		></cosmoz-omnitable-datetime-range-input>`}computeSource(e,t){return Q(e,t)}}customElements.define(dt.is,dt);const La=({column:i,item:e,selected:t,folded:a,group:n})=>i?(i.renderGroup??i.renderCell)(i,{item:e,selected:t,folded:a,group:n}):gt;customElements.define("cosmoz-omnitable-group-row",O(La,{useShadowDOM:!1}));const Da=i=>{const{column:e}=i;return E(()=>{let t=0,a=0;const n=l=>{i.dispatchEvent(new CustomEvent("column-resize",{bubbles:!0,composed:!0,detail:{newWidth:Math.ceil(a+l.pageX-t),column:e}}))},o=()=>{document.removeEventListener("pointermove",n),document.removeEventListener("pointerup",o)},r=l=>{t=l.pageX,a=i.previousElementSibling.getBoundingClientRect().width,document.addEventListener("pointermove",n),document.addEventListener("pointerup",o)};return i.addEventListener("pointerdown",r),()=>i.removeEventListener("pointerdown",r)},[e]),gt};customElements.define("cosmoz-omnitable-resize-nub",O(Da));const Ta=({data:i,columns:e,groupOnColumn:t,filters:a,setFilterState:n,sortAndGroup:o})=>xt(e,r=>r.name,r=>[d`<div
			...
			>
				...
				.column="${r}"
				name="${r.name}"
			></cosmoz-omnitable-resize-nub>`]),Va=({columns:i,settingsConfig:e,hideSelectAll:t,...a})=>{const n=he(ye);return d`
...
`;customElements.define("cosmoz-omnitable-item-expand-line",O(Na,{styleSheets:[Ee(Pa)]}));const Ra=({columns:i,item:e,selected:t,expanded:a,groupOnColumn:n})=>ti(i,o=>d`<cosmoz-omnitable-item-expand-line
				.column=${o}
				?hidden=${o===n}
				exportparts="item-expand-label, item-expand-value"
				>${o.renderCell(o,{item:e,selected:t,expanded:a})}</cosmoz-omnitable-item-expand-line
			>`);customElements.define("cosmoz-omnitable-item-expand",O(Ra,{useShadowDOM:!1}));const Ba=(i,e,t)=>i.editable?i.renderEditCell(i,e,t(i,e.item)):i.renderCell(i,e),Ha=({columns:i,groupOnColumn:e,item:t,index:a,selected:n,expanded:o,onItemChange:r})=>xt(i,l=>l.name,l=>d`<div
...
`,ct=i=>{const e=i.replace(/"/gu,'""');return e.search(/("|,|\n)/gu)>=0?'"'+e+'"':i},ja=(i,e,t)=>{const o=i.map(l=>ct(l.title)).join(";")+`
`,r=e.map(l=>i.map(s=>{const u=s.getString(s,l);return u==null?"":ct(String(u))}).join(";")+`
`);r.unshift(o),vt(new File(r,t,{type:"text/csv;charset=utf-8"}))},Wa=(i,e)=>{const t=i.map(n=>n.title),a=e.map(n=>i.map(o=>{const r=o.toXlsxValue(o,n);return r??""}));return a.unshift(t),a},Ua=(i,e,t,a)=>{const n=Wa(i,e),o=new ii(t).addSheetFromData(n,a).generate();vt(new File([o],t,{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}))},Ka=({columns:i,selectedItems:e,csvFilename:t,xlsxFilename:a,xlsxSheetname:n,topPlacement:o})=>d`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!Oe(e.length)}
		part="bottomBar"
...
`,se=i=>{const e=parseInt(i,10);return isFinite(e)?e:void 0},tn=i=>{const{config:e}=i,{settings:t,setSettings:a,collapsed:n}=e,o=Le({collapsed:n,settings:t.columns,setSettings:$(r=>a(l=>({...l,columns:r})),[a])});return{...e,onDown:$(r=>{r.target.closest(".pull")&&(o.handle=r.currentTarget)},[o]),onDragStart:$(r=>{const{target:l}=r,s=se(l.dataset.index);if(!o.handle?.contains(l)||s==null)return r.preventDefault();o.handle=null,r.dataTransfer.effectAllowed="move",r.dataTransfer.setData("omnitable/sort-index",s),r.dataTransfer.setData("text/plain",s),setTimeout(()=>l.classList.add("drag"),0),l.addEventListener("dragend",u=>u.target.classList.remove("drag"),{once:!0})},[o]),onDragEnter:$(r=>{const l=r.currentTarget;l===r.target&&(r.preventDefault(),r.dataTransfer.dropEffect="move",l.classList.add("dragover"))},[]),onDragOver:$(r=>{r.preventDefault(),r.currentTarget.classList.add("dragover")},[]),onDragLeave:$(r=>{const l=r.currentTarget;l.contains(r.relatedTarget)||l.classList.remove("dragover")},[]),onDrop:$(r=>{const l=se(r.dataTransfer.getData("omnitable/sort-index")),s=se(r.currentTarget.dataset.index),{settings:u,setSettings:m}=o;r.currentTarget.classList.remove("dragover"),r.preventDefault();const c=u.slice();c.splice(s+(l>=s?0:-1),0,c.splice(l,1)[0]),m(c)},[o]),onToggle:$(r=>{const{settings:l,setSettings:s}=o,u=l.map(c=>({...c,disabled:c.disabled||o.collapsed?.some(g=>g.name===c.name)})),m=se(r.target.closest("[data-index]")?.dataset.index);u.splice(m,1,{...l[m],disabled:!r.target.checked,priority:r.target.checked?l.reduce((c,g)=>Math.max(c,g.priority),0)+1:l[m].priority}),s(u)},[o])}},an=[ni({apply({availableHeight:i,elements:e}){Object.assign(e.floating.style,{maxHeight:`${Math.max(0,i)}px`})}}),...oi],nn=({onDragStart:i,onDragEnter:e,onDragOver:t,onDragLeave:a,onDrop:n,onDown:o,onToggle:r,collapsed:l,filters:s})=>(u,m)=>{const c=!!l?.find(p=>p.name===u.name),g=!u.disabled&&!c;return d` <div
			class="item"
			data-index=${m}
			@mousedown=${o}
			draggable="true"
		...
		>
			...
			<label class="title" ?has-filter=${!Oe(s[u.name]?.filter)}
				>${u.title}</label
			>
			<input
				class="checkbox"
		...
		<div class="contents">
			...
			<cosmoz-collapse ?opened=${r.sort}> ${Ti()} </cosmoz-collapse>
		...
		${k(t,()=>d`<div class="buttons">
				...
				</div>`)}`};customElements.define("cosmoz-omnitable-settings-ui",O(on,{styleSheets:[Ee(Za)]}));const rn=({config:i,newLayout:e})=>d`
	<cosmoz-dropdown
...
`;customElements.define("cosmoz-omnitable-settings",O(rn,{styleSheets:[Ee(en)]}));const pe=["sortOn","descending","groupOn","groupOnDescending"],ue=i=>e=>typeof e=="object"&&e!==null&&"name"in e&&e.name===i,ln=(i=[],e=[],t=[])=>{const a=e.filter(r=>i.some(ue(r.name))),n=i.filter(r=>r.name!=null&&!e.some(ue(r.name))&&!t.some(ue(r.name))),o=t.filter(r=>!e.some(ue(r.name)));return[...a,...o.flatMap(r=>{const l=i.find(s=>s.name===r.name);return l?{...r,title:l.title??r.title??"",minWidth:parseInt(l.minWidth??"0",10)}:[]}),...n.map(r=>{const{name:l,title:s,priority:u,minWidth:m,width:c,flex:g}=r;return{name:l??"",title:s??"",priority:u??0,minWidth:parseInt(m??"0",10),width:parseInt(c??"0",10),flex:parseInt(g??"0",10)}})]},sn=(i,e)=>({...e,...Fe(Array.from(pe))(i),columns:i.columns?.map(Fe(["name","priority","width","flex","disabled"]))}),un=({columns:i,settings:e,savedSettings:t,initial:a})=>({...Object.fromEntries(pe.flatMap(o=>a?.[o]!=null?[[o,a[o]]]:[])),...t?Fe(Array.from(pe))(t):{},...e,columns:ln(i,e?.columns,t?.columns)}),dn=({prefix:i="omnitable-"}={})=>({write:async(t,a)=>{const n=i+t;try{a?localStorage.setItem(n,JSON.stringify(a)):localStorage.removeItem(n)}catch(o){console.error(o)}},read:async t=>{if(t)try{const a=localStorage.getItem(i+t);return a==null?void 0:JSON.parse(a)}catch(a){console.error(a)}}}),cn=ht(dn),mn=()=>{const i=he(cn);return F(()=>i(),[i])},pn=(i,e,t,a)=>{const[n,o]=T(),{read:r,write:l}=mn();return E(async()=>{i&&o(await r(i))},[i,r]),{settingsId:i,savedSettings:n,onSave:$(async()=>{if(!i)return;const s=sn(e,n);await l(i,s),t(),o(s)},[e,n]),onReset:$(async s=>{t(),s.shiftKey&&(await l(i),o()),a?.()},[a]),hasChanges:e!=null}},gn=({settingsId:i,host:e})=>{const t=F(()=>Object.fromEntries(pe.map(h=>[h,e[h]])),[]),a=De(),n=$(()=>{a.current?.(t)},[t]),[o,r]=T(),[l,s]=T({columns:!0,sort:!0}),{savedSettings:u,...m}=pn(i,o,r,n),{enabledColumns:c}=e,g=zi(e,{enabledColumns:c}),p=F(()=>un({columns:g,settings:o,savedSettings:u,initial:t}),[g,o,u]),C=F(()=>p.columns.map(h=>g.find(v=>v.name===h.name)).filter(Boolean),[g,...p.columns.map(h=>h.name)]);return{...m,opened:l,setOpened:s,settings:p,columns:C,setSettings:r,resetRef:a}},mt=i=>Number.isFinite(i)?i:0,bn=(i,e)=>{const t=[];let[a,n]=i.reduce(([m,c],{width:g,flex:p})=>[m+g,c+p],[0,0]),o=e-a,r=mt(o/n),l=0,s=0,u=0;for(let m=0;m<i.length;m++){const{width:c,minWidth:g,flex:p}=i[m],C=o>=0?r*p:c*o/a;if(g>c+C){l+=c,s+=g,u+=p,t[m]=g;continue}if(p===0){l+=c,s+=c,t[m]=c;continue}}a-=l,o=e-s-a,n-=u,r=mt(o/n);for(let m=0;m<i.length;m++){if(t[m]!=null)continue;const{width:c,flex:g}=i[m],p=o>=0?r*g:c*o/a;t[m]=c+p}return t},ge=Symbol("index"),fn=(i,e)=>{if(typeof i.findLastIndex=="function")return i.findLastIndex(e);for(let t=i.length-1;t>=0;t--)if(e(i[t],t,i))return t;return-1},hn=(i,e)=>{const t=fn(i,r=>r!=null&&r>0),a=(r,l)=>`.cell[name="${r}"], cosmoz-omnitable-skeleton::part(cell-${r}){width: ${Math.floor(l)}px;padding: 0 min(3px, ${l/2}px)}`,n=r=>`cosmoz-omnitable-resize-nub[name="${r}"]{display:none}`,o=r=>`cosmoz-omnitable-resize-nub[name="${r}"], .cell[name="${r}"]{display:none}`;return e.map((r,l)=>{const s=i[l];if(s==null||s===0)return o(r.name);const u=a(r.name,s);return l===t?`${u}
${n(r.name)}`:u}).join(`
`)},Lt=(i,e,t)=>{const a=i.filter(l=>!l.hidden),n=a.reduce((l,{width:s})=>l+s,0);if(a.length>1&&n>e)return Lt(a.slice(1),e,t);const o=a.reduce(([l,s],u,m)=>[Math.max(l,u.index),u.index>l?m:s],[-1,-1])[1];return o!==-1&&(a[o].flex=1),bn(a,e).reduce((l,s,u)=>(l[a[u].index]=s,l),new Array(t).fill(void 0))},xn=(i,e)=>i.length===0?".cell {display: none;}":hn(i,e),vn=({host:i,canvasWidth:e,layout:t,setSettings:a})=>{const n=De();n.current=o=>a(r=>{const l=r.columns,{detail:{newWidth:s,column:u}}=o,m=l.findIndex(p=>p.name===u.name),c=[],g=l.reduce((p,C)=>Math.max(p,C.priority),-1/0);for(let p=0;p<t.length;p++)if(c[p]={...l[p]},p<m&&t[p]!=null&&(c[p].width=t[p],c[p].flex=0,c[p].priority=g),p===m){const C=t.reduce((h,v,_)=>_<m&&v?h-v:h,e);c[p].width=Math.min(C,Math.max(s,l[p].minWidth)),c[p].flex=0,c[p].priority=g}return{...r,columns:c}}),E(()=>{const o=r=>n.current?.(r);return i.addEventListener("column-resize",o),()=>i.removeEventListener("column-resize",o)},[])},yn=(i,e)=>E(()=>{const t=([n])=>{n.contentRect?.width!==0&&requestAnimationFrame(()=>e(n.contentRect?.width-20-44-24))},a=new ResizeObserver(t);return a.observe(i),()=>a.unobserve(i)},[]),$n=i=>{const[e,t]=T(()=>i.getBoundingClientRect().width);return yn(i,t),e},wn=(i,e)=>{const t=F(()=>{let a=!1,n;const o=()=>{if(!a)return;n=requestAnimationFrame(o),i()&&(a=!1)};return{start:()=>{a=!0,cancelAnimationFrame(n),n=requestAnimationFrame(o)},stop:()=>{a=!1,cancelAnimationFrame(n)}}},[]);E(()=>{t.start()},e),E(()=>()=>t.stop(),[])},Cn=(i=0,e=0)=>Math.abs((i??0)-(e??0))<.1,Sn=(i,e=1.9,t=ri)=>{const a=Le({target:i}),n=$(()=>{if(a.tween||(a.tween=a.target),a.target.every((o,r)=>a.tween[r]===o))return t(a.tween),!0;a.tween=a.target.map((o,r)=>Cn(a.tween[r],o)?o:(a.tween[r]??0)+((o??0)-(a.tween[r]??0))/e||0),t(a.tween)},[]);wn(n,[i])},qn=({canvasWidth:i,groupOnColumn:e,config:t,miniColumn:a})=>F(()=>{if(!Array.isArray(t)||i==null||i===0)return[];const n=t.map((o,r)=>({minWidth:o.minWidth,width:o.width,flex:o.flex,priority:o.priority,name:o.name,index:r,hidden:o.name===e?.name||o.disabled})).map(o=>a?{...o,hidden:a.name!==o.name}:o).sort(({index:o,priority:r},{index:l,priority:s})=>r===s?l-o:r-s);return Lt(n,i,n.length)},[i,e,t]),An=({host:i,canvasWidth:e,columns:t})=>{const a=i.miniBreakpoint??480,n=F(()=>e<=a,[e,a]),o=F(()=>n?t?.filter(u=>u.mini!=null).sort((u,m)=>(u.mini??0)-(m.mini??0)):[],[t,n]),[r,...l]=o??[],s=!!r;return E(()=>{i.toggleAttribute("mini",s)},[s]),{isMini:s&&n,miniColumn:r,miniColumns:l}},zn=i=>{const e=F(()=>new CSSStyleSheet,[]);return E(()=>{i.shadowRoot.adoptedStyleSheets=[...i.shadowRoot.adoptedStyleSheets,e]},[]),e},Fn=({host:i,columns:e,settings:t,setSettings:a,resizeSpeedFactor:n,sortAndGroupOptions:o})=>{const r=$n(i),{isMini:l,miniColumn:s,miniColumns:u}=An({host:i,canvasWidth:r,columns:e}),{groupOnColumn:m}=o,c=qn({canvasWidth:r,groupOnColumn:m,miniColumn:s,config:t.columns}),g=zn(i),p=F(()=>t.columns.reduce((h,v,_)=>c[_]!=null||v.name===m?.name||v.disabled?h:[...h,e.find(b=>b.name===v.name)].filter(b=>b!=null),[]),[e,t,c,m]),C=Le({columns:t.columns});return Sn(c,n,h=>{const v=xn(h,C.columns);g.replace(v)}),vn({host:i,canvasWidth:r,layout:c,setSettings:h=>a(h(t))}),{isMini:l,collapsedColumns:p,miniColumns:u}},_n=({host:i,...e})=>{const{csvFilename:t="omnitable.csv",xlsxFilename:a="omnitable.xlsx",xlsxSheetname:n="Omnitable",topPlacement:o="top-end"}=i;return{csvFilename:t,xlsxFilename:a,xlsxSheetname:n,topPlacement:o,...e}},kn=({host:i,selectedItems:e,data:t,sortAndGroupOptions:a,collapsedColumns:n,settings:o,filterFunctions:r,settingS:l,filters:s,...u})=>{const m=t&&t.length>0&&e.length===t.length,c=h=>{h.target.checked?i.shadowRoot.querySelector("#groupedList").selectAll():i.shadowRoot.querySelector("#groupedList").deselectAll()},{groupOnColumn:g}=a,p=F(()=>[g,...n,...o.columns.filter(h=>h.disabled)].some(h=>h&&Object.keys(r).includes(h.name)),[r,o,n]),C=F(()=>({...l,collapsed:n,badge:p,filters:s}),[l,n,p,s]);return E(()=>{const h=i.shadowRoot.querySelector("#tableContent"),v=new ResizeObserver(_=>requestAnimationFrame(()=>{i.style.setProperty("--ot-height",_[0]?.contentRect.height+"px")}));return v.observe(h),()=>v.unobserve(h)},[]),{allSelected:m,onAllCheckboxChange:c,data:t,settingsConfig:C,filters:s,groupOnColumn:g,sortAndGroup:a.sortAndGroup,...u}},Dt=d`
	<svg
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
...
`,In=i=>i?"groupRow groupRow-folded":"groupRow",Mn=({item:i,index:e})=>t=>k((t?.length??0)>0,()=>d`
		...
		<div
			?selected=${c}
			part="${["itemRow",`itemRow-${u[ge]}`,s?.(u,m)].filter(Boolean).join(" ")}"
			.dataIndex=${u[ge]}
			.dataItem=${u}
			class="itemRow"
			@click=${a}
	...
	`,On=({onCheckboxChange:i,dataIsValid:e,groupOnColumn:t})=>(a,n,{selected:o,folded:r,toggleFold:l})=>d` <div
		...
		</div>`,Ln=({host:i,error:e,dataIsValid:t,processedItems:a,columns:n,collapsedColumns:o,miniColumns:r,sortAndGroupOptions:l,rowPartFn:s,...u})=>{const{loading:m=!1,displayEmptyGroups:c=!1,compareItemsFn:g}=i,p=De({shiftKey:!1,ctrlKey:!1}),C=$(b=>{const A=b.target,f=A.dataItem,y=A.checked,x=i.shadowRoot.querySelector("#groupedList");p.current.shiftKey?x.toggleSelectTo(f,y):p.current.ctrlKey?(A.checked=!0,x.selectOnly(f)):x.toggleSelect(f,y),b.preventDefault(),b.stopPropagation()},[]);E(()=>{const b=({shiftKey:A,ctrlKey:f})=>{p.current={shiftKey:A,ctrlKey:f}};return window.addEventListener("keydown",b),window.addEventListener("keyup",b),()=>{window.removeEventListener("keydown",b),window.removeEventListener("keyup",b)}},[]);const h=$(b=>{const A=b.currentTarget,f=b.composedPath();f.slice(0,f.indexOf(A)).find(x=>x.matches?.("a, .checkbox, .expand"))||i.dispatchEvent(new window.CustomEvent("omnitable-item-click",{bubbles:!0,composed:!0,detail:{item:A.dataItem,index:A.dataIndex}}))},[]),{groupOnColumn:v}=l,_=$((b,A)=>f=>Fi(i,b,A,f),[]);return{...u,processedItems:a,dataIsValid:t,filterIsTooStrict:t&&a.length<1,loading:m,compareItemsFn:g,displayEmptyGroups:c,error:e,renderItem:F(()=>En({columns:n,collapsedColumns:o,miniColumns:r,onItemClick:h,onCheckboxChange:C,dataIsValid:t,groupOnColumn:v,onItemChange:_,rowPartFn:s}),[n,o,h,C,t,v,_,s]),renderGroup:F(()=>On({onCheckboxChange:C,dataIsValid:t,groupOnColumn:v}),[C,t,v])}},Dn=(i,e)=>{if(i===e)return 0;if(i==null)return-1;if(e==null)return 1;const t=typeof i,a=typeof e;return t==="object"&&a==="object"?i.toString()<e.toString()?-1:1:t==="number"&&a==="number"?i-e:t==="string"&&a==="string"?i<e?-1:1:t==="boolean"&&a==="boolean"?i?-1:1:(console.warn("unsupported sort",t,i,a,e),0)},qe=(i,e)=>(t,a)=>Dn(i(t),i(a))*(e?-1:1),Tn=i=>i.replace(/([a-z0-9])([A-Z])/gu,"$1-$2").toLowerCase(),pt=(i,e)=>{!i||!e||Object.entries(e).forEach(([t,a])=>{i[R].__ownChange=!0,i[R][t]=a,i[R].__ownChange=!1,i[R].dispatchEvent(new CustomEvent(`${Tn(t)}-changed`,{bubbles:!0,detail:{value:a}}))})},Ae=(i,e)=>Object.assign(i,{[ge]:e}),de=Symbol("unparsed"),Vn=({data:i,columns:e,hashParam:t,sortAndGroupOptions:a,noLocalSort:n,noLocalFilter:o})=>{const{groupOnColumn:r,groupOnDescending:l,sortOnColumn:s,descending:u}=a,m=$(([f,y])=>{const x=e.find(({name:w})=>w===f);return x==null?[f,void 0]:[f,y.filter&&x.serializeFilter(x,y.filter)]},[e]),c=$(([f,y])=>{const x=e.find(({name:q})=>q===f);if(x==null)return[f,{[de]:y}];const w={filter:x.deserializeFilter(x,y)};return pt(x,w),[f,w]},[e]),[g,p]=J({},t,{multi:!0,suffix:"-filter--",write:m,read:c}),C=$((f,y)=>p(x=>{const w=fe(y,x[f]);return pt(e.find(q=>q.name===f),w),{...x,[f]:{...x[f],...w}}}),[e,p]),h=F(()=>Object.values(g).map(f=>f.filter),[g]),v=F(()=>Object.fromEntries(e.map(f=>[f.name,!f.noLocalFilter&&f.getFilterFn(f,g[f.name]?.filter)]).filter(([,f])=>!!f)),[e,...h]),_=F(()=>!Array.isArray(i)||i.length===0?[]:Object.entries(v).length===0||o?i.slice():i.filter(f=>Object.values(v).every(y=>y(f))),[i,v,o]),b=F(()=>{if(!n&&!r&&s!=null&&s.sortPath!=null)return _.slice().sort(qe(f=>s.getComparableValue({...s,valuePath:s.sortPath},f),u));if(r!=null&&r.groupOn!=null){const f=_.reduce((y,x)=>{const w=r.getComparableValue({...r,valuePath:r.groupOn},x);if(w===void 0)return y;let q=y.find(D=>D.id===w);return q?(q.items.push(x),y):(q={id:w,name:w,items:[x]},[...y,q])},[]);return f.sort(qe(y=>r.getComparableValue({...r,valuePath:r.groupOn},y.items[0]),l)),!s||n?f:f.filter(y=>Array.isArray(y.items)).map(y=>(y.items.sort(qe(x=>s.getComparableValue({...s,valuePath:s.sortPath},x),u)),y))}return _},[_,r,l,s,u,n]),A=F(()=>{let f=0,y=0;const x=[];return b.forEach(w=>{if(Array.isArray(w.items)){Ae(w,y++),w.items.forEach(q=>{Ae(q,f++),x.push(q)});return}return Ae(w,f++),x.push(w)},[]),x},[b]);return E(()=>{p(f=>Object.values(f).some(x=>x[de]!=null)?Object.fromEntries(Object.entries(f).map(([x,w])=>w[de]==null?[x,w]:c([x,w[de]]))):f)},[c]),{processedItems:b,visibleData:A,filters:g,filterFunctions:v,setFilterState:C}},Pn=i=>{const e=a=>{const n=i.data.indexOf(a);if(n<0)return null;const o=i.data.splice(n,1);if(i.data=i.data.slice(),Array.isArray(o)&&o.length>0)return o[0]},t=(a,n)=>{i.data.splice(a,1,n),i.data=i.data.slice()};return{removeItem:e,removeItems(a){const n=[];for(let o=a.length-1;o>=0;o-=1){const r=i.removeItem(a[o]);r!=null&&n.push(r)}return n},replaceItemAtIndex:t,replaceItem(a,n){const o=i.data.indexOf(a);if(o>-1)return t(o,n)},selectItem(a){i.shadowRoot.querySelector("#groupedList").select(a)},selectAll(){i.shadowRoot.querySelector("#groupedList").selectAll()},deselectAll(){i.shadowRoot.querySelector("#groupedList").deselectAll()},deselectItem(a){i.shadowRoot.querySelector("#groupedList").deselect(a)},isItemSelected(a){return i.shadowRoot.querySelector("#groupedList").isItemSelected(a)}}},Nn=({host:i,visibleData:e,filters:t,...a})=>{const{setFilterState:n}=a,o=F(()=>Pn(i),[]);_e(a,Object.values(a)),_e(o,Object.values(o)),E(()=>{const l=s=>n(s.detail.name,u=>({...u,...s.detail.state}));return i.addEventListener("legacy-filter-changed",l),()=>i.removeEventListener("legacy-filter-changed",l)},[]),N("visibleData",e),N("sortedFilteredGroupedItems",a.sortedFilteredGroupedItems),N("selectedItems",a.selectedItems),N("sortOn",a.sortOn),N("descending",a.descending),N("isMini",a.isMini);const r=F(()=>Object.fromEntries(Object.entries(t).filter(([,{filter:l}])=>l!==void 0).map(([l,{filter:s}])=>[l,s])),[t]);N("filters",r,Object.values(r))},Rn=i=>{const{hashParam:e,settingsId:t,data:a,resizeSpeedFactor:n,noLocal:o,noLocalSort:r=o,noLocalFilter:l=o,error:s,rowPartFn:u}=i,m=gn({settingsId:t,host:i}),{settings:c,setSettings:g,columns:p,resetRef:C}=m,h=Mi(p,e,c,g,C),{processedItems:v,visibleData:_,filters:b,setFilterState:A,filterFunctions:f}=Vn({data:a,columns:p,hashParam:e,sortAndGroupOptions:h,noLocalSort:r,noLocalFilter:l}),{isMini:y,collapsedColumns:x,miniColumns:w}=Fn({host:i,columns:p,settings:c,setSettings:g,resizeSpeedFactor:n,sortAndGroupOptions:h}),q=a&&Array.isArray(a)&&a.length>0,[D,H]=T([]);return Nn({host:i,visibleData:_,sortedFilteredGroupedItems:v,columns:p,filters:b,setFilterState:A,selectedItems:D,isMini:y,...h}),{header:kn({host:i,selectedItems:D,sortAndGroupOptions:h,dataIsValid:q,data:a,columns:p,filters:b,collapsedColumns:x,settings:c,filterFunctions:f,settingS:m,setFilterState:A,hideSelectAll:i.hideSelectAll===!0}),list:Ln({host:i,error:s,dataIsValid:q,processedItems:v,setSelectedItems:H,columns:p,collapsedColumns:x,miniColumns:w,sortAndGroupOptions:h,rowPartFn:u}),footer:_n({host:i,selectedItems:D,columns:p})}};customElements.define("cosmoz-grouped-list-row",class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||ze(this._renderFn(this._item,this._index),this)}});const Bn={group:Symbol("group")},$e=(i,e)=>(e.has(i)||e.set(i,{}),e.get(i)),Hn=(i,e)=>!!$e(i,e).expanded,Gn=(i,e)=>!!$e(i,e).folded,ke=i=>i?i.items instanceof Array:!1,jn=i=>{if(!Array.isArray(i)||i.length===0)return;const e=Array.isArray(i[0]?.items);if(!i.every(a=>Array.isArray(a.items)===e))throw new Error("Data must be homogeneous.")},Wn=(i,e,t)=>Array.isArray(i)?(jn(i),i.reduce((n,o)=>{const r=o;if(!r.items)return n.concat(o);if(r.items.length){if($e(o,t).folded)return n.concat(o);const l=r.items.map(s=>Object.assign(s,{[Bn.group]:o}));return n.concat(o,l)}return e?n.concat(o):n},[])):void 0,Un=(i,...e)=>typeof i=="function"?i(...e):i,Kn=(i,e)=>i===e,Jn=()=>{const[i,e]=T(()=>[new WeakMap]);return{setItemState:$((a,n)=>e(([o])=>{const r=$e(a,o);return Object.assign(r,Un(n,r)),[o]}),[]),state:i[0],signal:i}},Xn=()=>{const{setItemState:i,state:e,signal:t}=Jn(),a=$((o,r)=>{ke(o)&&i(o,l=>({folded:r!==void 0?r:!l.folded}))},[]),n=$((o,r)=>{ke(o)||i(o,l=>({expanded:r!==void 0?!r:!l.expanded}))},[]);return{state:e,signal:t,toggleFold:a,toggleCollapse:n}},Qn=({initial:i,compareItemsFn:e,data:t,flatData:a})=>{const[n,o]=T(i),[r,l]=T(),s=$(b=>n.includes(b),[n]),u=$(b=>b?.items?.every(s)??!1,[s]),m=$(b=>s(b)||u(b),[s,u]),c=$(b=>{const f=b.items??[b];o(y=>[...y,...f.filter(x=>!y.includes(x))]),l(b)},[]),g=$(b=>{const f=b.items??[b];o(y=>y.filter(x=>!f.includes(x))),l(b)},[]),p=$(b=>{o(b.items?.slice()||[b]),l(b)},[]),C=$(()=>{o(t.flatMap(b=>b.items||b)),l(void 0)},[t]),h=$(()=>{o([]),l(void 0)},[]),v=$((b,A=!m(b))=>A?c(b):g(b),[m]),_=$((b,A)=>{if(!a)return;const f=r?a.findIndex(w=>e(w,r)):-1;if(f<0)return v(b,A);const[y,x]=[f,a.indexOf(b)].sort((w,q)=>w-q);a.slice(y,x+1).forEach((w,q,D)=>{q>0&&q<D.length-1&&ke(w)||v(w,A)}),l(b)},[a,e,v]);return E(()=>o(b=>b.length>0&&a?a.filter(A=>b.find(f=>e(A,f))):b),[a]),{selectedItems:n,isItemSelected:s,isGroupSelected:u,isSelected:m,select:c,deselect:g,selectOnly:p,selectAll:C,deselectAll:h,toggleSelect:v,toggleSelectTo:_}},Yn={host:{position:"relative",display:"flex",flexDirection:"column"}},Zn=i=>{const{data:e,renderItem:t,renderGroup:a,displayEmptyGroups:n,compareItemsFn:o=Kn}=i,{toggleFold:r,toggleCollapse:l,state:s,signal:u}=Xn(),m=F(()=>Wn(e,n,s),[e,n,u]),{selectedItems:c,isItemSelected:g,isGroupSelected:p,isSelected:C,select:h,deselect:v,selectOnly:_,selectAll:b,deselectAll:A,toggleSelect:f,toggleSelectTo:y}=Qn({initial:[],compareItemsFn:o,data:e,flatData:m}),x=$((q,D)=>Array.isArray(q.items)?a(q,D,{selected:p(q),folded:Gn(q,s),toggleSelect:H=>f(q,typeof H=="boolean"?H:void 0),toggleFold:()=>r(q)}):t(q,D,{selected:c.includes(q),expanded:Hn(q,s),toggleSelect:H=>f(q,typeof H=="boolean"?H:void 0),toggleCollapse:()=>l(q)}),[t,a,c,f,u]);bt(()=>{Object.assign(i.style,Yn.host)},[]),N("selectedItems",c);const w={toggleFold:r,toggleCollapse:l,isItemSelected:g,isGroupSelected:p,isSelected:C,select:h,deselect:v,selectOnly:_,selectAll:b,deselectAll:A,toggleSelect:f,toggleSelectTo:y};return _e(w,Object.values(w)),{renderRow:x,flatData:m}},eo=({renderRow:i,flatData:e})=>li({items:e,renderItem:(t,a)=>d`<cosmoz-grouped-list-row
				.item=${t}
				.index=${a}
				.renderFn=${i}
