import{x as m,B as ke,E as ht}from"./iframe-EpDbBkpO.js";import{t as K,c as O,g as S,P as I,u as T,a as xt,m as yt,s as Nt,D as Rt,b as Bt,e as Ht,i as $e,h as Oe,d as Gt,f as vt,r as jt,j as Wt,k as A,l as Ut,n as we,p as he,o as k,q as Kt,v as Ce,w as Jt,x as Xt,y as Qt,T as Yt,z as M,A as Zt,B as ei,C as ti,E as ii,F as $,G as ai,H as ni,I as $t,J as Le,K as F,L as wt,M as De,N as oi,O as Ct,Q as ri,R as Te,S as Ye,U as li,V as Ve,W as si,X as ui,Y as Ee,Z as Pe,_ as di,$ as Ie,a0 as N,a1 as ci,a2 as ze,a3 as mi}from"./cosmoz-collapse-I-omUgaP.js";import"./preload-helper-PPVm8Dsz.js";const pi=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
>
	${i||""}
</div>`,Di=(i,e)=>e?m`${e} ${i}`:i,Ti=({label:i,value:e,slot:t,sortHandle:a})=>jt(Li(e,t),{label:Di(i,a)});customElements.define("cosmoz-omnitable-dropdown-input",O(Ti,{observedAttributes:Mi,styleSheets:[Oi]}));const ne=({title:i,tooltip:e="",filterText:t="",onOpenedChanged:a,content:n,horizontalAlign:o="left",externalValues:r=null,sortHandle:l=null})=>{const s={filtered:!!t,...r!=null&&{[`external-values-${r}`]:!0}};return m`
		<style>
			.dropdown {
				outline: none;
			}
	...
	`};class Vi extends Ne(ae(I)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1},sortHandle:{type:Object,value:null}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return m`
			<style>
				paper-dropdown-menu {
					--iron-icon-width: 0;
					display: block;
			...
			${ne({title:this.title,tooltip:this._tooltip,filterText:this._filterText,headerFocused:this.headerFocused,horizontalAlign:"right",externalValues:this.externalValues,sortHandle:this.sortHandle,onOpenedChanged:e,content:m`
		...
		>
		...
		</cosmoz-input>`}renderHeader({title:e,min:t,max:a,limits:n,locale:o,rates:r,currency:l,autoupdate:s,autodetect:u},{filter:d},c,b,{sortHandle:p}={}){return m`<cosmoz-omnitable-amount-range-input
			.title=${e}
			.filter=${d}
			.values=${b}
			.rates=${r}
			...
			.autodetect=${u}
			.sortHandle=${p}
			@filter-changed=${({detail:{value:w}})=>c(h=>({...h,filter:w}))}
			@header-focused-changed=${({detail:{value:w}})=>c(h=>({...h,headerFocused:w}))}
		></cosmoz-omnitable-amount-range-input>`}computeSource(e,t){return ie(e,t)}}customElements.define("cosmoz-omnitable-column-amount",Ui);const Ki=(i,e)=>{if(!Array.isArray(i))return;const t=[];return i.reduce((a,n)=>Array.isArray(n)?(n.forEach(o=>{a.push(o)}),a):(a.push(n),a),[]).filter((a,n,o)=>{if(o.indexOf(a)!==n)return!1;if(e){const r=S(a,e);if(t.indexOf(r)!==-1)return!1;t.push(r)}return!0})},Ji=(i,e,t)=>{if(i==null)return[];if(Array.isArray(i))return Ki(i,e);if(typeof i=="object"){const a=e??"id",n=t??"label";return Object.entries(i).map(([o,r])=>({[a]:o,[n]:r})).sort((o,r)=>o[n]<r[n]?-1:o[n]>r[n]?1:0)}return[]},Re=(i,e,t)=>we(e&&S(i,e)).map(he(t)),Be=({valuePath:i,textProperty:e},t)=>Re(t,i,e).filter(a=>a!=null).join(", "),Xi=Be,Qi=({valueProperty:i,valuePath:e,emptyValue:t,emptyProperty:a},n)=>o=>{const r=he(i),l=we(S(o,e));return n.some(s=>l.length===0&&he(a||i)(s)===t||l.some(u=>r(u)===r(s)))},He=i=>e=>i(t=>({...t,filter:e})),Ge=i=>e=>i(t=>({...t,headerFocused:e})),je=i=>e=>i(t=>({...t,query:e})),At=({emptyValue:i,emptyLabel:e,emptyProperty:t,textProperty:a,valueProperty:n},o)=>{const r=Ji(o,n,a);return!e||i===void 0||!a||!(t||n)||!r?r:[{[a]:e,[t||n]:i},...r]},Yi=(i,e)=>At(i,St(e,i.valuePath)),We=i=>class extends i{static get properties(){return{textProperty:{type:String},valueProperty:{type:String},emptyLabel:{type:String},emptyValue:{type:Object},emptyProperty:{type:String}}}getConfig(e){return{emptyProperty:e.emptyProperty}}getString(e,t){return Be(e,t)}toXlsxValue(e,t){return Xi(e,t)}getComparableValue({valuePath:e,valueProperty:t},a){const n=S(a,e);return t==null?n:we(n).reduce((r,l)=>(r.push(S(l,t)),r),[]).sort().join(" ")}getFilterFn(e,t){if(!(!t||!Array.isArray(t)||t.length===0))return Qi(e,t)}serializeFilter(e,t){return t.length===0?null:JSON.stringify(t)}deserializeFilter(e,t){return JSON.parse(decodeURIComponent(t))}computeSource(e,t){return e.externalValues||typeof e.values=="function"?async(...a)=>At(e,await Promise.resolve($e(e.values,...a))):Yi(e,t)}},Zi=({valuePath:i,textProperty:e,valueProperty:t},a)=>{const n=e?Kt(e):he(t),o=we(i&&S(a,i)).map(n);return o.length>1?o.filter(Boolean).join(","):o[0]};class ea extends We(V(I)){static get properties(){return{headerCellClass:{type:String,value:"autocomplete-header-cell"},minWidth:{type:String,value:"55px"},editMinWidth:{type:String,value:"55px"},keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},showSingle:{type:Boolean},preserveOrder:{type:Boolean},limit:{type:Number},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,showSingle:e.showSingle,preserveOrder:e.preserveOrder,limit:e.limit,textual:e.textual}}renderCell(e,{item:t}){return m`<span class="default-column"
		...
		>`}getComparableValue(e,t){return Zi(e,t)}}customElements.define("cosmoz-omnitable-column-autocomplete",ea);const Ue=(i,e)=>e.find(({value:t})=>i===t),ta=(i,e,t)=>{const a=Ue(e,t);return a?a.text:i},nt=(i,e,t,a)=>ta(i,S(e,t),a),ia=({valuePath:i},e,t)=>Ue(S(e,i),t),aa=i=>e=>{i(t=>({...t,filter:e?.[0]?.value??null}))},na=i=>e=>{i(t=>({...t,headerFocused:e}))},oa=i=>e=>{i(t=>({...t,query:e}))},ra=i=>e=>i(e?.[0]?.value),ot=({valuePath:i,trueLabel:e,falseLabel:t},a)=>S(a,i)?e:t,la=({valuePath:i},e)=>t=>S(t,i)===e,le=yt((i,e)=>[{text:i,value:!0},{text:e,value:!1}]),sa=({valuePath:i,trueLabel:e,falseLabel:t},a)=>i?S(a,i)?e:t:"",ua=(i,e)=>{try{return JSON.parse(e)}catch{return null}};class da extends V(I){static get properties(){return{trueLabel:{type:String,value:"True"},falseLabel:{type:String,value:"False"},flex:{type:String,value:"0"},cellClass:{type:String,value:"boolean-cell"}}}getString(e,t){return ot(e,t)}renderCell(e,{item:t}){return ot(e,t)}renderEditCell(e,{item:t},a){const{trueLabel:n,falseLabel:o}=e;return m`<cosmoz-autocomplete
			no-label-float
		...
		>`}renderHeader(e,{filter:t,query:a},n,o){return m`<cosmoz-autocomplete-ui
			...
			.limit=${1}
			>${k(e.loading,()=>m`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}computeSource({trueLabel:e,falseLabel:t}){return le(e,t)}getFilterFn(e,t){if(t!=null)return la(e,t)}toXlsxValue(e,t){return sa(e,t)}deserializeFilter(e,t){return ua(e,t)}}customElements.define("cosmoz-omnitable-column-boolean",da);const Ke=i=>class extends Ne(i){static get properties(){return{max:{type:Date,value:null},min:{type:Date,value:null},_filterText:{type:String,computed:"_computeFilterText(filter.*, formatter)"},formatter:{type:Object,computed:"_computeFormatter(locale)"},sortHandle:{type:Object,value:null}}}toDate(e,t,a){if(e==null||e==="")return;let n=e;if(n instanceof Date||(typeof e=="string"&&(n=this.getAbsoluteISOString(n)),n=new Date(n)),Number.isNaN(n.getTime()))return null;if(a==null||t==null)return n;const o=this.toDate(t);if(o==null)return n;const r=this.getComparableValue(n),l=this.getComparableValue(o);return a(r,l)===r?n:o}toValue(){return this.toDate.apply(this,arguments)}getComparableValue(e,t){const a=super.getComparableValue(e,t);if(a!=null)return this.toNumber(a.getTime())}getString(e,t=this.valuePath,a=this.formatter){const n=this.toValue(this.get(t,e));return n===void 0?"":n===null?"Invalid Date":this.renderValue(n,a)}getAbsoluteISOString(e){return e.length===19?e+this._getTimezoneString(e):e}_getTimezoneString(e){const t=-new Date(e).getTimezoneOffset()/60;return(t<0?"-":"+")+["0",Math.abs(t)].join("").substr(-2)+":00"}renderValue(e,t=this.formatter){if(t==null)return;const a=this.toValue(e);if(a!=null)return t.format(a)}_computeFormatter(e){return new Intl.DateTimeFormat(e||void 0)}_toInputString(e){const t=this.toValue(e);return t==null?null:this._toLocalISOString(t).slice(0,10)}_dateValueChanged(e){const t=e.currentTarget,a=t.value,n=e.model.item,o=this.get(this.valuePath,n),r=this._fromInputString(a);this.set(this.valuePath,r,n),this._fireItemChangeEvent(n,this.valuePath,o,this.renderValue.bind(this))}_toLocalISOString(e){return Ce(e)}};class ca extends Ke(ae(I)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return m`
			<style>
			...
			${ne({title:this.title,tooltip:this._tooltip,filterText:this._filterText,headerFocused:this.headerFocused,horizontalAlign:"right",externalValues:this.externalValues,sortHandle:this.sortHandle,onOpenedChanged:e,content:m`
					...
					></cosmoz-input>
				`})}
		`}_fromInputString(e,t){const a=this.toDate(e);if(a!=null)return t==="min"&&a.setHours(0,0,0,0),t==="max"&&a.setHours(23,59,59),a}_filterInputChanged(e,t){const a=e.path.split(".")[1],n=a&&e.value;if(n&&n.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}}customElements.define("cosmoz-omnitable-date-range-input",ca);const ma=i=>{const e=-new Date(i).getTimezoneOffset()/60;return(e<0?"-":"+")+["0",Math.abs(e)].join("").substr(-2)+":00"},Je=i=>i.length===19?i+ma(i):i,Ft=i=>{if(i==null||i==="")return;let e=i;return!(e instanceof Date)&&(typeof i=="string"&&(e=Je(e)),e=Jt(e),!e)||Number.isNaN(e.getTime())?null:e},P=({valuePath:i},e)=>{if(e==null)return;let t=e;i!=null&&(t=S(e,i));const a=Ft(t);if(a!=null)return L(a.getTime())},E=(i,e,t)=>{const a=Ft(i);return a??null},Xe=(i,e)=>{if(e==null)return;const t=E(i);if(t!=null)return e.format(t)},se={},pa=i=>{const e=i||"";return se[e]||(se[e]=new Intl.DateTimeFormat(i||void 0)),se[e]},rt=({valuePath:i,locale:e},t)=>{let a=S(t,i||"");return a===void 0?"":(a=E(a),a===null?"Invalid Date":Xe(a,pa(e)))},_t=i=>{const e=E(i);if(e==null)return null;const t=Ce(e);return t==null?null:t.slice(0,10)},ga=({valuePath:i},e)=>_t(S(e,i||"")),kt=(i,e)=>{const t=E(i);if(t!=null)return t},lt=i=>{const e=_t(i);return e??""},ba=({valuePath:i},e)=>{if(!i)return"";const t=E(S(e,i));if(!t)return"";const a=E(Ce(t));return a?(a.setHours(0,0,0,0),a):""},Et=(i,e)=>t=>{const a=P(i,t);if(a==null)return!1;const n=P({...i,valuePath:"min"},e),o=P({...i,valuePath:"max"},e);return!(a<(n??-1/0)||a>(o??1/0))};class fa extends V(I){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"date-header-cell"},width:{type:String,value:"100px"},minWidth:{type:String,value:"82px"},flex:{type:String,value:"0"}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const a=P({...e,valuePath:"min"},t),n=P({...e,valuePath:"max"},t);if(!(a==null&&n==null))return Et(e,t)}getString(e,t){return rt(e,t)}toXlsxValue(e,t){return ba(e,t)}getComparableValue(e,t){return P(e,t)}serializeFilter(e,t){if(t==null)return;const a=E(t.min),n=E(t.max);if(!(a==null&&n==null))return lt(a)+"~"+lt(n)}deserializeFilter(e,t){if(t==null||t==="")return null;const a=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(a)?{min:E(a[1]),max:E(a[2])}:null}renderCell(e,{item:t}){return m`<div class="omnitable-cell-date">
			${rt(e,t)}
			...
			.value=${ga(e,t)}
		></cosmoz-input>`}renderHeader({title:e,min:t,max:a,limits:n,locale:o},{filter:r},l,s,{sortHandle:u}={}){return m`<cosmoz-omnitable-date-range-input
			.title=${e}
			.filter=${r}
			.values=${s}
			.min=${t}
			...
			.locale=${o}
			.sortHandle=${u}
			@filter-changed=${({detail:{value:d}})=>l(c=>({...c,filter:d}))}
			@header-focused-changed=${({detail:{value:d}})=>l(c=>({...c,headerFocused:d}))}
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return ie(e,t)}}customElements.define("cosmoz-omnitable-column-date",fa);class ha extends We(V(I)){renderCell({valuePath:e,textProperty:t},{item:a}){const n=Re(a,e,t).map(o=>m`<li>${o}</li>`);return m`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		`}renderEditCell(){return"not implemented"}renderHeader(e,{filter:t,query:a},n,o){return m`<cosmoz-autocomplete-ui
			...
			.onText=${je(n)}
			>${k(e.loading,()=>m`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}}customElements.define("cosmoz-omnitable-column-list-horizontal",ha);window.Cosmoz=window.Cosmoz||{};class st extends Xt(Qt(Yt,I)){static get template(){return Oe`
			<style>
				:host {
					display: block;
				}
		...
		`}static get is(){return"cosmoz-omnitable-column-list-data"}static get properties(){return{items:{type:Array},_expanded:{type:Boolean,value:!1},_othersCount:{type:Number,computed:"_computeOthersCount(items)"}}}static get observers(){return["_itemsLengthChanged(items.length)"]}_itemsLengthChanged(){requestAnimationFrame(()=>this.dispatchEvent(new CustomEvent("expand",{bubbles:!0})))}_firstItem(e){if(e!=null&&e.length>0)return e[0]}_hideExpand(e,t){return e!==void 0&&e.length!==null?e.length<=2||t:!0}_hideCollapse(e,t){return e!==void 0&&e.length!==null?e.length<=2||!t:!0}_otherItems(e,t){if(e!=null&&(e.length<=2||t))return e.slice(1)}_computeOthersCount(e){if(e!=null)return e.length-1}_toggleExpand(e){this._expanded=!this._expanded,e.stopPropagation(),e.preventDefault()}}customElements.define(st.is,st);class xa extends We(V(I)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:a}){return m`<cosmoz-omnitable-column-list-data
			.items=${Re(a,e,t)}
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:a},n,o){return m`<cosmoz-autocomplete-ui
			...
			.onText=${je(n)}
			>${k(e.loading,()=>m`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}}customElements.define("cosmoz-omnitable-column-list",xa);class ya extends Ne(ae(I)){static get properties(){return{maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null},formatter:{type:Object,computed:"_computeFormatter(locale, minimumFractionDigits, maximumFractionDigits)"},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, formatter)"},headerFocused:{type:Boolean,value:!1},sortHandle:{type:Object,value:null}}}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return m`
			<style>
				cosmoz-input[type='number'] {
					background: var(--cosmoz-omnitable-amount-input-background, #ffffff);
					border-radius: 6px;
		...
		`}_computeFormatter(e,t,a){const n={localeMatcher:"best fit"};return t!==null&&(n.minimumFractionDigits=t),a!==null&&(n.maximumFractionDigits=a),new Intl.NumberFormat(e||void 0,n)}getComparableValue(e,t){if(e==null)return;let a=e;if(t!=null&&(a=this.get(t,e)),a=this.toValue(a),a==null)return;const n=this.maximumFractionDigits;return n!==null?this.toValue(a.toFixed(n)):a}renderValue(e,t=this.formatter){const a=this.toNumber(e);if(a!=null)return t.format(a)}}customElements.define("cosmoz-omnitable-number-range-input",ya);class va extends V(I){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},autoupdate:{type:Boolean,value:!1,notify:!0},cellClass:{type:String,value:"number-cell align-right"},width:{type:String,value:"30px"},minWidth:{type:String,value:"30px"},headerCellClass:{type:String,value:"number-header-cell"},maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const a=G({...e,valuePath:"min"},t),n=G({...e,valuePath:"max"},t);if(!(a==null&&n==null))return Ri(e,t)}getString(e,t){return et(e,t)}toXlsxValue({valuePath:e},t){return S(t,e)}getComparableValue(e,t){return G(e,t)}serializeFilter(e,t){if(t==null)return;const a=L(t.min),n=L(t.max);if(!(a==null&&n==null))return Ze(a)+"~"+Ze(n)}deserializeFilter(e,t){if(t==null||t==="")return null;const a=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(a)?{min:L(a[1]),max:L(a[2])}:null}renderCell(e,{item:t}){return m`<div class="omnitable-cell-number">
			...
			@change=${o=>a(o.target.value)}
			.value=${Pi(e,t)}
		></cosmoz-input>`}renderHeader({title:e,min:t,max:a,limits:n,locale:o,maximumFractionDigits:r,minimumFractionDigits:l,autoupdate:s},{filter:u},d,c,{sortHandle:b}={}){return m`<cosmoz-omnitable-number-range-input
			.title=${e}
			.filter=${u}
			.values=${c}
			.min=${t}
			...
			.autoupdate=${s}
			.sortHandle=${b}
			@filter-changed=${({detail:{value:p}})=>d(w=>({...w,filter:p}))}
			@header-focused-changed=${({detail:{value:p}})=>d(w=>({...w,headerFocused:p}))}
		></cosmoz-omnitable-number-range-input>`}computeSource(e,t){return ie(e,t)}}customElements.define("cosmoz-omnitable-column-number",va);const It="1970-01-01",B=(i,e,t)=>{const a=typeof i=="string"&&i.length>3&&i.length<=9?Je(It+"T"+i):i;return E(a)},ue={},$a=i=>{const e=i||"";if(ue[e])return ue[e];const t={hour:"numeric",minute:"numeric",second:"numeric"};return ue[e]=new Intl.DateTimeFormat(i||void 0,t),ue[e]},fe=({valuePath:i,locale:e},t)=>{const a=B(S(t,i||""));return a===void 0?"":a===null?"Invalid Date":Xe(a,$a(e))},wa=(i,e)=>i.valuePath?fe(i,e):"",Ca=i=>{const e=B(i);if(e==null)return null;const t=Ce(e);return t&&t.slice(11,19)},W=({valuePath:i},e)=>{if(e==null)return;const t=Ca(i==null?e:S(e,i));if(t==null)return;const a=B(Je(It+"T"+t));return a==null?a:L(a.getTime())},Sa=(i,e)=>t=>{const a=W(i,t);if(a==null)return!1;const n=W({...i,valuePath:"min"},e),o=W({...i,valuePath:"max"},e);return n==null||o==null?!1:!(a<n||a>o)},ut=i=>{const e=B(i);return e==null?"":e.toISOString().slice(11,19).replace(/:/gu,".")},dt=i=>{if(!(i==null||i===""))return B(typeof i=="string"?i.replace(/\./gu,":")+"Z":i)};class za extends Ke(ae(I)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return m`
			<cosmoz-clear-button
				@click=${()=>this.resetFilter()}
				?visible=${this.hasFilter()}
			></cosmoz-clear-button>
			...
			${ne({title:this.title,tooltip:this._tooltip,filterText:this._filterText,headerFocused:this.headerFocused,horizontalAlign:"right",externalValues:this.externalValues,sortHandle:this.sortHandle,onOpenedChanged:e,content:m`
					...
					></cosmoz-input>
				`})}
		`}get _fixedDate(){return"1970-01-01"}toDate(e,t,a){const n=typeof e=="string"&&e.length>3&&e.length<=9?this.getAbsoluteISOString(this._fixedDate+"T"+e):e;return super.toDate(n,t,a)}_toInputString(e){const t=this.toValue(e);return t==null?null:this._toLocalISOString(t).slice(11,19)}getComparableValue(e,t){if(e==null)return;let a=this._toInputString(t==null?e:this.get(t,e));if(a!=null&&(a=this.toValue(this.getAbsoluteISOString(this._fixedDate+"T"+a)),a!=null))return this.toNumber(a.getTime())}_timeValueChanged(e){const t=e.target,a=t.value,n=e.model.item,o=this.toDate(n.date),r=this.toDate(o!=null?o.toISOString().slice(0,10)+"T"+a:a),l=s=>s;r==null&&(this.set(this.valuePath,r,n),this._fireItemChangeEvent(n,this.valuePath,o,l.bind(this)))}_computeFormatter(e){const t={hour:"numeric",minute:"numeric",second:"numeric"};return new Intl.DateTimeFormat(e||void 0,t)}}customElements.define("cosmoz-omnitable-time-range-input",za);class qa extends V(I){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"time-header-cell"},minWidth:{type:String,value:"63px"},width:{type:String,value:"210px"},flex:{type:String,value:"0"},filterStep:{type:String,value:"1"}}}getFilterFn(e,t){const a=W({...e,valuePath:"min"},t),n=W({...e,valuePath:"max"},t);if(!(a==null&&n==null))return Sa(e,t)}getString(e,t){return fe(e,t)}toXlsxValue(e,t){return wa(e,t)}getComparableValue(e,t){return W(e,t)}serializeFilter(e,t){if(t==null)return;const a=B(t.min),n=B(t.max);if(!(a==null&&n==null))return ut(a)+"~"+ut(n)}deserializeFilter(e,t){if(t==null||t==="")return null;const a=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(a)?{min:dt(a[1]),max:dt(a[2])}:null}renderCell(e,{item:t}){return fe(e,t)}renderEditCell(e,{item:t},a){return m`<cosmoz-input
			no-label-float
			type="text"
			@change=${o=>a(o.target.value)}
			.value=${fe(e,t)}
		></cosmoz-input>`}renderHeader({title:e,min:t,max:a,locale:n,filterStep:o},{filter:r},l,s,{sortHandle:u}={}){return m`<cosmoz-omnitable-time-range-input
			.title=${e}
			.filter=${r}
			.values=${s}
			.min=${t}
			...
			@filter-changed=${({detail:{value:d}})=>l(c=>({...c,filter:d}))}
			@header-focused-changed=${({detail:{value:d}})=>l(c=>({...c,headerFocused:d}))}
		></cosmoz-omnitable-time-range-input>`}computeSource(e,t){return ie(e,t)}}customElements.define("cosmoz-omnitable-column-time",qa);const de={},Aa=i=>{const e=i||"";if(de[e])return de[e];const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return de[e]=new Intl.DateTimeFormat(i||void 0,t),de[e]},qe=({valuePath:i,locale:e},t)=>{const a=E(S(t,i||""));return a===void 0?"":a===null?"Invalid Date":Xe(a,Aa(e))},Fa=({valuePath:i},e)=>i?S(e,i):"",ct=i=>{const e=E(i);return e==null?"":e.toISOString().slice(0,19).replace(/:/gu,".")},mt=i=>{if(!(i==null||i==="")&&typeof i=="string")return E(i.replace(/\./gu,":")+"Z")};class _a extends Ke(ae(I)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return m`
			<style>
			...
			${ne({title:this.title,tooltip:this._tooltip,filterText:this._filterText,headerFocused:this.headerFocused,horizontalAlign:"right",externalValues:this.externalValues,onOpenedChanged:e,content:m`
					<h3 style="margin: 0;">${this.title}</h3>
					<cosmoz-datetime-input
					...
					></cosmoz-datetime-input>
				`})}
		`}_toInputString(e){const t=this.toValue(e);if(t!=null)return this._toLocalISOString(t).slice(0,19)}_computeFormatter(e){const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return new Intl.DateTimeFormat(e||void 0,t)}}customElements.define("cosmoz-omnitable-datetime-range-input",_a);class pt extends V(I){static get is(){return"cosmoz-omnitable-column-datetime"}static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"datetime-header-cell"},width:{type:String,value:"210px"},minWidth:{type:String,value:"128px"},flex:{type:String,value:"0"},filterStep:{type:Number,value:1}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const a=P({...e,valuePath:"min"},t),n=P({...e,valuePath:"max"},t);if(!(a==null&&n==null))return Et(e,t)}getString(e,t){return qe(e,t)}toXlsxValue(e,t){return Fa(e,t)}getComparableValue(e,t){return P(e,t)}serializeFilter(e,t){if(t==null)return;const a=E(t.min),n=E(t.max);if(!(a==null&&n==null))return ct(a)+"~"+ct(n)}deserializeFilter(e,t){if(t==null||t==="")return null;const a=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(a)?{min:mt(a[1]),max:mt(a[2])}:null}renderCell(e,{item:t}){return qe(e,t)}renderEditCell(e,{item:t},a){return m`<cosmoz-input
			no-label-float
			type="text"
			@change=${o=>a(kt(o.target.value))}
			.value=${qe(e,t)}
		></cosmoz-input>`}renderHeader({title:e,min:t,max:a,limits:n,locale:o,filterStep:r},{filter:l},s,u,{sortHandle:d}={}){return m`<cosmoz-omnitable-datetime-range-input
			.title=${e}
			.filter=${l}
			.values=${u}
			.min=${t}
			...
			.filterStep=${r}
			.sortHandle=${d}
			@filter-changed=${({detail:{value:c}})=>s(b=>({...b,filter:c}))}
			@header-focused-changed=${({detail:{value:c}})=>s(b=>({...b,headerFocused:c}))}
		></cosmoz-omnitable-datetime-range-input>`}computeSource(e,t){return ie(e,t)}}customElements.define(pt.is,pt);const ka=({column:i,item:e,selected:t,folded:a,group:n})=>i?(i.renderGroup??i.renderCell)(i,{item:e,selected:t,folded:a,group:n}):ht;customElements.define("cosmoz-omnitable-group-row",O(ka,{useShadowDOM:!1}));const Ea=i=>{const{column:e}=i;return M(()=>{let t=0,a=0;const n=l=>{i.dispatchEvent(new CustomEvent("column-resize",{bubbles:!0,composed:!0,detail:{newWidth:Math.ceil(a+l.pageX-t),column:e}}))},o=()=>{document.removeEventListener("pointermove",n),document.removeEventListener("pointerup",o)},r=l=>{t=l.pageX,a=i.previousElementSibling.getBoundingClientRect().width,document.addEventListener("pointermove",n),document.addEventListener("pointerup",o)};return i.addEventListener("pointerdown",r),()=>i.removeEventListener("pointerdown",r)},[e]),ht};customElements.define("cosmoz-omnitable-resize-nub",O(Ea));const Ia=m`<svg
	width="10"
	height="9"
	viewBox="0 0 10 9"
	stroke="currentColor"
...
>
	...
	/>
</svg> `,Mt=({column:i,on:e,descending:t,setOn:a,setDescending:n})=>{const{name:o,title:r}=i??{};return m`<button
		class="sg"
		title=${r}
		data-on=${Zt(o===e&&(t?"desc":"asc")||void 0)}
		@click=${l=>{const s=l.currentTarget?.dataset.on;s||(a(o),n(!1)),s==="asc"?n(!0):s==="desc"&&(a(),n(!1))}}
	>
		<span>${r}</span> ${Oa}
	</button>`},Ot=({columns:i,...e})=>i?.map(t=>Mt({column:t,...e})),La=()=>m`
	<sort-and-group-consumer
		class="sgs"
		.render=${({columns:i,groupOn:e,setGroupOn:t,groupOnDescending:a,setGroupOnDescending:n}={})=>Ot({columns:i?.filter?.(o=>o.groupOn),on:e,setOn:t,descending:a,setDescending:n})}
	>
	</sort-and-group-consumer>
`,Da=()=>m`
	<sort-and-group-consumer
		class="sgs"
		.render=${({columns:i,sortOn:e,setSortOn:t,descending:a,setDescending:n}={})=>Ot({columns:i?.filter?.(o=>o.sortOn&&!o.noSort),on:e,setOn:t,descending:a,setDescending:n})}
	>
	</sort-and-group-consumer>
`,Lt=i=>(e,t,a=ei)=>{const n=ni(),o=new URLSearchParams(n.hash.replace("#",""));return i(e,t,a,o),"#!"+Object.assign(n,{hash:o}).href.replace(location.origin,"")},Dt=i=>i==null||i==="",Ta=Lt((i,e,t,a)=>Dt(t(e))?a.delete(i):a.set(i,t(e))),Va=Lt((i,e,t,a)=>Object.entries(e).map(t).forEach(([n,o])=>Dt(o)?a.delete(i+n):a.set(i+n,o))),J=(i,e,{suffix:t="",read:a,write:n,multi:o}={})=>{const[r,l]=o?[Va,ti]:[Ta,ii],[s,u]=T(()=>e==null?i:l(e+t,a)??i),d=$(c=>u(b=>{const p=$e(c,b);return e!=null&&ai(r(e+t,p,n),null,{notify:!1}),p}),[e,t,r,n]);return[s,d]},Pa=i=>[!0,"true",1,"yes","on"].includes(i),ce=i=>i===""||(i==null?void 0:Pa(i)),me=(i,e,t)=>$(a=>{i(a),t(n=>({...n,[e]:a}))},[i,e,t]),Na=(i,e,t,a,n)=>{const[o,r]=J(t.sortOn,e,{suffix:"-sortOn"}),[l,s]=J(ce(t.descending),e,{suffix:"-descending",read:ce}),[u,d]=J(t.groupOn,e,{suffix:"-groupOn"}),[c,b]=J(ce(t.groupOnDescending),e,{suffix:"-groupOnDescending",read:ce}),p=F(()=>i.find(g=>g.name===o),[i,o]),w=F(()=>i.find(g=>g.name===u),[i,u]),h={groupOn:u,setGroupOn:me(d,"groupOn",a),groupOnDescending:c,setGroupOnDescending:me(b,"groupOnDescending",a),sortOn:o,setSortOn:me(r,"sortOn",a),descending:l,setDescending:me(s,"descending",a),columns:i},v=F(()=>h,Object.values(h)),_=$(g=>{r(g.sortOn),d(g.groupOn),s(g.descending),b(g.groupOnDescending)},[]);return M(()=>void(n.current=_),[]),{...v,sortAndGroup:v,groupOnColumn:w,sortOnColumn:p}},Qe=$t();customElements.define("sort-and-group-provider",Qe.Provider);customElements.define("sort-and-group-consumer",O(({render:i})=>i(Le(Qe)),{useShadowDOM:!1}));const Ra=({data:i,columns:e,groupOnColumn:t,filters:a,setFilterState:n,sortAndGroup:{sortOn:o,setSortOn:r,descending:l,setDescending:s}={}})=>wt(e,u=>u.name,u=>[m`<div
				...
				name="${u.name}"
			>
				${u.renderHeader(u,a[u.name]??{},d=>n(u.name,d),u.source(u,i),{sortHandle:k(!u.noSort,()=>Mt({on:o,setOn:r,descending:l,setDescending:s,column:u}))})}
			</div>`,m`<cosmoz-omnitable-resize-nub
				.column="${u}"
				name="${u.name}"
			></cosmoz-omnitable-resize-nub>`]),Ba=({columns:i,settingsConfig:e,hideSelectAll:t,...a})=>{const n=Le(Qe);return m`
		${k(i,o=>Ra({columns:o,sortAndGroup:n,...a}))}
...
`;customElements.define("cosmoz-omnitable-item-expand-line",O(Ga,{styleSheets:[De(Ha)]}));const ja=({columns:i,item:e,selected:t,expanded:a,groupOnColumn:n})=>oi(i,o=>m`<cosmoz-omnitable-item-expand-line
				.column=${o}
				?hidden=${o===n}
				exportparts="item-expand-label, item-expand-value"
				>${o.renderCell(o,{item:e,selected:t,expanded:a})}</cosmoz-omnitable-item-expand-line
			>`);customElements.define("cosmoz-omnitable-item-expand",O(ja,{useShadowDOM:!1}));const Wa=(i,e,t)=>i.editable?i.renderEditCell(i,e,t(i,e.item)):i.renderCell(i,e),Ua=({columns:i,groupOnColumn:e,item:t,index:a,selected:n,expanded:o,onItemChange:r})=>wt(i,l=>l.name,l=>m`<div
...
`);r.unshift(o),Ct(new File(r,t,{type:"text/csv;charset=utf-8"}))},Xa=(i,e)=>{const t=i.map(n=>n.title),a=e.map(n=>i.map(o=>{const r=o.toXlsxValue(o,n);return r??""}));return a.unshift(t),a},Qa=(i,e,t,a)=>{const n=Xa(i,e),o=new ri(t).addSheetFromData(n,a).generate();Ct(new File([o],t,{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}))},Ya=({columns:i,selectedItems:e,csvFilename:t,xlsxFilename:a,xlsxSheetname:n,topPlacement:o})=>m`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!Te(e.length)}
		part="bottomBar"
	...
	>
	...
	</cosmoz-bottom-bar>`,Za=({allSelected:i,onAllCheckboxChange:e,sortAndGroup:t,dataIsValid:a,data:n,columns:o,filters:r,groupOnColumn:l,setFilterState:s,settingsConfig:u,hideSelectAll:d})=>m`<sort-and-group-provider .value=${t}>
		<div class="header" id="header" part="header">
			${k(!d,()=>m`<input
						...
						part="all"
					/>`)}
			${k(d,()=>m` <cosmoz-omnitable-settings
						.newLayout="${!0}"
						.config=${u}
					></cosmoz-omnitable-settings>`)}
...
`,tn=({settingsConfig:i})=>{const{columns:e,collapsed:t}=i,a=e.filter(n=>!t.some(o=>o.name===n.name));return m`<div class="skeleton">
	...
	</div>`};customElements.define("cosmoz-omnitable-skeleton",O(tn,{styleSheets:[en]}));const an=(i,e)=>{const{settingsConfig:t}=i,{processedItems:a,dataIsValid:n,filterIsTooStrict:o,loading:r,displayEmptyGroups:l,compareItemsFn:s,setSelectedItems:u,renderItem:d,renderGroup:c,error:b}=e;return m`${k(!r&&!n&&!b,()=>m`<div class="tableContent-empty">
		...
		${k(r&&!a.length,()=>m`<div class="tableContent-empty overlay">
					<cosmoz-omnitable-skeleton
						.settingsConfig=${t}
					></cosmoz-omnitable-skeleton>
				</div>`)}
		${k(r&&a.length,()=>m`<div class="tableContent-empty overlay spinner">
					<cz-spinner></cz-spinner>
				</div>`)}
		${k(b,()=>m`<div class="tableContent-empty overlay">
...
`,pe=i=>{const e=parseInt(i,10);return isFinite(e)?e:void 0},rn=i=>{const{config:e}=i,{settings:t,setSettings:a,collapsed:n}=e,o=Ve({collapsed:n,settings:t.columns,setSettings:$(r=>a(l=>({...l,columns:r})),[a])});return{...e,onDown:$(r=>{r.target.closest(".pull")&&(o.handle=r.currentTarget)},[o]),onDragStart:$(r=>{const{target:l}=r,s=pe(l.dataset.index);if(!o.handle?.contains(l)||s==null)return r.preventDefault();o.handle=null,r.dataTransfer.effectAllowed="move",r.dataTransfer.setData("omnitable/sort-index",s),r.dataTransfer.setData("text/plain",s),setTimeout(()=>l.classList.add("drag"),0),l.addEventListener("dragend",u=>u.target.classList.remove("drag"),{once:!0})},[o]),onDragEnter:$(r=>{const l=r.currentTarget;l===r.target&&(r.preventDefault(),r.dataTransfer.dropEffect="move",l.classList.add("dragover"))},[]),onDragOver:$(r=>{r.preventDefault(),r.currentTarget.classList.add("dragover")},[]),onDragLeave:$(r=>{const l=r.currentTarget;l.contains(r.relatedTarget)||l.classList.remove("dragover")},[]),onDrop:$(r=>{const l=pe(r.dataTransfer.getData("omnitable/sort-index")),s=pe(r.currentTarget.dataset.index),{settings:u,setSettings:d}=o;r.currentTarget.classList.remove("dragover"),r.preventDefault();const c=u.slice();c.splice(s+(l>=s?0:-1),0,c.splice(l,1)[0]),d(c)},[o]),onToggle:$(r=>{const{settings:l,setSettings:s}=o,u=l.map(c=>({...c,disabled:c.disabled||o.collapsed?.some(b=>b.name===c.name)})),d=pe(r.target.closest("[data-index]")?.dataset.index);u.splice(d,1,{...l[d],disabled:!r.target.checked,priority:r.target.checked?l.reduce((c,b)=>Math.max(c,b.priority),0)+1:l[d].priority}),s(u)},[o])}},ln=[si({apply({availableHeight:i,elements:e}){Object.assign(e.floating.style,{maxHeight:`${Math.max(0,i)}px`})}}),...ui],sn=({onDragStart:i,onDragEnter:e,onDragOver:t,onDragLeave:a,onDrop:n,onDown:o,onToggle:r,collapsed:l,filters:s})=>(u,d)=>{const c=!!l?.find(p=>p.name===u.name),b=!u.disabled&&!c;return m` <div
		...
		>
			...
			<input
				...
				.indeterminate=${c}
			/>
		</div>`},un=i=>{const{settings:e,settingsId:t,onSave:a,onReset:n,hasChanges:o,opened:r,setOpened:l,...s}=rn(i);return m` <div class="headline">
			${A("Sort and filter")}
			<button
				class="close"
		...
		<div class="contents">
			...
			<cosmoz-collapse ?opened=${r.sort}> ${Da()} </cosmoz-collapse>
		...
		${k(t,()=>m`<div class="buttons">
				...
				</div>`)}`};customElements.define("cosmoz-omnitable-settings-ui",O(un,{styleSheets:[De(nn)]}));const dn=({config:i,newLayout:e})=>m`
	<cosmoz-dropdown
		.placement="${e?"bottom-start":"bottom-end"}"
		.middleware="${ln}"
	>
		${k(e,()=>m`<div class="headerDots" slot="button">...</div>`,()=>m` <svg
					viewBox="0 0 24 24"
					width="24"
					slot="button"
					fill="currentColor"
		...
		${k(i?.badge,()=>m`<div class="badge" slot="button"></div>`)}
		<cosmoz-omnitable-settings-ui
			exportparts="columns, groups"
			.config=${i}
		></cosmoz-omnitable-settings-ui>
	</cosmoz-dropdown>
`;customElements.define("cosmoz-omnitable-settings",O(dn,{styleSheets:[De(on)]}));const xe=["sortOn","descending","groupOn","groupOnDescending"],ge=i=>e=>typeof e=="object"&&e!==null&&"name"in e&&e.name===i,cn=(i=[],e=[],t=[])=>{const a=e.filter(r=>i.some(ge(r.name))),n=i.filter(r=>r.name!=null&&!e.some(ge(r.name))&&!t.some(ge(r.name))),o=t.filter(r=>!e.some(ge(r.name)));return[...a,...o.flatMap(r=>{const l=i.find(s=>s.name===r.name);return l?{...r,title:l.title??r.title??"",minWidth:parseInt(l.minWidth??"0",10)}:[]}),...n.map(r=>{const{name:l,title:s,priority:u,minWidth:d,width:c,flex:b}=r;return{name:l??"",title:s??"",priority:u??0,minWidth:parseInt(d??"0",10),width:parseInt(c??"0",10),flex:parseInt(b??"0",10)}})]},mn=(i,e)=>({...e,...Ee(Array.from(xe))(i),columns:i.columns?.map(Ee(["name","priority","width","flex","disabled"]))}),pn=({columns:i,settings:e,savedSettings:t,initial:a})=>({...Object.fromEntries(xe.flatMap(o=>a?.[o]!=null?[[o,a[o]]]:[])),...t?Ee(Array.from(xe))(t):{},...e,columns:cn(i,e?.columns,t?.columns)}),gn=({prefix:i="omnitable-"}={})=>({write:async(t,a)=>{const n=i+t;try{a?localStorage.setItem(n,JSON.stringify(a)):localStorage.removeItem(n)}catch(o){console.error(o)}},read:async t=>{if(t)try{const a=localStorage.getItem(i+t);return a==null?void 0:JSON.parse(a)}catch(a){console.error(a)}}}),bn=$t(gn),fn=()=>{const i=Le(bn);return F(()=>i(),[i])},hn=(i,e,t,a)=>{const[n,o]=T(),{read:r,write:l}=fn();return M(async()=>{i&&o(await r(i))},[i,r]),{settingsId:i,savedSettings:n,onSave:$(async()=>{if(!i)return;const s=mn(e,n);await l(i,s),t(),o(s)},[e,n]),onReset:$(async s=>{t(),s.shiftKey&&(await l(i),o()),a?.()},[a]),hasChanges:e!=null}},xn=({settingsId:i,host:e})=>{const t=F(()=>Object.fromEntries(xe.map(h=>[h,e[h]])),[]),a=Pe(),n=$(()=>{a.current?.(t)},[t]),[o,r]=T(),[l,s]=T({columns:!0,sort:!0}),{savedSettings:u,...d}=hn(i,o,r,n),{enabledColumns:c}=e,b=Ei(e,{enabledColumns:c}),p=F(()=>pn({columns:b,settings:o,savedSettings:u,initial:t}),[b,o,u]),w=F(()=>p.columns.map(h=>b.find(v=>v.name===h.name)).filter(Boolean),[b,...p.columns.map(h=>h.name)]);return{...d,opened:l,setOpened:s,settings:p,columns:w,setSettings:r,resetRef:a}},bt=i=>Number.isFinite(i)?i:0,yn=(i,e)=>{const t=[];let[a,n]=i.reduce(([d,c],{width:b,flex:p})=>[d+b,c+p],[0,0]),o=e-a,r=bt(o/n),l=0,s=0,u=0;for(let d=0;d<i.length;d++){const{width:c,minWidth:b,flex:p}=i[d],w=o>=0?r*p:c*o/a;if(b>c+w){l+=c,s+=b,u+=p,t[d]=b;continue}if(p===0){l+=c,s+=c,t[d]=c;continue}}a-=l,o=e-s-a,n-=u,r=bt(o/n);for(let d=0;d<i.length;d++){if(t[d]!=null)continue;const{width:c,flex:b}=i[d],p=o>=0?r*b:c*o/a;t[d]=c+p}return t},ye=Symbol("index"),vn=(i,e)=>{if(typeof i.findLastIndex=="function")return i.findLastIndex(e);for(let t=i.length-1;t>=0;t--)if(e(i[t],t,i))return t;return-1},$n=(i,e)=>{const t=vn(i,r=>r!=null&&r>0),a=(r,l)=>`.cell[name="${r}"], cosmoz-omnitable-skeleton::part(cell-${r}){width: ${Math.floor(l)}px;padding: 0 min(3px, ${l/2}px)}`,n=r=>`cosmoz-omnitable-resize-nub[name="${r}"]{display:none}`,o=r=>`cosmoz-omnitable-resize-nub[name="${r}"], .cell[name="${r}"]{display:none}`;return e.map((r,l)=>{const s=i[l];if(s==null||s===0)return o(r.name);const u=a(r.name,s);return l===t?`${u}
${n(r.name)}`:u}).join(`
`)},Vt=(i,e,t)=>{const a=i.filter(l=>!l.hidden),n=a.reduce((l,{width:s})=>l+s,0);if(a.length>1&&n>e)return Vt(a.slice(1),e,t);const o=a.reduce(([l,s],u,d)=>[Math.max(l,u.index),u.index>l?d:s],[-1,-1])[1];return o!==-1&&(a[o].flex=1),yn(a,e).reduce((l,s,u)=>(l[a[u].index]=s,l),new Array(t).fill(void 0))},wn=(i,e)=>i.length===0?".cell {display: none;}":$n(i,e),Cn=({host:i,canvasWidth:e,layout:t,setSettings:a})=>{const n=Pe();n.current=o=>a(r=>{const l=r.columns,{detail:{newWidth:s,column:u}}=o,d=l.findIndex(p=>p.name===u.name),c=[],b=l.reduce((p,w)=>Math.max(p,w.priority),-1/0);for(let p=0;p<t.length;p++)if(c[p]={...l[p]},p<d&&t[p]&&(c[p].width=t[p],c[p].flex=0,c[p].priority=b),p===d){const w=t.reduce((h,v,_)=>_<d&&v?h-v:h,e);c[p].width=Math.min(w,Math.max(s,l[p].minWidth)),c[p].flex=0,c[p].priority=b}return{...r,columns:c}}),M(()=>{const o=r=>n.current?.(r);return i.addEventListener("column-resize",o),()=>i.removeEventListener("column-resize",o)},[])},Sn=(i,e)=>M(()=>{const t=([n])=>{n.contentRect?.width!==0&&requestAnimationFrame(()=>e(n.contentRect?.width-20-44-24))},a=new ResizeObserver(t);return a.observe(i),()=>a.unobserve(i)},[]),zn=i=>{const[e,t]=T(()=>i.getBoundingClientRect().width);return Sn(i,t),e},qn=(i,e)=>{const t=F(()=>{let a=!1,n;const o=()=>{if(!a)return;n=requestAnimationFrame(o),i()&&(a=!1)};return{start:()=>{a=!0,cancelAnimationFrame(n),n=requestAnimationFrame(o)},stop:()=>{a=!1,cancelAnimationFrame(n)}}},[]);M(()=>{t.start()},e),M(()=>()=>t.stop(),[])},An=(i=0,e=0)=>Math.abs(i-e)<.1,Fn=(i,e=1.9,t=di)=>{const a=Ve({target:i}),n=$(()=>{if(a.tween||(a.tween=a.target),a.target.every((o,r)=>a.tween[r]===o))return t(a.tween),!0;a.tween=a.target.map((o,r)=>An(a.tween[r],o)?o:(a.tween[r]??0)+((o??0)-(a.tween[r]??0))/e||0),t(a.tween)},[]);qn(n,[i])},_n=({canvasWidth:i,groupOnColumn:e,config:t,miniColumn:a})=>F(()=>{if(!Array.isArray(t)||i==null||i===0)return[];const n=t.map((o,r)=>({minWidth:o.minWidth,width:o.width,flex:o.flex,priority:o.priority,name:o.name,index:r,hidden:o.name===e?.name||o.disabled})).map(o=>a?{...o,hidden:a.name!==o.name}:o).sort(({index:o,priority:r},{index:l,priority:s})=>r===s?l-o:r-s);return Vt(n,i,n.length)},[i,e,t]),kn=({host:i,canvasWidth:e,columns:t})=>{const a=i.miniBreakpoint??480,n=F(()=>e<=a,[e,a]),o=F(()=>n?t?.filter(u=>u.mini!=null).sort((u,d)=>(u.mini??0)-(d.mini??0)):[],[t,n]),[r,...l]=o??[],s=!!r;return M(()=>{i.toggleAttribute("mini",s)},[s]),{isMini:s&&n,miniColumn:r,miniColumns:l}},En=i=>{const e=F(()=>new CSSStyleSheet,[]);return M(()=>{i.shadowRoot.adoptedStyleSheets=[...i.shadowRoot.adoptedStyleSheets,e]},[]),e},In=({host:i,columns:e,settings:t,setSettings:a,resizeSpeedFactor:n,sortAndGroupOptions:o})=>{const r=zn(i),{isMini:l,miniColumn:s,miniColumns:u}=kn({host:i,canvasWidth:r,columns:e}),{groupOnColumn:d}=o,c=_n({canvasWidth:r,groupOnColumn:d,miniColumn:s,config:t.columns}),b=En(i),p=F(()=>t.columns.reduce((h,v,_)=>c[_]!=null||v.name===d?.name||v.disabled?h:[...h,e.find(g=>g.name===v.name)],[]),[e,t,c]),w=Ve({columns:t.columns});return Fn(c,n,h=>{const v=wn(h,w.columns);b.replace(v)}),Cn({host:i,canvasWidth:r,layout:c,setSettings:h=>a(h(t))}),{isMini:l,collapsedColumns:p,miniColumns:u}},Mn=({host:i,...e})=>{const{csvFilename:t="omnitable.csv",xlsxFilename:a="omnitable.xlsx",xlsxSheetname:n="Omnitable",topPlacement:o="top-end"}=i;return{csvFilename:t,xlsxFilename:a,xlsxSheetname:n,topPlacement:o,...e}},On=({host:i,selectedItems:e,data:t,sortAndGroupOptions:a,collapsedColumns:n,settings:o,filterFunctions:r,settingS:l,filters:s,...u})=>{const d=t&&t.length>0&&e.length===t.length,c=h=>{h.target.checked?i.shadowRoot.querySelector("#groupedList").selectAll():i.shadowRoot.querySelector("#groupedList").deselectAll()},{groupOnColumn:b}=a,p=F(()=>[b,...n,...o.columns.filter(h=>h.disabled)].some(h=>h&&Object.keys(r).includes(h.name)),[r,o,n]),w=F(()=>({...l,collapsed:n,badge:p,filters:s}),[l,n,p,s]);return M(()=>{const h=i.shadowRoot.querySelector("#tableContent"),v=new ResizeObserver(_=>requestAnimationFrame(()=>{i.style.setProperty("--ot-height",_[0]?.contentRect.height+"px")}));return v.observe(h),()=>v.unobserve(h)},[]),{allSelected:d,onAllCheckboxChange:c,data:t,settingsConfig:w,filters:s,groupOnColumn:b,sortAndGroup:a.sortAndGroup,...u}},Pt=m`
	<svg
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
...
`,Ln=i=>i?"groupRow groupRow-folded":"groupRow",Dn=({item:i,index:e})=>t=>k(t?.length>0,()=>m`
			...
			`),Tn=({columns:i,collapsedColumns:e,miniColumns:t,onItemClick:a,onCheckboxChange:n,dataIsValid:o,groupOnColumn:r,onItemChange:l,rowPartFn:s})=>(u,d,{selected:c,expanded:b,toggleCollapse:p})=>m`
		<div
			?selected=${c}
			part="${["itemRow",`itemRow-${u[ye]}`,s?.(u,d)].filter(Boolean).join(" ")}"
			.dataIndex=${u[ye]}
			.dataItem=${u}
			class="itemRow"
			@click=${a}
	...
	`,Vn=({onCheckboxChange:i,dataIsValid:e,groupOnColumn:t})=>(a,n,{selected:o,folded:r,toggleFold:l})=>m` <div
			class="${Ln(r)}"
