import{x as d,B as ke,E as ht}from"./iframe-BdGcfk9Y.js";import{t as K,c as O,g as S,P as I,u as T,a as xt,m as yt,s as Nt,D as Rt,b as Bt,e as Ht,i as $e,h as Oe,d as Gt,f as jt,j as Wt,k as $,n as Ut,l as Kt,o as vt,p as Le,q as F,r as M,v as Jt,w as Xt,x as $t,y as Qt,z as Yt,A,B as Zt,C as we,E as he,F as k,G as ei,H as Ce,I as ti,J as ii,K as ai,T as ni,L as wt,M as De,N as oi,O as Ct,Q as ri,R as Te,S as Ye,U as li,V as Ve,W as si,X as ui,Y as Ee,Z as Pe,_ as ci,$ as Ie,a0 as N,a1 as di,a2 as ze,a3 as mi}from"./cosmoz-collapse-CKbFadSh.js";import"./preload-helper-PPVm8Dsz.js";const pi=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
>
	...
	/>
</svg> `,Ft=({column:i,on:e,descending:t,setOn:a,setDescending:n})=>{const{name:o,title:r}=i??{};return d`<button
		class="sg"
		title=${r}
	...
	>
		<span>${r}</span> ${Pi}
	</button>`},_t=({columns:i,...e})=>i?.map(t=>Ft({column:t,...e})),Ni=()=>d`
...
`,Gi=(i,e)=>d`<div id="input" part="input" role="button" class="control" slot=${e}>
	...
	`};class Ui extends Ne(ae(I)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1},column:{type:Object,value:null}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return d`
			...
			${ne({title:this.title,tooltip:this._tooltip,filterText:this._filterText,headerFocused:this.headerFocused,horizontalAlign:"right",externalValues:this.externalValues,onOpenedChanged:e,column:this.column,content:d`
		...
		>
		...
		</cosmoz-input>`}renderHeader({title:e,min:t,max:a,limits:n,locale:o,rates:r,currency:l,autoupdate:s,autodetect:u,noSort:m},{filter:c},b,p){return d`<cosmoz-omnitable-amount-range-input
			.title=${e}
			.filter=${c}
			.values=${p}
			.rates=${r}
			...
			.autodetect=${u}
			.column=${{noSort:m}}
			@filter-changed=${({detail:{value:w}})=>b(h=>({...h,filter:w}))}
			@header-focused-changed=${({detail:{value:w}})=>b(h=>({...h,headerFocused:w}))}
		...
		`}_fromInputString(e,t){const a=this.toDate(e);if(a!=null)return t==="min"&&a.setHours(0,0,0,0),t==="max"&&a.setHours(23,59,59),a}_filterInputChanged(e,t){const a=e.path.split(".")[1],n=a&&e.value;if(n&&n.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}}customElements.define("cosmoz-omnitable-date-range-input",va);const $a=i=>{const e=-new Date(i).getTimezoneOffset()/60;return(e<0?"-":"+")+["0",Math.abs(e)].join("").substr(-2)+":00"},Xe=i=>i.length===19?i+$a(i):i,It=i=>{if(i==null||i==="")return;let e=i;return!(e instanceof Date)&&(typeof i=="string"&&(e=Xe(e)),e=ti(e),!e)||Number.isNaN(e.getTime())?null:e},P=({valuePath:i},e)=>{if(e==null)return;let t=e;i!=null&&(t=S(e,i));const a=It(t);if(a!=null)return L(a.getTime())},E=(i,e,t)=>{const a=It(i);return a??null},Qe=(i,e)=>{if(e==null)return;const t=E(i);if(t!=null)return e.format(t)},ce={},wa=i=>{const e=i||"";return ce[e]||(ce[e]=new Intl.DateTimeFormat(i||void 0)),ce[e]},rt=({valuePath:i,locale:e},t)=>{let a=S(t,i||"");return a===void 0?"":(a=E(a),a===null?"Invalid Date":Qe(a,wa(e)))},Mt=i=>{const e=E(i);if(e==null)return null;const t=Ce(e);return t==null?null:t.slice(0,10)},Ca=({valuePath:i},e)=>Mt(S(e,i||"")),Ot=(i,e)=>{const t=E(i);if(t!=null)return t},lt=i=>{const e=Mt(i);return e??""},Sa=({valuePath:i},e)=>{if(!i)return"";const t=E(S(e,i));if(!t)return"";const a=E(Ce(t));return a?(a.setHours(0,0,0,0),a):""},Lt=(i,e)=>t=>{const a=P(i,t);if(a==null)return!1;const n=P({...i,valuePath:"min"},e),o=P({...i,valuePath:"max"},e);return!(a<(n??-1/0)||a>(o??1/0))};class za extends V(I){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"date-header-cell"},width:{type:String,value:"100px"},minWidth:{type:String,value:"82px"},flex:{type:String,value:"0"}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const a=P({...e,valuePath:"min"},t),n=P({...e,valuePath:"max"},t);if(!(a==null&&n==null))return Lt(e,t)}getString(e,t){return rt(e,t)}toXlsxValue(e,t){return Sa(e,t)}getComparableValue(e,t){return P(e,t)}serializeFilter(e,t){if(t==null)return;const a=E(t.min),n=E(t.max);if(!(a==null&&n==null))return lt(a)+"~"+lt(n)}deserializeFilter(e,t){if(t==null||t==="")return null;const a=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(a)?{min:E(a[1]),max:E(a[2])}:null}renderCell(e,{item:t}){return d`<div class="omnitable-cell-date">
			...
			.value=${Ca(e,t)}
		></cosmoz-input>`}renderHeader({title:e,min:t,max:a,limits:n,locale:o,noSort:r},{filter:l},s,u){return d`<cosmoz-omnitable-date-range-input
			.title=${e}
			.filter=${l}
			.values=${u}
			.min=${t}
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return ie(e,t)}}customElements.define("cosmoz-omnitable-column-date",za);class qa extends Ue(V(I)){renderCell({valuePath:e,textProperty:t},{item:a}){const n=Be(a,e,t).map(o=>d`<li>${o}</li>`);return d`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		`}_computeFormatter(e,t,a){const n={localeMatcher:"best fit"};return t!==null&&(n.minimumFractionDigits=t),a!==null&&(n.maximumFractionDigits=a),new Intl.NumberFormat(e||void 0,n)}getComparableValue(e,t){if(e==null)return;let a=e;if(t!=null&&(a=this.get(t,e)),a=this.toValue(a),a==null)return;const n=this.maximumFractionDigits;return n!==null?this.toValue(a.toFixed(n)):a}renderValue(e,t=this.formatter){const a=this.toNumber(e);if(a!=null)return t.format(a)}}customElements.define("cosmoz-omnitable-number-range-input",Fa);class _a extends V(I){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},autoupdate:{type:Boolean,value:!1,notify:!0},cellClass:{type:String,value:"number-cell align-right"},width:{type:String,value:"30px"},minWidth:{type:String,value:"30px"},headerCellClass:{type:String,value:"number-header-cell"},maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const a=G({...e,valuePath:"min"},t),n=G({...e,valuePath:"max"},t);if(!(a==null&&n==null))return Xi(e,t)}getString(e,t){return et(e,t)}toXlsxValue({valuePath:e},t){return S(t,e)}getComparableValue(e,t){return G(e,t)}serializeFilter(e,t){if(t==null)return;const a=L(t.min),n=L(t.max);if(!(a==null&&n==null))return Ze(a)+"~"+Ze(n)}deserializeFilter(e,t){if(t==null||t==="")return null;const a=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(a)?{min:L(a[1]),max:L(a[2])}:null}renderCell(e,{item:t}){return d`<div class="omnitable-cell-number">
			...
			@change=${o=>a(o.target.value)}
			.value=${Ki(e,t)}
		></cosmoz-input>`}renderHeader({title:e,min:t,max:a,limits:n,locale:o,maximumFractionDigits:r,minimumFractionDigits:l,autoupdate:s,noSort:u},{filter:m},c,b){return d`<cosmoz-omnitable-number-range-input
			.title=${e}
			.filter=${m}
			.values=${b}
			.min=${t}
			...
			.autoupdate=${s}
			.column=${{noSort:u}}
			@filter-changed=${({detail:{value:p}})=>c(w=>({...w,filter:p}))}
			@header-focused-changed=${({detail:{value:p}})=>c(w=>({...w,headerFocused:p}))}
		...
		`}get _fixedDate(){return"1970-01-01"}toDate(e,t,a){const n=typeof e=="string"&&e.length>3&&e.length<=9?this.getAbsoluteISOString(this._fixedDate+"T"+e):e;return super.toDate(n,t,a)}_toInputString(e){const t=this.toValue(e);return t==null?null:this._toLocalISOString(t).slice(11,19)}getComparableValue(e,t){if(e==null)return;let a=this._toInputString(t==null?e:this.get(t,e));if(a!=null&&(a=this.toValue(this.getAbsoluteISOString(this._fixedDate+"T"+a)),a!=null))return this.toNumber(a.getTime())}_timeValueChanged(e){const t=e.target,a=t.value,n=e.model.item,o=this.toDate(n.date),r=this.toDate(o!=null?o.toISOString().slice(0,10)+"T"+a:a),l=s=>s;r==null&&(this.set(this.valuePath,r,n),this._fireItemChangeEvent(n,this.valuePath,o,l.bind(this)))}_computeFormatter(e){const t={hour:"numeric",minute:"numeric",second:"numeric"};return new Intl.DateTimeFormat(e||void 0,t)}}customElements.define("cosmoz-omnitable-time-range-input",Oa);class La extends V(I){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"time-header-cell"},minWidth:{type:String,value:"63px"},width:{type:String,value:"210px"},flex:{type:String,value:"0"},filterStep:{type:String,value:"1"}}}getFilterFn(e,t){const a=W({...e,valuePath:"min"},t),n=W({...e,valuePath:"max"},t);if(!(a==null&&n==null))return Ma(e,t)}getString(e,t){return fe(e,t)}toXlsxValue(e,t){return Ea(e,t)}getComparableValue(e,t){return W(e,t)}serializeFilter(e,t){if(t==null)return;const a=B(t.min),n=B(t.max);if(!(a==null&&n==null))return ut(a)+"~"+ut(n)}deserializeFilter(e,t){if(t==null||t==="")return null;const a=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(a)?{min:ct(a[1]),max:ct(a[2])}:null}renderCell(e,{item:t}){return fe(e,t)}renderEditCell(e,{item:t},a){return d`<cosmoz-input
			...
			@change=${o=>a(o.target.value)}
			.value=${fe(e,t)}
		></cosmoz-input>`}renderHeader({title:e,min:t,max:a,locale:n,filterStep:o,noSort:r},{filter:l},s,u){return d`<cosmoz-omnitable-time-range-input
			.title=${e}
			.filter=${l}
			.values=${u}
			.min=${t}
		...
		`}_toInputString(e){const t=this.toValue(e);if(t!=null)return this._toLocalISOString(t).slice(0,19)}_computeFormatter(e){const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return new Intl.DateTimeFormat(e||void 0,t)}}customElements.define("cosmoz-omnitable-datetime-range-input",Va);class pt extends V(I){static get is(){return"cosmoz-omnitable-column-datetime"}static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"datetime-header-cell"},width:{type:String,value:"210px"},minWidth:{type:String,value:"128px"},flex:{type:String,value:"0"},filterStep:{type:Number,value:1}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const a=P({...e,valuePath:"min"},t),n=P({...e,valuePath:"max"},t);if(!(a==null&&n==null))return Lt(e,t)}getString(e,t){return Ae(e,t)}toXlsxValue(e,t){return Ta(e,t)}getComparableValue(e,t){return P(e,t)}serializeFilter(e,t){if(t==null)return;const a=E(t.min),n=E(t.max);if(!(a==null&&n==null))return dt(a)+"~"+dt(n)}deserializeFilter(e,t){if(t==null||t==="")return null;const a=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(a)?{min:mt(a[1]),max:mt(a[2])}:null}renderCell(e,{item:t}){return Ae(e,t)}renderEditCell(e,{item:t},a){return d`<cosmoz-input
			...
			@change=${o=>a(Ot(o.target.value))}
			.value=${Ae(e,t)}
		></cosmoz-input>`}renderHeader({title:e,min:t,max:a,limits:n,locale:o,filterStep:r,noSort:l},{filter:s},u,m){return d`<cosmoz-omnitable-datetime-range-input
			.title=${e}
			.filter=${s}
			.values=${m}
			.min=${t}
			...
			.filterStep=${r}
			.column=${{noSort:l}}
			@filter-changed=${({detail:{value:c}})=>u(b=>({...b,filter:c}))}
			@header-focused-changed=${({detail:{value:c}})=>u(b=>({...b,headerFocused:c}))}
		></cosmoz-omnitable-datetime-range-input>`}computeSource(e,t){return ie(e,t)}}customElements.define(pt.is,pt);const Pa=({column:i,item:e,selected:t,folded:a,group:n})=>i?(i.renderGroup??i.renderCell)(i,{item:e,selected:t,folded:a,group:n}):ht;customElements.define("cosmoz-omnitable-group-row",O(Pa,{useShadowDOM:!1}));const Na=i=>{const{column:e}=i;return M(()=>{let t=0,a=0;const n=l=>{i.dispatchEvent(new CustomEvent("column-resize",{bubbles:!0,composed:!0,detail:{newWidth:Math.ceil(a+l.pageX-t),column:e}}))},o=()=>{document.removeEventListener("pointermove",n),document.removeEventListener("pointerup",o)},r=l=>{t=l.pageX,a=i.previousElementSibling.getBoundingClientRect().width,document.addEventListener("pointermove",n),document.addEventListener("pointerup",o)};return i.addEventListener("pointerdown",r),()=>i.removeEventListener("pointerdown",r)},[e]),ht};customElements.define("cosmoz-omnitable-resize-nub",O(Na));const Ra=({data:i,columns:e,groupOnColumn:t,filters:a,setFilterState:n})=>wt(e,o=>o.name,o=>[d`<div
			...
			>
				...
				.column="${o}"
				name="${o.name}"
			></cosmoz-omnitable-resize-nub>`]),Ba=({columns:i,settingsConfig:e,hideSelectAll:t,...a})=>d`
...
`;customElements.define("cosmoz-omnitable-item-expand-line",O(Ga,{styleSheets:[De(Ha)]}));const ja=({columns:i,item:e,selected:t,expanded:a,groupOnColumn:n})=>oi(i,o=>d`<cosmoz-omnitable-item-expand-line
				.column=${o}
				?hidden=${o===n}
				exportparts="item-expand-label, item-expand-value"
				>${o.renderCell(o,{item:e,selected:t,expanded:a})}</cosmoz-omnitable-item-expand-line
			>`);customElements.define("cosmoz-omnitable-item-expand",O(ja,{useShadowDOM:!1}));const Wa=(i,e,t)=>i.editable?i.renderEditCell(i,e,t(i,e.item)):i.renderCell(i,e),Ua=({columns:i,groupOnColumn:e,item:t,index:a,selected:n,expanded:o,onItemChange:r})=>wt(i,l=>l.name,l=>d`<div
...
`);r.unshift(o),Ct(new File(r,t,{type:"text/csv;charset=utf-8"}))},Xa=(i,e)=>{const t=i.map(n=>n.title),a=e.map(n=>i.map(o=>{const r=o.toXlsxValue(o,n);return r??""}));return a.unshift(t),a},Qa=(i,e,t,a)=>{const n=Xa(i,e),o=new ri(t).addSheetFromData(n,a).generate();Ct(new File([o],t,{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}))},Ya=({columns:i,selectedItems:e,csvFilename:t,xlsxFilename:a,xlsxSheetname:n,topPlacement:o})=>d`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!Te(e.length)}
		part="bottomBar"
	...
	</cosmoz-bottom-bar>`,Za=({allSelected:i,onAllCheckboxChange:e,sortAndGroup:t,dataIsValid:a,data:n,columns:o,filters:r,groupOnColumn:l,setFilterState:s,settingsConfig:u,hideSelectAll:m})=>d`<sort-and-group-provider .value=${t}>
...
`,tn=({settingsConfig:i})=>{const{columns:e,collapsed:t}=i,a=e.filter(n=>!t.some(o=>o.name===n.name));return d`<div class="skeleton">
	...
	</div>`};customElements.define("cosmoz-omnitable-skeleton",O(tn,{styleSheets:[en]}));const an=(i,e)=>{const{settingsConfig:t}=i,{processedItems:a,dataIsValid:n,filterIsTooStrict:o,loading:r,displayEmptyGroups:l,compareItemsFn:s,setSelectedItems:u,renderItem:m,renderGroup:c,error:b}=e;return d`${k(!r&&!n&&!b,()=>d`<div class="tableContent-empty">
...
`,pe=i=>{const e=parseInt(i,10);return isFinite(e)?e:void 0},rn=i=>{const{config:e}=i,{settings:t,setSettings:a,collapsed:n}=e,o=Ve({collapsed:n,settings:t.columns,setSettings:$(r=>a(l=>({...l,columns:r})),[a])});return{...e,onDown:$(r=>{r.target.closest(".pull")&&(o.handle=r.currentTarget)},[o]),onDragStart:$(r=>{const{target:l}=r,s=pe(l.dataset.index);if(!o.handle?.contains(l)||s==null)return r.preventDefault();o.handle=null,r.dataTransfer.effectAllowed="move",r.dataTransfer.setData("omnitable/sort-index",s),r.dataTransfer.setData("text/plain",s),setTimeout(()=>l.classList.add("drag"),0),l.addEventListener("dragend",u=>u.target.classList.remove("drag"),{once:!0})},[o]),onDragEnter:$(r=>{const l=r.currentTarget;l===r.target&&(r.preventDefault(),r.dataTransfer.dropEffect="move",l.classList.add("dragover"))},[]),onDragOver:$(r=>{r.preventDefault(),r.currentTarget.classList.add("dragover")},[]),onDragLeave:$(r=>{const l=r.currentTarget;l.contains(r.relatedTarget)||l.classList.remove("dragover")},[]),onDrop:$(r=>{const l=pe(r.dataTransfer.getData("omnitable/sort-index")),s=pe(r.currentTarget.dataset.index),{settings:u,setSettings:m}=o;r.currentTarget.classList.remove("dragover"),r.preventDefault();const c=u.slice();c.splice(s+(l>=s?0:-1),0,c.splice(l,1)[0]),m(c)},[o]),onToggle:$(r=>{const{settings:l,setSettings:s}=o,u=l.map(c=>({...c,disabled:c.disabled||o.collapsed?.some(b=>b.name===c.name)})),m=pe(r.target.closest("[data-index]")?.dataset.index);u.splice(m,1,{...l[m],disabled:!r.target.checked,priority:r.target.checked?l.reduce((c,b)=>Math.max(c,b.priority),0)+1:l[m].priority}),s(u)},[o])}},ln=[si({apply({availableHeight:i,elements:e}){Object.assign(e.floating.style,{maxHeight:`${Math.max(0,i)}px`})}}),...ui],sn=({onDragStart:i,onDragEnter:e,onDragOver:t,onDragLeave:a,onDrop:n,onDown:o,onToggle:r,collapsed:l,filters:s})=>(u,m)=>{const c=!!l?.find(p=>p.name===u.name),b=!u.disabled&&!c;return d` <div
		...
		>
			...
			<input
				...
				.indeterminate=${c}
			/>
		</div>`},un=i=>{const{settings:e,settingsId:t,onSave:a,onReset:n,hasChanges:o,opened:r,setOpened:l,...s}=rn(i);return d` <div class="headline">
			${A("Sort and filter")}
			<button
				class="close"
		...
		${k(t,()=>d`<div class="buttons">
				...
				</div>`)}`};customElements.define("cosmoz-omnitable-settings-ui",O(un,{styleSheets:[De(nn)]}));const cn=({config:i,newLayout:e})=>d`
	<cosmoz-dropdown
...
`;customElements.define("cosmoz-omnitable-settings",O(cn,{styleSheets:[De(on)]}));const xe=["sortOn","descending","groupOn","groupOnDescending"],ge=i=>e=>typeof e=="object"&&e!==null&&"name"in e&&e.name===i,dn=(i=[],e=[],t=[])=>{const a=e.filter(r=>i.some(ge(r.name))),n=i.filter(r=>r.name!=null&&!e.some(ge(r.name))&&!t.some(ge(r.name))),o=t.filter(r=>!e.some(ge(r.name)));return[...a,...o.flatMap(r=>{const l=i.find(s=>s.name===r.name);return l?{...r,title:l.title??r.title??"",minWidth:parseInt(l.minWidth??"0",10)}:[]}),...n.map(r=>{const{name:l,title:s,priority:u,minWidth:m,width:c,flex:b}=r;return{name:l??"",title:s??"",priority:u??0,minWidth:parseInt(m??"0",10),width:parseInt(c??"0",10),flex:parseInt(b??"0",10)}})]},mn=(i,e)=>({...e,...Ee(Array.from(xe))(i),columns:i.columns?.map(Ee(["name","priority","width","flex","disabled"]))}),pn=({columns:i,settings:e,savedSettings:t,initial:a})=>({...Object.fromEntries(xe.flatMap(o=>a?.[o]!=null?[[o,a[o]]]:[])),...t?Ee(Array.from(xe))(t):{},...e,columns:dn(i,e?.columns,t?.columns)}),gn=({prefix:i="omnitable-"}={})=>({write:async(t,a)=>{const n=i+t;try{a?localStorage.setItem(n,JSON.stringify(a)):localStorage.removeItem(n)}catch(o){console.error(o)}},read:async t=>{if(t)try{const a=localStorage.getItem(i+t);return a==null?void 0:JSON.parse(a)}catch(a){console.error(a)}}}),bn=vt(gn),fn=()=>{const i=Le(bn);return F(()=>i(),[i])},hn=(i,e,t,a)=>{const[n,o]=T(),{read:r,write:l}=fn();return M(async()=>{i&&o(await r(i))},[i,r]),{settingsId:i,savedSettings:n,onSave:$(async()=>{if(!i)return;const s=mn(e,n);await l(i,s),t(),o(s)},[e,n]),onReset:$(async s=>{t(),s.shiftKey&&(await l(i),o()),a?.()},[a]),hasChanges:e!=null}},xn=({settingsId:i,host:e})=>{const t=F(()=>Object.fromEntries(xe.map(h=>[h,e[h]])),[]),a=Pe(),n=$(()=>{a.current?.(t)},[t]),[o,r]=T(),[l,s]=T({columns:!0,sort:!0}),{savedSettings:u,...m}=hn(i,o,r,n),{enabledColumns:c}=e,b=Ei(e,{enabledColumns:c}),p=F(()=>pn({columns:b,settings:o,savedSettings:u,initial:t}),[b,o,u]),w=F(()=>p.columns.map(h=>b.find(v=>v.name===h.name)).filter(Boolean),[b,...p.columns.map(h=>h.name)]);return{...m,opened:l,setOpened:s,settings:p,columns:w,setSettings:r,resetRef:a}},bt=i=>Number.isFinite(i)?i:0,yn=(i,e)=>{const t=[];let[a,n]=i.reduce(([m,c],{width:b,flex:p})=>[m+b,c+p],[0,0]),o=e-a,r=bt(o/n),l=0,s=0,u=0;for(let m=0;m<i.length;m++){const{width:c,minWidth:b,flex:p}=i[m],w=o>=0?r*p:c*o/a;if(b>c+w){l+=c,s+=b,u+=p,t[m]=b;continue}if(p===0){l+=c,s+=c,t[m]=c;continue}}a-=l,o=e-s-a,n-=u,r=bt(o/n);for(let m=0;m<i.length;m++){if(t[m]!=null)continue;const{width:c,flex:b}=i[m],p=o>=0?r*b:c*o/a;t[m]=c+p}return t},ye=Symbol("index"),vn=(i,e)=>{if(typeof i.findLastIndex=="function")return i.findLastIndex(e);for(let t=i.length-1;t>=0;t--)if(e(i[t],t,i))return t;return-1},$n=(i,e)=>{const t=vn(i,r=>r!=null&&r>0),a=(r,l)=>`.cell[name="${r}"], cosmoz-omnitable-skeleton::part(cell-${r}){width: ${Math.floor(l)}px;padding: 0 min(3px, ${l/2}px)}`,n=r=>`cosmoz-omnitable-resize-nub[name="${r}"]{display:none}`,o=r=>`cosmoz-omnitable-resize-nub[name="${r}"], .cell[name="${r}"]{display:none}`;return e.map((r,l)=>{const s=i[l];if(s==null||s===0)return o(r.name);const u=a(r.name,s);return l===t?`${u}
${n(r.name)}`:u}).join(`
`)},Vt=(i,e,t)=>{const a=i.filter(l=>!l.hidden),n=a.reduce((l,{width:s})=>l+s,0);if(a.length>1&&n>e)return Vt(a.slice(1),e,t);const o=a.reduce(([l,s],u,m)=>[Math.max(l,u.index),u.index>l?m:s],[-1,-1])[1];return o!==-1&&(a[o].flex=1),yn(a,e).reduce((l,s,u)=>(l[a[u].index]=s,l),new Array(t).fill(void 0))},wn=(i,e)=>i.length===0?".cell {display: none;}":$n(i,e),Cn=({host:i,canvasWidth:e,layout:t,setSettings:a})=>{const n=Pe();n.current=o=>a(r=>{const l=r.columns,{detail:{newWidth:s,column:u}}=o,m=l.findIndex(p=>p.name===u.name),c=[],b=l.reduce((p,w)=>Math.max(p,w.priority),-1/0);for(let p=0;p<t.length;p++)if(c[p]={...l[p]},p<m&&t[p]&&(c[p].width=t[p],c[p].flex=0,c[p].priority=b),p===m){const w=t.reduce((h,v,_)=>_<m&&v?h-v:h,e);c[p].width=Math.min(w,Math.max(s,l[p].minWidth)),c[p].flex=0,c[p].priority=b}return{...r,columns:c}}),M(()=>{const o=r=>n.current?.(r);return i.addEventListener("column-resize",o),()=>i.removeEventListener("column-resize",o)},[])},Sn=(i,e)=>M(()=>{const t=([n])=>{n.contentRect?.width!==0&&requestAnimationFrame(()=>e(n.contentRect?.width-20-44-24))},a=new ResizeObserver(t);return a.observe(i),()=>a.unobserve(i)},[]),zn=i=>{const[e,t]=T(()=>i.getBoundingClientRect().width);return Sn(i,t),e},qn=(i,e)=>{const t=F(()=>{let a=!1,n;const o=()=>{if(!a)return;n=requestAnimationFrame(o),i()&&(a=!1)};return{start:()=>{a=!0,cancelAnimationFrame(n),n=requestAnimationFrame(o)},stop:()=>{a=!1,cancelAnimationFrame(n)}}},[]);M(()=>{t.start()},e),M(()=>()=>t.stop(),[])},An=(i=0,e=0)=>Math.abs(i-e)<.1,Fn=(i,e=1.9,t=ci)=>{const a=Ve({target:i}),n=$(()=>{if(a.tween||(a.tween=a.target),a.target.every((o,r)=>a.tween[r]===o))return t(a.tween),!0;a.tween=a.target.map((o,r)=>An(a.tween[r],o)?o:(a.tween[r]??0)+((o??0)-(a.tween[r]??0))/e||0),t(a.tween)},[]);qn(n,[i])},_n=({canvasWidth:i,groupOnColumn:e,config:t,miniColumn:a})=>F(()=>{if(!Array.isArray(t)||i==null||i===0)return[];const n=t.map((o,r)=>({minWidth:o.minWidth,width:o.width,flex:o.flex,priority:o.priority,name:o.name,index:r,hidden:o.name===e?.name||o.disabled})).map(o=>a?{...o,hidden:a.name!==o.name}:o).sort(({index:o,priority:r},{index:l,priority:s})=>r===s?l-o:r-s);return Vt(n,i,n.length)},[i,e,t]),kn=({host:i,canvasWidth:e,columns:t})=>{const a=i.miniBreakpoint??480,n=F(()=>e<=a,[e,a]),o=F(()=>n?t?.filter(u=>u.mini!=null).sort((u,m)=>(u.mini??0)-(m.mini??0)):[],[t,n]),[r,...l]=o??[],s=!!r;return M(()=>{i.toggleAttribute("mini",s)},[s]),{isMini:s&&n,miniColumn:r,miniColumns:l}},En=i=>{const e=F(()=>new CSSStyleSheet,[]);return M(()=>{i.shadowRoot.adoptedStyleSheets=[...i.shadowRoot.adoptedStyleSheets,e]},[]),e},In=({host:i,columns:e,settings:t,setSettings:a,resizeSpeedFactor:n,sortAndGroupOptions:o})=>{const r=zn(i),{isMini:l,miniColumn:s,miniColumns:u}=kn({host:i,canvasWidth:r,columns:e}),{groupOnColumn:m}=o,c=_n({canvasWidth:r,groupOnColumn:m,miniColumn:s,config:t.columns}),b=En(i),p=F(()=>t.columns.reduce((h,v,_)=>c[_]!=null||v.name===m?.name||v.disabled?h:[...h,e.find(g=>g.name===v.name)],[]),[e,t,c]),w=Ve({columns:t.columns});return Fn(c,n,h=>{const v=wn(h,w.columns);b.replace(v)}),Cn({host:i,canvasWidth:r,layout:c,setSettings:h=>a(h(t))}),{isMini:l,collapsedColumns:p,miniColumns:u}},Mn=({host:i,...e})=>{const{csvFilename:t="omnitable.csv",xlsxFilename:a="omnitable.xlsx",xlsxSheetname:n="Omnitable",topPlacement:o="top-end"}=i;return{csvFilename:t,xlsxFilename:a,xlsxSheetname:n,topPlacement:o,...e}},On=({host:i,selectedItems:e,data:t,sortAndGroupOptions:a,collapsedColumns:n,settings:o,filterFunctions:r,settingS:l,filters:s,...u})=>{const m=t&&t.length>0&&e.length===t.length,c=h=>{h.target.checked?i.shadowRoot.querySelector("#groupedList").selectAll():i.shadowRoot.querySelector("#groupedList").deselectAll()},{groupOnColumn:b}=a,p=F(()=>[b,...n,...o.columns.filter(h=>h.disabled)].some(h=>h&&Object.keys(r).includes(h.name)),[r,o,n]),w=F(()=>({...l,collapsed:n,badge:p,filters:s}),[l,n,p,s]);return M(()=>{const h=i.shadowRoot.querySelector("#tableContent"),v=new ResizeObserver(_=>requestAnimationFrame(()=>{i.style.setProperty("--ot-height",_[0]?.contentRect.height+"px")}));return v.observe(h),()=>v.unobserve(h)},[]),{allSelected:m,onAllCheckboxChange:c,data:t,settingsConfig:w,filters:s,groupOnColumn:b,sortAndGroup:a.sortAndGroup,...u}},Pt=d`
	<svg
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
...
`,Ln=i=>i?"groupRow groupRow-folded":"groupRow",Dn=({item:i,index:e})=>t=>k(t?.length>0,()=>d`
			...
			`),Tn=({columns:i,collapsedColumns:e,miniColumns:t,onItemClick:a,onCheckboxChange:n,dataIsValid:o,groupOnColumn:r,onItemChange:l,rowPartFn:s})=>(u,m,{selected:c,expanded:b,toggleCollapse:p})=>d`
		<div
			?selected=${c}
	...
	`,Vn=({onCheckboxChange:i,dataIsValid:e,groupOnColumn:t})=>(a,n,{selected:o,folded:r,toggleFold:l})=>d` <div
			class="${Ln(r)}"
		...
		</div>`,Pn=({host:i,error:e,dataIsValid:t,processedItems:a,columns:n,collapsedColumns:o,miniColumns:r,sortAndGroupOptions:l,rowPartFn:s,...u})=>{const{loading:m=!1,displayEmptyGroups:c=!1,compareItemsFn:b}=i,p=Pe({shiftKey:!1,ctrlKey:!1}),w=$(g=>{const q=g.target.dataItem,f=g.target.checked;p.current.shiftKey?i.shadowRoot.querySelector("#groupedList").toggleSelectTo(q,f):p.current.ctrlKey?(g.target.checked=!0,i.shadowRoot.querySelector("#groupedList").selectOnly(q)):i.shadowRoot.querySelector("#groupedList").toggleSelect(q,f),g.preventDefault(),g.stopPropagation()},[]);M(()=>{const g=({shiftKey:q,ctrlKey:f})=>{p.current={shiftKey:q,ctrlKey:f}};return window.addEventListener("keydown",g),window.addEventListener("keyup",g),()=>{window.removeEventListener("keydown",g),window.removeEventListener("keyup",g)}},[]);const h=$(g=>{const q=g.composedPath();q.slice(0,q.indexOf(g.currentTarget)).find(y=>y.matches?.("a, .checkbox, .expand"))||i.dispatchEvent(new window.CustomEvent("omnitable-item-click",{bubbles:!0,composed:!0,detail:{item:g.currentTarget.dataItem,index:g.currentTarget.dataIndex}}))},[]),{groupOnColumn:v}=l,_=$((g,q)=>f=>Ii(i,g,q,f),[]);return{...u,processedItems:a,dataIsValid:t,filterIsTooStrict:t&&a.length<1,loading:m,compareItemsFn:b,displayEmptyGroups:c,error:e,renderItem:F(()=>Tn({columns:n,collapsedColumns:o,miniColumns:r,onItemClick:h,onCheckboxChange:w,dataIsValid:t,groupOnColumn:v,onItemChange:_,rowPartFn:s}),[n,o,h,w,t,v,_,s]),renderGroup:F(()=>Vn({onCheckboxChange:w,dataIsValid:t,groupOnColumn:v}),[w,t,v])}},Nn=(i,e)=>{if(i===e)return 0;if(i==null)return-1;if(e==null)return 1;const t=typeof i,a=typeof e;return t==="object"&&a==="object"?i.toString()<e.toString()?-1:1:t==="number"&&a==="number"?i-e:t==="string"&&a==="string"?i<e?-1:1:t==="boolean"&&a==="boolean"?i?-1:1:(console.warn("unsupported sort",t,i,a,e),0)},Fe=(i,e)=>(t,a)=>Nn(i(t),i(a))*(e?-1:1),Rn=i=>i.replace(/([a-z0-9])([A-Z])/gu,"$1-$2").toLowerCase(),ft=(i,e)=>{!i||!e||Object.entries(e).forEach(([t,a])=>{i[R].__ownChange=!0,i[R][t]=a,i[R].__ownChange=!1,i[R].dispatchEvent(new CustomEvent(`${Rn(t)}-changed`,{bubbles:!0,detail:{value:a}}))})},_e=(i,e)=>Object.assign(i,{[ye]:e}),be=Symbol("unparsed"),Bn=({data:i,columns:e,hashParam:t,sortAndGroupOptions:a,noLocalSort:n,noLocalFilter:o})=>{const{groupOnColumn:r,groupOnDescending:l,sortOnColumn:s,descending:u}=a,m=$(([f,y])=>{const x=e.find(({name:C})=>C===f);return x==null?[f,void 0]:[f,y.filter&&x.serializeFilter(x,y.filter)]},[e]),c=$(([f,y])=>{const x=e.find(({name:z})=>z===f);if(x==null)return[f,{[be]:y}];const C={filter:x.deserializeFilter(x,y)};return ft(x,C),[f,C]},[e]),[b,p]=J({},t,{multi:!0,suffix:"-filter--",write:m,read:c}),w=$((f,y)=>p(x=>{const C=$e(y,x[f]);return ft(e.find(z=>z.name===f),C),{...x,[f]:{...x[f],...C}}}),[e,p]),h=F(()=>Object.values(b).map(f=>f.filter),[b]),v=F(()=>Object.fromEntries(e.map(f=>[f.name,!f.noLocalFilter&&f.getFilterFn(f,b[f.name]?.filter)]).filter(([,f])=>!!f)),[e,...h]),_=F(()=>!Array.isArray(i)||i.length===0?[]:Object.entries(v).length===0||o?i.slice():i.filter(f=>Object.values(v).every(y=>y(f))),[i,v,o]),g=F(()=>{if(!n&&!r&&s!=null&&s.sortOn!=null)return _.slice().sort(Fe(f=>s.getComparableValue({...s,valuePath:s.sortOn},f),u));if(r!=null&&r.groupOn!=null){const f=_.reduce((y,x)=>{const C=r.getComparableValue({...r,valuePath:r.groupOn},x);if(C===void 0)return y;let z=y.find(D=>D.id===C);return z?(z.items.push(x),y):(z={id:C,name:C,items:[x]},[...y,z])},[]);return f.sort(Fe(y=>r.getComparableValue({...r,valuePath:r.groupOn},y.items[0]),l)),!s||n?f:f.filter(y=>Array.isArray(y.items)).map(y=>(y.items.sort(Fe(x=>s.getComparableValue({...s,valuePath:s.sortOn},x),u)),y))}return _},[_,r,l,s,u,n]),q=F(()=>{let f=0,y=0;const x=[];return g.forEach(C=>{if(Array.isArray(C.items)){_e(C,y++),C.items.forEach(z=>{_e(z,f++),x.push(z)});return}return _e(C,f++),x.push(C)},[]),x},[g]);return M(()=>{p(f=>Object.values(f).some(x=>x[be]!=null)?Object.fromEntries(Object.entries(f).map(([x,C])=>C[be]==null?[x,C]:c([x,C[be]]))):f)},[c]),{processedItems:g,visibleData:q,filters:b,filterFunctions:v,setFilterState:w}},Hn=i=>{const e=a=>{const n=i.data.indexOf(a);if(n<0)return null;const o=i.data.splice(n,1);if(i.data=i.data.slice(),Array.isArray(o)&&o.length>0)return o[0]},t=(a,n)=>{i.data.splice(a,1,n),i.data=i.data.slice()};return{removeItem:e,removeItems(a){const n=[];for(let o=a.length-1;o>=0;o-=1){const r=i.removeItem(a[o]);r!=null&&n.push(r)}return n},replaceItemAtIndex:t,replaceItem(a,n){const o=i.data.indexOf(a);if(o>-1)return t(o,n)},selectItem(a){i.shadowRoot.querySelector("#groupedList").select(a)},selectAll(){i.shadowRoot.querySelector("#groupedList").selectAll()},deselectAll(){i.shadowRoot.querySelector("#groupedList").deselectAll()},deselectItem(a){i.shadowRoot.querySelector("#groupedList").deselect(a)},isItemSelected(a){return i.shadowRoot.querySelector("#groupedList").isItemSelected(a)}}},Gn=({host:i,visibleData:e,filters:t,...a})=>{const{setFilterState:n}=a,o=F(()=>Hn(i),[]);Ie(a,Object.values(a)),Ie(o,Object.values(o)),M(()=>{const l=s=>n(s.detail.name,u=>({...u,...s.detail.state}));return i.addEventListener("legacy-filter-changed",l),()=>i.removeEventListener("legacy-filter-changed",l)},[]),N("visibleData",e),N("sortedFilteredGroupedItems",a.sortedFilteredGroupedItems),N("selectedItems",a.selectedItems),N("sortOn",a.sortOn),N("descending",a.descending),N("isMini",a.isMini);const r=F(()=>Object.fromEntries(Object.entries(t).filter(([,{filter:l}])=>l!==void 0).map(([l,{filter:s}])=>[l,s])),[t]);N("filters",r,Object.values(r))},jn=i=>{const{hashParam:e,settingsId:t,data:a,resizeSpeedFactor:n,noLocal:o,noLocalSort:r=o,noLocalFilter:l=o,error:s,rowPartFn:u}=i,m=xn({settingsId:t,host:i}),{settings:c,setSettings:b,columns:p,resetRef:w}=m,h=Di(p,e,c,b,w),{processedItems:v,visibleData:_,filters:g,setFilterState:q,filterFunctions:f}=Bn({data:a,columns:p,hashParam:e,sortAndGroupOptions:h,noLocalSort:r,noLocalFilter:l}),{isMini:y,collapsedColumns:x,miniColumns:C}=In({host:i,columns:p,settings:c,setSettings:b,resizeSpeedFactor:n,sortAndGroupOptions:h}),z=a&&Array.isArray(a)&&a.length>0,[D,H]=T([]);return Gn({host:i,visibleData:_,sortedFilteredGroupedItems:v,columns:p,filters:g,setFilterState:q,selectedItems:D,isMini:y,...h}),{header:On({host:i,selectedItems:D,sortAndGroupOptions:h,dataIsValid:z,data:a,columns:p,filters:g,collapsedColumns:x,settings:c,filterFunctions:f,settingS:m,setFilterState:q,hideSelectAll:i.hideSelectAll===!0}),list:Pn({host:i,error:s,dataIsValid:z,processedItems:v,setSelectedItems:H,columns:p,collapsedColumns:x,miniColumns:C,sortAndGroupOptions:h,rowPartFn:u}),footer:Mn({host:i,selectedItems:D,columns:p})}};customElements.define("cosmoz-grouped-list-row",class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||ke(this._renderFn(this._item,this._index),this)}});const Wn={group:Symbol("group")},Se=(i,e)=>(e.has(i)||e.set(i,{}),e.get(i)),Un=(i,e)=>!!Se(i,e).expanded,Kn=(i,e)=>!!Se(i,e).folded,Me=i=>i?i.items instanceof Array:!1,Jn=i=>{if(!Array.isArray(i)||i.length===0)return;const e=Array.isArray(i[0]?.items);if(!i.every(a=>Array.isArray(a.items)===e))throw new Error("Data must be homogeneous.")},Xn=(i,e,t)=>Array.isArray(i)?(Jn(i),i.reduce((n,o)=>{const r=o;return r.items?r.items.length?Se(o,t).folded?n.concat(o):n.concat(o,r.items.map(l=>Object.assign(l,{[Wn.group]:o}))):e?n.concat(o):n:n.concat(o)},[])):void 0,Qn=(i,...e)=>typeof i=="function"?i(...e):i,Yn=(i,e)=>i===e,Zn=()=>{const[i,e]=T(()=>[new WeakMap]);return{setItemState:$((a,n)=>e(([o])=>{const r=Se(a,o);return Object.assign(r,Qn(n,r)),[o]}),[]),state:i[0],signal:i}},eo=()=>{const{setItemState:i,state:e,signal:t}=Zn(),a=$((o,r)=>{Me(o)&&i(o,l=>({folded:r!==void 0?r:!l.folded}))},[]),n=$((o,r)=>{Me(o)||i(o,l=>({expanded:r!==void 0?!r:!l.expanded}))},[]);return{state:e,signal:t,toggleFold:a,toggleCollapse:n}},to=({initial:i,compareItemsFn:e,data:t,flatData:a})=>{const[n,o]=T(i),[r,l]=T(),s=$(g=>n.includes(g),[n]),u=$(g=>g?.items?.every(s)??!1,[s]),m=$(g=>s(g)||u(g),[s,u]),c=$(g=>{const f=g.items??[g];o(y=>[...y,...f.filter(x=>!y.includes(x))]),l(g)},[]),b=$(g=>{const f=g.items??[g];o(y=>y.filter(x=>!f.includes(x))),l(g)},[]),p=$(g=>{o(g.items?.slice()||[g]),l(g)},[]),w=$(()=>{o(t.flatMap(g=>g.items||g)),l(void 0)},[t]),h=$(()=>{o([]),l(void 0)},[]),v=$((g,q=!m(g))=>q?c(g):b(g),[m]),_=$((g,q)=>{if(!a)return;const f=r?a.findIndex(C=>e(C,r)):-1;if(f<0)return v(g,q);const[y,x]=[f,a.indexOf(g)].sort((C,z)=>C-z);a.slice(y,x+1).forEach((C,z,D)=>{z>0&&z<D.length-1&&Me(C)||v(C,q)}),l(g)},[a,e,v]);return M(()=>o(g=>g.length>0&&a?a.filter(q=>g.find(f=>e(q,f))):g),[a]),{selectedItems:n,isItemSelected:s,isGroupSelected:u,isSelected:m,select:c,deselect:b,selectOnly:p,selectAll:w,deselectAll:h,toggleSelect:v,toggleSelectTo:_}},io={host:{position:"relative",display:"flex",flexDirection:"column"}},ao=i=>{const{data:e,renderItem:t,renderGroup:a,displayEmptyGroups:n,compareItemsFn:o=Yn}=i,{toggleFold:r,toggleCollapse:l,state:s,signal:u}=eo(),m=F(()=>Xn(e,n,s),[e,n,u]),{selectedItems:c,isItemSelected:b,isGroupSelected:p,isSelected:w,select:h,deselect:v,selectOnly:_,selectAll:g,deselectAll:q,toggleSelect:f,toggleSelectTo:y}=to({initial:[],compareItemsFn:o,data:e,flatData:m}),x=$((z,D)=>Array.isArray(z.items)?a(z,D,{selected:p(z),folded:Kn(z,s),toggleSelect:H=>f(z,typeof H=="boolean"?H:void 0),toggleFold:()=>r(z)}):t(z,D,{selected:c.includes(z),expanded:Un(z,s),toggleSelect:H=>f(z,typeof H=="boolean"?H:void 0),toggleCollapse:()=>l(z)}),[t,a,c,f,u]);xt(()=>{Object.assign(i.style,io.host)},[]),N("selectedItems",c);const C={toggleFold:r,toggleCollapse:l,isItemSelected:b,isGroupSelected:p,isSelected:w,select:h,deselect:v,selectOnly:_,selectAll:g,deselectAll:q,toggleSelect:f,toggleSelectTo:y};return Ie(C,Object.values(C)),{renderRow:x,flatData:m}},no=({renderRow:i,flatData:e})=>di({items:e,renderItem:(t,a)=>d`<cosmoz-grouped-list-row
				.item=${t}
				.index=${a}
				.renderFn=${i}
			></cosmoz-grouped-list-row>`}),oo=i=>no(ao(i));customElements.define("cosmoz-grouped-list",O(oo,{useShadowDOM:!1}));const ro=i=>window.ShadyCSS?.ApplyShim?.transformCssText?.(i)||i,lo=i=>{const{header:e,list:t,footer:a}=jn(i);return d`
		<style>
			${mi([],()=>ro(Ka))}
		</style>
