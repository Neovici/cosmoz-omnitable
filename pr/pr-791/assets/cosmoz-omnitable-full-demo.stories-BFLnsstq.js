import{x as c,B as Ie,E as ht,b as Nt}from"./iframe-BwBUM8zk.js";import{t as K,c as E,g as C,P as A,u as M,a as ft,m as bt,s as jt,D as Pt,b as Bt,e as Ht,i as be,h as De,d as Gt,f as Wt,j as qt,k as $,n as Xt,l as Ut,o as xt,p as xe,q as I,r as L,v as me,w as Kt,x as Ae,y as Jt,z as Qt,A as _,B as Yt,C as ye,E as pe,F as V,G as Zt,H as ve,I as en,J as tn,K as nn,T as on,L as yt,M as Ee,N as rn,O as vt,Q as ln,R as Le,S as Ke,U as an,V as Te,W as sn,X as un,Y as Fe,Z as Re,_ as cn,$ as Oe,a0 as P,a1 as dn,a2 as ze,a3 as mn}from"./cosmoz-collapse-iJ9Ra0yp.js";const pn=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
>
	...
	>
		<span>${l}</span> ${Nn}
	</button>`},kt=({columns:n,...e})=>n?.map(t=>St({column:t,...e})),jn=()=>c`
...
`,Bn=["label","value","slot","always-float-label","column"],Hn=Ae`
	${Kt}
...
`,Wn=(n,e)=>c`<div id="input" part="input" role="button" class="control" slot=${e}>
		${n||""}
	</div>`,_t=(n,e,t)=>{if(!e||e.noSort||!t)return n;const{sortOn:o,setSortOn:r,descending:i,setDescending:l}=t,a=St({column:e,on:o,setOn:r,descending:i,setDescending:l});return c`<style>
			${Gn}
		</style>
		${a} ${n}`},qn=({label:n,value:e,slot:t,column:o})=>{const r=xe($e);return Jt(Wn(e,t),{label:_t(n,o,r)})};customElements.define("cosmoz-omnitable-dropdown-input",E(qn,{observedAttributes:Bn,styleSheets:[Hn]}));const ee=({title:n,tooltip:e="",filterText:t="",onOpenedChanged:o,content:r,horizontalAlign:i="left",externalValues:l=null,column:a=null})=>{const s={filtered:!!t,...l!=null&&{[`external-values-${l}`]:!0}};return c`
		<style>
			.dropdown {
				outline: none;
			}
	...
	`};class Xn extends Me(Z(A)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1},column:{type:Object,value:null}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return c`
			<style>
		...
		></cosmoz-omnitable-amount-range-input>`}computeSource(e,t){return Y(e,t)}}customElements.define("cosmoz-omnitable-column-amount",no);const oo=(n,e)=>{if(!Array.isArray(n))return;const t=[];return n.reduce((o,r)=>Array.isArray(r)?(r.forEach(i=>{o.push(i)}),o):(o.push(r),o),[]).filter((o,r,i)=>{if(i.indexOf(o)!==r)return!1;if(e){const l=C(o,e);if(t.indexOf(l)!==-1)return!1;t.push(l)}return!0})},ro=(n,e,t)=>{if(n==null)return[];if(Array.isArray(n))return oo(n,e);if(typeof n=="object"){const o=e??"id",r=t??"label";return Object.entries(n).map(([i,l])=>({[o]:i,[r]:l})).sort((i,l)=>i[r]<l[r]?-1:i[r]>l[r]?1:0)}return[]},Ne=(n,e,t)=>ye(e&&C(n,e)).map(pe(t)),je=({valuePath:n,textProperty:e},t)=>Ne(t,n,e).filter(o=>o!=null).join(", "),io=je,lo=({valueProperty:n,valuePath:e,emptyValue:t,emptyProperty:o},r)=>i=>{const l=pe(n),a=ye(C(i,e));return r.some(s=>a.length===0&&pe(o||n)(s)===t||a.some(u=>l(u)===l(s)))},Pe=n=>e=>n(t=>({...t,filter:e})),Be=n=>e=>n(t=>({...t,headerFocused:e})),He=n=>e=>n(t=>({...t,query:e})),Ft=({emptyValue:n,emptyLabel:e,emptyProperty:t,textProperty:o,valueProperty:r},i)=>{const l=ro(i,r,o);return!e||n===void 0||!o||!(t||r)||!l?l:[{[o]:e,[t||r]:n},...l]},ao=(n,e)=>Ft(n,$t(e,n.valuePath)),Ge=n=>class extends n{static get properties(){return{textProperty:{type:String},valueProperty:{type:String},emptyLabel:{type:String},emptyValue:{type:Object},emptyProperty:{type:String}}}getConfig(e){return{emptyProperty:e.emptyProperty}}getString(e,t){return je(e,t)}toXlsxValue(e,t){return io(e,t)}getComparableValue({valuePath:e,valueProperty:t},o){const r=C(o,e);return t==null?r:ye(r).reduce((l,a)=>(l.push(C(a,t)),l),[]).sort().join(" ")}getFilterFn(e,t){if(!(!t||!Array.isArray(t)||t.length===0))return lo(e,t)}serializeFilter(e,t){return t.length===0?null:JSON.stringify(t)}deserializeFilter(e,t){return JSON.parse(decodeURIComponent(t))}computeSource(e,t){return e.externalValues||typeof e.values=="function"?async(...o)=>Ft(e,await Promise.resolve(be(e.values,...o))):ao(e,t)}},so=({valuePath:n,textProperty:e,valueProperty:t},o)=>{const r=e?Zt(e):pe(t),i=ye(n&&C(o,n)).map(r);return i.length>1?i.filter(Boolean).join(","):i[0]};class uo extends Ge(N(A)){static get properties(){return{headerCellClass:{type:String,value:"autocomplete-header-cell"},minWidth:{type:String,value:"55px"},editMinWidth:{type:String,value:"55px"},keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},showSingle:{type:Boolean},preserveOrder:{type:Boolean},limit:{type:Number},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,showSingle:e.showSingle,preserveOrder:e.preserveOrder,limit:e.limit,textual:e.textual}}renderCell(e,{item:t}){return c`<span class="default-column"
		...
		>`}getComparableValue(e,t){return so(e,t)}}customElements.define("cosmoz-omnitable-column-autocomplete",uo);const We=(n,e)=>e.find(({value:t})=>n===t),co=(n,e,t)=>{const o=We(e,t);return o?o.text:n},tt=(n,e,t,o)=>co(n,C(e,t),o),mo=({valuePath:n},e,t)=>We(C(e,n),t),po=n=>e=>{n(t=>({...t,filter:e?.[0]?.value??null}))},go=n=>e=>{n(t=>({...t,headerFocused:e}))},ho=n=>e=>{n(t=>({...t,query:e}))},fo=n=>e=>n(e?.[0]?.value),nt=({valuePath:n,trueLabel:e,falseLabel:t},o)=>C(o,n)?e:t,bo=({valuePath:n},e)=>t=>C(t,n)===e,re=bt((n,e)=>[{text:n,value:!0},{text:e,value:!1}]),xo=({valuePath:n,trueLabel:e,falseLabel:t},o)=>n?C(o,n)?e:t:"",yo=(n,e)=>{try{return JSON.parse(e)}catch{return null}};class vo extends N(A){static get properties(){return{trueLabel:{type:String,value:"True"},falseLabel:{type:String,value:"False"},flex:{type:String,value:"0"},cellClass:{type:String,value:"boolean-cell"}}}getString(e,t){return nt(e,t)}renderCell(e,{item:t}){return nt(e,t)}renderEditCell(e,{item:t},o){const{trueLabel:r,falseLabel:i}=e;return c`<cosmoz-autocomplete
			no-label-float
			.title=${tt(e.title,t,e.valuePath,re(r,i))}
			.source=${re(r,i)}
			.textProperty=${"text"}
			.value=${mo(e,t,re(r,i))}
			.onChange=${fo(o)}
		...
		>`}computeSource({trueLabel:e,falseLabel:t}){return re(e,t)}getFilterFn(e,t){if(t!=null)return bo(e,t)}toXlsxValue(e,t){return xo(e,t)}deserializeFilter(e,t){return yo(e,t)}}customElements.define("cosmoz-omnitable-column-boolean",vo);const qe=n=>class extends Me(n){static get properties(){return{max:{type:Date,value:null},min:{type:Date,value:null},_filterText:{type:String,computed:"_computeFilterText(filter.*, formatter)"},formatter:{type:Object,computed:"_computeFormatter(locale)"},headerFocused:{type:Boolean,value:!1},column:{type:Object,value:null}}}toDate(e,t,o){if(e==null||e==="")return;let r=e;if(r instanceof Date||(typeof e=="string"&&(r=this.getAbsoluteISOString(r)),r=new Date(r)),Number.isNaN(r.getTime()))return null;if(o==null||t==null)return r;const i=this.toDate(t);if(i==null)return r;const l=this.getComparableValue(r),a=this.getComparableValue(i);return o(l,a)===l?r:i}toValue(){return this.toDate.apply(this,arguments)}getComparableValue(e,t){const o=super.getComparableValue(e,t);if(o!=null)return this.toNumber(o.getTime())}getString(e,t=this.valuePath,o=this.formatter){const r=this.toValue(this.get(t,e));return r===void 0?"":r===null?"Invalid Date":this.renderValue(r,o)}getAbsoluteISOString(e){return e.length===19?e+this._getTimezoneString(e):e}_getTimezoneString(e){const t=-new Date(e).getTimezoneOffset()/60;return(t<0?"-":"+")+["0",Math.abs(t)].join("").substr(-2)+":00"}renderValue(e,t=this.formatter){if(t==null)return;const o=this.toValue(e);if(o!=null)return t.format(o)}_computeFormatter(e){return new Intl.DateTimeFormat(e||void 0)}_toInputString(e){const t=this.toValue(e);return t==null?null:this._toLocalISOString(t).slice(0,10)}_dateValueChanged(e){const t=e.currentTarget,o=t.value,r=e.model.item,i=this.get(this.valuePath,r),l=this._fromInputString(o);this.set(this.valuePath,l,r),this._fireItemChangeEvent(r,this.valuePath,i,this.renderValue.bind(this))}_toLocalISOString(e){return ve(e)}};class $o extends qe(Z(A)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return c`
			...
			${ee({title:this.title,tooltip:this._tooltip,filterText:this._filterText,headerFocused:this.headerFocused,externalValues:this.externalValues,onOpenedChanged:e,column:this.column,content:c`
					...
					></cosmoz-input>
				`})}
		`}_fromInputString(e,t){const o=this.toDate(e);if(o!=null)return t==="min"&&o.setHours(0,0,0,0),t==="max"&&o.setHours(23,59,59),o}_filterInputChanged(e,t){const o=e.path.split(".")[1],r=o&&e.value;if(r&&r.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}}customElements.define("cosmoz-omnitable-date-range-input",$o);const wo=n=>{const e=-new Date(n).getTimezoneOffset()/60;return(e<0?"-":"+")+["0",Math.abs(e)].join("").substr(-2)+":00"},Xe=n=>n.length===19?n+wo(n):n,Ot=n=>{if(n==null||n==="")return;let e=n;return!(e instanceof Date)&&(typeof n=="string"&&(e=Xe(e)),e=en(e),!e)||Number.isNaN(e.getTime())?null:e},j=({valuePath:n},e)=>{if(e==null)return;let t=e;n!=null&&(t=C(e,n));const o=Ot(t);if(o!=null)return T(o.getTime())},D=(n,e,t)=>{const o=Ot(n);return o??null},Ue=(n,e)=>{if(e==null)return;const t=D(n);if(t!=null)return e.format(t)},ie={},zo=n=>{const e=n||"";return ie[e]||(ie[e]=new Intl.DateTimeFormat(n||void 0)),ie[e]},ot=({valuePath:n,locale:e},t)=>{let o=C(t,n||"");return o===void 0?"":(o=D(o),o===null?"Invalid Date":Ue(o,zo(e)))},Vt=n=>{const e=D(n);if(e==null)return null;const t=ve(e);return t==null?null:t.slice(0,10)},Co=({valuePath:n},e)=>Vt(C(e,n||"")),Dt=(n,e)=>{const t=D(n);if(t!=null)return t},rt=n=>{const e=Vt(n);return e??""},So=({valuePath:n},e)=>{if(!n)return"";const t=D(C(e,n));if(!t)return"";const o=D(ve(t));return o?(o.setHours(0,0,0,0),o):""},At=(n,e)=>t=>{const o=j(n,t);if(o==null)return!1;const r=j({...n,valuePath:"min"},e),i=j({...n,valuePath:"max"},e);return!(o<(r??-1/0)||o>(i??1/0))};class ko extends N(A){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"date-header-cell"},width:{type:String,value:"100px"},minWidth:{type:String,value:"82px"},flex:{type:String,value:"0"}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const o=j({...e,valuePath:"min"},t),r=j({...e,valuePath:"max"},t);if(!(o==null&&r==null))return At(e,t)}getString(e,t){return ot(e,t)}toXlsxValue(e,t){return So(e,t)}getComparableValue(e,t){return j(e,t)}serializeFilter(e,t){if(t==null)return;const o=D(t.min),r=D(t.max);if(!(o==null&&r==null))return rt(o)+"~"+rt(r)}deserializeFilter(e,t){if(t==null||t==="")return null;const o=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(o)?{min:D(o[1]),max:D(o[2])}:null}renderCell(e,{item:t}){return c`<div class="omnitable-cell-date">
			${ot(e,t)}
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return Y(e,t)}}customElements.define("cosmoz-omnitable-column-date",ko);class _o extends Ge(N(A)){renderCell({valuePath:e,textProperty:t},{item:o}){const r=Ne(o,e,t).map(i=>c`<li>${i}</li>`);return c`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		`}renderEditCell(){return"not implemented"}renderHeader(e,{filter:t,query:o},r,i){return c`<cosmoz-autocomplete-ui
			...
			.onText=${He(r)}
			>${V(e.loading,()=>c`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}}customElements.define("cosmoz-omnitable-column-list-horizontal",_o);window.Cosmoz=window.Cosmoz||{};class it extends tn(nn(on,A)){static get template(){return De`
			<style>
				:host {
					display: block;
				}
		...
		`}static get is(){return"cosmoz-omnitable-column-list-data"}static get properties(){return{items:{type:Array},_expanded:{type:Boolean,value:!1},_othersCount:{type:Number,computed:"_computeOthersCount(items)"}}}static get observers(){return["_itemsLengthChanged(items.length)"]}_itemsLengthChanged(){requestAnimationFrame(()=>this.dispatchEvent(new CustomEvent("expand",{bubbles:!0})))}_firstItem(e){if(e!=null&&e.length>0)return e[0]}_hideExpand(e,t){return e!==void 0&&e.length!==null?e.length<=2||t:!0}_hideCollapse(e,t){return e!==void 0&&e.length!==null?e.length<=2||!t:!0}_otherItems(e,t){if(e!=null&&(e.length<=2||t))return e.slice(1)}_computeOthersCount(e){if(e!=null)return e.length-1}_toggleExpand(e){this._expanded=!this._expanded,e.stopPropagation(),e.preventDefault()}}customElements.define(it.is,it);class Io extends Ge(N(A)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:o}){return c`<cosmoz-omnitable-column-list-data
			.items=${Ne(o,e,t)}
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:o},r,i){return c`<cosmoz-autocomplete-ui
			...
			.onText=${He(r)}
			>${V(e.loading,()=>c`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}}customElements.define("cosmoz-omnitable-column-list",Io);class Fo extends Me(Z(A)){static get properties(){return{maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null},formatter:{type:Object,computed:"_computeFormatter(locale, minimumFractionDigits, maximumFractionDigits)"},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, formatter)"},headerFocused:{type:Boolean,value:!1},column:{type:Object,value:null}}}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return c`
			<style>
				cosmoz-input[type='number'] {
					background: var(--cosmoz-omnitable-amount-input-background, #ffffff);
					border-radius: 6px;
		...
		></cosmoz-omnitable-number-range-input>`}computeSource(e,t){return Y(e,t)}}customElements.define("cosmoz-omnitable-column-number",Oo);const Et="1970-01-01",H=(n,e,t)=>{const o=typeof n=="string"&&n.length>3&&n.length<=9?Xe(Et+"T"+n):n;return D(o)},le={},Vo=n=>{const e=n||"";if(le[e])return le[e];const t={hour:"numeric",minute:"numeric",second:"numeric"};return le[e]=new Intl.DateTimeFormat(n||void 0,t),le[e]},de=({valuePath:n,locale:e},t)=>{const o=H(C(t,n||""));return o===void 0?"":o===null?"Invalid Date":Ue(o,Vo(e))},Do=(n,e)=>n.valuePath?de(n,e):"",Ao=n=>{const e=H(n);if(e==null)return null;const t=ve(e);return t&&t.slice(11,19)},X=({valuePath:n},e)=>{if(e==null)return;const t=Ao(n==null?e:C(e,n));if(t==null)return;const o=H(Xe(Et+"T"+t));return o==null?o:T(o.getTime())},Eo=(n,e)=>t=>{const o=X(n,t);if(o==null)return!1;const r=X({...n,valuePath:"min"},e),i=X({...n,valuePath:"max"},e);return r==null||i==null?!1:!(o<r||o>i)},lt=n=>{const e=H(n);return e==null?"":e.toISOString().slice(11,19).replace(/:/gu,".")},at=n=>{if(!(n==null||n===""))return H(typeof n=="string"?n.replace(/\./gu,":")+"Z":n)};class Lo extends qe(Z(A)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return c`
			<cosmoz-clear-button
				@click=${()=>this.resetFilter()}
				?visible=${this.hasFilter()}
			></cosmoz-clear-button>
		...
		></cosmoz-input>`}renderHeader({title:e,min:t,max:o,locale:r,filterStep:i,noSort:l,name:a},{filter:s},u,m){return c`<cosmoz-omnitable-time-range-input
			...
			@filter-changed=${({detail:{value:d}})=>u(g=>({...g,filter:d}))}
			@header-focused-changed=${({detail:{value:d}})=>u(g=>({...g,headerFocused:d}))}
		></cosmoz-omnitable-time-range-input>`}computeSource(e,t){return Y(e,t)}}customElements.define("cosmoz-omnitable-column-time",To);const ae={},Ro=n=>{const e=n||"";if(ae[e])return ae[e];const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return ae[e]=new Intl.DateTimeFormat(n||void 0,t),ae[e]},Se=({valuePath:n,locale:e},t)=>{const o=D(C(t,n||""));return o===void 0?"":o===null?"Invalid Date":Ue(o,Ro(e))},Mo=({valuePath:n},e)=>n?C(e,n):"",st=n=>{const e=D(n);return e==null?"":e.toISOString().slice(0,19).replace(/:/gu,".")},ut=n=>{if(!(n==null||n==="")&&typeof n=="string")return D(n.replace(/\./gu,":")+"Z")};class No extends qe(Z(A)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return c`
			<style>
			...
			${ee({title:this.title,tooltip:this._tooltip,filterText:this._filterText,headerFocused:this.headerFocused,externalValues:this.externalValues,onOpenedChanged:e,column:this.column,content:c`
					...
					></cosmoz-datetime-input>
				`})}
		`}_toInputString(e){const t=this.toValue(e);if(t!=null)return this._toLocalISOString(t).slice(0,19)}_computeFormatter(e){const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return new Intl.DateTimeFormat(e||void 0,t)}}customElements.define("cosmoz-omnitable-datetime-range-input",No);class ct extends N(A){static get is(){return"cosmoz-omnitable-column-datetime"}static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"datetime-header-cell"},width:{type:String,value:"210px"},minWidth:{type:String,value:"128px"},flex:{type:String,value:"0"},filterStep:{type:Number,value:1}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const o=j({...e,valuePath:"min"},t),r=j({...e,valuePath:"max"},t);if(!(o==null&&r==null))return At(e,t)}getString(e,t){return Se(e,t)}toXlsxValue(e,t){return Mo(e,t)}getComparableValue(e,t){return j(e,t)}serializeFilter(e,t){if(t==null)return;const o=D(t.min),r=D(t.max);if(!(o==null&&r==null))return st(o)+"~"+st(r)}deserializeFilter(e,t){if(t==null||t==="")return null;const o=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(o)?{min:ut(o[1]),max:ut(o[2])}:null}renderCell(e,{item:t}){return Se(e,t)}renderEditCell(e,{item:t},o){return c`<cosmoz-input
			no-label-float
			type="text"
			@change=${i=>o(Dt(i.target.value))}
			.value=${Se(e,t)}
		...
		></cosmoz-omnitable-datetime-range-input>`}computeSource(e,t){return Y(e,t)}}customElements.define(ct.is,ct);const jo=({column:n,item:e,selected:t,folded:o,group:r})=>n?(n.renderGroup??n.renderCell)(n,{item:e,selected:t,folded:o,group:r}):ht;customElements.define("cosmoz-omnitable-group-row",E(jo,{useShadowDOM:!1}));const Po=n=>{const{column:e}=n;return L(()=>{let t=0,o=0;const r=a=>{n.dispatchEvent(new CustomEvent("column-resize",{bubbles:!0,composed:!0,detail:{newWidth:Math.ceil(o+a.pageX-t),column:e}}))},i=()=>{document.removeEventListener("pointermove",r),document.removeEventListener("pointerup",i)},l=a=>{t=a.pageX,o=n.previousElementSibling.getBoundingClientRect().width,document.addEventListener("pointermove",r),document.addEventListener("pointerup",i)};return n.addEventListener("pointerdown",l),()=>n.removeEventListener("pointerdown",l)},[e]),ht};customElements.define("cosmoz-omnitable-resize-nub",E(Po));const Bo=({data:n,columns:e,groupOnColumn:t,filters:o,setFilterState:r,sortAndGroup:i})=>yt(e,l=>l.name,l=>[c`<div
			...
			>
				...
				.column="${l}"
				name="${l.name}"
			></cosmoz-omnitable-resize-nub>`]),Ho=({columns:n,settingsConfig:e,hideSelectAll:t,...o})=>{const r=xe($e);return c`
...
`;customElements.define("cosmoz-omnitable-item-expand-line",E(Wo,{styleSheets:[Ee(Go)]}));const qo=({columns:n,item:e,selected:t,expanded:o,groupOnColumn:r})=>rn(n,i=>c`<cosmoz-omnitable-item-expand-line
				.column=${i}
				?hidden=${i===r}
				exportparts="item-expand-label, item-expand-value"
				>${i.renderCell(i,{item:e,selected:t,expanded:o})}</cosmoz-omnitable-item-expand-line
			>`);customElements.define("cosmoz-omnitable-item-expand",E(qo,{useShadowDOM:!1}));const Xo=(n,e,t)=>n.editable?n.renderEditCell(n,e,t(n,e.item)):n.renderCell(n,e),Uo=({columns:n,groupOnColumn:e,item:t,index:o,selected:r,expanded:i,onItemChange:l})=>yt(n,a=>a.name,a=>c`<div
...
`,dt=n=>{const e=n.replace(/"/gu,'""');return e.search(/("|,|\n)/gu)>=0?'"'+e+'"':n},Jo=(n,e,t)=>{const i=n.map(a=>dt(a.title)).join(";")+`
`,l=e.map(a=>n.map(s=>{const u=s.getString(s,a);return u==null?"":dt(String(u))}).join(";")+`
`);l.unshift(i),vt(new File(l,t,{type:"text/csv;charset=utf-8"}))},Qo=(n,e)=>{const t=n.map(r=>r.title),o=e.map(r=>n.map(i=>{const l=i.toXlsxValue(i,r);return l??""}));return o.unshift(t),o},Yo=(n,e,t,o)=>{const r=Qo(n,e),i=new ln(t).addSheetFromData(r,o).generate();vt(new File([i],t,{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}))},Zo=({columns:n,selectedItems:e,csvFilename:t,xlsxFilename:o,xlsxSheetname:r,topPlacement:i})=>c`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!Le(e.length)}
		part="bottomBar"
...
`,se=n=>{const e=parseInt(n,10);return isFinite(e)?e:void 0},ar=n=>{const{config:e}=n,{settings:t,setSettings:o,collapsed:r}=e,i=Te({collapsed:r,settings:t.columns,setSettings:$(l=>o(a=>({...a,columns:l})),[o])});return{...e,onDown:$(l=>{l.target.closest(".pull")&&(i.handle=l.currentTarget)},[i]),onDragStart:$(l=>{const{target:a}=l,s=se(a.dataset.index);if(!i.handle?.contains(a)||s==null)return l.preventDefault();i.handle=null,l.dataTransfer.effectAllowed="move",l.dataTransfer.setData("omnitable/sort-index",s),l.dataTransfer.setData("text/plain",s),setTimeout(()=>a.classList.add("drag"),0),a.addEventListener("dragend",u=>u.target.classList.remove("drag"),{once:!0})},[i]),onDragEnter:$(l=>{const a=l.currentTarget;a===l.target&&(l.preventDefault(),l.dataTransfer.dropEffect="move",a.classList.add("dragover"))},[]),onDragOver:$(l=>{l.preventDefault(),l.currentTarget.classList.add("dragover")},[]),onDragLeave:$(l=>{const a=l.currentTarget;a.contains(l.relatedTarget)||a.classList.remove("dragover")},[]),onDrop:$(l=>{const a=se(l.dataTransfer.getData("omnitable/sort-index")),s=se(l.currentTarget.dataset.index),{settings:u,setSettings:m}=i;l.currentTarget.classList.remove("dragover"),l.preventDefault();const d=u.slice();d.splice(s+(a>=s?0:-1),0,d.splice(a,1)[0]),m(d)},[i]),onToggle:$(l=>{const{settings:a,setSettings:s}=i,u=a.map(d=>({...d,disabled:d.disabled||i.collapsed?.some(g=>g.name===d.name)})),m=se(l.target.closest("[data-index]")?.dataset.index);u.splice(m,1,{...a[m],disabled:!l.target.checked,priority:l.target.checked?a.reduce((d,g)=>Math.max(d,g.priority),0)+1:a[m].priority}),s(u)},[i])}},sr=[sn({apply({availableHeight:n,elements:e}){Object.assign(e.floating.style,{maxHeight:`${Math.max(0,n)}px`})}}),...un],ur=({onDragStart:n,onDragEnter:e,onDragOver:t,onDragLeave:o,onDrop:r,onDown:i,onToggle:l,collapsed:a,filters:s})=>(u,m)=>{const d=!!a?.find(p=>p.name===u.name),g=!u.disabled&&!d;return c` <div
		...
		<div class="contents">
			...
			<cosmoz-collapse ?opened=${l.sort}> ${Pn()} </cosmoz-collapse>
		...
		${V(t,()=>c`<div class="buttons">
				...
				</div>`)}`};customElements.define("cosmoz-omnitable-settings-ui",E(cr,{styleSheets:[Ee(ir)]}));const dr=({config:n,newLayout:e})=>c`
	<cosmoz-dropdown
...
`;c(Object.assign([fe],{raw:[fe]}));De(Object.assign([fe],{raw:[fe]}));const ui=()=>c`<style>
	@keyframes rotating {
		100% {
