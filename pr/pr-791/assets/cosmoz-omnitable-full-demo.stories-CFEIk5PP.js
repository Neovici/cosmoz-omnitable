import{x as d,B as Ie,E as bt,f as Pt}from"./iframe-BdGcfk9Y.js";import{t as K,c as E,g as S,P as A,u as M,a as xt,m as yt,s as Bt,D as Ht,b as Gt,e as Wt,i as ye,h as Ae,d as qt,f as Xt,j as Ut,k as w,n as Kt,l as Jt,o as vt,p as Ee,q as I,r as T,v as Fe,w as Qt,x as $t,y as Yt,z as Zt,A as _,B as en,C as ve,E as he,F as D,G as tn,H as $e,I as nn,J as on,K as rn,T as an,L as wt,M as Te,N as ln,O as zt,Q as sn,R as Le,S as Qe,U as un,V as Re,W as cn,X as dn,Y as Oe,Z as Me,_ as mn,$ as De,a0 as P,a1 as pn,a2 as ze,a3 as gn}from"./cosmoz-collapse-CKbFadSh.js";import"./preload-helper-PPVm8Dsz.js";const hn=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
>
	...
	/>
</svg> `,It=({column:n,on:e,descending:t,setOn:o,setDescending:r})=>{const{name:i,title:a}=n??{};return d`<button
		class="sg"
		title=${a}
	...
	>
		<span>${a}</span> ${Pn}
	</button>`},Ft=({columns:n,...e})=>n?.map(t=>It({column:t,...e})),Bn=()=>d`
...
`,qn=(n,e)=>d`<div id="input" part="input" role="button" class="control" slot=${e}>
		${n||""}
	</div>`,Xn=(n,e,t)=>{if(!e||e.noSort||!t)return n;const{sortOn:o,setSortOn:r,descending:i,setDescending:a}=t,l=It({column:e,on:o,setOn:r,descending:i,setDescending:a});return d`${l} ${n}`},Un=({label:n,value:e,slot:t,column:o})=>{const r=Ee(je);return Yt(qn(e,t),{label:Xn(n,o,r)})};customElements.define("cosmoz-omnitable-dropdown-input",E(Un,{observedAttributes:Gn,styleSheets:[Wn]}));const ee=({title:n,tooltip:e="",filterText:t="",onOpenedChanged:o,content:r,horizontalAlign:i="left",externalValues:a=null,column:l=null})=>{const s={filtered:!!t,...a!=null&&{[`external-values-${a}`]:!0}};return d`
		<style>
			.dropdown {
				outline: none;
			}
	...
	`};class Kn extends Ne(Z(A)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1},column:{type:Object,value:null}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return d`
		...
		</cosmoz-input>`}renderHeader({title:e,min:t,max:o,limits:r,locale:i,rates:a,currency:l,autoupdate:s,autodetect:u,noSort:m},{filter:c},h,p){return d`<cosmoz-omnitable-amount-range-input
			.title=${e}
			.filter=${c}
			.values=${p}
			.rates=${a}
		...
		`}_fromInputString(e,t){const o=this.toDate(e);if(o!=null)return t==="min"&&o.setHours(0,0,0,0),t==="max"&&o.setHours(23,59,59),o}_filterInputChanged(e,t){const o=e.path.split(".")[1],r=o&&e.value;if(r&&r.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}}customElements.define("cosmoz-omnitable-date-range-input",zo);const So=n=>{const e=-new Date(n).getTimezoneOffset()/60;return(e<0?"-":"+")+["0",Math.abs(e)].join("").substr(-2)+":00"},Ke=n=>n.length===19?n+So(n):n,Vt=n=>{if(n==null||n==="")return;let e=n;return!(e instanceof Date)&&(typeof n=="string"&&(e=Ke(e)),e=nn(e),!e)||Number.isNaN(e.getTime())?null:e},j=({valuePath:n},e)=>{if(e==null)return;let t=e;n!=null&&(t=S(e,n));const o=Vt(t);if(o!=null)return L(o.getTime())},V=(n,e,t)=>{const o=Vt(n);return o??null},Je=(n,e)=>{if(e==null)return;const t=V(n);if(t!=null)return e.format(t)},ie={},Co=n=>{const e=n||"";return ie[e]||(ie[e]=new Intl.DateTimeFormat(n||void 0)),ie[e]},it=({valuePath:n,locale:e},t)=>{let o=S(t,n||"");return o===void 0?"":(o=V(o),o===null?"Invalid Date":Je(o,Co(e)))},At=n=>{const e=V(n);if(e==null)return null;const t=$e(e);return t==null?null:t.slice(0,10)},ko=({valuePath:n},e)=>At(S(e,n||"")),Et=(n,e)=>{const t=V(n);if(t!=null)return t},at=n=>{const e=At(n);return e??""},_o=({valuePath:n},e)=>{if(!n)return"";const t=V(S(e,n));if(!t)return"";const o=V($e(t));return o?(o.setHours(0,0,0,0),o):""},Tt=(n,e)=>t=>{const o=j(n,t);if(o==null)return!1;const r=j({...n,valuePath:"min"},e),i=j({...n,valuePath:"max"},e);return!(o<(r??-1/0)||o>(i??1/0))};class Io extends N(A){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"date-header-cell"},width:{type:String,value:"100px"},minWidth:{type:String,value:"82px"},flex:{type:String,value:"0"}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const o=j({...e,valuePath:"min"},t),r=j({...e,valuePath:"max"},t);if(!(o==null&&r==null))return Tt(e,t)}getString(e,t){return it(e,t)}toXlsxValue(e,t){return _o(e,t)}getComparableValue(e,t){return j(e,t)}serializeFilter(e,t){if(t==null)return;const o=V(t.min),r=V(t.max);if(!(o==null&&r==null))return at(o)+"~"+at(r)}deserializeFilter(e,t){if(t==null||t==="")return null;const o=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(o)?{min:V(o[1]),max:V(o[2])}:null}renderCell(e,{item:t}){return d`<div class="omnitable-cell-date">
			...
			.value=${ko(e,t)}
		></cosmoz-input>`}renderHeader({title:e,min:t,max:o,limits:r,locale:i,noSort:a},{filter:l},s,u){return d`<cosmoz-omnitable-date-range-input
			.title=${e}
			.filter=${l}
			.values=${u}
			.min=${t}
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return Y(e,t)}}customElements.define("cosmoz-omnitable-column-date",Io);class Fo extends qe(N(A)){renderCell({valuePath:e,textProperty:t},{item:o}){const r=Pe(o,e,t).map(i=>d`<li>${i}</li>`);return d`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		`}_computeFormatter(e,t,o){const r={localeMatcher:"best fit"};return t!==null&&(r.minimumFractionDigits=t),o!==null&&(r.maximumFractionDigits=o),new Intl.NumberFormat(e||void 0,r)}getComparableValue(e,t){if(e==null)return;let o=e;if(t!=null&&(o=this.get(t,e)),o=this.toValue(o),o==null)return;const r=this.maximumFractionDigits;return r!==null?this.toValue(o.toFixed(r)):o}renderValue(e,t=this.formatter){const o=this.toNumber(e);if(o!=null)return t.format(o)}}customElements.define("cosmoz-omnitable-number-range-input",Do);class Vo extends N(A){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},autoupdate:{type:Boolean,value:!1,notify:!0},cellClass:{type:String,value:"number-cell align-right"},width:{type:String,value:"30px"},minWidth:{type:String,value:"30px"},headerCellClass:{type:String,value:"number-header-cell"},maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const o=W({...e,valuePath:"min"},t),r=W({...e,valuePath:"max"},t);if(!(o==null&&r==null))return Yn(e,t)}getString(e,t){return Ze(e,t)}toXlsxValue({valuePath:e},t){return S(t,e)}getComparableValue(e,t){return W(e,t)}serializeFilter(e,t){if(t==null)return;const o=L(t.min),r=L(t.max);if(!(o==null&&r==null))return Ye(o)+"~"+Ye(r)}deserializeFilter(e,t){if(t==null||t==="")return null;const o=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(o)?{min:L(o[1]),max:L(o[2])}:null}renderCell(e,{item:t}){return d`<div class="omnitable-cell-number">
			...
			@change=${i=>o(i.target.value)}
			.value=${Jn(e,t)}
		></cosmoz-input>`}renderHeader({title:e,min:t,max:o,limits:r,locale:i,maximumFractionDigits:a,minimumFractionDigits:l,autoupdate:s,noSort:u},{filter:m},c,h){return d`<cosmoz-omnitable-number-range-input
			.title=${e}
			.filter=${m}
			.values=${h}
			.min=${t}
		...
		`}get _fixedDate(){return"1970-01-01"}toDate(e,t,o){const r=typeof e=="string"&&e.length>3&&e.length<=9?this.getAbsoluteISOString(this._fixedDate+"T"+e):e;return super.toDate(r,t,o)}_toInputString(e){const t=this.toValue(e);return t==null?null:this._toLocalISOString(t).slice(11,19)}getComparableValue(e,t){if(e==null)return;let o=this._toInputString(t==null?e:this.get(t,e));if(o!=null&&(o=this.toValue(this.getAbsoluteISOString(this._fixedDate+"T"+o)),o!=null))return this.toNumber(o.getTime())}_timeValueChanged(e){const t=e.target,o=t.value,r=e.model.item,i=this.toDate(r.date),a=this.toDate(i!=null?i.toISOString().slice(0,10)+"T"+o:o),l=s=>s;a==null&&(this.set(this.valuePath,a,r),this._fireItemChangeEvent(r,this.valuePath,i,l.bind(this)))}_computeFormatter(e){const t={hour:"numeric",minute:"numeric",second:"numeric"};return new Intl.DateTimeFormat(e||void 0,t)}}customElements.define("cosmoz-omnitable-time-range-input",Ro);class Mo extends N(A){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"time-header-cell"},minWidth:{type:String,value:"63px"},width:{type:String,value:"210px"},flex:{type:String,value:"0"},filterStep:{type:String,value:"1"}}}getFilterFn(e,t){const o=X({...e,valuePath:"min"},t),r=X({...e,valuePath:"max"},t);if(!(o==null&&r==null))return Lo(e,t)}getString(e,t){return ge(e,t)}toXlsxValue(e,t){return Eo(e,t)}getComparableValue(e,t){return X(e,t)}serializeFilter(e,t){if(t==null)return;const o=H(t.min),r=H(t.max);if(!(o==null&&r==null))return st(o)+"~"+st(r)}deserializeFilter(e,t){if(t==null||t==="")return null;const o=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(o)?{min:ut(o[1]),max:ut(o[2])}:null}renderCell(e,{item:t}){return ge(e,t)}renderEditCell(e,{item:t},o){return d`<cosmoz-input
			...
			@change=${i=>o(i.target.value)}
			.value=${ge(e,t)}
		></cosmoz-input>`}renderHeader({title:e,min:t,max:o,locale:r,filterStep:i,noSort:a},{filter:l},s,u){return d`<cosmoz-omnitable-time-range-input
			.title=${e}
			.filter=${l}
			.values=${u}
			.min=${t}
		...
		></cosmoz-omnitable-time-range-input>`}computeSource(e,t){return Y(e,t)}}customElements.define("cosmoz-omnitable-column-time",Mo);const le={},No=n=>{const e=n||"";if(le[e])return le[e];const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return le[e]=new Intl.DateTimeFormat(n||void 0,t),le[e]},Ce=({valuePath:n,locale:e},t)=>{const o=V(S(t,n||""));return o===void 0?"":o===null?"Invalid Date":Je(o,No(e))},jo=({valuePath:n},e)=>n?S(e,n):"",ct=n=>{const e=V(n);return e==null?"":e.toISOString().slice(0,19).replace(/:/gu,".")},dt=n=>{if(!(n==null||n==="")&&typeof n=="string")return V(n.replace(/\./gu,":")+"Z")};class Po extends Ue(Z(A)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return d`
			...
			${ee({title:this.title,tooltip:this._tooltip,filterText:this._filterText,headerFocused:this.headerFocused,horizontalAlign:"right",externalValues:this.externalValues,onOpenedChanged:e,column:this.column,content:d`
					...
					></cosmoz-datetime-input>
				`})}
		`}_toInputString(e){const t=this.toValue(e);if(t!=null)return this._toLocalISOString(t).slice(0,19)}_computeFormatter(e){const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return new Intl.DateTimeFormat(e||void 0,t)}}customElements.define("cosmoz-omnitable-datetime-range-input",Po);class mt extends N(A){static get is(){return"cosmoz-omnitable-column-datetime"}static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"datetime-header-cell"},width:{type:String,value:"210px"},minWidth:{type:String,value:"128px"},flex:{type:String,value:"0"},filterStep:{type:Number,value:1}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const o=j({...e,valuePath:"min"},t),r=j({...e,valuePath:"max"},t);if(!(o==null&&r==null))return Tt(e,t)}getString(e,t){return Ce(e,t)}toXlsxValue(e,t){return jo(e,t)}getComparableValue(e,t){return j(e,t)}serializeFilter(e,t){if(t==null)return;const o=V(t.min),r=V(t.max);if(!(o==null&&r==null))return ct(o)+"~"+ct(r)}deserializeFilter(e,t){if(t==null||t==="")return null;const o=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(o)?{min:dt(o[1]),max:dt(o[2])}:null}renderCell(e,{item:t}){return Ce(e,t)}renderEditCell(e,{item:t},o){return d`<cosmoz-input
			no-label-float
			type="text"
			@change=${i=>o(Et(i.target.value))}
			.value=${Ce(e,t)}
		></cosmoz-input>`}renderHeader({title:e,min:t,max:o,limits:r,locale:i,filterStep:a,noSort:l},{filter:s},u,m){return d`<cosmoz-omnitable-datetime-range-input
			.title=${e}
			.filter=${s}
			.values=${m}
			.min=${t}
		...
		></cosmoz-omnitable-datetime-range-input>`}computeSource(e,t){return Y(e,t)}}customElements.define(mt.is,mt);const Bo=({column:n,item:e,selected:t,folded:o,group:r})=>n?(n.renderGroup??n.renderCell)(n,{item:e,selected:t,folded:o,group:r}):bt;customElements.define("cosmoz-omnitable-group-row",E(Bo,{useShadowDOM:!1}));const Ho=n=>{const{column:e}=n;return T(()=>{let t=0,o=0;const r=l=>{n.dispatchEvent(new CustomEvent("column-resize",{bubbles:!0,composed:!0,detail:{newWidth:Math.ceil(o+l.pageX-t),column:e}}))},i=()=>{document.removeEventListener("pointermove",r),document.removeEventListener("pointerup",i)},a=l=>{t=l.pageX,o=n.previousElementSibling.getBoundingClientRect().width,document.addEventListener("pointermove",r),document.addEventListener("pointerup",i)};return n.addEventListener("pointerdown",a),()=>n.removeEventListener("pointerdown",a)},[e]),bt};customElements.define("cosmoz-omnitable-resize-nub",E(Ho));const Go=({data:n,columns:e,groupOnColumn:t,filters:o,setFilterState:r})=>wt(e,i=>i.name,i=>[d`<div
			...
			>
				...
				.column="${i}"
				name="${i.name}"
			></cosmoz-omnitable-resize-nub>`]),Wo=({columns:n,settingsConfig:e,hideSelectAll:t,...o})=>d`
...
`;customElements.define("cosmoz-omnitable-item-expand-line",E(Xo,{styleSheets:[Te(qo)]}));const Uo=({columns:n,item:e,selected:t,expanded:o,groupOnColumn:r})=>ln(n,i=>d`<cosmoz-omnitable-item-expand-line
				.column=${i}
				?hidden=${i===r}
				exportparts="item-expand-label, item-expand-value"
				>${i.renderCell(i,{item:e,selected:t,expanded:o})}</cosmoz-omnitable-item-expand-line
			>`);customElements.define("cosmoz-omnitable-item-expand",E(Uo,{useShadowDOM:!1}));const Ko=(n,e,t)=>n.editable?n.renderEditCell(n,e,t(n,e.item)):n.renderCell(n,e),Jo=({columns:n,groupOnColumn:e,item:t,index:o,selected:r,expanded:i,onItemChange:a})=>wt(n,l=>l.name,l=>d`<div
...
`);a.unshift(i),zt(new File(a,t,{type:"text/csv;charset=utf-8"}))},Zo=(n,e)=>{const t=n.map(r=>r.title),o=e.map(r=>n.map(i=>{const a=i.toXlsxValue(i,r);return a??""}));return o.unshift(t),o},er=(n,e,t,o)=>{const r=Zo(n,e),i=new sn(t).addSheetFromData(r,o).generate();zt(new File([i],t,{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}))},tr=({columns:n,selectedItems:e,csvFilename:t,xlsxFilename:o,xlsxSheetname:r,topPlacement:i})=>d`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!Le(e.length)}
		part="bottomBar"
	...
	>
	...
	</cosmoz-bottom-bar>`,nr=({allSelected:n,onAllCheckboxChange:e,sortAndGroup:t,dataIsValid:o,data:r,columns:i,filters:a,groupOnColumn:l,setFilterState:s,settingsConfig:u,hideSelectAll:m})=>d`<sort-and-group-provider .value=${t}>
		<div class="header" id="header" part="header">
			${D(!m,()=>d`<input
						...
						part="all"
					/>`)}
			${D(m,()=>d` <cosmoz-omnitable-settings
						.newLayout="${!0}"
						.config=${u}
					></cosmoz-omnitable-settings>`)}
...
`,rr=({settingsConfig:n})=>{const{columns:e,collapsed:t}=n,o=e.filter(r=>!t.some(i=>i.name===r.name));return d`<div class="skeleton">
	...
	</div>`};customElements.define("cosmoz-omnitable-skeleton",E(rr,{styleSheets:[or]}));const ir=({slot:n,title:e,className:t,width:o="24",height:r="24",styles:i}={})=>d`
  <svg
    slot=${Fe(n)}
    class=${`delete-icon ${t??""}`}
    viewBox="0 0 24 24"
...
`,ar=(n,e)=>{const{settingsConfig:t}=n,{processedItems:o,dataIsValid:r,filterIsTooStrict:i,loading:a,displayEmptyGroups:l,compareItemsFn:s,setSelectedItems:u,renderItem:m,renderGroup:c,error:h}=e;return d`${D(!a&&!r&&!h,()=>d`<div class="tableContent-empty">
...
`,se=n=>{const e=parseInt(n,10);return isFinite(e)?e:void 0},ur=n=>{const{config:e}=n,{settings:t,setSettings:o,collapsed:r}=e,i=Re({collapsed:r,settings:t.columns,setSettings:w(a=>o(l=>({...l,columns:a})),[o])});return{...e,onDown:w(a=>{a.target.closest(".pull")&&(i.handle=a.currentTarget)},[i]),onDragStart:w(a=>{const{target:l}=a,s=se(l.dataset.index);if(!i.handle?.contains(l)||s==null)return a.preventDefault();i.handle=null,a.dataTransfer.effectAllowed="move",a.dataTransfer.setData("omnitable/sort-index",s),a.dataTransfer.setData("text/plain",s),setTimeout(()=>l.classList.add("drag"),0),l.addEventListener("dragend",u=>u.target.classList.remove("drag"),{once:!0})},[i]),onDragEnter:w(a=>{const l=a.currentTarget;l===a.target&&(a.preventDefault(),a.dataTransfer.dropEffect="move",l.classList.add("dragover"))},[]),onDragOver:w(a=>{a.preventDefault(),a.currentTarget.classList.add("dragover")},[]),onDragLeave:w(a=>{const l=a.currentTarget;l.contains(a.relatedTarget)||l.classList.remove("dragover")},[]),onDrop:w(a=>{const l=se(a.dataTransfer.getData("omnitable/sort-index")),s=se(a.currentTarget.dataset.index),{settings:u,setSettings:m}=i;a.currentTarget.classList.remove("dragover"),a.preventDefault();const c=u.slice();c.splice(s+(l>=s?0:-1),0,c.splice(l,1)[0]),m(c)},[i]),onToggle:w(a=>{const{settings:l,setSettings:s}=i,u=l.map(c=>({...c,disabled:c.disabled||i.collapsed?.some(h=>h.name===c.name)})),m=se(a.target.closest("[data-index]")?.dataset.index);u.splice(m,1,{...l[m],disabled:!a.target.checked,priority:a.target.checked?l.reduce((c,h)=>Math.max(c,h.priority),0)+1:l[m].priority}),s(u)},[i])}},cr=[cn({apply({availableHeight:n,elements:e}){Object.assign(e.floating.style,{maxHeight:`${Math.max(0,n)}px`})}}),...dn],dr=({onDragStart:n,onDragEnter:e,onDragOver:t,onDragLeave:o,onDrop:r,onDown:i,onToggle:a,collapsed:l,filters:s})=>(u,m)=>{const c=!!l?.find(p=>p.name===u.name),h=!u.disabled&&!c;return d` <div
		...
		>
			...
			<input
				...
				.indeterminate=${c}
			/>
		</div>`},mr=n=>{const{settings:e,settingsId:t,onSave:o,onReset:r,hasChanges:i,opened:a,setOpened:l,...s}=ur(n);return d` <div class="headline">
			${_("Sort and filter")}
			<button
				class="close"
		...
		${D(t,()=>d`<div class="buttons">
				...
				</div>`)}`};customElements.define("cosmoz-omnitable-settings-ui",E(mr,{styleSheets:[Te(lr)]}));const pr=({config:n,newLayout:e})=>d`
	<cosmoz-dropdown
...
`,Mr=n=>n?"groupRow groupRow-folded":"groupRow",Nr=({item:n,index:e})=>t=>D(t?.length>0,()=>d`
			...
			`),jr=({columns:n,collapsedColumns:e,miniColumns:t,onItemClick:o,onCheckboxChange:r,dataIsValid:i,groupOnColumn:a,onItemChange:l,rowPartFn:s})=>(u,m,{selected:c,expanded:h,toggleCollapse:p})=>d`
		<div
			?selected=${c}
	...
	`,Pr=({onCheckboxChange:n,dataIsValid:e,groupOnColumn:t})=>(o,r,{selected:i,folded:a,toggleFold:l})=>d` <div
			class="${Mr(a)}"
...
`;d(Object.assign([xe],{raw:[xe]}));Ae(Object.assign([xe],{raw:[xe]}));const di=()=>d`<style>
	@keyframes rotating {
		100% {
