import{x as d,B as qe,E as pt}from"./iframe-CMF0zCY9.js";import{t as K,c as O,g as S,P as M,u as T,a as gt,m as bt,s as Dt,D as Tt,b as Vt,e as Pt,i as fe,h as _e,d as Nt,f as Rt,j as Bt,k as $,n as Ht,l as Gt,o as ft,p as ke,q as F,r as E,v as Ue,w as jt,x as ht,y as Wt,z as Ut,A as z,B as Kt,C as he,E as me,F as k,G as Jt,H as xe,I as Xt,J as Qt,K as Yt,T as Zt,L as xt,M as Ie,N as ei,O as vt,Q as ti,R as Me,S as Ke,U as ii,V as Ee,W as ai,X as ni,Y as Ae,Z as Oe,_ as oi,$ as ze,a0 as N,a1 as ri,a2 as ye,a3 as li}from"./cosmoz-collapse-CoU8qQTx.js";const si=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,Pi=(i,e)=>d`<div id="input" part="input" role="button" class="control" slot=${e}>
		${i||""}
	</div>`,Ni=(i,e,t)=>{if(!e||e.noSort||!t)return i;const{sortOn:a,setSortOn:n,descending:o,setDescending:r}=t,l=St({column:e,on:a,setOn:n,descending:o,setDescending:r});return d`${l} ${i}`},Ri=({label:i,value:e,slot:t,column:a})=>{const n=ke(De);return Wt(Pi(e,t),{label:Ni(i,a,n)})};customElements.define("cosmoz-omnitable-dropdown-input",O(Ri,{observedAttributes:Ti,styleSheets:[Vi]}));const Z=({title:i,tooltip:e="",filterText:t="",onOpenedChanged:a,content:n,horizontalAlign:o="left",externalValues:r=null,column:l=null})=>{const s={filtered:!!t,...r!=null&&{[`external-values-${r}`]:!0}};return d`
		<style>
			.dropdown {
				outline: none;
			}
	...
	`};class Bi extends Le(Y(M)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1},column:{type:Object,value:null}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return d`
		...
		>`}computeSource({trueLabel:e,falseLabel:t}){return ne(e,t)}getFilterFn(e,t){if(t!=null)return ca(e,t)}toXlsxValue(e,t){return ma(e,t)}deserializeFilter(e,t){return pa(e,t)}}customElements.define("cosmoz-omnitable-column-boolean",ga);const Ge=i=>class extends Le(i){static get properties(){return{max:{type:Date,value:null},min:{type:Date,value:null},_filterText:{type:String,computed:"_computeFilterText(filter.*, formatter)"},formatter:{type:Object,computed:"_computeFormatter(locale)"},headerFocused:{type:Boolean,value:!1},column:{type:Object,value:null}}}toDate(e,t,a){if(e==null||e==="")return;let n=e;if(n instanceof Date||(typeof e=="string"&&(n=this.getAbsoluteISOString(n)),n=new Date(n)),Number.isNaN(n.getTime()))return null;if(a==null||t==null)return n;const o=this.toDate(t);if(o==null)return n;const r=this.getComparableValue(n),l=this.getComparableValue(o);return a(r,l)===r?n:o}toValue(){return this.toDate.apply(this,arguments)}getComparableValue(e,t){const a=super.getComparableValue(e,t);if(a!=null)return this.toNumber(a.getTime())}getString(e,t=this.valuePath,a=this.formatter){const n=this.toValue(this.get(t,e));return n===void 0?"":n===null?"Invalid Date":this.renderValue(n,a)}getAbsoluteISOString(e){return e.length===19?e+this._getTimezoneString(e):e}_getTimezoneString(e){const t=-new Date(e).getTimezoneOffset()/60;return(t<0?"-":"+")+["0",Math.abs(t)].join("").substr(-2)+":00"}renderValue(e,t=this.formatter){if(t==null)return;const a=this.toValue(e);if(a!=null)return t.format(a)}_computeFormatter(e){return new Intl.DateTimeFormat(e||void 0)}_toInputString(e){const t=this.toValue(e);return t==null?null:this._toLocalISOString(t).slice(0,10)}_dateValueChanged(e){const t=e.currentTarget,a=t.value,n=e.model.item,o=this.get(this.valuePath,n),r=this._fromInputString(a);this.set(this.valuePath,r,n),this._fireItemChangeEvent(n,this.valuePath,o,this.renderValue.bind(this))}_toLocalISOString(e){return xe(e)}};class ba extends Ge(Y(M)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return d`
			...
			${Z({title:this.title,tooltip:this._tooltip,filterText:this._filterText,headerFocused:this.headerFocused,externalValues:this.externalValues,onOpenedChanged:e,column:this.column,content:d`
					...
					></cosmoz-input>
				`})}
		`}_fromInputString(e,t){const a=this.toDate(e);if(a!=null)return t==="min"&&a.setHours(0,0,0,0),t==="max"&&a.setHours(23,59,59),a}_filterInputChanged(e,t){const a=e.path.split(".")[1],n=a&&e.value;if(n&&n.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}}customElements.define("cosmoz-omnitable-date-range-input",ba);const fa=i=>{const e=-new Date(i).getTimezoneOffset()/60;return(e<0?"-":"+")+["0",Math.abs(e)].join("").substr(-2)+":00"},je=i=>i.length===19?i+fa(i):i,Ft=i=>{if(i==null||i==="")return;let e=i;return!(e instanceof Date)&&(typeof i=="string"&&(e=je(e)),e=Xt(e),!e)||Number.isNaN(e.getTime())?null:e},P=({valuePath:i},e)=>{if(e==null)return;let t=e;i!=null&&(t=S(e,i));const a=Ft(t);if(a!=null)return L(a.getTime())},I=(i,e,t)=>{const a=Ft(i);return a??null},We=(i,e)=>{if(e==null)return;const t=I(i);if(t!=null)return e.format(t)},oe={},ha=i=>{const e=i||"";return oe[e]||(oe[e]=new Intl.DateTimeFormat(i||void 0)),oe[e]},it=({valuePath:i,locale:e},t)=>{let a=S(t,i||"");return a===void 0?"":(a=I(a),a===null?"Invalid Date":We(a,ha(e)))},_t=i=>{const e=I(i);if(e==null)return null;const t=xe(e);return t==null?null:t.slice(0,10)},xa=({valuePath:i},e)=>_t(S(e,i||"")),kt=(i,e)=>{const t=I(i);if(t!=null)return t},at=i=>{const e=_t(i);return e??""},va=({valuePath:i},e)=>{if(!i)return"";const t=I(S(e,i));if(!t)return"";const a=I(xe(t));return a?(a.setHours(0,0,0,0),a):""},It=(i,e)=>t=>{const a=P(i,t);if(a==null)return!1;const n=P({...i,valuePath:"min"},e),o=P({...i,valuePath:"max"},e);return!(a<(n??-1/0)||a>(o??1/0))};class ya extends V(M){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"date-header-cell"},width:{type:String,value:"100px"},minWidth:{type:String,value:"82px"},flex:{type:String,value:"0"}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const a=P({...e,valuePath:"min"},t),n=P({...e,valuePath:"max"},t);if(!(a==null&&n==null))return It(e,t)}getString(e,t){return it(e,t)}toXlsxValue(e,t){return va(e,t)}getComparableValue(e,t){return P(e,t)}serializeFilter(e,t){if(t==null)return;const a=I(t.min),n=I(t.max);if(!(a==null&&n==null))return at(a)+"~"+at(n)}deserializeFilter(e,t){if(t==null||t==="")return null;const a=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(a)?{min:I(a[1]),max:I(a[2])}:null}renderCell(e,{item:t}){return d`<div class="omnitable-cell-date">
			${it(e,t)}
...
`;customElements.define("cosmoz-omnitable-item-expand-line",O(Pa,{styleSheets:[Ie(Va)]}));const Na=({columns:i,item:e,selected:t,expanded:a,groupOnColumn:n})=>ei(i,o=>d`<cosmoz-omnitable-item-expand-line
				.column=${o}
				?hidden=${o===n}
				exportparts="item-expand-label, item-expand-value"
				>${o.renderCell(o,{item:e,selected:t,expanded:a})}</cosmoz-omnitable-item-expand-line
			>`);customElements.define("cosmoz-omnitable-item-expand",O(Na,{useShadowDOM:!1}));const Ra=(i,e,t)=>i.editable?i.renderEditCell(i,e,t(i,e.item)):i.renderCell(i,e),Ba=({columns:i,groupOnColumn:e,item:t,index:a,selected:n,expanded:o,onItemChange:r})=>xt(i,l=>l.name,l=>d`<div
...
`,kn=i=>i?"groupRow groupRow-folded":"groupRow",In=({item:i,index:e})=>t=>k((t?.length??0)>0,()=>d`
	...
	`,En=({onCheckboxChange:i,dataIsValid:e,groupOnColumn:t})=>(a,n,{selected:o,folded:r,toggleFold:l})=>d` <div
		...
		</div>`,On=({host:i,error:e,dataIsValid:t,processedItems:a,columns:n,collapsedColumns:o,miniColumns:r,sortAndGroupOptions:l,rowPartFn:s,...u})=>{const{loading:m=!1,displayEmptyGroups:c=!1,compareItemsFn:g}=i,p=Oe({shiftKey:!1,ctrlKey:!1}),C=$(b=>{const A=b.target,f=A.dataItem,y=A.checked,x=i.shadowRoot.querySelector("#groupedList");p.current.shiftKey?x.toggleSelectTo(f,y):p.current.ctrlKey?(A.checked=!0,x.selectOnly(f)):x.toggleSelect(f,y),b.preventDefault(),b.stopPropagation()},[]);E(()=>{const b=({shiftKey:A,ctrlKey:f})=>{p.current={shiftKey:A,ctrlKey:f}};return window.addEventListener("keydown",b),window.addEventListener("keyup",b),()=>{window.removeEventListener("keydown",b),window.removeEventListener("keyup",b)}},[]);const h=$(b=>{const A=b.currentTarget,f=b.composedPath();f.slice(0,f.indexOf(A)).find(x=>x.matches?.("a, .checkbox, .expand"))||i.dispatchEvent(new window.CustomEvent("omnitable-item-click",{bubbles:!0,composed:!0,detail:{item:A.dataItem,index:A.dataIndex}}))},[]),{groupOnColumn:v}=l,_=$((b,A)=>f=>zi(i,b,A,f),[]);return{...u,processedItems:a,dataIsValid:t,filterIsTooStrict:t&&a.length<1,loading:m,compareItemsFn:g,displayEmptyGroups:c,error:e,renderItem:F(()=>Mn({columns:n,collapsedColumns:o,miniColumns:r,onItemClick:h,onCheckboxChange:C,dataIsValid:t,groupOnColumn:v,onItemChange:_,rowPartFn:s}),[n,o,h,C,t,v,_,s]),renderGroup:F(()=>En({onCheckboxChange:C,dataIsValid:t,groupOnColumn:v}),[C,t,v])}},Ln=(i,e)=>{if(i===e)return 0;if(i==null)return-1;if(e==null)return 1;const t=typeof i,a=typeof e;return t==="object"&&a==="object"?i.toString()<e.toString()?-1:1:t==="number"&&a==="number"?i-e:t==="string"&&a==="string"?i<e?-1:1:t==="boolean"&&a==="boolean"?i?-1:1:(console.warn("unsupported sort",t,i,a,e),0)},Ce=(i,e)=>(t,a)=>Ln(i(t),i(a))*(e?-1:1),Dn=i=>i.replace(/([a-z0-9])([A-Z])/gu,"$1-$2").toLowerCase(),mt=(i,e)=>{!i||!e||Object.entries(e).forEach(([t,a])=>{i[R].__ownChange=!0,i[R][t]=a,i[R].__ownChange=!1,i[R].dispatchEvent(new CustomEvent(`${Dn(t)}-changed`,{bubbles:!0,detail:{value:a}}))})},Se=(i,e)=>Object.assign(i,{[ge]:e}),de=Symbol("unparsed"),Tn=({data:i,columns:e,hashParam:t,sortAndGroupOptions:a,noLocalSort:n,noLocalFilter:o})=>{const{groupOnColumn:r,groupOnDescending:l,sortOnColumn:s,descending:u}=a,m=$(([f,y])=>{const x=e.find(({name:w})=>w===f);return x==null?[f,void 0]:[f,y.filter&&x.serializeFilter(x,y.filter)]},[e]),c=$(([f,y])=>{const x=e.find(({name:q})=>q===f);if(x==null)return[f,{[de]:y}];const w={filter:x.deserializeFilter(x,y)};return mt(x,w),[f,w]},[e]),[g,p]=J({},t,{multi:!0,suffix:"-filter--",write:m,read:c}),C=$((f,y)=>p(x=>{const w=fe(y,x[f]);return mt(e.find(q=>q.name===f),w),{...x,[f]:{...x[f],...w}}}),[e,p]),h=F(()=>Object.values(g).map(f=>f.filter),[g]),v=F(()=>Object.fromEntries(e.map(f=>[f.name,!f.noLocalFilter&&f.getFilterFn(f,g[f.name]?.filter)]).filter(([,f])=>!!f)),[e,...h]),_=F(()=>!Array.isArray(i)||i.length===0?[]:Object.entries(v).length===0||o?i.slice():i.filter(f=>Object.values(v).every(y=>y(f))),[i,v,o]),b=F(()=>{if(!n&&!r&&s!=null&&s.sortPath!=null)return _.slice().sort(Ce(f=>s.getComparableValue({...s,valuePath:s.sortPath},f),u));if(r!=null&&r.groupOn!=null){const f=_.reduce((y,x)=>{const w=r.getComparableValue({...r,valuePath:r.groupOn},x);if(w===void 0)return y;let q=y.find(D=>D.id===w);return q?(q.items.push(x),y):(q={id:w,name:w,items:[x]},[...y,q])},[]);return f.sort(Ce(y=>r.getComparableValue({...r,valuePath:r.groupOn},y.items[0]),l)),!s||n?f:f.filter(y=>Array.isArray(y.items)).map(y=>(y.items.sort(Ce(x=>s.getComparableValue({...s,valuePath:s.sortPath},x),u)),y))}return _},[_,r,l,s,u,n]),A=F(()=>{let f=0,y=0;const x=[];return b.forEach(w=>{if(Array.isArray(w.items)){Se(w,y++),w.items.forEach(q=>{Se(q,f++),x.push(q)});return}return Se(w,f++),x.push(w)},[]),x},[b]);return E(()=>{p(f=>Object.values(f).some(x=>x[de]!=null)?Object.fromEntries(Object.entries(f).map(([x,w])=>w[de]==null?[x,w]:c([x,w[de]]))):f)},[c]),{processedItems:b,visibleData:A,filters:g,filterFunctions:v,setFilterState:C}},Vn=i=>{const e=a=>{const n=i.data.indexOf(a);if(n<0)return null;const o=i.data.splice(n,1);if(i.data=i.data.slice(),Array.isArray(o)&&o.length>0)return o[0]},t=(a,n)=>{i.data.splice(a,1,n),i.data=i.data.slice()};return{removeItem:e,removeItems(a){const n=[];for(let o=a.length-1;o>=0;o-=1){const r=i.removeItem(a[o]);r!=null&&n.push(r)}return n},replaceItemAtIndex:t,replaceItem(a,n){const o=i.data.indexOf(a);if(o>-1)return t(o,n)},selectItem(a){i.shadowRoot.querySelector("#groupedList").select(a)},selectAll(){i.shadowRoot.querySelector("#groupedList").selectAll()},deselectAll(){i.shadowRoot.querySelector("#groupedList").deselectAll()},deselectItem(a){i.shadowRoot.querySelector("#groupedList").deselect(a)},isItemSelected(a){return i.shadowRoot.querySelector("#groupedList").isItemSelected(a)}}},Pn=({host:i,visibleData:e,filters:t,...a})=>{const{setFilterState:n}=a,o=F(()=>Vn(i),[]);ze(a,Object.values(a)),ze(o,Object.values(o)),E(()=>{const l=s=>n(s.detail.name,u=>({...u,...s.detail.state}));return i.addEventListener("legacy-filter-changed",l),()=>i.removeEventListener("legacy-filter-changed",l)},[]),N("visibleData",e),N("sortedFilteredGroupedItems",a.sortedFilteredGroupedItems),N("selectedItems",a.selectedItems),N("sortOn",a.sortOn),N("descending",a.descending),N("isMini",a.isMini);const r=F(()=>Object.fromEntries(Object.entries(t).filter(([,{filter:l}])=>l!==void 0).map(([l,{filter:s}])=>[l,s])),[t]);N("filters",r,Object.values(r))},Nn=i=>{const{hashParam:e,settingsId:t,data:a,resizeSpeedFactor:n,noLocal:o,noLocalSort:r=o,noLocalFilter:l=o,error:s,rowPartFn:u}=i,m=pn({settingsId:t,host:i}),{settings:c,setSettings:g,columns:p,resetRef:C}=m,h=Ii(p,e,c,g,C),{processedItems:v,visibleData:_,filters:b,setFilterState:A,filterFunctions:f}=Tn({data:a,columns:p,hashParam:e,sortAndGroupOptions:h,noLocalSort:r,noLocalFilter:l}),{isMini:y,collapsedColumns:x,miniColumns:w}=zn({host:i,columns:p,settings:c,setSettings:g,resizeSpeedFactor:n,sortAndGroupOptions:h}),q=a&&Array.isArray(a)&&a.length>0,[D,H]=T([]);return Pn({host:i,visibleData:_,sortedFilteredGroupedItems:v,columns:p,filters:b,setFilterState:A,selectedItems:D,isMini:y,...h}),{header:_n({host:i,selectedItems:D,sortAndGroupOptions:h,dataIsValid:q,data:a,columns:p,filters:b,collapsedColumns:x,settings:c,filterFunctions:f,settingS:m,setFilterState:A,hideSelectAll:i.hideSelectAll===!0}),list:On({host:i,error:s,dataIsValid:q,processedItems:v,setSelectedItems:H,columns:p,collapsedColumns:x,miniColumns:w,sortAndGroupOptions:h,rowPartFn:u}),footer:Fn({host:i,selectedItems:D,columns:p})}};customElements.define("cosmoz-grouped-list-row",class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||qe(this._renderFn(this._item,this._index),this)}});const Rn={group:Symbol("group")},ve=(i,e)=>(e.has(i)||e.set(i,{}),e.get(i)),Bn=(i,e)=>!!ve(i,e).expanded,Hn=(i,e)=>!!ve(i,e).folded,Fe=i=>i?i.items instanceof Array:!1,Gn=i=>{if(!Array.isArray(i)||i.length===0)return;const e=Array.isArray(i[0]?.items);if(!i.every(a=>Array.isArray(a.items)===e))throw new Error("Data must be homogeneous.")},jn=(i,e,t)=>Array.isArray(i)?(Gn(i),i.reduce((n,o)=>{const r=o;if(!r.items)return n.concat(o);if(r.items.length){if(ve(o,t).folded)return n.concat(o);const l=r.items.map(s=>Object.assign(s,{[Rn.group]:o}));return n.concat(o,l)}return e?n.concat(o):n},[])):void 0,Wn=(i,...e)=>typeof i=="function"?i(...e):i,Un=(i,e)=>i===e,Kn=()=>{const[i,e]=T(()=>[new WeakMap]);return{setItemState:$((a,n)=>e(([o])=>{const r=ve(a,o);return Object.assign(r,Wn(n,r)),[o]}),[]),state:i[0],signal:i}},Jn=()=>{const{setItemState:i,state:e,signal:t}=Kn(),a=$((o,r)=>{Fe(o)&&i(o,l=>({folded:r!==void 0?r:!l.folded}))},[]),n=$((o,r)=>{Fe(o)||i(o,l=>({expanded:r!==void 0?!r:!l.expanded}))},[]);return{state:e,signal:t,toggleFold:a,toggleCollapse:n}},Xn=({initial:i,compareItemsFn:e,data:t,flatData:a})=>{const[n,o]=T(i),[r,l]=T(),s=$(b=>n.includes(b),[n]),u=$(b=>b?.items?.every(s)??!1,[s]),m=$(b=>s(b)||u(b),[s,u]),c=$(b=>{const f=b.items??[b];o(y=>[...y,...f.filter(x=>!y.includes(x))]),l(b)},[]),g=$(b=>{const f=b.items??[b];o(y=>y.filter(x=>!f.includes(x))),l(b)},[]),p=$(b=>{o(b.items?.slice()||[b]),l(b)},[]),C=$(()=>{o(t.flatMap(b=>b.items||b)),l(void 0)},[t]),h=$(()=>{o([]),l(void 0)},[]),v=$((b,A=!m(b))=>A?c(b):g(b),[m]),_=$((b,A)=>{if(!a)return;const f=r?a.findIndex(w=>e(w,r)):-1;if(f<0)return v(b,A);const[y,x]=[f,a.indexOf(b)].sort((w,q)=>w-q);a.slice(y,x+1).forEach((w,q,D)=>{q>0&&q<D.length-1&&Fe(w)||v(w,A)}),l(b)},[a,e,v]);return E(()=>o(b=>b.length>0&&a?a.filter(A=>b.find(f=>e(A,f))):b),[a]),{selectedItems:n,isItemSelected:s,isGroupSelected:u,isSelected:m,select:c,deselect:g,selectOnly:p,selectAll:C,deselectAll:h,toggleSelect:v,toggleSelectTo:_}},Qn={host:{position:"relative",display:"flex",flexDirection:"column"}},Yn=i=>{const{data:e,renderItem:t,renderGroup:a,displayEmptyGroups:n,compareItemsFn:o=Un}=i,{toggleFold:r,toggleCollapse:l,state:s,signal:u}=Jn(),m=F(()=>jn(e,n,s),[e,n,u]),{selectedItems:c,isItemSelected:g,isGroupSelected:p,isSelected:C,select:h,deselect:v,selectOnly:_,selectAll:b,deselectAll:A,toggleSelect:f,toggleSelectTo:y}=Xn({initial:[],compareItemsFn:o,data:e,flatData:m}),x=$((q,D)=>Array.isArray(q.items)?a(q,D,{selected:p(q),folded:Hn(q,s),toggleSelect:H=>f(q,typeof H=="boolean"?H:void 0),toggleFold:()=>r(q)}):t(q,D,{selected:c.includes(q),expanded:Bn(q,s),toggleSelect:H=>f(q,typeof H=="boolean"?H:void 0),toggleCollapse:()=>l(q)}),[t,a,c,f,u]);gt(()=>{Object.assign(i.style,Qn.host)},[]),N("selectedItems",c);const w={toggleFold:r,toggleCollapse:l,isItemSelected:g,isGroupSelected:p,isSelected:C,select:h,deselect:v,selectOnly:_,selectAll:b,deselectAll:A,toggleSelect:f,toggleSelectTo:y};return ze(w,Object.values(w)),{renderRow:x,flatData:m}},Zn=({renderRow:i,flatData:e})=>ri({items:e,renderItem:(t,a)=>d`<cosmoz-grouped-list-row
				.item=${t}
				.index=${a}
				.renderFn=${i}
			></cosmoz-grouped-list-row>`}),eo=i=>Zn(Yn(i));customElements.define("cosmoz-grouped-list",O(eo,{useShadowDOM:!1}));const to=i=>window.ShadyCSS?.ApplyShim?.transformCssText?.(i)||i,io=i=>{const{header:e,list:t,footer:a}=Nn(i);return d`
		<style>
			${li([],()=>to(Ha))}
		</style>
