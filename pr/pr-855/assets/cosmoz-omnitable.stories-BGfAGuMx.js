import{b as d,D as ke,A as xt}from"./iframe-DIbys1OW.js";import{t as K,c as O,g as z,P as E,u as T,a as yt,m as vt,s as Bt,D as Ht,b as Gt,e as Wt,i as $e,h as Oe,d as jt,f as $t,r as Ut,j as Kt,k as A,l as Jt,n as Ce,p as he,o as k,q as Xt,v as we,w as Qt,x as Yt,y as Zt,T as ei,z as M,A as Ye,B as ti,C as ii,E as w,F as ai,G as ni,H as oi,I as Ct,J as Le,K as F,L as wt,M as De,N as ri,O as St,Q as li,R as Te,S as Ze,U as si,V as Pe,W as ui,X as ci,Y as Ie,Z as Ve,_ as di,$ as Ee,a0 as N,a1 as mi,a2 as ze,a3 as pi}from"./cosmoz-collapse-Y-BGfaT3.js";import"./preload-helper-PPVm8Dsz.js";const gi=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,Ti=i=>{const{label:e,value:t,slot:a}=i,n=d`<div
	...
	`};class Pi extends Ne(ae(E)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return d`
		...
		>`}getComparableValue(e,t){return Zi(e,t)}}customElements.define("cosmoz-omnitable-column-autocomplete",ea);const Ue=(i,e)=>e.find(({value:t})=>i===t),ta=(i,e,t)=>{const a=Ue(e,t);return a?a.text:i},ot=(i,e,t,a)=>ta(i,z(e,t),a),ia=({valuePath:i},e,t)=>Ue(z(e,i),t),aa=i=>e=>{i(t=>({...t,filter:e?.[0]?.value??null}))},na=i=>e=>{i(t=>({...t,headerFocused:e}))},oa=i=>e=>{i(t=>({...t,query:e}))},ra=i=>e=>i(e?.[0]?.value),rt=({valuePath:i,trueLabel:e,falseLabel:t},a)=>z(a,i)?e:t,la=({valuePath:i},e)=>t=>z(t,i)===e,le=vt((i,e)=>[{text:i,value:!0},{text:e,value:!1}]),sa=({valuePath:i,trueLabel:e,falseLabel:t},a)=>i?z(a,i)?e:t:"",ua=(i,e)=>{try{return JSON.parse(e)}catch{return null}};class ca extends P(E){static get properties(){return{trueLabel:{type:String,value:"True"},falseLabel:{type:String,value:"False"},flex:{type:String,value:"0"},cellClass:{type:String,value:"boolean-cell"}}}getString(e,t){return rt(e,t)}renderCell(e,{item:t}){return rt(e,t)}renderEditCell(e,{item:t},a){const{trueLabel:n,falseLabel:o}=e;return d`<cosmoz-autocomplete
			no-label-float
		...
		>`}computeSource({trueLabel:e,falseLabel:t}){return le(e,t)}getFilterFn(e,t){if(t!=null)return la(e,t)}toXlsxValue(e,t){return sa(e,t)}deserializeFilter(e,t){return ua(e,t)}}customElements.define("cosmoz-omnitable-column-boolean",ca);const Ke=i=>class extends Ne(i){static get properties(){return{max:{type:Date,value:null},min:{type:Date,value:null},_filterText:{type:String,computed:"_computeFilterText(filter.*, formatter)"},formatter:{type:Object,computed:"_computeFormatter(locale)"}}}toDate(e,t,a){if(e==null||e==="")return;let n=e;if(n instanceof Date||(typeof e=="string"&&(n=this.getAbsoluteISOString(n)),n=new Date(n)),Number.isNaN(n.getTime()))return null;if(a==null||t==null)return n;const o=this.toDate(t);if(o==null)return n;const r=this.getComparableValue(n),l=this.getComparableValue(o);return a(r,l)===r?n:o}toValue(){return this.toDate.apply(this,arguments)}getComparableValue(e,t){const a=super.getComparableValue(e,t);if(a!=null)return this.toNumber(a.getTime())}getString(e,t=this.valuePath,a=this.formatter){const n=this.toValue(this.get(t,e));return n===void 0?"":n===null?"Invalid Date":this.renderValue(n,a)}getAbsoluteISOString(e){return e.length===19?e+this._getTimezoneString(e):e}_getTimezoneString(e){const t=-new Date(e).getTimezoneOffset()/60;return(t<0?"-":"+")+["0",Math.abs(t)].join("").substr(-2)+":00"}renderValue(e,t=this.formatter){if(t==null)return;const a=this.toValue(e);if(a!=null)return t.format(a)}_computeFormatter(e){return new Intl.DateTimeFormat(e||void 0)}_toInputString(e){const t=this.toValue(e);return t==null?null:this._toLocalISOString(t).slice(0,10)}_dateValueChanged(e){const t=e.currentTarget,a=t.value,n=e.model.item,o=this.get(this.valuePath,n),r=this._fromInputString(a);this.set(this.valuePath,r,n),this._fireItemChangeEvent(n,this.valuePath,o,this.renderValue.bind(this))}_toLocalISOString(e){return we(e)}};class da extends Ke(ae(E)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return d`
			...
			${ne({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:d`
					...
					></cosmoz-input>
				`})}
		`}_fromInputString(e,t){const a=this.toDate(e);if(a!=null)return t==="min"&&a.setHours(0,0,0,0),t==="max"&&a.setHours(23,59,59),a}_filterInputChanged(e,t){const a=e.path.split(".")[1],n=a&&e.value;if(n&&n.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}}customElements.define("cosmoz-omnitable-date-range-input",da);const ma=i=>{const e=-new Date(i).getTimezoneOffset()/60;return(e<0?"-":"+")+["0",Math.abs(e)].join("").substr(-2)+":00"},Je=i=>i.length===19?i+ma(i):i,_t=i=>{if(i==null||i==="")return;let e=i;return!(e instanceof Date)&&(typeof i=="string"&&(e=Je(e)),e=Qt(e),!e)||Number.isNaN(e.getTime())?null:e},V=({valuePath:i},e)=>{if(e==null)return;let t=e;i!=null&&(t=z(e,i));const a=_t(t);if(a!=null)return L(a.getTime())},I=(i,e,t)=>{const a=_t(i);return a??null},Xe=(i,e)=>{if(e==null)return;const t=I(i);if(t!=null)return e.format(t)},se={},pa=i=>{const e=i||"";return se[e]||(se[e]=new Intl.DateTimeFormat(i||void 0)),se[e]},lt=({valuePath:i,locale:e},t)=>{let a=z(t,i||"");return a===void 0?"":(a=I(a),a===null?"Invalid Date":Xe(a,pa(e)))},kt=i=>{const e=I(i);if(e==null)return null;const t=we(e);return t==null?null:t.slice(0,10)},ga=({valuePath:i},e)=>kt(z(e,i||"")),It=(i,e)=>{const t=I(i);if(t!=null)return t},st=i=>{const e=kt(i);return e??""},ba=({valuePath:i},e)=>{if(!i)return"";const t=I(z(e,i));if(!t)return"";const a=I(we(t));return a?(a.setHours(0,0,0,0),a):""},Et=(i,e)=>t=>{const a=V(i,t);if(a==null)return!1;const n=V({...i,valuePath:"min"},e),o=V({...i,valuePath:"max"},e);return!(a<(n??-1/0)||a>(o??1/0))};class fa extends P(E){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"date-header-cell"},width:{type:String,value:"100px"},minWidth:{type:String,value:"82px"},flex:{type:String,value:"0"}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const a=V({...e,valuePath:"min"},t),n=V({...e,valuePath:"max"},t);if(!(a==null&&n==null))return Et(e,t)}getString(e,t){return lt(e,t)}toXlsxValue(e,t){return ba(e,t)}getComparableValue(e,t){return V(e,t)}serializeFilter(e,t){if(t==null)return;const a=I(t.min),n=I(t.max);if(!(a==null&&n==null))return st(a)+"~"+st(n)}deserializeFilter(e,t){if(t==null||t==="")return null;const a=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(a)?{min:I(a[1]),max:I(a[2])}:null}renderCell(e,{item:t}){return d`<div class="omnitable-cell-date">
			${lt(e,t)}
		...
		></cosmoz-input>`}renderHeader({title:e,min:t,max:a,locale:n,filterStep:o},{filter:r},l,u){return d`<cosmoz-omnitable-time-range-input
			...
			@filter-changed=${({detail:{value:s}})=>l(c=>({...c,filter:s}))}
			@header-focused-changed=${({detail:{value:s}})=>l(c=>({...c,headerFocused:s}))}
		></cosmoz-omnitable-time-range-input>`}computeSource(e,t){return ie(e,t)}}customElements.define("cosmoz-omnitable-column-time",qa);const ce={},Aa=i=>{const e=i||"";if(ce[e])return ce[e];const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return ce[e]=new Intl.DateTimeFormat(i||void 0,t),ce[e]},qe=({valuePath:i,locale:e},t)=>{const a=I(z(t,i||""));return a===void 0?"":a===null?"Invalid Date":Xe(a,Aa(e))},Fa=({valuePath:i},e)=>i?z(e,i):"",mt=i=>{const e=I(i);return e==null?"":e.toISOString().slice(0,19).replace(/:/gu,".")},pt=i=>{if(!(i==null||i==="")&&typeof i=="string")return I(i.replace(/\./gu,":")+"Z")};class _a extends Ke(ae(E)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return d`
			<style>
