import{b as d,D as Fe,A as bt,w as Bt}from"./iframe-COlzdU9-.js";import{t as K,c as E,g as C,P as A,u as M,a as xt,m as vt,s as Ht,D as Gt,b as Wt,e as qt,i as ye,h as Ae,d as Xt,f as yt,r as Ut,j as Kt,k,l as Jt,n as $e,p as he,o as D,q as Yt,v as we,w as Qt,x as Zt,y as en,T as tn,z as T,A as fe,B as nn,C as on,E as z,F as rn,G as an,H as ln,I as $t,J as Ee,K as I,L as wt,M as Te,N as sn,O as zt,Q as un,R as Le,S as Ye,U as cn,V as Re,W as dn,X as mn,Y as Oe,Z as Me,_ as pn,$ as De,a0 as P,a1 as gn,a2 as Ce,a3 as hn}from"./cosmoz-collapse-CfA6I19t.js";import"./preload-helper-PPVm8Dsz.js";const fn=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,Mn=n=>{const{label:e,value:t,slot:o}=n,r=d`<div
	...
	>
		${t||""}
	</div>`;return Ut(r,{label:e})};customElements.define("cosmoz-omnitable-dropdown-input",E(Mn,{observedAttributes:Ln,styleSheets:[Rn]}));const ee=({title:n,tooltip:e="",filterText:t="",onOpenedChanged:o,content:r,horizontalAlign:i="left",externalValues:a=null})=>{const l={filtered:!!t,...a!=null&&{[`external-values-${a}`]:!0}};return d`
		<style>
			.dropdown {
				outline: none;
			}
	...
	`};class Nn extends Ne(Z(A)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return d`
		...
		>
			...
			.autoupdate=${s}
			.autodetect=${u}
			@filter-changed=${({detail:{value:p}})=>m(y=>({...y,filter:p}))}
			@header-focused-changed=${({detail:{value:p}})=>m(y=>({...y,headerFocused:p}))}
		></cosmoz-omnitable-amount-range-input>`}computeSource(e,t){return Q(e,t)}}customElements.define("cosmoz-omnitable-column-amount",Un);const Kn=(n,e)=>{if(!Array.isArray(n))return;const t=[];return n.reduce((o,r)=>Array.isArray(r)?(r.forEach(i=>{o.push(i)}),o):(o.push(r),o),[]).filter((o,r,i)=>{if(i.indexOf(o)!==r)return!1;if(e){const a=C(o,e);if(t.indexOf(a)!==-1)return!1;t.push(a)}return!0})},Jn=(n,e,t)=>{if(n==null)return[];if(Array.isArray(n))return Kn(n,e);if(typeof n=="object"){const o=e??"id",r=t??"label";return Object.entries(n).map(([i,a])=>({[o]:i,[r]:a})).sort((i,a)=>i[r]<a[r]?-1:i[r]>a[r]?1:0)}return[]},je=(n,e,t)=>$e(e&&C(n,e)).map(he(t)),Pe=({valuePath:n,textProperty:e},t)=>je(t,n,e).filter(o=>o!=null).join(", "),Yn=Pe,Qn=({valueProperty:n,valuePath:e,emptyValue:t,emptyProperty:o},r)=>i=>{const a=he(n),l=$e(C(i,e));return r.some(s=>l.length===0&&he(o||n)(s)===t||l.some(u=>a(u)===a(s)))},Be=n=>e=>n(t=>({...t,filter:e})),He=n=>e=>n(t=>({...t,headerFocused:e})),Ge=n=>e=>n(t=>({...t,query:e})),kt=({emptyValue:n,emptyLabel:e,emptyProperty:t,textProperty:o,valueProperty:r},i)=>{const a=Jn(i,r,o);return!e||n===void 0||!o||!(t||r)||!a?a:[{[o]:e,[t||r]:n},...a]},Zn=(n,e)=>kt(n,Ct(e,n.valuePath)),We=n=>class extends n{static get properties(){return{textProperty:{type:String},valueProperty:{type:String},emptyLabel:{type:String},emptyValue:{type:Object},emptyProperty:{type:String}}}getConfig(e){return{emptyProperty:e.emptyProperty}}getString(e,t){return Pe(e,t)}toXlsxValue(e,t){return Yn(e,t)}getComparableValue({valuePath:e,valueProperty:t},o){const r=C(o,e);return t==null?r:$e(r).reduce((a,l)=>(a.push(C(l,t)),a),[]).sort().join(" ")}getFilterFn(e,t){if(!(!t||!Array.isArray(t)||t.length===0))return Qn(e,t)}serializeFilter(e,t){return t.length===0?null:JSON.stringify(t)}deserializeFilter(e,t){return JSON.parse(decodeURIComponent(t))}computeSource(e,t){return e.externalValues||typeof e.values=="function"?async(...o)=>kt(e,await Promise.resolve(ye(e.values,...o))):Zn(e,t)}},eo=({valuePath:n,textProperty:e,valueProperty:t},o)=>{const r=e?Yt(e):he(t),i=$e(n&&C(o,n)).map(r);return i.length>1?i.filter(Boolean).join(","):i[0]};class to extends We(N(A)){static get properties(){return{headerCellClass:{type:String,value:"autocomplete-header-cell"},minWidth:{type:String,value:"55px"},editMinWidth:{type:String,value:"55px"},keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},showSingle:{type:Boolean},preserveOrder:{type:Boolean},limit:{type:Number},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,showSingle:e.showSingle,preserveOrder:e.preserveOrder,limit:e.limit,textual:e.textual}}renderCell(e,{item:t}){return d`<span class="default-column"
		...
		>`}getComparableValue(e,t){return eo(e,t)}}customElements.define("cosmoz-omnitable-column-autocomplete",to);const qe=(n,e)=>e.find(({value:t})=>n===t),no=(n,e,t)=>{const o=qe(e,t);return o?o.text:n},ot=(n,e,t,o)=>no(n,C(e,t),o),oo=({valuePath:n},e,t)=>qe(C(e,n),t),ro=n=>e=>{n(t=>({...t,filter:e?.[0]?.value??null}))},io=n=>e=>{n(t=>({...t,headerFocused:e}))},ao=n=>e=>{n(t=>({...t,query:e}))},lo=n=>e=>n(e?.[0]?.value),rt=({valuePath:n,trueLabel:e,falseLabel:t},o)=>C(o,n)?e:t,so=({valuePath:n},e)=>t=>C(t,n)===e,ne=vt((n,e)=>[{text:n,value:!0},{text:e,value:!1}]),uo=({valuePath:n,trueLabel:e,falseLabel:t},o)=>n?C(o,n)?e:t:"",co=(n,e)=>{try{return JSON.parse(e)}catch{return null}};class mo extends N(A){static get properties(){return{trueLabel:{type:String,value:"True"},falseLabel:{type:String,value:"False"},flex:{type:String,value:"0"},cellClass:{type:String,value:"boolean-cell"}}}getString(e,t){return rt(e,t)}renderCell(e,{item:t}){return rt(e,t)}renderEditCell(e,{item:t},o){const{trueLabel:r,falseLabel:i}=e;return d`<cosmoz-autocomplete
			no-label-float
		...
		`}renderEditCell(){return"not implemented"}renderHeader(e,{filter:t,query:o},r,i){return d`<cosmoz-autocomplete-ui
			...
			.onText=${Ge(r)}
			>${D(e.loading,()=>d`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}}customElements.define("cosmoz-omnitable-column-list-horizontal",vo);window.Cosmoz=window.Cosmoz||{};class lt extends Zt(en(tn,A)){static get template(){return Ae`
			<style>
				:host {
					display: block;
				}
		...
		></cosmoz-omnitable-number-range-input>`}computeSource(e,t){return Q(e,t)}}customElements.define("cosmoz-omnitable-column-number",wo);const Vt="1970-01-01",B=(n,e,t)=>{const o=typeof n=="string"&&n.length>3&&n.length<=9?Ue(Vt+"T"+n):n;return V(o)},re={},zo=n=>{const e=n||"";if(re[e])return re[e];const t={hour:"numeric",minute:"numeric",second:"numeric"};return re[e]=new Intl.DateTimeFormat(n||void 0,t),re[e]},ge=({valuePath:n,locale:e},t)=>{const o=B(C(t,n||""));return o===void 0?"":o===null?"Invalid Date":Ke(o,zo(e))},Co=(n,e)=>n.valuePath?ge(n,e):"",So=n=>{const e=B(n);if(e==null)return null;const t=we(e);return t&&t.slice(11,19)},q=({valuePath:n},e)=>{if(e==null)return;const t=So(n==null?e:C(e,n));if(t==null)return;const o=B(Ue(Vt+"T"+t));return o==null?o:L(o.getTime())},_o=(n,e)=>t=>{const o=q(n,t);if(o==null)return!1;const r=q({...n,valuePath:"min"},e),i=q({...n,valuePath:"max"},e);return r==null||i==null?!1:!(o<r||o>i)},st=n=>{const e=B(n);return e==null?"":e.toISOString().slice(11,19).replace(/:/gu,".")},ut=n=>{if(!(n==null||n===""))return B(typeof n=="string"?n.replace(/\./gu,":")+"Z":n)};class ko extends Xe(Z(A)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return d`
			<cosmoz-clear-button
				@click=${()=>this.resetFilter()}
				?visible=${this.hasFilter()}
			></cosmoz-clear-button>
...
`,Mo=()=>d`
	<sort-and-group-consumer
		class="sgs"
		.render=${({columns:n,sortOn:e,setSortOn:t,descending:o,setDescending:r}={})=>Et({columns:n?.filter?.(i=>i.sortPath&&!i.noSort),on:e,setOn:t,descending:o,setDescending:r})}
	>
	</sort-and-group-consumer>
`,Tt=n=>(e,t,o)=>{const r=an(),i=new URLSearchParams(r.hash.replace("#",""));return n(e,t,o??ln,i),"#!"+Object.assign(r,{hash:i}).href.replace(location.origin,"")},Lt=n=>n==null||n==="",No=Tt((n,e,t,o)=>Lt(t(e))?o.delete(n):o.set(n,t(e))),jo=Tt((n,e,t,o)=>Object.entries(e).map(t).forEach(([r,i])=>Lt(i)?o.delete(n+r):o.set(n+r,i))),J=(n,e,{suffix:t="",read:o,write:r,multi:i}={})=>{const[a,l]=i?[jo,nn]:[No,on],[s,u]=M(()=>e==null?n:l(e+t,o)??n),c=z(m=>u(h=>{const p=ye(m,h);return e!=null&&rn(a(e+t,p,r),null,{notify:!1}),p}),[e,t,a,r]);return[s,c]},Po=n=>[!0,"true",1,"yes","on"].includes(n),ae=n=>n===""||(n==null?void 0:Po(n)),le=(n,e,t)=>z(o=>{n(o),t(r=>({...r,[e]:o}))},[n,e,t]),Bo=(n,e,t,o,r)=>{const[i,a]=J(t.sortOn,e,{suffix:"-sortOn"}),[l,s]=J(ae(t.descending),e,{suffix:"-descending",read:ae}),[u,c]=J(t.groupOn,e,{suffix:"-groupOn"}),[m,h]=J(ae(t.groupOnDescending),e,{suffix:"-groupOnDescending",read:ae}),p=I(()=>n.find(g=>g.name===i),[n,i]),y=I(()=>n.find(g=>g.name===u),[n,u]),b={groupOn:u,setGroupOn:le(c,"groupOn",o),groupOnDescending:m,setGroupOnDescending:le(h,"groupOnDescending",o),sortOn:i,setSortOn:le(a,"sortOn",o),descending:l,setDescending:le(s,"descending",o),columns:n},$=I(()=>b,Object.values(b)),F=z(g=>{a(g.sortPath),c(g.groupOn),s(g.descending),h(g.groupOnDescending)},[]);return T(()=>void(r.current=F),[]),{...$,sortAndGroup:$,groupOnColumn:y,sortOnColumn:p}},Je=$t();customElements.define("sort-and-group-provider",Je.Provider);customElements.define("sort-and-group-consumer",E(({render:n})=>n(Ee(Je)),{useShadowDOM:!1}));const Ho=({data:n,columns:e,groupOnColumn:t,filters:o,setFilterState:r,sortAndGroup:{sortOn:i,setSortOn:a,descending:l,setDescending:s}={}})=>wt(e,u=>u.name,u=>[d`<div
			...
			>
				...
				${D(!u.noSort,()=>At({on:i,setOn:a,descending:l,setDescending:s,column:u}))}
	...
	`};customElements.define("cosmoz-omnitable-header-row",E(Go,{useShadowDOM:!1}));const Wo=K`
	:host {
		display: flex;
		align-items: center;
		flex-wrap: wrap;
...
`;customElements.define("cosmoz-omnitable-item-expand-line",E(qo,{styleSheets:[Te(Wo)]}));const Xo=({columns:n,item:e,selected:t,expanded:o,groupOnColumn:r})=>sn(n,i=>d`<cosmoz-omnitable-item-expand-line
				.column=${i}
				?hidden=${i===r}
				exportparts="item-expand-label, item-expand-value"
				>${i.renderCell(i,{item:e,selected:t,expanded:o})}</cosmoz-omnitable-item-expand-line
			>`);customElements.define("cosmoz-omnitable-item-expand",E(Xo,{useShadowDOM:!1}));const Uo=(n,e,t)=>n.editable?n.renderEditCell(n,e,t(n,e.item)):n.renderCell(n,e),Ko=({columns:n,groupOnColumn:e,item:t,index:o,selected:r,expanded:i,onItemChange:a})=>wt(n,l=>l.name,l=>d`<div
				...
				name="${l.name}"
			>
				${Uo(l,{item:t,index:o,selected:r,expanded:i},a)}
			</div>`);customElements.define("cosmoz-omnitable-item-row",E(Ko,{useShadowDOM:!1}));const Rt=K`
	.checkbox {
		box-sizing: border-box;
		width: 18px;
		height: 18px;
...
`);a.unshift(i),zt(new File(a,t,{type:"text/csv;charset=utf-8"}))},Qo=(n,e)=>{const t=n.map(r=>r.title),o=e.map(r=>n.map(i=>{const a=i.toXlsxValue(i,r);return a??""}));return o.unshift(t),o},Zo=(n,e,t,o)=>{const r=Qo(n,e),i=new un(t).addSheetFromData(r,o).generate();zt(new File([i],t,{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}))},er=({columns:n,selectedItems:e,csvFilename:t,xlsxFilename:o,xlsxSheetname:r,topPlacement:i})=>d`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!Le(e.length)}
		part="bottomBar"
	...
	</cosmoz-bottom-bar>`,tr=({allSelected:n,onAllCheckboxChange:e,sortAndGroup:t,dataIsValid:o,data:r,columns:i,filters:a,groupOnColumn:l,setFilterState:s,settingsConfig:u,hideSelectAll:c})=>d`<sort-and-group-provider .value=${t}>
...
`,or=({settingsConfig:n})=>{const{columns:e,collapsed:t}=n,o=e.filter(r=>!t.some(i=>i.name===r.name));return d`<div class="skeleton">
	...
	</div>`};customElements.define("cosmoz-omnitable-skeleton",E(or,{styleSheets:[nr]}));const rr=({slot:n,title:e,className:t,width:o="24",height:r="24",styles:i}={})=>d`
  <svg
    slot=${fe(n)}
    class=${`delete-icon ${t??""}`}
    viewBox="0 0 24 24"
...
`,ir=(n,e)=>{const{settingsConfig:t}=n,{processedItems:o,dataIsValid:r,filterIsTooStrict:i,loading:a,displayEmptyGroups:l,compareItemsFn:s,setSelectedItems:u,renderItem:c,renderGroup:m,error:h}=e;return d`${D(!a&&!r&&!h,()=>d`<div class="tableContent-empty">
...
`,se=n=>{const e=parseInt(n,10);return isFinite(e)?e:void 0},sr=n=>{const{config:e}=n,{settings:t,setSettings:o,collapsed:r}=e,i=Re({collapsed:r,settings:t.columns,setSettings:z(a=>o(l=>({...l,columns:a})),[o])});return{...e,onDown:z(a=>{a.target.closest(".pull")&&(i.handle=a.currentTarget)},[i]),onDragStart:z(a=>{const{target:l}=a,s=se(l.dataset.index);if(!i.handle?.contains(l)||s==null)return a.preventDefault();i.handle=null,a.dataTransfer.effectAllowed="move",a.dataTransfer.setData("omnitable/sort-index",s),a.dataTransfer.setData("text/plain",s),setTimeout(()=>l.classList.add("drag"),0),l.addEventListener("dragend",u=>u.target.classList.remove("drag"),{once:!0})},[i]),onDragEnter:z(a=>{const l=a.currentTarget;l===a.target&&(a.preventDefault(),a.dataTransfer.dropEffect="move",l.classList.add("dragover"))},[]),onDragOver:z(a=>{a.preventDefault(),a.currentTarget.classList.add("dragover")},[]),onDragLeave:z(a=>{const l=a.currentTarget;l.contains(a.relatedTarget)||l.classList.remove("dragover")},[]),onDrop:z(a=>{const l=se(a.dataTransfer.getData("omnitable/sort-index")),s=se(a.currentTarget.dataset.index),{settings:u,setSettings:c}=i;a.currentTarget.classList.remove("dragover"),a.preventDefault();const m=u.slice();m.splice(s+(l>=s?0:-1),0,m.splice(l,1)[0]),c(m)},[i]),onToggle:z(a=>{const{settings:l,setSettings:s}=i,u=l.map(m=>({...m,disabled:m.disabled||i.collapsed?.some(h=>h.name===m.name)})),c=se(a.target.closest("[data-index]")?.dataset.index);u.splice(c,1,{...l[c],disabled:!a.target.checked,priority:a.target.checked?l.reduce((m,h)=>Math.max(m,h.priority),0)+1:l[c].priority}),s(u)},[i])}},ur=[dn({apply({availableHeight:n,elements:e}){Object.assign(e.floating.style,{maxHeight:`${Math.max(0,n)}px`})}}),...mn],cr=({onDragStart:n,onDragEnter:e,onDragOver:t,onDragLeave:o,onDrop:r,onDown:i,onToggle:a,collapsed:l,filters:s})=>(u,c)=>{const m=!!l?.find(p=>p.name===u.name),h=!u.disabled&&!m;return d` <div
			class="item"
			data-index=${c}
			@mousedown=${i}
			draggable="true"
		...
		>
			...
			<input
				...
				.indeterminate=${m}
			/>
		</div>`},dr=n=>{const{settings:e,settingsId:t,onSave:o,onReset:r,hasChanges:i,opened:a,setOpened:l,...s}=sr(n);return d` <div class="headline">
			${k("Sort and filter")}
			<button
				class="close"
		...
		<div class="contents">
			...
			>
				<div class="list">${e.columns?.map(cr(s))}</div>
			</cosmoz-collapse>
			...
			<cosmoz-collapse ?opened=${a.sort}> ${Mo()} </cosmoz-collapse>
		...
		${D(t,()=>d`<div class="buttons">
				...
				</div>`)}`};customElements.define("cosmoz-omnitable-settings-ui",E(dr,{styleSheets:[Te(ar)]}));const mr=({config:n,newLayout:e})=>d`
	<cosmoz-dropdown
...
`;customElements.define("cosmoz-omnitable-settings",E(mr,{styleSheets:[Te(lr)]}));const be=["sortOn","descending","groupOn","groupOnDescending"],ue=n=>e=>typeof e=="object"&&e!==null&&"name"in e&&e.name===n,pr=(n=[],e=[],t=[])=>{const o=e.filter(a=>n.some(ue(a.name))),r=n.filter(a=>a.name!=null&&!e.some(ue(a.name))&&!t.some(ue(a.name))),i=t.filter(a=>!e.some(ue(a.name)));return[...o,...i.flatMap(a=>{const l=n.find(s=>s.name===a.name);return l?{...a,title:l.title??a.title??"",minWidth:parseInt(l.minWidth??"0",10)}:[]}),...r.map(a=>{const{name:l,title:s,priority:u,minWidth:c,width:m,flex:h}=a;return{name:l??"",title:s??"",priority:u??0,minWidth:parseInt(c??"0",10),width:parseInt(m??"0",10),flex:parseInt(h??"0",10)}})]},gr=(n,e)=>({...e,...Oe(Array.from(be))(n),columns:n.columns?.map(Oe(["name","priority","width","flex","disabled"]))}),hr=({columns:n,settings:e,savedSettings:t,initial:o})=>({...Object.fromEntries(be.flatMap(i=>o?.[i]!=null?[[i,o[i]]]:[])),...t?Oe(Array.from(be))(t):{},...e,columns:pr(n,e?.columns,t?.columns)}),fr=({prefix:n="omnitable-"}={})=>({write:async(t,o)=>{const r=n+t;try{o?localStorage.setItem(r,JSON.stringify(o)):localStorage.removeItem(r)}catch(i){console.error(i)}},read:async t=>{if(t)try{const o=localStorage.getItem(n+t);return o==null?void 0:JSON.parse(o)}catch(o){console.error(o)}}}),br=$t(fr),xr=()=>{const n=Ee(br);return I(()=>n(),[n])},vr=(n,e,t,o)=>{const[r,i]=M(),{read:a,write:l}=xr();return T(async()=>{n&&i(await a(n))},[n,a]),{settingsId:n,savedSettings:r,onSave:z(async()=>{if(!n)return;const s=gr(e,r);await l(n,s),t(),i(s)},[e,r]),onReset:z(async s=>{t(),s.shiftKey&&(await l(n),i()),o?.()},[o]),hasChanges:e!=null}},yr=({settingsId:n,host:e})=>{const t=I(()=>Object.fromEntries(be.map(b=>[b,e[b]])),[]),o=Me(),r=z(()=>{o.current?.(t)},[t]),[i,a]=M(),[l,s]=M({columns:!0,sort:!0}),{savedSettings:u,...c}=vr(n,i,a,r),{enabledColumns:m}=e,h=En(e,{enabledColumns:m}),p=I(()=>hr({columns:h,settings:i,savedSettings:u,initial:t}),[h,i,u]),y=I(()=>p.columns.map(b=>h.find($=>$.name===b.name)).filter(Boolean),[h,...p.columns.map(b=>b.name)]);return{...c,opened:l,setOpened:s,settings:p,columns:y,setSettings:a,resetRef:o}},gt=n=>Number.isFinite(n)?n:0,$r=(n,e)=>{const t=[];let[o,r]=n.reduce(([c,m],{width:h,flex:p})=>[c+h,m+p],[0,0]),i=e-o,a=gt(i/r),l=0,s=0,u=0;for(let c=0;c<n.length;c++){const{width:m,minWidth:h,flex:p}=n[c],y=i>=0?a*p:m*i/o;if(h>m+y){l+=m,s+=h,u+=p,t[c]=h;continue}if(p===0){l+=m,s+=m,t[c]=m;continue}}o-=l,i=e-s-o,r-=u,a=gt(i/r);for(let c=0;c<n.length;c++){if(t[c]!=null)continue;const{width:m,flex:h}=n[c],p=i>=0?a*h:m*i/o;t[c]=m+p}return t},xe=Symbol("index"),wr=(n,e)=>{if(typeof n.findLastIndex=="function")return n.findLastIndex(e);for(let t=n.length-1;t>=0;t--)if(e(n[t],t,n))return t;return-1},zr=(n,e)=>{const t=wr(n,a=>a!=null&&a>0),o=(a,l)=>`.cell[name="${a}"], cosmoz-omnitable-skeleton::part(cell-${a}){width: ${Math.floor(l)}px;padding: 0 min(3px, ${l/2}px)}`,r=a=>`cosmoz-omnitable-resize-nub[name="${a}"]{display:none}`,i=a=>`cosmoz-omnitable-resize-nub[name="${a}"], .cell[name="${a}"]{display:none}`;return e.map((a,l)=>{const s=n[l];if(s==null||s===0)return i(a.name);const u=o(a.name,s);return l===t?`${u}
${r(a.name)}`:u}).join(`
`)},Mt=(n,e,t)=>{const o=n.filter(l=>!l.hidden),r=o.reduce((l,{width:s})=>l+s,0);if(o.length>1&&r>e)return Mt(o.slice(1),e,t);const i=o.reduce(([l,s],u,c)=>[Math.max(l,u.index),u.index>l?c:s],[-1,-1])[1];return i!==-1&&(o[i].flex=1),$r(o,e).reduce((l,s,u)=>(l[o[u].index]=s,l),new Array(t).fill(void 0))},Cr=(n,e)=>n.length===0?".cell {display: none;}":zr(n,e),Sr=({host:n,canvasWidth:e,layout:t,setSettings:o})=>{const r=Me();r.current=i=>o(a=>{const l=a.columns,{detail:{newWidth:s,column:u}}=i,c=l.findIndex(p=>p.name===u.name),m=[],h=l.reduce((p,y)=>Math.max(p,y.priority),-1/0);for(let p=0;p<t.length;p++)if(m[p]={...l[p]},p<c&&t[p]!=null&&(m[p].width=t[p],m[p].flex=0,m[p].priority=h),p===c){const y=t.reduce((b,$,F)=>F<c&&$?b-$:b,e);m[p].width=Math.min(y,Math.max(s,l[p].minWidth)),m[p].flex=0,m[p].priority=h}return{...a,columns:m}}),T(()=>{const i=a=>r.current?.(a);return n.addEventListener("column-resize",i),()=>n.removeEventListener("column-resize",i)},[])},_r=20,kr=44,Ir=24,Nt=_r+kr+Ir,Fr=(n,e)=>T(()=>{const t=([r])=>{r.contentRect?.width!==0&&requestAnimationFrame(()=>e(r.contentRect?.width-Nt))},o=new ResizeObserver(t);return o.observe(n),()=>o.unobserve(n)},[]),Or=n=>{const[e,t]=M(()=>n.getBoundingClientRect().width-Nt);return Fr(n,t),e},Dr=(n,e)=>{const t=I(()=>{let o=!1,r;const i=()=>{if(!o)return;r=requestAnimationFrame(i),n()&&(o=!1)};return{start:()=>{o=!0,cancelAnimationFrame(r),r=requestAnimationFrame(i)},stop:()=>{o=!1,cancelAnimationFrame(r)}}},[]);T(()=>{t.start()},e),T(()=>()=>t.stop(),[])},Vr=(n=0,e=0)=>Math.abs((n??0)-(e??0))<.1,Ar=(n,e=1.9,t=pn)=>{const o=Re({target:n}),r=z(()=>{if(!o.tween)return o.tween=o.target,t(o.tween),!0;if(o.target.every((i,a)=>o.tween[a]===i))return t(o.tween),!0;o.tween=o.target.map((i,a)=>Vr(o.tween[a],i)?i:(o.tween[a]??0)+((i??0)-(o.tween[a]??0))/e||0),t(o.tween)},[]);Dr(r,[n])},Er=({canvasWidth:n,groupOnColumn:e,config:t,miniColumn:o})=>I(()=>{if(!Array.isArray(t)||n==null||n===0)return[];const r=t.map((i,a)=>({minWidth:i.minWidth,width:i.width,flex:i.flex,priority:i.priority,name:i.name,index:a,hidden:i.name===e?.name||i.disabled})).map(i=>o?{...i,hidden:o.name!==i.name}:i).sort(({index:i,priority:a},{index:l,priority:s})=>a===s?l-i:a-s);return Mt(r,n,r.length)},[n,e,t]),Tr=({host:n,canvasWidth:e,columns:t})=>{const o=n.miniBreakpoint??480,r=I(()=>e<=o,[e,o]),i=I(()=>r?t?.filter(u=>u.mini!=null).sort((u,c)=>(u.mini??0)-(c.mini??0)):[],[t,r]),[a,...l]=i??[],s=!!a;return T(()=>{n.toggleAttribute("mini",s)},[s]),{isMini:s&&r,miniColumn:a,miniColumns:l}},Lr=n=>{const e=I(()=>new CSSStyleSheet,[]);return T(()=>{n.shadowRoot.adoptedStyleSheets=[...n.shadowRoot.adoptedStyleSheets,e]},[]),e},Rr=({host:n,columns:e,settings:t,setSettings:o,resizeSpeedFactor:r,sortAndGroupOptions:i})=>{const a=Or(n),{isMini:l,miniColumn:s,miniColumns:u}=Tr({host:n,canvasWidth:a,columns:e}),{groupOnColumn:c}=i,m=Er({canvasWidth:a,groupOnColumn:c,miniColumn:s,config:t.columns}),h=Lr(n),p=I(()=>t.columns.reduce((b,$,F)=>m[F]!=null||$.name===c?.name||$.disabled?b:[...b,e.find(g=>g.name===$.name)].filter(g=>g!=null),[]),[e,t,m,c]),y=Re({columns:t.columns});return Ar(m,r,b=>{const $=Cr(b,y.columns);h.replace($)}),Sr({host:n,canvasWidth:a,layout:m,setSettings:b=>o(b(t))}),{isMini:l,collapsedColumns:p,miniColumns:u}},Mr=({host:n,...e})=>{const{csvFilename:t="omnitable.csv",xlsxFilename:o="omnitable.xlsx",xlsxSheetname:r="Omnitable",topPlacement:i="top-end"}=n;return{csvFilename:t,xlsxFilename:o,xlsxSheetname:r,topPlacement:i,...e}},Nr=({host:n,selectedItems:e,data:t,sortAndGroupOptions:o,collapsedColumns:r,settings:i,filterFunctions:a,settingS:l,filters:s,...u})=>{const c=t&&t.length>0&&e.length===t.length,m=b=>{b.target.checked?n.shadowRoot.querySelector("#groupedList").selectAll():n.shadowRoot.querySelector("#groupedList").deselectAll()},{groupOnColumn:h}=o,p=I(()=>[h,...r,...i.columns.filter(b=>b.disabled)].some(b=>b&&Object.keys(a).includes(b.name)),[a,i,r]),y=I(()=>({...l,collapsed:r,badge:p,filters:s}),[l,r,p,s]);return T(()=>{const b=n.shadowRoot.querySelector("#tableContent"),$=new ResizeObserver(F=>requestAnimationFrame(()=>{n.style.setProperty("--ot-height",F[0]?.contentRect.height+"px")}));return $.observe(b),()=>$.unobserve(b)},[]),{allSelected:c,onAllCheckboxChange:m,data:t,settingsConfig:y,filters:s,groupOnColumn:h,sortAndGroup:o.sortAndGroup,...u}},jt=d`
	<svg
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
...
`,jr=n=>n?"groupRow groupRow-folded":"groupRow",Pr=({item:n,index:e})=>t=>D((t?.length??0)>0,()=>d`
			...
			`),Br=({columns:n,collapsedColumns:e,miniColumns:t,onItemClick:o,onCheckboxChange:r,dataIsValid:i,groupOnColumn:a,onItemChange:l,rowPartFn:s})=>(u,c,{selected:m,expanded:h,toggleCollapse:p})=>d`
		<div
			?selected=${m}
	...
	`,Hr=({onCheckboxChange:n,dataIsValid:e,groupOnColumn:t})=>(o,r,{selected:i,folded:a,toggleFold:l})=>d` <div
			class="${jr(a)}"
		...
		</div>`,Gr=({host:n,error:e,dataIsValid:t,processedItems:o,columns:r,collapsedColumns:i,miniColumns:a,sortAndGroupOptions:l,rowPartFn:s,...u})=>{const{loading:c=!1,displayEmptyGroups:m=!1,compareItemsFn:h}=n,p=Me({shiftKey:!1,ctrlKey:!1}),y=z(g=>{const _=g.target,f=_.dataItem,v=_.checked,x=n.shadowRoot.querySelector("#groupedList");p.current.shiftKey?x.toggleSelectTo(f,v):p.current.ctrlKey?(_.checked=!0,x.selectOnly(f)):x.toggleSelect(f,v),g.preventDefault(),g.stopPropagation()},[]);T(()=>{const g=({shiftKey:_,ctrlKey:f})=>{p.current={shiftKey:_,ctrlKey:f}};return window.addEventListener("keydown",g),window.addEventListener("keyup",g),()=>{window.removeEventListener("keydown",g),window.removeEventListener("keyup",g)}},[]);const b=z(g=>{const _=g.currentTarget,f=g.composedPath();f.slice(0,f.indexOf(_)).find(x=>x.matches?.("a, .checkbox, .expand"))||n.dispatchEvent(new window.CustomEvent("omnitable-item-click",{bubbles:!0,composed:!0,detail:{item:_.dataItem,index:_.dataIndex}}))},[]),{groupOnColumn:$}=l,F=z((g,_)=>f=>Tn(n,g,_,f),[]);return{...u,processedItems:o,dataIsValid:t,filterIsTooStrict:t&&o.length<1,loading:c,compareItemsFn:h,displayEmptyGroups:m,error:e,renderItem:I(()=>Br({columns:r,collapsedColumns:i,miniColumns:a,onItemClick:b,onCheckboxChange:y,dataIsValid:t,groupOnColumn:$,onItemChange:F,rowPartFn:s}),[r,i,b,y,t,$,F,s]),renderGroup:I(()=>Hr({onCheckboxChange:y,dataIsValid:t,groupOnColumn:$}),[y,t,$])}},Wr=(n,e)=>{if(n===e)return 0;if(n==null)return-1;if(e==null)return 1;const t=typeof n,o=typeof e;return t==="object"&&o==="object"?n.toString()<e.toString()?-1:1:t==="number"&&o==="number"?n-e:t==="string"&&o==="string"?n<e?-1:1:t==="boolean"&&o==="boolean"?n?-1:1:(console.warn("unsupported sort",t,n,o,e),0)},ke=(n,e)=>(t,o)=>Wr(n(t),n(o))*(e?-1:1),qr=n=>n.replace(/([a-z0-9])([A-Z])/gu,"$1-$2").toLowerCase(),ht=(n,e)=>{!n||!e||!n[U]||Object.entries(e).forEach(([t,o])=>{const r=n[U];r.__ownChange=!0,r[t]=o,r.__ownChange=!1,r.dispatchEvent(new CustomEvent(`${qr(t)}-changed`,{bubbles:!0,detail:{value:o}}))})},Ie=(n,e)=>Object.assign(n,{[xe]:e}),ce=Symbol("unparsed"),Xr=({data:n,columns:e,hashParam:t,sortAndGroupOptions:o,noLocalSort:r,noLocalFilter:i})=>{const{groupOnColumn:a,groupOnDescending:l,sortOnColumn:s,descending:u}=o,c=z(([f,v])=>{const x=e.find(({name:w})=>w===f);return x==null?[f,void 0]:[f,v.filter&&x.serializeFilter?.(x,v.filter)]},[e]),m=z(([f,v])=>{const x=e.find(({name:S})=>S===f);if(x==null)return[f,{[ce]:v}];const w={filter:x.deserializeFilter?.(x,v)};return ht(x,w),[f,w]},[e]),[h,p]=J({},t,{multi:!0,suffix:"-filter--",write:c,read:m}),y=z((f,v)=>p(x=>{const w=ye(v,x[f]);return ht(e.find(S=>S.name===f),w),{...x,[f]:{...x[f],...w}}}),[e,p]),b=I(()=>Object.values(h).map(f=>f.filter),[h]),$=I(()=>Object.fromEntries(e.map(f=>[f.name,!f.noLocalFilter&&f.getFilterFn?.(f,h[f.name]?.filter)]).filter(([,f])=>!!f)),[e,...b]),F=I(()=>!Array.isArray(n)||n.length===0?[]:Object.entries($).length===0||i?n.slice():n.filter(f=>Object.values($).every(v=>v(f))),[n,$,i]),g=I(()=>{if(!r&&!a&&s!=null&&s.sortPath!=null)return F.slice().sort(ke(f=>s.getComparableValue?.({...s,valuePath:s.sortPath},f),u));if(a!=null&&a.groupOn!=null){const f=F.reduce((v,x)=>{const w=a.getComparableValue?.({...a,valuePath:a.groupOn},x);if(w===void 0)return v;let S=v.find(R=>R.id===w);return S?(S.items.push(x),v):(S={id:w,name:w,items:[x]},[...v,S])},[]);return f.sort(ke(v=>a.getComparableValue?.({...a,valuePath:a.groupOn},v.items[0]),l)),!s||r?f:f.filter(v=>Array.isArray(v.items)).map(v=>(v.items.sort(ke(x=>s.getComparableValue?.({...s,valuePath:s.sortPath},x),u)),v))}return F},[F,a,l,s,u,r]),_=I(()=>{let f=0,v=0;const x=[];return g.forEach(w=>{if("items"in w&&Array.isArray(w.items)){Ie(w,v++),w.items.forEach(S=>{Ie(S,f++),x.push(S)});return}Ie(w,f++),x.push(w)},[]),x},[g]);return T(()=>{p(f=>Object.values(f).some(x=>x[ce]!=null)?Object.fromEntries(Object.entries(f).map(([x,w])=>w[ce]==null?[x,w]:m([x,w[ce]]))):f)},[m]),{processedItems:g,visibleData:_,filters:h,filterFunctions:$,setFilterState:y}},Ur=n=>{const e=o=>{const r=n.data.indexOf(o);if(r<0)return null;const i=n.data.splice(r,1);if(n.data=n.data.slice(),Array.isArray(i)&&i.length>0)return i[0]},t=(o,r)=>{n.data.splice(o,1,r),n.data=n.data.slice()};return{removeItem:e,removeItems(o){const r=[];for(let i=o.length-1;i>=0;i-=1){const a=n.removeItem(o[i]);a!=null&&r.push(a)}return r},replaceItemAtIndex:t,replaceItem(o,r){const i=n.data.indexOf(o);if(i>-1)return t(i,r)},selectItem(o){n.shadowRoot.querySelector("#groupedList").select(o)},selectAll(){n.shadowRoot.querySelector("#groupedList").selectAll()},deselectAll(){n.shadowRoot.querySelector("#groupedList").deselectAll()},deselectItem(o){n.shadowRoot.querySelector("#groupedList").deselect(o)},isItemSelected(o){return n.shadowRoot.querySelector("#groupedList").isItemSelected(o)}}},Kr=({host:n,visibleData:e,filters:t,...o})=>{const{setFilterState:r}=o,i=I(()=>Ur(n),[]);De(o,Object.values(o)),De(i,Object.values(i)),T(()=>{const l=s=>r(s.detail.name,u=>({...u,...s.detail.state}));return n.addEventListener("legacy-filter-changed",l),()=>n.removeEventListener("legacy-filter-changed",l)},[]),P("visibleData",e),P("sortedFilteredGroupedItems",o.sortedFilteredGroupedItems),P("selectedItems",o.selectedItems),P("sortOn",o.sortOn),P("descending",o.descending),P("isMini",o.isMini);const a=I(()=>Object.fromEntries(Object.entries(t).filter(([,{filter:l}])=>l!==void 0).map(([l,{filter:s}])=>[l,s])),[t]);P("filters",a,Object.values(a))},Jr=n=>{const{hashParam:e,settingsId:t,data:o,resizeSpeedFactor:r,noLocal:i,noLocalSort:a=i,noLocalFilter:l=i,error:s,rowPartFn:u}=n,c=yr({settingsId:t,host:n}),{settings:m,setSettings:h,columns:p,resetRef:y}=c,b=Bo(p,e,m,h,y),{processedItems:$,visibleData:F,filters:g,setFilterState:_,filterFunctions:f}=Xr({data:o,columns:p,hashParam:e,sortAndGroupOptions:b,noLocalSort:a,noLocalFilter:l}),{isMini:v,collapsedColumns:x,miniColumns:w}=Rr({host:n,columns:p,settings:m,setSettings:h,resizeSpeedFactor:r,sortAndGroupOptions:b}),S=o&&Array.isArray(o)&&o.length>0,[R,H]=M([]);return Kr({host:n,visibleData:F,sortedFilteredGroupedItems:$,columns:p,filters:g,setFilterState:_,selectedItems:R,isMini:v,...b}),{header:Nr({host:n,selectedItems:R,sortAndGroupOptions:b,dataIsValid:S,data:o,columns:p,filters:g,collapsedColumns:x,settings:m,filterFunctions:f,settingS:c,setFilterState:_,hideSelectAll:n.hideSelectAll===!0}),list:Gr({host:n,error:s,dataIsValid:S,processedItems:$,setSelectedItems:H,columns:p,collapsedColumns:x,miniColumns:w,sortAndGroupOptions:b,rowPartFn:u}),footer:Mr({host:n,selectedItems:R,columns:p})}};customElements.define("cosmoz-grouped-list-row",class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||Fe(this._renderFn(this._item,this._index),this)}});const Yr={group:Symbol("group")},ze=(n,e)=>(e.has(n)||e.set(n,{}),e.get(n)),Qr=(n,e)=>!!ze(n,e).expanded,Zr=(n,e)=>!!ze(n,e).folded,Ve=n=>n?n.items instanceof Array:!1,ei=n=>{if(!Array.isArray(n)||n.length===0)return;const e=Array.isArray(n[0]?.items);if(!n.every(o=>Array.isArray(o.items)===e))throw new Error("Data must be homogeneous.")},ti=(n,e,t)=>Array.isArray(n)?(ei(n),n.reduce((r,i)=>{const a=i;if(!a.items)return r.concat(i);if(a.items.length){if(ze(i,t).folded)return r.concat(i);const l=a.items.map(s=>Object.assign(s,{[Yr.group]:i}));return r.concat(i,l)}return e?r.concat(i):r},[])):void 0,ni=(n,...e)=>typeof n=="function"?n(...e):n,oi=(n,e)=>n===e,ri=()=>{const[n,e]=M(()=>[new WeakMap]);return{setItemState:z((o,r)=>e(([i])=>{const a=ze(o,i);return Object.assign(a,ni(r,a)),[i]}),[]),state:n[0],signal:n}},ii=()=>{const{setItemState:n,state:e,signal:t}=ri(),o=z((i,a)=>{Ve(i)&&n(i,l=>({folded:a!==void 0?a:!l.folded}))},[]),r=z((i,a)=>{Ve(i)||n(i,l=>({expanded:a!==void 0?!a:!l.expanded}))},[]);return{state:e,signal:t,toggleFold:o,toggleCollapse:r}},ai=({initial:n,compareItemsFn:e,data:t,flatData:o})=>{const[r,i]=M(n),[a,l]=M(),s=z(g=>r.includes(g),[r]),u=z(g=>g?.items?.every(s)??!1,[s]),c=z(g=>s(g)||u(g),[s,u]),m=z(g=>{const f=g.items??[g];i(v=>[...v,...f.filter(x=>!v.includes(x))]),l(g)},[]),h=z(g=>{const f=g.items??[g];i(v=>v.filter(x=>!f.includes(x))),l(g)},[]),p=z(g=>{i(g.items?.slice()||[g]),l(g)},[]),y=z(()=>{i(t.flatMap(g=>g.items||g)),l(void 0)},[t]),b=z(()=>{i([]),l(void 0)},[]),$=z((g,_=!c(g))=>_?m(g):h(g),[c]),F=z((g,_)=>{if(!o)return;const f=a?o.findIndex(w=>e(w,a)):-1;if(f<0)return $(g,_);const[v,x]=[f,o.indexOf(g)].sort((w,S)=>w-S);o.slice(v,x+1).forEach((w,S,R)=>{S>0&&S<R.length-1&&Ve(w)||$(w,_)}),l(g)},[o,e,$]);return T(()=>i(g=>g.length>0&&o?o.filter(_=>g.find(f=>e(_,f))):g),[o]),{selectedItems:r,isItemSelected:s,isGroupSelected:u,isSelected:c,select:m,deselect:h,selectOnly:p,selectAll:y,deselectAll:b,toggleSelect:$,toggleSelectTo:F}},li={host:{position:"relative",display:"flex",flexDirection:"column"}},si=n=>{const{data:e,renderItem:t,renderGroup:o,displayEmptyGroups:r,compareItemsFn:i=oi}=n,{toggleFold:a,toggleCollapse:l,state:s,signal:u}=ii(),c=I(()=>ti(e,r,s),[e,r,u]),{selectedItems:m,isItemSelected:h,isGroupSelected:p,isSelected:y,select:b,deselect:$,selectOnly:F,selectAll:g,deselectAll:_,toggleSelect:f,toggleSelectTo:v}=ai({initial:[],compareItemsFn:i,data:e,flatData:c}),x=z((S,R)=>Array.isArray(S.items)?o(S,R,{selected:p(S),folded:Zr(S,s),toggleSelect:H=>f(S,typeof H=="boolean"?H:void 0),toggleFold:()=>a(S)}):t(S,R,{selected:m.includes(S),expanded:Qr(S,s),toggleSelect:H=>f(S,typeof H=="boolean"?H:void 0),toggleCollapse:()=>l(S)}),[t,o,m,f,u]);xt(()=>{Object.assign(n.style,li.host)},[]),P("selectedItems",m);const w={toggleFold:a,toggleCollapse:l,isItemSelected:h,isGroupSelected:p,isSelected:y,select:b,deselect:$,selectOnly:F,selectAll:g,deselectAll:_,toggleSelect:f,toggleSelectTo:v};return De(w,Object.values(w)),{renderRow:x,flatData:c}},ui=({renderRow:n,flatData:e})=>gn({items:e,renderItem:(t,o)=>d`<cosmoz-grouped-list-row
				.item=${t}
				.index=${o}
				.renderFn=${n}
			></cosmoz-grouped-list-row>`}),ci=n=>ui(si(n));customElements.define("cosmoz-grouped-list",E(ci,{useShadowDOM:!1}));const di=n=>window.ShadyCSS?.ApplyShim?.transformCssText?.(n)||n,mi=n=>{const{header:e,list:t,footer:o}=Jr(n);return d`
		<style>
			${hn([],()=>di(Jo))}
		</style>
	...
	`};customElements.define("cosmoz-omnitable",class extends E(mi,{observedAttributes:["hash-param","sort-on","group-on","descending","group-on-descending","hide-select-all","settings-id","no-local","no-local-sort","no-local-filter","loading","mini-breakpoint"]}){connectedCallback(){super.connectedCallback(),Ce(this,"selectedItems",[]),Ce(this,"visibleData",[]),Ce(this,"sortedFilteredGroupedItems",[])}});const ve=`
