import{n as e}from"./chunk-BneVvdWh.js";import{$ as t,X as n,Z as r,et as i,n as a,t as o}from"./iframe-D-uvezHW.js";import{$ as s,A as c,At as l,B as u,C as d,Ct as f,D as p,Dt as m,E as h,Et as g,F as _,Ft as v,G as y,H as b,I as x,It as ee,J as te,K as ne,L as re,Lt as ie,M as ae,N as oe,Nt as se,O as ce,Ot as S,P as le,Pt as C,Q as ue,R as de,S as fe,St as w,T as pe,Tt as T,U as me,V as he,W as ge,X as E,Y as _e,Z as D,_ as ve,_t as O,a as ye,at as be,b as k,bt as xe,c as Se,ct as Ce,d as we,dt as Te,et as Ee,f as De,ft as Oe,g as ke,gt as Ae,h as je,ht as Me,i as Ne,it as Pe,j as Fe,jt as Ie,k as Le,kt as Re,l as ze,lt as Be,m as Ve,mt as He,n as Ue,nt as A,o as We,ot as Ge,p as Ke,pt as qe,q as Je,r as Ye,rt as j,s as Xe,st as Ze,t as Qe,tt as $e,u as et,ut as tt,v as nt,vt as M,w as rt,wt as it,x as at,xt as ot,y as st,yt as ct,z as lt}from"./dist-BC7PBfC2.js";var ut,dt,ft=e((()=>{u(),O(),ut=b`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`})),Li,Ri,zi=e((()=>{Ne(),Li=e=>{let t=e.replace(/"/gu,`""`);return t.search(/("|,|\n)/gu)>=0?`"`+t+`"`:e},Ri=(e,t,n)=>{let r=e.filter(e=>e.title!=null&&`getString`in e&&typeof e.getString==`function`),i=r.map(e=>Li(e.title)).join(`;`)+`
`,a=t.map(e=>r.map(t=>{let n=t.getString(t,e);return n==null?``:Li(String(n))}).join(`;`)+`
`);a.unshift(i),ye(new File(a,n,{type:`text/csv;charset=utf-8`}))}})),Bi,Vi,Hi=e((()=>{Ue(),Ne(),Bi=(e,t)=>{let n=e.filter(e=>e.title!=null&&`toXlsxValue`in e&&typeof e.toXlsxValue==`function`),r=n.map(e=>e.title),i=t.map(e=>n.map(t=>t.toXlsxValue(t,e)??``));return i.unshift(r),i},Vi=(e,t,n,r)=>{let i=Bi(e,t),a=new Ye(n).addSheetFromData(i,r).generate();ye(new File([a],n,{type:`application/vnd.openxmlformats-officedocument.spreadsheetml.sheet`}))}})),Ui,Wi=e((()=>{ne(),o(),i(),zi(),Hi(),Ui=({columns:e,selectedItems:n,csvFilename:r,xlsxFilename:i,xlsxSheetname:o,topPlacement:s})=>t`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!Je(n.length)}
		part="bottomBar"
