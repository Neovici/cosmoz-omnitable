import{r as Qn,D as yr,E as H,A as it,d as O,p as ti,n as _r,M as br,u as mt,v as Mt,h as Qe,w as ei}from"./iframe-UsFv1mkh.js";import{_ as wr}from"./preload-helper-PPVm8Dsz.js";const vr={duration:250},si=e=>(t,s,n)=>{const i="max"+e.charAt(0).toUpperCase()+e.slice(1);Object.assign(t.style,{[i]:"",display:""});const{[e]:r}=t.getBoundingClientRect(),o=[0,r],[a,l]=s?o:o.slice().reverse(),c=t.animate([{[i]:`${a}px`},{[i]:`${l}px`}],{...vr,...n});c.onfinish=()=>Object.assign(t.style,{[i]:"",display:s?"":"none"})};let we,ni=0;function Bs(e){we=e}function js(){we=null,ni=0}function xr(){return ni++}const ts=Symbol("haunted.phase"),ge=Symbol("haunted.hook"),Vs=Symbol("haunted.update"),Us=Symbol("haunted.commit"),gt=Symbol("haunted.effects"),Wt=Symbol("haunted.layoutEffects"),ds="haunted.context";class Sr{update;host;virtual;[ge];[gt];[Wt];constructor(t,s){this.update=t,this.host=s,this[ge]=new Map,this[gt]=[],this[Wt]=[]}run(t){Bs(this);let s=t();return js(),s}_runEffects(t){let s=this[t];Bs(this);for(let n of s)n.call(this);js()}runEffects(){this._runEffects(gt)}runLayoutEffects(){this._runEffects(Wt)}teardown(){this[ge].forEach(s=>{typeof s.teardown=="function"&&s.teardown(!0)})}}const Cr=Promise.resolve().then.bind(Promise.resolve());function ii(){let e=[],t;function s(){t=null;let n=e;e=[];for(var i=0,r=n.length;i<r;i++)n[i]()}return function(n){e.push(n),t==null&&(t=Cr(s))}}const Er=ii(),Hs=ii();class Pr{renderer;host;state;[ts];_updateQueued;_active;constructor(t,s){this.renderer=t,this.host=s,this.state=new Sr(this.update.bind(this),s),this[ts]=null,this._updateQueued=!1,this._active=!1}update(){this._active&&(this._updateQueued||(Er(()=>{let t=this.handlePhase(Vs);Hs(()=>{this.handlePhase(Us,t),Hs(()=>{this.handlePhase(gt)})}),this._updateQueued=!1}),this._updateQueued=!0))}handlePhase(t,s){switch(this[ts]=t,t){case Us:this.commit(s),this.runEffects(Wt);return;case Vs:return this.render();case gt:return this.runEffects(gt)}}render(){return this.state.run(()=>this.renderer.call(this.host,this.host))}runEffects(t){this.state._runEffects(t)}teardown(){this.state.teardown()}pause(){this._active=!1}resume(){this._active=!0}}const Ps=(...e)=>{const t=new CSSStyleSheet;return t.replaceSync(e.join("")),t},Or=e=>e?.map(t=>typeof t=="string"?Ps(t):t),Tr=(e,...t)=>e.flatMap((s,n)=>[s,t[n]||""]).join(""),q=Tr,Ar=(e="")=>e.replace(/-+([a-z])?/g,(t,s)=>s?s.toUpperCase():"");function $r(e){class t extends Pr{frag;renderResult;constructor(i,r,o){super(i,o||r),this.frag=r}commit(i){this.renderResult=e(i,this.frag)}}function s(n,i,r){const o=(r||i||{}).baseElement||HTMLElement,{observedAttributes:a=[],useShadowDOM:l=!0,shadowRootInit:c={},styleSheets:u}=r||i||{},d=Or(n.styleSheets||u);class h extends o{_scheduler;static get observedAttributes(){return n.observedAttributes||a||[]}constructor(){if(super(),l===!1)this._scheduler=new t(n,this);else{const g=this.attachShadow({mode:"open",...c});d&&(g.adoptedStyleSheets=d),this._scheduler=new t(n,g,this)}}connectedCallback(){this._scheduler.resume(),this._scheduler.update(),this._scheduler.renderResult?.setConnected(!0)}disconnectedCallback(){this._scheduler.pause(),this._scheduler.teardown(),this._scheduler.renderResult?.setConnected(!1)}attributeChangedCallback(g,y,_){if(y===_)return;let b=_===""?!0:_;Reflect.set(this,Ar(g),b)}}function f(m){let g=m,y=!1;return Object.freeze({enumerable:!0,configurable:!0,get(){return g},set(_){y&&g===_||(y=!0,g=_,this._scheduler&&this._scheduler.update())}})}const p=new Proxy(o.prototype,{getPrototypeOf(m){return m},set(m,g,y,_){let b;return g in m?(b=Object.getOwnPropertyDescriptor(m,g),b&&b.set?(b.set.call(_,y),!0):(Reflect.set(m,g,y,_),!0)):(typeof g=="symbol"||g[0]==="_"?b={enumerable:!0,configurable:!0,writable:!0,value:y}:b=f(y),Object.defineProperty(_,g,b),b.set&&b.set.call(_,y),!0)}});return Object.setPrototypeOf(h.prototype,p),h}return s}class ct{id;state;constructor(t,s){this.id=t,this.state=s}}function Lr(e,...t){let s=xr(),n=we[ge],i=n.get(s);return i||(i=new e(s,we,...t),n.set(s,i)),i.update(...t)}function ut(e){return Lr.bind(null,e)}function ri(e){return ut(class extends ct{callback;lastValues;values;_teardown;constructor(t,s,n,i){super(t,s),e(s,this)}update(t,s){this.callback=t,this.values=s}call(){const t=!this.values||this.hasChanged();this.lastValues=this.values,t&&this.run()}run(){this.teardown(),this._teardown=this.callback.call(this.state)}teardown(t){typeof this._teardown=="function"&&(this._teardown(),this._teardown=void 0),t&&(this.lastValues=this.values=void 0)}hasChanged(){return!this.lastValues||this.values.some((t,s)=>this.lastValues[s]!==t)}})}function oi(e,t){e[gt].push(t)}const L=ri(oi),kr=e=>e instanceof Element?e:e.startNode||e.endNode||e.parentNode,ai=ut(class extends ct{Context;value;_ranEffect;_unsubscribe;constructor(e,t,s){super(e,t),this._updater=this._updater.bind(this),this._ranEffect=!1,this._unsubscribe=null,oi(t,this)}update(e){return this.Context!==e&&(this._subscribe(e),this.Context=e),this.value}call(){this._ranEffect||(this._ranEffect=!0,this._unsubscribe&&this._unsubscribe(),this._subscribe(this.Context),this.state.update())}_updater(e){this.value=e,this.state.update()}_subscribe(e){const t={Context:e,callback:this._updater};kr(this.state.host).dispatchEvent(new CustomEvent(ds,{detail:t,bubbles:!0,cancelable:!0,composed:!0}));const{unsubscribe:n=null,value:i}=t;this.value=n?i:e.defaultValue,this._unsubscribe=n}teardown(){this._unsubscribe&&this._unsubscribe()}});function Rr(e){return t=>{const s={Provider:class extends HTMLElement{listeners;_value;constructor(){super(),this.style.display="contents",this.listeners=new Set,this.addEventListener(ds,this)}disconnectedCallback(){this.removeEventListener(ds,this)}handleEvent(n){const{detail:i}=n;i.Context===s&&(i.value=this.value,i.unsubscribe=this.unsubscribe.bind(this,i.callback),this.listeners.add(i.callback),n.stopPropagation())}unsubscribe(n){this.listeners.delete(n)}set value(n){this._value=n;for(let i of this.listeners)i(n)}get value(){return this._value}},Consumer:e(function({render:n}){const i=ai(s);return n(i)},{useShadowDOM:!1}),defaultValue:t};return s}}const k=ut(class extends ct{value;values;constructor(e,t,s,n){super(e,t),this.value=s(),this.values=n}update(e,t){return this.hasChanged(t)&&(this.values=t,this.value=e()),this.value}hasChanged(e=[]){return e.some((t,s)=>this.values[s]!==t)}}),P=(e,t)=>k(()=>e,t);function zr(e,t){e[Wt].push(t)}const hs=ri(zr),lt=ut(class extends ct{args;constructor(e,t,s){super(e,t),this.updater=this.updater.bind(this),typeof s=="function"&&(s=s()),this.makeArgs(s)}update(){return this.args}updater(e){const[t]=this.args;typeof e=="function"&&(e=e(t)),!Object.is(t,e)&&(this.makeArgs(e),this.state.update())}makeArgs(e){this.args=Object.freeze([e,this.updater])}}),Nr=ut(class extends ct{reducer;currentState;constructor(e,t,s,n,i){super(e,t),this.dispatch=this.dispatch.bind(this),this.currentState=i!==void 0?i(n):n}update(e){return this.reducer=e,[this.currentState,this.dispatch]}dispatch(e){this.currentState=this.reducer(this.currentState,e),this.state.update()}}),Mr=/([A-Z])/gu,se=ut(class extends ct{property;eventName;constructor(e,t,s,n){if(super(e,t),this.state.virtual)throw new Error("Can't be used with virtual components.");this.updater=this.updater.bind(this),this.property=s,this.eventName=s.replace(Mr,"-$1").toLowerCase()+"-changed",this.state.host[this.property]==null&&(typeof n=="function"&&(n=n()),n!=null&&this.updateProp(n))}update(e,t){return[this.state.host[this.property],this.updater]}updater(e){const t=this.state.host[this.property];typeof e=="function"&&(e=e(t)),!Object.is(t,e)&&this.updateProp(e)}updateProp(e){this.notify(e).defaultPrevented||(this.state.host[this.property]=e)}notify(e){const t=new CustomEvent(this.eventName,{detail:{value:e,path:this.property},cancelable:!0});return this.state.host.dispatchEvent(t),t}});function Ir(e){let t=e;return{get current(){return t},set current(s){t=s},get value(){return t},set value(s){t=s}}}function $t(e){return k(()=>Ir(e),[])}ut(class extends ct{update(){return this.state.host}});function Fr({render:e}){const t=$r(e),s=Rr(t);return{component:t,createContext:s}}const X={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},dt=e=>(...t)=>({_$litDirective$:e,values:t});let vt=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,s,n){this._$Ct=t,this._$AM=s,this._$Ci=n}_$AS(t,s){return this.update(t,s)}update(t,s){return this.render(...s)}};const Kt=(e,t)=>{const s=e._$AN;if(s===void 0)return!1;for(const n of s)n._$AO?.(t,!1),Kt(n,t);return!0},ve=e=>{let t,s;do{if((t=e._$AM)===void 0)break;s=t._$AN,s.delete(e),e=t}while(s?.size===0)},li=e=>{for(let t;t=e._$AM;e=t){let s=t._$AN;if(s===void 0)t._$AN=s=new Set;else if(s.has(e))break;s.add(e),jr(t)}};function Dr(e){this._$AN!==void 0?(ve(this),this._$AM=e,li(this)):this._$AM=e}function Br(e,t=!1,s=0){const n=this._$AH,i=this._$AN;if(i!==void 0&&i.size!==0)if(t)if(Array.isArray(n))for(let r=s;r<n.length;r++)Kt(n[r],!1),ve(n[r]);else n!=null&&(Kt(n,!1),ve(n));else Kt(this,e)}const jr=e=>{e.type==X.CHILD&&(e._$AP??=Br,e._$AQ??=Dr)};class Os extends vt{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,s,n){super._$AT(t,s,n),li(this),this.isConnected=t._$AU}_$AO(t,s=!0){t!==this.isConnected&&(this.isConnected=t,t?this.reconnected?.():this.disconnected?.()),s&&(Kt(this,t),ve(this))}setValue(t){if(Qn(this._$Ct))this._$Ct._$AI(t,this);else{const s=[...this._$Ct._$AH];s[this._$Ci]=t,this._$Ct._$AI(s,this,0)}}disconnected(){}reconnected(){}}const{component:D,createContext:Vr}=Fr({render:yr});const Ur={},xe=dt(class extends vt{constructor(){super(...arguments),this.ot=Ur}render(e,t){return t()}update(e,[t,s]){if(Array.isArray(t)){if(Array.isArray(this.ot)&&this.ot.length===t.length&&t.every((n,i)=>n===this.ot[i]))return H}else if(this.ot===t)return H;return this.ot=Array.isArray(t)?Array.from(t):t,this.render(t,s)}}),es=new WeakMap,Lt=dt(class extends Os{render(e){return it}update(e,[t]){const s=t!==this.G;return s&&this.G!==void 0&&this.rt(void 0),(s||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),it}rt(e){if(this.isConnected||(e=void 0),typeof this.G=="function"){const t=this.ht??globalThis;let s=es.get(t);s===void 0&&(s=new WeakMap,es.set(t,s)),s.get(this.G)!==void 0&&this.G.call(this.ht,void 0),s.set(this.G,e),e!==void 0&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){return typeof this.G=="function"?es.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});const ci="important",Hr=" !"+ci,Wr=dt(class extends vt{constructor(e){if(super(e),e.type!==X.ATTRIBUTE||e.name!=="style"||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,s)=>{const n=e[s];return n==null?t:t+`${s=s.includes("-")?s:s.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${n};`},"")}update(e,[t]){const{style:s}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(const n of this.ft)t[n]==null&&(this.ft.delete(n),n.includes("-")?s.removeProperty(n):s[n]=null);for(const n in t){const i=t[n];if(i!=null){this.ft.add(n);const r=typeof i=="string"&&i.endsWith(Hr);n.includes("-")||r?s.setProperty(n,r?i.slice(0,-11):i,r?ci:""):s[n]=i}}return H}});function G(e,t,s){return e?t(e):s?.(e)}const Kr=(e=HTMLElement)=>class extends e{connectedCallback(){super.connectedCallback?.(),this.dispatchEvent(new CustomEvent("connected"))}disconnectedCallback(){super.disconnectedCallback?.(),this.dispatchEvent(new CustomEvent("disconnected"))}},Yr=q`
	:host {
		position: fixed;
		left: -9999999999px;
		min-width: 72px;
...
`;O(Object.assign([$e],{raw:[$e]}));$l(Object.assign([$e],{raw:[$e]}));const N=e=>e??it;const Ue=dt(class extends vt{constructor(e){if(super(e),e.type!==X.PROPERTY&&e.type!==X.ATTRIBUTE&&e.type!==X.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Qn(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===H||t===it)return t;const s=e.element,n=e.name;if(e.type===X.PROPERTY){if(t===s[n])return H}else if(e.type===X.BOOLEAN_ATTRIBUTE){if(!!t===s.hasAttribute(n))return H}else if(e.type===X.ATTRIBUTE&&s.getAttribute(n)===t+"")return H;return ti(e),t}}),Wi=(e,{label:t,invalid:s,errorMessage:n})=>O`
	...
	`,Ki=["autocomplete","readonly","disabled","maxlength","invalid","no-label-float","always-float-label"],Bl=Math.abs,jl=(...e)=>e.some(t=>!!t),Vl=(...e)=>e.join(""),Ul=(e,t,s)=>e?t:s,Hl=(e,t)=>t.indexOf(e)>-1,Wl=(e,t)=>e===t,Kl=e=>!!(e==null||Array.isArray(e)&&e.length===0||typeof e=="string"&&e.length===0||typeof e=="number"&&e===0),Yl=(e,t)=>typeof e!="number"?"":e.toFixed(t),vd=Object.freeze(Object.defineProperty({__proto__:null,abs:Bl,anyTrue:jl,concat:Vl,ifElse:Ul,inArray:Hl,isEmpty:Kl,isEqual:Wl,toFixed:Yl},Symbol.toStringTag,{value:"Module"})),ql={isoBasic:/^\d{4}-\d{2}-\d{2}$/iu},Jl=e=>typeof e=="string"&&ql.isoBasic.test(e)?new Date(`${e}T00:00`):new Date(e),xd=e=>{if(e==null)return;if(e instanceof Date&&!isNaN(e.getTime()))return e;if(!(typeof e=="number"||typeof e=="string"))return;const t=Jl(e);if(!(t instanceof Date&&isNaN(t.getTime())))return t},Dt=e=>e<10?"0"+e:e,Sd=e=>e instanceof Date?e.getFullYear()+"-"+Dt(e.getMonth()+1)+"-"+Dt(e.getDate())+"T"+Dt(e.getHours())+":"+Dt(e.getMinutes())+":"+Dt(e.getSeconds())+"."+(e.getMilliseconds()/1e3).toFixed(3).slice(2,5):null,He=(e,...t)=>e.flatMap((s,n)=>[s,t[n]??""]).join(""),Ns=(...e)=>{const t=new CSSStyleSheet;return t.replaceSync(e.join("")),t},Cd=(e,t)=>{const s=class extends t{};return Object.assign(s.prototype,e),s},wn=He`
	.wrap {
...
`,Ju=()=>it,Gu=D(Ju,{styleSheets:[qu]});customElements.define("cosmoz-spinner",Gu);const _e=[],Je=()=>{A.isInitialized||A.init({lng:"en",resStore:{en:{}},fallbackLng:!1})},Ge=e=>e.reduce((t,s,n)=>(t.count===void 0&&typeof s=="number"&&(t.count=s),typeof s=="object"?{...t,...s}:(t[n]=s,t)),{}),Wn=function(e){Je();const t=Ge([...arguments].slice(1));return delete t.count,A.t(e,t)},Xu=function(e,t){Je();const s=Ge([...arguments].slice(2)),n=s.count;let i;delete s.count;const r=A.services.pluralResolver.getSuffix(A.language,n);return r?(s.defaultValue=t,i=e+r):(i=e,s.defaultValue=e),A.t(i,s)},Zu=function(e,t){Je();const s=Ge([...arguments].slice(2));return s.context=e,delete s.count,A.t(t,s)},Qu=function(e,t,s){Je();const n=Ge([...arguments].slice(3)),i=n.count,r=e?"_"+e:"";let o=t;delete n.count;const a=A.services.pluralResolver.getSuffix(A.language,i);return a?(n.defaultValue=s,o=t+r+a):(o=t,n.context=e),A.t(o,n)},td=(e,t,s)=>{A.init({resources:{}}),A.addResourceBundle(e,t,s)},Ld=xt(e=>class extends e{static get properties(){return{t:{type:Object,value(){return{}}}}}_filterT(t){return t.filter(s=>s!==this.t)}_(){return Wn.apply(null,this._filterT([...arguments]))}connectedCallback(){super.connectedCallback(),_e.push(this)}disconnectedCallback(){super.disconnectedCallback();const t=_e.indexOf(this);t>=0&&_e.splice(t,1)}gettext(){return Wn.apply(null,this._filterT([...arguments]))}ngettext(){return Xu.apply(null,this._filterT([...arguments]))}pgettext(){return Zu.apply(null,this._filterT([...arguments]))}npgettext(){return Qu.apply(null,this._filterT([...arguments]))}});class ed extends Ll{static get properties(){return{compatibilityJSON:{type:String,value:"v3"},domain:{type:String,value:"messages"},interpolationPrefix:{type:String,value:"__"},interpolationSuffix:{type:String,value:"__"},language:{type:String,value:"en"},namespace:{type:String,value:"translation"},translations:{type:Object,observer(t){t!=null&&(td(this.language,this.namespace,t),_e.forEach(s=>s.set("t",{})))}},keySeparator:{type:String,value:"."},nsSeparator:{type:String,value:":"}}}ready(){super.ready(),A.init({compatibilityJSON:this.compatibilityJSON,interpolation:{escapeValue:!1,prefix:this.interpolationPrefix,suffix:this.interpolationSuffix},keySeparator:this.keySeparator,lng:this.language,nsSeparator:this.nsSeparator,resStore:{}})}}customElements.define("cosmoz-i18next",ed);const or=["T"," "],Kn=e=>{if(!e||typeof e!="string")return;let t;return or.some(s=>e.match(s)?(t=e.split(s),!0):!1),t||[e]},sd=(e,t)=>{const s=Kn(e),n=Kn(t);return{minDate:Array.isArray(s)?s.shift():null,minTime:Array.isArray(s)?s.shift():null,maxDate:Array.isArray(n)?n.shift():null,maxTime:Array.isArray(n)?n.shift():null}},Yn=(e,t)=>{if(!(!e&&!t))return!e&&t?`T${t}`:e&&!t?e:`${e}T${t}`},nd=e=>{if(e){for(const t of or)if(e.match(t)){const s=e.split(t);return{date:s.shift(),time:s.shift()}}return{date:e}}},id=e=>{const{dateLabel:t,timeLabel:s,min:n,max:i,step:r="1",value:o}=e,{minDate:a,maxDate:l,minTime:c,maxTime:u}=k(()=>sd(n,i),[n,i]),{date:d,time:h}=k(()=>nd(o)??{},[o]);return L(()=>{e.dispatchEvent(new CustomEvent("cosmoz-datetime-input-value-changed",{bubbles:!0,composed:!0}))},[o]),O`
		<style>
			:host {
				display: flex;
				flex-direction: row;
		...
		<cosmoz-input
			...
			type="date"
			.value="${d}"
			@value-changed="${f=>te(e,"value",Yn(f.target.value,h))}"
			.min="${a}"
			.max="${l}"
		></cosmoz-input>
		<cosmoz-input
  ...
  <svg
    ...
    style=${N(r)}
  >
    ${G(t,()=>ei`<title>${t}</title>`)}
    <path
      d="M20 2H4c-1.1 0-1.99.9-1.99 2L2 22l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-7 9h-2V5h2v6zm0 4h-2v-2h2v2z"
    />
  </svg>
`,Fd=({slot:e,title:t,className:s,width:n="24",height:i="24",styles:r}={})=>O`
  <svg
    slot=${N(e)}
    class=${`error-icon ${s??""}`}
    viewBox="0 0 24 24"
...
`,Zn=(e,t)=>{Object.assign(e.style,{display:t?"":"none"})};class md extends HTMLElement{static get observedAttributes(){return["opened"]}toggle=si("height");constructor(){super();const t=new CSSStyleSheet;t.replaceSync(`
      :host { display: block; overflow: hidden; }
		`);const s=this.attachShadow({mode:"open"});s.appendChild(document.createElement("slot")),s.adoptedStyleSheets=[t]}connectedCallback(){Zn(this,this.getAttribute("opened")!=null)}attributeChangedCallback(t,s,n){if(t==="opened"){const i=n!=null;return this.isConnected?this.toggle(this,i):Zn(this,i)}}}customElements.define("cosmoz-collapse",md);export{Xl as $,N as A,k as B,P as C,vs as D,zd as E,Rd as F,kd as G,zt as H,ar as I,Vr as J,ai as K,Mc as L,Ns as M,Nd as N,Es as O,Ll as P,Md as Q,Kl as R,Id as S,vd as T,Fd as U,je as V,jo as W,bd as X,Zc as Y,$t as Z,vi as _,hs as a,Ed as a0,Kc as a1,te as a2,xe as a3,wd as b,D as c,Yi as d,Td as e,q as f,U as g,$l as h,na as i,Ad as j,kc as k,Od as l,Pd as m,ft as n,G as o,ye as p,Xc as q,Wi as r,an as s,He as t,lt as u,Sd as v,xd as w,Ld as x,Cd as y,L as z};
