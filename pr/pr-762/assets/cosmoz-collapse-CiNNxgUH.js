import{f as Hn,B as cr,x as P,E as ct,T as j,m as Un,i as ur,p as dr,v as pt,s as zt,M as qe,b as Kn}from"./iframe-jIs1weBS.js";import{_ as hr}from"./preload-helper-PPVm8Dsz.js";/**
 * @license
...
`;customElements.define("cosmoz-autocomplete-skeleton-span",V(()=>ct,{styleSheets:[Cc]}));/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Pc{constructor(t){this.G=t}disconnect(){this.G=void 0}reconnect(t){this.G=t}deref(){return this.G}}class Ec{constructor(){this.Y=void 0,this.Z=void 0}get(){return this.Y}pause(){this.Y??=new Promise((t=>this.Z=t))}resume(){this.Z?.(),this.Y=this.Z=void 0}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Pn=e=>!ur(e)&&typeof e.then=="function",En=1073741823;let Oc=class extends Re{constructor(){super(...arguments),this._$Cwt=En,this._$Cbt=[],this._$CK=new Pc(this),this._$CX=new Ec}render(...t){return t.find((s=>!Pn(s)))??j}update(t,s){const n=this._$Cbt;let i=n.length;this._$Cbt=s;const r=this._$CK,o=this._$CX;this.isConnected||this.disconnected();for(let a=0;a<s.length&&!(a>this._$Cwt);a++){const l=s[a];if(!Pn(l))return this._$Cwt=a,l;a<i&&l===n[a]||(this._$Cwt=En,i=0,Promise.resolve(l).then((async c=>{for(;o.get();)await o.get();const u=r.deref();if(u!==void 0){const d=u._$Cbt.indexOf(l);d>-1&&d<u._$Cwt&&(u._$Cwt=d,u.setValue(c))}})))}return j}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}};const ys=ot(Oc);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const On=(e,t,s)=>{const n=new Map;for(let i=t;i<=s;i++)n.set(e[i],i);return n},Tc=ot(class extends Ct{constructor(e){if(super(e),e.type!==G.CHILD)throw Error("repeat() can only be used in text expressions")}dt(e,t,s){let n;s===void 0?s=t:t!==void 0&&(n=t);const i=[],r=[];let o=0;for(const a of e)i[o]=n?n(a,o):o,r[o]=s(a,o),o++;return{values:r,keys:i}}render(e,t,s){return this.dt(e,t,s).values}update(e,[t,s,n]){const i=dr(e),{values:r,keys:o}=this.dt(t,s,n);if(!Array.isArray(i))return this.ut=o,r;const a=this.ut??=[],l=[];let c,u,d=0,h=i.length-1,f=0,p=r.length-1;for(;d<=h&&f<=p;)if(i[d]===null)d++;else if(i[h]===null)h--;else if(a[d]===o[f])l[f]=pt(i[d],r[f]),d++,f++;else if(a[h]===o[p])l[p]=pt(i[h],r[p]),h--,p--;else if(a[d]===o[p])l[p]=pt(i[d],r[p]),zt(e,l[p+1],i[d]),d++,p--;else if(a[h]===o[f])l[f]=pt(i[h],r[f]),zt(e,i[d],i[h]),h--,f++;else if(c===void 0&&(c=On(o,f,p),u=On(a,d,h)),c.has(a[d]))if(c.has(a[h])){const m=u.get(o[f]),g=m!==void 0?i[m]:null;if(g===null){const y=zt(e,i[d]);pt(y,r[f]),l[f]=y}else l[f]=pt(g,r[f]),zt(e,i[d],g),i[m]=null;f++}else qe(i[h]),h--;else qe(i[d]),d++;for(;f<=p;){const m=zt(e,l[p+1]);pt(m,r[f]),l[f++]=m}for(;d<=h;){const m=i[d++];m!==null&&qe(m)}return this.ut=o,Un(e,l),j}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const Nc=e=>e,Mc=(e,t)=>P`${t}: ${JSON.stringify(e,null,2)}`;class Fc extends Re{constructor(t){if(super(t),this._virtualizer=null,this._first=0,this._last=-1,this._renderItem=(s,n)=>Mc(s,n+this._first),this._keyFunction=(s,n)=>Nc(s,n+this._first),this._items=[],t.type!==G.CHILD)throw new Error("The virtualize directive can only be used in child expressions")}render(t){t&&this._setFunctions(t);const s=[];if(this._first>=0&&this._last>=this._first)for(let n=this._first;n<=this._last;n++)s.push(this._items[n]);return Tc(s,this._keyFunction,this._renderItem)}update(t,[s]){this._setFunctions(s);const n=this._items!==s.items;return this._items=s.items||[],this._virtualizer?this._updateVirtualizerConfig(t,s):this._initialize(t,s),n?j:this.render()}async _updateVirtualizerConfig(t,s){if(!await this._virtualizer.updateLayoutConfig(s.layout||{})){const i=t.parentNode;this._makeVirtualizer(i,s)}this._virtualizer.items=this._items}_setFunctions(t){const{renderItem:s,keyFunction:n}=t;s&&(this._renderItem=(i,r)=>s(i,r+this._first)),n&&(this._keyFunction=(i,r)=>n(i,r+this._first))}_makeVirtualizer(t,s){this._virtualizer&&this._virtualizer.disconnected();const{layout:n,scroller:i,items:r}=s;this._virtualizer=new $c({hostElement:t,layout:n,scroller:i}),this._virtualizer.items=r,this._virtualizer.connected()}_initialize(t,s){const n=t.parentNode;n&&n.nodeType===1&&(n.addEventListener("rangeChanged",i=>{this._first=i.first,this._last=i.last,this.setValue(this.render())}),this._makeVirtualizer(n,s))}disconnected(){this._virtualizer?.disconnected()}reconnected(){this._virtualizer?.connected()}}const Ic=ot(Fc),Dc=(e,t)=>{if(!e||!t)return;const s=Object.keys(t);return Object.fromEntries(Object.keys(e).flatMap(n=>s.includes(n)?[]:[[n,void 0]]))};class Bc extends Ct{_props;render(t){return j}update(t,[s]){return this._props!==s&&Object.assign(t.element,Dc(this._props,s),this._props=s),j}}const jc=ot(Bc),Vc=e=>{const t=ee(),s=R(()=>new CSSStyleSheet,[]);T(()=>{t.shadowRoot.adoptedStyleSheets=[...t.shadowRoot.adoptedStyleSheets,s]},[]),T(()=>{s.replaceSync(e)},[e])};function qi(e){return e?t=>t?.[e]:At}const Hc=e=>{const t=qi(e);return s=>typeof s=="string"?s:t(s)?.toString()||""},Uc=e=>t=>{const s={};for(const n in t)e.includes(n)&&(s[n]=t[n]);return s},Kc="data:image/svg+xml,%3Csvg width='11' height='8' viewBox='0 0 11 8' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M9.5 1L5.20039 7.04766L1.66348 3.46152' stroke='white' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round'/%3E%3C/svg%3E",Wc=X`
	...
	:host([multi]) .item[aria-selected]::before {
		border-color: #5881f6;
		/* prettier-ignore */
		background: url("${Kc}") #5881f6 no-repeat 50%;
	}
	:host([multi]) .sizer {
		padding-left: 33px;
	}
...
`,qc=({index:e,itemHeight:t,auto:s})=>X`
	${J(!s,()=>X`
			.item {
				line-height: ${t}px;
				height: ${t}px;
...
`,Yc=e=>typeof e=="object"&&e!==null&&Symbol.iterator in e;function vt(e){return e==null?[]:Array.isArray(e)?e:typeof e=="string"?[e]:Yc(e)?Array.from(e):[e]}const ss=(e,t=At)=>s=>{const n=vt(e).map(t);return vt(s).filter(i=>!n.includes(t(i)))},Jc=(e,t)=>t?s=>vt(e).find(n=>n[t]===s[t]):s=>vt(e).includes(s),Gc=(e,t)=>{if(!t||!e)return e;const s=e.toLowerCase().indexOf(t.toLowerCase());if(s<0)return e;const n=s+t.length;return[e.slice(0,s),P`<mark>${e.slice(s,n)}</mark>`,e.slice(n)]},Xc=e=>{const t=Rt(e);T(()=>{const s=n=>{if(!(n.ctrlKey&&n.altKey||n.defaultPrevented))switch(n.key){case"Up":case"ArrowUp":n.preventDefault(),t.onUp();break;case"Down":case"ArrowDown":n.preventDefault(),t.onDown();break;case"Enter":n.preventDefault(),t.onEnter();break}};return document.addEventListener("keydown",s,!0),()=>document.removeEventListener("keydown",s,!0)},[t])},Qc=({items:e,onSelect:t,defaultIndex:s=0})=>{const[n,i]=nt({index:s}),{index:r}=n,{length:o}=e;return T(()=>{i({index:n.index<0?s:Math.min(n.index,e.length-1),scroll:!0})},[e,s]),Xc({onUp:$(()=>i(a=>({index:a.index>0?a.index-1:o-1,scroll:!0})),[o]),onDown:$(()=>i(a=>({index:a.index<o-1?a.index+1:0,scroll:!0})),[o]),onEnter:$(()=>r>-1&&r<o&&t?.(e[r],r),[r,e,t])}),{position:n,highlight:$(a=>i({index:a}),[]),select:$(a=>t?.(a),[t])}},Zc=(e=At)=>(t,s,{highlight:n,select:i,textual:r=At,query:o,isSelected:a})=>{const l=r(t),c=Gc(l,o),u=e(c,t,s);return P`<div
				class="item"
				role="option"
				part="option"
				?aria-selected=${a(t)}
			...
			<div class="sizer" virtualizer-sizer>${u}</div>`},tu=({itemRenderer:e=Zc(),...t})=>{const s=Rt(t);return $((n,i)=>e(n,i,s),[s,e])},eu=e=>{const t=e==="auto",[s,n]=nt(t?40:e);return[s,i=>t?n(i):void 0]},su=["query","items","onSelect","textual","anchor","itemHeight","itemLimit","itemRenderer","defaultIndex","value","valueProperty","loading"],nu=({value:e,valueProperty:t,items:s,onSelect:n,defaultIndex:i,query:r,textual:o,itemRenderer:a,itemHeight:l=40,itemLimit:c=5})=>{const u=R(()=>Jc(e,t),[e,t]),d=R(()=>s.slice(),[s,u]),{position:h,highlight:f,select:p}=Qc({items:d,onSelect:n,defaultIndex:isNaN(i)?void 0:Number(i)}),[m,g]=eu(l);return{position:h,items:d,height:Math.min(c,d.length)*m,highlight:f,select:p,itemHeight:m,setItemHeight:g,renderItem:tu({itemRenderer:a,items:d,position:h,highlight:f,select:p,textual:o,query:r,isSelected:u})}},$n=wi,iu=e=>{const t=yi(void 0),{position:s,items:n,renderItem:i,height:r,itemHeight:o,setItemHeight:a}=nu(e);return T(()=>{const l=t.current?.[_s];l&&l.layoutComplete.then(()=>{e.dispatchEvent(new CustomEvent("layout-complete"));const{averageChildSize:c,averageMarginSize:u}=l._layout._metricsCache;return a(c+u*2)},$n)},[n]),T(()=>{if(!s.scroll)return;const l=t.current?.[_s];if(l){if(!l?._layout){l.layoutComplete.then(()=>l.element(s.index)?.scrollIntoView({block:"nearest"}),$n);return}l.element(s.index)?.scrollIntoView({block:"nearest"})}},[s]),Vc(qc({...s,itemHeight:o,auto:e.itemHeight==="auto"})),P`<div
			class="items"
			style="min-height: ${r}px"
			${_t(l=>t.current=l)}
		>
			<div virtualizer-sizer></div>
			${Ic({items:n,renderItem:i,scroller:!0})}
		</div>
		<slot></slot>`};customElements.define("cosmoz-listbox",Ei(V(iu,{styleSheets:[Ls(Wc)]})));const ru=({multi:e,setFloating:t,styles:s,...n},i)=>P`<cosmoz-listbox
		style="${Ci(s)}"
...
`;customElements.define("cosmoz-autocomplete-chip",V(lu,{observedAttributes:["disabled"],styleSheets:[Ls(ou)]}));const Rn=({content:e,onClear:t,disabled:s,hidden:n,className:i="chip",slot:r})=>P`<cosmoz-autocomplete-chip
		class=${B(i)}
		slot=${B(r)}
		part="chip"
	...
	>`,cu=({value:e,min:t=0,onDeselect:s,textual:n,disabled:i})=>[...e.filter(Boolean).map(r=>Rn({content:n(r),onClear:e.length>t&&(()=>s(r)),disabled:i,slot:"control"})),Rn({content:P`<span></span>`,className:"badge",disabled:!0,slot:"control",hidden:!0})],uu=As`
	:host {
		display: block;
		position: relative;
		min-width: 35px;
...
`,du=({focused:e,empty:t,...s})=>{const n=e&&t&&s.limit!==1,i=Rt(s);T(()=>{if(!n)return;const r=o=>{if(o.defaultPrevented)return;const{key:a}=o,l=vt(i.value),c=i.limit==1;if(l.length>0&&(a==="Backspace"||c&&a.length===1))return i.onChange(l.slice(0,-1))};return document.addEventListener("keydown",r,!0),()=>document.removeEventListener("keydown",r,!0)},[n,i])},kn=e=>e.normalize("NFD").replace(/[\u0300-\u036f]/gu,""),hu=(e,t,s)=>{if(!t)return e;const n=kn(t.toLowerCase()),i=[];for(const r of e){const a=kn(s(r).toLowerCase()).indexOf(n);a<0||i.push({item:r,index:a})}return i.sort((r,o)=>r.index-o.index).map(({item:r})=>r)},fu=e=>e===!1||e==null?[]:e,Yi=(e,t,s)=>e.dispatchEvent(new CustomEvent(t,{detail:s})),pu=(e,t,s)=>$(n=>{t?.(n),Yi(e,s,n)},[t]),mu=[],gu=e=>(...t)=>{let s;const n=()=>{s&&cancelAnimationFrame(s)};return n(),s=requestAnimationFrame(()=>{s=void 0,e(...t)}),n},$s=(e,t=()=>({}))=>{const s={type:e,toString(){return e}};return Object.assign((...i)=>Object.assign(t(...i),s),s)},zn=e=>e.type||e.toString(),Nn=e=>Array.isArray(e)?e:[e],yu=(e,t)=>{const s=Nn(t),n=(s.every(Array.isArray)?s:[s]).map(([i,r])=>({actions:Nn(i).map(zn),handle:r}));return(i=e,r)=>{const o=n.find(a=>a.actions.includes(zn(r)));return o?o.handle(i,r):i}},yt={pending:"pending",rejected:"rejected",resolved:"resolved"},Ji={error:void 0,result:void 0,state:yt.pending},Gi=$s(yt.pending),Xi=$s(yt.resolved,e=>({result:e})),Qi=$s(yt.rejected,e=>({error:e})),_u=yu(Ji,[[Gi,()=>({error:void 0,result:void 0,state:yt.pending})],[Xi,(e,{result:t})=>({error:void 0,result:t,state:yt.resolved})],[Qi,(e,{error:t})=>({error:t,result:void 0,state:yt.rejected})]]),bu=e=>{const[{error:t,result:s,state:n},i]=sa(_u,Ji);return T(()=>{if(!e)return;let r=!1;return i(Gi()),e.then(o=>!r&&i(Xi(o)),o=>!r&&i(Qi(o))),()=>{r=!0}},[e]),[s,t,n]},wu=({value:e,text:t,onChange:s,onText:n,onSelect:i,limit:r,min:o,source:a,textProperty:l,textual:c,valueProperty:u,keepOpened:d,keepQuery:h,preserveOrder:f,defaultIndex:p,externalSearch:m,...g})=>{const y=R(()=>(c??Hc)(l),[c,l]),{active:_,focused:b,onFocus:w,setClosed:v}=xi(g),A=!t,S=R(()=>t?.trim(),[t]),N=ee(),z=pu(N,n,"text"),F=$(L=>{s?.(L,()=>v(!0)),Yi(N,"value",L)},[s]),[I,tt]=nt([]),H=R(()=>Promise.resolve(typeof a=="function"?a({query:S,active:_}):a).then(fu),[a,_,S]),k=R(()=>vt(e),[e]);T(()=>H.then(tt),[H]),du({focused:b,empty:A,limit:r,value:k,onChange:F,onText:z}),T(()=>{b||z("")},[b]);const D=Rt({onText:z,onChange:F,value:k,limit:r,min:o,keepQuery:h,keepOpened:d,setClosed:v,onSelect:i}),[,,Y]=bu(H);return{active:_,query:S,textual:y,value:k,source$:H,loading:Y==="pending",items:R(()=>{if(!_)return mu;const L=f?I:[...k,...ss(k,qi(u))(I)];return m?L:hu(L,S,y)},[I,_,S,y,A,k,f,u,m]),onClick:$(()=>v(!1),[]),onFocus:w,onText:$(L=>{z(L.target.value),v(!1)},[z,t,v]),onSelect:$(L=>{D.onSelect?.(L,D);const{onChange:O,onText:M,limit:lt,min:se,value:rr,keepQuery:or,keepOpened:ar,setClosed:lr}=D;or||M(""),ar||lr(!0);const ne=vt(rr),Rs=ne.includes(L);Rs&&ne.length===se||O((Rs?ss(L)(ne):[...ne,L]).slice(-lt))},[D]),onDeselect:$(L=>D.onChange(ss(L)(D.value)),[D]),defaultIndex:S!==void 0&&S?.length>0?0:p}},vu=e=>{const t=e.shadowRoot.querySelectorAll(".chip"),s=e.shadowRoot.querySelector(".badge");s.hidden=!0;for(const a of t)a.hidden=!1;const i=e.shadowRoot.querySelector("cosmoz-input").shadowRoot?.querySelector(".control")?.getBoundingClientRect();let r;for(r=0;r<t.length;r++){const l=t[r].getBoundingClientRect();if(!(l.x+l.width<=i.x+i.width-24))break}const o=t.length-r;for(s.querySelector("span").textContent="+"+o.toString(),s.hidden=o<1;r<t.length;r++)t[r].hidden=!0},xu=({value:e,active:t,wrap:s,limit:n})=>{const i=ee(),r=!(s||n==1),o=R(()=>gu(()=>vu(i)),[]),[a,l]=nt(0);ds(()=>{if(!r)return;const c=i.shadowRoot.querySelector("cosmoz-input"),u=new ResizeObserver(d=>{l(d[0].contentRect.width)});return u.observe(c),()=>u.disconnect()},[r]),ds(()=>r?o():void 0,[r,a,t,e])},Su=["input","control","label","line","error","wrap"].map(e=>`${e}: input-${e}`).join(),Cu=[dl({apply({rects:e,elements:t}){Object.assign(t.floating.style,{minWidth:`${Math.max(e.reference.width,e.floating.width)}px`})}}),...Ii],Pu=({active:e,isSingle:t,showSingle:s})=>e?!(t&&!s):!1,Eu=e=>{const{active:t,invalid:s,errorMessage:n,label:i,placeholder:r,disabled:o,noLabelFloat:a,alwaysFloatLabel:l,textual:c,text:u,onText:d,onFocus:h,onClick:f,onDeselect:p,value:m,limit:g,min:y,showSingle:_,items:b,source$:w,placement:v,loading:A}=e,S=ee(),N=g==1,z=N&&m?.[0]!=null,{styles:F,setReference:I,setFloating:tt}=Di({placement:v,middleware:Cu});T(()=>(S.addEventListener("focusin",h),S.addEventListener("focusout",h),()=>{S.removeEventListener("focusin",h),S.removeEventListener("focusout",h)}),[h]),Bi({focus:()=>S.shadowRoot?.querySelector("#input")?.focus()},[]);const H=A||b.length>0||u!=null&&u.length>0;return P`<cosmoz-input
				id="input"
				part="input"
				${_t(I)}
				.label=${i}
			...
			>
				...
				${cu({value:m,min:y,onDeselect:p,textual:c,disabled:o})}
			</cosmoz-input>

			${J(Pu({active:t,isSingle:z,showSingle:_}),()=>ru({...e,items:b,multi:!N,setFloating:tt,styles:{...F,display:H?void 0:"none"}},J(A,()=>P`<cosmoz-autocomplete-skeleton-span></cosmoz-autocomplete-skeleton-span>`,()=>J(u!=null&&u.length>0&&b.length===0,()=>P`<slot name="no-result"></slot>`))))}`},Zi=e=>{const t={...e,...wu(e)};return xu(t),Eu(t)},tr=["disabled","invalid","no-label-float","always-float-label","text-property","value-property","limit","min","show-single","preserve-order","keep-opened","keep-query","default-index","external-search","item-height","item-limit","wrap"],Ou=e=>{const{onChange:t,onText:s,...n}=e,[i,r]=ia("value");return T(()=>{e.onChange!=null&&console.warn("onChange is deprecated; use value-changed and lift instead")},[]),Zi({...n,value:i,onChange:$((o,...a)=>{r(o),t?.(o,...a)},[t]),onText:$(o=>{e.text=o,s?.(o)},[s])})},er=[Ls(uu)];customElements.define("cosmoz-autocomplete-ui",V(Zi,{observedAttributes:tr,styleSheets:er}));customElements.define("cosmoz-autocomplete",V(Ou,{observedAttributes:tr,styleSheets:er}));const Tu=X`
	@keyframes rotating {
		100% {
...
`,hd=({slot:e,title:t,className:s,width:n="24",height:i="24",styles:r}={})=>P`
  <svg
    slot=${B(e)}
    class=${`error-icon ${s??""}`}
    viewBox="0 0 24 24"
...
`,Vn=(e,t)=>{Object.assign(e.style,{display:t?"":"none"})};class Uu extends HTMLElement{static get observedAttributes(){return["opened"]}toggle=bi("height");constructor(){super();const t=new CSSStyleSheet;t.replaceSync(`
      :host { display: block; overflow: hidden; }
		`);const s=this.attachShadow({mode:"open"});s.appendChild(document.createElement("slot")),s.adoptedStyleSheets=[t]}connectedCallback(){Vn(this,this.getAttribute("opened")!=null)}attributeChangedCallback(t,s,n){switch(t){case"opened":{const i=n!=null;return this.isConnected?this.toggle(this,i):Vn(this,i)}}}}customElements.define("cosmoz-collapse",Uu);export{Gu as $,ld as A,$ as B,ad as C,ms as D,nr as E,ca as F,gi as G,R as H,Tc as I,Ls as J,fr as K,bs as L,bc as M,ud as N,Fl as O,Vo as P,X as Q,dd as R,hd as S,Xu as T,Rt as U,dl as V,Ii as W,Uc as X,yi as Y,wi as Z,Bi as _,ds as a,Ic as a0,Qt as a1,Pi as a2,qu as b,V as c,rd as d,id as e,Cn as f,U as g,jo as h,Ju as i,sd as j,vt as k,Hc as l,ed as m,J as n,Zu as o,qi as p,Qu as q,nd as r,Is as s,As as t,nt as u,td as v,T as w,B as x,At as y,cd as z};
