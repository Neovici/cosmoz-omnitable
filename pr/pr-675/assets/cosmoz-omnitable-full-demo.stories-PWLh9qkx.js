import{x as m,B as Ie,E as Ve}from"./iframe-ByvMHQdj.js";import{t as K,c as L,g as S,P as A,u as M,a as ft,m as bt,s as Mt,D as Nt,b as jt,e as Pt,i as ve,h as Ae,o as Q,d as _,f as Bt,j as ye,p as he,n as D,k as Gt,l as $e,q as Ht,r as Wt,v as qt,T as Xt,w as Ut,x as E,y as Kt,z as Jt,A as Yt,B as y,C as Qt,E as Zt,F as xt,G as Ee,H as I,I as vt,J as Le,K as en,L as yt,N as tn,M as nn,O as Te,Q as on,R as Re,S as rn,U as an,V as Fe,W as Me,X as ln,Y as Oe,Z as P,_ as sn,$ as ze,a0 as un}from"./cosmoz-collapse-_0EEBALq.js";import"./preload-helper-D9Z9MdNV.js";const cn=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,se=n=>{const e=parseInt(n,10);return isFinite(e)?e:void 0},Zo=n=>{const{config:e}=n,{settings:t,setSettings:o,collapsed:r}=e,i=Re({collapsed:r,settings:t.columns,setSettings:y(a=>o(l=>({...l,columns:a})),[o])});return{...e,onDown:y(a=>{a.target.closest(".pull")&&(i.handle=a.currentTarget)},[i]),onDragStart:y(a=>{const{target:l}=a,s=se(l.dataset.index);if(!i.handle?.contains(l)||s==null)return a.preventDefault();i.handle=null,a.dataTransfer.effectAllowed="move",a.dataTransfer.setData("omnitable/sort-index",s),a.dataTransfer.setData("text/plain",s),setTimeout(()=>l.classList.add("drag"),0),l.addEventListener("dragend",u=>u.target.classList.remove("drag"),{once:!0})},[i]),onDragEnter:y(a=>{const l=a.currentTarget;l===a.target&&(a.preventDefault(),a.dataTransfer.dropEffect="move",l.classList.add("dragover"))},[]),onDragOver:y(a=>{a.preventDefault(),a.currentTarget.classList.add("dragover")},[]),onDragLeave:y(a=>{const l=a.currentTarget;l.contains(a.relatedTarget)||l.classList.remove("dragover")},[]),onDrop:y(a=>{const l=se(a.dataTransfer.getData("omnitable/sort-index")),s=se(a.currentTarget.dataset.index),{settings:u,setSettings:c}=i;a.currentTarget.classList.remove("dragover"),a.preventDefault();const d=u.slice();d.splice(s+(l>=s?0:-1),0,d.splice(l,1)[0]),c(d)},[i]),onToggle:y(a=>{const{settings:l,setSettings:s}=i,u=l.map(d=>({...d,disabled:d.disabled||i.collapsed?.some(h=>h.name===d.name)})),c=se(a.target.closest("[data-index]")?.dataset.index);u.splice(c,1,{...l[c],disabled:!a.target.checked,priority:a.target.checked?l.reduce((d,h)=>Math.max(d,h.priority),0)+1:l[c].priority}),s(u)},[i])}},er=[rn({apply({availableHeight:n,elements:e}){Object.assign(e.floating.style,{maxHeight:`${Math.max(0,n)}px`})}}),...an],tr=({onDragStart:n,onDragEnter:e,onDragOver:t,onDragLeave:o,onDrop:r,onDown:i,onToggle:a,collapsed:l,filters:s})=>(u,c)=>{const d=!!l?.find(p=>p.name===u.name),h=!u.disabled&&!d;return m` <div
			class="item"
			data-index=${c}
			@mousedown=${i}
			draggable="true"
...
`,Ir=n=>n?"groupRow groupRow-folded":"groupRow",Fr=({item:n,index:e})=>t=>D(t?.length>0,()=>m`
	...
	`,Dr=({onCheckboxChange:n,dataIsValid:e,groupOnColumn:t})=>(o,r,{selected:i,folded:a,toggleFold:l})=>m` <div
		...
		</div>`,Vr=({host:n,error:e,dataIsValid:t,processedItems:o,columns:r,collapsedColumns:i,miniColumns:a,sortAndGroupOptions:l,rowPartFn:s,...u})=>{const{loading:c=!1,displayEmptyGroups:d=!1,compareItemsFn:h}=n,p=Me({shiftKey:!1,ctrlKey:!1}),z=y(g=>{const k=g.target.dataItem,f=g.target.checked;p.current.shiftKey?n.shadowRoot.querySelector("#groupedList").toggleSelectTo(k,f):p.current.ctrlKey?(g.target.checked=!0,n.shadowRoot.querySelector("#groupedList").selectOnly(k)):n.shadowRoot.querySelector("#groupedList").toggleSelect(k,f),g.preventDefault(),g.stopPropagation()},[]);E(()=>{const g=({shiftKey:k,ctrlKey:f})=>{p.current={shiftKey:k,ctrlKey:f}};return window.addEventListener("keydown",g),window.addEventListener("keyup",g),()=>{window.removeEventListener("keydown",g),window.removeEventListener("keyup",g)}},[]);const b=y(g=>{const k=g.composedPath();k.slice(0,k.indexOf(g.currentTarget)).find(v=>v.matches?.("a, .checkbox, .expand"))||n.dispatchEvent(new window.CustomEvent("omnitable-item-click",{bubbles:!0,composed:!0,detail:{item:g.currentTarget.dataItem,index:g.currentTarget.dataIndex}}))},[]),{groupOnColumn:x}=l,F=y((g,k)=>f=>Fn(n,g,k,f),[]);return{...u,processedItems:o,dataIsValid:t,filterIsTooStrict:t&&o.length<1,loading:c,compareItemsFn:h,displayEmptyGroups:d,error:e,renderItem:I(()=>Or({columns:r,collapsedColumns:i,miniColumns:a,onItemClick:b,onCheckboxChange:z,dataIsValid:t,groupOnColumn:x,onItemChange:F,rowPartFn:s}),[r,i,b,z,t,x,F,s]),renderGroup:I(()=>Dr({onCheckboxChange:z,dataIsValid:t,groupOnColumn:x}),[z,t,x])}},Ar=(n,e)=>{if(n===e)return 0;if(n==null)return-1;if(e==null)return 1;const t=typeof n,o=typeof e;return t==="object"&&o==="object"?n.toString()<e.toString()?-1:1:t==="number"&&o==="number"?n-e:t==="string"&&o==="string"?n<e?-1:1:t==="boolean"&&o==="boolean"?n?-1:1:(console.warn("unsupported sort",t,n,o,e),0)},ke=(n,e)=>(t,o)=>Ar(n(t),n(o))*(e?-1:1),Er=n=>n.replace(/([a-z0-9])([A-Z])/gu,"$1-$2").toLowerCase(),gt=(n,e)=>{!n||!e||Object.entries(e).forEach(([t,o])=>{n[B].__ownChange=!0,n[B][t]=o,n[B].__ownChange=!1,n[B].dispatchEvent(new CustomEvent(`${Er(t)}-changed`,{bubbles:!0,detail:{value:o}}))})},_e=(n,e)=>Object.assign(n,{[be]:e}),ce=Symbol("unparsed"),Lr=({data:n,columns:e,hashParam:t,sortAndGroupOptions:o,noLocalSort:r,noLocalFilter:i})=>{const{groupOnColumn:a,groupOnDescending:l,sortOnColumn:s,descending:u}=o,c=y(([f,v])=>{const $=e.find(({name:w})=>w===f);return $==null?[f,void 0]:[f,v.filter&&$.serializeFilter($,v.filter)]},[e]),d=y(([f,v])=>{const $=e.find(({name:C})=>C===f);if($==null)return[f,{[ce]:v}];const w={filter:$.deserializeFilter($,v)};return gt($,w),[f,w]},[e]),[h,p]=J({},t,{multi:!0,suffix:"-filter--",write:c,read:d}),z=y((f,v)=>p($=>{const w=ve(v,$[f]);return gt(e.find(C=>C.name===f),w),{...$,[f]:{...$[f],...w}}}),[e,p]),b=I(()=>Object.values(h).map(f=>f.filter),[h]),x=I(()=>Object.fromEntries(e.map(f=>[f.name,!f.noLocalFilter&&f.getFilterFn(f,h[f.name]?.filter)]).filter(([,f])=>!!f)),[e,...b]),F=I(()=>!Array.isArray(n)||n.length===0?[]:Object.entries(x).length===0||i?n.slice():n.filter(f=>Object.values(x).every(v=>v(f))),[n,x,i]),g=I(()=>{if(!r&&!a&&s!=null&&s.sortOn!=null)return F.slice().sort(ke(f=>s.getComparableValue({...s,valuePath:s.sortOn},f),u));if(a!=null&&a.groupOn!=null){const f=F.reduce((v,$)=>{const w=a.getComparableValue({...a,valuePath:a.groupOn},$);if(w===void 0)return v;let C=v.find(R=>R.id===w);return C?(C.items.push($),v):(C={id:w,name:w,items:[$]},[...v,C])},[]);return f.sort(ke(v=>a.getComparableValue({...a,valuePath:a.groupOn},v.items[0]),l)),!s||r?f:f.filter(v=>Array.isArray(v.items)).map(v=>(v.items.sort(ke($=>s.getComparableValue({...s,valuePath:s.sortOn},$),u)),v))}return F},[F,a,l,s,u,r]),k=I(()=>{let f=0,v=0;const $=[];return g.forEach(w=>{if(Array.isArray(w.items)){_e(w,v++),w.items.forEach(C=>{_e(C,f++),$.push(C)});return}return _e(w,f++),$.push(w)},[]),$},[g]);return E(()=>{p(f=>Object.values(f).some($=>$[ce]!=null)?Object.fromEntries(Object.entries(f).map(([$,w])=>w[ce]==null?[$,w]:d([$,w[ce]]))):f)},[d]),{processedItems:g,visibleData:k,filters:h,filterFunctions:x,setFilterState:z}},Tr=n=>{const e=o=>{const r=n.data.indexOf(o);if(r<0)return null;const i=n.data.splice(r,1);if(n.data=n.data.slice(),Array.isArray(i)&&i.length>0)return i[0]},t=(o,r)=>{n.data.splice(o,1,r),n.data=n.data.slice()};return{removeItem:e,removeItems(o){const r=[];for(let i=o.length-1;i>=0;i-=1){const a=n.removeItem(o[i]);a!=null&&r.push(a)}return r},replaceItemAtIndex:t,replaceItem(o,r){const i=n.data.indexOf(o);if(i>-1)return t(i,r)},selectItem(o){n.shadowRoot.querySelector("#groupedList").select(o)},selectAll(){n.shadowRoot.querySelector("#groupedList").selectAll()},deselectAll(){n.shadowRoot.querySelector("#groupedList").deselectAll()},deselectItem(o){n.shadowRoot.querySelector("#groupedList").deselect(o)},isItemSelected(o){return n.shadowRoot.querySelector("#groupedList").isItemSelected(o)}}},Rr=({host:n,visibleData:e,filters:t,...o})=>{const{setFilterState:r}=o,i=I(()=>Tr(n),[]);Oe(o,Object.values(o)),Oe(i,Object.values(i)),E(()=>{const l=s=>r(s.detail.name,u=>({...u,...s.detail.state}));return n.addEventListener("legacy-filter-changed",l),()=>n.removeEventListener("legacy-filter-changed",l)},[]),P("visibleData",e),P("sortedFilteredGroupedItems",o.sortedFilteredGroupedItems),P("selectedItems",o.selectedItems),P("sortOn",o.sortOn),P("descending",o.descending),P("isMini",o.isMini);const a=I(()=>Object.fromEntries(Object.entries(t).filter(([,{filter:l}])=>l!==void 0).map(([l,{filter:s}])=>[l,s])),[t]);P("filters",a,Object.values(a))},Mr=n=>{const{hashParam:e,settingsId:t,data:o,resizeSpeedFactor:r,noLocal:i,noLocalSort:a=i,noLocalFilter:l=i,error:s,rowPartFn:u}=n,c=dr({settingsId:t,host:n}),{settings:d,setSettings:h,columns:p,resetRef:z}=c,b=Eo(p,e,d,h,z),{processedItems:x,visibleData:F,filters:g,setFilterState:k,filterFunctions:f}=Lr({data:o,columns:p,hashParam:e,sortAndGroupOptions:b,noLocalSort:a,noLocalFilter:l}),{isMini:v,collapsedColumns:$,miniColumns:w}=Cr({host:n,columns:p,settings:d,setSettings:h,resizeSpeedFactor:r,sortAndGroupOptions:b}),C=o&&Array.isArray(o)&&o.length>0,[R,H]=M([]);return Rr({host:n,visibleData:F,sortedFilteredGroupedItems:x,columns:p,filters:g,setFilterState:k,selectedItems:R,isMini:v,...b}),{header:_r({host:n,selectedItems:R,sortAndGroupOptions:b,dataIsValid:C,data:o,columns:p,filters:g,collapsedColumns:$,settings:d,filterFunctions:f,settingS:c,setFilterState:k,hideSelectAll:n.hideSelectAll===!0}),list:Vr({host:n,error:s,dataIsValid:C,processedItems:x,setSelectedItems:H,columns:p,collapsedColumns:$,miniColumns:w,sortAndGroupOptions:b,rowPartFn:u}),footer:kr({host:n,selectedItems:R,columns:p})}};customElements.define("cosmoz-grouped-list-row",class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||Ie(this._renderFn(this._item,this._index),this)}});const Nr={group:Symbol("group")},we=(n,e)=>(e.has(n)||e.set(n,{}),e.get(n)),jr=(n,e)=>!!we(n,e).expanded,Pr=(n,e)=>!!we(n,e).folded,De=n=>n?n.items instanceof Array:!1,Br=n=>{if(!Array.isArray(n)||n.length===0)return;const e=Array.isArray(n[0]?.items);if(!n.every(o=>Array.isArray(o.items)===e))throw new Error("Data must be homogeneous.")},Gr=(n,e,t)=>Array.isArray(n)?(Br(n),n.reduce((r,i)=>{const a=i;return a.items?a.items.length?we(i,t).folded?r.concat(i):r.concat(i,a.items.map(l=>Object.assign(l,{[Nr.group]:i}))):e?r.concat(i):r:r.concat(i)},[])):void 0,Hr=(n,...e)=>typeof n=="function"?n(...e):n,Wr=(n,e)=>n===e,qr=()=>{const[n,e]=M(()=>[new WeakMap]);return{setItemState:y((o,r)=>e(([i])=>{const a=we(o,i);return Object.assign(a,Hr(r,a)),[i]}),[]),state:n[0],signal:n}},Xr=()=>{const{setItemState:n,state:e,signal:t}=qr(),o=y((i,a)=>{De(i)&&n(i,l=>({folded:a!==void 0?a:!l.folded}))},[]),r=y((i,a)=>{De(i)||n(i,l=>({expanded:a!==void 0?!a:!l.expanded}))},[]);return{state:e,signal:t,toggleFold:o,toggleCollapse:r}},Ur=({initial:n,compareItemsFn:e,data:t,flatData:o})=>{const[r,i]=M(n),[a,l]=M(),s=y(g=>r.includes(g),[r]),u=y(g=>g?.items?.every(s),[s]),c=y(g=>s(g)||u(g),[s,u]),d=y(g=>{const k=g.items??[g];i(f=>[...f,...k.filter(v=>!f.includes(v))]),l(g)},[]),h=y(g=>{const k=g.items??[g];i(f=>f.filter(v=>!k.includes(v))),l(g)},[]),p=y(g=>{i(g.items?.slice()||[g]),l(g)},[]),z=y(()=>{i(t.flatMap(g=>g.items||g)),l(void 0)},[t]),b=y(()=>{i([]),l(void 0)},[]),x=y((g,k=!c(g))=>k?d(g):h(g),[c]),F=y((g,k)=>{const f=a?o.findIndex(w=>e(w,a)):-1;if(f<0)return x(g,k);const[v,$]=[f,o.indexOf(g)].sort((w,C)=>w-C);o.slice(v,$+1).forEach((w,C,R)=>{C>0&&C<R.length-1&&De(w)||x(w,k)}),l(g)},[o,e,x]);return E(()=>i(g=>g.length>0?o.filter(k=>g.find(f=>e(k,f))):g),[o]),{selectedItems:r,isItemSelected:s,isGroupSelected:u,isSelected:c,select:d,deselect:h,selectOnly:p,selectAll:z,deselectAll:b,toggleSelect:x,toggleSelectTo:F}},Kr={host:{position:"relative",display:"flex",flexDirection:"column"}},Jr=n=>{const{data:e,renderItem:t,renderGroup:o,displayEmptyGroups:r,compareItemsFn:i=Wr}=n,{toggleFold:a,toggleCollapse:l,state:s,signal:u}=Xr(),c=I(()=>Gr(e,r,s),[e,r,u]),{selectedItems:d,isItemSelected:h,isGroupSelected:p,isSelected:z,select:b,deselect:x,selectOnly:F,selectAll:g,deselectAll:k,toggleSelect:f,toggleSelectTo:v}=Ur({initial:[],compareItemsFn:i,data:e,flatData:c}),$=y((C,R)=>Array.isArray(C.items)?o(C,R,{selected:p(C,d),folded:Pr(C,s),toggleSelect:H=>f(C,typeof H=="boolean"?H:void 0),toggleFold:()=>a(C)}):t(C,R,{selected:d.includes(C),expanded:jr(C,s),toggleSelect:H=>f(C,typeof H=="boolean"?H:void 0),toggleCollapse:()=>l(C)}),[t,o,d,f,u]);ft(()=>Object.assign(n.style,Kr.host),[]),P("selectedItems",d);const w={toggleFold:a,toggleCollapse:l,isItemSelected:h,isGroupSelected:p,isSelected:z,select:b,deselect:x,selectOnly:F,selectAll:g,deselectAll:k,toggleSelect:f,toggleSelectTo:v};return Oe(w,Object.values(w)),{renderRow:$,flatData:c}},Yr=({renderRow:n,flatData:e})=>sn({items:e,renderItem:(t,o)=>m`<cosmoz-grouped-list-row
				.item=${t}
				.index=${o}
				.renderFn=${n}
