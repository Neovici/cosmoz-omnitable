import{n as e}from"./chunk-BneVvdWh.js";import{$ as t,X as n,Z as r,et as i,n as a,t as o}from"./iframe-C1LkH8fE.js";import{$ as s,A as c,At as l,B as u,C as d,Ct as f,D as p,Dt as m,E as h,Et as g,F as _,Ft as v,G as y,H as b,I as x,It as ee,J as te,K as S,L as ne,Lt as re,M as ie,Mt as ae,N as oe,Nt as se,O as ce,Ot as C,P as le,Pt as w,Q as ue,R as de,S as fe,St as T,T as pe,Tt as E,U as me,V as he,W as ge,X as D,Y as _e,Z as O,_ as k,_t as A,a as ve,at as ye,b as j,bt as be,c as xe,ct as Se,d as Ce,dt as we,et as Te,f as Ee,ft as De,g as Oe,gt as ke,h as Ae,ht as je,i as Me,it as Ne,j as Pe,jt as Fe,k as Ie,kt as Le,l as Re,lt as ze,m as Be,mt as Ve,n as He,nt as M,o as Ue,ot as We,p as Ge,pt as Ke,q as qe,r as Je,rt as N,s as Ye,st as Xe,t as Ze,tt as Qe,u as $e,ut as et,v as tt,vt as P,w as nt,wt as rt,x as it,xt as at,y as ot,yt as st,z as ct}from"./dist-CJ7mt_6h.js";var lt,ut=e((()=>{A(),lt=()=>t`<style>
	@keyframes rotating {
		100% {
...
`})),Qi,$i,ea=e((()=>{et(),A(),Qi=e=>{let t=parseInt(e,10);return isFinite(t)?t:void 0},$i=e=>{let{config:t}=e,{settings:n,setSettings:r,collapsed:i}=t,a=we({collapsed:i,settings:n.columns,setSettings:E(e=>r(t=>({...t,columns:e})),[r])});return{...t,onDown:E(e=>{e.target.closest(`.pull`)&&(a.handle=e.currentTarget)},[a]),onDragStart:E(e=>{let{target:t}=e,n=Qi(t.dataset.index);if(!a.handle?.contains(t)||n==null)return e.preventDefault();a.handle=null,e.dataTransfer.effectAllowed=`move`,e.dataTransfer.setData(`omnitable/sort-index`,n),e.dataTransfer.setData(`text/plain`,n),setTimeout(()=>t.classList.add(`drag`),0),t.addEventListener(`dragend`,e=>e.target.classList.remove(`drag`),{once:!0})},[a]),onDragEnter:E(e=>{let t=e.currentTarget;t===e.target&&(e.preventDefault(),e.dataTransfer.dropEffect=`move`,t.classList.add(`dragover`))},[]),onDragOver:E(e=>{e.preventDefault(),e.currentTarget.classList.add(`dragover`)},[]),onDragLeave:E(e=>{let t=e.currentTarget;t.contains(e.relatedTarget)||t.classList.remove(`dragover`)},[]),onDrop:E(e=>{let t=Qi(e.dataTransfer.getData(`omnitable/sort-index`)),n=Qi(e.currentTarget.dataset.index),{settings:r,setSettings:i}=a;e.currentTarget.classList.remove(`dragover`),e.preventDefault();let o=r.slice();o.splice(n+(t>=n?0:-1),0,o.splice(t,1)[0]),i(o)},[a]),onToggle:E(e=>{let{settings:t,setSettings:n}=a,r=t.map(e=>({...e,disabled:e.disabled||a.collapsed?.some(t=>t.name===e.name)})),i=Qi(e.target.closest(`[data-index]`)?.dataset.index);r.splice(i,1,{...t[i],disabled:!e.target.checked,priority:e.target.checked?t.reduce((e,t)=>Math.max(e,t.priority),0)+1:t[i].priority}),n(r)},[a])}}})),ta,na,ra,ia,aa=e((()=>{Ze(),Ke(),u(),S(),A(),o(),w(),ni(),si(),Zi(),ea(),ta=[Ve({apply({availableHeight:e,elements:t}){Object.assign(t.floating.style,{maxHeight:`${Math.max(0,e)}px`})}}),...De],na=({onDragStart:e,onDragEnter:n,onDragOver:r,onDragLeave:i,onDrop:a,onDown:o,onToggle:s,collapsed:c,filters:l})=>(u,d)=>{let f=!!c?.find(e=>e.name===u.name),p=!u.disabled&&!f;return t` <div
		...
		>
			...
			<input
				...
				.indeterminate=${f}
			/>
		</div>`},ra=e=>{let n=$i(e),{settings:r,settingsId:i,onSave:o,onReset:s,hasChanges:c,opened:l,setOpened:u}=n;return t` <div class="headline">
			${a(`Sort and filter`)}
			<button
				class="close"
		...
		<div class="contents">
			...
			>
				<div class="list">${r.columns?.map(na(n))}</div>
			</cosmoz-collapse>
			...
			<cosmoz-collapse ?opened=${l.sort}> ${oi()} </cosmoz-collapse>
	...
	`,ao=({onCheckboxChange:e,dataIsValid:n,groupOnColumn:r})=>(i,a,{selected:o,folded:s,toggleFold:c})=>t` <div
		...
		>
			...
			<button class="expand" ?aria-expanded="${s}" @click=${c}>
				...
				.index=${r}
				.renderFn=${e}
			></cosmoz-grouped-list-row>`})})),Wo,Go=e((()=>{Uo(),A(),Wo=e=>Ho(Vo(e)),customElements.define(`cosmoz-grouped-list`,P(Wo,{useShadowDOM:!1}))})),Ko=e((()=>{Go()})),qo,Jo,Yo,Xo,Zo=e((()=>{_e(),Tt(),qr(),Yr(),Si(),Di(),Ai(),A(),s(),i(),ke(),Ni(),Vi(),Ui(),Ji(),So(),Ko(),qo=e=>window.ShadyCSS?.ApplyShim?.transformCssText?.(e)||e,Jo=e=>{let{header:n,list:r,footer:i}=xo(e);return t`
		<style>
			${je([],()=>qo(Mi))}
		</style>
