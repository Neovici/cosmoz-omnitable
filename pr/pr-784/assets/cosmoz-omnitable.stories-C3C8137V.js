import{x as c,B as _e,E as Oe}from"./iframe-CkHvepVg.js";import{t as K,c as L,g as C,P as I,u as T,a as xt,m as vt,s as Pt,D as Nt,b as Rt,e as Bt,i as $e,h as Le,d as Gt,f as A,j as Ht,k as we,p as he,n as _,l as jt,o as Ce,q as Wt,r as Ut,v as Kt,T as Jt,w as M,x as Xt,y as Qt,z as Yt,A as Zt,B as $,C as ei,E as ti,F as yt,G as De,H as F,I as $t,J as Te,K as ii,L as wt,N as ai,M as Ve,O as ni,Q as Ze,R as oi,S as Pe,U as ri,V as li,W as Ee,X as Ne,Y as si,Z as Ie,_ as N,$ as ui,a0 as ze,a1 as di}from"./cosmoz-collapse-BROyLM4l.js";import"./preload-helper-PPVm8Dsz.js";const ci=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,ka=()=>c`
	<sort-and-group-consumer
		class="sgs"
		.render=${({columns:i,sortOn:e,setSortOn:t,descending:a,setDescending:n}={})=>Mt({columns:i?.filter?.(o=>o.sortOn&&!o.noSort),on:e,setOn:t,descending:a,setDescending:n})}
	>
	</sort-and-group-consumer>
`,Ot=i=>(e,t,a=Qt)=>{const n=ti(),o=new URLSearchParams(n.hash.replace("#",""));return i(e,t,a,o),"#!"+Object.assign(n,{hash:o}).href.replace(location.origin,"")},Lt=i=>i==null||i==="",_a=Ot((i,e,t,a)=>Lt(t(e))?a.delete(i):a.set(i,t(e))),Ea=Ot((i,e,t,a)=>Object.entries(e).map(t).forEach(([n,o])=>Lt(o)?a.delete(i+n):a.set(i+n,o))),J=(i,e,{suffix:t="",read:a,write:n,multi:o}={})=>{const[r,l]=o?[Ea,Yt]:[_a,Zt],[s,u]=T(()=>e==null?i:l(e+t,a)??i),d=$(m=>u(b=>{const p=$e(m,b);return e!=null&&ei(r(e+t,p,n),null,{notify:!1}),p}),[e,t,r,n]);return[s,d]},Ia=i=>[!0,"true",1,"yes","on"].includes(i),ce=i=>i===""||(i==null?void 0:Ia(i)),me=(i,e,t)=>$(a=>{i(a),t(n=>({...n,[e]:a}))},[i,e,t]),Ma=(i,e,t,a,n)=>{const[o,r]=J(t.sortOn,e,{suffix:"-sortOn"}),[l,s]=J(ce(t.descending),e,{suffix:"-descending",read:ce}),[u,d]=J(t.groupOn,e,{suffix:"-groupOn"}),[m,b]=J(ce(t.groupOnDescending),e,{suffix:"-groupOnDescending",read:ce}),p=F(()=>i.find(g=>g.name===o),[i,o]),z=F(()=>i.find(g=>g.name===u),[i,u]),h={groupOn:u,setGroupOn:me(d,"groupOn",a),groupOnDescending:m,setGroupOnDescending:me(b,"groupOnDescending",a),sortOn:o,setSortOn:me(r,"sortOn",a),descending:l,setDescending:me(s,"descending",a),columns:i},y=F(()=>h,Object.values(h)),k=$(g=>{r(g.sortOn),d(g.groupOn),s(g.descending),b(g.groupOnDescending)},[]);return M(()=>void(n.current=k),[]),{...y,sortAndGroup:y,groupOnColumn:z,sortOnColumn:p}},Ye=yt();customElements.define("sort-and-group-provider",Ye.Provider);customElements.define("sort-and-group-consumer",L(({render:i})=>i(De(Ye)),{useShadowDOM:!1}));const Oa=({data:i,columns:e,groupOnColumn:t,filters:a,setFilterState:n,sortAndGroup:{sortOn:o,setSortOn:r,descending:l,setDescending:s}={}})=>$t(e,u=>u.name,u=>[c`<div
			...
			>
				...
				${_(!u.noSort,()=>It({on:o,setOn:r,descending:l,setDescending:s,column:u}))}
