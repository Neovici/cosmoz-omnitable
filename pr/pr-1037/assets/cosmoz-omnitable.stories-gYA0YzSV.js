import{e as c,D as He,t as S,A as Ge}from"./iframe-B95bYgTf.js";import{t as W,c as M,g as A,n as E,P as O,s as ln,a as Ft,r as sn,e as un,D as cn,b as dn,d as mn,i as ke,h as Et,m as pn,u as R,f as It,j as _t,k as gn,l as Z,p as B,o as je,q as Ot,v as Fe,w as bn,x as Ee,y as F,z as _,A as st,B as Ie,C as Mt,E as ut,F as ct,G as w,H as fn,I as hn,J as Lt,K as Je,L as Dt,M as xn,N as Tt,O as yn,Q as Xe,R as dt,S as vn,T as $n,U as wn,V as We,W as _e,X as Cn,Y as Rt,Z as Ue,_ as U,$ as zn,a0 as Sn}from"./cosmoz-collapse-BdfCTiRh.js";import"./preload-helper-PPVm8Dsz.js";const An=W`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,Nn=n=>{const{label:e,value:t,slot:i}=n,a=c`<div
	...
	`},Vt=n=>n?typeof n.close=="function"?n:Vt(n.parentElement):null,Qe=n=>class extends n{static get properties(){return{disabled:{type:Boolean,value:!1},filter:{type:Object,notify:!0},values:{type:Array,value(){return[]}},headerFocused:{type:Boolean,notify:!0},min:{type:Number,value:null},max:{type:Number,value:null},limits:{type:Function},autoupdate:{type:String,value:!0},locale:{type:String,value:null},_filterInput:{type:Object,value(){return{min:null,max:null}}},_range:{type:Object,computed:"_computeRange(values.*)"},_limit:{type:Object,computed:"_computeLimit(_range, _filterInput.*, min, max)",value(){return{}}},_tooltip:{type:String,computed:"_computeTooltip(title, _filterText)"},_fromClasses:{type:String,computed:"_computeInputClasses(_filterInput.min)"},_toClasses:{type:String,computed:"_computeInputClasses(_filterInput.max)"}}}static get observers(){return["_filterInputChanged(_filterInput.*, autoupdate)","_filterChanged(filter.*)","_updateLimits(limits, headerFocused)"]}disconnectedCallback(){this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),super.disconnectedCallback()}_computeInputClasses(e){return e!=null&&e!==""?"has-value":""}toNumber(e,t,i){if(e==null||e==="")return;const a=typeof e=="number"?e:Number(e);if(Number.isNaN(a))return;if(i==null||t==null)return a;const o=this.toNumber(t);return o==null?a:i(a,o)}toValue(){return this.toNumber.apply(this,arguments)}getComparableValue(e,t){if(e==null)return;let i=e;return t!=null&&(i=this.get(t,e)),this.toValue(i)}renderValue(){}getInputString(e,t=this.valuePath){const i=this.toValue(this.get(t,e));return this._toInputString(i)}_computeRange(e){const t=e.base,i=Array.isArray(t)&&t.length&&t.map(a=>this.toValue(a)).filter(a=>a!=null);return!i||i.length<1?{min:null,max:null}:i.reduce((a,o)=>({min:this.toValue(o,a.min,Math.min),max:this.toValue(o,a.max,Math.max)}),{})}_computeLimit(e,t,i,a){if(!e)return;const o=t.base,r=this.toValue(i),l=this.toValue(a),s=r??this.toValue(e.min),u=l??this.toValue(e.max);return{fromMin:s,fromMax:this.toValue(u,this._fromInputString(o.max,"max"),Math.min),toMin:this.toValue(s,this._fromInputString(o.min,"min"),Math.max),toMax:u}}_computeFilterText(e){if(e.base==null)return;const t=e.base,i=this.toValue(t.min),a=this.toValue(t.max),o=[];return i!=null&&o.push(this.renderValue(i)),o.push(" - "),a!=null&&o.push(this.renderValue(a)),o.length>1?o.join(""):void 0}_computeTooltip(e,t){return t==null?e:`${e}: ${t}`}_fromInputString(e){return this.toValue(e)}_toInputString(e){const t=this.toValue(e);return t??null}_getDefaultFilter(){return{min:null,max:null}}_filterInputChanged(e,t){const i=e.path.split(".")[1];this.__inputChangePath=i||null,t&&(this._limitInputDebouncer=cn.debounce(this._limitInputDebouncer,dn.after(600),()=>{this._limitInput(),this._updateFilter()}),mn(this._limitInputDebouncer))}_clearFrom(){this.set("_filterInput.min",null),this._updateFilter()}_clearTo(){this.set("_filterInput.max",null),this._updateFilter()}_onBlur(){this._limitInput(),this._updateFilter()}_onKeyDown(e){const t=e.currentTarget,i=Array.from(t.parentElement.querySelectorAll("cosmoz-input")),a=i[i.findIndex(l=>l===t)+1],o=!a,r=i[0]===t;switch(e.keyCode){case 13:if(e.preventDefault(),!o)a.focus();else{const l=this._limitInput();this._updateFilter(),l||this._closeParent(t)}break;case 9:(o&&!e.shiftKey||r&&e.shiftKey)&&this._closeParent(t)}}_closeParent(e){const t=Vt(e);t&&t.close()}_onDropdownOpenedChanged({currentTarget:e,type:t,detail:i}){(t==="focus"||i?.value===!0)&&setTimeout(()=>{e.querySelector("cosmoz-input:focus")||e.querySelector("cosmoz-input")?.focus()},100)}_limitInput(){const e=this._filterInput,t=this.__inputChangePath,i=t?this._fromInputString(this.get(t,e),t):null;if(this.__inputChangePath=null,i==null)return!1;const a=this._limit,o=t==="min"?"from":"to",r=this.get(o+"Min",a),l=this.get(o+"Max",a),s=this.toValue(i,r,Math.max),u=this.toValue(s,l,Math.min);return this.getComparableValue(i)!==this.getComparableValue(u)?(this.set(["_filterInput",t],this._toInputString(u,t)),this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),!0):!1}_updateFilter(){const e=this._filterInput,t=this.filter,i=this._fromInputString(e.min,"min"),a=this._fromInputString(e.max,"max");this.getComparableValue(i)===this.getComparableValue(t,"min")&&this.getComparableValue(a)===this.getComparableValue(t,"max")||this.set("filter",{min:i,max:a})}_filterChanged(e){if(this._filterInput==null)return;const t=this._filterInput,i=e.base,a=this._fromInputString(t.min,"min"),o=this._fromInputString(t.max,"max");this.getComparableValue(a)===this.getComparableValue(i,"min")&&this.getComparableValue(o)===this.getComparableValue(i,"max")||(this.set("_filterInput",{min:this._toInputString(i.min),max:this._toInputString(i.max)}),this._limitInputDebouncer&&this._limitInputDebouncer.cancel())}hasFilter(){const e=this.filter;return e==null?!1:this.toValue(e.min)!=null||this.toValue(e.max)!=null}resetFilter(){this.filter=this._getDefaultFilter()}_updateLimits(e,t){e&&Promise.resolve(ke(e,{active:t})).then(i=>{const{min:a,max:o}=i??{};Object.assign(this,{...a!=null?{min:a}:{},...o!=null?{max:o}:{}})})}},me=n=>class extends n{static get template(){return Et`<div id="output" style="position:relative;"></div>`}connectedCallback(){super.connectedCallback();const e=this;He(e.render(),e.$.output)}_propertiesChanged(e,t,i){super._propertiesChanged(e,t,i);const a=this;requestAnimationFrame(()=>He(a.render(),a.$.output))}};class Bn extends Qe(me(O)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return c`
		...
		>
			...
			.autoupdate=${s}
			.autodetect=${u}
			@filter-changed=${({detail:{value:h}})=>g(C=>({...C,filter:h}))}
			@header-focused-changed=${({detail:{value:h}})=>g(C=>({...C,headerFocused:h}))}
		></cosmoz-omnitable-amount-range-input>`}computeSource(e,t){return pe(e,t)}}customElements.define("cosmoz-omnitable-column-amount",ai);const oi=(n,e)=>{if(!Array.isArray(n))return;const t=[];return n.reduce((i,a)=>Array.isArray(a)?(a.forEach(o=>{i.push(o)}),i):(i.push(a),i),[]).filter((i,a,o)=>{if(o.indexOf(i)!==a)return!1;if(e){const r=A(i,e);if(t.indexOf(r)!==-1)return!1;t.push(r)}return!0})},ri=(n,e,t)=>{if(n==null)return[];if(Array.isArray(n)){const i=oi(n,e);if(!i?.length)return i;const a=t??"label",o=r=>typeof r=="object"&&r!=null?String(A(r,a)??""):String(r??"");return i.sort((r,l)=>o(r).localeCompare(o(l)))}if(typeof n=="object"){const i=e??"id",a=t??"label";return Object.entries(n).map(([o,r])=>({[i]:o,[a]:r})).sort((o,r)=>String(o[a]??"").localeCompare(String(r[a]??"")))}return[]},Ye=(n,e,t)=>Z(e&&A(n,e)).map(B(t)),Ze=({valuePath:n,textProperty:e},t)=>Ye(t,n,e).filter(i=>i!=null).join(", "),li=Ze,si=({valueProperty:n,valuePath:e,emptyValue:t,emptyProperty:i},a)=>o=>{const r=B(n),l=Z(A(o,e));return a.some(s=>l.length===0&&B(i||n)(s)===t||l.some(u=>r(u)===r(s)))},Oe=n=>e=>n(t=>({...t,filter:e})),Me=n=>e=>n(t=>({...t,headerFocused:e})),Le=n=>e=>n(t=>({...t,query:e})),Bt=({emptyValue:n,emptyLabel:e,emptyProperty:t,textProperty:i,valueProperty:a},o)=>{const r=ri(o,a,i);return!e||n===void 0||!i||!(t||a)||!r?r:[{[i]:e,[t||a]:n},...r]},ui=(n,e)=>Bt(n,Nt(e,n.valuePath)),De=n=>class extends n{static get properties(){return{textProperty:{type:String},valueProperty:{type:String},emptyLabel:{type:String},emptyValue:{type:Object},emptyProperty:{type:String}}}getConfig(e){return{emptyProperty:e.emptyProperty}}getString(e,t){return Ze(e,t)}toXlsxValue(e,t){return li(e,t)}getComparableValue({valuePath:e,valueProperty:t},i){const a=A(i,e);return t==null?a:Z(a).map(B(t)).sort().join(" ")}getFilterFn(e,t){if(!(!t||!Array.isArray(t)||t.length===0))return si(e,t)}serializeFilter(e,t){return t.length===0?null:JSON.stringify(t)}deserializeFilter(e,t){if(t==null)return null;try{return JSON.parse(decodeURIComponent(t))}catch(i){return console.error("Failed to deserialize filter value:",{error:i?.name,message:i?.message,filterLength:typeof t=="string"?t.length:null}),null}}computeSource(e,t){return e.externalValues||typeof e.values=="function"?async(...i)=>Bt(e,await Promise.resolve(ke(e.values,...i))):ui(e,t)}},ci=({valuePath:n,textProperty:e,valueProperty:t},i)=>{const a=e?Ot(e):B(t),o=Z(n&&A(i,n)).map(a);return o.length>1?o.filter(Boolean).join(","):o[0]},di=({valueProperty:n,valuePath:e,emptyValue:t,emptyProperty:i},a)=>{const o=B(n),r=B(i||n),l=new Set(a.filter(d=>d.excluded).map(d=>o(d.item))),s=new Set(a.filter(d=>!d.excluded).map(d=>o(d.item))),u=a.some(d=>d.excluded&&r(d.item)===t),m=a.some(d=>!d.excluded&&r(d.item)===t);return d=>{const g=Z(A(d,e)).map(o);return g.length===0?!u&&(m||s.size===0):!g.some(p=>l.has(p))&&(s.size===0||g.some(p=>s.has(p)))}};let mi=class extends De(D(O)){static get properties(){return{headerCellClass:{type:String,value:"autocomplete-header-cell"},minWidth:{type:String,value:"55px"},editMinWidth:{type:String,value:"55px"},keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},showSingle:{type:Boolean},preserveOrder:{type:Boolean},limit:{type:Number},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,showSingle:e.showSingle,preserveOrder:e.preserveOrder,limit:e.limit,textual:e.textual}}renderCell(e,{item:t}){return c`<span class="default-column"
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:i},a,o){return c`<cosmoz-autocomplete-excluding
			...
			@value-changed=${je(Oe(a))}
			@text-changed=${je(Le(a))}
			>${E(e.loading,()=>c`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-excluding
		>`}getComparableValue(e,t){return ci(e,t)}getFilterFn(e,t){if(!(!t||!Array.isArray(t)||t.length===0))return di(e,t)}};customElements.define("cosmoz-omnitable-column-autocomplete-excluding",mi);const pi=({valuePath:n,textProperty:e,valueProperty:t},i)=>{const a=e?Ot(e):B(t),o=Z(n&&A(i,n)).map(a);return o.length>1?o.filter(Boolean).join(","):o[0]};class gi extends De(D(O)){static get properties(){return{headerCellClass:{type:String,value:"autocomplete-header-cell"},minWidth:{type:String,value:"55px"},editMinWidth:{type:String,value:"55px"},keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},showSingle:{type:Boolean},preserveOrder:{type:Boolean},limit:{type:Number},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,showSingle:e.showSingle,preserveOrder:e.preserveOrder,limit:e.limit,textual:e.textual}}renderCell(e,{item:t}){return c`<span class="default-column"
			>${e.getString(e,t)}</span
		>`}renderEditCell(e,{item:t},i){return c`<cosmoz-input
			no-label-float
			type="text"
		...
		>`}getComparableValue(e,t){return pi(e,t)}}customElements.define("cosmoz-omnitable-column-autocomplete",gi);const et=(n,e)=>e.find(({value:t})=>n===t),bi=(n,e,t)=>{const i=et(e,t);return i?i.text:n},ht=(n,e,t,i)=>bi(n,A(e,t),i),fi=({valuePath:n},e,t)=>et(A(e,n),t),hi=n=>e=>{n(t=>({...t,filter:e?.[0]?.value??null}))},xi=n=>e=>{n(t=>({...t,headerFocused:e}))},yi=n=>e=>{n(t=>({...t,query:e}))},vi=n=>e=>n(e?.[0]?.value),xt=({valuePath:n,trueLabel:e,falseLabel:t},i)=>A(i,n)?e:t,$i=({valuePath:n},e)=>t=>A(t,n)===e,be=_t((n,e)=>[{text:n,value:!0},{text:e,value:!1}]),wi=({valuePath:n,trueLabel:e,falseLabel:t},i)=>n?A(i,n)?e:t:"",Ci=(n,e)=>{try{return JSON.parse(e)}catch{return null}};class zi extends D(O){static get properties(){return{trueLabel:{type:String,value:"True"},falseLabel:{type:String,value:"False"},flex:{type:String,value:"0"},cellClass:{type:String,value:"boolean-cell"}}}getString(e,t){return xt(e,t)}renderCell(e,{item:t}){return xt(e,t)}renderEditCell(e,{item:t},i){const{trueLabel:a,falseLabel:o}=e;return c`<cosmoz-autocomplete
			no-label-float
			.title=${ht(e.title,t,e.valuePath,be(a,o))}
			.source=${be(a,o)}
			.textProperty=${"text"}
			.value=${fi(e,t,be(a,o))}
			.onChange=${vi(i)}
		...
		>`}renderHeader(e,{filter:t,query:i},a,o){return c`<cosmoz-autocomplete-ui
			?disabled=${e.disabledFiltering}
			.label=${e.title}
			.title=${ht(e.title,t,e.valuePath,o)}
			.source=${o}
			.textProperty=${"text"}
			.value=${et(t,o)}
			.text=${i}
			...
			${E(this.disabled,()=>c`
				...
				`,()=>c`
					...
					${de({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:c`
						...
						`})}
				`)}
		`}_fromInputString(e,t){const i=this.toDate(e);if(i!=null)return t==="min"&&i.setHours(0,0,0,0),t==="max"&&i.setHours(23,59,59),i}_filterInputChanged(e,t){const i=e.path.split(".")[1],a=i&&e.value;if(a&&a.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}}customElements.define("cosmoz-omnitable-date-range-input",Si);const Ai=n=>{const e=-new Date(n).getTimezoneOffset()/60;return(e<0?"-":"+")+["0",Math.abs(e)].join("").substr(-2)+":00"},nt=n=>n.length===19?n+Ai(n):n,Ht=n=>{if(n==null||n==="")return;let e=n;return!(e instanceof Date)&&(typeof n=="string"&&(e=nt(e)),e=bn(e),!e)||Number.isNaN(e.getTime())?null:e},P=({valuePath:n},e)=>{if(e==null)return;let t=e;n!=null&&(t=A(e,n));const i=Ht(t);if(i!=null)return L(i.getTime())},I=(n,e,t)=>{const i=Ht(n);return i??null},it=(n,e)=>{if(e==null)return;const t=I(n);if(t!=null)return e.format(t)},fe={},qi=n=>{const e=n||"";return fe[e]||(fe[e]=new Intl.DateTimeFormat(n||void 0)),fe[e]},yt=({valuePath:n,locale:e},t)=>{let i=A(t,n||"");return i===void 0?"":(i=I(i),i===null?"Invalid Date":it(i,qi(e)))},Gt=n=>{const e=I(n);if(e==null)return null;const t=Fe(e);return t==null?null:t.slice(0,10)},ki=({valuePath:n},e)=>Gt(A(e,n||"")),jt=(n,e)=>{const t=I(n);if(t!=null)return t},vt=n=>{const e=Gt(n);return e??""},Fi=({valuePath:n},e)=>{if(!n)return"";const t=I(A(e,n));if(!t)return"";const i=I(Fe(t));return i?(i.setHours(0,0,0,0),i):""},Wt=(n,e)=>t=>{const i=P(n,t);if(i==null)return!1;const a=P({...n,valuePath:"min"},e),o=P({...n,valuePath:"max"},e);return!(i<(a??-1/0)||i>(o??1/0))};class Ei extends D(O){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"date-header-cell"},width:{type:String,value:"100px"},minWidth:{type:String,value:"82px"},flex:{type:String,value:"0"}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const i=P({...e,valuePath:"min"},t),a=P({...e,valuePath:"max"},t);if(!(i==null&&a==null))return Wt(e,t)}getString(e,t){return yt(e,t)}toXlsxValue(e,t){return Fi(e,t)}getComparableValue(e,t){return P(e,t)}serializeFilter(e,t){if(t==null)return;const i=I(t.min),a=I(t.max);if(!(i==null&&a==null))return vt(i)+"~"+vt(a)}deserializeFilter(e,t){if(typeof t!="string"||t==="")return null;const i=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(i)?{min:I(i[1]),max:I(i[2])}:null}renderCell(e,{item:t}){return c`<div class="omnitable-cell-date">
			${yt(e,t)}
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return pe(e,t)}}customElements.define("cosmoz-omnitable-column-date",Ei);class Ii extends tt(me(O)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return c`
			<style>
			...
			${E(this.disabled,()=>c`
				...
				`,()=>c`
					...
					${de({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:c`
						...
						`})}
				`)}
		`}_toInputString(e){const t=this.toValue(e);if(t!=null)return this._toLocalISOString(t).slice(0,19)}_computeFormatter(e){const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return new Intl.DateTimeFormat(e||void 0,t)}}customElements.define("cosmoz-omnitable-datetime-range-input",Ii);const he={},_i=n=>{const e=n||"";if(he[e])return he[e];const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return he[e]=new Intl.DateTimeFormat(n||void 0,t),he[e]},Ve=({valuePath:n,locale:e},t)=>{const i=I(A(t,n||""));return i===void 0?"":i===null?"Invalid Date":it(i,_i(e))},Oi=({valuePath:n},e)=>n?A(e,n):"",$t=n=>{const e=I(n);return e==null?"":e.toISOString().slice(0,19).replace(/:/gu,".")},wt=n=>{if(!(n==null||n==="")&&typeof n=="string")return I(n.replace(/\./gu,":")+"Z")};class Ct extends D(O){static get is(){return"cosmoz-omnitable-column-datetime"}static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"datetime-header-cell"},width:{type:String,value:"210px"},minWidth:{type:String,value:"128px"},flex:{type:String,value:"0"},filterStep:{type:Number,value:1}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const i=P({...e,valuePath:"min"},t),a=P({...e,valuePath:"max"},t);if(!(i==null&&a==null))return Wt(e,t)}getString(e,t){return Ve(e,t)}toXlsxValue(e,t){return Oi(e,t)}getComparableValue(e,t){return P(e,t)}serializeFilter(e,t){if(t==null)return;const i=I(t.min),a=I(t.max);if(!(i==null&&a==null))return $t(i)+"~"+$t(a)}deserializeFilter(e,t){if(typeof t!="string"||t==="")return null;const i=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(i)?{min:wt(i[1]),max:wt(i[2])}:null}renderCell(e,{item:t}){return Ve(e,t)}renderEditCell(e,{item:t},i){return c`<cosmoz-input
			no-label-float
			type="text"
			@change=${o=>i(jt(o.target.value))}
			.value=${Ve(e,t)}
		...
		></cosmoz-omnitable-datetime-range-input>`}computeSource(e,t){return pe(e,t)}}customElements.define(Ct.is,Ct);class Mi extends De(D(O)){renderCell({valuePath:e,textProperty:t},{item:i}){const a=Ye(i,e,t).map(o=>c`<li>${o}</li>`);return c`
			<style>
				ul {
					padding: 0;
					display: inline;
...
`,Di=({items:n})=>{const[e,t]=R(!1),i=Array.isArray(n)?n:[],a=F(()=>Math.max(0,i.length-1),[i]);if(i.length===0)return null;const o=i.length>2,r=i[0],l=o&&!e?[]:i.slice(1),s=u=>{u.stopPropagation(),u.preventDefault(),t(m=>!m)};return c`
		<ul>
			<li>
				<span>${r}</span>
			</li>
	...
	`};customElements.define("cosmoz-omnitable-column-list-data",M(Di,{styleSheets:[Ee(Li)]}));class Ti extends De(D(O)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:i}){return c`<cosmoz-omnitable-column-list-data
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:i},a,o){return c`<cosmoz-autocomplete-ui
			...
			.onText=${Le(a)}
			>${E(e.loading,()=>c`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}}customElements.define("cosmoz-omnitable-column-list",Ti);class Ri extends Qe(me(O)){static get properties(){return{maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null},formatter:{type:Object,computed:"_computeFormatter(locale, minimumFractionDigits, maximumFractionDigits)"},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, formatter)"},headerFocused:{type:Boolean,value:!1}}}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return c`
			<style>
				cosmoz-input[type='number'] {
					background: var(--cosmoz-omnitable-amount-input-background, #ffffff);
					border-radius: 6px;
		...
		></cosmoz-omnitable-number-range-input>`}computeSource(e,t){return pe(e,t)}}customElements.define("cosmoz-omnitable-column-number",Vi);class Pi extends tt(me(O)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return c`
			${E(this.disabled,()=>c`
					<cosmoz-omnitable-dropdown-input
						disabled
						.label=${this.title}
				...
				`,()=>c`
					...
					${de({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:c`
						...
						`})}
				`)}
		`}get _fixedDate(){return"1970-01-01"}toDate(e,t,i){const a=typeof e=="string"&&e.length>3&&e.length<=9?this.getAbsoluteISOString(this._fixedDate+"T"+e):e;return super.toDate(a,t,i)}_toInputString(e){const t=this.toValue(e);return t==null?null:this._toLocalISOString(t).slice(11,19)}getComparableValue(e,t){if(e==null)return;let i=this._toInputString(t==null?e:this.get(t,e));if(i!=null&&(i=this.toValue(this.getAbsoluteISOString(this._fixedDate+"T"+i)),i!=null))return this.toNumber(i.getTime())}_timeValueChanged(e){const t=e.target,i=t.value,a=e.model.item,o=this.toDate(a.date),r=this.toDate(o!=null?o.toISOString().slice(0,10)+"T"+i:i),l=s=>s;r==null&&(this.set(this.valuePath,r,a),this._fireItemChangeEvent(a,this.valuePath,o,l.bind(this)))}_computeFormatter(e){const t={hour:"numeric",minute:"numeric",second:"numeric"};return new Intl.DateTimeFormat(e||void 0,t)}}customElements.define("cosmoz-omnitable-time-range-input",Pi);const Ut="1970-01-01",H=(n,e,t)=>{const i=typeof n=="string"&&n.length>3&&n.length<=9?nt(Ut+"T"+n):n;return I(i)},xe={},Ni=n=>{const e=n||"";if(xe[e])return xe[e];const t={hour:"numeric",minute:"numeric",second:"numeric"};return xe[e]=new Intl.DateTimeFormat(n||void 0,t),xe[e]},ze=({valuePath:n,locale:e},t)=>{const i=H(A(t,n||""));return i===void 0?"":i===null?"Invalid Date":it(i,Ni(e))},Bi=(n,e)=>n.valuePath?ze(n,e):"",Hi=n=>{const e=H(n);if(e==null)return null;const t=Fe(e);return t&&t.slice(11,19)},Y=({valuePath:n},e)=>{if(e==null)return;const t=Hi(n==null?e:A(e,n));if(t==null)return;const i=H(nt(Ut+"T"+t));return i==null?i:L(i.getTime())},Gi=(n,e)=>t=>{const i=Y(n,t);if(i==null)return!1;const a=Y({...n,valuePath:"min"},e),o=Y({...n,valuePath:"max"},e);return a==null||o==null?!1:!(i<a||i>o)},zt=n=>{const e=H(n);return e==null?"":e.toISOString().slice(11,19).replace(/:/gu,".")},St=n=>{if(!(n==null||n===""))return H(typeof n=="string"?n.replace(/\./gu,":")+"Z":n)};class ji extends D(O){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"time-header-cell"},minWidth:{type:String,value:"63px"},width:{type:String,value:"210px"},flex:{type:String,value:"0"},filterStep:{type:String,value:"1"}}}getFilterFn(e,t){const i=Y({...e,valuePath:"min"},t),a=Y({...e,valuePath:"max"},t);if(!(i==null&&a==null))return Gi(e,t)}getString(e,t){return ze(e,t)}toXlsxValue(e,t){return Bi(e,t)}getComparableValue(e,t){return Y(e,t)}serializeFilter(e,t){if(t==null)return;const i=H(t.min),a=H(t.max);if(!(i==null&&a==null))return zt(i)+"~"+zt(a)}deserializeFilter(e,t){if(typeof t!="string"||t==="")return null;const i=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(i)?{min:St(i[1]),max:St(i[2])}:null}renderCell(e,{item:t}){return ze(e,t)}renderEditCell(e,{item:t},i){return c`<cosmoz-input
			no-label-float
			type="text"
			@change=${o=>i(o.target.value)}
			.value=${ze(e,t)}
		></cosmoz-input>`}renderHeader({title:e,min:t,max:i,locale:a,filterStep:o,disabledFiltering:r},{filter:l},s,u){return c`<cosmoz-omnitable-time-range-input
			...
			@filter-changed=${({detail:{value:m}})=>s(d=>({...d,filter:m}))}
			@header-focused-changed=${({detail:{value:m}})=>s(d=>({...d,headerFocused:m}))}
		></cosmoz-omnitable-time-range-input>`}computeSource(e,t){return pe(e,t)}}customElements.define("cosmoz-omnitable-column-time",ji);const Wi=({column:n,item:e,selected:t,folded:i,group:a})=>{if(!n)return Ge;const o=n.renderGroup??n.renderCell;return o?o(n,{item:e,selected:t,folded:i,group:a}):Ge};customElements.define("cosmoz-omnitable-group-row",M(Wi,{useShadowDOM:!1}));const Ui=n=>{const{column:e}=n;return _(()=>{let t=0,i=0;const a=l=>{n.dispatchEvent(new CustomEvent("column-resize",{bubbles:!0,composed:!0,detail:{newWidth:Math.ceil(i+l.pageX-t),column:e}}))},o=()=>{document.removeEventListener("pointermove",a),document.removeEventListener("pointerup",o)},r=l=>{t=l.pageX,i=n.previousElementSibling.getBoundingClientRect().width,document.addEventListener("pointermove",a),document.addEventListener("pointerup",o)};return n.addEventListener("pointerdown",r),()=>n.removeEventListener("pointerdown",r)},[e]),Ge};customElements.define("cosmoz-omnitable-resize-nub",M(Ui));const Ki=c`<svg
	width="10"
	height="9"
	viewBox="0 0 10 9"
	stroke="currentColor"
...
>
	...
	/>
		...
		class="sg"
		title=${st(r)}
		data-on=${st(o===e&&(t?"desc":"asc")||void 0)}
...
`,Xt=n=>(e,t,i=Mt)=>{const a=hn(),o=new URLSearchParams(a.hash.replace("#",""));return n(e,t,i,o),"#!"+Object.assign(a,{hash:o}).href.replace(location.origin,"")},Qt=n=>n==null||n==="",Zi=Xt((n,e,t,i)=>Qt(t(e))?i.delete(n):i.set(n,t(e))),ea=Xt((n,e,t,i)=>{const a=Object.entries(e),o=a.map(t).filter(([,l])=>l!==void 0);if(o.length===0&&a.length>0)return;const r=n;Array.from(i.keys()).filter(l=>l.startsWith(r)).forEach(l=>i.delete(l)),o.forEach(([l,s])=>Qt(s)?i.delete(n+l):i.set(n+l,s))});function te(n,e,{suffix:t="",read:i,write:a,ready:o=!0,multi:r}={}){const l=r?ea:Zi,s=Ie({param:e,suffix:t,link:l,write:a??Mt}),u=F(()=>{if(e==null)return!1;if(r){const p=ut(e+t);return Object.keys(p).length>0}return ct(e+t)!==void 0},[]),[m,d]=R(()=>{if(e==null)return n;if(r){const h=ut(e+t,i);return Object.keys(h).length>0?h:n}return ct(e+t,i)??n}),g=w(p=>d(h=>{const C=ke(p,h);return s.param!=null&&fn(s.link(s.param+s.suffix,C,s.write),null,{notify:!1}),C}),[]);return _(()=>{s.param==null||!o||u||n!=null&&g(n)},[o]),[m,g]}const ta=n=>[!0,"true",1,"yes","on"].includes(n),ye=n=>n===""||(n==null?void 0:ta(n)),ve=(n,e,t)=>w(i=>{n(i),t(a=>({...a,[e]:i}))},[n,e,t]),na=(n,e,{settings:t,setSettings:i,resetRef:a,ready:o=!0})=>{const[r,l]=te(t.sortOn,e,{suffix:"-sortOn",ready:o}),[s,u]=te(ye(t.descending),e,{suffix:"-descending",read:ye,ready:o}),[m,d]=te(t.groupOn,e,{suffix:"-groupOn",ready:o}),[g,p]=te(ye(t.groupOnDescending),e,{suffix:"-groupOnDescending",read:ye,ready:o}),h=F(()=>n.find(y=>y.name===r),[n,r]),C=F(()=>n.find(y=>y.name===m),[n,m]),x={groupOn:m,setGroupOn:ve(d,"groupOn",i),groupOnDescending:g,setGroupOnDescending:ve(p,"groupOnDescending",i),sortOn:r,setSortOn:ve(l,"sortOn",i),descending:s,setDescending:ve(u,"descending",i),columns:n},k=F(()=>x,Object.values(x)),b=w(y=>{l(y.sortOn),d(y.groupOn),u(y.descending),p(y.groupOnDescending)},[]);return _(()=>{a.current=b},[]),{...k,sortAndGroup:k,groupOnColumn:C,sortOnColumn:h}},at=Lt();customElements.define("sort-and-group-provider",at.Provider);customElements.define("sort-and-group-consumer",M(({render:n})=>n(Je(at)),{useShadowDOM:!1}));const ia=({data:n,columns:e,groupOnColumn:t,filters:i,setFilterState:a,sortAndGroup:{sortOn:o,setSortOn:r,descending:l,setDescending:s}={}})=>Dt(e,u=>u.name,u=>[c`<div
			...
			>
				...
				${E(!u.noSort,()=>Kt({on:o,setOn:r,descending:l,setDescending:s,column:u}))}
			</div>`,c`<cosmoz-omnitable-resize-nub
				.column="${u}"
				name="${u.name}"
			></cosmoz-omnitable-resize-nub>`]),aa=({columns:n,settingsConfig:e,hideSelectAll:t,...i})=>{const a=Je(at);return c`
		${E(n,o=>ia({columns:o,sortAndGroup:a,...i}))}
		${E(!t,()=>c` <cosmoz-omnitable-settings
					.config=${e}
					part="settings"
...
`;customElements.define("cosmoz-omnitable-item-expand-line",M(ra,{styleSheets:[Ee(oa)]}));const la=({columns:n,item:e,selected:t,expanded:i,groupOnColumn:a})=>xn(n,o=>c`<cosmoz-omnitable-item-expand-line
				.column=${o}
				?hidden=${o===a}
				exportparts="item-expand-label, item-expand-value"
				>${o.renderCell(o,{item:e,selected:t,expanded:i})}</cosmoz-omnitable-item-expand-line
			>`);customElements.define("cosmoz-omnitable-item-expand",M(la,{useShadowDOM:!1}));const sa=(n,e,t)=>n.editable?n.renderEditCell(n,e,t(n,e.item)):n.renderCell(n,e),ua=({columns:n,groupOnColumn:e,item:t,index:i,selected:a,expanded:o,onItemChange:r})=>Dt(n,l=>l.name,l=>c`<div
...
`,At=n=>{const e=n.replace(/"/gu,'""');return e.search(/("|,|\n)/gu)>=0?'"'+e+'"':n},da=(n,e,t)=>{const o=n.map(l=>At(l.title)).join(";")+`
`,r=e.map(l=>n.map(s=>{const u=s.getString(s,l);return u==null?"":At(String(u))}).join(";")+`
`);r.unshift(o),Tt(new File(r,t,{type:"text/csv;charset=utf-8"}))},ma=(n,e)=>{const t=n.map(a=>a.title),i=e.map(a=>n.map(o=>{const r=o.toXlsxValue(o,a);return r??""}));return i.unshift(t),i},pa=(n,e,t,i)=>{const a=ma(n,e),o=new yn(t).addSheetFromData(a,i).generate();Tt(new File([o],t,{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}))},Se=Symbol("index"),T=Symbol("All"),ga=(n,e)=>{if(typeof n.findLastIndex=="function")return n.findLastIndex(e);for(let t=n.length-1;t>=0;t--)if(e(n[t],t,n))return t;return-1},ba=({columns:n,selectedItems:e,saveAsCsv:t=da,saveAsXlsx:i=pa,setSelectedItems:a,csvFilename:o,xlsxFilename:r,xlsxSheetname:l,topPlacement:s,enableSelectAll:u,allSelected:m=!1,allItemsCount:d})=>{const g=e===T,p=g?d??0:e.length;let h;return g?h=d!==void 0?S("All {count} items selected",{count:d}):S("All items selected"):h=S("{count} selected item",{count:p}),c`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${g||!Xe(p)}
		part="bottomBar"
	...
	>
		...
		${e!==T&&u&&m?c`<button @click=${()=>a(T)}>
					${S("Select all items")}
				</button>`:""}
		<slot name="actions" id="actions"></slot>
		<slot name="bottom-bar-toolbar" slot="bottom-bar-toolbar"></slot>
		<slot name="bottom-bar-menu" slot="bottom-bar-menu"></slot>
		${e!==T?c`<cosmoz-dropdown-menu
					part="extra"
					slot="extra"
					.placement=${s}
				>
		...
		<div class="header" id="header" part="header">
			${E(!m,()=>c`<input
						...
						part="all"
					/>`)}
			${E(m,()=>c` <cosmoz-omnitable-settings
						.newLayout="${!0}"
						.config=${u}
					></cosmoz-omnitable-settings>`)}
...
`,xa=({settingsConfig:n})=>{const{columns:e,collapsed:t}=n,i=e.filter(a=>!t.some(o=>o.name===a.name));return c`<div class="skeleton">
		...
		${E(o,()=>c`<div class="tableContent-empty">
					${dt({width:"96px",height:"96px",styles:"margin-right: 24px; fill: currentColor;"})}
					<div>
		...
		${E(r&&!i.length,()=>c`<div class="tableContent-empty overlay">
					<cosmoz-omnitable-skeleton
						.settingsConfig=${t}
					></cosmoz-omnitable-skeleton>
				</div>`)}
		${E(r&&i.length,()=>c`<div class="tableContent-empty overlay spinner">
					<cz-spinner></cz-spinner>
				</div>`)}
		${E(p,()=>c`<div class="tableContent-empty overlay">
...
`,$e=n=>{const e=parseInt(n,10);return isFinite(e)?e:void 0},wa=n=>{const{config:e}=n,{settings:t,setSettings:i,collapsed:a,requestTween:o}=e,r=Ie({collapsed:a,settings:t.columns,requestTween:o,setSettings:w(l=>i(s=>({...s,columns:l})),[i])});return{...e,onDown:w(l=>{l.target.closest(".pull")&&(r.handle=l.currentTarget)},[r]),onDragStart:w(l=>{const{target:s}=l,u=$e(s.dataset.index);if(!r.handle?.contains(s)||u==null)return l.preventDefault();r.handle=null,l.dataTransfer.effectAllowed="move",l.dataTransfer.setData("omnitable/sort-index",u),l.dataTransfer.setData("text/plain",u),setTimeout(()=>s.classList.add("drag"),0),s.addEventListener("dragend",m=>m.target.classList.remove("drag"),{once:!0})},[r]),onDragEnter:w(l=>{const s=l.currentTarget;s===l.target&&(l.preventDefault(),l.dataTransfer.dropEffect="move",s.classList.add("dragover"))},[]),onDragOver:w(l=>{l.preventDefault(),l.currentTarget.classList.add("dragover")},[]),onDragLeave:w(l=>{const s=l.currentTarget;s.contains(l.relatedTarget)||s.classList.remove("dragover")},[]),onDrop:w(l=>{const s=$e(l.dataTransfer.getData("omnitable/sort-index")),u=$e(l.currentTarget.dataset.index),{settings:m,setSettings:d,requestTween:g}=r;l.currentTarget.classList.remove("dragover"),l.preventDefault();const p=m.slice();p.splice(u+(s>=u?0:-1),0,p.splice(s,1)[0]),g?.(),d(p)},[r]),onToggle:w(l=>{const{settings:s,setSettings:u,requestTween:m}=r,d=s.map(p=>({...p,disabled:p.disabled||r.collapsed?.some(h=>h.name===p.name)})),g=$e(l.target.closest("[data-index]")?.dataset.index);d.splice(g,1,{...s[g],disabled:!l.target.checked,priority:l.target.checked?s.reduce((p,h)=>Math.max(p,h.priority),0)+1:s[g].priority}),m?.(),u(d)},[r])}},Ca=[wn({apply({availableHeight:n,elements:e}){Object.assign(e.floating.style,{maxHeight:`${Math.max(0,n)}px`})}}),...$n],za=({onDragStart:n,onDragEnter:e,onDragOver:t,onDragLeave:i,onDrop:a,onDown:o,onToggle:r,collapsed:l,filters:s})=>(u,m)=>{const d=!!l?.find(p=>p.name===u.name),g=!u.disabled&&!d;return c` <div
			class="item"
			data-index=${m}
			@mousedown=${o}
			draggable="true"
		...
		>
			...
			<label class="title" ?has-filter=${!Xe(s[u.name]?.filter)}
				>${u.title}</label
			>
			<input
				class="checkbox"
				...
				.indeterminate=${d}
			/>
		</div>`},Sa=n=>{const{settings:e,settingsId:t,onSave:i,onReset:a,hasChanges:o,opened:r,setOpened:l,...s}=wa(n);return c` <div class="headline">
			${S("Sort and filter")}
			<button
				class="close"
		...
		${E(t,()=>c`<div class="buttons">
				...
				</div>`)}`};customElements.define("cosmoz-omnitable-settings-ui",M(Sa,{styleSheets:[Ee(va)]}));const Aa=({config:n,newLayout:e})=>c`
	<cosmoz-dropdown
		.placement="${e?"bottom-start":"bottom-end"}"
		.middleware="${Ca}"
	>
		<div title="${S("Sort and filter")}" slot="button">
			${E(e,()=>c`<div class="headerDots">...</div>`,()=>c` <svg viewBox="0 0 24 24" width="24" fill="currentColor">
						<circle cx="10" cy="18" r="2"></circle>
						<circle cx="10" cy="12" r="2"></circle>
						<circle cx="10" cy="6" r="2"></circle>
					</svg>`)}
			${E(n?.badge,()=>c`<div class="badge"></div>`)}
		</div>
		<cosmoz-omnitable-settings-ui
...
`;customElements.define("cosmoz-omnitable-settings",M(Aa,{styleSheets:[Ee($a)]}));const Ae=["sortOn","descending","groupOn","groupOnDescending"],we=n=>e=>typeof e=="object"&&e!==null&&"name"in e&&e.name===n,qa=(n=[],e=[],t=[])=>{const i=e.filter(r=>n.some(we(r.name))),a=n.filter(r=>r.name!=null&&!e.some(we(r.name))&&!t.some(we(r.name))),o=t.filter(r=>!e.some(we(r.name)));return[...i,...o.flatMap(r=>{const l=n.find(s=>s.name===r.name);return l?{...r,title:l.title??r.title??"",minWidth:parseInt(l.minWidth??"0",10)}:[]}),...a.map(r=>{const{name:l,title:s,priority:u,minWidth:m,width:d,flex:g}=r;return{name:l??"",title:s??"",priority:u??0,minWidth:parseInt(m??"0",10),width:parseInt(d??"0",10),flex:parseInt(g??"0",10)}})]},ka=(n,e)=>({...e,...We(Array.from(Ae))(n),columns:n.columns?.map(We(["name","priority","width","flex","disabled"]))}),Fa=({columns:n,settings:e,savedSettings:t,initial:i})=>({...Object.fromEntries(Ae.flatMap(o=>i?.[o]!=null?[[o,i[o]]]:[])),...t?We(Array.from(Ae))(t):{},...e,columns:qa(n,e?.columns,t?.columns)}),Ea=({prefix:n="omnitable-"}={})=>({write:async(t,i)=>{const a=n+t;try{i?localStorage.setItem(a,JSON.stringify(i)):localStorage.removeItem(a)}catch(o){console.error(o)}},read:async t=>{if(!t)return null;try{const i=localStorage.getItem(n+t);return i==null?null:JSON.parse(i)}catch(i){return console.error(i),null}}}),Ia=Lt(Ea),_a=()=>{const n=Je(Ia);return F(()=>n(),[n])},Oa=(n,e,t,i)=>{const[a,o]=R(n?void 0:null),{read:r,write:l}=_a();return _(async()=>{n&&o(await r(n))},[n,r]),{settingsId:n,savedSettings:a,onSave:w(async()=>{if(!n)return;const s=ka(e,a);await l(n,s),t(),o(s)},[e,a]),onReset:w(async s=>{t(),s.shiftKey&&(await l(n),o(null)),i?.()},[i]),hasChanges:e!=null}},Ma=({settingsId:n,host:e})=>{const t=F(()=>Object.fromEntries(Ae.map(x=>[x,e[x]])),[]),i=_e(),a=w(()=>{i.current?.(t)},[t]),[o,r]=R(),[l,s]=R({columns:!0,sort:!0}),{savedSettings:u,...m}=Oa(n,o,r,a),{enabledColumns:d,disabledFiltering:g}=e,p=ni(e,{enabledColumns:d,disabledFiltering:g}),h=F(()=>Fa({columns:p,settings:o,savedSettings:u,initial:t}),[p,o,u]),C=F(()=>h.columns.map(x=>p.find(k=>k.name===x.name)).filter(Boolean),[p,...h.columns.map(x=>x.name)]);return{...m,savedSettings:u,opened:l,setOpened:s,settings:h,columns:C,setSettings:r,resetRef:i}},qt=n=>Number.isFinite(n)?n:0,La=(n,e)=>{const t=[];let[i,a]=n.reduce(([m,d],{width:g,flex:p})=>[m+g,d+p],[0,0]),o=e-i,r=qt(o/a),l=0,s=0,u=0;for(let m=0;m<n.length;m++){const{width:d,minWidth:g,flex:p}=n[m],h=o>=0?r*p:d*o/i;if(g>d+h){l+=d,s+=g,u+=p,t[m]=g;continue}if(p===0){l+=d,s+=d,t[m]=d;continue}}i-=l,o=e-s-i,a-=u,r=qt(o/a);for(let m=0;m<n.length;m++){if(t[m]!=null)continue;const{width:d,flex:g}=n[m],p=o>=0?r*g:d*o/i;t[m]=d+p}return t},Da=(n,e)=>{const t=ga(n,r=>r!=null&&r>0),i=(r,l)=>`.cell[name="${r}"], cosmoz-omnitable-skeleton::part(cell-${r}){width: ${Math.floor(l)}px;padding: 0 min(3px, ${l/2}px)}`,a=r=>`cosmoz-omnitable-resize-nub[name="${r}"]{display:none}`,o=r=>`cosmoz-omnitable-resize-nub[name="${r}"], .cell[name="${r}"]{display:none}`;return e.map((r,l)=>{const s=n[l];if(s==null||s===0)return o(r.name);const u=i(r.name,s);return l===t?`${u}
${a(r.name)}`:u}).join(`
`)},Zt=(n,e,t)=>{const i=n.filter(l=>!l.hidden),a=i.reduce((l,{width:s})=>l+s,0);if(i.length>1&&a>e)return Zt(i.slice(1),e,t);const o=i.reduce(([l,s],u,m)=>[Math.max(l,u.index),u.index>l?m:s],[-1,-1])[1];return o!==-1&&(i[o].flex=1),La(i,e).reduce((l,s,u)=>(l[i[u].index]=s,l),new Array(t).fill(void 0))},Ta=(n,e)=>n.length===0?".cell {display: none;}":Da(n,e),Ra=20,Va=44,Pa=24,en=Ra+Va+Pa,Na=(n,e)=>_(()=>{const t=([a])=>{a.contentRect?.width!==0&&e(a.contentRect.width-en)},i=new ResizeObserver(t);return i.observe(n),()=>i.unobserve(n)},[]),Ba=n=>{const[e,t]=R(()=>n.getBoundingClientRect().width-en);return Na(n,t),e},Ha=({canvasWidth:n,groupOnColumn:e,config:t,miniColumn:i})=>F(()=>{if(!Array.isArray(t)||n==null||n===0)return[];const a=t.map((o,r)=>({minWidth:o.minWidth,width:o.width,flex:o.flex,priority:o.priority,name:o.name,index:r,hidden:o.name===e?.name||o.disabled})).map(o=>i?{...o,hidden:i.name!==o.name}:o).sort(({index:o,priority:r},{index:l,priority:s})=>r===s?l-o:r-s);return Zt(a,n,a.length)},[n,e,t]),Ga=({host:n,canvasWidth:e,columns:t})=>{const i=n.miniBreakpoint??480,a=F(()=>e<=i,[e,i]),o=F(()=>a?t?.filter(u=>u.mini!=null).sort((u,m)=>(u.mini??0)-(m.mini??0)):[],[t,a]),[r,...l]=o??[],s=!!r;return _(()=>{n.toggleAttribute("mini",s)},[s]),{isMini:s&&a,miniColumn:r,miniColumns:l}},ja=({host:n,canvasWidth:e,layout:t,setSettings:i,requestTween:a})=>{const o=_e();o.current=r=>{a(),i(l=>{const s=l.columns,{detail:{newWidth:u,column:m}}=r,d=s.findIndex(h=>h.name===m.name),g=[],p=s.reduce((h,C)=>Math.max(h,C.priority),-1/0);for(let h=0;h<t.length;h++)if(g[h]={...s[h]},h<d&&t[h]&&(g[h].width=t[h],g[h].flex=0,g[h].priority=p),h===d){const C=t.reduce((x,k,b)=>b<d&&k?x-k:x,e);g[h].width=Math.min(C,Math.max(u,s[h].minWidth)),g[h].flex=0,g[h].priority=p}return{...l,columns:g}})},_(()=>{const r=l=>o.current?.(l);return n.addEventListener("column-resize",r),()=>n.removeEventListener("column-resize",r)},[])},Wa=(n,e)=>{const t=F(()=>{let i=!1,a;const o=()=>{if(!i)return;a=requestAnimationFrame(o),n()&&(i=!1)};return{start:()=>{i=!0,cancelAnimationFrame(a),a=requestAnimationFrame(o)},stop:()=>{i=!1,cancelAnimationFrame(a)}}},[]);_(()=>{t.start()},e),_(()=>()=>t.stop(),[])},Ua=(n=0,e=0)=>Math.abs(n-e)<.1,Ka=(n,e=1.9,t=Cn,i)=>{const a=Ie({target:n,speedFactor:e,onConverge:i}),o=w(()=>{if(!a.tween)return a.tween=a.target,t(a.tween),a.onConverge?.(),!0;if(a.target.every((r,l)=>a.tween[l]===r))return t(a.tween),a.onConverge?.(),!0;if(a.tween=a.target.map((r,l)=>Ua(a.tween[l],r)?r:(a.tween[l]??0)+((r??0)-(a.tween[l]??0))/a.speedFactor||0),t(a.tween),a.tween.every((r,l)=>r===a.target[l]))return a.onConverge?.(),!0},[]);Wa(o,[n])},Ja=n=>{const e=F(()=>new CSSStyleSheet,[]);return _(()=>{n.shadowRoot.adoptedStyleSheets=[...n.shadowRoot.adoptedStyleSheets,e]},[]),e},Xa=({host:n,columns:e,settings:t,setSettings:i,resizeSpeedFactor:a,sortAndGroupOptions:o})=>{const r=Ba(n),{isMini:l,miniColumn:s,miniColumns:u}=Ga({host:n,canvasWidth:r,columns:e}),{groupOnColumn:m}=o,d=Ha({canvasWidth:r,groupOnColumn:m,miniColumn:s,config:t.columns}),g=Ja(n),p=F(()=>t.columns.reduce((y,f,v)=>d[v]!=null||f.name===m?.name||f.disabled?y:[...y,e.find($=>$.name===f.name)],[]),[e,t,d]),[h,C]=R(1),x=w(()=>C(a??1.9),[a]),k=w(()=>C(1),[]),b=Ie({columns:t.columns});return Ka(d,h,y=>{const f=Ta(y,b.columns);g.replace(f)},k),ja({host:n,canvasWidth:r,layout:d,setSettings:y=>i(y(t)),requestTween:x}),{isMini:l,collapsedColumns:p,miniColumns:u,requestTween:x}},Qa=({host:n,...e})=>{const{csvFilename:t="omnitable.csv",xlsxFilename:i="omnitable.xlsx",xlsxSheetname:a="Omnitable",topPlacement:o="top-end"}=n;return{csvFilename:t,xlsxFilename:i,xlsxSheetname:a,topPlacement:o,...e}},Ya=({host:n,selectedItems:e,data:t,sortAndGroupOptions:i,collapsedColumns:a,settings:o,filterFunctions:r,settingS:l,filters:s,requestTween:u,...m})=>{const d=e===T||t&&t.length>0&&e.length===t.length,g=x=>{x.target.checked?n.shadowRoot.querySelector("#groupedList").selectAll():n.shadowRoot.querySelector("#groupedList").deselectAll()},{groupOnColumn:p}=i,h=F(()=>[p,...a,...o.columns.filter(x=>x.disabled)].some(x=>x&&Object.keys(r).includes(x.name)),[r,o,a]),C=F(()=>({...l,collapsed:a,badge:h,filters:s,requestTween:u}),[l,a,h,s,u]);return _(()=>{const x=n.shadowRoot.querySelector("#tableContent"),k=new ResizeObserver(b=>requestAnimationFrame(()=>{n.style.setProperty("--ot-height",b[0]?.contentRect.height+"px")}));return k.observe(x),()=>k.unobserve(x)},[]),{allSelected:d,onAllCheckboxChange:g,data:t,settingsConfig:C,filters:s,groupOnColumn:p,sortAndGroup:i.sortAndGroup,...m}},tn=c`
	<svg
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
...
`,Za=n=>n?"groupRow groupRow-folded":"groupRow",eo=({item:n,index:e})=>t=>E(t?.length>0,()=>c`
	...
	`,no=({onCheckboxChange:n,dataIsValid:e,groupOnColumn:t})=>(i,a,{selected:o,folded:r,toggleFold:l})=>c` <div
		...
		</div>`,io=({host:n,error:e,dataIsValid:t,processedItems:i,columns:a,collapsedColumns:o,miniColumns:r,sortAndGroupOptions:l,rowPartFn:s,...u})=>{const{loading:m=!1,displayEmptyGroups:d=!1,compareItemsFn:g}=n,p=_e({shiftKey:!1,ctrlKey:!1}),h=w(b=>{const y=b.target.dataItem,f=b.target.checked;p.current.shiftKey?n.shadowRoot.querySelector("#groupedList").toggleSelectTo(y,f):p.current.ctrlKey?(b.target.checked=!0,n.shadowRoot.querySelector("#groupedList").selectOnly(y)):n.shadowRoot.querySelector("#groupedList").toggleSelect(y,f),b.preventDefault(),b.stopPropagation()},[]);_(()=>{const b=({shiftKey:y,ctrlKey:f})=>{p.current={shiftKey:y,ctrlKey:f}};return window.addEventListener("keydown",b),window.addEventListener("keyup",b),()=>{window.removeEventListener("keydown",b),window.removeEventListener("keyup",b)}},[]);const C=w(b=>{const y=b.composedPath();y.slice(0,y.indexOf(b.currentTarget)).find(v=>v.matches?.("a, .checkbox, .expand"))||n.dispatchEvent(new window.CustomEvent("omnitable-item-click",{bubbles:!0,composed:!0,detail:{item:b.currentTarget.dataItem,index:b.currentTarget.dataIndex}}))},[]),{groupOnColumn:x}=l,k=w((b,y)=>f=>ii(n,b,y,f),[]);return{...u,processedItems:i,dataIsValid:t,filterIsTooStrict:t&&i.length<1,loading:m,compareItemsFn:g,displayEmptyGroups:d,error:e,renderItem:F(()=>to({columns:a,collapsedColumns:o,miniColumns:r,onItemClick:C,onCheckboxChange:h,dataIsValid:t,groupOnColumn:x,onItemChange:k,rowPartFn:s}),[a,o,C,h,t,x,k,s]),renderGroup:F(()=>no({onCheckboxChange:h,dataIsValid:t,groupOnColumn:x}),[h,t,x])}},ao=(n,e)=>{if(n===e)return 0;if(n==null)return-1;if(e==null)return 1;const t=typeof n,i=typeof e;return t==="object"&&i==="object"?n.toString()<e.toString()?-1:1:t==="number"&&i==="number"?n-e:t==="string"&&i==="string"?n<e?-1:1:t==="boolean"&&i==="boolean"?n?-1:1:(console.warn("unsupported sort",t,n,i,e),0)},Ne=(n,e)=>(t,i)=>ao(n(t),n(i))*(e?-1:1),oo=n=>n.replace(/([a-z0-9])([A-Z])/gu,"$1-$2").toLowerCase(),kt=(n,e)=>{!n||!e||Object.entries(e).forEach(([t,i])=>{n[V].__ownChange=!0,n[V][t]=i,n[V].__ownChange=!1,n[V].dispatchEvent(new CustomEvent(`${oo(t)}-changed`,{bubbles:!0,detail:{value:i}}))})},Be=(n,e)=>Object.assign(n,{[Se]:e}),Ce=Symbol("unparsed"),ro=({data:n,columns:e,hashParam:t,sortAndGroupOptions:i,noLocalSort:a,noLocalFilter:o})=>{const{groupOnColumn:r,groupOnDescending:l,sortOnColumn:s,descending:u}=i,m=w(([f,v])=>{const $=e.find(({name:z})=>z===f);return $==null?[f,void 0]:[f,v.filter&&$.serializeFilter($,v.filter)]},[e]),d=w(([f,v])=>{const $=e.find(({name:q})=>q===f);if($==null)return[f,{[Ce]:v}];const z={filter:$.deserializeFilter($,v)};return kt($,z),[f,z]},[e]),[g,p]=te({},t,{multi:!0,suffix:"-filter--",write:m,read:d}),h=w((f,v)=>p($=>{const z=ke(v,$[f]);return kt(e.find(q=>q.name===f),z),{...$,[f]:{...$[f],...z}}}),[e,p]),C=F(()=>Object.values(g).map(f=>f.filter),[g]),x=F(()=>Object.fromEntries(e.map(f=>[f.name,!f.noLocalFilter&&f.getFilterFn(f,g[f.name]?.filter)]).filter(([,f])=>!!f)),[e,...C]),k=F(()=>!Array.isArray(n)||n.length===0?[]:Object.entries(x).length===0||o?n.slice():n.filter(f=>Object.values(x).every(v=>v(f))),[n,x,o]),b=F(()=>{if(!a&&!r&&s!=null&&s.sortOn!=null)return k.slice().sort(Ne(f=>s.getComparableValue({...s,valuePath:s.sortOn},f),u));if(r!=null&&r.groupOn!=null){const f=k.reduce((v,$)=>{const z=r.getComparableValue({...r,valuePath:r.groupOn},$);if(z===void 0)return v;let q=v.find(N=>N.id===z);return q?(q.items.push($),v):(q={id:z,name:z,items:[$]},[...v,q])},[]);return f.sort(Ne(v=>r.getComparableValue({...r,valuePath:r.groupOn},v.items[0]),l)),!s||a?f:f.filter(v=>Array.isArray(v.items)).map(v=>(v.items.sort(Ne($=>s.getComparableValue({...s,valuePath:s.sortOn},$),u)),v))}return k},[k,r,l,s,u,a]),y=F(()=>{let f=0,v=0;const $=[];return b.forEach(z=>{if(Array.isArray(z.items)){Be(z,v++),z.items.forEach(q=>{Be(q,f++),$.push(q)});return}return Be(z,f++),$.push(z)},[]),$},[b]);return _(()=>{p(f=>Object.values(f).some($=>$[Ce]!=null)?Object.fromEntries(Object.entries(f).map(([$,z])=>z[Ce]==null?[$,z]:d([$,z[Ce]]))):f)},[d]),{processedItems:b,visibleData:y,filters:g,filterFunctions:x,setFilterState:h}},lo=n=>{const e=i=>{const a=n.data.indexOf(i);if(a<0)return null;const o=n.data.splice(a,1);if(n.data=n.data.slice(),Array.isArray(o)&&o.length>0)return o[0]},t=(i,a)=>{n.data.splice(i,1,a),n.data=n.data.slice()};return{removeItem:e,removeItems(i){const a=[];for(let o=i.length-1;o>=0;o-=1){const r=n.removeItem(i[o]);r!=null&&a.push(r)}return a},replaceItemAtIndex:t,replaceItem(i,a){const o=n.data.indexOf(i);if(o>-1)return t(o,a)},selectItem(i){n.shadowRoot.querySelector("#groupedList").select(i)},selectAll(){n.shadowRoot.querySelector("#groupedList").selectAll()},deselectAll(){n.shadowRoot.querySelector("#groupedList").deselectAll()},deselectItem(i){n.shadowRoot.querySelector("#groupedList").deselect(i)},isItemSelected(i){return n.shadowRoot.querySelector("#groupedList").isItemSelected(i)}}},so=({host:n,visibleData:e,filters:t,...i})=>{const{setFilterState:a}=i,o=F(()=>lo(n),[]),[r,l]=Rt("selectedItems",[]);Ue(i,Object.values(i)),Ue(o,Object.values(o)),_(()=>{const u=m=>a(m.detail.name,d=>({...d,...m.detail.state}));return n.addEventListener("legacy-filter-changed",u),()=>n.removeEventListener("legacy-filter-changed",u)},[]),U("visibleData",e),U("sortedFilteredGroupedItems",i.sortedFilteredGroupedItems),U("sortOn",i.sortOn),U("descending",i.descending),U("isMini",i.isMini);const s=F(()=>Object.fromEntries(Object.entries(t).filter(([,{filter:u}])=>u!==void 0).map(([u,{filter:m}])=>[u,m])),[t]);return U("filters",s,Object.values(s)),{selectedItems:r,setSelectedItems:l}},uo=n=>{const{hashParam:e,settingsId:t,data:i,resizeSpeedFactor:a,noLocal:o,noLocalSort:r=o,noLocalFilter:l=o,error:s,rowPartFn:u}=n,m=Ma({settingsId:t,host:n}),{settings:d,setSettings:g,columns:p,resetRef:h,savedSettings:C}=m,x=C!==void 0,k=na(p,e,{settings:d,setSettings:g,resetRef:h,ready:x}),{processedItems:b,visibleData:y,filters:f,setFilterState:v,filterFunctions:$}=ro({data:i,columns:p,hashParam:e,sortAndGroupOptions:k,noLocalSort:r,noLocalFilter:l}),{isMini:z,collapsedColumns:q,miniColumns:N,requestTween:G}=Xa({host:n,columns:p,settings:d,setSettings:g,resizeSpeedFactor:a,sortAndGroupOptions:k}),ot=i&&Array.isArray(i)&&i.length>0,{selectedItems:Re,setSelectedItems:rt}=so({host:n,visibleData:y,sortedFilteredGroupedItems:b,columns:p,filters:f,setFilterState:v,isMini:z,...k}),lt=Ya({host:n,selectedItems:Re,sortAndGroupOptions:k,dataIsValid:ot,data:i,columns:p,filters:f,collapsedColumns:q,settings:d,filterFunctions:$,settingS:m,setFilterState:v,hideSelectAll:n.hideSelectAll===!0,requestTween:G});return{header:lt,list:io({host:n,error:s,dataIsValid:ot,processedItems:b,selectedItems:Re,setSelectedItems:rt,columns:p,collapsedColumns:q,miniColumns:N,sortAndGroupOptions:k,rowPartFn:u}),footer:Qa({host:n,selectedItems:Re,allSelected:lt.allSelected,setSelectedItems:rt,columns:p,enableSelectAll:n.enableSelectAll===!0,allItemsCount:n.allItemsCount})}};customElements.define("cosmoz-grouped-list-row",class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||He(this._renderFn(this._item,this._index),this)}});const co={group:Symbol("group")},Te=(n,e)=>(e.has(n)||e.set(n,{}),e.get(n)),mo=(n,e)=>!!Te(n,e).expanded,po=(n,e)=>!!Te(n,e).folded,Ke=n=>n?n.items instanceof Array:!1,go=n=>{if(!Array.isArray(n)||n.length===0)return;const e=Array.isArray(n[0]?.items);if(!n.every(i=>Array.isArray(i.items)===e))throw new Error("Data must be homogeneous.")},bo=(n,e,t)=>Array.isArray(n)?(go(n),n.reduce((a,o)=>{const r=o;return r.items?r.items.length?Te(o,t).folded?a.concat(o):a.concat(o,r.items.map(l=>Object.assign(l,{[co.group]:o}))):e?a.concat(o):a:a.concat(o)},[])):void 0,fo=(n,...e)=>typeof n=="function"?n(...e):n,ho=(n,e)=>n===e,xo=()=>{const[n,e]=R(()=>[new WeakMap]);return{setItemState:w((i,a)=>e(([o])=>{const r=Te(i,o);return Object.assign(r,fo(a,r)),[o]}),[]),state:n[0],signal:n}},yo=()=>{const{setItemState:n,state:e,signal:t}=xo(),i=w((o,r)=>{Ke(o)&&n(o,l=>({folded:r!==void 0?r:!l.folded}))},[]),a=w((o,r)=>{Ke(o)||n(o,l=>({expanded:r!==void 0?!r:!l.expanded}))},[]);return{state:e,signal:t,toggleFold:i,toggleCollapse:a}},vo=({compareItemsFn:n,data:e,flatData:t})=>{const[i,a]=Rt("selectedItems",()=>[]),[o,r]=R(),l=_e(e);_(()=>{l.current=e},[e]);const s=w(b=>i===T||i.includes(b),[i]),u=w(b=>i===T||(b?.items?.every(s)??!1),[i,s]),m=w(b=>s(b)||u(b),[s,u]),d=w(b=>{const f=b.items??[b];a(v=>v===T?v:[...v,...f.filter($=>!v.includes($))]),r(b)},[]),g=w(b=>{const f=b.items??[b];a(v=>v===T?(l.current??[]).flatMap($=>($.items||[$]).filter(q=>!f.includes(q))):v.filter($=>!f.includes($))),r(b)},[]),p=w(b=>{a(b.items?.slice()||[b]),r(b)},[]),h=w(()=>{a((l.current??[]).flatMap(b=>b.items||b)),r(void 0)},[]),C=w(()=>{a([]),r(void 0)},[]),x=w((b,y=!m(b))=>y?d(b):g(b),[m]),k=w((b,y)=>{if(!t)return;const f=o?t.findIndex(z=>n(z,o)):-1;if(f<0)return x(b,y);const[v,$]=[f,t.indexOf(b)].sort((z,q)=>z-q);t.slice(v,$+1).forEach((z,q,N)=>{q>0&&q<N.length-1&&Ke(z)||x(z,y)}),r(b)},[t,n,x]);return _(()=>a(b=>b!==T&&b.length>0&&t?t.filter(y=>b.find(f=>n(y,f))):b),[t]),{selectedItems:i,isItemSelected:s,isGroupSelected:u,isSelected:m,select:d,deselect:g,selectOnly:p,selectAll:h,deselectAll:C,toggleSelect:x,toggleSelectTo:k}},$o={host:{position:"relative",display:"flex",flexDirection:"column"}},wo=n=>{const{data:e,renderItem:t,renderGroup:i,displayEmptyGroups:a,compareItemsFn:o=ho}=n,{toggleFold:r,toggleCollapse:l,state:s,signal:u}=yo(),m=F(()=>bo(e,a,s),[e,a,u]),{selectedItems:d,isItemSelected:g,isGroupSelected:p,isSelected:h,select:C,deselect:x,selectOnly:k,selectAll:b,deselectAll:y,toggleSelect:f,toggleSelectTo:v}=vo({compareItemsFn:o,data:e,flatData:m}),$=w((q,N)=>Array.isArray(q.items)?i(q,N,{selected:p(q),folded:po(q,s),toggleSelect:G=>f(q,typeof G=="boolean"?G:void 0),toggleFold:()=>r(q)}):t(q,N,{selected:g(q),expanded:mo(q,s),toggleSelect:G=>f(q,typeof G=="boolean"?G:void 0),toggleCollapse:()=>l(q)}),[t,i,d,f,u]);It(()=>{Object.assign(n.style,$o.host)},[]);const z={toggleFold:r,toggleCollapse:l,isItemSelected:g,isGroupSelected:p,isSelected:h,select:C,deselect:x,selectOnly:k,selectAll:b,deselectAll:y,toggleSelect:f,toggleSelectTo:v};return Ue(z,Object.values(z)),{renderRow:$,flatData:m}},Co=({renderRow:n,flatData:e})=>zn({items:e,renderItem:(t,i)=>c`<cosmoz-grouped-list-row
				.item=${t}
				.index=${i}
				.renderFn=${n}
			></cosmoz-grouped-list-row>`}),zo=n=>Co(wo(n));customElements.define("cosmoz-grouped-list",M(zo,{useShadowDOM:!1}));const So=n=>window.ShadyCSS?.ApplyShim?.transformCssText?.(n)||n,Ao=n=>{const{header:e,list:t,footer:i}=uo(n);return c`
		<style>
			${Sn([],()=>So(ca))}
		</style>
