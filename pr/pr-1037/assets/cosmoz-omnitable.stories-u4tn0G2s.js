...
`);i.unshift(r),Ke(new File(i,n,{type:`text/csv;charset=utf-8`}))}})),Wi,Gi,Ki=e((()=>{We(),Se(),Wi=(e,t)=>{let n=e.map(e=>e.title),r=t.map(t=>e.map(e=>e.toXlsxValue(e,t)??``));return r.unshift(n),r},Gi=(e,t,n,r)=>{let i=Wi(e,t),a=new Qe(n).addSheetFromData(i,r).generate();Ke(new File([a],n,{type:`application/vnd.openxmlformats-officedocument.spreadsheetml.sheet`}))}})),qi,W,Ji,Yi=e((()=>{qi=Symbol(`index`),W=Symbol(`All`),Ji=(e,t)=>{if(typeof e.findLastIndex==`function`)return e.findLastIndex(t);for(let n=e.length-1;n>=0;n--)if(t(e[n],n,e))return n;return-1}})),Xi,Zi=e((()=>{s(),i(),o(),Ui(),Ki(),Yi(),Xi=({columns:e,selectedItems:t,visibleData:n=[],saveAsCsv:i=Hi,saveAsXlsx:o=Gi,setSelectedItems:s,csvFilename:c,xlsxFilename:l,xlsxSheetname:u,topPlacement:d,enableSelectAll:f,allItemsCount:p=0})=>{let m=t===W?p:t.length;return a`<cosmoz-bottom-bar
	...
	>
		<span slot="info">
			${t===W?r(`All {count} items selected`,{count:p}):r(`{count} selected item`,{count:m})}
		</span>
