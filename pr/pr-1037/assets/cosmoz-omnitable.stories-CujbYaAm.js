import{e as c,D as He,t as S,A as Ge}from"./iframe-B6A6qcs8.js";import{t as W,c as M,g as A,n as F,P as E,s as ln,a as Ft,r as sn,e as un,D as cn,b as dn,d as mn,i as ke,h as kt,m as pn,u as R,f as _t,j as It,k as gn,l as Z,p as N,o as We,q as Et,v as _e,w as bn,x as Ie,y as _,z as O,A as lt,B as Ee,C as Ot,E as st,F as ut,G as z,H as fn,I as hn,J as Mt,K as Ke,L as Lt,M as xn,N as Dt,O as yn,Q as ct,R as vn,S as $n,T as Cn,U as Tt,V as je,W as Je,X as wn,Y as Rt,Z as Ue,_ as U,$ as zn,a0 as Sn}from"./cosmoz-collapse-CgK1u8XK.js";import"./preload-helper-PPVm8Dsz.js";const An=W`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`);r.unshift(o),Dt(new File(r,t,{type:"text/csv;charset=utf-8"}))},ma=(n,e)=>{const t=n.map(a=>a.title),i=e.map(a=>n.map(o=>{const r=o.toXlsxValue(o,a);return r??""}));return i.unshift(t),i},pa=(n,e,t,i)=>{const a=ma(n,e),o=new yn(t).addSheetFromData(a,i).generate();Dt(new File([o],t,{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}))},Se=Symbol("index"),D=Symbol("All"),ga=(n,e)=>{if(typeof n.findLastIndex=="function")return n.findLastIndex(e);for(let t=n.length-1;t>=0;t--)if(e(n[t],t,n))return t;return-1},ba=({columns:n,selectedItems:e,saveAsCsv:t=da,saveAsXlsx:i=pa,setSelectedItems:a,csvFilename:o,xlsxFilename:r,xlsxSheetname:l,topPlacement:s,enableSelectAll:u,allSelected:m=!1,allItemsCount:d})=>{const g=e===D,p=g||e.length>0,f=e!==D&&u&&m,w=()=>{if(e!==D)return c`<cosmoz-dropdown-menu
		...
		</cosmoz-dropdown-menu>`},y=F(g,()=>d!==void 0?S("All {count} items selected",{count:d}):S("All items selected"),()=>S("{count} selected item",{count:e===D?0:e.length}));return c`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${p}
		part="bottomBar"
