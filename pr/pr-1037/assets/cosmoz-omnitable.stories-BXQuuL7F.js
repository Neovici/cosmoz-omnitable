import{e as c,D as Be,t as S,A as He}from"./iframe-1zWPeDd9.js";import{t as W,c as M,g as A,n as _,P as E,s as ln,a as kt,r as sn,e as un,D as cn,b as dn,d as mn,i as Fe,h as _t,m as pn,u as R,f as It,j as Et,k as gn,l as Z,p as N,o as Ge,q as Ot,v as ke,w as bn,x as _e,y as k,z as O,A as st,B as Ie,C as Mt,E as ut,F as ct,G as z,H as fn,I as hn,J as Lt,K as Ke,L as Dt,M as xn,N as Tt,O as yn,Q as Je,R as dt,S as vn,T as $n,U as Cn,V as We,W as Xe,X as wn,Y as Rt,Z as je,_ as U,$ as zn,a0 as Sn}from"./cosmoz-collapse-DigBs-oQ.js";import"./preload-helper-PPVm8Dsz.js";const An=W`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`;customElements.define("cosmoz-clear-button",M(qn));const G=({valuePath:n},e)=>A(e,n),Fn=G,kn=G,_n=({valuePath:n},e)=>t=>{const i=A(t,n);return i==null?!1:i.toString().toLowerCase().trim().includes(e.toLowerCase().trim())},In=(n,e)=>e===""||e==null?null:e,D=n=>class extends n{static get properties(){return{isOmnitableColumn:{type:Boolean,value:!0},title:{type:String},valuePath:{type:String,notify:!0},values:{type:Array,notify:!0},filter:{type:Object},noLocalFilter:{type:Boolean},disabled:{type:Boolean,value:!1,notify:!0},editable:{type:Boolean,notify:!0},loading:{type:Boolean,value:!1,notify:!0},externalValues:{type:Boolean,value:!1,notify:!0},name:{type:String},sortOn:{type:String},groupOn:{type:String},noSort:{type:Boolean,value:!1},disabledFiltering:{type:Boolean,value:!1},width:{type:String,value:"75px"},minWidth:{type:String,value:"40px"},flex:{type:String,value:"1"},cellClass:{type:String,value:"default-cell"},headerCellClass:{type:String,value:"default-header-cell"},priority:{type:Number,value:0},hidden:{type:Boolean,notify:!0},preferredDropdownHorizontalAlign:{type:String,value:"right"},renderHeader:{type:Function},renderCell:{type:Function},renderEditCell:{type:Function},renderGroup:{type:Function},mini:{type:Number,value:null},renderMini:{type:Function}}}static get observers(){return["notifyFilterChange(filter)"]}notifyFilterChange(e){this.__ownChange||this.dispatchEvent(new CustomEvent("legacy-filter-changed",{detail:{name:this.name,state:this.legacyFilterToState(e)},bubbles:!0}))}legacyFilterToState(e){return{filter:e}}getFilterFn(){}getString(e,t){return G(e,t)}toXlsxValue(e,t){return Fn(e,t)}cellTitleFn(e,t){return this.getString(e,t)}headerTitleFn(e){return e.title}serializeFilter(e,t){return In(e,t)}deserializeFilter(e,t){if(t==null)return null;if(typeof t=="string")try{return window.decodeURIComponent(t)}catch{return null}return t}getComparableValue(e,t){return kn(e,t)}computeSource(e,t){return t}_propertiesChanged(e,t,i){super._propertiesChanged(e,t,i),this.dispatchEvent(new CustomEvent("cosmoz-column-prop-changed",{bubbles:!0}))}},En=n=>e=>n(t=>{if(t.inputValue===void 0&&e.target.value==="")return t;clearTimeout(t.t);const i=setTimeout(()=>n(a=>({...a,filter:a.inputValue})),1e3);return{...t,inputValue:e.target.value,t:i}}),On=n=>()=>n(e=>({...e,filter:e.inputValue})),Mn=n=>e=>{e.keyCode===13&&(e.preventDefault(),n(t=>({...t,filter:t.inputValue})))},Ln=n=>e=>n(t=>({...t,headerFocused:e.detail.value})),Dn=n=>()=>n(e=>({...e,filter:null,inputValue:null})),Tn=n=>n!=null&&n!=="";class Rn extends D(E){static get properties(){return{minWidth:{type:String,value:"55px"},editMinWidth:{type:String,value:"55px"},inputValue:{type:Object,notify:!0}}}getFilterFn(e,t){if(!(t==null||t===""))return _n(e,t)}renderCell(e,{item:t}){return c`<span class="default-column">${G(e,t)}</span>`}renderEditCell(e,{item:t},i){return c`<cosmoz-input
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,inputValue:i,headerFocused:a},o){return c`<cosmoz-input
			...
			@blur=${On(o)}
		>
			${_(!e.disabledFiltering,()=>c`<cosmoz-clear-button
						suffix
						slot="suffix"
						?visible=${Tn(t)}
						light
						@click=${Dn(o)}
					></cosmoz-clear-button>`)}
		</cosmoz-input>`}legacyFilterToState(e){return{filter:e,inputValue:e}}}customElements.define("cosmoz-omnitable-column",Rn);const Vn=["label","value","slot","always-float-label","disabled"],Pn=kt`
	${ln}
...
`,Nn=n=>{const{label:e,value:t,slot:i}=n,a=c`<div
	...
	`},Vt=n=>n?typeof n.close=="function"?n:Vt(n.parentElement):null,Qe=n=>class extends n{static get properties(){return{disabled:{type:Boolean,value:!1},filter:{type:Object,notify:!0},values:{type:Array,value(){return[]}},headerFocused:{type:Boolean,notify:!0},min:{type:Number,value:null},max:{type:Number,value:null},limits:{type:Function},autoupdate:{type:String,value:!0},locale:{type:String,value:null},_filterInput:{type:Object,value(){return{min:null,max:null}}},_range:{type:Object,computed:"_computeRange(values.*)"},_limit:{type:Object,computed:"_computeLimit(_range, _filterInput.*, min, max)",value(){return{}}},_tooltip:{type:String,computed:"_computeTooltip(title, _filterText)"},_fromClasses:{type:String,computed:"_computeInputClasses(_filterInput.min)"},_toClasses:{type:String,computed:"_computeInputClasses(_filterInput.max)"}}}static get observers(){return["_filterInputChanged(_filterInput.*, autoupdate)","_filterChanged(filter.*)","_updateLimits(limits, headerFocused)"]}disconnectedCallback(){this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),super.disconnectedCallback()}_computeInputClasses(e){return e!=null&&e!==""?"has-value":""}toNumber(e,t,i){if(e==null||e==="")return;const a=typeof e=="number"?e:Number(e);if(Number.isNaN(a))return;if(i==null||t==null)return a;const o=this.toNumber(t);return o==null?a:i(a,o)}toValue(){return this.toNumber.apply(this,arguments)}getComparableValue(e,t){if(e==null)return;let i=e;return t!=null&&(i=this.get(t,e)),this.toValue(i)}renderValue(){}getInputString(e,t=this.valuePath){const i=this.toValue(this.get(t,e));return this._toInputString(i)}_computeRange(e){const t=e.base,i=Array.isArray(t)&&t.length&&t.map(a=>this.toValue(a)).filter(a=>a!=null);return!i||i.length<1?{min:null,max:null}:i.reduce((a,o)=>({min:this.toValue(o,a.min,Math.min),max:this.toValue(o,a.max,Math.max)}),{})}_computeLimit(e,t,i,a){if(!e)return;const o=t.base,r=this.toValue(i),l=this.toValue(a),s=r??this.toValue(e.min),u=l??this.toValue(e.max);return{fromMin:s,fromMax:this.toValue(u,this._fromInputString(o.max,"max"),Math.min),toMin:this.toValue(s,this._fromInputString(o.min,"min"),Math.max),toMax:u}}_computeFilterText(e){if(e.base==null)return;const t=e.base,i=this.toValue(t.min),a=this.toValue(t.max),o=[];return i!=null&&o.push(this.renderValue(i)),o.push(" - "),a!=null&&o.push(this.renderValue(a)),o.length>1?o.join(""):void 0}_computeTooltip(e,t){return t==null?e:`${e}: ${t}`}_fromInputString(e){return this.toValue(e)}_toInputString(e){const t=this.toValue(e);return t??null}_getDefaultFilter(){return{min:null,max:null}}_filterInputChanged(e,t){const i=e.path.split(".")[1];this.__inputChangePath=i||null,t&&(this._limitInputDebouncer=cn.debounce(this._limitInputDebouncer,dn.after(600),()=>{this._limitInput(),this._updateFilter()}),mn(this._limitInputDebouncer))}_clearFrom(){this.set("_filterInput.min",null),this._updateFilter()}_clearTo(){this.set("_filterInput.max",null),this._updateFilter()}_onBlur(){this._limitInput(),this._updateFilter()}_onKeyDown(e){const t=e.currentTarget,i=Array.from(t.parentElement.querySelectorAll("cosmoz-input")),a=i[i.findIndex(l=>l===t)+1],o=!a,r=i[0]===t;switch(e.keyCode){case 13:if(e.preventDefault(),!o)a.focus();else{const l=this._limitInput();this._updateFilter(),l||this._closeParent(t)}break;case 9:(o&&!e.shiftKey||r&&e.shiftKey)&&this._closeParent(t)}}_closeParent(e){const t=Vt(e);t&&t.close()}_onDropdownOpenedChanged({currentTarget:e,type:t,detail:i}){(t==="focus"||i?.value===!0)&&setTimeout(()=>{e.querySelector("cosmoz-input:focus")||e.querySelector("cosmoz-input")?.focus()},100)}_limitInput(){const e=this._filterInput,t=this.__inputChangePath,i=t?this._fromInputString(this.get(t,e),t):null;if(this.__inputChangePath=null,i==null)return!1;const a=this._limit,o=t==="min"?"from":"to",r=this.get(o+"Min",a),l=this.get(o+"Max",a),s=this.toValue(i,r,Math.max),u=this.toValue(s,l,Math.min);return this.getComparableValue(i)!==this.getComparableValue(u)?(this.set(["_filterInput",t],this._toInputString(u,t)),this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),!0):!1}_updateFilter(){const e=this._filterInput,t=this.filter,i=this._fromInputString(e.min,"min"),a=this._fromInputString(e.max,"max");this.getComparableValue(i)===this.getComparableValue(t,"min")&&this.getComparableValue(a)===this.getComparableValue(t,"max")||this.set("filter",{min:i,max:a})}_filterChanged(e){if(this._filterInput==null)return;const t=this._filterInput,i=e.base,a=this._fromInputString(t.min,"min"),o=this._fromInputString(t.max,"max");this.getComparableValue(a)===this.getComparableValue(i,"min")&&this.getComparableValue(o)===this.getComparableValue(i,"max")||(this.set("_filterInput",{min:this._toInputString(i.min),max:this._toInputString(i.max)}),this._limitInputDebouncer&&this._limitInputDebouncer.cancel())}hasFilter(){const e=this.filter;return e==null?!1:this.toValue(e.min)!=null||this.toValue(e.max)!=null}resetFilter(){this.filter=this._getDefaultFilter()}_updateLimits(e,t){e&&Promise.resolve(Fe(e,{active:t})).then(i=>{const{min:a,max:o}=i??{};Object.assign(this,{...a!=null?{min:a}:{},...o!=null?{max:o}:{}})})}},me=n=>class extends n{static get template(){return _t`<div id="output" style="position:relative;"></div>`}connectedCallback(){super.connectedCallback();const e=this;Be(e.render(),e.$.output)}_propertiesChanged(e,t,i){super._propertiesChanged(e,t,i);const a=this;requestAnimationFrame(()=>Be(a.render(),a.$.output))}};class Bn extends Qe(me(E)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return c`
		...
		>`}getComparableValue(e,t){return pi(e,t)}}customElements.define("cosmoz-omnitable-column-autocomplete",gi);const et=(n,e)=>e.find(({value:t})=>n===t),bi=(n,e,t)=>{const i=et(e,t);return i?i.text:n},ht=(n,e,t,i)=>bi(n,A(e,t),i),fi=({valuePath:n},e,t)=>et(A(e,n),t),hi=n=>e=>{n(t=>({...t,filter:e?.[0]?.value??null}))},xi=n=>e=>{n(t=>({...t,headerFocused:e}))},yi=n=>e=>{n(t=>({...t,query:e}))},vi=n=>e=>n(e?.[0]?.value),xt=({valuePath:n,trueLabel:e,falseLabel:t},i)=>A(i,n)?e:t,$i=({valuePath:n},e)=>t=>A(t,n)===e,be=Et((n,e)=>[{text:n,value:!0},{text:e,value:!1}]),Ci=({valuePath:n,trueLabel:e,falseLabel:t},i)=>n?A(i,n)?e:t:"",wi=(n,e)=>{try{return JSON.parse(e)}catch{return null}};class zi extends D(E){static get properties(){return{trueLabel:{type:String,value:"True"},falseLabel:{type:String,value:"False"},flex:{type:String,value:"0"},cellClass:{type:String,value:"boolean-cell"}}}getString(e,t){return xt(e,t)}renderCell(e,{item:t}){return xt(e,t)}renderEditCell(e,{item:t},i){const{trueLabel:a,falseLabel:o}=e;return c`<cosmoz-autocomplete
			no-label-float
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return pe(e,t)}}customElements.define("cosmoz-omnitable-column-date",_i);class Ii extends tt(me(E)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return c`
			<style>
			...
			${_(this.disabled,()=>c`
				...
				`,()=>c`
					...
					${de({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:c`
						...
						`})}
				`)}
		`}_toInputString(e){const t=this.toValue(e);if(t!=null)return this._toLocalISOString(t).slice(0,19)}_computeFormatter(e){const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return new Intl.DateTimeFormat(e||void 0,t)}}customElements.define("cosmoz-omnitable-datetime-range-input",Ii);const he={},Ei=n=>{const e=n||"";if(he[e])return he[e];const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return he[e]=new Intl.DateTimeFormat(n||void 0,t),he[e]},Re=({valuePath:n,locale:e},t)=>{const i=I(A(t,n||""));return i===void 0?"":i===null?"Invalid Date":it(i,Ei(e))},Oi=({valuePath:n},e)=>n?A(e,n):"",$t=n=>{const e=I(n);return e==null?"":e.toISOString().slice(0,19).replace(/:/gu,".")},Ct=n=>{if(!(n==null||n==="")&&typeof n=="string")return I(n.replace(/\./gu,":")+"Z")};class wt extends D(E){static get is(){return"cosmoz-omnitable-column-datetime"}static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"datetime-header-cell"},width:{type:String,value:"210px"},minWidth:{type:String,value:"128px"},flex:{type:String,value:"0"},filterStep:{type:Number,value:1}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const i=P({...e,valuePath:"min"},t),a=P({...e,valuePath:"max"},t);if(!(i==null&&a==null))return jt(e,t)}getString(e,t){return Re(e,t)}toXlsxValue(e,t){return Oi(e,t)}getComparableValue(e,t){return P(e,t)}serializeFilter(e,t){if(t==null)return;const i=I(t.min),a=I(t.max);if(!(i==null&&a==null))return $t(i)+"~"+$t(a)}deserializeFilter(e,t){if(typeof t!="string"||t==="")return null;const i=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(i)?{min:Ct(i[1]),max:Ct(i[2])}:null}renderCell(e,{item:t}){return Re(e,t)}renderEditCell(e,{item:t},i){return c`<cosmoz-input
			no-label-float
			type="text"
			@change=${o=>i(Wt(o.target.value))}
			.value=${Re(e,t)}
		...
		></cosmoz-omnitable-datetime-range-input>`}computeSource(e,t){return pe(e,t)}}customElements.define(wt.is,wt);class Mi extends Le(D(E)){renderCell({valuePath:e,textProperty:t},{item:i}){const a=Ye(i,e,t).map(o=>c`<li>${o}</li>`);return c`
			<style>
				ul {
					padding: 0;
					display: inline;
...
`,Di=({items:n})=>{const[e,t]=R(!1),i=Array.isArray(n)?n:[],a=k(()=>Math.max(0,i.length-1),[i]);if(i.length===0)return null;const o=i.length>2,r=i[0],l=o&&!e?[]:i.slice(1),s=u=>{u.stopPropagation(),u.preventDefault(),t(m=>!m)};return c`
		<ul>
			<li>
				<span>${r}</span>
			</li>
	...
	`};customElements.define("cosmoz-omnitable-column-list-data",M(Di,{styleSheets:[_e(Li)]}));class Ti extends Le(D(E)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:i}){return c`<cosmoz-omnitable-column-list-data
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:i},a,o){return c`<cosmoz-autocomplete-ui
			...
			.onText=${Me(a)}
			>${_(e.loading,()=>c`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}}customElements.define("cosmoz-omnitable-column-list",Ti);class Ri extends Qe(me(E)){static get properties(){return{maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null},formatter:{type:Object,computed:"_computeFormatter(locale, minimumFractionDigits, maximumFractionDigits)"},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, formatter)"},headerFocused:{type:Boolean,value:!1}}}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return c`
			<style>
				cosmoz-input[type='number'] {
					background: var(--cosmoz-omnitable-amount-input-background, #ffffff);
					border-radius: 6px;
		...
		></cosmoz-omnitable-number-range-input>`}computeSource(e,t){return pe(e,t)}}customElements.define("cosmoz-omnitable-column-number",Vi);class Pi extends tt(me(E)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return c`
			${_(this.disabled,()=>c`
					<cosmoz-omnitable-dropdown-input
						disabled
						.label=${this.title}
...
`,Xt=n=>(e,t,i=Mt)=>{const a=hn(),o=new URLSearchParams(a.hash.replace("#",""));return n(e,t,i,o),"#!"+Object.assign(a,{hash:o}).href.replace(location.origin,"")},Qt=n=>n==null||n==="",Zi=Xt((n,e,t,i)=>Qt(t(e))?i.delete(n):i.set(n,t(e))),ea=Xt((n,e,t,i)=>{const a=Object.entries(e),o=a.map(t).filter(([,l])=>l!==void 0);if(o.length===0&&a.length>0)return;const r=n;Array.from(i.keys()).filter(l=>l.startsWith(r)).forEach(l=>i.delete(l)),o.forEach(([l,s])=>Qt(s)?i.delete(n+l):i.set(n+l,s))});function te(n,e,{suffix:t="",read:i,write:a,ready:o=!0,multi:r}={}){const l=r?ea:Zi,s=Ie({param:e,suffix:t,link:l,write:a??Mt}),u=k(()=>{if(e==null)return!1;if(r){const p=ut(e+t);return Object.keys(p).length>0}return ct(e+t)!==void 0},[]),[m,d]=R(()=>{if(e==null)return n;if(r){const f=ut(e+t,i);return Object.keys(f).length>0?f:n}return ct(e+t,i)??n}),g=z(p=>d(f=>{const w=Fe(p,f);return s.param!=null&&fn(s.link(s.param+s.suffix,w,s.write),null,{notify:!1}),w}),[]);return O(()=>{s.param==null||!o||u||n!=null&&g(n)},[o]),[m,g]}const ta=n=>[!0,"true",1,"yes","on"].includes(n),ye=n=>n===""||(n==null?void 0:ta(n)),ve=(n,e,t)=>z(i=>{n(i),t(a=>({...a,[e]:i}))},[n,e,t]),na=(n,e,{settings:t,setSettings:i,resetRef:a,ready:o=!0})=>{const[r,l]=te(t.sortOn,e,{suffix:"-sortOn",ready:o}),[s,u]=te(ye(t.descending),e,{suffix:"-descending",read:ye,ready:o}),[m,d]=te(t.groupOn,e,{suffix:"-groupOn",ready:o}),[g,p]=te(ye(t.groupOnDescending),e,{suffix:"-groupOnDescending",read:ye,ready:o}),f=k(()=>n.find(v=>v.name===r),[n,r]),w=k(()=>n.find(v=>v.name===m),[n,m]),y={groupOn:m,setGroupOn:ve(d,"groupOn",i),groupOnDescending:g,setGroupOnDescending:ve(p,"groupOnDescending",i),sortOn:r,setSortOn:ve(l,"sortOn",i),descending:s,setDescending:ve(u,"descending",i),columns:n},h=k(()=>y,Object.values(y)),x=z(v=>{l(v.sortOn),d(v.groupOn),u(v.descending),p(v.groupOnDescending)},[]);return O(()=>{a.current=x},[]),{...h,sortAndGroup:h,groupOnColumn:w,sortOnColumn:f}},at=Lt();customElements.define("sort-and-group-provider",at.Provider);customElements.define("sort-and-group-consumer",M(({render:n})=>n(Ke(at)),{useShadowDOM:!1}));const ia=({data:n,columns:e,groupOnColumn:t,filters:i,setFilterState:a,sortAndGroup:{sortOn:o,setSortOn:r,descending:l,setDescending:s}={}})=>Dt(e,u=>u.name,u=>[c`<div
			...
			>
				...
				${_(!u.noSort,()=>Kt({on:o,setOn:r,descending:l,setDescending:s,column:u}))}
		...
		${_(n,o=>ia({columns:o,sortAndGroup:a,...i}))}
...
`;customElements.define("cosmoz-omnitable-item-expand-line",M(ra,{styleSheets:[_e(oa)]}));const la=({columns:n,item:e,selected:t,expanded:i,groupOnColumn:a})=>xn(n,o=>c`<cosmoz-omnitable-item-expand-line
				.column=${o}
				?hidden=${o===a}
	...
	>
		...
		<div class="header" id="header" part="header">
			${_(!m,()=>c`<input
						...
						part="all"
					/>`)}
			${_(m,()=>c` <cosmoz-omnitable-settings
						.newLayout="${!0}"
						.config=${u}
					></cosmoz-omnitable-settings>`)}
...
`,xa=({settingsConfig:n})=>{const{columns:e,collapsed:t}=n,i=e.filter(a=>!t.some(o=>o.name===a.name));return c`<div class="skeleton">
		...
		${_(r&&!i.length,()=>c`<div class="tableContent-empty overlay">
					<cosmoz-omnitable-skeleton
						.settingsConfig=${t}
					></cosmoz-omnitable-skeleton>
				</div>`)}
		${_(r&&i.length,()=>c`<div class="tableContent-empty overlay spinner">
					<cz-spinner></cz-spinner>
				</div>`)}
		${_(p,()=>c`<div class="tableContent-empty overlay">
...
`,$e=n=>{const e=parseInt(n,10);return isFinite(e)?e:void 0},Ca=n=>{const{config:e}=n,{settings:t,setSettings:i,collapsed:a,requestTween:o}=e,r=Ie({collapsed:a,settings:t.columns,requestTween:o,setSettings:z(l=>i(s=>({...s,columns:l})),[i])});return{...e,onDown:z(l=>{l.target.closest(".pull")&&(r.handle=l.currentTarget)},[r]),onDragStart:z(l=>{const{target:s}=l,u=$e(s.dataset.index);if(!r.handle?.contains(s)||u==null)return l.preventDefault();r.handle=null,l.dataTransfer.effectAllowed="move",l.dataTransfer.setData("omnitable/sort-index",u),l.dataTransfer.setData("text/plain",u),setTimeout(()=>s.classList.add("drag"),0),s.addEventListener("dragend",m=>m.target.classList.remove("drag"),{once:!0})},[r]),onDragEnter:z(l=>{const s=l.currentTarget;s===l.target&&(l.preventDefault(),l.dataTransfer.dropEffect="move",s.classList.add("dragover"))},[]),onDragOver:z(l=>{l.preventDefault(),l.currentTarget.classList.add("dragover")},[]),onDragLeave:z(l=>{const s=l.currentTarget;s.contains(l.relatedTarget)||s.classList.remove("dragover")},[]),onDrop:z(l=>{const s=$e(l.dataTransfer.getData("omnitable/sort-index")),u=$e(l.currentTarget.dataset.index),{settings:m,setSettings:d,requestTween:g}=r;l.currentTarget.classList.remove("dragover"),l.preventDefault();const p=m.slice();p.splice(u+(s>=u?0:-1),0,p.splice(s,1)[0]),g?.(),d(p)},[r]),onToggle:z(l=>{const{settings:s,setSettings:u,requestTween:m}=r,d=s.map(p=>({...p,disabled:p.disabled||r.collapsed?.some(f=>f.name===p.name)})),g=$e(l.target.closest("[data-index]")?.dataset.index);d.splice(g,1,{...s[g],disabled:!l.target.checked,priority:l.target.checked?s.reduce((p,f)=>Math.max(p,f.priority),0)+1:s[g].priority}),m?.(),u(d)},[r])}},wa=[Cn({apply({availableHeight:n,elements:e}){Object.assign(e.floating.style,{maxHeight:`${Math.max(0,n)}px`})}}),...$n],za=({onDragStart:n,onDragEnter:e,onDragOver:t,onDragLeave:i,onDrop:a,onDown:o,onToggle:r,collapsed:l,filters:s})=>(u,m)=>{const d=!!l?.find(p=>p.name===u.name),g=!u.disabled&&!d;return c` <div
		...
		${_(t,()=>c`<div class="buttons">
				...
				</div>`)}`};customElements.define("cosmoz-omnitable-settings-ui",M(Sa,{styleSheets:[_e(va)]}));const Aa=({config:n,newLayout:e})=>c`
	<cosmoz-dropdown
		.placement="${e?"bottom-start":"bottom-end"}"
		.middleware="${wa}"
	>
		<div title="${S("Sort and filter")}" slot="button">
			${_(e,()=>c`<div class="headerDots">...</div>`,()=>c` <svg viewBox="0 0 24 24" width="24" fill="currentColor">
						<circle cx="10" cy="18" r="2"></circle>
						<circle cx="10" cy="12" r="2"></circle>
						<circle cx="10" cy="6" r="2"></circle>
					</svg>`)}
			${_(n?.badge,()=>c`<div class="badge"></div>`)}
		</div>
		<cosmoz-omnitable-settings-ui
...
`;customElements.define("cosmoz-omnitable-settings",M(Aa,{styleSheets:[_e($a)]}));const Ae=["sortOn","descending","groupOn","groupOnDescending"],Ce=n=>e=>typeof e=="object"&&e!==null&&"name"in e&&e.name===n,qa=(n=[],e=[],t=[])=>{const i=e.filter(r=>n.some(Ce(r.name))),a=n.filter(r=>r.name!=null&&!e.some(Ce(r.name))&&!t.some(Ce(r.name))),o=t.filter(r=>!e.some(Ce(r.name)));return[...i,...o.flatMap(r=>{const l=n.find(s=>s.name===r.name);return l?{...r,title:l.title??r.title??"",minWidth:parseInt(l.minWidth??"0",10)}:[]}),...a.map(r=>{const{name:l,title:s,priority:u,minWidth:m,width:d,flex:g}=r;return{name:l??"",title:s??"",priority:u??0,minWidth:parseInt(m??"0",10),width:parseInt(d??"0",10),flex:parseInt(g??"0",10)}})]},Fa=(n,e)=>({...e,...We(Array.from(Ae))(n),columns:n.columns?.map(We(["name","priority","width","flex","disabled"]))}),ka=({columns:n,settings:e,savedSettings:t,initial:i})=>({...Object.fromEntries(Ae.flatMap(o=>i?.[o]!=null?[[o,i[o]]]:[])),...t?We(Array.from(Ae))(t):{},...e,columns:qa(n,e?.columns,t?.columns)}),_a=({prefix:n="omnitable-"}={})=>({write:async(t,i)=>{const a=n+t;try{i?localStorage.setItem(a,JSON.stringify(i)):localStorage.removeItem(a)}catch(o){console.error(o)}},read:async t=>{if(!t)return null;try{const i=localStorage.getItem(n+t);return i==null?null:JSON.parse(i)}catch(i){return console.error(i),null}}}),Ia=Lt(_a),Ea=()=>{const n=Ke(Ia);return k(()=>n(),[n])},Oa=(n,e,t,i)=>{const[a,o]=R(n?void 0:null),{read:r,write:l}=Ea();return O(async()=>{n&&o(await r(n))},[n,r]),{settingsId:n,savedSettings:a,onSave:z(async()=>{if(!n)return;const s=Fa(e,a);await l(n,s),t(),o(s)},[e,a]),onReset:z(async s=>{t(),s.shiftKey&&(await l(n),o(null)),i?.()},[i]),hasChanges:e!=null}},Ma=({settingsId:n,host:e})=>{const t=k(()=>Object.fromEntries(Ae.map(y=>[y,e[y]])),[]),i=Xe(),a=z(()=>{i.current?.(t)},[t]),[o,r]=R(),[l,s]=R({columns:!0,sort:!0}),{savedSettings:u,...m}=Oa(n,o,r,a),{enabledColumns:d,disabledFiltering:g}=e,p=ni(e,{enabledColumns:d,disabledFiltering:g}),f=k(()=>ka({columns:p,settings:o,savedSettings:u,initial:t}),[p,o,u]),w=k(()=>f.columns.map(y=>p.find(h=>h.name===y.name)).filter(Boolean),[p,...f.columns.map(y=>y.name)]);return{...m,savedSettings:u,opened:l,setOpened:s,settings:f,columns:w,setSettings:r,resetRef:i}},qt=n=>Number.isFinite(n)?n:0,La=(n,e)=>{const t=[];let[i,a]=n.reduce(([m,d],{width:g,flex:p})=>[m+g,d+p],[0,0]),o=e-i,r=qt(o/a),l=0,s=0,u=0;for(let m=0;m<n.length;m++){const{width:d,minWidth:g,flex:p}=n[m],f=o>=0?r*p:d*o/i;if(g>d+f){l+=d,s+=g,u+=p,t[m]=g;continue}if(p===0){l+=d,s+=d,t[m]=d;continue}}i-=l,o=e-s-i,a-=u,r=qt(o/a);for(let m=0;m<n.length;m++){if(t[m]!=null)continue;const{width:d,flex:g}=n[m],p=o>=0?r*g:d*o/i;t[m]=d+p}return t},Da=(n,e)=>{const t=ga(n,r=>r!=null&&r>0),i=(r,l)=>`.cell[name="${r}"], cosmoz-omnitable-skeleton::part(cell-${r}){width: ${Math.floor(l)}px;padding: 0 min(3px, ${l/2}px)}`,a=r=>`cosmoz-omnitable-resize-nub[name="${r}"]{display:none}`,o=r=>`cosmoz-omnitable-resize-nub[name="${r}"], .cell[name="${r}"]{display:none}`;return e.map((r,l)=>{const s=n[l];if(s==null||s===0)return o(r.name);const u=i(r.name,s);return l===t?`${u}
${a(r.name)}`:u}).join(`
`)},Zt=(n,e,t)=>{const i=n.filter(l=>!l.hidden),a=i.reduce((l,{width:s})=>l+s,0);if(i.length>1&&a>e)return Zt(i.slice(1),e,t);const o=i.reduce(([l,s],u,m)=>[Math.max(l,u.index),u.index>l?m:s],[-1,-1])[1];return o!==-1&&(i[o].flex=1),La(i,e).reduce((l,s,u)=>(l[i[u].index]=s,l),new Array(t).fill(void 0))},Ta=(n,e)=>n.length===0?".cell {display: none;}":Da(n,e),Ra=20,Va=44,Pa=24,en=Ra+Va+Pa,Na=(n,e)=>O(()=>{const t=([a])=>{a.contentRect?.width!==0&&e(a.contentRect.width-en)},i=new ResizeObserver(t);return i.observe(n),()=>i.unobserve(n)},[]),Ba=n=>{const[e,t]=R(()=>n.getBoundingClientRect().width-en);return Na(n,t),e},Ha=({canvasWidth:n,groupOnColumn:e,config:t,miniColumn:i})=>k(()=>{if(!Array.isArray(t)||n==null||n===0)return[];const a=t.map((o,r)=>({minWidth:o.minWidth,width:o.width,flex:o.flex,priority:o.priority,name:o.name,index:r,hidden:o.name===e?.name||o.disabled})).map(o=>i?{...o,hidden:i.name!==o.name}:o).sort(({index:o,priority:r},{index:l,priority:s})=>r===s?l-o:r-s);return Zt(a,n,a.length)},[n,e,t]),Ga=({host:n,canvasWidth:e,columns:t})=>{const i=n.miniBreakpoint??480,a=k(()=>e<=i,[e,i]),o=k(()=>a?t?.filter(u=>u.mini!=null).sort((u,m)=>(u.mini??0)-(m.mini??0)):[],[t,a]),[r,...l]=o??[],s=!!r;return O(()=>{n.toggleAttribute("mini",s)},[s]),{isMini:s&&a,miniColumn:r,miniColumns:l}},Wa=({host:n,canvasWidth:e,layout:t,setSettings:i,requestTween:a})=>{const o=Xe();o.current=r=>{a(),i(l=>{const s=l.columns,{detail:{newWidth:u,column:m}}=r,d=s.findIndex(f=>f.name===m.name),g=[],p=s.reduce((f,w)=>Math.max(f,w.priority),-1/0);for(let f=0;f<t.length;f++)if(g[f]={...s[f]},f<d&&t[f]&&(g[f].width=t[f],g[f].flex=0,g[f].priority=p),f===d){const w=t.reduce((y,h,x)=>x<d&&h?y-h:y,e);g[f].width=Math.min(w,Math.max(u,s[f].minWidth)),g[f].flex=0,g[f].priority=p}return{...l,columns:g}})},O(()=>{const r=l=>o.current?.(l);return n.addEventListener("column-resize",r),()=>n.removeEventListener("column-resize",r)},[])},ja=(n,e)=>{const t=k(()=>{let i=!1,a;const o=()=>{if(!i)return;a=requestAnimationFrame(o),n()&&(i=!1)};return{start:()=>{i=!0,cancelAnimationFrame(a),a=requestAnimationFrame(o)},stop:()=>{i=!1,cancelAnimationFrame(a)}}},[]);O(()=>{t.start()},e),O(()=>()=>t.stop(),[])},Ua=(n=0,e=0)=>Math.abs(n-e)<.1,Ka=(n,e=1.9,t=wn,i)=>{const a=Ie({target:n,speedFactor:e,onConverge:i}),o=z(()=>{if(!a.tween)return a.tween=a.target,t(a.tween),a.onConverge?.(),!0;if(a.target.every((r,l)=>a.tween[l]===r))return t(a.tween),a.onConverge?.(),!0;if(a.tween=a.target.map((r,l)=>Ua(a.tween[l],r)?r:(a.tween[l]??0)+((r??0)-(a.tween[l]??0))/a.speedFactor||0),t(a.tween),a.tween.every((r,l)=>r===a.target[l]))return a.onConverge?.(),!0},[]);ja(o,[n])},Ja=n=>{const e=k(()=>new CSSStyleSheet,[]);return O(()=>{n.shadowRoot.adoptedStyleSheets=[...n.shadowRoot.adoptedStyleSheets,e]},[]),e},Xa=({host:n,columns:e,settings:t,setSettings:i,resizeSpeedFactor:a,sortAndGroupOptions:o})=>{const r=Ba(n),{isMini:l,miniColumn:s,miniColumns:u}=Ga({host:n,canvasWidth:r,columns:e}),{groupOnColumn:m}=o,d=Ha({canvasWidth:r,groupOnColumn:m,miniColumn:s,config:t.columns}),g=Ja(n),p=k(()=>t.columns.reduce((v,b,$)=>d[$]!=null||b.name===m?.name||b.disabled?v:[...v,e.find(C=>C.name===b.name)],[]),[e,t,d]),[f,w]=R(1),y=z(()=>w(a??1.9),[a]),h=z(()=>w(1),[]),x=Ie({columns:t.columns});return Ka(d,f,v=>{const b=Ta(v,x.columns);g.replace(b)},h),Wa({host:n,canvasWidth:r,layout:d,setSettings:v=>i(v(t)),requestTween:y}),{isMini:l,collapsedColumns:p,miniColumns:u,requestTween:y}},Qa=({host:n,...e})=>{const{csvFilename:t="omnitable.csv",xlsxFilename:i="omnitable.xlsx",xlsxSheetname:a="Omnitable",topPlacement:o="top-end"}=n;return{csvFilename:t,xlsxFilename:i,xlsxSheetname:a,topPlacement:o,...e}},Ya=({host:n,selectedItems:e,data:t,sortAndGroupOptions:i,collapsedColumns:a,settings:o,filterFunctions:r,settingS:l,filters:s,requestTween:u,...m})=>{const d=e===T||t&&t.length>0&&e.length===t.length,g=y=>{y.target.checked?n.shadowRoot.querySelector("#groupedList").selectAll():n.shadowRoot.querySelector("#groupedList").deselectAll()},{groupOnColumn:p}=i,f=k(()=>[p,...a,...o.columns.filter(y=>y.disabled)].some(y=>y&&Object.keys(r).includes(y.name)),[r,o,a]),w=k(()=>({...l,collapsed:a,badge:f,filters:s,requestTween:u}),[l,a,f,s,u]);return O(()=>{const y=n.shadowRoot.querySelector("#tableContent"),h=new ResizeObserver(x=>requestAnimationFrame(()=>{n.style.setProperty("--ot-height",x[0]?.contentRect.height+"px")}));return h.observe(y),()=>h.unobserve(y)},[]),{allSelected:d,onAllCheckboxChange:g,data:t,settingsConfig:w,filters:s,groupOnColumn:p,sortAndGroup:i.sortAndGroup,...m}},tn=c`
	<svg
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
...
`,Za=n=>n?"groupRow groupRow-folded":"groupRow",eo=({item:n,index:e})=>t=>_(t?.length>0,()=>c`
	...
	`,no=({onCheckboxChange:n,dataIsValid:e,groupOnColumn:t})=>(i,a,{selected:o,folded:r,toggleFold:l})=>c` <div
		...
		</div>`,io=({host:n,error:e,dataIsValid:t,processedItems:i,columns:a,collapsedColumns:o,miniColumns:r,sortAndGroupOptions:l,rowPartFn:s,...u})=>{const{loading:m=!1,displayEmptyGroups:d=!1,compareItemsFn:g}=n,p=Xe({shiftKey:!1,ctrlKey:!1}),f=z(x=>{const v=x.target.dataItem,b=x.target.checked;p.current.shiftKey?n.shadowRoot.querySelector("#groupedList").toggleSelectTo(v,b):p.current.ctrlKey?(x.target.checked=!0,n.shadowRoot.querySelector("#groupedList").selectOnly(v)):n.shadowRoot.querySelector("#groupedList").toggleSelect(v,b),x.preventDefault(),x.stopPropagation()},[]);O(()=>{const x=({shiftKey:v,ctrlKey:b})=>{p.current={shiftKey:v,ctrlKey:b}};return window.addEventListener("keydown",x),window.addEventListener("keyup",x),()=>{window.removeEventListener("keydown",x),window.removeEventListener("keyup",x)}},[]);const w=z(x=>{const v=x.composedPath();v.slice(0,v.indexOf(x.currentTarget)).find($=>$.matches?.("a, .checkbox, .expand"))||n.dispatchEvent(new window.CustomEvent("omnitable-item-click",{bubbles:!0,composed:!0,detail:{item:x.currentTarget.dataItem,index:x.currentTarget.dataIndex}}))},[]),{groupOnColumn:y}=l,h=z((x,v)=>b=>ii(n,x,v,b),[]);return{...u,processedItems:i,dataIsValid:t,filterIsTooStrict:t&&i.length<1,loading:m,compareItemsFn:g,displayEmptyGroups:d,error:e,renderItem:k(()=>to({columns:a,collapsedColumns:o,miniColumns:r,onItemClick:w,onCheckboxChange:f,dataIsValid:t,groupOnColumn:y,onItemChange:h,rowPartFn:s}),[a,o,w,f,t,y,h,s]),renderGroup:k(()=>no({onCheckboxChange:f,dataIsValid:t,groupOnColumn:y}),[f,t,y])}},ao=(n,e)=>{if(n===e)return 0;if(n==null)return-1;if(e==null)return 1;const t=typeof n,i=typeof e;return t==="object"&&i==="object"?n.toString()<e.toString()?-1:1:t==="number"&&i==="number"?n-e:t==="string"&&i==="string"?n<e?-1:1:t==="boolean"&&i==="boolean"?n?-1:1:(console.warn("unsupported sort",t,n,i,e),0)},Pe=(n,e)=>(t,i)=>ao(n(t),n(i))*(e?-1:1),oo=n=>n.replace(/([a-z0-9])([A-Z])/gu,"$1-$2").toLowerCase(),Ft=(n,e)=>{!n||!e||Object.entries(e).forEach(([t,i])=>{n[V].__ownChange=!0,n[V][t]=i,n[V].__ownChange=!1,n[V].dispatchEvent(new CustomEvent(`${oo(t)}-changed`,{bubbles:!0,detail:{value:i}}))})},Ne=(n,e)=>Object.assign(n,{[Se]:e}),we=Symbol("unparsed"),ro=({data:n,columns:e,hashParam:t,sortAndGroupOptions:i,noLocalSort:a,noLocalFilter:o})=>{const{groupOnColumn:r,groupOnDescending:l,sortOnColumn:s,descending:u}=i,m=z(([b,$])=>{const C=e.find(({name:q})=>q===b);return C==null?[b,void 0]:[b,$.filter&&C.serializeFilter(C,$.filter)]},[e]),d=z(([b,$])=>{const C=e.find(({name:F})=>F===b);if(C==null)return[b,{[we]:$}];const q={filter:C.deserializeFilter(C,$)};return Ft(C,q),[b,q]},[e]),[g,p]=te({},t,{multi:!0,suffix:"-filter--",write:m,read:d}),f=z((b,$)=>p(C=>{const q=Fe($,C[b]);return Ft(e.find(F=>F.name===b),q),{...C,[b]:{...C[b],...q}}}),[e,p]),w=k(()=>Object.values(g).map(b=>b.filter),[g]),y=k(()=>Object.fromEntries(e.map(b=>[b.name,!b.noLocalFilter&&b.getFilterFn(b,g[b.name]?.filter)]).filter(([,b])=>!!b)),[e,...w]),h=k(()=>!Array.isArray(n)||n.length===0?[]:Object.entries(y).length===0||o?n.slice():n.filter(b=>Object.values(y).every($=>$(b))),[n,y,o]),x=k(()=>{if(!a&&!r&&s!=null&&s.sortOn!=null)return h.slice().sort(Pe(b=>s.getComparableValue({...s,valuePath:s.sortOn},b),u));if(r!=null&&r.groupOn!=null){const b=h.reduce(($,C)=>{const q=r.getComparableValue({...r,valuePath:r.groupOn},C);if(q===void 0)return $;let F=$.find(j=>j.id===q);return F?(F.items.push(C),$):(F={id:q,name:q,items:[C]},[...$,F])},[]);return b.sort(Pe($=>r.getComparableValue({...r,valuePath:r.groupOn},$.items[0]),l)),!s||a?b:b.filter($=>Array.isArray($.items)).map($=>($.items.sort(Pe(C=>s.getComparableValue({...s,valuePath:s.sortOn},C),u)),$))}return h},[h,r,l,s,u,a]),v=k(()=>{let b=0,$=0;const C=[];return x.forEach(q=>{if(Array.isArray(q.items)){Ne(q,$++),q.items.forEach(F=>{Ne(F,b++),C.push(F)});return}return Ne(q,b++),C.push(q)},[]),C},[x]);return O(()=>{p(b=>Object.values(b).some(C=>C[we]!=null)?Object.fromEntries(Object.entries(b).map(([C,q])=>q[we]==null?[C,q]:d([C,q[we]]))):b)},[d]),{processedItems:x,visibleData:v,filters:g,filterFunctions:y,setFilterState:f}},lo=n=>{const e=i=>{const a=n.data.indexOf(i);if(a<0)return null;const o=n.data.splice(a,1);if(n.data=n.data.slice(),Array.isArray(o)&&o.length>0)return o[0]},t=(i,a)=>{n.data.splice(i,1,a),n.data=n.data.slice()};return{removeItem:e,removeItems(i){const a=[];for(let o=i.length-1;o>=0;o-=1){const r=n.removeItem(i[o]);r!=null&&a.push(r)}return a},replaceItemAtIndex:t,replaceItem(i,a){const o=n.data.indexOf(i);if(o>-1)return t(o,a)},selectItem(i){n.shadowRoot.querySelector("#groupedList").select(i)},selectAll(){n.shadowRoot.querySelector("#groupedList").selectAll()},deselectAll(){n.shadowRoot.querySelector("#groupedList").deselectAll()},deselectItem(i){n.shadowRoot.querySelector("#groupedList").deselect(i)},isItemSelected(i){return n.shadowRoot.querySelector("#groupedList").isItemSelected(i)}}},so=({host:n,visibleData:e,filters:t,...i})=>{const{setFilterState:a}=i,o=k(()=>lo(n),[]),[r,l]=Rt("selectedItems",[]);je(i,Object.values(i)),je(o,Object.values(o)),O(()=>{const u=m=>a(m.detail.name,d=>({...d,...m.detail.state}));return n.addEventListener("legacy-filter-changed",u),()=>n.removeEventListener("legacy-filter-changed",u)},[]),U("visibleData",e),U("sortedFilteredGroupedItems",i.sortedFilteredGroupedItems),U("sortOn",i.sortOn),U("descending",i.descending),U("isMini",i.isMini);const s=k(()=>Object.fromEntries(Object.entries(t).filter(([,{filter:u}])=>u!==void 0).map(([u,{filter:m}])=>[u,m])),[t]);return U("filters",s,Object.values(s)),{selectedItems:r,setSelectedItems:l}},uo=n=>{const{hashParam:e,settingsId:t,data:i,resizeSpeedFactor:a,noLocal:o,noLocalSort:r=o,noLocalFilter:l=o,error:s,rowPartFn:u}=n,m=Ma({settingsId:t,host:n}),{settings:d,setSettings:g,columns:p,resetRef:f,savedSettings:w}=m,y=w!==void 0,h=na(p,e,{settings:d,setSettings:g,resetRef:f,ready:y}),{processedItems:x,visibleData:v,filters:b,setFilterState:$,filterFunctions:C}=ro({data:i,columns:p,hashParam:e,sortAndGroupOptions:h,noLocalSort:r,noLocalFilter:l}),{isMini:q,collapsedColumns:F,miniColumns:j,requestTween:H}=Xa({host:n,columns:p,settings:d,setSettings:g,resizeSpeedFactor:a,sortAndGroupOptions:h}),ot=i&&Array.isArray(i)&&i.length>0,{selectedItems:Te,setSelectedItems:rt}=so({host:n,visibleData:v,sortedFilteredGroupedItems:x,columns:p,filters:b,setFilterState:$,isMini:q,...h}),lt=Ya({host:n,selectedItems:Te,sortAndGroupOptions:h,dataIsValid:ot,data:i,columns:p,filters:b,collapsedColumns:F,settings:d,filterFunctions:C,settingS:m,setFilterState:$,hideSelectAll:n.hideSelectAll===!0,requestTween:H});return{header:lt,list:io({host:n,error:s,dataIsValid:ot,processedItems:x,selectedItems:Te,setSelectedItems:rt,columns:p,collapsedColumns:F,miniColumns:j,sortAndGroupOptions:h,rowPartFn:u}),footer:Qa({host:n,selectedItems:Te,allSelected:lt.allSelected,setSelectedItems:rt,columns:p,enableSelectAll:n.enableSelectAll===!0,allItemsCount:n.allItemsCount})}};customElements.define("cosmoz-grouped-list-row",class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||Be(this._renderFn(this._item,this._index),this)}});const co={group:Symbol("group")},De=(n,e)=>(e.has(n)||e.set(n,{}),e.get(n)),mo=(n,e)=>!!De(n,e).expanded,po=(n,e)=>!!De(n,e).folded,Ue=n=>n?n.items instanceof Array:!1,go=n=>{if(!Array.isArray(n)||n.length===0)return;const e=Array.isArray(n[0]?.items);if(!n.every(i=>Array.isArray(i.items)===e))throw new Error("Data must be homogeneous.")},bo=(n,e,t)=>Array.isArray(n)?(go(n),n.reduce((a,o)=>{const r=o;return r.items?r.items.length?De(o,t).folded?a.concat(o):a.concat(o,r.items.map(l=>Object.assign(l,{[co.group]:o}))):e?a.concat(o):a:a.concat(o)},[])):void 0,fo=(n,...e)=>typeof n=="function"?n(...e):n,ho=(n,e)=>n===e,xo=()=>{const[n,e]=R(()=>[new WeakMap]);return{setItemState:z((i,a)=>e(([o])=>{const r=De(i,o);return Object.assign(r,fo(a,r)),[o]}),[]),state:n[0],signal:n}},yo=()=>{const{setItemState:n,state:e,signal:t}=xo(),i=z((o,r)=>{Ue(o)&&n(o,l=>({folded:r!==void 0?r:!l.folded}))},[]),a=z((o,r)=>{Ue(o)||n(o,l=>({expanded:r!==void 0?!r:!l.expanded}))},[]);return{state:e,signal:t,toggleFold:i,toggleCollapse:a}},vo=({compareItemsFn:n,data:e,flatData:t})=>{const[i,a]=Rt("selectedItems",()=>[]),[o,r]=R(),l=z(h=>i===T||i.includes(h),[i]),s=z(h=>i===T||(h?.items?.every(l)??!1),[i,l]),u=z(h=>l(h)||s(h),[l,s]),m=z(h=>{const v=h.items??[h];a(b=>b===T?b:[...b,...v.filter($=>!b.includes($))]),r(h)},[]),d=z(h=>{const v=h.items??[h];a(b=>b===T?(t??[]).filter($=>!v.includes($)):b.filter($=>!v.includes($))),r(h)},[t]),g=z(h=>{a(h.items?.slice()||[h]),r(h)},[]),p=z(()=>{a(e.flatMap(h=>h.items||h)),r(void 0)},[e]),f=z(()=>{a([]),r(void 0)},[]),w=z((h,x=!u(h))=>x?m(h):d(h),[u]),y=z((h,x)=>{if(!t)return;const v=o?t.findIndex(C=>n(C,o)):-1;if(v<0)return w(h,x);const[b,$]=[v,t.indexOf(h)].sort((C,q)=>C-q);t.slice(b,$+1).forEach((C,q,F)=>{q>0&&q<F.length-1&&Ue(C)||w(C,x)}),r(h)},[t,n,w]);return O(()=>a(h=>h!==T&&h.length>0&&t?t.filter(x=>h.find(v=>n(x,v))):h),[t]),{selectedItems:i,isItemSelected:l,isGroupSelected:s,isSelected:u,select:m,deselect:d,selectOnly:g,selectAll:p,deselectAll:f,toggleSelect:w,toggleSelectTo:y}},$o={host:{position:"relative",display:"flex",flexDirection:"column"}},Co=n=>{const{data:e,renderItem:t,renderGroup:i,displayEmptyGroups:a,compareItemsFn:o=ho}=n,{toggleFold:r,toggleCollapse:l,state:s,signal:u}=yo(),m=k(()=>bo(e,a,s),[e,a,u]),{selectedItems:d,isItemSelected:g,isGroupSelected:p,isSelected:f,select:w,deselect:y,selectOnly:h,selectAll:x,deselectAll:v,toggleSelect:b,toggleSelectTo:$}=vo({compareItemsFn:o,data:e,flatData:m}),C=z((F,j)=>Array.isArray(F.items)?i(F,j,{selected:p(F),folded:po(F,s),toggleSelect:H=>b(F,typeof H=="boolean"?H:void 0),toggleFold:()=>r(F)}):t(F,j,{selected:g(F),expanded:mo(F,s),toggleSelect:H=>b(F,typeof H=="boolean"?H:void 0),toggleCollapse:()=>l(F)}),[t,i,d,b,u]);It(()=>{Object.assign(n.style,$o.host)},[]);const q={toggleFold:r,toggleCollapse:l,isItemSelected:g,isGroupSelected:p,isSelected:f,select:w,deselect:y,selectOnly:h,selectAll:x,deselectAll:v,toggleSelect:b,toggleSelectTo:$};return je(q,Object.values(q)),{renderRow:C,flatData:m}},wo=({renderRow:n,flatData:e})=>zn({items:e,renderItem:(t,i)=>c`<cosmoz-grouped-list-row
				.item=${t}
				.index=${i}
				.renderFn=${n}
