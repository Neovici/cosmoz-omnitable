...
</style>`,customElements.define(`cz-spinner`,m(ft))})),mt,ht,P=e((()=>{v(),g(),mt=E`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,customElements.define(`cosmoz-clear-button`,m(ht))})),F,gt,_t,vt,yt,I,L=e((()=>{O(),F=({valuePath:e},t)=>M(t,e),gt=F,_t=F,vt=({valuePath:e},t)=>n=>{let r=M(n,e);return r!=null&&r.toString().toLowerCase().trim().includes(t.toLowerCase().trim())},yt=(e,t)=>t===``||t==null?null:t,I=e=>class extends e{static get properties(){return{isOmnitableColumn:{type:Boolean,value:!0},title:{type:String},valuePath:{type:String,notify:!0},values:{type:Array,notify:!0},filter:{type:Object},noLocalFilter:{type:Boolean},disabled:{type:Boolean,value:!1,notify:!0},editable:{type:Boolean,notify:!0},loading:{type:Boolean,value:!1,notify:!0},externalValues:{type:Boolean,value:!1,notify:!0},name:{type:String},sortOn:{type:String},groupOn:{type:String},noSort:{type:Boolean,value:!1},disabledFiltering:{type:Boolean,value:!1},width:{type:String,value:`75px`},minWidth:{type:String,value:`40px`},flex:{type:String,value:`1`},cellClass:{type:String,value:`default-cell`},headerCellClass:{type:String,value:`default-header-cell`},priority:{type:Number,value:0},hidden:{type:Boolean,notify:!0},preferredDropdownHorizontalAlign:{type:String,value:`right`},renderHeader:{type:Function},renderCell:{type:Function},renderEditCell:{type:Function},renderGroup:{type:Function},mini:{type:Number,value:null},renderMini:{type:Function}}}static get observers(){return[`notifyFilterChange(filter)`]}notifyFilterChange(e){this.__ownChange||this.dispatchEvent(new CustomEvent(`legacy-filter-changed`,{detail:{name:this.name,state:this.legacyFilterToState(e)},bubbles:!0}))}legacyFilterToState(e){return{filter:e}}getFilterFn(){}getString(e,t){return F(e,t)}toXlsxValue(e,t){return gt(e,t)}cellTitleFn(e,t){return this.getString(e,t)}headerTitleFn(e){return e.title}serializeFilter(e,t){return yt(e,t)}deserializeFilter(e,t){if(t==null)return null;if(typeof t==`string`)try{return window.decodeURIComponent(t)}catch{return null}return t}getComparableValue(e,t){return _t(e,t)}computeSource(e,t){return t}_propertiesChanged(e,t,n){super._propertiesChanged(e,t,n),this.dispatchEvent(new CustomEvent(`cosmoz-column-prop-changed`,{bubbles:!0}))}}})),bt,xt,St,Ct,wt,Tt,Et,Dt=e((()=>{w(),P(),D(),o(),A(),L(),bt=e=>t=>e(n=>{if(n.inputValue===void 0&&t.target.value===``)return n;clearTimeout(n.t);let r=setTimeout(()=>e(e=>({...e,filter:e.inputValue})),1e3);return{...n,inputValue:t.target.value,t:r}}),xt=e=>()=>e(e=>({...e,filter:e.inputValue})),St=e=>t=>{t.keyCode===13&&(t.preventDefault(),e(e=>({...e,filter:e.inputValue})))},Ct=e=>t=>e(e=>({...e,headerFocused:t.detail.value})),wt=e=>()=>e(e=>({...e,filter:null,inputValue:null})),Tt=e=>e!=null&&e!==``,Et=class extends I(k){static get properties(){return{minWidth:{type:String,value:`55px`},editMinWidth:{type:String,value:`55px`},inputValue:{type:Object,notify:!0}}}getFilterFn(e,t){if(!(t==null||t===``))return vt(e,t)}renderCell(e,{item:t}){return a`<span class="default-column">${F(e,t)}</span>`}renderEditCell(e,{item:t},n){return a`<cosmoz-input
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,inputValue:n,headerFocused:r},i){return a`<cosmoz-input
			...
			@blur=${xt(i)}
		>
			${j(!e.disabledFiltering,()=>a`<cosmoz-clear-button
						suffix
						slot="suffix"
						?visible=${Tt(t)}
						light
						@click=${wt(i)}
					></cosmoz-clear-button>`)}
		</cosmoz-input>`}legacyFilterToState(e){return{filter:e,inputValue:e}}},customElements.define(`cosmoz-omnitable-column`,Et)})),Ot,kt,At,R=e((()=>{w(),g(),o(),Ot=[`label`,`value`,`slot`,`always-float-label`,`disabled`],kt=Ze`
	${me}
...
`,At=e=>{let{label:t,value:n,slot:r}=e;return Ge(a`<div
	...
	>
		${n||``}
	</div>`,{label:t})},customElements.define(`cosmoz-omnitable-dropdown-input`,m(At,{observedAttributes:Ot,styleSheets:[kt]}))})),z,jt=e((()=>{xe(),o(),te(),R(),z=({title:e,tooltip:t=``,filterText:n=``,onOpenedChanged:r,content:i,horizontalAlign:o=`left`,externalValues:s=null})=>a`
		<style>
			.dropdown {
				outline: none;
			}
	...
	`})),Mt,Nt,Pt=e((()=>{Ue(),De(),_(),ne(),Mt=e=>e?typeof e.close==`function`?e:Mt(e.parentElement):null,Nt=e=>class extends e{static get properties(){return{disabled:{type:Boolean,value:!1},filter:{type:Object,notify:!0},values:{type:Array,value(){return[]}},headerFocused:{type:Boolean,notify:!0},min:{type:Number,value:null},max:{type:Number,value:null},limits:{type:Function},autoupdate:{type:String,value:!0},locale:{type:String,value:null},_filterInput:{type:Object,value(){return{min:null,max:null}}},_range:{type:Object,computed:`_computeRange(values.*)`},_limit:{type:Object,computed:`_computeLimit(_range, _filterInput.*, min, max)`,value(){return{}}},_tooltip:{type:String,computed:`_computeTooltip(title, _filterText)`},_fromClasses:{type:String,computed:`_computeInputClasses(_filterInput.min)`},_toClasses:{type:String,computed:`_computeInputClasses(_filterInput.max)`}}}static get observers(){return[`_filterInputChanged(_filterInput.*, autoupdate)`,`_filterChanged(filter.*)`,`_updateLimits(limits, headerFocused)`]}disconnectedCallback(){this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),super.disconnectedCallback()}_computeInputClasses(e){return e!=null&&e!==``?`has-value`:``}toNumber(e,t,n){if(e==null||e===``)return;let r=typeof e==`number`?e:Number(e);if(Number.isNaN(r))return;if(n==null||t==null)return r;let i=this.toNumber(t);return i==null?r:n(r,i)}toValue(){return this.toNumber.apply(this,arguments)}getComparableValue(e,t){if(e==null)return;let n=e;return t!=null&&(n=this.get(t,e)),this.toValue(n)}renderValue(){}getInputString(e,t=this.valuePath){let n=this.toValue(this.get(t,e));return this._toInputString(n)}_computeRange(e){let t=e.base,n=Array.isArray(t)&&t.length&&t.map(e=>this.toValue(e)).filter(e=>e!=null);return!n||n.length<1?{min:null,max:null}:n.reduce((e,t)=>({min:this.toValue(t,e.min,Math.min),max:this.toValue(t,e.max,Math.max)}),{})}_computeLimit(e,t,n,r){if(!e)return;let i=t.base,a=this.toValue(n),o=this.toValue(r),s=a??this.toValue(e.min),c=o??this.toValue(e.max);return{fromMin:s,fromMax:this.toValue(c,this._fromInputString(i.max,`max`),Math.min),toMin:this.toValue(s,this._fromInputString(i.min,`min`),Math.max),toMax:c}}_computeFilterText(e){if(e.base==null)return;let t=e.base,n=this.toValue(t.min),r=this.toValue(t.max),i=[];return n!=null&&i.push(this.renderValue(n)),i.push(` - `),r!=null&&i.push(this.renderValue(r)),i.length>1?i.join(``):void 0}_computeTooltip(e,t){return t==null?e:`${e}: ${t}`}_fromInputString(e){return this.toValue(e)}_toInputString(e){return this.toValue(e)??null}_getDefaultFilter(){return{min:null,max:null}}_filterInputChanged(e,t){let n=e.path.split(`.`)[1];this.__inputChangePath=n||null,t&&(this._limitInputDebouncer=re.debounce(this._limitInputDebouncer,He.after(600),()=>{this._limitInput(),this._updateFilter()}),oe(this._limitInputDebouncer))}_clearFrom(){this.set(`_filterInput.min`,null),this._updateFilter()}_clearTo(){this.set(`_filterInput.max`,null),this._updateFilter()}_onBlur(){this._limitInput(),this._updateFilter()}_onKeyDown(e){let t=e.currentTarget,n=Array.from(t.parentElement.querySelectorAll(`cosmoz-input`)),r=n[n.findIndex(e=>e===t)+1],i=!r,a=n[0]===t;switch(e.keyCode){case 13:if(e.preventDefault(),!i)r.focus();else{let e=this._limitInput();this._updateFilter(),e||this._closeParent(t)}break;case 9:(i&&!e.shiftKey||a&&e.shiftKey)&&this._closeParent(t)}}_closeParent(e){let t=Mt(e);t&&t.close()}_onDropdownOpenedChanged({currentTarget:e,type:t,detail:n}){(t===`focus`||n?.value===!0)&&setTimeout(()=>{e.querySelector(`cosmoz-input:focus`)||e.querySelector(`cosmoz-input`)?.focus()},100)}_limitInput(){let e=this._filterInput,t=this.__inputChangePath,n=t?this._fromInputString(this.get(t,e),t):null;if(this.__inputChangePath=null,n==null)return!1;let r=this._limit,i=t===`min`?`from`:`to`,a=this.get(i+`Min`,r),o=this.get(i+`Max`,r),s=this.toValue(n,a,Math.max),c=this.toValue(s,o,Math.min);return this.getComparableValue(n)===this.getComparableValue(c)?!1:(this.set([`_filterInput`,t],this._toInputString(c,t)),this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),!0)}_updateFilter(){let e=this._filterInput,t=this.filter,n=this._fromInputString(e.min,`min`),r=this._fromInputString(e.max,`max`);this.getComparableValue(n)===this.getComparableValue(t,`min`)&&this.getComparableValue(r)===this.getComparableValue(t,`max`)||this.set(`filter`,{min:n,max:r})}_filterChanged(e){if(this._filterInput==null)return;let t=this._filterInput,n=e.base,r=this._fromInputString(t.min,`min`),i=this._fromInputString(t.max,`max`);this.getComparableValue(r)===this.getComparableValue(n,`min`)&&this.getComparableValue(i)===this.getComparableValue(n,`max`)||(this.set(`_filterInput`,{min:this._toInputString(n.min),max:this._toInputString(n.max)}),this._limitInputDebouncer&&this._limitInputDebouncer.cancel())}hasFilter(){let e=this.filter;return e==null?!1:this.toValue(e.min)!=null||this.toValue(e.max)!=null}resetFilter(){this.filter=this._getDefaultFilter()}_updateLimits(e,t){e&&Promise.resolve(Ie(e,{active:t})).then(e=>{let{min:t,max:n}=e??{};Object.assign(this,{...t==null?{}:{min:t},...n==null?{}:{max:n}})})}}})),Ft,It=e((()=>{D(),o(),Ft=e=>class extends e{static get template(){return qe`<div id="output" style="position:relative;"></div>`}connectedCallback(){super.connectedCallback();let e=this;t(e.render(),e.$.output)}_propertiesChanged(e,n,r){super._propertiesChanged(e,n,r);let i=this;requestAnimationFrame(()=>t(i.render(),i.$.output))}}})),Lt,Rt=e((()=>{w(),D(),i(),o(),A(),jt(),R(),Pt(),It(),Lt=class extends Nt(Ft(k)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:`_computeFilterText(filter.*, _formatters)`},headerFocused:{type:Boolean,value:!1}}}static get observers(){return[`_valuesChanged(autodetect, currency, values)`]}render(){let e=e=>{this.headerFocused=e.type===`focus`,this._onDropdownOpenedChanged(e)};return a`
			...
			${j(this.disabled,()=>a`
				...
				`,()=>a`
					...
					></cosmoz-clear-button>
					${z({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:a`
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:n},r,i){return a`<cosmoz-autocomplete-excluding
			...
			@text-changed=${C(xn(r))}
			>${j(e.loading,()=>a`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-excluding
		>`}getComparableValue(e,t){return En(e,t)}getFilterFn(e,t){if(!(!t||!Array.isArray(t)||t.length===0))return Dn(e,t)}},customElements.define(`cosmoz-omnitable-column-autocomplete-excluding`,On)})),An,jn,Mn=e((()=>{it(),be(),D(),o(),A(),we(),ct(),Tn(),L(),O(),G(),An=({valuePath:e,textProperty:t,valueProperty:n},r)=>{let i=t?ot(t):T(n),a=N(e&&M(r,e)).map(i);return a.length>1?a.filter(Boolean).join(`,`):a[0]},jn=class extends wn(I(k)){static get properties(){return{headerCellClass:{type:String,value:`autocomplete-header-cell`},minWidth:{type:String,value:`55px`},editMinWidth:{type:String,value:`55px`},keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},showSingle:{type:Boolean},preserveOrder:{type:Boolean},limit:{type:Number},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,showSingle:e.showSingle,preserveOrder:e.preserveOrder,limit:e.limit,textual:e.textual}}renderCell(e,{item:t}){return a`<span class="default-column"
			>${e.getString(e,t)}</span
		>`}renderEditCell(e,{item:t},n){return a`<cosmoz-input
			no-label-float
			type="text"
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:n},r,i){return a`<cosmoz-autocomplete-ui
			...
			@opened-changed=${e=>bn(r)(e.detail.value)}
			.onText=${xn(r)}
			>${j(e.loading,()=>a`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}getComparableValue(e,t){return An(e,t)}},customElements.define(`cosmoz-omnitable-column-autocomplete`,jn)})),Nn,Pn,Fn,In,Ln,Rn,zn,Bn,Vn,Hn,Un,Wn,Gn,Kn,qn=e((()=>{D(),L(),it(),Be(),O(),o(),A(),Nn=(e,t)=>t.find(({value:t})=>e===t),Pn=(e,t,n)=>{let r=Nn(t,n);return r?r.text:e},Fn=(e,t,n,r)=>Pn(e,M(t,n),r),In=({valuePath:e},t,n)=>Nn(M(t,e),n),Ln=e=>t=>{e(e=>({...e,filter:t?.[0]?.value??null}))},Rn=e=>t=>{e(e=>({...e,headerFocused:t}))},zn=e=>t=>{e(e=>({...e,query:t}))},Bn=e=>t=>e(t?.[0]?.value),Vn=({valuePath:e,trueLabel:t,falseLabel:n},r)=>M(r,e)?t:n,Hn=({valuePath:e},t)=>n=>M(n,e)===t,Un=c((e,t)=>[{text:e,value:!0},{text:t,value:!1}]),Wn=({valuePath:e,trueLabel:t,falseLabel:n},r)=>e?M(r,e)?t:n:``,Gn=(e,t)=>{try{return JSON.parse(t)}catch{return null}},Kn=class extends I(k){static get properties(){return{trueLabel:{type:String,value:`True`},falseLabel:{type:String,value:`False`},flex:{type:String,value:`0`},cellClass:{type:String,value:`boolean-cell`}}}getString(e,t){return Vn(e,t)}renderCell(e,{item:t}){return Vn(e,t)}renderEditCell(e,{item:t},n){let{trueLabel:r,falseLabel:i}=e;return a`<cosmoz-autocomplete
			no-label-float
			...
			.onChange=${Bn(n)}
			.limit=${1}
			>${j(e.loading,()=>a`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return K(e,t)}},customElements.define(`cosmoz-omnitable-column-date`,fr)})),mr,hr=e((()=>{D(),i(),o(),A(),Yn(),jt(),R(),It(),mr=class extends Jn(Ft(k)){render(){let e=e=>{this.headerFocused=e.type===`focus`};return a`
			<style>
		...
		></cosmoz-omnitable-datetime-range-input>`}computeSource(e,t){return K(e,t)}},customElements.define(Cr.is,Cr)})),Tr,Er=e((()=>{it(),be(),D(),o(),A(),Tn(),L(),Tr=class extends wn(I(k)){renderCell({valuePath:e,textProperty:t},{item:n}){return a`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		`}renderEditCell(){return`not implemented`}renderHeader(e,{filter:t,query:n},r,i){return a`<cosmoz-autocomplete-ui
			...
			.onText=${xn(r)}
			>${j(e.loading,()=>a`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}},customElements.define(`cosmoz-omnitable-column-list-horizontal`,Tr)})),Dr,Or,kr=e((()=>{v(),g(),i(),Dr=E`
	:host {
		display: block;
	}
...
`,Or=({items:e})=>{let[t,n]=x(!1),i=Array.isArray(e)?e:[],o=b(()=>Math.max(0,i.length-1),[i]);if(i.length===0)return null;let s=i.length>2,c=i[0],l=s&&!t?[]:i.slice(1),u=e=>{e.stopPropagation(),e.preventDefault(),n(e=>!e)};return a`
		<ul>
			<li>
				<span>${c}</span>
			</li>
	...
	`},customElements.define(`cosmoz-omnitable-column-list-data`,m(Or,{styleSheets:[Xe(Dr)]}))})),Ar,jr=e((()=>{kr(),D(),o(),A(),it(),Tn(),L(),G(),Ar=class extends wn(I(k)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:n}){return a`<cosmoz-omnitable-column-list-data
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:n},r,i){return a`<cosmoz-autocomplete-ui
			...
			.onText=${xn(r)}
			>${j(e.loading,()=>a`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}},customElements.define(`cosmoz-omnitable-column-list`,Ar)})),Mr,Nr=e((()=>{w(),D(),i(),o(),A(),jt(),R(),Pt(),It(),Mr=class extends Nt(Ft(k)){static get properties(){return{maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null},formatter:{type:Object,computed:`_computeFormatter(locale, minimumFractionDigits, maximumFractionDigits)`},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:`_computeFilterText(filter.*, formatter)`},headerFocused:{type:Boolean,value:!1}}}render(){let e=e=>{this.headerFocused=e.type===`focus`,this._onDropdownOpenedChanged(e)};return a`
			<style>
				cosmoz-input[type='number'] {
					background: var(--cosmoz-omnitable-amount-input-background, #ffffff);
					border-radius: 6px;
			...
			${j(this.disabled,()=>a`
				...
				`,()=>a`
					<cosmoz-clear-button
						...
						?visible=${this.hasFilter()}
					></cosmoz-clear-button>
					${z({title:this.title,tooltip:this._tooltip,filterText:this._filterText,horizontalAlign:`right`,externalValues:this.externalValues,onOpenedChanged:e,content:a`
							<h3>${this.title}</h3>
							<cosmoz-input
								class=${this._fromClasses}
								type="number"
		...
		></cosmoz-omnitable-number-range-input>`}computeSource(e,t){return K(e,t)}},customElements.define(`cosmoz-omnitable-column-number`,Pr)})),Ir,Lr=e((()=>{w(),D(),i(),o(),A(),Yn(),jt(),R(),It(),Ir=class extends Jn(Ft(k)){render(){let e=e=>{this.headerFocused=e.type===`focus`};return a`
			${j(this.disabled,()=>a`
					<cosmoz-omnitable-dropdown-input
						disabled
						.label=${this.title}
...
>
	...
	/>
</svg> `})),ai,oi,si,ci,li=e((()=>{g(),Le(),ii(),ai=({column:e,on:t,descending:n,setOn:r,setDescending:i})=>{let{name:o,title:s}=e??{};return a`<button
		class="sg"
		title=${Ce(s)}
	...
	>
		<span>${s}</span> ${ri}
	</button>`},oi=({columns:e,...t})=>e?.map(e=>ai({column:e,...t})),si=()=>a`
...
`}));function ui(e,t,{suffix:n=``,read:r,write:i,ready:a=!0,multi:o}={}){let s=ut({param:t,suffix:n,link:o?mi:pi,write:i??Ye}),c=b(()=>{if(t==null)return!1;if(o){let e=Oe(t+n);return Object.keys(e).length>0}return je(t+n)!==void 0},[]),[l,d]=x(()=>{if(t==null)return e;if(o){let i=Oe(t+n,r);return Object.keys(i).length>0?i:e}return je(t+n,r)??e}),f=u(e=>d(t=>{let n=Ie(e,t);return s.param!=null&&Fe(s.link(s.param+s.suffix,n,s.write),null,{notify:!1}),n}),[]);return S(()=>{s.param==null||!a||c||e!=null&&f(e)},[a]),[l,f]}var di,fi,pi,mi,hi=e((()=>{Je(),Ue(),at(),rt(),g(),di=e=>(t,n,r=Ye)=>{let i=Ve(),a=new URLSearchParams(i.hash.replace(`#`,``));return e(t,n,r,a),`#!`+Object.assign(i,{hash:a}).href.replace(location.origin,``)},fi=e=>e==null||e===``,pi=di((e,t,n,r)=>fi(n(t))?r.delete(e):r.set(e,n(t))),mi=di((e,t,n,r)=>{let i=Object.entries(t),a=i.map(n).filter(([,e])=>e!==void 0);if(a.length===0&&i.length>0)return;let o=e;Array.from(r.keys()).filter(e=>e.startsWith(o)).forEach(e=>r.delete(e)),a.forEach(([t,n])=>fi(n)?r.delete(e+t):r.set(e+t,n))})})),gi,_i,vi,yi,bi,xi=e((()=>{g(),hi(),gi=e=>[!0,`true`,1,`yes`,`on`].includes(e),_i=e=>e===``||(e==null?void 0:gi(e)),vi=(e,t,n)=>u(r=>{e(r),n(e=>({...e,[t]:r}))},[e,t,n]),yi=(e,t,{settings:n,setSettings:r,resetRef:i,ready:a=!0})=>{let[o,s]=ui(n.sortOn,t,{suffix:`-sortOn`,ready:a}),[c,l]=ui(_i(n.descending),t,{suffix:`-descending`,read:_i,ready:a}),[d,f]=ui(n.groupOn,t,{suffix:`-groupOn`,ready:a}),[p,m]=ui(_i(n.groupOnDescending),t,{suffix:`-groupOnDescending`,read:_i,ready:a}),h=b(()=>e.find(e=>e.name===o),[e,o]),g=b(()=>e.find(e=>e.name===d),[e,d]),_={groupOn:d,setGroupOn:vi(f,`groupOn`,r),groupOnDescending:p,setGroupOnDescending:vi(m,`groupOnDescending`,r),sortOn:o,setSortOn:vi(s,`sortOn`,r),descending:c,setDescending:vi(l,`descending`,r),columns:e},v=b(()=>_,Object.values(_)),y=u(e=>{s(e.sortOn),f(e.groupOn),l(e.descending),m(e.groupOnDescending)},[]);return S(()=>void(i.current=y),[]),{...v,sortAndGroup:v,groupOnColumn:g,sortOnColumn:h}},bi=ae(),customElements.define(`sort-and-group-provider`,bi.Provider),customElements.define(`sort-and-group-consumer`,m(({render:e})=>e(he(bi)),{useShadowDOM:!1}))})),Si,Ci,wi=e((()=>{g(),ie(),$r(),li(),A(),xi(),Si=({data:e,columns:t,groupOnColumn:n,filters:r,setFilterState:i,sortAndGroup:{sortOn:o,setSortOn:s,descending:c,setDescending:l}={}})=>p(t,e=>e.name,t=>[a`<div
			...
			>
				...
				.column="${t}"
				name="${t.name}"
			></cosmoz-omnitable-resize-nub>`]),Ci=({columns:e,settingsConfig:t,hideSelectAll:n,...r})=>{let i=he(bi);return a`
		${j(e,e=>Si({columns:e,sortAndGroup:i,...r}))}
		${j(!n,()=>a` <cosmoz-omnitable-settings
					.config=${t}
					part="settings"
...
`,customElements.define(`cosmoz-omnitable-item-expand-line`,m(Ei,{styleSheets:[Xe(Ti)]}))})),Oi,ki=e((()=>{g(),o(),et(),Di(),Oi=({columns:e,item:t,selected:n,expanded:r,groupOnColumn:i})=>Ee(e,e=>a`<cosmoz-omnitable-item-expand-line
				.column=${e}
				?hidden=${e===i}
				exportparts="item-expand-label, item-expand-value"
				>${e.renderCell(e,{item:t,selected:n,expanded:r})}</cosmoz-omnitable-item-expand-line
			>`),customElements.define(`cosmoz-omnitable-item-expand`,m(Oi,{useShadowDOM:!1}))})),Ai,ji,Mi=e((()=>{g(),ie(),Ai=(e,t,n)=>e.editable?e.renderEditCell(e,t,n(e,t.item)):e.renderCell(e,t),ji=({columns:e,groupOnColumn:t,item:n,index:r,selected:i,expanded:o,onItemChange:s})=>p(e,e=>e.name,e=>a`<div
				...
				name="${e.name}"
			>
				${Ai(e,{item:n,index:r,selected:i,expanded:o},s)}
...
`);i.unshift(r),Ke(new File(i,n,{type:`text/csv;charset=utf-8`}))}})),zi,Bi,Vi=e((()=>{We(),Se(),zi=(e,t)=>{let n=e.map(e=>e.title),r=t.map(t=>e.map(e=>e.toXlsxValue(e,t)??``));return r.unshift(n),r},Bi=(e,t,n,r)=>{let i=zi(e,t),a=new Qe(n).addSheetFromData(i,r).generate();Ke(new File([a],n,{type:`application/vnd.openxmlformats-officedocument.spreadsheetml.sheet`}))}})),Hi,Q,Ui,Wi=e((()=>{Hi=Symbol(`index`),Q=Symbol(`All`),Ui=(e,t)=>{if(typeof e.findLastIndex==`function`)return e.findLastIndex(t);for(let n=e.length-1;n>=0;n--)if(t(e[n],n,e))return n;return-1}})),Gi,Ki=e((()=>{s(),i(),o(),Ri(),Vi(),Wi(),Gi=({columns:e,selectedItems:t,visibleData:n=[],saveAsCsv:i=Li,saveAsXlsx:o=Bi,setSelectedItems:s,csvFilename:c,xlsxFilename:l,xlsxSheetname:u,topPlacement:d,enableSelectAll:f,allSelected:p=!1,allItemsCount:m})=>{let h=t===Q,g=h?m??0:t.length,_;return _=h?m===void 0?r(`All items selected`):r(`All {count} items selected`,{count:m}):r(`{count} selected item`,{count:g}),a`<cosmoz-bottom-bar
	...
	>
		...
		<cosmoz-dropdown-menu part="extra" slot="extra" .placement=${d}>
			...
			<button
				@click=${()=>o(e,t===Q?n:t,l,u)}
			>
				${r(`Save selected items as XLSX`)}
			</button>
			<slot name="download-menu"></slot>
		</cosmoz-dropdown-menu>
	</cosmoz-bottom-bar>`}})),qi,Ji=e((()=>{o(),A(),qi=({allSelected:e,onAllCheckboxChange:t,sortAndGroup:n,dataIsValid:r,data:i,columns:o,filters:s,groupOnColumn:c,setFilterState:l,settingsConfig:u,hideSelectAll:d})=>a`<sort-and-group-provider .value=${n}>
		<div class="header" id="header" part="header">
			${j(!d,()=>a`<input
						...
						part="all"
					/>`)}
			${j(d,()=>a` <cosmoz-omnitable-settings
						.newLayout="${!0}"
						.config=${u}
					></cosmoz-omnitable-settings>`)}
...
`,Xi=({settingsConfig:e})=>{let{columns:t,collapsed:n}=e,r=t.filter(e=>!n.some(t=>t.name===e.name));return a`<div class="skeleton">
	...
	</div>`},customElements.define(`cosmoz-omnitable-skeleton`,m(Xi,{styleSheets:[Yi]}))})),Qi,$i=e((()=>{g(),Zi(),ve(),i(),o(),A(),Qi=(e,t)=>{let{settingsConfig:n}=e,{processedItems:i,dataIsValid:o,filterIsTooStrict:s,loading:c,displayEmptyGroups:l,compareItemsFn:u,selectedItems:d,setSelectedItems:f,renderItem:p,renderGroup:m,error:h}=t;return a`${j(!c&&!o&&!h,()=>a`<div class="tableContent-empty">
		...
		${j(s,()=>a`<div class="tableContent-empty">
					${ke({width:`96px`,height:`96px`,styles:`margin-right: 24px; fill: currentColor;`})}
					<div>
		...
		${j(c&&!i.length,()=>a`<div class="tableContent-empty overlay">
					<cosmoz-omnitable-skeleton
						.settingsConfig=${n}
					></cosmoz-omnitable-skeleton>
				</div>`)}
		${j(c&&i.length,()=>a`<div class="tableContent-empty overlay spinner">
					<cz-spinner></cz-spinner>
				</div>`)}
		${j(h,()=>a`<div class="tableContent-empty overlay">
...
`})),ra,ia,aa=e((()=>{at(),g(),ra=e=>{let t=parseInt(e,10);return isFinite(t)?t:void 0},ia=e=>{let{config:t}=e,{settings:n,setSettings:r,collapsed:i,requestTween:a}=t,o=ut({collapsed:i,settings:n.columns,requestTween:a,setSettings:u(e=>r(t=>({...t,columns:e})),[r])});return{...t,onDown:u(e=>{e.target.closest(`.pull`)&&(o.handle=e.currentTarget)},[o]),onDragStart:u(e=>{let{target:t}=e,n=ra(t.dataset.index);if(!o.handle?.contains(t)||n==null)return e.preventDefault();o.handle=null,e.dataTransfer.effectAllowed=`move`,e.dataTransfer.setData(`omnitable/sort-index`,n),e.dataTransfer.setData(`text/plain`,n),setTimeout(()=>t.classList.add(`drag`),0),t.addEventListener(`dragend`,e=>e.target.classList.remove(`drag`),{once:!0})},[o]),onDragEnter:u(e=>{let t=e.currentTarget;t===e.target&&(e.preventDefault(),e.dataTransfer.dropEffect=`move`,t.classList.add(`dragover`))},[]),onDragOver:u(e=>{e.preventDefault(),e.currentTarget.classList.add(`dragover`)},[]),onDragLeave:u(e=>{let t=e.currentTarget;t.contains(e.relatedTarget)||t.classList.remove(`dragover`)},[]),onDrop:u(e=>{let t=ra(e.dataTransfer.getData(`omnitable/sort-index`)),n=ra(e.currentTarget.dataset.index),{settings:r,setSettings:i,requestTween:a}=o;e.currentTarget.classList.remove(`dragover`),e.preventDefault();let s=r.slice();s.splice(n+(t>=n?0:-1),0,s.splice(t,1)[0]),a?.(),i(s)},[o]),onToggle:u(e=>{let{settings:t,setSettings:n,requestTween:r}=o,i=t.map(e=>({...e,disabled:e.disabled||o.collapsed?.some(t=>t.name===e.name)})),a=ra(e.target.closest(`[data-index]`)?.dataset.index);i.splice(a,1,{...t[a],disabled:!e.target.checked,priority:e.target.checked?t.reduce((e,t)=>Math.max(e,t.priority),0)+1:t[a].priority}),r?.(),n(i)},[o])}}})),oa,sa,ca,la,ua=e((()=>{nt(),lt(),v(),s(),g(),i(),A(),ii(),li(),na(),aa(),oa=[f({apply({availableHeight:e,elements:t}){Object.assign(t.floating.style,{maxHeight:`${Math.max(0,e)}px`})}}),...Te],sa=({onDragStart:e,onDragEnter:t,onDragOver:n,onDragLeave:r,onDrop:i,onDown:o,onToggle:s,collapsed:c,filters:l})=>(u,d)=>{let f=!!c?.find(e=>e.name===u.name),p=!u.disabled&&!f;return a` <div
		...
		>
			...
			<input
				...
				.indeterminate=${f}
			/>
		</div>`},ca=e=>{let{settings:t,settingsId:n,onSave:i,onReset:o,hasChanges:s,opened:c,setOpened:l,...u}=ia(e);return a` <div class="headline">
			${r(`Sort and filter`)}
			<button
				class="close"
		...
		${j(n,()=>a`<div class="buttons">
				...
				</div>`)}`},customElements.define(`cosmoz-omnitable-settings-ui`,m(ca,{styleSheets:[Xe(ea)]})),la=({config:e,newLayout:t})=>a`
	<cosmoz-dropdown
		.placement="${t?`bottom-start`:`bottom-end`}"
		.middleware="${oa}"
	>
		<div title="${r(`Sort and filter`)}" slot="button">
			${j(t,()=>a`<div class="headerDots">...</div>`,()=>a` <svg viewBox="0 0 24 24" width="24" fill="currentColor">
						<circle cx="10" cy="18" r="2"></circle>
						<circle cx="10" cy="12" r="2"></circle>
						<circle cx="10" cy="6" r="2"></circle>
					</svg>`)}
			${j(e?.badge,()=>a`<div class="badge"></div>`)}
		</div>
		<cosmoz-omnitable-settings-ui
...
`,ro=e=>e?`groupRow groupRow-folded`:`groupRow`,io=({item:e,index:t})=>n=>j(n?.length>0,()=>a`
			...
			`),ao=({columns:e,collapsedColumns:t,miniColumns:n,onItemClick:r,onCheckboxChange:i,dataIsValid:o,groupOnColumn:s,onItemChange:c,rowPartFn:l})=>(u,d,{selected:f,expanded:p,toggleCollapse:m})=>a`
		<div
			?selected=${f}
	...
	`,oo=({onCheckboxChange:e,dataIsValid:t,groupOnColumn:n})=>(r,i,{selected:o,folded:s,toggleFold:c})=>a` <div
			class="${ro(s)}"
			part="groupRow groupRow-${r[Hi]}"
		>
			<input
				class="checkbox"
				type="checkbox"
