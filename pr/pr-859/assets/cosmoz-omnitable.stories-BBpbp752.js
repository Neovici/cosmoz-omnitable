import{b as d,D as ke,A as xt}from"./iframe-Bq-sHemm.js";import{t as K,c as O,g as S,P as E,u as T,a as yt,m as vt,s as Bt,D as Ht,b as Gt,e as Wt,i as $e,h as Oe,d as jt,f as $t,r as Ut,j as Kt,k as q,l as Jt,n as Ce,p as he,o as k,q as Xt,v as we,w as Qt,x as Yt,y as Zt,T as ei,z as M,A as Ye,B as ti,C as ii,E as ai,F as C,G as ni,H as oi,I as Ct,J as Le,K as F,L as wt,M as De,N as ri,O as St,Q as li,R as Te,S as Ze,U as si,V as Ve,W as ui,X as ci,Y as Ie,Z as Re,_ as di,$ as Ee,a0 as N,a1 as mi,a2 as ze,a3 as pi}from"./cosmoz-collapse-D69mIS5Z.js";import"./preload-helper-PPVm8Dsz.js";const gi=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,Di=i=>{const{label:e,value:t,slot:a}=i,n=d`<div
		id="input"
		part="input"
		role="button"
		class="control"
	...
	>
		${t||""}
	</div>`;return Ut(n,{label:e})};customElements.define("cosmoz-omnitable-dropdown-input",O(Di,{observedAttributes:Oi,styleSheets:[Li]}));const ne=({title:i,tooltip:e="",filterText:t="",onOpenedChanged:a,content:n,horizontalAlign:o="left",externalValues:r=null})=>{const l={filtered:!!t,...r!=null&&{[`external-values-${r}`]:!0}};return d`
		<style>
			.dropdown {
				outline: none;
			}
	...
	`};class Ti extends Ne(ae(E)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return d`
			<style>
		...
		></cosmoz-omnitable-amount-range-input>`}computeSource(e,t){return ie(e,t)}}customElements.define("cosmoz-omnitable-column-amount",ji);const Ui=(i,e)=>{if(!Array.isArray(i))return;const t=[];return i.reduce((a,n)=>Array.isArray(n)?(n.forEach(o=>{a.push(o)}),a):(a.push(n),a),[]).filter((a,n,o)=>{if(o.indexOf(a)!==n)return!1;if(e){const r=S(a,e);if(t.indexOf(r)!==-1)return!1;t.push(r)}return!0})},Ki=(i,e,t)=>{if(i==null)return[];if(Array.isArray(i))return Ui(i,e);if(typeof i=="object"){const a=e??"id",n=t??"label";return Object.entries(i).map(([o,r])=>({[a]:o,[n]:r})).sort((o,r)=>o[n]<r[n]?-1:o[n]>r[n]?1:0)}return[]},Pe=(i,e,t)=>Ce(e&&S(i,e)).map(he(t)),Be=({valuePath:i,textProperty:e},t)=>Pe(t,i,e).filter(a=>a!=null).join(", "),Ji=Be,Xi=({valueProperty:i,valuePath:e,emptyValue:t,emptyProperty:a},n)=>o=>{const r=he(i),l=Ce(S(o,e));return n.some(u=>l.length===0&&he(a||i)(u)===t||l.some(s=>r(s)===r(u)))},He=i=>e=>i(t=>({...t,filter:e})),Ge=i=>e=>i(t=>({...t,headerFocused:e})),We=i=>e=>i(t=>({...t,query:e})),Ft=({emptyValue:i,emptyLabel:e,emptyProperty:t,textProperty:a,valueProperty:n},o)=>{const r=Ki(o,n,a);return!e||i===void 0||!a||!(t||n)||!r?r:[{[a]:e,[t||n]:i},...r]},Qi=(i,e)=>Ft(i,zt(e,i.valuePath)),je=i=>class extends i{static get properties(){return{textProperty:{type:String},valueProperty:{type:String},emptyLabel:{type:String},emptyValue:{type:Object},emptyProperty:{type:String}}}getConfig(e){return{emptyProperty:e.emptyProperty}}getString(e,t){return Be(e,t)}toXlsxValue(e,t){return Ji(e,t)}getComparableValue({valuePath:e,valueProperty:t},a){const n=S(a,e);return t==null?n:Ce(n).reduce((r,l)=>(r.push(S(l,t)),r),[]).sort().join(" ")}getFilterFn(e,t){if(!(!t||!Array.isArray(t)||t.length===0))return Xi(e,t)}serializeFilter(e,t){return t.length===0?null:JSON.stringify(t)}deserializeFilter(e,t){return JSON.parse(decodeURIComponent(t))}computeSource(e,t){return e.externalValues||typeof e.values=="function"?async(...a)=>Ft(e,await Promise.resolve($e(e.values,...a))):Qi(e,t)}},Yi=({valuePath:i,textProperty:e,valueProperty:t},a)=>{const n=e?Xt(e):he(t),o=Ce(i&&S(a,i)).map(n);return o.length>1?o.filter(Boolean).join(","):o[0]};class Zi extends je(V(E)){static get properties(){return{headerCellClass:{type:String,value:"autocomplete-header-cell"},minWidth:{type:String,value:"55px"},editMinWidth:{type:String,value:"55px"},keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},showSingle:{type:Boolean},preserveOrder:{type:Boolean},limit:{type:Number},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,showSingle:e.showSingle,preserveOrder:e.preserveOrder,limit:e.limit,textual:e.textual}}renderCell(e,{item:t}){return d`<span class="default-column"
		...
		>`}getComparableValue(e,t){return Yi(e,t)}}customElements.define("cosmoz-omnitable-column-autocomplete",Zi);const Ue=(i,e)=>e.find(({value:t})=>i===t),ea=(i,e,t)=>{const a=Ue(e,t);return a?a.text:i},ot=(i,e,t,a)=>ea(i,S(e,t),a),ta=({valuePath:i},e,t)=>Ue(S(e,i),t),ia=i=>e=>{i(t=>({...t,filter:e?.[0]?.value??null}))},aa=i=>e=>{i(t=>({...t,headerFocused:e}))},na=i=>e=>{i(t=>({...t,query:e}))},oa=i=>e=>i(e?.[0]?.value),rt=({valuePath:i,trueLabel:e,falseLabel:t},a)=>S(a,i)?e:t,ra=({valuePath:i},e)=>t=>S(t,i)===e,le=vt((i,e)=>[{text:i,value:!0},{text:e,value:!1}]),la=({valuePath:i,trueLabel:e,falseLabel:t},a)=>i?S(a,i)?e:t:"",sa=(i,e)=>{try{return JSON.parse(e)}catch{return null}};class ua extends V(E){static get properties(){return{trueLabel:{type:String,value:"True"},falseLabel:{type:String,value:"False"},flex:{type:String,value:"0"},cellClass:{type:String,value:"boolean-cell"}}}getString(e,t){return rt(e,t)}renderCell(e,{item:t}){return rt(e,t)}renderEditCell(e,{item:t},a){const{trueLabel:n,falseLabel:o}=e;return d`<cosmoz-autocomplete
			no-label-float
		...
		>`}computeSource({trueLabel:e,falseLabel:t}){return le(e,t)}getFilterFn(e,t){if(t!=null)return ra(e,t)}toXlsxValue(e,t){return la(e,t)}deserializeFilter(e,t){return sa(e,t)}}customElements.define("cosmoz-omnitable-column-boolean",ua);const Ke=i=>class extends Ne(i){static get properties(){return{max:{type:Date,value:null},min:{type:Date,value:null},_filterText:{type:String,computed:"_computeFilterText(filter.*, formatter)"},formatter:{type:Object,computed:"_computeFormatter(locale)"}}}toDate(e,t,a){if(e==null||e==="")return;let n=e;if(n instanceof Date||(typeof e=="string"&&(n=this.getAbsoluteISOString(n)),n=new Date(n)),Number.isNaN(n.getTime()))return null;if(a==null||t==null)return n;const o=this.toDate(t);if(o==null)return n;const r=this.getComparableValue(n),l=this.getComparableValue(o);return a(r,l)===r?n:o}toValue(){return this.toDate.apply(this,arguments)}getComparableValue(e,t){const a=super.getComparableValue(e,t);if(a!=null)return this.toNumber(a.getTime())}getString(e,t=this.valuePath,a=this.formatter){const n=this.toValue(this.get(t,e));return n===void 0?"":n===null?"Invalid Date":this.renderValue(n,a)}getAbsoluteISOString(e){return e.length===19?e+this._getTimezoneString(e):e}_getTimezoneString(e){const t=-new Date(e).getTimezoneOffset()/60;return(t<0?"-":"+")+["0",Math.abs(t)].join("").substr(-2)+":00"}renderValue(e,t=this.formatter){if(t==null)return;const a=this.toValue(e);if(a!=null)return t.format(a)}_computeFormatter(e){return new Intl.DateTimeFormat(e||void 0)}_toInputString(e){const t=this.toValue(e);return t==null?null:this._toLocalISOString(t).slice(0,10)}_dateValueChanged(e){const t=e.currentTarget,a=t.value,n=e.model.item,o=this.get(this.valuePath,n),r=this._fromInputString(a);this.set(this.valuePath,r,n),this._fireItemChangeEvent(n,this.valuePath,o,this.renderValue.bind(this))}_toLocalISOString(e){return we(e)}};class ca extends Ke(ae(E)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return d`
			...
			${ne({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:d`
					...
					></cosmoz-input>
				`})}
		`}_fromInputString(e,t){const a=this.toDate(e);if(a!=null)return t==="min"&&a.setHours(0,0,0,0),t==="max"&&a.setHours(23,59,59),a}_filterInputChanged(e,t){const a=e.path.split(".")[1],n=a&&e.value;if(n&&n.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}}customElements.define("cosmoz-omnitable-date-range-input",ca);const da=i=>{const e=-new Date(i).getTimezoneOffset()/60;return(e<0?"-":"+")+["0",Math.abs(e)].join("").substr(-2)+":00"},Je=i=>i.length===19?i+da(i):i,_t=i=>{if(i==null||i==="")return;let e=i;return!(e instanceof Date)&&(typeof i=="string"&&(e=Je(e)),e=Qt(e),!e)||Number.isNaN(e.getTime())?null:e},R=({valuePath:i},e)=>{if(e==null)return;let t=e;i!=null&&(t=S(e,i));const a=_t(t);if(a!=null)return L(a.getTime())},I=(i,e,t)=>{const a=_t(i);return a??null},Xe=(i,e)=>{if(e==null)return;const t=I(i);if(t!=null)return e.format(t)},se={},ma=i=>{const e=i||"";return se[e]||(se[e]=new Intl.DateTimeFormat(i||void 0)),se[e]},lt=({valuePath:i,locale:e},t)=>{let a=S(t,i||"");return a===void 0?"":(a=I(a),a===null?"Invalid Date":Xe(a,ma(e)))},kt=i=>{const e=I(i);if(e==null)return null;const t=we(e);return t==null?null:t.slice(0,10)},pa=({valuePath:i},e)=>kt(S(e,i||"")),It=(i,e)=>{const t=I(i);if(t!=null)return t},st=i=>{const e=kt(i);return e??""},ga=({valuePath:i},e)=>{if(!i)return"";const t=I(S(e,i));if(!t)return"";const a=I(we(t));return a?(a.setHours(0,0,0,0),a):""},Et=(i,e)=>t=>{const a=R(i,t);if(a==null)return!1;const n=R({...i,valuePath:"min"},e),o=R({...i,valuePath:"max"},e);return!(a<(n??-1/0)||a>(o??1/0))};class ba extends V(E){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"date-header-cell"},width:{type:String,value:"100px"},minWidth:{type:String,value:"82px"},flex:{type:String,value:"0"}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const a=R({...e,valuePath:"min"},t),n=R({...e,valuePath:"max"},t);if(!(a==null&&n==null))return Et(e,t)}getString(e,t){return lt(e,t)}toXlsxValue(e,t){return ga(e,t)}getComparableValue(e,t){return R(e,t)}serializeFilter(e,t){if(t==null)return;const a=I(t.min),n=I(t.max);if(!(a==null&&n==null))return st(a)+"~"+st(n)}deserializeFilter(e,t){if(t==null||t==="")return null;const a=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(a)?{min:I(a[1]),max:I(a[2])}:null}renderCell(e,{item:t}){return d`<div class="omnitable-cell-date">
			${lt(e,t)}
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return ie(e,t)}}customElements.define("cosmoz-omnitable-column-date",ba);class fa extends je(V(E)){renderCell({valuePath:e,textProperty:t},{item:a}){const n=Pe(a,e,t).map(o=>d`<li>${o}</li>`);return d`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		`}renderEditCell(){return"not implemented"}renderHeader(e,{filter:t,query:a},n,o){return d`<cosmoz-autocomplete-ui
			...
			.onText=${We(n)}
			>${k(e.loading,()=>d`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}}customElements.define("cosmoz-omnitable-column-list-horizontal",fa);window.Cosmoz=window.Cosmoz||{};class ut extends Yt(Zt(ei,E)){static get template(){return Oe`
			<style>
				:host {
					display: block;
				}
		...
		`}static get is(){return"cosmoz-omnitable-column-list-data"}static get properties(){return{items:{type:Array},_expanded:{type:Boolean,value:!1},_othersCount:{type:Number,computed:"_computeOthersCount(items)"}}}static get observers(){return["_itemsLengthChanged(items.length)"]}_itemsLengthChanged(){requestAnimationFrame(()=>this.dispatchEvent(new CustomEvent("expand",{bubbles:!0})))}_firstItem(e){if(e!=null&&e.length>0)return e[0]}_hideExpand(e,t){return e!==void 0&&e.length!==null?e.length<=2||t:!0}_hideCollapse(e,t){return e!==void 0&&e.length!==null?e.length<=2||!t:!0}_otherItems(e,t){if(e!=null&&(e.length<=2||t))return e.slice(1)}_computeOthersCount(e){if(e!=null)return e.length-1}_toggleExpand(e){this._expanded=!this._expanded,e.stopPropagation(),e.preventDefault()}}customElements.define(ut.is,ut);class ha extends je(V(E)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:a}){return d`<cosmoz-omnitable-column-list-data
			.items=${Pe(a,e,t)}
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:a},n,o){return d`<cosmoz-autocomplete-ui
			...
			.onText=${We(n)}
			>${k(e.loading,()=>d`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}}customElements.define("cosmoz-omnitable-column-list",ha);class xa extends Ne(ae(E)){static get properties(){return{maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null},formatter:{type:Object,computed:"_computeFormatter(locale, minimumFractionDigits, maximumFractionDigits)"},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, formatter)"},headerFocused:{type:Boolean,value:!1}}}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return d`
			<style>
				cosmoz-input[type='number'] {
					background: var(--cosmoz-omnitable-amount-input-background, #ffffff);
					border-radius: 6px;
		...
		></cosmoz-omnitable-number-range-input>`}computeSource(e,t){return ie(e,t)}}customElements.define("cosmoz-omnitable-column-number",ya);const Mt="1970-01-01",B=(i,e,t)=>{const a=typeof i=="string"&&i.length>3&&i.length<=9?Je(Mt+"T"+i):i;return I(a)},ue={},va=i=>{const e=i||"";if(ue[e])return ue[e];const t={hour:"numeric",minute:"numeric",second:"numeric"};return ue[e]=new Intl.DateTimeFormat(i||void 0,t),ue[e]},fe=({valuePath:i,locale:e},t)=>{const a=B(S(t,i||""));return a===void 0?"":a===null?"Invalid Date":Xe(a,va(e))},$a=(i,e)=>i.valuePath?fe(i,e):"",Ca=i=>{const e=B(i);if(e==null)return null;const t=we(e);return t&&t.slice(11,19)},j=({valuePath:i},e)=>{if(e==null)return;const t=Ca(i==null?e:S(e,i));if(t==null)return;const a=B(Je(Mt+"T"+t));return a==null?a:L(a.getTime())},wa=(i,e)=>t=>{const a=j(i,t);if(a==null)return!1;const n=j({...i,valuePath:"min"},e),o=j({...i,valuePath:"max"},e);return n==null||o==null?!1:!(a<n||a>o)},ct=i=>{const e=B(i);return e==null?"":e.toISOString().slice(11,19).replace(/:/gu,".")},dt=i=>{if(!(i==null||i===""))return B(typeof i=="string"?i.replace(/\./gu,":")+"Z":i)};class Sa extends Ke(ae(E)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return d`
			<cosmoz-clear-button
				@click=${()=>this.resetFilter()}
				?visible=${this.hasFilter()}
			></cosmoz-clear-button>
		...
		></cosmoz-input>`}renderHeader({title:e,min:t,max:a,locale:n,filterStep:o},{filter:r},l,u){return d`<cosmoz-omnitable-time-range-input
			...
			@filter-changed=${({detail:{value:s}})=>l(c=>({...c,filter:s}))}
			@header-focused-changed=${({detail:{value:s}})=>l(c=>({...c,headerFocused:s}))}
		></cosmoz-omnitable-time-range-input>`}computeSource(e,t){return ie(e,t)}}customElements.define("cosmoz-omnitable-column-time",za);const ce={},qa=i=>{const e=i||"";if(ce[e])return ce[e];const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return ce[e]=new Intl.DateTimeFormat(i||void 0,t),ce[e]},qe=({valuePath:i,locale:e},t)=>{const a=I(S(t,i||""));return a===void 0?"":a===null?"Invalid Date":Xe(a,qa(e))},Aa=({valuePath:i},e)=>i?S(e,i):"",mt=i=>{const e=I(i);return e==null?"":e.toISOString().slice(0,19).replace(/:/gu,".")},pt=i=>{if(!(i==null||i==="")&&typeof i=="string")return I(i.replace(/\./gu,":")+"Z")};class Fa extends Ke(ae(E)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return d`
			<style>
			...
			${ne({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:d`
					...
					></cosmoz-datetime-input>
				`})}
		`}_toInputString(e){const t=this.toValue(e);if(t!=null)return this._toLocalISOString(t).slice(0,19)}_computeFormatter(e){const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return new Intl.DateTimeFormat(e||void 0,t)}}customElements.define("cosmoz-omnitable-datetime-range-input",Fa);class gt extends V(E){static get is(){return"cosmoz-omnitable-column-datetime"}static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"datetime-header-cell"},width:{type:String,value:"210px"},minWidth:{type:String,value:"128px"},flex:{type:String,value:"0"},filterStep:{type:Number,value:1}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const a=R({...e,valuePath:"min"},t),n=R({...e,valuePath:"max"},t);if(!(a==null&&n==null))return Et(e,t)}getString(e,t){return qe(e,t)}toXlsxValue(e,t){return Aa(e,t)}getComparableValue(e,t){return R(e,t)}serializeFilter(e,t){if(t==null)return;const a=I(t.min),n=I(t.max);if(!(a==null&&n==null))return mt(a)+"~"+mt(n)}deserializeFilter(e,t){if(t==null||t==="")return null;const a=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(a)?{min:pt(a[1]),max:pt(a[2])}:null}renderCell(e,{item:t}){return qe(e,t)}renderEditCell(e,{item:t},a){return d`<cosmoz-input
			no-label-float
			type="text"
			@change=${o=>a(It(o.target.value))}
			.value=${qe(e,t)}
...
>
	...
	>
		<span>${r}</span> ${Ma}
	</button>`},Lt=({columns:i,...e})=>i?.map(t=>Ot({column:t,...e})),Oa=()=>d`
...
`,Dt=i=>(e,t,a=ti)=>{const n=oi(),o=new URLSearchParams(n.hash.replace("#",""));return i(e,t,a,o),"#!"+Object.assign(n,{hash:o}).href.replace(location.origin,"")},Tt=i=>i==null||i==="",Da=Dt((i,e,t,a)=>Tt(t(e))?a.delete(i):a.set(i,t(e))),Ta=Dt((i,e,t,a)=>Object.entries(e).map(t).forEach(([n,o])=>Tt(o)?a.delete(i+n):a.set(i+n,o))),J=(i,e,{suffix:t="",read:a,write:n,multi:o}={})=>{const[r,l]=o?[Ta,ii]:[Da,ai],[u,s]=T(()=>e==null?i:l(e+t,a)??i),c=C(m=>s(b=>{const p=$e(m,b);return e!=null&&ni(r(e+t,p,n),null,{notify:!1}),p}),[e,t,r,n]);return[u,c]},Va=i=>[!0,"true",1,"yes","on"].includes(i),de=i=>i===""||(i==null?void 0:Va(i)),me=(i,e,t)=>C(a=>{i(a),t(n=>({...n,[e]:a}))},[i,e,t]),Ra=(i,e,t,a,n)=>{const[o,r]=J(t.sortOn,e,{suffix:"-sortOn"}),[l,u]=J(de(t.descending),e,{suffix:"-descending",read:de}),[s,c]=J(t.groupOn,e,{suffix:"-groupOn"}),[m,b]=J(de(t.groupOnDescending),e,{suffix:"-groupOnDescending",read:de}),p=F(()=>i.find(g=>g.name===o),[i,o]),v=F(()=>i.find(g=>g.name===s),[i,s]),h={groupOn:s,setGroupOn:me(c,"groupOn",a),groupOnDescending:m,setGroupOnDescending:me(b,"groupOnDescending",a),sortOn:o,setSortOn:me(r,"sortOn",a),descending:l,setDescending:me(u,"descending",a),columns:i},$=F(()=>h,Object.values(h)),_=C(g=>{r(g.sortOn),c(g.groupOn),u(g.descending),b(g.groupOnDescending)},[]);return M(()=>void(n.current=_),[]),{...$,sortAndGroup:$,groupOnColumn:v,sortOnColumn:p}},Qe=Ct();customElements.define("sort-and-group-provider",Qe.Provider);customElements.define("sort-and-group-consumer",O(({render:i})=>i(Le(Qe)),{useShadowDOM:!1}));const Na=({data:i,columns:e,groupOnColumn:t,filters:a,setFilterState:n,sortAndGroup:{sortOn:o,setSortOn:r,descending:l,setDescending:u}={}})=>wt(e,s=>s.name,s=>[d`<div
			...
			>
				...
				.column="${s}"
				name="${s.name}"
			></cosmoz-omnitable-resize-nub>`]),Pa=({columns:i,settingsConfig:e,hideSelectAll:t,...a})=>{const n=Le(Qe);return d`
		${k(i,o=>Na({columns:o,sortAndGroup:n,...a}))}
		${k(!t,()=>d` <cosmoz-omnitable-settings
					.config=${e}
					part="settings"
				></cosmoz-omnitable-settings>`)}
	`};customElements.define("cosmoz-omnitable-header-row",O(Pa,{useShadowDOM:!1}));const Ba=K`
	:host {
		display: flex;
		align-items: center;
		flex-wrap: wrap;
...
`;customElements.define("cosmoz-omnitable-item-expand-line",O(Ha,{styleSheets:[De(Ba)]}));const Ga=({columns:i,item:e,selected:t,expanded:a,groupOnColumn:n})=>ri(i,o=>d`<cosmoz-omnitable-item-expand-line
				.column=${o}
				?hidden=${o===n}
				exportparts="item-expand-label, item-expand-value"
				>${o.renderCell(o,{item:e,selected:t,expanded:a})}</cosmoz-omnitable-item-expand-line
			>`);customElements.define("cosmoz-omnitable-item-expand",O(Ga,{useShadowDOM:!1}));const Wa=(i,e,t)=>i.editable?i.renderEditCell(i,e,t(i,e.item)):i.renderCell(i,e),ja=({columns:i,groupOnColumn:e,item:t,index:a,selected:n,expanded:o,onItemChange:r})=>wt(i,l=>l.name,l=>d`<div
...
`,bt=i=>{const e=i.replace(/"/gu,'""');return e.search(/("|,|\n)/gu)>=0?'"'+e+'"':i},Ka=(i,e,t)=>{const o=i.map(l=>bt(l.title)).join(";")+`
`,r=e.map(l=>i.map(u=>{const s=u.getString(u,l);return s==null?"":bt(String(s))}).join(";")+`
`);r.unshift(o),St(new File(r,t,{type:"text/csv;charset=utf-8"}))},Ja=(i,e)=>{const t=i.map(n=>n.title),a=e.map(n=>i.map(o=>{const r=o.toXlsxValue(o,n);return r??""}));return a.unshift(t),a},Xa=(i,e,t,a)=>{const n=Ja(i,e),o=new li(t).addSheetFromData(n,a).generate();St(new File([o],t,{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}))},Qa=({columns:i,selectedItems:e,csvFilename:t,xlsxFilename:a,xlsxSheetname:n,topPlacement:o})=>d`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!Te(e.length)}
		part="bottomBar"
	...
	</cosmoz-bottom-bar>`,Ya=({allSelected:i,onAllCheckboxChange:e,sortAndGroup:t,dataIsValid:a,data:n,columns:o,filters:r,groupOnColumn:l,setFilterState:u,settingsConfig:s,hideSelectAll:c})=>d`<sort-and-group-provider .value=${t}>
...
`,en=({settingsConfig:i})=>{const{columns:e,collapsed:t}=i,a=e.filter(n=>!t.some(o=>o.name===n.name));return d`<div class="skeleton">
	...
	</div>`};customElements.define("cosmoz-omnitable-skeleton",O(en,{styleSheets:[Za]}));const tn=(i,e)=>{const{settingsConfig:t}=i,{processedItems:a,dataIsValid:n,filterIsTooStrict:o,loading:r,displayEmptyGroups:l,compareItemsFn:u,setSelectedItems:s,renderItem:c,renderGroup:m,error:b}=e;return d`${k(!r&&!n&&!b,()=>d`<div class="tableContent-empty">
...
`,pe=i=>{const e=parseInt(i,10);return isFinite(e)?e:void 0},on=i=>{const{config:e}=i,{settings:t,setSettings:a,collapsed:n}=e,o=Ve({collapsed:n,settings:t.columns,setSettings:C(r=>a(l=>({...l,columns:r})),[a])});return{...e,onDown:C(r=>{r.target.closest(".pull")&&(o.handle=r.currentTarget)},[o]),onDragStart:C(r=>{const{target:l}=r,u=pe(l.dataset.index);if(!o.handle?.contains(l)||u==null)return r.preventDefault();o.handle=null,r.dataTransfer.effectAllowed="move",r.dataTransfer.setData("omnitable/sort-index",u),r.dataTransfer.setData("text/plain",u),setTimeout(()=>l.classList.add("drag"),0),l.addEventListener("dragend",s=>s.target.classList.remove("drag"),{once:!0})},[o]),onDragEnter:C(r=>{const l=r.currentTarget;l===r.target&&(r.preventDefault(),r.dataTransfer.dropEffect="move",l.classList.add("dragover"))},[]),onDragOver:C(r=>{r.preventDefault(),r.currentTarget.classList.add("dragover")},[]),onDragLeave:C(r=>{const l=r.currentTarget;l.contains(r.relatedTarget)||l.classList.remove("dragover")},[]),onDrop:C(r=>{const l=pe(r.dataTransfer.getData("omnitable/sort-index")),u=pe(r.currentTarget.dataset.index),{settings:s,setSettings:c}=o;r.currentTarget.classList.remove("dragover"),r.preventDefault();const m=s.slice();m.splice(u+(l>=u?0:-1),0,m.splice(l,1)[0]),c(m)},[o]),onToggle:C(r=>{const{settings:l,setSettings:u}=o,s=l.map(m=>({...m,disabled:m.disabled||o.collapsed?.some(b=>b.name===m.name)})),c=pe(r.target.closest("[data-index]")?.dataset.index);s.splice(c,1,{...l[c],disabled:!r.target.checked,priority:r.target.checked?l.reduce((m,b)=>Math.max(m,b.priority),0)+1:l[c].priority}),u(s)},[o])}},rn=[ui({apply({availableHeight:i,elements:e}){Object.assign(e.floating.style,{maxHeight:`${Math.max(0,i)}px`})}}),...ci],ln=({onDragStart:i,onDragEnter:e,onDragOver:t,onDragLeave:a,onDrop:n,onDown:o,onToggle:r,collapsed:l,filters:u})=>(s,c)=>{const m=!!l?.find(p=>p.name===s.name),b=!s.disabled&&!m;return d` <div
			class="item"
			data-index=${c}
			@mousedown=${o}
			draggable="true"
		...
		>
			...
			<input
				...
				.indeterminate=${m}
			/>
		</div>`},sn=i=>{const{settings:e,settingsId:t,onSave:a,onReset:n,hasChanges:o,opened:r,setOpened:l,...u}=on(i);return d` <div class="headline">
			${q("Sort and filter")}
			<button
				class="close"
		...
		<div class="contents">
			...
			>
				<div class="list">${e.columns?.map(ln(u))}</div>
			</cosmoz-collapse>
			...
			<cosmoz-collapse ?opened=${r.sort}> ${La()} </cosmoz-collapse>
		...
		${k(t,()=>d`<div class="buttons">
				...
				</div>`)}`};customElements.define("cosmoz-omnitable-settings-ui",O(sn,{styleSheets:[De(an)]}));const un=({config:i,newLayout:e})=>d`
	<cosmoz-dropdown
...
`;customElements.define("cosmoz-omnitable-settings",O(un,{styleSheets:[De(nn)]}));const xe=["sortOn","descending","groupOn","groupOnDescending"],ge=i=>e=>typeof e=="object"&&e!==null&&"name"in e&&e.name===i,cn=(i=[],e=[],t=[])=>{const a=e.filter(r=>i.some(ge(r.name))),n=i.filter(r=>r.name!=null&&!e.some(ge(r.name))&&!t.some(ge(r.name))),o=t.filter(r=>!e.some(ge(r.name)));return[...a,...o.flatMap(r=>{const l=i.find(u=>u.name===r.name);return l?{...r,title:l.title??r.title??"",minWidth:parseInt(l.minWidth??"0",10)}:[]}),...n.map(r=>{const{name:l,title:u,priority:s,minWidth:c,width:m,flex:b}=r;return{name:l??"",title:u??"",priority:s??0,minWidth:parseInt(c??"0",10),width:parseInt(m??"0",10),flex:parseInt(b??"0",10)}})]},dn=(i,e)=>({...e,...Ie(Array.from(xe))(i),columns:i.columns?.map(Ie(["name","priority","width","flex","disabled"]))}),mn=({columns:i,settings:e,savedSettings:t,initial:a})=>({...Object.fromEntries(xe.flatMap(o=>a?.[o]!=null?[[o,a[o]]]:[])),...t?Ie(Array.from(xe))(t):{},...e,columns:cn(i,e?.columns,t?.columns)}),pn=({prefix:i="omnitable-"}={})=>({write:async(t,a)=>{const n=i+t;try{a?localStorage.setItem(n,JSON.stringify(a)):localStorage.removeItem(n)}catch(o){console.error(o)}},read:async t=>{if(t)try{const a=localStorage.getItem(i+t);return a==null?void 0:JSON.parse(a)}catch(a){console.error(a)}}}),gn=Ct(pn),bn=()=>{const i=Le(gn);return F(()=>i(),[i])},fn=(i,e,t,a)=>{const[n,o]=T(),{read:r,write:l}=bn();return M(async()=>{i&&o(await r(i))},[i,r]),{settingsId:i,savedSettings:n,onSave:C(async()=>{if(!i)return;const u=dn(e,n);await l(i,u),t(),o(u)},[e,n]),onReset:C(async u=>{t(),u.shiftKey&&(await l(i),o()),a?.()},[a]),hasChanges:e!=null}},hn=({settingsId:i,host:e})=>{const t=F(()=>Object.fromEntries(xe.map(h=>[h,e[h]])),[]),a=Re(),n=C(()=>{a.current?.(t)},[t]),[o,r]=T(),[l,u]=T({columns:!0,sort:!0}),{savedSettings:s,...c}=fn(i,o,r,n),{enabledColumns:m}=e,b=Ei(e,{enabledColumns:m}),p=F(()=>mn({columns:b,settings:o,savedSettings:s,initial:t}),[b,o,s]),v=F(()=>p.columns.map(h=>b.find($=>$.name===h.name)).filter(Boolean),[b,...p.columns.map(h=>h.name)]);return{...c,opened:l,setOpened:u,settings:p,columns:v,setSettings:r,resetRef:a}},ft=i=>Number.isFinite(i)?i:0,xn=(i,e)=>{const t=[];let[a,n]=i.reduce(([c,m],{width:b,flex:p})=>[c+b,m+p],[0,0]),o=e-a,r=ft(o/n),l=0,u=0,s=0;for(let c=0;c<i.length;c++){const{width:m,minWidth:b,flex:p}=i[c],v=o>=0?r*p:m*o/a;if(b>m+v){l+=m,u+=b,s+=p,t[c]=b;continue}if(p===0){l+=m,u+=m,t[c]=m;continue}}a-=l,o=e-u-a,n-=s,r=ft(o/n);for(let c=0;c<i.length;c++){if(t[c]!=null)continue;const{width:m,flex:b}=i[c],p=o>=0?r*b:m*o/a;t[c]=m+p}return t},ye=Symbol("index"),yn=(i,e)=>{if(typeof i.findLastIndex=="function")return i.findLastIndex(e);for(let t=i.length-1;t>=0;t--)if(e(i[t],t,i))return t;return-1},vn=(i,e)=>{const t=yn(i,r=>r!=null&&r>0),a=(r,l)=>`.cell[name="${r}"], cosmoz-omnitable-skeleton::part(cell-${r}){width: ${Math.floor(l)}px;padding: 0 min(3px, ${l/2}px)}`,n=r=>`cosmoz-omnitable-resize-nub[name="${r}"]{display:none}`,o=r=>`cosmoz-omnitable-resize-nub[name="${r}"], .cell[name="${r}"]{display:none}`;return e.map((r,l)=>{const u=i[l];if(u==null||u===0)return o(r.name);const s=a(r.name,u);return l===t?`${s}
${n(r.name)}`:s}).join(`
`)},Rt=(i,e,t)=>{const a=i.filter(l=>!l.hidden),n=a.reduce((l,{width:u})=>l+u,0);if(a.length>1&&n>e)return Rt(a.slice(1),e,t);const o=a.reduce(([l,u],s,c)=>[Math.max(l,s.index),s.index>l?c:u],[-1,-1])[1];return o!==-1&&(a[o].flex=1),xn(a,e).reduce((l,u,s)=>(l[a[s].index]=u,l),new Array(t).fill(void 0))},$n=(i,e)=>i.length===0?".cell {display: none;}":vn(i,e),Cn=({host:i,canvasWidth:e,layout:t,setSettings:a})=>{const n=Re();n.current=o=>a(r=>{const l=r.columns,{detail:{newWidth:u,column:s}}=o,c=l.findIndex(p=>p.name===s.name),m=[],b=l.reduce((p,v)=>Math.max(p,v.priority),-1/0);for(let p=0;p<t.length;p++)if(m[p]={...l[p]},p<c&&t[p]&&(m[p].width=t[p],m[p].flex=0,m[p].priority=b),p===c){const v=t.reduce((h,$,_)=>_<c&&$?h-$:h,e);m[p].width=Math.min(v,Math.max(u,l[p].minWidth)),m[p].flex=0,m[p].priority=b}return{...r,columns:m}}),M(()=>{const o=r=>n.current?.(r);return i.addEventListener("column-resize",o),()=>i.removeEventListener("column-resize",o)},[])},wn=20,Sn=44,zn=24,Nt=wn+Sn+zn,qn=(i,e)=>M(()=>{const t=([n])=>{n.contentRect?.width!==0&&requestAnimationFrame(()=>e(n.contentRect?.width-Nt))},a=new ResizeObserver(t);return a.observe(i),()=>a.unobserve(i)},[]),An=i=>{const[e,t]=T(()=>i.getBoundingClientRect().width-Nt);return qn(i,t),e},Fn=(i,e)=>{const t=F(()=>{let a=!1,n;const o=()=>{if(!a)return;n=requestAnimationFrame(o),i()&&(a=!1)};return{start:()=>{a=!0,cancelAnimationFrame(n),n=requestAnimationFrame(o)},stop:()=>{a=!1,cancelAnimationFrame(n)}}},[]);M(()=>{t.start()},e),M(()=>()=>t.stop(),[])},_n=(i=0,e=0)=>Math.abs(i-e)<.1,kn=(i,e=1.9,t=di)=>{const a=Ve({target:i}),n=C(()=>{if(!a.tween)return a.tween=a.target,t(a.tween),!0;if(a.target.every((o,r)=>a.tween[r]===o))return t(a.tween),!0;a.tween=a.target.map((o,r)=>_n(a.tween[r],o)?o:(a.tween[r]??0)+((o??0)-(a.tween[r]??0))/e||0),t(a.tween)},[]);Fn(n,[i])},In=({canvasWidth:i,groupOnColumn:e,config:t,miniColumn:a})=>F(()=>{if(!Array.isArray(t)||i==null||i===0)return[];const n=t.map((o,r)=>({minWidth:o.minWidth,width:o.width,flex:o.flex,priority:o.priority,name:o.name,index:r,hidden:o.name===e?.name||o.disabled})).map(o=>a?{...o,hidden:a.name!==o.name}:o).sort(({index:o,priority:r},{index:l,priority:u})=>r===u?l-o:r-u);return Rt(n,i,n.length)},[i,e,t]),En=({host:i,canvasWidth:e,columns:t})=>{const a=i.miniBreakpoint??480,n=F(()=>e<=a,[e,a]),o=F(()=>n?t?.filter(s=>s.mini!=null).sort((s,c)=>(s.mini??0)-(c.mini??0)):[],[t,n]),[r,...l]=o??[],u=!!r;return M(()=>{i.toggleAttribute("mini",u)},[u]),{isMini:u&&n,miniColumn:r,miniColumns:l}},Mn=i=>{const e=F(()=>new CSSStyleSheet,[]);return M(()=>{i.shadowRoot.adoptedStyleSheets=[...i.shadowRoot.adoptedStyleSheets,e]},[]),e},On=({host:i,columns:e,settings:t,setSettings:a,resizeSpeedFactor:n,sortAndGroupOptions:o})=>{const r=An(i),{isMini:l,miniColumn:u,miniColumns:s}=En({host:i,canvasWidth:r,columns:e}),{groupOnColumn:c}=o,m=In({canvasWidth:r,groupOnColumn:c,miniColumn:u,config:t.columns}),b=Mn(i),p=F(()=>t.columns.reduce((h,$,_)=>m[_]!=null||$.name===c?.name||$.disabled?h:[...h,e.find(g=>g.name===$.name)],[]),[e,t,m]),v=Ve({columns:t.columns});return kn(m,n,h=>{const $=$n(h,v.columns);b.replace($)}),Cn({host:i,canvasWidth:r,layout:m,setSettings:h=>a(h(t))}),{isMini:l,collapsedColumns:p,miniColumns:s}},Ln=({host:i,...e})=>{const{csvFilename:t="omnitable.csv",xlsxFilename:a="omnitable.xlsx",xlsxSheetname:n="Omnitable",topPlacement:o="top-end"}=i;return{csvFilename:t,xlsxFilename:a,xlsxSheetname:n,topPlacement:o,...e}},Dn=({host:i,selectedItems:e,data:t,sortAndGroupOptions:a,collapsedColumns:n,settings:o,filterFunctions:r,settingS:l,filters:u,...s})=>{const c=t&&t.length>0&&e.length===t.length,m=h=>{h.target.checked?i.shadowRoot.querySelector("#groupedList").selectAll():i.shadowRoot.querySelector("#groupedList").deselectAll()},{groupOnColumn:b}=a,p=F(()=>[b,...n,...o.columns.filter(h=>h.disabled)].some(h=>h&&Object.keys(r).includes(h.name)),[r,o,n]),v=F(()=>({...l,collapsed:n,badge:p,filters:u}),[l,n,p,u]);return M(()=>{const h=i.shadowRoot.querySelector("#tableContent"),$=new ResizeObserver(_=>requestAnimationFrame(()=>{i.style.setProperty("--ot-height",_[0]?.contentRect.height+"px")}));return $.observe(h),()=>$.unobserve(h)},[]),{allSelected:c,onAllCheckboxChange:m,data:t,settingsConfig:v,filters:u,groupOnColumn:b,sortAndGroup:a.sortAndGroup,...s}},Pt=d`
	<svg
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
...
`,Tn=i=>i?"groupRow groupRow-folded":"groupRow",Vn=({item:i,index:e})=>t=>k(t?.length>0,()=>d`
			...
			`),Rn=({columns:i,collapsedColumns:e,miniColumns:t,onItemClick:a,onCheckboxChange:n,dataIsValid:o,groupOnColumn:r,onItemChange:l,rowPartFn:u})=>(s,c,{selected:m,expanded:b,toggleCollapse:p})=>d`
		<div
			?selected=${m}
	...
	`,Nn=({onCheckboxChange:i,dataIsValid:e,groupOnColumn:t})=>(a,n,{selected:o,folded:r,toggleFold:l})=>d` <div
		...
		</div>`,Pn=({host:i,error:e,dataIsValid:t,processedItems:a,columns:n,collapsedColumns:o,miniColumns:r,sortAndGroupOptions:l,rowPartFn:u,...s})=>{const{loading:c=!1,displayEmptyGroups:m=!1,compareItemsFn:b}=i,p=Re({shiftKey:!1,ctrlKey:!1}),v=C(g=>{const A=g.target.dataItem,f=g.target.checked;p.current.shiftKey?i.shadowRoot.querySelector("#groupedList").toggleSelectTo(A,f):p.current.ctrlKey?(g.target.checked=!0,i.shadowRoot.querySelector("#groupedList").selectOnly(A)):i.shadowRoot.querySelector("#groupedList").toggleSelect(A,f),g.preventDefault(),g.stopPropagation()},[]);M(()=>{const g=({shiftKey:A,ctrlKey:f})=>{p.current={shiftKey:A,ctrlKey:f}};return window.addEventListener("keydown",g),window.addEventListener("keyup",g),()=>{window.removeEventListener("keydown",g),window.removeEventListener("keyup",g)}},[]);const h=C(g=>{const A=g.composedPath();A.slice(0,A.indexOf(g.currentTarget)).find(y=>y.matches?.("a, .checkbox, .expand"))||i.dispatchEvent(new window.CustomEvent("omnitable-item-click",{bubbles:!0,composed:!0,detail:{item:g.currentTarget.dataItem,index:g.currentTarget.dataIndex}}))},[]),{groupOnColumn:$}=l,_=C((g,A)=>f=>Mi(i,g,A,f),[]);return{...s,processedItems:a,dataIsValid:t,filterIsTooStrict:t&&a.length<1,loading:c,compareItemsFn:b,displayEmptyGroups:m,error:e,renderItem:F(()=>Rn({columns:n,collapsedColumns:o,miniColumns:r,onItemClick:h,onCheckboxChange:v,dataIsValid:t,groupOnColumn:$,onItemChange:_,rowPartFn:u}),[n,o,h,v,t,$,_,u]),renderGroup:F(()=>Nn({onCheckboxChange:v,dataIsValid:t,groupOnColumn:$}),[v,t,$])}},Bn=(i,e)=>{if(i===e)return 0;if(i==null)return-1;if(e==null)return 1;const t=typeof i,a=typeof e;return t==="object"&&a==="object"?i.toString()<e.toString()?-1:1:t==="number"&&a==="number"?i-e:t==="string"&&a==="string"?i<e?-1:1:t==="boolean"&&a==="boolean"?i?-1:1:(console.warn("unsupported sort",t,i,a,e),0)},Fe=(i,e)=>(t,a)=>Bn(i(t),i(a))*(e?-1:1),Hn=i=>i.replace(/([a-z0-9])([A-Z])/gu,"$1-$2").toLowerCase(),ht=(i,e)=>{!i||!e||Object.entries(e).forEach(([t,a])=>{i[P].__ownChange=!0,i[P][t]=a,i[P].__ownChange=!1,i[P].dispatchEvent(new CustomEvent(`${Hn(t)}-changed`,{bubbles:!0,detail:{value:a}}))})},_e=(i,e)=>Object.assign(i,{[ye]:e}),be=Symbol("unparsed"),Gn=({data:i,columns:e,hashParam:t,sortAndGroupOptions:a,noLocalSort:n,noLocalFilter:o})=>{const{groupOnColumn:r,groupOnDescending:l,sortOnColumn:u,descending:s}=a,c=C(([f,y])=>{const x=e.find(({name:w})=>w===f);return x==null?[f,void 0]:[f,y.filter&&x.serializeFilter(x,y.filter)]},[e]),m=C(([f,y])=>{const x=e.find(({name:z})=>z===f);if(x==null)return[f,{[be]:y}];const w={filter:x.deserializeFilter(x,y)};return ht(x,w),[f,w]},[e]),[b,p]=J({},t,{multi:!0,suffix:"-filter--",write:c,read:m}),v=C((f,y)=>p(x=>{const w=$e(y,x[f]);return ht(e.find(z=>z.name===f),w),{...x,[f]:{...x[f],...w}}}),[e,p]),h=F(()=>Object.values(b).map(f=>f.filter),[b]),$=F(()=>Object.fromEntries(e.map(f=>[f.name,!f.noLocalFilter&&f.getFilterFn(f,b[f.name]?.filter)]).filter(([,f])=>!!f)),[e,...h]),_=F(()=>!Array.isArray(i)||i.length===0?[]:Object.entries($).length===0||o?i.slice():i.filter(f=>Object.values($).every(y=>y(f))),[i,$,o]),g=F(()=>{if(!n&&!r&&u!=null&&u.sortOn!=null)return _.slice().sort(Fe(f=>u.getComparableValue({...u,valuePath:u.sortOn},f),s));if(r!=null&&r.groupOn!=null){const f=_.reduce((y,x)=>{const w=r.getComparableValue({...r,valuePath:r.groupOn},x);if(w===void 0)return y;let z=y.find(D=>D.id===w);return z?(z.items.push(x),y):(z={id:w,name:w,items:[x]},[...y,z])},[]);return f.sort(Fe(y=>r.getComparableValue({...r,valuePath:r.groupOn},y.items[0]),l)),!u||n?f:f.filter(y=>Array.isArray(y.items)).map(y=>(y.items.sort(Fe(x=>u.getComparableValue({...u,valuePath:u.sortOn},x),s)),y))}return _},[_,r,l,u,s,n]),A=F(()=>{let f=0,y=0;const x=[];return g.forEach(w=>{if(Array.isArray(w.items)){_e(w,y++),w.items.forEach(z=>{_e(z,f++),x.push(z)});return}return _e(w,f++),x.push(w)},[]),x},[g]);return M(()=>{p(f=>Object.values(f).some(x=>x[be]!=null)?Object.fromEntries(Object.entries(f).map(([x,w])=>w[be]==null?[x,w]:m([x,w[be]]))):f)},[m]),{processedItems:g,visibleData:A,filters:b,filterFunctions:$,setFilterState:v}},Wn=i=>{const e=a=>{const n=i.data.indexOf(a);if(n<0)return null;const o=i.data.splice(n,1);if(i.data=i.data.slice(),Array.isArray(o)&&o.length>0)return o[0]},t=(a,n)=>{i.data.splice(a,1,n),i.data=i.data.slice()};return{removeItem:e,removeItems(a){const n=[];for(let o=a.length-1;o>=0;o-=1){const r=i.removeItem(a[o]);r!=null&&n.push(r)}return n},replaceItemAtIndex:t,replaceItem(a,n){const o=i.data.indexOf(a);if(o>-1)return t(o,n)},selectItem(a){i.shadowRoot.querySelector("#groupedList").select(a)},selectAll(){i.shadowRoot.querySelector("#groupedList").selectAll()},deselectAll(){i.shadowRoot.querySelector("#groupedList").deselectAll()},deselectItem(a){i.shadowRoot.querySelector("#groupedList").deselect(a)},isItemSelected(a){return i.shadowRoot.querySelector("#groupedList").isItemSelected(a)}}},jn=({host:i,visibleData:e,filters:t,...a})=>{const{setFilterState:n}=a,o=F(()=>Wn(i),[]);Ee(a,Object.values(a)),Ee(o,Object.values(o)),M(()=>{const l=u=>n(u.detail.name,s=>({...s,...u.detail.state}));return i.addEventListener("legacy-filter-changed",l),()=>i.removeEventListener("legacy-filter-changed",l)},[]),N("visibleData",e),N("sortedFilteredGroupedItems",a.sortedFilteredGroupedItems),N("selectedItems",a.selectedItems),N("sortOn",a.sortOn),N("descending",a.descending),N("isMini",a.isMini);const r=F(()=>Object.fromEntries(Object.entries(t).filter(([,{filter:l}])=>l!==void 0).map(([l,{filter:u}])=>[l,u])),[t]);N("filters",r,Object.values(r))},Un=i=>{const{hashParam:e,settingsId:t,data:a,resizeSpeedFactor:n,noLocal:o,noLocalSort:r=o,noLocalFilter:l=o,error:u,rowPartFn:s}=i,c=hn({settingsId:t,host:i}),{settings:m,setSettings:b,columns:p,resetRef:v}=c,h=Ra(p,e,m,b,v),{processedItems:$,visibleData:_,filters:g,setFilterState:A,filterFunctions:f}=Gn({data:a,columns:p,hashParam:e,sortAndGroupOptions:h,noLocalSort:r,noLocalFilter:l}),{isMini:y,collapsedColumns:x,miniColumns:w}=On({host:i,columns:p,settings:m,setSettings:b,resizeSpeedFactor:n,sortAndGroupOptions:h}),z=a&&Array.isArray(a)&&a.length>0,[D,H]=T([]);return jn({host:i,visibleData:_,sortedFilteredGroupedItems:$,columns:p,filters:g,setFilterState:A,selectedItems:D,isMini:y,...h}),{header:Dn({host:i,selectedItems:D,sortAndGroupOptions:h,dataIsValid:z,data:a,columns:p,filters:g,collapsedColumns:x,settings:m,filterFunctions:f,settingS:c,setFilterState:A,hideSelectAll:i.hideSelectAll===!0}),list:Pn({host:i,error:u,dataIsValid:z,processedItems:$,setSelectedItems:H,columns:p,collapsedColumns:x,miniColumns:w,sortAndGroupOptions:h,rowPartFn:s}),footer:Ln({host:i,selectedItems:D,columns:p})}};customElements.define("cosmoz-grouped-list-row",class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||ke(this._renderFn(this._item,this._index),this)}});const Kn={group:Symbol("group")},Se=(i,e)=>(e.has(i)||e.set(i,{}),e.get(i)),Jn=(i,e)=>!!Se(i,e).expanded,Xn=(i,e)=>!!Se(i,e).folded,Me=i=>i?i.items instanceof Array:!1,Qn=i=>{if(!Array.isArray(i)||i.length===0)return;const e=Array.isArray(i[0]?.items);if(!i.every(a=>Array.isArray(a.items)===e))throw new Error("Data must be homogeneous.")},Yn=(i,e,t)=>Array.isArray(i)?(Qn(i),i.reduce((n,o)=>{const r=o;return r.items?r.items.length?Se(o,t).folded?n.concat(o):n.concat(o,r.items.map(l=>Object.assign(l,{[Kn.group]:o}))):e?n.concat(o):n:n.concat(o)},[])):void 0,Zn=(i,...e)=>typeof i=="function"?i(...e):i,eo=(i,e)=>i===e,to=()=>{const[i,e]=T(()=>[new WeakMap]);return{setItemState:C((a,n)=>e(([o])=>{const r=Se(a,o);return Object.assign(r,Zn(n,r)),[o]}),[]),state:i[0],signal:i}},io=()=>{const{setItemState:i,state:e,signal:t}=to(),a=C((o,r)=>{Me(o)&&i(o,l=>({folded:r!==void 0?r:!l.folded}))},[]),n=C((o,r)=>{Me(o)||i(o,l=>({expanded:r!==void 0?!r:!l.expanded}))},[]);return{state:e,signal:t,toggleFold:a,toggleCollapse:n}},ao=({initial:i,compareItemsFn:e,data:t,flatData:a})=>{const[n,o]=T(i),[r,l]=T(),u=C(g=>n.includes(g),[n]),s=C(g=>g?.items?.every(u)??!1,[u]),c=C(g=>u(g)||s(g),[u,s]),m=C(g=>{const f=g.items??[g];o(y=>[...y,...f.filter(x=>!y.includes(x))]),l(g)},[]),b=C(g=>{const f=g.items??[g];o(y=>y.filter(x=>!f.includes(x))),l(g)},[]),p=C(g=>{o(g.items?.slice()||[g]),l(g)},[]),v=C(()=>{o(t.flatMap(g=>g.items||g)),l(void 0)},[t]),h=C(()=>{o([]),l(void 0)},[]),$=C((g,A=!c(g))=>A?m(g):b(g),[c]),_=C((g,A)=>{if(!a)return;const f=r?a.findIndex(w=>e(w,r)):-1;if(f<0)return $(g,A);const[y,x]=[f,a.indexOf(g)].sort((w,z)=>w-z);a.slice(y,x+1).forEach((w,z,D)=>{z>0&&z<D.length-1&&Me(w)||$(w,A)}),l(g)},[a,e,$]);return M(()=>o(g=>g.length>0&&a?a.filter(A=>g.find(f=>e(A,f))):g),[a]),{selectedItems:n,isItemSelected:u,isGroupSelected:s,isSelected:c,select:m,deselect:b,selectOnly:p,selectAll:v,deselectAll:h,toggleSelect:$,toggleSelectTo:_}},no={host:{position:"relative",display:"flex",flexDirection:"column"}},oo=i=>{const{data:e,renderItem:t,renderGroup:a,displayEmptyGroups:n,compareItemsFn:o=eo}=i,{toggleFold:r,toggleCollapse:l,state:u,signal:s}=io(),c=F(()=>Yn(e,n,u),[e,n,s]),{selectedItems:m,isItemSelected:b,isGroupSelected:p,isSelected:v,select:h,deselect:$,selectOnly:_,selectAll:g,deselectAll:A,toggleSelect:f,toggleSelectTo:y}=ao({initial:[],compareItemsFn:o,data:e,flatData:c}),x=C((z,D)=>Array.isArray(z.items)?a(z,D,{selected:p(z),folded:Xn(z,u),toggleSelect:H=>f(z,typeof H=="boolean"?H:void 0),toggleFold:()=>r(z)}):t(z,D,{selected:m.includes(z),expanded:Jn(z,u),toggleSelect:H=>f(z,typeof H=="boolean"?H:void 0),toggleCollapse:()=>l(z)}),[t,a,m,f,s]);yt(()=>{Object.assign(i.style,no.host)},[]),N("selectedItems",m);const w={toggleFold:r,toggleCollapse:l,isItemSelected:b,isGroupSelected:p,isSelected:v,select:h,deselect:$,selectOnly:_,selectAll:g,deselectAll:A,toggleSelect:f,toggleSelectTo:y};return Ee(w,Object.values(w)),{renderRow:x,flatData:c}},ro=({renderRow:i,flatData:e})=>mi({items:e,renderItem:(t,a)=>d`<cosmoz-grouped-list-row
				.item=${t}
				.index=${a}
				.renderFn=${i}
