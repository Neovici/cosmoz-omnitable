import{b as d,D as Fe,A as bt,w as Bt}from"./iframe-COQXeZig.js";import{t as K,c as E,g as C,P as A,u as M,a as xt,m as vt,s as Ht,D as Gt,b as Wt,e as qt,i as ye,h as Ae,d as Xt,f as yt,r as Ut,j as Kt,k as _,l as Jt,n as $e,p as he,o as D,q as Yt,v as we,w as Qt,x as Zt,y as en,T as tn,z as T,A as fe,B as nn,C as on,E as rn,F as w,G as an,H as ln,I as $t,J as Ee,K as I,L as wt,M as Te,N as sn,O as zt,Q as un,R as Le,S as Ye,U as cn,V as Re,W as dn,X as mn,Y as Oe,Z as Me,_ as pn,$ as De,a0 as P,a1 as gn,a2 as Ce,a3 as hn}from"./cosmoz-collapse-CmxS_DIY.js";import"./preload-helper-PPVm8Dsz.js";const fn=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,Tt=n=>(e,t,o=nn)=>{const r=ln(),i=new URLSearchParams(r.hash.replace("#",""));return n(e,t,o,i),"#!"+Object.assign(r,{hash:i}).href.replace(location.origin,"")},Lt=n=>n==null||n==="",No=Tt((n,e,t,o)=>Lt(t(e))?o.delete(n):o.set(n,t(e))),jo=Tt((n,e,t,o)=>Object.entries(e).map(t).forEach(([r,i])=>Lt(i)?o.delete(n+r):o.set(n+r,i))),J=(n,e,{suffix:t="",read:o,write:r,multi:i}={})=>{const[a,l]=i?[jo,on]:[No,rn],[u,s]=M(()=>e==null?n:l(e+t,o)??n),c=w(m=>s(h=>{const p=ye(m,h);return e!=null&&an(a(e+t,p,r),null,{notify:!1}),p}),[e,t,a,r]);return[u,c]},Po=n=>[!0,"true",1,"yes","on"].includes(n),ae=n=>n===""||(n==null?void 0:Po(n)),le=(n,e,t)=>w(o=>{n(o),t(r=>({...r,[e]:o}))},[n,e,t]),Bo=(n,e,t,o,r)=>{const[i,a]=J(t.sortOn,e,{suffix:"-sortOn"}),[l,u]=J(ae(t.descending),e,{suffix:"-descending",read:ae}),[s,c]=J(t.groupOn,e,{suffix:"-groupOn"}),[m,h]=J(ae(t.groupOnDescending),e,{suffix:"-groupOnDescending",read:ae}),p=I(()=>n.find(g=>g.name===i),[n,i]),x=I(()=>n.find(g=>g.name===s),[n,s]),b={groupOn:s,setGroupOn:le(c,"groupOn",o),groupOnDescending:m,setGroupOnDescending:le(h,"groupOnDescending",o),sortOn:i,setSortOn:le(a,"sortOn",o),descending:l,setDescending:le(u,"descending",o),columns:n},$=I(()=>b,Object.values(b)),F=w(g=>{a(g.sortOn),c(g.groupOn),u(g.descending),h(g.groupOnDescending)},[]);return T(()=>void(r.current=F),[]),{...$,sortAndGroup:$,groupOnColumn:x,sortOnColumn:p}},Je=$t();customElements.define("sort-and-group-provider",Je.Provider);customElements.define("sort-and-group-consumer",E(({render:n})=>n(Ee(Je)),{useShadowDOM:!1}));const Ho=({data:n,columns:e,groupOnColumn:t,filters:o,setFilterState:r,sortAndGroup:{sortOn:i,setSortOn:a,descending:l,setDescending:u}={}})=>wt(e,s=>s.name,s=>[d`<div
...
`);a.unshift(i),zt(new File(a,t,{type:"text/csv;charset=utf-8"}))},Qo=(n,e)=>{const t=n.map(r=>r.title),o=e.map(r=>n.map(i=>{const a=i.toXlsxValue(i,r);return a??""}));return o.unshift(t),o},Zo=(n,e,t,o)=>{const r=Qo(n,e),i=new un(t).addSheetFromData(r,o).generate();zt(new File([i],t,{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}))},er=({columns:n,selectedItems:e,csvFilename:t,xlsxFilename:o,xlsxSheetname:r,topPlacement:i})=>d`<cosmoz-bottom-bar
	...
	</cosmoz-bottom-bar>`,tr=({allSelected:n,onAllCheckboxChange:e,sortAndGroup:t,dataIsValid:o,data:r,columns:i,filters:a,groupOnColumn:l,setFilterState:u,settingsConfig:s,hideSelectAll:c})=>d`<sort-and-group-provider .value=${t}>
...
`,ir=(n,e)=>{const{settingsConfig:t}=n,{processedItems:o,dataIsValid:r,filterIsTooStrict:i,loading:a,displayEmptyGroups:l,compareItemsFn:u,setSelectedItems:s,renderItem:c,renderGroup:m,error:h}=e;return d`${D(!a&&!r&&!h,()=>d`<div class="tableContent-empty">
...
`,se=n=>{const e=parseInt(n,10);return isFinite(e)?e:void 0},sr=n=>{const{config:e}=n,{settings:t,setSettings:o,collapsed:r}=e,i=Re({collapsed:r,settings:t.columns,setSettings:w(a=>o(l=>({...l,columns:a})),[o])});return{...e,onDown:w(a=>{a.target.closest(".pull")&&(i.handle=a.currentTarget)},[i]),onDragStart:w(a=>{const{target:l}=a,u=se(l.dataset.index);if(!i.handle?.contains(l)||u==null)return a.preventDefault();i.handle=null,a.dataTransfer.effectAllowed="move",a.dataTransfer.setData("omnitable/sort-index",u),a.dataTransfer.setData("text/plain",u),setTimeout(()=>l.classList.add("drag"),0),l.addEventListener("dragend",s=>s.target.classList.remove("drag"),{once:!0})},[i]),onDragEnter:w(a=>{const l=a.currentTarget;l===a.target&&(a.preventDefault(),a.dataTransfer.dropEffect="move",l.classList.add("dragover"))},[]),onDragOver:w(a=>{a.preventDefault(),a.currentTarget.classList.add("dragover")},[]),onDragLeave:w(a=>{const l=a.currentTarget;l.contains(a.relatedTarget)||l.classList.remove("dragover")},[]),onDrop:w(a=>{const l=se(a.dataTransfer.getData("omnitable/sort-index")),u=se(a.currentTarget.dataset.index),{settings:s,setSettings:c}=i;a.currentTarget.classList.remove("dragover"),a.preventDefault();const m=s.slice();m.splice(u+(l>=u?0:-1),0,m.splice(l,1)[0]),c(m)},[i]),onToggle:w(a=>{const{settings:l,setSettings:u}=i,s=l.map(m=>({...m,disabled:m.disabled||i.collapsed?.some(h=>h.name===m.name)})),c=se(a.target.closest("[data-index]")?.dataset.index);s.splice(c,1,{...l[c],disabled:!a.target.checked,priority:a.target.checked?l.reduce((m,h)=>Math.max(m,h.priority),0)+1:l[c].priority}),u(s)},[i])}},ur=[dn({apply({availableHeight:n,elements:e}){Object.assign(e.floating.style,{maxHeight:`${Math.max(0,n)}px`})}}),...mn],cr=({onDragStart:n,onDragEnter:e,onDragOver:t,onDragLeave:o,onDrop:r,onDown:i,onToggle:a,collapsed:l,filters:u})=>(s,c)=>{const m=!!l?.find(p=>p.name===s.name),h=!s.disabled&&!m;return d` <div
			class="item"
			data-index=${c}
			@mousedown=${i}
			draggable="true"
		...
		>
			...
			<input
				...
				.indeterminate=${m}
			/>
		</div>`},dr=n=>{const{settings:e,settingsId:t,onSave:o,onReset:r,hasChanges:i,opened:a,setOpened:l,...u}=sr(n);return d` <div class="headline">
			${_("Sort and filter")}
			<button
				class="close"
...
`;customElements.define("cosmoz-omnitable-settings",E(mr,{styleSheets:[Te(lr)]}));const be=["sortOn","descending","groupOn","groupOnDescending"],ue=n=>e=>typeof e=="object"&&e!==null&&"name"in e&&e.name===n,pr=(n=[],e=[],t=[])=>{const o=e.filter(a=>n.some(ue(a.name))),r=n.filter(a=>a.name!=null&&!e.some(ue(a.name))&&!t.some(ue(a.name))),i=t.filter(a=>!e.some(ue(a.name)));return[...o,...i.flatMap(a=>{const l=n.find(u=>u.name===a.name);return l?{...a,title:l.title??a.title??"",minWidth:parseInt(l.minWidth??"0",10)}:[]}),...r.map(a=>{const{name:l,title:u,priority:s,minWidth:c,width:m,flex:h}=a;return{name:l??"",title:u??"",priority:s??0,minWidth:parseInt(c??"0",10),width:parseInt(m??"0",10),flex:parseInt(h??"0",10)}})]},gr=(n,e)=>({...e,...Oe(Array.from(be))(n),columns:n.columns?.map(Oe(["name","priority","width","flex","disabled"]))}),hr=({columns:n,settings:e,savedSettings:t,initial:o})=>({...Object.fromEntries(be.flatMap(i=>o?.[i]!=null?[[i,o[i]]]:[])),...t?Oe(Array.from(be))(t):{},...e,columns:pr(n,e?.columns,t?.columns)}),fr=({prefix:n="omnitable-"}={})=>({write:async(t,o)=>{const r=n+t;try{o?localStorage.setItem(r,JSON.stringify(o)):localStorage.removeItem(r)}catch(i){console.error(i)}},read:async t=>{if(t)try{const o=localStorage.getItem(n+t);return o==null?void 0:JSON.parse(o)}catch(o){console.error(o)}}}),br=$t(fr),xr=()=>{const n=Ee(br);return I(()=>n(),[n])},vr=(n,e,t,o)=>{const[r,i]=M(),{read:a,write:l}=xr();return T(async()=>{n&&i(await a(n))},[n,a]),{settingsId:n,savedSettings:r,onSave:w(async()=>{if(!n)return;const u=gr(e,r);await l(n,u),t(),i(u)},[e,r]),onReset:w(async u=>{t(),u.shiftKey&&(await l(n),i()),o?.()},[o]),hasChanges:e!=null}},yr=({settingsId:n,host:e})=>{const t=I(()=>Object.fromEntries(be.map(b=>[b,e[b]])),[]),o=Me(),r=w(()=>{o.current?.(t)},[t]),[i,a]=M(),[l,u]=M({columns:!0,sort:!0}),{savedSettings:s,...c}=vr(n,i,a,r),{enabledColumns:m}=e,h=En(e,{enabledColumns:m}),p=I(()=>hr({columns:h,settings:i,savedSettings:s,initial:t}),[h,i,s]),x=I(()=>p.columns.map(b=>h.find($=>$.name===b.name)).filter(Boolean),[h,...p.columns.map(b=>b.name)]);return{...c,opened:l,setOpened:u,settings:p,columns:x,setSettings:a,resetRef:o}},gt=n=>Number.isFinite(n)?n:0,$r=(n,e)=>{const t=[];let[o,r]=n.reduce(([c,m],{width:h,flex:p})=>[c+h,m+p],[0,0]),i=e-o,a=gt(i/r),l=0,u=0,s=0;for(let c=0;c<n.length;c++){const{width:m,minWidth:h,flex:p}=n[c],x=i>=0?a*p:m*i/o;if(h>m+x){l+=m,u+=h,s+=p,t[c]=h;continue}if(p===0){l+=m,u+=m,t[c]=m;continue}}o-=l,i=e-u-o,r-=s,a=gt(i/r);for(let c=0;c<n.length;c++){if(t[c]!=null)continue;const{width:m,flex:h}=n[c],p=i>=0?a*h:m*i/o;t[c]=m+p}return t},xe=Symbol("index"),wr=(n,e)=>{if(typeof n.findLastIndex=="function")return n.findLastIndex(e);for(let t=n.length-1;t>=0;t--)if(e(n[t],t,n))return t;return-1},zr=(n,e)=>{const t=wr(n,a=>a!=null&&a>0),o=(a,l)=>`.cell[name="${a}"], cosmoz-omnitable-skeleton::part(cell-${a}){width: ${Math.floor(l)}px;padding: 0 min(3px, ${l/2}px)}`,r=a=>`cosmoz-omnitable-resize-nub[name="${a}"]{display:none}`,i=a=>`cosmoz-omnitable-resize-nub[name="${a}"], .cell[name="${a}"]{display:none}`;return e.map((a,l)=>{const u=n[l];if(u==null||u===0)return i(a.name);const s=o(a.name,u);return l===t?`${s}
${r(a.name)}`:s}).join(`
`)},Mt=(n,e,t)=>{const o=n.filter(l=>!l.hidden),r=o.reduce((l,{width:u})=>l+u,0);if(o.length>1&&r>e)return Mt(o.slice(1),e,t);const i=o.reduce(([l,u],s,c)=>[Math.max(l,s.index),s.index>l?c:u],[-1,-1])[1];return i!==-1&&(o[i].flex=1),$r(o,e).reduce((l,u,s)=>(l[o[s].index]=u,l),new Array(t).fill(void 0))},Cr=(n,e)=>n.length===0?".cell {display: none;}":zr(n,e),Sr=({host:n,canvasWidth:e,layout:t,setSettings:o})=>{const r=Me();r.current=i=>o(a=>{const l=a.columns,{detail:{newWidth:u,column:s}}=i,c=l.findIndex(p=>p.name===s.name),m=[],h=l.reduce((p,x)=>Math.max(p,x.priority),-1/0);for(let p=0;p<t.length;p++)if(m[p]={...l[p]},p<c&&t[p]&&(m[p].width=t[p],m[p].flex=0,m[p].priority=h),p===c){const x=t.reduce((b,$,F)=>F<c&&$?b-$:b,e);m[p].width=Math.min(x,Math.max(u,l[p].minWidth)),m[p].flex=0,m[p].priority=h}return{...a,columns:m}}),T(()=>{const i=a=>r.current?.(a);return n.addEventListener("column-resize",i),()=>n.removeEventListener("column-resize",i)},[])},_r=(n,e)=>T(()=>{const t=([r])=>{r.contentRect?.width!==0&&requestAnimationFrame(()=>e(r.contentRect?.width-Nt))},o=new ResizeObserver(t);return o.observe(n),()=>o.unobserve(n)},[]),kr=20,Ir=44,Fr=24,Nt=kr+Ir+Fr,Or=n=>{const[e,t]=M(()=>n.getBoundingClientRect().width-Nt);return _r(n,t),e},Dr=(n,e)=>{const t=I(()=>{let o=!1,r;const i=()=>{if(!o)return;r=requestAnimationFrame(i),n()&&(o=!1)};return{start:()=>{o=!0,cancelAnimationFrame(r),r=requestAnimationFrame(i)},stop:()=>{o=!1,cancelAnimationFrame(r)}}},[]);T(()=>{t.start()},e),T(()=>()=>t.stop(),[])},Vr=(n=0,e=0)=>Math.abs(n-e)<.1,Ar=(n,e=1.9,t=pn)=>{const o=Re({target:n}),r=w(()=>{if(!o.tween)return o.tween=o.target,t(o.tween),!0;if(o.target.every((i,a)=>o.tween[a]===i))return t(o.tween),!0;o.tween=o.target.map((i,a)=>Vr(o.tween[a],i)?i:(o.tween[a]??0)+((i??0)-(o.tween[a]??0))/e||0),t(o.tween)},[]);Dr(r,[n])},Er=({canvasWidth:n,groupOnColumn:e,config:t,miniColumn:o})=>I(()=>{if(!Array.isArray(t)||n==null||n===0)return[];const r=t.map((i,a)=>({minWidth:i.minWidth,width:i.width,flex:i.flex,priority:i.priority,name:i.name,index:a,hidden:i.name===e?.name||i.disabled})).map(i=>o?{...i,hidden:o.name!==i.name}:i).sort(({index:i,priority:a},{index:l,priority:u})=>a===u?l-i:a-u);return Mt(r,n,r.length)},[n,e,t]),Tr=({host:n,canvasWidth:e,columns:t})=>{const o=n.miniBreakpoint??480,r=I(()=>e<=o,[e,o]),i=I(()=>r?t?.filter(s=>s.mini!=null).sort((s,c)=>(s.mini??0)-(c.mini??0)):[],[t,r]),[a,...l]=i??[],u=!!a;return T(()=>{n.toggleAttribute("mini",u)},[u]),{isMini:u&&r,miniColumn:a,miniColumns:l}},Lr=n=>{const e=I(()=>new CSSStyleSheet,[]);return T(()=>{n.shadowRoot.adoptedStyleSheets=[...n.shadowRoot.adoptedStyleSheets,e]},[]),e},Rr=({host:n,columns:e,settings:t,setSettings:o,resizeSpeedFactor:r,sortAndGroupOptions:i})=>{const a=Or(n),{isMini:l,miniColumn:u,miniColumns:s}=Tr({host:n,canvasWidth:a,columns:e}),{groupOnColumn:c}=i,m=Er({canvasWidth:a,groupOnColumn:c,miniColumn:u,config:t.columns}),h=Lr(n),p=I(()=>t.columns.reduce((b,$,F)=>m[F]!=null||$.name===c?.name||$.disabled?b:[...b,e.find(g=>g.name===$.name)],[]),[e,t,m]),x=Re({columns:t.columns});return Ar(m,r,b=>{const $=Cr(b,x.columns);h.replace($)}),Sr({host:n,canvasWidth:a,layout:m,setSettings:b=>o(b(t))}),{isMini:l,collapsedColumns:p,miniColumns:s}},Mr=({host:n,...e})=>{const{csvFilename:t="omnitable.csv",xlsxFilename:o="omnitable.xlsx",xlsxSheetname:r="Omnitable",topPlacement:i="top-end"}=n;return{csvFilename:t,xlsxFilename:o,xlsxSheetname:r,topPlacement:i,...e}},Nr=({host:n,selectedItems:e,data:t,sortAndGroupOptions:o,collapsedColumns:r,settings:i,filterFunctions:a,settingS:l,filters:u,...s})=>{const c=t&&t.length>0&&e.length===t.length,m=b=>{b.target.checked?n.shadowRoot.querySelector("#groupedList").selectAll():n.shadowRoot.querySelector("#groupedList").deselectAll()},{groupOnColumn:h}=o,p=I(()=>[h,...r,...i.columns.filter(b=>b.disabled)].some(b=>b&&Object.keys(a).includes(b.name)),[a,i,r]),x=I(()=>({...l,collapsed:r,badge:p,filters:u}),[l,r,p,u]);return T(()=>{const b=n.shadowRoot.querySelector("#tableContent"),$=new ResizeObserver(F=>requestAnimationFrame(()=>{n.style.setProperty("--ot-height",F[0]?.contentRect.height+"px")}));return $.observe(b),()=>$.unobserve(b)},[]),{allSelected:c,onAllCheckboxChange:m,data:t,settingsConfig:x,filters:u,groupOnColumn:h,sortAndGroup:o.sortAndGroup,...s}},jt=d`
	<svg
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
...
`,jr=n=>n?"groupRow groupRow-folded":"groupRow",Pr=({item:n,index:e})=>t=>D(t?.length>0,()=>d`
			...
			`),Br=({columns:n,collapsedColumns:e,miniColumns:t,onItemClick:o,onCheckboxChange:r,dataIsValid:i,groupOnColumn:a,onItemChange:l,rowPartFn:u})=>(s,c,{selected:m,expanded:h,toggleCollapse:p})=>d`
		<div
			?selected=${m}
	...
	`,Hr=({onCheckboxChange:n,dataIsValid:e,groupOnColumn:t})=>(o,r,{selected:i,folded:a,toggleFold:l})=>d` <div
		...
		</div>`,Gr=({host:n,error:e,dataIsValid:t,processedItems:o,columns:r,collapsedColumns:i,miniColumns:a,sortAndGroupOptions:l,rowPartFn:u,...s})=>{const{loading:c=!1,displayEmptyGroups:m=!1,compareItemsFn:h}=n,p=Me({shiftKey:!1,ctrlKey:!1}),x=w(g=>{const k=g.target.dataItem,f=g.target.checked;p.current.shiftKey?n.shadowRoot.querySelector("#groupedList").toggleSelectTo(k,f):p.current.ctrlKey?(g.target.checked=!0,n.shadowRoot.querySelector("#groupedList").selectOnly(k)):n.shadowRoot.querySelector("#groupedList").toggleSelect(k,f),g.preventDefault(),g.stopPropagation()},[]);T(()=>{const g=({shiftKey:k,ctrlKey:f})=>{p.current={shiftKey:k,ctrlKey:f}};return window.addEventListener("keydown",g),window.addEventListener("keyup",g),()=>{window.removeEventListener("keydown",g),window.removeEventListener("keyup",g)}},[]);const b=w(g=>{const k=g.composedPath();k.slice(0,k.indexOf(g.currentTarget)).find(y=>y.matches?.("a, .checkbox, .expand"))||n.dispatchEvent(new window.CustomEvent("omnitable-item-click",{bubbles:!0,composed:!0,detail:{item:g.currentTarget.dataItem,index:g.currentTarget.dataIndex}}))},[]),{groupOnColumn:$}=l,F=w((g,k)=>f=>Tn(n,g,k,f),[]);return{...s,processedItems:o,dataIsValid:t,filterIsTooStrict:t&&o.length<1,loading:c,compareItemsFn:h,displayEmptyGroups:m,error:e,renderItem:I(()=>Br({columns:r,collapsedColumns:i,miniColumns:a,onItemClick:b,onCheckboxChange:x,dataIsValid:t,groupOnColumn:$,onItemChange:F,rowPartFn:u}),[r,i,b,x,t,$,F,u]),renderGroup:I(()=>Hr({onCheckboxChange:x,dataIsValid:t,groupOnColumn:$}),[x,t,$])}},Wr=(n,e)=>{if(n===e)return 0;if(n==null)return-1;if(e==null)return 1;const t=typeof n,o=typeof e;return t==="object"&&o==="object"?n.toString()<e.toString()?-1:1:t==="number"&&o==="number"?n-e:t==="string"&&o==="string"?n<e?-1:1:t==="boolean"&&o==="boolean"?n?-1:1:(console.warn("unsupported sort",t,n,o,e),0)},ke=(n,e)=>(t,o)=>Wr(n(t),n(o))*(e?-1:1),qr=n=>n.replace(/([a-z0-9])([A-Z])/gu,"$1-$2").toLowerCase(),ht=(n,e)=>{!n||!e||Object.entries(e).forEach(([t,o])=>{n[B].__ownChange=!0,n[B][t]=o,n[B].__ownChange=!1,n[B].dispatchEvent(new CustomEvent(`${qr(t)}-changed`,{bubbles:!0,detail:{value:o}}))})},Ie=(n,e)=>Object.assign(n,{[xe]:e}),ce=Symbol("unparsed"),Xr=({data:n,columns:e,hashParam:t,sortAndGroupOptions:o,noLocalSort:r,noLocalFilter:i})=>{const{groupOnColumn:a,groupOnDescending:l,sortOnColumn:u,descending:s}=o,c=w(([f,y])=>{const v=e.find(({name:z})=>z===f);return v==null?[f,void 0]:[f,y.filter&&v.serializeFilter(v,y.filter)]},[e]),m=w(([f,y])=>{const v=e.find(({name:S})=>S===f);if(v==null)return[f,{[ce]:y}];const z={filter:v.deserializeFilter(v,y)};return ht(v,z),[f,z]},[e]),[h,p]=J({},t,{multi:!0,suffix:"-filter--",write:c,read:m}),x=w((f,y)=>p(v=>{const z=ye(y,v[f]);return ht(e.find(S=>S.name===f),z),{...v,[f]:{...v[f],...z}}}),[e,p]),b=I(()=>Object.values(h).map(f=>f.filter),[h]),$=I(()=>Object.fromEntries(e.map(f=>[f.name,!f.noLocalFilter&&f.getFilterFn(f,h[f.name]?.filter)]).filter(([,f])=>!!f)),[e,...b]),F=I(()=>!Array.isArray(n)||n.length===0?[]:Object.entries($).length===0||i?n.slice():n.filter(f=>Object.values($).every(y=>y(f))),[n,$,i]),g=I(()=>{if(!r&&!a&&u!=null&&u.sortOn!=null)return F.slice().sort(ke(f=>u.getComparableValue({...u,valuePath:u.sortOn},f),s));if(a!=null&&a.groupOn!=null){const f=F.reduce((y,v)=>{const z=a.getComparableValue({...a,valuePath:a.groupOn},v);if(z===void 0)return y;let S=y.find(R=>R.id===z);return S?(S.items.push(v),y):(S={id:z,name:z,items:[v]},[...y,S])},[]);return f.sort(ke(y=>a.getComparableValue({...a,valuePath:a.groupOn},y.items[0]),l)),!u||r?f:f.filter(y=>Array.isArray(y.items)).map(y=>(y.items.sort(ke(v=>u.getComparableValue({...u,valuePath:u.sortOn},v),s)),y))}return F},[F,a,l,u,s,r]),k=I(()=>{let f=0,y=0;const v=[];return g.forEach(z=>{if(Array.isArray(z.items)){Ie(z,y++),z.items.forEach(S=>{Ie(S,f++),v.push(S)});return}return Ie(z,f++),v.push(z)},[]),v},[g]);return T(()=>{p(f=>Object.values(f).some(v=>v[ce]!=null)?Object.fromEntries(Object.entries(f).map(([v,z])=>z[ce]==null?[v,z]:m([v,z[ce]]))):f)},[m]),{processedItems:g,visibleData:k,filters:h,filterFunctions:$,setFilterState:x}},Ur=n=>{const e=o=>{const r=n.data.indexOf(o);if(r<0)return null;const i=n.data.splice(r,1);if(n.data=n.data.slice(),Array.isArray(i)&&i.length>0)return i[0]},t=(o,r)=>{n.data.splice(o,1,r),n.data=n.data.slice()};return{removeItem:e,removeItems(o){const r=[];for(let i=o.length-1;i>=0;i-=1){const a=n.removeItem(o[i]);a!=null&&r.push(a)}return r},replaceItemAtIndex:t,replaceItem(o,r){const i=n.data.indexOf(o);if(i>-1)return t(i,r)},selectItem(o){n.shadowRoot.querySelector("#groupedList").select(o)},selectAll(){n.shadowRoot.querySelector("#groupedList").selectAll()},deselectAll(){n.shadowRoot.querySelector("#groupedList").deselectAll()},deselectItem(o){n.shadowRoot.querySelector("#groupedList").deselect(o)},isItemSelected(o){return n.shadowRoot.querySelector("#groupedList").isItemSelected(o)}}},Kr=({host:n,visibleData:e,filters:t,...o})=>{const{setFilterState:r}=o,i=I(()=>Ur(n),[]);De(o,Object.values(o)),De(i,Object.values(i)),T(()=>{const l=u=>r(u.detail.name,s=>({...s,...u.detail.state}));return n.addEventListener("legacy-filter-changed",l),()=>n.removeEventListener("legacy-filter-changed",l)},[]),P("visibleData",e),P("sortedFilteredGroupedItems",o.sortedFilteredGroupedItems),P("selectedItems",o.selectedItems),P("sortOn",o.sortOn),P("descending",o.descending),P("isMini",o.isMini);const a=I(()=>Object.fromEntries(Object.entries(t).filter(([,{filter:l}])=>l!==void 0).map(([l,{filter:u}])=>[l,u])),[t]);P("filters",a,Object.values(a))},Jr=n=>{const{hashParam:e,settingsId:t,data:o,resizeSpeedFactor:r,noLocal:i,noLocalSort:a=i,noLocalFilter:l=i,error:u,rowPartFn:s}=n,c=yr({settingsId:t,host:n}),{settings:m,setSettings:h,columns:p,resetRef:x}=c,b=Bo(p,e,m,h,x),{processedItems:$,visibleData:F,filters:g,setFilterState:k,filterFunctions:f}=Xr({data:o,columns:p,hashParam:e,sortAndGroupOptions:b,noLocalSort:a,noLocalFilter:l}),{isMini:y,collapsedColumns:v,miniColumns:z}=Rr({host:n,columns:p,settings:m,setSettings:h,resizeSpeedFactor:r,sortAndGroupOptions:b}),S=o&&Array.isArray(o)&&o.length>0,[R,G]=M([]);return Kr({host:n,visibleData:F,sortedFilteredGroupedItems:$,columns:p,filters:g,setFilterState:k,selectedItems:R,isMini:y,...b}),{header:Nr({host:n,selectedItems:R,sortAndGroupOptions:b,dataIsValid:S,data:o,columns:p,filters:g,collapsedColumns:v,settings:m,filterFunctions:f,settingS:c,setFilterState:k,hideSelectAll:n.hideSelectAll===!0}),list:Gr({host:n,error:u,dataIsValid:S,processedItems:$,setSelectedItems:G,columns:p,collapsedColumns:v,miniColumns:z,sortAndGroupOptions:b,rowPartFn:s}),footer:Mr({host:n,selectedItems:R,columns:p})}};customElements.define("cosmoz-grouped-list-row",class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||Fe(this._renderFn(this._item,this._index),this)}});const Yr={group:Symbol("group")},ze=(n,e)=>(e.has(n)||e.set(n,{}),e.get(n)),Qr=(n,e)=>!!ze(n,e).expanded,Zr=(n,e)=>!!ze(n,e).folded,Ve=n=>n?n.items instanceof Array:!1,ei=n=>{if(!Array.isArray(n)||n.length===0)return;const e=Array.isArray(n[0]?.items);if(!n.every(o=>Array.isArray(o.items)===e))throw new Error("Data must be homogeneous.")},ti=(n,e,t)=>Array.isArray(n)?(ei(n),n.reduce((r,i)=>{const a=i;return a.items?a.items.length?ze(i,t).folded?r.concat(i):r.concat(i,a.items.map(l=>Object.assign(l,{[Yr.group]:i}))):e?r.concat(i):r:r.concat(i)},[])):void 0,ni=(n,...e)=>typeof n=="function"?n(...e):n,oi=(n,e)=>n===e,ri=()=>{const[n,e]=M(()=>[new WeakMap]);return{setItemState:w((o,r)=>e(([i])=>{const a=ze(o,i);return Object.assign(a,ni(r,a)),[i]}),[]),state:n[0],signal:n}},ii=()=>{const{setItemState:n,state:e,signal:t}=ri(),o=w((i,a)=>{Ve(i)&&n(i,l=>({folded:a!==void 0?a:!l.folded}))},[]),r=w((i,a)=>{Ve(i)||n(i,l=>({expanded:a!==void 0?!a:!l.expanded}))},[]);return{state:e,signal:t,toggleFold:o,toggleCollapse:r}},ai=({initial:n,compareItemsFn:e,data:t,flatData:o})=>{const[r,i]=M(n),[a,l]=M(),u=w(g=>r.includes(g),[r]),s=w(g=>g?.items?.every(u)??!1,[u]),c=w(g=>u(g)||s(g),[u,s]),m=w(g=>{const f=g.items??[g];i(y=>[...y,...f.filter(v=>!y.includes(v))]),l(g)},[]),h=w(g=>{const f=g.items??[g];i(y=>y.filter(v=>!f.includes(v))),l(g)},[]),p=w(g=>{i(g.items?.slice()||[g]),l(g)},[]),x=w(()=>{i(t.flatMap(g=>g.items||g)),l(void 0)},[t]),b=w(()=>{i([]),l(void 0)},[]),$=w((g,k=!c(g))=>k?m(g):h(g),[c]),F=w((g,k)=>{if(!o)return;const f=a?o.findIndex(z=>e(z,a)):-1;if(f<0)return $(g,k);const[y,v]=[f,o.indexOf(g)].sort((z,S)=>z-S);o.slice(y,v+1).forEach((z,S,R)=>{S>0&&S<R.length-1&&Ve(z)||$(z,k)}),l(g)},[o,e,$]);return T(()=>i(g=>g.length>0&&o?o.filter(k=>g.find(f=>e(k,f))):g),[o]),{selectedItems:r,isItemSelected:u,isGroupSelected:s,isSelected:c,select:m,deselect:h,selectOnly:p,selectAll:x,deselectAll:b,toggleSelect:$,toggleSelectTo:F}},li={host:{position:"relative",display:"flex",flexDirection:"column"}},si=n=>{const{data:e,renderItem:t,renderGroup:o,displayEmptyGroups:r,compareItemsFn:i=oi}=n,{toggleFold:a,toggleCollapse:l,state:u,signal:s}=ii(),c=I(()=>ti(e,r,u),[e,r,s]),{selectedItems:m,isItemSelected:h,isGroupSelected:p,isSelected:x,select:b,deselect:$,selectOnly:F,selectAll:g,deselectAll:k,toggleSelect:f,toggleSelectTo:y}=ai({initial:[],compareItemsFn:i,data:e,flatData:c}),v=w((S,R)=>Array.isArray(S.items)?o(S,R,{selected:p(S),folded:Zr(S,u),toggleSelect:G=>f(S,typeof G=="boolean"?G:void 0),toggleFold:()=>a(S)}):t(S,R,{selected:m.includes(S),expanded:Qr(S,u),toggleSelect:G=>f(S,typeof G=="boolean"?G:void 0),toggleCollapse:()=>l(S)}),[t,o,m,f,s]);xt(()=>{Object.assign(n.style,li.host)},[]),P("selectedItems",m);const z={toggleFold:a,toggleCollapse:l,isItemSelected:h,isGroupSelected:p,isSelected:x,select:b,deselect:$,selectOnly:F,selectAll:g,deselectAll:k,toggleSelect:f,toggleSelectTo:y};return De(z,Object.values(z)),{renderRow:v,flatData:c}},ui=({renderRow:n,flatData:e})=>gn({items:e,renderItem:(t,o)=>d`<cosmoz-grouped-list-row
				.item=${t}
				.index=${o}
				.renderFn=${n}
