import{x as m,B as Ie,E as ht}from"./iframe-XN-4DUUg.js";import{t as K,c as T,g as C,P as A,u as M,a as ft,m as bt,s as Mt,D as Nt,b as jt,e as Pt,i as ve,h as Ve,o as J,d as _,f as Bt,j as ye,p as he,n as D,k as Gt,l as $e,q as Ht,r as Wt,v as qt,T as Xt,w as E,x as Ut,y as Kt,z as Jt,A as $,B as Qt,C as Yt,E as xt,F as Ae,G as I,H as vt,I as Ee,J as Zt,K as yt,N as en,L as tn,M as Te,O as nn,Q as Le,R as rn,S as on,U as Fe,V as Re,W as an,X as Oe,Y as P,Z as ln,_ as ze,$ as sn}from"./cosmoz-collapse-Y4tJsllc.js";import"./preload-helper-D9Z9MdNV.js";const un=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,Vt=n=>(e,t,r=Ut)=>{const o=Yt(),i=new URLSearchParams(o.hash.replace("#",""));return n(e,t,r,i),"#!"+Object.assign(o,{hash:i}).href.replace(location.origin,"")},At=n=>n==null||n==="",Ir=Vt((n,e,t,r)=>At(t(e))?r.delete(n):r.set(n,t(e))),Fr=Vt((n,e,t,r)=>Object.entries(e).map(t).forEach(([o,i])=>At(i)?r.delete(n+o):r.set(n+o,i))),Q=(n,e,{suffix:t="",read:r,write:o,multi:i}={})=>{const[a,l]=i?[Fr,Kt]:[Ir,Jt],[s,u]=M(()=>e==null?n:l(e+t,r)??n),c=$(d=>u(h=>{const p=ve(d,h);return e!=null&&Qt(a(e+t,p,o),null,{notify:!1}),p}),[e,t,a,o]);return[s,c]},Or=n=>[!0,"true",1,"yes","on"].includes(n),ae=n=>n===""||(n==null?void 0:Or(n)),le=(n,e,t)=>$(r=>{n(r),t(o=>({...o,[e]:r}))},[n,e,t]),Dr=(n,e,t,r,o)=>{const[i,a]=Q(t.sortOn,e,{suffix:"-sortOn"}),[l,s]=Q(ae(t.descending),e,{suffix:"-descending",read:ae}),[u,c]=Q(t.groupOn,e,{suffix:"-groupOn"}),[d,h]=Q(ae(t.groupOnDescending),e,{suffix:"-groupOnDescending",read:ae}),p=I(()=>n.find(g=>g.name===i),[n,i]),z=I(()=>n.find(g=>g.name===u),[n,u]),b={groupOn:u,setGroupOn:le(c,"groupOn",r),groupOnDescending:d,setGroupOnDescending:le(h,"groupOnDescending",r),sortOn:i,setSortOn:le(a,"sortOn",r),descending:l,setDescending:le(s,"descending",r),columns:n},y=I(()=>b,Object.values(b)),F=$(g=>{a(g.sortOn),c(g.groupOn),s(g.descending),h(g.groupOnDescending)},[]);return E(()=>void(o.current=F),[]),{...y,sortAndGroup:y,groupOnColumn:z,sortOnColumn:p}},Ke=xt();customElements.define("sort-and-group-provider",Ke.Provider);customElements.define("sort-and-group-consumer",T(({render:n})=>n(Ae(Ke)),{useShadowDOM:!1}));const Vr=({data:n,columns:e,groupOnColumn:t,filters:r,setFilterState:o,sortAndGroup:{sortOn:i,setSortOn:a,descending:l,setDescending:s}={}})=>vt(e,u=>u.name,u=>[m`<div
...
`;customElements.define("cosmoz-omnitable-item-expand-line",T(Tr,{styleSheets:[Ee(Er)]}));const Lr=({columns:n,item:e,selected:t,expanded:r,groupOnColumn:o})=>Zt(n,i=>m`<cosmoz-omnitable-item-expand-line
			...
			>`);customElements.define("cosmoz-omnitable-item-expand",T(Lr,{useShadowDOM:!1}));const Rr=(n,e,t)=>n.editable?n.renderEditCell(n,e,t(n,e.item)):n.renderCell(n,e),Mr=({columns:n,groupOnColumn:e,item:t,index:r,selected:o,expanded:i,onItemChange:a})=>vt(n,l=>l.name,l=>m`<div
...
`);a.unshift(i),yt(new File(a,t,{type:"text/csv;charset=utf-8"}))},Pr=(n,e)=>{const t=n.map(o=>o.title),r=e.map(o=>n.map(i=>{const a=i.toXlsxValue(i,o);return a??""}));return r.unshift(t),r},Br=(n,e,t,r)=>{const o=Pr(n,e),i=new en(t).addSheetFromData(o,r).generate();yt(new File([i],t,{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}))},Gr=({columns:n,selectedItems:e,csvFilename:t,xlsxFilename:r,xlsxSheetname:o,topPlacement:i})=>m`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!Te(e.length)}
		part="bottomBar"
