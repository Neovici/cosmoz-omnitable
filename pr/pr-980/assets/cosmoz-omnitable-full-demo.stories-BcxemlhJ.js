import{n as e}from"./chunk-BneVvdWh.js";import{$ as t,X as n,Z as r,et as i,n as a,t as o}from"./iframe-Cp13OLGe.js";import{$ as s,A as c,At as l,B as u,C as d,Ct as f,D as p,Dt as m,E as h,Et as g,F as _,Ft as v,G as y,H as b,I as x,It as S,J as C,K as ee,L as w,Lt as T,M as te,Mt as ne,N as re,Nt as ie,O as ae,Ot as E,P as oe,Pt as se,Q as ce,R as le,Rt as ue,S as de,St as fe,T as pe,Tt as D,U as O,V as me,W as he,X as ge,Y as _e,Z as ve,_ as ye,_t as be,a as xe,at as k,b as A,bt as j,c as Se,ct as Ce,d as we,dt as Te,et as M,f as Ee,ft as De,g as Oe,gt as ke,h as Ae,ht as je,i as Me,it as Ne,j as Pe,jt as Fe,k as Ie,kt as Le,l as Re,lt as ze,m as Be,mt as Ve,n as He,nt as Ue,o as We,ot as N,p as Ge,pt as Ke,q as qe,r as Je,rt as Ye,s as Xe,st as Ze,t as Qe,tt as $e,u as et,ut as tt,v as nt,vt as rt,w as it,wt as at,x as ot,xt as P,y as st,yt as ct,z as F,zt as lt}from"./dist-vPY_klt_.js";var ut,dt=e((()=>{j(),ut=()=>t`<style>
	@keyframes rotating {
		100% {
...
</style>`,customElements.define(`cz-spinner`,P(ut))})),ft,pt,I=e((()=>{O(),j(),ft=y`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,customElements.define(`cosmoz-clear-button`,P(pt))})),L,mt,ht,gt,_t,R,z=e((()=>{N(),L=({valuePath:e},t)=>k(t,e),mt=L,ht=L,gt=({valuePath:e},t)=>n=>{let r=k(n,e);return r==null?!1:r.toString().toLowerCase().trim().includes(t.toLowerCase().trim())},_t=(e,t)=>t===``||t==null?null:t,R=e=>class extends e{static get properties(){return{isOmnitableColumn:{type:Boolean,value:!0},title:{type:String},valuePath:{type:String,notify:!0},values:{type:Array,notify:!0},filter:{type:Object},noLocalFilter:{type:Boolean},disabled:{type:Boolean,value:!1,notify:!0},editable:{type:Boolean,notify:!0},loading:{type:Boolean,value:!1,notify:!0},externalValues:{type:Boolean,value:!1,notify:!0},name:{type:String},sortOn:{type:String},groupOn:{type:String},noSort:{type:Boolean,value:!1},disabledFiltering:{type:Boolean,value:!1},width:{type:String,value:`75px`},minWidth:{type:String,value:`40px`},flex:{type:String,value:`1`},cellClass:{type:String,value:`default-cell`},headerCellClass:{type:String,value:`default-header-cell`},priority:{type:Number,value:0},hidden:{type:Boolean,notify:!0},preferredDropdownHorizontalAlign:{type:String,value:`right`},renderHeader:{type:Function},renderCell:{type:Function},renderEditCell:{type:Function},renderGroup:{type:Function},mini:{type:Number,value:null},renderMini:{type:Function}}}static get observers(){return[`notifyFilterChange(filter)`]}notifyFilterChange(e){this.__ownChange||this.dispatchEvent(new CustomEvent(`legacy-filter-changed`,{detail:{name:this.name,state:this.legacyFilterToState(e)},bubbles:!0}))}legacyFilterToState(e){return{filter:e}}getFilterFn(){}getString(e,t){return L(e,t)}toXlsxValue(e,t){return mt(e,t)}cellTitleFn(e,t){return this.getString(e,t)}headerTitleFn(e){return e.title}serializeFilter(e,t){return _t(e,t)}deserializeFilter(e,t){return t==null?null:typeof t==`string`?window.decodeURIComponent(t):t}getComparableValue(e,t){return ht(e,t)}computeSource(e,t){return t}_propertiesChanged(e,t,n){super._propertiesChanged(e,t,n),this.dispatchEvent(new CustomEvent(`cosmoz-column-prop-changed`,{bubbles:!0}))}}})),vt,yt,bt,xt,St,Ct,wt,Tt=e((()=>{x(),I(),M(),i(),S(),z(),vt=e=>t=>e(n=>{if(n.inputValue===void 0&&t.target.value===``)return n;clearTimeout(n.t);let r=setTimeout(()=>e(e=>({...e,filter:e.inputValue})),1e3);return{...n,inputValue:t.target.value,t:r}}),yt=e=>()=>e(e=>({...e,filter:e.inputValue})),bt=e=>t=>{t.keyCode===13&&(t.preventDefault(),e(e=>({...e,filter:e.inputValue})))},xt=e=>t=>e(e=>({...e,headerFocused:t.detail.value})),St=e=>()=>e(e=>({...e,filter:null,inputValue:null})),Ct=e=>e!=null&&e!==``,wt=class extends R(s){static get properties(){return{minWidth:{type:String,value:`55px`},editMinWidth:{type:String,value:`55px`},inputValue:{type:Object,notify:!0}}}getFilterFn(e,t){if(!(t==null||t===``))return gt(e,t)}renderCell(e,{item:n}){return t`<span class="default-column">${L(e,n)}</span>`}renderEditCell(e,{item:n},r){return t`<cosmoz-input
		...
		>
			${T(!e.disabledFiltering,()=>t`<cosmoz-clear-button
						...
						@click=${St(a)}
					></cosmoz-clear-button>`)}
		</cosmoz-input>`}legacyFilterToState(e){return{filter:e,inputValue:e}}},customElements.define(`cosmoz-omnitable-column`,wt)})),Et,Dt,Ot,B=e((()=>{x(),j(),i(),Et=[`label`,`value`,`slot`,`always-float-label`,`disabled`],Dt=Fe`
	${b}
...
`,Ot=e=>{let{label:n,value:r,slot:i}=e;return ve(t`<div
		id="input"
		part="input"
		role="button"
		class="control"
	...
	>
		${r||``}
	</div>`,{label:n})},customElements.define(`cosmoz-omnitable-dropdown-input`,P(Ot,{observedAttributes:Et,styleSheets:[Dt]}))})),V,kt=e((()=>{De(),i(),_(),B(),V=({title:e,tooltip:n=``,filterText:r=``,onOpenedChanged:i,content:a,horizontalAlign:o=`left`,externalValues:s=null})=>t`
		<style>
			.dropdown {
				outline: none;
			}
	...
	`})),At,jt,Mt=e((()=>{ze(),Ye(),re(),c(),At=e=>e?typeof e.close==`function`?e:At(e.parentElement):null,jt=e=>class extends e{static get properties(){return{disabled:{type:Boolean,value:!1},filter:{type:Object,notify:!0},values:{type:Array,value(){return[]}},headerFocused:{type:Boolean,notify:!0},min:{type:Number,value:null},max:{type:Number,value:null},limits:{type:Function},autoupdate:{type:String,value:!0},locale:{type:String,value:null},_filterInput:{type:Object,value(){return{min:null,max:null}}},_range:{type:Object,computed:`_computeRange(values.*)`},_limit:{type:Object,computed:`_computeLimit(_range, _filterInput.*, min, max)`,value(){return{}}},_tooltip:{type:String,computed:`_computeTooltip(title, _filterText)`},_fromClasses:{type:String,computed:`_computeInputClasses(_filterInput.min)`},_toClasses:{type:String,computed:`_computeInputClasses(_filterInput.max)`}}}static get observers(){return[`_filterInputChanged(_filterInput.*, autoupdate)`,`_filterChanged(filter.*)`,`_updateLimits(limits, headerFocused)`]}disconnectedCallback(){this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),super.disconnectedCallback()}_computeInputClasses(e){return e!=null&&e!==``?`has-value`:``}toNumber(e,t,n){if(e==null||e===``)return;let r=typeof e==`number`?e:Number(e);if(Number.isNaN(r))return;if(n==null||t==null)return r;let i=this.toNumber(t);return i==null?r:n(r,i)}toValue(){return this.toNumber.apply(this,arguments)}getComparableValue(e,t){if(e==null)return;let n=e;return t!=null&&(n=this.get(t,e)),this.toValue(n)}renderValue(){}getInputString(e,t=this.valuePath){let n=this.toValue(this.get(t,e));return this._toInputString(n)}_computeRange(e){let t=e.base,n=Array.isArray(t)&&t.length&&t.map(e=>this.toValue(e)).filter(e=>e!=null);return!n||n.length<1?{min:null,max:null}:n.reduce((e,t)=>({min:this.toValue(t,e.min,Math.min),max:this.toValue(t,e.max,Math.max)}),{})}_computeLimit(e,t,n,r){if(!e)return;let i=t.base,a=this.toValue(n),o=this.toValue(r),s=a??this.toValue(e.min),c=o??this.toValue(e.max);return{fromMin:s,fromMax:this.toValue(c,this._fromInputString(i.max,`max`),Math.min),toMin:this.toValue(s,this._fromInputString(i.min,`min`),Math.max),toMax:c}}_computeFilterText(e){if(e.base==null)return;let t=e.base,n=this.toValue(t.min),r=this.toValue(t.max),i=[];return n!=null&&i.push(this.renderValue(n)),i.push(` - `),r!=null&&i.push(this.renderValue(r)),i.length>1?i.join(``):void 0}_computeTooltip(e,t){return t==null?e:`${e}: ${t}`}_fromInputString(e){return this.toValue(e)}_toInputString(e){return this.toValue(e)??null}_getDefaultFilter(){return{min:null,max:null}}_filterInputChanged(e,t){this.__inputChangePath=e.path.split(`.`)[1]||null,t&&(this._limitInputDebouncer=Pe.debounce(this._limitInputDebouncer,Ne.after(600),()=>{this._limitInput(),this._updateFilter()}),te(this._limitInputDebouncer))}_clearFrom(){this.set(`_filterInput.min`,null),this._updateFilter()}_clearTo(){this.set(`_filterInput.max`,null),this._updateFilter()}_onBlur(){this._limitInput(),this._updateFilter()}_onKeyDown(e){let t=e.currentTarget,n=Array.from(t.parentElement.querySelectorAll(`cosmoz-input`)),r=n[n.findIndex(e=>e===t)+1],i=!r,a=n[0]===t;switch(e.keyCode){case 13:if(e.preventDefault(),!i)r.focus();else{let e=this._limitInput();this._updateFilter(),e||this._closeParent(t)}break;case 9:(i&&!e.shiftKey||a&&e.shiftKey)&&this._closeParent(t)}}_closeParent(e){let t=At(e);t&&t.close()}_onDropdownOpenedChanged({currentTarget:e,type:t,detail:n}){(t===`focus`||n?.value===!0)&&setTimeout(()=>{e.querySelector(`cosmoz-input:focus`)||e.querySelector(`cosmoz-input`)?.focus()},100)}_limitInput(){let e=this._filterInput,t=this.__inputChangePath,n=t?this._fromInputString(this.get(t,e),t):null;if(this.__inputChangePath=null,n==null)return!1;let r=this._limit,i=t===`min`?`from`:`to`,a=this.get(i+`Min`,r),o=this.get(i+`Max`,r),s=this.toValue(n,a,Math.max),c=this.toValue(s,o,Math.min);return this.getComparableValue(n)===this.getComparableValue(c)?!1:(this.set([`_filterInput`,t],this._toInputString(c,t)),this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),!0)}_updateFilter(){let e=this._filterInput,t=this.filter,n=this._fromInputString(e.min,`min`),r=this._fromInputString(e.max,`max`);this.getComparableValue(n)===this.getComparableValue(t,`min`)&&this.getComparableValue(r)===this.getComparableValue(t,`max`)||this.set(`filter`,{min:n,max:r})}_filterChanged(e){if(this._filterInput==null)return;let t=this._filterInput,n=e.base,r=this._fromInputString(t.min,`min`),i=this._fromInputString(t.max,`max`);this.getComparableValue(r)===this.getComparableValue(n,`min`)&&this.getComparableValue(i)===this.getComparableValue(n,`max`)||(this.set(`_filterInput`,{min:this._toInputString(n.min),max:this._toInputString(n.max)}),this._limitInputDebouncer&&this._limitInputDebouncer.cancel())}hasFilter(){let e=this.filter;return e==null?!1:this.toValue(e.min)!=null||this.toValue(e.max)!=null}resetFilter(){this.filter=this._getDefaultFilter()}_updateLimits(e,t){e&&Promise.resolve(tt(e,{active:t})).then(e=>{let{min:t,max:n}=e??{};Object.assign(this,{...t==null?{}:{min:t},...n==null?{}:{max:n}})})}}})),H,Nt=e((()=>{M(),i(),H=e=>class extends e{static get template(){return $e`<div id="output" style="position:relative;"></div>`}connectedCallback(){super.connectedCallback(),r(this.render(),this.$.output)}_propertiesChanged(e,t,n){super._propertiesChanged(e,t,n),requestAnimationFrame(()=>r(this.render(),this.$.output))}}})),Pt,Ft=e((()=>{x(),M(),o(),i(),S(),kt(),B(),Mt(),Nt(),Pt=class extends jt(H(s)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:`_computeFilterText(filter.*, _formatters)`},headerFocused:{type:Boolean,value:!1}}}static get observers(){return[`_valuesChanged(autodetect, currency, values)`]}render(){let e=e=>{this.headerFocused=e.type===`focus`,this._onDropdownOpenedChanged(e)};return t`
		...
		></cosmoz-input>`}renderHeader(e,{filter:n,query:r},i,a){return t`<cosmoz-autocomplete-excluding
			...
			@value-changed=${at(vn(i))}
			@text-changed=${at(bn(i))}
			>${T(e.loading,()=>t`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-excluding
		>`}getComparableValue(e,t){return Tn(e,t)}getFilterFn(e,t){if(!(!t||!Array.isArray(t)||t.length===0))return En(e,t)}},customElements.define(`cosmoz-omnitable-column-autocomplete-excluding`,Dn)})),kn,An,jn=e((()=>{Oe(),Ae(),M(),i(),S(),nt(),st(),wn(),z(),N(),on(),kn=({valuePath:e,textProperty:t,valueProperty:n},r)=>{let i=t?de(t):A(n),a=ye(e&&k(r,e)).map(i);return a.length>1?a.filter(Boolean).join(`,`):a[0]},An=class extends Cn(R(s)){static get properties(){return{headerCellClass:{type:String,value:`autocomplete-header-cell`},minWidth:{type:String,value:`55px`},editMinWidth:{type:String,value:`55px`},keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},showSingle:{type:Boolean},preserveOrder:{type:Boolean},limit:{type:Number},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,showSingle:e.showSingle,preserveOrder:e.preserveOrder,limit:e.limit,textual:e.textual}}renderCell(e,{item:n}){return t`<span class="default-column"
			>${e.getString(e,n)}</span
		>`}renderEditCell(e,{item:n},r){return t`<cosmoz-input
			no-label-float
			type="text"
		...
		>`}getComparableValue(e,t){return kn(e,t)}},customElements.define(`cosmoz-omnitable-column-autocomplete`,An)})),Mn,Nn,Pn,Fn,In,Ln,Rn,zn,Bn,Vn,Hn,Un,Wn,Gn,Kn=e((()=>{M(),z(),Oe(),p(),N(),i(),S(),Mn=(e,t)=>t.find(({value:t})=>e===t),Nn=(e,t,n)=>{let r=Mn(t,n);return r?r.text:e},Pn=(e,t,n,r)=>Nn(e,k(t,n),r),Fn=({valuePath:e},t,n)=>Mn(k(t,e),n),In=e=>t=>{e(e=>({...e,filter:t?.[0]?.value??null}))},Ln=e=>t=>{e(e=>({...e,headerFocused:t}))},Rn=e=>t=>{e(e=>({...e,query:t}))},zn=e=>t=>e(t?.[0]?.value),Bn=({valuePath:e,trueLabel:t,falseLabel:n},r)=>k(r,e)?t:n,Vn=({valuePath:e},t)=>n=>k(n,e)===t,Hn=ae((e,t)=>[{text:e,value:!0},{text:t,value:!1}]),Un=({valuePath:e,trueLabel:t,falseLabel:n},r)=>e?k(r,e)?t:n:``,Wn=(e,t)=>{try{return JSON.parse(t)}catch{return null}},Gn=class extends R(s){static get properties(){return{trueLabel:{type:String,value:`True`},falseLabel:{type:String,value:`False`},flex:{type:String,value:`0`},cellClass:{type:String,value:`boolean-cell`}}}getString(e,t){return Bn(e,t)}renderCell(e,{item:t}){return Bn(e,t)}renderEditCell(e,{item:n},r){let{trueLabel:i,falseLabel:a}=e;return t`<cosmoz-autocomplete
			no-label-float
			...
			${T(this.disabled,()=>t`
				...
				`,()=>t`
					...
					${V({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:t`
						...
						`})}
				`)}
		`}_fromInputString(e,t){let n=this.toDate(e);if(n!=null)return t===`min`&&n.setHours(0,0,0,0),t===`max`&&n.setHours(23,59,59),n}_filterInputChanged(e,t){let n=e.path.split(`.`)[1]&&e.value;if(n&&n.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}},customElements.define(`cosmoz-omnitable-date-range-input`,Yn)})),Zn,Qn,$n,Y,X,er,tr,nr,rr,ir,ar,or,sr,cr,lr,ur=e((()=>{qe(),N(),Ht(),Zn=e=>{let t=-new Date(e).getTimezoneOffset()/60;return(t<0?`-`:`+`)+[`0`,Math.abs(t)].join(``).substr(-2)+`:00`},Qn=e=>e.length===19?e+Zn(e):e,$n=e=>{if(e==null||e===``)return;let t=e;return!(t instanceof Date)&&(typeof e==`string`&&(t=Qn(t)),t=ee(t),!t)||Number.isNaN(t.getTime())?null:t},Y=({valuePath:e},t)=>{if(t==null)return;let n=t;e!=null&&(n=k(t,e));let r=$n(n);if(r!=null)return U(r.getTime())},X=(e,t,n)=>{let r=$n(e);if(r==null)return null;if(n==null||t==null)return r;let i=X(t);if(i==null)return r;let a=Y({},r),o=Y({},i);return a==null||o==null||n(a,o)===a?r:i},er=(e,t)=>{if(t==null)return;let n=X(e);if(n!=null)return t.format(n)},tr={},nr=e=>{let t=e||``;return tr[t]||(tr[t]=new Intl.DateTimeFormat(e||void 0)),tr[t]},rr=({valuePath:e,locale:t},n)=>{let r=k(n,e||``);return r===void 0?``:(r=X(r),r===null?`Invalid Date`:er(r,nr(t)))},ir=e=>{let t=X(e);if(t==null)return null;let n=C(t);return n==null?null:n.slice(0,10)},ar=({valuePath:e},t)=>ir(k(t,e||``)),or=(e,t)=>{let n=X(e);if(n!=null)return t===`min`&&n.setHours(0,0,0,0),t===`max`&&n.setHours(23,59,59),n},sr=e=>ir(e)??``,cr=({valuePath:e},t)=>{if(!e)return``;let n=X(k(t,e));if(!n)return``;let r=X(C(n));return r?(r.setHours(0,0,0,0),r):``},lr=(e,t)=>n=>{let r=Y(e,n);if(r==null)return!1;let i=Y({...e,valuePath:`min`},t),a=Y({...e,valuePath:`max`},t);return!(r<(i??-1/0)||r>(a??1/0))}})),dr,fr=e((()=>{x(),M(),i(),z(),Xn(),J(),ur(),I(),dr=class extends R(s){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:`date-header-cell`},width:{type:String,value:`100px`},minWidth:{type:String,value:`82px`},flex:{type:String,value:`0`}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){let n=Y({...e,valuePath:`min`},t),r=Y({...e,valuePath:`max`},t);if(!(n==null&&r==null))return lr(e,t)}getString(e,t){return rr(e,t)}toXlsxValue(e,t){return cr(e,t)}getComparableValue(e,t){return Y(e,t)}serializeFilter(e,t){if(t==null)return;let n=X(t.min),r=X(t.max);if(!(n==null&&r==null))return sr(n)+`~`+sr(r)}deserializeFilter(e,t){if(t==null||t===``)return null;let n=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(n)?{min:X(n[1]),max:X(n[2])}:null}renderCell(e,{item:n}){return t`<div class="omnitable-cell-date">
			${rr(e,n)}
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return cn(e,t)}},customElements.define(`cosmoz-omnitable-column-date`,dr)})),pr,mr=e((()=>{M(),o(),i(),S(),Jn(),kt(),B(),Nt(),pr=class extends qn(H(s)){render(){let e=e=>{this.headerFocused=e.type===`focus`};return t`
			<style>
		...
		></cosmoz-omnitable-datetime-range-input>`}computeSource(e,t){return cn(e,t)}},customElements.define(Sr.is,Sr)})),wr,Tr=e((()=>{Oe(),Ae(),M(),i(),S(),wn(),z(),wr=class extends Cn(R(s)){renderCell({valuePath:e,textProperty:n},{item:r}){return t`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		`}renderEditCell(){return`not implemented`}renderHeader(e,{filter:n,query:r},i,a){return t`<cosmoz-autocomplete-ui
			...
			.onText=${bn(i)}
			>${T(e.loading,()=>t`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}},customElements.define(`cosmoz-omnitable-column-list-horizontal`,wr)})),Er,Dr,Or=e((()=>{O(),j(),o(),Er=y`
	:host {
		display: block;
	}
...
`,Dr=({items:e})=>{let[n,r]=D(!1),i=Array.isArray(e)?e:[],o=E(()=>Math.max(0,i.length-1),[i]);if(i.length===0)return null;let s=i.length>2,c=i[0],l=s&&!n?[]:i.slice(1),u=e=>{e.stopPropagation(),e.preventDefault(),r(e=>!e)};return t`
		<ul>
			<li>
				<span>${c}</span>
			</li>
	...
	`},customElements.define(`cosmoz-omnitable-column-list-data`,P(Dr,{styleSheets:[he(Er)]}))})),kr,Ar=e((()=>{Or(),M(),i(),S(),Oe(),wn(),z(),on(),kr=class extends Cn(R(s)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:n},{item:r}){return t`<cosmoz-omnitable-column-list-data
		...
		></cosmoz-input>`}renderHeader(e,{filter:n,query:r},i,a){return t`<cosmoz-autocomplete-ui
			...
			.onText=${bn(i)}
			>${T(e.loading,()=>t`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}},customElements.define(`cosmoz-omnitable-column-list`,kr)})),jr,Mr=e((()=>{x(),M(),o(),i(),S(),kt(),B(),Mt(),Nt(),jr=class extends jt(H(s)){static get properties(){return{maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null},formatter:{type:Object,computed:`_computeFormatter(locale, minimumFractionDigits, maximumFractionDigits)`},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:`_computeFilterText(filter.*, formatter)`},headerFocused:{type:Boolean,value:!1}}}render(){let e=e=>{this.headerFocused=e.type===`focus`,this._onDropdownOpenedChanged(e)};return t`
			<style>
				cosmoz-input[type='number'] {
					background: var(--cosmoz-omnitable-amount-input-background, #ffffff);
					border-radius: 6px;
		...
		></cosmoz-omnitable-number-range-input>`}computeSource(e,t){return cn(e,t)}},customElements.define(`cosmoz-omnitable-column-number`,Nr)})),Fr,Ir=e((()=>{x(),M(),o(),i(),S(),Jn(),kt(),B(),Nt(),Fr=class extends qn(H(s)){render(){let e=e=>{this.headerFocused=e.type===`focus`};return t`
			${T(this.disabled,()=>t`
					<cosmoz-omnitable-dropdown-input
						disabled
						.label=${this.title}
		...
		></cosmoz-input>`}renderHeader({title:e,min:n,max:r,locale:i,filterStep:a,disabledFiltering:o},{filter:s},c,l){return t`<cosmoz-omnitable-time-range-input
			...
			@filter-changed=${({detail:{value:e}})=>c(t=>({...t,filter:e}))}
			@header-focused-changed=${({detail:{value:e}})=>c(t=>({...t,headerFocused:e}))}
		></cosmoz-omnitable-time-range-input>`}computeSource(e,t){return cn(e,t)}},customElements.define(`cosmoz-omnitable-column-time`,qr)})),Yr=e((()=>{dn(),On(),jn(),Kn(),fr(),Cr(),Tr(),Ar(),Pr(),Jr()})),Xr,Zr=e((()=>{j(),i(),Xr=({column:e,item:t,selected:r,folded:i,group:a})=>e?(e.renderGroup??e.renderCell)(e,{item:t,selected:r,folded:i,group:a}):n,customElements.define(`cosmoz-omnitable-group-row`,P(Xr,{useShadowDOM:!1}))})),Qr,$r=e((()=>{j(),i(),Qr=e=>{let{column:t}=e;return l(()=>{let n=0,r=0,i=i=>{e.dispatchEvent(new CustomEvent(`column-resize`,{bubbles:!0,composed:!0,detail:{newWidth:Math.ceil(r+i.pageX-n),column:t}}))},a=()=>{document.removeEventListener(`pointermove`,i),document.removeEventListener(`pointerup`,a)},o=t=>{n=t.pageX,r=e.previousElementSibling.getBoundingClientRect().width,document.addEventListener(`pointermove`,i),document.addEventListener(`pointerup`,a)};return e.addEventListener(`pointerdown`,o),()=>e.removeEventListener(`pointerdown`,o)},[t]),n},customElements.define(`cosmoz-omnitable-resize-nub`,P(Qr))})),ei,ti,ni,ri,ii=e((()=>{i(),ei=t`<svg
	width="10"
	height="9"
	viewBox="0 0 10 9"
	stroke="currentColor"
...
>
	...
	/>
</svg> `})),ai,oi,si,ci,li=e((()=>{j(),ue(),ii(),ai=({column:e,on:n,descending:r,setOn:i,setDescending:a})=>{let{name:o,title:s}=e??{};return t`<button
		class="sg"
		title=${lt(s)}
...
`}));function ui(e,t,{suffix:n=``,read:r,write:i,ready:a=!0,multi:o}={}){let s=Ve({param:t,suffix:n,link:o?mi:pi,write:i??Ce}),c=E(()=>{if(t==null)return!1;if(o){let e=et(t+n);return Object.keys(e).length>0}return we(t+n)!==void 0},[]),[u,d]=D(()=>{if(t==null)return e;if(o){let i=et(t+n,r);return Object.keys(i).length>0?i:e}return we(t+n,r)??e}),f=m(e=>d(t=>{let n=tt(e,t);return s.param!=null&&Ge(s.link(s.param+s.suffix,n,s.write),null,{notify:!1}),n}),[]);return l(()=>{s.param==null||!a||c||e!=null&&f(e)},[a]),[u,f]}var di,fi,pi,mi,hi=e((()=>{Ee(),ze(),Ke(),Re(),j(),di=e=>(t,n,r=Ce)=>{let i=Se(),a=new URLSearchParams(i.hash.replace(`#`,``));return e(t,n,r,a),`#!`+Object.assign(i,{hash:a}).href.replace(location.origin,``)},fi=e=>e==null||e===``,pi=di((e,t,n,r)=>fi(n(t))?r.delete(e):r.set(e,n(t))),mi=di((e,t,n,r)=>{let i=Object.entries(t),a=i.map(n).filter(([,e])=>e!==void 0);if(a.length===0&&i.length>0)return;let o=e;Array.from(r.keys()).filter(e=>e.startsWith(o)).forEach(e=>r.delete(e)),a.forEach(([t,n])=>fi(n)?r.delete(e+t):r.set(e+t,n))})})),gi,_i,vi,yi,bi,xi=e((()=>{j(),hi(),gi=e=>[!0,`true`,1,`yes`,`on`].includes(e),_i=e=>e===``||(e==null?void 0:gi(e)),vi=(e,t,n)=>m(r=>{e(r),n(e=>({...e,[t]:r}))},[e,t,n]),yi=(e,t,{settings:n,setSettings:r,resetRef:i,ready:a=!0})=>{let[o,s]=ui(n.sortOn,t,{suffix:`-sortOn`,ready:a}),[c,u]=ui(_i(n.descending),t,{suffix:`-descending`,read:_i,ready:a}),[d,f]=ui(n.groupOn,t,{suffix:`-groupOn`,ready:a}),[p,h]=ui(_i(n.groupOnDescending),t,{suffix:`-groupOnDescending`,read:_i,ready:a}),g=E(()=>e.find(e=>e.name===o),[e,o]),_=E(()=>e.find(e=>e.name===d),[e,d]),v={groupOn:d,setGroupOn:vi(f,`groupOn`,r),groupOnDescending:p,setGroupOnDescending:vi(h,`groupOnDescending`,r),sortOn:o,setSortOn:vi(s,`sortOn`,r),descending:c,setDescending:vi(u,`descending`,r),columns:e},y=E(()=>v,Object.values(v)),b=m(e=>{s(e.sortOn),f(e.groupOn),u(e.descending),h(e.groupOnDescending)},[]);return l(()=>void(i.current=b),[]),{...y,sortAndGroup:y,groupOnColumn:_,sortOnColumn:g}},bi=fe(),customElements.define(`sort-and-group-provider`,bi.Provider),customElements.define(`sort-and-group-consumer`,P(({render:e})=>e(Le(bi)),{useShadowDOM:!1}))})),Si,Ci,wi=e((()=>{j(),h(),$r(),li(),S(),xi(),Si=({data:e,columns:n,groupOnColumn:r,filters:i,setFilterState:a,sortAndGroup:{sortOn:o,setSortOn:s,descending:c,setDescending:l}={}})=>pe(n,e=>e.name,n=>[t`<div
			...
			>
				...
				${T(!n.noSort,()=>ai({on:o,setOn:s,descending:c,setDescending:l,column:n}))}
			</div>`,t`<cosmoz-omnitable-resize-nub
				.column="${n}"
				name="${n.name}"
			></cosmoz-omnitable-resize-nub>`]),Ci=({columns:e,settingsConfig:n,hideSelectAll:r,...i})=>{let a=Le(bi);return t`
		${T(e,e=>Si({columns:e,sortAndGroup:a,...i}))}
		${T(!r,()=>t` <cosmoz-omnitable-settings
					.config=${n}
					part="settings"
				></cosmoz-omnitable-settings>`)}
	`},customElements.define(`cosmoz-omnitable-header-row`,P(Ci,{useShadowDOM:!1}))})),Ti,Ei,Di=e((()=>{j(),O(),Ti=y`
	:host {
		display: flex;
		align-items: center;
		flex-wrap: wrap;
...
`,customElements.define(`cosmoz-omnitable-item-expand-line`,P(Ei,{styleSheets:[he(Ti)]}))})),Oi,ki=e((()=>{j(),i(),We(),Di(),Oi=({columns:e,item:n,selected:r,expanded:i,groupOnColumn:a})=>Xe(e,e=>t`<cosmoz-omnitable-item-expand-line
				.column=${e}
				?hidden=${e===a}
				exportparts="item-expand-label, item-expand-value"
				>${e.renderCell(e,{item:n,selected:r,expanded:i})}</cosmoz-omnitable-item-expand-line
			>`),customElements.define(`cosmoz-omnitable-item-expand`,P(Oi,{useShadowDOM:!1}))})),Ai,ji,Mi=e((()=>{j(),h(),Ai=(e,t,n)=>e.editable?e.renderEditCell(e,t,n(e,t.item)):e.renderCell(e,t),ji=({columns:e,groupOnColumn:n,item:r,index:i,selected:a,expanded:o,onItemChange:s})=>pe(e,e=>e.name,e=>t`<div
			...
			</div>`),customElements.define(`cosmoz-omnitable-item-row`,P(ji,{useShadowDOM:!1}))})),Ni,Pi,Fi=e((()=>{O(),Ni=y`
	.checkbox {
		box-sizing: border-box;
		width: 18px;
		height: 18px;
...
`})),Ii,Li,Ri=e((()=>{Me(),Ii=e=>{let t=e.replace(/"/gu,`""`);return t.search(/("|,|\n)/gu)>=0?`"`+t+`"`:e},Li=(e,t,n)=>{let r=e.map(e=>Ii(e.title)).join(`;`)+`
`,i=t.map(t=>e.map(e=>{let n=e.getString(e,t);return n==null?``:Ii(String(n))}).join(`;`)+`
`);i.unshift(r),xe(new File(i,n,{type:`text/csv;charset=utf-8`}))}})),zi,Bi,Vi=e((()=>{Me(),He(),zi=(e,t)=>{let n=e.map(e=>e.title),r=t.map(t=>e.map(e=>e.toXlsxValue(e,t)??``));return r.unshift(n),r},Bi=(e,t,n,r)=>{let i=zi(e,t),a=new Je(n).addSheetFromData(i,r).generate();xe(new File([a],n,{type:`application/vnd.openxmlformats-officedocument.spreadsheetml.sheet`}))}})),Hi,Ui=e((()=>{_e(),o(),i(),Ri(),Vi(),Hi=({columns:e,selectedItems:n,csvFilename:r,xlsxFilename:i,xlsxSheetname:o,topPlacement:s})=>t`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!ge(n.length)}
		part="bottomBar"
	...
	</sort-and-group-provider>`})),Ki,qi,Ji=e((()=>{j(),Ki=Fe`
	:host {
		max-width: 100%;
		overflow-x: hidden;
		padding: 0 12px;
...
`,qi=({settingsConfig:e})=>{let{columns:n,collapsed:r}=e,i=n.filter(e=>!r.some(t=>t.name===e.name));return t`<div class="skeleton">
	...
	</div>`},customElements.define(`cosmoz-omnitable-skeleton`,P(qi,{styleSheets:[Ki]}))})),Yi,Xi=e((()=>{Ji(),o(),i(),S(),ne(),Yi=(e,n)=>{let{settingsConfig:r}=e,{processedItems:i,dataIsValid:o,filterIsTooStrict:s,loading:c,displayEmptyGroups:l,compareItemsFn:u,setSelectedItems:d,renderItem:f,renderGroup:p,error:m}=n;return t`${T(!c&&!o&&!m,()=>t`<div class="tableContent-empty">
...
`})),ea,ta,na=e((()=>{j(),Ke(),ea=e=>{let t=parseInt(e,10);return isFinite(t)?t:void 0},ta=e=>{let{config:t}=e,{settings:n,setSettings:r,collapsed:i}=t,a=Ve({collapsed:i,settings:n.columns,setSettings:m(e=>r(t=>({...t,columns:e})),[r])});return{...t,onDown:m(e=>{e.target.closest(`.pull`)&&(a.handle=e.currentTarget)},[a]),onDragStart:m(e=>{let{target:t}=e,n=ea(t.dataset.index);if(!a.handle?.contains(t)||n==null)return e.preventDefault();a.handle=null,e.dataTransfer.effectAllowed=`move`,e.dataTransfer.setData(`omnitable/sort-index`,n),e.dataTransfer.setData(`text/plain`,n),setTimeout(()=>t.classList.add(`drag`),0),t.addEventListener(`dragend`,e=>e.target.classList.remove(`drag`),{once:!0})},[a]),onDragEnter:m(e=>{let t=e.currentTarget;t===e.target&&(e.preventDefault(),e.dataTransfer.dropEffect=`move`,t.classList.add(`dragover`))},[]),onDragOver:m(e=>{e.preventDefault(),e.currentTarget.classList.add(`dragover`)},[]),onDragLeave:m(e=>{let t=e.currentTarget;t.contains(e.relatedTarget)||t.classList.remove(`dragover`)},[]),onDrop:m(e=>{let t=ea(e.dataTransfer.getData(`omnitable/sort-index`)),n=ea(e.currentTarget.dataset.index),{settings:r,setSettings:i}=a;e.currentTarget.classList.remove(`dragover`),e.preventDefault();let o=r.slice();o.splice(n+(t>=n?0:-1),0,o.splice(t,1)[0]),i(o)},[a]),onToggle:m(e=>{let{settings:t,setSettings:n}=a,r=t.map(e=>({...e,disabled:e.disabled||a.collapsed?.some(t=>t.name===e.name)})),i=ea(e.target.closest(`[data-index]`)?.dataset.index);r.splice(i,1,{...t[i],disabled:!e.target.checked,priority:e.target.checked?t.reduce((e,t)=>Math.max(e,t.priority),0)+1:t[i].priority}),n(r)},[a])}}})),ra,ia,aa,oa,sa=e((()=>{Qe(),ke(),O(),_e(),j(),o(),S(),ii(),li(),$i(),na(),ra=[be({apply({availableHeight:e,elements:t}){Object.assign(t.floating.style,{maxHeight:`${Math.max(0,e)}px`})}}),...je],ia=({onDragStart:e,onDragEnter:n,onDragOver:r,onDragLeave:i,onDrop:a,onDown:o,onToggle:s,collapsed:c,filters:l})=>(u,d)=>{let f=!!c?.find(e=>e.name===u.name),p=!u.disabled&&!f;return t` <div
			class="item"
			data-index=${d}
			@mousedown=${o}
			draggable="true"
		...
		${T(r,()=>t`<div class="buttons">
				...
				</div>`)}`},customElements.define(`cosmoz-omnitable-settings-ui`,P(aa,{styleSheets:[he(Zi)]})),oa=({config:e,newLayout:n})=>t`
	<cosmoz-dropdown
...
`,customElements.define(`cosmoz-omnitable-settings`,P(oa,{styleSheets:[he(Qi)]}))})),ca,la,ua,da,fa,pa=e((()=>{st(),ca=[`sortOn`,`descending`,`groupOn`,`groupOnDescending`],la=e=>t=>typeof t==`object`&&!!t&&`name`in t&&t.name===e,ua=(e=[],t=[],n=[])=>{let r=t.filter(t=>e.some(la(t.name))),i=e.filter(e=>e.name!=null&&!t.some(la(e.name))&&!n.some(la(e.name))),a=n.filter(e=>!t.some(la(e.name)));return[...r,...a.flatMap(t=>{let n=e.find(e=>e.name===t.name);return n?{...t,title:n.title??t.title??``,minWidth:parseInt(n.minWidth??`0`,10)}:[]}),...i.map(e=>{let{name:t,title:n,priority:r,minWidth:i,width:a,flex:o}=e;return{name:t??``,title:n??``,priority:r??0,minWidth:parseInt(i??`0`,10),width:parseInt(a??`0`,10),flex:parseInt(o??`0`,10)}})]},da=(e,t)=>({...t,...ot(Array.from(ca))(e),columns:e.columns?.map(ot([`name`,`priority`,`width`,`flex`,`disabled`]))}),fa=({columns:e,settings:t,savedSettings:n,initial:r})=>({...Object.fromEntries(ca.flatMap(e=>r?.[e]==null?[]:[[e,r[e]]])),...n?ot(Array.from(ca))(n):{},...t,columns:ua(e,t?.columns,n?.columns)})})),ma,ha=e((()=>{ma=({prefix:e=`omnitable-`}={})=>({write:async(t,n)=>{let r=e+t;try{n?localStorage.setItem(r,JSON.stringify(n)):localStorage.removeItem(r)}catch(e){console.error(e)}},read:async t=>{if(!t)return null;try{let n=localStorage.getItem(e+t);return n==null?null:JSON.parse(n)}catch(e){return console.error(e),null}}})})),ga,_a,va=e((()=>{j(),ha(),ga=fe(ma),_a=()=>{let e=Le(ga);return E(()=>e(),[e])}})),ya=e((()=>{va()})),ba,xa=e((()=>{j(),ya(),pa(),ba=(e,t,n,r)=>{let[i,a]=D(e?void 0:null),{read:o,write:s}=_a();return l(async()=>{e&&a(await o(e))},[e,o]),{settingsId:e,savedSettings:i,onSave:m(async()=>{if(!e)return;let r=da(t,i);await s(e,r),n(),a(r)},[t,i]),onReset:m(async t=>{n(),t.shiftKey&&(await s(e),a(null)),r?.()},[r]),hasChanges:t!=null}}})),Sa,Ca=e((()=>{j(),on(),pa(),xa(),Sa=({settingsId:e,host:t})=>{let n=E(()=>Object.fromEntries(ca.map(e=>[e,t[e]])),[]),r=f(),i=m(()=>{r.current?.(n)},[n]),[a,o]=D(),[s,c]=D({columns:!0,sort:!0}),{savedSettings:l,...u}=ba(e,a,o,i),{enabledColumns:d,disabledFiltering:p}=t,h=an(t,{enabledColumns:d,disabledFiltering:p}),g=E(()=>fa({columns:h,settings:a,savedSettings:l,initial:n}),[h,a,l]),_=E(()=>g.columns.map(e=>h.find(t=>t.name===e.name)).filter(Boolean),[h,...g.columns.map(e=>e.name)]);return{...u,savedSettings:l,opened:s,setOpened:c,settings:g,columns:_,setSettings:o,resetRef:r}}})),wa=e((()=>{sa(),Ca()})),Ta,Ea,Da=e((()=>{Ta=e=>Number.isFinite(e)?e:0,Ea=(e,t)=>{let n=[],[r,i]=e.reduce(([e,t],{width:n,flex:r})=>[e+n,t+r],[0,0]),a=t-r,o=Ta(a/i),s=0,c=0,l=0;for(let t=0;t<e.length;t++){let{width:i,minWidth:u,flex:d}=e[t];if(u>i+(a>=0?o*d:i*a/r)){s+=i,c+=u,l+=d,n[t]=u;continue}if(d===0){s+=i,c+=i,n[t]=i;continue}}r-=s,a=t-c-r,i-=l,o=Ta(a/i);for(let t=0;t<e.length;t++){if(n[t]!=null)continue;let{width:i,flex:s}=e[t];n[t]=i+(a>=0?o*s:i*a/r)}return n}})),Oa,ka,Aa=e((()=>{Oa=Symbol(`index`),ka=(e,t)=>{if(typeof e.findLastIndex==`function`)return e.findLastIndex(t);for(let n=e.length-1;n>=0;n--)if(t(e[n],n,e))return n;return-1}})),ja,Ma,Na,Pa=e((()=>{Da(),Aa(),ja=(e,t)=>{let n=ka(e,e=>e!=null&&e>0),r=(e,t)=>`.cell[name="${e}"], cosmoz-omnitable-skeleton::part(cell-${e}){width: ${Math.floor(t)}px;padding: 0 min(3px, ${t/2}px)}`,i=e=>`cosmoz-omnitable-resize-nub[name="${e}"]{display:none}`,a=e=>`cosmoz-omnitable-resize-nub[name="${e}"], .cell[name="${e}"]{display:none}`;return t.map((t,o)=>{let s=e[o];if(s==null||s===0)return a(t.name);let c=r(t.name,s);return o===n?`${c}\n${i(t.name)}`:c}).join(`
`)},Ma=(e,t,n)=>{let r=e.filter(e=>!e.hidden),i=r.reduce((e,{width:t})=>e+t,0);if(r.length>1&&i>t)return Ma(r.slice(1),t,n);let a=r.reduce(([e,t],n,r)=>[Math.max(e,n.index),n.index>e?r:t],[-1,-1])[1];return a!==-1&&(r[a].flex=1),Ea(r,t).reduce((e,t,n)=>(e[r[n].index]=t,e),Array(n).fill(void 0))},Na=(e,t)=>e.length===0?`.cell {display: none;}`:ja(e,t)})),Fa,Ia=e((()=>{j(),Fa=({host:e,canvasWidth:t,layout:n,setSettings:r})=>{let i=f();i.current=e=>r(r=>{let i=r.columns,{detail:{newWidth:a,column:o}}=e,s=i.findIndex(e=>e.name===o.name),c=[],l=i.reduce((e,t)=>Math.max(e,t.priority),-1/0);for(let e=0;e<n.length;e++)if(c[e]={...i[e]},e<s&&n[e]&&(c[e].width=n[e],c[e].flex=0,c[e].priority=l),e===s){let r=n.reduce((e,t,n)=>n<s&&t?e-t:e,t);c[e].width=Math.min(r,Math.max(a,i[e].minWidth)),c[e].flex=0,c[e].priority=l}return{...r,columns:c}}),l(()=>{let t=e=>i.current?.(e);return e.addEventListener(`column-resize`,t),()=>e.removeEventListener(`column-resize`,t)},[])}})),La,Ra,za=e((()=>{j(),La=88,Ra=(e,t)=>l(()=>{let n=new ResizeObserver(([e])=>{e.contentRect?.width!==0&&requestAnimationFrame(()=>t(e.contentRect?.width-La))});return n.observe(e),()=>n.unobserve(e)},[])})),Ba,Va=e((()=>{j(),za(),Ba=e=>{let[t,n]=D(()=>e.getBoundingClientRect().width-La);return Ra(e,n),t}})),Ha,Ua,Wa,Ga=e((()=>{j(),Ke(),ze(),Ha=(e,t)=>{let n=E(()=>{let t=!1,n,r=()=>{t&&(n=requestAnimationFrame(r),e()&&(t=!1))};return{start:()=>{t=!0,cancelAnimationFrame(n),n=requestAnimationFrame(r)},stop:()=>{t=!1,cancelAnimationFrame(n)}}},[]);l(()=>{n.start()},t),l(()=>()=>n.stop(),[])},Ua=(e=0,t=0)=>Math.abs(e-t)<.1,Wa=(e,t=1.9,n=Te)=>{let r=Ve({target:e});Ha(m(()=>{if(!r.tween)return r.tween=r.target,n(r.tween),!0;if(r.target.every((e,t)=>r.tween[t]===e))return n(r.tween),!0;r.tween=r.target.map((e,n)=>Ua(r.tween[n],e)?e:(r.tween[n]??0)+((e??0)-(r.tween[n]??0))/t||0),n(r.tween)},[]),[e])}})),Ka,qa=e((()=>{j(),Pa(),Ka=({canvasWidth:e,groupOnColumn:t,config:n,miniColumn:r})=>E(()=>{if(!Array.isArray(n)||e==null||e===0)return[];let i=n.map((e,n)=>({minWidth:e.minWidth,width:e.width,flex:e.flex,priority:e.priority,name:e.name,index:n,hidden:e.name===t?.name||e.disabled})).map(e=>r?{...e,hidden:r.name!==e.name}:e).sort(({index:e,priority:t},{index:n,priority:r})=>t===r?n-e:t-r);return Ma(i,e,i.length)},[e,t,n])})),Ja,Ya=e((()=>{j(),Ja=({host:e,canvasWidth:t,columns:n})=>{let r=e.miniBreakpoint??480,i=E(()=>t<=r,[t,r]),[a,...o]=E(()=>i?n?.filter(e=>e.mini!=null).sort((e,t)=>(e.mini??0)-(t.mini??0)):[],[n,i])??[],s=!!a;return l(()=>{e.toggleAttribute(`mini`,s)},[s]),{isMini:s&&i,miniColumn:a,miniColumns:o}}})),Xa,Za,Qa=e((()=>{j(),Pa(),Ia(),Va(),Ga(),qa(),Ya(),Ke(),Xa=e=>{let t=E(()=>new CSSStyleSheet,[]);return l(()=>{e.shadowRoot.adoptedStyleSheets=[...e.shadowRoot.adoptedStyleSheets,t]},[]),t},Za=({host:e,columns:t,settings:n,setSettings:r,resizeSpeedFactor:i,sortAndGroupOptions:a})=>{let o=Ba(e),{isMini:s,miniColumn:c,miniColumns:l}=Ja({host:e,canvasWidth:o,columns:t}),{groupOnColumn:u}=a,d=Ka({canvasWidth:o,groupOnColumn:u,miniColumn:c,config:n.columns}),f=Xa(e),p=E(()=>n.columns.reduce((e,n,r)=>d[r]!=null||n.name===u?.name||n.disabled?e:[...e,t.find(e=>e.name===n.name)],[]),[t,n,d]),m=Ve({columns:n.columns});return Wa(d,i,e=>{let t=Na(e,m.columns);f.replace(t)}),Fa({host:e,canvasWidth:o,layout:d,setSettings:e=>r(e(n))}),{isMini:s,collapsedColumns:p,miniColumns:l}}})),$a,eo=e((()=>{$a=({host:e,...t})=>{let{csvFilename:n=`omnitable.csv`,xlsxFilename:r=`omnitable.xlsx`,xlsxSheetname:i=`Omnitable`,topPlacement:a=`top-end`}=e;return{csvFilename:n,xlsxFilename:r,xlsxSheetname:i,topPlacement:a,...t}}})),to,no=e((()=>{j(),to=({host:e,selectedItems:t,data:n,sortAndGroupOptions:r,collapsedColumns:i,settings:a,filterFunctions:o,settingS:s,filters:c,...u})=>{let d=n&&n.length>0&&t.length===n.length,f=t=>{t.target.checked?e.shadowRoot.querySelector(`#groupedList`).selectAll():e.shadowRoot.querySelector(`#groupedList`).deselectAll()},{groupOnColumn:p}=r,m=E(()=>[p,...i,...a.columns.filter(e=>e.disabled)].some(e=>e&&Object.keys(o).includes(e.name)),[o,a,i]),h=E(()=>({...s,collapsed:i,badge:m,filters:c}),[s,i,m,c]);return l(()=>{let t=e.shadowRoot.querySelector(`#tableContent`),n=new ResizeObserver(t=>requestAnimationFrame(()=>{e.style.setProperty(`--ot-height`,t[0]?.contentRect.height+`px`)}));return n.observe(t),()=>n.unobserve(t)},[]),{allSelected:d,onAllCheckboxChange:f,data:n,settingsConfig:h,filters:c,groupOnColumn:p,sortAndGroup:r.sortAndGroup,...u}}})),ro,io,ao,oo,so,co,lo=e((()=>{j(),S(),_e(),Aa(),J(),ro=t`
	<svg
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
...
`,io=e=>e?`groupRow groupRow-folded`:`groupRow`,ao=({item:e,index:n})=>r=>T(r?.length>0,()=>t`
	...
	`,so=({onCheckboxChange:e,dataIsValid:n,groupOnColumn:r})=>(i,a,{selected:o,folded:s,toggleFold:c})=>t` <div
		...
		</div>`,co=({host:e,error:t,dataIsValid:n,processedItems:r,columns:i,collapsedColumns:a,miniColumns:o,sortAndGroupOptions:s,rowPartFn:c,...u})=>{let{loading:d=!1,displayEmptyGroups:p=!1,compareItemsFn:h}=e,g=f({shiftKey:!1,ctrlKey:!1}),_=m(t=>{let n=t.target.dataItem,r=t.target.checked;g.current.shiftKey?e.shadowRoot.querySelector(`#groupedList`).toggleSelectTo(n,r):g.current.ctrlKey?(t.target.checked=!0,e.shadowRoot.querySelector(`#groupedList`).selectOnly(n)):e.shadowRoot.querySelector(`#groupedList`).toggleSelect(n,r),t.preventDefault(),t.stopPropagation()},[]);l(()=>{let e=({shiftKey:e,ctrlKey:t})=>{g.current={shiftKey:e,ctrlKey:t}};return window.addEventListener(`keydown`,e),window.addEventListener(`keyup`,e),()=>{window.removeEventListener(`keydown`,e),window.removeEventListener(`keyup`,e)}},[]);let v=m(t=>{let n=t.composedPath();n.slice(0,n.indexOf(t.currentTarget)).find(e=>e.matches?.(`a, .checkbox, .expand`))||e.dispatchEvent(new window.CustomEvent(`omnitable-item-click`,{bubbles:!0,composed:!0,detail:{item:t.currentTarget.dataItem,index:t.currentTarget.dataIndex}}))},[]),{groupOnColumn:y}=s,b=m((t,n)=>r=>ln(e,t,n,r),[]);return{...u,processedItems:r,dataIsValid:n,filterIsTooStrict:n&&r.length<1,loading:d,compareItemsFn:h,displayEmptyGroups:p,error:t,renderItem:E(()=>oo({columns:i,collapsedColumns:a,miniColumns:o,onItemClick:v,onCheckboxChange:_,dataIsValid:n,groupOnColumn:y,onItemChange:b,rowPartFn:c}),[i,a,v,_,n,y,b,c]),renderGroup:E(()=>so({onCheckboxChange:_,dataIsValid:n,groupOnColumn:y}),[_,n,y])}}})),uo,fo=e((()=>{uo=(e,t)=>{if(e===t)return 0;if(e==null)return-1;if(t==null)return 1;let n=typeof e,r=typeof t;return n===`object`&&r===`object`?e.toString()<t.toString()?-1:1:n===`number`&&r===`number`?e-t:n===`string`&&r===`string`?e<t?-1:1:n===`boolean`&&r===`boolean`?e?-1:1:(console.warn(`unsupported sort`,n,e,r,t),0)}})),po,mo,ho,go,_o,vo,yo=e((()=>{ze(),j(),fo(),on(),hi(),Aa(),po=(e,t)=>(n,r)=>uo(e(n),e(r))*(t?-1:1),mo=e=>e.replace(/([a-z0-9])([A-Z])/gu,`$1-$2`).toLowerCase(),ho=(e,t)=>{!e||!t||Object.entries(t).forEach(([t,n])=>{e[q].__ownChange=!0,e[q][t]=n,e[q].__ownChange=!1,e[q].dispatchEvent(new CustomEvent(`${mo(t)}-changed`,{bubbles:!0,detail:{value:n}}))})},go=(e,t)=>Object.assign(e,{[Oa]:t}),_o=Symbol(`unparsed`),vo=({data:e,columns:t,hashParam:n,sortAndGroupOptions:r,noLocalSort:i,noLocalFilter:a})=>{let{groupOnColumn:o,groupOnDescending:s,sortOnColumn:c,descending:u}=r,d=m(([e,n])=>{let r=t.find(({name:t})=>t===e);return r==null?[e,void 0]:[e,n.filter&&r.serializeFilter(r,n.filter)]},[t]),f=m(([e,n])=>{let r=t.find(({name:t})=>t===e);if(r==null)return[e,{[_o]:n}];let i={filter:r.deserializeFilter(r,n)};return ho(r,i),[e,i]},[t]),[p,h]=ui({},n,{multi:!0,suffix:`-filter--`,write:d,read:f}),g=m((e,n)=>h(r=>{let i=tt(n,r[e]);return ho(t.find(t=>t.name===e),i),{...r,[e]:{...r[e],...i}}}),[t,h]),_=E(()=>Object.fromEntries(t.map(e=>[e.name,!e.noLocalFilter&&e.getFilterFn(e,p[e.name]?.filter)]).filter(([,e])=>!!e)),[t,...E(()=>Object.values(p).map(e=>e.filter),[p])]),v=E(()=>!Array.isArray(e)||e.length===0?[]:Object.entries(_).length===0||a?e.slice():e.filter(e=>Object.values(_).every(t=>t(e))),[e,_,a]),y=E(()=>{if(!i&&!o&&c!=null&&c.sortOn!=null)return v.slice().sort(po(e=>c.getComparableValue({...c,valuePath:c.sortOn},e),u));if(o!=null&&o.groupOn!=null){let e=v.reduce((e,t)=>{let n=o.getComparableValue({...o,valuePath:o.groupOn},t);if(n===void 0)return e;let r=e.find(e=>e.id===n);return r?(r.items.push(t),e):(r={id:n,name:n,items:[t]},[...e,r])},[]);return e.sort(po(e=>o.getComparableValue({...o,valuePath:o.groupOn},e.items[0]),s)),!c||i?e:e.filter(e=>Array.isArray(e.items)).map(e=>(e.items.sort(po(e=>c.getComparableValue({...c,valuePath:c.sortOn},e),u)),e))}return v},[v,o,s,c,u,i]),b=E(()=>{let e=0,t=0,n=[];return y.forEach(r=>{if(Array.isArray(r.items)){go(r,t++),r.items.forEach(t=>{go(t,e++),n.push(t)});return}return go(r,e++),n.push(r)},[]),n},[y]);return l(()=>{h(e=>Object.values(e).some(e=>e[_o]!=null)?Object.fromEntries(Object.entries(e).map(([e,t])=>t[_o]==null?[e,t]:f([e,t[_o]]))):e)},[f]),{processedItems:y,visibleData:b,filters:p,filterFunctions:_,setFilterState:g}}})),bo,xo,So=e((()=>{u(),j(),w(),bo=e=>{let t=t=>{let n=e.data.indexOf(t);if(n<0)return null;let r=e.data.splice(n,1);if(e.data=e.data.slice(),Array.isArray(r)&&r.length>0)return r[0]},n=(t,n)=>{e.data.splice(t,1,n),e.data=e.data.slice()};return{removeItem:t,removeItems(t){let n=[];for(let r=t.length-1;r>=0;--r){let i=e.removeItem(t[r]);i!=null&&n.push(i)}return n},replaceItemAtIndex:n,replaceItem(t,r){let i=e.data.indexOf(t);if(i>-1)return n(i,r)},selectItem(t){e.shadowRoot.querySelector(`#groupedList`).select(t)},selectAll(){e.shadowRoot.querySelector(`#groupedList`).selectAll()},deselectAll(){e.shadowRoot.querySelector(`#groupedList`).deselectAll()},deselectItem(t){e.shadowRoot.querySelector(`#groupedList`).deselect(t)},isItemSelected(t){return e.shadowRoot.querySelector(`#groupedList`).isItemSelected(t)}}},xo=({host:e,visibleData:t,filters:n,...r})=>{let{setFilterState:i}=r,a=E(()=>bo(e),[]);me(r,Object.values(r)),me(a,Object.values(a)),l(()=>{let t=e=>i(e.detail.name,t=>({...t,...e.detail.state}));return e.addEventListener(`legacy-filter-changed`,t),()=>e.removeEventListener(`legacy-filter-changed`,t)},[]),F(`visibleData`,t),F(`sortedFilteredGroupedItems`,r.sortedFilteredGroupedItems),F(`selectedItems`,r.selectedItems),F(`sortOn`,r.sortOn),F(`descending`,r.descending),F(`isMini`,r.isMini);let o=E(()=>Object.fromEntries(Object.entries(n).filter(([,{filter:e}])=>e!==void 0).map(([e,{filter:t}])=>[e,t])),[n]);F(`filters`,o,Object.values(o))}})),Co,wo=e((()=>{j(),wa(),Qa(),eo(),no(),lo(),yo(),So(),xi(),Co=e=>{let{hashParam:t,settingsId:n,data:r,resizeSpeedFactor:i,noLocal:a,noLocalSort:o=a,noLocalFilter:s=a,error:c,rowPartFn:l}=e,u=Sa({settingsId:n,host:e}),{settings:d,setSettings:f,columns:p,resetRef:m,savedSettings:h}=u,g=yi(p,t,{settings:d,setSettings:f,resetRef:m,ready:h!==void 0}),{processedItems:_,visibleData:v,filters:y,setFilterState:b,filterFunctions:x}=vo({data:r,columns:p,hashParam:t,sortAndGroupOptions:g,noLocalSort:o,noLocalFilter:s}),{isMini:S,collapsedColumns:C,miniColumns:ee}=Za({host:e,columns:p,settings:d,setSettings:f,resizeSpeedFactor:i,sortAndGroupOptions:g}),w=r&&Array.isArray(r)&&r.length>0,[T,te]=D([]);return xo({host:e,visibleData:v,sortedFilteredGroupedItems:_,columns:p,filters:y,setFilterState:b,selectedItems:T,isMini:S,...g}),{header:to({host:e,selectedItems:T,sortAndGroupOptions:g,dataIsValid:w,data:r,columns:p,filters:y,collapsedColumns:C,settings:d,filterFunctions:x,settingS:u,setFilterState:b,hideSelectAll:e.hideSelectAll===!0}),list:co({host:e,error:c,dataIsValid:w,processedItems:_,setSelectedItems:te,columns:p,collapsedColumns:C,miniColumns:ee,sortAndGroupOptions:g,rowPartFn:l}),footer:$a({host:e,selectedItems:T,columns:p})}}})),To=e((()=>{i(),customElements.define(`cosmoz-grouped-list-row`,class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||r(this._renderFn(this._item,this._index),this)}})})),Eo,Do,Oo,ko,Ao,jo,Mo,No,Po,Fo=e((()=>{Eo={group:Symbol(`group`)},Do=(e,t)=>(t.has(e)||t.set(e,{}),t.get(e)),Oo=(e,t)=>!!Do(e,t).expanded,ko=(e,t)=>!!Do(e,t).folded,Ao=e=>e?e.items instanceof Array:!1,jo=e=>{if(!Array.isArray(e)||e.length===0)return;let t=Array.isArray(e[0]?.items);if(!e.every(e=>Array.isArray(e.items)===t))throw Error(`Data must be homogeneous.`)},Mo=(e,t,n)=>{if(Array.isArray(e))return jo(e),e.reduce((e,r)=>{let i=r;return i.items?i.items.length?Do(r,n).folded?e.concat(r):e.concat(r,i.items.map(e=>Object.assign(e,{[Eo.group]:r}))):t?e.concat(r):e:e.concat(r)},[])},No=(e,...t)=>typeof e==`function`?e(...t):e,Po=(e,t)=>e===t})),Io,Lo=e((()=>{j(),Fo(),Io=()=>{let[e,t]=D(()=>[new WeakMap]);return{setItemState:m((e,n)=>t(([t])=>{let r=Do(e,t);return Object.assign(r,No(n,r)),[t]}),[]),state:e[0],signal:e}}})),Ro,zo=e((()=>{j(),Lo(),Fo(),Ro=()=>{let{setItemState:e,state:t,signal:n}=Io();return{state:t,signal:n,toggleFold:m((t,n)=>{Ao(t)&&e(t,e=>({folded:n===void 0?!e.folded:n}))},[]),toggleCollapse:m((t,n)=>{Ao(t)||e(t,e=>({expanded:n===void 0?!e.expanded:!n}))},[])}}})),Bo,Vo=e((()=>{j(),Fo(),Bo=({initial:e,compareItemsFn:t,data:n,flatData:r})=>{let[i,a]=D(e),[o,s]=D(),c=m(e=>i.includes(e),[i]),u=m(e=>e?.items?.every(c)??!1,[c]),d=m(e=>c(e)||u(e),[c,u]),f=m(e=>{let t=e.items??[e];a(e=>[...e,...t.filter(t=>!e.includes(t))]),s(e)},[]),p=m(e=>{let t=e.items??[e];a(e=>e.filter(e=>!t.includes(e))),s(e)},[]),h=m(e=>{a(e.items?.slice()||[e]),s(e)},[]),g=m(()=>{a(n.flatMap(e=>e.items||e)),s(void 0)},[n]),_=m(()=>{a([]),s(void 0)},[]),v=m((e,t=!d(e))=>t?f(e):p(e),[d]),y=m((e,n)=>{if(!r)return;let i=o?r.findIndex(e=>t(e,o)):-1;if(i<0)return v(e,n);let[a,c]=[i,r.indexOf(e)].sort((e,t)=>e-t);r.slice(a,c+1).forEach((e,t,r)=>{t>0&&t<r.length-1&&Ao(e)||v(e,n)}),s(e)},[r,t,v]);return l(()=>a(e=>e.length>0&&r?r.filter(n=>e.find(e=>t(n,e))):e),[r]),{selectedItems:i,isItemSelected:c,isGroupSelected:u,isSelected:d,select:f,deselect:p,selectOnly:h,selectAll:g,deselectAll:_,toggleSelect:v,toggleSelectTo:y}}})),Ho,Uo,Wo,Go=e((()=>{u(),w(),j(),i(),To(),zo(),Vo(),Fo(),d(),Ho={host:{position:`relative`,display:`flex`,flexDirection:`column`}},Uo=e=>{let{data:t,renderItem:n,renderGroup:r,displayEmptyGroups:i,compareItemsFn:a=Po}=e,{toggleFold:o,toggleCollapse:s,state:c,signal:l}=Ro(),u=E(()=>Mo(t,i,c),[t,i,l]),{selectedItems:d,isItemSelected:f,isGroupSelected:p,isSelected:h,select:_,deselect:v,selectOnly:y,selectAll:b,deselectAll:x,toggleSelect:S,toggleSelectTo:C}=Bo({initial:[],compareItemsFn:a,data:t,flatData:u}),ee=m((e,t)=>Array.isArray(e.items)?r(e,t,{selected:p(e),folded:ko(e,c),toggleSelect:t=>S(e,typeof t==`boolean`?t:void 0),toggleFold:()=>o(e)}):n(e,t,{selected:d.includes(e),expanded:Oo(e,c),toggleSelect:t=>S(e,typeof t==`boolean`?t:void 0),toggleCollapse:()=>s(e)}),[n,r,d,S,l]);g(()=>{Object.assign(e.style,Ho.host)},[]),F(`selectedItems`,d);let w={toggleFold:o,toggleCollapse:s,isItemSelected:f,isGroupSelected:p,isSelected:h,select:_,deselect:v,selectOnly:y,selectAll:b,deselectAll:x,toggleSelect:S,toggleSelectTo:C};return me(w,Object.values(w)),{renderRow:ee,flatData:u}},Wo=({renderRow:e,flatData:n})=>it({items:n,renderItem:(n,r)=>t`<cosmoz-grouped-list-row
				.item=${n}
				.index=${r}
				.renderFn=${e}
			></cosmoz-grouped-list-row>`})})),Ko,qo=e((()=>{Go(),j(),Ko=e=>Wo(Uo(e)),customElements.define(`cosmoz-grouped-list`,P(Ko,{useShadowDOM:!1}))})),Jo=e((()=>{qo()})),Yo,Xo,Zo,Qo=e((()=>{ce(),Tt(),Yr(),Zr(),wi(),ki(),Mi(),w(),j(),Ue(),i(),ct(),Fi(),Ui(),Gi(),Xi(),wo(),Jo(),Yo=e=>window.ShadyCSS?.ApplyShim?.transformCssText?.(e)||e,Xo=e=>{let{header:n,list:r,footer:i}=Co(e);return t`
		<style>
			${rt([],()=>Yo(Pi))}
		</style>
...
`,t(Object.assign([Zo],{raw:[Zo]})),$e(Object.assign([Zo],{raw:[Zo]}))})),$o,$,es,ts,ns,rs=e((()=>{$o=(e,t,n)=>{let r=String(e),i=-1,a=!n&&n!==0?` `:n,o=t-r.length;for(;++i<o;)r=a+r;return r},$=(e,t)=>Math.floor(Math.random()*(t-e+1))+e,es=()=>`2015-`+$o($(1,12),2,`0`)+`-`+$o($(1,28),2,`0`),ts=()=>{let e=$(0,20);return e===1?new Date(2015,3,2,14,26,10,299):e===2?new Date(2016,4,2,10,9,10,444):e===3?new Date(2016,4,2,10,9,10,443):e===4?new Date(2016,4,2,10,9,10,442):new Date($(2014,2017),$(1,12),$(1,28),$(0,23),$(0,59),$(0,59),$(0,999))},ns=(e,t,n)=>{let r=$(e,t),i=[],a=[`Lorem ipsum dolor sit amet`,`Nunc tristique`,`Curabitur vestibulum`,`Cras laoreet`,`Himenaeos`,`maximus diam purus at mauris`],o=[`SEK`,`USD`,`EUR`,`AUD`],s=0;for(let e=0;e<r;e+=1){let t=`Group `+e,r=e*2+1;for(let e=0;e<r;e+=1){let r=[],c=[],l=[],u=s%10;for(let e=0;e<u;e+=1)r.push(`Item `+e),c.push({name:`Item `+e,value:`item-value-`+e}),l.push({value:`cat-`+e,label:`Category `+e});i.push({id:s,name:t+` item `+e,value:$(0,1e4),bool:$(0,100)>50,object:{value:$(0,1e4),label:`Random string `+$(1,n)},sub:{subProp:a[s%a.length]},randomString:`Random string `+$(1,n),randomString2:`Random string 2 `+$(1,n),randomString3:`Random string 3 `+$(1,n),randomString4:`Random string 4 `+$(1,n),date:ts(),dateJSON:es(),amount:{amount:$(10,100),currency:o[s%o.length]},group:t,list:r,objectList:c,categories:s%7==0?null:l}),s+=1}}return i}})),is,as,os,ss,cs;e((()=>{i(),ne(),dt(),Qo(),rs(),is={title:`Components/ComsmozOmnitableFullDemo`,component:`cosmoz-omnitable`,tags:[`autodocs`],args:{loading:!1,locale:`en`,sortOn:``,groupOn:``,descending:!1,groupOnDescending:!1,hashParam:``,settingsId:``,selectedItems:[],disabledFiltering:!1},argTypes:{loading:{control:`boolean`,description:`Show loading state`,table:{defaultValue:{summary:`false`}}},locale:{control:`select`,options:[`en`,`fr`,`sv`],description:`Language locale`,table:{defaultValue:{summary:`en`}}},selectedItems:{control:`object`,description:`Show selected items`},data:{control:`object`,description:`Show specified items`},sortOn:{control:`text`,description:`Column property name to sort on (e.g., "amount", "date", "id")`},groupOn:{control:`text`,description:`Column property name to group on (e.g., "amount", "date", "id")`},descending:{control:`boolean`,description:`Sort on descending`},groupOnDescending:{control:`boolean`,description:`Group on descending`},hashParam:{control:`text`,description:`Hash parameter for URL state management`},settingsId:{control:`text`,description:`ID for storing table settings`},disabledFiltering:{control:`boolean`,description:`Disable filter inputs in all column headers`,table:{defaultValue:{summary:`false`}}}},render:e=>t`
            ...
            >
                ...
                <paper-button slot="actions" on-run="removeItems">
                    ${se({styles:`vertical-align: middle; fill: currentColor;`})}
