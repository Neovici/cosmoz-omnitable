import{n as e}from"./chunk-BneVvdWh.js";import{J as t,Q as n,Y as r,Z as i}from"./iframe-D3C1c2eE.js";import{$ as a,A as o,At as s,B as c,Bt as l,C as u,Ct as d,D as f,Dt as p,E as m,Et as h,F as g,Ft as _,G as v,H as y,Ht as ee,I as b,It as te,J as ne,K as x,L as S,Lt as re,M as ie,Mt as ae,N as oe,Nt as C,O as se,Ot as w,P as ce,Pt as le,Q as ue,R as T,Rt as de,S as fe,St as E,T as pe,Tt as me,U as he,V as D,Vt as ge,W as _e,X as ve,Y as ye,Z as be,_ as xe,_t as Se,a as Ce,at as we,b as O,bt as Te,c as Ee,ct as k,d as De,dt as Oe,et as ke,f as Ae,ft as je,g as Me,gt as Ne,h as Pe,ht as Fe,i as Ie,it as Le,j as Re,jt as A,k as ze,kt as Be,l as Ve,lt as He,m as Ue,mt as We,n as Ge,nt as j,o as Ke,ot as qe,p as Je,pt as Ye,q as M,r as Xe,rt as Ze,s as Qe,st as N,t as $e,tt as P,u as et,ut as tt,v as nt,vt as rt,w as it,wt as at,x as ot,xt as st,y as ct,yt as lt,z as ut,zt as F}from"./dist-BSrU4Gtj.js";var dt,ft=e((()=>{E(),dt=()=>i`<style>
	@keyframes rotating {
		100% {
...
`,kr=({items:e})=>{let[t,n]=w(!1),r=me(),a=Array.isArray(e)?e:[],o=A(()=>Math.max(0,a.length-1),[a]);if(C(()=>{requestAnimationFrame(()=>r.dispatchEvent(new CustomEvent(`expand`,{bubbles:!0})))},[r,a.length]),a.length===0)return null;let s=a.length>2,c=a[0],l=s&&!t?[]:a.slice(1),u=e=>{e.stopPropagation(),e.preventDefault(),n(e=>!e)};return i`
		<ul>
			<li>
				<span>${c}</span>
			</li>
