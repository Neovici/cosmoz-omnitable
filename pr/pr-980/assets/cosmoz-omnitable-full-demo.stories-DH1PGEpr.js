import{n as e}from"./chunk-BneVvdWh.js";import{J as t,Q as n,Y as r,Z as i}from"./iframe-DKQAQDYi.js";import{$ as a,A as o,At as s,B as c,Bt as l,C as u,Ct as d,D as f,Dt as p,E as m,Et as h,F as g,Ft as _,G as v,H as ee,I as y,It as b,J as te,K as x,L as S,Lt as ne,M as re,Mt as C,N as ie,Nt as ae,O as oe,Ot as se,P as ce,Pt as le,Q as ue,R as w,Rt as T,S as de,St as E,T as fe,Tt as pe,U as me,V as D,Vt as he,W as ge,X as _e,Y as ve,Z as ye,_ as be,_t as xe,a as Se,at as Ce,b as O,bt as we,c as Te,ct as k,d as Ee,dt as De,et as Oe,f as ke,ft as Ae,g as je,gt as Me,h as Ne,ht as Pe,i as Fe,it as Ie,j as Le,jt as Re,k as ze,kt as A,l as Be,lt as Ve,m as He,mt as Ue,n as We,nt as j,o as Ge,ot as Ke,p as qe,pt as Je,q as M,r as Ye,rt as Xe,s as Ze,st as N,t as Qe,tt as P,u as $e,ut as et,v as tt,vt as nt,w as rt,wt as it,x as at,xt as ot,y as st,yt as ct,z as lt,zt as F}from"./dist-C_q5rwIK.js";var ut,dt=e((()=>{E(),ut=()=>i`<style>
	@keyframes rotating {
		100% {
...
</style>`,customElements.define(`cz-spinner`,d(ut))})),ft,pt,I=e((()=>{v(),E(),ft=M`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,customElements.define(`cosmoz-clear-button`,d(pt))})),L,mt,ht,gt,_t,R,z=e((()=>{k(),L=({valuePath:e},t)=>N(t,e),mt=L,ht=L,gt=({valuePath:e},t)=>n=>{let r=N(n,e);return r==null?!1:r.toString().toLowerCase().trim().includes(t.toLowerCase().trim())},_t=(e,t)=>t===``||t==null?null:t,R=e=>class extends e{static get properties(){return{isOmnitableColumn:{type:Boolean,value:!0},title:{type:String},valuePath:{type:String,notify:!0},values:{type:Array,notify:!0},filter:{type:Object},noLocalFilter:{type:Boolean},disabled:{type:Boolean,value:!1,notify:!0},editable:{type:Boolean,notify:!0},loading:{type:Boolean,value:!1,notify:!0},externalValues:{type:Boolean,value:!1,notify:!0},name:{type:String},sortOn:{type:String},groupOn:{type:String},noSort:{type:Boolean,value:!1},disabledFiltering:{type:Boolean,value:!1},width:{type:String,value:`75px`},minWidth:{type:String,value:`40px`},flex:{type:String,value:`1`},cellClass:{type:String,value:`default-cell`},headerCellClass:{type:String,value:`default-header-cell`},priority:{type:Number,value:0},hidden:{type:Boolean,notify:!0},preferredDropdownHorizontalAlign:{type:String,value:`right`},renderHeader:{type:Function},renderCell:{type:Function},renderEditCell:{type:Function},renderGroup:{type:Function},mini:{type:Number,value:null},renderMini:{type:Function}}}static get observers(){return[`notifyFilterChange(filter)`]}notifyFilterChange(e){this.__ownChange||this.dispatchEvent(new CustomEvent(`legacy-filter-changed`,{detail:{name:this.name,state:this.legacyFilterToState(e)},bubbles:!0}))}legacyFilterToState(e){return{filter:e}}getFilterFn(){}getString(e,t){return L(e,t)}toXlsxValue(e,t){return mt(e,t)}cellTitleFn(e,t){return this.getString(e,t)}headerTitleFn(e){return e.title}serializeFilter(e,t){return _t(e,t)}deserializeFilter(e,t){return t==null?null:typeof t==`string`?window.decodeURIComponent(t):t}getComparableValue(e,t){return ht(e,t)}computeSource(e,t){return t}_propertiesChanged(e,t,n){super._propertiesChanged(e,t,n),this.dispatchEvent(new CustomEvent(`cosmoz-column-prop-changed`,{bubbles:!0}))}}})),vt,yt,bt,xt,St,Ct,wt,Tt=e((()=>{w(),I(),j(),n(),T(),z(),vt=e=>t=>e(n=>{if(n.inputValue===void 0&&t.target.value===``)return n;clearTimeout(n.t);let r=setTimeout(()=>e(e=>({...e,filter:e.inputValue})),1e3);return{...n,inputValue:t.target.value,t:r}}),yt=e=>()=>e(e=>({...e,filter:e.inputValue})),bt=e=>t=>{t.keyCode===13&&(t.preventDefault(),e(e=>({...e,filter:e.inputValue})))},xt=e=>t=>e(e=>({...e,headerFocused:t.detail.value})),St=e=>()=>e(e=>({...e,filter:null,inputValue:null})),Ct=e=>e!=null&&e!==``,wt=class extends R(P){static get properties(){return{minWidth:{type:String,value:`55px`},editMinWidth:{type:String,value:`55px`},inputValue:{type:Object,notify:!0}}}getFilterFn(e,t){if(!(t==null||t===``))return gt(e,t)}renderCell(e,{item:t}){return i`<span class="default-column">${L(e,t)}</span>`}renderEditCell(e,{item:t},n){return i`<cosmoz-input
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,inputValue:n,headerFocused:r},a){return i`<cosmoz-input
			...
			@blur=${yt(a)}
		>
			${F(!e.disabledFiltering,()=>i`<cosmoz-clear-button
						suffix
						slot="suffix"
						?visible=${Ct(t)}
						light
						@click=${St(a)}
					></cosmoz-clear-button>`)}
		</cosmoz-input>`}legacyFilterToState(e){return{filter:e,inputValue:e}}},customElements.define(`cosmoz-omnitable-column`,wt)})),Et,Dt,Ot,kt=e((()=>{w(),E(),n(),Et=[`label`,`value`,`slot`,`always-float-label`,`disabled`],Dt=ae`
	${ge}
...
`,Ot=e=>{let{label:t,value:n,slot:r}=e;return a(i`<div
		id="input"
		part="input"
		role="button"
		class="control"
	...
	>
		${n||``}
	</div>`,{label:t})},customElements.define(`cosmoz-omnitable-dropdown-input`,d(Ot,{observedAttributes:Et,styleSheets:[Dt]}))})),At,jt=e((()=>{Ue(),n(),g(),kt(),At=({title:e,tooltip:t=``,filterText:n=``,onOpenedChanged:r,content:a,horizontalAlign:o=`left`,externalValues:s=null})=>i`
		<style>
			.dropdown {
				outline: none;
			}
	...
	`})),Mt,Nt,Pt=e((()=>{De(),Ce(),ie(),o(),Mt=e=>e?typeof e.close==`function`?e:Mt(e.parentElement):null,Nt=e=>class extends e{static get properties(){return{disabled:{type:Boolean,value:!1},filter:{type:Object,notify:!0},values:{type:Array,value(){return[]}},headerFocused:{type:Boolean,notify:!0},min:{type:Number,value:null},max:{type:Number,value:null},limits:{type:Function},autoupdate:{type:String,value:!0},locale:{type:String,value:null},_filterInput:{type:Object,value(){return{min:null,max:null}}},_range:{type:Object,computed:`_computeRange(values.*)`},_limit:{type:Object,computed:`_computeLimit(_range, _filterInput.*, min, max)`,value(){return{}}},_tooltip:{type:String,computed:`_computeTooltip(title, _filterText)`},_fromClasses:{type:String,computed:`_computeInputClasses(_filterInput.min)`},_toClasses:{type:String,computed:`_computeInputClasses(_filterInput.max)`}}}static get observers(){return[`_filterInputChanged(_filterInput.*, autoupdate)`,`_filterChanged(filter.*)`,`_updateLimits(limits, headerFocused)`]}disconnectedCallback(){this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),super.disconnectedCallback()}_computeInputClasses(e){return e!=null&&e!==``?`has-value`:``}toNumber(e,t,n){if(e==null||e===``)return;let r=typeof e==`number`?e:Number(e);if(Number.isNaN(r))return;if(n==null||t==null)return r;let i=this.toNumber(t);return i==null?r:n(r,i)}toValue(){return this.toNumber.apply(this,arguments)}getComparableValue(e,t){if(e==null)return;let n=e;return t!=null&&(n=this.get(t,e)),this.toValue(n)}renderValue(){}getInputString(e,t=this.valuePath){let n=this.toValue(this.get(t,e));return this._toInputString(n)}_computeRange(e){let t=e.base,n=Array.isArray(t)&&t.length&&t.map(e=>this.toValue(e)).filter(e=>e!=null);return!n||n.length<1?{min:null,max:null}:n.reduce((e,t)=>({min:this.toValue(t,e.min,Math.min),max:this.toValue(t,e.max,Math.max)}),{})}_computeLimit(e,t,n,r){if(!e)return;let i=t.base,a=this.toValue(n),o=this.toValue(r),s=a??this.toValue(e.min),c=o??this.toValue(e.max);return{fromMin:s,fromMax:this.toValue(c,this._fromInputString(i.max,`max`),Math.min),toMin:this.toValue(s,this._fromInputString(i.min,`min`),Math.max),toMax:c}}_computeFilterText(e){if(e.base==null)return;let t=e.base,n=this.toValue(t.min),r=this.toValue(t.max),i=[];return n!=null&&i.push(this.renderValue(n)),i.push(` - `),r!=null&&i.push(this.renderValue(r)),i.length>1?i.join(``):void 0}_computeTooltip(e,t){return t==null?e:`${e}: ${t}`}_fromInputString(e){return this.toValue(e)}_toInputString(e){return this.toValue(e)??null}_getDefaultFilter(){return{min:null,max:null}}_filterInputChanged(e,t){this.__inputChangePath=e.path.split(`.`)[1]||null,t&&(this._limitInputDebouncer=Le.debounce(this._limitInputDebouncer,Ke.after(600),()=>{this._limitInput(),this._updateFilter()}),re(this._limitInputDebouncer))}_clearFrom(){this.set(`_filterInput.min`,null),this._updateFilter()}_clearTo(){this.set(`_filterInput.max`,null),this._updateFilter()}_onBlur(){this._limitInput(),this._updateFilter()}_onKeyDown(e){let t=e.currentTarget,n=Array.from(t.parentElement.querySelectorAll(`cosmoz-input`)),r=n[n.findIndex(e=>e===t)+1],i=!r,a=n[0]===t;switch(e.keyCode){case 13:if(e.preventDefault(),!i)r.focus();else{let e=this._limitInput();this._updateFilter(),e||this._closeParent(t)}break;case 9:(i&&!e.shiftKey||a&&e.shiftKey)&&this._closeParent(t)}}_closeParent(e){let t=Mt(e);t&&t.close()}_onDropdownOpenedChanged({currentTarget:e,type:t,detail:n}){(t===`focus`||n?.value===!0)&&setTimeout(()=>{e.querySelector(`cosmoz-input:focus`)||e.querySelector(`cosmoz-input`)?.focus()},100)}_limitInput(){let e=this._filterInput,t=this.__inputChangePath,n=t?this._fromInputString(this.get(t,e),t):null;if(this.__inputChangePath=null,n==null)return!1;let r=this._limit,i=t===`min`?`from`:`to`,a=this.get(i+`Min`,r),o=this.get(i+`Max`,r),s=this.toValue(n,a,Math.max),c=this.toValue(s,o,Math.min);return this.getComparableValue(n)===this.getComparableValue(c)?!1:(this.set([`_filterInput`,t],this._toInputString(c,t)),this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),!0)}_updateFilter(){let e=this._filterInput,t=this.filter,n=this._fromInputString(e.min,`min`),r=this._fromInputString(e.max,`max`);this.getComparableValue(n)===this.getComparableValue(t,`min`)&&this.getComparableValue(r)===this.getComparableValue(t,`max`)||this.set(`filter`,{min:n,max:r})}_filterChanged(e){if(this._filterInput==null)return;let t=this._filterInput,n=e.base,r=this._fromInputString(t.min,`min`),i=this._fromInputString(t.max,`max`);this.getComparableValue(r)===this.getComparableValue(n,`min`)&&this.getComparableValue(i)===this.getComparableValue(n,`max`)||(this.set(`_filterInput`,{min:this._toInputString(n.min),max:this._toInputString(n.max)}),this._limitInputDebouncer&&this._limitInputDebouncer.cancel())}hasFilter(){let e=this.filter;return e==null?!1:this.toValue(e.min)!=null||this.toValue(e.max)!=null}resetFilter(){this.filter=this._getDefaultFilter()}_updateLimits(e,t){e&&Promise.resolve(Ae(e,{active:t})).then(e=>{let{min:t,max:n}=e??{};Object.assign(this,{...t==null?{}:{min:t},...n==null?{}:{max:n}})})}}})),B,Ft=e((()=>{j(),n(),B=e=>class extends e{static get template(){return Xe`<div id="output" style="position:relative;"></div>`}connectedCallback(){super.connectedCallback(),r(this.render(),this.$.output)}_propertiesChanged(e,t,n){super._propertiesChanged(e,t,n),requestAnimationFrame(()=>r(this.render(),this.$.output))}}})),It,Lt=e((()=>{w(),j(),y(),n(),T(),jt(),kt(),Pt(),Ft(),It=class extends Nt(B(P)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:`_computeFilterText(filter.*, _formatters)`},headerFocused:{type:Boolean,value:!1}}}static get observers(){return[`_valuesChanged(autodetect, currency, values)`]}render(){let e=e=>{this.headerFocused=e.type===`focus`,this._onDropdownOpenedChanged(e)};return i`
			...
			${F(this.disabled,()=>i`
				...
				`,()=>i`
					...
					></cosmoz-clear-button>
					${At({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:i`
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:n},r,a){return i`<cosmoz-autocomplete-excluding
			...
			@value-changed=${h(vn(r))}
			@text-changed=${h(bn(r))}
			>${F(e.loading,()=>i`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-excluding
		>`}getComparableValue(e,t){return Tn(e,t)}getFilterFn(e,t){if(!(!t||!Array.isArray(t)||t.length===0))return En(e,t)}},customElements.define(`cosmoz-omnitable-column-autocomplete-excluding`,Dn)})),kn,An,jn=e((()=>{je(),Ne(),j(),n(),T(),tt(),st(),wn(),z(),k(),K(),kn=({valuePath:e,textProperty:t,valueProperty:n},r)=>{let i=t?de(t):O(n),a=be(e&&N(r,e)).map(i);return a.length>1?a.filter(Boolean).join(`,`):a[0]},An=class extends Cn(R(P)){static get properties(){return{headerCellClass:{type:String,value:`autocomplete-header-cell`},minWidth:{type:String,value:`55px`},editMinWidth:{type:String,value:`55px`},keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},showSingle:{type:Boolean},preserveOrder:{type:Boolean},limit:{type:Number},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,showSingle:e.showSingle,preserveOrder:e.preserveOrder,limit:e.limit,textual:e.textual}}renderCell(e,{item:t}){return i`<span class="default-column"
			>${e.getString(e,t)}</span
		>`}renderEditCell(e,{item:t},n){return i`<cosmoz-input
			no-label-float
			type="text"
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:n},r,a){return i`<cosmoz-autocomplete-ui
			...
			@opened-changed=${e=>yn(r)(e.detail.value)}
			.onText=${bn(r)}
			>${F(e.loading,()=>i`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}getComparableValue(e,t){return kn(e,t)}},customElements.define(`cosmoz-omnitable-column-autocomplete`,An)})),Mn,Nn,Pn,Fn,In,Ln,Rn,zn,Bn,Vn,Hn,Un,Wn,Gn,Kn=e((()=>{j(),z(),je(),f(),k(),n(),T(),Mn=(e,t)=>t.find(({value:t})=>e===t),Nn=(e,t,n)=>{let r=Mn(t,n);return r?r.text:e},Pn=(e,t,n,r)=>Nn(e,N(t,n),r),Fn=({valuePath:e},t,n)=>Mn(N(t,e),n),In=e=>t=>{e(e=>({...e,filter:t?.[0]?.value??null}))},Ln=e=>t=>{e(e=>({...e,headerFocused:t}))},Rn=e=>t=>{e(e=>({...e,query:t}))},zn=e=>t=>e(t?.[0]?.value),Bn=({valuePath:e,trueLabel:t,falseLabel:n},r)=>N(r,e)?t:n,Vn=({valuePath:e},t)=>n=>N(n,e)===t,Hn=oe((e,t)=>[{text:e,value:!0},{text:t,value:!1}]),Un=({valuePath:e,trueLabel:t,falseLabel:n},r)=>e?N(r,e)?t:n:``,Wn=(e,t)=>{try{return JSON.parse(t)}catch{return null}},Gn=class extends R(P){static get properties(){return{trueLabel:{type:String,value:`True`},falseLabel:{type:String,value:`False`},flex:{type:String,value:`0`},cellClass:{type:String,value:`boolean-cell`}}}getString(e,t){return Bn(e,t)}renderCell(e,{item:t}){return Bn(e,t)}renderEditCell(e,{item:t},n){let{trueLabel:r,falseLabel:a}=e;return i`<cosmoz-autocomplete
			no-label-float
			.title=${Pn(e.title,t,e.valuePath,Hn(r,a))}
			.source=${Hn(r,a)}
			.textProperty=${`text`}
			.value=${Fn(e,t,Hn(r,a))}
			.onChange=${zn(n)}
			.limit=${1}
			>${F(e.loading,()=>i`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete
			...
			${F(this.disabled,()=>i`
				...
				`,()=>i`
					...
					${At({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:i`
						...
						`})}
				`)}
		`}_fromInputString(e,t){let n=this.toDate(e);if(n!=null)return t===`min`&&n.setHours(0,0,0,0),t===`max`&&n.setHours(23,59,59),n}_filterInputChanged(e,t){let n=e.path.split(`.`)[1]&&e.value;if(n&&n.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}},customElements.define(`cosmoz-omnitable-date-range-input`,Yn)})),Zn,Qn,$n,Y,X,er,tr,nr,rr,ir,ar,or,sr,cr,lr,ur=e((()=>{ve(),k(),Wt(),Zn=e=>{let t=-new Date(e).getTimezoneOffset()/60;return(t<0?`-`:`+`)+[`0`,Math.abs(t)].join(``).substr(-2)+`:00`},Qn=e=>e.length===19?e+Zn(e):e,$n=e=>{if(e==null||e===``)return;let t=e;return!(t instanceof Date)&&(typeof e==`string`&&(t=Qn(t)),t=te(t),!t)||Number.isNaN(t.getTime())?null:t},Y=({valuePath:e},t)=>{if(t==null)return;let n=t;e!=null&&(n=N(t,e));let r=$n(n);if(r!=null)return V(r.getTime())},X=(e,t,n)=>{let r=$n(e);if(r==null)return null;if(n==null||t==null)return r;let i=X(t);if(i==null)return r;let a=Y({},r),o=Y({},i);return a==null||o==null||n(a,o)===a?r:i},er=(e,t)=>{if(t==null)return;let n=X(e);if(n!=null)return t.format(n)},tr={},nr=e=>{let t=e||``;return tr[t]||(tr[t]=new Intl.DateTimeFormat(e||void 0)),tr[t]},rr=({valuePath:e,locale:t},n)=>{let r=N(n,e||``);return r===void 0?``:(r=X(r),r===null?`Invalid Date`:er(r,nr(t)))},ir=e=>{let t=X(e);if(t==null)return null;let n=_e(t);return n==null?null:n.slice(0,10)},ar=({valuePath:e},t)=>ir(N(t,e||``)),or=(e,t)=>{let n=X(e);if(n!=null)return t===`min`&&n.setHours(0,0,0,0),t===`max`&&n.setHours(23,59,59),n},sr=e=>ir(e)??``,cr=({valuePath:e},t)=>{if(!e)return``;let n=X(N(t,e));if(!n)return``;let r=X(_e(n));return r?(r.setHours(0,0,0,0),r):``},lr=(e,t)=>n=>{let r=Y(e,n);if(r==null)return!1;let i=Y({...e,valuePath:`min`},t),a=Y({...e,valuePath:`max`},t);return!(r<(i??-1/0)||r>(a??1/0))}})),dr,fr=e((()=>{w(),j(),n(),z(),Xn(),J(),ur(),I(),dr=class extends R(P){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:`date-header-cell`},width:{type:String,value:`100px`},minWidth:{type:String,value:`82px`},flex:{type:String,value:`0`}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){let n=Y({...e,valuePath:`min`},t),r=Y({...e,valuePath:`max`},t);if(!(n==null&&r==null))return lr(e,t)}getString(e,t){return rr(e,t)}toXlsxValue(e,t){return cr(e,t)}getComparableValue(e,t){return Y(e,t)}serializeFilter(e,t){if(t==null)return;let n=X(t.min),r=X(t.max);if(!(n==null&&r==null))return sr(n)+`~`+sr(r)}deserializeFilter(e,t){if(t==null||t===``)return null;let n=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(n)?{min:X(n[1]),max:X(n[2])}:null}renderCell(e,{item:t}){return i`<div class="omnitable-cell-date">
			${rr(e,t)}
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return q(e,t)}},customElements.define(`cosmoz-omnitable-column-date`,dr)})),pr,mr=e((()=>{j(),y(),n(),T(),Jn(),jt(),kt(),Ft(),pr=class extends qn(B(P)){render(){let e=e=>{this.headerFocused=e.type===`focus`};return i`
			<style>
		...
		></cosmoz-omnitable-datetime-range-input>`}computeSource(e,t){return q(e,t)}},customElements.define(Sr.is,Sr)})),wr,Tr=e((()=>{je(),Ne(),j(),n(),T(),wn(),z(),wr=class extends Cn(R(P)){renderCell({valuePath:e,textProperty:t},{item:n}){return i`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		`}renderEditCell(){return`not implemented`}renderHeader(e,{filter:t,query:n},r,a){return i`<cosmoz-autocomplete-ui
			...
			.onText=${bn(r)}
			>${F(e.loading,()=>i`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}},customElements.define(`cosmoz-omnitable-column-list-horizontal`,wr)})),Er,Dr,Or=e((()=>{v(),E(),y(),Er=M`
	:host {
		display: block;
	}
...
`,Dr=({items:e})=>{let[t,n]=p(!1),r=Array.isArray(e)?e:[],a=s(()=>Math.max(0,r.length-1),[r]);if(r.length===0)return null;let o=r.length>2,c=r[0],l=o&&!t?[]:r.slice(1),u=e=>{e.stopPropagation(),e.preventDefault(),n(e=>!e)};return i`
		<ul>
			<li>
				<span>${c}</span>
			</li>
	...
	`},customElements.define(`cosmoz-omnitable-column-list-data`,d(Dr,{styleSheets:[x(Er)]}))})),kr,Ar=e((()=>{Or(),j(),n(),T(),je(),wn(),z(),K(),kr=class extends Cn(R(P)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:n}){return i`<cosmoz-omnitable-column-list-data
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:n},r,a){return i`<cosmoz-autocomplete-ui
			...
			.onText=${bn(r)}
			>${F(e.loading,()=>i`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}},customElements.define(`cosmoz-omnitable-column-list`,kr)})),jr,Mr=e((()=>{w(),j(),y(),n(),T(),jt(),kt(),Pt(),Ft(),jr=class extends Nt(B(P)){static get properties(){return{maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null},formatter:{type:Object,computed:`_computeFormatter(locale, minimumFractionDigits, maximumFractionDigits)`},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:`_computeFilterText(filter.*, formatter)`},headerFocused:{type:Boolean,value:!1}}}render(){let e=e=>{this.headerFocused=e.type===`focus`,this._onDropdownOpenedChanged(e)};return i`
			<style>
				cosmoz-input[type='number'] {
					background: var(--cosmoz-omnitable-amount-input-background, #ffffff);
					border-radius: 6px;
			...
			${F(this.disabled,()=>i`
				...
				`,()=>i`
					<cosmoz-clear-button
						...
						?visible=${this.hasFilter()}
					></cosmoz-clear-button>
					${At({title:this.title,tooltip:this._tooltip,filterText:this._filterText,horizontalAlign:`right`,externalValues:this.externalValues,onOpenedChanged:e,content:i`
							<h3>${this.title}</h3>
							<cosmoz-input
								class=${this._fromClasses}
								type="number"
		...
		></cosmoz-omnitable-number-range-input>`}computeSource(e,t){return q(e,t)}},customElements.define(`cosmoz-omnitable-column-number`,Nr)})),Fr,Ir=e((()=>{w(),j(),y(),n(),T(),Jn(),jt(),kt(),Ft(),Fr=class extends qn(B(P)){render(){let e=e=>{this.headerFocused=e.type===`focus`};return i`
			${F(this.disabled,()=>i`
					<cosmoz-omnitable-dropdown-input
						disabled
						.label=${this.title}
		...
		></cosmoz-input>`}renderHeader({title:e,min:t,max:n,locale:r,filterStep:a,disabledFiltering:o},{filter:s},c,l){return i`<cosmoz-omnitable-time-range-input
			...
			@filter-changed=${({detail:{value:e}})=>c(t=>({...t,filter:e}))}
			@header-focused-changed=${({detail:{value:e}})=>c(t=>({...t,headerFocused:e}))}
		></cosmoz-omnitable-time-range-input>`}computeSource(e,t){return q(e,t)}},customElements.define(`cosmoz-omnitable-column-time`,qr)})),Yr=e((()=>{dn(),On(),jn(),Kn(),fr(),Cr(),Tr(),Ar(),Pr(),Jr()})),Xr,Zr=e((()=>{E(),n(),Xr=({column:e,item:n,selected:r,folded:i,group:a})=>e?(e.renderGroup??e.renderCell)(e,{item:n,selected:r,folded:i,group:a}):t,customElements.define(`cosmoz-omnitable-group-row`,d(Xr,{useShadowDOM:!1}))})),Qr,$r=e((()=>{E(),n(),Qr=e=>{let{column:n}=e;return C(()=>{let t=0,r=0,i=i=>{e.dispatchEvent(new CustomEvent(`column-resize`,{bubbles:!0,composed:!0,detail:{newWidth:Math.ceil(r+i.pageX-t),column:n}}))},a=()=>{document.removeEventListener(`pointermove`,i),document.removeEventListener(`pointerup`,a)},o=n=>{t=n.pageX,r=e.previousElementSibling.getBoundingClientRect().width,document.addEventListener(`pointermove`,i),document.addEventListener(`pointerup`,a)};return e.addEventListener(`pointerdown`,o),()=>e.removeEventListener(`pointerdown`,o)},[n]),t},customElements.define(`cosmoz-omnitable-resize-nub`,d(Qr))})),ei,ti,ni,ri,ii=e((()=>{n(),ei=i`<svg
	width="10"
	height="9"
	viewBox="0 0 10 9"
	stroke="currentColor"
...
>
	...
	/>
</svg> `})),ai,oi,si,ci,li=e((()=>{E(),l(),ii(),ai=({column:e,on:t,descending:n,setOn:r,setDescending:a})=>{let{name:o,title:s}=e??{};return i`<button
		class="sg"
		title=${he(s)}
	...
	>
		<span>${s}</span> ${ri}
	</button>`},oi=({columns:e,...t})=>e?.map(e=>ai({column:e,...t})),si=()=>i`
...
`}));function ui(e,t,{suffix:n=``,read:r,write:i,ready:a=!0,multi:o}={}){let c=Me({param:t,suffix:n,link:o?mi:pi,write:i??et}),l=s(()=>{if(t==null)return!1;if(o){let e=$e(t+n);return Object.keys(e).length>0}return Ee(t+n)!==void 0},[]),[u,d]=p(()=>{if(t==null)return e;if(o){let i=$e(t+n,r);return Object.keys(i).length>0?i:e}return Ee(t+n,r)??e}),f=A(e=>d(t=>{let n=Ae(e,t);return c.param!=null&&qe(c.link(c.param+c.suffix,n,c.write),null,{notify:!1}),n}),[]);return C(()=>{c.param==null||!a||l||e!=null&&f(e)},[a]),[u,f]}var di,fi,pi,mi,hi=e((()=>{ke(),De(),Pe(),Be(),E(),di=e=>(t,n,r=et)=>{let i=Te(),a=new URLSearchParams(i.hash.replace(`#`,``));return e(t,n,r,a),`#!`+Object.assign(i,{hash:a}).href.replace(location.origin,``)},fi=e=>e==null||e===``,pi=di((e,t,n,r)=>fi(n(t))?r.delete(e):r.set(e,n(t))),mi=di((e,t,n,r)=>{let i=Object.entries(t),a=i.map(n).filter(([,e])=>e!==void 0);if(a.length===0&&i.length>0)return;let o=e;Array.from(r.keys()).filter(e=>e.startsWith(o)).forEach(e=>r.delete(e)),a.forEach(([t,n])=>fi(n)?r.delete(e+t):r.set(e+t,n))})})),gi,_i,vi,yi,bi,xi=e((()=>{E(),hi(),gi=e=>[!0,`true`,1,`yes`,`on`].includes(e),_i=e=>e===``||(e==null?void 0:gi(e)),vi=(e,t,n)=>A(r=>{e(r),n(e=>({...e,[t]:r}))},[e,t,n]),yi=(e,t,{settings:n,setSettings:r,resetRef:i,ready:a=!0})=>{let[o,c]=ui(n.sortOn,t,{suffix:`-sortOn`,ready:a}),[l,u]=ui(_i(n.descending),t,{suffix:`-descending`,read:_i,ready:a}),[d,f]=ui(n.groupOn,t,{suffix:`-groupOn`,ready:a}),[p,m]=ui(_i(n.groupOnDescending),t,{suffix:`-groupOnDescending`,read:_i,ready:a}),h=s(()=>e.find(e=>e.name===o),[e,o]),g=s(()=>e.find(e=>e.name===d),[e,d]),_={groupOn:d,setGroupOn:vi(f,`groupOn`,r),groupOnDescending:p,setGroupOnDescending:vi(m,`groupOnDescending`,r),sortOn:o,setSortOn:vi(c,`sortOn`,r),descending:l,setDescending:vi(u,`descending`,r),columns:e},v=s(()=>_,Object.values(_)),ee=A(e=>{c(e.sortOn),f(e.groupOn),u(e.descending),m(e.groupOnDescending)},[]);return C(()=>void(i.current=ee),[]),{...v,sortAndGroup:v,groupOnColumn:g,sortOnColumn:h}},bi=it(),customElements.define(`sort-and-group-provider`,bi.Provider),customElements.define(`sort-and-group-consumer`,d(({render:e})=>e(Re(bi)),{useShadowDOM:!1}))})),Si,Ci,wi=e((()=>{E(),m(),$r(),li(),T(),xi(),Si=({data:e,columns:t,groupOnColumn:n,filters:r,setFilterState:a,sortAndGroup:{sortOn:o,setSortOn:s,descending:c,setDescending:l}={}})=>fe(t,e=>e.name,t=>[i`<div
			...
			>
				...
				${F(!t.noSort,()=>ai({on:o,setOn:s,descending:c,setDescending:l,column:t}))}
			</div>`,i`<cosmoz-omnitable-resize-nub
				.column="${t}"
				name="${t.name}"
			></cosmoz-omnitable-resize-nub>`]),Ci=({columns:e,settingsConfig:t,hideSelectAll:n,...r})=>{let a=Re(bi);return i`
		${F(e,e=>Si({columns:e,sortAndGroup:a,...r}))}
		${F(!n,()=>i` <cosmoz-omnitable-settings
					.config=${t}
					part="settings"
				></cosmoz-omnitable-settings>`)}
	`},customElements.define(`cosmoz-omnitable-header-row`,d(Ci,{useShadowDOM:!1}))})),Ti,Ei,Di=e((()=>{E(),v(),Ti=M`
	:host {
		display: flex;
		align-items: center;
		flex-wrap: wrap;
...
`,customElements.define(`cosmoz-omnitable-item-expand-line`,d(Ei,{styleSheets:[x(Ti)]}))})),Oi,ki=e((()=>{E(),n(),Ge(),Di(),Oi=({columns:e,item:t,selected:n,expanded:r,groupOnColumn:a})=>Ze(e,e=>i`<cosmoz-omnitable-item-expand-line
				.column=${e}
				?hidden=${e===a}
				exportparts="item-expand-label, item-expand-value"
				>${e.renderCell(e,{item:t,selected:n,expanded:r})}</cosmoz-omnitable-item-expand-line
			>`),customElements.define(`cosmoz-omnitable-item-expand`,d(Oi,{useShadowDOM:!1}))})),Ai,ji,Mi=e((()=>{E(),m(),Ai=(e,t,n)=>e.editable?e.renderEditCell(e,t,n(e,t.item)):e.renderCell(e,t),ji=({columns:e,groupOnColumn:t,item:n,index:r,selected:a,expanded:o,onItemChange:s})=>fe(e,e=>e.name,e=>i`<div
				...
				name="${e.name}"
			>
				${Ai(e,{item:n,index:r,selected:a,expanded:o},s)}
			</div>`),customElements.define(`cosmoz-omnitable-item-row`,d(ji,{useShadowDOM:!1}))})),Ni,Pi,Fi=e((()=>{v(),Ni=M`
	.checkbox {
		box-sizing: border-box;
		width: 18px;
		height: 18px;
...
`})),Ii,Li,Ri=e((()=>{Fe(),Ii=e=>{let t=e.replace(/"/gu,`""`);return t.search(/("|,|\n)/gu)>=0?`"`+t+`"`:e},Li=(e,t,n)=>{let r=e.map(e=>Ii(e.title)).join(`;`)+`
`,i=t.map(t=>e.map(e=>{let n=e.getString(e,t);return n==null?``:Ii(String(n))}).join(`;`)+`
`);i.unshift(r),Se(new File(i,n,{type:`text/csv;charset=utf-8`}))}})),zi,Bi,Vi=e((()=>{Fe(),We(),zi=(e,t)=>{let n=e.map(e=>e.title),r=t.map(t=>e.map(e=>e.toXlsxValue(e,t)??``));return r.unshift(n),r},Bi=(e,t,n,r)=>{let i=zi(e,t),a=new Ye(n).addSheetFromData(i,r).generate();Se(new File([a],n,{type:`application/vnd.openxmlformats-officedocument.spreadsheetml.sheet`}))}})),Hi,Ui=e((()=>{ye(),y(),n(),Ri(),Vi(),Hi=({columns:e,selectedItems:t,csvFilename:n,xlsxFilename:r,xlsxSheetname:a,topPlacement:o})=>i`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!ue(t.length)}
		part="bottomBar"
	...
	>
	...
	</cosmoz-bottom-bar>`})),Wi,Gi=e((()=>{n(),T(),Wi=({allSelected:e,onAllCheckboxChange:t,sortAndGroup:n,dataIsValid:r,data:a,columns:o,filters:s,groupOnColumn:c,setFilterState:l,settingsConfig:u,hideSelectAll:d})=>i`<sort-and-group-provider .value=${n}>
		<div class="header" id="header" part="header">
			${F(!d,()=>i`<input
						...
						part="all"
					/>`)}
			${F(d,()=>i` <cosmoz-omnitable-settings
						.newLayout="${!0}"
						.config=${u}
					></cosmoz-omnitable-settings>`)}
	...
	</sort-and-group-provider>`})),Ki,qi,Ji=e((()=>{E(),Ki=ae`
	:host {
		max-width: 100%;
		overflow-x: hidden;
		padding: 0 12px;
...
`,qi=({settingsConfig:e})=>{let{columns:t,collapsed:n}=e,r=t.filter(e=>!n.some(t=>t.name===e.name));return i`<div class="skeleton">
	...
	</div>`},customElements.define(`cosmoz-omnitable-skeleton`,d(qi,{styleSheets:[Ki]}))})),Yi,Xi=e((()=>{Ji(),y(),n(),T(),le(),Yi=(e,t)=>{let{settingsConfig:n}=e,{processedItems:r,dataIsValid:a,filterIsTooStrict:o,loading:s,displayEmptyGroups:c,compareItemsFn:l,setSelectedItems:u,renderItem:d,renderGroup:f,error:p}=t;return i`${F(!s&&!a&&!p,()=>i`<div class="tableContent-empty">
		...
		${F(o,()=>i`<div class="tableContent-empty">
					${ne({width:`96px`,height:`96px`,styles:`margin-right: 24px; fill: currentColor;`})}
					<div>
		...
		${F(s&&!r.length,()=>i`<div class="tableContent-empty overlay">
					<cosmoz-omnitable-skeleton
						.settingsConfig=${n}
					></cosmoz-omnitable-skeleton>
				</div>`)}
		${F(s&&r.length,()=>i`<div class="tableContent-empty overlay spinner">
					<cz-spinner></cz-spinner>
				</div>`)}
		${F(p,()=>i`<div class="tableContent-empty overlay">
...
`})),ea,ta,na=e((()=>{E(),Pe(),ea=e=>{let t=parseInt(e,10);return isFinite(t)?t:void 0},ta=e=>{let{config:t}=e,{settings:n,setSettings:r,collapsed:i}=t,a=Me({collapsed:i,settings:n.columns,setSettings:A(e=>r(t=>({...t,columns:e})),[r])});return{...t,onDown:A(e=>{e.target.closest(`.pull`)&&(a.handle=e.currentTarget)},[a]),onDragStart:A(e=>{let{target:t}=e,n=ea(t.dataset.index);if(!a.handle?.contains(t)||n==null)return e.preventDefault();a.handle=null,e.dataTransfer.effectAllowed=`move`,e.dataTransfer.setData(`omnitable/sort-index`,n),e.dataTransfer.setData(`text/plain`,n),setTimeout(()=>t.classList.add(`drag`),0),t.addEventListener(`dragend`,e=>e.target.classList.remove(`drag`),{once:!0})},[a]),onDragEnter:A(e=>{let t=e.currentTarget;t===e.target&&(e.preventDefault(),e.dataTransfer.dropEffect=`move`,t.classList.add(`dragover`))},[]),onDragOver:A(e=>{e.preventDefault(),e.currentTarget.classList.add(`dragover`)},[]),onDragLeave:A(e=>{let t=e.currentTarget;t.contains(e.relatedTarget)||t.classList.remove(`dragover`)},[]),onDrop:A(e=>{let t=ea(e.dataTransfer.getData(`omnitable/sort-index`)),n=ea(e.currentTarget.dataset.index),{settings:r,setSettings:i}=a;e.currentTarget.classList.remove(`dragover`),e.preventDefault();let o=r.slice();o.splice(n+(t>=n?0:-1),0,o.splice(t,1)[0]),i(o)},[a]),onToggle:A(e=>{let{settings:t,setSettings:n}=a,r=t.map(e=>({...e,disabled:e.disabled||a.collapsed?.some(t=>t.name===e.name)})),i=ea(e.target.closest(`[data-index]`)?.dataset.index);r.splice(i,1,{...t[i],disabled:!e.target.checked,priority:e.target.checked?t.reduce((e,t)=>Math.max(e,t.priority),0)+1:t[i].priority}),n(r)},[a])}}})),ra,ia,aa,oa,sa=e((()=>{Qe(),nt(),v(),ye(),E(),y(),T(),ii(),li(),$i(),na(),ra=[ct({apply({availableHeight:e,elements:t}){Object.assign(t.floating.style,{maxHeight:`${Math.max(0,e)}px`})}}),...xe],ia=({onDragStart:e,onDragEnter:t,onDragOver:n,onDragLeave:r,onDrop:a,onDown:o,onToggle:s,collapsed:c,filters:l})=>(u,d)=>{let f=!!c?.find(e=>e.name===u.name),p=!u.disabled&&!f;return i` <div
			class="item"
			data-index=${d}
			@mousedown=${o}
			draggable="true"
		...
		>
			...
			<input
				...
				.indeterminate=${f}
			/>
		</div>`},aa=e=>{let{settings:t,settingsId:n,onSave:r,onReset:a,hasChanges:o,opened:s,setOpened:c,...l}=ta(e);return i` <div class="headline">
			${S(`Sort and filter`)}
			<button
				class="close"
		...
		${F(n,()=>i`<div class="buttons">
				...
				</div>`)}`},customElements.define(`cosmoz-omnitable-settings-ui`,d(aa,{styleSheets:[x(Zi)]})),oa=({config:e,newLayout:t})=>i`
	<cosmoz-dropdown
		.placement="${t?`bottom-start`:`bottom-end`}"
		.middleware="${ra}"
	>
		<div title="${S(`Sort and filter`)}" slot="button">
			${F(t,()=>i`<div class="headerDots">...</div>`,()=>i` <svg viewBox="0 0 24 24" width="24" fill="currentColor">
						<circle cx="10" cy="18" r="2"></circle>
						<circle cx="10" cy="12" r="2"></circle>
						<circle cx="10" cy="6" r="2"></circle>
					</svg>`)}
			${F(e?.badge,()=>i`<div class="badge"></div>`)}
		</div>
		<cosmoz-omnitable-settings-ui
...
`,customElements.define(`cosmoz-omnitable-settings`,d(oa,{styleSheets:[x(Qi)]}))})),ca,la,ua,da,fa,pa=e((()=>{st(),ca=[`sortOn`,`descending`,`groupOn`,`groupOnDescending`],la=e=>t=>typeof t==`object`&&!!t&&`name`in t&&t.name===e,ua=(e=[],t=[],n=[])=>{let r=t.filter(t=>e.some(la(t.name))),i=e.filter(e=>e.name!=null&&!t.some(la(e.name))&&!n.some(la(e.name))),a=n.filter(e=>!t.some(la(e.name)));return[...r,...a.flatMap(t=>{let n=e.find(e=>e.name===t.name);return n?{...t,title:n.title??t.title??``,minWidth:parseInt(n.minWidth??`0`,10)}:[]}),...i.map(e=>{let{name:t,title:n,priority:r,minWidth:i,width:a,flex:o}=e;return{name:t??``,title:n??``,priority:r??0,minWidth:parseInt(i??`0`,10),width:parseInt(a??`0`,10),flex:parseInt(o??`0`,10)}})]},da=(e,t)=>({...t,...at(Array.from(ca))(e),columns:e.columns?.map(at([`name`,`priority`,`width`,`flex`,`disabled`]))}),fa=({columns:e,settings:t,savedSettings:n,initial:r})=>({...Object.fromEntries(ca.flatMap(e=>r?.[e]==null?[]:[[e,r[e]]])),...n?at(Array.from(ca))(n):{},...t,columns:ua(e,t?.columns,n?.columns)})})),ma,ha=e((()=>{ma=({prefix:e=`omnitable-`}={})=>({write:async(t,n)=>{let r=e+t;try{n?localStorage.setItem(r,JSON.stringify(n)):localStorage.removeItem(r)}catch(e){console.error(e)}},read:async t=>{if(!t)return null;try{let n=localStorage.getItem(e+t);return n==null?null:JSON.parse(n)}catch(e){return console.error(e),null}}})})),ga,_a,va=e((()=>{E(),ha(),ga=it(ma),_a=()=>{let e=Re(ga);return s(()=>e(),[e])}})),ya=e((()=>{va()})),ba,xa=e((()=>{E(),ya(),pa(),ba=(e,t,n,r)=>{let[i,a]=p(e?void 0:null),{read:o,write:s}=_a();return C(async()=>{e&&a(await o(e))},[e,o]),{settingsId:e,savedSettings:i,onSave:A(async()=>{if(!e)return;let r=da(t,i);await s(e,r),n(),a(r)},[t,i]),onReset:A(async t=>{n(),t.shiftKey&&(await s(e),a(null)),r?.()},[r]),hasChanges:t!=null}}})),Sa,Ca=e((()=>{E(),K(),pa(),xa(),Sa=({settingsId:e,host:t})=>{let n=s(()=>Object.fromEntries(ca.map(e=>[e,t[e]])),[]),r=pe(),i=A(()=>{r.current?.(n)},[n]),[a,o]=p(),[c,l]=p({columns:!0,sort:!0}),{savedSettings:u,...d}=ba(e,a,o,i),{enabledColumns:f,disabledFiltering:m}=t,h=sn(t,{enabledColumns:f,disabledFiltering:m}),g=s(()=>fa({columns:h,settings:a,savedSettings:u,initial:n}),[h,a,u]),_=s(()=>g.columns.map(e=>h.find(t=>t.name===e.name)).filter(Boolean),[h,...g.columns.map(e=>e.name)]);return{...d,savedSettings:u,opened:c,setOpened:l,settings:g,columns:_,setSettings:o,resetRef:r}}})),wa=e((()=>{sa(),Ca()})),Ta,Ea,Da=e((()=>{Ta=e=>Number.isFinite(e)?e:0,Ea=(e,t)=>{let n=[],[r,i]=e.reduce(([e,t],{width:n,flex:r})=>[e+n,t+r],[0,0]),a=t-r,o=Ta(a/i),s=0,c=0,l=0;for(let t=0;t<e.length;t++){let{width:i,minWidth:u,flex:d}=e[t];if(u>i+(a>=0?o*d:i*a/r)){s+=i,c+=u,l+=d,n[t]=u;continue}if(d===0){s+=i,c+=i,n[t]=i;continue}}r-=s,a=t-c-r,i-=l,o=Ta(a/i);for(let t=0;t<e.length;t++){if(n[t]!=null)continue;let{width:i,flex:s}=e[t];n[t]=i+(a>=0?o*s:i*a/r)}return n}})),Oa,ka,Aa=e((()=>{Oa=Symbol(`index`),ka=(e,t)=>{if(typeof e.findLastIndex==`function`)return e.findLastIndex(t);for(let n=e.length-1;n>=0;n--)if(t(e[n],n,e))return n;return-1}})),ja,Ma,Na,Pa=e((()=>{Da(),Aa(),ja=(e,t)=>{let n=ka(e,e=>e!=null&&e>0),r=(e,t)=>`.cell[name="${e}"], cosmoz-omnitable-skeleton::part(cell-${e}){width: ${Math.floor(t)}px;padding: 0 min(3px, ${t/2}px)}`,i=e=>`cosmoz-omnitable-resize-nub[name="${e}"]{display:none}`,a=e=>`cosmoz-omnitable-resize-nub[name="${e}"], .cell[name="${e}"]{display:none}`;return t.map((t,o)=>{let s=e[o];if(s==null||s===0)return a(t.name);let c=r(t.name,s);return o===n?`${c}\n${i(t.name)}`:c}).join(`
`)},Ma=(e,t,n)=>{let r=e.filter(e=>!e.hidden),i=r.reduce((e,{width:t})=>e+t,0);if(r.length>1&&i>t)return Ma(r.slice(1),t,n);let a=r.reduce(([e,t],n,r)=>[Math.max(e,n.index),n.index>e?r:t],[-1,-1])[1];return a!==-1&&(r[a].flex=1),Ea(r,t).reduce((e,t,n)=>(e[r[n].index]=t,e),Array(n).fill(void 0))},Na=(e,t)=>e.length===0?`.cell {display: none;}`:ja(e,t)})),Fa,Ia=e((()=>{E(),Fa=({host:e,canvasWidth:t,layout:n,setSettings:r})=>{let i=pe();i.current=e=>r(r=>{let i=r.columns,{detail:{newWidth:a,column:o}}=e,s=i.findIndex(e=>e.name===o.name),c=[],l=i.reduce((e,t)=>Math.max(e,t.priority),-1/0);for(let e=0;e<n.length;e++)if(c[e]={...i[e]},e<s&&n[e]&&(c[e].width=n[e],c[e].flex=0,c[e].priority=l),e===s){let r=n.reduce((e,t,n)=>n<s&&t?e-t:e,t);c[e].width=Math.min(r,Math.max(a,i[e].minWidth)),c[e].flex=0,c[e].priority=l}return{...r,columns:c}}),C(()=>{let t=e=>i.current?.(e);return e.addEventListener(`column-resize`,t),()=>e.removeEventListener(`column-resize`,t)},[])}})),La,Ra,za=e((()=>{E(),La=88,Ra=(e,t)=>C(()=>{let n=new ResizeObserver(([e])=>{e.contentRect?.width!==0&&requestAnimationFrame(()=>t(e.contentRect?.width-La))});return n.observe(e),()=>n.unobserve(e)},[])})),Ba,Va=e((()=>{E(),za(),Ba=e=>{let[t,n]=p(()=>e.getBoundingClientRect().width-La);return Ra(e,n),t}})),Ha,Ua,Wa,Ga=e((()=>{E(),Pe(),De(),Ha=(e,t)=>{let n=s(()=>{let t=!1,n,r=()=>{t&&(n=requestAnimationFrame(r),e()&&(t=!1))};return{start:()=>{t=!0,cancelAnimationFrame(n),n=requestAnimationFrame(r)},stop:()=>{t=!1,cancelAnimationFrame(n)}}},[]);C(()=>{n.start()},t),C(()=>()=>n.stop(),[])},Ua=(e=0,t=0)=>Math.abs(e-t)<.1,Wa=(e,t=1.9,n=Je)=>{let r=Me({target:e});Ha(A(()=>{if(!r.tween)return r.tween=r.target,n(r.tween),!0;if(r.target.every((e,t)=>r.tween[t]===e))return n(r.tween),!0;r.tween=r.target.map((e,n)=>Ua(r.tween[n],e)?e:(r.tween[n]??0)+((e??0)-(r.tween[n]??0))/t||0),n(r.tween)},[]),[e])}})),Ka,qa=e((()=>{E(),Pa(),Ka=({canvasWidth:e,groupOnColumn:t,config:n,miniColumn:r})=>s(()=>{if(!Array.isArray(n)||e==null||e===0)return[];let i=n.map((e,n)=>({minWidth:e.minWidth,width:e.width,flex:e.flex,priority:e.priority,name:e.name,index:n,hidden:e.name===t?.name||e.disabled})).map(e=>r?{...e,hidden:r.name!==e.name}:e).sort(({index:e,priority:t},{index:n,priority:r})=>t===r?n-e:t-r);return Ma(i,e,i.length)},[e,t,n])})),Ja,Ya=e((()=>{E(),Ja=({host:e,canvasWidth:t,columns:n})=>{let r=e.miniBreakpoint??480,i=s(()=>t<=r,[t,r]),[a,...o]=s(()=>i?n?.filter(e=>e.mini!=null).sort((e,t)=>(e.mini??0)-(t.mini??0)):[],[n,i])??[],c=!!a;return C(()=>{e.toggleAttribute(`mini`,c)},[c]),{isMini:c&&i,miniColumn:a,miniColumns:o}}})),Xa,Za,Qa=e((()=>{E(),Pa(),Ia(),Va(),Ga(),qa(),Ya(),Pe(),Xa=e=>{let t=s(()=>new CSSStyleSheet,[]);return C(()=>{e.shadowRoot.adoptedStyleSheets=[...e.shadowRoot.adoptedStyleSheets,t]},[]),t},Za=({host:e,columns:t,settings:n,setSettings:r,resizeSpeedFactor:i,sortAndGroupOptions:a})=>{let o=Ba(e),{isMini:c,miniColumn:l,miniColumns:u}=Ja({host:e,canvasWidth:o,columns:t}),{groupOnColumn:d}=a,f=Ka({canvasWidth:o,groupOnColumn:d,miniColumn:l,config:n.columns}),p=Xa(e),m=s(()=>n.columns.reduce((e,n,r)=>f[r]!=null||n.name===d?.name||n.disabled?e:[...e,t.find(e=>e.name===n.name)],[]),[t,n,f]),h=Me({columns:n.columns});return Wa(f,i,e=>{let t=Na(e,h.columns);p.replace(t)}),Fa({host:e,canvasWidth:o,layout:f,setSettings:e=>r(e(n))}),{isMini:c,collapsedColumns:m,miniColumns:u}}})),$a,eo=e((()=>{$a=({host:e,...t})=>{let{csvFilename:n=`omnitable.csv`,xlsxFilename:r=`omnitable.xlsx`,xlsxSheetname:i=`Omnitable`,topPlacement:a=`top-end`}=e;return{csvFilename:n,xlsxFilename:r,xlsxSheetname:i,topPlacement:a,...t}}})),to,no=e((()=>{E(),to=({host:e,selectedItems:t,data:n,sortAndGroupOptions:r,collapsedColumns:i,settings:a,filterFunctions:o,settingS:c,filters:l,...u})=>{let d=n&&n.length>0&&t.length===n.length,f=t=>{t.target.checked?e.shadowRoot.querySelector(`#groupedList`).selectAll():e.shadowRoot.querySelector(`#groupedList`).deselectAll()},{groupOnColumn:p}=r,m=s(()=>[p,...i,...a.columns.filter(e=>e.disabled)].some(e=>e&&Object.keys(o).includes(e.name)),[o,a,i]),h=s(()=>({...c,collapsed:i,badge:m,filters:l}),[c,i,m,l]);return C(()=>{let t=e.shadowRoot.querySelector(`#tableContent`),n=new ResizeObserver(t=>requestAnimationFrame(()=>{e.style.setProperty(`--ot-height`,t[0]?.contentRect.height+`px`)}));return n.observe(t),()=>n.unobserve(t)},[]),{allSelected:d,onAllCheckboxChange:f,data:n,settingsConfig:h,filters:l,groupOnColumn:p,sortAndGroup:r.sortAndGroup,...u}}})),ro,io,ao,oo,so,co,lo=e((()=>{E(),T(),ye(),Aa(),J(),ro=i`
	<svg
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
...
`,io=e=>e?`groupRow groupRow-folded`:`groupRow`,ao=({item:e,index:t})=>n=>F(n?.length>0,()=>i`
			...
			`),oo=({columns:e,collapsedColumns:t,miniColumns:n,onItemClick:r,onCheckboxChange:a,dataIsValid:o,groupOnColumn:s,onItemChange:c,rowPartFn:l})=>(u,d,{selected:f,expanded:p,toggleCollapse:m})=>i`
		<div
			?selected=${f}
	...
	`,so=({onCheckboxChange:e,dataIsValid:t,groupOnColumn:n})=>(r,a,{selected:o,folded:s,toggleFold:c})=>i` <div
			class="${io(s)}"
		...
		</div>`,co=({host:e,error:t,dataIsValid:n,processedItems:r,columns:i,collapsedColumns:a,miniColumns:o,sortAndGroupOptions:c,rowPartFn:l,...u})=>{let{loading:d=!1,displayEmptyGroups:f=!1,compareItemsFn:p}=e,m=pe({shiftKey:!1,ctrlKey:!1}),h=A(t=>{let n=t.target.dataItem,r=t.target.checked;m.current.shiftKey?e.shadowRoot.querySelector(`#groupedList`).toggleSelectTo(n,r):m.current.ctrlKey?(t.target.checked=!0,e.shadowRoot.querySelector(`#groupedList`).selectOnly(n)):e.shadowRoot.querySelector(`#groupedList`).toggleSelect(n,r),t.preventDefault(),t.stopPropagation()},[]);C(()=>{let e=({shiftKey:e,ctrlKey:t})=>{m.current={shiftKey:e,ctrlKey:t}};return window.addEventListener(`keydown`,e),window.addEventListener(`keyup`,e),()=>{window.removeEventListener(`keydown`,e),window.removeEventListener(`keyup`,e)}},[]);let g=A(t=>{let n=t.composedPath();n.slice(0,n.indexOf(t.currentTarget)).find(e=>e.matches?.(`a, .checkbox, .expand`))||e.dispatchEvent(new window.CustomEvent(`omnitable-item-click`,{bubbles:!0,composed:!0,detail:{item:t.currentTarget.dataItem,index:t.currentTarget.dataIndex}}))},[]),{groupOnColumn:_}=c,v=A((t,n)=>r=>ln(e,t,n,r),[]);return{...u,processedItems:r,dataIsValid:n,filterIsTooStrict:n&&r.length<1,loading:d,compareItemsFn:p,displayEmptyGroups:f,error:t,renderItem:s(()=>oo({columns:i,collapsedColumns:a,miniColumns:o,onItemClick:g,onCheckboxChange:h,dataIsValid:n,groupOnColumn:_,onItemChange:v,rowPartFn:l}),[i,a,g,h,n,_,v,l]),renderGroup:s(()=>so({onCheckboxChange:h,dataIsValid:n,groupOnColumn:_}),[h,n,_])}}})),uo,fo=e((()=>{uo=(e,t)=>{if(e===t)return 0;if(e==null)return-1;if(t==null)return 1;let n=typeof e,r=typeof t;return n===`object`&&r===`object`?e.toString()<t.toString()?-1:1:n===`number`&&r===`number`?e-t:n===`string`&&r===`string`?e<t?-1:1:n===`boolean`&&r===`boolean`?e?-1:1:(console.warn(`unsupported sort`,n,e,r,t),0)}})),po,mo,ho,go,_o,vo,yo=e((()=>{De(),E(),fo(),K(),hi(),Aa(),po=(e,t)=>(n,r)=>uo(e(n),e(r))*(t?-1:1),mo=e=>e.replace(/([a-z0-9])([A-Z])/gu,`$1-$2`).toLowerCase(),ho=(e,t)=>{!e||!t||Object.entries(t).forEach(([t,n])=>{e[G].__ownChange=!0,e[G][t]=n,e[G].__ownChange=!1,e[G].dispatchEvent(new CustomEvent(`${mo(t)}-changed`,{bubbles:!0,detail:{value:n}}))})},go=(e,t)=>Object.assign(e,{[Oa]:t}),_o=Symbol(`unparsed`),vo=({data:e,columns:t,hashParam:n,sortAndGroupOptions:r,noLocalSort:i,noLocalFilter:a})=>{let{groupOnColumn:o,groupOnDescending:c,sortOnColumn:l,descending:u}=r,d=A(([e,n])=>{let r=t.find(({name:t})=>t===e);return r==null?[e,void 0]:[e,n.filter&&r.serializeFilter(r,n.filter)]},[t]),f=A(([e,n])=>{let r=t.find(({name:t})=>t===e);if(r==null)return[e,{[_o]:n}];let i={filter:r.deserializeFilter(r,n)};return ho(r,i),[e,i]},[t]),[p,m]=ui({},n,{multi:!0,suffix:`-filter--`,write:d,read:f}),h=A((e,n)=>m(r=>{let i=Ae(n,r[e]);return ho(t.find(t=>t.name===e),i),{...r,[e]:{...r[e],...i}}}),[t,m]),g=s(()=>Object.fromEntries(t.map(e=>[e.name,!e.noLocalFilter&&e.getFilterFn(e,p[e.name]?.filter)]).filter(([,e])=>!!e)),[t,...s(()=>Object.values(p).map(e=>e.filter),[p])]),_=s(()=>!Array.isArray(e)||e.length===0?[]:Object.entries(g).length===0||a?e.slice():e.filter(e=>Object.values(g).every(t=>t(e))),[e,g,a]),v=s(()=>{if(!i&&!o&&l!=null&&l.sortOn!=null)return _.slice().sort(po(e=>l.getComparableValue({...l,valuePath:l.sortOn},e),u));if(o!=null&&o.groupOn!=null){let e=_.reduce((e,t)=>{let n=o.getComparableValue({...o,valuePath:o.groupOn},t);if(n===void 0)return e;let r=e.find(e=>e.id===n);return r?(r.items.push(t),e):(r={id:n,name:n,items:[t]},[...e,r])},[]);return e.sort(po(e=>o.getComparableValue({...o,valuePath:o.groupOn},e.items[0]),c)),!l||i?e:e.filter(e=>Array.isArray(e.items)).map(e=>(e.items.sort(po(e=>l.getComparableValue({...l,valuePath:l.sortOn},e),u)),e))}return _},[_,o,c,l,u,i]),ee=s(()=>{let e=0,t=0,n=[];return v.forEach(r=>{if(Array.isArray(r.items)){go(r,t++),r.items.forEach(t=>{go(t,e++),n.push(t)});return}return go(r,e++),n.push(r)},[]),n},[v]);return C(()=>{m(e=>Object.values(e).some(e=>e[_o]!=null)?Object.fromEntries(Object.entries(e).map(([e,t])=>t[_o]==null?[e,t]:f([e,t[_o]]))):e)},[f]),{processedItems:v,visibleData:ee,filters:p,filterFunctions:g,setFilterState:h}}})),bo,xo,So=e((()=>{ee(),E(),lt(),bo=e=>{let t=t=>{let n=e.data.indexOf(t);if(n<0)return null;let r=e.data.splice(n,1);if(e.data=e.data.slice(),Array.isArray(r)&&r.length>0)return r[0]},n=(t,n)=>{e.data.splice(t,1,n),e.data=e.data.slice()};return{removeItem:t,removeItems(t){let n=[];for(let r=t.length-1;r>=0;--r){let i=e.removeItem(t[r]);i!=null&&n.push(i)}return n},replaceItemAtIndex:n,replaceItem(t,r){let i=e.data.indexOf(t);if(i>-1)return n(i,r)},selectItem(t){e.shadowRoot.querySelector(`#groupedList`).select(t)},selectAll(){e.shadowRoot.querySelector(`#groupedList`).selectAll()},deselectAll(){e.shadowRoot.querySelector(`#groupedList`).deselectAll()},deselectItem(t){e.shadowRoot.querySelector(`#groupedList`).deselect(t)},isItemSelected(t){return e.shadowRoot.querySelector(`#groupedList`).isItemSelected(t)}}},xo=({host:e,visibleData:t,filters:n,...r})=>{let{setFilterState:i}=r,a=s(()=>bo(e),[]);me(r,Object.values(r)),me(a,Object.values(a)),C(()=>{let t=e=>i(e.detail.name,t=>({...t,...e.detail.state}));return e.addEventListener(`legacy-filter-changed`,t),()=>e.removeEventListener(`legacy-filter-changed`,t)},[]),D(`visibleData`,t),D(`sortedFilteredGroupedItems`,r.sortedFilteredGroupedItems),D(`selectedItems`,r.selectedItems),D(`sortOn`,r.sortOn),D(`descending`,r.descending),D(`isMini`,r.isMini);let o=s(()=>Object.fromEntries(Object.entries(n).filter(([,{filter:e}])=>e!==void 0).map(([e,{filter:t}])=>[e,t])),[n]);D(`filters`,o,Object.values(o))}})),Co,wo=e((()=>{E(),wa(),Qa(),eo(),no(),lo(),yo(),So(),xi(),Co=e=>{let{hashParam:t,settingsId:n,data:r,resizeSpeedFactor:i,noLocal:a,noLocalSort:o=a,noLocalFilter:s=a,error:c,rowPartFn:l}=e,u=Sa({settingsId:n,host:e}),{settings:d,setSettings:f,columns:m,resetRef:h,savedSettings:g}=u,_=yi(m,t,{settings:d,setSettings:f,resetRef:h,ready:g!==void 0}),{processedItems:v,visibleData:ee,filters:y,setFilterState:b,filterFunctions:te}=vo({data:r,columns:m,hashParam:t,sortAndGroupOptions:_,noLocalSort:o,noLocalFilter:s}),{isMini:x,collapsedColumns:S,miniColumns:ne}=Za({host:e,columns:m,settings:d,setSettings:f,resizeSpeedFactor:i,sortAndGroupOptions:_}),re=r&&Array.isArray(r)&&r.length>0,[C,ie]=p([]);return xo({host:e,visibleData:ee,sortedFilteredGroupedItems:v,columns:m,filters:y,setFilterState:b,selectedItems:C,isMini:x,..._}),{header:to({host:e,selectedItems:C,sortAndGroupOptions:_,dataIsValid:re,data:r,columns:m,filters:y,collapsedColumns:S,settings:d,filterFunctions:te,settingS:u,setFilterState:b,hideSelectAll:e.hideSelectAll===!0}),list:co({host:e,error:c,dataIsValid:re,processedItems:v,setSelectedItems:ie,columns:m,collapsedColumns:S,miniColumns:ne,sortAndGroupOptions:_,rowPartFn:l}),footer:$a({host:e,selectedItems:C,columns:m})}}})),To=e((()=>{n(),customElements.define(`cosmoz-grouped-list-row`,class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||r(this._renderFn(this._item,this._index),this)}})})),Eo,Do,Oo,ko,Ao,jo,Mo,No,Po,Fo=e((()=>{Eo={group:Symbol(`group`)},Do=(e,t)=>(t.has(e)||t.set(e,{}),t.get(e)),Oo=(e,t)=>!!Do(e,t).expanded,ko=(e,t)=>!!Do(e,t).folded,Ao=e=>e?e.items instanceof Array:!1,jo=e=>{if(!Array.isArray(e)||e.length===0)return;let t=Array.isArray(e[0]?.items);if(!e.every(e=>Array.isArray(e.items)===t))throw Error(`Data must be homogeneous.`)},Mo=(e,t,n)=>{if(Array.isArray(e))return jo(e),e.reduce((e,r)=>{let i=r;return i.items?i.items.length?Do(r,n).folded?e.concat(r):e.concat(r,i.items.map(e=>Object.assign(e,{[Eo.group]:r}))):t?e.concat(r):e:e.concat(r)},[])},No=(e,...t)=>typeof e==`function`?e(...t):e,Po=(e,t)=>e===t})),Io,Lo=e((()=>{E(),Fo(),Io=()=>{let[e,t]=p(()=>[new WeakMap]);return{setItemState:A((e,n)=>t(([t])=>{let r=Do(e,t);return Object.assign(r,No(n,r)),[t]}),[]),state:e[0],signal:e}}})),Ro,zo=e((()=>{E(),Lo(),Fo(),Ro=()=>{let{setItemState:e,state:t,signal:n}=Io();return{state:t,signal:n,toggleFold:A((t,n)=>{Ao(t)&&e(t,e=>({folded:n===void 0?!e.folded:n}))},[]),toggleCollapse:A((t,n)=>{Ao(t)||e(t,e=>({expanded:n===void 0?!e.expanded:!n}))},[])}}})),Bo,Vo=e((()=>{E(),Fo(),Bo=({initial:e,compareItemsFn:t,data:n,flatData:r})=>{let[i,a]=p(e),[o,s]=p(),c=A(e=>i.includes(e),[i]),l=A(e=>e?.items?.every(c)??!1,[c]),u=A(e=>c(e)||l(e),[c,l]),d=A(e=>{let t=e.items??[e];a(e=>[...e,...t.filter(t=>!e.includes(t))]),s(e)},[]),f=A(e=>{let t=e.items??[e];a(e=>e.filter(e=>!t.includes(e))),s(e)},[]),m=A(e=>{a(e.items?.slice()||[e]),s(e)},[]),h=A(()=>{a(n.flatMap(e=>e.items||e)),s(void 0)},[n]),g=A(()=>{a([]),s(void 0)},[]),_=A((e,t=!u(e))=>t?d(e):f(e),[u]),v=A((e,n)=>{if(!r)return;let i=o?r.findIndex(e=>t(e,o)):-1;if(i<0)return _(e,n);let[a,c]=[i,r.indexOf(e)].sort((e,t)=>e-t);r.slice(a,c+1).forEach((e,t,r)=>{t>0&&t<r.length-1&&Ao(e)||_(e,n)}),s(e)},[r,t,_]);return C(()=>a(e=>e.length>0&&r?r.filter(n=>e.find(e=>t(n,e))):e),[r]),{selectedItems:i,isItemSelected:c,isGroupSelected:l,isSelected:u,select:d,deselect:f,selectOnly:m,selectAll:h,deselectAll:g,toggleSelect:_,toggleSelectTo:v}}})),Ho,Uo,Wo,Go=e((()=>{ee(),lt(),E(),n(),To(),zo(),Vo(),Fo(),u(),Ho={host:{position:`relative`,display:`flex`,flexDirection:`column`}},Uo=e=>{let{data:t,renderItem:n,renderGroup:r,displayEmptyGroups:i,compareItemsFn:a=Po}=e,{toggleFold:o,toggleCollapse:c,state:l,signal:u}=Ro(),d=s(()=>Mo(t,i,l),[t,i,u]),{selectedItems:f,isItemSelected:p,isGroupSelected:m,isSelected:h,select:g,deselect:_,selectOnly:v,selectAll:ee,deselectAll:y,toggleSelect:b,toggleSelectTo:te}=Bo({initial:[],compareItemsFn:a,data:t,flatData:d}),x=A((e,t)=>Array.isArray(e.items)?r(e,t,{selected:m(e),folded:ko(e,l),toggleSelect:t=>b(e,typeof t==`boolean`?t:void 0),toggleFold:()=>o(e)}):n(e,t,{selected:f.includes(e),expanded:Oo(e,l),toggleSelect:t=>b(e,typeof t==`boolean`?t:void 0),toggleCollapse:()=>c(e)}),[n,r,f,b,u]);se(()=>{Object.assign(e.style,Ho.host)},[]),D(`selectedItems`,f);let S={toggleFold:o,toggleCollapse:c,isItemSelected:p,isGroupSelected:m,isSelected:h,select:g,deselect:_,selectOnly:v,selectAll:ee,deselectAll:y,toggleSelect:b,toggleSelectTo:te};return me(S,Object.values(S)),{renderRow:x,flatData:d}},Wo=({renderRow:e,flatData:t})=>rt({items:t,renderItem:(t,n)=>i`<cosmoz-grouped-list-row
				.item=${t}
				.index=${n}
				.renderFn=${e}
			></cosmoz-grouped-list-row>`})})),Ko,qo=e((()=>{Go(),E(),Ko=e=>Wo(Uo(e)),customElements.define(`cosmoz-grouped-list`,d(Ko,{useShadowDOM:!1}))})),Jo=e((()=>{qo()})),Yo,Xo,Zo,Qo=e((()=>{Oe(),Tt(),Yr(),Zr(),wi(),ki(),Mi(),lt(),E(),Ie(),n(),ot(),Fi(),Ui(),Gi(),Xi(),wo(),Jo(),Yo=e=>window.ShadyCSS?.ApplyShim?.transformCssText?.(e)||e,Xo=e=>{let{header:t,list:n,footer:r}=Co(e);return i`
		<style>
			${we([],()=>Yo(Pi))}
		</style>
...
`,i(Object.assign([Zo],{raw:[Zo]})),Xe(Object.assign([Zo],{raw:[Zo]}))})),$o,$,es,ts,ns,rs=e((()=>{$o=(e,t,n)=>{let r=String(e),i=-1,a=!n&&n!==0?` `:n,o=t-r.length;for(;++i<o;)r=a+r;return r},$=(e,t)=>Math.floor(Math.random()*(t-e+1))+e,es=()=>`2015-`+$o($(1,12),2,`0`)+`-`+$o($(1,28),2,`0`),ts=()=>{let e=$(0,20);return e===1?new Date(2015,3,2,14,26,10,299):e===2?new Date(2016,4,2,10,9,10,444):e===3?new Date(2016,4,2,10,9,10,443):e===4?new Date(2016,4,2,10,9,10,442):new Date($(2014,2017),$(1,12),$(1,28),$(0,23),$(0,59),$(0,59),$(0,999))},ns=(e,t,n)=>{let r=$(e,t),i=[],a=[`Lorem ipsum dolor sit amet`,`Nunc tristique`,`Curabitur vestibulum`,`Cras laoreet`,`Himenaeos`,`maximus diam purus at mauris`],o=[`SEK`,`USD`,`EUR`,`AUD`],s=0;for(let e=0;e<r;e+=1){let t=`Group `+e,r=e*2+1;for(let e=0;e<r;e+=1){let r=[],c=[],l=[],u=s%10;for(let e=0;e<u;e+=1)r.push(`Item `+e),c.push({name:`Item `+e,value:`item-value-`+e}),l.push({value:`cat-`+e,label:`Category `+e});i.push({id:s,name:t+` item `+e,value:$(0,1e4),bool:$(0,100)>50,object:{value:$(0,1e4),label:`Random string `+$(1,n)},sub:{subProp:a[s%a.length]},randomString:`Random string `+$(1,n),randomString2:`Random string 2 `+$(1,n),randomString3:`Random string 3 `+$(1,n),randomString4:`Random string 4 `+$(1,n),date:ts(),dateJSON:es(),amount:{amount:$(10,100),currency:o[s%o.length]},group:t,list:r,objectList:c,categories:s%7==0?null:l}),s+=1}}return i}})),is,as,os,ss,cs;e((()=>{n(),le(),dt(),Qo(),rs(),is={title:`Components/ComsmozOmnitableFullDemo`,component:`cosmoz-omnitable`,tags:[`autodocs`],args:{loading:!1,locale:`en`,sortOn:``,groupOn:``,descending:!1,groupOnDescending:!1,hashParam:``,settingsId:``,selectedItems:[],disabledFiltering:!1},argTypes:{loading:{control:`boolean`,description:`Show loading state`,table:{defaultValue:{summary:`false`}}},locale:{control:`select`,options:[`en`,`fr`,`sv`],description:`Language locale`,table:{defaultValue:{summary:`en`}}},selectedItems:{control:`object`,description:`Show selected items`},data:{control:`object`,description:`Show specified items`},sortOn:{control:`text`,description:`Column property name to sort on (e.g., "amount", "date", "id")`},groupOn:{control:`text`,description:`Column property name to group on (e.g., "amount", "date", "id")`},descending:{control:`boolean`,description:`Sort on descending`},groupOnDescending:{control:`boolean`,description:`Group on descending`},hashParam:{control:`text`,description:`Hash parameter for URL state management`},settingsId:{control:`text`,description:`ID for storing table settings`},disabledFiltering:{control:`boolean`,description:`Disable filter inputs in all column headers`,table:{defaultValue:{summary:`false`}}}},render:e=>i`
            ...
            >
                ...
                <paper-button slot="actions" on-run="removeItems">
                    ${b({styles:`vertical-align: middle; fill: currentColor;`})}
