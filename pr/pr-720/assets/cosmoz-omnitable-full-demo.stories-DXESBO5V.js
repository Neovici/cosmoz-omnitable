import{x as m,B as Ie,E as ht}from"./iframe-B5vgDPfm.js";import{t as K,c as T,g as C,P as A,u as M,a as ft,m as bt,s as Mt,D as Nt,b as jt,e as Pt,i as ye,h as Ve,o as J,d as _,f as Bt,j as ve,p as he,n as D,k as Gt,l as $e,q as Ht,r as Wt,v as qt,T as Xt,w as E,x as Ut,y as Kt,z as Jt,A as v,B as Qt,C as Yt,E as xt,F as Ae,G as I,H as yt,I as Ee,J as Zt,K as vt,N as en,L as tn,M as Te,O as nn,Q as Le,R as rn,S as on,U as Fe,V as Re,W as an,X as Oe,Y as P,Z as ln,_ as ze,$ as sn}from"./cosmoz-collapse-DCyNa-rd.js";import"./preload-helper-D9Z9MdNV.js";const un=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`;customElements.define("cosmoz-clear-button",T(cn));const U=({valuePath:n},e)=>C(e,n),dn=U,mn=U,pn=({valuePath:n},e)=>t=>{const r=C(t,n);return r==null?!1:r.toString().toLowerCase().trim().includes(e.toLowerCase().trim())},gn=(n,e)=>e===""||e==null?null:e,N=n=>class extends n{static get properties(){return{isOmnitableColumn:{type:Boolean,value:!0},title:{type:String},valuePath:{type:String,notify:!0},values:{type:Array,notify:!0},filter:{type:Object},noLocalFilter:{type:Boolean},disabled:{type:Boolean,value:!1,notify:!0},editable:{type:Boolean,notify:!0},loading:{type:Boolean,value:!1,notify:!0},externalValues:{type:Boolean,value:!1,notify:!0},name:{type:String},sortOn:{type:String},groupOn:{type:String},width:{type:String,value:"75px"},minWidth:{type:String,value:"40px"},flex:{type:String,value:"1"},cellClass:{type:String,value:"default-cell"},headerCellClass:{type:String,value:"default-header-cell"},priority:{type:Number,value:0},hidden:{type:Boolean,notify:!0},preferredDropdownHorizontalAlign:{type:String,value:"right"},renderHeader:{type:Function},renderCell:{type:Function},renderEditCell:{type:Function},renderGroup:{type:Function},mini:{type:Number,value:null},renderMini:{type:Function}}}static get observers(){return["notifyFilterChange(filter)"]}notifyFilterChange(e){this.__ownChange||this.dispatchEvent(new CustomEvent("legacy-filter-changed",{detail:{name:this.name,state:this.legacyFilterToState(e)},bubbles:!0}))}legacyFilterToState(e){return{filter:e}}getFilterFn(){}getString(e,t){return U(e,t)}toXlsxValue(e,t){return dn(e,t)}cellTitleFn(e,t){return this.getString(e,t)}headerTitleFn(e){return e.title}serializeFilter(e,t){return gn(e,t)}deserializeFilter(e,t){return t==null?null:typeof t=="string"?window.decodeURIComponent(t):t}getComparableValue(e,t){return mn(e,t)}computeSource(e,t){return t}_propertiesChanged(e,t,r){super._propertiesChanged(e,t,r),this.dispatchEvent(new CustomEvent("cosmoz-column-prop-changed",{bubbles:!0}))}},hn=n=>e=>n(t=>{if(t.inputValue===void 0&&e.target.value==="")return t;clearTimeout(t.t);const r=setTimeout(()=>n(o=>({...o,filter:o.inputValue})),1e3);return{...t,inputValue:e.target.value,t:r}}),fn=n=>()=>n(e=>({...e,filter:e.inputValue})),bn=n=>e=>{e.keyCode===13&&(e.preventDefault(),n(t=>({...t,filter:t.inputValue})))},xn=n=>e=>n(t=>({...t,headerFocused:e.detail.value})),yn=n=>()=>n(e=>({...e,filter:null,inputValue:null})),vn=n=>n!=null&&n!=="";class $n extends N(A){static get properties(){return{minWidth:{type:String,value:"55px"},editMinWidth:{type:String,value:"55px"},inputValue:{type:Object,notify:!0}}}getFilterFn(e,t){if(!(t==null||t===""))return pn(e,t)}renderCell(e,{item:t}){return m`<span class="default-column">${U(e,t)}</span>`}renderEditCell(e,{item:t},r){return m`<cosmoz-input
			no-label-float
			type="text"
		...
		></cosmoz-omnitable-amount-range-input>`}computeSource(e,t){return Z(e,t)}}customElements.define("cosmoz-omnitable-column-amount",Mn);const Nn=(n,e)=>{if(!Array.isArray(n))return;const t=[];return n.reduce((r,o)=>Array.isArray(o)?(o.forEach(i=>{r.push(i)}),r):(r.push(o),r),[]).filter((r,o,i)=>{if(i.indexOf(r)!==o)return!1;if(e){const a=C(r,e);if(t.indexOf(a)!==-1)return!1;t.push(a)}return!0})},jn=(n,e,t)=>{if(n==null)return[];if(Array.isArray(n))return Nn(n,e);if(typeof n=="object"){const r=e??"id",o=t??"label";return Object.entries(n).map(([i,a])=>({[r]:i,[o]:a})).sort((i,a)=>i[o]<a[o]?-1:i[o]>a[o]?1:0)}return[]},Ne=(n,e,t)=>ve(e&&C(n,e)).map(he(t)),je=({valuePath:n,textProperty:e},t)=>Ne(t,n,e).filter(r=>r!=null).join(", "),Pn=je,Bn=({valueProperty:n,valuePath:e,emptyValue:t,emptyProperty:r},o)=>i=>{const a=he(n),l=ve(C(i,e));return o.some(s=>l.length===0&&he(r||n)(s)===t||l.some(u=>a(u)===a(s)))},Pe=n=>e=>n(t=>({...t,filter:e})),Be=n=>e=>n(t=>({...t,headerFocused:e})),Ge=n=>e=>n(t=>({...t,query:e})),Ct=({emptyValue:n,emptyLabel:e,emptyProperty:t,textProperty:r,valueProperty:o},i)=>{const a=jn(i,o,r);return!e||n===void 0||!r||!(t||o)||!a?a:[{[r]:e,[t||o]:n},...a]},Gn=(n,e)=>Ct(n,$t(e,n.valuePath)),He=n=>class extends n{static get properties(){return{textProperty:{type:String},valueProperty:{type:String},emptyLabel:{type:String},emptyValue:{type:Object},emptyProperty:{type:String}}}getConfig(e){return{emptyProperty:e.emptyProperty}}getString(e,t){return je(e,t)}toXlsxValue(e,t){return Pn(e,t)}getComparableValue({valuePath:e,valueProperty:t},r){const o=C(r,e);return t==null?o:ve(o).reduce((a,l)=>(a.push(C(l,t)),a),[]).sort().join(" ")}getFilterFn(e,t){if(!(!t||!Array.isArray(t)||t.length===0))return Bn(e,t)}serializeFilter(e,t){return t.length===0?null:JSON.stringify(t)}deserializeFilter(e,t){return JSON.parse(decodeURIComponent(t))}computeSource(e,t){return e.externalValues||typeof e.values=="function"?async(...r)=>Ct(e,await Promise.resolve(ye(e.values,...r))):Gn(e,t)}},Hn=({valuePath:n,textProperty:e,valueProperty:t},r)=>{const o=e?Gt(e):he(t),i=ve(n&&C(r,n)).map(o);return i.length>1?i.filter(Boolean).join(","):i[0]};class Wn extends He(N(A)){static get properties(){return{headerCellClass:{type:String,value:"autocomplete-header-cell"},minWidth:{type:String,value:"55px"},editMinWidth:{type:String,value:"55px"},keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},showSingle:{type:Boolean},preserveOrder:{type:Boolean},limit:{type:Number},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,showSingle:e.showSingle,preserveOrder:e.preserveOrder,limit:e.limit,textual:e.textual}}renderCell(e,{item:t}){return m`<span class="default-column"
		...
		>`}getComparableValue(e,t){return Hn(e,t)}}customElements.define("cosmoz-omnitable-column-autocomplete",Wn);const We=(n,e)=>e.find(({value:t})=>n===t),qn=(n,e,t)=>{const r=We(e,t);return r?r.text:n},tt=(n,e,t,r)=>qn(n,C(e,t),r),Xn=({valuePath:n},e,t)=>We(C(e,n),t),Un=n=>e=>{n(t=>({...t,filter:e?.[0]?.value??null}))},Kn=n=>e=>{n(t=>({...t,headerFocused:e}))},Jn=n=>e=>{n(t=>({...t,query:e}))},Qn=n=>e=>n(e?.[0]?.value),nt=({valuePath:n,trueLabel:e,falseLabel:t},r)=>C(r,n)?e:t,Yn=({valuePath:n},e)=>t=>C(t,n)===e,ne=bt((n,e)=>[{text:n,value:!0},{text:e,value:!1}]),Zn=({valuePath:n,trueLabel:e,falseLabel:t},r)=>n?C(r,n)?e:t:"",er=(n,e)=>{try{return JSON.parse(e)}catch{return null}};class tr extends N(A){static get properties(){return{trueLabel:{type:String,value:"True"},falseLabel:{type:String,value:"False"},flex:{type:String,value:"0"},cellClass:{type:String,value:"boolean-cell"}}}getString(e,t){return nt(e,t)}renderCell(e,{item:t}){return nt(e,t)}renderEditCell(e,{item:t},r){const{trueLabel:o,falseLabel:i}=e;return m`<cosmoz-autocomplete
			no-label-float
		...
		`}_fromInputString(e,t){const r=this.toDate(e);if(r!=null)return t==="min"&&r.setHours(0,0,0,0),t==="max"&&r.setHours(23,59,59),r}_filterInputChanged(e,t){const r=e.path.split(".")[1],o=r&&e.value;if(o&&o.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}}customElements.define("cosmoz-omnitable-date-range-input",nr);const rr=n=>{const e=-new Date(n).getTimezoneOffset()/60;return(e<0?"-":"+")+["0",Math.abs(e)].join("").substr(-2)+":00"},Xe=n=>n.length===19?n+rr(n):n,St=n=>{if(n==null||n==="")return;let e=n;return!(e instanceof Date)&&(typeof n=="string"&&(e=Xe(e)),e=Ht(e),!e)||Number.isNaN(e.getTime())?null:e},j=({valuePath:n},e)=>{if(e==null)return;let t=e;n!=null&&(t=C(e,n));const r=St(t);if(r!=null)return L(r.getTime())},V=(n,e,t)=>{const r=St(n);return r??null},Ue=(n,e)=>{if(e==null)return;const t=V(n);if(t!=null)return e.format(t)},re={},or=n=>{const e=n||"";return re[e]||(re[e]=new Intl.DateTimeFormat(n||void 0)),re[e]},rt=({valuePath:n,locale:e},t)=>{let r=C(t,n||"");return r===void 0?"":(r=V(r),r===null?"Invalid Date":Ue(r,or(e)))},kt=n=>{const e=V(n);if(e==null)return null;const t=$e(e);return t==null?null:t.slice(0,10)},ir=({valuePath:n},e)=>kt(C(e,n||"")),_t=(n,e)=>{const t=V(n);if(t!=null)return t},ot=n=>{const e=kt(n);return e??""},ar=({valuePath:n},e)=>{if(!n)return"";const t=V(C(e,n));if(!t)return"";const r=V($e(t));return r?(r.setHours(0,0,0,0),r):""},It=(n,e)=>t=>{const r=j(n,t);if(r==null)return!1;const o=j({...n,valuePath:"min"},e),i=j({...n,valuePath:"max"},e);return!(r<(o??-1/0)||r>(i??1/0))};class lr extends N(A){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"date-header-cell"},width:{type:String,value:"100px"},minWidth:{type:String,value:"82px"},flex:{type:String,value:"0"}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const r=j({...e,valuePath:"min"},t),o=j({...e,valuePath:"max"},t);if(!(r==null&&o==null))return It(e,t)}getString(e,t){return rt(e,t)}toXlsxValue(e,t){return ar(e,t)}getComparableValue(e,t){return j(e,t)}serializeFilter(e,t){if(t==null)return;const r=V(t.min),o=V(t.max);if(!(r==null&&o==null))return ot(r)+"~"+ot(o)}deserializeFilter(e,t){if(t==null||t==="")return null;const r=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(r)?{min:V(r[1]),max:V(r[2])}:null}renderCell(e,{item:t}){return m`<div class="omnitable-cell-date">
			${rt(e,t)}
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return Z(e,t)}}customElements.define("cosmoz-omnitable-column-date",lr);class sr extends He(N(A)){renderCell({valuePath:e,textProperty:t},{item:r}){const o=Ne(r,e,t).map(i=>m`<li>${i}</li>`);return m`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		`}renderEditCell(){return"not implemented"}renderHeader(e,{filter:t,query:r},o,i){return m`<cosmoz-autocomplete-ui
			...
			.onText=${Ge(o)}
			>${D(e.loading,()=>m`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}}customElements.define("cosmoz-omnitable-column-list-horizontal",sr);window.Cosmoz=window.Cosmoz||{};class it extends Wt(qt(Xt,A)){static get template(){return Ve`
			<style>
				:host {
					display: block;
				}
		...
		`}static get is(){return"cosmoz-omnitable-column-list-data"}static get properties(){return{items:{type:Array},_expanded:{type:Boolean,value:!1},_othersCount:{type:Number,computed:"_computeOthersCount(items)"}}}static get observers(){return["_itemsLengthChanged(items.length)"]}_itemsLengthChanged(){requestAnimationFrame(()=>this.dispatchEvent(new CustomEvent("expand",{bubbles:!0})))}_firstItem(e){if(e!=null&&e.length>0)return e[0]}_hideExpand(e,t){return e!==void 0&&e.length!==null?e.length<=2||t:!0}_hideCollapse(e,t){return e!==void 0&&e.length!==null?e.length<=2||!t:!0}_otherItems(e,t){if(e!=null&&(e.length<=2||t))return e.slice(1)}_computeOthersCount(e){if(e!=null)return e.length-1}_toggleExpand(e){this._expanded=!this._expanded,e.stopPropagation(),e.preventDefault()}}customElements.define(it.is,it);class ur extends He(N(A)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:r}){return m`<cosmoz-omnitable-column-list-data
			.items=${Ne(r,e,t)}
		...
		></cosmoz-omnitable-number-range-input>`}computeSource(e,t){return Z(e,t)}}customElements.define("cosmoz-omnitable-column-number",dr);const Ft="1970-01-01",G=(n,e,t)=>{const r=typeof n=="string"&&n.length>3&&n.length<=9?Xe(Ft+"T"+n):n;return V(r)},oe={},mr=n=>{const e=n||"";if(oe[e])return oe[e];const t={hour:"numeric",minute:"numeric",second:"numeric"};return oe[e]=new Intl.DateTimeFormat(n||void 0,t),oe[e]},ge=({valuePath:n,locale:e},t)=>{const r=G(C(t,n||""));return r===void 0?"":r===null?"Invalid Date":Ue(r,mr(e))},pr=(n,e)=>n.valuePath?ge(n,e):"",gr=n=>{const e=G(n);if(e==null)return null;const t=$e(e);return t&&t.slice(11,19)},X=({valuePath:n},e)=>{if(e==null)return;const t=gr(n==null?e:C(e,n));if(t==null)return;const r=G(Xe(Ft+"T"+t));return r==null?r:L(r.getTime())},hr=(n,e)=>t=>{const r=X(n,t);if(r==null)return!1;const o=X({...n,valuePath:"min"},e),i=X({...n,valuePath:"max"},e);return o==null||i==null?!1:!(r<o||r>i)},at=n=>{const e=G(n);return e==null?"":e.toISOString().slice(11,19).replace(/:/gu,".")},lt=n=>{if(!(n==null||n===""))return G(typeof n=="string"?n.replace(/\./gu,":")+"Z":n)};class fr extends qe(ee(A)){render(){return m`
			<style>
				paper-dropdown-menu {
					--iron-icon-width: 0;
					display: block;
		...
		></cosmoz-input>`}renderHeader({title:e,min:t,max:r,locale:o,filterStep:i},{filter:a},l,s){return m`<cosmoz-omnitable-time-range-input
			...
			@filter-changed=${({detail:{value:u}})=>l(c=>({...c,filter:u}))}
			@header-focused-changed=${({detail:{value:u}})=>l(c=>({...c,headerFocused:u}))}
		></cosmoz-omnitable-time-range-input>`}computeSource(e,t){return Z(e,t)}}customElements.define("cosmoz-omnitable-column-time",br);const ie={},xr=n=>{const e=n||"";if(ie[e])return ie[e];const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return ie[e]=new Intl.DateTimeFormat(n||void 0,t),ie[e]},Ce=({valuePath:n,locale:e},t)=>{const r=V(C(t,n||""));return r===void 0?"":r===null?"Invalid Date":Ue(r,xr(e))},yr=({valuePath:n},e)=>n?C(e,n):"",st=n=>{const e=V(n);return e==null?"":e.toISOString().slice(0,19).replace(/:/gu,".")},ut=n=>{if(!(n==null||n==="")&&typeof n=="string")return V(n.replace(/\./gu,":")+"Z")};class vr extends qe(ee(A)){render(){return m`
			<style>
				paper-dropdown-menu {
					--iron-icon-width: 0;
					display: block;
		...
		`}_toInputString(e){const t=this.toValue(e);if(t!=null)return this._toLocalISOString(t).slice(0,19)}_computeFormatter(e){const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return new Intl.DateTimeFormat(e||void 0,t)}}customElements.define("cosmoz-omnitable-datetime-range-input",vr);class ct extends N(A){static get is(){return"cosmoz-omnitable-column-datetime"}static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"datetime-header-cell"},width:{type:String,value:"210px"},minWidth:{type:String,value:"128px"},flex:{type:String,value:"0"},filterStep:{type:Number,value:1}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const r=j({...e,valuePath:"min"},t),o=j({...e,valuePath:"max"},t);if(!(r==null&&o==null))return It(e,t)}getString(e,t){return Ce(e,t)}toXlsxValue(e,t){return yr(e,t)}getComparableValue(e,t){return j(e,t)}serializeFilter(e,t){if(t==null)return;const r=V(t.min),o=V(t.max);if(!(r==null&&o==null))return st(r)+"~"+st(o)}deserializeFilter(e,t){if(t==null||t==="")return null;const r=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(r)?{min:ut(r[1]),max:ut(r[2])}:null}renderCell(e,{item:t}){return Ce(e,t)}renderEditCell(e,{item:t},r){return m`<cosmoz-input
			no-label-float
			type="text"
			@change=${i=>r(_t(i.target.value))}
			.value=${Ce(e,t)}
...
>
	...
	>
		<span>${a}</span> ${Sr}
	</button>`},Dt=({columns:n,...e})=>n?.map(t=>Ot({column:t,...e})),kr=()=>m`
...
`,Vt=n=>(e,t,r=Ut)=>{const o=Yt(),i=new URLSearchParams(o.hash.replace("#",""));return n(e,t,r,i),"#!"+Object.assign(o,{hash:i}).href.replace(location.origin,"")},At=n=>n==null||n==="",Ir=Vt((n,e,t,r)=>At(t(e))?r.delete(n):r.set(n,t(e))),Fr=Vt((n,e,t,r)=>Object.entries(e).map(t).forEach(([o,i])=>At(i)?r.delete(n+o):r.set(n+o,i))),Q=(n,e,{suffix:t="",read:r,write:o,multi:i}={})=>{const[a,l]=i?[Fr,Kt]:[Ir,Jt],[s,u]=M(()=>e==null?n:l(e+t,r)??n),c=v(d=>u(h=>{const p=ye(d,h);return e!=null&&Qt(a(e+t,p,o),null,{notify:!1}),p}),[e,t,a,o]);return[s,c]},Or=n=>[!0,"true",1,"yes","on"].includes(n),ae=n=>n===""||(n==null?void 0:Or(n)),le=(n,e,t)=>v(r=>{n(r),t(o=>({...o,[e]:r}))},[n,e,t]),Dr=(n,e,t,r,o)=>{const[i,a]=Q(t.sortOn,e,{suffix:"-sortOn"}),[l,s]=Q(ae(t.descending),e,{suffix:"-descending",read:ae}),[u,c]=Q(t.groupOn,e,{suffix:"-groupOn"}),[d,h]=Q(ae(t.groupOnDescending),e,{suffix:"-groupOnDescending",read:ae}),p=I(()=>n.find(g=>g.name===i),[n,i]),z=I(()=>n.find(g=>g.name===u),[n,u]),b={groupOn:u,setGroupOn:le(c,"groupOn",r),groupOnDescending:d,setGroupOnDescending:le(h,"groupOnDescending",r),sortOn:i,setSortOn:le(a,"sortOn",r),descending:l,setDescending:le(s,"descending",r),columns:n},x=I(()=>b,Object.values(b)),F=v(g=>{a(g.sortOn),c(g.groupOn),s(g.descending),h(g.groupOnDescending)},[]);return E(()=>void(o.current=F),[]),{...x,sortAndGroup:x,groupOnColumn:z,sortOnColumn:p}},Ke=xt();customElements.define("sort-and-group-provider",Ke.Provider);customElements.define("sort-and-group-consumer",T(({render:n})=>n(Ae(Ke)),{useShadowDOM:!1}));const Vr=({data:n,columns:e,groupOnColumn:t,filters:r,setFilterState:o,sortAndGroup:{sortOn:i,setSortOn:a,descending:l,setDescending:s}={}})=>yt(e,u=>u.name,u=>[m`<div
			...
			>
				...
				.column="${u}"
				name="${u.name}"
			></cosmoz-omnitable-resize-nub>`]),Ar=({columns:n,settingsConfig:e,hideSelectAll:t,...r})=>{const o=Ae(Ke);return m`
		${D(n,i=>Vr({columns:i,sortAndGroup:o,...r}))}
		${D(!t,()=>m` <cosmoz-omnitable-settings
					.config=${e}
					part="settings"
				></cosmoz-omnitable-settings>`)}
	`};customElements.define("cosmoz-omnitable-header-row",T(Ar,{useShadowDOM:!1}));const Er=K`
	:host {
		display: flex;
		align-items: center;
		flex-wrap: wrap;
...
`;customElements.define("cosmoz-omnitable-item-expand-line",T(Tr,{styleSheets:[Ee(Er)]}));const Lr=({columns:n,item:e,selected:t,expanded:r,groupOnColumn:o})=>Zt(n,i=>m`<cosmoz-omnitable-item-expand-line
				.column=${i}
				?hidden=${i===o}
				exportparts="item-expand-label, item-expand-value"
				>${i.renderCell(i,{item:e,selected:t,expanded:r})}</cosmoz-omnitable-item-expand-line
			>`);customElements.define("cosmoz-omnitable-item-expand",T(Lr,{useShadowDOM:!1}));const Rr=(n,e,t)=>n.editable?n.renderEditCell(n,e,t(n,e.item)):n.renderCell(n,e),Mr=({columns:n,groupOnColumn:e,item:t,index:r,selected:o,expanded:i,onItemChange:a})=>yt(n,l=>l.name,l=>m`<div
				...
				name="${l.name}"
			>
				${Rr(l,{item:t,index:r,selected:o,expanded:i},a)}
			</div>`);customElements.define("cosmoz-omnitable-item-row",T(Mr,{useShadowDOM:!1}));const Et=K`
	.checkbox {
		box-sizing: border-box;
		width: 18px;
		height: 18px;
...
`,dt=n=>{const e=n.replace(/"/gu,'""');return e.search(/("|,|\n)/gu)>=0?'"'+e+'"':n},jr=(n,e,t)=>{const i=n.map(l=>dt(l.title)).join(";")+`
`,a=e.map(l=>n.map(s=>{const u=s.getString(s,l);return u==null?"":dt(String(u))}).join(";")+`
`);a.unshift(i),vt(new File(a,t,{type:"text/csv;charset=utf-8"}))},Pr=(n,e)=>{const t=n.map(o=>o.title),r=e.map(o=>n.map(i=>{const a=i.toXlsxValue(i,o);return a??""}));return r.unshift(t),r},Br=(n,e,t,r)=>{const o=Pr(n,e),i=new en(t).addSheetFromData(o,r).generate();vt(new File([i],t,{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}))},Gr=({columns:n,selectedItems:e,csvFilename:t,xlsxFilename:r,xlsxSheetname:o,topPlacement:i})=>m`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!Te(e.length)}
		part="bottomBar"
	...
	>
		<slot name="info" slot="info">
			${tn("{0} selected item","{0} selected items",e.length)}
		</slot>
	...
	</cosmoz-bottom-bar>`,Hr=({allSelected:n,onAllCheckboxChange:e,sortAndGroup:t,dataIsValid:r,data:o,columns:i,filters:a,groupOnColumn:l,setFilterState:s,settingsConfig:u,hideSelectAll:c})=>m`<sort-and-group-provider .value=${t}>
...
`,qr=({settingsConfig:n})=>{const{columns:e,collapsed:t}=n,r=e.filter(o=>!t.some(i=>i.name===o.name));return m`<div class="skeleton">
...
`,se=n=>{const e=parseInt(n,10);return isFinite(e)?e:void 0},Jr=n=>{const{config:e}=n,{settings:t,setSettings:r,collapsed:o}=e,i=Le({collapsed:o,settings:t.columns,setSettings:v(a=>r(l=>({...l,columns:a})),[r])});return{...e,onDown:v(a=>{a.target.closest(".pull")&&(i.handle=a.currentTarget)},[i]),onDragStart:v(a=>{const{target:l}=a,s=se(l.dataset.index);if(!i.handle?.contains(l)||s==null)return a.preventDefault();i.handle=null,a.dataTransfer.effectAllowed="move",a.dataTransfer.setData("omnitable/sort-index",s),a.dataTransfer.setData("text/plain",s),setTimeout(()=>l.classList.add("drag"),0),l.addEventListener("dragend",u=>u.target.classList.remove("drag"),{once:!0})},[i]),onDragEnter:v(a=>{const l=a.currentTarget;l===a.target&&(a.preventDefault(),a.dataTransfer.dropEffect="move",l.classList.add("dragover"))},[]),onDragOver:v(a=>{a.preventDefault(),a.currentTarget.classList.add("dragover")},[]),onDragLeave:v(a=>{const l=a.currentTarget;l.contains(a.relatedTarget)||l.classList.remove("dragover")},[]),onDrop:v(a=>{const l=se(a.dataTransfer.getData("omnitable/sort-index")),s=se(a.currentTarget.dataset.index),{settings:u,setSettings:c}=i;a.currentTarget.classList.remove("dragover"),a.preventDefault();const d=u.slice();d.splice(s+(l>=s?0:-1),0,d.splice(l,1)[0]),c(d)},[i]),onToggle:v(a=>{const{settings:l,setSettings:s}=i,u=l.map(d=>({...d,disabled:d.disabled||i.collapsed?.some(h=>h.name===d.name)})),c=se(a.target.closest("[data-index]")?.dataset.index);u.splice(c,1,{...l[c],disabled:!a.target.checked,priority:a.target.checked?l.reduce((d,h)=>Math.max(d,h.priority),0)+1:l[c].priority}),s(u)},[i])}},Qr=[rn({apply({availableHeight:n,elements:e}){Object.assign(e.floating.style,{maxHeight:`${Math.max(0,n)}px`})}}),...on],Yr=({onDragStart:n,onDragEnter:e,onDragOver:t,onDragLeave:r,onDrop:o,onDown:i,onToggle:a,collapsed:l,filters:s})=>(u,c)=>{const d=!!l?.find(p=>p.name===u.name),h=!u.disabled&&!d;return m` <div
			class="item"
			data-index=${c}
			@mousedown=${i}
			draggable="true"
		...
		>
			...
			<input
				...
				.indeterminate=${d}
			/>
		</div>`},Zr=n=>{const{settings:e,settingsId:t,onSave:r,onReset:o,hasChanges:i,opened:a,setOpened:l,...s}=Jr(n);return m` <div class="headline">
			${_("Sort and filter")}
			<button
				class="close"
		...
		<div class="contents">
			...
			>
				<div class="list">${e.columns?.map(Yr(s))}</div>
			</cosmoz-collapse>
			...
			<cosmoz-collapse ?opened=${a.sort}> ${_r()} </cosmoz-collapse>
		...
		${D(t,()=>m`<div class="buttons">
				...
				</div>`)}`};customElements.define("cosmoz-omnitable-settings-ui",T(Zr,{styleSheets:[Ee(Ur)]}));const eo=({config:n,newLayout:e})=>m`
	<cosmoz-dropdown
...
`;customElements.define("cosmoz-omnitable-settings",T(eo,{styleSheets:[Ee(Kr)]}));const fe=["sortOn","descending","groupOn","groupOnDescending"],ue=n=>e=>typeof e=="object"&&e!==null&&"name"in e&&e.name===n,to=(n=[],e=[],t=[])=>{const r=e.filter(a=>n.some(ue(a.name))),o=n.filter(a=>a.name!=null&&!e.some(ue(a.name))&&!t.some(ue(a.name))),i=t.filter(a=>!e.some(ue(a.name)));return[...r,...i.flatMap(a=>{const l=n.find(s=>s.name===a.name);return l?{...a,title:l.title??a.title??"",minWidth:parseInt(l.minWidth??"0",10)}:[]}),...o.map(a=>{const{name:l,title:s,priority:u,minWidth:c,width:d,flex:h}=a;return{name:l??"",title:s??"",priority:u??0,minWidth:parseInt(c??"0",10),width:parseInt(d??"0",10),flex:parseInt(h??"0",10)}})]},no=(n,e)=>({...e,...Fe(Array.from(fe))(n),columns:n.columns?.map(Fe(["name","priority","width","flex","disabled"]))}),ro=({columns:n,settings:e,savedSettings:t,initial:r})=>({...Object.fromEntries(fe.flatMap(i=>r?.[i]!=null?[[i,r[i]]]:[])),...t?Fe(Array.from(fe))(t):{},...e,columns:to(n,e?.columns,t?.columns)}),oo=({prefix:n="omnitable-"}={})=>({write:async(t,r)=>{const o=n+t;try{r?localStorage.setItem(o,JSON.stringify(r)):localStorage.removeItem(o)}catch(i){console.error(i)}},read:async t=>{if(t)try{return JSON.parse(localStorage.getItem(n+t))}catch(r){console.error(r)}}}),io=xt(oo),ao=()=>{const n=Ae(io);return I(()=>n(),[n])},lo=(n,e,t,r)=>{const[o,i]=M(),{read:a,write:l}=ao();return E(async()=>{n&&i(await a(n))},[n,a]),{settingsId:n,savedSettings:o,onSave:v(async()=>{if(!n)return;const s=no(e,o);await l(n,s),t(),i(s)},[e,o]),onReset:v(async s=>{t(),s.shiftKey&&(await l(n),i()),r?.()},[r]),hasChanges:e!=null}},so=({settingsId:n,host:e})=>{const t=I(()=>Object.fromEntries(fe.map(b=>[b,e[b]])),[]),r=Re(),o=v(()=>{r.current?.(t)},[t]),[i,a]=M(),[l,s]=M({columns:!0,sort:!0}),{savedSettings:u,...c}=lo(n,i,a,o),{enabledColumns:d}=e,h=_n(e,{enabledColumns:d}),p=I(()=>ro({columns:h,settings:i,savedSettings:u,initial:t}),[h,i,u]),z=I(()=>p.columns.map(b=>h.find(x=>x.name===b.name)).filter(Boolean),[h,...p.columns.map(b=>b.name)]);return{...c,opened:l,setOpened:s,settings:p,columns:z,setSettings:a,resetRef:r}},mt=n=>Number.isFinite(n)?n:0,uo=(n,e)=>{const t=[];let[r,o]=n.reduce(([c,d],{width:h,flex:p})=>[c+h,d+p],[0,0]),i=e-r,a=mt(i/o),l=0,s=0,u=0;for(let c=0;c<n.length;c++){const{width:d,minWidth:h,flex:p}=n[c],z=i>=0?a*p:d*i/r;if(h>d+z){l+=d,s+=h,u+=p,t[c]=h;continue}if(p===0){l+=d,s+=d,t[c]=d;continue}}r-=l,i=e-s-r,o-=u,a=mt(i/o);for(let c=0;c<n.length;c++){if(t[c]!=null)continue;const{width:d,flex:h}=n[c],p=i>=0?a*h:d*i/r;t[c]=d+p}return t},be=Symbol("index"),co=(n,e)=>{if(typeof n.findLastIndex=="function")return n.findLastIndex(e);for(let t=n.length-1;t>=0;t--)if(e(n[t],t,n))return t;return-1},mo=(n,e)=>{const t=co(n,a=>a!=null&&a>0),r=(a,l)=>`.cell[name="${a}"], cosmoz-omnitable-skeleton::part(cell-${a}){width: ${Math.floor(l)}px;padding: 0 min(3px, ${l/2}px)}`,o=a=>`cosmoz-omnitable-resize-nub[name="${a}"]{display:none}`,i=a=>`cosmoz-omnitable-resize-nub[name="${a}"], .cell[name="${a}"]{display:none}`;return e.map((a,l)=>{const s=n[l];if(s==null||s===0)return i(a.name);const u=r(a.name,s);return l===t?`${u}
${o(a.name)}`:u}).join(`
`)},Tt=(n,e,t)=>{const r=n.filter(l=>!l.hidden),o=r.reduce((l,{width:s})=>l+s,0);if(r.length>1&&o>e)return Tt(r.slice(1),e,t);const i=r.reduce(([l,s],u,c)=>[Math.max(l,u.index),u.index>l?c:s],[-1,-1])[1];return i!==-1&&(r[i].flex=1),uo(r,e).reduce((l,s,u)=>(l[r[u].index]=s,l),new Array(t).fill(void 0))},po=(n,e)=>n.length===0?".cell {display: none;}":mo(n,e),go=({host:n,canvasWidth:e,layout:t,setSettings:r})=>{const o=Re();o.current=i=>r(a=>{const l=a.columns,{detail:{newWidth:s,column:u}}=i,c=l.findIndex(p=>p.name===u.name),d=[],h=l.reduce((p,z)=>Math.max(p,z.priority),-1/0);for(let p=0;p<t.length;p++)if(d[p]={...l[p]},p<c&&t[p]&&(d[p].width=t[p],d[p].flex=0,d[p].priority=h),p===c){const z=t.reduce((b,x,F)=>F<c&&x?b-x:b,e);d[p].width=Math.min(z,Math.max(s,l[p].minWidth)),d[p].flex=0,d[p].priority=h}return{...a,columns:d}}),E(()=>{const i=a=>o.current(a);return n.addEventListener("column-resize",i),()=>n.removeEventListener("column-resize",i)},[])},ho=(n,e)=>E(()=>{const t=([o])=>{o.contentRect?.width!==0&&requestAnimationFrame(()=>e(o.contentRect?.width-20-44-24))},r=new ResizeObserver(t);return r.observe(n),()=>r.unobserve(n)},[]),fo=n=>{const[e,t]=M(()=>n.getBoundingClientRect().width);return ho(n,t),e},bo=(n,e)=>{const t=I(()=>{let r=!1,o;const i=()=>{if(!r)return;o=requestAnimationFrame(i),n()&&(r=!1)};return{start:()=>{r=!0,cancelAnimationFrame(o),o=requestAnimationFrame(i)},stop:()=>{r=!1,cancelAnimationFrame(o)}}},[]);E(()=>{t.start()},e),E(()=>()=>t.stop(),[])},xo=(n=0,e=0)=>Math.abs(n-e)<.1,yo=(n,e=1.9,t=an)=>{const r=Le({target:n}),o=v(()=>{if(r.tween||(r.tween=r.target),r.target.every((i,a)=>r.tween[a]===i))return t(r.tween),!0;r.tween=r.target.map((i,a)=>xo(r.tween[a],i)?i:(r.tween[a]??0)+((i??0)-(r.tween[a]??0))/e||0),t(r.tween)},[]);bo(o,[n])},vo=({canvasWidth:n,groupOnColumn:e,config:t,miniColumn:r})=>I(()=>{if(!Array.isArray(t)||n==null||n===0)return[];const o=t.map((i,a)=>({minWidth:i.minWidth,width:i.width,flex:i.flex,priority:i.priority,name:i.name,index:a,hidden:i.name===e?.name||i.disabled})).map(i=>r?{...i,hidden:r.name!==i.name}:i).sort(({index:i,priority:a},{index:l,priority:s})=>a===s?l-i:a-s);return Tt(o,n,o.length)},[n,e,t]),$o=({host:n,canvasWidth:e,columns:t})=>{const r=n.miniBreakpoint??480,o=I(()=>e<=r,[e,r]),i=I(()=>o?t?.filter(u=>u.mini!=null).sort((u,c)=>(u.mini??0)-(c.mini??0)):[],[t,o]),[a,...l]=i??[],s=!!a;return E(()=>{n.toggleAttribute("mini",s)},[s]),{isMini:s&&o,miniColumn:a,miniColumns:l}},wo=n=>{const e=I(()=>new CSSStyleSheet,[]);return E(()=>{n.shadowRoot.adoptedStyleSheets=[...n.shadowRoot.adoptedStyleSheets,e]},[]),e},zo=({host:n,columns:e,settings:t,setSettings:r,resizeSpeedFactor:o,sortAndGroupOptions:i})=>{const a=fo(n),{isMini:l,miniColumn:s,miniColumns:u}=$o({host:n,canvasWidth:a,columns:e}),{groupOnColumn:c}=i,d=vo({canvasWidth:a,groupOnColumn:c,miniColumn:s,config:t.columns}),h=wo(n),p=I(()=>t.columns.reduce((b,x,F)=>d[F]!=null||x.name===c?.name||x.disabled?b:[...b,e.find(g=>g.name===x.name)],[]),[e,t,d]),z=Le({columns:t.columns});return yo(d,o,b=>{const x=po(b,z.columns);h.replace(x)}),go({host:n,canvasWidth:a,layout:d,setSettings:b=>r(b(t))}),{isMini:l,collapsedColumns:p,miniColumns:u}},Co=({host:n,...e})=>{const{csvFilename:t="omnitable.csv",xlsxFilename:r="omnitable.xlsx",xlsxSheetname:o="Omnitable",topPlacement:i="top-end"}=n;return{csvFilename:t,xlsxFilename:r,xlsxSheetname:o,topPlacement:i,...e}},So=({host:n,selectedItems:e,data:t,sortAndGroupOptions:r,collapsedColumns:o,settings:i,filterFunctions:a,settingS:l,filters:s,...u})=>{const c=t&&t.length>0&&e.length===t.length,d=b=>{b.target.checked?n.shadowRoot.querySelector("#groupedList").selectAll():n.shadowRoot.querySelector("#groupedList").deselectAll()},{groupOnColumn:h}=r,p=I(()=>[h,...o,...i.columns.filter(b=>b.disabled)].some(b=>b&&Object.keys(a).includes(b.name)),[a,i,o]),z=I(()=>({...l,collapsed:o,badge:p,filters:s}),[l,o,p,s]);return E(()=>{const b=n.shadowRoot.querySelector("#tableContent"),x=new ResizeObserver(F=>requestAnimationFrame(()=>{n.style.setProperty("--ot-height",F[0]?.contentRect.height+"px")}));return x.observe(b),()=>x.unobserve(b)},[]),{allSelected:c,onAllCheckboxChange:d,data:t,settingsConfig:z,filters:s,groupOnColumn:h,sortAndGroup:r.sortAndGroup,...u}},Lt=m`
	<svg
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
...
`,ko=n=>n?"groupRow groupRow-folded":"groupRow",_o=({item:n,index:e})=>t=>D(t?.length>0,()=>m`
			...
			`),Io=({columns:n,collapsedColumns:e,miniColumns:t,onItemClick:r,onCheckboxChange:o,dataIsValid:i,groupOnColumn:a,onItemChange:l,rowPartFn:s})=>(u,c,{selected:d,expanded:h,toggleCollapse:p})=>m`
		<div
			?selected=${d}
	...
	`,Fo=({onCheckboxChange:n,dataIsValid:e,groupOnColumn:t})=>(r,o,{selected:i,folded:a,toggleFold:l})=>m` <div
			class="${ko(a)}"
		...
		</div>`,Oo=({host:n,error:e,dataIsValid:t,processedItems:r,columns:o,collapsedColumns:i,miniColumns:a,sortAndGroupOptions:l,rowPartFn:s,...u})=>{const{loading:c=!1,displayEmptyGroups:d=!1,compareItemsFn:h}=n,p=Re({shiftKey:!1,ctrlKey:!1}),z=v(g=>{const k=g.target.dataItem,f=g.target.checked;p.current.shiftKey?n.shadowRoot.querySelector("#groupedList").toggleSelectTo(k,f):p.current.ctrlKey?(g.target.checked=!0,n.shadowRoot.querySelector("#groupedList").selectOnly(k)):n.shadowRoot.querySelector("#groupedList").toggleSelect(k,f),g.preventDefault(),g.stopPropagation()},[]);E(()=>{const g=({shiftKey:k,ctrlKey:f})=>{p.current={shiftKey:k,ctrlKey:f}};return window.addEventListener("keydown",g),window.addEventListener("keyup",g),()=>{window.removeEventListener("keydown",g),window.removeEventListener("keyup",g)}},[]);const b=v(g=>{const k=g.composedPath();k.slice(0,k.indexOf(g.currentTarget)).find(y=>y.matches?.("a, .checkbox, .expand"))||n.dispatchEvent(new window.CustomEvent("omnitable-item-click",{bubbles:!0,composed:!0,detail:{item:g.currentTarget.dataItem,index:g.currentTarget.dataIndex}}))},[]),{groupOnColumn:x}=l,F=v((g,k)=>f=>In(n,g,k,f),[]);return{...u,processedItems:r,dataIsValid:t,filterIsTooStrict:t&&r.length<1,loading:c,compareItemsFn:h,displayEmptyGroups:d,error:e,renderItem:I(()=>Io({columns:o,collapsedColumns:i,miniColumns:a,onItemClick:b,onCheckboxChange:z,dataIsValid:t,groupOnColumn:x,onItemChange:F,rowPartFn:s}),[o,i,b,z,t,x,F,s]),renderGroup:I(()=>Fo({onCheckboxChange:z,dataIsValid:t,groupOnColumn:x}),[z,t,x])}},Do=(n,e)=>{if(n===e)return 0;if(n==null)return-1;if(e==null)return 1;const t=typeof n,r=typeof e;return t==="object"&&r==="object"?n.toString()<e.toString()?-1:1:t==="number"&&r==="number"?n-e:t==="string"&&r==="string"?n<e?-1:1:t==="boolean"&&r==="boolean"?n?-1:1:(console.warn("unsupported sort",t,n,r,e),0)},ke=(n,e)=>(t,r)=>Do(n(t),n(r))*(e?-1:1),Vo=n=>n.replace(/([a-z0-9])([A-Z])/gu,"$1-$2").toLowerCase(),pt=(n,e)=>{!n||!e||Object.entries(e).forEach(([t,r])=>{n[B].__ownChange=!0,n[B][t]=r,n[B].__ownChange=!1,n[B].dispatchEvent(new CustomEvent(`${Vo(t)}-changed`,{bubbles:!0,detail:{value:r}}))})},_e=(n,e)=>Object.assign(n,{[be]:e}),ce=Symbol("unparsed"),Ao=({data:n,columns:e,hashParam:t,sortAndGroupOptions:r,noLocalSort:o,noLocalFilter:i})=>{const{groupOnColumn:a,groupOnDescending:l,sortOnColumn:s,descending:u}=r,c=v(([f,y])=>{const $=e.find(({name:w})=>w===f);return $==null?[f,void 0]:[f,y.filter&&$.serializeFilter($,y.filter)]},[e]),d=v(([f,y])=>{const $=e.find(({name:S})=>S===f);if($==null)return[f,{[ce]:y}];const w={filter:$.deserializeFilter($,y)};return pt($,w),[f,w]},[e]),[h,p]=Q({},t,{multi:!0,suffix:"-filter--",write:c,read:d}),z=v((f,y)=>p($=>{const w=ye(y,$[f]);return pt(e.find(S=>S.name===f),w),{...$,[f]:{...$[f],...w}}}),[e,p]),b=I(()=>Object.values(h).map(f=>f.filter),[h]),x=I(()=>Object.fromEntries(e.map(f=>[f.name,!f.noLocalFilter&&f.getFilterFn(f,h[f.name]?.filter)]).filter(([,f])=>!!f)),[e,...b]),F=I(()=>!Array.isArray(n)||n.length===0?[]:Object.entries(x).length===0||i?n.slice():n.filter(f=>Object.values(x).every(y=>y(f))),[n,x,i]),g=I(()=>{if(!o&&!a&&s!=null&&s.sortOn!=null)return F.slice().sort(ke(f=>s.getComparableValue({...s,valuePath:s.sortOn},f),u));if(a!=null&&a.groupOn!=null){const f=F.reduce((y,$)=>{const w=a.getComparableValue({...a,valuePath:a.groupOn},$);if(w===void 0)return y;let S=y.find(R=>R.id===w);return S?(S.items.push($),y):(S={id:w,name:w,items:[$]},[...y,S])},[]);return f.sort(ke(y=>a.getComparableValue({...a,valuePath:a.groupOn},y.items[0]),l)),!s||o?f:f.filter(y=>Array.isArray(y.items)).map(y=>(y.items.sort(ke($=>s.getComparableValue({...s,valuePath:s.sortOn},$),u)),y))}return F},[F,a,l,s,u,o]),k=I(()=>{let f=0,y=0;const $=[];return g.forEach(w=>{if(Array.isArray(w.items)){_e(w,y++),w.items.forEach(S=>{_e(S,f++),$.push(S)});return}return _e(w,f++),$.push(w)},[]),$},[g]);return E(()=>{p(f=>Object.values(f).some($=>$[ce]!=null)?Object.fromEntries(Object.entries(f).map(([$,w])=>w[ce]==null?[$,w]:d([$,w[ce]]))):f)},[d]),{processedItems:g,visibleData:k,filters:h,filterFunctions:x,setFilterState:z}},Eo=n=>{const e=r=>{const o=n.data.indexOf(r);if(o<0)return null;const i=n.data.splice(o,1);if(n.data=n.data.slice(),Array.isArray(i)&&i.length>0)return i[0]},t=(r,o)=>{n.data.splice(r,1,o),n.data=n.data.slice()};return{removeItem:e,removeItems(r){const o=[];for(let i=r.length-1;i>=0;i-=1){const a=n.removeItem(r[i]);a!=null&&o.push(a)}return o},replaceItemAtIndex:t,replaceItem(r,o){const i=n.data.indexOf(r);if(i>-1)return t(i,o)},selectItem(r){n.shadowRoot.querySelector("#groupedList").select(r)},selectAll(){n.shadowRoot.querySelector("#groupedList").selectAll()},deselectAll(){n.shadowRoot.querySelector("#groupedList").deselectAll()},deselectItem(r){n.shadowRoot.querySelector("#groupedList").deselect(r)},isItemSelected(r){return n.shadowRoot.querySelector("#groupedList").isItemSelected(r)}}},To=({host:n,visibleData:e,filters:t,...r})=>{const{setFilterState:o}=r,i=I(()=>Eo(n),[]);Oe(r,Object.values(r)),Oe(i,Object.values(i)),E(()=>{const l=s=>o(s.detail.name,u=>({...u,...s.detail.state}));return n.addEventListener("legacy-filter-changed",l),()=>n.removeEventListener("legacy-filter-changed",l)},[]),P("visibleData",e),P("sortedFilteredGroupedItems",r.sortedFilteredGroupedItems),P("selectedItems",r.selectedItems),P("sortOn",r.sortOn),P("descending",r.descending),P("isMini",r.isMini);const a=I(()=>Object.fromEntries(Object.entries(t).filter(([,{filter:l}])=>l!==void 0).map(([l,{filter:s}])=>[l,s])),[t]);P("filters",a,Object.values(a))},Lo=n=>{const{hashParam:e,settingsId:t,data:r,resizeSpeedFactor:o,noLocal:i,noLocalSort:a=i,noLocalFilter:l=i,error:s,rowPartFn:u}=n,c=so({settingsId:t,host:n}),{settings:d,setSettings:h,columns:p,resetRef:z}=c,b=Dr(p,e,d,h,z),{processedItems:x,visibleData:F,filters:g,setFilterState:k,filterFunctions:f}=Ao({data:r,columns:p,hashParam:e,sortAndGroupOptions:b,noLocalSort:a,noLocalFilter:l}),{isMini:y,collapsedColumns:$,miniColumns:w}=zo({host:n,columns:p,settings:d,setSettings:h,resizeSpeedFactor:o,sortAndGroupOptions:b}),S=r&&Array.isArray(r)&&r.length>0,[R,H]=M([]);return To({host:n,visibleData:F,sortedFilteredGroupedItems:x,columns:p,filters:g,setFilterState:k,selectedItems:R,isMini:y,...b}),{header:So({host:n,selectedItems:R,sortAndGroupOptions:b,dataIsValid:S,data:r,columns:p,filters:g,collapsedColumns:$,settings:d,filterFunctions:f,settingS:c,setFilterState:k,hideSelectAll:n.hideSelectAll===!0}),list:Oo({host:n,error:s,dataIsValid:S,processedItems:x,setSelectedItems:H,columns:p,collapsedColumns:$,miniColumns:w,sortAndGroupOptions:b,rowPartFn:u}),footer:Co({host:n,selectedItems:R,columns:p})}};customElements.define("cosmoz-grouped-list-row",class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||Ie(this._renderFn(this._item,this._index),this)}});const Ro={group:Symbol("group")},we=(n,e)=>(e.has(n)||e.set(n,{}),e.get(n)),Mo=(n,e)=>!!we(n,e).expanded,No=(n,e)=>!!we(n,e).folded,De=n=>n?n.items instanceof Array:!1,jo=n=>{if(!Array.isArray(n)||n.length===0)return;const e=Array.isArray(n[0]?.items);if(!n.every(r=>Array.isArray(r.items)===e))throw new Error("Data must be homogeneous.")},Po=(n,e,t)=>Array.isArray(n)?(jo(n),n.reduce((o,i)=>{const a=i;return a.items?a.items.length?we(i,t).folded?o.concat(i):o.concat(i,a.items.map(l=>Object.assign(l,{[Ro.group]:i}))):e?o.concat(i):o:o.concat(i)},[])):void 0,Bo=(n,...e)=>typeof n=="function"?n(...e):n,Go=(n,e)=>n===e,Ho=()=>{const[n,e]=M(()=>[new WeakMap]);return{setItemState:v((r,o)=>e(([i])=>{const a=we(r,i);return Object.assign(a,Bo(o,a)),[i]}),[]),state:n[0],signal:n}},Wo=()=>{const{setItemState:n,state:e,signal:t}=Ho(),r=v((i,a)=>{De(i)&&n(i,l=>({folded:a!==void 0?a:!l.folded}))},[]),o=v((i,a)=>{De(i)||n(i,l=>({expanded:a!==void 0?!a:!l.expanded}))},[]);return{state:e,signal:t,toggleFold:r,toggleCollapse:o}},qo=({initial:n,compareItemsFn:e,data:t,flatData:r})=>{const[o,i]=M(n),[a,l]=M(),s=v(g=>o.includes(g),[o]),u=v(g=>g?.items?.every(s),[s]),c=v(g=>s(g)||u(g),[s,u]),d=v(g=>{const k=g.items??[g];i(f=>[...f,...k.filter(y=>!f.includes(y))]),l(g)},[]),h=v(g=>{const k=g.items??[g];i(f=>f.filter(y=>!k.includes(y))),l(g)},[]),p=v(g=>{i(g.items?.slice()||[g]),l(g)},[]),z=v(()=>{i(t.flatMap(g=>g.items||g)),l(void 0)},[t]),b=v(()=>{i([]),l(void 0)},[]),x=v((g,k=!c(g))=>k?d(g):h(g),[c]),F=v((g,k)=>{const f=a?r.findIndex(w=>e(w,a)):-1;if(f<0)return x(g,k);const[y,$]=[f,r.indexOf(g)].sort((w,S)=>w-S);r.slice(y,$+1).forEach((w,S,R)=>{S>0&&S<R.length-1&&De(w)||x(w,k)}),l(g)},[r,e,x]);return E(()=>i(g=>g.length>0?r.filter(k=>g.find(f=>e(k,f))):g),[r]),{selectedItems:o,isItemSelected:s,isGroupSelected:u,isSelected:c,select:d,deselect:h,selectOnly:p,selectAll:z,deselectAll:b,toggleSelect:x,toggleSelectTo:F}},Xo={host:{position:"relative",display:"flex",flexDirection:"column"}},Uo=n=>{const{data:e,renderItem:t,renderGroup:r,displayEmptyGroups:o,compareItemsFn:i=Go}=n,{toggleFold:a,toggleCollapse:l,state:s,signal:u}=Wo(),c=I(()=>Po(e,o,s),[e,o,u]),{selectedItems:d,isItemSelected:h,isGroupSelected:p,isSelected:z,select:b,deselect:x,selectOnly:F,selectAll:g,deselectAll:k,toggleSelect:f,toggleSelectTo:y}=qo({initial:[],compareItemsFn:i,data:e,flatData:c}),$=v((S,R)=>Array.isArray(S.items)?r(S,R,{selected:p(S,d),folded:No(S,s),toggleSelect:H=>f(S,typeof H=="boolean"?H:void 0),toggleFold:()=>a(S)}):t(S,R,{selected:d.includes(S),expanded:Mo(S,s),toggleSelect:H=>f(S,typeof H=="boolean"?H:void 0),toggleCollapse:()=>l(S)}),[t,r,d,f,u]);ft(()=>Object.assign(n.style,Xo.host),[]),P("selectedItems",d);const w={toggleFold:a,toggleCollapse:l,isItemSelected:h,isGroupSelected:p,isSelected:z,select:b,deselect:x,selectOnly:F,selectAll:g,deselectAll:k,toggleSelect:f,toggleSelectTo:y};return Oe(w,Object.values(w)),{renderRow:$,flatData:c}},Ko=({renderRow:n,flatData:e})=>ln({items:e,renderItem:(t,r)=>m`<cosmoz-grouped-list-row
				.item=${t}
				.index=${r}
				.renderFn=${n}
			></cosmoz-grouped-list-row>`}),Jo=n=>Ko(Uo(n));customElements.define("cosmoz-grouped-list",T(Jo,{useShadowDOM:!1}));const Qo=n=>window.ShadyCSS?.ApplyShim?.transformCssText?.(n)||n,Yo=n=>{const{header:e,list:t,footer:r}=Lo(n);return m`
		<style>
			${sn([],()=>Qo(Nr))}
		</style>
...
`;m(Object.assign([xe],{raw:[xe]}));Ve(Object.assign([xe],{raw:[xe]}));const Zo=()=>m`<style>
	@keyframes rotating {
		100% {
...
}`,...pe.parameters?.docs?.source}}};const li=["TableWithLargeData","TableWithSmallData","TableWithNoData"];export{de as TableWithLargeData,pe as TableWithNoData,me as TableWithSmallData,li as __namedExportsOrder,ai as default};
