import{n as e}from"./chunk-BneVvdWh.js";import{$ as t,X as n,Z as r,et as i,n as a,t as o}from"./iframe-Bk4DRnPv.js";import{$ as s,A as c,At as l,B as u,C as d,Ct as f,D as p,Dt as m,E as h,Et as g,F as _,Ft as v,G as y,H as b,I as x,It as ee,J as te,K as ne,L as re,Lt as ie,M as ae,N as oe,Nt as se,O as ce,Ot as S,P as le,Pt as C,Q as ue,R as de,S as fe,St as w,T as pe,Tt as T,U as me,V as he,W as ge,X as E,Y as _e,Z as D,_ as O,_t as k,a as ve,at as ye,b as A,bt as be,c as xe,ct as Se,d as Ce,dt as we,et as Te,f as Ee,ft as De,g as Oe,gt as ke,h as Ae,ht as je,i as Me,it as Ne,j as Pe,jt as Fe,k as Ie,kt as Le,l as Re,lt as ze,m as Be,mt as Ve,n as He,nt as j,o as Ue,ot as We,p as Ge,pt as Ke,q as qe,r as Je,rt as M,s as Ye,st as Xe,t as Ze,tt as Qe,u as $e,ut as et,v as tt,vt as N,w as nt,wt as rt,x as it,xt as at,y as ot,yt as st,z as ct}from"./dist-DuWaCab5.js";var lt,ut,dt=e((()=>{u(),k(),lt=b`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`}));function di(e,t,{suffix:n=``,read:r,write:i,ready:a=!0,multi:o}={}){let s=we({param:t,suffix:n,link:o?hi:mi,write:i??ye}),c=g(()=>{if(t==null)return!1;if(o){let e=$e(t+n);return Object.keys(e).length>0}return Ce(t+n)!==void 0},[]),[l,u]=f(()=>{if(t==null)return e;if(o){let i=$e(t+n,r);return Object.keys(i).length>0?i:e}return Ce(t+n,r)??e}),d=T(e=>u(t=>{let n=Xe(e,t);return s.param!=null&&Ge(s.link(s.param+s.suffix,n,s.write),null,{notify:!1}),n}),[]);return S(()=>{s.param==null||!a||c||e!=null&&d(e)},[a]),[l,d]}var fi,pi,mi,hi,gi=e((()=>{Ee(),We(),et(),Re(),k(),fi=e=>(t,n,r=ye)=>{let i=xe(),a=new URLSearchParams(i.hash.replace(`#`,``));return e(t,n,r,a),`#!`+Object.assign(i,{hash:a}).href.replace(location.origin,``)},pi=e=>e==null||e===``,mi=fi((e,t,n,r)=>pi(n(t))?r.delete(e):r.set(e,n(t))),hi=fi((e,t,n,r)=>{let i=Object.entries(t),a=i.map(n).filter(([,e])=>e!==void 0);if(a.length===0&&i.length>0)return;let o=e;Array.from(r.keys()).filter(e=>e.startsWith(o)).forEach(e=>r.delete(e)),a.forEach(([t,n])=>pi(n)?r.delete(e+t):r.set(e+t,n))})})),_i,vi,yi,bi,xi,Si=e((()=>{k(),gi(),_i=e=>[!0,`true`,1,`yes`,`on`].includes(e),vi=e=>e===``||(e==null?void 0:_i(e)),yi=(e,t,n)=>T(r=>{e(r),n(e=>({...e,[t]:r}))},[e,t,n]),bi=(e,t,{settings:n,setSettings:r,resetRef:i,ready:a=!0})=>{let[o,s]=di(n.sortOn,t,{suffix:`-sortOn`,ready:a}),[c,l]=di(vi(n.descending),t,{suffix:`-descending`,read:vi,ready:a}),[u,d]=di(n.groupOn,t,{suffix:`-groupOn`,ready:a}),[f,p]=di(vi(n.groupOnDescending),t,{suffix:`-groupOnDescending`,read:vi,ready:a}),m=g(()=>e.find(e=>e.name===o),[e,o]),h=g(()=>e.find(e=>e.name===u),[e,u]),_={groupOn:u,setGroupOn:yi(d,`groupOn`,r),groupOnDescending:f,setGroupOnDescending:yi(p,`groupOnDescending`,r),sortOn:o,setSortOn:yi(s,`sortOn`,r),descending:c,setDescending:yi(l,`descending`,r),columns:e},v=g(()=>_,Object.values(_)),y=T(e=>{s(e.sortOn),d(e.groupOn),l(e.descending),p(e.groupOnDescending)},[]);return S(()=>void(i.current=y),[]),{...v,sortAndGroup:v,groupOnColumn:h,sortOnColumn:m}},xi=st(),customElements.define(`sort-and-group-provider`,xi.Provider),customElements.define(`sort-and-group-consumer`,N(({render:e})=>e(m(xi)),{useShadowDOM:!1}))})),Ci,wi,Ti=e((()=>{k(),h(),ei(),ui(),C(),Si(),Ci=({data:e,columns:n,groupOnColumn:r,filters:i,setFilterState:a,sortAndGroup:{sortOn:o,setSortOn:s,descending:c,setDescending:l}={}})=>pe(n,e=>e.name,n=>[t`<div
	...
	`},customElements.define(`cosmoz-omnitable-header-row`,N(wi,{useShadowDOM:!1}))})),Ei,Di,Oi=e((()=>{k(),u(),Ei=b`
	:host {
		display: flex;
		align-items: center;
		flex-wrap: wrap;
...
`,Ji=({settingsConfig:e})=>{let{columns:n,collapsed:r}=e,i=n.filter(e=>!r.some(t=>t.name===e.name));return t`<div class="skeleton">
	...
	</div>`},customElements.define(`cosmoz-omnitable-skeleton`,N(Ji,{styleSheets:[qi]}))})),Xi,Zi=e((()=>{Yi(),l(),o(),i(),C(),Xi=(e,n)=>{let{settingsConfig:r}=e,{processedItems:i,dataIsValid:o,filterIsTooStrict:s,loading:c,displayEmptyGroups:l,compareItemsFn:u,selectedItems:d,setSelectedItems:f,renderItem:p,renderGroup:m,error:h}=n;return t`${v(!c&&!o&&!h,()=>t`<div class="tableContent-empty">
		...
		<div class="tableContent-scroller" id="scroller" part="scroller">
			<cosmoz-grouped-list
				...
				.data=${i}
				.selectedItems=${d}
				@selected-items-changed=${e=>f(e.detail.value)}
...
`)},Na=(e,t,n)=>{let r=e.filter(e=>!e.hidden),i=r.reduce((e,{width:t})=>e+t,0);if(r.length>1&&i>t)return Na(r.slice(1),t,n);let a=r.reduce(([e,t],n,r)=>[Math.max(e,n.index),n.index>e?r:t],[-1,-1])[1];return a!==-1&&(r[a].flex=1),Da(r,t).reduce((e,t,n)=>(e[r[n].index]=t,e),Array(n).fill(void 0))},Pa=(e,t)=>e.length===0?`.cell {display: none;}`:Ma(e,t)})),Ia,La=e((()=>{k(),Ia=({host:e,canvasWidth:t,layout:n,setSettings:r})=>{let i=be();i.current=e=>r(r=>{let i=r.columns,{detail:{newWidth:a,column:o}}=e,s=i.findIndex(e=>e.name===o.name),c=[],l=i.reduce((e,t)=>Math.max(e,t.priority),-1/0);for(let e=0;e<n.length;e++)if(c[e]={...i[e]},e<s&&n[e]&&(c[e].width=n[e],c[e].flex=0,c[e].priority=l),e===s){let r=n.reduce((e,t,n)=>n<s&&t?e-t:e,t);c[e].width=Math.min(r,Math.max(a,i[e].minWidth)),c[e].flex=0,c[e].priority=l}return{...r,columns:c}}),S(()=>{let t=e=>i.current?.(e);return e.addEventListener(`column-resize`,t),()=>e.removeEventListener(`column-resize`,t)},[])}})),Ra,za,Ba=e((()=>{k(),Ra=88,za=(e,t)=>S(()=>{let n=new ResizeObserver(([e])=>{e.contentRect?.width!==0&&requestAnimationFrame(()=>t(e.contentRect?.width-Ra))});return n.observe(e),()=>n.unobserve(e)},[])})),Va,Ha=e((()=>{k(),Ba(),Va=e=>{let[t,n]=f(()=>e.getBoundingClientRect().width-Ra);return za(e,n),t}})),Ua,Wa,Ga,Ka=e((()=>{k(),et(),We(),Ua=(e,t)=>{let n=g(()=>{let t=!1,n,r=()=>{t&&(n=requestAnimationFrame(r),e()&&(t=!1))};return{start:()=>{t=!0,cancelAnimationFrame(n),n=requestAnimationFrame(r)},stop:()=>{t=!1,cancelAnimationFrame(n)}}},[]);S(()=>{n.start()},t),S(()=>()=>n.stop(),[])},Wa=(e=0,t=0)=>Math.abs(e-t)<.1,Ga=(e,t=1.9,n=Se)=>{let r=we({target:e});Ua(T(()=>{if(!r.tween)return r.tween=r.target,n(r.tween),!0;if(r.target.every((e,t)=>r.tween[t]===e))return n(r.tween),!0;r.tween=r.target.map((e,n)=>Wa(r.tween[n],e)?e:(r.tween[n]??0)+((e??0)-(r.tween[n]??0))/t||0),n(r.tween)},[]),[e])}})),qa,Ja=e((()=>{k(),Fa(),qa=({canvasWidth:e,groupOnColumn:t,config:n,miniColumn:r})=>g(()=>{if(!Array.isArray(n)||e==null||e===0)return[];let i=n.map((e,n)=>({minWidth:e.minWidth,width:e.width,flex:e.flex,priority:e.priority,name:e.name,index:n,hidden:e.name===t?.name||e.disabled})).map(e=>r?{...e,hidden:r.name!==e.name}:e).sort(({index:e,priority:t},{index:n,priority:r})=>t===r?n-e:t-r);return Na(i,e,i.length)},[e,t,n])})),Ya,Xa=e((()=>{k(),Ya=({host:e,canvasWidth:t,columns:n})=>{let r=e.miniBreakpoint??480,i=g(()=>t<=r,[t,r]),[a,...o]=g(()=>i?n?.filter(e=>e.mini!=null).sort((e,t)=>(e.mini??0)-(t.mini??0)):[],[n,i])??[],s=!!a;return S(()=>{e.toggleAttribute(`mini`,s)},[s]),{isMini:s&&i,miniColumn:a,miniColumns:o}}})),Za,Qa,$a=e((()=>{k(),Fa(),La(),Ha(),Ka(),Ja(),Xa(),et(),Za=e=>{let t=g(()=>new CSSStyleSheet,[]);return S(()=>{e.shadowRoot.adoptedStyleSheets=[...e.shadowRoot.adoptedStyleSheets,t]},[]),t},Qa=({host:e,columns:t,settings:n,setSettings:r,resizeSpeedFactor:i,sortAndGroupOptions:a})=>{let o=Va(e),{isMini:s,miniColumn:c,miniColumns:l}=Ya({host:e,canvasWidth:o,columns:t}),{groupOnColumn:u}=a,d=qa({canvasWidth:o,groupOnColumn:u,miniColumn:c,config:n.columns}),f=Za(e),p=g(()=>n.columns.reduce((e,n,r)=>d[r]!=null||n.name===u?.name||n.disabled?e:[...e,t.find(e=>e.name===n.name)],[]),[t,n,d]),m=we({columns:n.columns});return Ga(d,i,e=>{let t=Pa(e,m.columns);f.replace(t)}),Ia({host:e,canvasWidth:o,layout:d,setSettings:e=>r(e(n))}),{isMini:s,collapsedColumns:p,miniColumns:l}}})),eo,to=e((()=>{eo=({host:e,...t})=>{let{csvFilename:n=`omnitable.csv`,xlsxFilename:r=`omnitable.xlsx`,xlsxSheetname:i=`Omnitable`,topPlacement:a=`top-end`}=e;return{csvFilename:n,xlsxFilename:r,xlsxSheetname:i,topPlacement:a,...t}}})),no,ro=e((()=>{k(),no=({host:e,selectedItems:t,data:n,sortAndGroupOptions:r,collapsedColumns:i,settings:a,filterFunctions:o,settingS:s,filters:c,...l})=>{let u=n&&n.length>0&&t.length===n.length,d=t=>{t.target.checked?e.shadowRoot.querySelector(`#groupedList`).selectAll():e.shadowRoot.querySelector(`#groupedList`).deselectAll()},{groupOnColumn:f}=r,p=g(()=>[f,...i,...a.columns.filter(e=>e.disabled)].some(e=>e&&Object.keys(o).includes(e.name)),[o,a,i]),m=g(()=>({...s,collapsed:i,badge:p,filters:c}),[s,i,p,c]);return S(()=>{let t=e.shadowRoot.querySelector(`#tableContent`),n=new ResizeObserver(t=>requestAnimationFrame(()=>{e.style.setProperty(`--ot-height`,t[0]?.contentRect.height+`px`)}));return n.observe(t),()=>n.unobserve(t)},[]),{allSelected:u,onAllCheckboxChange:d,data:n,settingsConfig:m,filters:c,groupOnColumn:f,sortAndGroup:r.sortAndGroup,...l}}})),io,ao,oo,so,co,lo,uo=e((()=>{k(),C(),ne(),ja(),H(),io=t`
	<svg
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
