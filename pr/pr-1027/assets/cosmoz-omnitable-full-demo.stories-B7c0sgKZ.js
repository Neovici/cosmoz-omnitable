import{n as e}from"./chunk-BneVvdWh.js";import{$ as t,X as n,Z as r,et as i,n as a,t as o}from"./iframe-CHTUmAZq.js";import{$ as s,A as c,At as l,B as u,C as d,Ct as f,D as p,Dt as m,E as h,Et as g,F as _,Ft as v,G as y,H as b,I as x,It as ee,J as te,K as ne,L as re,Lt as ie,M as ae,Mt as oe,N as se,Nt as ce,O as le,Ot as S,P as ue,Pt as C,Q as de,R as fe,S as pe,St as w,T as me,Tt as T,U as he,V as ge,W as _e,X as E,Y as ve,Z as D,_ as O,_t as k,a as ye,at as be,b as A,bt as xe,c as Se,ct as Ce,d as we,dt as Te,et as Ee,f as De,ft as Oe,g as ke,gt as Ae,h as je,ht as Me,i as Ne,it as Pe,j as Fe,jt as Ie,k as Le,kt as Re,l as ze,lt as Be,m as Ve,mt as He,n as Ue,nt as j,o as We,ot as Ge,p as Ke,pt as qe,q as Je,r as Ye,rt as M,s as Xe,st as Ze,t as Qe,tt as $e,u as et,ut as tt,v as nt,vt as N,w as rt,wt as it,x as at,xt as ot,y as st,yt as ct,z as lt}from"./dist-De8sNikL.js";var ut,dt=e((()=>{k(),ut=()=>t`<style>
	@keyframes rotating {
		100% {
...
</style>`,customElements.define(`cz-spinner`,N(ut))})),ft,pt,P=e((()=>{u(),k(),ft=b`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,customElements.define(`cosmoz-clear-button`,N(pt))})),F,mt,ht,gt,_t,I,L=e((()=>{M(),F=({valuePath:e},t)=>j(t,e),mt=F,ht=F,gt=({valuePath:e},t)=>n=>{let r=j(n,e);return r==null?!1:r.toString().toLowerCase().trim().includes(t.toLowerCase().trim())},_t=(e,t)=>t===``||t==null?null:t,I=e=>class extends e{static get properties(){return{isOmnitableColumn:{type:Boolean,value:!0},title:{type:String},valuePath:{type:String,notify:!0},values:{type:Array,notify:!0},filter:{type:Object},noLocalFilter:{type:Boolean},disabled:{type:Boolean,value:!1,notify:!0},editable:{type:Boolean,notify:!0},loading:{type:Boolean,value:!1,notify:!0},externalValues:{type:Boolean,value:!1,notify:!0},name:{type:String},sortOn:{type:String},groupOn:{type:String},noSort:{type:Boolean,value:!1},disabledFiltering:{type:Boolean,value:!1},width:{type:String,value:`75px`},minWidth:{type:String,value:`40px`},flex:{type:String,value:`1`},cellClass:{type:String,value:`default-cell`},headerCellClass:{type:String,value:`default-header-cell`},priority:{type:Number,value:0},hidden:{type:Boolean,notify:!0},preferredDropdownHorizontalAlign:{type:String,value:`right`},renderHeader:{type:Function},renderCell:{type:Function},renderEditCell:{type:Function},renderGroup:{type:Function},mini:{type:Number,value:null},renderMini:{type:Function}}}static get observers(){return[`notifyFilterChange(filter)`]}notifyFilterChange(e){this.__ownChange||this.dispatchEvent(new CustomEvent(`legacy-filter-changed`,{detail:{name:this.name,state:this.legacyFilterToState(e)},bubbles:!0}))}legacyFilterToState(e){return{filter:e}}getFilterFn(){}getString(e,t){return F(e,t)}toXlsxValue(e,t){return mt(e,t)}cellTitleFn(e,t){return this.getString(e,t)}headerTitleFn(e){return e.title}serializeFilter(e,t){return _t(e,t)}deserializeFilter(e,t){return t==null?null:typeof t==`string`?window.decodeURIComponent(t):t}getComparableValue(e,t){return ht(e,t)}computeSource(e,t){return t}_propertiesChanged(e,t,n){super._propertiesChanged(e,t,n),this.dispatchEvent(new CustomEvent(`cosmoz-column-prop-changed`,{bubbles:!0}))}}})),vt,yt,bt,xt,St,Ct,wt,Tt=e((()=>{x(),P(),D(),i(),C(),L(),vt=e=>t=>e(n=>{if(n.inputValue===void 0&&t.target.value===``)return n;clearTimeout(n.t);let r=setTimeout(()=>e(e=>({...e,filter:e.inputValue})),1e3);return{...n,inputValue:t.target.value,t:r}}),yt=e=>()=>e(e=>({...e,filter:e.inputValue})),bt=e=>t=>{t.keyCode===13&&(t.preventDefault(),e(e=>({...e,filter:e.inputValue})))},xt=e=>t=>e(e=>({...e,headerFocused:t.detail.value})),St=e=>()=>e(e=>({...e,filter:null,inputValue:null})),Ct=e=>e!=null&&e!==``,wt=class extends I(E){static get properties(){return{minWidth:{type:String,value:`55px`},editMinWidth:{type:String,value:`55px`},inputValue:{type:Object,notify:!0}}}getFilterFn(e,t){if(!(t==null||t===``))return gt(e,t)}renderCell(e,{item:n}){return t`<span class="default-column">${F(e,n)}</span>`}renderEditCell(e,{item:n},r){return t`<cosmoz-input
		...
		>
			${v(!e.disabledFiltering,()=>t`<cosmoz-clear-button
						...
						@click=${St(a)}
					></cosmoz-clear-button>`)}
		</cosmoz-input>`}legacyFilterToState(e){return{filter:e,inputValue:e}}},customElements.define(`cosmoz-omnitable-column`,wt)})),Et,Dt,Ot,R=e((()=>{x(),k(),i(),Et=[`label`,`value`,`slot`,`always-float-label`,`disabled`],Dt=Re`
	${lt}
...
`,Ot=e=>{let{label:n,value:r,slot:i}=e;return te(t`<div
	...
	>
		${r||``}
	</div>`,{label:n})},customElements.define(`cosmoz-omnitable-dropdown-input`,N(Ot,{observedAttributes:Et,styleSheets:[Dt]}))})),z,kt=e((()=>{Be(),i(),_(),R(),z=({title:e,tooltip:n=``,filterText:r=``,onOpenedChanged:i,content:a,horizontalAlign:o=`left`,externalValues:s=null})=>t`
		<style>
			.dropdown {
				outline: none;
			}
		...
		<cosmoz-dropdown
			@focus=${i}
			class=${ue({filtered:!!r,...s!=null&&{[`external-values-${s}`]:!0},dropdown:!0})}
			title=${n||``}
		>
	...
	`})),At,jt,Mt=e((()=>{Ge(),Ee(),se(),c(),At=e=>e?typeof e.close==`function`?e:At(e.parentElement):null,jt=e=>class extends e{static get properties(){return{disabled:{type:Boolean,value:!1},filter:{type:Object,notify:!0},values:{type:Array,value(){return[]}},headerFocused:{type:Boolean,notify:!0},min:{type:Number,value:null},max:{type:Number,value:null},limits:{type:Function},autoupdate:{type:String,value:!0},locale:{type:String,value:null},_filterInput:{type:Object,value(){return{min:null,max:null}}},_range:{type:Object,computed:`_computeRange(values.*)`},_limit:{type:Object,computed:`_computeLimit(_range, _filterInput.*, min, max)`,value(){return{}}},_tooltip:{type:String,computed:`_computeTooltip(title, _filterText)`},_fromClasses:{type:String,computed:`_computeInputClasses(_filterInput.min)`},_toClasses:{type:String,computed:`_computeInputClasses(_filterInput.max)`}}}static get observers(){return[`_filterInputChanged(_filterInput.*, autoupdate)`,`_filterChanged(filter.*)`,`_updateLimits(limits, headerFocused)`]}disconnectedCallback(){this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),super.disconnectedCallback()}_computeInputClasses(e){return e!=null&&e!==``?`has-value`:``}toNumber(e,t,n){if(e==null||e===``)return;let r=typeof e==`number`?e:Number(e);if(Number.isNaN(r))return;if(n==null||t==null)return r;let i=this.toNumber(t);return i==null?r:n(r,i)}toValue(){return this.toNumber.apply(this,arguments)}getComparableValue(e,t){if(e==null)return;let n=e;return t!=null&&(n=this.get(t,e)),this.toValue(n)}renderValue(){}getInputString(e,t=this.valuePath){let n=this.toValue(this.get(t,e));return this._toInputString(n)}_computeRange(e){let t=e.base,n=Array.isArray(t)&&t.length&&t.map(e=>this.toValue(e)).filter(e=>e!=null);return!n||n.length<1?{min:null,max:null}:n.reduce((e,t)=>({min:this.toValue(t,e.min,Math.min),max:this.toValue(t,e.max,Math.max)}),{})}_computeLimit(e,t,n,r){if(!e)return;let i=t.base,a=this.toValue(n),o=this.toValue(r),s=a??this.toValue(e.min),c=o??this.toValue(e.max);return{fromMin:s,fromMax:this.toValue(c,this._fromInputString(i.max,`max`),Math.min),toMin:this.toValue(s,this._fromInputString(i.min,`min`),Math.max),toMax:c}}_computeFilterText(e){if(e.base==null)return;let t=e.base,n=this.toValue(t.min),r=this.toValue(t.max),i=[];return n!=null&&i.push(this.renderValue(n)),i.push(` - `),r!=null&&i.push(this.renderValue(r)),i.length>1?i.join(``):void 0}_computeTooltip(e,t){return t==null?e:`${e}: ${t}`}_fromInputString(e){return this.toValue(e)}_toInputString(e){return this.toValue(e)??null}_getDefaultFilter(){return{min:null,max:null}}_filterInputChanged(e,t){this.__inputChangePath=e.path.split(`.`)[1]||null,t&&(this._limitInputDebouncer=Fe.debounce(this._limitInputDebouncer,$e.after(600),()=>{this._limitInput(),this._updateFilter()}),ae(this._limitInputDebouncer))}_clearFrom(){this.set(`_filterInput.min`,null),this._updateFilter()}_clearTo(){this.set(`_filterInput.max`,null),this._updateFilter()}_onBlur(){this._limitInput(),this._updateFilter()}_onKeyDown(e){let t=e.currentTarget,n=Array.from(t.parentElement.querySelectorAll(`cosmoz-input`)),r=n[n.findIndex(e=>e===t)+1],i=!r,a=n[0]===t;switch(e.keyCode){case 13:if(e.preventDefault(),!i)r.focus();else{let e=this._limitInput();this._updateFilter(),e||this._closeParent(t)}break;case 9:(i&&!e.shiftKey||a&&e.shiftKey)&&this._closeParent(t)}}_closeParent(e){let t=At(e);t&&t.close()}_onDropdownOpenedChanged({currentTarget:e,type:t,detail:n}){(t===`focus`||n?.value===!0)&&setTimeout(()=>{e.querySelector(`cosmoz-input:focus`)||e.querySelector(`cosmoz-input`)?.focus()},100)}_limitInput(){let e=this._filterInput,t=this.__inputChangePath,n=t?this._fromInputString(this.get(t,e),t):null;if(this.__inputChangePath=null,n==null)return!1;let r=this._limit,i=t===`min`?`from`:`to`,a=this.get(i+`Min`,r),o=this.get(i+`Max`,r),s=this.toValue(n,a,Math.max),c=this.toValue(s,o,Math.min);return this.getComparableValue(n)===this.getComparableValue(c)?!1:(this.set([`_filterInput`,t],this._toInputString(c,t)),this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),!0)}_updateFilter(){let e=this._filterInput,t=this.filter,n=this._fromInputString(e.min,`min`),r=this._fromInputString(e.max,`max`);this.getComparableValue(n)===this.getComparableValue(t,`min`)&&this.getComparableValue(r)===this.getComparableValue(t,`max`)||this.set(`filter`,{min:n,max:r})}_filterChanged(e){if(this._filterInput==null)return;let t=this._filterInput,n=e.base,r=this._fromInputString(t.min,`min`),i=this._fromInputString(t.max,`max`);this.getComparableValue(r)===this.getComparableValue(n,`min`)&&this.getComparableValue(i)===this.getComparableValue(n,`max`)||(this.set(`_filterInput`,{min:this._toInputString(n.min),max:this._toInputString(n.max)}),this._limitInputDebouncer&&this._limitInputDebouncer.cancel())}hasFilter(){let e=this.filter;return e==null?!1:this.toValue(e.min)!=null||this.toValue(e.max)!=null}resetFilter(){this.filter=this._getDefaultFilter()}_updateLimits(e,t){e&&Promise.resolve(Ze(e,{active:t})).then(e=>{let{min:t,max:n}=e??{};Object.assign(this,{...t==null?{}:{min:t},...n==null?{}:{max:n}})})}}})),B,Nt=e((()=>{D(),i(),B=e=>class extends e{static get template(){return de`<div id="output" style="position:relative;"></div>`}connectedCallback(){super.connectedCallback();let e=this;r(e.render(),e.$.output)}_propertiesChanged(e,t,n){super._propertiesChanged(e,t,n);let i=this;requestAnimationFrame(()=>r(i.render(),i.$.output))}}})),Pt,Ft=e((()=>{x(),D(),o(),i(),C(),kt(),R(),Mt(),Nt(),Pt=class extends jt(B(E)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:`_computeFilterText(filter.*, _formatters)`},headerFocused:{type:Boolean,value:!1}}}static get observers(){return[`_valuesChanged(autodetect, currency, values)`]}render(){let e=e=>{this.headerFocused=e.type===`focus`,this._onDropdownOpenedChanged(e)};return t`
		...
		></cosmoz-omnitable-amount-range-input>`}computeSource(e,t){return q(e,t)}},customElements.define(`cosmoz-omnitable-column-amount`,cn)})),un,dn,fn,pn,mn,hn,gn,_n,vn,yn,bn,xn,Sn=e((()=>{nt(),Ge(),st(),M(),J(),un=(e,t)=>{if(!Array.isArray(e))return;let n=[];return e.reduce((e,t)=>Array.isArray(t)?(t.forEach(t=>{e.push(t)}),e):(e.push(t),e),[]).filter((e,r,i)=>{if(i.indexOf(e)!==r)return!1;if(t){let r=j(e,t);if(n.indexOf(r)!==-1)return!1;n.push(r)}return!0})},dn=(e,t,n)=>{if(e==null)return[];if(Array.isArray(e)){let r=un(e,t);if(!r?.length)return r;let i=n??`label`,a=e=>String(typeof e==`object`&&e?j(e,i)??``:e??``);return r.sort((e,t)=>a(e).localeCompare(a(t)))}if(typeof e==`object`){let r=t??`id`,i=n??`label`;return Object.entries(e).map(([e,t])=>({[r]:e,[i]:t})).sort((e,t)=>String(e[i]??``).localeCompare(String(t[i]??``)))}return[]},fn=(e,t,n)=>O(t&&j(e,t)).map(A(n)),pn=({valuePath:e,textProperty:t},n)=>fn(n,e,t).filter(e=>e!=null).join(`, `),mn=pn,hn=({valueProperty:e,valuePath:t,emptyValue:n,emptyProperty:r},i)=>a=>{let o=A(e),s=O(j(a,t));return i.some(t=>s.length===0&&A(r||e)(t)===n||s.some(e=>o(e)===o(t)))},gn=e=>t=>e(e=>({...e,filter:t})),_n=e=>t=>e(e=>({...e,headerFocused:t})),vn=e=>t=>e(e=>({...e,query:t})),yn=({emptyValue:e,emptyLabel:t,emptyProperty:n,textProperty:r,valueProperty:i},a)=>{let o=dn(a,i,r);return!t||e===void 0||!r||!(n||i)||!o?o:[{[r]:t,[n||i]:e},...o]},bn=(e,t)=>yn(e,on(t,e.valuePath)),xn=e=>class extends e{static get properties(){return{textProperty:{type:String},valueProperty:{type:String},emptyLabel:{type:String},emptyValue:{type:Object},emptyProperty:{type:String}}}getConfig(e){return{emptyProperty:e.emptyProperty}}getString(e,t){return pn(e,t)}toXlsxValue(e,t){return mn(e,t)}getComparableValue({valuePath:e,valueProperty:t},n){let r=j(n,e);return t==null?r:O(r).map(A(t)).sort().join(` `)}getFilterFn(e,t){if(!(!t||!Array.isArray(t)||t.length===0))return hn(e,t)}serializeFilter(e,t){return t.length===0?null:JSON.stringify(t)}deserializeFilter(e,t){return JSON.parse(decodeURIComponent(t))}computeSource(e,t){return e.externalValues||typeof e.values==`function`?async(...t)=>yn(e,await Promise.resolve(Ze(e.values,...t))):bn(e,t)}}})),Cn,wn,Tn,En=e((()=>{ke(),je(),D(),i(),C(),nt(),st(),Sn(),L(),k(),M(),K(),Cn=({valuePath:e,textProperty:t,valueProperty:n},r)=>{let i=t?pe(t):A(n),a=O(e&&j(r,e)).map(i);return a.length>1?a.filter(Boolean).join(`,`):a[0]},wn=({valueProperty:e,valuePath:t,emptyValue:n,emptyProperty:r},i)=>{let a=A(e),o=A(r||e),s=new Set(i.filter(e=>e.excluded).map(e=>a(e.item))),c=new Set(i.filter(e=>!e.excluded).map(e=>a(e.item))),l=i.some(e=>e.excluded&&o(e.item)===n),u=i.some(e=>!e.excluded&&o(e.item)===n);return e=>{let n=O(j(e,t)).map(a);return n.length===0?!l&&(u||c.size===0):!n.some(e=>s.has(e))&&(c.size===0||n.some(e=>c.has(e)))}},Tn=class extends xn(I(E)){static get properties(){return{headerCellClass:{type:String,value:`autocomplete-header-cell`},minWidth:{type:String,value:`55px`},editMinWidth:{type:String,value:`55px`},keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},showSingle:{type:Boolean},preserveOrder:{type:Boolean},limit:{type:Number},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,showSingle:e.showSingle,preserveOrder:e.preserveOrder,limit:e.limit,textual:e.textual}}renderCell(e,{item:n}){return t`<span class="default-column"
		...
		></cosmoz-input>`}renderHeader(e,{filter:n,query:r},i,a){return t`<cosmoz-autocomplete-excluding
			...
			@value-changed=${ot(gn(i))}
			@text-changed=${ot(vn(i))}
			>${v(e.loading,()=>t`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-excluding
		>`}getComparableValue(e,t){return Cn(e,t)}getFilterFn(e,t){if(!(!t||!Array.isArray(t)||t.length===0))return wn(e,t)}},customElements.define(`cosmoz-omnitable-column-autocomplete-excluding`,Tn)})),Dn,On,kn=e((()=>{ke(),je(),D(),i(),C(),nt(),st(),Sn(),L(),M(),K(),Dn=({valuePath:e,textProperty:t,valueProperty:n},r)=>{let i=t?pe(t):A(n),a=O(e&&j(r,e)).map(i);return a.length>1?a.filter(Boolean).join(`,`):a[0]},On=class extends xn(I(E)){static get properties(){return{headerCellClass:{type:String,value:`autocomplete-header-cell`},minWidth:{type:String,value:`55px`},editMinWidth:{type:String,value:`55px`},keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},showSingle:{type:Boolean},preserveOrder:{type:Boolean},limit:{type:Number},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,showSingle:e.showSingle,preserveOrder:e.preserveOrder,limit:e.limit,textual:e.textual}}renderCell(e,{item:n}){return t`<span class="default-column"
			>${e.getString(e,n)}</span
		>`}renderEditCell(e,{item:n},r){return t`<cosmoz-input
			no-label-float
			type="text"
		...
		>`}getComparableValue(e,t){return Dn(e,t)}},customElements.define(`cosmoz-omnitable-column-autocomplete`,On)})),An,jn,Mn,Nn,Pn,Fn,In,Ln,Rn,zn,Bn,Vn,Hn,Un,Wn=e((()=>{D(),L(),ke(),p(),M(),i(),C(),An=(e,t)=>t.find(({value:t})=>e===t),jn=(e,t,n)=>{let r=An(t,n);return r?r.text:e},Mn=(e,t,n,r)=>jn(e,j(t,n),r),Nn=({valuePath:e},t,n)=>An(j(t,e),n),Pn=e=>t=>{e(e=>({...e,filter:t?.[0]?.value??null}))},Fn=e=>t=>{e(e=>({...e,headerFocused:t}))},In=e=>t=>{e(e=>({...e,query:t}))},Ln=e=>t=>e(t?.[0]?.value),Rn=({valuePath:e,trueLabel:t,falseLabel:n},r)=>j(r,e)?t:n,zn=({valuePath:e},t)=>n=>j(n,e)===t,Bn=le((e,t)=>[{text:e,value:!0},{text:t,value:!1}]),Vn=({valuePath:e,trueLabel:t,falseLabel:n},r)=>e?j(r,e)?t:n:``,Hn=(e,t)=>{try{return JSON.parse(t)}catch{return null}},Un=class extends I(E){static get properties(){return{trueLabel:{type:String,value:`True`},falseLabel:{type:String,value:`False`},flex:{type:String,value:`0`},cellClass:{type:String,value:`boolean-cell`}}}getString(e,t){return Rn(e,t)}renderCell(e,{item:t}){return Rn(e,t)}renderEditCell(e,{item:n},r){let{trueLabel:i,falseLabel:a}=e;return t`<cosmoz-autocomplete
			no-label-float
			...
			${v(this.disabled,()=>t`
				...
				`,()=>t`
					...
					${z({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:t`
						...
						`})}
				`)}
		`}_fromInputString(e,t){let n=this.toDate(e);if(n!=null)return t===`min`&&n.setHours(0,0,0,0),t===`max`&&n.setHours(23,59,59),n}_filterInputChanged(e,t){let n=e.path.split(`.`)[1]&&e.value;if(n&&n.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}},customElements.define(`cosmoz-omnitable-date-range-input`,qn)})),Yn,Xn,Zn,Y,X,Qn,$n,er,tr,nr,rr,ir,ar,or,sr,cr=e((()=>{_e(),M(),Ht(),Yn=e=>{let t=-new Date(e).getTimezoneOffset()/60;return(t<0?`-`:`+`)+[`0`,Math.abs(t)].join(``).substr(-2)+`:00`},Xn=e=>e.length===19?e+Yn(e):e,Zn=e=>{if(e==null||e===``)return;let t=e;return!(t instanceof Date)&&(typeof e==`string`&&(t=Xn(t)),t=he(t),!t)||Number.isNaN(t.getTime())?null:t},Y=({valuePath:e},t)=>{if(t==null)return;let n=t;e!=null&&(n=j(t,e));let r=Zn(n);if(r!=null)return V(r.getTime())},X=(e,t,n)=>{let r=Zn(e);if(r==null)return null;if(n==null||t==null)return r;let i=X(t);if(i==null)return r;let a=Y({},r),o=Y({},i);return a==null||o==null||n(a,o)===a?r:i},Qn=(e,t)=>{if(t==null)return;let n=X(e);if(n!=null)return t.format(n)},$n={},er=e=>{let t=e||``;return $n[t]||($n[t]=new Intl.DateTimeFormat(e||void 0)),$n[t]},tr=({valuePath:e,locale:t},n)=>{let r=j(n,e||``);return r===void 0?``:(r=X(r),r===null?`Invalid Date`:Qn(r,er(t)))},nr=e=>{let t=X(e);if(t==null)return null;let n=y(t);return n==null?null:n.slice(0,10)},rr=({valuePath:e},t)=>nr(j(t,e||``)),ir=(e,t)=>{let n=X(e);if(n!=null)return t===`min`&&n.setHours(0,0,0,0),t===`max`&&n.setHours(23,59,59),n},ar=e=>nr(e)??``,or=({valuePath:e},t)=>{if(!e)return``;let n=X(j(t,e));if(!n)return``;let r=X(y(n));return r?(r.setHours(0,0,0,0),r):``},sr=(e,t)=>n=>{let r=Y(e,n);if(r==null)return!1;let i=Y({...e,valuePath:`min`},t),a=Y({...e,valuePath:`max`},t);return!(r<(i??-1/0)||r>(a??1/0))}})),lr,ur=e((()=>{x(),D(),i(),L(),Jn(),J(),cr(),P(),lr=class extends I(E){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:`date-header-cell`},width:{type:String,value:`100px`},minWidth:{type:String,value:`82px`},flex:{type:String,value:`0`}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){let n=Y({...e,valuePath:`min`},t),r=Y({...e,valuePath:`max`},t);if(!(n==null&&r==null))return sr(e,t)}getString(e,t){return tr(e,t)}toXlsxValue(e,t){return or(e,t)}getComparableValue(e,t){return Y(e,t)}serializeFilter(e,t){if(t==null)return;let n=X(t.min),r=X(t.max);if(!(n==null&&r==null))return ar(n)+`~`+ar(r)}deserializeFilter(e,t){if(t==null||t===``)return null;let n=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(n)?{min:X(n[1]),max:X(n[2])}:null}renderCell(e,{item:n}){return t`<div class="omnitable-cell-date">
			${tr(e,n)}
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return q(e,t)}},customElements.define(`cosmoz-omnitable-column-date`,lr)})),dr,fr=e((()=>{D(),o(),i(),C(),Kn(),kt(),R(),Nt(),dr=class extends Gn(B(E)){render(){let e=e=>{this.headerFocused=e.type===`focus`};return t`
			<style>
		...
		></cosmoz-omnitable-datetime-range-input>`}computeSource(e,t){return q(e,t)}},customElements.define(br.is,br)})),Sr,Cr=e((()=>{ke(),je(),D(),i(),C(),Sn(),L(),Sr=class extends xn(I(E)){renderCell({valuePath:e,textProperty:n},{item:r}){return t`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		`}renderEditCell(){return`not implemented`}renderHeader(e,{filter:n,query:r},i,a){return t`<cosmoz-autocomplete-ui
			...
			.onText=${vn(i)}
			>${v(e.loading,()=>t`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}},customElements.define(`cosmoz-omnitable-column-list-horizontal`,Sr)})),wr,Tr,Er=e((()=>{u(),k(),o(),wr=b`
	:host {
		display: block;
	}
...
`,Tr=({items:e})=>{let[n,r]=f(!1),i=Array.isArray(e)?e:[],o=g(()=>Math.max(0,i.length-1),[i]);if(i.length===0)return null;let s=i.length>2,c=i[0],l=s&&!n?[]:i.slice(1),u=e=>{e.stopPropagation(),e.preventDefault(),r(e=>!e)};return t`
	...
	`},customElements.define(`cosmoz-omnitable-column-list-data`,N(Tr,{styleSheets:[ge(wr)]}))})),Dr,Or=e((()=>{Er(),D(),i(),C(),ke(),Sn(),L(),K(),Dr=class extends xn(I(E)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:n},{item:r}){return t`<cosmoz-omnitable-column-list-data
		...
		></cosmoz-input>`}renderHeader(e,{filter:n,query:r},i,a){return t`<cosmoz-autocomplete-ui
			...
			.onText=${vn(i)}
			>${v(e.loading,()=>t`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}},customElements.define(`cosmoz-omnitable-column-list`,Dr)})),kr,Ar=e((()=>{x(),D(),o(),i(),C(),kt(),R(),Mt(),Nt(),kr=class extends jt(B(E)){static get properties(){return{maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null},formatter:{type:Object,computed:`_computeFormatter(locale, minimumFractionDigits, maximumFractionDigits)`},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:`_computeFilterText(filter.*, formatter)`},headerFocused:{type:Boolean,value:!1}}}render(){let e=e=>{this.headerFocused=e.type===`focus`,this._onDropdownOpenedChanged(e)};return t`
			<style>
				cosmoz-input[type='number'] {
					background: var(--cosmoz-omnitable-amount-input-background, #ffffff);
					border-radius: 6px;
		...
		></cosmoz-omnitable-number-range-input>`}computeSource(e,t){return q(e,t)}},customElements.define(`cosmoz-omnitable-column-number`,jr)})),Nr,Pr=e((()=>{x(),D(),o(),i(),C(),Kn(),kt(),R(),Nt(),Nr=class extends Gn(B(E)){render(){let e=e=>{this.headerFocused=e.type===`focus`};return t`
			${v(this.disabled,()=>t`
					<cosmoz-omnitable-dropdown-input
						disabled
						.label=${this.title}
		...
		></cosmoz-input>`}renderHeader({title:e,min:n,max:r,locale:i,filterStep:a,disabledFiltering:o},{filter:s},c,l){return t`<cosmoz-omnitable-time-range-input
			...
			@filter-changed=${({detail:{value:e}})=>c(t=>({...t,filter:e}))}
			@header-focused-changed=${({detail:{value:e}})=>c(t=>({...t,headerFocused:e}))}
		></cosmoz-omnitable-time-range-input>`}computeSource(e,t){return q(e,t)}},customElements.define(`cosmoz-omnitable-column-time`,Gr)})),qr=e((()=>{ln(),En(),kn(),Wn(),ur(),xr(),Cr(),Or(),Mr(),Kr()})),Jr,Yr=e((()=>{k(),i(),Jr=({column:e,item:t,selected:r,folded:i,group:a})=>{if(!e)return n;let o=e.renderGroup??e.renderCell;return o?o(e,{item:t,selected:r,folded:i,group:a}):n},customElements.define(`cosmoz-omnitable-group-row`,N(Jr,{useShadowDOM:!1}))})),Xr,Zr=e((()=>{k(),i(),Xr=e=>{let{column:t}=e;return S(()=>{let n=0,r=0,i=i=>{e.dispatchEvent(new CustomEvent(`column-resize`,{bubbles:!0,composed:!0,detail:{newWidth:Math.ceil(r+i.pageX-n),column:t}}))},a=()=>{document.removeEventListener(`pointermove`,i),document.removeEventListener(`pointerup`,a)},o=t=>{n=t.pageX,r=e.previousElementSibling.getBoundingClientRect().width,document.addEventListener(`pointermove`,i),document.addEventListener(`pointerup`,a)};return e.addEventListener(`pointerdown`,o),()=>e.removeEventListener(`pointerdown`,o)},[t]),n},customElements.define(`cosmoz-omnitable-resize-nub`,N(Xr))})),Qr,$r,ei,ti,ni=e((()=>{i(),Qr=t`<svg
	width="10"
	height="9"
	viewBox="0 0 10 9"
	stroke="currentColor"
...
>
	...
	/>
</svg> `})),ri,ii,ai,oi,si=e((()=>{k(),ee(),ni(),ri=({column:e,on:n,descending:r,setOn:i,setDescending:a})=>{let{name:o,title:s}=e??{};return t`<button
		class="sg"
		title=${ie(s)}
...
`}));function ci(e,t,{suffix:n=``,read:r,write:i,ready:a=!0,multi:o}={}){let s=Te({param:t,suffix:n,link:o?fi:di,write:i??be}),c=g(()=>{if(t==null)return!1;if(o){let e=et(t+n);return Object.keys(e).length>0}return we(t+n)!==void 0},[]),[l,u]=f(()=>{if(t==null)return e;if(o){let i=et(t+n,r);return Object.keys(i).length>0?i:e}return we(t+n,r)??e}),d=T(e=>u(t=>{let n=Ze(e,t);return s.param!=null&&Ke(s.link(s.param+s.suffix,n,s.write),null,{notify:!1}),n}),[]);return S(()=>{s.param==null||!a||c||e!=null&&d(e)},[a]),[l,d]}var li,ui,di,fi,pi=e((()=>{De(),Ge(),tt(),ze(),k(),li=e=>(t,n,r=be)=>{let i=Se(),a=new URLSearchParams(i.hash.replace(`#`,``));return e(t,n,r,a),`#!`+Object.assign(i,{hash:a}).href.replace(location.origin,``)},ui=e=>e==null||e===``,di=li((e,t,n,r)=>ui(n(t))?r.delete(e):r.set(e,n(t))),fi=li((e,t,n,r)=>{let i=Object.entries(t),a=i.map(n).filter(([,e])=>e!==void 0);if(a.length===0&&i.length>0)return;let o=e;Array.from(r.keys()).filter(e=>e.startsWith(o)).forEach(e=>r.delete(e)),a.forEach(([t,n])=>ui(n)?r.delete(e+t):r.set(e+t,n))})})),mi,hi,gi,_i,vi,yi=e((()=>{k(),pi(),mi=e=>[!0,`true`,1,`yes`,`on`].includes(e),hi=e=>e===``||(e==null?void 0:mi(e)),gi=(e,t,n)=>T(r=>{e(r),n(e=>({...e,[t]:r}))},[e,t,n]),_i=(e,t,{settings:n,setSettings:r,resetRef:i,ready:a=!0})=>{let[o,s]=ci(n.sortOn,t,{suffix:`-sortOn`,ready:a}),[c,l]=ci(hi(n.descending),t,{suffix:`-descending`,read:hi,ready:a}),[u,d]=ci(n.groupOn,t,{suffix:`-groupOn`,ready:a}),[f,p]=ci(hi(n.groupOnDescending),t,{suffix:`-groupOnDescending`,read:hi,ready:a}),m=g(()=>e.find(e=>e.name===o),[e,o]),h=g(()=>e.find(e=>e.name===u),[e,u]),_={groupOn:u,setGroupOn:gi(d,`groupOn`,r),groupOnDescending:f,setGroupOnDescending:gi(p,`groupOnDescending`,r),sortOn:o,setSortOn:gi(s,`sortOn`,r),descending:c,setDescending:gi(l,`descending`,r),columns:e},v=g(()=>_,Object.values(_)),y=T(e=>{s(e.sortOn),d(e.groupOn),l(e.descending),p(e.groupOnDescending)},[]);return S(()=>void(i.current=y),[]),{...v,sortAndGroup:v,groupOnColumn:h,sortOnColumn:m}},vi=ct(),customElements.define(`sort-and-group-provider`,vi.Provider),customElements.define(`sort-and-group-consumer`,N(({render:e})=>e(m(vi)),{useShadowDOM:!1}))})),bi,xi,Si=e((()=>{k(),h(),Zr(),si(),C(),yi(),bi=({data:e,columns:n,groupOnColumn:r,filters:i,setFilterState:a,sortAndGroup:{sortOn:o,setSortOn:s,descending:c,setDescending:l}={}})=>me(n,e=>e.name,n=>[t`<div
	...
	`},customElements.define(`cosmoz-omnitable-header-row`,N(xi,{useShadowDOM:!1}))})),Ci,wi,Ti=e((()=>{u(),k(),Ci=b`
	:host {
		display: flex;
		align-items: center;
		flex-wrap: wrap;
...
`,customElements.define(`cosmoz-omnitable-item-expand-line`,N(wi,{styleSheets:[ge(Ci)]}))})),Ei,Di=e((()=>{k(),i(),We(),Ti(),Ei=({columns:e,item:n,selected:r,expanded:i,groupOnColumn:a})=>Xe(e,e=>t`<cosmoz-omnitable-item-expand-line
				.column=${e}
				?hidden=${e===a}
				exportparts="item-expand-label, item-expand-value"
				>${e.renderCell(e,{item:n,selected:r,expanded:i})}</cosmoz-omnitable-item-expand-line
			>`),customElements.define(`cosmoz-omnitable-item-expand`,N(Ei,{useShadowDOM:!1}))})),Oi,ki,Ai=e((()=>{k(),h(),Oi=(e,t,n)=>e.editable?e.renderEditCell(e,t,n(e,t.item)):e.renderCell(e,t),ki=({columns:e,groupOnColumn:n,item:r,index:i,selected:a,expanded:o,onItemChange:s})=>me(e,e=>e.name,e=>t`<div
			...
			</div>`),customElements.define(`cosmoz-omnitable-item-row`,N(ki,{useShadowDOM:!1}))})),ji,Mi,Ni=e((()=>{u(),ji=b`
	.checkbox {
		box-sizing: border-box;
		width: 18px;
		height: 18px;
...
`})),Pi,Fi,Ii=e((()=>{Ne(),Pi=e=>{let t=e.replace(/"/gu,`""`);return t.search(/("|,|\n)/gu)>=0?`"`+t+`"`:e},Fi=(e,t,n)=>{let r=e.map(e=>Pi(e.title)).join(`;`)+`
`,i=t.map(t=>e.map(e=>{let n=e.getString(e,t);return n==null?``:Pi(String(n))}).join(`;`)+`
`);i.unshift(r),ye(new File(i,n,{type:`text/csv;charset=utf-8`}))}})),Li,Ri,zi=e((()=>{Ue(),Ne(),Li=(e,t)=>{let n=e.map(e=>e.title),r=t.map(t=>e.map(e=>e.toXlsxValue(e,t)??``));return r.unshift(n),r},Ri=(e,t,n,r)=>{let i=Li(e,t),a=new Ye(n).addSheetFromData(i,r).generate();ye(new File([a],n,{type:`application/vnd.openxmlformats-officedocument.spreadsheetml.sheet`}))}})),Bi,Vi=e((()=>{ne(),o(),i(),Ii(),zi(),Bi=({columns:e,selectedItems:n,csvFilename:r,xlsxFilename:i,xlsxSheetname:o,topPlacement:s})=>t`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!Je(n.length)}
		part="bottomBar"
	...
	</cosmoz-bottom-bar>`})),Hi,Ui=e((()=>{i(),C(),Hi=({allSelected:e,onAllCheckboxChange:n,sortAndGroup:r,dataIsValid:i,data:a,columns:o,filters:s,groupOnColumn:c,setFilterState:l,settingsConfig:u,hideSelectAll:d})=>t`<sort-and-group-provider .value=${r}>
	...
	</sort-and-group-provider>`})),Wi,Gi,Ki=e((()=>{k(),Wi=Re`
	:host {
		max-width: 100%;
		overflow-x: hidden;
		padding: 0 12px;
...
`,Gi=({settingsConfig:e})=>{let{columns:n,collapsed:r}=e,i=n.filter(e=>!r.some(t=>t.name===e.name));return t`<div class="skeleton">
	...
	</div>`},customElements.define(`cosmoz-omnitable-skeleton`,N(Gi,{styleSheets:[Wi]}))})),qi,Ji=e((()=>{k(),Ki(),l(),o(),i(),C(),qi=(e,n)=>{let{settingsConfig:r}=e,{processedItems:i,dataIsValid:o,filterIsTooStrict:s,loading:c,displayEmptyGroups:l,compareItemsFn:u,selectedItems:d,setSelectedItems:f,renderItem:p,renderGroup:m,error:h}=n;return t`${v(!c&&!o&&!h,()=>t`<div class="tableContent-empty">
					<slot name="empty-set-message">
						${ce({width:`96px`,height:`96px`,styles:`margin-right: 24px; fill: currentColor;`})}
...
`})),Qi,$i,ea=e((()=>{tt(),k(),Qi=e=>{let t=parseInt(e,10);return isFinite(t)?t:void 0},$i=e=>{let{config:t}=e,{settings:n,setSettings:r,collapsed:i,requestTween:a}=t,o=Te({collapsed:i,settings:n.columns,requestTween:a,setSettings:T(e=>r(t=>({...t,columns:e})),[r])});return{...t,onDown:T(e=>{e.target.closest(`.pull`)&&(o.handle=e.currentTarget)},[o]),onDragStart:T(e=>{let{target:t}=e,n=Qi(t.dataset.index);if(!o.handle?.contains(t)||n==null)return e.preventDefault();o.handle=null,e.dataTransfer.effectAllowed=`move`,e.dataTransfer.setData(`omnitable/sort-index`,n),e.dataTransfer.setData(`text/plain`,n),setTimeout(()=>t.classList.add(`drag`),0),t.addEventListener(`dragend`,e=>e.target.classList.remove(`drag`),{once:!0})},[o]),onDragEnter:T(e=>{let t=e.currentTarget;t===e.target&&(e.preventDefault(),e.dataTransfer.dropEffect=`move`,t.classList.add(`dragover`))},[]),onDragOver:T(e=>{e.preventDefault(),e.currentTarget.classList.add(`dragover`)},[]),onDragLeave:T(e=>{let t=e.currentTarget;t.contains(e.relatedTarget)||t.classList.remove(`dragover`)},[]),onDrop:T(e=>{let t=Qi(e.dataTransfer.getData(`omnitable/sort-index`)),n=Qi(e.currentTarget.dataset.index),{settings:r,setSettings:i,requestTween:a}=o;e.currentTarget.classList.remove(`dragover`),e.preventDefault();let s=r.slice();s.splice(n+(t>=n?0:-1),0,s.splice(t,1)[0]),a?.(),i(s)},[o]),onToggle:T(e=>{let{settings:t,setSettings:n,requestTween:r}=o,i=t.map(e=>({...e,disabled:e.disabled||o.collapsed?.some(t=>t.name===e.name)})),a=Qi(e.target.closest(`[data-index]`)?.dataset.index);i.splice(a,1,{...t[a],disabled:!e.target.checked,priority:e.target.checked?t.reduce((e,t)=>Math.max(e,t.priority),0)+1:t[a].priority}),r?.(),n(i)},[o])}}})),ta,na,ra,ia,aa=e((()=>{Qe(),qe(),u(),ne(),k(),o(),C(),ni(),si(),Zi(),ea(),ta=[He({apply({availableHeight:e,elements:t}){Object.assign(t.floating.style,{maxHeight:`${Math.max(0,e)}px`})}}),...Oe],na=({onDragStart:e,onDragEnter:n,onDragOver:r,onDragLeave:i,onDrop:a,onDown:o,onToggle:s,collapsed:c,filters:l})=>(u,d)=>{let f=!!c?.find(e=>e.name===u.name),p=!u.disabled&&!f;return t` <div
			class="item"
			data-index=${d}
			@mousedown=${o}
			draggable="true"
		...
		${v(r,()=>t`<div class="buttons">
				...
				</div>`)}`},customElements.define(`cosmoz-omnitable-settings-ui`,N(ra,{styleSheets:[ge(Yi)]})),ia=({config:e,newLayout:n})=>t`
	<cosmoz-dropdown
...
`,customElements.define(`cosmoz-omnitable-settings`,N(ia,{styleSheets:[ge(Xi)]}))})),oa,sa,ca,la,ua,da=e((()=>{st(),oa=[`sortOn`,`descending`,`groupOn`,`groupOnDescending`],sa=e=>t=>typeof t==`object`&&!!t&&`name`in t&&t.name===e,ca=(e=[],t=[],n=[])=>{let r=t.filter(t=>e.some(sa(t.name))),i=e.filter(e=>e.name!=null&&!t.some(sa(e.name))&&!n.some(sa(e.name))),a=n.filter(e=>!t.some(sa(e.name)));return[...r,...a.flatMap(t=>{let n=e.find(e=>e.name===t.name);return n?{...t,title:n.title??t.title??``,minWidth:parseInt(n.minWidth??`0`,10)}:[]}),...i.map(e=>{let{name:t,title:n,priority:r,minWidth:i,width:a,flex:o}=e;return{name:t??``,title:n??``,priority:r??0,minWidth:parseInt(i??`0`,10),width:parseInt(a??`0`,10),flex:parseInt(o??`0`,10)}})]},la=(e,t)=>({...t,...at(Array.from(oa))(e),columns:e.columns?.map(at([`name`,`priority`,`width`,`flex`,`disabled`]))}),ua=({columns:e,settings:t,savedSettings:n,initial:r})=>({...Object.fromEntries(oa.flatMap(e=>r?.[e]==null?[]:[[e,r[e]]])),...n?at(Array.from(oa))(n):{},...t,columns:ca(e,t?.columns,n?.columns)})})),fa,pa=e((()=>{fa=({prefix:e=`omnitable-`}={})=>({write:async(t,n)=>{let r=e+t;try{n?localStorage.setItem(r,JSON.stringify(n)):localStorage.removeItem(r)}catch(e){console.error(e)}},read:async t=>{if(!t)return null;try{let n=localStorage.getItem(e+t);return n==null?null:JSON.parse(n)}catch(e){return console.error(e),null}}})})),ma,ha,ga=e((()=>{k(),pa(),ma=ct(fa),ha=()=>{let e=m(ma);return g(()=>e(),[e])}})),_a=e((()=>{ga()})),va,ya=e((()=>{k(),_a(),da(),va=(e,t,n,r)=>{let[i,a]=f(e?void 0:null),{read:o,write:s}=ha();return S(async()=>{e&&a(await o(e))},[e,o]),{settingsId:e,savedSettings:i,onSave:T(async()=>{if(!e)return;let r=la(t,i);await s(e,r),n(),a(r)},[t,i]),onReset:T(async t=>{n(),t.shiftKey&&(await s(e),a(null)),r?.()},[r]),hasChanges:t!=null}}})),ba,xa=e((()=>{k(),K(),da(),ya(),ba=({settingsId:e,host:t})=>{let n=g(()=>Object.fromEntries(oa.map(e=>[e,t[e]])),[]),r=xe(),i=T(()=>{r.current?.(n)},[n]),[a,o]=f(),[s,c]=f({columns:!0,sort:!0}),{savedSettings:l,...u}=va(e,a,o,i),{enabledColumns:d,disabledFiltering:p,noLocal:m}=t,h=an(t,{enabledColumns:d,disabledFiltering:p,noLocal:m}),_=g(()=>ua({columns:h,settings:a,savedSettings:l,initial:n}),[h,a,l]),v=g(()=>_.columns.map(e=>h.find(t=>t.name===e.name)).filter(Boolean),[h,..._.columns.map(e=>e.name)]);return{...u,savedSettings:l,opened:s,setOpened:c,settings:_,columns:v,setSettings:o,resetRef:r}}})),Sa=e((()=>{aa(),xa()})),Ca,wa,Ta=e((()=>{Ca=e=>Number.isFinite(e)?e:0,wa=(e,t)=>{let n=[],[r,i]=e.reduce(([e,t],{width:n,flex:r})=>[e+n,t+r],[0,0]),a=t-r,o=Ca(a/i),s=0,c=0,l=0;for(let t=0;t<e.length;t++){let{width:i,minWidth:u,flex:d}=e[t];if(u>i+(a>=0?o*d:i*a/r)){s+=i,c+=u,l+=d,n[t]=u;continue}if(d===0){s+=i,c+=i,n[t]=i;continue}}r-=s,a=t-c-r,i-=l,o=Ca(a/i);for(let t=0;t<e.length;t++){if(n[t]!=null)continue;let{width:i,flex:s}=e[t];n[t]=i+(a>=0?o*s:i*a/r)}return n}})),Ea,Da,Oa=e((()=>{Ea=Symbol(`index`),Da=(e,t)=>{if(typeof e.findLastIndex==`function`)return e.findLastIndex(t);for(let n=e.length-1;n>=0;n--)if(t(e[n],n,e))return n;return-1}})),ka,Aa,ja,Ma=e((()=>{Ta(),Oa(),ka=(e,t)=>{let n=Da(e,e=>e!=null&&e>0),r=(e,t)=>`.cell[name="${e}"], cosmoz-omnitable-skeleton::part(cell-${e}){width: ${Math.floor(t)}px;padding: 0 min(3px, ${t/2}px)}`,i=e=>`cosmoz-omnitable-resize-nub[name="${e}"]{display:none}`,a=e=>`cosmoz-omnitable-resize-nub[name="${e}"], .cell[name="${e}"]{display:none}`;return t.map((t,o)=>{let s=e[o];if(s==null||s===0)return a(t.name);let c=r(t.name,s);return o===n?`${c}\n${i(t.name)}`:c}).join(`
`)},Aa=(e,t,n)=>{let r=e.filter(e=>!e.hidden),i=r.reduce((e,{width:t})=>e+t,0);if(r.length>1&&i>t)return Aa(r.slice(1),t,n);let a=r.reduce(([e,t],n,r)=>[Math.max(e,n.index),n.index>e?r:t],[-1,-1])[1];return a!==-1&&(r[a].flex=1),wa(r,t).reduce((e,t,n)=>(e[r[n].index]=t,e),Array(n).fill(void 0))},ja=(e,t)=>e.length===0?`.cell {display: none;}`:ka(e,t)})),Na,Pa,Fa=e((()=>{k(),Na=88,Pa=(e,t)=>S(()=>{let n=new ResizeObserver(([e])=>{e.contentRect?.width!==0&&t(e.contentRect.width-Na)});return n.observe(e),()=>n.unobserve(e)},[])})),Ia,La=e((()=>{k(),Fa(),Ia=e=>{let[t,n]=f(()=>e.getBoundingClientRect().width-Na);return Pa(e,n),t}})),Ra,za=e((()=>{k(),Ma(),Ra=({canvasWidth:e,groupOnColumn:t,config:n,miniColumn:r})=>g(()=>{if(!Array.isArray(n)||e==null||e===0)return[];let i=n.map((e,n)=>({minWidth:e.minWidth,width:e.width,flex:e.flex,priority:e.priority,name:e.name,index:n,hidden:e.name===t?.name||e.disabled})).map(e=>r?{...e,hidden:r.name!==e.name}:e).sort(({index:e,priority:t},{index:n,priority:r})=>t===r?n-e:t-r);return Aa(i,e,i.length)},[e,t,n])})),Ba,Va=e((()=>{k(),Ba=({host:e,canvasWidth:t,columns:n})=>{let r=e.miniBreakpoint??480,i=g(()=>t<=r,[t,r]),[a,...o]=g(()=>i?n?.filter(e=>e.mini!=null).sort((e,t)=>(e.mini??0)-(t.mini??0)):[],[n,i])??[],s=!!a;return S(()=>{e.toggleAttribute(`mini`,s)},[s]),{isMini:s&&i,miniColumn:a,miniColumns:o}}})),Ha,Ua=e((()=>{k(),Ha=({host:e,canvasWidth:t,layout:n,setSettings:r,requestTween:i})=>{let a=xe();a.current=e=>{i(),r(r=>{let i=r.columns,{detail:{newWidth:a,column:o}}=e,s=i.findIndex(e=>e.name===o.name),c=[],l=i.reduce((e,t)=>Math.max(e,t.priority),-1/0);for(let e=0;e<n.length;e++)if(c[e]={...i[e]},e<s&&n[e]&&(c[e].width=n[e],c[e].flex=0,c[e].priority=l),e===s){let r=n.reduce((e,t,n)=>n<s&&t?e-t:e,t);c[e].width=Math.min(r,Math.max(a,i[e].minWidth)),c[e].flex=0,c[e].priority=l}return{...r,columns:c}})},S(()=>{let t=e=>a.current?.(e);return e.addEventListener(`column-resize`,t),()=>e.removeEventListener(`column-resize`,t)},[])}})),Wa,Ga,Ka,qa=e((()=>{Ge(),tt(),k(),Wa=(e,t)=>{let n=g(()=>{let t=!1,n,r=()=>{t&&(n=requestAnimationFrame(r),e()&&(t=!1))};return{start:()=>{t=!0,cancelAnimationFrame(n),n=requestAnimationFrame(r)},stop:()=>{t=!1,cancelAnimationFrame(n)}}},[]);S(()=>{n.start()},t),S(()=>()=>n.stop(),[])},Ga=(e=0,t=0)=>Math.abs(e-t)<.1,Ka=(e,t=1.9,n=Ce,r)=>{let i=Te({target:e,speedFactor:t,onConverge:r});Wa(T(()=>{if(!i.tween)return i.tween=i.target,n(i.tween),i.onConverge?.(),!0;if(i.target.every((e,t)=>i.tween[t]===e))return n(i.tween),i.onConverge?.(),!0;i.tween=i.target.map((e,t)=>Ga(i.tween[t],e)?e:(i.tween[t]??0)+((e??0)-(i.tween[t]??0))/i.speedFactor||0),n(i.tween)},[]),[e])}})),Ja,Ya,Xa=e((()=>{tt(),k(),Ma(),La(),za(),Va(),Ua(),qa(),Ja=e=>{let t=g(()=>new CSSStyleSheet,[]);return S(()=>{e.shadowRoot.adoptedStyleSheets=[...e.shadowRoot.adoptedStyleSheets,t]},[]),t},Ya=({host:e,columns:t,settings:n,setSettings:r,resizeSpeedFactor:i,sortAndGroupOptions:a})=>{let o=Ia(e),{isMini:s,miniColumn:c,miniColumns:l}=Ba({host:e,canvasWidth:o,columns:t}),{groupOnColumn:u}=a,d=Ra({canvasWidth:o,groupOnColumn:u,miniColumn:c,config:n.columns}),p=Ja(e),m=g(()=>n.columns.reduce((e,n,r)=>d[r]!=null||n.name===u?.name||n.disabled?e:[...e,t.find(e=>e.name===n.name)],[]),[t,n,d]),[h,_]=f(1),v=T(()=>_(i??1.9),[i]),y=T(()=>_(1),[]),b=xe(!0);S(()=>{if(b.current){b.current=!1;return}v()},[u,v]);let x=Te({columns:n.columns});return Ka(d,h,e=>{let t=ja(e,x.columns);p.replace(t)},y),Ha({host:e,canvasWidth:o,layout:d,setSettings:e=>r(e(n)),requestTween:v}),{isMini:s,collapsedColumns:m,miniColumns:l,requestTween:v}}})),Za,Qa=e((()=>{Za=({host:e,...t})=>{let{csvFilename:n=`omnitable.csv`,xlsxFilename:r=`omnitable.xlsx`,xlsxSheetname:i=`Omnitable`,topPlacement:a=`top-end`}=e;return{csvFilename:n,xlsxFilename:r,xlsxSheetname:i,topPlacement:a,...t}}})),$a,eo=e((()=>{k(),$a=({host:e,selectedItems:t,data:n,sortAndGroupOptions:r,collapsedColumns:i,settings:a,filterFunctions:o,settingS:s,filters:c,requestTween:l,...u})=>{let d=n&&n.length>0&&t.length===n.length,f=t=>{t.target.checked?e.shadowRoot.querySelector(`#groupedList`).selectAll():e.shadowRoot.querySelector(`#groupedList`).deselectAll()},{groupOnColumn:p}=r,m=g(()=>[p,...i,...a.columns.filter(e=>e.disabled)].some(e=>e&&Object.keys(o).includes(e.name)),[o,a,i]),h=g(()=>({...s,collapsed:i,badge:m,filters:c,requestTween:l}),[s,i,m,c,l]);return S(()=>{let t=e.shadowRoot.querySelector(`#tableContent`),n=new ResizeObserver(t=>requestAnimationFrame(()=>{e.style.setProperty(`--ot-height`,t[0]?.contentRect.height+`px`)}));return n.observe(t),()=>n.unobserve(t)},[]),{allSelected:d,onAllCheckboxChange:f,data:n,settingsConfig:h,filters:c,groupOnColumn:p,sortAndGroup:r.sortAndGroup,...u}}})),to,no,ro,io,ao,oo,so=e((()=>{k(),C(),ne(),Oa(),J(),to=t`
	<svg
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
...
`,t(Object.assign([Yo],{raw:[Yo]})),de(Object.assign([Yo],{raw:[Yo]}))})),Zo,$,Qo,$o,es,ts=e((()=>{Zo=(e,t,n)=>{let r=String(e),i=-1,a=!n&&n!==0?` `:n,o=t-r.length;for(;++i<o;)r=a+r;return r},$=(e,t)=>Math.floor(Math.random()*(t-e+1))+e,Qo=()=>`2015-`+Zo($(1,12),2,`0`)+`-`+Zo($(1,28),2,`0`),$o=()=>{let e=$(0,20);return e===1?new Date(2015,3,2,14,26,10,299):e===2?new Date(2016,4,2,10,9,10,444):e===3?new Date(2016,4,2,10,9,10,443):e===4?new Date(2016,4,2,10,9,10,442):new Date($(2014,2017),$(1,12),$(1,28),$(0,23),$(0,59),$(0,59),$(0,999))},es=(e,t,n)=>{let r=$(e,t),i=[],a=[`Lorem ipsum dolor sit amet`,`Nunc tristique`,`Curabitur vestibulum`,`Cras laoreet`,`Himenaeos`,`maximus diam purus at mauris`],o=[`SEK`,`USD`,`EUR`,`AUD`],s=0;for(let e=0;e<r;e+=1){let t=`Group `+e,r=e*2+1;for(let e=0;e<r;e+=1){let r=[],c=[],l=[],u=s%10;for(let e=0;e<u;e+=1)r.push(`Item `+e),c.push({name:`Item `+e,value:`item-value-`+e}),l.push({value:`cat-`+e,label:`Category `+e});i.push({id:s,name:t+` item `+e,value:$(0,1e4),bool:$(0,100)>50,object:{value:$(0,1e4),label:`Random string `+$(1,n)},sub:{subProp:a[s%a.length]},randomString:`Random string `+$(1,n),randomString2:`Random string 2 `+$(1,n),randomString3:`Random string 3 `+$(1,n),randomString4:`Random string 4 `+$(1,n),date:$o(),dateJSON:Qo(),amount:{amount:$(10,100),currency:o[s%o.length]},group:t,list:r,objectList:c,categories:s%7==0?null:l}),s+=1}}return i}})),ns,rs,is,as,os;e((()=>{i(),l(),dt(),Xo(),ts(),ns={title:`Components/ComsmozOmnitableFullDemo`,component:`cosmoz-omnitable`,tags:[`autodocs`],args:{loading:!1,locale:`en`,sortOn:``,groupOn:``,descending:!1,groupOnDescending:!1,hashParam:``,settingsId:``,selectedItems:[],disabledFiltering:!1},argTypes:{loading:{control:`boolean`,description:`Show loading state`,table:{defaultValue:{summary:`false`}}},locale:{control:`select`,options:[`en`,`fr`,`sv`],description:`Language locale`,table:{defaultValue:{summary:`en`}}},selectedItems:{control:`object`,description:`Show selected items`},data:{control:`object`,description:`Show specified items`},sortOn:{control:`text`,description:`Column property name to sort on (e.g., "amount", "date", "id")`},groupOn:{control:`text`,description:`Column property name to group on (e.g., "amount", "date", "id")`},descending:{control:`boolean`,description:`Sort on descending`},groupOnDescending:{control:`boolean`,description:`Group on descending`},hashParam:{control:`text`,description:`Hash parameter for URL state management`},settingsId:{control:`text`,description:`ID for storing table settings`},disabledFiltering:{control:`boolean`,description:`Disable filter inputs in all column headers`,table:{defaultValue:{summary:`false`}}}},render:e=>t`
            ...
            >
                ...
                <paper-button slot="actions" on-run="removeItems">
                    ${oe({styles:`vertical-align: middle; fill: currentColor;`})}
