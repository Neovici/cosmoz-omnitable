import{n as e}from"./chunk-BneVvdWh.js";import{$ as t,X as n,Z as r,et as i,n as a,t as o}from"./iframe-CHTUmAZq.js";import{$ as s,A as c,At as l,B as u,C as d,Ct as f,D as p,Dt as m,E as h,Et as g,F as _,Ft as v,G as y,H as b,I as x,It as ee,J as te,K as S,L as ne,Lt as re,M as ie,N as ae,Nt as oe,O as se,Ot as C,P as ce,Pt as w,Q as le,R as ue,S as de,St as T,T as fe,Tt as E,U as pe,V as me,W as he,X as D,Y as ge,Z as O,_ as _e,_t as k,a as ve,at as ye,b as A,bt as be,c as xe,ct as Se,d as Ce,dt as we,et as Te,f as Ee,ft as De,g as Oe,gt as ke,h as Ae,ht as je,i as Me,it as Ne,j as Pe,jt as Fe,k as Ie,kt as Le,l as Re,lt as ze,m as Be,mt as Ve,n as He,nt as j,o as Ue,ot as We,p as Ge,pt as Ke,q as qe,r as Je,rt as M,s as Ye,st as Xe,t as Ze,tt as Qe,u as $e,ut as et,v as tt,vt as N,w as nt,wt as rt,x as it,xt as at,y as ot,yt as st,z as ct}from"./dist-De8sNikL.js";var lt,ut,dt=e((()=>{u(),k(),lt=b`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,Et=e=>{let{label:n,value:r,slot:i}=e;return te(t`<div
	...
	>
		...
		<cosmoz-dropdown
			@focus=${i}
			class=${ce({filtered:!!r,...s!=null&&{[`external-values-${s}`]:!0},dropdown:!0})}
			title=${n||``}
		>
	...
	`})),At,jt,Mt=e((()=>{We(),Te(),ae(),c(),At=e=>e?typeof e.close==`function`?e:At(e.parentElement):null,jt=e=>class extends e{static get properties(){return{disabled:{type:Boolean,value:!1},filter:{type:Object,notify:!0},values:{type:Array,value(){return[]}},headerFocused:{type:Boolean,notify:!0},min:{type:Number,value:null},max:{type:Number,value:null},limits:{type:Function},autoupdate:{type:String,value:!0},locale:{type:String,value:null},_filterInput:{type:Object,value(){return{min:null,max:null}}},_range:{type:Object,computed:`_computeRange(values.*)`},_limit:{type:Object,computed:`_computeLimit(_range, _filterInput.*, min, max)`,value(){return{}}},_tooltip:{type:String,computed:`_computeTooltip(title, _filterText)`},_fromClasses:{type:String,computed:`_computeInputClasses(_filterInput.min)`},_toClasses:{type:String,computed:`_computeInputClasses(_filterInput.max)`}}}static get observers(){return[`_filterInputChanged(_filterInput.*, autoupdate)`,`_filterChanged(filter.*)`,`_updateLimits(limits, headerFocused)`]}disconnectedCallback(){this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),super.disconnectedCallback()}_computeInputClasses(e){return e!=null&&e!==``?`has-value`:``}toNumber(e,t,n){if(e==null||e===``)return;let r=typeof e==`number`?e:Number(e);if(Number.isNaN(r))return;if(n==null||t==null)return r;let i=this.toNumber(t);return i==null?r:n(r,i)}toValue(){return this.toNumber.apply(this,arguments)}getComparableValue(e,t){if(e==null)return;let n=e;return t!=null&&(n=this.get(t,e)),this.toValue(n)}renderValue(){}getInputString(e,t=this.valuePath){let n=this.toValue(this.get(t,e));return this._toInputString(n)}_computeRange(e){let t=e.base,n=Array.isArray(t)&&t.length&&t.map(e=>this.toValue(e)).filter(e=>e!=null);return!n||n.length<1?{min:null,max:null}:n.reduce((e,t)=>({min:this.toValue(t,e.min,Math.min),max:this.toValue(t,e.max,Math.max)}),{})}_computeLimit(e,t,n,r){if(!e)return;let i=t.base,a=this.toValue(n),o=this.toValue(r),s=a??this.toValue(e.min),c=o??this.toValue(e.max);return{fromMin:s,fromMax:this.toValue(c,this._fromInputString(i.max,`max`),Math.min),toMin:this.toValue(s,this._fromInputString(i.min,`min`),Math.max),toMax:c}}_computeFilterText(e){if(e.base==null)return;let t=e.base,n=this.toValue(t.min),r=this.toValue(t.max),i=[];return n!=null&&i.push(this.renderValue(n)),i.push(` - `),r!=null&&i.push(this.renderValue(r)),i.length>1?i.join(``):void 0}_computeTooltip(e,t){return t==null?e:`${e}: ${t}`}_fromInputString(e){return this.toValue(e)}_toInputString(e){return this.toValue(e)??null}_getDefaultFilter(){return{min:null,max:null}}_filterInputChanged(e,t){this.__inputChangePath=e.path.split(`.`)[1]||null,t&&(this._limitInputDebouncer=Pe.debounce(this._limitInputDebouncer,Qe.after(600),()=>{this._limitInput(),this._updateFilter()}),ie(this._limitInputDebouncer))}_clearFrom(){this.set(`_filterInput.min`,null),this._updateFilter()}_clearTo(){this.set(`_filterInput.max`,null),this._updateFilter()}_onBlur(){this._limitInput(),this._updateFilter()}_onKeyDown(e){let t=e.currentTarget,n=Array.from(t.parentElement.querySelectorAll(`cosmoz-input`)),r=n[n.findIndex(e=>e===t)+1],i=!r,a=n[0]===t;switch(e.keyCode){case 13:if(e.preventDefault(),!i)r.focus();else{let e=this._limitInput();this._updateFilter(),e||this._closeParent(t)}break;case 9:(i&&!e.shiftKey||a&&e.shiftKey)&&this._closeParent(t)}}_closeParent(e){let t=At(e);t&&t.close()}_onDropdownOpenedChanged({currentTarget:e,type:t,detail:n}){(t===`focus`||n?.value===!0)&&setTimeout(()=>{e.querySelector(`cosmoz-input:focus`)||e.querySelector(`cosmoz-input`)?.focus()},100)}_limitInput(){let e=this._filterInput,t=this.__inputChangePath,n=t?this._fromInputString(this.get(t,e),t):null;if(this.__inputChangePath=null,n==null)return!1;let r=this._limit,i=t===`min`?`from`:`to`,a=this.get(i+`Min`,r),o=this.get(i+`Max`,r),s=this.toValue(n,a,Math.max),c=this.toValue(s,o,Math.min);return this.getComparableValue(n)===this.getComparableValue(c)?!1:(this.set([`_filterInput`,t],this._toInputString(c,t)),this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),!0)}_updateFilter(){let e=this._filterInput,t=this.filter,n=this._fromInputString(e.min,`min`),r=this._fromInputString(e.max,`max`);this.getComparableValue(n)===this.getComparableValue(t,`min`)&&this.getComparableValue(r)===this.getComparableValue(t,`max`)||this.set(`filter`,{min:n,max:r})}_filterChanged(e){if(this._filterInput==null)return;let t=this._filterInput,n=e.base,r=this._fromInputString(t.min,`min`),i=this._fromInputString(t.max,`max`);this.getComparableValue(r)===this.getComparableValue(n,`min`)&&this.getComparableValue(i)===this.getComparableValue(n,`max`)||(this.set(`_filterInput`,{min:this._toInputString(n.min),max:this._toInputString(n.max)}),this._limitInputDebouncer&&this._limitInputDebouncer.cancel())}hasFilter(){let e=this.filter;return e==null?!1:this.toValue(e.min)!=null||this.toValue(e.max)!=null}resetFilter(){this.filter=this._getDefaultFilter()}_updateLimits(e,t){e&&Promise.resolve(Xe(e,{active:t})).then(e=>{let{min:t,max:n}=e??{};Object.assign(this,{...t==null?{}:{min:t},...n==null?{}:{max:n}})})}}})),Nt,Pt=e((()=>{O(),i(),Nt=e=>class extends e{static get template(){return le`<div id="output" style="position:relative;"></div>`}connectedCallback(){super.connectedCallback();let e=this;r(e.render(),e.$.output)}_propertiesChanged(e,t,n){super._propertiesChanged(e,t,n);let i=this;requestAnimationFrame(()=>r(i.render(),i.$.output))}}})),Ft,It=e((()=>{x(),O(),o(),i(),w(),kt(),Dt(),Mt(),Pt(),Ft=class extends jt(Nt(D)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:`_computeFilterText(filter.*, _formatters)`},headerFocused:{type:Boolean,value:!1}}}static get observers(){return[`_valuesChanged(autodetect, currency, values)`]}render(){let e=e=>{this.headerFocused=e.type===`focus`,this._onDropdownOpenedChanged(e)};return t`
		...
		>`}getComparableValue(e,t){return En(e,t)}getFilterFn(e,t){if(!(!t||!Array.isArray(t)||t.length===0))return Dn(e,t)}},customElements.define(`cosmoz-omnitable-column-autocomplete-excluding`,On)})),An,jn,Mn=e((()=>{Oe(),Ae(),O(),i(),w(),tt(),ot(),Tn(),I(),M(),sn(),An=({valuePath:e,textProperty:t,valueProperty:n},r)=>{let i=t?de(t):A(n),a=_e(e&&j(r,e)).map(i);return a.length>1?a.filter(Boolean).join(`,`):a[0]},jn=class extends wn(F(D)){static get properties(){return{headerCellClass:{type:String,value:`autocomplete-header-cell`},minWidth:{type:String,value:`55px`},editMinWidth:{type:String,value:`55px`},keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},showSingle:{type:Boolean},preserveOrder:{type:Boolean},limit:{type:Number},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,showSingle:e.showSingle,preserveOrder:e.preserveOrder,limit:e.limit,textual:e.textual}}renderCell(e,{item:n}){return t`<span class="default-column"
			>${e.getString(e,n)}</span
		>`}renderEditCell(e,{item:n},r){return t`<cosmoz-input
			no-label-float
			type="text"
		...
		>`}getComparableValue(e,t){return An(e,t)}},customElements.define(`cosmoz-omnitable-column-autocomplete`,jn)})),Nn,Pn,Fn,In,Ln,Rn,zn,Bn,Vn,Hn,Un,Wn,Gn,Kn,qn=e((()=>{O(),I(),Oe(),p(),M(),i(),w(),Nn=(e,t)=>t.find(({value:t})=>e===t),Pn=(e,t,n)=>{let r=Nn(t,n);return r?r.text:e},Fn=(e,t,n,r)=>Pn(e,j(t,n),r),In=({valuePath:e},t,n)=>Nn(j(t,e),n),Ln=e=>t=>{e(e=>({...e,filter:t?.[0]?.value??null}))},Rn=e=>t=>{e(e=>({...e,headerFocused:t}))},zn=e=>t=>{e(e=>({...e,query:t}))},Bn=e=>t=>e(t?.[0]?.value),Vn=({valuePath:e,trueLabel:t,falseLabel:n},r)=>j(r,e)?t:n,Hn=({valuePath:e},t)=>n=>j(n,e)===t,Un=se((e,t)=>[{text:e,value:!0},{text:t,value:!1}]),Wn=({valuePath:e,trueLabel:t,falseLabel:n},r)=>e?j(r,e)?t:n:``,Gn=(e,t)=>{try{return JSON.parse(t)}catch{return null}},Kn=class extends F(D){static get properties(){return{trueLabel:{type:String,value:`True`},falseLabel:{type:String,value:`False`},flex:{type:String,value:`0`},cellClass:{type:String,value:`boolean-cell`}}}getString(e,t){return Vn(e,t)}renderCell(e,{item:t}){return Vn(e,t)}renderEditCell(e,{item:n},r){let{trueLabel:i,falseLabel:a}=e;return t`<cosmoz-autocomplete
			no-label-float
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return ln(e,t)}},customElements.define(`cosmoz-omnitable-column-date`,fr)})),mr,hr=e((()=>{O(),o(),i(),w(),Yn(),kt(),Dt(),Pt(),mr=class extends Jn(Nt(D)){render(){let e=e=>{this.headerFocused=e.type===`focus`};return t`
			<style>
		...
		></cosmoz-omnitable-datetime-range-input>`}computeSource(e,t){return ln(e,t)}},customElements.define(Cr.is,Cr)})),Tr,Er=e((()=>{Oe(),Ae(),O(),i(),w(),Tn(),I(),Tr=class extends wn(F(D)){renderCell({valuePath:e,textProperty:n},{item:r}){return t`
			<style>
				ul {
					padding: 0;
					display: inline;
...
`,Or=({items:e})=>{let[n,r]=f(!1),i=Array.isArray(e)?e:[],o=g(()=>Math.max(0,i.length-1),[i]);if(i.length===0)return null;let s=i.length>2,c=i[0],l=s&&!n?[]:i.slice(1),u=e=>{e.stopPropagation(),e.preventDefault(),r(e=>!e)};return t`
	...
	`},customElements.define(`cosmoz-omnitable-column-list-data`,N(Or,{styleSheets:[me(Dr)]}))})),Ar,jr=e((()=>{kr(),O(),i(),w(),Oe(),Tn(),I(),sn(),Ar=class extends wn(F(D)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:n},{item:r}){return t`<cosmoz-omnitable-column-list-data
		...
		></cosmoz-input>`}renderHeader(e,{filter:n,query:r},i,a){return t`<cosmoz-autocomplete-ui
			...
			.onText=${xn(i)}
			>${v(e.loading,()=>t`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}},customElements.define(`cosmoz-omnitable-column-list`,Ar)})),Mr,Nr=e((()=>{x(),O(),o(),i(),w(),kt(),Dt(),Mt(),Pt(),Mr=class extends jt(Nt(D)){static get properties(){return{maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null},formatter:{type:Object,computed:`_computeFormatter(locale, minimumFractionDigits, maximumFractionDigits)`},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:`_computeFilterText(filter.*, formatter)`},headerFocused:{type:Boolean,value:!1}}}render(){let e=e=>{this.headerFocused=e.type===`focus`,this._onDropdownOpenedChanged(e)};return t`
			<style>
				cosmoz-input[type='number'] {
					background: var(--cosmoz-omnitable-amount-input-background, #ffffff);
					border-radius: 6px;
		...
		></cosmoz-omnitable-number-range-input>`}computeSource(e,t){return ln(e,t)}},customElements.define(`cosmoz-omnitable-column-number`,Pr)})),Ir,Lr=e((()=>{x(),O(),o(),i(),w(),Yn(),kt(),Dt(),Pt(),Ir=class extends Jn(Nt(D)){render(){let e=e=>{this.headerFocused=e.type===`focus`};return t`
			${v(this.disabled,()=>t`
					<cosmoz-omnitable-dropdown-input
						disabled
						.label=${this.title}
...
`}));function di(e,t,{suffix:n=``,read:r,write:i,ready:a=!0,multi:o}={}){let s=we({param:t,suffix:n,link:o?hi:mi,write:i??ye}),c=g(()=>{if(t==null)return!1;if(o){let e=$e(t+n);return Object.keys(e).length>0}return Ce(t+n)!==void 0},[]),[l,u]=f(()=>{if(t==null)return e;if(o){let i=$e(t+n,r);return Object.keys(i).length>0?i:e}return Ce(t+n,r)??e}),d=E(e=>u(t=>{let n=Xe(e,t);return s.param!=null&&Ge(s.link(s.param+s.suffix,n,s.write),null,{notify:!1}),n}),[]);return C(()=>{s.param==null||!a||c||e!=null&&d(e)},[a]),[l,d]}var fi,pi,mi,hi,gi=e((()=>{Ee(),We(),et(),Re(),k(),fi=e=>(t,n,r=ye)=>{let i=xe(),a=new URLSearchParams(i.hash.replace(`#`,``));return e(t,n,r,a),`#!`+Object.assign(i,{hash:a}).href.replace(location.origin,``)},pi=e=>e==null||e===``,mi=fi((e,t,n,r)=>pi(n(t))?r.delete(e):r.set(e,n(t))),hi=fi((e,t,n,r)=>{let i=Object.entries(t),a=i.map(n).filter(([,e])=>e!==void 0);if(a.length===0&&i.length>0)return;let o=e;Array.from(r.keys()).filter(e=>e.startsWith(o)).forEach(e=>r.delete(e)),a.forEach(([t,n])=>pi(n)?r.delete(e+t):r.set(e+t,n))})})),_i,vi,yi,bi,xi,Si=e((()=>{k(),gi(),_i=e=>[!0,`true`,1,`yes`,`on`].includes(e),vi=e=>e===``||(e==null?void 0:_i(e)),yi=(e,t,n)=>E(r=>{e(r),n(e=>({...e,[t]:r}))},[e,t,n]),bi=(e,t,{settings:n,setSettings:r,resetRef:i,ready:a=!0})=>{let[o,s]=di(n.sortOn,t,{suffix:`-sortOn`,ready:a}),[c,l]=di(vi(n.descending),t,{suffix:`-descending`,read:vi,ready:a}),[u,d]=di(n.groupOn,t,{suffix:`-groupOn`,ready:a}),[f,p]=di(vi(n.groupOnDescending),t,{suffix:`-groupOnDescending`,read:vi,ready:a}),m=g(()=>e.find(e=>e.name===o),[e,o]),h=g(()=>e.find(e=>e.name===u),[e,u]),_={groupOn:u,setGroupOn:yi(d,`groupOn`,r),groupOnDescending:f,setGroupOnDescending:yi(p,`groupOnDescending`,r),sortOn:o,setSortOn:yi(s,`sortOn`,r),descending:c,setDescending:yi(l,`descending`,r),columns:e},v=g(()=>_,Object.values(_)),y=E(e=>{s(e.sortOn),d(e.groupOn),l(e.descending),p(e.groupOnDescending)},[]);return C(()=>void(i.current=y),[]),{...v,sortAndGroup:v,groupOnColumn:h,sortOnColumn:m}},xi=st(),customElements.define(`sort-and-group-provider`,xi.Provider),customElements.define(`sort-and-group-consumer`,N(({render:e})=>e(m(xi)),{useShadowDOM:!1}))})),Ci,wi,Ti=e((()=>{k(),h(),ei(),ui(),w(),Si(),Ci=({data:e,columns:n,groupOnColumn:r,filters:i,setFilterState:a,sortAndGroup:{sortOn:o,setSortOn:s,descending:c,setDescending:l}={}})=>fe(n,e=>e.name,n=>[t`<div
...
`,customElements.define(`cosmoz-omnitable-item-expand-line`,N(Di,{styleSheets:[me(Ei)]}))})),ki,Ai=e((()=>{k(),i(),Ue(),Oi(),ki=({columns:e,item:n,selected:r,expanded:i,groupOnColumn:a})=>Ye(e,e=>t`<cosmoz-omnitable-item-expand-line
				.column=${e}
				?hidden=${e===a}
				exportparts="item-expand-label, item-expand-value"
				>${e.renderCell(e,{item:n,selected:r,expanded:i})}</cosmoz-omnitable-item-expand-line
			>`),customElements.define(`cosmoz-omnitable-item-expand`,N(ki,{useShadowDOM:!1}))})),ji,Mi,Ni=e((()=>{k(),h(),ji=(e,t,n)=>e.editable?e.renderEditCell(e,t,n(e,t.item)):e.renderCell(e,t),Mi=({columns:e,groupOnColumn:n,item:r,index:i,selected:a,expanded:o,onItemChange:s})=>fe(e,e=>e.name,e=>t`<div
...
`);i.unshift(r),ve(new File(i,n,{type:`text/csv;charset=utf-8`}))}})),Bi,Vi,Hi=e((()=>{He(),Me(),Bi=(e,t)=>{let n=e.map(e=>e.title),r=t.map(t=>e.map(e=>e.toXlsxValue(e,t)??``));return r.unshift(n),r},Vi=(e,t,n,r)=>{let i=Bi(e,t),a=new Je(n).addSheetFromData(i,r).generate();ve(new File([a],n,{type:`application/vnd.openxmlformats-officedocument.spreadsheetml.sheet`}))}})),Ui,Wi=e((()=>{S(),o(),i(),zi(),Hi(),Ui=({columns:e,selectedItems:n,csvFilename:r,xlsxFilename:i,xlsxSheetname:o,topPlacement:s})=>t`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!qe(n.length)}
		part="bottomBar"
	...
	</cosmoz-bottom-bar>`})),Gi,Ki=e((()=>{i(),w(),Gi=({allSelected:e,onAllCheckboxChange:n,sortAndGroup:r,dataIsValid:i,data:a,columns:o,filters:s,groupOnColumn:c,setFilterState:l,settingsConfig:u,hideSelectAll:d})=>t`<sort-and-group-provider .value=${r}>
...
`,Ji=({settingsConfig:e})=>{let{columns:n,collapsed:r}=e,i=n.filter(e=>!r.some(t=>t.name===e.name));return t`<div class="skeleton">
	...
	</div>`},customElements.define(`cosmoz-omnitable-skeleton`,N(Ji,{styleSheets:[qi]}))})),Xi,Zi=e((()=>{k(),Yi(),l(),o(),i(),w(),Xi=(e,n)=>{let{settingsConfig:r}=e,{processedItems:i,dataIsValid:o,filterIsTooStrict:s,loading:c,displayEmptyGroups:l,compareItemsFn:u,selectedItems:d,setSelectedItems:f,renderItem:p,renderGroup:m,error:h}=n;return t`${v(!c&&!o&&!h,()=>t`<div class="tableContent-empty">
...
`})),ta,na,ra=e((()=>{et(),k(),ta=e=>{let t=parseInt(e,10);return isFinite(t)?t:void 0},na=e=>{let{config:t}=e,{settings:n,setSettings:r,collapsed:i,requestTween:a}=t,o=we({collapsed:i,settings:n.columns,requestTween:a,setSettings:E(e=>r(t=>({...t,columns:e})),[r])});return{...t,onDown:E(e=>{e.target.closest(`.pull`)&&(o.handle=e.currentTarget)},[o]),onDragStart:E(e=>{let{target:t}=e,n=ta(t.dataset.index);if(!o.handle?.contains(t)||n==null)return e.preventDefault();o.handle=null,e.dataTransfer.effectAllowed=`move`,e.dataTransfer.setData(`omnitable/sort-index`,n),e.dataTransfer.setData(`text/plain`,n),setTimeout(()=>t.classList.add(`drag`),0),t.addEventListener(`dragend`,e=>e.target.classList.remove(`drag`),{once:!0})},[o]),onDragEnter:E(e=>{let t=e.currentTarget;t===e.target&&(e.preventDefault(),e.dataTransfer.dropEffect=`move`,t.classList.add(`dragover`))},[]),onDragOver:E(e=>{e.preventDefault(),e.currentTarget.classList.add(`dragover`)},[]),onDragLeave:E(e=>{let t=e.currentTarget;t.contains(e.relatedTarget)||t.classList.remove(`dragover`)},[]),onDrop:E(e=>{let t=ta(e.dataTransfer.getData(`omnitable/sort-index`)),n=ta(e.currentTarget.dataset.index),{settings:r,setSettings:i,requestTween:a}=o;e.currentTarget.classList.remove(`dragover`),e.preventDefault();let s=r.slice();s.splice(n+(t>=n?0:-1),0,s.splice(t,1)[0]),a?.(),i(s)},[o]),onToggle:E(e=>{let{settings:t,setSettings:n,requestTween:r}=o,i=t.map(e=>({...e,disabled:e.disabled||o.collapsed?.some(t=>t.name===e.name)})),a=ta(e.target.closest(`[data-index]`)?.dataset.index);i.splice(a,1,{...t[a],disabled:!e.target.checked,priority:e.target.checked?t.reduce((e,t)=>Math.max(e,t.priority),0)+1:t[a].priority}),r?.(),n(i)},[o])}}})),ia,aa,oa,sa,ca=e((()=>{Ze(),Ke(),u(),S(),k(),o(),w(),ai(),ui(),ea(),ra(),ia=[Ve({apply({availableHeight:e,elements:t}){Object.assign(t.floating.style,{maxHeight:`${Math.max(0,e)}px`})}}),...De],aa=({onDragStart:e,onDragEnter:n,onDragOver:r,onDragLeave:i,onDrop:a,onDown:o,onToggle:s,collapsed:c,filters:l})=>(u,d)=>{let f=!!c?.find(e=>e.name===u.name),p=!u.disabled&&!f;return t` <div
			class="item"
			data-index=${d}
			@mousedown=${o}
			draggable="true"
		...
		${v(r,()=>t`<div class="buttons">
				...
				</div>`)}`},customElements.define(`cosmoz-omnitable-settings-ui`,N(oa,{styleSheets:[me(Qi)]})),sa=({config:e,newLayout:n})=>t`
	<cosmoz-dropdown
