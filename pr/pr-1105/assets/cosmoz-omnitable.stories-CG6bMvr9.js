import{e as c,D as He,t as S,A as Ge}from"./iframe-Cs3nlxcs.js";import{t as G,c as O,g as A,n as k,P as I,s as ln,a as Ft,r as sn,e as un,D as cn,b as dn,d as mn,i as Fe,h as kt,m as pn,u as V,f as Et,j as _t,k as gn,l as Y,p as N,o as je,q as It,v as ke,w as bn,x as Ee,y as E,z as M,A as lt,B as _e,C as Mt,E as st,F as ut,G as z,H as fn,I as hn,J as Ot,K as Ke,L as Lt,M as xn,N as Dt,O as yn,Q as ct,R as vn,S as $n,T as Cn,U as Tt,V as We,W as Je,X as wn,Y as Vt,Z as Ue,_ as W,$ as zn,a0 as Sn}from"./cosmoz-collapse-DnU7KUvW.js";import"./preload-helper-PPVm8Dsz.js";const An=G`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,Pn=n=>{const{label:e,value:t,slot:i}=n,a=c`<div
	...
	`},Rt=n=>n?typeof n.close=="function"?n:Rt(n.parentElement):null,Xe=n=>class extends n{static get properties(){return{disabled:{type:Boolean,value:!1},filter:{type:Object,notify:!0},values:{type:Array,value(){return[]}},headerFocused:{type:Boolean,notify:!0},min:{type:Number,value:null},max:{type:Number,value:null},limits:{type:Function},autoupdate:{type:String,value:!0},locale:{type:String,value:null},align:{type:String,value:"left"},_filterInput:{type:Object,value(){return{min:null,max:null}}},_range:{type:Object,computed:"_computeRange(values.*)"},_limit:{type:Object,computed:"_computeLimit(_range, _filterInput.*, min, max)",value(){return{}}},_tooltip:{type:String,computed:"_computeTooltip(title, _filterText)"},_fromClasses:{type:String,computed:"_computeInputClasses(_filterInput.min)"},_toClasses:{type:String,computed:"_computeInputClasses(_filterInput.max)"}}}static get observers(){return["_filterInputChanged(_filterInput.*, autoupdate)","_filterChanged(filter.*)","_updateLimits(limits, headerFocused)"]}disconnectedCallback(){this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),super.disconnectedCallback()}_computeInputClasses(e){return e!=null&&e!==""?"has-value":""}toNumber(e,t,i){if(e==null||e==="")return;const a=typeof e=="number"?e:Number(e);if(Number.isNaN(a))return;if(i==null||t==null)return a;const o=this.toNumber(t);return o==null?a:i(a,o)}toValue(){return this.toNumber.apply(this,arguments)}getComparableValue(e,t){if(e==null)return;let i=e;return t!=null&&(i=this.get(t,e)),this.toValue(i)}renderValue(){}getInputString(e,t=this.valuePath){const i=this.toValue(this.get(t,e));return this._toInputString(i)}_computeRange(e){const t=e.base,i=Array.isArray(t)&&t.length&&t.map(a=>this.toValue(a)).filter(a=>a!=null);return!i||i.length<1?{min:null,max:null}:i.reduce((a,o)=>({min:this.toValue(o,a.min,Math.min),max:this.toValue(o,a.max,Math.max)}),{})}_computeLimit(e,t,i,a){if(!e)return;const o=t.base,r=this.toValue(i),l=this.toValue(a),s=r??this.toValue(e.min),u=l??this.toValue(e.max);return{fromMin:s,fromMax:this.toValue(u,this._fromInputString(o.max,"max"),Math.min),toMin:this.toValue(s,this._fromInputString(o.min,"min"),Math.max),toMax:u}}_computeFilterText(e){if(e.base==null)return;const t=e.base,i=this.toValue(t.min),a=this.toValue(t.max),o=[];return i!=null&&o.push(this.renderValue(i)),o.push(" - "),a!=null&&o.push(this.renderValue(a)),o.length>1?o.join(""):void 0}_computeTooltip(e,t){return t==null?e:`${e}: ${t}`}_fromInputString(e){return this.toValue(e)}_toInputString(e){const t=this.toValue(e);return t??null}_getDefaultFilter(){return{min:null,max:null}}_filterInputChanged(e,t){const i=e.path.split(".")[1];this.__inputChangePath=i||null,t&&(this._limitInputDebouncer=cn.debounce(this._limitInputDebouncer,dn.after(600),()=>{this._limitInput(),this._updateFilter()}),mn(this._limitInputDebouncer))}_clearFrom(){this.set("_filterInput.min",null),this._updateFilter()}_clearTo(){this.set("_filterInput.max",null),this._updateFilter()}_onBlur(){this._limitInput(),this._updateFilter()}_onKeyDown(e){const t=e.currentTarget,i=Array.from(t.parentElement.querySelectorAll("cosmoz-input")),a=i[i.findIndex(l=>l===t)+1],o=!a,r=i[0]===t;switch(e.keyCode){case 13:if(e.preventDefault(),!o)a.focus();else{const l=this._limitInput();this._updateFilter(),l||this._closeParent(t)}break;case 9:(o&&!e.shiftKey||r&&e.shiftKey)&&this._closeParent(t)}}_closeParent(e){const t=Rt(e);t&&t.close()}_onDropdownOpenedChanged({currentTarget:e,type:t,detail:i}){(t==="focus"||i?.value===!0)&&setTimeout(()=>{e.querySelector("cosmoz-input:focus")||e.querySelector("cosmoz-input")?.focus()},100)}_limitInput(){const e=this._filterInput,t=this.__inputChangePath,i=t?this._fromInputString(this.get(t,e),t):null;if(this.__inputChangePath=null,i==null)return!1;const a=this._limit,o=t==="min"?"from":"to",r=this.get(o+"Min",a),l=this.get(o+"Max",a),s=this.toValue(i,r,Math.max),u=this.toValue(s,l,Math.min);return this.getComparableValue(i)!==this.getComparableValue(u)?(this.set(["_filterInput",t],this._toInputString(u,t)),this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),!0):!1}_updateFilter(){const e=this._filterInput,t=this.filter,i=this._fromInputString(e.min,"min"),a=this._fromInputString(e.max,"max");this.getComparableValue(i)===this.getComparableValue(t,"min")&&this.getComparableValue(a)===this.getComparableValue(t,"max")||this.set("filter",{min:i,max:a})}_filterChanged(e){if(this._filterInput==null)return;const t=this._filterInput,i=e.base,a=this._fromInputString(t.min,"min"),o=this._fromInputString(t.max,"max");this.getComparableValue(a)===this.getComparableValue(i,"min")&&this.getComparableValue(o)===this.getComparableValue(i,"max")||(this.set("_filterInput",{min:this._toInputString(i.min),max:this._toInputString(i.max)}),this._limitInputDebouncer&&this._limitInputDebouncer.cancel())}hasFilter(){const e=this.filter;return e==null?!1:this.toValue(e.min)!=null||this.toValue(e.max)!=null}resetFilter(){this.filter=this._getDefaultFilter()}_updateLimits(e,t){e&&Promise.resolve(Fe(e,{active:t})).then(i=>{const{min:a,max:o}=i??{};Object.assign(this,{...a!=null?{min:a}:{},...o!=null?{max:o}:{}})})}},me=n=>class extends n{static get template(){return kt`<div id="output" style="position:relative;"></div>`}connectedCallback(){super.connectedCallback();const e=this;He(e.render(),e.$.output)}_propertiesChanged(e,t,i){super._propertiesChanged(e,t,i);const a=this;requestAnimationFrame(()=>He(a.render(),a.$.output))}};class Bn extends Xe(me(I)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return c`
		...
		</cosmoz-input>`}renderHeader({title:e,min:t,max:i,limits:a,locale:o,rates:r,currency:l,autoupdate:s,autodetect:u,disabledFiltering:d,headerAlign:m,align:b},{filter:p},f,$){return c`<cosmoz-omnitable-amount-range-input
			.title=${e}
			?disabled=${d}
			.filter=${p}
			.values=${$}
		...
		`}_toInputString(e){const t=this.toValue(e);if(t!=null)return this._toLocalISOString(t).slice(0,19)}_computeFormatter(e){const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return new Intl.DateTimeFormat(e||void 0,t)}}customElements.define("cosmoz-omnitable-datetime-range-input",_i);const he={},Ii=n=>{const e=n||"";if(he[e])return he[e];const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return he[e]=new Intl.DateTimeFormat(n||void 0,t),he[e]},Ve=({valuePath:n,locale:e},t)=>{const i=_(A(t,n||""));return i===void 0?"":i===null?"Invalid Date":nt(i,Ii(e))},Mi=({valuePath:n},e)=>n?A(e,n):"",vt=n=>{const e=_(n);return e==null?"":e.toISOString().slice(0,19).replace(/:/gu,".")},$t=n=>{if(!(n==null||n==="")&&typeof n=="string")return _(n.replace(/\./gu,":")+"Z")};class Ct extends T(I){static get is(){return"cosmoz-omnitable-column-datetime"}static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"datetime-header-cell"},width:{type:String,value:"210px"},minWidth:{type:String,value:"128px"},flex:{type:String,value:"0"},filterStep:{type:Number,value:1}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const i=R({...e,valuePath:"min"},t),a=R({...e,valuePath:"max"},t);if(!(i==null&&a==null))return Wt(e,t)}getString(e,t){return Ve(e,t)}toXlsxValue(e,t){return Mi(e,t)}getComparableValue(e,t){return R(e,t)}serializeFilter(e,t){if(t==null)return;const i=_(t.min),a=_(t.max);if(!(i==null&&a==null))return vt(i)+"~"+vt(a)}deserializeFilter(e,t){if(typeof t!="string"||t==="")return null;const i=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(i)?{min:$t(i[1]),max:$t(i[2])}:null}renderCell(e,{item:t}){return Ve(e,t)}renderEditCell(e,{item:t},i){return c`<cosmoz-input
			...
			@change=${o=>i(jt(o.target.value))}
			.value=${Ve(e,t)}
		></cosmoz-input>`}renderHeader({title:e,min:t,max:i,limits:a,locale:o,filterStep:r,disabledFiltering:l,headerAlign:s,align:u},{filter:d},m,b){return c`<cosmoz-omnitable-datetime-range-input
			.title=${e}
			?disabled=${l}
			.filter=${d}
			.values=${b}
...
`,Di=({items:n})=>{const[e,t]=V(!1),i=Array.isArray(n)?n:[],a=E(()=>Math.max(0,i.length-1),[i]);if(i.length===0)return null;const o=i.length>2,r=i[0],l=o&&!e?[]:i.slice(1),s=u=>{u.stopPropagation(),u.preventDefault(),t(d=>!d)};return c`
	...
	`};customElements.define("cosmoz-omnitable-column-list-data",O(Di,{styleSheets:[Ee(Li)]}));class Ti extends Le(T(I)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:i}){return c`<cosmoz-omnitable-column-list-data
		...
		`}_computeFormatter(e,t,i){const a={localeMatcher:"best fit"};return t!==null&&(a.minimumFractionDigits=t),i!==null&&(a.maximumFractionDigits=i),new Intl.NumberFormat(e||void 0,a)}getComparableValue(e,t){if(e==null)return;let i=e;if(t!=null&&(i=this.get(t,e)),i=this.toValue(i),i==null)return;const a=this.maximumFractionDigits;return a!==null?this.toValue(i.toFixed(a)):i}renderValue(e,t=this.formatter){const i=this.toNumber(e);if(i!=null)return t.format(i)}}customElements.define("cosmoz-omnitable-number-range-input",Vi);class Ri extends T(I){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},autoupdate:{type:Boolean,value:!1,notify:!0},cellClass:{type:String,value:"number-cell"},width:{type:String,value:"30px"},minWidth:{type:String,value:"30px"},headerCellClass:{type:String,value:"number-header-cell"},maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null},align:{type:String,value:"right"}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const i=J({...e,valuePath:"min"},t),a=J({...e,valuePath:"max"},t);if(!(i==null&&a==null))return jn(e,t)}getString(e,t){return mt(e,t)}toXlsxValue({valuePath:e},t){return A(t,e)}getComparableValue(e,t){return J(e,t)}serializeFilter(e,t){if(t==null)return;const i=L(t.min),a=L(t.max);if(!(i==null&&a==null))return dt(i)+"~"+dt(a)}deserializeFilter(e,t){if(typeof t!="string"||t==="")return null;const i=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(i)?{min:L(i[1]),max:L(i[2])}:null}renderCell(e,{item:t}){return c`<div class="omnitable-cell-number">
			...
			@change=${o=>i(o.target.value)}
			.value=${Hn(e,t)}
		></cosmoz-input>`}renderHeader({title:e,min:t,max:i,limits:a,locale:o,maximumFractionDigits:r,minimumFractionDigits:l,autoupdate:s,disabledFiltering:u,headerAlign:d,align:m},{filter:b},p,f){return c`<cosmoz-omnitable-number-range-input
			.title=${e}
			?disabled=${u}
			.filter=${b}
			.values=${f}
...
`,xa=({settingsConfig:n})=>{const{columns:e,collapsed:t}=n,i=e.filter(a=>!t.some(o=>o.name===a.name));return c`<div class="skeleton">
	...
	</div>`};customElements.define("cosmoz-omnitable-skeleton",O(xa,{styleSheets:[ha]}));const ya=(n,e)=>{const{settingsConfig:t}=n,{processedItems:i,dataIsValid:a,filterIsTooStrict:o,loading:r,displayEmptyGroups:l,compareItemsFn:s,selectedItems:u,setSelectedItems:d,renderItem:m,renderGroup:b,error:p}=e;return c`${k(!r&&!a&&!p,()=>c`<div class="tableContent-empty">
...
`,to=n=>n?"groupRow groupRow-folded":"groupRow",no=({item:n,index:e})=>t=>k((t?.length??0)>0,()=>c`
			...
			`),io=({columns:n,collapsedColumns:e,miniColumns:t,onItemClick:i,onCheckboxChange:a,dataIsValid:o,groupOnColumn:r,onItemChange:l,rowPartFn:s})=>(u,d,{selected:m,expanded:b,toggleCollapse:p})=>c`
		<div
			?selected=${m}
	...
	`,ao=({onCheckboxChange:n,dataIsValid:e,groupOnColumn:t})=>(i,a,{selected:o,folded:r,toggleFold:l})=>c` <div
		...
		</div>`,oo=({host:n,error:e,dataIsValid:t,processedItems:i,columns:a,collapsedColumns:o,miniColumns:r,sortAndGroupOptions:l,rowPartFn:s,...u})=>{const{loading:d=!1,displayEmptyGroups:m=!1,compareItemsFn:b}=n,p=Je({shiftKey:!1,ctrlKey:!1}),f=z(w=>{if(!Za(w.target))return;const y=w.target,g=y.dataItem,x=y.checked,v=n.shadowRoot.querySelector("#groupedList");p.current.shiftKey?v.toggleSelectTo(g,x):p.current.ctrlKey?(y.checked=!0,v.selectOnly(g)):v.toggleSelect(g,x),w.preventDefault(),w.stopPropagation()},[]);M(()=>{const w=({shiftKey:y,ctrlKey:g})=>{p.current={shiftKey:y,ctrlKey:g}};return window.addEventListener("keydown",w),window.addEventListener("keyup",w),()=>{window.removeEventListener("keydown",w),window.removeEventListener("keyup",w)}},[]);const $=z(w=>{if(!eo(w.currentTarget))return;const y=w.currentTarget,g=w.composedPath();g.slice(0,g.indexOf(y)).some(v=>v instanceof Element&&v.matches("a, .checkbox, .expand"))||n.dispatchEvent(new window.CustomEvent("omnitable-item-click",{bubbles:!0,composed:!0,detail:{item:y.dataItem,index:y.dataIndex}}))},[]),{groupOnColumn:C}=l,h=z((w,y)=>g=>ii(n,w,y,g),[]);return{...u,processedItems:i,dataIsValid:t,filterIsTooStrict:t&&i.length<1,loading:d,compareItemsFn:b,displayEmptyGroups:m,error:e,renderItem:E(()=>io({columns:a,collapsedColumns:o,miniColumns:r,onItemClick:$,onCheckboxChange:f,dataIsValid:t,groupOnColumn:C,onItemChange:h,rowPartFn:s}),[a,o,$,f,t,C,h,s]),renderGroup:E(()=>ao({onCheckboxChange:f,dataIsValid:t,groupOnColumn:C}),[f,t,C])}},ro=(n,e)=>{if(n===e)return 0;if(n==null)return-1;if(e==null)return 1;const t=typeof n,i=typeof e;return t==="object"&&i==="object"?n.toString()<e.toString()?-1:1:t==="number"&&i==="number"?n-e:t==="string"&&i==="string"?n<e?-1:1:t==="boolean"&&i==="boolean"?n?-1:1:(console.warn("unsupported sort",t,n,i,e),0)},Ne=(n,e)=>(t,i)=>ro(n(t),n(i))*(e?-1:1),lo=n=>n.replace(/([a-z0-9])([A-Z])/gu,"$1-$2").toLowerCase(),qt=(n,e)=>{!n||!e||Object.entries(e).forEach(([t,i])=>{const a=n[Z];a.__ownChange=!0,Object.assign(a,{[t]:i}),a.__ownChange=!1,a.dispatchEvent(new CustomEvent(`${lo(t)}-changed`,{bubbles:!0,detail:{value:i}}))})},Pe=(n,e)=>Object.assign(n,{[ze]:e}),Be=Symbol("unparsed"),so=({data:n,columns:e,hashParam:t,sortAndGroupOptions:i,noLocalSort:a,noLocalFilter:o})=>{const{groupOnColumn:r,groupOnDescending:l,sortOnColumn:s,descending:u}=i,d=z(([g,x])=>{const v=e.find(({name:q})=>q===g);return v==null?[g,void 0]:[g,x.filter&&v.serializeFilter(v,x.filter)]},[e]),m=z(([g,x])=>{const v=e.find(({name:F})=>F===g);if(v==null)return[g,{[Be]:x}];const q={filter:v.deserializeFilter(v,x)};return qt(v,q),[g,q]},[e]),[b,p]=te({},t,{multi:!0,suffix:"-filter--",write:d,read:m}),f=z((g,x)=>p(v=>{const q=Fe(x,v[g]);return qt(e.find(F=>F.name===g),q),{...v,[g]:{...v[g],...q}}}),[e,p]),$=E(()=>Object.values(b).map(g=>g.filter),[b]),C=E(()=>Object.fromEntries(e.map(g=>[g.name,!g.noLocalFilter&&g.getFilterFn(g,b[g.name]?.filter)]).filter(g=>!!g[1])),[e,...$]),h=E(()=>!Array.isArray(n)||n.length===0?[]:Object.entries(C).length===0||o?n.slice():n.filter(g=>Object.values(C).every(x=>x(g))),[n,C,o]),w=E(()=>{if(!a&&!r&&s!=null&&s.sortOn!=null)return h.slice().sort(Ne(g=>s.getComparableValue({...s,valuePath:s.sortOn},g),u));if(r!=null&&r.groupOn!=null){const g=h.reduce((x,v)=>{const q=r.getComparableValue({...r,valuePath:r.groupOn},v);if(q===void 0)return x;let F=x.find(j=>j.id===q);return F?(F.items.push(v),x):(F={id:q,name:q,items:[v]},[...x,F])},[]);return g.sort(Ne(x=>r.getComparableValue({...r,valuePath:r.groupOn},x.items[0]),l)),!s||a?g:g.filter(x=>Array.isArray(x.items)).map(x=>(x.items.sort(Ne(v=>s.getComparableValue({...s,valuePath:s.sortOn},v),u)),x))}return h},[h,r,l,s,u,a]),y=E(()=>{let g=0,x=0;const v=[];return w.forEach(q=>{if("items"in q&&Array.isArray(q.items)){Pe(q,x++),q.items.forEach(F=>{Pe(F,g++),v.push(F)});return}return Pe(q,g++),v.push(q)},[]),v},[w]);return M(()=>{p(g=>Object.values(g).some(v=>v[Be]!=null)?Object.fromEntries(Object.entries(g).map(([v,q])=>{const F=q[Be];return F==null?[v,q]:m([v,F])})):g)},[m]),{processedItems:w,visibleData:y,filters:b,filterFunctions:C,setFilterState:f}},uo=n=>{const e=i=>{const a=n.data.indexOf(i);if(a<0)return null;const o=n.data.splice(a,1);if(n.data=n.data.slice(),Array.isArray(o)&&o.length>0)return o[0]},t=(i,a)=>{n.data.splice(i,1,a),n.data=n.data.slice()};return{removeItem:e,removeItems(i){const a=[];for(let o=i.length-1;o>=0;o-=1){const r=e(i[o]);r!=null&&a.push(r)}return a},replaceItemAtIndex:t,replaceItem(i,a){const o=n.data.indexOf(i);o>-1&&t(o,a)},selectItem(i){n.shadowRoot.querySelector("#groupedList").select(i)},selectAll(){n.shadowRoot.querySelector("#groupedList").selectAll()},deselectAll(){n.shadowRoot.querySelector("#groupedList").deselectAll()},deselectItem(i){n.shadowRoot.querySelector("#groupedList").deselect(i)},isItemSelected(i){return n.shadowRoot.querySelector("#groupedList").isItemSelected(i)}}},co=({host:n,visibleData:e,filters:t,...i})=>{const{setFilterState:a}=i,o=E(()=>uo(n),[]),[r,l]=Vt("selectedItems",[]);Ue(i,Object.values(i)),Ue(o,Object.values(o)),M(()=>{const u=d=>{if(!(d instanceof CustomEvent))return;const m=d.detail;a(m.name,b=>({...typeof b=="object"&&b!==null?b:{},...m.state}))};return n.addEventListener("legacy-filter-changed",u),()=>n.removeEventListener("legacy-filter-changed",u)},[]),W("visibleData",e),W("sortedFilteredGroupedItems",i.sortedFilteredGroupedItems),W("sortOn",i.sortOn),W("descending",i.descending),W("isMini",i.isMini);const s=E(()=>Object.fromEntries(Object.entries(t).filter(([,{filter:u}])=>u!==void 0).map(([u,{filter:d}])=>[u,d])),[t]);return W("filters",s,Object.values(s)),{selectedItems:r,setSelectedItems:l}},mo=n=>{const{hashParam:e,settingsId:t,data:i,resizeSpeedFactor:a,noLocal:o,noLocalSort:r=o,noLocalFilter:l=o,error:s,rowPartFn:u}=n,d=Oa({settingsId:t,host:n}),{settings:m,setSettings:b,columns:p,resetRef:f,savedSettings:$}=d,C=$!==void 0,h=na(p,e,{settings:m,setSettings:b,resetRef:f,ready:C}),{processedItems:w,visibleData:y,filters:g,setFilterState:x,filterFunctions:v}=so({data:i,columns:p,hashParam:e,sortAndGroupOptions:h,noLocalSort:r,noLocalFilter:l}),{isMini:q,collapsedColumns:F,miniColumns:j,requestTween:B}=Xa({host:n,columns:p,settings:m,setSettings:b,resizeSpeedFactor:a,sortAndGroupOptions:h}),at=i&&Array.isArray(i)&&i.length>0,{selectedItems:Te,setSelectedItems:ot}=co({host:n,visibleData:y,sortedFilteredGroupedItems:w,columns:p,filters:g,setFilterState:x,isMini:q,...h}),rt=Ya({host:n,selectedItems:Te,sortAndGroupOptions:h,dataIsValid:at,data:i,columns:p,filters:g,collapsedColumns:F,settings:m,filterFunctions:v,settingS:d,setFilterState:x,hideSelectAll:n.hideSelectAll===!0,requestTween:B});return{header:rt,list:oo({host:n,error:s,dataIsValid:at,processedItems:w,selectedItems:Te,setSelectedItems:ot,columns:p,collapsedColumns:F,miniColumns:j,sortAndGroupOptions:h,rowPartFn:u}),footer:Qa({host:n,selectedItems:Te,allSelected:rt.allSelected,setSelectedItems:ot,columns:p,enableSelectAll:n.enableSelectAll,allItemsCount:n.allItemsCount})}};customElements.define("cosmoz-grouped-list-row",class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||He(this._renderFn(this._item,this._index),this)}});const po={group:Symbol("group")},De=(n,e)=>(e.has(n)||e.set(n,{}),e.get(n)),go=(n,e)=>!!De(n,e).expanded,bo=(n,e)=>!!De(n,e).folded,Ae=n=>n?n.items instanceof Array:!1,fo=n=>{if(!Array.isArray(n)||n.length===0)return;const e=Array.isArray(n[0]?.items);if(!n.every(i=>Array.isArray(i.items)===e))throw new Error("Data must be homogeneous.")},ho=(n,e,t)=>Array.isArray(n)?(fo(n),n.reduce((a,o)=>{const r=o;return r.items?r.items.length?De(o,t).folded?a.concat(o):a.concat(o,r.items.map(l=>Object.assign(l,{[po.group]:o}))):e?a.concat(o):a:a.concat(o)},[])):void 0,xo=(n,...e)=>typeof n=="function"?n(...e):n,yo=(n,e)=>n===e,vo=()=>{const[n,e]=V(()=>[new WeakMap]);return{setItemState:z((i,a)=>e(([o])=>{const r=De(i,o);return Object.assign(r,xo(a,r)),[o]}),[]),state:n[0],signal:n}},$o=()=>{const{setItemState:n,state:e,signal:t}=vo(),i=z((o,r)=>{Ae(o)&&n(o,l=>({folded:r!==void 0?r:!l.folded}))},[]),a=z((o,r)=>{Ae(o)||n(o,l=>({expanded:r!==void 0?!r:!l.expanded}))},[]);return{state:e,signal:t,toggleFold:i,toggleCollapse:a}},Co=({compareItemsFn:n,data:e,flatData:t})=>{const[i,a]=Vt("selectedItems",()=>[]),[o,r]=V(),l=z(h=>i===D||i.includes(h),[i]),s=z(h=>i===D||(h?.items?.every(l)??!1),[i,l]),u=z(h=>l(h)||s(h),[l,s]),d=z(h=>{const y=h.items??[h];a(g=>g===D?g:[...g,...y.filter(x=>!g.includes(x))]),r(h)},[]),m=z(h=>{const y=h.items??[h];a(g=>g===D?(t??[]).filter(x=>!Ae(x)).filter(x=>!y.includes(x)):g.filter(x=>!y.includes(x))),r(h)},[t]),b=z(h=>{a(h.items?.slice()||[h]),r(h)},[]),p=z(()=>{a(e.flatMap(h=>h.items||h)),r(void 0)},[e]),f=z(()=>{a([]),r(void 0)},[]),$=z((h,w=!u(h))=>w?d(h):m(h),[u]),C=z((h,w)=>{if(!t)return;const y=o?t.findIndex(v=>n(v,o)):-1;if(y<0)return $(h,w);const[g,x]=[y,t.indexOf(h)].sort((v,q)=>v-q);t.slice(g,x+1).forEach((v,q,F)=>{q>0&&q<F.length-1&&Ae(v)||$(v,w)}),r(h)},[t,n,$]);return M(()=>a(h=>h!==D&&h.length>0&&t?t.filter(w=>h.find(y=>n(w,y))):h),[t]),{selectedItems:i,isItemSelected:l,isGroupSelected:s,isSelected:u,select:d,deselect:m,selectOnly:b,selectAll:p,deselectAll:f,toggleSelect:$,toggleSelectTo:C}},wo={host:{position:"relative",display:"flex",flexDirection:"column"}},zo=n=>{const{data:e,renderItem:t,renderGroup:i,displayEmptyGroups:a,compareItemsFn:o=yo}=n,{toggleFold:r,toggleCollapse:l,state:s,signal:u}=$o(),d=E(()=>ho(e,a,s),[e,a,u]),{selectedItems:m,isItemSelected:b,isGroupSelected:p,isSelected:f,select:$,deselect:C,selectOnly:h,selectAll:w,deselectAll:y,toggleSelect:g,toggleSelectTo:x}=Co({compareItemsFn:o,data:e,flatData:d}),v=z((F,j)=>Array.isArray(F.items)?i(F,j,{selected:p(F),folded:bo(F,s),toggleSelect:B=>g(F,typeof B=="boolean"?B:void 0),toggleFold:()=>r(F)}):t(F,j,{selected:b(F),expanded:go(F,s),toggleSelect:B=>g(F,typeof B=="boolean"?B:void 0),toggleCollapse:()=>l(F)}),[t,i,m,g,u]);Et(()=>{Object.assign(n.style,wo.host)},[]);const q={toggleFold:r,toggleCollapse:l,isItemSelected:b,isGroupSelected:p,isSelected:f,select:$,deselect:C,selectOnly:h,selectAll:w,deselectAll:y,toggleSelect:g,toggleSelectTo:x};return Ue(q,Object.values(q)),{renderRow:v,flatData:d}},So=({renderRow:n,flatData:e})=>zn({items:e,renderItem:(t,i)=>c`<cosmoz-grouped-list-row
				.item=${t}
				.index=${i}
				.renderFn=${n}
