...
`,Ii=i=>{const{label:e,value:t,slot:a}=i,n=c`<div
	...
	`};class Oi extends De(Z(E)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return c`
		...
		</cosmoz-input>`}renderHeader({title:e,min:t,max:a,limits:n,locale:o,rates:r,currency:l,autoupdate:u,autodetect:s},{filter:d},m,b){return c`<cosmoz-omnitable-amount-range-input
			.title=${e}
			.filter=${d}
			.values=${b}
			.rates=${r}
		...
		>`}getComparableValue(e,t){return Ji(e,t)}}customElements.define("cosmoz-omnitable-column-autocomplete",Xi);const Ge=(i,e)=>e.find(({value:t})=>i===t),Qi=(i,e,t)=>{const a=Ge(e,t);return a?a.text:i},it=(i,e,t,a)=>Qi(i,S(e,t),a),Yi=({valuePath:i},e,t)=>Ge(S(e,i),t),Zi=i=>e=>{i(t=>({...t,filter:e?.[0]?.value??null}))},ea=i=>e=>{i(t=>({...t,headerFocused:e}))},ta=i=>e=>{i(t=>({...t,query:e}))},ia=i=>e=>i(e?.[0]?.value),at=({valuePath:i,trueLabel:e,falseLabel:t},a)=>S(a,i)?e:t,aa=({valuePath:i},e)=>t=>S(t,i)===e,ae=ht((i,e)=>[{text:i,value:!0},{text:e,value:!1}]),na=({valuePath:i,trueLabel:e,falseLabel:t},a)=>i?S(a,i)?e:t:"",oa=(i,e)=>{try{return JSON.parse(e)}catch{return null}};class ra extends V(E){static get properties(){return{trueLabel:{type:String,value:"True"},falseLabel:{type:String,value:"False"},flex:{type:String,value:"0"},cellClass:{type:String,value:"boolean-cell"}}}getString(e,t){return at(e,t)}renderCell(e,{item:t}){return at(e,t)}renderEditCell(e,{item:t},a){const{trueLabel:n,falseLabel:o}=e;return c`<cosmoz-autocomplete
			no-label-float
		...
		>`}computeSource({trueLabel:e,falseLabel:t}){return ae(e,t)}getFilterFn(e,t){if(t!=null)return aa(e,t)}toXlsxValue(e,t){return na(e,t)}deserializeFilter(e,t){return oa(e,t)}}customElements.define("cosmoz-omnitable-column-boolean",ra);const He=i=>class extends De(i){static get properties(){return{max:{type:Date,value:null},min:{type:Date,value:null},_filterText:{type:String,computed:"_computeFilterText(filter.*, formatter)"},formatter:{type:Object,computed:"_computeFormatter(locale)"}}}toDate(e,t,a){if(e==null||e==="")return;let n=e;if(n instanceof Date||(typeof e=="string"&&(n=this.getAbsoluteISOString(n)),n=new Date(n)),Number.isNaN(n.getTime()))return null;if(a==null||t==null)return n;const o=this.toDate(t);if(o==null)return n;const r=this.getComparableValue(n),l=this.getComparableValue(o);return a(r,l)===r?n:o}toValue(){return this.toDate.apply(this,arguments)}getComparableValue(e,t){const a=super.getComparableValue(e,t);if(a!=null)return this.toNumber(a.getTime())}getString(e,t=this.valuePath,a=this.formatter){const n=this.toValue(this.get(t,e));return n===void 0?"":n===null?"Invalid Date":this.renderValue(n,a)}getAbsoluteISOString(e){return e.length===19?e+this._getTimezoneString(e):e}_getTimezoneString(e){const t=-new Date(e).getTimezoneOffset()/60;return(t<0?"-":"+")+["0",Math.abs(t)].join("").substr(-2)+":00"}renderValue(e,t=this.formatter){if(t==null)return;const a=this.toValue(e);if(a!=null)return t.format(a)}_computeFormatter(e){return new Intl.DateTimeFormat(e||void 0)}_toInputString(e){const t=this.toValue(e);return t==null?null:this._toLocalISOString(t).slice(0,10)}_dateValueChanged(e){const t=e.currentTarget,a=t.value,n=e.model.item,o=this.get(this.valuePath,n),r=this._fromInputString(a);this.set(this.valuePath,r,n),this._fireItemChangeEvent(n,this.valuePath,o,this.renderValue.bind(this))}_toLocalISOString(e){return ve(e)}};class la extends He(Z(E)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return c`
			...
			${ee({title:this.title,tooltip:this._tooltip,filterText:this._filterText,headerFocused:this.headerFocused,externalValues:this.externalValues,onOpenedChanged:e,content:c`
					...
					></cosmoz-input>
				`})}
		`}_fromInputString(e,t){const a=this.toDate(e);if(a!=null)return t==="min"&&a.setHours(0,0,0,0),t==="max"&&a.setHours(23,59,59),a}_filterInputChanged(e,t){const a=e.path.split(".")[1],n=a&&e.value;if(n&&n.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}}customElements.define("cosmoz-omnitable-date-range-input",la);const sa=i=>{const e=-new Date(i).getTimezoneOffset()/60;return(e<0?"-":"+")+["0",Math.abs(e)].join("").substr(-2)+":00"},je=i=>i.length===19?i+sa(i):i,At=i=>{if(i==null||i==="")return;let e=i;return!(e instanceof Date)&&(typeof i=="string"&&(e=je(e)),e=Kt(e),!e)||Number.isNaN(e.getTime())?null:e},R=({valuePath:i},e)=>{if(e==null)return;let t=e;i!=null&&(t=S(e,i));const a=At(t);if(a!=null)return L(a.getTime())},M=(i,e,t)=>{const a=At(i);return a??null},We=(i,e)=>{if(e==null)return;const t=M(i);if(t!=null)return e.format(t)},ne={},ua=i=>{const e=i||"";return ne[e]||(ne[e]=new Intl.DateTimeFormat(i||void 0)),ne[e]},nt=({valuePath:i,locale:e},t)=>{let a=S(t,i||"");return a===void 0?"":(a=M(a),a===null?"Invalid Date":We(a,ua(e)))},zt=i=>{const e=M(i);if(e==null)return null;const t=ve(e);return t==null?null:t.slice(0,10)},da=({valuePath:i},e)=>zt(S(e,i||"")),Ft=(i,e)=>{const t=M(i);if(t!=null)return t},ot=i=>{const e=zt(i);return e??""},ca=({valuePath:i},e)=>{if(!i)return"";const t=M(S(e,i));if(!t)return"";const a=M(ve(t));return a?(a.setHours(0,0,0,0),a):""},_t=(i,e)=>t=>{const a=R(i,t);if(a==null)return!1;const n=R({...i,valuePath:"min"},e),o=R({...i,valuePath:"max"},e);return!(a<(n??-1/0)||a>(o??1/0))};class ma extends V(E){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"date-header-cell"},width:{type:String,value:"100px"},minWidth:{type:String,value:"82px"},flex:{type:String,value:"0"}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const a=R({...e,valuePath:"min"},t),n=R({...e,valuePath:"max"},t);if(!(a==null&&n==null))return _t(e,t)}getString(e,t){return nt(e,t)}toXlsxValue(e,t){return ca(e,t)}getComparableValue(e,t){return R(e,t)}serializeFilter(e,t){if(t==null)return;const a=M(t.min),n=M(t.max);if(!(a==null&&n==null))return ot(a)+"~"+ot(n)}deserializeFilter(e,t){if(t==null||t==="")return null;const a=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(a)?{min:M(a[1]),max:M(a[2])}:null}renderCell(e,{item:t}){return c`<div class="omnitable-cell-date">
			${nt(e,t)}
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return Y(e,t)}}customElements.define("cosmoz-omnitable-column-date",ma);class pa extends Be(V(E)){renderCell({valuePath:e,textProperty:t},{item:a}){const n=Te(a,e,t).map(o=>c`<li>${o}</li>`);return c`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		`}static get is(){return"cosmoz-omnitable-column-list-data"}static get properties(){return{items:{type:Array},_expanded:{type:Boolean,value:!1},_othersCount:{type:Number,computed:"_computeOthersCount(items)"}}}static get observers(){return["_itemsLengthChanged(items.length)"]}_itemsLengthChanged(){requestAnimationFrame(()=>this.dispatchEvent(new CustomEvent("expand",{bubbles:!0})))}_firstItem(e){if(e!=null&&e.length>0)return e[0]}_hideExpand(e,t){return e!==void 0&&e.length!==null?e.length<=2||t:!0}_hideCollapse(e,t){return e!==void 0&&e.length!==null?e.length<=2||!t:!0}_otherItems(e,t){if(e!=null&&(e.length<=2||t))return e.slice(1)}_computeOthersCount(e){if(e!=null)return e.length-1}_toggleExpand(e){this._expanded=!this._expanded,e.stopPropagation(),e.preventDefault()}}customElements.define(rt.is,rt);class ga extends Be(V(E)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:a}){return c`<cosmoz-omnitable-column-list-data
			.items=${Te(a,e,t)}
		...
		></cosmoz-omnitable-time-range-input>`}computeSource(e,t){return Y(e,t)}}customElements.define("cosmoz-omnitable-column-time",wa);const re={},Ca=i=>{const e=i||"";if(re[e])return re[e];const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return re[e]=new Intl.DateTimeFormat(i||void 0,t),re[e]},we=({valuePath:i,locale:e},t)=>{const a=M(S(t,i||""));return a===void 0?"":a===null?"Invalid Date":We(a,Ca(e))},Sa=({valuePath:i},e)=>i?S(e,i):"",ut=i=>{const e=M(i);return e==null?"":e.toISOString().slice(0,19).replace(/:/gu,".")},dt=i=>{if(!(i==null||i==="")&&typeof i=="string")return M(i.replace(/\./gu,":")+"Z")};class qa extends He(Z(E)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return c`
			...
			${ee({title:this.title,tooltip:this._tooltip,filterText:this._filterText,headerFocused:this.headerFocused,externalValues:this.externalValues,onOpenedChanged:e,content:c`
					...
					></cosmoz-datetime-input>
				`})}
		`}_toInputString(e){const t=this.toValue(e);if(t!=null)return this._toLocalISOString(t).slice(0,19)}_computeFormatter(e){const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return new Intl.DateTimeFormat(e||void 0,t)}}customElements.define("cosmoz-omnitable-datetime-range-input",qa);class ct extends V(E){static get is(){return"cosmoz-omnitable-column-datetime"}static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"datetime-header-cell"},width:{type:String,value:"210px"},minWidth:{type:String,value:"128px"},flex:{type:String,value:"0"},filterStep:{type:Number,value:1}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const a=R({...e,valuePath:"min"},t),n=R({...e,valuePath:"max"},t);if(!(a==null&&n==null))return _t(e,t)}getString(e,t){return we(e,t)}toXlsxValue(e,t){return Sa(e,t)}getComparableValue(e,t){return R(e,t)}serializeFilter(e,t){if(t==null)return;const a=M(t.min),n=M(t.max);if(!(a==null&&n==null))return ut(a)+"~"+ut(n)}deserializeFilter(e,t){if(t==null||t==="")return null;const a=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(a)?{min:dt(a[1]),max:dt(a[2])}:null}renderCell(e,{item:t}){return we(e,t)}renderEditCell(e,{item:t},a){return c`<cosmoz-input
			no-label-float
			type="text"
			@change=${o=>a(Ft(o.target.value))}
			.value=${we(e,t)}
...
`,Ea=()=>c`
	<sort-and-group-consumer
		class="sgs"
		.render=${({columns:i,sortOn:e,setSortOn:t,descending:a,setDescending:n}={})=>Et({columns:i?.filter?.(o=>o.sortPath&&!o.noSort),on:e,setOn:t,descending:a,setDescending:n})}
	>
	</sort-and-group-consumer>
`,It=i=>(e,t,a=Yt)=>{const n=ii(),o=new URLSearchParams(n.hash.replace("#",""));return i(e,t,a,o),"#!"+Object.assign(n,{hash:o}).href.replace(location.origin,"")},Ot=i=>i==null||i==="",Ia=It((i,e,t,a)=>Ot(t(e))?a.delete(i):a.set(i,t(e))),Oa=It((i,e,t,a)=>Object.entries(e).map(t).forEach(([n,o])=>Ot(o)?a.delete(i+n):a.set(i+n,o))),X=(i,e,{suffix:t="",read:a,write:n,multi:o}={})=>{const[r,l]=o?[Oa,Zt]:[Ia,ei],[u,s]=T(()=>e==null?i:l(e+t,a)??i),d=C(m=>s(b=>{const p=he(m,b);return e!=null&&ti(r(e+t,p,n),null,{notify:!1}),p}),[e,t,r,n]);return[u,d]},La=i=>[!0,"true",1,"yes","on"].includes(i),le=i=>i===""||(i==null?void 0:La(i)),se=(i,e,t)=>C(a=>{i(a),t(n=>({...n,[e]:a}))},[i,e,t]),Da=(i,e,t,a,n)=>{const[o,r]=X(t.sortOn,e,{suffix:"-sortOn"}),[l,u]=X(le(t.descending),e,{suffix:"-descending",read:le}),[s,d]=X(t.groupOn,e,{suffix:"-groupOn"}),[m,b]=X(le(t.groupOnDescending),e,{suffix:"-groupOnDescending",read:le}),p=F(()=>i.find(g=>g.name===o),[i,o]),$=F(()=>i.find(g=>g.name===s),[i,s]),v={groupOn:s,setGroupOn:se(d,"groupOn",a),groupOnDescending:m,setGroupOnDescending:se(b,"groupOnDescending",a),sortOn:o,setSortOn:se(r,"sortOn",a),descending:l,setDescending:se(u,"descending",a),columns:i},y=F(()=>v,Object.values(v)),_=C(g=>{r(g.sortPath),d(g.groupOn),u(g.descending),b(g.groupOnDescending)},[]);return I(()=>void(n.current=_),[]),{...y,sortAndGroup:y,groupOnColumn:$,sortOnColumn:p}},Ue=vt();customElements.define("sort-and-group-provider",Ue.Provider);customElements.define("sort-and-group-consumer",O(({render:i})=>i(Me(Ue)),{useShadowDOM:!1}));const Ta=({data:i,columns:e,groupOnColumn:t,filters:a,setFilterState:n,sortAndGroup:{sortOn:o,setSortOn:r,descending:l,setDescending:u}={}})=>yt(e,s=>s.name,s=>[c`<div
	...
	`};customElements.define("cosmoz-omnitable-header-row",O(Va,{useShadowDOM:!1}));const Pa=J`
	:host {
		display: flex;
		align-items: center;
		flex-wrap: wrap;
...
`;customElements.define("cosmoz-omnitable-item-expand-line",O(Na,{styleSheets:[Ee(Pa)]}));const Ra=({columns:i,item:e,selected:t,expanded:a,groupOnColumn:n})=>ai(i,o=>c`<cosmoz-omnitable-item-expand-line
				.column=${o}
				?hidden=${o===n}
...
`);r.unshift(o),$t(new File(r,t,{type:"text/csv;charset=utf-8"}))},Wa=(i,e)=>{const t=i.map(n=>n.title),a=e.map(n=>i.map(o=>{const r=o.toXlsxValue(o,n);return r??""}));return a.unshift(t),a},Ua=(i,e,t,a)=>{const n=Wa(i,e),o=new ni(t).addSheetFromData(n,a).generate();$t(new File([o],t,{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}))},D=Symbol("All"),Ka=({columns:i,selectedItems:e,csvFilename:t,xlsxFilename:a,xlsxSheetname:n,topPlacement:o,enableSelectAll:r,onSelectAllMatching:l,visibleData:u=[]})=>{const s=e===D||!Ie(e),d=e===D?u.length:e.length;return c`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${s}
		part="bottomBar"
	...
	>
		...
		<cosmoz-dropdown-menu part="extra" slot="extra" .placement=${o}>
			...
			<button
				@click=${()=>ja(i,e===D?u:e,t)}
			>
				${z("Save as CSV")}
			</button>
			<button
				@click=${()=>Ua(i,e===D?u:e,a,n)}
			>
				${z("Save as XLSX")}
			</button>
...
`,Qa=({settingsConfig:i})=>{const{columns:e,collapsed:t}=i,a=e.filter(n=>!t.some(o=>o.name===n.name));return c`<div class="skeleton">
		...
		${k(b,()=>c`<div class="tableContent-empty overlay">
...
`;customElements.define("cosmoz-omnitable-settings",O(rn,{styleSheets:[Ee(en)]}));const ge=["sortOn","descending","groupOn","groupOnDescending"],de=i=>e=>typeof e=="object"&&e!==null&&"name"in e&&e.name===i,ln=(i=[],e=[],t=[])=>{const a=e.filter(r=>i.some(de(r.name))),n=i.filter(r=>r.name!=null&&!e.some(de(r.name))&&!t.some(de(r.name))),o=t.filter(r=>!e.some(de(r.name)));return[...a,...o.flatMap(r=>{const l=i.find(u=>u.name===r.name);return l?{...r,title:l.title??r.title??"",minWidth:parseInt(l.minWidth??"0",10)}:[]}),...n.map(r=>{const{name:l,title:u,priority:s,minWidth:d,width:m,flex:b}=r;return{name:l??"",title:u??"",priority:s??0,minWidth:parseInt(d??"0",10),width:parseInt(m??"0",10),flex:parseInt(b??"0",10)}})]},sn=(i,e)=>({...e,...ze(Array.from(ge))(i),columns:i.columns?.map(ze(["name","priority","width","flex","disabled"]))}),un=({columns:i,settings:e,savedSettings:t,initial:a})=>({...Object.fromEntries(ge.flatMap(o=>a?.[o]!=null?[[o,a[o]]]:[])),...t?ze(Array.from(ge))(t):{},...e,columns:ln(i,e?.columns,t?.columns)}),dn=({prefix:i="omnitable-"}={})=>({write:async(t,a)=>{const n=i+t;try{a?localStorage.setItem(n,JSON.stringify(a)):localStorage.removeItem(n)}catch(o){console.error(o)}},read:async t=>{if(t)try{const a=localStorage.getItem(i+t);return a==null?void 0:JSON.parse(a)}catch(a){console.error(a)}}}),cn=vt(dn),mn=()=>{const i=Me(cn);return F(()=>i(),[i])},pn=(i,e,t,a)=>{const[n,o]=T(),{read:r,write:l}=mn();return I(async()=>{i&&o(await r(i))},[i,r]),{settingsId:i,savedSettings:n,onSave:C(async()=>{if(!i)return;const u=sn(e,n);await l(i,u),t(),o(u)},[e,n]),onReset:C(async u=>{t(),u.shiftKey&&(await l(i),o()),a?.()},[a]),hasChanges:e!=null}},gn=({settingsId:i,host:e})=>{const t=F(()=>Object.fromEntries(ge.map(v=>[v,e[v]])),[]),a=Le(),n=C(()=>{a.current?.(t)},[t]),[o,r]=T(),[l,u]=T({columns:!0,sort:!0}),{savedSettings:s,...d}=pn(i,o,r,n),{enabledColumns:m}=e,b=_i(e,{enabledColumns:m}),p=F(()=>un({columns:b,settings:o,savedSettings:s,initial:t}),[b,o,s]),$=F(()=>p.columns.map(v=>b.find(y=>y.name===v.name)).filter(Boolean),[b,...p.columns.map(v=>v.name)]);return{...d,opened:l,setOpened:u,settings:p,columns:$,setSettings:r,resetRef:a}},pt=i=>Number.isFinite(i)?i:0,fn=(i,e)=>{const t=[];let[a,n]=i.reduce(([d,m],{width:b,flex:p})=>[d+b,m+p],[0,0]),o=e-a,r=pt(o/n),l=0,u=0,s=0;for(let d=0;d<i.length;d++){const{width:m,minWidth:b,flex:p}=i[d],$=o>=0?r*p:m*o/a;if(b>m+$){l+=m,u+=b,s+=p,t[d]=b;continue}if(p===0){l+=m,u+=m,t[d]=m;continue}}a-=l,o=e-u-a,n-=s,r=pt(o/n);for(let d=0;d<i.length;d++){if(t[d]!=null)continue;const{width:m,flex:b}=i[d],p=o>=0?r*b:m*o/a;t[d]=m+p}return t},fe=Symbol("index"),bn=(i,e)=>{if(typeof i.findLastIndex=="function")return i.findLastIndex(e);for(let t=i.length-1;t>=0;t--)if(e(i[t],t,i))return t;return-1},hn=(i,e)=>{const t=bn(i,r=>r!=null&&r>0),a=(r,l)=>`.cell[name="${r}"], cosmoz-omnitable-skeleton::part(cell-${r}){width: ${Math.floor(l)}px;padding: 0 min(3px, ${l/2}px)}`,n=r=>`cosmoz-omnitable-resize-nub[name="${r}"]{display:none}`,o=r=>`cosmoz-omnitable-resize-nub[name="${r}"], .cell[name="${r}"]{display:none}`;return e.map((r,l)=>{const u=i[l];if(u==null||u===0)return o(r.name);const s=a(r.name,u);return l===t?`${s}
${n(r.name)}`:s}).join(`
`)},Dt=(i,e,t)=>{const a=i.filter(l=>!l.hidden),n=a.reduce((l,{width:u})=>l+u,0);if(a.length>1&&n>e)return Dt(a.slice(1),e,t);const o=a.reduce(([l,u],s,d)=>[Math.max(l,s.index),s.index>l?d:u],[-1,-1])[1];return o!==-1&&(a[o].flex=1),fn(a,e).reduce((l,u,s)=>(l[a[s].index]=u,l),new Array(t).fill(void 0))},xn=(i,e)=>i.length===0?".cell {display: none;}":hn(i,e),vn=({host:i,canvasWidth:e,layout:t,setSettings:a})=>{const n=Le();n.current=o=>a(r=>{const l=r.columns,{detail:{newWidth:u,column:s}}=o,d=l.findIndex(p=>p.name===s.name),m=[],b=l.reduce((p,$)=>Math.max(p,$.priority),-1/0);for(let p=0;p<t.length;p++)if(m[p]={...l[p]},p<d&&t[p]!=null&&(m[p].width=t[p],m[p].flex=0,m[p].priority=b),p===d){const $=t.reduce((v,y,_)=>_<d&&y?v-y:v,e);m[p].width=Math.min($,Math.max(u,l[p].minWidth)),m[p].flex=0,m[p].priority=b}return{...r,columns:m}}),I(()=>{const o=r=>n.current?.(r);return i.addEventListener("column-resize",o),()=>i.removeEventListener("column-resize",o)},[])},yn=(i,e)=>I(()=>{const t=([n])=>{n.contentRect?.width!==0&&requestAnimationFrame(()=>e(n.contentRect?.width-20-44-24))},a=new ResizeObserver(t);return a.observe(i),()=>a.unobserve(i)},[]),$n=i=>{const[e,t]=T(()=>i.getBoundingClientRect().width);return yn(i,t),e},wn=(i,e)=>{const t=F(()=>{let a=!1,n;const o=()=>{if(!a)return;n=requestAnimationFrame(o),i()&&(a=!1)};return{start:()=>{a=!0,cancelAnimationFrame(n),n=requestAnimationFrame(o)},stop:()=>{a=!1,cancelAnimationFrame(n)}}},[]);I(()=>{t.start()},e),I(()=>()=>t.stop(),[])},Cn=(i=0,e=0)=>Math.abs((i??0)-(e??0))<.1,Sn=(i,e=1.9,t=si)=>{const a=Oe({target:i}),n=C(()=>{if(a.tween||(a.tween=a.target),a.target.every((o,r)=>a.tween[r]===o))return t(a.tween),!0;a.tween=a.target.map((o,r)=>Cn(a.tween[r],o)?o:(a.tween[r]??0)+((o??0)-(a.tween[r]??0))/e||0),t(a.tween)},[]);wn(n,[i])},qn=({canvasWidth:i,groupOnColumn:e,config:t,miniColumn:a})=>F(()=>{if(!Array.isArray(t)||i==null||i===0)return[];const n=t.map((o,r)=>({minWidth:o.minWidth,width:o.width,flex:o.flex,priority:o.priority,name:o.name,index:r,hidden:o.name===e?.name||o.disabled})).map(o=>a?{...o,hidden:a.name!==o.name}:o).sort(({index:o,priority:r},{index:l,priority:u})=>r===u?l-o:r-u);return Dt(n,i,n.length)},[i,e,t]),An=({host:i,canvasWidth:e,columns:t})=>{const a=i.miniBreakpoint??480,n=F(()=>e<=a,[e,a]),o=F(()=>n?t?.filter(s=>s.mini!=null).sort((s,d)=>(s.mini??0)-(d.mini??0)):[],[t,n]),[r,...l]=o??[],u=!!r;return I(()=>{i.toggleAttribute("mini",u)},[u]),{isMini:u&&n,miniColumn:r,miniColumns:l}},zn=i=>{const e=F(()=>new CSSStyleSheet,[]);return I(()=>{i.shadowRoot.adoptedStyleSheets=[...i.shadowRoot.adoptedStyleSheets,e]},[]),e},Fn=({host:i,columns:e,settings:t,setSettings:a,resizeSpeedFactor:n,sortAndGroupOptions:o})=>{const r=$n(i),{isMini:l,miniColumn:u,miniColumns:s}=An({host:i,canvasWidth:r,columns:e}),{groupOnColumn:d}=o,m=qn({canvasWidth:r,groupOnColumn:d,miniColumn:u,config:t.columns}),b=zn(i),p=F(()=>t.columns.reduce((v,y,_)=>m[_]!=null||y.name===d?.name||y.disabled?v:[...v,e.find(g=>g.name===y.name)].filter(g=>g!=null),[]),[e,t,m,d]),$=Oe({columns:t.columns});return Sn(m,n,v=>{const y=xn(v,$.columns);b.replace(y)}),vn({host:i,canvasWidth:r,layout:m,setSettings:v=>a(v(t))}),{isMini:l,collapsedColumns:p,miniColumns:s}},_n=({host:i,...e})=>{const{csvFilename:t="omnitable.csv",xlsxFilename:a="omnitable.xlsx",xlsxSheetname:n="Omnitable",topPlacement:o="top-end"}=i;return{csvFilename:t,xlsxFilename:a,xlsxSheetname:n,topPlacement:o,...e}},kn=({host:i,selectedItems:e,data:t,sortAndGroupOptions:a,collapsedColumns:n,settings:o,filterFunctions:r,settingS:l,filters:u,...s})=>{const d=e===D||t&&t.length>0&&e.length===t.length,m=v=>{v.target.checked?i.shadowRoot.querySelector("#groupedList").selectAll():i.shadowRoot.querySelector("#groupedList").deselectAll()},{groupOnColumn:b}=a,p=F(()=>[b,...n,...o.columns.filter(v=>v.disabled)].some(v=>v&&Object.keys(r).includes(v.name)),[r,o,n]),$=F(()=>({...l,collapsed:n,badge:p,filters:u}),[l,n,p,u]);return I(()=>{const v=i.shadowRoot.querySelector("#tableContent"),y=new ResizeObserver(_=>requestAnimationFrame(()=>{i.style.setProperty("--ot-height",_[0]?.contentRect.height+"px")}));return y.observe(v),()=>y.unobserve(v)},[]),{allSelected:d,onAllCheckboxChange:m,data:t,settingsConfig:$,filters:u,groupOnColumn:b,sortAndGroup:a.sortAndGroup,...s}},Tt=c`
	<svg
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
...
`,Mn=i=>i?"groupRow groupRow-folded":"groupRow",En=({item:i,index:e})=>t=>k((t?.length??0)>0,()=>c`
			...
			`),In=({columns:i,collapsedColumns:e,miniColumns:t,onItemClick:a,onCheckboxChange:n,dataIsValid:o,groupOnColumn:r,onItemChange:l,rowPartFn:u})=>(s,d,{selected:m,expanded:b,toggleCollapse:p})=>c`
		<div
			?selected=${m}
	...
	`,On=({onCheckboxChange:i,dataIsValid:e,groupOnColumn:t})=>(a,n,{selected:o,folded:r,toggleFold:l})=>c` <div
		...
		>
			...
			<div class="groupRow-badge">${a.items?.length??0}</div>
			<button class="expand" ?aria-expanded="${r}" @click=${l}>
				${Tt}
			</button>
		</div>`,Ln=({host:i,error:e,dataIsValid:t,processedItems:a,columns:n,collapsedColumns:o,miniColumns:r,sortAndGroupOptions:l,rowPartFn:u,...s})=>{const{loading:d=!1,displayEmptyGroups:m=!1,compareItemsFn:b}=i,p=Le({shiftKey:!1,ctrlKey:!1}),$=C(g=>{const A=g.target,f=A.dataItem,h=A.checked,x=i.shadowRoot.querySelector("#groupedList");p.current.shiftKey?x.toggleSelectTo(f,h):p.current.ctrlKey?(A.checked=!0,x.selectOnly(f)):x.toggleSelect(f,h),g.preventDefault(),g.stopPropagation()},[]);I(()=>{const g=({shiftKey:A,ctrlKey:f})=>{p.current={shiftKey:A,ctrlKey:f}};return window.addEventListener("keydown",g),window.addEventListener("keyup",g),()=>{window.removeEventListener("keydown",g),window.removeEventListener("keyup",g)}},[]);const v=C(g=>{const A=g.currentTarget,f=g.composedPath();f.slice(0,f.indexOf(A)).find(x=>x.matches?.("a, .checkbox, .expand"))||i.dispatchEvent(new window.CustomEvent("omnitable-item-click",{bubbles:!0,composed:!0,detail:{item:A.dataItem,index:A.dataIndex}}))},[]),{groupOnColumn:y}=l,_=C((g,A)=>f=>ki(i,g,A,f),[]);return{...s,processedItems:a,dataIsValid:t,filterIsTooStrict:t&&a.length<1,loading:d,compareItemsFn:b,displayEmptyGroups:m,error:e,renderItem:F(()=>In({columns:n,collapsedColumns:o,miniColumns:r,onItemClick:v,onCheckboxChange:$,dataIsValid:t,groupOnColumn:y,onItemChange:_,rowPartFn:u}),[n,o,v,$,t,y,_,u]),renderGroup:F(()=>On({onCheckboxChange:$,dataIsValid:t,groupOnColumn:y}),[$,t,y])}},Dn=(i,e)=>{if(i===e)return 0;if(i==null)return-1;if(e==null)return 1;const t=typeof i,a=typeof e;return t==="object"&&a==="object"?i.toString()<e.toString()?-1:1:t==="number"&&a==="number"?i-e:t==="string"&&a==="string"?i<e?-1:1:t==="boolean"&&a==="boolean"?i?-1:1:(console.warn("unsupported sort",t,i,a,e),0)},Se=(i,e)=>(t,a)=>Dn(i(t),i(a))*(e?-1:1),Tn=i=>i.replace(/([a-z0-9])([A-Z])/gu,"$1-$2").toLowerCase(),gt=(i,e)=>{!i||!e||Object.entries(e).forEach(([t,a])=>{i[G].__ownChange=!0,i[G][t]=a,i[G].__ownChange=!1,i[G].dispatchEvent(new CustomEvent(`${Tn(t)}-changed`,{bubbles:!0,detail:{value:a}}))})},qe=(i,e)=>Object.assign(i,{[fe]:e}),ce=Symbol("unparsed"),Vn=({data:i,columns:e,hashParam:t,sortAndGroupOptions:a,noLocalSort:n,noLocalFilter:o})=>{const{groupOnColumn:r,groupOnDescending:l,sortOnColumn:u,descending:s}=a,d=C(([f,h])=>{const x=e.find(({name:w})=>w===f);return x==null?[f,void 0]:[f,h.filter&&x.serializeFilter(x,h.filter)]},[e]),m=C(([f,h])=>{const x=e.find(({name:q})=>q===f);if(x==null)return[f,{[ce]:h}];const w={filter:x.deserializeFilter(x,h)};return gt(x,w),[f,w]},[e]),[b,p]=X({},t,{multi:!0,suffix:"-filter--",write:d,read:m}),$=C((f,h)=>p(x=>{const w=he(h,x[f]);return gt(e.find(q=>q.name===f),w),{...x,[f]:{...x[f],...w}}}),[e,p]),v=F(()=>Object.values(b).map(f=>f.filter),[b]),y=F(()=>Object.fromEntries(e.map(f=>[f.name,!f.noLocalFilter&&f.getFilterFn(f,b[f.name]?.filter)]).filter(([,f])=>!!f)),[e,...v]),_=F(()=>!Array.isArray(i)||i.length===0?[]:Object.entries(y).length===0||o?i.slice():i.filter(f=>Object.values(y).every(h=>h(f))),[i,y,o]),g=F(()=>{if(!n&&!r&&u!=null&&u.sortPath!=null)return _.slice().sort(Se(f=>u.getComparableValue({...u,valuePath:u.sortPath},f),s));if(r!=null&&r.groupOn!=null){const f=_.reduce((h,x)=>{const w=r.getComparableValue({...r,valuePath:r.groupOn},x);if(w===void 0)return h;let q=h.find(P=>P.id===w);return q?(q.items.push(x),h):(q={id:w,name:w,items:[x]},[...h,q])},[]);return f.sort(Se(h=>r.getComparableValue({...r,valuePath:r.groupOn},h.items[0]),l)),!u||n?f:f.filter(h=>Array.isArray(h.items)).map(h=>(h.items.sort(Se(x=>u.getComparableValue({...u,valuePath:u.sortPath},x),s)),h))}return _},[_,r,l,u,s,n]),A=F(()=>{let f=0,h=0;const x=[];return g.forEach(w=>{if(Array.isArray(w.items)){qe(w,h++),w.items.forEach(q=>{qe(q,f++),x.push(q)});return}return qe(w,f++),x.push(w)},[]),x},[g]);return I(()=>{p(f=>Object.values(f).some(x=>x[ce]!=null)?Object.fromEntries(Object.entries(f).map(([x,w])=>w[ce]==null?[x,w]:m([x,w[ce]]))):f)},[m]),{processedItems:g,visibleData:A,filters:b,filterFunctions:y,setFilterState:$}},Pn=i=>{const e=a=>{const n=i.data.indexOf(a);if(n<0)return null;const o=i.data.splice(n,1);if(i.data=i.data.slice(),Array.isArray(o)&&o.length>0)return o[0]},t=(a,n)=>{i.data.splice(a,1,n),i.data=i.data.slice()};return{removeItem:e,removeItems(a){const n=[];for(let o=a.length-1;o>=0;o-=1){const r=i.removeItem(a[o]);r!=null&&n.push(r)}return n},replaceItemAtIndex:t,replaceItem(a,n){const o=i.data.indexOf(a);if(o>-1)return t(o,n)},selectItem(a){i.shadowRoot.querySelector("#groupedList").select(a)},selectAll(){i.shadowRoot.querySelector("#groupedList").selectAll()},deselectAll(){i.shadowRoot.querySelector("#groupedList").deselectAll()},deselectItem(a){i.shadowRoot.querySelector("#groupedList").deselect(a)},isItemSelected(a){return i.shadowRoot.querySelector("#groupedList").isItemSelected(a)}}},Nn=({host:i,visibleData:e,filters:t,...a})=>{const{setFilterState:n}=a,o=F(()=>Pn(i),[]);Fe(a,Object.values(a)),Fe(o,Object.values(o)),I(()=>{const l=u=>n(u.detail.name,s=>({...s,...u.detail.state}));return i.addEventListener("legacy-filter-changed",l),()=>i.removeEventListener("legacy-filter-changed",l)},[]),B("visibleData",e),B("sortedFilteredGroupedItems",a.sortedFilteredGroupedItems),B("selectedItems",a.selectedItems),B("sortOn",a.sortOn),B("descending",a.descending),B("isMini",a.isMini);const r=F(()=>Object.fromEntries(Object.entries(t).filter(([,{filter:l}])=>l!==void 0).map(([l,{filter:u}])=>[l,u])),[t]);B("filters",r,Object.values(r))},Rn=i=>{const{hashParam:e,settingsId:t,data:a,resizeSpeedFactor:n,noLocal:o,noLocalSort:r=o,noLocalFilter:l=o,error:u,rowPartFn:s,enableSelectAll:d}=i,m=gn({settingsId:t,host:i}),{settings:b,setSettings:p,columns:$,resetRef:v}=m,y=Da($,e,b,p,v),{processedItems:_,visibleData:g,filters:A,setFilterState:f,filterFunctions:h}=Vn({data:a,columns:$,hashParam:e,sortAndGroupOptions:y,noLocalSort:r,noLocalFilter:l}),{isMini:x,collapsedColumns:w,miniColumns:q}=Fn({host:i,columns:$,settings:b,setSettings:p,resizeSpeedFactor:n,sortAndGroupOptions:y}),P=a&&Array.isArray(a)&&a.length>0,[N,Ke]=T([]),Vt=()=>Ke(D);return Nn({host:i,visibleData:g,sortedFilteredGroupedItems:_,columns:$,filters:A,setFilterState:f,selectedItems:N,isMini:x,...y}),{header:kn({host:i,selectedItems:N,sortAndGroupOptions:y,dataIsValid:P,data:a,columns:$,filters:A,collapsedColumns:w,settings:b,filterFunctions:h,settingS:m,setFilterState:f,hideSelectAll:i.hideSelectAll===!0}),list:Ln({host:i,error:u,dataIsValid:P,processedItems:_,setSelectedItems:Ke,columns:$,collapsedColumns:w,miniColumns:q,sortAndGroupOptions:y,rowPartFn:s}),footer:_n({host:i,selectedItems:N,columns:$,enableSelectAll:d,onSelectAllMatching:Vt,visibleData:g})}};customElements.define("cosmoz-grouped-list-row",class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||Ae(this._renderFn(this._item,this._index),this)}});const Bn={group:Symbol("group")},ye=(i,e)=>(e.has(i)||e.set(i,{}),e.get(i)),Gn=(i,e)=>!!ye(i,e).expanded,Hn=(i,e)=>!!ye(i,e).folded,_e=i=>i?i.items instanceof Array:!1,jn=i=>{if(!Array.isArray(i)||i.length===0)return;const e=Array.isArray(i[0]?.items);if(!i.every(a=>Array.isArray(a.items)===e))throw new Error("Data must be homogeneous.")},Wn=(i,e,t)=>Array.isArray(i)?(jn(i),i.reduce((n,o)=>{const r=o;if(!r.items)return n.concat(o);if(r.items.length){if(ye(o,t).folded)return n.concat(o);const l=r.items.map(u=>Object.assign(u,{[Bn.group]:o}));return n.concat(o,l)}return e?n.concat(o):n},[])):void 0,Un=(i,...e)=>typeof i=="function"?i(...e):i,Kn=(i,e)=>i===e,Jn=()=>{const[i,e]=T(()=>[new WeakMap]);return{setItemState:C((a,n)=>e(([o])=>{const r=ye(a,o);return Object.assign(r,Un(n,r)),[o]}),[]),state:i[0],signal:i}},Xn=()=>{const{setItemState:i,state:e,signal:t}=Jn(),a=C((o,r)=>{_e(o)&&i(o,l=>({folded:r!==void 0?r:!l.folded}))},[]),n=C((o,r)=>{_e(o)||i(o,l=>({expanded:r!==void 0?!r:!l.expanded}))},[]);return{state:e,signal:t,toggleFold:a,toggleCollapse:n}},Qn=({initial:i,compareItemsFn:e,data:t,flatData:a})=>{const[n,o]=T(i),[r,l]=T(),u=C(g=>Array.isArray(n)&&n.includes(g)||n===D,[n]),s=C(g=>g?.items?.every(u)??!1,[u]),d=C(g=>u(g)||s(g),[u,s]),m=C(g=>{const f=g.items??[g];o(h=>h===D?h:[...h,...f.filter(x=>!h.includes(x))]),l(g)},[]),b=C(g=>{const f=g.items??[g];o(h=>h===D?h:h.filter(x=>!f.includes(x))),l(g)},[]),p=C(g=>{o(g.items?.slice()||[g]),l(g)},[]),$=C(()=>{o(t.flatMap(g=>g.items||g)),l(void 0)},[t]),v=C(()=>{o([]),l(void 0)},[]),y=C((g,A=!d(g))=>A?m(g):b(g),[d]),_=C((g,A)=>{if(!a)return;const f=r?a.findIndex(w=>e(w,r)):-1;if(f<0)return y(g,A);const[h,x]=[f,a.indexOf(g)].sort((w,q)=>w-q);a.slice(h,x+1).forEach((w,q,P)=>{q>0&&q<P.length-1&&_e(w)||y(w,A)}),l(g)},[a,e,y]);return I(()=>o(g=>g===D||g.length===0||!a?g:a.filter(A=>g.find(f=>e(A,f)))),[a]),{selectedItems:n,isItemSelected:u,isGroupSelected:s,isSelected:d,select:m,deselect:b,selectOnly:p,selectAll:$,deselectAll:v,toggleSelect:y,toggleSelectTo:_}},Yn={host:{position:"relative",display:"flex",flexDirection:"column"}},Zn=i=>{const{data:e,renderItem:t,renderGroup:a,displayEmptyGroups:n,compareItemsFn:o=Kn}=i,{toggleFold:r,toggleCollapse:l,state:u,signal:s}=Xn(),d=F(()=>Wn(e,n,u),[e,n,s]),{selectedItems:m,isItemSelected:b,isGroupSelected:p,isSelected:$,select:v,deselect:y,selectOnly:_,selectAll:g,deselectAll:A,toggleSelect:f,toggleSelectTo:h}=Qn({initial:[],compareItemsFn:o,data:e,flatData:d}),x=C((q,P)=>Array.isArray(q.items)?a(q,P,{selected:p(q),folded:Hn(q,u),toggleSelect:N=>f(q,typeof N=="boolean"?N:void 0),toggleFold:()=>r(q)}):t(q,P,{selected:b(q),expanded:Gn(q,u),toggleSelect:N=>f(q,typeof N=="boolean"?N:void 0),toggleCollapse:()=>l(q)}),[t,a,m,f,s]);bt(()=>{Object.assign(i.style,Yn.host)},[]),B("selectedItems",m);const w={toggleFold:r,toggleCollapse:l,isItemSelected:b,isGroupSelected:p,isSelected:$,select:v,deselect:y,selectOnly:_,selectAll:g,deselectAll:A,toggleSelect:f,toggleSelectTo:h};return Fe(w,Object.values(w)),{renderRow:x,flatData:d}},eo=({renderRow:i,flatData:e})=>ui({items:e,renderItem:(t,a)=>c`<cosmoz-grouped-list-row
				.item=${t}
				.index=${a}
				.renderFn=${i}
