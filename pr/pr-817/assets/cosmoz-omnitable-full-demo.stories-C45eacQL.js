import{x as d,B as _e,E as ft,b as Pt}from"./iframe-Gg_Tq9lk.js";import{t as J,c as E,g as S,P as A,u as M,a as bt,m as xt,s as Bt,D as Gt,b as Ht,e as Wt,i as xe,h as Ve,d as qt,f as yt,r as Xt,j as Ut,k as _,l as Kt,n as ye,p as pe,o as O,q as Jt,v as ve,w as Qt,x as Yt,y as Zt,T as en,z as T,A as ge,B as tn,C as nn,E as on,F as z,G as rn,H as ln,I as vt,J as De,K as I,L as $t,M as Ae,N as an,O as wt,Q as sn,R as Ee,S as Je,U as un,V as Te,W as cn,X as dn,Y as Ie,Z as Le,_ as mn,$ as Fe,a0 as G,a1 as pn,a2 as we,a3 as gn}from"./cosmoz-collapse-DUDquckH.js";const hn=J`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,Rn=n=>{const{label:e,value:t,slot:o}=n,r=d`<div
	...
	`};class Mn extends Re(ee(A)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return d`
		...
		</cosmoz-input>`}renderHeader({title:e,min:t,max:o,limits:r,locale:i,rates:l,currency:a,autoupdate:s,autodetect:u},{filter:c},m,h){return d`<cosmoz-omnitable-amount-range-input
			.title=${e}
			.filter=${c}
			.values=${h}
			.rates=${l}
		...
		>`}getComparableValue(e,t){return Zn(e,t)}}customElements.define("cosmoz-omnitable-column-autocomplete",eo);const He=(n,e)=>e.find(({value:t})=>n===t),to=(n,e,t)=>{const o=He(e,t);return o?o.text:n},nt=(n,e,t,o)=>to(n,S(e,t),o),no=({valuePath:n},e,t)=>He(S(e,n),t),oo=n=>e=>{n(t=>({...t,filter:e?.[0]?.value??null}))},ro=n=>e=>{n(t=>({...t,headerFocused:e}))},io=n=>e=>{n(t=>({...t,query:e}))},lo=n=>e=>n(e?.[0]?.value),ot=({valuePath:n,trueLabel:e,falseLabel:t},o)=>S(o,n)?e:t,ao=({valuePath:n},e)=>t=>S(t,n)===e,oe=xt((n,e)=>[{text:n,value:!0},{text:e,value:!1}]),so=({valuePath:n,trueLabel:e,falseLabel:t},o)=>n?S(o,n)?e:t:"",uo=(n,e)=>{try{return JSON.parse(e)}catch{return null}};class co extends N(A){static get properties(){return{trueLabel:{type:String,value:"True"},falseLabel:{type:String,value:"False"},flex:{type:String,value:"0"},cellClass:{type:String,value:"boolean-cell"}}}getString(e,t){return ot(e,t)}renderCell(e,{item:t}){return ot(e,t)}renderEditCell(e,{item:t},o){const{trueLabel:r,falseLabel:i}=e;return d`<cosmoz-autocomplete
			no-label-float
		...
		`}_fromInputString(e,t){const o=this.toDate(e);if(o!=null)return t==="min"&&o.setHours(0,0,0,0),t==="max"&&o.setHours(23,59,59),o}_filterInputChanged(e,t){const o=e.path.split(".")[1],r=o&&e.value;if(r&&r.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}}customElements.define("cosmoz-omnitable-date-range-input",mo);const po=n=>{const e=-new Date(n).getTimezoneOffset()/60;return(e<0?"-":"+")+["0",Math.abs(e)].join("").substr(-2)+":00"},qe=n=>n.length===19?n+po(n):n,_t=n=>{if(n==null||n==="")return;let e=n;return!(e instanceof Date)&&(typeof n=="string"&&(e=qe(e)),e=Qt(e),!e)||Number.isNaN(e.getTime())?null:e},B=({valuePath:n},e)=>{if(e==null)return;let t=e;n!=null&&(t=S(e,n));const o=_t(t);if(o!=null)return L(o.getTime())},D=(n,e,t)=>{const o=_t(n);return o??null},Xe=(n,e)=>{if(e==null)return;const t=D(n);if(t!=null)return e.format(t)},re={},go=n=>{const e=n||"";return re[e]||(re[e]=new Intl.DateTimeFormat(n||void 0)),re[e]},rt=({valuePath:n,locale:e},t)=>{let o=S(t,n||"");return o===void 0?"":(o=D(o),o===null?"Invalid Date":Xe(o,go(e)))},It=n=>{const e=D(n);if(e==null)return null;const t=ve(e);return t==null?null:t.slice(0,10)},ho=({valuePath:n},e)=>It(S(e,n||"")),Ft=(n,e)=>{const t=D(n);if(t!=null)return t},it=n=>{const e=It(n);return e??""},fo=({valuePath:n},e)=>{if(!n)return"";const t=D(S(e,n));if(!t)return"";const o=D(ve(t));return o?(o.setHours(0,0,0,0),o):""},Ot=(n,e)=>t=>{const o=B(n,t);if(o==null)return!1;const r=B({...n,valuePath:"min"},e),i=B({...n,valuePath:"max"},e);return!(o<(r??-1/0)||o>(i??1/0))};class bo extends N(A){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"date-header-cell"},width:{type:String,value:"100px"},minWidth:{type:String,value:"82px"},flex:{type:String,value:"0"}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const o=B({...e,valuePath:"min"},t),r=B({...e,valuePath:"max"},t);if(!(o==null&&r==null))return Ot(e,t)}getString(e,t){return rt(e,t)}toXlsxValue(e,t){return fo(e,t)}getComparableValue(e,t){return B(e,t)}serializeFilter(e,t){if(t==null)return;const o=D(t.min),r=D(t.max);if(!(o==null&&r==null))return it(o)+"~"+it(r)}deserializeFilter(e,t){if(t==null||t==="")return null;const o=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(o)?{min:D(o[1]),max:D(o[2])}:null}renderCell(e,{item:t}){return d`<div class="omnitable-cell-date">
			...
			.value=${ho(e,t)}
		></cosmoz-input>`}renderHeader({title:e,min:t,max:o,limits:r,locale:i},{filter:l},a,s){return d`<cosmoz-omnitable-date-range-input
			.title=${e}
			.filter=${l}
			.values=${s}
			.min=${t}
			...
			.limits=${r}
			.locale=${i}
			@filter-changed=${({detail:{value:u}})=>a(c=>({...c,filter:u}))}
			@header-focused-changed=${({detail:{value:u}})=>a(c=>({...c,headerFocused:u}))}
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return Z(e,t)}}customElements.define("cosmoz-omnitable-column-date",bo);class xo extends Ge(N(A)){renderCell({valuePath:e,textProperty:t},{item:o}){const r=Me(o,e,t).map(i=>d`<li>${i}</li>`);return d`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		`}static get is(){return"cosmoz-omnitable-column-list-data"}static get properties(){return{items:{type:Array},_expanded:{type:Boolean,value:!1},_othersCount:{type:Number,computed:"_computeOthersCount(items)"}}}static get observers(){return["_itemsLengthChanged(items.length)"]}_itemsLengthChanged(){requestAnimationFrame(()=>this.dispatchEvent(new CustomEvent("expand",{bubbles:!0})))}_firstItem(e){if(e!=null&&e.length>0)return e[0]}_hideExpand(e,t){return e!==void 0&&e.length!==null?e.length<=2||t:!0}_hideCollapse(e,t){return e!==void 0&&e.length!==null?e.length<=2||!t:!0}_otherItems(e,t){if(e!=null&&(e.length<=2||t))return e.slice(1)}_computeOthersCount(e){if(e!=null)return e.length-1}_toggleExpand(e){this._expanded=!this._expanded,e.stopPropagation(),e.preventDefault()}}customElements.define(lt.is,lt);class yo extends Ge(N(A)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:o}){return d`<cosmoz-omnitable-column-list-data
			.items=${Me(o,e,t)}
		...
		`}_computeFormatter(e,t,o){const r={localeMatcher:"best fit"};return t!==null&&(r.minimumFractionDigits=t),o!==null&&(r.maximumFractionDigits=o),new Intl.NumberFormat(e||void 0,r)}getComparableValue(e,t){if(e==null)return;let o=e;if(t!=null&&(o=this.get(t,e)),o=this.toValue(o),o==null)return;const r=this.maximumFractionDigits;return r!==null?this.toValue(o.toFixed(r)):o}renderValue(e,t=this.formatter){const o=this.toNumber(e);if(o!=null)return t.format(o)}}customElements.define("cosmoz-omnitable-number-range-input",vo);class $o extends N(A){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},autoupdate:{type:Boolean,value:!1,notify:!0},cellClass:{type:String,value:"number-cell align-right"},width:{type:String,value:"30px"},minWidth:{type:String,value:"30px"},headerCellClass:{type:String,value:"number-header-cell"},maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const o=q({...e,valuePath:"min"},t),r=q({...e,valuePath:"max"},t);if(!(o==null&&r==null))return Pn(e,t)}getString(e,t){return Ye(e,t)}toXlsxValue({valuePath:e},t){return S(t,e)}getComparableValue(e,t){return q(e,t)}serializeFilter(e,t){if(t==null)return;const o=L(t.min),r=L(t.max);if(!(o==null&&r==null))return Qe(o)+"~"+Qe(r)}deserializeFilter(e,t){if(t==null||t==="")return null;const o=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(o)?{min:L(o[1]),max:L(o[2])}:null}renderCell(e,{item:t}){return d`<div class="omnitable-cell-number">
			...
			@change=${i=>o(i.target.value)}
			.value=${Nn(e,t)}
		></cosmoz-input>`}renderHeader({title:e,min:t,max:o,limits:r,locale:i,maximumFractionDigits:l,minimumFractionDigits:a,autoupdate:s},{filter:u},c,m){return d`<cosmoz-omnitable-number-range-input
			.title=${e}
			.filter=${u}
			.values=${m}
			.min=${t}
		...
		`}get _fixedDate(){return"1970-01-01"}toDate(e,t,o){const r=typeof e=="string"&&e.length>3&&e.length<=9?this.getAbsoluteISOString(this._fixedDate+"T"+e):e;return super.toDate(r,t,o)}_toInputString(e){const t=this.toValue(e);return t==null?null:this._toLocalISOString(t).slice(11,19)}getComparableValue(e,t){if(e==null)return;let o=this._toInputString(t==null?e:this.get(t,e));if(o!=null&&(o=this.toValue(this.getAbsoluteISOString(this._fixedDate+"T"+o)),o!=null))return this.toNumber(o.getTime())}_timeValueChanged(e){const t=e.target,o=t.value,r=e.model.item,i=this.toDate(r.date),l=this.toDate(i!=null?i.toISOString().slice(0,10)+"T"+o:o),a=s=>s;l==null&&(this.set(this.valuePath,l,r),this._fireItemChangeEvent(r,this.valuePath,i,a.bind(this)))}_computeFormatter(e){const t={hour:"numeric",minute:"numeric",second:"numeric"};return new Intl.DateTimeFormat(e||void 0,t)}}customElements.define("cosmoz-omnitable-time-range-input",ko);class _o extends N(A){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"time-header-cell"},minWidth:{type:String,value:"63px"},width:{type:String,value:"210px"},flex:{type:String,value:"0"},filterStep:{type:String,value:"1"}}}getFilterFn(e,t){const o=U({...e,valuePath:"min"},t),r=U({...e,valuePath:"max"},t);if(!(o==null&&r==null))return Co(e,t)}getString(e,t){return me(e,t)}toXlsxValue(e,t){return zo(e,t)}getComparableValue(e,t){return U(e,t)}serializeFilter(e,t){if(t==null)return;const o=W(t.min),r=W(t.max);if(!(o==null&&r==null))return at(o)+"~"+at(r)}deserializeFilter(e,t){if(t==null||t==="")return null;const o=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(o)?{min:st(o[1]),max:st(o[2])}:null}renderCell(e,{item:t}){return me(e,t)}renderEditCell(e,{item:t},o){return d`<cosmoz-input
			...
			@change=${i=>o(i.target.value)}
			.value=${me(e,t)}
		></cosmoz-input>`}renderHeader({title:e,min:t,max:o,locale:r,filterStep:i},{filter:l},a,s){return d`<cosmoz-omnitable-time-range-input
			.title=${e}
			.filter=${l}
			.values=${s}
			.min=${t}
...
`,Ro=()=>d`
	<sort-and-group-consumer
		class="sgs"
		.render=${({columns:n,sortOn:e,setSortOn:t,descending:o,setDescending:r}={})=>At({columns:n?.filter?.(i=>i.sortPath&&!i.noSort),on:e,setOn:t,descending:o,setDescending:r})}
	>
	</sort-and-group-consumer>
`,Et=n=>(e,t,o=tn)=>{const r=ln(),i=new URLSearchParams(r.hash.replace("#",""));return n(e,t,o,i),"#!"+Object.assign(r,{hash:i}).href.replace(location.origin,"")},Tt=n=>n==null||n==="",Mo=Et((n,e,t,o)=>Tt(t(e))?o.delete(n):o.set(n,t(e))),No=Et((n,e,t,o)=>Object.entries(e).map(t).forEach(([r,i])=>Tt(i)?o.delete(n+r):o.set(n+r,i))),Q=(n,e,{suffix:t="",read:o,write:r,multi:i}={})=>{const[l,a]=i?[No,nn]:[Mo,on],[s,u]=M(()=>e==null?n:a(e+t,o)??n),c=z(m=>u(h=>{const p=xe(m,h);return e!=null&&rn(l(e+t,p,r),null,{notify:!1}),p}),[e,t,l,r]);return[s,c]},jo=n=>[!0,"true",1,"yes","on"].includes(n),ae=n=>n===""||(n==null?void 0:jo(n)),se=(n,e,t)=>z(o=>{n(o),t(r=>({...r,[e]:o}))},[n,e,t]),Po=(n,e,t,o,r)=>{const[i,l]=Q(t.sortOn,e,{suffix:"-sortOn"}),[a,s]=Q(ae(t.descending),e,{suffix:"-descending",read:ae}),[u,c]=Q(t.groupOn,e,{suffix:"-groupOn"}),[m,h]=Q(ae(t.groupOnDescending),e,{suffix:"-groupOnDescending",read:ae}),p=I(()=>n.find(g=>g.name===i),[n,i]),$=I(()=>n.find(g=>g.name===u),[n,u]),b={groupOn:u,setGroupOn:se(c,"groupOn",o),groupOnDescending:m,setGroupOnDescending:se(h,"groupOnDescending",o),sortOn:i,setSortOn:se(l,"sortOn",o),descending:a,setDescending:se(s,"descending",o),columns:n},v=I(()=>b,Object.values(b)),F=z(g=>{l(g.sortPath),c(g.groupOn),s(g.descending),h(g.groupOnDescending)},[]);return T(()=>void(r.current=F),[]),{...v,sortAndGroup:v,groupOnColumn:$,sortOnColumn:p}},Ue=vt();customElements.define("sort-and-group-provider",Ue.Provider);customElements.define("sort-and-group-consumer",E(({render:n})=>n(De(Ue)),{useShadowDOM:!1}));const Bo=({data:n,columns:e,groupOnColumn:t,filters:o,setFilterState:r,sortAndGroup:{sortOn:i,setSortOn:l,descending:a,setDescending:s}={}})=>$t(e,u=>u.name,u=>[d`<div
			...
			>
				...
				${O(!u.noSort,()=>Dt({on:i,setOn:l,descending:a,setDescending:s,column:u}))}
...
`);l.unshift(i),wt(new File(l,t,{type:"text/csv;charset=utf-8"}))},Qo=(n,e)=>{const t=n.map(r=>r.title),o=e.map(r=>n.map(i=>{const l=i.toXlsxValue(i,r);return l??""}));return o.unshift(t),o},Yo=(n,e,t,o)=>{const r=Qo(n,e),i=new sn(t).addSheetFromData(r,o).generate();wt(new File([i],t,{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}))},R=Symbol("All"),Zo=({columns:n,selectedItems:e,csvFilename:t,xlsxFilename:o,xlsxSheetname:r,topPlacement:i,enableSelectAll:l,onSelectAllMatching:a,visibleData:s=[]})=>{const u=e===R||!Ee(e),c=e===R?s.length:e.length;return d`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${u}
		part="bottomBar"
		exportparts="bar: bottomBar-bar, info: bottomBar-info, buttons: bottomBar-buttons"
	>
		${O(!0,()=>d`<div slot="info" style="color: white">
					${e===R?d`All matching items selected.`:d` ${c} selected items.
								<button
									@click=${a}
		...
		<cosmoz-dropdown-menu part="extra" slot="extra" .placement=${i}>
			...
			<button
				@click=${()=>Jo(n,e===R?s:e,t)}
			>
				${_("Save as CSV")}
			</button>
			<button
				@click=${()=>Yo(n,e===R?s:e,o,r)}
			>
				${_("Save as XLSX")}
			</button>
			<slot name="download-menu"></slot>
		</cosmoz-dropdown-menu>
	</cosmoz-bottom-bar>`},er=({allSelected:n,onAllCheckboxChange:e,sortAndGroup:t,dataIsValid:o,data:r,columns:i,filters:l,groupOnColumn:a,setFilterState:s,settingsConfig:u,hideSelectAll:c})=>d`<sort-and-group-provider .value=${t}>
...
`,rr=(n,e)=>{const{settingsConfig:t}=n,{processedItems:o,dataIsValid:r,filterIsTooStrict:i,loading:l,displayEmptyGroups:a,compareItemsFn:s,setSelectedItems:u,renderItem:c,renderGroup:m,error:h}=e;return d`${O(!l&&!r&&!h,()=>d`<div class="tableContent-empty">
...
`,ue=n=>{const e=parseInt(n,10);return isFinite(e)?e:void 0},ar=n=>{const{config:e}=n,{settings:t,setSettings:o,collapsed:r}=e,i=Te({collapsed:r,settings:t.columns,setSettings:z(l=>o(a=>({...a,columns:l})),[o])});return{...e,onDown:z(l=>{l.target.closest(".pull")&&(i.handle=l.currentTarget)},[i]),onDragStart:z(l=>{const{target:a}=l,s=ue(a.dataset.index);if(!i.handle?.contains(a)||s==null)return l.preventDefault();i.handle=null,l.dataTransfer.effectAllowed="move",l.dataTransfer.setData("omnitable/sort-index",s),l.dataTransfer.setData("text/plain",s),setTimeout(()=>a.classList.add("drag"),0),a.addEventListener("dragend",u=>u.target.classList.remove("drag"),{once:!0})},[i]),onDragEnter:z(l=>{const a=l.currentTarget;a===l.target&&(l.preventDefault(),l.dataTransfer.dropEffect="move",a.classList.add("dragover"))},[]),onDragOver:z(l=>{l.preventDefault(),l.currentTarget.classList.add("dragover")},[]),onDragLeave:z(l=>{const a=l.currentTarget;a.contains(l.relatedTarget)||a.classList.remove("dragover")},[]),onDrop:z(l=>{const a=ue(l.dataTransfer.getData("omnitable/sort-index")),s=ue(l.currentTarget.dataset.index),{settings:u,setSettings:c}=i;l.currentTarget.classList.remove("dragover"),l.preventDefault();const m=u.slice();m.splice(s+(a>=s?0:-1),0,m.splice(a,1)[0]),c(m)},[i]),onToggle:z(l=>{const{settings:a,setSettings:s}=i,u=a.map(m=>({...m,disabled:m.disabled||i.collapsed?.some(h=>h.name===m.name)})),c=ue(l.target.closest("[data-index]")?.dataset.index);u.splice(c,1,{...a[c],disabled:!l.target.checked,priority:l.target.checked?a.reduce((m,h)=>Math.max(m,h.priority),0)+1:a[c].priority}),s(u)},[i])}},sr=[cn({apply({availableHeight:n,elements:e}){Object.assign(e.floating.style,{maxHeight:`${Math.max(0,n)}px`})}}),...dn],ur=({onDragStart:n,onDragEnter:e,onDragOver:t,onDragLeave:o,onDrop:r,onDown:i,onToggle:l,collapsed:a,filters:s})=>(u,c)=>{const m=!!a?.find(p=>p.name===u.name),h=!u.disabled&&!m;return d` <div
			class="item"
			data-index=${c}
			@mousedown=${i}
			draggable="true"
		...
		>
			...
			<label class="title" ?has-filter=${!Ee(s[u.name]?.filter)}
				>${u.title}</label
			>
			<input
				class="checkbox"
				...
				.indeterminate=${m}
			/>
		</div>`},cr=n=>{const{settings:e,settingsId:t,onSave:o,onReset:r,hasChanges:i,opened:l,setOpened:a,...s}=ar(n);return d` <div class="headline">
			${_("Sort and filter")}
			<button
				class="close"
...
`;customElements.define("cosmoz-omnitable-settings",E(dr,{styleSheets:[Ae(lr)]}));const he=["sortOn","descending","groupOn","groupOnDescending"],ce=n=>e=>typeof e=="object"&&e!==null&&"name"in e&&e.name===n,mr=(n=[],e=[],t=[])=>{const o=e.filter(l=>n.some(ce(l.name))),r=n.filter(l=>l.name!=null&&!e.some(ce(l.name))&&!t.some(ce(l.name))),i=t.filter(l=>!e.some(ce(l.name)));return[...o,...i.flatMap(l=>{const a=n.find(s=>s.name===l.name);return a?{...l,title:a.title??l.title??"",minWidth:parseInt(a.minWidth??"0",10)}:[]}),...r.map(l=>{const{name:a,title:s,priority:u,minWidth:c,width:m,flex:h}=l;return{name:a??"",title:s??"",priority:u??0,minWidth:parseInt(c??"0",10),width:parseInt(m??"0",10),flex:parseInt(h??"0",10)}})]},pr=(n,e)=>({...e,...Ie(Array.from(he))(n),columns:n.columns?.map(Ie(["name","priority","width","flex","disabled"]))}),gr=({columns:n,settings:e,savedSettings:t,initial:o})=>({...Object.fromEntries(he.flatMap(i=>o?.[i]!=null?[[i,o[i]]]:[])),...t?Ie(Array.from(he))(t):{},...e,columns:mr(n,e?.columns,t?.columns)}),hr=({prefix:n="omnitable-"}={})=>({write:async(t,o)=>{const r=n+t;try{o?localStorage.setItem(r,JSON.stringify(o)):localStorage.removeItem(r)}catch(i){console.error(i)}},read:async t=>{if(t)try{const o=localStorage.getItem(n+t);return o==null?void 0:JSON.parse(o)}catch(o){console.error(o)}}}),fr=vt(hr),br=()=>{const n=De(fr);return I(()=>n(),[n])},xr=(n,e,t,o)=>{const[r,i]=M(),{read:l,write:a}=br();return T(async()=>{n&&i(await l(n))},[n,l]),{settingsId:n,savedSettings:r,onSave:z(async()=>{if(!n)return;const s=pr(e,r);await a(n,s),t(),i(s)},[e,r]),onReset:z(async s=>{t(),s.shiftKey&&(await a(n),i()),o?.()},[o]),hasChanges:e!=null}},yr=({settingsId:n,host:e})=>{const t=I(()=>Object.fromEntries(he.map(b=>[b,e[b]])),[]),o=Le(),r=z(()=>{o.current?.(t)},[t]),[i,l]=M(),[a,s]=M({columns:!0,sort:!0}),{savedSettings:u,...c}=xr(n,i,l,r),{enabledColumns:m}=e,h=An(e,{enabledColumns:m}),p=I(()=>gr({columns:h,settings:i,savedSettings:u,initial:t}),[h,i,u]),$=I(()=>p.columns.map(b=>h.find(v=>v.name===b.name)).filter(Boolean),[h,...p.columns.map(b=>b.name)]);return{...c,opened:a,setOpened:s,settings:p,columns:$,setSettings:l,resetRef:o}},pt=n=>Number.isFinite(n)?n:0,vr=(n,e)=>{const t=[];let[o,r]=n.reduce(([c,m],{width:h,flex:p})=>[c+h,m+p],[0,0]),i=e-o,l=pt(i/r),a=0,s=0,u=0;for(let c=0;c<n.length;c++){const{width:m,minWidth:h,flex:p}=n[c],$=i>=0?l*p:m*i/o;if(h>m+$){a+=m,s+=h,u+=p,t[c]=h;continue}if(p===0){a+=m,s+=m,t[c]=m;continue}}o-=a,i=e-s-o,r-=u,l=pt(i/r);for(let c=0;c<n.length;c++){if(t[c]!=null)continue;const{width:m,flex:h}=n[c],p=i>=0?l*h:m*i/o;t[c]=m+p}return t},fe=Symbol("index"),$r=(n,e)=>{if(typeof n.findLastIndex=="function")return n.findLastIndex(e);for(let t=n.length-1;t>=0;t--)if(e(n[t],t,n))return t;return-1},wr=(n,e)=>{const t=$r(n,l=>l!=null&&l>0),o=(l,a)=>`.cell[name="${l}"], cosmoz-omnitable-skeleton::part(cell-${l}){width: ${Math.floor(a)}px;padding: 0 min(3px, ${a/2}px)}`,r=l=>`cosmoz-omnitable-resize-nub[name="${l}"]{display:none}`,i=l=>`cosmoz-omnitable-resize-nub[name="${l}"], .cell[name="${l}"]{display:none}`;return e.map((l,a)=>{const s=n[a];if(s==null||s===0)return i(l.name);const u=o(l.name,s);return a===t?`${u}
${r(l.name)}`:u}).join(`
`)},Rt=(n,e,t)=>{const o=n.filter(a=>!a.hidden),r=o.reduce((a,{width:s})=>a+s,0);if(o.length>1&&r>e)return Rt(o.slice(1),e,t);const i=o.reduce(([a,s],u,c)=>[Math.max(a,u.index),u.index>a?c:s],[-1,-1])[1];return i!==-1&&(o[i].flex=1),vr(o,e).reduce((a,s,u)=>(a[o[u].index]=s,a),new Array(t).fill(void 0))},zr=(n,e)=>n.length===0?".cell {display: none;}":wr(n,e),Sr=({host:n,canvasWidth:e,layout:t,setSettings:o})=>{const r=Le();r.current=i=>o(l=>{const a=l.columns,{detail:{newWidth:s,column:u}}=i,c=a.findIndex(p=>p.name===u.name),m=[],h=a.reduce((p,$)=>Math.max(p,$.priority),-1/0);for(let p=0;p<t.length;p++)if(m[p]={...a[p]},p<c&&t[p]!=null&&(m[p].width=t[p],m[p].flex=0,m[p].priority=h),p===c){const $=t.reduce((b,v,F)=>F<c&&v?b-v:b,e);m[p].width=Math.min($,Math.max(s,a[p].minWidth)),m[p].flex=0,m[p].priority=h}return{...l,columns:m}}),T(()=>{const i=l=>r.current?.(l);return n.addEventListener("column-resize",i),()=>n.removeEventListener("column-resize",i)},[])},Cr=(n,e)=>T(()=>{const t=([r])=>{r.contentRect?.width!==0&&requestAnimationFrame(()=>e(r.contentRect?.width-20-44-24))},o=new ResizeObserver(t);return o.observe(n),()=>o.unobserve(n)},[]),kr=n=>{const[e,t]=M(()=>n.getBoundingClientRect().width);return Cr(n,t),e},_r=(n,e)=>{const t=I(()=>{let o=!1,r;const i=()=>{if(!o)return;r=requestAnimationFrame(i),n()&&(o=!1)};return{start:()=>{o=!0,cancelAnimationFrame(r),r=requestAnimationFrame(i)},stop:()=>{o=!1,cancelAnimationFrame(r)}}},[]);T(()=>{t.start()},e),T(()=>()=>t.stop(),[])},Ir=(n=0,e=0)=>Math.abs((n??0)-(e??0))<.1,Fr=(n,e=1.9,t=mn)=>{const o=Te({target:n}),r=z(()=>{if(o.tween||(o.tween=o.target),o.target.every((i,l)=>o.tween[l]===i))return t(o.tween),!0;o.tween=o.target.map((i,l)=>Ir(o.tween[l],i)?i:(o.tween[l]??0)+((i??0)-(o.tween[l]??0))/e||0),t(o.tween)},[]);_r(r,[n])},Or=({canvasWidth:n,groupOnColumn:e,config:t,miniColumn:o})=>I(()=>{if(!Array.isArray(t)||n==null||n===0)return[];const r=t.map((i,l)=>({minWidth:i.minWidth,width:i.width,flex:i.flex,priority:i.priority,name:i.name,index:l,hidden:i.name===e?.name||i.disabled})).map(i=>o?{...i,hidden:o.name!==i.name}:i).sort(({index:i,priority:l},{index:a,priority:s})=>l===s?a-i:l-s);return Rt(r,n,r.length)},[n,e,t]),Vr=({host:n,canvasWidth:e,columns:t})=>{const o=n.miniBreakpoint??480,r=I(()=>e<=o,[e,o]),i=I(()=>r?t?.filter(u=>u.mini!=null).sort((u,c)=>(u.mini??0)-(c.mini??0)):[],[t,r]),[l,...a]=i??[],s=!!l;return T(()=>{n.toggleAttribute("mini",s)},[s]),{isMini:s&&r,miniColumn:l,miniColumns:a}},Dr=n=>{const e=I(()=>new CSSStyleSheet,[]);return T(()=>{n.shadowRoot.adoptedStyleSheets=[...n.shadowRoot.adoptedStyleSheets,e]},[]),e},Ar=({host:n,columns:e,settings:t,setSettings:o,resizeSpeedFactor:r,sortAndGroupOptions:i})=>{const l=kr(n),{isMini:a,miniColumn:s,miniColumns:u}=Vr({host:n,canvasWidth:l,columns:e}),{groupOnColumn:c}=i,m=Or({canvasWidth:l,groupOnColumn:c,miniColumn:s,config:t.columns}),h=Dr(n),p=I(()=>t.columns.reduce((b,v,F)=>m[F]!=null||v.name===c?.name||v.disabled?b:[...b,e.find(g=>g.name===v.name)].filter(g=>g!=null),[]),[e,t,m,c]),$=Te({columns:t.columns});return Fr(m,r,b=>{const v=zr(b,$.columns);h.replace(v)}),Sr({host:n,canvasWidth:l,layout:m,setSettings:b=>o(b(t))}),{isMini:a,collapsedColumns:p,miniColumns:u}},Er=({host:n,...e})=>{const{csvFilename:t="omnitable.csv",xlsxFilename:o="omnitable.xlsx",xlsxSheetname:r="Omnitable",topPlacement:i="top-end"}=n;return{csvFilename:t,xlsxFilename:o,xlsxSheetname:r,topPlacement:i,...e}},Tr=({host:n,selectedItems:e,data:t,sortAndGroupOptions:o,collapsedColumns:r,settings:i,filterFunctions:l,settingS:a,filters:s,...u})=>{const c=e===R||t&&t.length>0&&e.length===t.length,m=b=>{b.target.checked?n.shadowRoot.querySelector("#groupedList").selectAll():n.shadowRoot.querySelector("#groupedList").deselectAll()},{groupOnColumn:h}=o,p=I(()=>[h,...r,...i.columns.filter(b=>b.disabled)].some(b=>b&&Object.keys(l).includes(b.name)),[l,i,r]),$=I(()=>({...a,collapsed:r,badge:p,filters:s}),[a,r,p,s]);return T(()=>{const b=n.shadowRoot.querySelector("#tableContent"),v=new ResizeObserver(F=>requestAnimationFrame(()=>{n.style.setProperty("--ot-height",F[0]?.contentRect.height+"px")}));return v.observe(b),()=>v.unobserve(b)},[]),{allSelected:c,onAllCheckboxChange:m,data:t,settingsConfig:$,filters:s,groupOnColumn:h,sortAndGroup:o.sortAndGroup,...u}},Mt=d`
	<svg
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
...
`,Lr=n=>n?"groupRow groupRow-folded":"groupRow",Rr=({item:n,index:e})=>t=>O((t?.length??0)>0,()=>d`
			...
			`),Mr=({columns:n,collapsedColumns:e,miniColumns:t,onItemClick:o,onCheckboxChange:r,dataIsValid:i,groupOnColumn:l,onItemChange:a,rowPartFn:s})=>(u,c,{selected:m,expanded:h,toggleCollapse:p})=>d`
		<div
			?selected=${m}
	...
	`,Nr=({onCheckboxChange:n,dataIsValid:e,groupOnColumn:t})=>(o,r,{selected:i,folded:l,toggleFold:a})=>d` <div
		...
		</div>`,jr=({host:n,error:e,dataIsValid:t,processedItems:o,columns:r,collapsedColumns:i,miniColumns:l,sortAndGroupOptions:a,rowPartFn:s,...u})=>{const{loading:c=!1,displayEmptyGroups:m=!1,compareItemsFn:h}=n,p=Le({shiftKey:!1,ctrlKey:!1}),$=z(g=>{const k=g.target,f=k.dataItem,x=k.checked,y=n.shadowRoot.querySelector("#groupedList");p.current.shiftKey?y.toggleSelectTo(f,x):p.current.ctrlKey?(k.checked=!0,y.selectOnly(f)):y.toggleSelect(f,x),g.preventDefault(),g.stopPropagation()},[]);T(()=>{const g=({shiftKey:k,ctrlKey:f})=>{p.current={shiftKey:k,ctrlKey:f}};return window.addEventListener("keydown",g),window.addEventListener("keyup",g),()=>{window.removeEventListener("keydown",g),window.removeEventListener("keyup",g)}},[]);const b=z(g=>{const k=g.currentTarget,f=g.composedPath();f.slice(0,f.indexOf(k)).find(y=>y.matches?.("a, .checkbox, .expand"))||n.dispatchEvent(new window.CustomEvent("omnitable-item-click",{bubbles:!0,composed:!0,detail:{item:k.dataItem,index:k.dataIndex}}))},[]),{groupOnColumn:v}=a,F=z((g,k)=>f=>En(n,g,k,f),[]);return{...u,processedItems:o,dataIsValid:t,filterIsTooStrict:t&&o.length<1,loading:c,compareItemsFn:h,displayEmptyGroups:m,error:e,renderItem:I(()=>Mr({columns:r,collapsedColumns:i,miniColumns:l,onItemClick:b,onCheckboxChange:$,dataIsValid:t,groupOnColumn:v,onItemChange:F,rowPartFn:s}),[r,i,b,$,t,v,F,s]),renderGroup:I(()=>Nr({onCheckboxChange:$,dataIsValid:t,groupOnColumn:v}),[$,t,v])}},Pr=(n,e)=>{if(n===e)return 0;if(n==null)return-1;if(e==null)return 1;const t=typeof n,o=typeof e;return t==="object"&&o==="object"?n.toString()<e.toString()?-1:1:t==="number"&&o==="number"?n-e:t==="string"&&o==="string"?n<e?-1:1:t==="boolean"&&o==="boolean"?n?-1:1:(console.warn("unsupported sort",t,n,o,e),0)},Ce=(n,e)=>(t,o)=>Pr(n(t),n(o))*(e?-1:1),Br=n=>n.replace(/([a-z0-9])([A-Z])/gu,"$1-$2").toLowerCase(),gt=(n,e)=>{!n||!e||Object.entries(e).forEach(([t,o])=>{n[H].__ownChange=!0,n[H][t]=o,n[H].__ownChange=!1,n[H].dispatchEvent(new CustomEvent(`${Br(t)}-changed`,{bubbles:!0,detail:{value:o}}))})},ke=(n,e)=>Object.assign(n,{[fe]:e}),de=Symbol("unparsed"),Gr=({data:n,columns:e,hashParam:t,sortAndGroupOptions:o,noLocalSort:r,noLocalFilter:i})=>{const{groupOnColumn:l,groupOnDescending:a,sortOnColumn:s,descending:u}=o,c=z(([f,x])=>{const y=e.find(({name:w})=>w===f);return y==null?[f,void 0]:[f,x.filter&&y.serializeFilter(y,x.filter)]},[e]),m=z(([f,x])=>{const y=e.find(({name:C})=>C===f);if(y==null)return[f,{[de]:x}];const w={filter:y.deserializeFilter(y,x)};return gt(y,w),[f,w]},[e]),[h,p]=Q({},t,{multi:!0,suffix:"-filter--",write:c,read:m}),$=z((f,x)=>p(y=>{const w=xe(x,y[f]);return gt(e.find(C=>C.name===f),w),{...y,[f]:{...y[f],...w}}}),[e,p]),b=I(()=>Object.values(h).map(f=>f.filter),[h]),v=I(()=>Object.fromEntries(e.map(f=>[f.name,!f.noLocalFilter&&f.getFilterFn(f,h[f.name]?.filter)]).filter(([,f])=>!!f)),[e,...b]),F=I(()=>!Array.isArray(n)||n.length===0?[]:Object.entries(v).length===0||i?n.slice():n.filter(f=>Object.values(v).every(x=>x(f))),[n,v,i]),g=I(()=>{if(!r&&!l&&s!=null&&s.sortPath!=null)return F.slice().sort(Ce(f=>s.getComparableValue({...s,valuePath:s.sortPath},f),u));if(l!=null&&l.groupOn!=null){const f=F.reduce((x,y)=>{const w=l.getComparableValue({...l,valuePath:l.groupOn},y);if(w===void 0)return x;let C=x.find(j=>j.id===w);return C?(C.items.push(y),x):(C={id:w,name:w,items:[y]},[...x,C])},[]);return f.sort(Ce(x=>l.getComparableValue({...l,valuePath:l.groupOn},x.items[0]),a)),!s||r?f:f.filter(x=>Array.isArray(x.items)).map(x=>(x.items.sort(Ce(y=>s.getComparableValue({...s,valuePath:s.sortPath},y),u)),x))}return F},[F,l,a,s,u,r]),k=I(()=>{let f=0,x=0;const y=[];return g.forEach(w=>{if(Array.isArray(w.items)){ke(w,x++),w.items.forEach(C=>{ke(C,f++),y.push(C)});return}return ke(w,f++),y.push(w)},[]),y},[g]);return T(()=>{p(f=>Object.values(f).some(y=>y[de]!=null)?Object.fromEntries(Object.entries(f).map(([y,w])=>w[de]==null?[y,w]:m([y,w[de]]))):f)},[m]),{processedItems:g,visibleData:k,filters:h,filterFunctions:v,setFilterState:$}},Hr=n=>{const e=o=>{const r=n.data.indexOf(o);if(r<0)return null;const i=n.data.splice(r,1);if(n.data=n.data.slice(),Array.isArray(i)&&i.length>0)return i[0]},t=(o,r)=>{n.data.splice(o,1,r),n.data=n.data.slice()};return{removeItem:e,removeItems(o){const r=[];for(let i=o.length-1;i>=0;i-=1){const l=n.removeItem(o[i]);l!=null&&r.push(l)}return r},replaceItemAtIndex:t,replaceItem(o,r){const i=n.data.indexOf(o);if(i>-1)return t(i,r)},selectItem(o){n.shadowRoot.querySelector("#groupedList").select(o)},selectAll(){n.shadowRoot.querySelector("#groupedList").selectAll()},deselectAll(){n.shadowRoot.querySelector("#groupedList").deselectAll()},deselectItem(o){n.shadowRoot.querySelector("#groupedList").deselect(o)},isItemSelected(o){return n.shadowRoot.querySelector("#groupedList").isItemSelected(o)}}},Wr=({host:n,visibleData:e,filters:t,...o})=>{const{setFilterState:r}=o,i=I(()=>Hr(n),[]);Fe(o,Object.values(o)),Fe(i,Object.values(i)),T(()=>{const a=s=>r(s.detail.name,u=>({...u,...s.detail.state}));return n.addEventListener("legacy-filter-changed",a),()=>n.removeEventListener("legacy-filter-changed",a)},[]),G("visibleData",e),G("sortedFilteredGroupedItems",o.sortedFilteredGroupedItems),G("selectedItems",o.selectedItems),G("sortOn",o.sortOn),G("descending",o.descending),G("isMini",o.isMini);const l=I(()=>Object.fromEntries(Object.entries(t).filter(([,{filter:a}])=>a!==void 0).map(([a,{filter:s}])=>[a,s])),[t]);G("filters",l,Object.values(l))},qr=n=>{const{hashParam:e,settingsId:t,data:o,resizeSpeedFactor:r,noLocal:i,noLocalSort:l=i,noLocalFilter:a=i,error:s,rowPartFn:u,enableSelectAll:c}=n,m=yr({settingsId:t,host:n}),{settings:h,setSettings:p,columns:$,resetRef:b}=m,v=Po($,e,h,p,b),{processedItems:F,visibleData:g,filters:k,setFilterState:f,filterFunctions:x}=Gr({data:o,columns:$,hashParam:e,sortAndGroupOptions:v,noLocalSort:l,noLocalFilter:a}),{isMini:y,collapsedColumns:w,miniColumns:C}=Ar({host:n,columns:$,settings:h,setSettings:p,resizeSpeedFactor:r,sortAndGroupOptions:v}),j=o&&Array.isArray(o)&&o.length>0,[P,Ke]=M([]),jt=()=>Ke(R);return Wr({host:n,visibleData:g,sortedFilteredGroupedItems:F,columns:$,filters:k,setFilterState:f,selectedItems:P,isMini:y,...v}),{header:Tr({host:n,selectedItems:P,sortAndGroupOptions:v,dataIsValid:j,data:o,columns:$,filters:k,collapsedColumns:w,settings:h,filterFunctions:x,settingS:m,setFilterState:f,hideSelectAll:n.hideSelectAll===!0}),list:jr({host:n,error:s,dataIsValid:j,processedItems:F,setSelectedItems:Ke,columns:$,collapsedColumns:w,miniColumns:C,sortAndGroupOptions:v,rowPartFn:u}),footer:Er({host:n,selectedItems:P,columns:$,enableSelectAll:c,onSelectAllMatching:jt,visibleData:g})}};customElements.define("cosmoz-grouped-list-row",class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||_e(this._renderFn(this._item,this._index),this)}});const Xr={group:Symbol("group")},$e=(n,e)=>(e.has(n)||e.set(n,{}),e.get(n)),Ur=(n,e)=>!!$e(n,e).expanded,Kr=(n,e)=>!!$e(n,e).folded,Oe=n=>n?n.items instanceof Array:!1,Jr=n=>{if(!Array.isArray(n)||n.length===0)return;const e=Array.isArray(n[0]?.items);if(!n.every(o=>Array.isArray(o.items)===e))throw new Error("Data must be homogeneous.")},Qr=(n,e,t)=>Array.isArray(n)?(Jr(n),n.reduce((r,i)=>{const l=i;if(!l.items)return r.concat(i);if(l.items.length){if($e(i,t).folded)return r.concat(i);const a=l.items.map(s=>Object.assign(s,{[Xr.group]:i}));return r.concat(i,a)}return e?r.concat(i):r},[])):void 0,Yr=(n,...e)=>typeof n=="function"?n(...e):n,Zr=(n,e)=>n===e,ei=()=>{const[n,e]=M(()=>[new WeakMap]);return{setItemState:z((o,r)=>e(([i])=>{const l=$e(o,i);return Object.assign(l,Yr(r,l)),[i]}),[]),state:n[0],signal:n}},ti=()=>{const{setItemState:n,state:e,signal:t}=ei(),o=z((i,l)=>{Oe(i)&&n(i,a=>({folded:l!==void 0?l:!a.folded}))},[]),r=z((i,l)=>{Oe(i)||n(i,a=>({expanded:l!==void 0?!l:!a.expanded}))},[]);return{state:e,signal:t,toggleFold:o,toggleCollapse:r}},ni=({initial:n,compareItemsFn:e,data:t,flatData:o})=>{const[r,i]=M(n),[l,a]=M(),s=z(g=>Array.isArray(r)&&r.includes(g)||r===R,[r]),u=z(g=>g?.items?.every(s)??!1,[s]),c=z(g=>s(g)||u(g),[s,u]),m=z(g=>{const f=g.items??[g];i(x=>x===R?x:[...x,...f.filter(y=>!x.includes(y))]),a(g)},[]),h=z(g=>{const f=g.items??[g];i(x=>x===R?x:x.filter(y=>!f.includes(y))),a(g)},[]),p=z(g=>{i(g.items?.slice()||[g]),a(g)},[]),$=z(()=>{i(t.flatMap(g=>g.items||g)),a(void 0)},[t]),b=z(()=>{i([]),a(void 0)},[]),v=z((g,k=!c(g))=>k?m(g):h(g),[c]),F=z((g,k)=>{if(!o)return;const f=l?o.findIndex(w=>e(w,l)):-1;if(f<0)return v(g,k);const[x,y]=[f,o.indexOf(g)].sort((w,C)=>w-C);o.slice(x,y+1).forEach((w,C,j)=>{C>0&&C<j.length-1&&Oe(w)||v(w,k)}),a(g)},[o,e,v]);return T(()=>i(g=>g===R||g.length===0||!o?g:o.filter(k=>g.find(f=>e(k,f)))),[o]),{selectedItems:r,isItemSelected:s,isGroupSelected:u,isSelected:c,select:m,deselect:h,selectOnly:p,selectAll:$,deselectAll:b,toggleSelect:v,toggleSelectTo:F}},oi={host:{position:"relative",display:"flex",flexDirection:"column"}},ri=n=>{const{data:e,renderItem:t,renderGroup:o,displayEmptyGroups:r,compareItemsFn:i=Zr}=n,{toggleFold:l,toggleCollapse:a,state:s,signal:u}=ti(),c=I(()=>Qr(e,r,s),[e,r,u]),{selectedItems:m,isItemSelected:h,isGroupSelected:p,isSelected:$,select:b,deselect:v,selectOnly:F,selectAll:g,deselectAll:k,toggleSelect:f,toggleSelectTo:x}=ni({initial:[],compareItemsFn:i,data:e,flatData:c}),y=z((C,j)=>Array.isArray(C.items)?o(C,j,{selected:p(C),folded:Kr(C,s),toggleSelect:P=>f(C,typeof P=="boolean"?P:void 0),toggleFold:()=>l(C)}):t(C,j,{selected:h(C),expanded:Ur(C,s),toggleSelect:P=>f(C,typeof P=="boolean"?P:void 0),toggleCollapse:()=>a(C)}),[t,o,m,f,u]);bt(()=>{Object.assign(n.style,oi.host)},[]),G("selectedItems",m);const w={toggleFold:l,toggleCollapse:a,isItemSelected:h,isGroupSelected:p,isSelected:$,select:b,deselect:v,selectOnly:F,selectAll:g,deselectAll:k,toggleSelect:f,toggleSelectTo:x};return Fe(w,Object.values(w)),{renderRow:y,flatData:c}},ii=({renderRow:n,flatData:e})=>pn({items:e,renderItem:(t,o)=>d`<cosmoz-grouped-list-row
				.item=${t}
				.index=${o}
				.renderFn=${n}
