import{x as d,B as _e,E as ft,b as Pt}from"./iframe-B4I8_VN6.js";import{t as K,c as E,g as S,P as A,u as R,a as bt,m as xt,s as Bt,D as Gt,b as Ht,e as Wt,i as xe,h as Ve,d as qt,f as yt,r as Xt,j as Ut,k as _,l as Kt,n as ye,p as pe,o as O,q as Jt,v as ve,w as Qt,x as Yt,y as Zt,T as en,z as T,A as ge,B as tn,C as nn,E as on,F as z,G as rn,H as ln,I as vt,J as De,K as I,L as $t,M as Ae,N as an,O as wt,Q as sn,R as Ee,S as Je,U as un,V as Te,W as cn,X as dn,Y as Ie,Z as Le,_ as mn,$ as Fe,a0 as B,a1 as pn,a2 as we,a3 as gn}from"./cosmoz-collapse-CdJQwoXh.js";const hn=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,Rn=n=>{const{label:e,value:t,slot:o}=n,r=d`<div
	...
	>
		${t||""}
	</div>`;return Xt(r,{label:e})};customElements.define("cosmoz-omnitable-dropdown-input",E(Rn,{observedAttributes:Tn,styleSheets:[Ln]}));const ee=({title:n,tooltip:e="",filterText:t="",onOpenedChanged:o,content:r,horizontalAlign:i="left",externalValues:l=null})=>{const a={filtered:!!t,...l!=null&&{[`external-values-${l}`]:!0}};return d`
		<style>
			.dropdown {
				outline: none;
			}
	...
	`};class Mn extends Re(Z(A)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return d`
			<style>
		...
		>`}getComparableValue(e,t){return Zn(e,t)}}customElements.define("cosmoz-omnitable-column-autocomplete",eo);const He=(n,e)=>e.find(({value:t})=>n===t),to=(n,e,t)=>{const o=He(e,t);return o?o.text:n},nt=(n,e,t,o)=>to(n,S(e,t),o),no=({valuePath:n},e,t)=>He(S(e,n),t),oo=n=>e=>{n(t=>({...t,filter:e?.[0]?.value??null}))},ro=n=>e=>{n(t=>({...t,headerFocused:e}))},io=n=>e=>{n(t=>({...t,query:e}))},lo=n=>e=>n(e?.[0]?.value),ot=({valuePath:n,trueLabel:e,falseLabel:t},o)=>S(o,n)?e:t,ao=({valuePath:n},e)=>t=>S(t,n)===e,ne=xt((n,e)=>[{text:n,value:!0},{text:e,value:!1}]),so=({valuePath:n,trueLabel:e,falseLabel:t},o)=>n?S(o,n)?e:t:"",uo=(n,e)=>{try{return JSON.parse(e)}catch{return null}};class co extends M(A){static get properties(){return{trueLabel:{type:String,value:"True"},falseLabel:{type:String,value:"False"},flex:{type:String,value:"0"},cellClass:{type:String,value:"boolean-cell"}}}getString(e,t){return ot(e,t)}renderCell(e,{item:t}){return ot(e,t)}renderEditCell(e,{item:t},o){const{trueLabel:r,falseLabel:i}=e;return d`<cosmoz-autocomplete
			no-label-float
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return Y(e,t)}}customElements.define("cosmoz-omnitable-column-date",bo);class xo extends Ge(M(A)){renderCell({valuePath:e,textProperty:t},{item:o}){const r=Me(o,e,t).map(i=>d`<li>${i}</li>`);return d`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:o},r,i){return d`<cosmoz-autocomplete-ui
			...
			.onText=${Be(r)}
			>${O(e.loading,()=>d`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}}customElements.define("cosmoz-omnitable-column-list",yo);class vo extends Re(Z(A)){static get properties(){return{maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null},formatter:{type:Object,computed:"_computeFormatter(locale, minimumFractionDigits, maximumFractionDigits)"},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, formatter)"},headerFocused:{type:Boolean,value:!1}}}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return d`
			<style>
				cosmoz-input[type='number'] {
					background: var(--cosmoz-omnitable-amount-input-background, #ffffff);
					border-radius: 6px;
		...
		></cosmoz-omnitable-number-range-input>`}computeSource(e,t){return Y(e,t)}}customElements.define("cosmoz-omnitable-column-number",$o);const Vt="1970-01-01",H=(n,e,t)=>{const o=typeof n=="string"&&n.length>3&&n.length<=9?qe(Vt+"T"+n):n;return D(o)},re={},wo=n=>{const e=n||"";if(re[e])return re[e];const t={hour:"numeric",minute:"numeric",second:"numeric"};return re[e]=new Intl.DateTimeFormat(n||void 0,t),re[e]},de=({valuePath:n,locale:e},t)=>{const o=H(S(t,n||""));return o===void 0?"":o===null?"Invalid Date":Xe(o,wo(e))},zo=(n,e)=>n.valuePath?de(n,e):"",So=n=>{const e=H(n);if(e==null)return null;const t=ve(e);return t&&t.slice(11,19)},X=({valuePath:n},e)=>{if(e==null)return;const t=So(n==null?e:S(e,n));if(t==null)return;const o=H(qe(Vt+"T"+t));return o==null?o:L(o.getTime())},Co=(n,e)=>t=>{const o=X(n,t);if(o==null)return!1;const r=X({...n,valuePath:"min"},e),i=X({...n,valuePath:"max"},e);return r==null||i==null?!1:!(o<r||o>i)},at=n=>{const e=H(n);return e==null?"":e.toISOString().slice(11,19).replace(/:/gu,".")},st=n=>{if(!(n==null||n===""))return H(typeof n=="string"?n.replace(/\./gu,":")+"Z":n)};class ko extends We(Z(A)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return d`
			<cosmoz-clear-button
				@click=${()=>this.resetFilter()}
				?visible=${this.hasFilter()}
			></cosmoz-clear-button>
...
`);l.unshift(i),wt(new File(l,t,{type:"text/csv;charset=utf-8"}))},Qo=(n,e)=>{const t=n.map(r=>r.title),o=e.map(r=>n.map(i=>{const l=i.toXlsxValue(i,r);return l??""}));return o.unshift(t),o},Yo=(n,e,t,o)=>{const r=Qo(n,e),i=new sn(t).addSheetFromData(r,o).generate();wt(new File([i],t,{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}))},me=Symbol("All"),Zo=({columns:n,selectedItems:e,csvFilename:t,xlsxFilename:o,xlsxSheetname:r,topPlacement:i,enableSelectAll:l,onSelectAllMatching:a,visibleData:u=[]})=>{const s=e===me||!Ee(e.length),c=e===me?u.length:e.length;return d`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${s}
		part="bottomBar"
	...
	>
		${O(l,()=>d`<div slot="info" style="color: white">
					${c} selected items.
					${e===me?d`All matching items selected.`:d`<button
								@click=${a}
...
`,Lr=n=>n?"groupRow groupRow-folded":"groupRow",Rr=({item:n,index:e})=>t=>O(t?.length>0,()=>d`
	...
	`,Nr=({onCheckboxChange:n,dataIsValid:e,groupOnColumn:t})=>(o,r,{selected:i,folded:l,toggleFold:a})=>d` <div
		...
		</div>`,jr=({host:n,error:e,dataIsValid:t,processedItems:o,columns:r,collapsedColumns:i,miniColumns:l,sortAndGroupOptions:a,rowPartFn:u,...s})=>{const{loading:c=!1,displayEmptyGroups:m=!1,compareItemsFn:h}=n,p=Le({shiftKey:!1,ctrlKey:!1}),y=z(g=>{const k=g.target.dataItem,f=g.target.checked;p.current.shiftKey?n.shadowRoot.querySelector("#groupedList").toggleSelectTo(k,f):p.current.ctrlKey?(g.target.checked=!0,n.shadowRoot.querySelector("#groupedList").selectOnly(k)):n.shadowRoot.querySelector("#groupedList").toggleSelect(k,f),g.preventDefault(),g.stopPropagation()},[]);T(()=>{const g=({shiftKey:k,ctrlKey:f})=>{p.current={shiftKey:k,ctrlKey:f}};return window.addEventListener("keydown",g),window.addEventListener("keyup",g),()=>{window.removeEventListener("keydown",g),window.removeEventListener("keyup",g)}},[]);const b=z(g=>{const k=g.composedPath();k.slice(0,k.indexOf(g.currentTarget)).find(v=>v.matches?.("a, .checkbox, .expand"))||n.dispatchEvent(new window.CustomEvent("omnitable-item-click",{bubbles:!0,composed:!0,detail:{item:g.currentTarget.dataItem,index:g.currentTarget.dataIndex}}))},[]),{groupOnColumn:x}=a,F=z((g,k)=>f=>En(n,g,k,f),[]);return{...s,processedItems:o,dataIsValid:t,filterIsTooStrict:t&&o.length<1,loading:c,compareItemsFn:h,displayEmptyGroups:m,error:e,renderItem:I(()=>Mr({columns:r,collapsedColumns:i,miniColumns:l,onItemClick:b,onCheckboxChange:y,dataIsValid:t,groupOnColumn:x,onItemChange:F,rowPartFn:u}),[r,i,b,y,t,x,F,u]),renderGroup:I(()=>Nr({onCheckboxChange:y,dataIsValid:t,groupOnColumn:x}),[y,t,x])}},Pr=(n,e)=>{if(n===e)return 0;if(n==null)return-1;if(e==null)return 1;const t=typeof n,o=typeof e;return t==="object"&&o==="object"?n.toString()<e.toString()?-1:1:t==="number"&&o==="number"?n-e:t==="string"&&o==="string"?n<e?-1:1:t==="boolean"&&o==="boolean"?n?-1:1:(console.warn("unsupported sort",t,n,o,e),0)},Ce=(n,e)=>(t,o)=>Pr(n(t),n(o))*(e?-1:1),Br=n=>n.replace(/([a-z0-9])([A-Z])/gu,"$1-$2").toLowerCase(),gt=(n,e)=>{!n||!e||Object.entries(e).forEach(([t,o])=>{n[G].__ownChange=!0,n[G][t]=o,n[G].__ownChange=!1,n[G].dispatchEvent(new CustomEvent(`${Br(t)}-changed`,{bubbles:!0,detail:{value:o}}))})},ke=(n,e)=>Object.assign(n,{[fe]:e}),ce=Symbol("unparsed"),Gr=({data:n,columns:e,hashParam:t,sortAndGroupOptions:o,noLocalSort:r,noLocalFilter:i})=>{const{groupOnColumn:l,groupOnDescending:a,sortOnColumn:u,descending:s}=o,c=z(([f,v])=>{const $=e.find(({name:w})=>w===f);return $==null?[f,void 0]:[f,v.filter&&$.serializeFilter($,v.filter)]},[e]),m=z(([f,v])=>{const $=e.find(({name:C})=>C===f);if($==null)return[f,{[ce]:v}];const w={filter:$.deserializeFilter($,v)};return gt($,w),[f,w]},[e]),[h,p]=J({},t,{multi:!0,suffix:"-filter--",write:c,read:m}),y=z((f,v)=>p($=>{const w=xe(v,$[f]);return gt(e.find(C=>C.name===f),w),{...$,[f]:{...$[f],...w}}}),[e,p]),b=I(()=>Object.values(h).map(f=>f.filter),[h]),x=I(()=>Object.fromEntries(e.map(f=>[f.name,!f.noLocalFilter&&f.getFilterFn(f,h[f.name]?.filter)]).filter(([,f])=>!!f)),[e,...b]),F=I(()=>!Array.isArray(n)||n.length===0?[]:Object.entries(x).length===0||i?n.slice():n.filter(f=>Object.values(x).every(v=>v(f))),[n,x,i]),g=I(()=>{if(!r&&!l&&u!=null&&u.sortOn!=null)return F.slice().sort(Ce(f=>u.getComparableValue({...u,valuePath:u.sortOn},f),s));if(l!=null&&l.groupOn!=null){const f=F.reduce((v,$)=>{const w=l.getComparableValue({...l,valuePath:l.groupOn},$);if(w===void 0)return v;let C=v.find(N=>N.id===w);return C?(C.items.push($),v):(C={id:w,name:w,items:[$]},[...v,C])},[]);return f.sort(Ce(v=>l.getComparableValue({...l,valuePath:l.groupOn},v.items[0]),a)),!u||r?f:f.filter(v=>Array.isArray(v.items)).map(v=>(v.items.sort(Ce($=>u.getComparableValue({...u,valuePath:u.sortOn},$),s)),v))}return F},[F,l,a,u,s,r]),k=I(()=>{let f=0,v=0;const $=[];return g.forEach(w=>{if(Array.isArray(w.items)){ke(w,v++),w.items.forEach(C=>{ke(C,f++),$.push(C)});return}return ke(w,f++),$.push(w)},[]),$},[g]);return T(()=>{p(f=>Object.values(f).some($=>$[ce]!=null)?Object.fromEntries(Object.entries(f).map(([$,w])=>w[ce]==null?[$,w]:m([$,w[ce]]))):f)},[m]),{processedItems:g,visibleData:k,filters:h,filterFunctions:x,setFilterState:y}},Hr=n=>{const e=o=>{const r=n.data.indexOf(o);if(r<0)return null;const i=n.data.splice(r,1);if(n.data=n.data.slice(),Array.isArray(i)&&i.length>0)return i[0]},t=(o,r)=>{n.data.splice(o,1,r),n.data=n.data.slice()};return{removeItem:e,removeItems(o){const r=[];for(let i=o.length-1;i>=0;i-=1){const l=n.removeItem(o[i]);l!=null&&r.push(l)}return r},replaceItemAtIndex:t,replaceItem(o,r){const i=n.data.indexOf(o);if(i>-1)return t(i,r)},selectItem(o){n.shadowRoot.querySelector("#groupedList").select(o)},selectAll(){n.shadowRoot.querySelector("#groupedList").selectAll()},deselectAll(){n.shadowRoot.querySelector("#groupedList").deselectAll()},deselectItem(o){n.shadowRoot.querySelector("#groupedList").deselect(o)},isItemSelected(o){return n.shadowRoot.querySelector("#groupedList").isItemSelected(o)}}},Wr=({host:n,visibleData:e,filters:t,...o})=>{const{setFilterState:r}=o,i=I(()=>Hr(n),[]);Fe(o,Object.values(o)),Fe(i,Object.values(i)),T(()=>{const a=u=>r(u.detail.name,s=>({...s,...u.detail.state}));return n.addEventListener("legacy-filter-changed",a),()=>n.removeEventListener("legacy-filter-changed",a)},[]),B("visibleData",e),B("sortedFilteredGroupedItems",o.sortedFilteredGroupedItems),B("selectedItems",o.selectedItems),B("sortOn",o.sortOn),B("descending",o.descending),B("isMini",o.isMini);const l=I(()=>Object.fromEntries(Object.entries(t).filter(([,{filter:a}])=>a!==void 0).map(([a,{filter:u}])=>[a,u])),[t]);B("filters",l,Object.values(l))},qr=n=>{const{hashParam:e,settingsId:t,data:o,resizeSpeedFactor:r,noLocal:i,noLocalSort:l=i,noLocalFilter:a=i,error:u,rowPartFn:s,enableSelectAll:c}=n,m=yr({settingsId:t,host:n}),{settings:h,setSettings:p,columns:y,resetRef:b}=m,x=Po(y,e,h,p,b),{processedItems:F,visibleData:g,filters:k,setFilterState:f,filterFunctions:v}=Gr({data:o,columns:y,hashParam:e,sortAndGroupOptions:x,noLocalSort:l,noLocalFilter:a}),{isMini:$,collapsedColumns:w,miniColumns:C}=Ar({host:n,columns:y,settings:h,setSettings:p,resizeSpeedFactor:r,sortAndGroupOptions:x}),N=o&&Array.isArray(o)&&o.length>0,[j,Ke]=R([]),jt=()=>Ke(me);return Wr({host:n,visibleData:g,sortedFilteredGroupedItems:F,columns:y,filters:k,setFilterState:f,selectedItems:j,isMini:$,...x}),{header:Tr({host:n,selectedItems:j,sortAndGroupOptions:x,dataIsValid:N,data:o,columns:y,filters:k,collapsedColumns:w,settings:h,filterFunctions:v,settingS:m,setFilterState:f,hideSelectAll:n.hideSelectAll===!0}),list:jr({host:n,error:u,dataIsValid:N,processedItems:F,setSelectedItems:Ke,columns:y,collapsedColumns:w,miniColumns:C,sortAndGroupOptions:x,rowPartFn:s}),footer:Er({host:n,selectedItems:j,columns:y,enableSelectAll:c,onSelectAllMatching:jt,visibleData:g})}};customElements.define("cosmoz-grouped-list-row",class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||_e(this._renderFn(this._item,this._index),this)}});const Xr={group:Symbol("group")},$e=(n,e)=>(e.has(n)||e.set(n,{}),e.get(n)),Ur=(n,e)=>!!$e(n,e).expanded,Kr=(n,e)=>!!$e(n,e).folded,Oe=n=>n?n.items instanceof Array:!1,Jr=n=>{if(!Array.isArray(n)||n.length===0)return;const e=Array.isArray(n[0]?.items);if(!n.every(o=>Array.isArray(o.items)===e))throw new Error("Data must be homogeneous.")},Qr=(n,e,t)=>Array.isArray(n)?(Jr(n),n.reduce((r,i)=>{const l=i;return l.items?l.items.length?$e(i,t).folded?r.concat(i):r.concat(i,l.items.map(a=>Object.assign(a,{[Xr.group]:i}))):e?r.concat(i):r:r.concat(i)},[])):void 0,Yr=(n,...e)=>typeof n=="function"?n(...e):n,Zr=(n,e)=>n===e,ei=()=>{const[n,e]=R(()=>[new WeakMap]);return{setItemState:z((o,r)=>e(([i])=>{const l=$e(o,i);return Object.assign(l,Yr(r,l)),[i]}),[]),state:n[0],signal:n}},ti=()=>{const{setItemState:n,state:e,signal:t}=ei(),o=z((i,l)=>{Oe(i)&&n(i,a=>({folded:l!==void 0?l:!a.folded}))},[]),r=z((i,l)=>{Oe(i)||n(i,a=>({expanded:l!==void 0?!l:!a.expanded}))},[]);return{state:e,signal:t,toggleFold:o,toggleCollapse:r}},ni=({initial:n,compareItemsFn:e,data:t,flatData:o})=>{const[r,i]=R(n),[l,a]=R(),u=z(g=>r.includes(g),[r]),s=z(g=>g?.items?.every(u)??!1,[u]),c=z(g=>u(g)||s(g),[u,s]),m=z(g=>{const f=g.items??[g];i(v=>[...v,...f.filter($=>!v.includes($))]),a(g)},[]),h=z(g=>{const f=g.items??[g];i(v=>v.filter($=>!f.includes($))),a(g)},[]),p=z(g=>{i(g.items?.slice()||[g]),a(g)},[]),y=z(()=>{i(t.flatMap(g=>g.items||g)),a(void 0)},[t]),b=z(()=>{i([]),a(void 0)},[]),x=z((g,k=!c(g))=>k?m(g):h(g),[c]),F=z((g,k)=>{if(!o)return;const f=l?o.findIndex(w=>e(w,l)):-1;if(f<0)return x(g,k);const[v,$]=[f,o.indexOf(g)].sort((w,C)=>w-C);o.slice(v,$+1).forEach((w,C,N)=>{C>0&&C<N.length-1&&Oe(w)||x(w,k)}),a(g)},[o,e,x]);return T(()=>i(g=>g.length>0&&o?o.filter(k=>g.find(f=>e(k,f))):g),[o]),{selectedItems:r,isItemSelected:u,isGroupSelected:s,isSelected:c,select:m,deselect:h,selectOnly:p,selectAll:y,deselectAll:b,toggleSelect:x,toggleSelectTo:F}},oi={host:{position:"relative",display:"flex",flexDirection:"column"}},ri=n=>{const{data:e,renderItem:t,renderGroup:o,displayEmptyGroups:r,compareItemsFn:i=Zr}=n,{toggleFold:l,toggleCollapse:a,state:u,signal:s}=ti(),c=I(()=>Qr(e,r,u),[e,r,s]),{selectedItems:m,isItemSelected:h,isGroupSelected:p,isSelected:y,select:b,deselect:x,selectOnly:F,selectAll:g,deselectAll:k,toggleSelect:f,toggleSelectTo:v}=ni({initial:[],compareItemsFn:i,data:e,flatData:c}),$=z((C,N)=>Array.isArray(C.items)?o(C,N,{selected:p(C),folded:Kr(C,u),toggleSelect:j=>f(C,typeof j=="boolean"?j:void 0),toggleFold:()=>l(C)}):t(C,N,{selected:m.includes(C),expanded:Ur(C,u),toggleSelect:j=>f(C,typeof j=="boolean"?j:void 0),toggleCollapse:()=>a(C)}),[t,o,m,f,s]);bt(()=>{Object.assign(n.style,oi.host)},[]),B("selectedItems",m);const w={toggleFold:l,toggleCollapse:a,isItemSelected:h,isGroupSelected:p,isSelected:y,select:b,deselect:x,selectOnly:F,selectAll:g,deselectAll:k,toggleSelect:f,toggleSelectTo:v};return Fe(w,Object.values(w)),{renderRow:$,flatData:c}},ii=({renderRow:n,flatData:e})=>pn({items:e,renderItem:(t,o)=>d`<cosmoz-grouped-list-row
				.item=${t}
				.index=${o}
				.renderFn=${n}
