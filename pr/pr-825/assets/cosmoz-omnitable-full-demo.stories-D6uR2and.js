import{x as d,B as ke,E as gt,b as Mt}from"./iframe-Bu3yeduy.js";import{t as K,c as E,g as C,P as A,u as M,a as ht,m as ft,s as Nt,D as jt,b as Pt,e as Bt,i as be,h as Oe,d as Gt,f as bt,r as Ht,j as Wt,k as _,l as qt,n as xe,p as me,o as V,q as Xt,v as ve,w as Ut,x as Kt,y as Jt,T as Yt,z as T,A as pe,B as Qt,C as Zt,E as en,F as $,G as tn,H as nn,I as xt,J as Ve,K as I,L as vt,M as De,N as on,O as yt,Q as rn,R as Ae,S as Ue,U as ln,V as Ee,W as an,X as sn,Y as _e,Z as Te,_ as un,$ as Ie,a0 as P,a1 as cn,a2 as $e,a3 as dn}from"./cosmoz-collapse-PVplUGEf.js";const mn=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`;customElements.define("cosmoz-omnitable-item-expand-line",E(Bo,{styleSheets:[De(Po)]}));const Go=({columns:n,item:e,selected:t,expanded:o,groupOnColumn:r})=>on(n,i=>d`<cosmoz-omnitable-item-expand-line
			...
			>`);customElements.define("cosmoz-omnitable-item-expand",E(Go,{useShadowDOM:!1}));const Ho=(n,e,t)=>n.editable?n.renderEditCell(n,e,t(n,e.item)):n.renderCell(n,e),Wo=({columns:n,groupOnColumn:e,item:t,index:o,selected:r,expanded:i,onItemChange:l})=>vt(n,a=>a.name,a=>d`<div
...
`);l.unshift(i),yt(new File(l,t,{type:"text/csv;charset=utf-8"}))},Uo=(n,e)=>{const t=n.map(r=>r.title),o=e.map(r=>n.map(i=>{const l=i.toXlsxValue(i,r);return l??""}));return o.unshift(t),o},Ko=(n,e,t,o)=>{const r=Uo(n,e),i=new rn(t).addSheetFromData(r,o).generate();yt(new File([i],t,{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}))},Jo=({columns:n,selectedItems:e,csvFilename:t,xlsxFilename:o,xlsxSheetname:r,topPlacement:i})=>d`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!Ae(e.length)}
		part="bottomBar"
	...
	</cosmoz-bottom-bar>`,Yo=({allSelected:n,onAllCheckboxChange:e,sortAndGroup:t,dataIsValid:o,data:r,columns:i,filters:l,groupOnColumn:a,setFilterState:u,settingsConfig:s,hideSelectAll:c})=>d`<sort-and-group-provider .value=${t}>
