import{x as d,B as ke,E as gt,b as Mt}from"./iframe-JRrQCErP.js";import{t as K,c as E,g as C,P as A,u as M,a as ht,m as ft,s as Nt,D as jt,b as Pt,e as Bt,i as be,h as Oe,d as Gt,f as bt,r as Ht,j as Wt,k as _,l as qt,n as xe,p as me,o as V,q as Xt,v as ve,w as Ut,x as Kt,y as Jt,T as Yt,z as T,A as pe,B as Qt,C as Zt,E as en,F as $,G as tn,H as nn,I as xt,J as Ve,K as I,L as vt,M as De,N as on,O as yt,Q as rn,R as Ae,S as Ue,U as an,V as Ee,W as ln,X as sn,Y as _e,Z as Te,_ as un,$ as Ie,a0 as P,a1 as cn,a2 as $e,a3 as dn}from"./cosmoz-collapse-BTMSuZ_T.js";const mn=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,En=n=>{const{label:e,value:t,slot:o}=n,r=d`<div
	...
	>
		${t||""}
	</div>`;return Ht(r,{label:e})};customElements.define("cosmoz-omnitable-dropdown-input",E(En,{observedAttributes:Dn,styleSheets:[An]}));const ee=({title:n,tooltip:e="",filterText:t="",onOpenedChanged:o,content:r,horizontalAlign:i="left",externalValues:a=null})=>{const l={filtered:!!t,...a!=null&&{[`external-values-${a}`]:!0}};return d`
		<style>
			.dropdown {
				outline: none;
			}
	...
	`};class Tn extends Le(Z(A)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return d`
		...
		>`}getComparableValue(e,t){return Jn(e,t)}}customElements.define("cosmoz-omnitable-column-autocomplete",Yn);const Ge=(n,e)=>e.find(({value:t})=>n===t),Qn=(n,e,t)=>{const o=Ge(e,t);return o?o.text:n},et=(n,e,t,o)=>Qn(n,C(e,t),o),Zn=({valuePath:n},e,t)=>Ge(C(e,n),t),eo=n=>e=>{n(t=>({...t,filter:e?.[0]?.value??null}))},to=n=>e=>{n(t=>({...t,headerFocused:e}))},no=n=>e=>{n(t=>({...t,query:e}))},oo=n=>e=>n(e?.[0]?.value),tt=({valuePath:n,trueLabel:e,falseLabel:t},o)=>C(o,n)?e:t,ro=({valuePath:n},e)=>t=>C(t,n)===e,ne=ft((n,e)=>[{text:n,value:!0},{text:e,value:!1}]),io=({valuePath:n,trueLabel:e,falseLabel:t},o)=>n?C(o,n)?e:t:"",ao=(n,e)=>{try{return JSON.parse(e)}catch{return null}};class lo extends N(A){static get properties(){return{trueLabel:{type:String,value:"True"},falseLabel:{type:String,value:"False"},flex:{type:String,value:"0"},cellClass:{type:String,value:"boolean-cell"}}}getString(e,t){return tt(e,t)}renderCell(e,{item:t}){return tt(e,t)}renderEditCell(e,{item:t},o){const{trueLabel:r,falseLabel:i}=e;return d`<style>
			...
			>`}renderHeader(e,{filter:t,query:o},r,i){return d`<style>
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return Q(e,t)}}customElements.define("cosmoz-omnitable-column-date",go);class ho extends Be(N(A)){renderCell({valuePath:e,textProperty:t},{item:o}){const r=Re(o,e,t).map(i=>d`<li>${i}</li>`);return d`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		`}renderEditCell(){return"not implemented"}renderHeader(e,{filter:t,query:o},r,i){return d`<cosmoz-autocomplete-ui
			...
			.onText=${Pe(r)}
			>${V(e.loading,()=>d`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}}customElements.define("cosmoz-omnitable-column-list-horizontal",ho);window.Cosmoz=window.Cosmoz||{};class rt extends Kt(Jt(Yt,A)){static get template(){return Oe`
			<style>
				:host {
					display: block;
				}
...
`,Dt=n=>(e,t,o=Qt)=>{const r=nn(),i=new URLSearchParams(r.hash.replace("#",""));return n(e,t,o,i),"#!"+Object.assign(r,{hash:i}).href.replace(location.origin,"")},At=n=>n==null||n==="",To=Dt((n,e,t,o)=>At(t(e))?o.delete(n):o.set(n,t(e))),Lo=Dt((n,e,t,o)=>Object.entries(e).map(t).forEach(([r,i])=>At(i)?o.delete(n+r):o.set(n+r,i))),J=(n,e,{suffix:t="",read:o,write:r,multi:i}={})=>{const[a,l]=i?[Lo,Zt]:[To,en],[u,s]=M(()=>e==null?n:l(e+t,o)??n),c=$(m=>s(h=>{const p=be(m,h);return e!=null&&tn(a(e+t,p,r),null,{notify:!1}),p}),[e,t,a,r]);return[u,c]},Ro=n=>[!0,"true",1,"yes","on"].includes(n),ae=n=>n===""||(n==null?void 0:Ro(n)),le=(n,e,t)=>$(o=>{n(o),t(r=>({...r,[e]:o}))},[n,e,t]),Mo=(n,e,t,o,r)=>{const[i,a]=J(t.sortOn,e,{suffix:"-sortOn"}),[l,u]=J(ae(t.descending),e,{suffix:"-descending",read:ae}),[s,c]=J(t.groupOn,e,{suffix:"-groupOn"}),[m,h]=J(ae(t.groupOnDescending),e,{suffix:"-groupOnDescending",read:ae}),p=I(()=>n.find(g=>g.name===i),[n,i]),z=I(()=>n.find(g=>g.name===s),[n,s]),b={groupOn:s,setGroupOn:le(c,"groupOn",o),groupOnDescending:m,setGroupOnDescending:le(h,"groupOnDescending",o),sortOn:i,setSortOn:le(a,"sortOn",o),descending:l,setDescending:le(u,"descending",o),columns:n},y=I(()=>b,Object.values(b)),F=$(g=>{a(g.sortPath),c(g.groupOn),u(g.descending),h(g.groupOnDescending)},[]);return T(()=>void(r.current=F),[]),{...y,sortAndGroup:y,groupOnColumn:z,sortOnColumn:p}},Xe=xt();customElements.define("sort-and-group-provider",Xe.Provider);customElements.define("sort-and-group-consumer",E(({render:n})=>n(Ve(Xe)),{useShadowDOM:!1}));const No=({data:n,columns:e,groupOnColumn:t,filters:o,setFilterState:r,sortAndGroup:{sortOn:i,setSortOn:a,descending:l,setDescending:u}={}})=>vt(e,s=>s.name,s=>[d`<div
			...
			>
				...
				${V(!s.noSort,()=>Ot({on:i,setOn:a,descending:l,setDescending:u,column:s}))}
...
`;customElements.define("cosmoz-omnitable-item-expand-line",E(Bo,{styleSheets:[De(Po)]}));const Go=({columns:n,item:e,selected:t,expanded:o,groupOnColumn:r})=>on(n,i=>d`<cosmoz-omnitable-item-expand-line
			...
			>`);customElements.define("cosmoz-omnitable-item-expand",E(Go,{useShadowDOM:!1}));const Ho=(n,e,t)=>n.editable?n.renderEditCell(n,e,t(n,e.item)):n.renderCell(n,e),Wo=({columns:n,groupOnColumn:e,item:t,index:o,selected:r,expanded:i,onItemChange:a})=>vt(n,l=>l.name,l=>d`<div
				...
				name="${l.name}"
			>
				${Ho(l,{item:t,index:o,selected:r,expanded:i},a)}
...
`,ct=n=>{const e=n.replace(/"/gu,'""');return e.search(/("|,|\n)/gu)>=0?'"'+e+'"':n},Xo=(n,e,t)=>{const i=n.map(l=>ct(l.title)).join(";")+`
`,a=e.map(l=>n.map(u=>{const s=u.getString(u,l);return s==null?"":ct(String(s))}).join(";")+`
`);a.unshift(i),yt(new File(a,t,{type:"text/csv;charset=utf-8"}))},Uo=(n,e)=>{const t=n.map(r=>r.title),o=e.map(r=>n.map(i=>{const a=i.toXlsxValue(i,r);return a??""}));return o.unshift(t),o},Ko=(n,e,t,o)=>{const r=Uo(n,e),i=new rn(t).addSheetFromData(r,o).generate();yt(new File([i],t,{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}))},Jo=({columns:n,selectedItems:e,csvFilename:t,xlsxFilename:o,xlsxSheetname:r,topPlacement:i})=>d`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!Ae(e.length)}
		part="bottomBar"
	...
	</cosmoz-bottom-bar>`,Yo=({allSelected:n,onAllCheckboxChange:e,sortAndGroup:t,dataIsValid:o,data:r,columns:i,filters:a,groupOnColumn:l,setFilterState:u,settingsConfig:s,hideSelectAll:c})=>d`<sort-and-group-provider .value=${t}>
...
`,Zo=({settingsConfig:n})=>{const{columns:e,collapsed:t}=n,o=e.filter(r=>!t.some(i=>i.name===r.name));return d`<div class="skeleton">
	...
	</div>`};customElements.define("cosmoz-omnitable-skeleton",E(Zo,{styleSheets:[Qo]}));const er=({slot:n,title:e,className:t,width:o="24",height:r="24",styles:i}={})=>d`
  <svg
    slot=${pe(n)}
    class=${`delete-icon ${t??""}`}
    viewBox="0 0 24 24"
...
`,tr=(n,e)=>{const{settingsConfig:t}=n,{processedItems:o,dataIsValid:r,filterIsTooStrict:i,loading:a,displayEmptyGroups:l,compareItemsFn:u,setSelectedItems:s,renderItem:c,renderGroup:m,error:h}=e;return d`${V(!a&&!r&&!h,()=>d`<div class="tableContent-empty">
...
`,se=n=>{const e=parseInt(n,10);return isFinite(e)?e:void 0},rr=n=>{const{config:e}=n,{settings:t,setSettings:o,collapsed:r}=e,i=Ee({collapsed:r,settings:t.columns,setSettings:$(a=>o(l=>({...l,columns:a})),[o])});return{...e,onDown:$(a=>{a.target.closest(".pull")&&(i.handle=a.currentTarget)},[i]),onDragStart:$(a=>{const{target:l}=a,u=se(l.dataset.index);if(!i.handle?.contains(l)||u==null)return a.preventDefault();i.handle=null,a.dataTransfer.effectAllowed="move",a.dataTransfer.setData("omnitable/sort-index",u),a.dataTransfer.setData("text/plain",u),setTimeout(()=>l.classList.add("drag"),0),l.addEventListener("dragend",s=>s.target.classList.remove("drag"),{once:!0})},[i]),onDragEnter:$(a=>{const l=a.currentTarget;l===a.target&&(a.preventDefault(),a.dataTransfer.dropEffect="move",l.classList.add("dragover"))},[]),onDragOver:$(a=>{a.preventDefault(),a.currentTarget.classList.add("dragover")},[]),onDragLeave:$(a=>{const l=a.currentTarget;l.contains(a.relatedTarget)||l.classList.remove("dragover")},[]),onDrop:$(a=>{const l=se(a.dataTransfer.getData("omnitable/sort-index")),u=se(a.currentTarget.dataset.index),{settings:s,setSettings:c}=i;a.currentTarget.classList.remove("dragover"),a.preventDefault();const m=s.slice();m.splice(u+(l>=u?0:-1),0,m.splice(l,1)[0]),c(m)},[i]),onToggle:$(a=>{const{settings:l,setSettings:u}=i,s=l.map(m=>({...m,disabled:m.disabled||i.collapsed?.some(h=>h.name===m.name)})),c=se(a.target.closest("[data-index]")?.dataset.index);s.splice(c,1,{...l[c],disabled:!a.target.checked,priority:a.target.checked?l.reduce((m,h)=>Math.max(m,h.priority),0)+1:l[c].priority}),u(s)},[i])}},ir=[ln({apply({availableHeight:n,elements:e}){Object.assign(e.floating.style,{maxHeight:`${Math.max(0,n)}px`})}}),...sn],ar=({onDragStart:n,onDragEnter:e,onDragOver:t,onDragLeave:o,onDrop:r,onDown:i,onToggle:a,collapsed:l,filters:u})=>(s,c)=>{const m=!!l?.find(p=>p.name===s.name),h=!s.disabled&&!m;return d` <div
			class="item"
			data-index=${c}
			@mousedown=${i}
			draggable="true"
		...
		>
			...
			<input
				...
				.indeterminate=${m}
			/>
		</div>`},lr=n=>{const{settings:e,settingsId:t,onSave:o,onReset:r,hasChanges:i,opened:a,setOpened:l,...u}=rr(n);return d` <div class="headline">
			${_("Sort and filter")}
			<button
				class="close"
		...
		<div class="contents">
			...
			>
				<div class="list">${e.columns?.map(ar(u))}</div>
			</cosmoz-collapse>
			...
			<cosmoz-collapse ?opened=${a.sort}> ${Eo()} </cosmoz-collapse>
		...
		${V(t,()=>d`<div class="buttons">
				...
				</div>`)}`};customElements.define("cosmoz-omnitable-settings-ui",E(lr,{styleSheets:[De(nr)]}));const sr=({config:n,newLayout:e})=>d`
	<cosmoz-dropdown
...
`;customElements.define("cosmoz-omnitable-settings",E(sr,{styleSheets:[De(or)]}));const ge=["sortOn","descending","groupOn","groupOnDescending"],ue=n=>e=>typeof e=="object"&&e!==null&&"name"in e&&e.name===n,ur=(n=[],e=[],t=[])=>{const o=e.filter(a=>n.some(ue(a.name))),r=n.filter(a=>a.name!=null&&!e.some(ue(a.name))&&!t.some(ue(a.name))),i=t.filter(a=>!e.some(ue(a.name)));return[...o,...i.flatMap(a=>{const l=n.find(u=>u.name===a.name);return l?{...a,title:l.title??a.title??"",minWidth:parseInt(l.minWidth??"0",10)}:[]}),...r.map(a=>{const{name:l,title:u,priority:s,minWidth:c,width:m,flex:h}=a;return{name:l??"",title:u??"",priority:s??0,minWidth:parseInt(c??"0",10),width:parseInt(m??"0",10),flex:parseInt(h??"0",10)}})]},cr=(n,e)=>({...e,..._e(Array.from(ge))(n),columns:n.columns?.map(_e(["name","priority","width","flex","disabled"]))}),dr=({columns:n,settings:e,savedSettings:t,initial:o})=>({...Object.fromEntries(ge.flatMap(i=>o?.[i]!=null?[[i,o[i]]]:[])),...t?_e(Array.from(ge))(t):{},...e,columns:ur(n,e?.columns,t?.columns)}),mr=({prefix:n="omnitable-"}={})=>({write:async(t,o)=>{const r=n+t;try{o?localStorage.setItem(r,JSON.stringify(o)):localStorage.removeItem(r)}catch(i){console.error(i)}},read:async t=>{if(t)try{const o=localStorage.getItem(n+t);return o==null?void 0:JSON.parse(o)}catch(o){console.error(o)}}}),pr=xt(mr),gr=()=>{const n=Ve(pr);return I(()=>n(),[n])},hr=(n,e,t,o)=>{const[r,i]=M(),{read:a,write:l}=gr();return T(async()=>{n&&i(await a(n))},[n,a]),{settingsId:n,savedSettings:r,onSave:$(async()=>{if(!n)return;const u=cr(e,r);await l(n,u),t(),i(u)},[e,r]),onReset:$(async u=>{t(),u.shiftKey&&(await l(n),i()),o?.()},[o]),hasChanges:e!=null}},fr=({settingsId:n,host:e})=>{const t=I(()=>Object.fromEntries(ge.map(b=>[b,e[b]])),[]),o=Te(),r=$(()=>{o.current?.(t)},[t]),[i,a]=M(),[l,u]=M({columns:!0,sort:!0}),{savedSettings:s,...c}=hr(n,i,a,r),{enabledColumns:m}=e,h=On(e,{enabledColumns:m}),p=I(()=>dr({columns:h,settings:i,savedSettings:s,initial:t}),[h,i,s]),z=I(()=>p.columns.map(b=>h.find(y=>y.name===b.name)).filter(Boolean),[h,...p.columns.map(b=>b.name)]);return{...c,opened:l,setOpened:u,settings:p,columns:z,setSettings:a,resetRef:o}},dt=n=>Number.isFinite(n)?n:0,br=(n,e)=>{const t=[];let[o,r]=n.reduce(([c,m],{width:h,flex:p})=>[c+h,m+p],[0,0]),i=e-o,a=dt(i/r),l=0,u=0,s=0;for(let c=0;c<n.length;c++){const{width:m,minWidth:h,flex:p}=n[c],z=i>=0?a*p:m*i/o;if(h>m+z){l+=m,u+=h,s+=p,t[c]=h;continue}if(p===0){l+=m,u+=m,t[c]=m;continue}}o-=l,i=e-u-o,r-=s,a=dt(i/r);for(let c=0;c<n.length;c++){if(t[c]!=null)continue;const{width:m,flex:h}=n[c],p=i>=0?a*h:m*i/o;t[c]=m+p}return t},he=Symbol("index"),xr=(n,e)=>{if(typeof n.findLastIndex=="function")return n.findLastIndex(e);for(let t=n.length-1;t>=0;t--)if(e(n[t],t,n))return t;return-1},vr=(n,e)=>{const t=xr(n,a=>a!=null&&a>0),o=(a,l)=>`.cell[name="${a}"], cosmoz-omnitable-skeleton::part(cell-${a}){width: ${Math.floor(l)}px;padding: 0 min(3px, ${l/2}px)}`,r=a=>`cosmoz-omnitable-resize-nub[name="${a}"]{display:none}`,i=a=>`cosmoz-omnitable-resize-nub[name="${a}"], .cell[name="${a}"]{display:none}`;return e.map((a,l)=>{const u=n[l];if(u==null||u===0)return i(a.name);const s=o(a.name,u);return l===t?`${s}
${r(a.name)}`:s}).join(`
`)},Tt=(n,e,t)=>{const o=n.filter(l=>!l.hidden),r=o.reduce((l,{width:u})=>l+u,0);if(o.length>1&&r>e)return Tt(o.slice(1),e,t);const i=o.reduce(([l,u],s,c)=>[Math.max(l,s.index),s.index>l?c:u],[-1,-1])[1];return i!==-1&&(o[i].flex=1),br(o,e).reduce((l,u,s)=>(l[o[s].index]=u,l),new Array(t).fill(void 0))},yr=(n,e)=>n.length===0?".cell {display: none;}":vr(n,e),$r=({host:n,canvasWidth:e,layout:t,setSettings:o})=>{const r=Te();r.current=i=>o(a=>{const l=a.columns,{detail:{newWidth:u,column:s}}=i,c=l.findIndex(p=>p.name===s.name),m=[],h=l.reduce((p,z)=>Math.max(p,z.priority),-1/0);for(let p=0;p<t.length;p++)if(m[p]={...l[p]},p<c&&t[p]!=null&&(m[p].width=t[p],m[p].flex=0,m[p].priority=h),p===c){const z=t.reduce((b,y,F)=>F<c&&y?b-y:b,e);m[p].width=Math.min(z,Math.max(u,l[p].minWidth)),m[p].flex=0,m[p].priority=h}return{...a,columns:m}}),T(()=>{const i=a=>r.current?.(a);return n.addEventListener("column-resize",i),()=>n.removeEventListener("column-resize",i)},[])},wr=(n,e)=>T(()=>{const t=([r])=>{r.contentRect?.width!==0&&requestAnimationFrame(()=>e(r.contentRect?.width-20-44-24))},o=new ResizeObserver(t);return o.observe(n),()=>o.unobserve(n)},[]),zr=n=>{const[e,t]=M(()=>n.getBoundingClientRect().width);return wr(n,t),e},Cr=(n,e)=>{const t=I(()=>{let o=!1,r;const i=()=>{if(!o)return;r=requestAnimationFrame(i),n()&&(o=!1)};return{start:()=>{o=!0,cancelAnimationFrame(r),r=requestAnimationFrame(i)},stop:()=>{o=!1,cancelAnimationFrame(r)}}},[]);T(()=>{t.start()},e),T(()=>()=>t.stop(),[])},Sr=(n=0,e=0)=>Math.abs((n??0)-(e??0))<.1,kr=(n,e=1.9,t=un)=>{const o=Ee({target:n}),r=$(()=>{if(o.tween||(o.tween=o.target),o.target.every((i,a)=>o.tween[a]===i))return t(o.tween),!0;o.tween=o.target.map((i,a)=>Sr(o.tween[a],i)?i:(o.tween[a]??0)+((i??0)-(o.tween[a]??0))/e||0),t(o.tween)},[]);Cr(r,[n])},_r=({canvasWidth:n,groupOnColumn:e,config:t,miniColumn:o})=>I(()=>{if(!Array.isArray(t)||n==null||n===0)return[];const r=t.map((i,a)=>({minWidth:i.minWidth,width:i.width,flex:i.flex,priority:i.priority,name:i.name,index:a,hidden:i.name===e?.name||i.disabled})).map(i=>o?{...i,hidden:o.name!==i.name}:i).sort(({index:i,priority:a},{index:l,priority:u})=>a===u?l-i:a-u);return Tt(r,n,r.length)},[n,e,t]),Ir=({host:n,canvasWidth:e,columns:t})=>{const o=n.miniBreakpoint??480,r=I(()=>e<=o,[e,o]),i=I(()=>r?t?.filter(s=>s.mini!=null).sort((s,c)=>(s.mini??0)-(c.mini??0)):[],[t,r]),[a,...l]=i??[],u=!!a;return T(()=>{n.toggleAttribute("mini",u)},[u]),{isMini:u&&r,miniColumn:a,miniColumns:l}},Fr=n=>{const e=I(()=>new CSSStyleSheet,[]);return T(()=>{n.shadowRoot.adoptedStyleSheets=[...n.shadowRoot.adoptedStyleSheets,e]},[]),e},Or=({host:n,columns:e,settings:t,setSettings:o,resizeSpeedFactor:r,sortAndGroupOptions:i})=>{const a=zr(n),{isMini:l,miniColumn:u,miniColumns:s}=Ir({host:n,canvasWidth:a,columns:e}),{groupOnColumn:c}=i,m=_r({canvasWidth:a,groupOnColumn:c,miniColumn:u,config:t.columns}),h=Fr(n),p=I(()=>t.columns.reduce((b,y,F)=>m[F]!=null||y.name===c?.name||y.disabled?b:[...b,e.find(g=>g.name===y.name)].filter(g=>g!=null),[]),[e,t,m,c]),z=Ee({columns:t.columns});return kr(m,r,b=>{const y=yr(b,z.columns);h.replace(y)}),$r({host:n,canvasWidth:a,layout:m,setSettings:b=>o(b(t))}),{isMini:l,collapsedColumns:p,miniColumns:s}},Vr=({host:n,...e})=>{const{csvFilename:t="omnitable.csv",xlsxFilename:o="omnitable.xlsx",xlsxSheetname:r="Omnitable",topPlacement:i="top-end"}=n;return{csvFilename:t,xlsxFilename:o,xlsxSheetname:r,topPlacement:i,...e}},Dr=({host:n,selectedItems:e,data:t,sortAndGroupOptions:o,collapsedColumns:r,settings:i,filterFunctions:a,settingS:l,filters:u,...s})=>{const c=t&&t.length>0&&e.length===t.length,m=b=>{b.target.checked?n.shadowRoot.querySelector("#groupedList").selectAll():n.shadowRoot.querySelector("#groupedList").deselectAll()},{groupOnColumn:h}=o,p=I(()=>[h,...r,...i.columns.filter(b=>b.disabled)].some(b=>b&&Object.keys(a).includes(b.name)),[a,i,r]),z=I(()=>({...l,collapsed:r,badge:p,filters:u}),[l,r,p,u]);return T(()=>{const b=n.shadowRoot.querySelector("#tableContent"),y=new ResizeObserver(F=>requestAnimationFrame(()=>{n.style.setProperty("--ot-height",F[0]?.contentRect.height+"px")}));return y.observe(b),()=>y.unobserve(b)},[]),{allSelected:c,onAllCheckboxChange:m,data:t,settingsConfig:z,filters:u,groupOnColumn:h,sortAndGroup:o.sortAndGroup,...s}},Lt=d`
	<svg
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
...
`,Ar=n=>n?"groupRow groupRow-folded":"groupRow",Er=({item:n,index:e})=>t=>V((t?.length??0)>0,()=>d`
			...
			`),Tr=({columns:n,collapsedColumns:e,miniColumns:t,onItemClick:o,onCheckboxChange:r,dataIsValid:i,groupOnColumn:a,onItemChange:l,rowPartFn:u})=>(s,c,{selected:m,expanded:h,toggleCollapse:p})=>d`
		<div
			?selected=${m}
	...
	`,Lr=({onCheckboxChange:n,dataIsValid:e,groupOnColumn:t})=>(o,r,{selected:i,folded:a,toggleFold:l})=>d` <div
			class="${Ar(a)}"
		...
		</div>`,Rr=({host:n,error:e,dataIsValid:t,processedItems:o,columns:r,collapsedColumns:i,miniColumns:a,sortAndGroupOptions:l,rowPartFn:u,...s})=>{const{loading:c=!1,displayEmptyGroups:m=!1,compareItemsFn:h}=n,p=Te({shiftKey:!1,ctrlKey:!1}),z=$(g=>{const k=g.target,f=k.dataItem,v=k.checked,x=n.shadowRoot.querySelector("#groupedList");p.current.shiftKey?x.toggleSelectTo(f,v):p.current.ctrlKey?(k.checked=!0,x.selectOnly(f)):x.toggleSelect(f,v),g.preventDefault(),g.stopPropagation()},[]);T(()=>{const g=({shiftKey:k,ctrlKey:f})=>{p.current={shiftKey:k,ctrlKey:f}};return window.addEventListener("keydown",g),window.addEventListener("keyup",g),()=>{window.removeEventListener("keydown",g),window.removeEventListener("keyup",g)}},[]);const b=$(g=>{const k=g.currentTarget,f=g.composedPath();f.slice(0,f.indexOf(k)).find(x=>x.matches?.("a, .checkbox, .expand"))||n.dispatchEvent(new window.CustomEvent("omnitable-item-click",{bubbles:!0,composed:!0,detail:{item:k.dataItem,index:k.dataIndex}}))},[]),{groupOnColumn:y}=l,F=$((g,k)=>f=>Vn(n,g,k,f),[]);return{...s,processedItems:o,dataIsValid:t,filterIsTooStrict:t&&o.length<1,loading:c,compareItemsFn:h,displayEmptyGroups:m,error:e,renderItem:I(()=>Tr({columns:r,collapsedColumns:i,miniColumns:a,onItemClick:b,onCheckboxChange:z,dataIsValid:t,groupOnColumn:y,onItemChange:F,rowPartFn:u}),[r,i,b,z,t,y,F,u]),renderGroup:I(()=>Lr({onCheckboxChange:z,dataIsValid:t,groupOnColumn:y}),[z,t,y])}},Mr=(n,e)=>{if(n===e)return 0;if(n==null)return-1;if(e==null)return 1;const t=typeof n,o=typeof e;return t==="object"&&o==="object"?n.toString()<e.toString()?-1:1:t==="number"&&o==="number"?n-e:t==="string"&&o==="string"?n<e?-1:1:t==="boolean"&&o==="boolean"?n?-1:1:(console.warn("unsupported sort",t,n,o,e),0)},Ce=(n,e)=>(t,o)=>Mr(n(t),n(o))*(e?-1:1),Nr=n=>n.replace(/([a-z0-9])([A-Z])/gu,"$1-$2").toLowerCase(),mt=(n,e)=>{!n||!e||Object.entries(e).forEach(([t,o])=>{n[B].__ownChange=!0,n[B][t]=o,n[B].__ownChange=!1,n[B].dispatchEvent(new CustomEvent(`${Nr(t)}-changed`,{bubbles:!0,detail:{value:o}}))})},Se=(n,e)=>Object.assign(n,{[he]:e}),ce=Symbol("unparsed"),jr=({data:n,columns:e,hashParam:t,sortAndGroupOptions:o,noLocalSort:r,noLocalFilter:i})=>{const{groupOnColumn:a,groupOnDescending:l,sortOnColumn:u,descending:s}=o,c=$(([f,v])=>{const x=e.find(({name:w})=>w===f);return x==null?[f,void 0]:[f,v.filter&&x.serializeFilter(x,v.filter)]},[e]),m=$(([f,v])=>{const x=e.find(({name:S})=>S===f);if(x==null)return[f,{[ce]:v}];const w={filter:x.deserializeFilter(x,v)};return mt(x,w),[f,w]},[e]),[h,p]=J({},t,{multi:!0,suffix:"-filter--",write:c,read:m}),z=$((f,v)=>p(x=>{const w=be(v,x[f]);return mt(e.find(S=>S.name===f),w),{...x,[f]:{...x[f],...w}}}),[e,p]),b=I(()=>Object.values(h).map(f=>f.filter),[h]),y=I(()=>Object.fromEntries(e.map(f=>[f.name,!f.noLocalFilter&&f.getFilterFn(f,h[f.name]?.filter)]).filter(([,f])=>!!f)),[e,...b]),F=I(()=>!Array.isArray(n)||n.length===0?[]:Object.entries(y).length===0||i?n.slice():n.filter(f=>Object.values(y).every(v=>v(f))),[n,y,i]),g=I(()=>{if(!r&&!a&&u!=null&&u.sortPath!=null)return F.slice().sort(Ce(f=>u.getComparableValue({...u,valuePath:u.sortPath},f),s));if(a!=null&&a.groupOn!=null){const f=F.reduce((v,x)=>{const w=a.getComparableValue({...a,valuePath:a.groupOn},x);if(w===void 0)return v;let S=v.find(R=>R.id===w);return S?(S.items.push(x),v):(S={id:w,name:w,items:[x]},[...v,S])},[]);return f.sort(Ce(v=>a.getComparableValue({...a,valuePath:a.groupOn},v.items[0]),l)),!u||r?f:f.filter(v=>Array.isArray(v.items)).map(v=>(v.items.sort(Ce(x=>u.getComparableValue({...u,valuePath:u.sortPath},x),s)),v))}return F},[F,a,l,u,s,r]),k=I(()=>{let f=0,v=0;const x=[];return g.forEach(w=>{if(Array.isArray(w.items)){Se(w,v++),w.items.forEach(S=>{Se(S,f++),x.push(S)});return}return Se(w,f++),x.push(w)},[]),x},[g]);return T(()=>{p(f=>Object.values(f).some(x=>x[ce]!=null)?Object.fromEntries(Object.entries(f).map(([x,w])=>w[ce]==null?[x,w]:m([x,w[ce]]))):f)},[m]),{processedItems:g,visibleData:k,filters:h,filterFunctions:y,setFilterState:z}},Pr=n=>{const e=o=>{const r=n.data.indexOf(o);if(r<0)return null;const i=n.data.splice(r,1);if(n.data=n.data.slice(),Array.isArray(i)&&i.length>0)return i[0]},t=(o,r)=>{n.data.splice(o,1,r),n.data=n.data.slice()};return{removeItem:e,removeItems(o){const r=[];for(let i=o.length-1;i>=0;i-=1){const a=n.removeItem(o[i]);a!=null&&r.push(a)}return r},replaceItemAtIndex:t,replaceItem(o,r){const i=n.data.indexOf(o);if(i>-1)return t(i,r)},selectItem(o){n.shadowRoot.querySelector("#groupedList").select(o)},selectAll(){n.shadowRoot.querySelector("#groupedList").selectAll()},deselectAll(){n.shadowRoot.querySelector("#groupedList").deselectAll()},deselectItem(o){n.shadowRoot.querySelector("#groupedList").deselect(o)},isItemSelected(o){return n.shadowRoot.querySelector("#groupedList").isItemSelected(o)}}},Br=({host:n,visibleData:e,filters:t,...o})=>{const{setFilterState:r}=o,i=I(()=>Pr(n),[]);Ie(o,Object.values(o)),Ie(i,Object.values(i)),T(()=>{const l=u=>r(u.detail.name,s=>({...s,...u.detail.state}));return n.addEventListener("legacy-filter-changed",l),()=>n.removeEventListener("legacy-filter-changed",l)},[]),P("visibleData",e),P("sortedFilteredGroupedItems",o.sortedFilteredGroupedItems),P("selectedItems",o.selectedItems),P("sortOn",o.sortOn),P("descending",o.descending),P("isMini",o.isMini);const a=I(()=>Object.fromEntries(Object.entries(t).filter(([,{filter:l}])=>l!==void 0).map(([l,{filter:u}])=>[l,u])),[t]);P("filters",a,Object.values(a))},Gr=n=>{const{hashParam:e,settingsId:t,data:o,resizeSpeedFactor:r,noLocal:i,noLocalSort:a=i,noLocalFilter:l=i,error:u,rowPartFn:s}=n,c=fr({settingsId:t,host:n}),{settings:m,setSettings:h,columns:p,resetRef:z}=c,b=Mo(p,e,m,h,z),{processedItems:y,visibleData:F,filters:g,setFilterState:k,filterFunctions:f}=jr({data:o,columns:p,hashParam:e,sortAndGroupOptions:b,noLocalSort:a,noLocalFilter:l}),{isMini:v,collapsedColumns:x,miniColumns:w}=Or({host:n,columns:p,settings:m,setSettings:h,resizeSpeedFactor:r,sortAndGroupOptions:b}),S=o&&Array.isArray(o)&&o.length>0,[R,H]=M([]);return Br({host:n,visibleData:F,sortedFilteredGroupedItems:y,columns:p,filters:g,setFilterState:k,selectedItems:R,isMini:v,...b}),{header:Dr({host:n,selectedItems:R,sortAndGroupOptions:b,dataIsValid:S,data:o,columns:p,filters:g,collapsedColumns:x,settings:m,filterFunctions:f,settingS:c,setFilterState:k,hideSelectAll:n.hideSelectAll===!0}),list:Rr({host:n,error:u,dataIsValid:S,processedItems:y,setSelectedItems:H,columns:p,collapsedColumns:x,miniColumns:w,sortAndGroupOptions:b,rowPartFn:s}),footer:Vr({host:n,selectedItems:R,columns:p})}};customElements.define("cosmoz-grouped-list-row",class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||ke(this._renderFn(this._item,this._index),this)}});const Hr={group:Symbol("group")},ye=(n,e)=>(e.has(n)||e.set(n,{}),e.get(n)),Wr=(n,e)=>!!ye(n,e).expanded,qr=(n,e)=>!!ye(n,e).folded,Fe=n=>n?n.items instanceof Array:!1,Xr=n=>{if(!Array.isArray(n)||n.length===0)return;const e=Array.isArray(n[0]?.items);if(!n.every(o=>Array.isArray(o.items)===e))throw new Error("Data must be homogeneous.")},Ur=(n,e,t)=>Array.isArray(n)?(Xr(n),n.reduce((r,i)=>{const a=i;if(!a.items)return r.concat(i);if(a.items.length){if(ye(i,t).folded)return r.concat(i);const l=a.items.map(u=>Object.assign(u,{[Hr.group]:i}));return r.concat(i,l)}return e?r.concat(i):r},[])):void 0,Kr=(n,...e)=>typeof n=="function"?n(...e):n,Jr=(n,e)=>n===e,Yr=()=>{const[n,e]=M(()=>[new WeakMap]);return{setItemState:$((o,r)=>e(([i])=>{const a=ye(o,i);return Object.assign(a,Kr(r,a)),[i]}),[]),state:n[0],signal:n}},Qr=()=>{const{setItemState:n,state:e,signal:t}=Yr(),o=$((i,a)=>{Fe(i)&&n(i,l=>({folded:a!==void 0?a:!l.folded}))},[]),r=$((i,a)=>{Fe(i)||n(i,l=>({expanded:a!==void 0?!a:!l.expanded}))},[]);return{state:e,signal:t,toggleFold:o,toggleCollapse:r}},Zr=({initial:n,compareItemsFn:e,data:t,flatData:o})=>{const[r,i]=M(n),[a,l]=M(),u=$(g=>r.includes(g),[r]),s=$(g=>g?.items?.every(u)??!1,[u]),c=$(g=>u(g)||s(g),[u,s]),m=$(g=>{const f=g.items??[g];i(v=>[...v,...f.filter(x=>!v.includes(x))]),l(g)},[]),h=$(g=>{const f=g.items??[g];i(v=>v.filter(x=>!f.includes(x))),l(g)},[]),p=$(g=>{i(g.items?.slice()||[g]),l(g)},[]),z=$(()=>{i(t.flatMap(g=>g.items||g)),l(void 0)},[t]),b=$(()=>{i([]),l(void 0)},[]),y=$((g,k=!c(g))=>k?m(g):h(g),[c]),F=$((g,k)=>{if(!o)return;const f=a?o.findIndex(w=>e(w,a)):-1;if(f<0)return y(g,k);const[v,x]=[f,o.indexOf(g)].sort((w,S)=>w-S);o.slice(v,x+1).forEach((w,S,R)=>{S>0&&S<R.length-1&&Fe(w)||y(w,k)}),l(g)},[o,e,y]);return T(()=>i(g=>g.length>0&&o?o.filter(k=>g.find(f=>e(k,f))):g),[o]),{selectedItems:r,isItemSelected:u,isGroupSelected:s,isSelected:c,select:m,deselect:h,selectOnly:p,selectAll:z,deselectAll:b,toggleSelect:y,toggleSelectTo:F}},ei={host:{position:"relative",display:"flex",flexDirection:"column"}},ti=n=>{const{data:e,renderItem:t,renderGroup:o,displayEmptyGroups:r,compareItemsFn:i=Jr}=n,{toggleFold:a,toggleCollapse:l,state:u,signal:s}=Qr(),c=I(()=>Ur(e,r,u),[e,r,s]),{selectedItems:m,isItemSelected:h,isGroupSelected:p,isSelected:z,select:b,deselect:y,selectOnly:F,selectAll:g,deselectAll:k,toggleSelect:f,toggleSelectTo:v}=Zr({initial:[],compareItemsFn:i,data:e,flatData:c}),x=$((S,R)=>Array.isArray(S.items)?o(S,R,{selected:p(S),folded:qr(S,u),toggleSelect:H=>f(S,typeof H=="boolean"?H:void 0),toggleFold:()=>a(S)}):t(S,R,{selected:m.includes(S),expanded:Wr(S,u),toggleSelect:H=>f(S,typeof H=="boolean"?H:void 0),toggleCollapse:()=>l(S)}),[t,o,m,f,s]);ht(()=>{Object.assign(n.style,ei.host)},[]),P("selectedItems",m);const w={toggleFold:a,toggleCollapse:l,isItemSelected:h,isGroupSelected:p,isSelected:z,select:b,deselect:y,selectOnly:F,selectAll:g,deselectAll:k,toggleSelect:f,toggleSelectTo:v};return Ie(w,Object.values(w)),{renderRow:x,flatData:c}},ni=({renderRow:n,flatData:e})=>cn({items:e,renderItem:(t,o)=>d`<cosmoz-grouped-list-row
				.item=${t}
				.index=${o}
				.renderFn=${n}
...
`;d(Object.assign([fe],{raw:[fe]}));Oe(Object.assign([fe],{raw:[fe]}));const ai=()=>d`<style>
	@keyframes rotating {
		100% {
