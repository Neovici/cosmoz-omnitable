import{x as c,B as qe,E as pt}from"./iframe-Q7rZW2R8.js";import{t as K,c as O,g as C,P as M,u as T,a as gt,m as bt,s as Dt,D as Tt,b as Vt,e as Pt,i as fe,h as _e,d as Nt,f as ft,r as Rt,j as Bt,k as z,l as Gt,n as he,p as me,o as k,q as Ht,v as xe,w as jt,x as Wt,y as Ut,T as Kt,z as E,A as Ue,B as Jt,C as Xt,E as Qt,F as $,G as Yt,H as Zt,I as ht,J as ke,K as F,L as xt,M as Ie,N as ei,O as vt,Q as ti,R as Me,S as Ke,U as ii,V as Ee,W as ai,X as ni,Y as Ae,Z as Oe,_ as oi,$ as ze,a0 as N,a1 as ri,a2 as ye,a3 as li}from"./cosmoz-collapse-6xS9XTxF.js";const si=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,ki=i=>{const{label:e,value:t,slot:a}=i,n=c`<div
	...
	`};class Ii extends Le(Y(M)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return c`
		...
		>`}getComparableValue(e,t){return Wi(e,t)}}customElements.define("cosmoz-omnitable-column-autocomplete",Ui);const Be=(i,e)=>e.find(({value:t})=>i===t),Ki=(i,e,t)=>{const a=Be(e,t);return a?a.text:i},et=(i,e,t,a)=>Ki(i,C(e,t),a),Ji=({valuePath:i},e,t)=>Be(C(e,i),t),Xi=i=>e=>{i(t=>({...t,filter:e?.[0]?.value??null}))},Qi=i=>e=>{i(t=>({...t,headerFocused:e}))},Yi=i=>e=>{i(t=>({...t,query:e}))},Zi=i=>e=>i(e?.[0]?.value),tt=({valuePath:i,trueLabel:e,falseLabel:t},a)=>C(a,i)?e:t,ea=({valuePath:i},e)=>t=>C(t,i)===e,ie=bt((i,e)=>[{text:i,value:!0},{text:e,value:!1}]),ta=({valuePath:i,trueLabel:e,falseLabel:t},a)=>i?C(a,i)?e:t:"",ia=(i,e)=>{try{return JSON.parse(e)}catch{return null}};class aa extends V(M){static get properties(){return{trueLabel:{type:String,value:"True"},falseLabel:{type:String,value:"False"},flex:{type:String,value:"0"},cellClass:{type:String,value:"boolean-cell"}}}getString(e,t){return tt(e,t)}renderCell(e,{item:t}){return tt(e,t)}renderEditCell(e,{item:t},a){const{trueLabel:n,falseLabel:o}=e;return c`<cosmoz-autocomplete
			no-label-float
		...
		>`}renderHeader(e,{filter:t,query:a},n,o){return c`<style>
