import{n as e}from"./chunk-BneVvdWh.js";import{$ as t,X as n,Z as r,et as i,n as a,t as o}from"./iframe-D-k0AzI0.js";import{$ as s,A as c,At as l,B as u,C as d,Ct as f,D as p,Dt as m,E as h,Et as g,F as _,Ft as v,G as y,H as b,I as x,It as S,J as C,K as ee,L as te,Lt as w,M as ne,Mt as re,N as ie,Nt as ae,O as oe,Ot as T,P as se,Pt as ce,Q as E,R as D,Rt as le,S as ue,St as de,T as fe,Tt as O,U as pe,V as me,W as k,X as he,Y as ge,Z as _e,_ as A,_t as ve,a as ye,at as j,b as M,bt as N,c as be,ct as xe,d as Se,dt as Ce,et as we,f as Te,ft as Ee,g as De,gt as Oe,h as ke,ht as Ae,i as je,it as P,j as Me,jt as Ne,k as Pe,kt as Fe,l as Ie,lt as Le,m as Re,mt as ze,n as Be,nt as Ve,o as He,ot as Ue,p as We,pt as Ge,q as Ke,r as qe,rt as Je,s as Ye,st as Xe,t as Ze,tt as Qe,u as $e,ut as et,v as tt,vt as nt,w as rt,wt as it,x as at,xt as ot,y as st,yt as F,z as ct,zt as lt}from"./dist-CfLFRY2K.js";var ut,dt=e((()=>{F(),ut=()=>t`<style>
	@keyframes rotating {
		100% {
...
`)},Ma=(e,t,n)=>{let r=e.filter(e=>!e.hidden),i=r.reduce((e,{width:t})=>e+t,0);if(r.length>1&&i>t)return Ma(r.slice(1),t,n);let a=r.reduce(([e,t],n,r)=>[Math.max(e,n.index),n.index>e?r:t],[-1,-1])[1];return a!==-1&&(r[a].flex=1),Ea(r,t).reduce((e,t,n)=>(e[r[n].index]=t,e),Array(n).fill(void 0))},Na=(e,t)=>e.length===0?`.cell {display: none;}`:ja(e,t)})),Fa,Ia=e((()=>{F(),Fa=({host:e,canvasWidth:t,layout:n,setSettings:r})=>{let i=de();i.current=e=>r(r=>{let i=r.columns,{detail:{newWidth:a,column:o}}=e,s=i.findIndex(e=>e.name===o.name),c=[],l=i.reduce((e,t)=>Math.max(e,t.priority),-1/0);for(let e=0;e<n.length;e++)if(c[e]={...i[e]},e<s&&n[e]&&(c[e].width=n[e],c[e].flex=0,c[e].priority=l),e===s){let r=n.reduce((e,t,n)=>n<s&&t?e-t:e,t);c[e].width=Math.min(r,Math.max(a,i[e].minWidth)),c[e].flex=0,c[e].priority=l}return{...r,columns:c}}),l(()=>{let t=e=>i.current?.(e);return e.addEventListener(`column-resize`,t),()=>e.removeEventListener(`column-resize`,t)},[])}})),La,Ra,za=e((()=>{F(),La=88,Ra=(e,t)=>l(()=>{let n=new ResizeObserver(([e])=>{e.contentRect?.width!==0&&t(e.contentRect.width-La)});return n.observe(e),()=>n.unobserve(e)},[])})),Ba,Va=e((()=>{F(),za(),Ba=e=>{let[t,n]=O(()=>e.getBoundingClientRect().width-La);return Ra(e,n),t}})),Ha,Ua,Wa,Ga=e((()=>{xe(),Ee(),F(),Ha=(e,t)=>{let n=T(()=>{let t=!1,n,r=()=>{t&&(n=requestAnimationFrame(r),e()&&(t=!1))};return{start:()=>{t=!0,cancelAnimationFrame(n),n=requestAnimationFrame(r)},stop:()=>{t=!1,cancelAnimationFrame(n)}}},[]);l(()=>{n.start()},t),l(()=>()=>n.stop(),[])},Ua=(e=0,t=0)=>Math.abs(e-t)<.1,Wa=(e,t=1.9,n=et)=>{let r=Ge({target:e});Ha(m(()=>{if(!r.tween)return r.tween=r.target,n(r.tween),!0;if(r.target.every((e,t)=>r.tween[t]===e))return n(r.tween),!0;r.tween=r.target.map((e,n)=>Ua(r.tween[n],e)?e:(r.tween[n]??0)+((e??0)-(r.tween[n]??0))/t||0),n(r.tween)},[]),[e])}})),Ka,qa=e((()=>{F(),Pa(),Ka=({canvasWidth:e,groupOnColumn:t,config:n,miniColumn:r})=>T(()=>{if(!Array.isArray(n)||e==null||e===0)return[];let i=n.map((e,n)=>({minWidth:e.minWidth,width:e.width,flex:e.flex,priority:e.priority,name:e.name,index:n,hidden:e.name===t?.name||e.disabled})).map(e=>r?{...e,hidden:r.name!==e.name}:e).sort(({index:e,priority:t},{index:n,priority:r})=>t===r?n-e:t-r);return Ma(i,e,i.length)},[e,t,n])})),Ja,Ya=e((()=>{F(),Ja=({host:e,canvasWidth:t,columns:n})=>{let r=e.miniBreakpoint??480,i=T(()=>t<=r,[t,r]),[a,...o]=T(()=>i?n?.filter(e=>e.mini!=null).sort((e,t)=>(e.mini??0)-(t.mini??0)):[],[n,i])??[],s=!!a;return l(()=>{e.toggleAttribute(`mini`,s)},[s]),{isMini:s&&i,miniColumn:a,miniColumns:o}}})),Xa,Za,Qa=e((()=>{F(),Pa(),Ia(),Va(),Ga(),qa(),Ya(),Ee(),Xa=e=>{let t=T(()=>new CSSStyleSheet,[]);return l(()=>{e.shadowRoot.adoptedStyleSheets=[...e.shadowRoot.adoptedStyleSheets,t]},[]),t},Za=({host:e,columns:t,settings:n,setSettings:r,resizeSpeedFactor:i,sortAndGroupOptions:a})=>{let o=Ba(e),{isMini:s,miniColumn:c,miniColumns:l}=Ja({host:e,canvasWidth:o,columns:t}),{groupOnColumn:u}=a,d=Ka({canvasWidth:o,groupOnColumn:u,miniColumn:c,config:n.columns}),f=Xa(e),p=T(()=>n.columns.reduce((e,n,r)=>d[r]!=null||n.name===u?.name||n.disabled?e:[...e,t.find(e=>e.name===n.name)],[]),[t,n,d]),m=Ge({columns:n.columns});return Wa(d,i,e=>{let t=Na(e,m.columns);f.replace(t)}),Fa({host:e,canvasWidth:o,layout:d,setSettings:e=>r(e(n))}),{isMini:s,collapsedColumns:p,miniColumns:l}}})),$a,eo=e((()=>{$a=({host:e,...t})=>{let{csvFilename:n=`omnitable.csv`,xlsxFilename:r=`omnitable.xlsx`,xlsxSheetname:i=`Omnitable`,topPlacement:a=`top-end`}=e;return{csvFilename:n,xlsxFilename:r,xlsxSheetname:i,topPlacement:a,...t}}})),to,no=e((()=>{F(),to=({host:e,selectedItems:t,data:n,sortAndGroupOptions:r,collapsedColumns:i,settings:a,filterFunctions:o,settingS:s,filters:c,...u})=>{let d=n&&n.length>0&&t.length===n.length,f=t=>{t.target.checked?e.shadowRoot.querySelector(`#groupedList`).selectAll():e.shadowRoot.querySelector(`#groupedList`).deselectAll()},{groupOnColumn:p}=r,m=T(()=>[p,...i,...a.columns.filter(e=>e.disabled)].some(e=>e&&Object.keys(o).includes(e.name)),[o,a,i]),h=T(()=>({...s,collapsed:i,badge:m,filters:c}),[s,i,m,c]);return l(()=>{let t=e.shadowRoot.querySelector(`#tableContent`),n=new ResizeObserver(t=>requestAnimationFrame(()=>{e.style.setProperty(`--ot-height`,t[0]?.contentRect.height+`px`)}));return n.observe(t),()=>n.unobserve(t)},[]),{allSelected:d,onAllCheckboxChange:f,data:n,settingsConfig:h,filters:c,groupOnColumn:p,sortAndGroup:r.sortAndGroup,...u}}})),ro,io,ao,oo,so,co,lo=e((()=>{F(),S(),C(),Aa(),J(),ro=t`
	<svg
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
