import{f as Eo,B as Nl,x as O,E as be,T as X,m as Mo,i as Vl,p as Rl,v as Oe,s as ht,M as cn}from"./iframe-DRpWdHWS.js";import{_ as Dl}from"./preload-helper-PPVm8Dsz.js";/**
 * @license
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const Bi=!window.ShadyDOM||!window.ShadyDOM.inUse;!window.ShadyCSS||window.ShadyCSS.nativeCss;const jl=Bi&&"adoptedStyleSheets"in Document.prototype&&"replaceSync"in CSSStyleSheet.prototype&&(()=>{try{const t=new CSSStyleSheet;t.replaceSync("");const e=document.createElement("div");return e.attachShadow({mode:"open"}),e.shadowRoot.adoptedStyleSheets=[t],e.shadowRoot.adoptedStyleSheets[0]===t}catch{return!1}})();let Ul=window.Polymer&&window.Polymer.rootPath||ns(document.baseURI||window.location.href),yi=window.Polymer&&window.Polymer.sanitizeDOMValue||void 0,Kl=window.Polymer&&window.Polymer.setPassiveTouchGestures||!1,et=window.Polymer&&window.Polymer.strictTemplatePolicy||!1,Wl=window.Polymer&&window.Polymer.allowTemplateFromDomModule||!1,kt=window.Polymer&&window.Polymer.legacyOptimizations||!1,Ao=window.Polymer&&window.Polymer.legacyWarnings||!1,ql=window.Polymer&&window.Polymer.syncInitialRender||!1,An=window.Polymer&&window.Polymer.legacyUndefined||!1,Yl=window.Polymer&&window.Polymer.orderedComputed||!1,Ns=window.Polymer&&window.Polymer.removeNestedTemplates||!1,Lo=window.Polymer&&window.Polymer.fastDomIf||!1,Ln=window.Polymer&&window.Polymer.suppressTemplateNotifications||!1,Gt=window.Polymer&&window.Polymer.legacyNoObservedAttributes||!1,Jl=window.Polymer&&window.Polymer.useAdoptedStyleSheetsWithBuiltCSS||!1;/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/let hc=0,ko=0,Xe=[],dc=0,Tn=!1,Ho=document.createTextNode("");new window.MutationObserver(uc).observe(Ho,{characterData:!0});function uc(){Tn=!1;const t=Xe.length;for(let e=0;e<t;e++){let i=Xe[e];if(i)try{i()}catch(n){setTimeout(()=>{throw n})}}Xe.splice(0,t),ko+=t}const zt={after(t){return{run(e){return window.setTimeout(e,t)},cancel(e){window.clearTimeout(e)}}},run(t,e){return window.setTimeout(t,e)},cancel(t){window.clearTimeout(t)}},Se={run(t){return Tn||(Tn=!0,Ho.textContent=dc++),Xe.push(t),hc++},cancel(t){const e=t-ko;if(e>=0){if(!Xe[e])throw new Error("invalid async handle: "+t);Xe[e]=null}}};/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
`,Fh=()=>O`<div class="wrap" part="wrap"><slot></slot></div>`;customElements.define("cosmoz-dropdown-content",la(Z(Fh,{styleSheets:[$h]})));const it=Math.min,ie=Math.max,Ci=Math.round,Qt=Math.floor,pe=t=>({x:t,y:t}),Bh={left:"right",right:"left",bottom:"top",top:"bottom"},jh={start:"end",end:"start"};function rr(t,e,i){return ie(t,it(e,i))}function qi(t,e){return typeof t=="function"?t(e):t}function De(t){return t.split("-")[0]}function Yi(t){return t.split("-")[1]}function ca(t){return t==="x"?"y":"x"}function ha(t){return t==="y"?"height":"width"}const Uh=new Set(["top","bottom"]);function ze(t){return Uh.has(De(t))?"y":"x"}function da(t){return ca(ze(t))}function Kh(t,e,i){i===void 0&&(i=!1);const n=Yi(t),s=da(t),r=ha(s);let o=s==="x"?n===(i?"end":"start")?"right":"left":n==="start"?"bottom":"top";return e.reference[r]>e.floating[r]&&(o=zi(o)),[o,zi(o)]}function Wh(t){const e=zi(t);return[Nn(t),e,Nn(e)]}function Nn(t){return t.replace(/start|end/g,e=>jh[e])}const or=["left","right"],ar=["right","left"],qh=["top","bottom"],Yh=["bottom","top"];function Jh(t,e,i){switch(t){case"top":case"bottom":return i?e?ar:or:e?or:ar;case"left":case"right":return e?qh:Yh;default:return[]}}function Xh(t,e,i,n){const s=Yi(t);let r=Jh(De(t),i==="start",n);return s&&(r=r.map(o=>o+"-"+s),e&&(r=r.concat(r.map(Nn)))),r}function zi(t){return t.replace(/left|right|bottom|top/g,e=>Bh[e])}function Gh(t){return{top:0,right:0,bottom:0,left:0,...t}}function Zh(t){return typeof t!="number"?Gh(t):{top:t,right:t,bottom:t,left:t}}function Si(t){const{x:e,y:i,width:n,height:s}=t;return{width:n,height:s,top:i,left:e,right:e+n,bottom:i+s,x:e,y:i}}function lr(t,e,i){let{reference:n,floating:s}=t;const r=ze(e),o=da(e),a=ha(o),l=De(e),c=r==="y",h=n.x+n.width/2-s.width/2,d=n.y+n.height/2-s.height/2,u=n[a]/2-s[a]/2;let p;switch(l){case"top":p={x:h,y:n.y-s.height};break;case"bottom":p={x:h,y:n.y+n.height};break;case"right":p={x:n.x+n.width,y:d};break;case"left":p={x:n.x-s.width,y:d};break;default:p={x:n.x,y:n.y}}switch(Yi(e)){case"start":p[o]-=u*(i&&c?-1:1);break;case"end":p[o]+=u*(i&&c?-1:1);break}return p}const Qh=async(t,e,i)=>{const{placement:n="bottom",strategy:s="absolute",middleware:r=[],platform:o}=i,a=r.filter(Boolean),l=await(o.isRTL==null?void 0:o.isRTL(e));let c=await o.getElementRects({reference:t,floating:e,strategy:s}),{x:h,y:d}=lr(c,n,l),u=n,p={},f=0;for(let m=0;m<a.length;m++){const{name:g,fn:_}=a[m],{x:v,y,data:w,reset:x}=await _({x:h,y:d,initialPlacement:n,placement:u,strategy:s,middlewareData:p,rects:c,platform:o,elements:{reference:t,floating:e}});h=v??h,d=y??d,p={...p,[g]:{...p[g],...w}},x&&f<=50&&(f++,typeof x=="object"&&(x.placement&&(u=x.placement),x.rects&&(c=x.rects===!0?await o.getElementRects({reference:t,floating:e,strategy:s}):x.rects),{x:h,y:d}=lr(c,u,l)),m=-1)}return{x:h,y:d,placement:u,strategy:s,middlewareData:p}};async function ds(t,e){var i;e===void 0&&(e={});const{x:n,y:s,platform:r,rects:o,elements:a,strategy:l}=t,{boundary:c="clippingAncestors",rootBoundary:h="viewport",elementContext:d="floating",altBoundary:u=!1,padding:p=0}=qi(e,t),f=Zh(p),g=a[u?d==="floating"?"reference":"floating":d],_=Si(await r.getClippingRect({element:(i=await(r.isElement==null?void 0:r.isElement(g)))==null||i?g:g.contextElement||await(r.getDocumentElement==null?void 0:r.getDocumentElement(a.floating)),boundary:c,rootBoundary:h,strategy:l})),v=d==="floating"?{x:n,y:s,width:o.floating.width,height:o.floating.height}:o.reference,y=await(r.getOffsetParent==null?void 0:r.getOffsetParent(a.floating)),w=await(r.isElement==null?void 0:r.isElement(y))?await(r.getScale==null?void 0:r.getScale(y))||{x:1,y:1}:{x:1,y:1},x=Si(r.convertOffsetParentRelativeRectToViewportRelativeRect?await r.convertOffsetParentRelativeRectToViewportRelativeRect({elements:a,rect:v,offsetParent:y,strategy:l}):v);return{top:(_.top-x.top+f.top)/w.y,bottom:(x.bottom-_.bottom+f.bottom)/w.y,left:(_.left-x.left+f.left)/w.x,right:(x.right-_.right+f.right)/w.x}}const ed=function(t){return t===void 0&&(t={}),{name:"flip",options:t,async fn(e){var i,n;const{placement:s,middlewareData:r,rects:o,initialPlacement:a,platform:l,elements:c}=e,{mainAxis:h=!0,crossAxis:d=!0,fallbackPlacements:u,fallbackStrategy:p="bestFit",fallbackAxisSideDirection:f="none",flipAlignment:m=!0,...g}=qi(t,e);if((i=r.arrow)!=null&&i.alignmentOffset)return{};const _=De(s),v=ze(a),y=De(a)===a,w=await(l.isRTL==null?void 0:l.isRTL(c.floating)),x=u||(y||!m?[zi(a)]:Wh(a)),L=f!=="none";!u&&L&&x.push(...Xh(a,m,f,w));const S=[a,...x],F=await ds(e,g),R=[];let U=((n=r.flip)==null?void 0:n.overflows)||[];if(h&&R.push(F[_]),d){const H=Kh(s,o,w);R.push(F[H[0]],F[H[1]])}if(U=[...U,{placement:s,overflows:R}],!R.every(H=>H<=0)){var B,Y;const H=(((B=r.flip)==null?void 0:B.index)||0)+1,N=S[H];if(N&&(!(d==="alignment"?v!==ze(N):!1)||U.every(T=>ze(T.placement)===v?T.overflows[0]>0:!0)))return{data:{index:H,overflows:U},reset:{placement:N}};let D=(Y=U.filter(E=>E.overflows[0]<=0).sort((E,T)=>E.overflows[1]-T.overflows[1])[0])==null?void 0:Y.placement;if(!D)switch(p){case"bestFit":{var K;const E=(K=U.filter(T=>{if(L){const W=ze(T.placement);return W===v||W==="y"}return!0}).map(T=>[T.placement,T.overflows.filter(W=>W>0).reduce((W,ge)=>W+ge,0)]).sort((T,W)=>T[1]-W[1])[0])==null?void 0:K[0];E&&(D=E);break}case"initialPlacement":D=a;break}if(s!==D)return{reset:{placement:D}}}return{}}}},td=function(t){return t===void 0&&(t={}),{name:"shift",options:t,async fn(e){const{x:i,y:n,placement:s}=e,{mainAxis:r=!0,crossAxis:o=!1,limiter:a={fn:g=>{let{x:_,y:v}=g;return{x:_,y:v}}},...l}=qi(t,e),c={x:i,y:n},h=await ds(e,l),d=ze(De(s)),u=ca(d);let p=c[u],f=c[d];if(r){const g=u==="y"?"top":"left",_=u==="y"?"bottom":"right",v=p+h[g],y=p-h[_];p=rr(v,p,y)}if(o){const g=d==="y"?"top":"left",_=d==="y"?"bottom":"right",v=f+h[g],y=f-h[_];f=rr(v,f,y)}const m=a.fn({...e,[u]:p,[d]:f});return{...m,data:{x:m.x-i,y:m.y-n,enabled:{[u]:r,[d]:o}}}}}},id=function(t){return t===void 0&&(t={}),{name:"size",options:t,async fn(e){var i,n;const{placement:s,rects:r,platform:o,elements:a}=e,{apply:l=()=>{},...c}=qi(t,e),h=await ds(e,c),d=De(s),u=Yi(s),p=ze(s)==="y",{width:f,height:m}=r.floating;let g,_;d==="top"||d==="bottom"?(g=d,_=u===(await(o.isRTL==null?void 0:o.isRTL(a.floating))?"start":"end")?"left":"right"):(_=d,g=u==="end"?"top":"bottom");const v=m-h.top-h.bottom,y=f-h.left-h.right,w=it(m-h[g],v),x=it(f-h[_],y),L=!e.middlewareData.shift;let S=w,F=x;if((i=e.middlewareData.shift)!=null&&i.enabled.x&&(F=y),(n=e.middlewareData.shift)!=null&&n.enabled.y&&(S=v),L&&!u){const U=ie(h.left,0),B=ie(h.right,0),Y=ie(h.top,0),K=ie(h.bottom,0);p?F=f-2*(U!==0||B!==0?U+B:ie(h.left,h.right)):S=m-2*(Y!==0||K!==0?Y+K:ie(h.top,h.bottom))}await l({...e,availableWidth:F,availableHeight:S});const R=await o.getDimensions(a.floating);return f!==R.width||m!==R.height?{reset:{rects:!0}}:{}}}};function Ji(){return typeof window<"u"}function lt(t){return ua(t)?(t.nodeName||"").toLowerCase():"#document"}function ne(t){var e;return(t==null||(e=t.ownerDocument)==null?void 0:e.defaultView)||window}function me(t){var e;return(e=(ua(t)?t.ownerDocument:t.document)||window.document)==null?void 0:e.documentElement}function ua(t){return Ji()?t instanceof Node||t instanceof ne(t).Node:!1}function re(t){return Ji()?t instanceof Element||t instanceof ne(t).Element:!1}function fe(t){return Ji()?t instanceof HTMLElement||t instanceof ne(t).HTMLElement:!1}function cr(t){return!Ji()||typeof ShadowRoot>"u"?!1:t instanceof ShadowRoot||t instanceof ne(t).ShadowRoot}const nd=new Set(["inline","contents"]);function Kt(t){const{overflow:e,overflowX:i,overflowY:n,display:s}=oe(t);return/auto|scroll|overlay|hidden|clip/.test(e+n+i)&&!nd.has(s)}const sd=new Set(["table","td","th"]);function rd(t){return sd.has(lt(t))}const od=[":popover-open",":modal"];function Xi(t){return od.some(e=>{try{return t.matches(e)}catch{return!1}})}const ad=["transform","translate","scale","rotate","perspective"],ld=["transform","translate","scale","rotate","perspective","filter"],cd=["paint","layout","strict","content"];function us(t){const e=ps(),i=re(t)?oe(t):t;return ad.some(n=>i[n]?i[n]!=="none":!1)||(i.containerType?i.containerType!=="normal":!1)||!e&&(i.backdropFilter?i.backdropFilter!=="none":!1)||!e&&(i.filter?i.filter!=="none":!1)||ld.some(n=>(i.willChange||"").includes(n))||cd.some(n=>(i.contain||"").includes(n))}function hd(t){let e=Me(t);for(;fe(e)&&!nt(e);){if(us(e))return e;if(Xi(e))return null;e=Me(e)}return null}function ps(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}const dd=new Set(["html","body","#document"]);function nt(t){return dd.has(lt(t))}function oe(t){return ne(t).getComputedStyle(t)}function Gi(t){return re(t)?{scrollLeft:t.scrollLeft,scrollTop:t.scrollTop}:{scrollLeft:t.scrollX,scrollTop:t.scrollY}}function Me(t){if(lt(t)==="html")return t;const e=t.assignedSlot||t.parentNode||cr(t)&&t.host||me(t);return cr(e)?e.host:e}function pa(t){const e=Me(t);return nt(e)?t.ownerDocument?t.ownerDocument.body:t.body:fe(e)&&Kt(e)?e:pa(e)}function Dt(t,e,i){var n;e===void 0&&(e=[]),i===void 0&&(i=!0);const s=pa(t),r=s===((n=t.ownerDocument)==null?void 0:n.body),o=ne(s);if(r){const a=Vn(o);return e.concat(o,o.visualViewport||[],Kt(s)?s:[],a&&i?Dt(a):[])}return e.concat(s,Dt(s,[],i))}function Vn(t){return t.parent&&Object.getPrototypeOf(t.parent)?t.frameElement:null}function fa(t){const e=oe(t);let i=parseFloat(e.width)||0,n=parseFloat(e.height)||0;const s=fe(t),r=s?t.offsetWidth:i,o=s?t.offsetHeight:n,a=Ci(i)!==r||Ci(n)!==o;return a&&(i=r,n=o),{width:i,height:n,$:a}}function fs(t){return re(t)?t:t.contextElement}function Ge(t){const e=fs(t);if(!fe(e))return pe(1);const i=e.getBoundingClientRect(),{width:n,height:s,$:r}=fa(e);let o=(r?Ci(i.width):i.width)/n,a=(r?Ci(i.height):i.height)/s;return(!o||!Number.isFinite(o))&&(o=1),(!a||!Number.isFinite(a))&&(a=1),{x:o,y:a}}const ud=pe(0);function ma(t){const e=ne(t);return!ps()||!e.visualViewport?ud:{x:e.visualViewport.offsetLeft,y:e.visualViewport.offsetTop}}function pd(t,e,i){return e===void 0&&(e=!1),!i||e&&i!==ne(t)?!1:e}function $e(t,e,i,n){e===void 0&&(e=!1),i===void 0&&(i=!1);const s=t.getBoundingClientRect(),r=fs(t);let o=pe(1);e&&(n?re(n)&&(o=Ge(n)):o=Ge(t));const a=pd(r,i,n)?ma(r):pe(0);let l=(s.left+a.x)/o.x,c=(s.top+a.y)/o.y,h=s.width/o.x,d=s.height/o.y;if(r){const u=ne(r),p=n&&re(n)?ne(n):n;let f=u,m=Vn(f);for(;m&&n&&p!==f;){const g=Ge(m),_=m.getBoundingClientRect(),v=oe(m),y=_.left+(m.clientLeft+parseFloat(v.paddingLeft))*g.x,w=_.top+(m.clientTop+parseFloat(v.paddingTop))*g.y;l*=g.x,c*=g.y,h*=g.x,d*=g.y,l+=y,c+=w,f=ne(m),m=Vn(f)}}return Si({width:h,height:d,x:l,y:c})}function Zi(t,e){const i=Gi(t).scrollLeft;return e?e.left+i:$e(me(t)).left+i}function ga(t,e){const i=t.getBoundingClientRect(),n=i.left+e.scrollLeft-Zi(t,i),s=i.top+e.scrollTop;return{x:n,y:s}}function fd(t){let{elements:e,rect:i,offsetParent:n,strategy:s}=t;const r=s==="fixed",o=me(n),a=e?Xi(e.floating):!1;if(n===o||a&&r)return i;let l={scrollLeft:0,scrollTop:0},c=pe(1);const h=pe(0),d=fe(n);if((d||!d&&!r)&&((lt(n)!=="body"||Kt(o))&&(l=Gi(n)),fe(n))){const p=$e(n);c=Ge(n),h.x=p.x+n.clientLeft,h.y=p.y+n.clientTop}const u=o&&!d&&!r?ga(o,l):pe(0);return{width:i.width*c.x,height:i.height*c.y,x:i.x*c.x-l.scrollLeft*c.x+h.x+u.x,y:i.y*c.y-l.scrollTop*c.y+h.y+u.y}}function md(t){return Array.from(t.getClientRects())}function gd(t){const e=me(t),i=Gi(t),n=t.ownerDocument.body,s=ie(e.scrollWidth,e.clientWidth,n.scrollWidth,n.clientWidth),r=ie(e.scrollHeight,e.clientHeight,n.scrollHeight,n.clientHeight);let o=-i.scrollLeft+Zi(t);const a=-i.scrollTop;return oe(n).direction==="rtl"&&(o+=ie(e.clientWidth,n.clientWidth)-s),{width:s,height:r,x:o,y:a}}const hr=25;function _d(t,e){const i=ne(t),n=me(t),s=i.visualViewport;let r=n.clientWidth,o=n.clientHeight,a=0,l=0;if(s){r=s.width,o=s.height;const h=ps();(!h||h&&e==="fixed")&&(a=s.offsetLeft,l=s.offsetTop)}const c=Zi(n);if(c<=0){const h=n.ownerDocument,d=h.body,u=getComputedStyle(d),p=h.compatMode==="CSS1Compat"&&parseFloat(u.marginLeft)+parseFloat(u.marginRight)||0,f=Math.abs(n.clientWidth-d.clientWidth-p);f<=hr&&(r-=f)}else c<=hr&&(r+=c);return{width:r,height:o,x:a,y:l}}const vd=new Set(["absolute","fixed"]);function yd(t,e){const i=$e(t,!0,e==="fixed"),n=i.top+t.clientTop,s=i.left+t.clientLeft,r=fe(t)?Ge(t):pe(1),o=t.clientWidth*r.x,a=t.clientHeight*r.y,l=s*r.x,c=n*r.y;return{width:o,height:a,x:l,y:c}}function dr(t,e,i){let n;if(e==="viewport")n=_d(t,i);else if(e==="document")n=gd(me(t));else if(re(e))n=yd(e,i);else{const s=ma(t);n={x:e.x-s.x,y:e.y-s.y,width:e.width,height:e.height}}return Si(n)}function _a(t,e){const i=Me(t);return i===e||!re(i)||nt(i)?!1:oe(i).position==="fixed"||_a(i,e)}function bd(t,e){const i=e.get(t);if(i)return i;let n=Dt(t,[],!1).filter(a=>re(a)&&lt(a)!=="body"),s=null;const r=oe(t).position==="fixed";let o=r?Me(t):t;for(;re(o)&&!nt(o);){const a=oe(o),l=us(o);!l&&a.position==="fixed"&&(s=null),(r?!l&&!s:!l&&a.position==="static"&&!!s&&vd.has(s.position)||Kt(o)&&!l&&_a(t,o))?n=n.filter(h=>h!==o):s=a,o=Me(o)}return e.set(t,n),n}function wd(t){let{element:e,boundary:i,rootBoundary:n,strategy:s}=t;const o=[...i==="clippingAncestors"?Xi(e)?[]:bd(e,this._c):[].concat(i),n],a=o[0],l=o.reduce((c,h)=>{const d=dr(e,h,s);return c.top=ie(d.top,c.top),c.right=it(d.right,c.right),c.bottom=it(d.bottom,c.bottom),c.left=ie(d.left,c.left),c},dr(e,a,s));return{width:l.right-l.left,height:l.bottom-l.top,x:l.left,y:l.top}}function xd(t){const{width:e,height:i}=fa(t);return{width:e,height:i}}function Cd(t,e,i){const n=fe(e),s=me(e),r=i==="fixed",o=$e(t,!0,r,e);let a={scrollLeft:0,scrollTop:0};const l=pe(0);function c(){l.x=Zi(s)}if(n||!n&&!r)if((lt(e)!=="body"||Kt(s))&&(a=Gi(e)),n){const p=$e(e,!0,r,e);l.x=p.x+e.clientLeft,l.y=p.y+e.clientTop}else s&&c();r&&!n&&s&&c();const h=s&&!n&&!r?ga(s,a):pe(0),d=o.left+a.scrollLeft-l.x-h.x,u=o.top+a.scrollTop-l.y-h.y;return{x:d,y:u,width:o.width,height:o.height}}function mn(t){return oe(t).position==="static"}function ur(t,e){if(!fe(t)||oe(t).position==="fixed")return null;if(e)return e(t);let i=t.offsetParent;return me(t)===i&&(i=i.ownerDocument.body),i}function va(t,e){const i=ne(t);if(Xi(t))return i;if(!fe(t)){let s=Me(t);for(;s&&!nt(s);){if(re(s)&&!mn(s))return s;s=Me(s)}return i}let n=ur(t,e);for(;n&&rd(n)&&mn(n);)n=ur(n,e);return n&&nt(n)&&mn(n)&&!us(n)?i:n||hd(t)||i}const zd=async function(t){const e=this.getOffsetParent||va,i=this.getDimensions,n=await i(t.floating);return{reference:Cd(t.reference,await e(t.floating),t.strategy),floating:{x:0,y:0,width:n.width,height:n.height}}};function Sd(t){return oe(t).direction==="rtl"}const Ed={convertOffsetParentRelativeRectToViewportRelativeRect:fd,getDocumentElement:me,getClippingRect:wd,getOffsetParent:va,getElementRects:zd,getClientRects:md,getDimensions:xd,getScale:Ge,isElement:re,isRTL:Sd};function ya(t,e){return t.x===e.x&&t.y===e.y&&t.width===e.width&&t.height===e.height}function Md(t,e){let i=null,n;const s=me(t);function r(){var a;clearTimeout(n),(a=i)==null||a.disconnect(),i=null}function o(a,l){a===void 0&&(a=!1),l===void 0&&(l=1),r();const c=t.getBoundingClientRect(),{left:h,top:d,width:u,height:p}=c;if(a||e(),!u||!p)return;const f=Qt(d),m=Qt(s.clientWidth-(h+u)),g=Qt(s.clientHeight-(d+p)),_=Qt(h),y={rootMargin:-f+"px "+-m+"px "+-g+"px "+-_+"px",threshold:ie(0,it(1,l))||1};let w=!0;function x(L){const S=L[0].intersectionRatio;if(S!==l){if(!w)return o();S?o(!1,S):n=setTimeout(()=>{o(!1,1e-7)},1e3)}S===1&&!ya(c,t.getBoundingClientRect())&&o(),w=!1}try{i=new IntersectionObserver(x,{...y,root:s.ownerDocument})}catch{i=new IntersectionObserver(x,y)}i.observe(t)}return o(!0),r}function Ad(t,e,i,n){n===void 0&&(n={});const{ancestorScroll:s=!0,ancestorResize:r=!0,elementResize:o=typeof ResizeObserver=="function",layoutShift:a=typeof IntersectionObserver=="function",animationFrame:l=!1}=n,c=fs(t),h=s||r?[...c?Dt(c):[],...Dt(e)]:[];h.forEach(_=>{s&&_.addEventListener("scroll",i,{passive:!0}),r&&_.addEventListener("resize",i)});const d=c&&a?Md(c,i):null;let u=-1,p=null;o&&(p=new ResizeObserver(_=>{let[v]=_;v&&v.target===c&&p&&(p.unobserve(e),cancelAnimationFrame(u),u=requestAnimationFrame(()=>{var y;(y=p)==null||y.observe(e)})),i()}),c&&!l&&p.observe(c),p.observe(e));let f,m=l?$e(t):null;l&&g();function g(){const _=$e(t);m&&!ya(m,_)&&i(),m=_,f=requestAnimationFrame(g)}return i(),()=>{var _;h.forEach(v=>{s&&v.removeEventListener("scroll",i),r&&v.removeEventListener("resize",i)}),d?.(),(_=p)==null||_.disconnect(),p=null,l&&cancelAnimationFrame(f)}}const Ld=td,Pd=ed,Td=id,Od=(t,e,i)=>{const n=new Map,s={platform:Ed,...i},r={...s.platform,_c:n};return Qh(t,e,{...s,platform:r})},ba=[Pd({fallbackAxisSideDirection:"start",crossAxis:!1}),Ld()],wa=({placement:t="bottom-start",strategy:e,middleware:i=ba}={})=>{const[n,s]=ue(),[r,o]=ue(),[a,l]=ue();return k(()=>{if(!n||!(r instanceof HTMLElement)){l(void 0);return}return Ad(n,r,()=>Od(n,r,{placement:t,strategy:e,middleware:i}).then(l))},[n,r,t,e,i]),{setReference:s,setFloating:o,styles:I(()=>a?{left:`${a.x}px`,top:`${a.y}px`}:{},[a?.x,a?.y])}},kd=t=>t.preventDefault(),Hd=we`
	.anchor {
		pointer-events: none;
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/class fr{constructor(){this.start=0,this.end=0,this.previous=null,this.parent=null,this.rules=null,this.parsedCssText="",this.cssText="",this.atRule=!1,this.type=0,this.keyframesName="",this.selector="",this.parsedSelector=""}}function Ca(t){return t=Yd(t),za(Jd(t),t)}function Yd(t){return t.replace(ve.comments,"").replace(ve.port,"")}function Jd(t){let e=new fr;e.start=0,e.end=t.length;let i=e;for(let n=0,s=t.length;n<s;n++)if(t[n]===Ea){i.rules||(i.rules=[]);let r=i,o=r.rules[r.rules.length-1]||null;i=new fr,i.start=n+1,i.parent=r,i.previous=o,r.rules.push(i)}else t[n]===Ma&&(i.end=n+1,i=i.parent||e);return e}function za(t,e){let i=e.substring(t.start,t.end-1);if(t.parsedCssText=t.cssText=i.trim(),t.parent){let s=t.previous?t.previous.end:t.parent.start;i=e.substring(s,t.start-1),i=Xd(i),i=i.replace(ve.multipleSpaces," "),i=i.substring(i.lastIndexOf(";")+1);let r=t.parsedSelector=t.selector=i.trim();t.atRule=r.indexOf(iu)===0,t.atRule?r.indexOf(tu)===0?t.type=Je.MEDIA_RULE:r.match(ve.keyframesRule)&&(t.type=Je.KEYFRAMES_RULE,t.keyframesName=t.selector.split(ve.multipleSpaces).pop()):r.indexOf(Aa)===0?t.type=Je.MIXIN_RULE:t.type=Je.STYLE_RULE}let n=t.rules;if(n)for(let s=0,r=n.length,o;s<r&&(o=n[s]);s++)za(o,e);return t}function Xd(t){return t.replace(/\\([0-9a-f]{1,6})\s/gi,function(){let e=arguments[1],i=6-e.length;for(;i--;)e="0"+e;return"\\"+e})}function Sa(t,e,i=""){let n="";if(t.cssText||t.rules){let s=t.rules;if(s&&!Gd(s))for(let r=0,o=s.length,a;r<o&&(a=s[r]);r++)n=Sa(a,e,n);else n=e?t.cssText:Zd(t.cssText),n=n.trim(),n&&(n="  "+n+`
`)}return n&&(t.selector&&(i+=t.selector+" "+Ea+`
`),i+=n,t.selector&&(i+=Ma+`

`)),i}function Gd(t){let e=t[0];return!!e&&!!e.selector&&e.selector.indexOf(Aa)===0}function Zd(t){return t=Qd(t),eu(t)}function Qd(t){return t.replace(ve.customProp,"").replace(ve.mixinProp,"")}function eu(t){return t.replace(ve.mixinApply,"").replace(ve.varApply,"")}const Je={STYLE_RULE:1,KEYFRAMES_RULE:7,MEDIA_RULE:4,MIXIN_RULE:1e3},Ea="{",Ma="}",ve={comments:/\/\*[^*]*\*+([^/*][^*]*\*+)*\//gim,port:/@import[^;]*;/gim,customProp:/(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?(?:[;\n]|$)/gim,mixinProp:/(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?{[^}]*?}(?:[;\n]|$)?/gim,mixinApply:/@apply\s*\(?[^);]*\)?\s*(?:[;\n]|$)?/gim,varApply:/[^;:]*?:[^;]*?var\([^;]*\)(?:[;\n]|$)?/gim,keyframesRule:/^@[^\s]*keyframes/,multipleSpaces:/\s+/g},Aa="--",tu="@media",iu="@";/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const Pi="_applyShimCurrentVersion",st="_applyShimNextVersion",Ti="_applyShimValidatingVersion",gu=Promise.resolve();function _u(t){let e=Bn[t];e&&vu(e)}function vu(t){t[Pi]=t[Pi]||0,t[Ti]=t[Ti]||0,t[st]=(t[st]||0)+1}function Oa(t){return t[Pi]===t[st]}function yu(t){return!Oa(t)&&t[Ti]===t[st]}function bu(t){t[Ti]=t[st],t._validating||(t._validating=!0,gu.then(function(){t[Pi]=t[st],t._validating=!1}))}/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
`,is:"iron-a11y-announcer",properties:{mode:{type:String,value:"polite"},timeout:{type:Number,value:150},_text:{type:String,value:""}},created:function(){_e.instance||(_e.instance=this),document.addEventListener("iron-announce",this._onIronAnnounce.bind(this))},announce:function(t){this._text="",this.async(function(){this._text=t},this.timeout)},_onIronAnnounce:function(t){t.detail&&t.detail.text&&this.announce(t.detail.text)}});_e.instance=null;_e.requestAvailability=function(){_e.instance||(_e.instance=document.createElement("iron-a11y-announcer")),document.body?document.body.appendChild(_e.instance):document.addEventListener("load",function(){document.body.appendChild(_e.instance)})};/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
http://polymer.github.io/LICENSE.txt The complete set of authors may be found at
...
`;customElements.define("cosmoz-autocomplete-skeleton-span",Z(()=>be,{styleSheets:[uf]}));/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ao=t=>!Vl(t)&&typeof t.then=="function",lo=1073741823;let mf=class extends Wi{constructor(){super(...arguments),this._$Cwt=lo,this._$Cbt=[],this._$CK=new pf(this),this._$CX=new ff}render(...e){return e.find((i=>!ao(i)))??X}update(e,i){const n=this._$Cbt;let s=n.length;this._$Cbt=i;const r=this._$CK,o=this._$CX;this.isConnected||this.disconnected();for(let a=0;a<i.length&&!(a>this._$Cwt);a++){const l=i[a];if(!ao(l))return this._$Cwt=a,l;a<s&&l===n[a]||(this._$Cwt=lo,s=0,Promise.resolve(l).then((async c=>{for(;o.get();)await o.get();const h=r.deref();if(h!==void 0){const d=h._$Cbt.indexOf(l);d>-1&&d<h._$Cwt&&(h._$Cwt=d,h.setValue(c))}})))}return X}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}};const Qn=Ce(mf);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const co=(t,e,i)=>{const n=new Map;for(let s=e;s<=i;s++)n.set(t[s],s);return n},gf=Ce(class extends ot{constructor(t){if(super(t),t.type!==le.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,i){let n;i===void 0?i=e:e!==void 0&&(n=e);const s=[],r=[];let o=0;for(const a of t)s[o]=n?n(a,o):o,r[o]=i(a,o),o++;return{values:r,keys:s}}render(t,e,i){return this.dt(t,e,i).values}update(t,[e,i,n]){const s=Rl(t),{values:r,keys:o}=this.dt(e,i,n);if(!Array.isArray(s))return this.ut=o,r;const a=this.ut??=[],l=[];let c,h,d=0,u=s.length-1,p=0,f=r.length-1;for(;d<=u&&p<=f;)if(s[d]===null)d++;else if(s[u]===null)u--;else if(a[d]===o[p])l[p]=Oe(s[d],r[p]),d++,p++;else if(a[u]===o[f])l[f]=Oe(s[u],r[f]),u--,f--;else if(a[d]===o[f])l[f]=Oe(s[d],r[f]),ht(t,l[f+1],s[d]),d++,f--;else if(a[u]===o[p])l[p]=Oe(s[u],r[p]),ht(t,s[d],s[u]),u--,p++;else if(c===void 0&&(c=co(o,p,f),h=co(a,d,u)),c.has(a[d]))if(c.has(a[u])){const m=h.get(o[p]),g=m!==void 0?s[m]:null;if(g===null){const _=ht(t,s[d]);Oe(_,r[p]),l[p]=_}else l[p]=Oe(g,r[p]),ht(t,s[d],g),s[m]=null;p++}else cn(s[u]),u--;else cn(s[d]),d++;for(;p<=f;){const m=ht(t,l[f+1]);Oe(m,r[p]),l[p++]=m}for(;d<=u;){const m=s[d++];m!==null&&cn(m)}return this.ut=o,Mo(t,l),X}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Cf=t=>t,zf=(t,e)=>O`${e}: ${JSON.stringify(t,null,2)}`;class Sf extends Wi{constructor(e){if(super(e),this._virtualizer=null,this._first=0,this._last=-1,this._renderItem=(i,n)=>zf(i,n+this._first),this._keyFunction=(i,n)=>Cf(i,n+this._first),this._items=[],e.type!==le.CHILD)throw new Error("The virtualize directive can only be used in child expressions")}render(e){e&&this._setFunctions(e);const i=[];if(this._first>=0&&this._last>=this._first)for(let n=this._first;n<=this._last;n++)i.push(this._items[n]);return gf(i,this._keyFunction,this._renderItem)}update(e,[i]){this._setFunctions(i);const n=this._items!==i.items;return this._items=i.items||[],this._virtualizer?this._updateVirtualizerConfig(e,i):this._initialize(e,i),n?X:this.render()}async _updateVirtualizerConfig(e,i){if(!await this._virtualizer.updateLayoutConfig(i.layout||{})){const s=e.parentNode;this._makeVirtualizer(s,i)}this._virtualizer.items=this._items}_setFunctions(e){const{renderItem:i,keyFunction:n}=e;i&&(this._renderItem=(s,r)=>i(s,r+this._first)),n&&(this._keyFunction=(s,r)=>n(s,r+this._first))}_makeVirtualizer(e,i){this._virtualizer&&this._virtualizer.disconnected();const{layout:n,scroller:s,items:r}=i;this._virtualizer=new yf({hostElement:e,layout:n,scroller:s}),this._virtualizer.items=r,this._virtualizer.connected()}_initialize(e,i){const n=e.parentNode;n&&n.nodeType===1&&(n.addEventListener("rangeChanged",s=>{this._first=s.first,this._last=s.last,this.setValue(this.render())}),this._makeVirtualizer(n,i))}disconnected(){this._virtualizer?.disconnected()}reconnected(){this._virtualizer?.connected()}}const Ef=Ce(Sf),Mf=(t,e)=>{if(!t||!e)return;const i=Object.keys(e);return Object.fromEntries(Object.keys(t).flatMap(n=>i.includes(n)?[]:[[n,void 0]]))};class Af extends ot{_props;render(e){return X}update(e,[i]){return this._props!==i&&Object.assign(e.element,Mf(this._props,i),this._props=i),X}}const Lf=Ce(Af),Pf=t=>{const e=qt(),i=I(()=>new CSSStyleSheet,[]);k(()=>{e.shadowRoot.adoptedStyleSheets=[...e.shadowRoot.adoptedStyleSheets,i]},[]),k(()=>{i.replaceSync(t)},[t])};function bl(t){return t?e=>e?.[t]:tt}const Tf=t=>{const e=bl(t);return i=>typeof i=="string"?i:e(i)?.toString()||""},Of=t=>e=>{const i={};for(const n in e)t.includes(n)&&(i[n]=e[n]);return i},kf="data:image/svg+xml,%3Csvg width='11' height='8' viewBox='0 0 11 8' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M9.5 1L5.20039 7.04766L1.66348 3.46152' stroke='white' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round'/%3E%3C/svg%3E",Hf=we`
	:host {
		position: fixed;
		z-index: 1000;
...
`,If=({index:t,itemHeight:e,auto:i})=>we`
	${Ee(!i,()=>we`
			.item {
				line-height: ${e}px;
				height: ${e}px;
...
`,Nf=t=>typeof t=="object"&&t!==null&&Symbol.iterator in t;function je(t){return t==null?[]:Array.isArray(t)?t:typeof t=="string"?[t]:Nf(t)?Array.from(t):[t]}const Sn=(t,e=tt)=>i=>{const n=je(t).map(e);return je(i).filter(s=>!n.includes(e(s)))},Vf=(t,e)=>e?i=>je(t).find(n=>n[e]===i[e]):i=>je(t).includes(i),Rf=(t,e)=>{if(!e||!t)return t;const i=t.toLowerCase().indexOf(e.toLowerCase());if(i<0)return t;const n=i+e.length;return[t.slice(0,i),O`<mark>${t.slice(i,n)}</mark>`,t.slice(n)]},Df=t=>{const e=at(t);k(()=>{const i=n=>{if(!(n.ctrlKey&&n.altKey||n.defaultPrevented))switch(n.key){case"Up":case"ArrowUp":n.preventDefault(),e.onUp();break;case"Down":case"ArrowDown":n.preventDefault(),e.onDown();break;case"Enter":n.preventDefault(),e.onEnter();break}};return document.addEventListener("keydown",i,!0),()=>document.removeEventListener("keydown",i,!0)},[e])},$f=({items:t,onSelect:e,defaultIndex:i=0})=>{const[n,s]=ue({index:i}),{index:r}=n,{length:o}=t;return k(()=>{s({index:n.index<0?i:Math.min(n.index,t.length-1),scroll:!0})},[t,i]),Df({onUp:V(()=>s(a=>({index:a.index>0?a.index-1:o-1,scroll:!0})),[o]),onDown:V(()=>s(a=>({index:a.index<o-1?a.index+1:0,scroll:!0})),[o]),onEnter:V(()=>r>-1&&r<o&&e?.(t[r],r),[r,t,e])}),{position:n,highlight:V(a=>s({index:a}),[]),select:V(a=>e?.(a),[e])}},Ff=(t=tt)=>(e,i,{highlight:n,select:s,textual:r=tt,query:o,isSelected:a})=>{const l=r(e),c=Rf(l,o),h=t(c,e,i);return O`<div
				class="item"
				role="option"
				part="option"
				?aria-selected=${a(e)}
...
`,_2=()=>be,v2=Z(_2,{styleSheets:[g2]});customElements.define("cosmoz-spinner",v2);const Ll=["T"," "],yo=t=>{if(!t||typeof t!="string")return;let e;return Ll.some(i=>t.match(i)?(e=t.split(i),!0):!1),e||[t]},y2=(t,e)=>{const i=yo(t),n=yo(e);return{minDate:Array.isArray(i)?i.shift():null,minTime:Array.isArray(i)?i.shift():null,maxDate:Array.isArray(n)?n.shift():null,maxTime:Array.isArray(n)?n.shift():null}},bo=(t,e)=>{if(!(!t&&!e))return!t&&e?`T${e}`:t&&!e?t:`${t}T${e}`},b2=t=>{if(t){for(const e of Ll)if(t.match(e)){const i=t.split(e);return{date:i.shift(),time:i.shift()}}return{date:t}}},w2=t=>{const{dateLabel:e,timeLabel:i,min:n,max:s,step:r="1",value:o}=t,{minDate:a,maxDate:l,minTime:c,maxTime:h}=I(()=>y2(n,s),[n,s]),{date:d,time:u}=I(()=>b2(o)??{},[o]);return k(()=>{t.dispatchEvent(new CustomEvent("cosmoz-datetime-input-value-changed",{bubbles:!0,composed:!0}))},[o]),O`
		<style>
			:host {
				display: flex;
				flex-direction: row;
