import{x as m,B as _e,E as ft}from"./iframe-DRpWdHWS.js";import{t as K,c as O,g as C,P as I,u as T,a as ht,m as xt,s as Vt,D as Pt,b as Nt,e as Rt,i as $e,h as Le,o as J,d as A,f as Bt,j as we,p as he,n as _,k as Gt,l as Ce,q as Ht,r as jt,v as Wt,T as Ut,w as M,x as Kt,y as Jt,z as Xt,A as $,B as Qt,C as Yt,E as vt,F as Oe,G as F,H as yt,I as De,J as Zt,K as $t,N as ei,L as ti,M as Te,O as ii,Q as Ve,R as ai,S as ni,U as Ee,V as Pe,W as oi,X as Ie,Y as N,Z as ri,_ as ze,$ as li}from"./cosmoz-collapse-Axit9CT2.js";import"./preload-helper-PPVm8Dsz.js";const si=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`;customElements.define("cosmoz-clear-button",O(ui));const U=({valuePath:i},e)=>C(e,i),di=U,ci=U,mi=({valuePath:i},e)=>t=>{const a=C(t,i);return a==null?!1:a.toString().toLowerCase().trim().includes(e.toLowerCase().trim())},pi=(i,e)=>e===""||e==null?null:e,V=i=>class extends i{static get properties(){return{isOmnitableColumn:{type:Boolean,value:!0},title:{type:String},valuePath:{type:String,notify:!0},values:{type:Array,notify:!0},filter:{type:Object},noLocalFilter:{type:Boolean},disabled:{type:Boolean,value:!1,notify:!0},editable:{type:Boolean,notify:!0},loading:{type:Boolean,value:!1,notify:!0},externalValues:{type:Boolean,value:!1,notify:!0},name:{type:String},sortOn:{type:String},groupOn:{type:String},width:{type:String,value:"75px"},minWidth:{type:String,value:"40px"},flex:{type:String,value:"1"},cellClass:{type:String,value:"default-cell"},headerCellClass:{type:String,value:"default-header-cell"},priority:{type:Number,value:0},hidden:{type:Boolean,notify:!0},preferredDropdownHorizontalAlign:{type:String,value:"right"},renderHeader:{type:Function},renderCell:{type:Function},renderEditCell:{type:Function},renderGroup:{type:Function},mini:{type:Number,value:null},renderMini:{type:Function}}}static get observers(){return["notifyFilterChange(filter)"]}notifyFilterChange(e){this.__ownChange||this.dispatchEvent(new CustomEvent("legacy-filter-changed",{detail:{name:this.name,state:this.legacyFilterToState(e)},bubbles:!0}))}legacyFilterToState(e){return{filter:e}}getFilterFn(){}getString(e,t){return U(e,t)}toXlsxValue(e,t){return di(e,t)}cellTitleFn(e,t){return this.getString(e,t)}headerTitleFn(e){return e.title}serializeFilter(e,t){return pi(e,t)}deserializeFilter(e,t){return t==null?null:typeof t=="string"?window.decodeURIComponent(t):t}getComparableValue(e,t){return ci(e,t)}computeSource(e,t){return t}_propertiesChanged(e,t,a){super._propertiesChanged(e,t,a),this.dispatchEvent(new CustomEvent("cosmoz-column-prop-changed",{bubbles:!0}))}},gi=i=>e=>i(t=>{if(t.inputValue===void 0&&e.target.value==="")return t;clearTimeout(t.t);const a=setTimeout(()=>i(n=>({...n,filter:n.inputValue})),1e3);return{...t,inputValue:e.target.value,t:a}}),bi=i=>()=>i(e=>({...e,filter:e.inputValue})),fi=i=>e=>{e.keyCode===13&&(e.preventDefault(),i(t=>({...t,filter:t.inputValue})))},hi=i=>e=>i(t=>({...t,headerFocused:e.detail.value})),xi=i=>()=>i(e=>({...e,filter:null,inputValue:null})),vi=i=>i!=null&&i!=="";class yi extends V(I){static get properties(){return{minWidth:{type:String,value:"55px"},editMinWidth:{type:String,value:"55px"},inputValue:{type:Object,notify:!0}}}getFilterFn(e,t){if(!(t==null||t===""))return mi(e,t)}renderCell(e,{item:t}){return m`<span class="default-column">${U(e,t)}</span>`}renderEditCell(e,{item:t},a){return m`<cosmoz-input
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return ae(e,t)}}customElements.define("cosmoz-omnitable-column-date",ra);class la extends We(V(I)){renderCell({valuePath:e,textProperty:t},{item:a}){const n=Re(a,e,t).map(o=>m`<li>${o}</li>`);return m`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		`}renderEditCell(){return"not implemented"}renderHeader(e,{filter:t,query:a},n,o){return m`<cosmoz-autocomplete-ui
			...
			.onText=${je(n)}
			>${_(e.loading,()=>m`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}}customElements.define("cosmoz-omnitable-column-list-horizontal",la);window.Cosmoz=window.Cosmoz||{};class lt extends jt(Wt(Ut,I)){static get template(){return Le`
			<style>
				:host {
					display: block;
				}
		...
		`}static get is(){return"cosmoz-omnitable-column-list-data"}static get properties(){return{items:{type:Array},_expanded:{type:Boolean,value:!1},_othersCount:{type:Number,computed:"_computeOthersCount(items)"}}}static get observers(){return["_itemsLengthChanged(items.length)"]}_itemsLengthChanged(){requestAnimationFrame(()=>this.dispatchEvent(new CustomEvent("expand",{bubbles:!0})))}_firstItem(e){if(e!=null&&e.length>0)return e[0]}_hideExpand(e,t){return e!==void 0&&e.length!==null?e.length<=2||t:!0}_hideCollapse(e,t){return e!==void 0&&e.length!==null?e.length<=2||!t:!0}_otherItems(e,t){if(e!=null&&(e.length<=2||t))return e.slice(1)}_computeOthersCount(e){if(e!=null)return e.length-1}_toggleExpand(e){this._expanded=!this._expanded,e.stopPropagation(),e.preventDefault()}}customElements.define(lt.is,lt);class sa extends We(V(I)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:a}){return m`<cosmoz-omnitable-column-list-data
			.items=${Re(a,e,t)}
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:a},n,o){return m`<cosmoz-autocomplete-ui
			...
			.onText=${je(n)}
			>${_(e.loading,()=>m`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}}customElements.define("cosmoz-omnitable-column-list",sa);class ua extends Ne(ne(I)){static get properties(){return{maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null},formatter:{type:Object,computed:"_computeFormatter(locale, minimumFractionDigits, maximumFractionDigits)"},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, formatter)"}}}render(){const e=t=>{this.headerFocused=t.detail.value,this._onDropdownOpenedChanged(t)};return m`
			<style>
				paper-dropdown-menu {
					--iron-icon-width: 0;
					display: block;
...
>
	...
	>
		<span>${r}</span> ${Sa}
	</button>`},It=({columns:i,...e})=>i?.map(t=>Et({column:t,...e})),za=()=>m`
...
`,Mt=i=>(e,t,a=Kt)=>{const n=Yt(),o=new URLSearchParams(n.hash.replace("#",""));return i(e,t,a,o),"#!"+Object.assign(n,{hash:o}).href.replace(location.origin,"")},Lt=i=>i==null||i==="",Aa=Mt((i,e,t,a)=>Lt(t(e))?a.delete(i):a.set(i,t(e))),Fa=Mt((i,e,t,a)=>Object.entries(e).map(t).forEach(([n,o])=>Lt(o)?a.delete(i+n):a.set(i+n,o))),X=(i,e,{suffix:t="",read:a,write:n,multi:o}={})=>{const[r,l]=o?[Fa,Jt]:[Aa,Xt],[s,u]=T(()=>e==null?i:l(e+t,a)??i),d=$(c=>u(b=>{const p=$e(c,b);return e!=null&&Qt(r(e+t,p,n),null,{notify:!1}),p}),[e,t,r,n]);return[s,d]},ka=i=>[!0,"true",1,"yes","on"].includes(i),ce=i=>i===""||(i==null?void 0:ka(i)),me=(i,e,t)=>$(a=>{i(a),t(n=>({...n,[e]:a}))},[i,e,t]),_a=(i,e,t,a,n)=>{const[o,r]=X(t.sortOn,e,{suffix:"-sortOn"}),[l,s]=X(ce(t.descending),e,{suffix:"-descending",read:ce}),[u,d]=X(t.groupOn,e,{suffix:"-groupOn"}),[c,b]=X(ce(t.groupOnDescending),e,{suffix:"-groupOnDescending",read:ce}),p=F(()=>i.find(g=>g.name===o),[i,o]),z=F(()=>i.find(g=>g.name===u),[i,u]),h={groupOn:u,setGroupOn:me(d,"groupOn",a),groupOnDescending:c,setGroupOnDescending:me(b,"groupOnDescending",a),sortOn:o,setSortOn:me(r,"sortOn",a),descending:l,setDescending:me(s,"descending",a),columns:i},y=F(()=>h,Object.values(h)),k=$(g=>{r(g.sortOn),d(g.groupOn),s(g.descending),b(g.groupOnDescending)},[]);return M(()=>void(n.current=k),[]),{...y,sortAndGroup:y,groupOnColumn:z,sortOnColumn:p}},Qe=vt();customElements.define("sort-and-group-provider",Qe.Provider);customElements.define("sort-and-group-consumer",O(({render:i})=>i(Oe(Qe)),{useShadowDOM:!1}));const Ea=({data:i,columns:e,groupOnColumn:t,filters:a,setFilterState:n,sortAndGroup:{sortOn:o,setSortOn:r,descending:l,setDescending:s}={}})=>yt(e,u=>u.name,u=>[m`<div
			...
			>
				...
				.column="${u}"
				name="${u.name}"
			></cosmoz-omnitable-resize-nub>`]),Ia=({columns:i,settingsConfig:e,hideSelectAll:t,...a})=>{const n=Oe(Qe);return m`
		${_(i,o=>Ea({columns:o,sortAndGroup:n,...a}))}
		${_(!t,()=>m` <cosmoz-omnitable-settings
					.config=${e}
					part="settings"
				></cosmoz-omnitable-settings>`)}
	`};customElements.define("cosmoz-omnitable-header-row",O(Ia,{useShadowDOM:!1}));const Ma=K`
	:host {
		display: flex;
		align-items: center;
		flex-wrap: wrap;
...
`;customElements.define("cosmoz-omnitable-item-expand-line",O(La,{styleSheets:[De(Ma)]}));const Oa=({columns:i,item:e,selected:t,expanded:a,groupOnColumn:n})=>Zt(i,o=>m`<cosmoz-omnitable-item-expand-line
				.column=${o}
				?hidden=${o===n}
...
`,pe=i=>{const e=parseInt(i,10);return isFinite(e)?e:void 0},Ja=i=>{const{config:e}=i,{settings:t,setSettings:a,collapsed:n}=e,o=Ve({collapsed:n,settings:t.columns,setSettings:$(r=>a(l=>({...l,columns:r})),[a])});return{...e,onDown:$(r=>{r.target.closest(".pull")&&(o.handle=r.currentTarget)},[o]),onDragStart:$(r=>{const{target:l}=r,s=pe(l.dataset.index);if(!o.handle?.contains(l)||s==null)return r.preventDefault();o.handle=null,r.dataTransfer.effectAllowed="move",r.dataTransfer.setData("omnitable/sort-index",s),r.dataTransfer.setData("text/plain",s),setTimeout(()=>l.classList.add("drag"),0),l.addEventListener("dragend",u=>u.target.classList.remove("drag"),{once:!0})},[o]),onDragEnter:$(r=>{const l=r.currentTarget;l===r.target&&(r.preventDefault(),r.dataTransfer.dropEffect="move",l.classList.add("dragover"))},[]),onDragOver:$(r=>{r.preventDefault(),r.currentTarget.classList.add("dragover")},[]),onDragLeave:$(r=>{const l=r.currentTarget;l.contains(r.relatedTarget)||l.classList.remove("dragover")},[]),onDrop:$(r=>{const l=pe(r.dataTransfer.getData("omnitable/sort-index")),s=pe(r.currentTarget.dataset.index),{settings:u,setSettings:d}=o;r.currentTarget.classList.remove("dragover"),r.preventDefault();const c=u.slice();c.splice(s+(l>=s?0:-1),0,c.splice(l,1)[0]),d(c)},[o]),onToggle:$(r=>{const{settings:l,setSettings:s}=o,u=l.map(c=>({...c,disabled:c.disabled||o.collapsed?.some(b=>b.name===c.name)})),d=pe(r.target.closest("[data-index]")?.dataset.index);u.splice(d,1,{...l[d],disabled:!r.target.checked,priority:r.target.checked?l.reduce((c,b)=>Math.max(c,b.priority),0)+1:l[d].priority}),s(u)},[o])}},Xa=[ai({apply({availableHeight:i,elements:e}){Object.assign(e.floating.style,{maxHeight:`${Math.max(0,i)}px`})}}),...ni],Qa=({onDragStart:i,onDragEnter:e,onDragOver:t,onDragLeave:a,onDrop:n,onDown:o,onToggle:r,collapsed:l,filters:s})=>(u,d)=>{const c=!!l?.find(p=>p.name===u.name),b=!u.disabled&&!c;return m` <div
			class="item"
			data-index=${d}
			@mousedown=${o}
			draggable="true"
