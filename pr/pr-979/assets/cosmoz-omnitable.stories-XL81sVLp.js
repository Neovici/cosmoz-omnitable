import{n as e}from"./chunk-BneVvdWh.js";import{J as t,Q as n,Y as r,Z as i}from"./iframe-DMjGR7AQ.js";import{$ as a,A as o,At as s,B as c,C as l,Ct as u,D as d,Dt as f,E as p,Et as m,F as h,Ft as g,G as _,Gt as ee,H as te,Ht as v,I as ne,It as y,J as re,K as ie,L as ae,Lt as oe,M as se,Mt as ce,N as le,Nt as b,O as ue,Ot as de,P as fe,Pt as x,Q as pe,R as S,Rt as me,S as C,St as he,T as ge,Tt as _e,U as w,Ut as T,V as ve,Vt as ye,W as be,Wt as xe,X as Se,Y as Ce,Z as we,_ as Te,_t as Ee,a as De,at as E,b as Oe,bt as ke,c as Ae,ct as je,d as Me,dt as D,et as Ne,f as Pe,ft as O,g as Fe,gt as Ie,h as Le,ht as Re,i as ze,it as Be,j as Ve,jt as k,k as He,kt as Ue,l as We,lt as Ge,m as Ke,mt as qe,n as Je,nt as Ye,o as Xe,ot as A,p as Ze,pt as Qe,q as $e,r as et,rt as tt,s as nt,st as rt,t as it,tt as at,u as ot,ut as st,v as ct,vt as lt,w as ut,wt as dt,x as ft,xt as pt,y as j,yt as mt,z as M,zt as ht}from"./dist-qi5Vo4cd.js";var gt,_t,N=e((()=>{$e(),m(),gt=Se`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,Mt=e=>{let{label:t,value:n,slot:r}=e;return tt(i`<div
	...
	>
		${n||``}
	</div>`,{label:t})},customElements.define(`cosmoz-omnitable-dropdown-input`,f(Mt,{observedAttributes:At,styleSheets:[jt]}))})),Pt,Ft=e((()=>{lt(),n(),ae(),Nt(),Pt=({title:e,tooltip:t=``,filterText:n=``,onOpenedChanged:r,content:a,horizontalAlign:o=`left`,externalValues:s=null})=>i`
		<style>
			.dropdown {
				outline: none;
			}
...
`}));function gi(e,t,{suffix:n=``,read:r,write:i,ready:a=!0,multi:o}={}){let s=ke({param:t,suffix:n,link:o?bi:yi,write:i??qe}),c=x(()=>{if(t==null)return!1;if(o){let e=ot(t+n);return Object.keys(e).length>0}return Me(t+n)!==void 0},[]),[l,u]=k(()=>{if(t==null)return e;if(o){let i=ot(t+n,r);return Object.keys(i).length>0?i:e}return Me(t+n,r)??e}),d=b(e=>u(t=>{let n=Ie(e,t);return s.param!=null&&Ze(s.link(s.param+s.suffix,n,s.write),null,{notify:!1}),n}),[]);return y(()=>{s.param==null||!a||c||e!=null&&d(e)},[a]),[l,d]}var _i,vi,yi,bi,xi=e((()=>{Pe(),Re(),mt(),We(),m(),_i=e=>(t,n,r=qe)=>{let i=Ae(),a=new URLSearchParams(i.hash.replace(`#`,``));return e(t,n,r,a),`#!`+Object.assign(i,{hash:a}).href.replace(location.origin,``)},vi=e=>e==null||e===``,yi=_i((e,t,n,r)=>vi(n(t))?r.delete(e):r.set(e,n(t))),bi=_i((e,t,n,r)=>{let i=Object.entries(t),a=i.map(n).filter(([,e])=>e!==void 0);if(a.length===0&&i.length>0)return;let o=e;Array.from(r.keys()).filter(e=>e.startsWith(o)).forEach(e=>r.delete(e)),a.forEach(([t,n])=>vi(n)?r.delete(e+t):r.set(e+t,n))})})),Si,Ci,wi,Ti,Ei,Di=e((()=>{m(),xi(),Si=e=>[!0,`true`,1,`yes`,`on`].includes(e),Ci=e=>e===``||(e==null?void 0:Si(e)),wi=(e,t,n)=>b(r=>{e(r),n(e=>({...e,[t]:r}))},[e,t,n]),Ti=(e,t,{settings:n,setSettings:r,resetRef:i,ready:a=!0})=>{let[o,s]=gi(n.sortOn,t,{suffix:`-sortOn`,ready:a}),[c,l]=gi(Ci(n.descending),t,{suffix:`-descending`,read:Ci,ready:a}),[u,d]=gi(n.groupOn,t,{suffix:`-groupOn`,ready:a}),[f,p]=gi(Ci(n.groupOnDescending),t,{suffix:`-groupOnDescending`,read:Ci,ready:a}),m=x(()=>e.find(e=>e.name===o),[e,o]),h=x(()=>e.find(e=>e.name===u),[e,u]),g={groupOn:u,setGroupOn:wi(d,`groupOn`,r),groupOnDescending:f,setGroupOnDescending:wi(p,`groupOnDescending`,r),sortOn:o,setSortOn:wi(s,`sortOn`,r),descending:c,setDescending:wi(l,`descending`,r),columns:e},_=x(()=>g,Object.values(g)),ee=b(e=>{s(e.sortOn),d(e.groupOn),l(e.descending),p(e.groupOnDescending)},[]);return y(()=>void(i.current=ee),[]),{..._,sortAndGroup:_,groupOnColumn:h,sortOnColumn:m}},Ei=de(),customElements.define(`sort-and-group-provider`,Ei.Provider),customElements.define(`sort-and-group-consumer`,f(({render:e})=>e(g(Ei)),{useShadowDOM:!1}))})),Oi,ki,Ai=e((()=>{m(),ue(),ai(),hi(),v(),Di(),Oi=({data:e,columns:t,groupOnColumn:n,filters:r,setFilterState:a,sortAndGroup:{sortOn:o,setSortOn:s,descending:c,setDescending:l}={}})=>d(t,e=>e.name,t=>[i`<div
