import{b as d,D as Fe,A as bt,w as Pt}from"./iframe-rnRbFPxi.js";import{t as K,c as T,g as C,P as A,u as M,a as xt,m as vt,s as Bt,D as Gt,b as Ht,e as Wt,i as ye,h as Ae,d as qt,f as yt,r as Xt,j as Ut,k,l as Kt,n as $e,p as he,o as D,q as Jt,v as we,w as Qt,x as Yt,y as Zt,T as en,z as E,A as fe,B as I,C as tn,E as nn,F as on,G as w,H as rn,I as ln,J as $t,K as Ee,L as wt,M as Te,N as an,O as zt,Q as sn,R as Le,S as Qe,U as un,V as Re,W as cn,X as dn,Y as Oe,Z as Me,_ as mn,$ as De,a0 as P,a1 as pn,a2 as Ce,a3 as gn}from"./cosmoz-collapse-C0NVNiYT.js";import"./preload-helper-PPVm8Dsz.js";const hn=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,Rn=n=>{const{label:e,value:t,slot:o}=n,r=d`<div
	...
	>
		${t||""}
	</div>`;return Xt(r,{label:e})};customElements.define("cosmoz-omnitable-dropdown-input",T(Rn,{observedAttributes:Tn,styleSheets:[Ln]}));const ee=({title:n,tooltip:e="",filterText:t="",onOpenedChanged:o,content:r,horizontalAlign:i="left",externalValues:l=null})=>{const a={filtered:!!t,...l!=null&&{[`external-values-${l}`]:!0}};return d`
		<style>
			.dropdown {
				outline: none;
			}
	...
	`};class Mn extends Ne(Z(A)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return d`
		...
		>`}getComparableValue(e,t){return Zn(e,t)}}customElements.define("cosmoz-omnitable-column-autocomplete",eo);const qe=(n,e)=>e.find(({value:t})=>n===t),to=(n,e,t)=>{const o=qe(e,t);return o?o.text:n},ot=(n,e,t,o)=>to(n,C(e,t),o),no=({valuePath:n},e,t)=>qe(C(e,n),t),oo=n=>e=>{n(t=>({...t,filter:e?.[0]?.value??null}))},ro=n=>e=>{n(t=>({...t,headerFocused:e}))},io=n=>e=>{n(t=>({...t,query:e}))},lo=n=>e=>n(e?.[0]?.value),rt=({valuePath:n,trueLabel:e,falseLabel:t},o)=>C(o,n)?e:t,ao=({valuePath:n},e)=>t=>C(t,n)===e,ne=vt((n,e)=>[{text:n,value:!0},{text:e,value:!1}]),so=({valuePath:n,trueLabel:e,falseLabel:t},o)=>n?C(o,n)?e:t:"",uo=(n,e)=>{try{return JSON.parse(e)}catch{return null}};class co extends N(A){static get properties(){return{trueLabel:{type:String,value:"True"},falseLabel:{type:String,value:"False"},flex:{type:String,value:"0"},cellClass:{type:String,value:"boolean-cell"}}}getString(e,t){return rt(e,t)}renderCell(e,{item:t}){return rt(e,t)}renderEditCell(e,{item:t},o){const{trueLabel:r,falseLabel:i}=e;return d`<cosmoz-autocomplete
			no-label-float
		...
		`}renderEditCell(){return"not implemented"}renderHeader(e,{filter:t,query:o},r,i){return d`<cosmoz-autocomplete-ui
			...
			.onText=${He(r)}
			>${D(e.loading,()=>d`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}}customElements.define("cosmoz-omnitable-column-list-horizontal",xo);window.Cosmoz=window.Cosmoz||{};class at extends Yt(Zt(en,A)){static get template(){return Ae`
			<style>
				:host {
					display: block;
				}
		...
		`}static get is(){return"cosmoz-omnitable-column-list-data"}static get properties(){return{items:{type:Array},_expanded:{type:Boolean,value:!1},_othersCount:{type:Number,computed:"_computeOthersCount(items)"}}}static get observers(){return["_itemsLengthChanged(items.length)"]}_itemsLengthChanged(){requestAnimationFrame(()=>this.dispatchEvent(new CustomEvent("expand",{bubbles:!0})))}_firstItem(e){if(e!=null&&e.length>0)return e[0]}_hideExpand(e,t){return e!==void 0&&e.length!==null?e.length<=2||t:!0}_hideCollapse(e,t){return e!==void 0&&e.length!==null?e.length<=2||!t:!0}_otherItems(e,t){if(e!=null&&(e.length<=2||t))return e.slice(1)}_computeOthersCount(e){if(e!=null)return e.length-1}_toggleExpand(e){this._expanded=!this._expanded,e.stopPropagation(),e.preventDefault()}}customElements.define(at.is,at);class vo extends We(N(A)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:o}){return d`<cosmoz-omnitable-column-list-data
			.items=${je(o,e,t)}
...
`,Tt=n=>(e,t,o=tn)=>{const r=ln(),i=new URLSearchParams(r.hash.replace("#",""));return n(e,t,o,i),"#!"+Object.assign(r,{hash:i}).href.replace(location.origin,"")},Lt=n=>n==null||n==="",Mo=Tt((n,e,t,o)=>Lt(t(e))?o.delete(n):o.set(n,t(e))),No=Tt((n,e,t,o)=>Object.entries(e).map(t).forEach(([r,i])=>Lt(i)?o.delete(n+r):o.set(n+r,i))),J=(n,e,{suffix:t="",read:o,write:r,multi:i}={})=>{const[l,a]=i?[No,nn]:[Mo,on],u=I(()=>e!=null&&a(e+t,o)!=null,[]),[s,c]=M(()=>e==null?n:a(e+t,o)??n),m=w(h=>c(p=>{const x=ye(h,p);return e!=null&&rn(l(e+t,x,r),null,{notify:!1}),x}),[e,t,l,r]);return E(()=>{e!=null&&(u||n!=null&&m(n))},[n,e,u,m]),[s,m]},jo=n=>[!0,"true",1,"yes","on"].includes(n),le=n=>n===""||(n==null?void 0:jo(n)),ae=(n,e,t)=>w(o=>{n(o),t(r=>({...r,[e]:o}))},[n,e,t]),Po=(n,e,t,o,r)=>{const[i,l]=J(t.sortOn,e,{suffix:"-sortOn"}),[a,u]=J(le(t.descending),e,{suffix:"-descending",read:le}),[s,c]=J(t.groupOn,e,{suffix:"-groupOn"}),[m,h]=J(le(t.groupOnDescending),e,{suffix:"-groupOnDescending",read:le}),p=I(()=>n.find(g=>g.name===i),[n,i]),x=I(()=>n.find(g=>g.name===s),[n,s]),b={groupOn:s,setGroupOn:ae(c,"groupOn",o),groupOnDescending:m,setGroupOnDescending:ae(h,"groupOnDescending",o),sortOn:i,setSortOn:ae(l,"sortOn",o),descending:a,setDescending:ae(u,"descending",o),columns:n},$=I(()=>b,Object.values(b)),F=w(g=>{l(g.sortOn),c(g.groupOn),u(g.descending),h(g.groupOnDescending)},[]);return E(()=>void(r.current=F),[]),{...$,sortAndGroup:$,groupOnColumn:x,sortOnColumn:p}},Je=$t();customElements.define("sort-and-group-provider",Je.Provider);customElements.define("sort-and-group-consumer",T(({render:n})=>n(Ee(Je)),{useShadowDOM:!1}));const Bo=({data:n,columns:e,groupOnColumn:t,filters:o,setFilterState:r,sortAndGroup:{sortOn:i,setSortOn:l,descending:a,setDescending:u}={}})=>wt(e,s=>s.name,s=>[d`<div
...
`;customElements.define("cosmoz-omnitable-item-expand-line",T(Wo,{styleSheets:[Te(Ho)]}));const qo=({columns:n,item:e,selected:t,expanded:o,groupOnColumn:r})=>an(n,i=>d`<cosmoz-omnitable-item-expand-line
			...
			>`);customElements.define("cosmoz-omnitable-item-expand",T(qo,{useShadowDOM:!1}));const Xo=(n,e,t)=>n.editable?n.renderEditCell(n,e,t(n,e.item)):n.renderCell(n,e),Uo=({columns:n,groupOnColumn:e,item:t,index:o,selected:r,expanded:i,onItemChange:l})=>wt(n,a=>a.name,a=>d`<div
			...
			</div>`);customElements.define("cosmoz-omnitable-item-row",T(Uo,{useShadowDOM:!1}));const Rt=K`
	.checkbox {
		box-sizing: border-box;
		width: 18px;
		height: 18px;
...
`,pt=n=>{const e=n.replace(/"/gu,'""');return e.search(/("|,|\n)/gu)>=0?'"'+e+'"':n},Jo=(n,e,t)=>{const i=n.map(a=>pt(a.title)).join(";")+`
`,l=e.map(a=>n.map(u=>{const s=u.getString(u,a);return s==null?"":pt(String(s))}).join(";")+`
`);l.unshift(i),zt(new File(l,t,{type:"text/csv;charset=utf-8"}))},Qo=(n,e)=>{const t=n.map(r=>r.title),o=e.map(r=>n.map(i=>{const l=i.toXlsxValue(i,r);return l??""}));return o.unshift(t),o},Yo=(n,e,t,o)=>{const r=Qo(n,e),i=new sn(t).addSheetFromData(r,o).generate();zt(new File([i],t,{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}))},Zo=({columns:n,selectedItems:e,csvFilename:t,xlsxFilename:o,xlsxSheetname:r,topPlacement:i})=>d`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!Le(e.length)}
		part="bottomBar"
