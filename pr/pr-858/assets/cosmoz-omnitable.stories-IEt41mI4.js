import{b as d,D as ke,A as yt}from"./iframe-BqNT0oPs.js";import{t as K,c as O,g as S,P as I,u as D,a as vt,m as $t,s as Bt,D as Gt,b as Ht,e as jt,i as $e,h as Oe,d as Wt,f as Ct,r as Ut,j as Kt,k as q,l as Jt,n as Ce,p as he,o as k,q as Xt,v as we,w as Qt,x as Yt,y as Zt,T as ei,z as M,A as Ye,B as ti,C as ii,E as ai,F as C,G as Ze,H as ni,I as wt,J as Le,K as F,L as St,M as De,N as oi,O as zt,Q as ri,R as Te,S as et,U as li,V as Ve,W as si,X as ui,Y as Ee,Z as Pe,_ as ci,$ as Ie,a0 as R,a1 as di,a2 as ze,a3 as mi}from"./cosmoz-collapse-l0VW1IDB.js";import"./preload-helper-PPVm8Dsz.js";const pi=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,Li=i=>{const{label:e,value:t,slot:a}=i,n=d`<div
	...
	>
		${t||""}
	</div>`;return Ut(n,{label:e})};customElements.define("cosmoz-omnitable-dropdown-input",O(Li,{observedAttributes:Mi,styleSheets:[Oi]}));const ne=({title:i,tooltip:e="",filterText:t="",onOpenedChanged:a,content:n,horizontalAlign:o="left",externalValues:r=null})=>{const l={filtered:!!t,...r!=null&&{[`external-values-${r}`]:!0}};return d`
		<style>
			.dropdown {
				outline: none;
			}
	...
	`};class Di extends Re(ae(I)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return d`
		...
		>`}getComparableValue(e,t){return Qi(e,t)}}customElements.define("cosmoz-omnitable-column-autocomplete",Yi);const Ue=(i,e)=>e.find(({value:t})=>i===t),Zi=(i,e,t)=>{const a=Ue(e,t);return a?a.text:i},rt=(i,e,t,a)=>Zi(i,S(e,t),a),ea=({valuePath:i},e,t)=>Ue(S(e,i),t),ta=i=>e=>{i(t=>({...t,filter:e?.[0]?.value??null}))},ia=i=>e=>{i(t=>({...t,headerFocused:e}))},aa=i=>e=>{i(t=>({...t,query:e}))},na=i=>e=>i(e?.[0]?.value),lt=({valuePath:i,trueLabel:e,falseLabel:t},a)=>S(a,i)?e:t,oa=({valuePath:i},e)=>t=>S(t,i)===e,le=$t((i,e)=>[{text:i,value:!0},{text:e,value:!1}]),ra=({valuePath:i,trueLabel:e,falseLabel:t},a)=>i?S(a,i)?e:t:"",la=(i,e)=>{try{return JSON.parse(e)}catch{return null}};class sa extends V(I){static get properties(){return{trueLabel:{type:String,value:"True"},falseLabel:{type:String,value:"False"},flex:{type:String,value:"0"},cellClass:{type:String,value:"boolean-cell"}}}getString(e,t){return lt(e,t)}renderCell(e,{item:t}){return lt(e,t)}renderEditCell(e,{item:t},a){const{trueLabel:n,falseLabel:o}=e;return d`<cosmoz-autocomplete
			no-label-float
			.title=${rt(e.title,t,e.valuePath,le(n,o))}
			.source=${le(n,o)}
			.textProperty=${"text"}
			.value=${ea(e,t,le(n,o))}
			.onChange=${na(a)}
		...
		>`}computeSource({trueLabel:e,falseLabel:t}){return le(e,t)}getFilterFn(e,t){if(t!=null)return oa(e,t)}toXlsxValue(e,t){return ra(e,t)}deserializeFilter(e,t){return la(e,t)}}customElements.define("cosmoz-omnitable-column-boolean",sa);const Ke=i=>class extends Re(i){static get properties(){return{max:{type:Date,value:null},min:{type:Date,value:null},_filterText:{type:String,computed:"_computeFilterText(filter.*, formatter)"},formatter:{type:Object,computed:"_computeFormatter(locale)"}}}toDate(e,t,a){if(e==null||e==="")return;let n=e;if(n instanceof Date||(typeof e=="string"&&(n=this.getAbsoluteISOString(n)),n=new Date(n)),Number.isNaN(n.getTime()))return null;if(a==null||t==null)return n;const o=this.toDate(t);if(o==null)return n;const r=this.getComparableValue(n),l=this.getComparableValue(o);return a(r,l)===r?n:o}toValue(){return this.toDate.apply(this,arguments)}getComparableValue(e,t){const a=super.getComparableValue(e,t);if(a!=null)return this.toNumber(a.getTime())}getString(e,t=this.valuePath,a=this.formatter){const n=this.toValue(this.get(t,e));return n===void 0?"":n===null?"Invalid Date":this.renderValue(n,a)}getAbsoluteISOString(e){return e.length===19?e+this._getTimezoneString(e):e}_getTimezoneString(e){const t=-new Date(e).getTimezoneOffset()/60;return(t<0?"-":"+")+["0",Math.abs(t)].join("").substr(-2)+":00"}renderValue(e,t=this.formatter){if(t==null)return;const a=this.toValue(e);if(a!=null)return t.format(a)}_computeFormatter(e){return new Intl.DateTimeFormat(e||void 0)}_toInputString(e){const t=this.toValue(e);return t==null?null:this._toLocalISOString(t).slice(0,10)}_dateValueChanged(e){const t=e.currentTarget,a=t.value,n=e.model.item,o=this.get(this.valuePath,n),r=this._fromInputString(a);this.set(this.valuePath,r,n),this._fireItemChangeEvent(n,this.valuePath,o,this.renderValue.bind(this))}_toLocalISOString(e){return we(e)}};class ua extends Ke(ae(I)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return d`
			...
			${ne({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:d`
					...
					></cosmoz-input>
				`})}
		`}_fromInputString(e,t){const a=this.toDate(e);if(a!=null)return t==="min"&&a.setHours(0,0,0,0),t==="max"&&a.setHours(23,59,59),a}_filterInputChanged(e,t){const a=e.path.split(".")[1],n=a&&e.value;if(n&&n.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}}customElements.define("cosmoz-omnitable-date-range-input",ua);const ca=i=>{const e=-new Date(i).getTimezoneOffset()/60;return(e<0?"-":"+")+["0",Math.abs(e)].join("").substr(-2)+":00"},Je=i=>i.length===19?i+ca(i):i,kt=i=>{if(i==null||i==="")return;let e=i;return!(e instanceof Date)&&(typeof i=="string"&&(e=Je(e)),e=Qt(e),!e)||Number.isNaN(e.getTime())?null:e},P=({valuePath:i},e)=>{if(e==null)return;let t=e;i!=null&&(t=S(e,i));const a=kt(t);if(a!=null)return L(a.getTime())},E=(i,e,t)=>{const a=kt(i);return a??null},Xe=(i,e)=>{if(e==null)return;const t=E(i);if(t!=null)return e.format(t)},se={},da=i=>{const e=i||"";return se[e]||(se[e]=new Intl.DateTimeFormat(i||void 0)),se[e]},st=({valuePath:i,locale:e},t)=>{let a=S(t,i||"");return a===void 0?"":(a=E(a),a===null?"Invalid Date":Xe(a,da(e)))},Et=i=>{const e=E(i);if(e==null)return null;const t=we(e);return t==null?null:t.slice(0,10)},ma=({valuePath:i},e)=>Et(S(e,i||"")),It=(i,e)=>{const t=E(i);if(t!=null)return t},ut=i=>{const e=Et(i);return e??""},pa=({valuePath:i},e)=>{if(!i)return"";const t=E(S(e,i));if(!t)return"";const a=E(we(t));return a?(a.setHours(0,0,0,0),a):""},Mt=(i,e)=>t=>{const a=P(i,t);if(a==null)return!1;const n=P({...i,valuePath:"min"},e),o=P({...i,valuePath:"max"},e);return!(a<(n??-1/0)||a>(o??1/0))};class ga extends V(I){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"date-header-cell"},width:{type:String,value:"100px"},minWidth:{type:String,value:"82px"},flex:{type:String,value:"0"}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const a=P({...e,valuePath:"min"},t),n=P({...e,valuePath:"max"},t);if(!(a==null&&n==null))return Mt(e,t)}getString(e,t){return st(e,t)}toXlsxValue(e,t){return pa(e,t)}getComparableValue(e,t){return P(e,t)}serializeFilter(e,t){if(t==null)return;const a=E(t.min),n=E(t.max);if(!(a==null&&n==null))return ut(a)+"~"+ut(n)}deserializeFilter(e,t){if(t==null||t==="")return null;const a=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(a)?{min:E(a[1]),max:E(a[2])}:null}renderCell(e,{item:t}){return d`<div class="omnitable-cell-date">
			${st(e,t)}
		...
		`}renderEditCell(){return"not implemented"}renderHeader(e,{filter:t,query:a},n,o){return d`<cosmoz-autocomplete-ui
			...
			.onText=${je(n)}
			>${k(e.loading,()=>d`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}}customElements.define("cosmoz-omnitable-column-list-horizontal",ba);window.Cosmoz=window.Cosmoz||{};class ct extends Yt(Zt(ei,I)){static get template(){return Oe`
			<style>
				:host {
					display: block;
				}
		...
		`}static get is(){return"cosmoz-omnitable-column-list-data"}static get properties(){return{items:{type:Array},_expanded:{type:Boolean,value:!1},_othersCount:{type:Number,computed:"_computeOthersCount(items)"}}}static get observers(){return["_itemsLengthChanged(items.length)"]}_itemsLengthChanged(){requestAnimationFrame(()=>this.dispatchEvent(new CustomEvent("expand",{bubbles:!0})))}_firstItem(e){if(e!=null&&e.length>0)return e[0]}_hideExpand(e,t){return e!==void 0&&e.length!==null?e.length<=2||t:!0}_hideCollapse(e,t){return e!==void 0&&e.length!==null?e.length<=2||!t:!0}_otherItems(e,t){if(e!=null&&(e.length<=2||t))return e.slice(1)}_computeOthersCount(e){if(e!=null)return e.length-1}_toggleExpand(e){this._expanded=!this._expanded,e.stopPropagation(),e.preventDefault()}}customElements.define(ct.is,ct);class fa extends We(V(I)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:a}){return d`<cosmoz-omnitable-column-list-data
			.items=${Ne(a,e,t)}
		...
		></cosmoz-omnitable-number-range-input>`}computeSource(e,t){return ie(e,t)}}customElements.define("cosmoz-omnitable-column-number",xa);const Ot="1970-01-01",B=(i,e,t)=>{const a=typeof i=="string"&&i.length>3&&i.length<=9?Je(Ot+"T"+i):i;return E(a)},ue={},ya=i=>{const e=i||"";if(ue[e])return ue[e];const t={hour:"numeric",minute:"numeric",second:"numeric"};return ue[e]=new Intl.DateTimeFormat(i||void 0,t),ue[e]},fe=({valuePath:i,locale:e},t)=>{const a=B(S(t,i||""));return a===void 0?"":a===null?"Invalid Date":Xe(a,ya(e))},va=(i,e)=>i.valuePath?fe(i,e):"",$a=i=>{const e=B(i);if(e==null)return null;const t=we(e);return t&&t.slice(11,19)},W=({valuePath:i},e)=>{if(e==null)return;const t=$a(i==null?e:S(e,i));if(t==null)return;const a=B(Je(Ot+"T"+t));return a==null?a:L(a.getTime())},Ca=(i,e)=>t=>{const a=W(i,t);if(a==null)return!1;const n=W({...i,valuePath:"min"},e),o=W({...i,valuePath:"max"},e);return n==null||o==null?!1:!(a<n||a>o)},dt=i=>{const e=B(i);return e==null?"":e.toISOString().slice(11,19).replace(/:/gu,".")},mt=i=>{if(!(i==null||i===""))return B(typeof i=="string"?i.replace(/\./gu,":")+"Z":i)};class wa extends Ke(ae(I)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return d`
			<cosmoz-clear-button
				@click=${()=>this.resetFilter()}
				?visible=${this.hasFilter()}
			></cosmoz-clear-button>
		...
		></cosmoz-input>`}renderHeader({title:e,min:t,max:a,locale:n,filterStep:o},{filter:r},l,u){return d`<cosmoz-omnitable-time-range-input
			...
			@filter-changed=${({detail:{value:s}})=>l(c=>({...c,filter:s}))}
			@header-focused-changed=${({detail:{value:s}})=>l(c=>({...c,headerFocused:s}))}
		></cosmoz-omnitable-time-range-input>`}computeSource(e,t){return ie(e,t)}}customElements.define("cosmoz-omnitable-column-time",Sa);const ce={},za=i=>{const e=i||"";if(ce[e])return ce[e];const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return ce[e]=new Intl.DateTimeFormat(i||void 0,t),ce[e]},qe=({valuePath:i,locale:e},t)=>{const a=E(S(t,i||""));return a===void 0?"":a===null?"Invalid Date":Xe(a,za(e))},qa=({valuePath:i},e)=>i?S(e,i):"",pt=i=>{const e=E(i);return e==null?"":e.toISOString().slice(0,19).replace(/:/gu,".")},gt=i=>{if(!(i==null||i==="")&&typeof i=="string")return E(i.replace(/\./gu,":")+"Z")};class Aa extends Ke(ae(I)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return d`
			<style>
			...
			${ne({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:d`
					...
					></cosmoz-datetime-input>
				`})}
		`}_toInputString(e){const t=this.toValue(e);if(t!=null)return this._toLocalISOString(t).slice(0,19)}_computeFormatter(e){const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return new Intl.DateTimeFormat(e||void 0,t)}}customElements.define("cosmoz-omnitable-datetime-range-input",Aa);class bt extends V(I){static get is(){return"cosmoz-omnitable-column-datetime"}static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"datetime-header-cell"},width:{type:String,value:"210px"},minWidth:{type:String,value:"128px"},flex:{type:String,value:"0"},filterStep:{type:Number,value:1}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const a=P({...e,valuePath:"min"},t),n=P({...e,valuePath:"max"},t);if(!(a==null&&n==null))return Mt(e,t)}getString(e,t){return qe(e,t)}toXlsxValue(e,t){return qa(e,t)}getComparableValue(e,t){return P(e,t)}serializeFilter(e,t){if(t==null)return;const a=E(t.min),n=E(t.max);if(!(a==null&&n==null))return pt(a)+"~"+pt(n)}deserializeFilter(e,t){if(t==null||t==="")return null;const a=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(a)?{min:gt(a[1]),max:gt(a[2])}:null}renderCell(e,{item:t}){return qe(e,t)}renderEditCell(e,{item:t},a){return d`<cosmoz-input
			no-label-float
			type="text"
			@change=${o=>a(It(o.target.value))}
			.value=${qe(e,t)}
		...
		></cosmoz-omnitable-datetime-range-input>`}computeSource(e,t){return ie(e,t)}}customElements.define(bt.is,bt);const Fa=({column:i,item:e,selected:t,folded:a,group:n})=>i?(i.renderGroup??i.renderCell)(i,{item:e,selected:t,folded:a,group:n}):yt;customElements.define("cosmoz-omnitable-group-row",O(Fa,{useShadowDOM:!1}));const _a=i=>{const{column:e}=i;return M(()=>{let t=0,a=0;const n=l=>{i.dispatchEvent(new CustomEvent("column-resize",{bubbles:!0,composed:!0,detail:{newWidth:Math.ceil(a+l.pageX-t),column:e}}))},o=()=>{document.removeEventListener("pointermove",n),document.removeEventListener("pointerup",o)},r=l=>{t=l.pageX,a=i.previousElementSibling.getBoundingClientRect().width,document.addEventListener("pointermove",n),document.addEventListener("pointerup",o)};return i.addEventListener("pointerdown",r),()=>i.removeEventListener("pointerdown",r)},[e]),yt};customElements.define("cosmoz-omnitable-resize-nub",O(_a));const ka=d`<svg
	width="10"
	height="9"
	viewBox="0 0 10 9"
	stroke="currentColor"
...
>
	...
	/>
</svg> `,Lt=({column:i,on:e,descending:t,setOn:a,setDescending:n})=>{const{name:o,title:r}=i??{};return d`<button
		class="sg"
		title=${Ye(r)}
	...
	>
		<span>${r}</span> ${Ia}
	</button>`},Dt=({columns:i,...e})=>i?.map(t=>Lt({column:t,...e})),Ma=()=>d`
	<sort-and-group-consumer
		class="sgs"
		.render=${({columns:i,groupOn:e,setGroupOn:t,groupOnDescending:a,setGroupOnDescending:n}={})=>Dt({columns:i?.filter?.(o=>o.groupOn),on:e,setOn:t,descending:a,setDescending:n})}
	>
	</sort-and-group-consumer>
`,Oa=()=>d`
	<sort-and-group-consumer
		class="sgs"
		.render=${({columns:i,sortOn:e,setSortOn:t,descending:a,setDescending:n}={})=>Dt({columns:i?.filter?.(o=>o.sortOn&&!o.noSort),on:e,setOn:t,descending:a,setDescending:n})}
	>
	</sort-and-group-consumer>
`,Tt=i=>(e,t,a=ti)=>{const n=ni(),o=new URLSearchParams(n.hash.replace("#",""));return i(e,t,a,o),"#!"+Object.assign(n,{hash:o}).href.replace(location.origin,"")},Vt=i=>i==null||i==="",La=Tt((i,e,t,a)=>Vt(t(e))?a.delete(i):a.set(i,t(e))),Da=Tt((i,e,t,a)=>Object.entries(e).map(t).forEach(([n,o])=>Vt(o)?a.delete(i+n):a.set(i+n,o))),J=(i,e,{suffix:t="",read:a,write:n,multi:o}={})=>{const[r,l]=o?[Da,ii]:[La,ai],[u]=D(()=>e!=null&&l(e+t,a)!=null),[s,c]=D(()=>e==null?i:l(e+t,a)??i),m=C(b=>c(p=>{const x=$e(b,p);return e!=null&&Ze(r(e+t,x,n),null,{notify:!1}),x}),[e,t,r,n]);return M(()=>{e!=null&&(u||i!=null&&(c(i),Ze(r(e+t,i,n),null,{notify:!1})))},[i,e,t,u,r,n]),[s,m]},Ta=i=>[!0,"true",1,"yes","on"].includes(i),de=i=>i===""||(i==null?void 0:Ta(i)),me=(i,e,t)=>C(a=>{i(a),t(n=>({...n,[e]:a}))},[i,e,t]),Va=(i,e,t,a,n)=>{const[o,r]=J(t.sortOn,e,{suffix:"-sortOn"}),[l,u]=J(de(t.descending),e,{suffix:"-descending",read:de}),[s,c]=J(t.groupOn,e,{suffix:"-groupOn"}),[m,b]=J(de(t.groupOnDescending),e,{suffix:"-groupOnDescending",read:de}),p=F(()=>i.find(g=>g.name===o),[i,o]),x=F(()=>i.find(g=>g.name===s),[i,s]),h={groupOn:s,setGroupOn:me(c,"groupOn",a),groupOnDescending:m,setGroupOnDescending:me(b,"groupOnDescending",a),sortOn:o,setSortOn:me(r,"sortOn",a),descending:l,setDescending:me(u,"descending",a),columns:i},$=F(()=>h,Object.values(h)),_=C(g=>{r(g.sortOn),c(g.groupOn),u(g.descending),b(g.groupOnDescending)},[]);return M(()=>void(n.current=_),[]),{...$,sortAndGroup:$,groupOnColumn:x,sortOnColumn:p}},Qe=wt();customElements.define("sort-and-group-provider",Qe.Provider);customElements.define("sort-and-group-consumer",O(({render:i})=>i(Le(Qe)),{useShadowDOM:!1}));const Pa=({data:i,columns:e,groupOnColumn:t,filters:a,setFilterState:n,sortAndGroup:{sortOn:o,setSortOn:r,descending:l,setDescending:u}={}})=>St(e,s=>s.name,s=>[d`<div
			...
			>
				...
				${k(!s.noSort,()=>Lt({on:o,setOn:r,descending:l,setDescending:u,column:s}))}
...
`;customElements.define("cosmoz-omnitable-item-expand-line",O(Ba,{styleSheets:[De(Na)]}));const Ga=({columns:i,item:e,selected:t,expanded:a,groupOnColumn:n})=>oi(i,o=>d`<cosmoz-omnitable-item-expand-line
			...
			>`);customElements.define("cosmoz-omnitable-item-expand",O(Ga,{useShadowDOM:!1}));const Ha=(i,e,t)=>i.editable?i.renderEditCell(i,e,t(i,e.item)):i.renderCell(i,e),ja=({columns:i,groupOnColumn:e,item:t,index:a,selected:n,expanded:o,onItemChange:r})=>St(i,l=>l.name,l=>d`<div
...
`,ft=i=>{const e=i.replace(/"/gu,'""');return e.search(/("|,|\n)/gu)>=0?'"'+e+'"':i},Ua=(i,e,t)=>{const o=i.map(l=>ft(l.title)).join(";")+`
`,r=e.map(l=>i.map(u=>{const s=u.getString(u,l);return s==null?"":ft(String(s))}).join(";")+`
`);r.unshift(o),zt(new File(r,t,{type:"text/csv;charset=utf-8"}))},Ka=(i,e)=>{const t=i.map(n=>n.title),a=e.map(n=>i.map(o=>{const r=o.toXlsxValue(o,n);return r??""}));return a.unshift(t),a},Ja=(i,e,t,a)=>{const n=Ka(i,e),o=new ri(t).addSheetFromData(n,a).generate();zt(new File([o],t,{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}))},Xa=({columns:i,selectedItems:e,csvFilename:t,xlsxFilename:a,xlsxSheetname:n,topPlacement:o})=>d`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!Te(e.length)}
		part="bottomBar"
...
`,pe=i=>{const e=parseInt(i,10);return isFinite(e)?e:void 0},nn=i=>{const{config:e}=i,{settings:t,setSettings:a,collapsed:n}=e,o=Ve({collapsed:n,settings:t.columns,setSettings:C(r=>a(l=>({...l,columns:r})),[a])});return{...e,onDown:C(r=>{r.target.closest(".pull")&&(o.handle=r.currentTarget)},[o]),onDragStart:C(r=>{const{target:l}=r,u=pe(l.dataset.index);if(!o.handle?.contains(l)||u==null)return r.preventDefault();o.handle=null,r.dataTransfer.effectAllowed="move",r.dataTransfer.setData("omnitable/sort-index",u),r.dataTransfer.setData("text/plain",u),setTimeout(()=>l.classList.add("drag"),0),l.addEventListener("dragend",s=>s.target.classList.remove("drag"),{once:!0})},[o]),onDragEnter:C(r=>{const l=r.currentTarget;l===r.target&&(r.preventDefault(),r.dataTransfer.dropEffect="move",l.classList.add("dragover"))},[]),onDragOver:C(r=>{r.preventDefault(),r.currentTarget.classList.add("dragover")},[]),onDragLeave:C(r=>{const l=r.currentTarget;l.contains(r.relatedTarget)||l.classList.remove("dragover")},[]),onDrop:C(r=>{const l=pe(r.dataTransfer.getData("omnitable/sort-index")),u=pe(r.currentTarget.dataset.index),{settings:s,setSettings:c}=o;r.currentTarget.classList.remove("dragover"),r.preventDefault();const m=s.slice();m.splice(u+(l>=u?0:-1),0,m.splice(l,1)[0]),c(m)},[o]),onToggle:C(r=>{const{settings:l,setSettings:u}=o,s=l.map(m=>({...m,disabled:m.disabled||o.collapsed?.some(b=>b.name===m.name)})),c=pe(r.target.closest("[data-index]")?.dataset.index);s.splice(c,1,{...l[c],disabled:!r.target.checked,priority:r.target.checked?l.reduce((m,b)=>Math.max(m,b.priority),0)+1:l[c].priority}),u(s)},[o])}},on=[si({apply({availableHeight:i,elements:e}){Object.assign(e.floating.style,{maxHeight:`${Math.max(0,i)}px`})}}),...ui],rn=({onDragStart:i,onDragEnter:e,onDragOver:t,onDragLeave:a,onDrop:n,onDown:o,onToggle:r,collapsed:l,filters:u})=>(s,c)=>{const m=!!l?.find(p=>p.name===s.name),b=!s.disabled&&!m;return d` <div
			class="item"
			data-index=${c}
			@mousedown=${o}
			draggable="true"
...
`,Mn=i=>i?"groupRow groupRow-folded":"groupRow",On=({item:i,index:e})=>t=>k(t?.length>0,()=>d`
	...
	`,Dn=({onCheckboxChange:i,dataIsValid:e,groupOnColumn:t})=>(a,n,{selected:o,folded:r,toggleFold:l})=>d` <div
		...
		</div>`,Tn=({host:i,error:e,dataIsValid:t,processedItems:a,columns:n,collapsedColumns:o,miniColumns:r,sortAndGroupOptions:l,rowPartFn:u,...s})=>{const{loading:c=!1,displayEmptyGroups:m=!1,compareItemsFn:b}=i,p=Pe({shiftKey:!1,ctrlKey:!1}),x=C(g=>{const A=g.target.dataItem,f=g.target.checked;p.current.shiftKey?i.shadowRoot.querySelector("#groupedList").toggleSelectTo(A,f):p.current.ctrlKey?(g.target.checked=!0,i.shadowRoot.querySelector("#groupedList").selectOnly(A)):i.shadowRoot.querySelector("#groupedList").toggleSelect(A,f),g.preventDefault(),g.stopPropagation()},[]);M(()=>{const g=({shiftKey:A,ctrlKey:f})=>{p.current={shiftKey:A,ctrlKey:f}};return window.addEventListener("keydown",g),window.addEventListener("keyup",g),()=>{window.removeEventListener("keydown",g),window.removeEventListener("keyup",g)}},[]);const h=C(g=>{const A=g.composedPath();A.slice(0,A.indexOf(g.currentTarget)).find(v=>v.matches?.("a, .checkbox, .expand"))||i.dispatchEvent(new window.CustomEvent("omnitable-item-click",{bubbles:!0,composed:!0,detail:{item:g.currentTarget.dataItem,index:g.currentTarget.dataIndex}}))},[]),{groupOnColumn:$}=l,_=C((g,A)=>f=>Ii(i,g,A,f),[]);return{...s,processedItems:a,dataIsValid:t,filterIsTooStrict:t&&a.length<1,loading:c,compareItemsFn:b,displayEmptyGroups:m,error:e,renderItem:F(()=>Ln({columns:n,collapsedColumns:o,miniColumns:r,onItemClick:h,onCheckboxChange:x,dataIsValid:t,groupOnColumn:$,onItemChange:_,rowPartFn:u}),[n,o,h,x,t,$,_,u]),renderGroup:F(()=>Dn({onCheckboxChange:x,dataIsValid:t,groupOnColumn:$}),[x,t,$])}},Vn=(i,e)=>{if(i===e)return 0;if(i==null)return-1;if(e==null)return 1;const t=typeof i,a=typeof e;return t==="object"&&a==="object"?i.toString()<e.toString()?-1:1:t==="number"&&a==="number"?i-e:t==="string"&&a==="string"?i<e?-1:1:t==="boolean"&&a==="boolean"?i?-1:1:(console.warn("unsupported sort",t,i,a,e),0)},Fe=(i,e)=>(t,a)=>Vn(i(t),i(a))*(e?-1:1),Pn=i=>i.replace(/([a-z0-9])([A-Z])/gu,"$1-$2").toLowerCase(),xt=(i,e)=>{!i||!e||Object.entries(e).forEach(([t,a])=>{i[N].__ownChange=!0,i[N][t]=a,i[N].__ownChange=!1,i[N].dispatchEvent(new CustomEvent(`${Pn(t)}-changed`,{bubbles:!0,detail:{value:a}}))})},_e=(i,e)=>Object.assign(i,{[ye]:e}),be=Symbol("unparsed"),Rn=({data:i,columns:e,hashParam:t,sortAndGroupOptions:a,noLocalSort:n,noLocalFilter:o})=>{const{groupOnColumn:r,groupOnDescending:l,sortOnColumn:u,descending:s}=a,c=C(([f,v])=>{const y=e.find(({name:w})=>w===f);return y==null?[f,void 0]:[f,v.filter&&y.serializeFilter(y,v.filter)]},[e]),m=C(([f,v])=>{const y=e.find(({name:z})=>z===f);if(y==null)return[f,{[be]:v}];const w={filter:y.deserializeFilter(y,v)};return xt(y,w),[f,w]},[e]),[b,p]=J({},t,{multi:!0,suffix:"-filter--",write:c,read:m}),x=C((f,v)=>p(y=>{const w=$e(v,y[f]);return xt(e.find(z=>z.name===f),w),{...y,[f]:{...y[f],...w}}}),[e,p]),h=F(()=>Object.values(b).map(f=>f.filter),[b]),$=F(()=>Object.fromEntries(e.map(f=>[f.name,!f.noLocalFilter&&f.getFilterFn(f,b[f.name]?.filter)]).filter(([,f])=>!!f)),[e,...h]),_=F(()=>!Array.isArray(i)||i.length===0?[]:Object.entries($).length===0||o?i.slice():i.filter(f=>Object.values($).every(v=>v(f))),[i,$,o]),g=F(()=>{if(!n&&!r&&u!=null&&u.sortOn!=null)return _.slice().sort(Fe(f=>u.getComparableValue({...u,valuePath:u.sortOn},f),s));if(r!=null&&r.groupOn!=null){const f=_.reduce((v,y)=>{const w=r.getComparableValue({...r,valuePath:r.groupOn},y);if(w===void 0)return v;let z=v.find(T=>T.id===w);return z?(z.items.push(y),v):(z={id:w,name:w,items:[y]},[...v,z])},[]);return f.sort(Fe(v=>r.getComparableValue({...r,valuePath:r.groupOn},v.items[0]),l)),!u||n?f:f.filter(v=>Array.isArray(v.items)).map(v=>(v.items.sort(Fe(y=>u.getComparableValue({...u,valuePath:u.sortOn},y),s)),v))}return _},[_,r,l,u,s,n]),A=F(()=>{let f=0,v=0;const y=[];return g.forEach(w=>{if(Array.isArray(w.items)){_e(w,v++),w.items.forEach(z=>{_e(z,f++),y.push(z)});return}return _e(w,f++),y.push(w)},[]),y},[g]);return M(()=>{p(f=>Object.values(f).some(y=>y[be]!=null)?Object.fromEntries(Object.entries(f).map(([y,w])=>w[be]==null?[y,w]:m([y,w[be]]))):f)},[m]),{processedItems:g,visibleData:A,filters:b,filterFunctions:$,setFilterState:x}},Nn=i=>{const e=a=>{const n=i.data.indexOf(a);if(n<0)return null;const o=i.data.splice(n,1);if(i.data=i.data.slice(),Array.isArray(o)&&o.length>0)return o[0]},t=(a,n)=>{i.data.splice(a,1,n),i.data=i.data.slice()};return{removeItem:e,removeItems(a){const n=[];for(let o=a.length-1;o>=0;o-=1){const r=i.removeItem(a[o]);r!=null&&n.push(r)}return n},replaceItemAtIndex:t,replaceItem(a,n){const o=i.data.indexOf(a);if(o>-1)return t(o,n)},selectItem(a){i.shadowRoot.querySelector("#groupedList").select(a)},selectAll(){i.shadowRoot.querySelector("#groupedList").selectAll()},deselectAll(){i.shadowRoot.querySelector("#groupedList").deselectAll()},deselectItem(a){i.shadowRoot.querySelector("#groupedList").deselect(a)},isItemSelected(a){return i.shadowRoot.querySelector("#groupedList").isItemSelected(a)}}},Bn=({host:i,visibleData:e,filters:t,...a})=>{const{setFilterState:n}=a,o=F(()=>Nn(i),[]);Ie(a,Object.values(a)),Ie(o,Object.values(o)),M(()=>{const l=u=>n(u.detail.name,s=>({...s,...u.detail.state}));return i.addEventListener("legacy-filter-changed",l),()=>i.removeEventListener("legacy-filter-changed",l)},[]),R("visibleData",e),R("sortedFilteredGroupedItems",a.sortedFilteredGroupedItems),R("selectedItems",a.selectedItems),R("sortOn",a.sortOn),R("descending",a.descending),R("isMini",a.isMini);const r=F(()=>Object.fromEntries(Object.entries(t).filter(([,{filter:l}])=>l!==void 0).map(([l,{filter:u}])=>[l,u])),[t]);R("filters",r,Object.values(r))},Gn=i=>{const{hashParam:e,settingsId:t,data:a,resizeSpeedFactor:n,noLocal:o,noLocalSort:r=o,noLocalFilter:l=o,error:u,rowPartFn:s}=i,c=fn({settingsId:t,host:i}),{settings:m,setSettings:b,columns:p,resetRef:x}=c,h=Va(p,e,m,b,x),{processedItems:$,visibleData:_,filters:g,setFilterState:A,filterFunctions:f}=Rn({data:a,columns:p,hashParam:e,sortAndGroupOptions:h,noLocalSort:r,noLocalFilter:l}),{isMini:v,collapsedColumns:y,miniColumns:w}=kn({host:i,columns:p,settings:m,setSettings:b,resizeSpeedFactor:n,sortAndGroupOptions:h}),z=a&&Array.isArray(a)&&a.length>0,[T,G]=D([]);return Bn({host:i,visibleData:_,sortedFilteredGroupedItems:$,columns:p,filters:g,setFilterState:A,selectedItems:T,isMini:v,...h}),{header:In({host:i,selectedItems:T,sortAndGroupOptions:h,dataIsValid:z,data:a,columns:p,filters:g,collapsedColumns:y,settings:m,filterFunctions:f,settingS:c,setFilterState:A,hideSelectAll:i.hideSelectAll===!0}),list:Tn({host:i,error:u,dataIsValid:z,processedItems:$,setSelectedItems:G,columns:p,collapsedColumns:y,miniColumns:w,sortAndGroupOptions:h,rowPartFn:s}),footer:En({host:i,selectedItems:T,columns:p})}};customElements.define("cosmoz-grouped-list-row",class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||ke(this._renderFn(this._item,this._index),this)}});const Hn={group:Symbol("group")},Se=(i,e)=>(e.has(i)||e.set(i,{}),e.get(i)),jn=(i,e)=>!!Se(i,e).expanded,Wn=(i,e)=>!!Se(i,e).folded,Me=i=>i?i.items instanceof Array:!1,Un=i=>{if(!Array.isArray(i)||i.length===0)return;const e=Array.isArray(i[0]?.items);if(!i.every(a=>Array.isArray(a.items)===e))throw new Error("Data must be homogeneous.")},Kn=(i,e,t)=>Array.isArray(i)?(Un(i),i.reduce((n,o)=>{const r=o;return r.items?r.items.length?Se(o,t).folded?n.concat(o):n.concat(o,r.items.map(l=>Object.assign(l,{[Hn.group]:o}))):e?n.concat(o):n:n.concat(o)},[])):void 0,Jn=(i,...e)=>typeof i=="function"?i(...e):i,Xn=(i,e)=>i===e,Qn=()=>{const[i,e]=D(()=>[new WeakMap]);return{setItemState:C((a,n)=>e(([o])=>{const r=Se(a,o);return Object.assign(r,Jn(n,r)),[o]}),[]),state:i[0],signal:i}},Yn=()=>{const{setItemState:i,state:e,signal:t}=Qn(),a=C((o,r)=>{Me(o)&&i(o,l=>({folded:r!==void 0?r:!l.folded}))},[]),n=C((o,r)=>{Me(o)||i(o,l=>({expanded:r!==void 0?!r:!l.expanded}))},[]);return{state:e,signal:t,toggleFold:a,toggleCollapse:n}},Zn=({initial:i,compareItemsFn:e,data:t,flatData:a})=>{const[n,o]=D(i),[r,l]=D(),u=C(g=>n.includes(g),[n]),s=C(g=>g?.items?.every(u)??!1,[u]),c=C(g=>u(g)||s(g),[u,s]),m=C(g=>{const f=g.items??[g];o(v=>[...v,...f.filter(y=>!v.includes(y))]),l(g)},[]),b=C(g=>{const f=g.items??[g];o(v=>v.filter(y=>!f.includes(y))),l(g)},[]),p=C(g=>{o(g.items?.slice()||[g]),l(g)},[]),x=C(()=>{o(t.flatMap(g=>g.items||g)),l(void 0)},[t]),h=C(()=>{o([]),l(void 0)},[]),$=C((g,A=!c(g))=>A?m(g):b(g),[c]),_=C((g,A)=>{if(!a)return;const f=r?a.findIndex(w=>e(w,r)):-1;if(f<0)return $(g,A);const[v,y]=[f,a.indexOf(g)].sort((w,z)=>w-z);a.slice(v,y+1).forEach((w,z,T)=>{z>0&&z<T.length-1&&Me(w)||$(w,A)}),l(g)},[a,e,$]);return M(()=>o(g=>g.length>0&&a?a.filter(A=>g.find(f=>e(A,f))):g),[a]),{selectedItems:n,isItemSelected:u,isGroupSelected:s,isSelected:c,select:m,deselect:b,selectOnly:p,selectAll:x,deselectAll:h,toggleSelect:$,toggleSelectTo:_}},eo={host:{position:"relative",display:"flex",flexDirection:"column"}},to=i=>{const{data:e,renderItem:t,renderGroup:a,displayEmptyGroups:n,compareItemsFn:o=Xn}=i,{toggleFold:r,toggleCollapse:l,state:u,signal:s}=Yn(),c=F(()=>Kn(e,n,u),[e,n,s]),{selectedItems:m,isItemSelected:b,isGroupSelected:p,isSelected:x,select:h,deselect:$,selectOnly:_,selectAll:g,deselectAll:A,toggleSelect:f,toggleSelectTo:v}=Zn({initial:[],compareItemsFn:o,data:e,flatData:c}),y=C((z,T)=>Array.isArray(z.items)?a(z,T,{selected:p(z),folded:Wn(z,u),toggleSelect:G=>f(z,typeof G=="boolean"?G:void 0),toggleFold:()=>r(z)}):t(z,T,{selected:m.includes(z),expanded:jn(z,u),toggleSelect:G=>f(z,typeof G=="boolean"?G:void 0),toggleCollapse:()=>l(z)}),[t,a,m,f,s]);vt(()=>{Object.assign(i.style,eo.host)},[]),R("selectedItems",m);const w={toggleFold:r,toggleCollapse:l,isItemSelected:b,isGroupSelected:p,isSelected:x,select:h,deselect:$,selectOnly:_,selectAll:g,deselectAll:A,toggleSelect:f,toggleSelectTo:v};return Ie(w,Object.values(w)),{renderRow:y,flatData:c}},io=({renderRow:i,flatData:e})=>di({items:e,renderItem:(t,a)=>d`<cosmoz-grouped-list-row
				.item=${t}
				.index=${a}
				.renderFn=${i}
