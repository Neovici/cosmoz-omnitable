import{b as d,D as ke,A as xt}from"./iframe-rnRbFPxi.js";import{t as K,c as O,g as S,P as I,u as T,a as yt,m as vt,s as Nt,D as Bt,b as Gt,e as Ht,i as $e,h as Oe,d as jt,f as $t,r as Wt,j as Ut,k as q,l as Kt,n as Ce,p as he,o as k,q as Jt,v as we,w as Xt,x as Qt,y as Yt,T as Zt,z as M,A as Ye,B as F,C as ei,E as ti,F as ii,G as C,H as ai,I as ni,J as Ct,K as Le,L as wt,M as De,N as oi,O as St,Q as ri,R as Te,S as Ze,U as li,V as Ve,W as si,X as ui,Y as Ee,Z as Pe,_ as ci,$ as Ie,a0 as R,a1 as di,a2 as ze,a3 as mi}from"./cosmoz-collapse-C0NVNiYT.js";import"./preload-helper-PPVm8Dsz.js";const pi=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,Li=i=>{const{label:e,value:t,slot:a}=i,n=d`<div
	...
	`};class Di extends Re(ae(I)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return d`
		...
		>`}getComparableValue(e,t){return Qi(e,t)}}customElements.define("cosmoz-omnitable-column-autocomplete",Yi);const Ue=(i,e)=>e.find(({value:t})=>i===t),Zi=(i,e,t)=>{const a=Ue(e,t);return a?a.text:i},ot=(i,e,t,a)=>Zi(i,S(e,t),a),ea=({valuePath:i},e,t)=>Ue(S(e,i),t),ta=i=>e=>{i(t=>({...t,filter:e?.[0]?.value??null}))},ia=i=>e=>{i(t=>({...t,headerFocused:e}))},aa=i=>e=>{i(t=>({...t,query:e}))},na=i=>e=>i(e?.[0]?.value),rt=({valuePath:i,trueLabel:e,falseLabel:t},a)=>S(a,i)?e:t,oa=({valuePath:i},e)=>t=>S(t,i)===e,le=vt((i,e)=>[{text:i,value:!0},{text:e,value:!1}]),ra=({valuePath:i,trueLabel:e,falseLabel:t},a)=>i?S(a,i)?e:t:"",la=(i,e)=>{try{return JSON.parse(e)}catch{return null}};class sa extends V(I){static get properties(){return{trueLabel:{type:String,value:"True"},falseLabel:{type:String,value:"False"},flex:{type:String,value:"0"},cellClass:{type:String,value:"boolean-cell"}}}getString(e,t){return rt(e,t)}renderCell(e,{item:t}){return rt(e,t)}renderEditCell(e,{item:t},a){const{trueLabel:n,falseLabel:o}=e;return d`<cosmoz-autocomplete
			no-label-float
		...
		></cosmoz-input>`}renderHeader({title:e,min:t,max:a,locale:n,filterStep:o},{filter:r},l,u){return d`<cosmoz-omnitable-time-range-input
			...
			@filter-changed=${({detail:{value:s}})=>l(c=>({...c,filter:s}))}
			@header-focused-changed=${({detail:{value:s}})=>l(c=>({...c,headerFocused:s}))}
		></cosmoz-omnitable-time-range-input>`}computeSource(e,t){return ie(e,t)}}customElements.define("cosmoz-omnitable-column-time",Sa);const ce={},za=i=>{const e=i||"";if(ce[e])return ce[e];const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return ce[e]=new Intl.DateTimeFormat(i||void 0,t),ce[e]},qe=({valuePath:i,locale:e},t)=>{const a=E(S(t,i||""));return a===void 0?"":a===null?"Invalid Date":Xe(a,za(e))},qa=({valuePath:i},e)=>i?S(e,i):"",mt=i=>{const e=E(i);return e==null?"":e.toISOString().slice(0,19).replace(/:/gu,".")},pt=i=>{if(!(i==null||i==="")&&typeof i=="string")return E(i.replace(/\./gu,":")+"Z")};class Aa extends Ke(ae(I)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return d`
			<style>
...
`,Dt=i=>(e,t,a=ei)=>{const n=ni(),o=new URLSearchParams(n.hash.replace("#",""));return i(e,t,a,o),"#!"+Object.assign(n,{hash:o}).href.replace(location.origin,"")},Tt=i=>i==null||i==="",La=Dt((i,e,t,a)=>Tt(t(e))?a.delete(i):a.set(i,t(e))),Da=Dt((i,e,t,a)=>Object.entries(e).map(t).forEach(([n,o])=>Tt(o)?a.delete(i+n):a.set(i+n,o))),J=(i,e,{suffix:t="",read:a,write:n,multi:o}={})=>{const[r,l]=o?[Da,ti]:[La,ii],u=F(()=>e!=null&&l(e+t,a)!=null,[]),[s,c]=T(()=>e==null?i:l(e+t,a)??i),m=C(b=>c(p=>{const x=$e(b,p);return e!=null&&ai(r(e+t,x,n),null,{notify:!1}),x}),[e,t,r,n]);return M(()=>{e!=null&&(u||i!=null&&m(i))},[i,e,u,m]),[s,m]},Ta=i=>[!0,"true",1,"yes","on"].includes(i),de=i=>i===""||(i==null?void 0:Ta(i)),me=(i,e,t)=>C(a=>{i(a),t(n=>({...n,[e]:a}))},[i,e,t]),Va=(i,e,t,a,n)=>{const[o,r]=J(t.sortOn,e,{suffix:"-sortOn"}),[l,u]=J(de(t.descending),e,{suffix:"-descending",read:de}),[s,c]=J(t.groupOn,e,{suffix:"-groupOn"}),[m,b]=J(de(t.groupOnDescending),e,{suffix:"-groupOnDescending",read:de}),p=F(()=>i.find(g=>g.name===o),[i,o]),x=F(()=>i.find(g=>g.name===s),[i,s]),h={groupOn:s,setGroupOn:me(c,"groupOn",a),groupOnDescending:m,setGroupOnDescending:me(b,"groupOnDescending",a),sortOn:o,setSortOn:me(r,"sortOn",a),descending:l,setDescending:me(u,"descending",a),columns:i},$=F(()=>h,Object.values(h)),_=C(g=>{r(g.sortOn),c(g.groupOn),u(g.descending),b(g.groupOnDescending)},[]);return M(()=>void(n.current=_),[]),{...$,sortAndGroup:$,groupOnColumn:x,sortOnColumn:p}},Qe=Ct();customElements.define("sort-and-group-provider",Qe.Provider);customElements.define("sort-and-group-consumer",O(({render:i})=>i(Le(Qe)),{useShadowDOM:!1}));const Pa=({data:i,columns:e,groupOnColumn:t,filters:a,setFilterState:n,sortAndGroup:{sortOn:o,setSortOn:r,descending:l,setDescending:u}={}})=>wt(e,s=>s.name,s=>[d`<div
