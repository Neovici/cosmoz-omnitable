import{b as d,D as Fe,A as xt,w as Bt}from"./iframe-B_LSPLvs.js";import{t as K,c as T,g as C,P as A,u as M,a as yt,m as vt,s as Gt,D as Ht,b as Wt,e as qt,i as ve,h as Ae,d as Xt,f as $t,r as Ut,j as Kt,k,l as Jt,n as $e,p as he,o as D,q as Qt,v as we,w as Yt,x as Zt,y as en,T as tn,z as E,A as fe,B as I,C as nn,E as on,F as rn,G as w,H as Qe,I as ln,J as wt,K as Ee,L as zt,M as Te,N as an,O as Ct,Q as sn,R as Le,S as Ye,U as un,V as Re,W as cn,X as dn,Y as Oe,Z as Me,_ as mn,$ as De,a0 as P,a1 as pn,a2 as Ce,a3 as gn}from"./cosmoz-collapse-D5Y0UGeg.js";import"./preload-helper-PPVm8Dsz.js";const hn=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,Rn=n=>{const{label:e,value:t,slot:o}=n,r=d`<div
	...
	>
		${t||""}
	</div>`;return Ut(r,{label:e})};customElements.define("cosmoz-omnitable-dropdown-input",T(Rn,{observedAttributes:Tn,styleSheets:[Ln]}));const ee=({title:n,tooltip:e="",filterText:t="",onOpenedChanged:o,content:r,horizontalAlign:i="left",externalValues:l=null})=>{const a={filtered:!!t,...l!=null&&{[`external-values-${l}`]:!0}};return d`
		<style>
			.dropdown {
				outline: none;
			}
	...
	`};class Mn extends Ne(Z(A)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return d`
		...
		>`}getComparableValue(e,t){return Zn(e,t)}}customElements.define("cosmoz-omnitable-column-autocomplete",eo);const qe=(n,e)=>e.find(({value:t})=>n===t),to=(n,e,t)=>{const o=qe(e,t);return o?o.text:n},rt=(n,e,t,o)=>to(n,C(e,t),o),no=({valuePath:n},e,t)=>qe(C(e,n),t),oo=n=>e=>{n(t=>({...t,filter:e?.[0]?.value??null}))},ro=n=>e=>{n(t=>({...t,headerFocused:e}))},io=n=>e=>{n(t=>({...t,query:e}))},lo=n=>e=>n(e?.[0]?.value),it=({valuePath:n,trueLabel:e,falseLabel:t},o)=>C(o,n)?e:t,ao=({valuePath:n},e)=>t=>C(t,n)===e,ne=vt((n,e)=>[{text:n,value:!0},{text:e,value:!1}]),so=({valuePath:n,trueLabel:e,falseLabel:t},o)=>n?C(o,n)?e:t:"",uo=(n,e)=>{try{return JSON.parse(e)}catch{return null}};class co extends N(A){static get properties(){return{trueLabel:{type:String,value:"True"},falseLabel:{type:String,value:"False"},flex:{type:String,value:"0"},cellClass:{type:String,value:"boolean-cell"}}}getString(e,t){return it(e,t)}renderCell(e,{item:t}){return it(e,t)}renderEditCell(e,{item:t},o){const{trueLabel:r,falseLabel:i}=e;return d`<cosmoz-autocomplete
			no-label-float
		...
		>`}computeSource({trueLabel:e,falseLabel:t}){return ne(e,t)}getFilterFn(e,t){if(t!=null)return ao(e,t)}toXlsxValue(e,t){return so(e,t)}deserializeFilter(e,t){return uo(e,t)}}customElements.define("cosmoz-omnitable-column-boolean",co);const Xe=n=>class extends Ne(n){static get properties(){return{max:{type:Date,value:null},min:{type:Date,value:null},_filterText:{type:String,computed:"_computeFilterText(filter.*, formatter)"},formatter:{type:Object,computed:"_computeFormatter(locale)"}}}toDate(e,t,o){if(e==null||e==="")return;let r=e;if(r instanceof Date||(typeof e=="string"&&(r=this.getAbsoluteISOString(r)),r=new Date(r)),Number.isNaN(r.getTime()))return null;if(o==null||t==null)return r;const i=this.toDate(t);if(i==null)return r;const l=this.getComparableValue(r),a=this.getComparableValue(i);return o(l,a)===l?r:i}toValue(){return this.toDate.apply(this,arguments)}getComparableValue(e,t){const o=super.getComparableValue(e,t);if(o!=null)return this.toNumber(o.getTime())}getString(e,t=this.valuePath,o=this.formatter){const r=this.toValue(this.get(t,e));return r===void 0?"":r===null?"Invalid Date":this.renderValue(r,o)}getAbsoluteISOString(e){return e.length===19?e+this._getTimezoneString(e):e}_getTimezoneString(e){const t=-new Date(e).getTimezoneOffset()/60;return(t<0?"-":"+")+["0",Math.abs(t)].join("").substr(-2)+":00"}renderValue(e,t=this.formatter){if(t==null)return;const o=this.toValue(e);if(o!=null)return t.format(o)}_computeFormatter(e){return new Intl.DateTimeFormat(e||void 0)}_toInputString(e){const t=this.toValue(e);return t==null?null:this._toLocalISOString(t).slice(0,10)}_dateValueChanged(e){const t=e.currentTarget,o=t.value,r=e.model.item,i=this.get(this.valuePath,r),l=this._fromInputString(o);this.set(this.valuePath,l,r),this._fireItemChangeEvent(r,this.valuePath,i,this.renderValue.bind(this))}_toLocalISOString(e){return we(e)}};class mo extends Xe(Z(A)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return d`
			...
			${ee({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:d`
					...
					></cosmoz-input>
				`})}
		`}_fromInputString(e,t){const o=this.toDate(e);if(o!=null)return t==="min"&&o.setHours(0,0,0,0),t==="max"&&o.setHours(23,59,59),o}_filterInputChanged(e,t){const o=e.path.split(".")[1],r=o&&e.value;if(r&&r.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}}customElements.define("cosmoz-omnitable-date-range-input",mo);const po=n=>{const e=-new Date(n).getTimezoneOffset()/60;return(e<0?"-":"+")+["0",Math.abs(e)].join("").substr(-2)+":00"},Ue=n=>n.length===19?n+po(n):n,Ft=n=>{if(n==null||n==="")return;let e=n;return!(e instanceof Date)&&(typeof n=="string"&&(e=Ue(e)),e=Yt(e),!e)||Number.isNaN(e.getTime())?null:e},j=({valuePath:n},e)=>{if(e==null)return;let t=e;n!=null&&(t=C(e,n));const o=Ft(t);if(o!=null)return L(o.getTime())},V=(n,e,t)=>{const o=Ft(n);return o??null},Ke=(n,e)=>{if(e==null)return;const t=V(n);if(t!=null)return e.format(t)},oe={},go=n=>{const e=n||"";return oe[e]||(oe[e]=new Intl.DateTimeFormat(n||void 0)),oe[e]},lt=({valuePath:n,locale:e},t)=>{let o=C(t,n||"");return o===void 0?"":(o=V(o),o===null?"Invalid Date":Ke(o,go(e)))},Ot=n=>{const e=V(n);if(e==null)return null;const t=we(e);return t==null?null:t.slice(0,10)},ho=({valuePath:n},e)=>Ot(C(e,n||"")),Dt=(n,e)=>{const t=V(n);if(t!=null)return t},at=n=>{const e=Ot(n);return e??""},fo=({valuePath:n},e)=>{if(!n)return"";const t=V(C(e,n));if(!t)return"";const o=V(we(t));return o?(o.setHours(0,0,0,0),o):""},Vt=(n,e)=>t=>{const o=j(n,t);if(o==null)return!1;const r=j({...n,valuePath:"min"},e),i=j({...n,valuePath:"max"},e);return!(o<(r??-1/0)||o>(i??1/0))};class bo extends N(A){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"date-header-cell"},width:{type:String,value:"100px"},minWidth:{type:String,value:"82px"},flex:{type:String,value:"0"}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const o=j({...e,valuePath:"min"},t),r=j({...e,valuePath:"max"},t);if(!(o==null&&r==null))return Vt(e,t)}getString(e,t){return lt(e,t)}toXlsxValue(e,t){return fo(e,t)}getComparableValue(e,t){return j(e,t)}serializeFilter(e,t){if(t==null)return;const o=V(t.min),r=V(t.max);if(!(o==null&&r==null))return at(o)+"~"+at(r)}deserializeFilter(e,t){if(t==null||t==="")return null;const o=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(o)?{min:V(o[1]),max:V(o[2])}:null}renderCell(e,{item:t}){return d`<div class="omnitable-cell-date">
			${lt(e,t)}
		...
		`}renderEditCell(){return"not implemented"}renderHeader(e,{filter:t,query:o},r,i){return d`<cosmoz-autocomplete-ui
			...
			.onText=${He(r)}
			>${D(e.loading,()=>d`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}}customElements.define("cosmoz-omnitable-column-list-horizontal",xo);window.Cosmoz=window.Cosmoz||{};class st extends Zt(en(tn,A)){static get template(){return Ae`
			<style>
				:host {
					display: block;
				}
		...
		`}static get is(){return"cosmoz-omnitable-column-list-data"}static get properties(){return{items:{type:Array},_expanded:{type:Boolean,value:!1},_othersCount:{type:Number,computed:"_computeOthersCount(items)"}}}static get observers(){return["_itemsLengthChanged(items.length)"]}_itemsLengthChanged(){requestAnimationFrame(()=>this.dispatchEvent(new CustomEvent("expand",{bubbles:!0})))}_firstItem(e){if(e!=null&&e.length>0)return e[0]}_hideExpand(e,t){return e!==void 0&&e.length!==null?e.length<=2||t:!0}_hideCollapse(e,t){return e!==void 0&&e.length!==null?e.length<=2||!t:!0}_otherItems(e,t){if(e!=null&&(e.length<=2||t))return e.slice(1)}_computeOthersCount(e){if(e!=null)return e.length-1}_toggleExpand(e){this._expanded=!this._expanded,e.stopPropagation(),e.preventDefault()}}customElements.define(st.is,st);class yo extends We(N(A)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:o}){return d`<cosmoz-omnitable-column-list-data
			.items=${je(o,e,t)}
		...
		></cosmoz-omnitable-time-range-input>`}computeSource(e,t){return Y(e,t)}}customElements.define("cosmoz-omnitable-column-time",_o);const ie={},Io=n=>{const e=n||"";if(ie[e])return ie[e];const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return ie[e]=new Intl.DateTimeFormat(n||void 0,t),ie[e]},Se=({valuePath:n,locale:e},t)=>{const o=V(C(t,n||""));return o===void 0?"":o===null?"Invalid Date":Ke(o,Io(e))},Fo=({valuePath:n},e)=>n?C(e,n):"",dt=n=>{const e=V(n);return e==null?"":e.toISOString().slice(0,19).replace(/:/gu,".")},mt=n=>{if(!(n==null||n==="")&&typeof n=="string")return V(n.replace(/\./gu,":")+"Z")};class Oo extends Xe(Z(A)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return d`
			...
			${ee({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:d`
					...
					></cosmoz-datetime-input>
				`})}
		`}_toInputString(e){const t=this.toValue(e);if(t!=null)return this._toLocalISOString(t).slice(0,19)}_computeFormatter(e){const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return new Intl.DateTimeFormat(e||void 0,t)}}customElements.define("cosmoz-omnitable-datetime-range-input",Oo);class pt extends N(A){static get is(){return"cosmoz-omnitable-column-datetime"}static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"datetime-header-cell"},width:{type:String,value:"210px"},minWidth:{type:String,value:"128px"},flex:{type:String,value:"0"},filterStep:{type:Number,value:1}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const o=j({...e,valuePath:"min"},t),r=j({...e,valuePath:"max"},t);if(!(o==null&&r==null))return Vt(e,t)}getString(e,t){return Se(e,t)}toXlsxValue(e,t){return Fo(e,t)}getComparableValue(e,t){return j(e,t)}serializeFilter(e,t){if(t==null)return;const o=V(t.min),r=V(t.max);if(!(o==null&&r==null))return dt(o)+"~"+dt(r)}deserializeFilter(e,t){if(t==null||t==="")return null;const o=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(o)?{min:mt(o[1]),max:mt(o[2])}:null}renderCell(e,{item:t}){return Se(e,t)}renderEditCell(e,{item:t},o){return d`<cosmoz-input
			no-label-float
			type="text"
			@change=${i=>o(Dt(i.target.value))}
			.value=${Se(e,t)}
...
>
	...
	/>
</svg> `,Et=({column:n,on:e,descending:t,setOn:o,setDescending:r})=>{const{name:i,title:l}=n??{};return d`<button
		class="sg"
		title=${fe(l)}
	...
	>
		<span>${l}</span> ${To}
	</button>`},Tt=({columns:n,...e})=>n?.map(t=>Et({column:t,...e})),Lo=()=>d`
	<sort-and-group-consumer
		class="sgs"
		.render=${({columns:n,groupOn:e,setGroupOn:t,groupOnDescending:o,setGroupOnDescending:r}={})=>Tt({columns:n?.filter?.(i=>i.groupOn),on:e,setOn:t,descending:o,setDescending:r})}
	>
	</sort-and-group-consumer>
`,Ro=()=>d`
	<sort-and-group-consumer
		class="sgs"
		.render=${({columns:n,sortOn:e,setSortOn:t,descending:o,setDescending:r}={})=>Tt({columns:n?.filter?.(i=>i.sortOn&&!i.noSort),on:e,setOn:t,descending:o,setDescending:r})}
	>
	</sort-and-group-consumer>
`,Lt=n=>(e,t,o=nn)=>{const r=ln(),i=new URLSearchParams(r.hash.replace("#",""));return n(e,t,o,i),"#!"+Object.assign(r,{hash:i}).href.replace(location.origin,"")},Rt=n=>n==null||n==="",Mo=Lt((n,e,t,o)=>Rt(t(e))?o.delete(n):o.set(n,t(e))),No=Lt((n,e,t,o)=>Object.entries(e).map(t).forEach(([r,i])=>Rt(i)?o.delete(n+r):o.set(n+r,i))),J=(n,e,{suffix:t="",read:o,write:r,multi:i}={})=>{const[l,a]=i?[No,on]:[Mo,rn],u=I(()=>e!=null&&a(e+t,o)!=null,[]),[s,c]=M(()=>e==null?n:a(e+t,o)??n),m=w(h=>c(p=>{const x=ve(h,p);return e!=null&&Qe(l(e+t,x,r),null,{notify:!1}),x}),[e,t,l,r]);return E(()=>{e!=null&&(u||n!=null&&(c(n),Qe(l(e+t,n,r),null,{notify:!1})))},[n,e,t,u,l,r]),[s,m]},jo=n=>[!0,"true",1,"yes","on"].includes(n),le=n=>n===""||(n==null?void 0:jo(n)),ae=(n,e,t)=>w(o=>{n(o),t(r=>({...r,[e]:o}))},[n,e,t]),Po=(n,e,t,o,r)=>{const[i,l]=J(t.sortOn,e,{suffix:"-sortOn"}),[a,u]=J(le(t.descending),e,{suffix:"-descending",read:le}),[s,c]=J(t.groupOn,e,{suffix:"-groupOn"}),[m,h]=J(le(t.groupOnDescending),e,{suffix:"-groupOnDescending",read:le}),p=I(()=>n.find(g=>g.name===i),[n,i]),x=I(()=>n.find(g=>g.name===s),[n,s]),b={groupOn:s,setGroupOn:ae(c,"groupOn",o),groupOnDescending:m,setGroupOnDescending:ae(h,"groupOnDescending",o),sortOn:i,setSortOn:ae(l,"sortOn",o),descending:a,setDescending:ae(u,"descending",o),columns:n},$=I(()=>b,Object.values(b)),F=w(g=>{l(g.sortOn),c(g.groupOn),u(g.descending),h(g.groupOnDescending)},[]);return E(()=>void(r.current=F),[]),{...$,sortAndGroup:$,groupOnColumn:x,sortOnColumn:p}},Je=wt();customElements.define("sort-and-group-provider",Je.Provider);customElements.define("sort-and-group-consumer",T(({render:n})=>n(Ee(Je)),{useShadowDOM:!1}));const Bo=({data:n,columns:e,groupOnColumn:t,filters:o,setFilterState:r,sortAndGroup:{sortOn:i,setSortOn:l,descending:a,setDescending:u}={}})=>zt(e,s=>s.name,s=>[d`<div
			...
			>
				...
				${D(!s.noSort,()=>Et({on:i,setOn:l,descending:a,setDescending:u,column:s}))}
	...
	`};customElements.define("cosmoz-omnitable-header-row",T(Go,{useShadowDOM:!1}));const Ho=K`
	:host {
		display: flex;
		align-items: center;
		flex-wrap: wrap;
...
`;customElements.define("cosmoz-omnitable-item-expand-line",T(Wo,{styleSheets:[Te(Ho)]}));const qo=({columns:n,item:e,selected:t,expanded:o,groupOnColumn:r})=>an(n,i=>d`<cosmoz-omnitable-item-expand-line
				.column=${i}
				?hidden=${i===r}
				exportparts="item-expand-label, item-expand-value"
				>${i.renderCell(i,{item:e,selected:t,expanded:o})}</cosmoz-omnitable-item-expand-line
			>`);customElements.define("cosmoz-omnitable-item-expand",T(qo,{useShadowDOM:!1}));const Xo=(n,e,t)=>n.editable?n.renderEditCell(n,e,t(n,e.item)):n.renderCell(n,e),Uo=({columns:n,groupOnColumn:e,item:t,index:o,selected:r,expanded:i,onItemChange:l})=>zt(n,a=>a.name,a=>d`<div
			...
			</div>`);customElements.define("cosmoz-omnitable-item-row",T(Uo,{useShadowDOM:!1}));const Mt=K`
	.checkbox {
		box-sizing: border-box;
		width: 18px;
		height: 18px;
...
`,gt=n=>{const e=n.replace(/"/gu,'""');return e.search(/("|,|\n)/gu)>=0?'"'+e+'"':n},Jo=(n,e,t)=>{const i=n.map(a=>gt(a.title)).join(";")+`
`,l=e.map(a=>n.map(u=>{const s=u.getString(u,a);return s==null?"":gt(String(s))}).join(";")+`
`);l.unshift(i),Ct(new File(l,t,{type:"text/csv;charset=utf-8"}))},Qo=(n,e)=>{const t=n.map(r=>r.title),o=e.map(r=>n.map(i=>{const l=i.toXlsxValue(i,r);return l??""}));return o.unshift(t),o},Yo=(n,e,t,o)=>{const r=Qo(n,e),i=new sn(t).addSheetFromData(r,o).generate();Ct(new File([i],t,{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}))},Zo=({columns:n,selectedItems:e,csvFilename:t,xlsxFilename:o,xlsxSheetname:r,topPlacement:i})=>d`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!Le(e.length)}
		part="bottomBar"
...
`,nr=({settingsConfig:n})=>{const{columns:e,collapsed:t}=n,o=e.filter(r=>!t.some(i=>i.name===r.name));return d`<div class="skeleton">
	...
	</div>`};customElements.define("cosmoz-omnitable-skeleton",T(nr,{styleSheets:[tr]}));const or=({slot:n,title:e,className:t,width:o="24",height:r="24",styles:i}={})=>d`
  <svg
    slot=${fe(n)}
    class=${`delete-icon ${t??""}`}
    viewBox="0 0 24 24"
...
`,rr=(n,e)=>{const{settingsConfig:t}=n,{processedItems:o,dataIsValid:r,filterIsTooStrict:i,loading:l,displayEmptyGroups:a,compareItemsFn:u,setSelectedItems:s,renderItem:c,renderGroup:m,error:h}=e;return d`${D(!l&&!r&&!h,()=>d`<div class="tableContent-empty">
...
`,se=n=>{const e=parseInt(n,10);return isFinite(e)?e:void 0},ar=n=>{const{config:e}=n,{settings:t,setSettings:o,collapsed:r}=e,i=Re({collapsed:r,settings:t.columns,setSettings:w(l=>o(a=>({...a,columns:l})),[o])});return{...e,onDown:w(l=>{l.target.closest(".pull")&&(i.handle=l.currentTarget)},[i]),onDragStart:w(l=>{const{target:a}=l,u=se(a.dataset.index);if(!i.handle?.contains(a)||u==null)return l.preventDefault();i.handle=null,l.dataTransfer.effectAllowed="move",l.dataTransfer.setData("omnitable/sort-index",u),l.dataTransfer.setData("text/plain",u),setTimeout(()=>a.classList.add("drag"),0),a.addEventListener("dragend",s=>s.target.classList.remove("drag"),{once:!0})},[i]),onDragEnter:w(l=>{const a=l.currentTarget;a===l.target&&(l.preventDefault(),l.dataTransfer.dropEffect="move",a.classList.add("dragover"))},[]),onDragOver:w(l=>{l.preventDefault(),l.currentTarget.classList.add("dragover")},[]),onDragLeave:w(l=>{const a=l.currentTarget;a.contains(l.relatedTarget)||a.classList.remove("dragover")},[]),onDrop:w(l=>{const a=se(l.dataTransfer.getData("omnitable/sort-index")),u=se(l.currentTarget.dataset.index),{settings:s,setSettings:c}=i;l.currentTarget.classList.remove("dragover"),l.preventDefault();const m=s.slice();m.splice(u+(a>=u?0:-1),0,m.splice(a,1)[0]),c(m)},[i]),onToggle:w(l=>{const{settings:a,setSettings:u}=i,s=a.map(m=>({...m,disabled:m.disabled||i.collapsed?.some(h=>h.name===m.name)})),c=se(l.target.closest("[data-index]")?.dataset.index);s.splice(c,1,{...a[c],disabled:!l.target.checked,priority:l.target.checked?a.reduce((m,h)=>Math.max(m,h.priority),0)+1:a[c].priority}),u(s)},[i])}},sr=[cn({apply({availableHeight:n,elements:e}){Object.assign(e.floating.style,{maxHeight:`${Math.max(0,n)}px`})}}),...dn],ur=({onDragStart:n,onDragEnter:e,onDragOver:t,onDragLeave:o,onDrop:r,onDown:i,onToggle:l,collapsed:a,filters:u})=>(s,c)=>{const m=!!a?.find(p=>p.name===s.name),h=!s.disabled&&!m;return d` <div
		...
		${D(t,()=>d`<div class="buttons">
				...
				</div>`)}`};customElements.define("cosmoz-omnitable-settings-ui",T(cr,{styleSheets:[Te(ir)]}));const dr=({config:n,newLayout:e})=>d`
	<cosmoz-dropdown
...
`;customElements.define("cosmoz-omnitable-settings",T(dr,{styleSheets:[Te(lr)]}));const be=["sortOn","descending","groupOn","groupOnDescending"],ue=n=>e=>typeof e=="object"&&e!==null&&"name"in e&&e.name===n,mr=(n=[],e=[],t=[])=>{const o=e.filter(l=>n.some(ue(l.name))),r=n.filter(l=>l.name!=null&&!e.some(ue(l.name))&&!t.some(ue(l.name))),i=t.filter(l=>!e.some(ue(l.name)));return[...o,...i.flatMap(l=>{const a=n.find(u=>u.name===l.name);return a?{...l,title:a.title??l.title??"",minWidth:parseInt(a.minWidth??"0",10)}:[]}),...r.map(l=>{const{name:a,title:u,priority:s,minWidth:c,width:m,flex:h}=l;return{name:a??"",title:u??"",priority:s??0,minWidth:parseInt(c??"0",10),width:parseInt(m??"0",10),flex:parseInt(h??"0",10)}})]},pr=(n,e)=>({...e,...Oe(Array.from(be))(n),columns:n.columns?.map(Oe(["name","priority","width","flex","disabled"]))}),gr=({columns:n,settings:e,savedSettings:t,initial:o})=>({...Object.fromEntries(be.flatMap(i=>o?.[i]!=null?[[i,o[i]]]:[])),...t?Oe(Array.from(be))(t):{},...e,columns:mr(n,e?.columns,t?.columns)}),hr=({prefix:n="omnitable-"}={})=>({write:async(t,o)=>{const r=n+t;try{o?localStorage.setItem(r,JSON.stringify(o)):localStorage.removeItem(r)}catch(i){console.error(i)}},read:async t=>{if(t)try{const o=localStorage.getItem(n+t);return o==null?void 0:JSON.parse(o)}catch(o){console.error(o)}}}),fr=wt(hr),br=()=>{const n=Ee(fr);return I(()=>n(),[n])},xr=(n,e,t,o)=>{const[r,i]=M(),{read:l,write:a}=br();return E(async()=>{n&&i(await l(n))},[n,l]),{settingsId:n,savedSettings:r,onSave:w(async()=>{if(!n)return;const u=pr(e,r);await a(n,u),t(),i(u)},[e,r]),onReset:w(async u=>{t(),u.shiftKey&&(await a(n),i()),o?.()},[o]),hasChanges:e!=null}},yr=({settingsId:n,host:e})=>{const t=I(()=>Object.fromEntries(be.map(b=>[b,e[b]])),[]),o=Me(),r=w(()=>{o.current?.(t)},[t]),[i,l]=M(),[a,u]=M({columns:!0,sort:!0}),{savedSettings:s,...c}=xr(n,i,l,r),{enabledColumns:m}=e,h=An(e,{enabledColumns:m}),p=I(()=>gr({columns:h,settings:i,savedSettings:s,initial:t}),[h,i,s]),x=I(()=>p.columns.map(b=>h.find($=>$.name===b.name)).filter(Boolean),[h,...p.columns.map(b=>b.name)]);return{...c,opened:a,setOpened:u,settings:p,columns:x,setSettings:l,resetRef:o}},ht=n=>Number.isFinite(n)?n:0,vr=(n,e)=>{const t=[];let[o,r]=n.reduce(([c,m],{width:h,flex:p})=>[c+h,m+p],[0,0]),i=e-o,l=ht(i/r),a=0,u=0,s=0;for(let c=0;c<n.length;c++){const{width:m,minWidth:h,flex:p}=n[c],x=i>=0?l*p:m*i/o;if(h>m+x){a+=m,u+=h,s+=p,t[c]=h;continue}if(p===0){a+=m,u+=m,t[c]=m;continue}}o-=a,i=e-u-o,r-=s,l=ht(i/r);for(let c=0;c<n.length;c++){if(t[c]!=null)continue;const{width:m,flex:h}=n[c],p=i>=0?l*h:m*i/o;t[c]=m+p}return t},xe=Symbol("index"),$r=(n,e)=>{if(typeof n.findLastIndex=="function")return n.findLastIndex(e);for(let t=n.length-1;t>=0;t--)if(e(n[t],t,n))return t;return-1},wr=(n,e)=>{const t=$r(n,l=>l!=null&&l>0),o=(l,a)=>`.cell[name="${l}"], cosmoz-omnitable-skeleton::part(cell-${l}){width: ${Math.floor(a)}px;padding: 0 min(3px, ${a/2}px)}`,r=l=>`cosmoz-omnitable-resize-nub[name="${l}"]{display:none}`,i=l=>`cosmoz-omnitable-resize-nub[name="${l}"], .cell[name="${l}"]{display:none}`;return e.map((l,a)=>{const u=n[a];if(u==null||u===0)return i(l.name);const s=o(l.name,u);return a===t?`${s}
${r(l.name)}`:s}).join(`
`)},Nt=(n,e,t)=>{const o=n.filter(a=>!a.hidden),r=o.reduce((a,{width:u})=>a+u,0);if(o.length>1&&r>e)return Nt(o.slice(1),e,t);const i=o.reduce(([a,u],s,c)=>[Math.max(a,s.index),s.index>a?c:u],[-1,-1])[1];return i!==-1&&(o[i].flex=1),vr(o,e).reduce((a,u,s)=>(a[o[s].index]=u,a),new Array(t).fill(void 0))},zr=(n,e)=>n.length===0?".cell {display: none;}":wr(n,e),Cr=({host:n,canvasWidth:e,layout:t,setSettings:o})=>{const r=Me();r.current=i=>o(l=>{const a=l.columns,{detail:{newWidth:u,column:s}}=i,c=a.findIndex(p=>p.name===s.name),m=[],h=a.reduce((p,x)=>Math.max(p,x.priority),-1/0);for(let p=0;p<t.length;p++)if(m[p]={...a[p]},p<c&&t[p]&&(m[p].width=t[p],m[p].flex=0,m[p].priority=h),p===c){const x=t.reduce((b,$,F)=>F<c&&$?b-$:b,e);m[p].width=Math.min(x,Math.max(u,a[p].minWidth)),m[p].flex=0,m[p].priority=h}return{...l,columns:m}}),E(()=>{const i=l=>r.current?.(l);return n.addEventListener("column-resize",i),()=>n.removeEventListener("column-resize",i)},[])},Sr=(n,e)=>E(()=>{const t=([r])=>{r.contentRect?.width!==0&&requestAnimationFrame(()=>e(r.contentRect?.width-20-44-24))},o=new ResizeObserver(t);return o.observe(n),()=>o.unobserve(n)},[]),kr=n=>{const[e,t]=M(()=>n.getBoundingClientRect().width);return Sr(n,t),e},_r=(n,e)=>{const t=I(()=>{let o=!1,r;const i=()=>{if(!o)return;r=requestAnimationFrame(i),n()&&(o=!1)};return{start:()=>{o=!0,cancelAnimationFrame(r),r=requestAnimationFrame(i)},stop:()=>{o=!1,cancelAnimationFrame(r)}}},[]);E(()=>{t.start()},e),E(()=>()=>t.stop(),[])},Ir=(n=0,e=0)=>Math.abs(n-e)<.1,Fr=(n,e=1.9,t=mn)=>{const o=Re({target:n}),r=w(()=>{if(o.tween||(o.tween=o.target),o.target.every((i,l)=>o.tween[l]===i))return t(o.tween),!0;o.tween=o.target.map((i,l)=>Ir(o.tween[l],i)?i:(o.tween[l]??0)+((i??0)-(o.tween[l]??0))/e||0),t(o.tween)},[]);_r(r,[n])},Or=({canvasWidth:n,groupOnColumn:e,config:t,miniColumn:o})=>I(()=>{if(!Array.isArray(t)||n==null||n===0)return[];const r=t.map((i,l)=>({minWidth:i.minWidth,width:i.width,flex:i.flex,priority:i.priority,name:i.name,index:l,hidden:i.name===e?.name||i.disabled})).map(i=>o?{...i,hidden:o.name!==i.name}:i).sort(({index:i,priority:l},{index:a,priority:u})=>l===u?a-i:l-u);return Nt(r,n,r.length)},[n,e,t]),Dr=({host:n,canvasWidth:e,columns:t})=>{const o=n.miniBreakpoint??480,r=I(()=>e<=o,[e,o]),i=I(()=>r?t?.filter(s=>s.mini!=null).sort((s,c)=>(s.mini??0)-(c.mini??0)):[],[t,r]),[l,...a]=i??[],u=!!l;return E(()=>{n.toggleAttribute("mini",u)},[u]),{isMini:u&&r,miniColumn:l,miniColumns:a}},Vr=n=>{const e=I(()=>new CSSStyleSheet,[]);return E(()=>{n.shadowRoot.adoptedStyleSheets=[...n.shadowRoot.adoptedStyleSheets,e]},[]),e},Ar=({host:n,columns:e,settings:t,setSettings:o,resizeSpeedFactor:r,sortAndGroupOptions:i})=>{const l=kr(n),{isMini:a,miniColumn:u,miniColumns:s}=Dr({host:n,canvasWidth:l,columns:e}),{groupOnColumn:c}=i,m=Or({canvasWidth:l,groupOnColumn:c,miniColumn:u,config:t.columns}),h=Vr(n),p=I(()=>t.columns.reduce((b,$,F)=>m[F]!=null||$.name===c?.name||$.disabled?b:[...b,e.find(g=>g.name===$.name)],[]),[e,t,m]),x=Re({columns:t.columns});return Fr(m,r,b=>{const $=zr(b,x.columns);h.replace($)}),Cr({host:n,canvasWidth:l,layout:m,setSettings:b=>o(b(t))}),{isMini:a,collapsedColumns:p,miniColumns:s}},Er=({host:n,...e})=>{const{csvFilename:t="omnitable.csv",xlsxFilename:o="omnitable.xlsx",xlsxSheetname:r="Omnitable",topPlacement:i="top-end"}=n;return{csvFilename:t,xlsxFilename:o,xlsxSheetname:r,topPlacement:i,...e}},Tr=({host:n,selectedItems:e,data:t,sortAndGroupOptions:o,collapsedColumns:r,settings:i,filterFunctions:l,settingS:a,filters:u,...s})=>{const c=t&&t.length>0&&e.length===t.length,m=b=>{b.target.checked?n.shadowRoot.querySelector("#groupedList").selectAll():n.shadowRoot.querySelector("#groupedList").deselectAll()},{groupOnColumn:h}=o,p=I(()=>[h,...r,...i.columns.filter(b=>b.disabled)].some(b=>b&&Object.keys(l).includes(b.name)),[l,i,r]),x=I(()=>({...a,collapsed:r,badge:p,filters:u}),[a,r,p,u]);return E(()=>{const b=n.shadowRoot.querySelector("#tableContent"),$=new ResizeObserver(F=>requestAnimationFrame(()=>{n.style.setProperty("--ot-height",F[0]?.contentRect.height+"px")}));return $.observe(b),()=>$.unobserve(b)},[]),{allSelected:c,onAllCheckboxChange:m,data:t,settingsConfig:x,filters:u,groupOnColumn:h,sortAndGroup:o.sortAndGroup,...s}},jt=d`
	<svg
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
...
`,Lr=n=>n?"groupRow groupRow-folded":"groupRow",Rr=({item:n,index:e})=>t=>D(t?.length>0,()=>d`
	...
	`,Nr=({onCheckboxChange:n,dataIsValid:e,groupOnColumn:t})=>(o,r,{selected:i,folded:l,toggleFold:a})=>d` <div
		...
		</div>`,jr=({host:n,error:e,dataIsValid:t,processedItems:o,columns:r,collapsedColumns:i,miniColumns:l,sortAndGroupOptions:a,rowPartFn:u,...s})=>{const{loading:c=!1,displayEmptyGroups:m=!1,compareItemsFn:h}=n,p=Me({shiftKey:!1,ctrlKey:!1}),x=w(g=>{const _=g.target.dataItem,f=g.target.checked;p.current.shiftKey?n.shadowRoot.querySelector("#groupedList").toggleSelectTo(_,f):p.current.ctrlKey?(g.target.checked=!0,n.shadowRoot.querySelector("#groupedList").selectOnly(_)):n.shadowRoot.querySelector("#groupedList").toggleSelect(_,f),g.preventDefault(),g.stopPropagation()},[]);E(()=>{const g=({shiftKey:_,ctrlKey:f})=>{p.current={shiftKey:_,ctrlKey:f}};return window.addEventListener("keydown",g),window.addEventListener("keyup",g),()=>{window.removeEventListener("keydown",g),window.removeEventListener("keyup",g)}},[]);const b=w(g=>{const _=g.composedPath();_.slice(0,_.indexOf(g.currentTarget)).find(v=>v.matches?.("a, .checkbox, .expand"))||n.dispatchEvent(new window.CustomEvent("omnitable-item-click",{bubbles:!0,composed:!0,detail:{item:g.currentTarget.dataItem,index:g.currentTarget.dataIndex}}))},[]),{groupOnColumn:$}=a,F=w((g,_)=>f=>En(n,g,_,f),[]);return{...s,processedItems:o,dataIsValid:t,filterIsTooStrict:t&&o.length<1,loading:c,compareItemsFn:h,displayEmptyGroups:m,error:e,renderItem:I(()=>Mr({columns:r,collapsedColumns:i,miniColumns:l,onItemClick:b,onCheckboxChange:x,dataIsValid:t,groupOnColumn:$,onItemChange:F,rowPartFn:u}),[r,i,b,x,t,$,F,u]),renderGroup:I(()=>Nr({onCheckboxChange:x,dataIsValid:t,groupOnColumn:$}),[x,t,$])}},Pr=(n,e)=>{if(n===e)return 0;if(n==null)return-1;if(e==null)return 1;const t=typeof n,o=typeof e;return t==="object"&&o==="object"?n.toString()<e.toString()?-1:1:t==="number"&&o==="number"?n-e:t==="string"&&o==="string"?n<e?-1:1:t==="boolean"&&o==="boolean"?n?-1:1:(console.warn("unsupported sort",t,n,o,e),0)},_e=(n,e)=>(t,o)=>Pr(n(t),n(o))*(e?-1:1),Br=n=>n.replace(/([a-z0-9])([A-Z])/gu,"$1-$2").toLowerCase(),ft=(n,e)=>{!n||!e||Object.entries(e).forEach(([t,o])=>{n[B].__ownChange=!0,n[B][t]=o,n[B].__ownChange=!1,n[B].dispatchEvent(new CustomEvent(`${Br(t)}-changed`,{bubbles:!0,detail:{value:o}}))})},Ie=(n,e)=>Object.assign(n,{[xe]:e}),ce=Symbol("unparsed"),Gr=({data:n,columns:e,hashParam:t,sortAndGroupOptions:o,noLocalSort:r,noLocalFilter:i})=>{const{groupOnColumn:l,groupOnDescending:a,sortOnColumn:u,descending:s}=o,c=w(([f,v])=>{const y=e.find(({name:z})=>z===f);return y==null?[f,void 0]:[f,v.filter&&y.serializeFilter(y,v.filter)]},[e]),m=w(([f,v])=>{const y=e.find(({name:S})=>S===f);if(y==null)return[f,{[ce]:v}];const z={filter:y.deserializeFilter(y,v)};return ft(y,z),[f,z]},[e]),[h,p]=J({},t,{multi:!0,suffix:"-filter--",write:c,read:m}),x=w((f,v)=>p(y=>{const z=ve(v,y[f]);return ft(e.find(S=>S.name===f),z),{...y,[f]:{...y[f],...z}}}),[e,p]),b=I(()=>Object.values(h).map(f=>f.filter),[h]),$=I(()=>Object.fromEntries(e.map(f=>[f.name,!f.noLocalFilter&&f.getFilterFn(f,h[f.name]?.filter)]).filter(([,f])=>!!f)),[e,...b]),F=I(()=>!Array.isArray(n)||n.length===0?[]:Object.entries($).length===0||i?n.slice():n.filter(f=>Object.values($).every(v=>v(f))),[n,$,i]),g=I(()=>{if(!r&&!l&&u!=null&&u.sortOn!=null)return F.slice().sort(_e(f=>u.getComparableValue({...u,valuePath:u.sortOn},f),s));if(l!=null&&l.groupOn!=null){const f=F.reduce((v,y)=>{const z=l.getComparableValue({...l,valuePath:l.groupOn},y);if(z===void 0)return v;let S=v.find(R=>R.id===z);return S?(S.items.push(y),v):(S={id:z,name:z,items:[y]},[...v,S])},[]);return f.sort(_e(v=>l.getComparableValue({...l,valuePath:l.groupOn},v.items[0]),a)),!u||r?f:f.filter(v=>Array.isArray(v.items)).map(v=>(v.items.sort(_e(y=>u.getComparableValue({...u,valuePath:u.sortOn},y),s)),v))}return F},[F,l,a,u,s,r]),_=I(()=>{let f=0,v=0;const y=[];return g.forEach(z=>{if(Array.isArray(z.items)){Ie(z,v++),z.items.forEach(S=>{Ie(S,f++),y.push(S)});return}return Ie(z,f++),y.push(z)},[]),y},[g]);return E(()=>{p(f=>Object.values(f).some(y=>y[ce]!=null)?Object.fromEntries(Object.entries(f).map(([y,z])=>z[ce]==null?[y,z]:m([y,z[ce]]))):f)},[m]),{processedItems:g,visibleData:_,filters:h,filterFunctions:$,setFilterState:x}},Hr=n=>{const e=o=>{const r=n.data.indexOf(o);if(r<0)return null;const i=n.data.splice(r,1);if(n.data=n.data.slice(),Array.isArray(i)&&i.length>0)return i[0]},t=(o,r)=>{n.data.splice(o,1,r),n.data=n.data.slice()};return{removeItem:e,removeItems(o){const r=[];for(let i=o.length-1;i>=0;i-=1){const l=n.removeItem(o[i]);l!=null&&r.push(l)}return r},replaceItemAtIndex:t,replaceItem(o,r){const i=n.data.indexOf(o);if(i>-1)return t(i,r)},selectItem(o){n.shadowRoot.querySelector("#groupedList").select(o)},selectAll(){n.shadowRoot.querySelector("#groupedList").selectAll()},deselectAll(){n.shadowRoot.querySelector("#groupedList").deselectAll()},deselectItem(o){n.shadowRoot.querySelector("#groupedList").deselect(o)},isItemSelected(o){return n.shadowRoot.querySelector("#groupedList").isItemSelected(o)}}},Wr=({host:n,visibleData:e,filters:t,...o})=>{const{setFilterState:r}=o,i=I(()=>Hr(n),[]);De(o,Object.values(o)),De(i,Object.values(i)),E(()=>{const a=u=>r(u.detail.name,s=>({...s,...u.detail.state}));return n.addEventListener("legacy-filter-changed",a),()=>n.removeEventListener("legacy-filter-changed",a)},[]),P("visibleData",e),P("sortedFilteredGroupedItems",o.sortedFilteredGroupedItems),P("selectedItems",o.selectedItems),P("sortOn",o.sortOn),P("descending",o.descending),P("isMini",o.isMini);const l=I(()=>Object.fromEntries(Object.entries(t).filter(([,{filter:a}])=>a!==void 0).map(([a,{filter:u}])=>[a,u])),[t]);P("filters",l,Object.values(l))},qr=n=>{const{hashParam:e,settingsId:t,data:o,resizeSpeedFactor:r,noLocal:i,noLocalSort:l=i,noLocalFilter:a=i,error:u,rowPartFn:s}=n,c=yr({settingsId:t,host:n}),{settings:m,setSettings:h,columns:p,resetRef:x}=c,b=Po(p,e,m,h,x),{processedItems:$,visibleData:F,filters:g,setFilterState:_,filterFunctions:f}=Gr({data:o,columns:p,hashParam:e,sortAndGroupOptions:b,noLocalSort:l,noLocalFilter:a}),{isMini:v,collapsedColumns:y,miniColumns:z}=Ar({host:n,columns:p,settings:m,setSettings:h,resizeSpeedFactor:r,sortAndGroupOptions:b}),S=o&&Array.isArray(o)&&o.length>0,[R,H]=M([]);return Wr({host:n,visibleData:F,sortedFilteredGroupedItems:$,columns:p,filters:g,setFilterState:_,selectedItems:R,isMini:v,...b}),{header:Tr({host:n,selectedItems:R,sortAndGroupOptions:b,dataIsValid:S,data:o,columns:p,filters:g,collapsedColumns:y,settings:m,filterFunctions:f,settingS:c,setFilterState:_,hideSelectAll:n.hideSelectAll===!0}),list:jr({host:n,error:u,dataIsValid:S,processedItems:$,setSelectedItems:H,columns:p,collapsedColumns:y,miniColumns:z,sortAndGroupOptions:b,rowPartFn:s}),footer:Er({host:n,selectedItems:R,columns:p})}};customElements.define("cosmoz-grouped-list-row",class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||Fe(this._renderFn(this._item,this._index),this)}});const Xr={group:Symbol("group")},ze=(n,e)=>(e.has(n)||e.set(n,{}),e.get(n)),Ur=(n,e)=>!!ze(n,e).expanded,Kr=(n,e)=>!!ze(n,e).folded,Ve=n=>n?n.items instanceof Array:!1,Jr=n=>{if(!Array.isArray(n)||n.length===0)return;const e=Array.isArray(n[0]?.items);if(!n.every(o=>Array.isArray(o.items)===e))throw new Error("Data must be homogeneous.")},Qr=(n,e,t)=>Array.isArray(n)?(Jr(n),n.reduce((r,i)=>{const l=i;return l.items?l.items.length?ze(i,t).folded?r.concat(i):r.concat(i,l.items.map(a=>Object.assign(a,{[Xr.group]:i}))):e?r.concat(i):r:r.concat(i)},[])):void 0,Yr=(n,...e)=>typeof n=="function"?n(...e):n,Zr=(n,e)=>n===e,ei=()=>{const[n,e]=M(()=>[new WeakMap]);return{setItemState:w((o,r)=>e(([i])=>{const l=ze(o,i);return Object.assign(l,Yr(r,l)),[i]}),[]),state:n[0],signal:n}},ti=()=>{const{setItemState:n,state:e,signal:t}=ei(),o=w((i,l)=>{Ve(i)&&n(i,a=>({folded:l!==void 0?l:!a.folded}))},[]),r=w((i,l)=>{Ve(i)||n(i,a=>({expanded:l!==void 0?!l:!a.expanded}))},[]);return{state:e,signal:t,toggleFold:o,toggleCollapse:r}},ni=({initial:n,compareItemsFn:e,data:t,flatData:o})=>{const[r,i]=M(n),[l,a]=M(),u=w(g=>r.includes(g),[r]),s=w(g=>g?.items?.every(u)??!1,[u]),c=w(g=>u(g)||s(g),[u,s]),m=w(g=>{const f=g.items??[g];i(v=>[...v,...f.filter(y=>!v.includes(y))]),a(g)},[]),h=w(g=>{const f=g.items??[g];i(v=>v.filter(y=>!f.includes(y))),a(g)},[]),p=w(g=>{i(g.items?.slice()||[g]),a(g)},[]),x=w(()=>{i(t.flatMap(g=>g.items||g)),a(void 0)},[t]),b=w(()=>{i([]),a(void 0)},[]),$=w((g,_=!c(g))=>_?m(g):h(g),[c]),F=w((g,_)=>{if(!o)return;const f=l?o.findIndex(z=>e(z,l)):-1;if(f<0)return $(g,_);const[v,y]=[f,o.indexOf(g)].sort((z,S)=>z-S);o.slice(v,y+1).forEach((z,S,R)=>{S>0&&S<R.length-1&&Ve(z)||$(z,_)}),a(g)},[o,e,$]);return E(()=>i(g=>g.length>0&&o?o.filter(_=>g.find(f=>e(_,f))):g),[o]),{selectedItems:r,isItemSelected:u,isGroupSelected:s,isSelected:c,select:m,deselect:h,selectOnly:p,selectAll:x,deselectAll:b,toggleSelect:$,toggleSelectTo:F}},oi={host:{position:"relative",display:"flex",flexDirection:"column"}},ri=n=>{const{data:e,renderItem:t,renderGroup:o,displayEmptyGroups:r,compareItemsFn:i=Zr}=n,{toggleFold:l,toggleCollapse:a,state:u,signal:s}=ti(),c=I(()=>Qr(e,r,u),[e,r,s]),{selectedItems:m,isItemSelected:h,isGroupSelected:p,isSelected:x,select:b,deselect:$,selectOnly:F,selectAll:g,deselectAll:_,toggleSelect:f,toggleSelectTo:v}=ni({initial:[],compareItemsFn:i,data:e,flatData:c}),y=w((S,R)=>Array.isArray(S.items)?o(S,R,{selected:p(S),folded:Kr(S,u),toggleSelect:H=>f(S,typeof H=="boolean"?H:void 0),toggleFold:()=>l(S)}):t(S,R,{selected:m.includes(S),expanded:Ur(S,u),toggleSelect:H=>f(S,typeof H=="boolean"?H:void 0),toggleCollapse:()=>a(S)}),[t,o,m,f,s]);yt(()=>{Object.assign(n.style,oi.host)},[]),P("selectedItems",m);const z={toggleFold:l,toggleCollapse:a,isItemSelected:h,isGroupSelected:p,isSelected:x,select:b,deselect:$,selectOnly:F,selectAll:g,deselectAll:_,toggleSelect:f,toggleSelectTo:v};return De(z,Object.values(z)),{renderRow:y,flatData:c}},ii=({renderRow:n,flatData:e})=>pn({items:e,renderItem:(t,o)=>d`<cosmoz-grouped-list-row
				.item=${t}
				.index=${o}
				.renderFn=${n}
			></cosmoz-grouped-list-row>`}),li=n=>ii(ri(n));customElements.define("cosmoz-grouped-list",T(li,{useShadowDOM:!1}));const ai=n=>window.ShadyCSS?.ApplyShim?.transformCssText?.(n)||n,si=n=>{const{header:e,list:t,footer:o}=qr(n);return d`
		<style>
			${gn([],()=>ai(Ko))}
		</style>
