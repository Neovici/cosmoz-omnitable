import{x as d,B as Ie,E as Ve}from"./iframe-CLUOl92u.js";import{t as K,c as T,g as C,P as A,u as M,a as ft,m as bt,s as Mt,D as Nt,b as jt,e as Pt,i as ve,h as Ae,d as Bt,f as _,j as Gt,k as ye,p as he,n as D,l as Ht,o as $e,q as Wt,r as qt,v as Xt,T as Ut,w as E,x as Kt,y as Jt,z as Yt,A as Qt,B as $,C as Zt,E as en,F as xt,G as Ee,H as I,I as vt,J as Te,K as tn,L as yt,N as nn,M as on,O as Le,Q as rn,R as Re,S as an,U as ln,V as Fe,W as Me,X as sn,Y as Oe,Z as P,_ as un,$ as ze,a0 as cn}from"./cosmoz-collapse-DivN7Rty.js";import"./preload-helper-PPVm8Dsz.js";const dn=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`;customElements.define("cosmoz-clear-button",T(mn));const U=({valuePath:n},e)=>C(e,n),pn=U,gn=U,hn=({valuePath:n},e)=>t=>{const o=C(t,n);return o==null?!1:o.toString().toLowerCase().trim().includes(e.toLowerCase().trim())},fn=(n,e)=>e===""||e==null?null:e,N=n=>class extends n{static get properties(){return{isOmnitableColumn:{type:Boolean,value:!0},title:{type:String},valuePath:{type:String,notify:!0},values:{type:Array,notify:!0},filter:{type:Object},noLocalFilter:{type:Boolean},disabled:{type:Boolean,value:!1,notify:!0},editable:{type:Boolean,notify:!0},loading:{type:Boolean,value:!1,notify:!0},externalValues:{type:Boolean,value:!1,notify:!0},name:{type:String},sortOn:{type:String},groupOn:{type:String},width:{type:String,value:"75px"},minWidth:{type:String,value:"40px"},flex:{type:String,value:"1"},cellClass:{type:String,value:"default-cell"},headerCellClass:{type:String,value:"default-header-cell"},priority:{type:Number,value:0},hidden:{type:Boolean,notify:!0},preferredDropdownHorizontalAlign:{type:String,value:"right"},renderHeader:{type:Function},renderCell:{type:Function},renderEditCell:{type:Function},renderGroup:{type:Function},mini:{type:Number,value:null},renderMini:{type:Function}}}static get observers(){return["notifyFilterChange(filter)"]}notifyFilterChange(e){this.__ownChange||this.dispatchEvent(new CustomEvent("legacy-filter-changed",{detail:{name:this.name,state:this.legacyFilterToState(e)},bubbles:!0}))}legacyFilterToState(e){return{filter:e}}getFilterFn(){}getString(e,t){return U(e,t)}toXlsxValue(e,t){return pn(e,t)}cellTitleFn(e,t){return this.getString(e,t)}headerTitleFn(e){return e.title}serializeFilter(e,t){return fn(e,t)}deserializeFilter(e,t){return t==null?null:typeof t=="string"?window.decodeURIComponent(t):t}getComparableValue(e,t){return gn(e,t)}computeSource(e,t){return t}_propertiesChanged(e,t,o){super._propertiesChanged(e,t,o),this.dispatchEvent(new CustomEvent("cosmoz-column-prop-changed",{bubbles:!0}))}},bn=n=>e=>n(t=>{if(t.inputValue===void 0&&e.target.value==="")return t;clearTimeout(t.t);const o=setTimeout(()=>n(r=>({...r,filter:r.inputValue})),1e3);return{...t,inputValue:e.target.value,t:o}}),xn=n=>()=>n(e=>({...e,filter:e.inputValue})),vn=n=>e=>{e.keyCode===13&&(e.preventDefault(),n(t=>({...t,filter:t.inputValue})))},yn=n=>e=>n(t=>({...t,headerFocused:e.detail.value})),$n=n=>()=>n(e=>({...e,filter:null,inputValue:null})),wn=n=>n!=null&&n!=="";class zn extends N(A){static get properties(){return{minWidth:{type:String,value:"55px"},editMinWidth:{type:String,value:"55px"},inputValue:{type:Object,notify:!0}}}getFilterFn(e,t){if(!(t==null||t===""))return hn(e,t)}renderCell(e,{item:t}){return d`<span class="default-column">${U(e,t)}</span>`}renderEditCell(e,{item:t},o){return d`<cosmoz-input
	...
	`};class Dn extends Ne(Z(A)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.detail.value,this._onDropdownOpenedChanged(t)};return d`
			<style>
				paper-dropdown-menu {
					--iron-icon-width: 0;
					display: block;
		...
		>`}getComparableValue(e,t){return qn(e,t)}}customElements.define("cosmoz-omnitable-column-autocomplete",Xn);const qe=(n,e)=>e.find(({value:t})=>n===t),Un=(n,e,t)=>{const o=qe(e,t);return o?o.text:n},nt=(n,e,t,o)=>Un(n,C(e,t),o),Kn=({valuePath:n},e,t)=>qe(C(e,n),t),Jn=n=>e=>{n(t=>({...t,filter:e?.[0]?.value??null}))},Yn=n=>e=>{n(t=>({...t,headerFocused:e}))},Qn=n=>e=>{n(t=>({...t,query:e}))},Zn=n=>e=>n(e?.[0]?.value),ot=({valuePath:n,trueLabel:e,falseLabel:t},o)=>C(o,n)?e:t,eo=({valuePath:n},e)=>t=>C(t,n)===e,ne=bt((n,e)=>[{text:n,value:!0},{text:e,value:!1}]),to=({valuePath:n,trueLabel:e,falseLabel:t},o)=>n?C(o,n)?e:t:"",no=(n,e)=>{try{return JSON.parse(e)}catch{return null}};class oo extends N(A){static get properties(){return{trueLabel:{type:String,value:"True"},falseLabel:{type:String,value:"False"},flex:{type:String,value:"0"},cellClass:{type:String,value:"boolean-cell"}}}getString(e,t){return ot(e,t)}renderCell(e,{item:t}){return ot(e,t)}renderEditCell(e,{item:t},o){const{trueLabel:r,falseLabel:i}=e;return d`<cosmoz-autocomplete
			no-label-float
		...
		>`}computeSource({trueLabel:e,falseLabel:t}){return ne(e,t)}getFilterFn(e,t){if(t!=null)return eo(e,t)}toXlsxValue(e,t){return to(e,t)}deserializeFilter(e,t){return no(e,t)}}customElements.define("cosmoz-omnitable-column-boolean",oo);const Xe=n=>class extends Ne(n){static get properties(){return{max:{type:Date,value:null},min:{type:Date,value:null},_filterText:{type:String,computed:"_computeFilterText(filter.*, formatter)"},formatter:{type:Object,computed:"_computeFormatter(locale)"}}}toDate(e,t,o){if(e==null||e==="")return;let r=e;if(r instanceof Date||(typeof e=="string"&&(r=this.getAbsoluteISOString(r)),r=new Date(r)),Number.isNaN(r.getTime()))return null;if(o==null||t==null)return r;const i=this.toDate(t);if(i==null)return r;const a=this.getComparableValue(r),l=this.getComparableValue(i);return o(a,l)===a?r:i}toValue(){return this.toDate.apply(this,arguments)}getComparableValue(e,t){const o=super.getComparableValue(e,t);if(o!=null)return this.toNumber(o.getTime())}getString(e,t=this.valuePath,o=this.formatter){const r=this.toValue(this.get(t,e));return r===void 0?"":r===null?"Invalid Date":this.renderValue(r,o)}getAbsoluteISOString(e){return e.length===19?e+this._getTimezoneString(e):e}_getTimezoneString(e){const t=-new Date(e).getTimezoneOffset()/60;return(t<0?"-":"+")+["0",Math.abs(t)].join("").substr(-2)+":00"}renderValue(e,t=this.formatter){if(t==null)return;const o=this.toValue(e);if(o!=null)return t.format(o)}_computeFormatter(e){return new Intl.DateTimeFormat(e||void 0)}_toInputString(e){const t=this.toValue(e);return t==null?null:this._toLocalISOString(t).slice(0,10)}_dateValueChanged(e){const t=e.currentTarget,o=t.value,r=e.model.item,i=this.get(this.valuePath,r),a=this._fromInputString(o);this.set(this.valuePath,a,r),this._fireItemChangeEvent(r,this.valuePath,i,this.renderValue.bind(this))}_toLocalISOString(e){return $e(e)}};class ro extends Xe(Z(A)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return d`
			...
			${ee({title:this.title,tooltip:this._tooltip,filterText:this._filterText,headerFocused:this.headerFocused,horizontalAlign:"right",externalValues:this.externalValues,onOpenedChanged:e,content:d`
					...
					></cosmoz-input>
				`})}
		`}_fromInputString(e,t){const o=this.toDate(e);if(o!=null)return t==="min"&&o.setHours(0,0,0,0),t==="max"&&o.setHours(23,59,59),o}_filterInputChanged(e,t){const o=e.path.split(".")[1],r=o&&e.value;if(r&&r.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}}customElements.define("cosmoz-omnitable-date-range-input",ro);const io=n=>{const e=-new Date(n).getTimezoneOffset()/60;return(e<0?"-":"+")+["0",Math.abs(e)].join("").substr(-2)+":00"},Ue=n=>n.length===19?n+io(n):n,St=n=>{if(n==null||n==="")return;let e=n;return!(e instanceof Date)&&(typeof n=="string"&&(e=Ue(e)),e=Wt(e),!e)||Number.isNaN(e.getTime())?null:e},j=({valuePath:n},e)=>{if(e==null)return;let t=e;n!=null&&(t=C(e,n));const o=St(t);if(o!=null)return L(o.getTime())},V=(n,e,t)=>{const o=St(n);return o??null},Ke=(n,e)=>{if(e==null)return;const t=V(n);if(t!=null)return e.format(t)},oe={},ao=n=>{const e=n||"";return oe[e]||(oe[e]=new Intl.DateTimeFormat(n||void 0)),oe[e]},rt=({valuePath:n,locale:e},t)=>{let o=C(t,n||"");return o===void 0?"":(o=V(o),o===null?"Invalid Date":Ke(o,ao(e)))},kt=n=>{const e=V(n);if(e==null)return null;const t=$e(e);return t==null?null:t.slice(0,10)},lo=({valuePath:n},e)=>kt(C(e,n||"")),_t=(n,e)=>{const t=V(n);if(t!=null)return t},it=n=>{const e=kt(n);return e??""},so=({valuePath:n},e)=>{if(!n)return"";const t=V(C(e,n));if(!t)return"";const o=V($e(t));return o?(o.setHours(0,0,0,0),o):""},It=(n,e)=>t=>{const o=j(n,t);if(o==null)return!1;const r=j({...n,valuePath:"min"},e),i=j({...n,valuePath:"max"},e);return!(o<(r??-1/0)||o>(i??1/0))};class uo extends N(A){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"date-header-cell"},width:{type:String,value:"100px"},minWidth:{type:String,value:"82px"},flex:{type:String,value:"0"}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const o=j({...e,valuePath:"min"},t),r=j({...e,valuePath:"max"},t);if(!(o==null&&r==null))return It(e,t)}getString(e,t){return rt(e,t)}toXlsxValue(e,t){return so(e,t)}getComparableValue(e,t){return j(e,t)}serializeFilter(e,t){if(t==null)return;const o=V(t.min),r=V(t.max);if(!(o==null&&r==null))return it(o)+"~"+it(r)}deserializeFilter(e,t){if(t==null||t==="")return null;const o=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(o)?{min:V(o[1]),max:V(o[2])}:null}renderCell(e,{item:t}){return d`<div class="omnitable-cell-date">
			${rt(e,t)}
		...
		`}renderEditCell(){return"not implemented"}renderHeader(e,{filter:t,query:o},r,i){return d`<cosmoz-autocomplete-ui
			...
			.onText=${He(r)}
			>${D(e.loading,()=>d`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}}customElements.define("cosmoz-omnitable-column-list-horizontal",co);window.Cosmoz=window.Cosmoz||{};class at extends qt(Xt(Ut,A)){static get template(){return Ae`
			<style>
				:host {
					display: block;
				}
		...
		></cosmoz-input>`}renderHeader({title:e,min:t,max:o,locale:r,filterStep:i},{filter:a},l,s){return d`<cosmoz-omnitable-time-range-input
			...
			@filter-changed=${({detail:{value:u}})=>l(c=>({...c,filter:u}))}
			@header-focused-changed=${({detail:{value:u}})=>l(c=>({...c,headerFocused:u}))}
		></cosmoz-omnitable-time-range-input>`}computeSource(e,t){return Q(e,t)}}customElements.define("cosmoz-omnitable-column-time",yo);const ie={},$o=n=>{const e=n||"";if(ie[e])return ie[e];const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return ie[e]=new Intl.DateTimeFormat(n||void 0,t),ie[e]},Ce=({valuePath:n,locale:e},t)=>{const o=V(C(t,n||""));return o===void 0?"":o===null?"Invalid Date":Ke(o,$o(e))},wo=({valuePath:n},e)=>n?C(e,n):"",ut=n=>{const e=V(n);return e==null?"":e.toISOString().slice(0,19).replace(/:/gu,".")},ct=n=>{if(!(n==null||n==="")&&typeof n=="string")return V(n.replace(/\./gu,":")+"Z")};class zo extends Xe(Z(A)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return d`
			<style>
...
>
	...
	/>
</svg> `,Ot=({column:n,on:e,descending:t,setOn:o,setDescending:r})=>{const{name:i,title:a}=n??{};return d`<button
		class="sg"
		title=${a}
		data-on=${Kt(i===e&&(t?"desc":"asc")||void 0)}
		@click=${l=>{const s=l.currentTarget?.dataset.on;s||(o(i),r(!1)),s==="asc"?r(!0):s==="desc"&&(o(),r(!1))}}
	>
		<span>${a}</span> ${Io}
	</button>`},Dt=({columns:n,...e})=>n?.map(t=>Ot({column:t,...e})),Fo=()=>d`
...
`;customElements.define("cosmoz-omnitable-item-expand-line",T(Mo,{styleSheets:[Te(Ro)]}));const No=({columns:n,item:e,selected:t,expanded:o,groupOnColumn:r})=>tn(n,i=>d`<cosmoz-omnitable-item-expand-line
			...
			>`);customElements.define("cosmoz-omnitable-item-expand",T(No,{useShadowDOM:!1}));const jo=(n,e,t)=>n.editable?n.renderEditCell(n,e,t(n,e.item)):n.renderCell(n,e),Po=({columns:n,groupOnColumn:e,item:t,index:o,selected:r,expanded:i,onItemChange:a})=>vt(n,l=>l.name,l=>d`<div
			...
			</div>`);customElements.define("cosmoz-omnitable-item-row",T(Po,{useShadowDOM:!1}));const Et=K`
	.checkbox {
		box-sizing: border-box;
		width: 18px;
		height: 18px;
...
`);a.unshift(i),yt(new File(a,t,{type:"text/csv;charset=utf-8"}))},Ho=(n,e)=>{const t=n.map(r=>r.title),o=e.map(r=>n.map(i=>{const a=i.toXlsxValue(i,r);return a??""}));return o.unshift(t),o},Wo=(n,e,t,o)=>{const r=Ho(n,e),i=new nn(t).addSheetFromData(r,o).generate();yt(new File([i],t,{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}))},qo=({columns:n,selectedItems:e,csvFilename:t,xlsxFilename:o,xlsxSheetname:r,topPlacement:i})=>d`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!Le(e.length)}
		part="bottomBar"
...
`;d(Object.assign([xe],{raw:[xe]}));Ae(Object.assign([xe],{raw:[xe]}));const ti=()=>d`<style>
	@keyframes rotating {
		100% {
