import{x as c,B as _e,E as Oe}from"./iframe-CLUOl92u.js";import{t as K,c as L,g as C,P as I,u as T,a as ht,m as xt,s as Vt,D as Pt,b as Nt,e as Rt,i as $e,h as Le,d as Bt,f as A,j as Gt,k as we,p as he,n as _,l as Ht,o as Ce,q as jt,r as Wt,v as Ut,T as Kt,w as M,x as Jt,y as Xt,z as Qt,A as Yt,B as $,C as Zt,E as ei,F as vt,G as De,H as F,I as yt,J as Te,K as ti,L as $t,N as ii,M as ai,O as Ve,Q as ni,R as Pe,S as oi,U as ri,V as Ee,W as Ne,X as li,Y as Ie,Z as N,_ as si,$ as ze,a0 as ui}from"./cosmoz-collapse-DivN7Rty.js";import"./preload-helper-PPVm8Dsz.js";const di=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`;customElements.define("cosmoz-clear-button",L(ci));const U=({valuePath:i},e)=>C(e,i),mi=U,pi=U,gi=({valuePath:i},e)=>t=>{const a=C(t,i);return a==null?!1:a.toString().toLowerCase().trim().includes(e.toLowerCase().trim())},bi=(i,e)=>e===""||e==null?null:e,V=i=>class extends i{static get properties(){return{isOmnitableColumn:{type:Boolean,value:!0},title:{type:String},valuePath:{type:String,notify:!0},values:{type:Array,notify:!0},filter:{type:Object},noLocalFilter:{type:Boolean},disabled:{type:Boolean,value:!1,notify:!0},editable:{type:Boolean,notify:!0},loading:{type:Boolean,value:!1,notify:!0},externalValues:{type:Boolean,value:!1,notify:!0},name:{type:String},sortOn:{type:String},groupOn:{type:String},width:{type:String,value:"75px"},minWidth:{type:String,value:"40px"},flex:{type:String,value:"1"},cellClass:{type:String,value:"default-cell"},headerCellClass:{type:String,value:"default-header-cell"},priority:{type:Number,value:0},hidden:{type:Boolean,notify:!0},preferredDropdownHorizontalAlign:{type:String,value:"right"},renderHeader:{type:Function},renderCell:{type:Function},renderEditCell:{type:Function},renderGroup:{type:Function},mini:{type:Number,value:null},renderMini:{type:Function}}}static get observers(){return["notifyFilterChange(filter)"]}notifyFilterChange(e){this.__ownChange||this.dispatchEvent(new CustomEvent("legacy-filter-changed",{detail:{name:this.name,state:this.legacyFilterToState(e)},bubbles:!0}))}legacyFilterToState(e){return{filter:e}}getFilterFn(){}getString(e,t){return U(e,t)}toXlsxValue(e,t){return mi(e,t)}cellTitleFn(e,t){return this.getString(e,t)}headerTitleFn(e){return e.title}serializeFilter(e,t){return bi(e,t)}deserializeFilter(e,t){return t==null?null:typeof t=="string"?window.decodeURIComponent(t):t}getComparableValue(e,t){return pi(e,t)}computeSource(e,t){return t}_propertiesChanged(e,t,a){super._propertiesChanged(e,t,a),this.dispatchEvent(new CustomEvent("cosmoz-column-prop-changed",{bubbles:!0}))}},fi=i=>e=>i(t=>{if(t.inputValue===void 0&&e.target.value==="")return t;clearTimeout(t.t);const a=setTimeout(()=>i(n=>({...n,filter:n.inputValue})),1e3);return{...t,inputValue:e.target.value,t:a}}),hi=i=>()=>i(e=>({...e,filter:e.inputValue})),xi=i=>e=>{e.keyCode===13&&(e.preventDefault(),i(t=>({...t,filter:t.inputValue})))},vi=i=>e=>i(t=>({...t,headerFocused:e.detail.value})),yi=i=>()=>i(e=>({...e,filter:null,inputValue:null})),$i=i=>i!=null&&i!=="";class wi extends V(I){static get properties(){return{minWidth:{type:String,value:"55px"},editMinWidth:{type:String,value:"55px"},inputValue:{type:Object,notify:!0}}}getFilterFn(e,t){if(!(t==null||t===""))return gi(e,t)}renderCell(e,{item:t}){return c`<span class="default-column">${U(e,t)}</span>`}renderEditCell(e,{item:t},a){return c`<cosmoz-input
	...
	`};class _i extends Re(ae(I)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.detail.value,this._onDropdownOpenedChanged(t)};return c`
		...
		>`}getComparableValue(e,t){return ji(e,t)}}customElements.define("cosmoz-omnitable-column-autocomplete",Wi);const Ke=(i,e)=>e.find(({value:t})=>i===t),Ui=(i,e,t)=>{const a=Ke(e,t);return a?a.text:i},nt=(i,e,t,a)=>Ui(i,C(e,t),a),Ki=({valuePath:i},e,t)=>Ke(C(e,i),t),Ji=i=>e=>{i(t=>({...t,filter:e?.[0]?.value??null}))},Xi=i=>e=>{i(t=>({...t,headerFocused:e}))},Qi=i=>e=>{i(t=>({...t,query:e}))},Yi=i=>e=>i(e?.[0]?.value),ot=({valuePath:i,trueLabel:e,falseLabel:t},a)=>C(a,i)?e:t,Zi=({valuePath:i},e)=>t=>C(t,i)===e,le=xt((i,e)=>[{text:i,value:!0},{text:e,value:!1}]),ea=({valuePath:i,trueLabel:e,falseLabel:t},a)=>i?C(a,i)?e:t:"",ta=(i,e)=>{try{return JSON.parse(e)}catch{return null}};class ia extends V(I){static get properties(){return{trueLabel:{type:String,value:"True"},falseLabel:{type:String,value:"False"},flex:{type:String,value:"0"},cellClass:{type:String,value:"boolean-cell"}}}getString(e,t){return ot(e,t)}renderCell(e,{item:t}){return ot(e,t)}renderEditCell(e,{item:t},a){const{trueLabel:n,falseLabel:o}=e;return c`<cosmoz-autocomplete
			no-label-float
		...
		`}renderEditCell(){return"not implemented"}renderHeader(e,{filter:t,query:a},n,o){return c`<cosmoz-autocomplete-ui
			...
			.onText=${We(n)}
			>${_(e.loading,()=>c`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}}customElements.define("cosmoz-omnitable-column-list-horizontal",ua);window.Cosmoz=window.Cosmoz||{};class st extends Wt(Ut(Kt,I)){static get template(){return Le`
			<style>
				:host {
					display: block;
				}
...
>
	...
	>
		<span>${r}</span> ${qa}
	</button>`},It=({columns:i,...e})=>i?.map(t=>Et({column:t,...e})),Aa=()=>c`
...
`,Mt=i=>(e,t,a=Xt)=>{const n=ei(),o=new URLSearchParams(n.hash.replace("#",""));return i(e,t,a,o),"#!"+Object.assign(n,{hash:o}).href.replace(location.origin,"")},Ot=i=>i==null||i==="",ka=Mt((i,e,t,a)=>Ot(t(e))?a.delete(i):a.set(i,t(e))),_a=Mt((i,e,t,a)=>Object.entries(e).map(t).forEach(([n,o])=>Ot(o)?a.delete(i+n):a.set(i+n,o))),J=(i,e,{suffix:t="",read:a,write:n,multi:o}={})=>{const[r,l]=o?[_a,Qt]:[ka,Yt],[s,u]=T(()=>e==null?i:l(e+t,a)??i),d=$(m=>u(b=>{const p=$e(m,b);return e!=null&&Zt(r(e+t,p,n),null,{notify:!1}),p}),[e,t,r,n]);return[s,d]},Ea=i=>[!0,"true",1,"yes","on"].includes(i),ce=i=>i===""||(i==null?void 0:Ea(i)),me=(i,e,t)=>$(a=>{i(a),t(n=>({...n,[e]:a}))},[i,e,t]),Ia=(i,e,t,a,n)=>{const[o,r]=J(t.sortOn,e,{suffix:"-sortOn"}),[l,s]=J(ce(t.descending),e,{suffix:"-descending",read:ce}),[u,d]=J(t.groupOn,e,{suffix:"-groupOn"}),[m,b]=J(ce(t.groupOnDescending),e,{suffix:"-groupOnDescending",read:ce}),p=F(()=>i.find(g=>g.name===o),[i,o]),z=F(()=>i.find(g=>g.name===u),[i,u]),h={groupOn:u,setGroupOn:me(d,"groupOn",a),groupOnDescending:m,setGroupOnDescending:me(b,"groupOnDescending",a),sortOn:o,setSortOn:me(r,"sortOn",a),descending:l,setDescending:me(s,"descending",a),columns:i},y=F(()=>h,Object.values(h)),k=$(g=>{r(g.sortOn),d(g.groupOn),s(g.descending),b(g.groupOnDescending)},[]);return M(()=>void(n.current=k),[]),{...y,sortAndGroup:y,groupOnColumn:z,sortOnColumn:p}},Ye=vt();customElements.define("sort-and-group-provider",Ye.Provider);customElements.define("sort-and-group-consumer",L(({render:i})=>i(De(Ye)),{useShadowDOM:!1}));const Ma=({data:i,columns:e,groupOnColumn:t,filters:a,setFilterState:n,sortAndGroup:{sortOn:o,setSortOn:r,descending:l,setDescending:s}={}})=>yt(e,u=>u.name,u=>[c`<div
...
`;customElements.define("cosmoz-omnitable-item-expand-line",L(Da,{styleSheets:[Te(La)]}));const Ta=({columns:i,item:e,selected:t,expanded:a,groupOnColumn:n})=>ti(i,o=>c`<cosmoz-omnitable-item-expand-line
			...
			>`);customElements.define("cosmoz-omnitable-item-expand",L(Ta,{useShadowDOM:!1}));const Va=(i,e,t)=>i.editable?i.renderEditCell(i,e,t(i,e.item)):i.renderCell(i,e),Pa=({columns:i,groupOnColumn:e,item:t,index:a,selected:n,expanded:o,onItemChange:r})=>yt(i,l=>l.name,l=>c`<div
			...
			</div>`);customElements.define("cosmoz-omnitable-item-row",L(Pa,{useShadowDOM:!1}));const Lt=K`
	.checkbox {
		box-sizing: border-box;
		width: 18px;
		height: 18px;
