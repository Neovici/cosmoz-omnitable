import{f as Hn,B as cr,x as P,E as ct,T as j,m as Un,i as ur,p as dr,v as pt,s as zt,M as qe,b as Kn}from"./iframe-vyDU3_4F.js";import{_ as hr}from"./preload-helper-PPVm8Dsz.js";/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Kt=(e,t)=>{const s=e._$AN;if(s===void 0)return!1;for(const n of s)n._$AO?.(t,!1),Kt(n,t);return!0},xe=e=>{let t,s;do{if((t=e._$AM)===void 0)break;s=t._$AN,s.delete(e),e=t}while(s?.size===0)},_i=e=>{for(let t;t=e._$AM;e=t){let s=t._$AN;if(s===void 0)t._$AN=s=new Set;else if(s.has(e))break;s.add(e),aa(t)}};function ra(e){this._$AN!==void 0?(xe(this),this._$AM=e,_i(this)):this._$AM=e}function oa(e,t=!1,s=0){const n=this._$AH,i=this._$AN;if(i!==void 0&&i.size!==0)if(t)if(Array.isArray(n))for(let r=s;r<n.length;r++)Kt(n[r],!1),xe(n[r]);else n!=null&&(Kt(n,!1),xe(n));else Kt(this,e)}const aa=e=>{e.type==G.CHILD&&(e._$AP??=oa,e._$AQ??=ra)};class Re extends Ct{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,s,n){super._$AT(t,s,n),_i(this),this.isConnected=t._$AU}_$AO(t,s=!0){t!==this.isConnected&&(this.isConnected=t,t?this.reconnected?.():this.disconnected?.()),s&&(Kt(this,t),xe(this))}setValue(t){if(Hn(this._$Ct))this._$Ct._$AI(t,this);else{const s=[...this._$Ct._$AH];s[this._$Ci]=t,this._$Ct._$AI(s,this,0)}}disconnected(){}reconnected(){}}const{component:V,createContext:la}=ia({render:cr}),ca={duration:250},bi=e=>(t,s,n)=>{const i="max"+e.charAt(0).toUpperCase()+e.slice(1);Object.assign(t.style,{[i]:"",display:""});const{[e]:r}=t.getBoundingClientRect(),o=[0,r],[a,l]=s?o:o.slice().reverse(),c=t.animate([{[i]:`${a}px`},{[i]:`${l}px`}],{...ca,...n});c.onfinish=()=>Object.assign(t.style,{[i]:"",display:s?"":"none"})};function ua(e){return()=>e}const da=ua(),wi=da,At=e=>e;function Yu(e,...t){return typeof e=="function"?e(...t):e}const vi=la(()=>wi);customElements.define("cosmoz-keybinding-provider",vi.Provider);const Rt=e=>{const t=R(()=>({}),[]);return R(()=>Object.assign(t,e),[t,...Object.values(e)])},ha=(e,t)=>{const s=gi(vi),n=Rt(e);T(()=>s(n),t)},en=e=>e.matches(":focus-within"),xi=({disabled:e,onFocus:t})=>{const[s,n]=nt(),{focused:i,closed:r}=s||{},o=i&&!e,a=Rt({closed:r,onFocus:t}),l=$(u=>n(d=>({...d,closed:u})),[]),c=$(u=>{const d=u.currentTarget;return en(d)?n(h=>({focused:!0,closed:!h?.closed})):d.focus()},[]);return T(()=>{if(!o)return;const u=d=>{if(d.defaultPrevented)return;const{closed:h}=a;d.key==="Escape"&&!h?(d.preventDefault(),l(!0)):["ArrowUp","Up"].includes(d.key)&&h&&(d.preventDefault(),l(!1))};return document.addEventListener("keydown",u,!0),()=>document.removeEventListener("keydown",u,!0)},[o]),{focused:o,active:o&&!r,setClosed:l,onToggle:c,onFocus:$(u=>{const d=en(u.currentTarget);n({focused:d}),a.onFocus?.(d)},[a])}},sn=["focusin","focusout"],fa=e=>{const t=xi(e),{onFocus:s}=t;return T(()=>(e.setAttribute("tabindex","0"),sn.forEach(n=>e.addEventListener(n,s)),()=>{sn.forEach(n=>e.removeEventListener(n,s))}),[]),t},pa=X`
	:host {
		display: contents;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const Si="important",ya=" !"+Si,Ci=ot(class extends Ct{constructor(e){if(super(e),e.type!==G.ATTRIBUTE||e.name!=="style"||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,s)=>{const n=e[s];return n==null?t:t+`${s=s.includes("-")?s:s.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${n};`}),"")}update(e,[t]){const{style:s}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(const n of this.ft)t[n]==null&&(this.ft.delete(n),n.includes("-")?s.removeProperty(n):s[n]=null);for(const n in t){const i=t[n];if(i!=null){this.ft.add(n);const r=typeof i=="string"&&i.endsWith(ya);n.includes("-")||r?s.setProperty(n,r?i.slice(0,-11):i,r?Si:""):s[n]=i}}return j}});/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const _a={},Pi=ot(class extends Ct{constructor(){super(...arguments),this.ot=_a}render(e,t){return t()}update(e,[t,s]){if(Array.isArray(t)){if(Array.isArray(this.ot)&&this.ot.length===t.length&&t.every(((n,i)=>n===this.ot[i])))return j}else if(this.ot===t)return j;return this.ot=Array.isArray(t)?Array.from(t):t,this.render(t,s)}}),Ei=(e=HTMLElement)=>class extends e{connectedCallback(){super.connectedCallback?.(),this.dispatchEvent(new CustomEvent("connected"))}disconnectedCallback(){super.disconnectedCallback?.(),this.dispatchEvent(new CustomEvent("disconnected"))}},ba=X`
	:host {
		position: fixed;
		left: -9999999999px;
		min-width: 72px;
...
`,wa=()=>P`<div class="wrap" part="wrap"><slot></slot></div>`;customElements.define("cosmoz-dropdown-content",Ei(V(wa,{styleSheets:[ba]})));const Lt=Math.min,W=Math.max,Se=Math.round,oe=Math.floor,it=e=>({x:e,y:e}),va={left:"right",right:"left",bottom:"top",top:"bottom"},xa={start:"end",end:"start"};function nn(e,t,s){return W(e,Lt(t,s))}function ke(e,t){return typeof e=="function"?e(t):e}function bt(e){return e.split("-")[0]}function ze(e){return e.split("-")[1]}function Oi(e){return e==="x"?"y":"x"}function Ti(e){return e==="y"?"height":"width"}const Sa=new Set(["top","bottom"]);function ut(e){return Sa.has(bt(e))?"y":"x"}function Ai(e){return Oi(ut(e))}function Ca(e,t,s){s===void 0&&(s=!1);const n=ze(e),i=Ai(e),r=Ti(i);let o=i==="x"?n===(s?"end":"start")?"right":"left":n==="start"?"bottom":"top";return t.reference[r]>t.floating[r]&&(o=Ce(o)),[o,Ce(o)]}function Pa(e){const t=Ce(e);return[hs(e),t,hs(t)]}function hs(e){return e.replace(/start|end/g,t=>xa[t])}const rn=["left","right"],on=["right","left"],Ea=["top","bottom"],Oa=["bottom","top"];function Ta(e,t,s){switch(e){case"top":case"bottom":return s?t?on:rn:t?rn:on;case"left":case"right":return t?Ea:Oa;default:return[]}}function Aa(e,t,s,n){const i=ze(e);let r=Ta(bt(e),s==="start",n);return i&&(r=r.map(o=>o+"-"+i),t&&(r=r.concat(r.map(hs)))),r}function Ce(e){return e.replace(/left|right|bottom|top/g,t=>va[t])}function La(e){return{top:0,right:0,bottom:0,left:0,...e}}function $a(e){return typeof e!="number"?La(e):{top:e,right:e,bottom:e,left:e}}function Pe(e){const{x:t,y:s,width:n,height:i}=e;return{width:n,height:i,top:s,left:t,right:t+n,bottom:s+i,x:t,y:s}}function an(e,t,s){let{reference:n,floating:i}=e;const r=ut(t),o=Ai(t),a=Ti(o),l=bt(t),c=r==="y",u=n.x+n.width/2-i.width/2,d=n.y+n.height/2-i.height/2,h=n[a]/2-i[a]/2;let f;switch(l){case"top":f={x:u,y:n.y-i.height};break;case"bottom":f={x:u,y:n.y+n.height};break;case"right":f={x:n.x+n.width,y:d};break;case"left":f={x:n.x-i.width,y:d};break;default:f={x:n.x,y:n.y}}switch(ze(t)){case"start":f[o]-=h*(s&&c?-1:1);break;case"end":f[o]+=h*(s&&c?-1:1);break}return f}const Ra=async(e,t,s)=>{const{placement:n="bottom",strategy:i="absolute",middleware:r=[],platform:o}=s,a=r.filter(Boolean),l=await(o.isRTL==null?void 0:o.isRTL(t));let c=await o.getElementRects({reference:e,floating:t,strategy:i}),{x:u,y:d}=an(c,n,l),h=n,f={},p=0;for(let m=0;m<a.length;m++){const{name:g,fn:y}=a[m],{x:_,y:b,data:w,reset:v}=await y({x:u,y:d,initialPlacement:n,placement:h,strategy:i,middlewareData:f,rects:c,platform:o,elements:{reference:e,floating:t}});u=_??u,d=b??d,f={...f,[g]:{...f[g],...w}},v&&p<=50&&(p++,typeof v=="object"&&(v.placement&&(h=v.placement),v.rects&&(c=v.rects===!0?await o.getElementRects({reference:e,floating:t,strategy:i}):v.rects),{x:u,y:d}=an(c,h,l)),m=-1)}return{x:u,y:d,placement:h,strategy:i,middlewareData:f}};async function Ps(e,t){var s;t===void 0&&(t={});const{x:n,y:i,platform:r,rects:o,elements:a,strategy:l}=e,{boundary:c="clippingAncestors",rootBoundary:u="viewport",elementContext:d="floating",altBoundary:h=!1,padding:f=0}=ke(t,e),p=$a(f),g=a[h?d==="floating"?"reference":"floating":d],y=Pe(await r.getClippingRect({element:(s=await(r.isElement==null?void 0:r.isElement(g)))==null||s?g:g.contextElement||await(r.getDocumentElement==null?void 0:r.getDocumentElement(a.floating)),boundary:c,rootBoundary:u,strategy:l})),_=d==="floating"?{x:n,y:i,width:o.floating.width,height:o.floating.height}:o.reference,b=await(r.getOffsetParent==null?void 0:r.getOffsetParent(a.floating)),w=await(r.isElement==null?void 0:r.isElement(b))?await(r.getScale==null?void 0:r.getScale(b))||{x:1,y:1}:{x:1,y:1},v=Pe(r.convertOffsetParentRelativeRectToViewportRelativeRect?await r.convertOffsetParentRelativeRectToViewportRelativeRect({elements:a,rect:_,offsetParent:b,strategy:l}):_);return{top:(y.top-v.top+p.top)/w.y,bottom:(v.bottom-y.bottom+p.bottom)/w.y,left:(y.left-v.left+p.left)/w.x,right:(v.right-y.right+p.right)/w.x}}const ka=function(e){return e===void 0&&(e={}),{name:"flip",options:e,async fn(t){var s,n;const{placement:i,middlewareData:r,rects:o,initialPlacement:a,platform:l,elements:c}=t,{mainAxis:u=!0,crossAxis:d=!0,fallbackPlacements:h,fallbackStrategy:f="bestFit",fallbackAxisSideDirection:p="none",flipAlignment:m=!0,...g}=ke(e,t);if((s=r.arrow)!=null&&s.alignmentOffset)return{};const y=bt(i),_=ut(a),b=bt(a)===a,w=await(l.isRTL==null?void 0:l.isRTL(c.floating)),v=h||(b||!m?[Ce(a)]:Pa(a)),A=p!=="none";!h&&A&&v.push(...Aa(a,m,p,w));const S=[a,...v],N=await Ps(t,g),k=[];let F=((n=r.flip)==null?void 0:n.overflows)||[];if(u&&k.push(N[y]),d){const z=Ca(i,o,w);k.push(N[z[0]],N[z[1]])}if(F=[...F,{placement:i,overflows:k}],!k.every(z=>z<=0)){var I,tt;const z=(((I=r.flip)==null?void 0:I.index)||0)+1,D=S[z];if(D&&(!(d==="alignment"?_!==ut(D):!1)||F.every(O=>ut(O.placement)===_?O.overflows[0]>0:!0)))return{data:{index:z,overflows:F},reset:{placement:D}};let Y=(tt=F.filter(L=>L.overflows[0]<=0).sort((L,O)=>L.overflows[1]-O.overflows[1])[0])==null?void 0:tt.placement;if(!Y)switch(f){case"bestFit":{var H;const L=(H=F.filter(O=>{if(A){const M=ut(O.placement);return M===_||M==="y"}return!0}).map(O=>[O.placement,O.overflows.filter(M=>M>0).reduce((M,lt)=>M+lt,0)]).sort((O,M)=>O[1]-M[1])[0])==null?void 0:H[0];L&&(Y=L);break}case"initialPlacement":Y=a;break}if(i!==Y)return{reset:{placement:Y}}}return{}}}},za=function(e){return e===void 0&&(e={}),{name:"shift",options:e,async fn(t){const{x:s,y:n,placement:i}=t,{mainAxis:r=!0,crossAxis:o=!1,limiter:a={fn:g=>{let{x:y,y:_}=g;return{x:y,y:_}}},...l}=ke(e,t),c={x:s,y:n},u=await Ps(t,l),d=ut(bt(i)),h=Oi(d);let f=c[h],p=c[d];if(r){const g=h==="y"?"top":"left",y=h==="y"?"bottom":"right",_=f+u[g],b=f-u[y];f=nn(_,f,b)}if(o){const g=d==="y"?"top":"left",y=d==="y"?"bottom":"right",_=p+u[g],b=p-u[y];p=nn(_,p,b)}const m=a.fn({...t,[h]:f,[d]:p});return{...m,data:{x:m.x-s,y:m.y-n,enabled:{[h]:r,[d]:o}}}}}},Na=function(e){return e===void 0&&(e={}),{name:"size",options:e,async fn(t){var s,n;const{placement:i,rects:r,platform:o,elements:a}=t,{apply:l=()=>{},...c}=ke(e,t),u=await Ps(t,c),d=bt(i),h=ze(i),f=ut(i)==="y",{width:p,height:m}=r.floating;let g,y;d==="top"||d==="bottom"?(g=d,y=h===(await(o.isRTL==null?void 0:o.isRTL(a.floating))?"start":"end")?"left":"right"):(y=d,g=h==="end"?"top":"bottom");const _=m-u.top-u.bottom,b=p-u.left-u.right,w=Lt(m-u[g],_),v=Lt(p-u[y],b),A=!t.middlewareData.shift;let S=w,N=v;if((s=t.middlewareData.shift)!=null&&s.enabled.x&&(N=b),(n=t.middlewareData.shift)!=null&&n.enabled.y&&(S=_),A&&!h){const F=W(u.left,0),I=W(u.right,0),tt=W(u.top,0),H=W(u.bottom,0);f?N=p-2*(F!==0||I!==0?F+I:W(u.left,u.right)):S=m-2*(tt!==0||H!==0?tt+H:W(u.top,u.bottom))}await l({...t,availableWidth:N,availableHeight:S});const k=await o.getDimensions(a.floating);return p!==k.width||m!==k.height?{reset:{rects:!0}}:{}}}};function Ne(){return typeof window<"u"}function kt(e){return Li(e)?(e.nodeName||"").toLowerCase():"#document"}function q(e){var t;return(e==null||(t=e.ownerDocument)==null?void 0:t.defaultView)||window}function at(e){var t;return(t=(Li(e)?e.ownerDocument:e.document)||window.document)==null?void 0:t.documentElement}function Li(e){return Ne()?e instanceof Node||e instanceof q(e).Node:!1}function Q(e){return Ne()?e instanceof Element||e instanceof q(e).Element:!1}function rt(e){return Ne()?e instanceof HTMLElement||e instanceof q(e).HTMLElement:!1}function ln(e){return!Ne()||typeof ShadowRoot>"u"?!1:e instanceof ShadowRoot||e instanceof q(e).ShadowRoot}const Ma=new Set(["inline","contents"]);function te(e){const{overflow:t,overflowX:s,overflowY:n,display:i}=Z(e);return/auto|scroll|overlay|hidden|clip/.test(t+n+s)&&!Ma.has(i)}const Fa=new Set(["table","td","th"]);function Ia(e){return Fa.has(kt(e))}const Da=[":popover-open",":modal"];function Me(e){return Da.some(t=>{try{return e.matches(t)}catch{return!1}})}const Ba=["transform","translate","scale","rotate","perspective"],ja=["transform","translate","scale","rotate","perspective","filter"],Va=["paint","layout","strict","content"];function Es(e){const t=Os(),s=Q(e)?Z(e):e;return Ba.some(n=>s[n]?s[n]!=="none":!1)||(s.containerType?s.containerType!=="normal":!1)||!t&&(s.backdropFilter?s.backdropFilter!=="none":!1)||!t&&(s.filter?s.filter!=="none":!1)||ja.some(n=>(s.willChange||"").includes(n))||Va.some(n=>(s.contain||"").includes(n))}function Ha(e){let t=dt(e);for(;rt(t)&&!$t(t);){if(Es(t))return t;if(Me(t))return null;t=dt(t)}return null}function Os(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}const Ua=new Set(["html","body","#document"]);function $t(e){return Ua.has(kt(e))}function Z(e){return q(e).getComputedStyle(e)}function Fe(e){return Q(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function dt(e){if(kt(e)==="html")return e;const t=e.assignedSlot||e.parentNode||ln(e)&&e.host||at(e);return ln(t)?t.host:t}function $i(e){const t=dt(e);return $t(t)?e.ownerDocument?e.ownerDocument.body:e.body:rt(t)&&te(t)?t:$i(t)}function Xt(e,t,s){var n;t===void 0&&(t=[]),s===void 0&&(s=!0);const i=$i(e),r=i===((n=e.ownerDocument)==null?void 0:n.body),o=q(i);if(r){const a=fs(o);return t.concat(o,o.visualViewport||[],te(i)?i:[],a&&s?Xt(a):[])}return t.concat(i,Xt(i,[],s))}function fs(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function Ri(e){const t=Z(e);let s=parseFloat(t.width)||0,n=parseFloat(t.height)||0;const i=rt(e),r=i?e.offsetWidth:s,o=i?e.offsetHeight:n,a=Se(s)!==r||Se(n)!==o;return a&&(s=r,n=o),{width:s,height:n,$:a}}function Ts(e){return Q(e)?e:e.contextElement}function Tt(e){const t=Ts(e);if(!rt(t))return it(1);const s=t.getBoundingClientRect(),{width:n,height:i,$:r}=Ri(t);let o=(r?Se(s.width):s.width)/n,a=(r?Se(s.height):s.height)/i;return(!o||!Number.isFinite(o))&&(o=1),(!a||!Number.isFinite(a))&&(a=1),{x:o,y:a}}const Ka=it(0);function ki(e){const t=q(e);return!Os()||!t.visualViewport?Ka:{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}}function Wa(e,t,s){return t===void 0&&(t=!1),!s||t&&s!==q(e)?!1:t}function wt(e,t,s,n){t===void 0&&(t=!1),s===void 0&&(s=!1);const i=e.getBoundingClientRect(),r=Ts(e);let o=it(1);t&&(n?Q(n)&&(o=Tt(n)):o=Tt(e));const a=Wa(r,s,n)?ki(r):it(0);let l=(i.left+a.x)/o.x,c=(i.top+a.y)/o.y,u=i.width/o.x,d=i.height/o.y;if(r){const h=q(r),f=n&&Q(n)?q(n):n;let p=h,m=fs(p);for(;m&&n&&f!==p;){const g=Tt(m),y=m.getBoundingClientRect(),_=Z(m),b=y.left+(m.clientLeft+parseFloat(_.paddingLeft))*g.x,w=y.top+(m.clientTop+parseFloat(_.paddingTop))*g.y;l*=g.x,c*=g.y,u*=g.x,d*=g.y,l+=b,c+=w,p=q(m),m=fs(p)}}return Pe({width:u,height:d,x:l,y:c})}function Ie(e,t){const s=Fe(e).scrollLeft;return t?t.left+s:wt(at(e)).left+s}function zi(e,t){const s=e.getBoundingClientRect(),n=s.left+t.scrollLeft-Ie(e,s),i=s.top+t.scrollTop;return{x:n,y:i}}function qa(e){let{elements:t,rect:s,offsetParent:n,strategy:i}=e;const r=i==="fixed",o=at(n),a=t?Me(t.floating):!1;if(n===o||a&&r)return s;let l={scrollLeft:0,scrollTop:0},c=it(1);const u=it(0),d=rt(n);if((d||!d&&!r)&&((kt(n)!=="body"||te(o))&&(l=Fe(n)),rt(n))){const f=wt(n);c=Tt(n),u.x=f.x+n.clientLeft,u.y=f.y+n.clientTop}const h=o&&!d&&!r?zi(o,l):it(0);return{width:s.width*c.x,height:s.height*c.y,x:s.x*c.x-l.scrollLeft*c.x+u.x+h.x,y:s.y*c.y-l.scrollTop*c.y+u.y+h.y}}function Ya(e){return Array.from(e.getClientRects())}function Ja(e){const t=at(e),s=Fe(e),n=e.ownerDocument.body,i=W(t.scrollWidth,t.clientWidth,n.scrollWidth,n.clientWidth),r=W(t.scrollHeight,t.clientHeight,n.scrollHeight,n.clientHeight);let o=-s.scrollLeft+Ie(e);const a=-s.scrollTop;return Z(n).direction==="rtl"&&(o+=W(t.clientWidth,n.clientWidth)-i),{width:i,height:r,x:o,y:a}}const cn=25;function Ga(e,t){const s=q(e),n=at(e),i=s.visualViewport;let r=n.clientWidth,o=n.clientHeight,a=0,l=0;if(i){r=i.width,o=i.height;const u=Os();(!u||u&&t==="fixed")&&(a=i.offsetLeft,l=i.offsetTop)}const c=Ie(n);if(c<=0){const u=n.ownerDocument,d=u.body,h=getComputedStyle(d),f=u.compatMode==="CSS1Compat"&&parseFloat(h.marginLeft)+parseFloat(h.marginRight)||0,p=Math.abs(n.clientWidth-d.clientWidth-f);p<=cn&&(r-=p)}else c<=cn&&(r+=c);return{width:r,height:o,x:a,y:l}}const Xa=new Set(["absolute","fixed"]);function Qa(e,t){const s=wt(e,!0,t==="fixed"),n=s.top+e.clientTop,i=s.left+e.clientLeft,r=rt(e)?Tt(e):it(1),o=e.clientWidth*r.x,a=e.clientHeight*r.y,l=i*r.x,c=n*r.y;return{width:o,height:a,x:l,y:c}}function un(e,t,s){let n;if(t==="viewport")n=Ga(e,s);else if(t==="document")n=Ja(at(e));else if(Q(t))n=Qa(t,s);else{const i=ki(e);n={x:t.x-i.x,y:t.y-i.y,width:t.width,height:t.height}}return Pe(n)}function Ni(e,t){const s=dt(e);return s===t||!Q(s)||$t(s)?!1:Z(s).position==="fixed"||Ni(s,t)}function Za(e,t){const s=t.get(e);if(s)return s;let n=Xt(e,[],!1).filter(a=>Q(a)&&kt(a)!=="body"),i=null;const r=Z(e).position==="fixed";let o=r?dt(e):e;for(;Q(o)&&!$t(o);){const a=Z(o),l=Es(o);!l&&a.position==="fixed"&&(i=null),(r?!l&&!i:!l&&a.position==="static"&&!!i&&Xa.has(i.position)||te(o)&&!l&&Ni(e,o))?n=n.filter(u=>u!==o):i=a,o=dt(o)}return t.set(e,n),n}function tl(e){let{element:t,boundary:s,rootBoundary:n,strategy:i}=e;const o=[...s==="clippingAncestors"?Me(t)?[]:Za(t,this._c):[].concat(s),n],a=o[0],l=o.reduce((c,u)=>{const d=un(t,u,i);return c.top=W(d.top,c.top),c.right=Lt(d.right,c.right),c.bottom=Lt(d.bottom,c.bottom),c.left=W(d.left,c.left),c},un(t,a,i));return{width:l.right-l.left,height:l.bottom-l.top,x:l.left,y:l.top}}function el(e){const{width:t,height:s}=Ri(e);return{width:t,height:s}}function sl(e,t,s){const n=rt(t),i=at(t),r=s==="fixed",o=wt(e,!0,r,t);let a={scrollLeft:0,scrollTop:0};const l=it(0);function c(){l.x=Ie(i)}if(n||!n&&!r)if((kt(t)!=="body"||te(i))&&(a=Fe(t)),n){const f=wt(t,!0,r,t);l.x=f.x+t.clientLeft,l.y=f.y+t.clientTop}else i&&c();r&&!n&&i&&c();const u=i&&!n&&!r?zi(i,a):it(0),d=o.left+a.scrollLeft-l.x-u.x,h=o.top+a.scrollTop-l.y-u.y;return{x:d,y:h,width:o.width,height:o.height}}function Ze(e){return Z(e).position==="static"}function dn(e,t){if(!rt(e)||Z(e).position==="fixed")return null;if(t)return t(e);let s=e.offsetParent;return at(e)===s&&(s=s.ownerDocument.body),s}function Mi(e,t){const s=q(e);if(Me(e))return s;if(!rt(e)){let i=dt(e);for(;i&&!$t(i);){if(Q(i)&&!Ze(i))return i;i=dt(i)}return s}let n=dn(e,t);for(;n&&Ia(n)&&Ze(n);)n=dn(n,t);return n&&$t(n)&&Ze(n)&&!Es(n)?s:n||Ha(e)||s}const nl=async function(e){const t=this.getOffsetParent||Mi,s=this.getDimensions,n=await s(e.floating);return{reference:sl(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:n.width,height:n.height}}};function il(e){return Z(e).direction==="rtl"}const rl={convertOffsetParentRelativeRectToViewportRelativeRect:qa,getDocumentElement:at,getClippingRect:tl,getOffsetParent:Mi,getElementRects:nl,getClientRects:Ya,getDimensions:el,getScale:Tt,isElement:Q,isRTL:il};function Fi(e,t){return e.x===t.x&&e.y===t.y&&e.width===t.width&&e.height===t.height}function ol(e,t){let s=null,n;const i=at(e);function r(){var a;clearTimeout(n),(a=s)==null||a.disconnect(),s=null}function o(a,l){a===void 0&&(a=!1),l===void 0&&(l=1),r();const c=e.getBoundingClientRect(),{left:u,top:d,width:h,height:f}=c;if(a||t(),!h||!f)return;const p=oe(d),m=oe(i.clientWidth-(u+h)),g=oe(i.clientHeight-(d+f)),y=oe(u),b={rootMargin:-p+"px "+-m+"px "+-g+"px "+-y+"px",threshold:W(0,Lt(1,l))||1};let w=!0;function v(A){const S=A[0].intersectionRatio;if(S!==l){if(!w)return o();S?o(!1,S):n=setTimeout(()=>{o(!1,1e-7)},1e3)}S===1&&!Fi(c,e.getBoundingClientRect())&&o(),w=!1}try{s=new IntersectionObserver(v,{...b,root:i.ownerDocument})}catch{s=new IntersectionObserver(v,b)}s.observe(e)}return o(!0),r}function al(e,t,s,n){n===void 0&&(n={});const{ancestorScroll:i=!0,ancestorResize:r=!0,elementResize:o=typeof ResizeObserver=="function",layoutShift:a=typeof IntersectionObserver=="function",animationFrame:l=!1}=n,c=Ts(e),u=i||r?[...c?Xt(c):[],...Xt(t)]:[];u.forEach(y=>{i&&y.addEventListener("scroll",s,{passive:!0}),r&&y.addEventListener("resize",s)});const d=c&&a?ol(c,s):null;let h=-1,f=null;o&&(f=new ResizeObserver(y=>{let[_]=y;_&&_.target===c&&f&&(f.unobserve(t),cancelAnimationFrame(h),h=requestAnimationFrame(()=>{var b;(b=f)==null||b.observe(t)})),s()}),c&&!l&&f.observe(c),f.observe(t));let p,m=l?wt(e):null;l&&g();function g(){const y=wt(e);m&&!Fi(m,y)&&s(),m=y,p=requestAnimationFrame(g)}return s(),()=>{var y;u.forEach(_=>{i&&_.removeEventListener("scroll",s),r&&_.removeEventListener("resize",s)}),d?.(),(y=f)==null||y.disconnect(),f=null,l&&cancelAnimationFrame(p)}}const ll=za,cl=ka,ul=Na,dl=(e,t,s)=>{const n=new Map,i={platform:rl,...s},r={...i.platform,_c:n};return Ra(e,t,{...i,platform:r})},Ii=[cl({fallbackAxisSideDirection:"start",crossAxis:!1}),ll()],Di=({placement:e="bottom-start",strategy:t,middleware:s=Ii}={})=>{const[n,i]=nt(),[r,o]=nt(),[a,l]=nt();return T(()=>{if(!n||!(r instanceof HTMLElement)){l(void 0);return}return al(n,r,()=>dl(n,r,{placement:e,strategy:t,middleware:s}).then(l))},[n,r,e,t,s]),{setReference:i,setFloating:o,styles:R(()=>a?{left:`${a.x}px`,top:`${a.y}px`}:{},[a?.x,a?.y])}},hl=e=>e.preventDefault(),fl=X`
	.anchor {
		pointer-events: none;
...
`,pl=e=>{const{placement:t,strategy:s,middleware:n,render:i}=e,{active:r,onToggle:o}=fa(e),{styles:a,setReference:l,setFloating:c}=Di({placement:t,strategy:s,middleware:n});return P` <div class="anchor" part="anchor" ${_t(l)}>
			<button
				@mousedown=${hl}
				@click=${o}
				part="button"
 ...
 */const B=e=>e??ct,Bi=ft(class extends ht{values;constructor(e,t,s,n){super(e,t),Object.assign(t.host,s),this.values=n}update(e,t){this.hasChanged(t)&&(this.values=t,Object.assign(this.state.host,e))}hasChanged(e=[]){return e.some((t,s)=>this.values[s]!==t)}}),ee=ft(class extends ht{update(){return this.state.host}}),Ol=/([A-Z])/gu,Qt=(e,t,s)=>{e[t]=s,e.dispatchEvent(new CustomEvent(t.replace(Ol,"-$1").toLowerCase()+"-changed",{detail:{value:s}}))},Ju=(e,t,s=[t])=>{const n=ee();T(()=>{Qt(n,e,t)},s)},ji=e=>{const t=yi(void 0),s=$(c=>t.current=c,[]),n=e.shadowRoot,i=$(c=>e.dispatchEvent(new Event(c.type,{bubbles:c.bubbles})),[]),r=$(c=>Qt(e,"value",c.target.value),[]),o=$(c=>Qt(e,"focused",c.type==="focus"),[]),a=$(()=>t.current?.focus(),[]),l=$(()=>{const c=t.current?.checkValidity();return e.toggleAttribute("invalid",!c),c},[]);return Bi({focus:a,validate:l},[a,l]),T(()=>{const c=u=>{u.defaultPrevented||e.disabled||u.target.matches("input, textarea, label")||(u.preventDefault(),e.matches(":focus-within")||a())};return n.addEventListener("mousedown",c),()=>n.removeEventListener("mousedown",c)},[a]),{onChange:i,onFocus:o,onInput:r,onRef:s}},Tl=e=>R(()=>{if(e==null)return;const t=new RegExp(e,"u");return s=>{!s.defaultPrevented&&s.data&&!t.test(s.data)&&s.preventDefault()}},[e]),Vi=(e,{label:t,invalid:s,errorMessage:n})=>P`
	...
	`,Hi=["autocomplete","readonly","disabled","maxlength","invalid","no-label-float","always-float-label"],Al=({placeholder:e,noLabelFloat:t,label:s})=>(t?s:void 0)||e||" ",Ll=Math.abs,$l=(...e)=>e.some(t=>!!t),Rl=(...e)=>e.join(""),kl=(e,t,s)=>e?t:s,zl=(e,t)=>t.indexOf(e)>-1,Nl=(e,t)=>e===t,Ml=e=>!!(e==null||Array.isArray(e)&&e.length===0||typeof e=="string"&&e.length===0||typeof e=="number"&&e===0),Fl=(e,t)=>typeof e!="number"?"":e.toFixed(t),Gu=Object.freeze(Object.defineProperty({__proto__:null,abs:Ll,anyTrue:$l,concat:Rl,ifElse:kl,inArray:zl,isEmpty:Ml,isEqual:Nl,toFixed:Fl},Symbol.toStringTag,{value:"Module"})),Il={isoBasic:/^\d{4}-\d{2}-\d{2}$/iu},Dl=e=>typeof e=="string"&&Il.isoBasic.test(e)?new Date(`${e}T00:00`):new Date(e),Xu=e=>{if(e==null)return;if(e instanceof Date&&!isNaN(e.getTime()))return e;if(!(typeof e=="number"||typeof e=="string"))return;const t=Dl(e);if(!(t instanceof Date&&isNaN(t.getTime())))return t},Ft=e=>e<10?"0"+e:e,Qu=e=>e instanceof Date?e.getFullYear()+"-"+Ft(e.getMonth()+1)+"-"+Ft(e.getDate())+"T"+Ft(e.getHours())+":"+Ft(e.getMinutes())+":"+Ft(e.getSeconds())+"."+(e.getMilliseconds()/1e3).toFixed(3).slice(2,5):null,As=(e,...t)=>e.flatMap((s,n)=>[s,t[n]??""]).join(""),Ls=(...e)=>{const t=new CSSStyleSheet;return t.replaceSync(e.join("")),t},Zu=(e,t)=>{const s=class extends t{};return Object.assign(s.prototype,e),s},Ui=As`
	:host {
		--font-family: var(
...
`,Bl=["type","pattern","allowed-pattern","min","max","step","autosize","label","placeholder",...Hi],jl=e=>{const{type:t="text",pattern:s,allowedPattern:n,autocomplete:i,value:r,readonly:o,disabled:a,min:l,max:c,step:u,maxlength:d}=e,{onChange:h,onFocus:f,onInput:p,onRef:m}=ji(e),g=Tl(n);return Vi(P`
			<input
				${_t(m)}
				...
				step=${B(u)}
			/>
		`,e)};customElements.define("cosmoz-input",V(jl,{observedAttributes:Bl,styleSheets:[Cs(Ui)]}));const hn=e=>{e.style.height="",e.style.height=`${e.scrollHeight}px`},Vl=(e,t=0)=>{if(t>0){const s=e.getAttribute("rows")??"",n=e.style.height;e.style.height="",e.setAttribute("rows",t),e.style.maxHeight=e.getBoundingClientRect().height+"px",e.style.height=n,e.setAttribute("rows",s)}},Hl=e=>{const{value:t,maxRows:s}=e,n=R(()=>()=>e.shadowRoot.querySelector("#input"),[]);T(()=>Vl(n(),s),[s,n]),T(()=>hn(n()),[n,t]),T(()=>{const i=n(),r=new ResizeObserver(()=>requestAnimationFrame(()=>hn(i)));return r.observe(i),()=>r.unobserve(i)},[n])},Ul=["rows","placeholder",...Hi],Kl=e=>{const{autocomplete:t,value:s,placeholder:n,readonly:i,disabled:r,rows:o,cols:a,maxlength:l}=e,{onChange:c,onFocus:u,onInput:d,onRef:h}=ji(e);return Hl(e),Vi(P`
			<textarea id="input" part="input"
				...
				@change=${c} @focus=${u} @blur=${u}>`,e)};customElements.define("cosmoz-textarea",V(Kl,{observedAttributes:Ul,styleSheets:[Cs(Ui)]}));const Wl=e=>{const{label:t,value:s,disabled:n,error:i}=e,r=$(o=>e.dispatchEvent(new CustomEvent("change",{detail:o.target.checked})),[]);return P`<input
			id="toggle"
			class="toggle"
			part="toggle"
			type="checkbox"
		...
		<slot name="suffix"></slot>
		${J(i,o=>P`<div class="failure">${o}</div>`)} `},ql=X`
	.toggle {
		appearance: none;
		width: 35px;
		height: 18px;
 ...
 */const zc=e=>e,Nc=(e,t)=>P`${t}: ${JSON.stringify(e,null,2)}`;class Mc extends Re{constructor(t){if(super(t),this._virtualizer=null,this._first=0,this._last=-1,this._renderItem=(s,n)=>Nc(s,n+this._first),this._keyFunction=(s,n)=>zc(s,n+this._first),this._items=[],t.type!==G.CHILD)throw new Error("The virtualize directive can only be used in child expressions")}render(t){t&&this._setFunctions(t);const s=[];if(this._first>=0&&this._last>=this._first)for(let n=this._first;n<=this._last;n++)s.push(this._items[n]);return Oc(s,this._keyFunction,this._renderItem)}update(t,[s]){this._setFunctions(s);const n=this._items!==s.items;return this._items=s.items||[],this._virtualizer?this._updateVirtualizerConfig(t,s):this._initialize(t,s),n?j:this.render()}async _updateVirtualizerConfig(t,s){if(!await this._virtualizer.updateLayoutConfig(s.layout||{})){const i=t.parentNode;this._makeVirtualizer(i,s)}this._virtualizer.items=this._items}_setFunctions(t){const{renderItem:s,keyFunction:n}=t;s&&(this._renderItem=(i,r)=>s(i,r+this._first)),n&&(this._keyFunction=(i,r)=>n(i,r+this._first))}_makeVirtualizer(t,s){this._virtualizer&&this._virtualizer.disconnected();const{layout:n,scroller:i,items:r}=s;this._virtualizer=new Lc({hostElement:t,layout:n,scroller:i}),this._virtualizer.items=r,this._virtualizer.connected()}_initialize(t,s){const n=t.parentNode;n&&n.nodeType===1&&(n.addEventListener("rangeChanged",i=>{this._first=i.first,this._last=i.last,this.setValue(this.render())}),this._makeVirtualizer(n,s))}disconnected(){this._virtualizer?.disconnected()}reconnected(){this._virtualizer?.connected()}}const Fc=ot(Mc),Ic=(e,t)=>{if(!e||!t)return;const s=Object.keys(t);return Object.fromEntries(Object.keys(e).flatMap(n=>s.includes(n)?[]:[[n,void 0]]))};class Dc extends Ct{_props;render(t){return j}update(t,[s]){return this._props!==s&&Object.assign(t.element,Ic(this._props,s),this._props=s),j}}const Bc=ot(Dc),jc=e=>{const t=ee(),s=R(()=>new CSSStyleSheet,[]);T(()=>{t.shadowRoot.adoptedStyleSheets=[...t.shadowRoot.adoptedStyleSheets,s]},[]),T(()=>{s.replaceSync(e)},[e])};function qi(e){return e?t=>t?.[e]:At}const Vc=e=>{const t=qi(e);return s=>typeof s=="string"?s:t(s)?.toString()||""},Hc=e=>t=>{const s={};for(const n in t)e.includes(n)&&(s[n]=t[n]);return s},Uc="data:image/svg+xml,%3Csvg width='11' height='8' viewBox='0 0 11 8' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M9.5 1L5.20039 7.04766L1.66348 3.46152' stroke='white' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round'/%3E%3C/svg%3E",Kc=X`
	...
	:host([multi]) .item[aria-selected]::before {
		border-color: #5881f6;
		/* prettier-ignore */
		background: url("${Uc}") #5881f6 no-repeat 50%;
	}
	:host([multi]) .sizer {
		padding-left: 33px;
	}
...
`,Wc=({index:e,itemHeight:t,auto:s})=>X`
	${J(!s,()=>X`
			.item {
				line-height: ${t}px;
				height: ${t}px;
...
`,qc=e=>typeof e=="object"&&e!==null&&Symbol.iterator in e;function vt(e){return e==null?[]:Array.isArray(e)?e:typeof e=="string"?[e]:qc(e)?Array.from(e):[e]}const ss=(e,t=At)=>s=>{const n=vt(e).map(t);return vt(s).filter(i=>!n.includes(t(i)))},Yc=(e,t)=>t?s=>vt(e).find(n=>n[t]===s[t]):s=>vt(e).includes(s),Jc=(e,t)=>{if(!t||!e)return e;const s=e.toLowerCase().indexOf(t.toLowerCase());if(s<0)return e;const n=s+t.length;return[e.slice(0,s),P`<mark>${e.slice(s,n)}</mark>`,e.slice(n)]},Gc=e=>{const t=Rt(e);T(()=>{const s=n=>{if(!(n.ctrlKey&&n.altKey||n.defaultPrevented))switch(n.key){case"Up":case"ArrowUp":n.preventDefault(),t.onUp();break;case"Down":case"ArrowDown":n.preventDefault(),t.onDown();break;case"Enter":n.preventDefault(),t.onEnter();break}};return document.addEventListener("keydown",s,!0),()=>document.removeEventListener("keydown",s,!0)},[t])},Xc=({items:e,onSelect:t,defaultIndex:s=0})=>{const[n,i]=nt({index:s}),{index:r}=n,{length:o}=e;return T(()=>{i({index:n.index<0?s:Math.min(n.index,e.length-1),scroll:!0})},[e,s]),Gc({onUp:$(()=>i(a=>({index:a.index>0?a.index-1:o-1,scroll:!0})),[o]),onDown:$(()=>i(a=>({index:a.index<o-1?a.index+1:0,scroll:!0})),[o]),onEnter:$(()=>r>-1&&r<o&&t?.(e[r],r),[r,e,t])}),{position:n,highlight:$(a=>i({index:a}),[]),select:$(a=>t?.(a),[t])}},Qc=(e=At)=>(t,s,{highlight:n,select:i,textual:r=At,query:o,isSelected:a})=>{const l=r(t),c=Jc(l,o),u=e(c,t,s);return P`<div
				class="item"
				role="option"
				part="option"
				?aria-selected=${a(t)}
			...
			<div class="sizer" virtualizer-sizer>${u}</div>`},Zc=({itemRenderer:e=Qc(),...t})=>{const s=Rt(t);return $((n,i)=>e(n,i,s),[s,e])},tu=e=>{const t=e==="auto",[s,n]=nt(t?40:e);return[s,i=>t?n(i):void 0]},eu=["query","items","onSelect","textual","anchor","itemHeight","itemLimit","itemRenderer","defaultIndex","value","valueProperty","loading"],su=({value:e,valueProperty:t,items:s,onSelect:n,defaultIndex:i,query:r,textual:o,itemRenderer:a,itemHeight:l=40,itemLimit:c=5})=>{const u=R(()=>Yc(e,t),[e,t]),d=R(()=>s.slice(),[s,u]),{position:h,highlight:f,select:p}=Xc({items:d,onSelect:n,defaultIndex:isNaN(i)?void 0:Number(i)}),[m,g]=tu(l);return{position:h,items:d,height:Math.min(c,d.length)*m,highlight:f,select:p,itemHeight:m,setItemHeight:g,renderItem:Zc({itemRenderer:a,items:d,position:h,highlight:f,select:p,textual:o,query:r,isSelected:u})}},$n=wi,nu=e=>{const t=yi(void 0),{position:s,items:n,renderItem:i,height:r,itemHeight:o,setItemHeight:a}=su(e);return T(()=>{const l=t.current?.[_s];l&&l.layoutComplete.then(()=>{e.dispatchEvent(new CustomEvent("layout-complete"));const{averageChildSize:c,averageMarginSize:u}=l._layout._metricsCache;return a(c+u*2)},$n)},[n]),T(()=>{if(!s.scroll)return;const l=t.current?.[_s];if(l){if(!l?._layout){l.layoutComplete.then(()=>l.element(s.index)?.scrollIntoView({block:"nearest"}),$n);return}l.element(s.index)?.scrollIntoView({block:"nearest"})}},[s]),jc(Wc({...s,itemHeight:o,auto:e.itemHeight==="auto"})),P`<div
			class="items"
			style="min-height: ${r}px"
			${_t(l=>t.current=l)}
		>
			<div virtualizer-sizer></div>
			${Fc({items:n,renderItem:i,scroller:!0})}
		</div>
		<slot></slot>`};customElements.define("cosmoz-listbox",Ei(V(nu,{styleSheets:[Ls(Kc)]})));const iu=({multi:e,setFloating:t,styles:s,...n},i)=>P`<cosmoz-listbox
		style="${Ci(s)}"
...
`;customElements.define("cosmoz-autocomplete-chip",V(au,{observedAttributes:["disabled"],styleSheets:[Ls(ru)]}));const Rn=({content:e,onClear:t,disabled:s,hidden:n,className:i="chip",slot:r})=>P`<cosmoz-autocomplete-chip
		class=${B(i)}
		slot=${B(r)}
		part="chip"
	...
	>`,lu=({value:e,min:t=0,onDeselect:s,textual:n,disabled:i})=>[...e.filter(Boolean).map(r=>Rn({content:n(r),onClear:e.length>t&&(()=>s(r)),disabled:i,slot:"control"})),Rn({content:P`<span></span>`,className:"badge",disabled:!0,slot:"control",hidden:!0})],cu=As`
	:host {
		display: block;
		position: relative;
		min-width: 35px;
...
`,uu=({focused:e,empty:t,...s})=>{const n=e&&t&&s.limit!==1,i=Rt(s);T(()=>{if(!n)return;const r=o=>{if(o.defaultPrevented)return;const{key:a}=o,l=vt(i.value),c=i.limit==1;if(l.length>0&&(a==="Backspace"||c&&a.length===1))return i.onChange(l.slice(0,-1))};return document.addEventListener("keydown",r,!0),()=>document.removeEventListener("keydown",r,!0)},[n,i])},kn=e=>e.normalize("NFD").replace(/[\u0300-\u036f]/gu,""),du=(e,t,s)=>{if(!t)return e;const n=kn(t.toLowerCase()),i=[];for(const r of e){const a=kn(s(r).toLowerCase()).indexOf(n);a<0||i.push({item:r,index:a})}return i.sort((r,o)=>r.index-o.index).map(({item:r})=>r)},hu=e=>e===!1||e==null?[]:e,Yi=(e,t,s)=>e.dispatchEvent(new CustomEvent(t,{detail:s})),fu=(e,t,s)=>$(n=>{t?.(n),Yi(e,s,n)},[t]),pu=[],mu=e=>(...t)=>{let s;const n=()=>{s&&cancelAnimationFrame(s)};return n(),s=requestAnimationFrame(()=>{s=void 0,e(...t)}),n},$s=(e,t=()=>({}))=>{const s={type:e,toString(){return e}};return Object.assign((...i)=>Object.assign(t(...i),s),s)},zn=e=>e.type||e.toString(),Nn=e=>Array.isArray(e)?e:[e],gu=(e,t)=>{const s=Nn(t),n=(s.every(Array.isArray)?s:[s]).map(([i,r])=>({actions:Nn(i).map(zn),handle:r}));return(i=e,r)=>{const o=n.find(a=>a.actions.includes(zn(r)));return o?o.handle(i,r):i}},yt={pending:"pending",rejected:"rejected",resolved:"resolved"},Ji={error:void 0,result:void 0,state:yt.pending},Gi=$s(yt.pending),Xi=$s(yt.resolved,e=>({result:e})),Qi=$s(yt.rejected,e=>({error:e})),yu=gu(Ji,[[Gi,()=>({error:void 0,result:void 0,state:yt.pending})],[Xi,(e,{result:t})=>({error:void 0,result:t,state:yt.resolved})],[Qi,(e,{error:t})=>({error:t,result:void 0,state:yt.rejected})]]),_u=e=>{const[{error:t,result:s,state:n},i]=sa(yu,Ji);return T(()=>{if(!e)return;let r=!1;return i(Gi()),e.then(o=>!r&&i(Xi(o)),o=>!r&&i(Qi(o))),()=>{r=!0}},[e]),[s,t,n]},bu=({value:e,text:t,onChange:s,onText:n,onSelect:i,limit:r,min:o,source:a,textProperty:l,textual:c,valueProperty:u,keepOpened:d,keepQuery:h,preserveOrder:f,defaultIndex:p,externalSearch:m,...g})=>{const y=R(()=>(c??Vc)(l),[c,l]),{active:_,focused:b,onFocus:w,setClosed:v}=xi(g),A=!t,S=R(()=>t?.trim(),[t]),N=ee(),k=fu(N,n,"text"),F=$(L=>{s?.(L,()=>v(!0)),Yi(N,"value",L)},[s]),[I,tt]=nt([]),H=R(()=>Promise.resolve(typeof a=="function"?a({query:S,active:_}):a).then(hu),[a,_,S]),z=R(()=>vt(e),[e]);T(()=>H.then(tt),[H]),uu({focused:b,empty:A,limit:r,value:z,onChange:F,onText:k}),T(()=>{b||k("")},[b]);const D=Rt({onText:k,onChange:F,value:z,limit:r,min:o,keepQuery:h,keepOpened:d,setClosed:v,onSelect:i}),[,,Y]=_u(H);return{active:_,query:S,textual:y,value:z,source$:H,loading:Y==="pending",items:R(()=>{if(!_)return pu;const L=f?I:[...z,...ss(z,qi(u))(I)];return m?L:du(L,S,y)},[I,_,S,y,A,z,f,u,m]),onClick:$(()=>v(!1),[]),onFocus:w,onText:$(L=>{k(L.target.value),v(!1)},[k,t,v]),onSelect:$(L=>{D.onSelect?.(L,D);const{onChange:O,onText:M,limit:lt,min:se,value:rr,keepQuery:or,keepOpened:ar,setClosed:lr}=D;or||M(""),ar||lr(!0);const ne=vt(rr),Rs=ne.includes(L);Rs&&ne.length===se||O((Rs?ss(L)(ne):[...ne,L]).slice(-lt))},[D]),onDeselect:$(L=>D.onChange(ss(L)(D.value)),[D]),defaultIndex:S!==void 0&&S?.length>0?0:p}},wu=e=>{const t=e.shadowRoot.querySelectorAll(".chip"),s=e.shadowRoot.querySelector(".badge");s.hidden=!0;for(const a of t)a.hidden=!1;const i=e.shadowRoot.querySelector("cosmoz-input").shadowRoot?.querySelector(".control")?.getBoundingClientRect();let r;for(r=0;r<t.length;r++){const l=t[r].getBoundingClientRect();if(!(l.x+l.width<=i.x+i.width-24))break}const o=t.length-r;for(s.querySelector("span").textContent="+"+o.toString(),s.hidden=o<1;r<t.length;r++)t[r].hidden=!0},vu=({value:e,active:t,wrap:s,limit:n})=>{const i=ee(),r=!(s||n==1),o=R(()=>mu(()=>wu(i)),[]),[a,l]=nt(0);ds(()=>{if(!r)return;const c=i.shadowRoot.querySelector("cosmoz-input"),u=new ResizeObserver(d=>{l(d[0].contentRect.width)});return u.observe(c),()=>u.disconnect()},[r]),ds(()=>r?o():void 0,[r,a,t,e])},xu=["input","control","label","line","error","wrap"].map(e=>`${e}: input-${e}`).join(),Su=[ul({apply({rects:e,elements:t}){Object.assign(t.floating.style,{minWidth:`${Math.max(e.reference.width,e.floating.width)}px`})}}),...Ii],Cu=({active:e,loading:t,items:s,text:n,isSingle:i,showSingle:r})=>e?(t||s.length>0||n!=null&&n.length>0)&&!(i&&!r):!1,Pu=e=>{const{active:t,invalid:s,errorMessage:n,label:i,placeholder:r,disabled:o,noLabelFloat:a,alwaysFloatLabel:l,textual:c,text:u,onText:d,onFocus:h,onClick:f,onDeselect:p,value:m,limit:g,min:y,showSingle:_,items:b,source$:w,placement:v,loading:A}=e,S=ee(),N=g==1,k=N&&m?.[0]!=null,{styles:F,setReference:I,setFloating:tt}=Di({placement:v,middleware:Su});return T(()=>(S.addEventListener("focusin",h),S.addEventListener("focusout",h),()=>{S.removeEventListener("focusin",h),S.removeEventListener("focusout",h)}),[h]),Bi({focus:()=>S.shadowRoot?.querySelector("#input")?.focus()},[]),P`<cosmoz-input
				id="input"
				part="input"
				${_t(I)}
				.label=${i}
				...
				.errorMessage=${ys(w.then(()=>n,H=>H.message),n)}
				.value=${De(u)}
				@value-changed=${d}
				@click=${f}
				autocomplete="off"
			...
			>
				...
				${lu({value:m,min:y,onDeselect:p,textual:c,disabled:o})}
			</cosmoz-input>

			${J(Cu({active:t,loading:A,items:b,text:u,isSingle:k,showSingle:_}),()=>iu({...e,items:b,multi:!N,setFloating:tt,styles:F},J(A,()=>P`<cosmoz-autocomplete-skeleton-span></cosmoz-autocomplete-skeleton-span>`,()=>J(u!=null&&u.length>0&&b.length===0,()=>P`<slot name="no-result"></slot>`))))}`},Zi=e=>{const t={...e,...bu(e)};return vu(t),Pu(t)},tr=["disabled","invalid","no-label-float","always-float-label","text-property","value-property","limit","min","show-single","preserve-order","keep-opened","keep-query","default-index","external-search","item-height","item-limit","wrap"],Eu=e=>{const{onChange:t,onText:s,...n}=e;return Zi({...n,onChange:$((i,...r)=>{e.value=i,t?.(i,...r)},[t]),onText:$(i=>{e.text=i,s?.(i)},[s])})},er=[Ls(cu)];customElements.define("cosmoz-autocomplete-ui",V(Zi,{observedAttributes:tr,styleSheets:er}));customElements.define("cosmoz-autocomplete",V(Eu,{observedAttributes:tr,styleSheets:er}));const Ou=X`
	@keyframes rotating {
		100% {
...
`,Tu=()=>ct,Au=V(Tu,{styleSheets:[Ou]});customElements.define("cosmoz-spinner",Au);const sr=["T"," "],Mn=e=>{if(!e||typeof e!="string")return;let t;return sr.some(s=>e.match(s)?(t=e.split(s),!0):!1),t||[e]},Lu=(e,t)=>{const s=Mn(e),n=Mn(t);return{minDate:Array.isArray(s)?s.shift():null,minTime:Array.isArray(s)?s.shift():null,maxDate:Array.isArray(n)?n.shift():null,maxTime:Array.isArray(n)?n.shift():null}},Fn=(e,t)=>{if(!(!e&&!t))return!e&&t?`T${t}`:e&&!t?e:`${e}T${t}`},$u=e=>{if(e){for(const t of sr)if(e.match(t)){const s=e.split(t);return{date:s.shift(),time:s.shift()}}return{date:e}}},Ru=e=>{const{dateLabel:t,timeLabel:s,min:n,max:i,step:r="1",value:o}=e,{minDate:a,maxDate:l,minTime:c,maxTime:u}=R(()=>Lu(n,i),[n,i]),{date:d,time:h}=R(()=>$u(o)??{},[o]);return T(()=>{e.dispatchEvent(new CustomEvent("cosmoz-datetime-input-value-changed",{bubbles:!0,composed:!0}))},[o]),P`
		<style>
			:host {
				display: flex;
				flex-direction: row;
...
`,dd=({slot:e,title:t,className:s,width:n="24",height:i="24",styles:r}={})=>P`
  <svg
    slot=${B(e)}
    class=${`error-icon ${s??""}`}
    viewBox="0 0 24 24"
...
`,Vn=(e,t)=>{Object.assign(e.style,{display:t?"":"none"})};class Hu extends HTMLElement{static get observedAttributes(){return["opened"]}toggle=bi("height");constructor(){super();const t=new CSSStyleSheet;t.replaceSync(`
      :host { display: block; overflow: hidden; }
		`);const s=this.attachShadow({mode:"open"});s.appendChild(document.createElement("slot")),s.adoptedStyleSheets=[t]}connectedCallback(){Vn(this,this.getAttribute("opened")!=null)}attributeChangedCallback(t,s,n){switch(t){case"opened":{const i=n!=null;return this.isConnected?this.toggle(this,i):Vn(this,i)}}}}customElements.define("cosmoz-collapse",Hu);export{Ju as $,ad as A,$ as B,od as C,ms as D,nr as E,la as F,gi as G,R as H,Oc as I,Ls as J,fr as K,bs as L,_c as M,cd as N,Ml as O,Vo as P,X as Q,ud as R,dd as S,Gu as T,Rt as U,ul as V,Ii as W,Hc as X,yi as Y,wi as Z,Bi as _,ds as a,Fc as a0,Qt as a1,Pi as a2,Wu as b,V as c,id as d,nd as e,Cn as f,U as g,jo as h,Yu as i,ed as j,vt as k,Vc as l,td as m,J as n,Qu as o,qi as p,Xu as q,sd as r,Is as s,As as t,nt as u,Zu as v,T as w,B as x,At as y,ld as z};
