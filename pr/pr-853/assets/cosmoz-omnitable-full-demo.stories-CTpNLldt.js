import{b as d,D as Fe,A as bt,w as Bt}from"./iframe-DqxkEt4J.js";import{t as K,c as E,g as C,P as A,u as M,a as xt,m as yt,s as Ht,D as Gt,b as Wt,e as qt,i as ve,h as Ae,d as Xt,f as vt,r as Ut,j as Kt,k,l as Jt,n as $e,p as he,o as D,q as Yt,v as we,w as Qt,x as Zt,y as en,T as tn,z as T,A as fe,B as nn,C as on,E as w,F as rn,G as an,H as ln,I as $t,J as Ee,K as I,L as wt,M as Te,N as sn,O as zt,Q as un,R as Le,S as Ye,U as cn,V as Re,W as dn,X as mn,Y as Oe,Z as Me,_ as pn,$ as De,a0 as P,a1 as gn,a2 as Ce,a3 as hn}from"./cosmoz-collapse-DvpeYYCa.js";import"./preload-helper-PPVm8Dsz.js";const fn=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,Mn=n=>{const{label:e,value:t,slot:o}=n,r=d`<div
	...
	`};class Nn extends Ne(Z(A)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return d`
		...
		>`}getComparableValue(e,t){return eo(e,t)}}customElements.define("cosmoz-omnitable-column-autocomplete",to);const qe=(n,e)=>e.find(({value:t})=>n===t),no=(n,e,t)=>{const o=qe(e,t);return o?o.text:n},ot=(n,e,t,o)=>no(n,C(e,t),o),oo=({valuePath:n},e,t)=>qe(C(e,n),t),ro=n=>e=>{n(t=>({...t,filter:e?.[0]?.value??null}))},io=n=>e=>{n(t=>({...t,headerFocused:e}))},ao=n=>e=>{n(t=>({...t,query:e}))},lo=n=>e=>n(e?.[0]?.value),rt=({valuePath:n,trueLabel:e,falseLabel:t},o)=>C(o,n)?e:t,so=({valuePath:n},e)=>t=>C(t,n)===e,ne=yt((n,e)=>[{text:n,value:!0},{text:e,value:!1}]),uo=({valuePath:n,trueLabel:e,falseLabel:t},o)=>n?C(o,n)?e:t:"",co=(n,e)=>{try{return JSON.parse(e)}catch{return null}};class mo extends N(A){static get properties(){return{trueLabel:{type:String,value:"True"},falseLabel:{type:String,value:"False"},flex:{type:String,value:"0"},cellClass:{type:String,value:"boolean-cell"}}}getString(e,t){return rt(e,t)}renderCell(e,{item:t}){return rt(e,t)}renderEditCell(e,{item:t},o){const{trueLabel:r,falseLabel:i}=e;return d`<cosmoz-autocomplete
			no-label-float
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return Q(e,t)}}customElements.define("cosmoz-omnitable-column-date",xo);class yo extends We(N(A)){renderCell({valuePath:e,textProperty:t},{item:o}){const r=je(o,e,t).map(i=>d`<li>${i}</li>`);return d`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		`}renderEditCell(){return"not implemented"}renderHeader(e,{filter:t,query:o},r,i){return d`<cosmoz-autocomplete-ui
			...
			.onText=${Ge(r)}
			>${D(e.loading,()=>d`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}}customElements.define("cosmoz-omnitable-column-list-horizontal",yo);window.Cosmoz=window.Cosmoz||{};class lt extends Zt(en(tn,A)){static get template(){return Ae`
			<style>
				:host {
					display: block;
				}
		...
		`}static get is(){return"cosmoz-omnitable-column-list-data"}static get properties(){return{items:{type:Array},_expanded:{type:Boolean,value:!1},_othersCount:{type:Number,computed:"_computeOthersCount(items)"}}}static get observers(){return["_itemsLengthChanged(items.length)"]}_itemsLengthChanged(){requestAnimationFrame(()=>this.dispatchEvent(new CustomEvent("expand",{bubbles:!0})))}_firstItem(e){if(e!=null&&e.length>0)return e[0]}_hideExpand(e,t){return e!==void 0&&e.length!==null?e.length<=2||t:!0}_hideCollapse(e,t){return e!==void 0&&e.length!==null?e.length<=2||!t:!0}_otherItems(e,t){if(e!=null&&(e.length<=2||t))return e.slice(1)}_computeOthersCount(e){if(e!=null)return e.length-1}_toggleExpand(e){this._expanded=!this._expanded,e.stopPropagation(),e.preventDefault()}}customElements.define(lt.is,lt);class vo extends We(N(A)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:o}){return d`<cosmoz-omnitable-column-list-data
			.items=${je(o,e,t)}
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:o},r,i){return d`<cosmoz-autocomplete-ui
			...
			.onText=${Ge(r)}
			>${D(e.loading,()=>d`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}}customElements.define("cosmoz-omnitable-column-list",vo);class $o extends Ne(Z(A)){static get properties(){return{maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null},formatter:{type:Object,computed:"_computeFormatter(locale, minimumFractionDigits, maximumFractionDigits)"},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, formatter)"},headerFocused:{type:Boolean,value:!1}}}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return d`
			<style>
				cosmoz-input[type='number'] {
					background: var(--cosmoz-omnitable-amount-input-background, #ffffff);
					border-radius: 6px;
...
`,se=n=>{const e=parseInt(n,10);return isFinite(e)?e:void 0},sr=n=>{const{config:e}=n,{settings:t,setSettings:o,collapsed:r}=e,i=Re({collapsed:r,settings:t.columns,setSettings:w(a=>o(l=>({...l,columns:a})),[o])});return{...e,onDown:w(a=>{a.target.closest(".pull")&&(i.handle=a.currentTarget)},[i]),onDragStart:w(a=>{const{target:l}=a,s=se(l.dataset.index);if(!i.handle?.contains(l)||s==null)return a.preventDefault();i.handle=null,a.dataTransfer.effectAllowed="move",a.dataTransfer.setData("omnitable/sort-index",s),a.dataTransfer.setData("text/plain",s),setTimeout(()=>l.classList.add("drag"),0),l.addEventListener("dragend",u=>u.target.classList.remove("drag"),{once:!0})},[i]),onDragEnter:w(a=>{const l=a.currentTarget;l===a.target&&(a.preventDefault(),a.dataTransfer.dropEffect="move",l.classList.add("dragover"))},[]),onDragOver:w(a=>{a.preventDefault(),a.currentTarget.classList.add("dragover")},[]),onDragLeave:w(a=>{const l=a.currentTarget;l.contains(a.relatedTarget)||l.classList.remove("dragover")},[]),onDrop:w(a=>{const l=se(a.dataTransfer.getData("omnitable/sort-index")),s=se(a.currentTarget.dataset.index),{settings:u,setSettings:c}=i;a.currentTarget.classList.remove("dragover"),a.preventDefault();const m=u.slice();m.splice(s+(l>=s?0:-1),0,m.splice(l,1)[0]),c(m)},[i]),onToggle:w(a=>{const{settings:l,setSettings:s}=i,u=l.map(m=>({...m,disabled:m.disabled||i.collapsed?.some(h=>h.name===m.name)})),c=se(a.target.closest("[data-index]")?.dataset.index);u.splice(c,1,{...l[c],disabled:!a.target.checked,priority:a.target.checked?l.reduce((m,h)=>Math.max(m,h.priority),0)+1:l[c].priority}),s(u)},[i])}},ur=[dn({apply({availableHeight:n,elements:e}){Object.assign(e.floating.style,{maxHeight:`${Math.max(0,n)}px`})}}),...mn],cr=({onDragStart:n,onDragEnter:e,onDragOver:t,onDragLeave:o,onDrop:r,onDown:i,onToggle:a,collapsed:l,filters:s})=>(u,c)=>{const m=!!l?.find(p=>p.name===u.name),h=!u.disabled&&!m;return d` <div
			class="item"
			data-index=${c}
			@mousedown=${i}
			draggable="true"
...
`,jr=n=>n?"groupRow groupRow-folded":"groupRow",Pr=({item:n,index:e})=>t=>D((t?.length??0)>0,()=>d`
	...
	`,Hr=({onCheckboxChange:n,dataIsValid:e,groupOnColumn:t})=>(o,r,{selected:i,folded:a,toggleFold:l})=>d` <div
		...
		</div>`,Gr=({host:n,error:e,dataIsValid:t,processedItems:o,columns:r,collapsedColumns:i,miniColumns:a,sortAndGroupOptions:l,rowPartFn:s,...u})=>{const{loading:c=!1,displayEmptyGroups:m=!1,compareItemsFn:h}=n,p=Me({shiftKey:!1,ctrlKey:!1}),v=w(g=>{const _=g.target,f=_.dataItem,y=_.checked,x=n.shadowRoot.querySelector("#groupedList");p.current.shiftKey?x.toggleSelectTo(f,y):p.current.ctrlKey?(_.checked=!0,x.selectOnly(f)):x.toggleSelect(f,y),g.preventDefault(),g.stopPropagation()},[]);T(()=>{const g=({shiftKey:_,ctrlKey:f})=>{p.current={shiftKey:_,ctrlKey:f}};return window.addEventListener("keydown",g),window.addEventListener("keyup",g),()=>{window.removeEventListener("keydown",g),window.removeEventListener("keyup",g)}},[]);const b=w(g=>{const _=g.currentTarget,f=g.composedPath();f.slice(0,f.indexOf(_)).find(x=>x.matches?.("a, .checkbox, .expand"))||n.dispatchEvent(new window.CustomEvent("omnitable-item-click",{bubbles:!0,composed:!0,detail:{item:_.dataItem,index:_.dataIndex}}))},[]),{groupOnColumn:$}=l,F=w((g,_)=>f=>Tn(n,g,_,f),[]);return{...u,processedItems:o,dataIsValid:t,filterIsTooStrict:t&&o.length<1,loading:c,compareItemsFn:h,displayEmptyGroups:m,error:e,renderItem:I(()=>Br({columns:r,collapsedColumns:i,miniColumns:a,onItemClick:b,onCheckboxChange:v,dataIsValid:t,groupOnColumn:$,onItemChange:F,rowPartFn:s}),[r,i,b,v,t,$,F,s]),renderGroup:I(()=>Hr({onCheckboxChange:v,dataIsValid:t,groupOnColumn:$}),[v,t,$])}},Wr=(n,e)=>{if(n===e)return 0;if(n==null)return-1;if(e==null)return 1;const t=typeof n,o=typeof e;return t==="object"&&o==="object"?n.toString()<e.toString()?-1:1:t==="number"&&o==="number"?n-e:t==="string"&&o==="string"?n<e?-1:1:t==="boolean"&&o==="boolean"?n?-1:1:(console.warn("unsupported sort",t,n,o,e),0)},ke=(n,e)=>(t,o)=>Wr(n(t),n(o))*(e?-1:1),qr=n=>n.replace(/([a-z0-9])([A-Z])/gu,"$1-$2").toLowerCase(),ht=(n,e)=>{!n||!e||Object.entries(e).forEach(([t,o])=>{n[B].__ownChange=!0,n[B][t]=o,n[B].__ownChange=!1,n[B].dispatchEvent(new CustomEvent(`${qr(t)}-changed`,{bubbles:!0,detail:{value:o}}))})},Ie=(n,e)=>Object.assign(n,{[xe]:e}),ce=Symbol("unparsed"),Xr=({data:n,columns:e,hashParam:t,sortAndGroupOptions:o,noLocalSort:r,noLocalFilter:i})=>{const{groupOnColumn:a,groupOnDescending:l,sortOnColumn:s,descending:u}=o,c=w(([f,y])=>{const x=e.find(({name:z})=>z===f);return x==null?[f,void 0]:[f,y.filter&&x.serializeFilter(x,y.filter)]},[e]),m=w(([f,y])=>{const x=e.find(({name:S})=>S===f);if(x==null)return[f,{[ce]:y}];const z={filter:x.deserializeFilter(x,y)};return ht(x,z),[f,z]},[e]),[h,p]=J({},t,{multi:!0,suffix:"-filter--",write:c,read:m}),v=w((f,y)=>p(x=>{const z=ve(y,x[f]);return ht(e.find(S=>S.name===f),z),{...x,[f]:{...x[f],...z}}}),[e,p]),b=I(()=>Object.values(h).map(f=>f.filter),[h]),$=I(()=>Object.fromEntries(e.map(f=>[f.name,!f.noLocalFilter&&f.getFilterFn(f,h[f.name]?.filter)]).filter(([,f])=>!!f)),[e,...b]),F=I(()=>!Array.isArray(n)||n.length===0?[]:Object.entries($).length===0||i?n.slice():n.filter(f=>Object.values($).every(y=>y(f))),[n,$,i]),g=I(()=>{if(!r&&!a&&s!=null&&s.sortPath!=null)return F.slice().sort(ke(f=>s.getComparableValue({...s,valuePath:s.sortPath},f),u));if(a!=null&&a.groupOn!=null){const f=F.reduce((y,x)=>{const z=a.getComparableValue({...a,valuePath:a.groupOn},x);if(z===void 0)return y;let S=y.find(R=>R.id===z);return S?(S.items.push(x),y):(S={id:z,name:z,items:[x]},[...y,S])},[]);return f.sort(ke(y=>a.getComparableValue({...a,valuePath:a.groupOn},y.items[0]),l)),!s||r?f:f.filter(y=>Array.isArray(y.items)).map(y=>(y.items.sort(ke(x=>s.getComparableValue({...s,valuePath:s.sortPath},x),u)),y))}return F},[F,a,l,s,u,r]),_=I(()=>{let f=0,y=0;const x=[];return g.forEach(z=>{if(Array.isArray(z.items)){Ie(z,y++),z.items.forEach(S=>{Ie(S,f++),x.push(S)});return}return Ie(z,f++),x.push(z)},[]),x},[g]);return T(()=>{p(f=>Object.values(f).some(x=>x[ce]!=null)?Object.fromEntries(Object.entries(f).map(([x,z])=>z[ce]==null?[x,z]:m([x,z[ce]]))):f)},[m]),{processedItems:g,visibleData:_,filters:h,filterFunctions:$,setFilterState:v}},Ur=n=>{const e=o=>{const r=n.data.indexOf(o);if(r<0)return null;const i=n.data.splice(r,1);if(n.data=n.data.slice(),Array.isArray(i)&&i.length>0)return i[0]},t=(o,r)=>{n.data.splice(o,1,r),n.data=n.data.slice()};return{removeItem:e,removeItems(o){const r=[];for(let i=o.length-1;i>=0;i-=1){const a=n.removeItem(o[i]);a!=null&&r.push(a)}return r},replaceItemAtIndex:t,replaceItem(o,r){const i=n.data.indexOf(o);if(i>-1)return t(i,r)},selectItem(o){n.shadowRoot.querySelector("#groupedList").select(o)},selectAll(){n.shadowRoot.querySelector("#groupedList").selectAll()},deselectAll(){n.shadowRoot.querySelector("#groupedList").deselectAll()},deselectItem(o){n.shadowRoot.querySelector("#groupedList").deselect(o)},isItemSelected(o){return n.shadowRoot.querySelector("#groupedList").isItemSelected(o)}}},Kr=({host:n,visibleData:e,filters:t,...o})=>{const{setFilterState:r}=o,i=I(()=>Ur(n),[]);De(o,Object.values(o)),De(i,Object.values(i)),T(()=>{const l=s=>r(s.detail.name,u=>({...u,...s.detail.state}));return n.addEventListener("legacy-filter-changed",l),()=>n.removeEventListener("legacy-filter-changed",l)},[]),P("visibleData",e),P("sortedFilteredGroupedItems",o.sortedFilteredGroupedItems),P("selectedItems",o.selectedItems),P("sortOn",o.sortOn),P("descending",o.descending),P("isMini",o.isMini);const a=I(()=>Object.fromEntries(Object.entries(t).filter(([,{filter:l}])=>l!==void 0).map(([l,{filter:s}])=>[l,s])),[t]);P("filters",a,Object.values(a))},Jr=n=>{const{hashParam:e,settingsId:t,data:o,resizeSpeedFactor:r,noLocal:i,noLocalSort:a=i,noLocalFilter:l=i,error:s,rowPartFn:u}=n,c=vr({settingsId:t,host:n}),{settings:m,setSettings:h,columns:p,resetRef:v}=c,b=Bo(p,e,m,h,v),{processedItems:$,visibleData:F,filters:g,setFilterState:_,filterFunctions:f}=Xr({data:o,columns:p,hashParam:e,sortAndGroupOptions:b,noLocalSort:a,noLocalFilter:l}),{isMini:y,collapsedColumns:x,miniColumns:z}=Rr({host:n,columns:p,settings:m,setSettings:h,resizeSpeedFactor:r,sortAndGroupOptions:b}),S=o&&Array.isArray(o)&&o.length>0,[R,G]=M([]);return Kr({host:n,visibleData:F,sortedFilteredGroupedItems:$,columns:p,filters:g,setFilterState:_,selectedItems:R,isMini:y,...b}),{header:Nr({host:n,selectedItems:R,sortAndGroupOptions:b,dataIsValid:S,data:o,columns:p,filters:g,collapsedColumns:x,settings:m,filterFunctions:f,settingS:c,setFilterState:_,hideSelectAll:n.hideSelectAll===!0}),list:Gr({host:n,error:s,dataIsValid:S,processedItems:$,setSelectedItems:G,columns:p,collapsedColumns:x,miniColumns:z,sortAndGroupOptions:b,rowPartFn:u}),footer:Mr({host:n,selectedItems:R,columns:p})}};customElements.define("cosmoz-grouped-list-row",class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||Fe(this._renderFn(this._item,this._index),this)}});const Yr={group:Symbol("group")},ze=(n,e)=>(e.has(n)||e.set(n,{}),e.get(n)),Qr=(n,e)=>!!ze(n,e).expanded,Zr=(n,e)=>!!ze(n,e).folded,Ve=n=>n?n.items instanceof Array:!1,ei=n=>{if(!Array.isArray(n)||n.length===0)return;const e=Array.isArray(n[0]?.items);if(!n.every(o=>Array.isArray(o.items)===e))throw new Error("Data must be homogeneous.")},ti=(n,e,t)=>Array.isArray(n)?(ei(n),n.reduce((r,i)=>{const a=i;if(!a.items)return r.concat(i);if(a.items.length){if(ze(i,t).folded)return r.concat(i);const l=a.items.map(s=>Object.assign(s,{[Yr.group]:i}));return r.concat(i,l)}return e?r.concat(i):r},[])):void 0,ni=(n,...e)=>typeof n=="function"?n(...e):n,oi=(n,e)=>n===e,ri=()=>{const[n,e]=M(()=>[new WeakMap]);return{setItemState:w((o,r)=>e(([i])=>{const a=ze(o,i);return Object.assign(a,ni(r,a)),[i]}),[]),state:n[0],signal:n}},ii=()=>{const{setItemState:n,state:e,signal:t}=ri(),o=w((i,a)=>{Ve(i)&&n(i,l=>({folded:a!==void 0?a:!l.folded}))},[]),r=w((i,a)=>{Ve(i)||n(i,l=>({expanded:a!==void 0?!a:!l.expanded}))},[]);return{state:e,signal:t,toggleFold:o,toggleCollapse:r}},ai=({initial:n,compareItemsFn:e,data:t,flatData:o})=>{const[r,i]=M(n),[a,l]=M(),s=w(g=>r.includes(g),[r]),u=w(g=>g?.items?.every(s)??!1,[s]),c=w(g=>s(g)||u(g),[s,u]),m=w(g=>{const f=g.items??[g];i(y=>[...y,...f.filter(x=>!y.includes(x))]),l(g)},[]),h=w(g=>{const f=g.items??[g];i(y=>y.filter(x=>!f.includes(x))),l(g)},[]),p=w(g=>{i(g.items?.slice()||[g]),l(g)},[]),v=w(()=>{i(t.flatMap(g=>g.items||g)),l(void 0)},[t]),b=w(()=>{i([]),l(void 0)},[]),$=w((g,_=!c(g))=>_?m(g):h(g),[c]),F=w((g,_)=>{if(!o)return;const f=a?o.findIndex(z=>e(z,a)):-1;if(f<0)return $(g,_);const[y,x]=[f,o.indexOf(g)].sort((z,S)=>z-S);o.slice(y,x+1).forEach((z,S,R)=>{S>0&&S<R.length-1&&Ve(z)||$(z,_)}),l(g)},[o,e,$]);return T(()=>i(g=>g.length>0&&o?o.filter(_=>g.find(f=>e(_,f))):g),[o]),{selectedItems:r,isItemSelected:s,isGroupSelected:u,isSelected:c,select:m,deselect:h,selectOnly:p,selectAll:v,deselectAll:b,toggleSelect:$,toggleSelectTo:F}},li={host:{position:"relative",display:"flex",flexDirection:"column"}},si=n=>{const{data:e,renderItem:t,renderGroup:o,displayEmptyGroups:r,compareItemsFn:i=oi}=n,{toggleFold:a,toggleCollapse:l,state:s,signal:u}=ii(),c=I(()=>ti(e,r,s),[e,r,u]),{selectedItems:m,isItemSelected:h,isGroupSelected:p,isSelected:v,select:b,deselect:$,selectOnly:F,selectAll:g,deselectAll:_,toggleSelect:f,toggleSelectTo:y}=ai({initial:[],compareItemsFn:i,data:e,flatData:c}),x=w((S,R)=>Array.isArray(S.items)?o(S,R,{selected:p(S),folded:Zr(S,s),toggleSelect:G=>f(S,typeof G=="boolean"?G:void 0),toggleFold:()=>a(S)}):t(S,R,{selected:m.includes(S),expanded:Qr(S,s),toggleSelect:G=>f(S,typeof G=="boolean"?G:void 0),toggleCollapse:()=>l(S)}),[t,o,m,f,u]);xt(()=>{Object.assign(n.style,li.host)},[]),P("selectedItems",m);const z={toggleFold:a,toggleCollapse:l,isItemSelected:h,isGroupSelected:p,isSelected:v,select:b,deselect:$,selectOnly:F,selectAll:g,deselectAll:_,toggleSelect:f,toggleSelectTo:y};return De(z,Object.values(z)),{renderRow:x,flatData:c}},ui=({renderRow:n,flatData:e})=>gn({items:e,renderItem:(t,o)=>d`<cosmoz-grouped-list-row
				.item=${t}
				.index=${o}
				.renderFn=${n}
	...
	`};customElements.define("cosmoz-omnitable",class extends E(mi,{observedAttributes:["hash-param","sort-on","group-on","descending","group-on-descending","hide-select-all","settings-id","no-local","no-local-sort","no-local-filter","loading","mini-breakpoint"]}){connectedCallback(){super.connectedCallback(),Ce(this,"selectedItems",[]),Ce(this,"visibleData",[]),Ce(this,"sortedFilteredGroupedItems",[])}});const ye=`
	<slot name="actions" slot="actions"></slot>
`;d(Object.assign([ye],{raw:[ye]}));Ae(Object.assign([ye],{raw:[ye]}));const pi=()=>d`<style>
	@keyframes rotating {
		100% {
...
}`,...pe.parameters?.docs?.source}}};const $i=["TableWithLargeData","TableWithSmallData","TableWithNoData"];export{de as TableWithLargeData,pe as TableWithNoData,me as TableWithSmallData,$i as __namedExportsOrder,vi as default};
