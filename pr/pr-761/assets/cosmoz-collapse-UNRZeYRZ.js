import{f as Hn,B as cr,x as P,E as ct,T as j,m as Un,i as ur,p as dr,v as pt,s as zt,M as qe,b as Kn}from"./iframe-BBnTJQCR.js";import{_ as hr}from"./preload-helper-PPVm8Dsz.js";/**
 * @license
...
`,Vn=(e,t)=>{Object.assign(e.style,{display:t?"":"none"})};class Uu extends HTMLElement{static get observedAttributes(){return["opened"]}toggle=bi("height");constructor(){super();const t=new CSSStyleSheet;t.replaceSync(`
      :host { display: block; overflow: hidden; }
		`);const s=this.attachShadow({mode:"open"});s.appendChild(document.createElement("slot")),s.adoptedStyleSheets=[t]}connectedCallback(){Vn(this,this.getAttribute("opened")!=null)}attributeChangedCallback(t,s,n){switch(t){case"opened":{const i=n!=null;return this.isConnected?this.toggle(this,i):Vn(this,i)}}}}customElements.define("cosmoz-collapse",Uu);export{kc as $,cd as A,$ as B,ld as C,ms as D,nr as E,ca as F,gi as G,R as H,Sc as I,Ls as J,fr as K,bs as L,Fl as M,dd as N,X as O,Vo as P,hd as Q,fd as R,Rt as S,Xu as T,dl as U,Ii as V,Dc as W,yi as X,wi as Y,Bi as Z,Gu as _,ds as a,Qt as a0,Pi as a1,qu as b,V as c,rd as d,id as e,nd as f,U as g,jo as h,Ju as i,sd as j,vt as k,Ic as l,ed as m,J as n,Zu as o,qi as p,Qu as q,ad as r,Is as s,As as t,nt as u,td as v,T as w,B as x,At as y,ud as z};
