import{x as c,B as ke,E as ht}from"./iframe-CvYN_v80.js";import{t as K,c as O,g as C,P as E,u as T,a as xt,m as yt,s as Nt,D as Rt,b as Bt,e as Gt,i as $e,h as Oe,d as Ht,f as vt,r as jt,j as Wt,k as A,l as Ut,n as we,p as he,o as k,q as Kt,v as Ce,w as Jt,x as Xt,y as Qt,T as Yt,z as M,A as Zt,B as ei,C as ti,E as ii,F as $,G as ai,H as ni,I as $t,J as Le,K as F,L as wt,M as De,N as oi,O as Ct,Q as ri,R as Te,S as Ye,U as li,V as Ve,W as si,X as ui,Y as Ie,Z as Pe,_ as di,$ as Ee,a0 as N,a1 as ci,a2 as ze,a3 as mi}from"./cosmoz-collapse-BzvSZWsF.js";import"./preload-helper-PPVm8Dsz.js";const pi=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,Li=i=>{const{label:e,value:t,slot:a}=i,n=c`<div
		id="input"
		part="input"
		role="button"
		class="control"
	...
	>
		${t||""}
	</div>`;return jt(n,{label:e})};customElements.define("cosmoz-omnitable-dropdown-input",O(Li,{observedAttributes:Mi,styleSheets:[Oi]}));const ne=({title:i,tooltip:e="",filterText:t="",onOpenedChanged:a,content:n,horizontalAlign:o="left",externalValues:r=null})=>{const l={filtered:!!t,...r!=null&&{[`external-values-${r}`]:!0}};return c`
		<style>
			.dropdown {
				outline: none;
			}
	...
	`};class Di extends Ne(ae(E)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return c`
			<style>
				paper-dropdown-menu {
					--iron-icon-width: 0;
					display: block;
		...
		</cosmoz-input>`}renderHeader({title:e,min:t,max:a,limits:n,locale:o,rates:r,currency:l,autoupdate:s,autodetect:u},{filter:d},m,f){return c`<cosmoz-omnitable-amount-range-input
			.title=${e}
			.filter=${d}
			.values=${f}
			.rates=${r}
		...
		>`}getComparableValue(e,t){return Qi(e,t)}}customElements.define("cosmoz-omnitable-column-autocomplete",Yi);const Ue=(i,e)=>e.find(({value:t})=>i===t),Zi=(i,e,t)=>{const a=Ue(e,t);return a?a.text:i},nt=(i,e,t,a)=>Zi(i,C(e,t),a),ea=({valuePath:i},e,t)=>Ue(C(e,i),t),ta=i=>e=>{i(t=>({...t,filter:e?.[0]?.value??null}))},ia=i=>e=>{i(t=>({...t,headerFocused:e}))},aa=i=>e=>{i(t=>({...t,query:e}))},na=i=>e=>i(e?.[0]?.value),ot=({valuePath:i,trueLabel:e,falseLabel:t},a)=>C(a,i)?e:t,oa=({valuePath:i},e)=>t=>C(t,i)===e,le=yt((i,e)=>[{text:i,value:!0},{text:e,value:!1}]),ra=({valuePath:i,trueLabel:e,falseLabel:t},a)=>i?C(a,i)?e:t:"",la=(i,e)=>{try{return JSON.parse(e)}catch{return null}};class sa extends V(E){static get properties(){return{trueLabel:{type:String,value:"True"},falseLabel:{type:String,value:"False"},flex:{type:String,value:"0"},cellClass:{type:String,value:"boolean-cell"}}}getString(e,t){return ot(e,t)}renderCell(e,{item:t}){return ot(e,t)}renderEditCell(e,{item:t},a){const{trueLabel:n,falseLabel:o}=e;return c`<cosmoz-autocomplete
			no-label-float
		...
		>`}computeSource({trueLabel:e,falseLabel:t}){return le(e,t)}getFilterFn(e,t){if(t!=null)return oa(e,t)}toXlsxValue(e,t){return ra(e,t)}deserializeFilter(e,t){return la(e,t)}}customElements.define("cosmoz-omnitable-column-boolean",sa);const Ke=i=>class extends Ne(i){static get properties(){return{max:{type:Date,value:null},min:{type:Date,value:null},_filterText:{type:String,computed:"_computeFilterText(filter.*, formatter)"},formatter:{type:Object,computed:"_computeFormatter(locale)"}}}toDate(e,t,a){if(e==null||e==="")return;let n=e;if(n instanceof Date||(typeof e=="string"&&(n=this.getAbsoluteISOString(n)),n=new Date(n)),Number.isNaN(n.getTime()))return null;if(a==null||t==null)return n;const o=this.toDate(t);if(o==null)return n;const r=this.getComparableValue(n),l=this.getComparableValue(o);return a(r,l)===r?n:o}toValue(){return this.toDate.apply(this,arguments)}getComparableValue(e,t){const a=super.getComparableValue(e,t);if(a!=null)return this.toNumber(a.getTime())}getString(e,t=this.valuePath,a=this.formatter){const n=this.toValue(this.get(t,e));return n===void 0?"":n===null?"Invalid Date":this.renderValue(n,a)}getAbsoluteISOString(e){return e.length===19?e+this._getTimezoneString(e):e}_getTimezoneString(e){const t=-new Date(e).getTimezoneOffset()/60;return(t<0?"-":"+")+["0",Math.abs(t)].join("").substr(-2)+":00"}renderValue(e,t=this.formatter){if(t==null)return;const a=this.toValue(e);if(a!=null)return t.format(a)}_computeFormatter(e){return new Intl.DateTimeFormat(e||void 0)}_toInputString(e){const t=this.toValue(e);return t==null?null:this._toLocalISOString(t).slice(0,10)}_dateValueChanged(e){const t=e.currentTarget,a=t.value,n=e.model.item,o=this.get(this.valuePath,n),r=this._fromInputString(a);this.set(this.valuePath,r,n),this._fireItemChangeEvent(n,this.valuePath,o,this.renderValue.bind(this))}_toLocalISOString(e){return Ce(e)}};class ua extends Ke(ae(E)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return c`
			...
			${ne({title:this.title,tooltip:this._tooltip,filterText:this._filterText,headerFocused:this.headerFocused,horizontalAlign:"right",externalValues:this.externalValues,onOpenedChanged:e,content:c`
					...
					></cosmoz-input>
				`})}
		`}_fromInputString(e,t){const a=this.toDate(e);if(a!=null)return t==="min"&&a.setHours(0,0,0,0),t==="max"&&a.setHours(23,59,59),a}_filterInputChanged(e,t){const a=e.path.split(".")[1],n=a&&e.value;if(n&&n.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}}customElements.define("cosmoz-omnitable-date-range-input",ua);const da=i=>{const e=-new Date(i).getTimezoneOffset()/60;return(e<0?"-":"+")+["0",Math.abs(e)].join("").substr(-2)+":00"},Je=i=>i.length===19?i+da(i):i,Ft=i=>{if(i==null||i==="")return;let e=i;return!(e instanceof Date)&&(typeof i=="string"&&(e=Je(e)),e=Jt(e),!e)||Number.isNaN(e.getTime())?null:e},P=({valuePath:i},e)=>{if(e==null)return;let t=e;i!=null&&(t=C(e,i));const a=Ft(t);if(a!=null)return L(a.getTime())},I=(i,e,t)=>{const a=Ft(i);return a??null},Xe=(i,e)=>{if(e==null)return;const t=I(i);if(t!=null)return e.format(t)},se={},ca=i=>{const e=i||"";return se[e]||(se[e]=new Intl.DateTimeFormat(i||void 0)),se[e]},rt=({valuePath:i,locale:e},t)=>{let a=C(t,i||"");return a===void 0?"":(a=I(a),a===null?"Invalid Date":Xe(a,ca(e)))},_t=i=>{const e=I(i);if(e==null)return null;const t=Ce(e);return t==null?null:t.slice(0,10)},ma=({valuePath:i},e)=>_t(C(e,i||"")),kt=(i,e)=>{const t=I(i);if(t!=null)return t},lt=i=>{const e=_t(i);return e??""},pa=({valuePath:i},e)=>{if(!i)return"";const t=I(C(e,i));if(!t)return"";const a=I(Ce(t));return a?(a.setHours(0,0,0,0),a):""},It=(i,e)=>t=>{const a=P(i,t);if(a==null)return!1;const n=P({...i,valuePath:"min"},e),o=P({...i,valuePath:"max"},e);return!(a<(n??-1/0)||a>(o??1/0))};class ga extends V(E){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"date-header-cell"},width:{type:String,value:"100px"},minWidth:{type:String,value:"82px"},flex:{type:String,value:"0"}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const a=P({...e,valuePath:"min"},t),n=P({...e,valuePath:"max"},t);if(!(a==null&&n==null))return It(e,t)}getString(e,t){return rt(e,t)}toXlsxValue(e,t){return pa(e,t)}getComparableValue(e,t){return P(e,t)}serializeFilter(e,t){if(t==null)return;const a=I(t.min),n=I(t.max);if(!(a==null&&n==null))return lt(a)+"~"+lt(n)}deserializeFilter(e,t){if(t==null||t==="")return null;const a=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(a)?{min:I(a[1]),max:I(a[2])}:null}renderCell(e,{item:t}){return c`<div class="omnitable-cell-date">
			${rt(e,t)}
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return ie(e,t)}}customElements.define("cosmoz-omnitable-column-date",ga);class ba extends We(V(E)){renderCell({valuePath:e,textProperty:t},{item:a}){const n=Re(a,e,t).map(o=>c`<li>${o}</li>`);return c`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		`}renderEditCell(){return"not implemented"}renderHeader(e,{filter:t,query:a},n,o){return c`<cosmoz-autocomplete-ui
			...
			.onText=${je(n)}
			>${k(e.loading,()=>c`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}}customElements.define("cosmoz-omnitable-column-list-horizontal",ba);window.Cosmoz=window.Cosmoz||{};class st extends Xt(Qt(Yt,E)){static get template(){return Oe`
			<style>
				:host {
					display: block;
				}
		...
		`}static get is(){return"cosmoz-omnitable-column-list-data"}static get properties(){return{items:{type:Array},_expanded:{type:Boolean,value:!1},_othersCount:{type:Number,computed:"_computeOthersCount(items)"}}}static get observers(){return["_itemsLengthChanged(items.length)"]}_itemsLengthChanged(){requestAnimationFrame(()=>this.dispatchEvent(new CustomEvent("expand",{bubbles:!0})))}_firstItem(e){if(e!=null&&e.length>0)return e[0]}_hideExpand(e,t){return e!==void 0&&e.length!==null?e.length<=2||t:!0}_hideCollapse(e,t){return e!==void 0&&e.length!==null?e.length<=2||!t:!0}_otherItems(e,t){if(e!=null&&(e.length<=2||t))return e.slice(1)}_computeOthersCount(e){if(e!=null)return e.length-1}_toggleExpand(e){this._expanded=!this._expanded,e.stopPropagation(),e.preventDefault()}}customElements.define(st.is,st);class fa extends We(V(E)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:a}){return c`<cosmoz-omnitable-column-list-data
			.items=${Re(a,e,t)}
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:a},n,o){return c`<cosmoz-autocomplete-ui
			...
			.onText=${je(n)}
			>${k(e.loading,()=>c`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}}customElements.define("cosmoz-omnitable-column-list",fa);class ha extends Ne(ae(E)){static get properties(){return{maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null},formatter:{type:Object,computed:"_computeFormatter(locale, minimumFractionDigits, maximumFractionDigits)"},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, formatter)"},headerFocused:{type:Boolean,value:!1}}}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return c`
			<style>
				cosmoz-input[type='number'] {
					background: var(--cosmoz-omnitable-amount-input-background, #ffffff);
					border-radius: 6px;
		...
		></cosmoz-omnitable-number-range-input>`}computeSource(e,t){return ie(e,t)}}customElements.define("cosmoz-omnitable-column-number",xa);const Et="1970-01-01",B=(i,e,t)=>{const a=typeof i=="string"&&i.length>3&&i.length<=9?Je(Et+"T"+i):i;return I(a)},ue={},ya=i=>{const e=i||"";if(ue[e])return ue[e];const t={hour:"numeric",minute:"numeric",second:"numeric"};return ue[e]=new Intl.DateTimeFormat(i||void 0,t),ue[e]},fe=({valuePath:i,locale:e},t)=>{const a=B(C(t,i||""));return a===void 0?"":a===null?"Invalid Date":Xe(a,ya(e))},va=(i,e)=>i.valuePath?fe(i,e):"",$a=i=>{const e=B(i);if(e==null)return null;const t=Ce(e);return t&&t.slice(11,19)},W=({valuePath:i},e)=>{if(e==null)return;const t=$a(i==null?e:C(e,i));if(t==null)return;const a=B(Je(Et+"T"+t));return a==null?a:L(a.getTime())},wa=(i,e)=>t=>{const a=W(i,t);if(a==null)return!1;const n=W({...i,valuePath:"min"},e),o=W({...i,valuePath:"max"},e);return n==null||o==null?!1:!(a<n||a>o)},ut=i=>{const e=B(i);return e==null?"":e.toISOString().slice(11,19).replace(/:/gu,".")},dt=i=>{if(!(i==null||i===""))return B(typeof i=="string"?i.replace(/\./gu,":")+"Z":i)};class Ca extends Ke(ae(E)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return c`
			<cosmoz-clear-button
				@click=${()=>this.resetFilter()}
				?visible=${this.hasFilter()}
			></cosmoz-clear-button>
		...
		></cosmoz-input>`}renderHeader({title:e,min:t,max:a,locale:n,filterStep:o},{filter:r},l,s){return c`<cosmoz-omnitable-time-range-input
			...
			@filter-changed=${({detail:{value:u}})=>l(d=>({...d,filter:u}))}
			@header-focused-changed=${({detail:{value:u}})=>l(d=>({...d,headerFocused:u}))}
		></cosmoz-omnitable-time-range-input>`}computeSource(e,t){return ie(e,t)}}customElements.define("cosmoz-omnitable-column-time",Sa);const de={},za=i=>{const e=i||"";if(de[e])return de[e];const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return de[e]=new Intl.DateTimeFormat(i||void 0,t),de[e]},qe=({valuePath:i,locale:e},t)=>{const a=I(C(t,i||""));return a===void 0?"":a===null?"Invalid Date":Xe(a,za(e))},qa=({valuePath:i},e)=>i?C(e,i):"",ct=i=>{const e=I(i);return e==null?"":e.toISOString().slice(0,19).replace(/:/gu,".")},mt=i=>{if(!(i==null||i==="")&&typeof i=="string")return I(i.replace(/\./gu,":")+"Z")};class Aa extends Ke(ae(E)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return c`
			<style>
			...
			${ne({title:this.title,tooltip:this._tooltip,filterText:this._filterText,headerFocused:this.headerFocused,horizontalAlign:"right",externalValues:this.externalValues,onOpenedChanged:e,content:c`
					...
					></cosmoz-datetime-input>
				`})}
		`}_toInputString(e){const t=this.toValue(e);if(t!=null)return this._toLocalISOString(t).slice(0,19)}_computeFormatter(e){const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return new Intl.DateTimeFormat(e||void 0,t)}}customElements.define("cosmoz-omnitable-datetime-range-input",Aa);class pt extends V(E){static get is(){return"cosmoz-omnitable-column-datetime"}static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"datetime-header-cell"},width:{type:String,value:"210px"},minWidth:{type:String,value:"128px"},flex:{type:String,value:"0"},filterStep:{type:Number,value:1}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const a=P({...e,valuePath:"min"},t),n=P({...e,valuePath:"max"},t);if(!(a==null&&n==null))return It(e,t)}getString(e,t){return qe(e,t)}toXlsxValue(e,t){return qa(e,t)}getComparableValue(e,t){return P(e,t)}serializeFilter(e,t){if(t==null)return;const a=I(t.min),n=I(t.max);if(!(a==null&&n==null))return ct(a)+"~"+ct(n)}deserializeFilter(e,t){if(t==null||t==="")return null;const a=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(a)?{min:mt(a[1]),max:mt(a[2])}:null}renderCell(e,{item:t}){return qe(e,t)}renderEditCell(e,{item:t},a){return c`<cosmoz-input
			no-label-float
			type="text"
			@change=${o=>a(kt(o.target.value))}
			.value=${qe(e,t)}
...
>
	...
	>
		<span>${r}</span> ${Ea}
	</button>`},Ot=({columns:i,...e})=>i?.map(t=>Mt({column:t,...e})),Ma=()=>c`
...
`,Lt=i=>(e,t,a=ei)=>{const n=ni(),o=new URLSearchParams(n.hash.replace("#",""));return i(e,t,a,o),"#!"+Object.assign(n,{hash:o}).href.replace(location.origin,"")},Dt=i=>i==null||i==="",La=Lt((i,e,t,a)=>Dt(t(e))?a.delete(i):a.set(i,t(e))),Da=Lt((i,e,t,a)=>Object.entries(e).map(t).forEach(([n,o])=>Dt(o)?a.delete(i+n):a.set(i+n,o))),J=(i,e,{suffix:t="",read:a,write:n,multi:o}={})=>{const[r,l]=o?[Da,ti]:[La,ii],[s,u]=T(()=>e==null?i:l(e+t,a)??i),d=$(m=>u(f=>{const p=$e(m,f);return e!=null&&ai(r(e+t,p,n),null,{notify:!1}),p}),[e,t,r,n]);return[s,d]},Ta=i=>[!0,"true",1,"yes","on"].includes(i),ce=i=>i===""||(i==null?void 0:Ta(i)),me=(i,e,t)=>$(a=>{i(a),t(n=>({...n,[e]:a}))},[i,e,t]),Va=(i,e,t,a,n)=>{const[o,r]=J(t.sortOn,e,{suffix:"-sortOn"}),[l,s]=J(ce(t.descending),e,{suffix:"-descending",read:ce}),[u,d]=J(t.groupOn,e,{suffix:"-groupOn"}),[m,f]=J(ce(t.groupOnDescending),e,{suffix:"-groupOnDescending",read:ce}),p=F(()=>i.find(g=>g.name===o),[i,o]),z=F(()=>i.find(g=>g.name===u),[i,u]),h={groupOn:u,setGroupOn:me(d,"groupOn",a),groupOnDescending:m,setGroupOnDescending:me(f,"groupOnDescending",a),sortOn:o,setSortOn:me(r,"sortOn",a),descending:l,setDescending:me(s,"descending",a),columns:i},v=F(()=>h,Object.values(h)),_=$(g=>{r(g.sortOn),d(g.groupOn),s(g.descending),f(g.groupOnDescending)},[]);return M(()=>void(n.current=_),[]),{...v,sortAndGroup:v,groupOnColumn:z,sortOnColumn:p}},Qe=$t();customElements.define("sort-and-group-provider",Qe.Provider);customElements.define("sort-and-group-consumer",O(({render:i})=>i(Le(Qe)),{useShadowDOM:!1}));const Pa=({data:i,columns:e,groupOnColumn:t,filters:a,setFilterState:n,sortAndGroup:{sortOn:o,setSortOn:r,descending:l,setDescending:s}={}})=>wt(e,u=>u.name,u=>[c`<div
			...
			>
				...
				${k(!u.noSort,()=>Mt({on:o,setOn:r,descending:l,setDescending:s,column:u}))}
			</div>`,c`<cosmoz-omnitable-resize-nub
				.column="${u}"
				name="${u.name}"
			></cosmoz-omnitable-resize-nub>`]),Na=({columns:i,settingsConfig:e,hideSelectAll:t,...a})=>{const n=Le(Qe);return c`
		${k(i,o=>Pa({columns:o,sortAndGroup:n,...a}))}
		${k(!t,()=>c` <cosmoz-omnitable-settings
					.config=${e}
					part="settings"
				></cosmoz-omnitable-settings>`)}
	`};customElements.define("cosmoz-omnitable-header-row",O(Na,{useShadowDOM:!1}));const Ra=K`
	:host {
		display: flex;
		align-items: center;
		flex-wrap: wrap;
...
`;customElements.define("cosmoz-omnitable-item-expand-line",O(Ba,{styleSheets:[De(Ra)]}));const Ga=({columns:i,item:e,selected:t,expanded:a,groupOnColumn:n})=>oi(i,o=>c`<cosmoz-omnitable-item-expand-line
				.column=${o}
				?hidden=${o===n}
				exportparts="item-expand-label, item-expand-value"
				>${o.renderCell(o,{item:e,selected:t,expanded:a})}</cosmoz-omnitable-item-expand-line
			>`);customElements.define("cosmoz-omnitable-item-expand",O(Ga,{useShadowDOM:!1}));const Ha=(i,e,t)=>i.editable?i.renderEditCell(i,e,t(i,e.item)):i.renderCell(i,e),ja=({columns:i,groupOnColumn:e,item:t,index:a,selected:n,expanded:o,onItemChange:r})=>wt(i,l=>l.name,l=>c`<div
			...
			</div>`);customElements.define("cosmoz-omnitable-item-row",O(ja,{useShadowDOM:!1}));const Tt=K`
	.checkbox {
		box-sizing: border-box;
		width: 18px;
		height: 18px;
...
`,gt=i=>{const e=i.replace(/"/gu,'""');return e.search(/("|,|\n)/gu)>=0?'"'+e+'"':i},Ua=(i,e,t)=>{const o=i.map(l=>gt(l.title)).join(";")+`
`,r=e.map(l=>i.map(s=>{const u=s.getString(s,l);return u==null?"":gt(String(u))}).join(";")+`
`);r.unshift(o),Ct(new File(r,t,{type:"text/csv;charset=utf-8"}))},Ka=(i,e)=>{const t=i.map(n=>n.title),a=e.map(n=>i.map(o=>{const r=o.toXlsxValue(o,n);return r??""}));return a.unshift(t),a},Ja=(i,e,t,a)=>{const n=Ka(i,e),o=new ri(t).addSheetFromData(n,a).generate();Ct(new File([o],t,{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}))},Xa=({columns:i,selectedItems:e,csvFilename:t,xlsxFilename:a,xlsxSheetname:n,topPlacement:o})=>c`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!Te(e.length)}
		part="bottomBar"
	...
	</cosmoz-bottom-bar>`,Qa=({allSelected:i,onAllCheckboxChange:e,sortAndGroup:t,dataIsValid:a,data:n,columns:o,filters:r,groupOnColumn:l,setFilterState:s,settingsConfig:u,hideSelectAll:d})=>c`<sort-and-group-provider .value=${t}>
...
`,Za=({settingsConfig:i})=>{const{columns:e,collapsed:t}=i,a=e.filter(n=>!t.some(o=>o.name===n.name));return c`<div class="skeleton">
	...
	</div>`};customElements.define("cosmoz-omnitable-skeleton",O(Za,{styleSheets:[Ya]}));const en=(i,e)=>{const{settingsConfig:t}=i,{processedItems:a,dataIsValid:n,filterIsTooStrict:o,loading:r,displayEmptyGroups:l,compareItemsFn:s,setSelectedItems:u,renderItem:d,renderGroup:m,error:f}=e;return c`${k(!r&&!n&&!f,()=>c`<div class="tableContent-empty">
...
`,pe=i=>{const e=parseInt(i,10);return isFinite(e)?e:void 0},nn=i=>{const{config:e}=i,{settings:t,setSettings:a,collapsed:n}=e,o=Ve({collapsed:n,settings:t.columns,setSettings:$(r=>a(l=>({...l,columns:r})),[a])});return{...e,onDown:$(r=>{r.target.closest(".pull")&&(o.handle=r.currentTarget)},[o]),onDragStart:$(r=>{const{target:l}=r,s=pe(l.dataset.index);if(!o.handle?.contains(l)||s==null)return r.preventDefault();o.handle=null,r.dataTransfer.effectAllowed="move",r.dataTransfer.setData("omnitable/sort-index",s),r.dataTransfer.setData("text/plain",s),setTimeout(()=>l.classList.add("drag"),0),l.addEventListener("dragend",u=>u.target.classList.remove("drag"),{once:!0})},[o]),onDragEnter:$(r=>{const l=r.currentTarget;l===r.target&&(r.preventDefault(),r.dataTransfer.dropEffect="move",l.classList.add("dragover"))},[]),onDragOver:$(r=>{r.preventDefault(),r.currentTarget.classList.add("dragover")},[]),onDragLeave:$(r=>{const l=r.currentTarget;l.contains(r.relatedTarget)||l.classList.remove("dragover")},[]),onDrop:$(r=>{const l=pe(r.dataTransfer.getData("omnitable/sort-index")),s=pe(r.currentTarget.dataset.index),{settings:u,setSettings:d}=o;r.currentTarget.classList.remove("dragover"),r.preventDefault();const m=u.slice();m.splice(s+(l>=s?0:-1),0,m.splice(l,1)[0]),d(m)},[o]),onToggle:$(r=>{const{settings:l,setSettings:s}=o,u=l.map(m=>({...m,disabled:m.disabled||o.collapsed?.some(f=>f.name===m.name)})),d=pe(r.target.closest("[data-index]")?.dataset.index);u.splice(d,1,{...l[d],disabled:!r.target.checked,priority:r.target.checked?l.reduce((m,f)=>Math.max(m,f.priority),0)+1:l[d].priority}),s(u)},[o])}},on=[si({apply({availableHeight:i,elements:e}){Object.assign(e.floating.style,{maxHeight:`${Math.max(0,i)}px`})}}),...ui],rn=({onDragStart:i,onDragEnter:e,onDragOver:t,onDragLeave:a,onDrop:n,onDown:o,onToggle:r,collapsed:l,filters:s})=>(u,d)=>{const m=!!l?.find(p=>p.name===u.name),f=!u.disabled&&!m;return c` <div
			class="item"
			data-index=${d}
			@mousedown=${o}
			draggable="true"
		...
		>
			...
			<input
				...
				.indeterminate=${m}
			/>
		</div>`},ln=i=>{const{settings:e,settingsId:t,onSave:a,onReset:n,hasChanges:o,opened:r,setOpened:l,...s}=nn(i);return c` <div class="headline">
			${A("Sort and filter")}
			<button
				class="close"
		...
		<div class="contents">
			...
			>
				<div class="list">${e.columns?.map(rn(s))}</div>
			</cosmoz-collapse>
		...
		${k(t,()=>c`<div class="buttons">
				...
				</div>`)}`};customElements.define("cosmoz-omnitable-settings-ui",O(ln,{styleSheets:[De(tn)]}));const sn=({config:i,newLayout:e})=>c`
	<cosmoz-dropdown
...
`;customElements.define("cosmoz-omnitable-settings",O(sn,{styleSheets:[De(an)]}));const xe=["sortOn","descending","groupOn","groupOnDescending"],ge=i=>e=>typeof e=="object"&&e!==null&&"name"in e&&e.name===i,un=(i=[],e=[],t=[])=>{const a=e.filter(r=>i.some(ge(r.name))),n=i.filter(r=>r.name!=null&&!e.some(ge(r.name))&&!t.some(ge(r.name))),o=t.filter(r=>!e.some(ge(r.name)));return[...a,...o.flatMap(r=>{const l=i.find(s=>s.name===r.name);return l?{...r,title:l.title??r.title??"",minWidth:parseInt(l.minWidth??"0",10)}:[]}),...n.map(r=>{const{name:l,title:s,priority:u,minWidth:d,width:m,flex:f}=r;return{name:l??"",title:s??"",priority:u??0,minWidth:parseInt(d??"0",10),width:parseInt(m??"0",10),flex:parseInt(f??"0",10)}})]},dn=(i,e)=>({...e,...Ie(Array.from(xe))(i),columns:i.columns?.map(Ie(["name","priority","width","flex","disabled"]))}),cn=({columns:i,settings:e,savedSettings:t,initial:a})=>({...Object.fromEntries(xe.flatMap(o=>a?.[o]!=null?[[o,a[o]]]:[])),...t?Ie(Array.from(xe))(t):{},...e,columns:un(i,e?.columns,t?.columns)}),mn=({prefix:i="omnitable-"}={})=>({write:async(t,a)=>{const n=i+t;try{a?localStorage.setItem(n,JSON.stringify(a)):localStorage.removeItem(n)}catch(o){console.error(o)}},read:async t=>{if(t)try{const a=localStorage.getItem(i+t);return a==null?void 0:JSON.parse(a)}catch(a){console.error(a)}}}),pn=$t(mn),gn=()=>{const i=Le(pn);return F(()=>i(),[i])},bn=(i,e,t,a)=>{const[n,o]=T(),{read:r,write:l}=gn();return M(async()=>{i&&o(await r(i))},[i,r]),{settingsId:i,savedSettings:n,onSave:$(async()=>{if(!i)return;const s=dn(e,n);await l(i,s),t(),o(s)},[e,n]),onReset:$(async s=>{t(),s.shiftKey&&(await l(i),o()),a?.()},[a]),hasChanges:e!=null}},fn=({settingsId:i,host:e})=>{const t=F(()=>Object.fromEntries(xe.map(h=>[h,e[h]])),[]),a=Pe(),n=$(()=>{a.current?.(t)},[t]),[o,r]=T(),[l,s]=T({columns:!0,sort:!0}),{savedSettings:u,...d}=bn(i,o,r,n),{enabledColumns:m}=e,f=Ii(e,{enabledColumns:m}),p=F(()=>cn({columns:f,settings:o,savedSettings:u,initial:t}),[f,o,u]),z=F(()=>p.columns.map(h=>f.find(v=>v.name===h.name)).filter(Boolean),[f,...p.columns.map(h=>h.name)]);return{...d,opened:l,setOpened:s,settings:p,columns:z,setSettings:r,resetRef:a}},bt=i=>Number.isFinite(i)?i:0,hn=(i,e)=>{const t=[];let[a,n]=i.reduce(([d,m],{width:f,flex:p})=>[d+f,m+p],[0,0]),o=e-a,r=bt(o/n),l=0,s=0,u=0;for(let d=0;d<i.length;d++){const{width:m,minWidth:f,flex:p}=i[d],z=o>=0?r*p:m*o/a;if(f>m+z){l+=m,s+=f,u+=p,t[d]=f;continue}if(p===0){l+=m,s+=m,t[d]=m;continue}}a-=l,o=e-s-a,n-=u,r=bt(o/n);for(let d=0;d<i.length;d++){if(t[d]!=null)continue;const{width:m,flex:f}=i[d],p=o>=0?r*f:m*o/a;t[d]=m+p}return t},ye=Symbol("index"),xn=(i,e)=>{if(typeof i.findLastIndex=="function")return i.findLastIndex(e);for(let t=i.length-1;t>=0;t--)if(e(i[t],t,i))return t;return-1},yn=(i,e)=>{const t=xn(i,r=>r!=null&&r>0),a=(r,l)=>`.cell[name="${r}"], cosmoz-omnitable-skeleton::part(cell-${r}){width: ${Math.floor(l)}px;padding: 0 min(3px, ${l/2}px)}`,n=r=>`cosmoz-omnitable-resize-nub[name="${r}"]{display:none}`,o=r=>`cosmoz-omnitable-resize-nub[name="${r}"], .cell[name="${r}"]{display:none}`;return e.map((r,l)=>{const s=i[l];if(s==null||s===0)return o(r.name);const u=a(r.name,s);return l===t?`${u}
${n(r.name)}`:u}).join(`
`)},Vt=(i,e,t)=>{const a=i.filter(l=>!l.hidden),n=a.reduce((l,{width:s})=>l+s,0);if(a.length>1&&n>e)return Vt(a.slice(1),e,t);const o=a.reduce(([l,s],u,d)=>[Math.max(l,u.index),u.index>l?d:s],[-1,-1])[1];return o!==-1&&(a[o].flex=1),hn(a,e).reduce((l,s,u)=>(l[a[u].index]=s,l),new Array(t).fill(void 0))},vn=(i,e)=>i.length===0?".cell {display: none;}":yn(i,e),$n=({host:i,canvasWidth:e,layout:t,setSettings:a})=>{const n=Pe();n.current=o=>a(r=>{const l=r.columns,{detail:{newWidth:s,column:u}}=o,d=l.findIndex(p=>p.name===u.name),m=[],f=l.reduce((p,z)=>Math.max(p,z.priority),-1/0);for(let p=0;p<t.length;p++)if(m[p]={...l[p]},p<d&&t[p]&&(m[p].width=t[p],m[p].flex=0,m[p].priority=f),p===d){const z=t.reduce((h,v,_)=>_<d&&v?h-v:h,e);m[p].width=Math.min(z,Math.max(s,l[p].minWidth)),m[p].flex=0,m[p].priority=f}return{...r,columns:m}}),M(()=>{const o=r=>n.current?.(r);return i.addEventListener("column-resize",o),()=>i.removeEventListener("column-resize",o)},[])},wn=(i,e)=>M(()=>{const t=([n])=>{n.contentRect?.width!==0&&requestAnimationFrame(()=>e(n.contentRect?.width-20-44-24))},a=new ResizeObserver(t);return a.observe(i),()=>a.unobserve(i)},[]),Cn=i=>{const[e,t]=T(()=>i.getBoundingClientRect().width);return wn(i,t),e},Sn=(i,e)=>{const t=F(()=>{let a=!1,n;const o=()=>{if(!a)return;n=requestAnimationFrame(o),i()&&(a=!1)};return{start:()=>{a=!0,cancelAnimationFrame(n),n=requestAnimationFrame(o)},stop:()=>{a=!1,cancelAnimationFrame(n)}}},[]);M(()=>{t.start()},e),M(()=>()=>t.stop(),[])},zn=(i=0,e=0)=>Math.abs(i-e)<.1,qn=(i,e=1.9,t=di)=>{const a=Ve({target:i}),n=$(()=>{if(a.tween||(a.tween=a.target),a.target.every((o,r)=>a.tween[r]===o))return t(a.tween),!0;a.tween=a.target.map((o,r)=>zn(a.tween[r],o)?o:(a.tween[r]??0)+((o??0)-(a.tween[r]??0))/e||0),t(a.tween)},[]);Sn(n,[i])},An=({canvasWidth:i,groupOnColumn:e,config:t,miniColumn:a})=>F(()=>{if(!Array.isArray(t)||i==null||i===0)return[];const n=t.map((o,r)=>({minWidth:o.minWidth,width:o.width,flex:o.flex,priority:o.priority,name:o.name,index:r,hidden:o.name===e?.name||o.disabled})).map(o=>a?{...o,hidden:a.name!==o.name}:o).sort(({index:o,priority:r},{index:l,priority:s})=>r===s?l-o:r-s);return Vt(n,i,n.length)},[i,e,t]),Fn=({host:i,canvasWidth:e,columns:t})=>{const a=i.miniBreakpoint??480,n=F(()=>e<=a,[e,a]),o=F(()=>n?t?.filter(u=>u.mini!=null).sort((u,d)=>(u.mini??0)-(d.mini??0)):[],[t,n]),[r,...l]=o??[],s=!!r;return M(()=>{i.toggleAttribute("mini",s)},[s]),{isMini:s&&n,miniColumn:r,miniColumns:l}},_n=i=>{const e=F(()=>new CSSStyleSheet,[]);return M(()=>{i.shadowRoot.adoptedStyleSheets=[...i.shadowRoot.adoptedStyleSheets,e]},[]),e},kn=({host:i,columns:e,settings:t,setSettings:a,resizeSpeedFactor:n,sortAndGroupOptions:o})=>{const r=Cn(i),{isMini:l,miniColumn:s,miniColumns:u}=Fn({host:i,canvasWidth:r,columns:e}),{groupOnColumn:d}=o,m=An({canvasWidth:r,groupOnColumn:d,miniColumn:s,config:t.columns}),f=_n(i),p=F(()=>t.columns.reduce((h,v,_)=>m[_]!=null||v.name===d?.name||v.disabled?h:[...h,e.find(g=>g.name===v.name)],[]),[e,t,m]),z=Ve({columns:t.columns});return qn(m,n,h=>{const v=vn(h,z.columns);f.replace(v)}),$n({host:i,canvasWidth:r,layout:m,setSettings:h=>a(h(t))}),{isMini:l,collapsedColumns:p,miniColumns:u}},In=({host:i,...e})=>{const{csvFilename:t="omnitable.csv",xlsxFilename:a="omnitable.xlsx",xlsxSheetname:n="Omnitable",topPlacement:o="top-end"}=i;return{csvFilename:t,xlsxFilename:a,xlsxSheetname:n,topPlacement:o,...e}},En=({host:i,selectedItems:e,data:t,sortAndGroupOptions:a,collapsedColumns:n,settings:o,filterFunctions:r,settingS:l,filters:s,...u})=>{const d=t&&t.length>0&&e.length===t.length,m=h=>{h.target.checked?i.shadowRoot.querySelector("#groupedList").selectAll():i.shadowRoot.querySelector("#groupedList").deselectAll()},{groupOnColumn:f}=a,p=F(()=>[f,...n,...o.columns.filter(h=>h.disabled)].some(h=>h&&Object.keys(r).includes(h.name)),[r,o,n]),z=F(()=>({...l,collapsed:n,badge:p,filters:s}),[l,n,p,s]);return M(()=>{const h=i.shadowRoot.querySelector("#tableContent"),v=new ResizeObserver(_=>requestAnimationFrame(()=>{i.style.setProperty("--ot-height",_[0]?.contentRect.height+"px")}));return v.observe(h),()=>v.unobserve(h)},[]),{allSelected:d,onAllCheckboxChange:m,data:t,settingsConfig:z,filters:s,groupOnColumn:f,sortAndGroup:a.sortAndGroup,...u}},Pt=c`
	<svg
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
...
`,Mn=i=>i?"groupRow groupRow-folded":"groupRow",On=({item:i,index:e})=>t=>k((t?.length??0)>0,()=>c`
			...
			`),Ln=({columns:i,collapsedColumns:e,miniColumns:t,onItemClick:a,onCheckboxChange:n,dataIsValid:o,groupOnColumn:r,onItemChange:l,rowPartFn:s})=>(u,d,{selected:m,expanded:f,toggleCollapse:p})=>c`
		<div
			?selected=${m}
	...
	`,Dn=({onCheckboxChange:i,dataIsValid:e,groupOnColumn:t})=>(a,n,{selected:o,folded:r,toggleFold:l})=>c` <div
			class="${Mn(r)}"
		...
		</div>`,Tn=({host:i,error:e,dataIsValid:t,processedItems:a,columns:n,collapsedColumns:o,miniColumns:r,sortAndGroupOptions:l,rowPartFn:s,...u})=>{const{loading:d=!1,displayEmptyGroups:m=!1,compareItemsFn:f}=i,p=Pe({shiftKey:!1,ctrlKey:!1}),z=$(g=>{const q=g.target,b=q.dataItem,y=q.checked,x=i.shadowRoot.querySelector("#groupedList");p.current.shiftKey?x.toggleSelectTo(b,y):p.current.ctrlKey?(q.checked=!0,x.selectOnly(b)):x.toggleSelect(b,y),g.preventDefault(),g.stopPropagation()},[]);M(()=>{const g=({shiftKey:q,ctrlKey:b})=>{p.current={shiftKey:q,ctrlKey:b}};return window.addEventListener("keydown",g),window.addEventListener("keyup",g),()=>{window.removeEventListener("keydown",g),window.removeEventListener("keyup",g)}},[]);const h=$(g=>{const q=g.currentTarget,b=g.composedPath();b.slice(0,b.indexOf(q)).find(x=>x.matches?.("a, .checkbox, .expand"))||i.dispatchEvent(new window.CustomEvent("omnitable-item-click",{bubbles:!0,composed:!0,detail:{item:q.dataItem,index:q.dataIndex}}))},[]),{groupOnColumn:v}=l,_=$((g,q)=>b=>Ei(i,g,q,b),[]);return{...u,processedItems:a,dataIsValid:t,filterIsTooStrict:t&&a.length<1,loading:d,compareItemsFn:f,displayEmptyGroups:m,error:e,renderItem:F(()=>Ln({columns:n,collapsedColumns:o,miniColumns:r,onItemClick:h,onCheckboxChange:z,dataIsValid:t,groupOnColumn:v,onItemChange:_,rowPartFn:s}),[n,o,h,z,t,v,_,s]),renderGroup:F(()=>Dn({onCheckboxChange:z,dataIsValid:t,groupOnColumn:v}),[z,t,v])}},Vn=(i,e)=>{if(i===e)return 0;if(i==null)return-1;if(e==null)return 1;const t=typeof i,a=typeof e;return t==="object"&&a==="object"?i.toString()<e.toString()?-1:1:t==="number"&&a==="number"?i-e:t==="string"&&a==="string"?i<e?-1:1:t==="boolean"&&a==="boolean"?i?-1:1:(console.warn("unsupported sort",t,i,a,e),0)},Fe=(i,e)=>(t,a)=>Vn(i(t),i(a))*(e?-1:1),Pn=i=>i.replace(/([a-z0-9])([A-Z])/gu,"$1-$2").toLowerCase(),ft=(i,e)=>{!i||!e||Object.entries(e).forEach(([t,a])=>{i[R].__ownChange=!0,i[R][t]=a,i[R].__ownChange=!1,i[R].dispatchEvent(new CustomEvent(`${Pn(t)}-changed`,{bubbles:!0,detail:{value:a}}))})},_e=(i,e)=>Object.assign(i,{[ye]:e}),be=Symbol("unparsed"),Nn=({data:i,columns:e,hashParam:t,sortAndGroupOptions:a,noLocalSort:n,noLocalFilter:o})=>{const{groupOnColumn:r,groupOnDescending:l,sortOnColumn:s,descending:u}=a,d=$(([b,y])=>{const x=e.find(({name:w})=>w===b);return x==null?[b,void 0]:[b,y.filter&&x.serializeFilter(x,y.filter)]},[e]),m=$(([b,y])=>{const x=e.find(({name:S})=>S===b);if(x==null)return[b,{[be]:y}];const w={filter:x.deserializeFilter(x,y)};return ft(x,w),[b,w]},[e]),[f,p]=J({},t,{multi:!0,suffix:"-filter--",write:d,read:m}),z=$((b,y)=>p(x=>{const w=$e(y,x[b]);return ft(e.find(S=>S.name===b),w),{...x,[b]:{...x[b],...w}}}),[e,p]),h=F(()=>Object.values(f).map(b=>b.filter),[f]),v=F(()=>Object.fromEntries(e.map(b=>[b.name,!b.noLocalFilter&&b.getFilterFn(b,f[b.name]?.filter)]).filter(([,b])=>!!b)),[e,...h]),_=F(()=>!Array.isArray(i)||i.length===0?[]:Object.entries(v).length===0||o?i.slice():i.filter(b=>Object.values(v).every(y=>y(b))),[i,v,o]),g=F(()=>{if(!n&&!r&&s!=null&&s.sortOn!=null)return _.slice().sort(Fe(b=>s.getComparableValue({...s,valuePath:s.sortOn},b),u));if(r!=null&&r.groupOn!=null){const b=_.reduce((y,x)=>{const w=r.getComparableValue({...r,valuePath:r.groupOn},x);if(w===void 0)return y;let S=y.find(D=>D.id===w);return S?(S.items.push(x),y):(S={id:w,name:w,items:[x]},[...y,S])},[]);return b.sort(Fe(y=>r.getComparableValue({...r,valuePath:r.groupOn},y.items[0]),l)),!s||n?b:b.filter(y=>Array.isArray(y.items)).map(y=>(y.items.sort(Fe(x=>s.getComparableValue({...s,valuePath:s.sortOn},x),u)),y))}return _},[_,r,l,s,u,n]),q=F(()=>{let b=0,y=0;const x=[];return g.forEach(w=>{if(Array.isArray(w.items)){_e(w,y++),w.items.forEach(S=>{_e(S,b++),x.push(S)});return}return _e(w,b++),x.push(w)},[]),x},[g]);return M(()=>{p(b=>Object.values(b).some(x=>x[be]!=null)?Object.fromEntries(Object.entries(b).map(([x,w])=>w[be]==null?[x,w]:m([x,w[be]]))):b)},[m]),{processedItems:g,visibleData:q,filters:f,filterFunctions:v,setFilterState:z}},Rn=i=>{const e=a=>{const n=i.data.indexOf(a);if(n<0)return null;const o=i.data.splice(n,1);if(i.data=i.data.slice(),Array.isArray(o)&&o.length>0)return o[0]},t=(a,n)=>{i.data.splice(a,1,n),i.data=i.data.slice()};return{removeItem:e,removeItems(a){const n=[];for(let o=a.length-1;o>=0;o-=1){const r=i.removeItem(a[o]);r!=null&&n.push(r)}return n},replaceItemAtIndex:t,replaceItem(a,n){const o=i.data.indexOf(a);if(o>-1)return t(o,n)},selectItem(a){i.shadowRoot.querySelector("#groupedList").select(a)},selectAll(){i.shadowRoot.querySelector("#groupedList").selectAll()},deselectAll(){i.shadowRoot.querySelector("#groupedList").deselectAll()},deselectItem(a){i.shadowRoot.querySelector("#groupedList").deselect(a)},isItemSelected(a){return i.shadowRoot.querySelector("#groupedList").isItemSelected(a)}}},Bn=({host:i,visibleData:e,filters:t,...a})=>{const{setFilterState:n}=a,o=F(()=>Rn(i),[]);Ee(a,Object.values(a)),Ee(o,Object.values(o)),M(()=>{const l=s=>n(s.detail.name,u=>({...u,...s.detail.state}));return i.addEventListener("legacy-filter-changed",l),()=>i.removeEventListener("legacy-filter-changed",l)},[]),N("visibleData",e),N("sortedFilteredGroupedItems",a.sortedFilteredGroupedItems),N("selectedItems",a.selectedItems),N("sortOn",a.sortOn),N("descending",a.descending),N("isMini",a.isMini);const r=F(()=>Object.fromEntries(Object.entries(t).filter(([,{filter:l}])=>l!==void 0).map(([l,{filter:s}])=>[l,s])),[t]);N("filters",r,Object.values(r))},Gn=i=>{const{hashParam:e,settingsId:t,data:a,resizeSpeedFactor:n,noLocal:o,noLocalSort:r=o,noLocalFilter:l=o,error:s,rowPartFn:u}=i,d=fn({settingsId:t,host:i}),{settings:m,setSettings:f,columns:p,resetRef:z}=d,h=Va(p,e,m,f,z),{processedItems:v,visibleData:_,filters:g,setFilterState:q,filterFunctions:b}=Nn({data:a,columns:p,hashParam:e,sortAndGroupOptions:h,noLocalSort:r,noLocalFilter:l}),{isMini:y,collapsedColumns:x,miniColumns:w}=kn({host:i,columns:p,settings:m,setSettings:f,resizeSpeedFactor:n,sortAndGroupOptions:h}),S=a&&Array.isArray(a)&&a.length>0,[D,G]=T([]);return Bn({host:i,visibleData:_,sortedFilteredGroupedItems:v,columns:p,filters:g,setFilterState:q,selectedItems:D,isMini:y,...h}),{header:En({host:i,selectedItems:D,sortAndGroupOptions:h,dataIsValid:S,data:a,columns:p,filters:g,collapsedColumns:x,settings:m,filterFunctions:b,settingS:d,setFilterState:q,hideSelectAll:i.hideSelectAll===!0}),list:Tn({host:i,error:s,dataIsValid:S,processedItems:v,setSelectedItems:G,columns:p,collapsedColumns:x,miniColumns:w,sortAndGroupOptions:h,rowPartFn:u}),footer:In({host:i,selectedItems:D,columns:p})}};customElements.define("cosmoz-grouped-list-row",class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||ke(this._renderFn(this._item,this._index),this)}});const Hn={group:Symbol("group")},Se=(i,e)=>(e.has(i)||e.set(i,{}),e.get(i)),jn=(i,e)=>!!Se(i,e).expanded,Wn=(i,e)=>!!Se(i,e).folded,Me=i=>i?i.items instanceof Array:!1,Un=i=>{if(!Array.isArray(i)||i.length===0)return;const e=Array.isArray(i[0]?.items);if(!i.every(a=>Array.isArray(a.items)===e))throw new Error("Data must be homogeneous.")},Kn=(i,e,t)=>Array.isArray(i)?(Un(i),i.reduce((n,o)=>{const r=o;if(!r.items)return n.concat(o);if(r.items.length){if(Se(o,t).folded)return n.concat(o);const l=r.items.map(s=>Object.assign(s,{[Hn.group]:o}));return n.concat(o,l)}return e?n.concat(o):n},[])):void 0,Jn=(i,...e)=>typeof i=="function"?i(...e):i,Xn=(i,e)=>i===e,Qn=()=>{const[i,e]=T(()=>[new WeakMap]);return{setItemState:$((a,n)=>e(([o])=>{const r=Se(a,o);return Object.assign(r,Jn(n,r)),[o]}),[]),state:i[0],signal:i}},Yn=()=>{const{setItemState:i,state:e,signal:t}=Qn(),a=$((o,r)=>{Me(o)&&i(o,l=>({folded:r!==void 0?r:!l.folded}))},[]),n=$((o,r)=>{Me(o)||i(o,l=>({expanded:r!==void 0?!r:!l.expanded}))},[]);return{state:e,signal:t,toggleFold:a,toggleCollapse:n}},Zn=({initial:i,compareItemsFn:e,data:t,flatData:a})=>{const[n,o]=T(i),[r,l]=T(),s=$(g=>n.includes(g),[n]),u=$(g=>g?.items?.every(s)??!1,[s]),d=$(g=>s(g)||u(g),[s,u]),m=$(g=>{const b=g.items??[g];o(y=>[...y,...b.filter(x=>!y.includes(x))]),l(g)},[]),f=$(g=>{const b=g.items??[g];o(y=>y.filter(x=>!b.includes(x))),l(g)},[]),p=$(g=>{o(g.items?.slice()||[g]),l(g)},[]),z=$(()=>{o(t.flatMap(g=>g.items||g)),l(void 0)},[t]),h=$(()=>{o([]),l(void 0)},[]),v=$((g,q=!d(g))=>q?m(g):f(g),[d]),_=$((g,q)=>{if(!a)return;const b=r?a.findIndex(w=>e(w,r)):-1;if(b<0)return v(g,q);const[y,x]=[b,a.indexOf(g)].sort((w,S)=>w-S);a.slice(y,x+1).forEach((w,S,D)=>{S>0&&S<D.length-1&&Me(w)||v(w,q)}),l(g)},[a,e,v]);return M(()=>o(g=>g.length>0&&a?a.filter(q=>g.find(b=>e(q,b))):g),[a]),{selectedItems:n,isItemSelected:s,isGroupSelected:u,isSelected:d,select:m,deselect:f,selectOnly:p,selectAll:z,deselectAll:h,toggleSelect:v,toggleSelectTo:_}},eo={host:{position:"relative",display:"flex",flexDirection:"column"}},to=i=>{const{data:e,renderItem:t,renderGroup:a,displayEmptyGroups:n,compareItemsFn:o=Xn}=i,{toggleFold:r,toggleCollapse:l,state:s,signal:u}=Yn(),d=F(()=>Kn(e,n,s),[e,n,u]),{selectedItems:m,isItemSelected:f,isGroupSelected:p,isSelected:z,select:h,deselect:v,selectOnly:_,selectAll:g,deselectAll:q,toggleSelect:b,toggleSelectTo:y}=Zn({initial:[],compareItemsFn:o,data:e,flatData:d}),x=$((S,D)=>Array.isArray(S.items)?a(S,D,{selected:p(S),folded:Wn(S,s),toggleSelect:G=>b(S,typeof G=="boolean"?G:void 0),toggleFold:()=>r(S)}):t(S,D,{selected:m.includes(S),expanded:jn(S,s),toggleSelect:G=>b(S,typeof G=="boolean"?G:void 0),toggleCollapse:()=>l(S)}),[t,a,m,b,u]);xt(()=>{Object.assign(i.style,eo.host)},[]),N("selectedItems",m);const w={toggleFold:r,toggleCollapse:l,isItemSelected:f,isGroupSelected:p,isSelected:z,select:h,deselect:v,selectOnly:_,selectAll:g,deselectAll:q,toggleSelect:b,toggleSelectTo:y};return Ee(w,Object.values(w)),{renderRow:x,flatData:d}},io=({renderRow:i,flatData:e})=>ci({items:e,renderItem:(t,a)=>c`<cosmoz-grouped-list-row
				.item=${t}
				.index=${a}
				.renderFn=${i}
			></cosmoz-grouped-list-row>`}),ao=i=>io(to(i));customElements.define("cosmoz-grouped-list",O(ao,{useShadowDOM:!1}));const no=i=>window.ShadyCSS?.ApplyShim?.transformCssText?.(i)||i,oo=i=>{const{header:e,list:t,footer:a}=Gn(i);return c`
		<style>
			${mi([],()=>no(Wa))}
		</style>
