...
`,customElements.define(`cosmoz-clear-button`,m(pt))})),N,ht,gt,_t,vt,P,F=e((()=>{O(),N=({valuePath:e},t)=>M(t,e),ht=N,gt=N,_t=({valuePath:e},t)=>n=>{let r=M(n,e);return r==null?!1:r.toString().toLowerCase().trim().includes(t.toLowerCase().trim())},vt=(e,t)=>t===``||t==null?null:t,P=e=>class extends e{static get properties(){return{isOmnitableColumn:{type:Boolean,value:!0},title:{type:String},valuePath:{type:String,notify:!0},values:{type:Array,notify:!0},filter:{type:Object},noLocalFilter:{type:Boolean},disabled:{type:Boolean,value:!1,notify:!0},editable:{type:Boolean,notify:!0},loading:{type:Boolean,value:!1,notify:!0},externalValues:{type:Boolean,value:!1,notify:!0},name:{type:String},sortOn:{type:String},groupOn:{type:String},noSort:{type:Boolean,value:!1},disabledFiltering:{type:Boolean,value:!1},width:{type:String,value:`75px`},minWidth:{type:String,value:`40px`},flex:{type:String,value:`1`},cellClass:{type:String,value:`default-cell`},headerCellClass:{type:String,value:`default-header-cell`},priority:{type:Number,value:0},hidden:{type:Boolean,notify:!0},preferredDropdownHorizontalAlign:{type:String,value:`right`},renderHeader:{type:Function},renderCell:{type:Function},renderEditCell:{type:Function},renderGroup:{type:Function},mini:{type:Number,value:null},renderMini:{type:Function}}}static get observers(){return[`notifyFilterChange(filter)`]}notifyFilterChange(e){this.__ownChange||this.dispatchEvent(new CustomEvent(`legacy-filter-changed`,{detail:{name:this.name,state:this.legacyFilterToState(e)},bubbles:!0}))}legacyFilterToState(e){return{filter:e}}getFilterFn(){}getString(e,t){return N(e,t)}toXlsxValue(e,t){return ht(e,t)}cellTitleFn(e,t){return this.getString(e,t)}headerTitleFn(e){return e.title}serializeFilter(e,t){return vt(e,t)}deserializeFilter(e,t){if(t==null)return null;if(typeof t==`string`)try{return window.decodeURIComponent(t)}catch{return null}return t}getComparableValue(e,t){return gt(e,t)}computeSource(e,t){return t}_propertiesChanged(e,t,n){super._propertiesChanged(e,t,n),this.dispatchEvent(new CustomEvent(`cosmoz-column-prop-changed`,{bubbles:!0}))}}})),yt,bt,xt,St,Ct,wt,Tt,Et=e((()=>{w(),mt(),D(),i(),A(),F(),yt=e=>t=>e(n=>{if(n.inputValue===void 0&&t.target.value===``)return n;clearTimeout(n.t);let r=setTimeout(()=>e(e=>({...e,filter:e.inputValue})),1e3);return{...n,inputValue:t.target.value,t:r}}),bt=e=>()=>e(e=>({...e,filter:e.inputValue})),xt=e=>t=>{t.keyCode===13&&(t.preventDefault(),e(e=>({...e,filter:e.inputValue})))},St=e=>t=>e(e=>({...e,headerFocused:t.detail.value})),Ct=e=>()=>e(e=>({...e,filter:null,inputValue:null})),wt=e=>e!=null&&e!==``,Tt=class extends P(k){static get properties(){return{minWidth:{type:String,value:`55px`},editMinWidth:{type:String,value:`55px`},inputValue:{type:Object,notify:!0}}}getFilterFn(e,t){if(!(t==null||t===``))return _t(e,t)}renderCell(e,{item:t}){return o`<span class="default-column">${N(e,t)}</span>`}renderEditCell(e,{item:t},n){return o`<cosmoz-input
			no-label-float
			type="text"
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,inputValue:n,headerFocused:r},i){return o`<cosmoz-input
			...
			@value-changed=${yt(i)}
			focused=${r}
			@focused-changed=${St(i)}
			@keydown=${xt(i)}
			@blur=${bt(i)}
		>
			${j(!e.disabledFiltering,()=>o`<cosmoz-clear-button
						suffix
						slot="suffix"
						?visible=${wt(t)}
						light
						@click=${Ct(i)}
					></cosmoz-clear-button>`)}
		</cosmoz-input>`}legacyFilterToState(e){return{filter:e,inputValue:e}}},customElements.define(`cosmoz-omnitable-column`,Tt)})),Dt,Ot,kt,At=e((()=>{w(),g(),i(),Dt=[`label`,`value`,`slot`,`always-float-label`,`disabled`],Ot=Xe`
	${pe}
...
`,kt=e=>{let{label:t,value:n,slot:r}=e;return We(o`<div
		id="input"
		part="input"
		role="button"
		class="control"
	...
	>
		${n||``}
	</div>`,{label:t})},customElements.define(`cosmoz-omnitable-dropdown-input`,m(kt,{observedAttributes:Dt,styleSheets:[Ot]}))})),I,jt=e((()=>{be(),i(),te(),At(),I=({title:e,tooltip:t=``,filterText:n=``,onOpenedChanged:r,content:i,horizontalAlign:a=`left`,externalValues:s=null})=>o`
		<style>
			.dropdown {
				outline: none;
			}
	...
	`})),Mt,Nt,Pt=e((()=>{He(),Ee(),_(),ne(),Mt=e=>e?typeof e.close==`function`?e:Mt(e.parentElement):null,Nt=e=>class extends e{static get properties(){return{disabled:{type:Boolean,value:!1},filter:{type:Object,notify:!0},values:{type:Array,value(){return[]}},headerFocused:{type:Boolean,notify:!0},min:{type:Number,value:null},max:{type:Number,value:null},limits:{type:Function},autoupdate:{type:String,value:!0},locale:{type:String,value:null},_filterInput:{type:Object,value(){return{min:null,max:null}}},_range:{type:Object,computed:`_computeRange(values.*)`},_limit:{type:Object,computed:`_computeLimit(_range, _filterInput.*, min, max)`,value(){return{}}},_tooltip:{type:String,computed:`_computeTooltip(title, _filterText)`},_fromClasses:{type:String,computed:`_computeInputClasses(_filterInput.min)`},_toClasses:{type:String,computed:`_computeInputClasses(_filterInput.max)`}}}static get observers(){return[`_filterInputChanged(_filterInput.*, autoupdate)`,`_filterChanged(filter.*)`,`_updateLimits(limits, headerFocused)`]}disconnectedCallback(){this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),super.disconnectedCallback()}_computeInputClasses(e){return e!=null&&e!==``?`has-value`:``}toNumber(e,t,n){if(e==null||e===``)return;let r=typeof e==`number`?e:Number(e);if(Number.isNaN(r))return;if(n==null||t==null)return r;let i=this.toNumber(t);return i==null?r:n(r,i)}toValue(){return this.toNumber.apply(this,arguments)}getComparableValue(e,t){if(e==null)return;let n=e;return t!=null&&(n=this.get(t,e)),this.toValue(n)}renderValue(){}getInputString(e,t=this.valuePath){let n=this.toValue(this.get(t,e));return this._toInputString(n)}_computeRange(e){let t=e.base,n=Array.isArray(t)&&t.length&&t.map(e=>this.toValue(e)).filter(e=>e!=null);return!n||n.length<1?{min:null,max:null}:n.reduce((e,t)=>({min:this.toValue(t,e.min,Math.min),max:this.toValue(t,e.max,Math.max)}),{})}_computeLimit(e,t,n,r){if(!e)return;let i=t.base,a=this.toValue(n),o=this.toValue(r),s=a??this.toValue(e.min),c=o??this.toValue(e.max);return{fromMin:s,fromMax:this.toValue(c,this._fromInputString(i.max,`max`),Math.min),toMin:this.toValue(s,this._fromInputString(i.min,`min`),Math.max),toMax:c}}_computeFilterText(e){if(e.base==null)return;let t=e.base,n=this.toValue(t.min),r=this.toValue(t.max),i=[];return n!=null&&i.push(this.renderValue(n)),i.push(` - `),r!=null&&i.push(this.renderValue(r)),i.length>1?i.join(``):void 0}_computeTooltip(e,t){return t==null?e:`${e}: ${t}`}_fromInputString(e){return this.toValue(e)}_toInputString(e){return this.toValue(e)??null}_getDefaultFilter(){return{min:null,max:null}}_filterInputChanged(e,t){let n=e.path.split(`.`)[1];this.__inputChangePath=n||null,t&&(this._limitInputDebouncer=re.debounce(this._limitInputDebouncer,Ve.after(600),()=>{this._limitInput(),this._updateFilter()}),oe(this._limitInputDebouncer))}_clearFrom(){this.set(`_filterInput.min`,null),this._updateFilter()}_clearTo(){this.set(`_filterInput.max`,null),this._updateFilter()}_onBlur(){this._limitInput(),this._updateFilter()}_onKeyDown(e){let t=e.currentTarget,n=Array.from(t.parentElement.querySelectorAll(`cosmoz-input`)),r=n[n.findIndex(e=>e===t)+1],i=!r,a=n[0]===t;switch(e.keyCode){case 13:if(e.preventDefault(),!i)r.focus();else{let e=this._limitInput();this._updateFilter(),e||this._closeParent(t)}break;case 9:(i&&!e.shiftKey||a&&e.shiftKey)&&this._closeParent(t)}}_closeParent(e){let t=Mt(e);t&&t.close()}_onDropdownOpenedChanged({currentTarget:e,type:t,detail:n}){(t===`focus`||n?.value===!0)&&setTimeout(()=>{e.querySelector(`cosmoz-input:focus`)||e.querySelector(`cosmoz-input`)?.focus()},100)}_limitInput(){let e=this._filterInput,t=this.__inputChangePath,n=t?this._fromInputString(this.get(t,e),t):null;if(this.__inputChangePath=null,n==null)return!1;let r=this._limit,i=t===`min`?`from`:`to`,a=this.get(i+`Min`,r),o=this.get(i+`Max`,r),s=this.toValue(n,a,Math.max),c=this.toValue(s,o,Math.min);return this.getComparableValue(n)===this.getComparableValue(c)?!1:(this.set([`_filterInput`,t],this._toInputString(c,t)),this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),!0)}_updateFilter(){let e=this._filterInput,t=this.filter,n=this._fromInputString(e.min,`min`),r=this._fromInputString(e.max,`max`);this.getComparableValue(n)===this.getComparableValue(t,`min`)&&this.getComparableValue(r)===this.getComparableValue(t,`max`)||this.set(`filter`,{min:n,max:r})}_filterChanged(e){if(this._filterInput==null)return;let t=this._filterInput,n=e.base,r=this._fromInputString(t.min,`min`),i=this._fromInputString(t.max,`max`);this.getComparableValue(r)===this.getComparableValue(n,`min`)&&this.getComparableValue(i)===this.getComparableValue(n,`max`)||(this.set(`_filterInput`,{min:this._toInputString(n.min),max:this._toInputString(n.max)}),this._limitInputDebouncer&&this._limitInputDebouncer.cancel())}hasFilter(){let e=this.filter;return e==null?!1:this.toValue(e.min)!=null||this.toValue(e.max)!=null}resetFilter(){this.filter=this._getDefaultFilter()}_updateLimits(e,t){e&&Promise.resolve(Fe(e,{active:t})).then(e=>{let{min:t,max:n}=e??{};Object.assign(this,{...t==null?{}:{min:t},...n==null?{}:{max:n}})})}}})),Ft,It=e((()=>{D(),i(),Ft=e=>class extends e{static get template(){return Ke`<div id="output" style="position:relative;"></div>`}connectedCallback(){super.connectedCallback();let e=this;t(e.render(),e.$.output)}_propertiesChanged(e,n,r){super._propertiesChanged(e,n,r);let i=this;requestAnimationFrame(()=>t(i.render(),i.$.output))}}})),Lt,Rt=e((()=>{w(),D(),a(),i(),A(),jt(),At(),Pt(),It(),Lt=class extends Nt(Ft(k)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:`_computeFilterText(filter.*, _formatters)`},headerFocused:{type:Boolean,value:!1}}}static get observers(){return[`_valuesChanged(autodetect, currency, values)`]}render(){let e=e=>{this.headerFocused=e.type===`focus`,this._onDropdownOpenedChanged(e)};return o`
			...
			${j(this.disabled,()=>o`
				...
				`,()=>o`
					...
					></cosmoz-clear-button>
					${I({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:o`
		...
		></cosmoz-omnitable-amount-range-input>`}computeSource(e,t){return dn(e,t)}},customElements.define(`cosmoz-omnitable-column-amount`,pn)})),hn,gn,_n,vn,yn,bn,xn,Sn,Cn,wn,Tn,En,Dn=e((()=>{Ce(),He(),st(),O(),H(),hn=(e,t)=>{if(!Array.isArray(e))return;let n=[];return e.reduce((e,t)=>Array.isArray(t)?(t.forEach(t=>{e.push(t)}),e):(e.push(t),e),[]).filter((e,r,i)=>{if(i.indexOf(e)!==r)return!1;if(t){let r=M(e,t);if(n.indexOf(r)!==-1)return!1;n.push(r)}return!0})},gn=(e,t,n)=>{if(e==null)return[];if(Array.isArray(e)){let r=hn(e,t);if(!r?.length)return r;let i=n??`label`,a=e=>String(typeof e==`object`&&e?M(e,i)??``:e??``);return r.sort((e,t)=>a(e).localeCompare(a(t)))}if(typeof e==`object`){let r=t??`id`,i=n??`label`;return Object.entries(e).map(([e,t])=>({[r]:e,[i]:t})).sort((e,t)=>String(e[i]??``).localeCompare(String(t[i]??``)))}return[]},_n=(e,t,n)=>lt(t&&M(e,t)).map(T(n)),vn=({valuePath:e,textProperty:t},n)=>_n(n,e,t).filter(e=>e!=null).join(`, `),yn=vn,bn=({valueProperty:e,valuePath:t,emptyValue:n,emptyProperty:r},i)=>a=>{let o=T(e),s=lt(M(a,t));return i.some(t=>s.length===0&&T(r||e)(t)===n||s.some(e=>o(e)===o(t)))},xn=e=>t=>e(e=>({...e,filter:t})),Sn=e=>t=>e(e=>({...e,headerFocused:t})),Cn=e=>t=>e(e=>({...e,query:t})),wn=({emptyValue:e,emptyLabel:t,emptyProperty:n,textProperty:r,valueProperty:i},a)=>{let o=gn(a,i,r);return!t||e===void 0||!r||!(n||i)||!o?o:[{[r]:t,[n||i]:e},...o]},Tn=(e,t)=>wn(e,un(t,e.valuePath)),En=e=>class extends e{static get properties(){return{textProperty:{type:String},valueProperty:{type:String},emptyLabel:{type:String},emptyValue:{type:Object},emptyProperty:{type:String}}}getConfig(e){return{emptyProperty:e.emptyProperty}}getString(e,t){return vn(e,t)}toXlsxValue(e,t){return yn(e,t)}getComparableValue({valuePath:e,valueProperty:t},n){let r=M(n,e);return t==null?r:lt(r).map(T(t)).sort().join(` `)}getFilterFn(e,t){if(!(!t||!Array.isArray(t)||t.length===0))return bn(e,t)}serializeFilter(e,t){return t.length===0?null:JSON.stringify(t)}deserializeFilter(e,t){if(t==null)return null;try{return JSON.parse(decodeURIComponent(t))}catch(e){return console.error(`Failed to deserialize filter value:`,{error:e?.name,message:e?.message,filterLength:typeof t==`string`?t.length:null}),null}}computeSource(e,t){return e.externalValues||typeof e.values==`function`?async(...t)=>wn(e,await Promise.resolve(Fe(e.values,...t))):Tn(e,t)}}})),On,kn,An,jn=e((()=>{rt(),ye(),D(),i(),A(),Ce(),st(),Dn(),F(),g(),O(),ln(),On=({valuePath:e,textProperty:t,valueProperty:n},r)=>{let i=t?at(t):T(n),a=lt(e&&M(r,e)).map(i);return a.length>1?a.filter(Boolean).join(`,`):a[0]},kn=({valueProperty:e,valuePath:t,emptyValue:n,emptyProperty:r},i)=>{let a=T(e),o=T(r||e),s=new Set(i.filter(e=>e.excluded).map(e=>a(e.item))),c=new Set(i.filter(e=>!e.excluded).map(e=>a(e.item))),l=i.some(e=>e.excluded&&o(e.item)===n),u=i.some(e=>!e.excluded&&o(e.item)===n);return e=>{let n=lt(M(e,t)).map(a);return n.length===0?!l&&(u||c.size===0):!n.some(e=>s.has(e))&&(c.size===0||n.some(e=>c.has(e)))}},An=class extends En(P(k)){static get properties(){return{headerCellClass:{type:String,value:`autocomplete-header-cell`},minWidth:{type:String,value:`55px`},editMinWidth:{type:String,value:`55px`},keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},showSingle:{type:Boolean},preserveOrder:{type:Boolean},limit:{type:Number},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,showSingle:e.showSingle,preserveOrder:e.preserveOrder,limit:e.limit,textual:e.textual}}renderCell(e,{item:t}){return o`<span class="default-column"
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:n},r,i){return o`<cosmoz-autocomplete-excluding
			...
			.text=${n}
			.limit=${e.limit}
			@opened-changed=${e=>Sn(r)(e.detail.value)}
			@value-changed=${C(xn(r))}
			@text-changed=${C(Cn(r))}
			>${j(e.loading,()=>o`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-excluding
		>`}getComparableValue(e,t){return On(e,t)}getFilterFn(e,t){if(!(!t||!Array.isArray(t)||t.length===0))return kn(e,t)}},customElements.define(`cosmoz-omnitable-column-autocomplete-excluding`,An)})),Mn,Nn,Pn=e((()=>{rt(),ye(),D(),i(),A(),Ce(),st(),Dn(),F(),O(),ln(),Mn=({valuePath:e,textProperty:t,valueProperty:n},r)=>{let i=t?at(t):T(n),a=lt(e&&M(r,e)).map(i);return a.length>1?a.filter(Boolean).join(`,`):a[0]},Nn=class extends En(P(k)){static get properties(){return{headerCellClass:{type:String,value:`autocomplete-header-cell`},minWidth:{type:String,value:`55px`},editMinWidth:{type:String,value:`55px`},keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},showSingle:{type:Boolean},preserveOrder:{type:Boolean},limit:{type:Number},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,showSingle:e.showSingle,preserveOrder:e.preserveOrder,limit:e.limit,textual:e.textual}}renderCell(e,{item:t}){return o`<span class="default-column"
			>${e.getString(e,t)}</span
		>`}renderEditCell(e,{item:t},n){return o`<cosmoz-input
			no-label-float
			type="text"
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:n},r,i){return o`<cosmoz-autocomplete-ui
			...
			@opened-changed=${e=>Sn(r)(e.detail.value)}
			.onText=${Cn(r)}
			>${j(e.loading,()=>o`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}getComparableValue(e,t){return Mn(e,t)}},customElements.define(`cosmoz-omnitable-column-autocomplete`,Nn)})),Fn,In,Ln,Rn,zn,Bn,Vn,Hn,Un,Wn,Gn,Kn,qn,Jn,Yn=e((()=>{D(),F(),rt(),ze(),O(),i(),A(),Fn=(e,t)=>t.find(({value:t})=>e===t),In=(e,t,n)=>{let r=Fn(t,n);return r?r.text:e},Ln=(e,t,n,r)=>In(e,M(t,n),r),Rn=({valuePath:e},t,n)=>Fn(M(t,e),n),zn=e=>t=>{e(e=>({...e,filter:t?.[0]?.value??null}))},Bn=e=>t=>{e(e=>({...e,headerFocused:t}))},Vn=e=>t=>{e(e=>({...e,query:t}))},Hn=e=>t=>e(t?.[0]?.value),Un=({valuePath:e,trueLabel:t,falseLabel:n},r)=>M(r,e)?t:n,Wn=({valuePath:e},t)=>n=>M(n,e)===t,Gn=c((e,t)=>[{text:e,value:!0},{text:t,value:!1}]),Kn=({valuePath:e,trueLabel:t,falseLabel:n},r)=>e?M(r,e)?t:n:``,qn=(e,t)=>{try{return JSON.parse(t)}catch{return null}},Jn=class extends P(k){static get properties(){return{trueLabel:{type:String,value:`True`},falseLabel:{type:String,value:`False`},flex:{type:String,value:`0`},cellClass:{type:String,value:`boolean-cell`}}}getString(e,t){return Un(e,t)}renderCell(e,{item:t}){return Un(e,t)}renderEditCell(e,{item:t},n){let{trueLabel:r,falseLabel:i}=e;return o`<cosmoz-autocomplete
			no-label-float
			.title=${Ln(e.title,t,e.valuePath,Gn(r,i))}
			.source=${Gn(r,i)}
			.textProperty=${`text`}
			.value=${Rn(e,t,Gn(r,i))}
			.onChange=${Hn(n)}
			.limit=${1}
			>${j(e.loading,()=>o`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete
		>`}renderHeader(e,{filter:t,query:n},r,i){return o`<cosmoz-autocomplete-ui
			?disabled=${e.disabledFiltering}
			.label=${e.title}
			.title=${Ln(e.title,t,e.valuePath,i)}
			.source=${i}
			.textProperty=${`text`}
			.value=${Fn(t,i)}
			.text=${n}
			.onChange=${zn(r)}
			@opened-changed=${e=>Bn(r)(e.detail.value)}
			.onText=${Vn(r)}
			.limit=${1}
			>${j(e.loading,()=>o`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}computeSource({trueLabel:e,falseLabel:t}){return Gn(e,t)}getFilterFn(e,t){if(t!=null)return Wn(e,t)}toXlsxValue(e,t){return Kn(e,t)}deserializeFilter(e,t){return qn(e,t)}},customElements.define(`cosmoz-omnitable-column-boolean`,Jn)})),Xn,Zn=e((()=>{ve(),Pt(),Xn=e=>class extends Nt(e){static get properties(){return{max:{type:Date,value:null},min:{type:Date,value:null},_filterText:{type:String,computed:`_computeFilterText(filter.*, formatter)`},formatter:{type:Object,computed:`_computeFormatter(locale)`}}}toDate(e,t,n){if(e==null||e===``)return;let r=e;if(r instanceof Date||(typeof e==`string`&&(r=this.getAbsoluteISOString(r)),r=new Date(r)),Number.isNaN(r.getTime()))return null;if(n==null||t==null)return r;let i=this.toDate(t);if(i==null)return r;let a=this.getComparableValue(r);return n(a,this.getComparableValue(i))===a?r:i}toValue(){return this.toDate.apply(this,arguments)}getComparableValue(e,t){let n=super.getComparableValue(e,t);if(n!=null)return this.toNumber(n.getTime())}getString(e,t=this.valuePath,n=this.formatter){let r=this.toValue(this.get(t,e));return r===void 0?``:r===null?`Invalid Date`:this.renderValue(r,n)}getAbsoluteISOString(e){return e.length===19?e+this._getTimezoneString(e):e}_getTimezoneString(e){let t=-new Date(e).getTimezoneOffset()/60;return(t<0?`-`:`+`)+[`0`,Math.abs(t)].join(``).substr(-2)+`:00`}renderValue(e,t=this.formatter){if(t==null)return;let n=this.toValue(e);if(n!=null)return t.format(n)}_computeFormatter(e){return new Intl.DateTimeFormat(e||void 0)}_toInputString(e){let t=this.toValue(e);return t==null?null:this._toLocalISOString(t).slice(0,10)}_dateValueChanged(e){let t=e.currentTarget.value,n=e.model.item,r=this.get(this.valuePath,n),i=this._fromInputString(t);this.set(this.valuePath,i,n),this._fireItemChangeEvent(n,this.valuePath,r,this.renderValue.bind(this))}_toLocalISOString(e){return ce(e)}}})),Qn,$n=e((()=>{w(),D(),a(),i(),A(),Zn(),jt(),At(),It(),Qn=class extends Xn(Ft(k)){render(){let e=e=>{this.headerFocused=e.type===`focus`};return o`
			<style>
			...
			${j(this.disabled,()=>o`
				...
				`,()=>o`
					...
					${I({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:o`
						...
						`})}
				`)}
		`}_fromInputString(e,t){let n=this.toDate(e);if(n!=null)return t===`min`&&n.setHours(0,0,0,0),t===`max`&&n.setHours(23,59,59),n}_filterInputChanged(e,t){let n=e.path.split(`.`)[1]&&e.value;if(n&&n.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}},customElements.define(`cosmoz-omnitable-date-range-input`,Qn)})),er,tr,nr,U,W,rr,ir,ar,or,sr,cr,lr,ur,dr,fr,pr=e((()=>{ve(),O(),Gt(),er=e=>{let t=-new Date(e).getTimezoneOffset()/60;return(t<0?`-`:`+`)+[`0`,Math.abs(t)].join(``).substr(-2)+`:00`},tr=e=>e.length===19?e+er(e):e,nr=e=>{if(e==null||e===``)return;let t=e;return!(t instanceof Date)&&(typeof e==`string`&&(t=tr(t)),t=he(t),!t)||Number.isNaN(t.getTime())?null:t},U=({valuePath:e},t)=>{if(t==null)return;let n=t;e!=null&&(n=M(t,e));let r=nr(n);if(r!=null)return L(r.getTime())},W=(e,t,n)=>{let r=nr(e);if(r==null)return null;if(n==null||t==null)return r;let i=W(t);if(i==null)return r;let a=U({},r),o=U({},i);return a==null||o==null||n(a,o)===a?r:i},rr=(e,t)=>{if(t==null)return;let n=W(e);if(n!=null)return t.format(n)},ir={},ar=e=>{let t=e||``;return ir[t]||(ir[t]=new Intl.DateTimeFormat(e||void 0)),ir[t]},or=({valuePath:e,locale:t},n)=>{let r=M(n,e||``);return r===void 0?``:(r=W(r),r===null?`Invalid Date`:rr(r,ar(t)))},sr=e=>{let t=W(e);if(t==null)return null;let n=ce(t);return n==null?null:n.slice(0,10)},cr=({valuePath:e},t)=>sr(M(t,e||``)),lr=(e,t)=>{let n=W(e);if(n!=null)return t===`min`&&n.setHours(0,0,0,0),t===`max`&&n.setHours(23,59,59),n},ur=e=>sr(e)??``,dr=({valuePath:e},t)=>{if(!e)return``;let n=W(M(t,e));if(!n)return``;let r=W(ce(n));return r?(r.setHours(0,0,0,0),r):``},fr=(e,t)=>n=>{let r=U(e,n);if(r==null)return!1;let i=U({...e,valuePath:`min`},t),a=U({...e,valuePath:`max`},t);return!(r<(i??-1/0)||r>(a??1/0))}})),mr,hr=e((()=>{w(),D(),i(),F(),$n(),H(),pr(),mt(),mr=class extends P(k){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:`date-header-cell`},width:{type:String,value:`100px`},minWidth:{type:String,value:`82px`},flex:{type:String,value:`0`}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){let n=U({...e,valuePath:`min`},t),r=U({...e,valuePath:`max`},t);if(!(n==null&&r==null))return fr(e,t)}getString(e,t){return or(e,t)}toXlsxValue(e,t){return dr(e,t)}getComparableValue(e,t){return U(e,t)}serializeFilter(e,t){if(t==null)return;let n=W(t.min),r=W(t.max);if(!(n==null&&r==null))return ur(n)+`~`+ur(r)}deserializeFilter(e,t){if(typeof t!=`string`||t===``)return null;let n=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(n)?{min:W(n[1]),max:W(n[2])}:null}renderCell(e,{item:t}){return o`<div class="omnitable-cell-date">
			${or(e,t)}
		</div>`}renderEditCell(e,{item:t},n){return o`<cosmoz-input
			no-label-float
			type="date"
			@change=${e=>n(lr(e.target.value))}
			.value=${cr(e,t)}
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return dn(e,t)}},customElements.define(`cosmoz-omnitable-column-date`,mr)})),gr,_r=e((()=>{D(),a(),i(),A(),Zn(),jt(),At(),It(),gr=class extends Xn(Ft(k)){render(){let e=e=>{this.headerFocused=e.type===`focus`};return o`
			<style>
			...
			${j(this.disabled,()=>o`
				...
				`,()=>o`
					...
					${I({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:o`
						...
						`})}
				`)}
		`}_toInputString(e){let t=this.toValue(e);if(t!=null)return this._toLocalISOString(t).slice(0,19)}_computeFormatter(e){return new Intl.DateTimeFormat(e||void 0,{year:`numeric`,month:`numeric`,day:`numeric`,hour:`numeric`,minute:`numeric`})}},customElements.define(`cosmoz-omnitable-datetime-range-input`,gr)})),vr,yr,br,xr,Sr,Cr,wr=e((()=>{O(),pr(),vr={},yr=e=>{let t=e||``;return vr[t]||(vr[t]=new Intl.DateTimeFormat(e||void 0,{year:`numeric`,month:`numeric`,day:`numeric`,hour:`numeric`,minute:`numeric`})),vr[t]},br=({valuePath:e,locale:t},n)=>{let r=W(M(n,e||``));return r===void 0?``:r===null?`Invalid Date`:rr(r,yr(t))},xr=({valuePath:e},t)=>e?M(t,e):``,Sr=e=>{let t=W(e);return t==null?``:t.toISOString().slice(0,19).replace(/:/gu,`.`)},Cr=e=>{if(!(e==null||e===``)&&typeof e==`string`)return W(e.replace(/\./gu,`:`)+`Z`)}})),Tr,Er=e((()=>{Me(),mt(),D(),i(),F(),_r(),H(),pr(),wr(),Tr=class extends P(k){static get is(){return`cosmoz-omnitable-column-datetime`}static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:`datetime-header-cell`},width:{type:String,value:`210px`},minWidth:{type:String,value:`128px`},flex:{type:String,value:`0`},filterStep:{type:Number,value:1}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){let n=U({...e,valuePath:`min`},t),r=U({...e,valuePath:`max`},t);if(!(n==null&&r==null))return fr(e,t)}getString(e,t){return br(e,t)}toXlsxValue(e,t){return xr(e,t)}getComparableValue(e,t){return U(e,t)}serializeFilter(e,t){if(t==null)return;let n=W(t.min),r=W(t.max);if(!(n==null&&r==null))return Sr(n)+`~`+Sr(r)}deserializeFilter(e,t){if(typeof t!=`string`||t===``)return null;let n=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(n)?{min:Cr(n[1]),max:Cr(n[2])}:null}renderCell(e,{item:t}){return br(e,t)}renderEditCell(e,{item:t},n){return o`<cosmoz-input
			no-label-float
			type="text"
			@change=${e=>n(lr(e.target.value))}
			.value=${br(e,t)}
		...
		></cosmoz-omnitable-datetime-range-input>`}computeSource(e,t){return dn(e,t)}},customElements.define(Tr.is,Tr)})),Dr,Or=e((()=>{rt(),ye(),D(),i(),A(),Dn(),F(),Dr=class extends En(P(k)){renderCell({valuePath:e,textProperty:t},{item:n}){return o`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		`}renderEditCell(){return`not implemented`}renderHeader(e,{filter:t,query:n},r,i){return o`<cosmoz-autocomplete-ui
			...
			.onText=${Cn(r)}
			>${j(e.loading,()=>o`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}},customElements.define(`cosmoz-omnitable-column-list-horizontal`,Dr)})),kr,Ar,jr=e((()=>{v(),g(),a(),kr=E`
	:host {
		display: block;
	}
...
`,Ar=({items:e})=>{let[t,n]=x(!1),i=Array.isArray(e)?e:[],a=b(()=>Math.max(0,i.length-1),[i]);if(i.length===0)return null;let s=i.length>2,c=i[0],l=s&&!t?[]:i.slice(1),u=e=>{e.stopPropagation(),e.preventDefault(),n(e=>!e)};return o`
		<ul>
			<li>
				<span>${c}</span>
			</li>
	...
	`},customElements.define(`cosmoz-omnitable-column-list-data`,m(Ar,{styleSheets:[Ye(kr)]}))})),Mr,Nr=e((()=>{jr(),D(),i(),A(),rt(),Dn(),F(),ln(),Mr=class extends En(P(k)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:n}){return o`<cosmoz-omnitable-column-list-data
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:n},r,i){return o`<cosmoz-autocomplete-ui
			...
			.onText=${Cn(r)}
			>${j(e.loading,()=>o`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}},customElements.define(`cosmoz-omnitable-column-list`,Mr)})),Pr,Fr=e((()=>{w(),D(),a(),i(),A(),jt(),At(),Pt(),It(),Pr=class extends Nt(Ft(k)){static get properties(){return{maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null},formatter:{type:Object,computed:`_computeFormatter(locale, minimumFractionDigits, maximumFractionDigits)`},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:`_computeFilterText(filter.*, formatter)`},headerFocused:{type:Boolean,value:!1}}}render(){let e=e=>{this.headerFocused=e.type===`focus`,this._onDropdownOpenedChanged(e)};return o`
			<style>
				cosmoz-input[type='number'] {
					background: var(--cosmoz-omnitable-amount-input-background, #ffffff);
					border-radius: 6px;
			...
			${j(this.disabled,()=>o`
				...
				`,()=>o`
					<cosmoz-clear-button
						...
						?visible=${this.hasFilter()}
					></cosmoz-clear-button>
					${I({title:this.title,tooltip:this._tooltip,filterText:this._filterText,horizontalAlign:`right`,externalValues:this.externalValues,onOpenedChanged:e,content:o`
							<h3>${this.title}</h3>
							<cosmoz-input
								class=${this._fromClasses}
								type="number"
		...
		></cosmoz-omnitable-number-range-input>`}computeSource(e,t){return dn(e,t)}},customElements.define(`cosmoz-omnitable-column-number`,Ir)})),Rr,zr=e((()=>{w(),D(),a(),i(),A(),Zn(),jt(),At(),It(),Rr=class extends Xn(Ft(k)){render(){let e=e=>{this.headerFocused=e.type===`focus`};return o`
			${j(this.disabled,()=>o`
					<cosmoz-omnitable-dropdown-input
						disabled
						.label=${this.title}
				...
				`,()=>o`
					...
					${I({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:o`
						...
						`})}
				`)}
		`}get _fixedDate(){return`1970-01-01`}toDate(e,t,n){let r=typeof e==`string`&&e.length>3&&e.length<=9?this.getAbsoluteISOString(this._fixedDate+`T`+e):e;return super.toDate(r,t,n)}_toInputString(e){let t=this.toValue(e);return t==null?null:this._toLocalISOString(t).slice(11,19)}getComparableValue(e,t){if(e==null)return;let n=this._toInputString(t==null?e:this.get(t,e));if(n!=null&&(n=this.toValue(this.getAbsoluteISOString(this._fixedDate+`T`+n)),n!=null))return this.toNumber(n.getTime())}_timeValueChanged(e){let t=e.target.value,n=e.model.item,r=this.toDate(n.date),i=this.toDate(r==null?t:r.toISOString().slice(0,10)+`T`+t);i??(this.set(this.valuePath,i,n),this._fireItemChangeEvent(n,this.valuePath,r,(e=>e).bind(this)))}_computeFormatter(e){return new Intl.DateTimeFormat(e||void 0,{hour:`numeric`,minute:`numeric`,second:`numeric`})}},customElements.define(`cosmoz-omnitable-time-range-input`,Rr)})),G,Br,Vr,Hr,Ur,Wr,K,Gr,Kr,qr,Jr=e((()=>{ve(),O(),pr(),Gt(),G=(e,t,n)=>W(typeof e==`string`&&e.length>3&&e.length<=9?tr(`1970-01-01T`+e):e,t,n),Br={},Vr=e=>{let t=e||``;return Br[t]||(Br[t]=new Intl.DateTimeFormat(e||void 0,{hour:`numeric`,minute:`numeric`,second:`numeric`})),Br[t]},Hr=({valuePath:e,locale:t},n)=>{let r=G(M(n,e||``));return r===void 0?``:r===null?`Invalid Date`:rr(r,Vr(t))},Ur=(e,t)=>e.valuePath?Hr(e,t):``,Wr=e=>{let t=G(e);if(t==null)return null;let n=ce(t);return n&&n.slice(11,19)},K=({valuePath:e},t)=>{if(t==null)return;let n=Wr(e==null?t:M(t,e));if(n==null)return;let r=G(tr(`1970-01-01T`+n));return r==null?r:L(r.getTime())},Gr=(e,t)=>n=>{let r=K(e,n);if(r==null)return!1;let i=K({...e,valuePath:`min`},t),a=K({...e,valuePath:`max`},t);return i==null||a==null?!1:!(r<i||r>a)},Kr=e=>{let t=G(e);return t==null?``:t.toISOString().slice(11,19).replace(/:/gu,`.`)},qr=e=>{if(!(e==null||e===``))return G(typeof e==`string`?e.replace(/\./gu,`:`)+`Z`:e)}})),Yr,Xr=e((()=>{w(),mt(),D(),i(),F(),zr(),H(),Jr(),Yr=class extends P(k){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:`time-header-cell`},minWidth:{type:String,value:`63px`},width:{type:String,value:`210px`},flex:{type:String,value:`0`},filterStep:{type:String,value:`1`}}}getFilterFn(e,t){let n=K({...e,valuePath:`min`},t),r=K({...e,valuePath:`max`},t);if(!(n==null&&r==null))return Gr(e,t)}getString(e,t){return Hr(e,t)}toXlsxValue(e,t){return Ur(e,t)}getComparableValue(e,t){return K(e,t)}serializeFilter(e,t){if(t==null)return;let n=G(t.min),r=G(t.max);if(!(n==null&&r==null))return Kr(n)+`~`+Kr(r)}deserializeFilter(e,t){if(typeof t!=`string`||t===``)return null;let n=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(n)?{min:qr(n[1]),max:qr(n[2])}:null}renderCell(e,{item:t}){return Hr(e,t)}renderEditCell(e,{item:t},n){return o`<cosmoz-input
			no-label-float
			type="text"
			@change=${e=>n(e.target.value)}
			.value=${Hr(e,t)}
		></cosmoz-input>`}renderHeader({title:e,min:t,max:n,locale:r,filterStep:i,disabledFiltering:a},{filter:s},c,l){return o`<cosmoz-omnitable-time-range-input
			...
			@filter-changed=${({detail:{value:e}})=>c(t=>({...t,filter:e}))}
			@header-focused-changed=${({detail:{value:e}})=>c(t=>({...t,headerFocused:e}))}
		></cosmoz-omnitable-time-range-input>`}computeSource(e,t){return dn(e,t)}},customElements.define(`cosmoz-omnitable-column-time`,Yr)})),Zr=e((()=>{mn(),jn(),Pn(),Yn(),hr(),Er(),Or(),Nr(),Lr(),Xr()})),Qr,$r=e((()=>{g(),i(),Qr=({column:e,item:t,selected:r,folded:i,group:a})=>{if(!e)return n;let o=e.renderGroup??e.renderCell;return o?o(e,{item:t,selected:r,folded:i,group:a}):n},customElements.define(`cosmoz-omnitable-group-row`,m(Qr,{useShadowDOM:!1}))})),ei,ti=e((()=>{g(),i(),ei=e=>{let{column:t}=e;return S(()=>{let n=0,r=0,i=i=>{e.dispatchEvent(new CustomEvent(`column-resize`,{bubbles:!0,composed:!0,detail:{newWidth:Math.ceil(r+i.pageX-n),column:t}}))},a=()=>{document.removeEventListener(`pointermove`,i),document.removeEventListener(`pointerup`,a)},o=t=>{n=t.pageX,r=e.previousElementSibling.getBoundingClientRect().width,document.addEventListener(`pointermove`,i),document.addEventListener(`pointerup`,a)};return e.addEventListener(`pointerdown`,o),()=>e.removeEventListener(`pointerdown`,o)},[t]),n},customElements.define(`cosmoz-omnitable-resize-nub`,m(ei))})),ni,ri,ii,ai,oi=e((()=>{i(),ni=o`<svg
	width="10"
	height="9"
	viewBox="0 0 10 9"
	stroke="currentColor"
...
>
	...
	/>
</svg> `})),si,ci,li,ui,di=e((()=>{g(),Ie(),oi(),si=({column:e,on:t,descending:n,setOn:r,setDescending:i})=>{let{name:a,title:s}=e??{};return o`<button
		class="sg"
		title=${Se(s)}
	...
	>
		<span>${s}</span> ${ai}
	</button>`},ci=({columns:e,...t})=>e?.map(e=>si({column:e,...t})),li=()=>o`
...
`}));function fi(e,t,{suffix:n=``,read:r,write:i,ready:a=!0,multi:o}={}){let s=ut({param:t,suffix:n,link:o?gi:hi,write:i??Je}),c=b(()=>{if(t==null)return!1;if(o){let e=De(t+n);return Object.keys(e).length>0}return Ae(t+n)!==void 0},[]),[l,d]=x(()=>{if(t==null)return e;if(o){let i=De(t+n,r);return Object.keys(i).length>0?i:e}return Ae(t+n,r)??e}),f=u(e=>d(t=>{let n=Fe(e,t);return s.param!=null&&Pe(s.link(s.param+s.suffix,n,s.write),null,{notify:!1}),n}),[]);return S(()=>{s.param==null||!a||c||e!=null&&f(e)},[a]),[l,f]}var pi,mi,hi,gi,_i=e((()=>{qe(),He(),it(),nt(),g(),pi=e=>(t,n,r=Je)=>{let i=Be(),a=new URLSearchParams(i.hash.replace(`#`,``));return e(t,n,r,a),`#!`+Object.assign(i,{hash:a}).href.replace(location.origin,``)},mi=e=>e==null||e===``,hi=pi((e,t,n,r)=>mi(n(t))?r.delete(e):r.set(e,n(t))),gi=pi((e,t,n,r)=>{let i=Object.entries(t),a=i.map(n).filter(([,e])=>e!==void 0);if(a.length===0&&i.length>0)return;let o=e;Array.from(r.keys()).filter(e=>e.startsWith(o)).forEach(e=>r.delete(e)),a.forEach(([t,n])=>mi(n)?r.delete(e+t):r.set(e+t,n))})})),vi,yi,bi,xi,Si,Ci=e((()=>{g(),_i(),vi=e=>[!0,`true`,1,`yes`,`on`].includes(e),yi=e=>e===``||(e==null?void 0:vi(e)),bi=(e,t,n)=>u(r=>{e(r),n(e=>({...e,[t]:r}))},[e,t,n]),xi=(e,t,{settings:n,setSettings:r,resetRef:i,ready:a=!0})=>{let[o,s]=fi(n.sortOn,t,{suffix:`-sortOn`,ready:a}),[c,l]=fi(yi(n.descending),t,{suffix:`-descending`,read:yi,ready:a}),[d,f]=fi(n.groupOn,t,{suffix:`-groupOn`,ready:a}),[p,m]=fi(yi(n.groupOnDescending),t,{suffix:`-groupOnDescending`,read:yi,ready:a}),h=b(()=>e.find(e=>e.name===o),[e,o]),g=b(()=>e.find(e=>e.name===d),[e,d]),_={groupOn:d,setGroupOn:bi(f,`groupOn`,r),groupOnDescending:p,setGroupOnDescending:bi(m,`groupOnDescending`,r),sortOn:o,setSortOn:bi(s,`sortOn`,r),descending:c,setDescending:bi(l,`descending`,r),columns:e},v=b(()=>_,Object.values(_)),y=u(e=>{s(e.sortOn),f(e.groupOn),l(e.descending),m(e.groupOnDescending)},[]);return S(()=>void(i.current=y),[]),{...v,sortAndGroup:v,groupOnColumn:g,sortOnColumn:h}},Si=ae(),customElements.define(`sort-and-group-provider`,Si.Provider),customElements.define(`sort-and-group-consumer`,m(({render:e})=>e(me(Si)),{useShadowDOM:!1}))})),wi,Ti,Ei=e((()=>{g(),ie(),ti(),di(),A(),Ci(),wi=({data:e,columns:t,groupOnColumn:n,filters:r,setFilterState:i,sortAndGroup:{sortOn:a,setSortOn:s,descending:c,setDescending:l}={}})=>p(t,e=>e.name,t=>[o`<div
			...
			>
				...
				${j(!t.noSort,()=>si({on:a,setOn:s,descending:c,setDescending:l,column:t}))}
			</div>`,o`<cosmoz-omnitable-resize-nub
				.column="${t}"
				name="${t.name}"
			></cosmoz-omnitable-resize-nub>`]),Ti=({columns:e,settingsConfig:t,hideSelectAll:n,...r})=>{let i=me(Si);return o`
		${j(e,e=>wi({columns:e,sortAndGroup:i,...r}))}
		${j(!n,()=>o` <cosmoz-omnitable-settings
					.config=${t}
					part="settings"
				></cosmoz-omnitable-settings>`)}
	`},customElements.define(`cosmoz-omnitable-header-row`,m(Ti,{useShadowDOM:!1}))})),Di,Oi,ki=e((()=>{v(),g(),Di=E`
	:host {
		display: flex;
		align-items: center;
		flex-wrap: wrap;
...
`,customElements.define(`cosmoz-omnitable-item-expand-line`,m(Oi,{styleSheets:[Ye(Di)]}))})),Ai,ji=e((()=>{g(),i(),$e(),ki(),Ai=({columns:e,item:t,selected:n,expanded:r,groupOnColumn:i})=>Te(e,e=>o`<cosmoz-omnitable-item-expand-line
				.column=${e}
				?hidden=${e===i}
				exportparts="item-expand-label, item-expand-value"
				>${e.renderCell(e,{item:t,selected:n,expanded:r})}</cosmoz-omnitable-item-expand-line
			>`),customElements.define(`cosmoz-omnitable-item-expand`,m(Ai,{useShadowDOM:!1}))})),Mi,Ni,Pi=e((()=>{g(),ie(),Mi=(e,t,n)=>e.editable?e.renderEditCell(e,t,n(e,t.item)):e.renderCell(e,t),Ni=({columns:e,groupOnColumn:t,item:n,index:r,selected:i,expanded:a,onItemChange:s})=>p(e,e=>e.name,e=>o`<div
				...
				name="${e.name}"
			>
				${Mi(e,{item:n,index:r,selected:i,expanded:a},s)}
			</div>`),customElements.define(`cosmoz-omnitable-item-row`,m(Ni,{useShadowDOM:!1}))})),Fi,Ii,Li=e((()=>{v(),Fi=E`
	.checkbox {
		box-sizing: border-box;
		width: 18px;
		height: 18px;
...
`})),Ri,zi,Bi=e((()=>{xe(),Ri=e=>{let t=e.replace(/"/gu,`""`);return t.search(/("|,|\n)/gu)>=0?`"`+t+`"`:e},zi=(e,t,n)=>{let r=e.map(e=>Ri(e.title)).join(`;`)+`
`,i=t.map(t=>e.map(e=>{let n=e.getString(e,t);return n==null?``:Ri(String(n))}).join(`;`)+`
`);i.unshift(r),Ge(new File(i,n,{type:`text/csv;charset=utf-8`}))}})),Vi,Hi,Ui=e((()=>{Ue(),xe(),Vi=(e,t)=>{let n=e.map(e=>e.title),r=t.map(t=>e.map(e=>e.toXlsxValue(e,t)??``));return r.unshift(n),r},Hi=(e,t,n,r)=>{let i=Vi(e,t),a=new Ze(n).addSheetFromData(i,r).generate();Ge(new File([a],n,{type:`application/vnd.openxmlformats-officedocument.spreadsheetml.sheet`}))}})),Wi,Gi=e((()=>{s(),a(),i(),Bi(),Ui(),Wi=({columns:e,selectedItems:t,csvFilename:n,xlsxFilename:i,xlsxSheetname:a,topPlacement:s})=>o`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!ke(t.length)}
		part="bottomBar"
	...
	>
	...
	</cosmoz-bottom-bar>`})),Ki,qi=e((()=>{i(),A(),Ki=({allSelected:e,onAllCheckboxChange:t,sortAndGroup:n,dataIsValid:r,data:i,columns:a,filters:s,groupOnColumn:c,setFilterState:l,settingsConfig:u,hideSelectAll:d})=>o`<sort-and-group-provider .value=${n}>
		<div class="header" id="header" part="header">
			${j(!d,()=>o`<input
						...
						part="all"
					/>`)}
			${j(d,()=>o` <cosmoz-omnitable-settings
						.newLayout="${!0}"
						.config=${u}
					></cosmoz-omnitable-settings>`)}
	...
	</sort-and-group-provider>`})),Ji,Yi,Xi=e((()=>{g(),Ji=Xe`
	:host {
		max-width: 100%;
		overflow-x: hidden;
		padding: 0 12px;
...
`,Yi=({settingsConfig:e})=>{let{columns:t,collapsed:n}=e,r=t.filter(e=>!n.some(t=>t.name===e.name));return o`<div class="skeleton">
	...
	</div>`},customElements.define(`cosmoz-omnitable-skeleton`,m(Yi,{styleSheets:[Ji]}))})),Zi,Qi=e((()=>{g(),Xi(),_e(),a(),i(),A(),Zi=(e,t)=>{let{settingsConfig:n}=e,{processedItems:i,dataIsValid:a,filterIsTooStrict:s,loading:c,displayEmptyGroups:l,compareItemsFn:u,selectedItems:d,setSelectedItems:f,renderItem:p,renderGroup:m,inline:h,error:g}=t;return o`${j(!c&&!a&&!g,()=>o`<div class="tableContent-empty">
		...
		${j(s,()=>o`<div class="tableContent-empty">
					${Oe({width:`96px`,height:`96px`,styles:`margin-right: 24px; fill: currentColor;`})}
					<div>
		...
		${j(c&&!i.length,()=>o`<div class="tableContent-empty overlay">
					<cosmoz-omnitable-skeleton
						.settingsConfig=${n}
					></cosmoz-omnitable-skeleton>
				</div>`)}
		${j(c&&i.length,()=>o`<div class="tableContent-empty overlay spinner">
					<cz-spinner></cz-spinner>
				</div>`)}
		${j(g,()=>o`<div class="tableContent-empty overlay">
...
`})),na,ra,ia=e((()=>{it(),g(),na=e=>{let t=parseInt(e,10);return isFinite(t)?t:void 0},ra=e=>{let{config:t}=e,{settings:n,setSettings:r,collapsed:i,requestTween:a}=t,o=ut({collapsed:i,settings:n.columns,requestTween:a,setSettings:u(e=>r(t=>({...t,columns:e})),[r])});return{...t,onDown:u(e=>{e.target.closest(`.pull`)&&(o.handle=e.currentTarget)},[o]),onDragStart:u(e=>{let{target:t}=e,n=na(t.dataset.index);if(!o.handle?.contains(t)||n==null)return e.preventDefault();o.handle=null,e.dataTransfer.effectAllowed=`move`,e.dataTransfer.setData(`omnitable/sort-index`,n),e.dataTransfer.setData(`text/plain`,n),setTimeout(()=>t.classList.add(`drag`),0),t.addEventListener(`dragend`,e=>e.target.classList.remove(`drag`),{once:!0})},[o]),onDragEnter:u(e=>{let t=e.currentTarget;t===e.target&&(e.preventDefault(),e.dataTransfer.dropEffect=`move`,t.classList.add(`dragover`))},[]),onDragOver:u(e=>{e.preventDefault(),e.currentTarget.classList.add(`dragover`)},[]),onDragLeave:u(e=>{let t=e.currentTarget;t.contains(e.relatedTarget)||t.classList.remove(`dragover`)},[]),onDrop:u(e=>{let t=na(e.dataTransfer.getData(`omnitable/sort-index`)),n=na(e.currentTarget.dataset.index),{settings:r,setSettings:i,requestTween:a}=o;e.currentTarget.classList.remove(`dragover`),e.preventDefault();let s=r.slice();s.splice(n+(t>=n?0:-1),0,s.splice(t,1)[0]),a?.(),i(s)},[o]),onToggle:u(e=>{let{settings:t,setSettings:n,requestTween:r}=o,i=t.map(e=>({...e,disabled:e.disabled||o.collapsed?.some(t=>t.name===e.name)})),a=na(e.target.closest(`[data-index]`)?.dataset.index);i.splice(a,1,{...t[a],disabled:!e.target.checked,priority:e.target.checked?t.reduce((e,t)=>Math.max(e,t.priority),0)+1:t[a].priority}),r?.(),n(i)},[o])}}})),aa,oa,sa,ca,la=e((()=>{tt(),ct(),v(),s(),g(),a(),A(),oi(),di(),ta(),ia(),aa=[f({apply({availableHeight:e,elements:t}){Object.assign(t.floating.style,{maxHeight:`${Math.max(0,e)}px`})}}),...we],oa=({onDragStart:e,onDragEnter:t,onDragOver:n,onDragLeave:r,onDrop:i,onDown:a,onToggle:s,collapsed:c,filters:l})=>(u,d)=>{let f=!!c?.find(e=>e.name===u.name),p=!u.disabled&&!f;return o` <div
			class="item"
			data-index=${d}
			@mousedown=${a}
			draggable="true"
		...
		>
			...
			<input
				...
				.indeterminate=${f}
			/>
		</div>`},sa=e=>{let{settings:t,settingsId:n,onSave:i,onReset:a,hasChanges:s,opened:c,setOpened:l,...u}=ra(e);return o` <div class="headline">
			${r(`Sort and filter`)}
			<button
				class="close"
		...
		${j(n,()=>o`<div class="buttons">
				...
				</div>`)}`},customElements.define(`cosmoz-omnitable-settings-ui`,m(sa,{styleSheets:[Ye($i)]})),ca=({config:e,newLayout:t})=>o`
	<cosmoz-dropdown
		.placement="${t?`bottom-start`:`bottom-end`}"
		.middleware="${aa}"
	>
		<div title="${r(`Sort and filter`)}" slot="button">
			${j(t,()=>o`<div class="headerDots">...</div>`,()=>o` <svg viewBox="0 0 24 24" width="24" fill="currentColor">
						<circle cx="10" cy="18" r="2"></circle>
						<circle cx="10" cy="12" r="2"></circle>
						<circle cx="10" cy="6" r="2"></circle>
					</svg>`)}
			${j(e?.badge,()=>o`<div class="badge"></div>`)}
		</div>
		<cosmoz-omnitable-settings-ui
...
`,customElements.define(`cosmoz-omnitable-settings`,m(ca,{styleSheets:[Ye(ea)]}))})),ua,da,fa,pa,ma,ha=e((()=>{st(),ua=[`sortOn`,`descending`,`groupOn`,`groupOnDescending`],da=e=>t=>typeof t==`object`&&!!t&&`name`in t&&t.name===e,fa=(e=[],t=[],n=[])=>{let r=t.filter(t=>e.some(da(t.name))),i=e.filter(e=>e.name!=null&&!t.some(da(e.name))&&!n.some(da(e.name))),a=n.filter(e=>!t.some(da(e.name)));return[...r,...a.flatMap(t=>{let n=e.find(e=>e.name===t.name);return n?{...t,title:n.title??t.title??``,minWidth:parseInt(n.minWidth??`0`,10)}:[]}),...i.map(e=>{let{name:t,title:n,priority:r,minWidth:i,width:a,flex:o}=e;return{name:t??``,title:n??``,priority:r??0,minWidth:parseInt(i??`0`,10),width:parseInt(a??`0`,10),flex:parseInt(o??`0`,10)}})]},pa=(e,t)=>({...t,...d(Array.from(ua))(e),columns:e.columns?.map(d([`name`,`priority`,`width`,`flex`,`disabled`]))}),ma=({columns:e,settings:t,savedSettings:n,initial:r})=>({...Object.fromEntries(ua.flatMap(e=>r?.[e]==null?[]:[[e,r[e]]])),...n?d(Array.from(ua))(n):{},...t,columns:fa(e,t?.columns,n?.columns)})})),ga,_a=e((()=>{ga=({prefix:e=`omnitable-`}={})=>({write:async(t,n)=>{let r=e+t;try{n?localStorage.setItem(r,JSON.stringify(n)):localStorage.removeItem(r)}catch(e){console.error(e)}},read:async t=>{if(!t)return null;try{let n=localStorage.getItem(e+t);return n==null?null:JSON.parse(n)}catch(e){return console.error(e),null}}})})),va,ya,ba=e((()=>{g(),_a(),va=ae(ga),ya=()=>{let e=me(va);return b(()=>e(),[e])}})),xa=e((()=>{ba(),_a()})),Sa,Ca=e((()=>{g(),xa(),ha(),Sa=(e,t,n,r)=>{let[i,a]=x(e?void 0:null),{read:o,write:s}=ya();return S(async()=>{e&&a(await o(e))},[e,o]),{settingsId:e,savedSettings:i,onSave:u(async()=>{if(!e)return;let r=pa(t,i);await s(e,r),n(),a(r)},[t,i]),onReset:u(async t=>{n(),t.shiftKey&&(await s(e),a(null)),r?.()},[r]),hasChanges:t!=null}}})),wa,Ta=e((()=>{g(),ln(),ha(),Ca(),wa=({settingsId:e,host:t})=>{let n=b(()=>Object.fromEntries(ua.map(e=>[e,t[e]])),[]),r=Re(),i=u(()=>{r.current?.(n)},[n]),[a,o]=x(),[s,c]=x({columns:!0,sort:!0}),{savedSettings:l,...d}=Sa(e,a,o,i),{enabledColumns:f,disabledFiltering:p}=t,m=cn(t,{enabledColumns:f,disabledFiltering:p}),h=b(()=>ma({columns:m,settings:a,savedSettings:l,initial:n}),[m,a,l]),g=b(()=>h.columns.map(e=>m.find(t=>t.name===e.name)).filter(Boolean),[m,...h.columns.map(e=>e.name)]);return{...d,savedSettings:l,opened:s,setOpened:c,settings:h,columns:g,setSettings:o,resetRef:r}}})),Ea=e((()=>{la(),Ta()})),Da,Oa,ka=e((()=>{Da=e=>Number.isFinite(e)?e:0,Oa=(e,t)=>{let n=[],[r,i]=e.reduce(([e,t],{width:n,flex:r})=>[e+n,t+r],[0,0]),a=t-r,o=Da(a/i),s=0,c=0,l=0;for(let t=0;t<e.length;t++){let{width:i,minWidth:u,flex:d}=e[t];if(u>i+(a>=0?o*d:i*a/r)){s+=i,c+=u,l+=d,n[t]=u;continue}if(d===0){s+=i,c+=i,n[t]=i;continue}}r-=s,a=t-c-r,i-=l,o=Da(a/i);for(let t=0;t<e.length;t++){if(n[t]!=null)continue;let{width:i,flex:s}=e[t];n[t]=i+(a>=0?o*s:i*a/r)}return n}})),Aa,ja,Ma=e((()=>{Aa=Symbol(`index`),ja=(e,t)=>{if(typeof e.findLastIndex==`function`)return e.findLastIndex(t);for(let n=e.length-1;n>=0;n--)if(t(e[n],n,e))return n;return-1}})),Na,Pa,Fa,Ia=e((()=>{ka(),Ma(),Na=(e,t)=>{let n=ja(e,e=>e!=null&&e>0),r=(e,t)=>`.cell[name="${e}"], cosmoz-omnitable-skeleton::part(cell-${e}){width: ${Math.floor(t)}px;padding: 0 min(3px, ${t/2}px)}`,i=e=>`cosmoz-omnitable-resize-nub[name="${e}"]{display:none}`,a=e=>`cosmoz-omnitable-resize-nub[name="${e}"], .cell[name="${e}"]{display:none}`;return t.map((t,o)=>{let s=e[o];if(s==null||s===0)return a(t.name);let c=r(t.name,s);return o===n?`${c}\n${i(t.name)}`:c}).join(`
`)},Pa=(e,t,n)=>{let r=e.filter(e=>!e.hidden),i=r.reduce((e,{width:t})=>e+t,0);if(r.length>1&&i>t)return Pa(r.slice(1),t,n);let a=r.reduce(([e,t],n,r)=>[Math.max(e,n.index),n.index>e?r:t],[-1,-1])[1];return a!==-1&&(r[a].flex=1),Oa(r,t).reduce((e,t,n)=>(e[r[n].index]=t,e),Array(n).fill(void 0))},Fa=(e,t)=>e.length===0?`.cell {display: none;}`:Na(e,t)})),La,Ra=e((()=>{g(),La=(e,t)=>S(()=>{let n=new ResizeObserver(([e])=>{e.contentRect?.width!==0&&t(e.contentRect.width-88)});return n.observe(e),()=>n.unobserve(e)},[])})),za,Ba=e((()=>{g(),Ra(),za=e=>{let[t,n]=x(()=>e.getBoundingClientRect().width-88);return La(e,n),t}})),Va,Ha=e((()=>{g(),Ia(),Va=({canvasWidth:e,groupOnColumn:t,config:n,miniColumn:r})=>b(()=>{if(!Array.isArray(n)||e==null||e===0)return[];let i=n.map((e,n)=>({minWidth:e.minWidth,width:e.width,flex:e.flex,priority:e.priority,name:e.name,index:n,hidden:e.name===t?.name||e.disabled})).map(e=>r?{...e,hidden:r.name!==e.name}:e).sort(({index:e,priority:t},{index:n,priority:r})=>t===r?n-e:t-r);return Pa(i,e,i.length)},[e,t,n])})),Ua,Wa=e((()=>{g(),Ua=({host:e,canvasWidth:t,columns:n})=>{let r=e.miniBreakpoint??480,i=b(()=>t<=r,[t,r]),[a,...o]=b(()=>i?n?.filter(e=>e.mini!=null).sort((e,t)=>(e.mini??0)-(t.mini??0)):[],[n,i])??[],s=!!a;return S(()=>{e.toggleAttribute(`mini`,s)},[s]),{isMini:s&&i,miniColumn:a,miniColumns:o}}})),Ga,Ka=e((()=>{g(),Ga=({host:e,canvasWidth:t,layout:n,setSettings:r,requestTween:i})=>{let a=Re();a.current=e=>{i(),r(r=>{let i=r.columns,{detail:{newWidth:a,column:o}}=e,s=i.findIndex(e=>e.name===o.name),c=[],l=i.reduce((e,t)=>Math.max(e,t.priority),-1/0);for(let e=0;e<n.length;e++)if(c[e]={...i[e]},e<s&&n[e]&&(c[e].width=n[e],c[e].flex=0,c[e].priority=l),e===s){let r=n.reduce((e,t,n)=>n<s&&t?e-t:e,t);c[e].width=Math.min(r,Math.max(a,i[e].minWidth)),c[e].flex=0,c[e].priority=l}return{...r,columns:c}})},S(()=>{let t=e=>a.current?.(e);return e.addEventListener(`column-resize`,t),()=>e.removeEventListener(`column-resize`,t)},[])}})),qa,Ja,Ya,Xa=e((()=>{He(),it(),g(),qa=(e,t)=>{let n=b(()=>{let t=!1,n,r=()=>{t&&(n=requestAnimationFrame(r),e()&&(t=!1))};return{start:()=>{t=!0,cancelAnimationFrame(n),n=requestAnimationFrame(r)},stop:()=>{t=!1,cancelAnimationFrame(n)}}},[]);S(()=>{n.start()},t),S(()=>()=>n.stop(),[])},Ja=(e=0,t=0)=>Math.abs(e-t)<.1,Ya=(e,t=1.9,n=Ne,r)=>{let i=ut({target:e,speedFactor:t,onConverge:r});qa(u(()=>{if(!i.tween)return i.tween=i.target,n(i.tween),i.onConverge?.(),!0;if(i.target.every((e,t)=>i.tween[t]===e))return n(i.tween),i.onConverge?.(),!0;if(i.tween=i.target.map((e,t)=>Ja(i.tween[t],e)?e:(i.tween[t]??0)+((e??0)-(i.tween[t]??0))/i.speedFactor||0),n(i.tween),i.tween.every((e,t)=>e===i.target[t]))return i.onConverge?.(),!0},[]),[e])}})),Za,Qa,$a=e((()=>{it(),g(),Ia(),Ba(),Ha(),Wa(),Ka(),Xa(),Za=e=>{let t=b(()=>new CSSStyleSheet,[]);return S(()=>{e.shadowRoot.adoptedStyleSheets=[...e.shadowRoot.adoptedStyleSheets,t]},[]),t},Qa=({host:e,columns:t,settings:n,setSettings:r,resizeSpeedFactor:i,sortAndGroupOptions:a})=>{let o=za(e),{isMini:s,miniColumn:c,miniColumns:l}=Ua({host:e,canvasWidth:o,columns:t}),{groupOnColumn:d}=a,f=Va({canvasWidth:o,groupOnColumn:d,miniColumn:c,config:n.columns}),p=Za(e),m=b(()=>n.columns.reduce((e,n,r)=>f[r]!=null||n.name===d?.name||n.disabled?e:[...e,t.find(e=>e.name===n.name)],[]),[t,n,f]),[h,g]=x(1),_=u(()=>g(i??1.9),[i]),v=u(()=>g(1),[]),y=ut({columns:n.columns});return Ya(f,h,e=>{let t=Fa(e,y.columns);p.replace(t)},v),Ga({host:e,canvasWidth:o,layout:f,setSettings:e=>r(e(n)),requestTween:_}),{isMini:s,collapsedColumns:m,miniColumns:l,requestTween:_}}})),eo,to=e((()=>{eo=({host:e,...t})=>{let{csvFilename:n=`omnitable.csv`,xlsxFilename:r=`omnitable.xlsx`,xlsxSheetname:i=`Omnitable`,topPlacement:a=`top-end`}=e;return{csvFilename:n,xlsxFilename:r,xlsxSheetname:i,topPlacement:a,...t}}})),no,ro=e((()=>{g(),no=({host:e,selectedItems:t,data:n,sortAndGroupOptions:r,collapsedColumns:i,settings:a,filterFunctions:o,settingS:s,filters:c,requestTween:l,...u})=>{let d=n&&n.length>0&&t.length===n.length,f=t=>{t.target.checked?e.shadowRoot.querySelector(`#groupedList`).selectAll():e.shadowRoot.querySelector(`#groupedList`).deselectAll()},{groupOnColumn:p}=r,m=b(()=>[p,...i,...a.columns.filter(e=>e.disabled)].some(e=>e&&Object.keys(o).includes(e.name)),[o,a,i]),h=b(()=>({...s,collapsed:i,badge:m,filters:c,requestTween:l}),[s,i,m,c,l]);return S(()=>{let t=e.shadowRoot.querySelector(`#tableContent`),n=new ResizeObserver(t=>requestAnimationFrame(()=>{e.style.setProperty(`--ot-height`,t[0]?.contentRect.height+`px`)}));return n.observe(t),()=>n.unobserve(t)},[]),{allSelected:d,onAllCheckboxChange:f,data:n,settingsConfig:h,filters:c,groupOnColumn:p,sortAndGroup:r.sortAndGroup,...u}}})),io,ao,oo,so,co,lo,uo=e((()=>{s(),g(),A(),Ma(),H(),io=o`
	<svg
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
...
`,ao=e=>e?`groupRow groupRow-folded`:`groupRow`,oo=({item:e,index:t})=>n=>j(n?.length>0,()=>o`
			...
			`),so=({columns:e,collapsedColumns:t,miniColumns:n,onItemClick:r,onCheckboxChange:i,dataIsValid:a,groupOnColumn:s,onItemChange:c,rowPartFn:l})=>(u,d,{selected:f,expanded:p,toggleCollapse:m})=>o`
		<div
			?selected=${f}
	...
	`,co=({onCheckboxChange:e,dataIsValid:t,groupOnColumn:n})=>(r,i,{selected:a,folded:s,toggleFold:c})=>o` <div
			class="${ao(s)}"
		...
		</div>`,lo=({host:e,error:t,dataIsValid:n,processedItems:r,columns:i,collapsedColumns:a,miniColumns:o,sortAndGroupOptions:s,rowPartFn:c,...l})=>{let{loading:d=!1,displayEmptyGroups:f=!1,compareItemsFn:p,inline:m}=e,h=Re({shiftKey:!1,ctrlKey:!1}),g=u(t=>{let n=t.target.dataItem,r=t.target.checked;h.current.shiftKey?e.shadowRoot.querySelector(`#groupedList`).toggleSelectTo(n,r):h.current.ctrlKey?(t.target.checked=!0,e.shadowRoot.querySelector(`#groupedList`).selectOnly(n)):e.shadowRoot.querySelector(`#groupedList`).toggleSelect(n,r),t.preventDefault(),t.stopPropagation()},[]);S(()=>{let e=({shiftKey:e,ctrlKey:t})=>{h.current={shiftKey:e,ctrlKey:t}};return window.addEventListener(`keydown`,e),window.addEventListener(`keyup`,e),()=>{window.removeEventListener(`keydown`,e),window.removeEventListener(`keyup`,e)}},[]);let _=u(t=>{let n=t.composedPath();n.slice(0,n.indexOf(t.currentTarget)).find(e=>e.matches?.(`a, .checkbox, .expand`))||e.dispatchEvent(new window.CustomEvent(`omnitable-item-click`,{bubbles:!0,composed:!0,detail:{item:t.currentTarget.dataItem,index:t.currentTarget.dataIndex}}))},[]),{groupOnColumn:v}=s,y=u((t,n)=>r=>fn(e,t,n,r),[]);return{...l,processedItems:r,dataIsValid:n,filterIsTooStrict:n&&r.length<1,loading:d,compareItemsFn:p,displayEmptyGroups:f,inline:m,error:t,renderItem:b(()=>so({columns:i,collapsedColumns:a,miniColumns:o,onItemClick:_,onCheckboxChange:g,dataIsValid:n,groupOnColumn:v,onItemChange:y,rowPartFn:c}),[i,a,_,g,n,v,y,c]),renderGroup:b(()=>co({onCheckboxChange:g,dataIsValid:n,groupOnColumn:v}),[g,n,v])}}})),fo,po=e((()=>{fo=(e,t)=>{if(e===t)return 0;if(e==null)return-1;if(t==null)return 1;let n=typeof e,r=typeof t;return n===`object`&&r===`object`?e.toString()<t.toString()?-1:1:n===`number`&&r===`number`?e-t:n===`string`&&r===`string`?e<t?-1:1:n===`boolean`&&r===`boolean`?e?-1:1:(console.warn(`unsupported sort`,n,e,r,t),0)}})),mo,ho,go,_o,vo,yo,bo=e((()=>{He(),g(),po(),ln(),_i(),Ma(),mo=(e,t)=>(n,r)=>fo(e(n),e(r))*(t?-1:1),ho=e=>e.replace(/([a-z0-9])([A-Z])/gu,`$1-$2`).toLowerCase(),go=(e,t)=>{!e||!t||Object.entries(t).forEach(([t,n])=>{e[V].__ownChange=!0,e[V][t]=n,e[V].__ownChange=!1,e[V].dispatchEvent(new CustomEvent(`${ho(t)}-changed`,{bubbles:!0,detail:{value:n}}))})},_o=(e,t)=>Object.assign(e,{[Aa]:t}),vo=Symbol(`unparsed`),yo=({data:e,columns:t,hashParam:n,sortAndGroupOptions:r,noLocalSort:i,noLocalFilter:a})=>{let{groupOnColumn:o,groupOnDescending:s,sortOnColumn:c,descending:l}=r,d=u(([e,n])=>{let r=t.find(({name:t})=>t===e);return r==null?[e,void 0]:[e,n.filter&&r.serializeFilter(r,n.filter)]},[t]),f=u(([e,n])=>{let r=t.find(({name:t})=>t===e);if(r==null)return[e,{[vo]:n}];let i={filter:r.deserializeFilter(r,n)};return go(r,i),[e,i]},[t]),[p,m]=fi({},n,{multi:!0,suffix:`-filter--`,write:d,read:f}),h=u((e,n)=>m(r=>{let i=Fe(n,r[e]);return go(t.find(t=>t.name===e),i),{...r,[e]:{...r[e],...i}}}),[t,m]),g=b(()=>Object.fromEntries(t.map(e=>[e.name,!e.noLocalFilter&&e.getFilterFn(e,p[e.name]?.filter)]).filter(([,e])=>!!e)),[t,...b(()=>Object.values(p).map(e=>e.filter),[p])]),_=b(()=>!Array.isArray(e)||e.length===0?[]:Object.entries(g).length===0||a?e.slice():e.filter(e=>Object.values(g).every(t=>t(e))),[e,g,a]),v=b(()=>{if(!i&&!o&&c!=null&&c.sortOn!=null)return _.slice().sort(mo(e=>c.getComparableValue({...c,valuePath:c.sortOn},e),l));if(o!=null&&o.groupOn!=null){let e=_.reduce((e,t)=>{let n=o.getComparableValue({...o,valuePath:o.groupOn},t);if(n===void 0)return e;let r=e.find(e=>e.id===n);return r?(r.items.push(t),e):(r={id:n,name:n,items:[t]},[...e,r])},[]);return e.sort(mo(e=>o.getComparableValue({...o,valuePath:o.groupOn},e.items[0]),s)),!c||i?e:e.filter(e=>Array.isArray(e.items)).map(e=>(e.items.sort(mo(e=>c.getComparableValue({...c,valuePath:c.sortOn},e),l)),e))}return _},[_,o,s,c,l,i]),y=b(()=>{let e=0,t=0,n=[];return v.forEach(r=>{if(Array.isArray(r.items)){_o(r,t++),r.items.forEach(t=>{_o(t,e++),n.push(t)});return}return _o(r,e++),n.push(r)},[]),n},[v]);return S(()=>{m(e=>Object.values(e).some(e=>e[vo]!=null)?Object.fromEntries(Object.entries(e).map(([e,t])=>t[vo]==null?[e,t]:f([e,t[vo]]))):e)},[f]),{processedItems:v,visibleData:y,filters:p,filterFunctions:g,setFilterState:h}}})),xo,So,Co=e((()=>{fe(),dt(),g(),xo=e=>{let t=t=>{let n=e.data.indexOf(t);if(n<0)return null;let r=e.data.splice(n,1);if(e.data=e.data.slice(),Array.isArray(r)&&r.length>0)return r[0]},n=(t,n)=>{e.data.splice(t,1,n),e.data=e.data.slice()};return{removeItem:t,removeItems(t){let n=[];for(let r=t.length-1;r>=0;--r){let i=e.removeItem(t[r]);i!=null&&n.push(i)}return n},replaceItemAtIndex:n,replaceItem(t,r){let i=e.data.indexOf(t);if(i>-1)return n(i,r)},selectItem(t){e.shadowRoot.querySelector(`#groupedList`).select(t)},selectAll(){e.shadowRoot.querySelector(`#groupedList`).selectAll()},deselectAll(){e.shadowRoot.querySelector(`#groupedList`).deselectAll()},deselectItem(t){e.shadowRoot.querySelector(`#groupedList`).deselect(t)},isItemSelected(t){return e.shadowRoot.querySelector(`#groupedList`).isItemSelected(t)}}},So=({host:e,visibleData:t,filters:n,...r})=>{let{setFilterState:i}=r,a=b(()=>xo(e),[]),[o,s]=se(`selectedItems`,[]);y(r,Object.values(r)),y(a,Object.values(a)),S(()=>{let t=e=>i(e.detail.name,t=>({...t,...e.detail.state}));return e.addEventListener(`legacy-filter-changed`,t),()=>e.removeEventListener(`legacy-filter-changed`,t)},[]),l(`visibleData`,t),l(`sortedFilteredGroupedItems`,r.sortedFilteredGroupedItems),l(`sortOn`,r.sortOn),l(`descending`,r.descending),l(`isMini`,r.isMini);let c=b(()=>Object.fromEntries(Object.entries(n).filter(([,{filter:e}])=>e!==void 0).map(([e,{filter:t}])=>[e,t])),[n]);return l(`filters`,c,Object.values(c)),{selectedItems:o,setSelectedItems:s}}})),wo,To=e((()=>{Ea(),$a(),to(),ro(),uo(),bo(),Co(),Ci(),wo=e=>{let{hashParam:t,settingsId:n,data:r,resizeSpeedFactor:i,noLocal:a,noLocalSort:o=a,noLocalFilter:s=a,error:c,rowPartFn:l}=e,u=wa({settingsId:n,host:e}),{settings:d,setSettings:f,columns:p,resetRef:m,savedSettings:h}=u,g=xi(p,t,{settings:d,setSettings:f,resetRef:m,ready:h!==void 0}),{processedItems:_,visibleData:v,filters:y,setFilterState:b,filterFunctions:ee}=yo({data:r,columns:p,hashParam:t,sortAndGroupOptions:g,noLocalSort:o,noLocalFilter:s}),{isMini:x,collapsedColumns:S,miniColumns:te,requestTween:ne}=Qa({host:e,columns:p,settings:d,setSettings:f,resizeSpeedFactor:i,sortAndGroupOptions:g}),re=r&&Array.isArray(r)&&r.length>0,{selectedItems:C,setSelectedItems:ie}=So({host:e,visibleData:v,sortedFilteredGroupedItems:_,columns:p,filters:y,setFilterState:b,isMini:x,...g});return{header:no({host:e,selectedItems:C,sortAndGroupOptions:g,dataIsValid:re,data:r,columns:p,filters:y,collapsedColumns:S,settings:d,filterFunctions:ee,settingS:u,setFilterState:b,hideSelectAll:e.hideSelectAll===!0,requestTween:ne}),list:lo({host:e,error:c,dataIsValid:re,processedItems:_,selectedItems:C,setSelectedItems:ie,columns:p,collapsedColumns:S,miniColumns:te,sortAndGroupOptions:g,rowPartFn:l}),footer:eo({host:e,selectedItems:C,columns:p})}}})),Eo=e((()=>{i(),customElements.define(`cosmoz-grouped-list-row`,class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||t(this._renderFn(this._item,this._index),this)}})})),Do,Oo,ko,Ao,jo,Mo,No,Po,Fo,Io=e((()=>{Do={group:Symbol(`group`)},Oo=(e,t)=>(t.has(e)||t.set(e,{}),t.get(e)),ko=(e,t)=>!!Oo(e,t).expanded,Ao=(e,t)=>!!Oo(e,t).folded,jo=e=>e?e.items instanceof Array:!1,Mo=e=>{if(!Array.isArray(e)||e.length===0)return;let t=Array.isArray(e[0]?.items);if(!e.every(e=>Array.isArray(e.items)===t))throw Error(`Data must be homogeneous.`)},No=(e,t,n)=>{if(Array.isArray(e))return Mo(e),e.reduce((e,r)=>{let i=r;return i.items?i.items.length?Oo(r,n).folded?e.concat(r):e.concat(r,i.items.map(e=>Object.assign(e,{[Do.group]:r}))):t?e.concat(r):e:e.concat(r)},[])},Po=(e,...t)=>typeof e==`function`?e(...t):e,Fo=(e,t)=>e===t})),Lo,Ro=e((()=>{g(),Io(),Lo=()=>{let[e,t]=x(()=>[new WeakMap]);return{setItemState:u((e,n)=>t(([t])=>{let r=Oo(e,t);return Object.assign(r,Po(n,r)),[t]}),[]),state:e[0],signal:e}}})),zo,Bo=e((()=>{g(),Ro(),Io(),zo=()=>{let{setItemState:e,state:t,signal:n}=Lo();return{state:t,signal:n,toggleFold:u((t,n)=>{jo(t)&&e(t,e=>({folded:n===void 0?!e.folded:n}))},[]),toggleCollapse:u((t,n)=>{jo(t)||e(t,e=>({expanded:n===void 0?!e.expanded:!n}))},[])}}})),Vo,Ho=e((()=>{g(),Io(),Vo=({compareItemsFn:e,data:t,flatData:n})=>{let[r,i]=se(`selectedItems`,()=>[]),[a,o]=x(),s=u(e=>r.includes(e),[r]),c=u(e=>e?.items?.every(s)??!1,[s]),l=u(e=>s(e)||c(e),[s,c]),d=u(e=>{let t=e.items??[e];i(e=>[...e,...t.filter(t=>!e.includes(t))]),o(e)},[]),f=u(e=>{let t=e.items??[e];i(e=>e.filter(e=>!t.includes(e))),o(e)},[]),p=u(e=>{i(e.items?.slice()||[e]),o(e)},[]),m=u(()=>{i(t.flatMap(e=>e.items||e)),o(void 0)},[t]),h=u(()=>{i([]),o(void 0)},[]),g=u((e,t=!l(e))=>t?d(e):f(e),[l]),_=u((t,r)=>{if(!n)return;let i=a?n.findIndex(t=>e(t,a)):-1;if(i<0)return g(t,r);let[s,c]=[i,n.indexOf(t)].sort((e,t)=>e-t);n.slice(s,c+1).forEach((e,t,n)=>{t>0&&t<n.length-1&&jo(e)||g(e,r)}),o(t)},[n,e,g]);return S(()=>i(t=>t.length>0&&n?n.filter(n=>t.find(t=>e(n,t))):t),[n]),{selectedItems:r,isItemSelected:s,isGroupSelected:c,isSelected:l,select:d,deselect:f,selectOnly:p,selectAll:m,deselectAll:h,toggleSelect:g,toggleSelectTo:_}}})),Uo,Wo,Go,Ko=e((()=>{ue(),fe(),g(),i(),Eo(),Bo(),Ho(),Io(),Uo={host:{position:`relative`,display:`flex`,flexDirection:`column`}},Wo=e=>{let{data:t,renderItem:n,renderGroup:r,displayEmptyGroups:i,compareItemsFn:a=Fo,inline:o}=e,{toggleFold:s,toggleCollapse:c,state:l,signal:d}=zo(),f=b(()=>No(t,i,l),[t,i,d]),{selectedItems:p,isItemSelected:m,isGroupSelected:h,isSelected:g,select:_,deselect:v,selectOnly:ee,selectAll:x,deselectAll:S,toggleSelect:te,toggleSelectTo:ne}=Vo({compareItemsFn:a,data:t,flatData:f}),re=u((e,t)=>Array.isArray(e.items)?r(e,t,{selected:h(e),folded:Ao(e,l),toggleSelect:t=>te(e,typeof t==`boolean`?t:void 0),toggleFold:()=>s(e)}):n(e,t,{selected:p.includes(e),expanded:ko(e,l),toggleSelect:t=>te(e,typeof t==`boolean`?t:void 0),toggleCollapse:()=>c(e)}),[n,r,p,te,d]);le(()=>{Object.assign(e.style,Uo.host)},[]);let C={toggleFold:s,toggleCollapse:c,isItemSelected:m,isGroupSelected:h,isSelected:g,select:_,deselect:v,selectOnly:ee,selectAll:x,deselectAll:S,toggleSelect:te,toggleSelectTo:ne};return y(C,Object.values(C)),{renderRow:re,flatData:f,inline:o}},Go=({renderRow:e,flatData:t,inline:n})=>h({items:t,renderItem:(t,n)=>o`<cosmoz-grouped-list-row
				.item=${t}
				.index=${n}
				.renderFn=${e}
			></cosmoz-grouped-list-row>`,...n?{scroller:!0}:{}})})),qo,Jo=e((()=>{g(),Ko(),qo=e=>Go(Wo(e)),customElements.define(`cosmoz-grouped-list`,m(qo,{observedAttributes:[`inline`],useShadowDOM:!1}))})),Yo=e((()=>{Jo()})),Xo,Zo,Qo,$o=e((()=>{Qe(),Et(),Zr(),$r(),Ei(),ji(),Pi(),g(),et(),i(),de(),Li(),Gi(),qi(),Qi(),To(),Yo(),Xo=e=>window.ShadyCSS?.ApplyShim?.transformCssText?.(e)||e,Zo=e=>{let{header:t,list:n,footer:r}=wo(e);return o`
		<style>
			${ot([],()=>Xo(Ii))}
		</style>
