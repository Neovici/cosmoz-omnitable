...
`,Pn=n=>{const{label:e,value:t,slot:i}=n,a=c`<div
	...
	`},Vt=n=>n?typeof n.close=="function"?n:Vt(n.parentElement):null,Xe=n=>class extends n{static get properties(){return{disabled:{type:Boolean,value:!1},filter:{type:Object,notify:!0},values:{type:Array,value(){return[]}},headerFocused:{type:Boolean,notify:!0},min:{type:Number,value:null},max:{type:Number,value:null},limits:{type:Function},autoupdate:{type:String,value:!0},locale:{type:String,value:null},align:{type:String,value:"left"},_filterInput:{type:Object,value(){return{min:null,max:null}}},_range:{type:Object,computed:"_computeRange(values.*)"},_limit:{type:Object,computed:"_computeLimit(_range, _filterInput.*, min, max)",value(){return{}}},_tooltip:{type:String,computed:"_computeTooltip(title, _filterText)"},_fromClasses:{type:String,computed:"_computeInputClasses(_filterInput.min)"},_toClasses:{type:String,computed:"_computeInputClasses(_filterInput.max)"}}}static get observers(){return["_filterInputChanged(_filterInput.*, autoupdate)","_filterChanged(filter.*)","_updateLimits(limits, headerFocused)"]}disconnectedCallback(){this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),super.disconnectedCallback()}_computeInputClasses(e){return e!=null&&e!==""?"has-value":""}toNumber(e,t,i){if(e==null||e==="")return;const a=typeof e=="number"?e:Number(e);if(Number.isNaN(a))return;if(i==null||t==null)return a;const o=this.toNumber(t);return o==null?a:i(a,o)}toValue(){return this.toNumber.apply(this,arguments)}getComparableValue(e,t){if(e==null)return;let i=e;return t!=null&&(i=this.get(t,e)),this.toValue(i)}renderValue(){}getInputString(e,t=this.valuePath){const i=this.toValue(this.get(t,e));return this._toInputString(i)}_computeRange(e){const t=e.base,i=Array.isArray(t)&&t.length&&t.map(a=>this.toValue(a)).filter(a=>a!=null);return!i||i.length<1?{min:null,max:null}:i.reduce((a,o)=>({min:this.toValue(o,a.min,Math.min),max:this.toValue(o,a.max,Math.max)}),{})}_computeLimit(e,t,i,a){if(!e)return;const o=t.base,r=this.toValue(i),l=this.toValue(a),s=r??this.toValue(e.min),u=l??this.toValue(e.max);return{fromMin:s,fromMax:this.toValue(u,this._fromInputString(o.max,"max"),Math.min),toMin:this.toValue(s,this._fromInputString(o.min,"min"),Math.max),toMax:u}}_computeFilterText(e){if(e.base==null)return;const t=e.base,i=this.toValue(t.min),a=this.toValue(t.max),o=[];return i!=null&&o.push(this.renderValue(i)),o.push(" - "),a!=null&&o.push(this.renderValue(a)),o.length>1?o.join(""):void 0}_computeTooltip(e,t){return t==null?e:`${e}: ${t}`}_fromInputString(e){return this.toValue(e)}_toInputString(e){const t=this.toValue(e);return t??null}_getDefaultFilter(){return{min:null,max:null}}_filterInputChanged(e,t){const i=e.path.split(".")[1];this.__inputChangePath=i||null,t&&(this._limitInputDebouncer=cn.debounce(this._limitInputDebouncer,dn.after(600),()=>{this._limitInput(),this._updateFilter()}),mn(this._limitInputDebouncer))}_clearFrom(){this.set("_filterInput.min",null),this._updateFilter()}_clearTo(){this.set("_filterInput.max",null),this._updateFilter()}_onBlur(){this._limitInput(),this._updateFilter()}_onKeyDown(e){const t=e.currentTarget,i=Array.from(t.parentElement.querySelectorAll("cosmoz-input")),a=i[i.findIndex(l=>l===t)+1],o=!a,r=i[0]===t;switch(e.keyCode){case 13:if(e.preventDefault(),!o)a.focus();else{const l=this._limitInput();this._updateFilter(),l||this._closeParent(t)}break;case 9:(o&&!e.shiftKey||r&&e.shiftKey)&&this._closeParent(t)}}_closeParent(e){const t=Vt(e);t&&t.close()}_onDropdownOpenedChanged({currentTarget:e,type:t,detail:i}){(t==="focus"||i?.value===!0)&&setTimeout(()=>{e.querySelector("cosmoz-input:focus")||e.querySelector("cosmoz-input")?.focus()},100)}_limitInput(){const e=this._filterInput,t=this.__inputChangePath,i=t?this._fromInputString(this.get(t,e),t):null;if(this.__inputChangePath=null,i==null)return!1;const a=this._limit,o=t==="min"?"from":"to",r=this.get(o+"Min",a),l=this.get(o+"Max",a),s=this.toValue(i,r,Math.max),u=this.toValue(s,l,Math.min);return this.getComparableValue(i)!==this.getComparableValue(u)?(this.set(["_filterInput",t],this._toInputString(u,t)),this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),!0):!1}_updateFilter(){const e=this._filterInput,t=this.filter,i=this._fromInputString(e.min,"min"),a=this._fromInputString(e.max,"max");this.getComparableValue(i)===this.getComparableValue(t,"min")&&this.getComparableValue(a)===this.getComparableValue(t,"max")||this.set("filter",{min:i,max:a})}_filterChanged(e){if(this._filterInput==null)return;const t=this._filterInput,i=e.base,a=this._fromInputString(t.min,"min"),o=this._fromInputString(t.max,"max");this.getComparableValue(a)===this.getComparableValue(i,"min")&&this.getComparableValue(o)===this.getComparableValue(i,"max")||(this.set("_filterInput",{min:this._toInputString(i.min),max:this._toInputString(i.max)}),this._limitInputDebouncer&&this._limitInputDebouncer.cancel())}hasFilter(){const e=this.filter;return e==null?!1:this.toValue(e.min)!=null||this.toValue(e.max)!=null}resetFilter(){this.filter=this._getDefaultFilter()}_updateLimits(e,t){e&&Promise.resolve(ke(e,{active:t})).then(i=>{const{min:a,max:o}=i??{};Object.assign(this,{...a!=null?{min:a}:{},...o!=null?{max:o}:{}})})}},me=n=>class extends n{static get template(){return kt`<div id="output" style="position:relative;"></div>`}connectedCallback(){super.connectedCallback();const e=this;He(e.render(),e.$.output)}_propertiesChanged(e,t,i){super._propertiesChanged(e,t,i);const a=this;requestAnimationFrame(()=>He(a.render(),a.$.output))}};class Bn extends Xe(me(I)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return c`
		...
		</cosmoz-input>`}renderHeader({title:e,min:t,max:i,limits:a,locale:o,rates:r,currency:l,autoupdate:s,autodetect:u,disabledFiltering:d,headerAlign:m,align:g},{filter:p},f,y){return c`<cosmoz-omnitable-amount-range-input
			.title=${e}
			?disabled=${d}
			.filter=${p}
			.values=${y}
...
`,Ti=({items:n})=>{const[e,t]=R(!1),i=Array.isArray(n)?n:[],a=E(()=>Math.max(0,i.length-1),[i]);if(i.length===0)return null;const o=i.length>2,r=i[0],l=o&&!e?[]:i.slice(1),s=u=>{u.stopPropagation(),u.preventDefault(),t(d=>!d)};return c`
	...
	`};customElements.define("cosmoz-omnitable-column-list-data",O(Ti,{styleSheets:[_e(Li)]}));class Di extends Te(D(I)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:i}){return c`<cosmoz-omnitable-column-list-data
		...
		></cosmoz-input>`}renderHeader({title:e,min:t,max:i,limits:a,locale:o,maximumFractionDigits:r,minimumFractionDigits:l,autoupdate:s,disabledFiltering:u,headerAlign:d,align:m},{filter:g},p,f){return c`<cosmoz-omnitable-number-range-input
			...
			.autoupdate=${s}
			.align=${d??m}
			@filter-changed=${({detail:{value:y}})=>p(w=>({...w,filter:y}))}
			@header-focused-changed=${({detail:{value:y}})=>p(w=>({...w,headerFocused:y}))}
...
`,xa=({settingsConfig:n})=>{const{columns:e,collapsed:t}=n,i=e.filter(a=>!t.some(o=>o.name===a.name));return c`<div class="skeleton">
	...
	</div>`};customElements.define("cosmoz-omnitable-skeleton",O(xa,{styleSheets:[ha]}));const ya=(n,e)=>{const{settingsConfig:t}=n,{processedItems:i,dataIsValid:a,filterIsTooStrict:o,loading:r,displayEmptyGroups:l,compareItemsFn:s,selectedItems:u,setSelectedItems:d,renderItem:m,renderGroup:g,error:p}=e;return c`${F(!r&&!a&&!p,()=>c`<div class="tableContent-empty">
...
`,to=n=>n?"groupRow groupRow-folded":"groupRow",no=({item:n,index:e,selected:t})=>i=>F((i?.length??0)>0,()=>c`
	...
	`,ao=({onCheckboxChange:n,dataIsValid:e,groupOnColumn:t})=>(i,a,{selected:o,folded:r,toggleFold:l})=>c` <div
		...
		</div>`,oo=({host:n,error:e,dataIsValid:t,processedItems:i,columns:a,collapsedColumns:o,miniColumns:r,sortAndGroupOptions:l,rowPartFn:s,...u})=>{const{loading:d=!1,displayEmptyGroups:m=!1,compareItemsFn:g}=n,p=Je({shiftKey:!1,ctrlKey:!1}),f=z($=>{if(!Za($.target))return;const C=$.target,b=C.dataItem,x=C.checked,v=n.shadowRoot.querySelector("#groupedList");p.current.shiftKey?v.toggleSelectTo(b,x):p.current.ctrlKey?(C.checked=!0,v.selectOnly(b)):v.toggleSelect(b,x),$.preventDefault(),$.stopPropagation()},[]);M(()=>{const $=({shiftKey:C,ctrlKey:b})=>{p.current={shiftKey:C,ctrlKey:b}};return window.addEventListener("keydown",$),window.addEventListener("keyup",$),()=>{window.removeEventListener("keydown",$),window.removeEventListener("keyup",$)}},[]);const y=z($=>{if(!eo($.currentTarget))return;const C=$.currentTarget;$.composedPath().slice(0,$.composedPath().indexOf(C)).some(x=>x instanceof Element&&x.matches("a, .checkbox, .expand"))||n.dispatchEvent(new window.CustomEvent("omnitable-item-click",{bubbles:!0,composed:!0,detail:{item:C.dataItem,index:C.dataIndex}}))},[]),{groupOnColumn:w}=l,h=z(($,C)=>b=>ii(n,$,C,b),[]);return{...u,processedItems:i,dataIsValid:t,filterIsTooStrict:t&&i.length<1,loading:d,compareItemsFn:g,displayEmptyGroups:m,error:e,renderItem:E(()=>io({columns:a,collapsedColumns:o,miniColumns:r,onItemClick:y,onCheckboxChange:f,dataIsValid:t,groupOnColumn:w,onItemChange:h,rowPartFn:s}),[a,o,y,f,t,w,h,s]),renderGroup:E(()=>ao({onCheckboxChange:f,dataIsValid:t,groupOnColumn:w}),[f,t,w])}},ro=(n,e)=>{if(n===e)return 0;if(n==null)return-1;if(e==null)return 1;const t=typeof n,i=typeof e;return t==="object"&&i==="object"?n.toString()<e.toString()?-1:1:t==="number"&&i==="number"?n-e:t==="string"&&i==="string"?n<e?-1:1:t==="boolean"&&i==="boolean"?n?-1:1:(console.warn("unsupported sort",t,n,i,e),0)},Pe=(n,e)=>(t,i)=>ro(n(t),n(i))*(e?-1:1),lo=n=>n.replace(/([a-z0-9])([A-Z])/gu,"$1-$2").toLowerCase(),qt=(n,e)=>{!n||!e||Object.entries(e).forEach(([t,i])=>{n[V].__ownChange=!0,n[V][t]=i,n[V].__ownChange=!1,n[V].dispatchEvent(new CustomEvent(`${lo(t)}-changed`,{bubbles:!0,detail:{value:i}}))})},Be=(n,e)=>Object.assign(n,{[Se]:e}),we=Symbol("unparsed"),so=({data:n,columns:e,hashParam:t,sortAndGroupOptions:i,noLocalSort:a,noLocalFilter:o})=>{const{groupOnColumn:r,groupOnDescending:l,sortOnColumn:s,descending:u}=i,d=z(([b,x])=>{const v=e.find(({name:q})=>q===b);return v==null?[b,void 0]:[b,x.filter&&v.serializeFilter(v,x.filter)]},[e]),m=z(([b,x])=>{const v=e.find(({name:k})=>k===b);if(v==null)return[b,{[we]:x}];const q={filter:v.deserializeFilter(v,x)};return qt(v,q),[b,q]},[e]),[g,p]=te({},t,{multi:!0,suffix:"-filter--",write:d,read:m}),f=z((b,x)=>p(v=>{const q=ke(x,v[b]);return qt(e.find(k=>k.name===b),q),{...v,[b]:{...v[b],...q}}}),[e,p]),y=E(()=>Object.values(g).map(b=>b.filter),[g]),w=E(()=>Object.fromEntries(e.map(b=>[b.name,!b.noLocalFilter&&b.getFilterFn(b,g[b.name]?.filter)]).filter(([,b])=>!!b)),[e,...y]),h=E(()=>!Array.isArray(n)||n.length===0?[]:Object.entries(w).length===0||o?n.slice():n.filter(b=>Object.values(w).every(x=>x(b))),[n,w,o]),$=E(()=>{if(!a&&!r&&s!=null&&s.sortOn!=null)return h.slice().sort(Pe(b=>s.getComparableValue({...s,valuePath:s.sortOn},b),u));if(r!=null&&r.groupOn!=null){const b=h.reduce((x,v)=>{const q=r.getComparableValue({...r,valuePath:r.groupOn},v);if(q===void 0)return x;let k=x.find(W=>W.id===q);return k?(k.items.push(v),x):(k={id:q,name:q,items:[v]},[...x,k])},[]);return b.sort(Pe(x=>r.getComparableValue({...r,valuePath:r.groupOn},x.items[0]),l)),!s||a?b:b.filter(x=>Array.isArray(x.items)).map(x=>(x.items.sort(Pe(v=>s.getComparableValue({...s,valuePath:s.sortOn},v),u)),x))}return h},[h,r,l,s,u,a]),C=E(()=>{let b=0,x=0;const v=[];return $.forEach(q=>{if(Array.isArray(q.items)){Be(q,x++),q.items.forEach(k=>{Be(k,b++),v.push(k)});return}return Be(q,b++),v.push(q)},[]),v},[$]);return M(()=>{p(b=>Object.values(b).some(v=>v[we]!=null)?Object.fromEntries(Object.entries(b).map(([v,q])=>q[we]==null?[v,q]:m([v,q[we]]))):b)},[m]),{processedItems:$,visibleData:C,filters:g,filterFunctions:w,setFilterState:f}},uo=n=>{const e=i=>{const a=n.data.indexOf(i);if(a<0)return null;const o=n.data.splice(a,1);if(n.data=n.data.slice(),Array.isArray(o)&&o.length>0)return o[0]},t=(i,a)=>{n.data.splice(i,1,a),n.data=n.data.slice()};return{removeItem:e,removeItems(i){const a=[];for(let o=i.length-1;o>=0;o-=1){const r=e(i[o]);r!=null&&a.push(r)}return a},replaceItemAtIndex:t,replaceItem(i,a){const o=n.data.indexOf(i);o>-1&&t(o,a)},selectItem(i){n.shadowRoot.querySelector("#groupedList").select(i)},selectAll(){n.shadowRoot.querySelector("#groupedList").selectAll()},deselectAll(){n.shadowRoot.querySelector("#groupedList").deselectAll()},deselectItem(i){n.shadowRoot.querySelector("#groupedList").deselect(i)},isItemSelected(i){return n.shadowRoot.querySelector("#groupedList").isItemSelected(i)}}},co=({host:n,visibleData:e,filters:t,...i})=>{const{setFilterState:a}=i,o=E(()=>uo(n),[]),[r,l]=Rt("selectedItems",[]);Ue(i,Object.values(i)),Ue(o,Object.values(o)),M(()=>{const u=d=>{if(!(d instanceof CustomEvent))return;const m=d.detail;a(m.name,g=>({...typeof g=="object"&&g!==null?g:{},...m.state}))};return n.addEventListener("legacy-filter-changed",u),()=>n.removeEventListener("legacy-filter-changed",u)},[]),U("visibleData",e),U("sortedFilteredGroupedItems",i.sortedFilteredGroupedItems),U("sortOn",i.sortOn),U("descending",i.descending),U("isMini",i.isMini);const s=E(()=>Object.fromEntries(Object.entries(t).filter(([,{filter:u}])=>u!==void 0).map(([u,{filter:d}])=>[u,d])),[t]);return U("filters",s,Object.values(s)),{selectedItems:r,setSelectedItems:l}},mo=n=>{const{hashParam:e,settingsId:t,data:i,resizeSpeedFactor:a,noLocal:o,noLocalSort:r=o,noLocalFilter:l=o,error:s,rowPartFn:u}=n,d=Oa({settingsId:t,host:n}),{settings:m,setSettings:g,columns:p,resetRef:f,savedSettings:y}=d,w=y!==void 0,h=na(p,e,{settings:m,setSettings:g,resetRef:f,ready:w}),{processedItems:$,visibleData:C,filters:b,setFilterState:x,filterFunctions:v}=so({data:i,columns:p,hashParam:e,sortAndGroupOptions:h,noLocalSort:r,noLocalFilter:l}),{isMini:q,collapsedColumns:k,miniColumns:W,requestTween:H}=Xa({host:n,columns:p,settings:m,setSettings:g,resizeSpeedFactor:a,sortAndGroupOptions:h}),at=i&&Array.isArray(i)&&i.length>0,{selectedItems:Re,setSelectedItems:ot}=co({host:n,visibleData:C,sortedFilteredGroupedItems:$,columns:p,filters:b,setFilterState:x,isMini:q,...h}),rt=Ya({host:n,selectedItems:Re,sortAndGroupOptions:h,dataIsValid:at,data:i,columns:p,filters:b,collapsedColumns:k,settings:m,filterFunctions:v,settingS:d,setFilterState:x,hideSelectAll:n.hideSelectAll===!0,requestTween:H});return{header:rt,list:oo({host:n,error:s,dataIsValid:at,processedItems:$,selectedItems:Re,setSelectedItems:ot,columns:p,collapsedColumns:k,miniColumns:W,sortAndGroupOptions:h,rowPartFn:u}),footer:Qa({host:n,selectedItems:Re,allSelected:rt.allSelected,setSelectedItems:ot,columns:p,enableSelectAll:n.enableSelectAll,allItemsCount:n.allItemsCount})}};customElements.define("cosmoz-grouped-list-row",class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||He(this._renderFn(this._item,this._index),this)}});const po={group:Symbol("group")},De=(n,e)=>(e.has(n)||e.set(n,{}),e.get(n)),go=(n,e)=>!!De(n,e).expanded,bo=(n,e)=>!!De(n,e).folded,qe=n=>n?n.items instanceof Array:!1,fo=n=>{if(!Array.isArray(n)||n.length===0)return;const e=Array.isArray(n[0]?.items);if(!n.every(i=>Array.isArray(i.items)===e))throw new Error("Data must be homogeneous.")},ho=(n,e,t)=>Array.isArray(n)?(fo(n),n.reduce((a,o)=>{const r=o;return r.items?r.items.length?De(o,t).folded?a.concat(o):a.concat(o,r.items.map(l=>Object.assign(l,{[po.group]:o}))):e?a.concat(o):a:a.concat(o)},[])):void 0,xo=(n,...e)=>typeof n=="function"?n(...e):n,yo=(n,e)=>n===e,vo=()=>{const[n,e]=R(()=>[new WeakMap]);return{setItemState:z((i,a)=>e(([o])=>{const r=De(i,o);return Object.assign(r,xo(a,r)),[o]}),[]),state:n[0],signal:n}},$o=()=>{const{setItemState:n,state:e,signal:t}=vo(),i=z((o,r)=>{qe(o)&&n(o,l=>({folded:r!==void 0?r:!l.folded}))},[]),a=z((o,r)=>{qe(o)||n(o,l=>({expanded:r!==void 0?!r:!l.expanded}))},[]);return{state:e,signal:t,toggleFold:i,toggleCollapse:a}},Co=({compareItemsFn:n,data:e,flatData:t})=>{const[i,a]=Rt("selectedItems",()=>[]),[o,r]=R(),l=z(h=>i===T||i.includes(h),[i]),s=z(h=>i===T||(h?.items?.every(l)??!1),[i,l]),u=z(h=>l(h)||s(h),[l,s]),d=z(h=>{const C=h.items??[h];a(b=>b===T?b:[...b,...C.filter(x=>!b.includes(x))]),r(h)},[]),m=z(h=>{const C=h.items??[h];a(b=>b===T?(t??[]).filter(x=>!qe(x)).filter(x=>!C.includes(x)):b.filter(x=>!C.includes(x))),r(h)},[t]),g=z(h=>{a(h.items?.slice()||[h]),r(h)},[]),p=z(()=>{a(e.flatMap(h=>h.items||h)),r(void 0)},[e]),f=z(()=>{a([]),r(void 0)},[]),y=z((h,$=!u(h))=>$?d(h):m(h),[u]),w=z((h,$)=>{if(!t)return;const C=o?t.findIndex(v=>n(v,o)):-1;if(C<0)return y(h,$);const[b,x]=[C,t.indexOf(h)].sort((v,q)=>v-q);t.slice(b,x+1).forEach((v,q,k)=>{q>0&&q<k.length-1&&qe(v)||y(v,$)}),r(h)},[t,n,y]);return M(()=>a(h=>h!==T&&h.length>0&&t?t.filter($=>h.find(C=>n($,C))):h),[t]),{selectedItems:i,isItemSelected:l,isGroupSelected:s,isSelected:u,select:d,deselect:m,selectOnly:g,selectAll:p,deselectAll:f,toggleSelect:y,toggleSelectTo:w}},wo={host:{position:"relative",display:"flex",flexDirection:"column"}},zo=n=>{const{data:e,renderItem:t,renderGroup:i,displayEmptyGroups:a,compareItemsFn:o=yo}=n,{toggleFold:r,toggleCollapse:l,state:s,signal:u}=$o(),d=E(()=>ho(e,a,s),[e,a,u]),{selectedItems:m,isItemSelected:g,isGroupSelected:p,isSelected:f,select:y,deselect:w,selectOnly:h,selectAll:$,deselectAll:C,toggleSelect:b,toggleSelectTo:x}=Co({compareItemsFn:o,data:e,flatData:d}),v=z((k,W)=>Array.isArray(k.items)?i(k,W,{selected:p(k),folded:bo(k,s),toggleSelect:H=>b(k,typeof H=="boolean"?H:void 0),toggleFold:()=>r(k)}):t(k,W,{selected:g(k),expanded:go(k,s),toggleSelect:H=>b(k,typeof H=="boolean"?H:void 0),toggleCollapse:()=>l(k)}),[t,i,m,b,u]);Et(()=>{Object.assign(n.style,wo.host)},[]);const q={toggleFold:r,toggleCollapse:l,isItemSelected:g,isGroupSelected:p,isSelected:f,select:y,deselect:w,selectOnly:h,selectAll:$,deselectAll:C,toggleSelect:b,toggleSelectTo:x};return Ue(q,Object.values(q)),{renderRow:v,flatData:d}},So=({renderRow:n,flatData:e})=>zn({items:e,renderItem:(t,i)=>c`<cosmoz-grouped-list-row
				.item=${t}
				.index=${i}
				.renderFn=${n}
