import{x as c,B as ke,E as xt}from"./iframe-knd7S2-5.js";import{t as K,c as O,g as C,P as I,u as T,a as vt,m as yt,s as Rt,D as Nt,b as Bt,e as Gt,i as $e,h as Oe,d as Ye,f as Ht,j as M,r as jt,k as Wt,l as A,n as Ut,o as we,p as he,q as k,v as Kt,w as Ce,x as Jt,y as Xt,z as Qt,T as Yt,A as Zt,B as ei,C as ti,E as ii,F as $,G as ai,H as ni,I as $t,J as Le,K as F,L as wt,M as De,N as oi,O as Ct,Q as ri,R as Te,S as li,U as Ze,V as si,W as Ve,X as ui,Y as di,Z as Ee,_ as Pe,$ as ci,a0 as Ie,a1 as R,a2 as mi,a3 as ze,a4 as pi}from"./cosmoz-collapse-a0JyL5p7.js";import"./preload-helper-D9Z9MdNV.js";const gi=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`;customElements.define("cosmoz-clear-button",O(bi));const U=({valuePath:i},e)=>C(e,i),fi=U,hi=U,xi=({valuePath:i},e)=>t=>{const a=C(t,i);return a==null?!1:a.toString().toLowerCase().trim().includes(e.toLowerCase().trim())},vi=(i,e)=>e===""||e==null?null:e,V=i=>class extends i{static get properties(){return{isOmnitableColumn:{type:Boolean,value:!0},title:{type:String},valuePath:{type:String,notify:!0},values:{type:Array,notify:!0},filter:{type:Object},noLocalFilter:{type:Boolean},disabled:{type:Boolean,value:!1,notify:!0},editable:{type:Boolean,notify:!0},loading:{type:Boolean,value:!1,notify:!0},externalValues:{type:Boolean,value:!1,notify:!0},name:{type:String},sortOn:{type:String},groupOn:{type:String},width:{type:String,value:"75px"},minWidth:{type:String,value:"40px"},flex:{type:String,value:"1"},cellClass:{type:String,value:"default-cell"},headerCellClass:{type:String,value:"default-header-cell"},priority:{type:Number,value:0},hidden:{type:Boolean,notify:!0},preferredDropdownHorizontalAlign:{type:String,value:"right"},renderHeader:{type:Function},renderCell:{type:Function},renderEditCell:{type:Function},renderGroup:{type:Function},mini:{type:Number,value:null},renderMini:{type:Function}}}static get observers(){return["notifyFilterChange(filter)"]}notifyFilterChange(e){this.__ownChange||this.dispatchEvent(new CustomEvent("legacy-filter-changed",{detail:{name:this.name,state:this.legacyFilterToState(e)},bubbles:!0}))}legacyFilterToState(e){return{filter:e}}getFilterFn(){}getString(e,t){return U(e,t)}toXlsxValue(e,t){return fi(e,t)}cellTitleFn(e,t){return this.getString(e,t)}headerTitleFn(e){return e.title}serializeFilter(e,t){return vi(e,t)}deserializeFilter(e,t){return t==null?null:typeof t=="string"?window.decodeURIComponent(t):t}getComparableValue(e,t){return hi(e,t)}computeSource(e,t){return t}_propertiesChanged(e,t,a){super._propertiesChanged(e,t,a),this.dispatchEvent(new CustomEvent("cosmoz-column-prop-changed",{bubbles:!0}))}},yi=i=>e=>i(t=>{if(t.inputValue===void 0&&e.target.value==="")return t;clearTimeout(t.t);const a=setTimeout(()=>i(n=>({...n,filter:n.inputValue})),1e3);return{...t,inputValue:e.target.value,t:a}}),$i=i=>()=>i(e=>({...e,filter:e.inputValue})),wi=i=>e=>{e.keyCode===13&&(e.preventDefault(),i(t=>({...t,filter:t.inputValue})))},Ci=i=>e=>i(t=>({...t,headerFocused:e.detail.value})),Si=i=>()=>i(e=>({...e,filter:null,inputValue:null})),zi=i=>i!=null&&i!=="";class qi extends V(I){static get properties(){return{minWidth:{type:String,value:"55px"},editMinWidth:{type:String,value:"55px"},inputValue:{type:Object,notify:!0}}}getFilterFn(e,t){if(!(t==null||t===""))return xi(e,t)}renderCell(e,{item:t}){return c`<span class="default-column">${U(e,t)}</span>`}renderEditCell(e,{item:t},a){return c`<cosmoz-input
	...
	`};class Di extends Re(ae(I)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return c`
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return ie(e,t)}}customElements.define("cosmoz-omnitable-column-date",ga);class ba extends We(V(I)){renderCell({valuePath:e,textProperty:t},{item:a}){const n=Ne(a,e,t).map(o=>c`<li>${o}</li>`);return c`
			<style>
				ul {
					padding: 0;
					display: inline;
...
`,Lt=i=>(e,t,a=ei)=>{const n=ni(),o=new URLSearchParams(n.hash.replace("#",""));return i(e,t,a,o),"#!"+Object.assign(n,{hash:o}).href.replace(location.origin,"")},Dt=i=>i==null||i==="",La=Lt((i,e,t,a)=>Dt(t(e))?a.delete(i):a.set(i,t(e))),Da=Lt((i,e,t,a)=>Object.entries(e).map(t).forEach(([n,o])=>Dt(o)?a.delete(i+n):a.set(i+n,o))),J=(i,e,{suffix:t="",read:a,write:n,multi:o}={})=>{const[r,l]=o?[Da,ti]:[La,ii],[s,u]=T(()=>e==null?i:l(e+t,a)??i),d=$(m=>u(b=>{const p=$e(m,b);return e!=null&&ai(r(e+t,p,n),null,{notify:!1}),p}),[e,t,r,n]);return[s,d]},Ta=i=>[!0,"true",1,"yes","on"].includes(i),ce=i=>i===""||(i==null?void 0:Ta(i)),me=(i,e,t)=>$(a=>{i(a),t(n=>({...n,[e]:a}))},[i,e,t]),Va=(i,e,t,a,n)=>{const[o,r]=J(t.sortOn,e,{suffix:"-sortOn"}),[l,s]=J(ce(t.descending),e,{suffix:"-descending",read:ce}),[u,d]=J(t.groupOn,e,{suffix:"-groupOn"}),[m,b]=J(ce(t.groupOnDescending),e,{suffix:"-groupOnDescending",read:ce}),p=F(()=>i.find(g=>g.name===o),[i,o]),z=F(()=>i.find(g=>g.name===u),[i,u]),h={groupOn:u,setGroupOn:me(d,"groupOn",a),groupOnDescending:m,setGroupOnDescending:me(b,"groupOnDescending",a),sortOn:o,setSortOn:me(r,"sortOn",a),descending:l,setDescending:me(s,"descending",a),columns:i},y=F(()=>h,Object.values(h)),_=$(g=>{r(g.sortOn),d(g.groupOn),s(g.descending),b(g.groupOnDescending)},[]);return M(()=>void(n.current=_),[]),{...y,sortAndGroup:y,groupOnColumn:z,sortOnColumn:p}},Qe=$t();customElements.define("sort-and-group-provider",Qe.Provider);customElements.define("sort-and-group-consumer",O(({render:i})=>i(Le(Qe)),{useShadowDOM:!1}));const Pa=({data:i,columns:e,groupOnColumn:t,filters:a,setFilterState:n,sortAndGroup:{sortOn:o,setSortOn:r,descending:l,setDescending:s}={}})=>wt(e,u=>u.name,u=>[c`<div
			...
			>
				...
				.column="${u}"
				name="${u.name}"
			></cosmoz-omnitable-resize-nub>`]),Ra=({columns:i,settingsConfig:e,hideSelectAll:t,...a})=>{const n=Le(Qe);return c`
...
`;customElements.define("cosmoz-omnitable-item-expand-line",O(Ba,{styleSheets:[De(Na)]}));const Ga=({columns:i,item:e,selected:t,expanded:a,groupOnColumn:n})=>oi(i,o=>c`<cosmoz-omnitable-item-expand-line
				.column=${o}
				?hidden=${o===n}
