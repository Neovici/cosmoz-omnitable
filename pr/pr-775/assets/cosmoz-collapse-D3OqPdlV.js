import{f as Hn,B as cr,x as P,E as ct,T as j,m as Un,i as ur,p as dr,v as pt,s as zt,M as qe,b as Kn}from"./iframe-CSNNINQe.js";import{_ as hr}from"./preload-helper-D9Z9MdNV.js";/**
 * @license
...
`,Vn=(e,t)=>{Object.assign(e.style,{display:t?"":"none"})};class Uu extends HTMLElement{static get observedAttributes(){return["opened"]}toggle=bi("height");constructor(){super();const t=new CSSStyleSheet;t.replaceSync(`
      :host { display: block; overflow: hidden; }
		`);const s=this.attachShadow({mode:"open"});s.appendChild(document.createElement("slot")),s.adoptedStyleSheets=[t]}connectedCallback(){Vn(this,this.getAttribute("opened")!=null)}attributeChangedCallback(t,s,n){switch(t){case"opened":{const i=n!=null;return this.isConnected?this.toggle(this,i):Vn(this,i)}}}}customElements.define("cosmoz-collapse",Uu);export{wi as $,B as A,At as B,ud as C,ms as D,cd as E,$ as F,ld as G,nr as H,ca as I,gi as J,R as K,Sc as L,Ls as M,fr as N,bs as O,Vo as P,dd as Q,Fl as R,X as S,Xu as T,hd as U,fd as V,Rt as W,dl as X,Ii as Y,Dc as Z,yi as _,ds as a,Bi as a0,Gu as a1,kc as a2,Qt as a3,Pi as a4,qu as b,V as c,Cs as d,id as e,Ui as f,U as g,jo as h,Ju as i,T as j,rd as k,nd as l,ed as m,sd as n,vt as o,qi as p,J as q,Vi as r,Is as s,As as t,nt as u,Ic as v,Zu as w,Qu as x,ad as y,td as z};
