import{x as d,B as _e,E as xt}from"./iframe-BzsO-atj.js";import{t as K,c as O,g as C,P as I,u as T,a as vt,m as yt,s as Nt,D as Rt,b as Bt,e as Gt,i as $e,h as Oe,d as Ye,f as Ht,r as jt,j as Wt,k as A,l as Ut,n as we,p as he,o as _,q as Kt,v as Ce,w as Jt,x as Xt,y as Qt,T as Yt,z as M,A as Zt,B as ei,C as ti,E as ii,F as $,G as ai,H as ni,I as $t,J as Le,K as F,L as wt,M as De,N as oi,O as Ct,Q as ri,R as Te,S as li,U as Ze,V as si,W as Ve,X as ui,Y as ci,Z as Ee,_ as Pe,$ as di,a0 as Ie,a1 as N,a2 as mi,a3 as ze,a4 as pi}from"./cosmoz-collapse-spSvJ_No.js";import"./preload-helper-D9Z9MdNV.js";const gi=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`;customElements.define("cosmoz-clear-button",O(bi));const U=({valuePath:i},e)=>C(e,i),fi=U,hi=U,xi=({valuePath:i},e)=>t=>{const a=C(t,i);return a==null?!1:a.toString().toLowerCase().trim().includes(e.toLowerCase().trim())},vi=(i,e)=>e===""||e==null?null:e,V=i=>class extends i{static get properties(){return{isOmnitableColumn:{type:Boolean,value:!0},title:{type:String},valuePath:{type:String,notify:!0},values:{type:Array,notify:!0},filter:{type:Object},noLocalFilter:{type:Boolean},disabled:{type:Boolean,value:!1,notify:!0},editable:{type:Boolean,notify:!0},loading:{type:Boolean,value:!1,notify:!0},externalValues:{type:Boolean,value:!1,notify:!0},name:{type:String},sortOn:{type:String},groupOn:{type:String},width:{type:String,value:"75px"},minWidth:{type:String,value:"40px"},flex:{type:String,value:"1"},cellClass:{type:String,value:"default-cell"},headerCellClass:{type:String,value:"default-header-cell"},priority:{type:Number,value:0},hidden:{type:Boolean,notify:!0},preferredDropdownHorizontalAlign:{type:String,value:"right"},renderHeader:{type:Function},renderCell:{type:Function},renderEditCell:{type:Function},renderGroup:{type:Function},mini:{type:Number,value:null},renderMini:{type:Function}}}static get observers(){return["notifyFilterChange(filter)"]}notifyFilterChange(e){this.__ownChange||this.dispatchEvent(new CustomEvent("legacy-filter-changed",{detail:{name:this.name,state:this.legacyFilterToState(e)},bubbles:!0}))}legacyFilterToState(e){return{filter:e}}getFilterFn(){}getString(e,t){return U(e,t)}toXlsxValue(e,t){return fi(e,t)}cellTitleFn(e,t){return this.getString(e,t)}headerTitleFn(e){return e.title}serializeFilter(e,t){return vi(e,t)}deserializeFilter(e,t){return t==null?null:typeof t=="string"?window.decodeURIComponent(t):t}getComparableValue(e,t){return hi(e,t)}computeSource(e,t){return t}_propertiesChanged(e,t,a){super._propertiesChanged(e,t,a),this.dispatchEvent(new CustomEvent("cosmoz-column-prop-changed",{bubbles:!0}))}},yi=i=>e=>i(t=>{if(t.inputValue===void 0&&e.target.value==="")return t;clearTimeout(t.t);const a=setTimeout(()=>i(n=>({...n,filter:n.inputValue})),1e3);return{...t,inputValue:e.target.value,t:a}}),$i=i=>()=>i(e=>({...e,filter:e.inputValue})),wi=i=>e=>{e.keyCode===13&&(e.preventDefault(),i(t=>({...t,filter:t.inputValue})))},Ci=i=>e=>i(t=>({...t,headerFocused:e.detail.value})),Si=i=>()=>i(e=>({...e,filter:null,inputValue:null})),zi=i=>i!=null&&i!=="";class qi extends V(I){static get properties(){return{minWidth:{type:String,value:"55px"},editMinWidth:{type:String,value:"55px"},inputValue:{type:Object,notify:!0}}}getFilterFn(e,t){if(!(t==null||t===""))return xi(e,t)}renderCell(e,{item:t}){return d`<span class="default-column">${U(e,t)}</span>`}renderEditCell(e,{item:t},a){return d`<cosmoz-input
	...
	>
		${t||""}
			...
			`]}));const ne=({title:i,tooltip:e="",filterText:t="",onOpenedChanged:a,content:n,horizontalAlign:o="left",externalValues:r=null,headerFocused:l})=>{const s={filtered:!!t,...r!=null&&{[`external-values-${r}`]:!0}};return d`
		<style>
			.dropdown {
				outline: none;
			}
	...
	`};class Di extends Ne(ae(I)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return d`
		...
		</cosmoz-input>`}renderHeader({title:e,min:t,max:a,limits:n,locale:o,rates:r,currency:l,autoupdate:s,autodetect:u},{filter:c},m,b){return d`<cosmoz-omnitable-amount-range-input
			.title=${e}
			.filter=${c}
			.values=${b}
			.rates=${r}
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:a},n,o){return d`<cosmoz-autocomplete-ui
			...
			.onFocus=${He(n)}
			.onText=${je(n)}
			>${_(e.loading,()=>d`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}getComparableValue(e,t){return Qi(e,t)}}customElements.define("cosmoz-omnitable-column-autocomplete",Yi);const Ue=(i,e)=>e.find(({value:t})=>i===t),Zi=(i,e,t)=>{const a=Ue(e,t);return a?a.text:i},ot=(i,e,t,a)=>Zi(i,C(e,t),a),ea=({valuePath:i},e,t)=>Ue(C(e,i),t),ta=i=>e=>{i(t=>({...t,filter:e?.[0]?.value??null}))},ia=i=>e=>{i(t=>({...t,headerFocused:e}))},aa=i=>e=>{i(t=>({...t,query:e}))},na=i=>e=>i(e?.[0]?.value),rt=({valuePath:i,trueLabel:e,falseLabel:t},a)=>C(a,i)?e:t,oa=({valuePath:i},e)=>t=>C(t,i)===e,le=yt((i,e)=>[{text:i,value:!0},{text:e,value:!1}]),ra=({valuePath:i,trueLabel:e,falseLabel:t},a)=>i?C(a,i)?e:t:"",la=(i,e)=>{try{return JSON.parse(e)}catch{return null}};class sa extends V(I){static get properties(){return{trueLabel:{type:String,value:"True"},falseLabel:{type:String,value:"False"},flex:{type:String,value:"0"},cellClass:{type:String,value:"boolean-cell"}}}getString(e,t){return rt(e,t)}renderCell(e,{item:t}){return rt(e,t)}renderEditCell(e,{item:t},a){const{trueLabel:n,falseLabel:o}=e;return d`<cosmoz-autocomplete
			...
			.onChange=${na(a)}
			.limit=${1}
			>${_(e.loading,()=>d`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return ie(e,t)}}customElements.define("cosmoz-omnitable-column-date",ga);class ba extends We(V(I)){renderCell({valuePath:e,textProperty:t},{item:a}){const n=Re(a,e,t).map(o=>d`<li>${o}</li>`);return d`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		`}_computeFormatter(e,t,a){const n={localeMatcher:"best fit"};return t!==null&&(n.minimumFractionDigits=t),a!==null&&(n.maximumFractionDigits=a),new Intl.NumberFormat(e||void 0,n)}getComparableValue(e,t){if(e==null)return;let a=e;if(t!=null&&(a=this.get(t,e)),a=this.toValue(a),a==null)return;const n=this.maximumFractionDigits;return n!==null?this.toValue(a.toFixed(n)):a}renderValue(e,t=this.formatter){const a=this.toNumber(e);if(a!=null)return t.format(a)}}customElements.define("cosmoz-omnitable-number-range-input",ha);class xa extends V(I){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},autoupdate:{type:Boolean,value:!1,notify:!0},cellClass:{type:String,value:"number-cell align-right"},width:{type:String,value:"30px"},minWidth:{type:String,value:"30px"},headerCellClass:{type:String,value:"number-header-cell"},maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const a=H({...e,valuePath:"min"},t),n=H({...e,valuePath:"max"},t);if(!(a==null&&n==null))return Pi(e,t)}getString(e,t){return tt(e,t)}toXlsxValue({valuePath:e},t){return C(t,e)}getComparableValue(e,t){return H(e,t)}serializeFilter(e,t){if(t==null)return;const a=L(t.min),n=L(t.max);if(!(a==null&&n==null))return et(a)+"~"+et(n)}deserializeFilter(e,t){if(t==null||t==="")return null;const a=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(a)?{min:L(a[1]),max:L(a[2])}:null}renderCell(e,{item:t}){return d`<div class="omnitable-cell-number">
			...
			@change=${o=>a(o.target.value)}
			.value=${Ti(e,t)}
		></cosmoz-input>`}renderHeader({title:e,min:t,max:a,limits:n,locale:o,maximumFractionDigits:r,minimumFractionDigits:l,autoupdate:s},{filter:u},c,m){return d`<cosmoz-omnitable-number-range-input
			.title=${e}
			.filter=${u}
			.values=${m}
			.min=${t}
		...
		`}_toInputString(e){const t=this.toValue(e);if(t!=null)return this._toLocalISOString(t).slice(0,19)}_computeFormatter(e){const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return new Intl.DateTimeFormat(e||void 0,t)}}customElements.define("cosmoz-omnitable-datetime-range-input",Aa);class gt extends V(I){static get is(){return"cosmoz-omnitable-column-datetime"}static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"datetime-header-cell"},width:{type:String,value:"210px"},minWidth:{type:String,value:"128px"},flex:{type:String,value:"0"},filterStep:{type:Number,value:1}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const a=P({...e,valuePath:"min"},t),n=P({...e,valuePath:"max"},t);if(!(a==null&&n==null))return Et(e,t)}getString(e,t){return qe(e,t)}toXlsxValue(e,t){return qa(e,t)}getComparableValue(e,t){return P(e,t)}serializeFilter(e,t){if(t==null)return;const a=E(t.min),n=E(t.max);if(!(a==null&&n==null))return mt(a)+"~"+mt(n)}deserializeFilter(e,t){if(t==null||t==="")return null;const a=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(a)?{min:pt(a[1]),max:pt(a[2])}:null}renderCell(e,{item:t}){return qe(e,t)}renderEditCell(e,{item:t},a){return d`<cosmoz-input
			...
			@change=${o=>a(_t(o.target.value))}
			.value=${qe(e,t)}
		></cosmoz-input>`}renderHeader({title:e,min:t,max:a,limits:n,locale:o,filterStep:r},{filter:l},s,u){return d`<cosmoz-omnitable-datetime-range-input
			.title=${e}
			.filter=${l}
			.values=${u}
			.min=${t}
...
>
	...
	/>
</svg> `,Mt=({column:i,on:e,descending:t,setOn:a,setDescending:n})=>{const{name:o,title:r}=i??{};return d`<button
		class="sg"
		title=${r}
	...
	>
		<span>${r}</span> ${Ia}
	</button>`},Ot=({columns:i,...e})=>i?.map(t=>Mt({column:t,...e})),Ma=()=>d`
...
`,Lt=i=>(e,t,a=ei)=>{const n=ni(),o=new URLSearchParams(n.hash.replace("#",""));return i(e,t,a,o),"#!"+Object.assign(n,{hash:o}).href.replace(location.origin,"")},Dt=i=>i==null||i==="",La=Lt((i,e,t,a)=>Dt(t(e))?a.delete(i):a.set(i,t(e))),Da=Lt((i,e,t,a)=>Object.entries(e).map(t).forEach(([n,o])=>Dt(o)?a.delete(i+n):a.set(i+n,o))),J=(i,e,{suffix:t="",read:a,write:n,multi:o}={})=>{const[r,l]=o?[Da,ti]:[La,ii],[s,u]=T(()=>e==null?i:l(e+t,a)??i),c=$(m=>u(b=>{const p=$e(m,b);return e!=null&&ai(r(e+t,p,n),null,{notify:!1}),p}),[e,t,r,n]);return[s,c]},Ta=i=>[!0,"true",1,"yes","on"].includes(i),de=i=>i===""||(i==null?void 0:Ta(i)),me=(i,e,t)=>$(a=>{i(a),t(n=>({...n,[e]:a}))},[i,e,t]),Va=(i,e,t,a,n)=>{const[o,r]=J(t.sortOn,e,{suffix:"-sortOn"}),[l,s]=J(de(t.descending),e,{suffix:"-descending",read:de}),[u,c]=J(t.groupOn,e,{suffix:"-groupOn"}),[m,b]=J(de(t.groupOnDescending),e,{suffix:"-groupOnDescending",read:de}),p=F(()=>i.find(g=>g.name===o),[i,o]),z=F(()=>i.find(g=>g.name===u),[i,u]),h={groupOn:u,setGroupOn:me(c,"groupOn",a),groupOnDescending:m,setGroupOnDescending:me(b,"groupOnDescending",a),sortOn:o,setSortOn:me(r,"sortOn",a),descending:l,setDescending:me(s,"descending",a),columns:i},y=F(()=>h,Object.values(h)),k=$(g=>{r(g.sortOn),c(g.groupOn),s(g.descending),b(g.groupOnDescending)},[]);return M(()=>void(n.current=k),[]),{...y,sortAndGroup:y,groupOnColumn:z,sortOnColumn:p}},Qe=$t();customElements.define("sort-and-group-provider",Qe.Provider);customElements.define("sort-and-group-consumer",O(({render:i})=>i(Le(Qe)),{useShadowDOM:!1}));const Pa=({data:i,columns:e,groupOnColumn:t,filters:a,setFilterState:n,sortAndGroup:{sortOn:o,setSortOn:r,descending:l,setDescending:s}={}})=>wt(e,u=>u.name,u=>[d`<div
				...
				name="${u.name}"
			>
				${u.renderHeader(u,a[u.name]??{},c=>n(u.name,c),u.source(u,i))}
				${Mt({on:o,setOn:r,descending:l,setDescending:s,column:u})}
			</div>`,d`<cosmoz-omnitable-resize-nub
				.column="${u}"
				name="${u.name}"
			></cosmoz-omnitable-resize-nub>`]),Na=({columns:i,settingsConfig:e,hideSelectAll:t,...a})=>{const n=Le(Qe);return d`
		${_(i,o=>Pa({columns:o,sortAndGroup:n,...a}))}
		${_(!t,()=>d` <cosmoz-omnitable-settings
					.config=${e}
					part="settings"
...
`;customElements.define("cosmoz-omnitable-item-expand-line",O(Ba,{styleSheets:[De(Ra)]}));const Ga=({columns:i,item:e,selected:t,expanded:a,groupOnColumn:n})=>oi(i,o=>d`<cosmoz-omnitable-item-expand-line
				.column=${o}
				?hidden=${o===n}
...
`);r.unshift(o),Ct(new File(r,t,{type:"text/csv;charset=utf-8"}))},Ka=(i,e)=>{const t=i.map(n=>n.title),a=e.map(n=>i.map(o=>{const r=o.toXlsxValue(o,n);return r??""}));return a.unshift(t),a},Ja=(i,e,t,a)=>{const n=Ka(i,e),o=new ri(t).addSheetFromData(n,a).generate();Ct(new File([o],t,{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}))},Xa=({columns:i,selectedItems:e,csvFilename:t,xlsxFilename:a,xlsxSheetname:n,topPlacement:o})=>d`<cosmoz-bottom-bar
	...
	>
	...
	</cosmoz-bottom-bar>`,Qa=({allSelected:i,onAllCheckboxChange:e,sortAndGroup:t,dataIsValid:a,data:n,columns:o,filters:r,groupOnColumn:l,setFilterState:s,settingsConfig:u,hideSelectAll:c})=>d`<sort-and-group-provider .value=${t}>
		<div class="header" id="header" part="header">
			${_(!c,()=>d`<input
						...
						part="all"
					/>`)}
			${_(c,()=>d` <cosmoz-omnitable-settings
						.newLayout="${!0}"
						.config=${u}
					></cosmoz-omnitable-settings>`)}
...
`,Za=({settingsConfig:i})=>{const{columns:e,collapsed:t}=i,a=e.filter(n=>!t.some(o=>o.name===n.name));return d`<div class="skeleton">
	...
	</div>`};customElements.define("cosmoz-omnitable-skeleton",O(Za,{styleSheets:[Ya]}));const en=(i,e)=>{const{settingsConfig:t}=i,{processedItems:a,dataIsValid:n,filterIsTooStrict:o,loading:r,displayEmptyGroups:l,compareItemsFn:s,setSelectedItems:u,renderItem:c,renderGroup:m,error:b}=e;return d`${_(!r&&!n&&!b,()=>d`<div class="tableContent-empty">
		...
		${_(o,()=>d`<div class="tableContent-empty">
					${Ze({width:"96px",height:"96px",styles:"margin-right: 24px; fill: currentColor;"})}
					<div>
		...
		${_(r&&!a.length,()=>d`<div class="tableContent-empty overlay">
					<cosmoz-omnitable-skeleton
						.settingsConfig=${t}
					></cosmoz-omnitable-skeleton>
				</div>`)}
		${_(r&&a.length,()=>d`<div class="tableContent-empty overlay spinner">
					<cz-spinner></cz-spinner>
				</div>`)}
		${_(b,()=>d`<div class="tableContent-empty overlay">
...
`,pe=i=>{const e=parseInt(i,10);return isFinite(e)?e:void 0},nn=i=>{const{config:e}=i,{settings:t,setSettings:a,collapsed:n}=e,o=Ve({collapsed:n,settings:t.columns,setSettings:$(r=>a(l=>({...l,columns:r})),[a])});return{...e,onDown:$(r=>{r.target.closest(".pull")&&(o.handle=r.currentTarget)},[o]),onDragStart:$(r=>{const{target:l}=r,s=pe(l.dataset.index);if(!o.handle?.contains(l)||s==null)return r.preventDefault();o.handle=null,r.dataTransfer.effectAllowed="move",r.dataTransfer.setData("omnitable/sort-index",s),r.dataTransfer.setData("text/plain",s),setTimeout(()=>l.classList.add("drag"),0),l.addEventListener("dragend",u=>u.target.classList.remove("drag"),{once:!0})},[o]),onDragEnter:$(r=>{const l=r.currentTarget;l===r.target&&(r.preventDefault(),r.dataTransfer.dropEffect="move",l.classList.add("dragover"))},[]),onDragOver:$(r=>{r.preventDefault(),r.currentTarget.classList.add("dragover")},[]),onDragLeave:$(r=>{const l=r.currentTarget;l.contains(r.relatedTarget)||l.classList.remove("dragover")},[]),onDrop:$(r=>{const l=pe(r.dataTransfer.getData("omnitable/sort-index")),s=pe(r.currentTarget.dataset.index),{settings:u,setSettings:c}=o;r.currentTarget.classList.remove("dragover"),r.preventDefault();const m=u.slice();m.splice(s+(l>=s?0:-1),0,m.splice(l,1)[0]),c(m)},[o]),onToggle:$(r=>{const{settings:l,setSettings:s}=o,u=l.map(m=>({...m,disabled:m.disabled||o.collapsed?.some(b=>b.name===m.name)})),c=pe(r.target.closest("[data-index]")?.dataset.index);u.splice(c,1,{...l[c],disabled:!r.target.checked,priority:r.target.checked?l.reduce((m,b)=>Math.max(m,b.priority),0)+1:l[c].priority}),s(u)},[o])}},on=[ui({apply({availableHeight:i,elements:e}){Object.assign(e.floating.style,{maxHeight:`${Math.max(0,i)}px`})}}),...ci],rn=({onDragStart:i,onDragEnter:e,onDragOver:t,onDragLeave:a,onDrop:n,onDown:o,onToggle:r,collapsed:l,filters:s})=>(u,c)=>{const m=!!l?.find(p=>p.name===u.name),b=!u.disabled&&!m;return d` <div
		...
		>
			...
			<input
				...
				.indeterminate=${m}
			/>
		</div>`},ln=i=>{const{settings:e,settingsId:t,onSave:a,onReset:n,hasChanges:o,opened:r,setOpened:l,...s}=nn(i);return d` <div class="headline">
			${A("Sort and filter")}
			<button
				class="close"
	...
	<cosmoz-dropdown
		...
		.middleware="${on}"
	>
		${_(e,()=>d`<div class="headerDots" slot="button">...</div>`,()=>d` <svg
					viewBox="0 0 24 24"
					width="24"
					slot="button"
					fill="currentColor"
		...
		${_(i?.badge,()=>d`<div class="badge" slot="button"></div>`)}
		<cosmoz-omnitable-settings-ui
			exportparts="columns, groups"
			.config=${i}
		></cosmoz-omnitable-settings-ui>
	</cosmoz-dropdown>
`;customElements.define("cosmoz-omnitable-settings",O(sn,{styleSheets:[De(an)]}));const xe=["sortOn","descending","groupOn","groupOnDescending"],ge=i=>e=>typeof e=="object"&&e!==null&&"name"in e&&e.name===i,un=(i=[],e=[],t=[])=>{const a=e.filter(r=>i.some(ge(r.name))),n=i.filter(r=>r.name!=null&&!e.some(ge(r.name))&&!t.some(ge(r.name))),o=t.filter(r=>!e.some(ge(r.name)));return[...a,...o.flatMap(r=>{const l=i.find(s=>s.name===r.name);return l?{...r,title:l.title??r.title??"",minWidth:parseInt(l.minWidth??"0",10)}:[]}),...n.map(r=>{const{name:l,title:s,priority:u,minWidth:c,width:m,flex:b}=r;return{name:l??"",title:s??"",priority:u??0,minWidth:parseInt(c??"0",10),width:parseInt(m??"0",10),flex:parseInt(b??"0",10)}})]},cn=(i,e)=>({...e,...Ee(Array.from(xe))(i),columns:i.columns?.map(Ee(["name","priority","width","flex","disabled"]))}),dn=({columns:i,settings:e,savedSettings:t,initial:a})=>({...Object.fromEntries(xe.flatMap(o=>a?.[o]!=null?[[o,a[o]]]:[])),...t?Ee(Array.from(xe))(t):{},...e,columns:un(i,e?.columns,t?.columns)}),mn=({prefix:i="omnitable-"}={})=>({write:async(t,a)=>{const n=i+t;try{a?localStorage.setItem(n,JSON.stringify(a)):localStorage.removeItem(n)}catch(o){console.error(o)}},read:async t=>{if(t)try{const a=localStorage.getItem(i+t);return a==null?void 0:JSON.parse(a)}catch(a){console.error(a)}}}),pn=$t(mn),gn=()=>{const i=Le(pn);return F(()=>i(),[i])},bn=(i,e,t,a)=>{const[n,o]=T(),{read:r,write:l}=gn();return M(async()=>{i&&o(await r(i))},[i,r]),{settingsId:i,savedSettings:n,onSave:$(async()=>{if(!i)return;const s=cn(e,n);await l(i,s),t(),o(s)},[e,n]),onReset:$(async s=>{t(),s.shiftKey&&(await l(i),o()),a?.()},[a]),hasChanges:e!=null}},fn=({settingsId:i,host:e})=>{const t=F(()=>Object.fromEntries(xe.map(h=>[h,e[h]])),[]),a=Pe(),n=$(()=>{a.current?.(t)},[t]),[o,r]=T(),[l,s]=T({columns:!0,sort:!0}),{savedSettings:u,...c}=bn(i,o,r,n),{enabledColumns:m}=e,b=Ii(e,{enabledColumns:m}),p=F(()=>dn({columns:b,settings:o,savedSettings:u,initial:t}),[b,o,u]),z=F(()=>p.columns.map(h=>b.find(y=>y.name===h.name)).filter(Boolean),[b,...p.columns.map(h=>h.name)]);return{...c,opened:l,setOpened:s,settings:p,columns:z,setSettings:r,resetRef:a}},ft=i=>Number.isFinite(i)?i:0,hn=(i,e)=>{const t=[];let[a,n]=i.reduce(([c,m],{width:b,flex:p})=>[c+b,m+p],[0,0]),o=e-a,r=ft(o/n),l=0,s=0,u=0;for(let c=0;c<i.length;c++){const{width:m,minWidth:b,flex:p}=i[c],z=o>=0?r*p:m*o/a;if(b>m+z){l+=m,s+=b,u+=p,t[c]=b;continue}if(p===0){l+=m,s+=m,t[c]=m;continue}}a-=l,o=e-s-a,n-=u,r=ft(o/n);for(let c=0;c<i.length;c++){if(t[c]!=null)continue;const{width:m,flex:b}=i[c],p=o>=0?r*b:m*o/a;t[c]=m+p}return t},ve=Symbol("index"),xn=(i,e)=>{if(typeof i.findLastIndex=="function")return i.findLastIndex(e);for(let t=i.length-1;t>=0;t--)if(e(i[t],t,i))return t;return-1},vn=(i,e)=>{const t=xn(i,r=>r!=null&&r>0),a=(r,l)=>`.cell[name="${r}"], cosmoz-omnitable-skeleton::part(cell-${r}){width: ${Math.floor(l)}px;padding: 0 min(3px, ${l/2}px)}`,n=r=>`cosmoz-omnitable-resize-nub[name="${r}"]{display:none}`,o=r=>`cosmoz-omnitable-resize-nub[name="${r}"], .cell[name="${r}"]{display:none}`;return e.map((r,l)=>{const s=i[l];if(s==null||s===0)return o(r.name);const u=a(r.name,s);return l===t?`${u}
${n(r.name)}`:u}).join(`
`)},Vt=(i,e,t)=>{const a=i.filter(l=>!l.hidden),n=a.reduce((l,{width:s})=>l+s,0);if(a.length>1&&n>e)return Vt(a.slice(1),e,t);const o=a.reduce(([l,s],u,c)=>[Math.max(l,u.index),u.index>l?c:s],[-1,-1])[1];return o!==-1&&(a[o].flex=1),hn(a,e).reduce((l,s,u)=>(l[a[u].index]=s,l),new Array(t).fill(void 0))},yn=(i,e)=>i.length===0?".cell {display: none;}":vn(i,e),$n=({host:i,canvasWidth:e,layout:t,setSettings:a})=>{const n=Pe();n.current=o=>a(r=>{const l=r.columns,{detail:{newWidth:s,column:u}}=o,c=l.findIndex(p=>p.name===u.name),m=[],b=l.reduce((p,z)=>Math.max(p,z.priority),-1/0);for(let p=0;p<t.length;p++)if(m[p]={...l[p]},p<c&&t[p]&&(m[p].width=t[p],m[p].flex=0,m[p].priority=b),p===c){const z=t.reduce((h,y,k)=>k<c&&y?h-y:h,e);m[p].width=Math.min(z,Math.max(s,l[p].minWidth)),m[p].flex=0,m[p].priority=b}return{...r,columns:m}}),M(()=>{const o=r=>n.current?.(r);return i.addEventListener("column-resize",o),()=>i.removeEventListener("column-resize",o)},[])},wn=(i,e)=>M(()=>{const t=([n])=>{n.contentRect?.width!==0&&requestAnimationFrame(()=>e(n.contentRect?.width-20-44-24))},a=new ResizeObserver(t);return a.observe(i),()=>a.unobserve(i)},[]),Cn=i=>{const[e,t]=T(()=>i.getBoundingClientRect().width);return wn(i,t),e},Sn=(i,e)=>{const t=F(()=>{let a=!1,n;const o=()=>{if(!a)return;n=requestAnimationFrame(o),i()&&(a=!1)};return{start:()=>{a=!0,cancelAnimationFrame(n),n=requestAnimationFrame(o)},stop:()=>{a=!1,cancelAnimationFrame(n)}}},[]);M(()=>{t.start()},e),M(()=>()=>t.stop(),[])},zn=(i=0,e=0)=>Math.abs(i-e)<.1,qn=(i,e=1.9,t=di)=>{const a=Ve({target:i}),n=$(()=>{if(a.tween||(a.tween=a.target),a.target.every((o,r)=>a.tween[r]===o))return t(a.tween),!0;a.tween=a.target.map((o,r)=>zn(a.tween[r],o)?o:(a.tween[r]??0)+((o??0)-(a.tween[r]??0))/e||0),t(a.tween)},[]);Sn(n,[i])},An=({canvasWidth:i,groupOnColumn:e,config:t,miniColumn:a})=>F(()=>{if(!Array.isArray(t)||i==null||i===0)return[];const n=t.map((o,r)=>({minWidth:o.minWidth,width:o.width,flex:o.flex,priority:o.priority,name:o.name,index:r,hidden:o.name===e?.name||o.disabled})).map(o=>a?{...o,hidden:a.name!==o.name}:o).sort(({index:o,priority:r},{index:l,priority:s})=>r===s?l-o:r-s);return Vt(n,i,n.length)},[i,e,t]),Fn=({host:i,canvasWidth:e,columns:t})=>{const a=i.miniBreakpoint??480,n=F(()=>e<=a,[e,a]),o=F(()=>n?t?.filter(u=>u.mini!=null).sort((u,c)=>(u.mini??0)-(c.mini??0)):[],[t,n]),[r,...l]=o??[],s=!!r;return M(()=>{i.toggleAttribute("mini",s)},[s]),{isMini:s&&n,miniColumn:r,miniColumns:l}},kn=i=>{const e=F(()=>new CSSStyleSheet,[]);return M(()=>{i.shadowRoot.adoptedStyleSheets=[...i.shadowRoot.adoptedStyleSheets,e]},[]),e},_n=({host:i,columns:e,settings:t,setSettings:a,resizeSpeedFactor:n,sortAndGroupOptions:o})=>{const r=Cn(i),{isMini:l,miniColumn:s,miniColumns:u}=Fn({host:i,canvasWidth:r,columns:e}),{groupOnColumn:c}=o,m=An({canvasWidth:r,groupOnColumn:c,miniColumn:s,config:t.columns}),b=kn(i),p=F(()=>t.columns.reduce((h,y,k)=>m[k]!=null||y.name===c?.name||y.disabled?h:[...h,e.find(g=>g.name===y.name)],[]),[e,t,m]),z=Ve({columns:t.columns});return qn(m,n,h=>{const y=yn(h,z.columns);b.replace(y)}),$n({host:i,canvasWidth:r,layout:m,setSettings:h=>a(h(t))}),{isMini:l,collapsedColumns:p,miniColumns:u}},En=({host:i,...e})=>{const{csvFilename:t="omnitable.csv",xlsxFilename:a="omnitable.xlsx",xlsxSheetname:n="Omnitable",topPlacement:o="top-end"}=i;return{csvFilename:t,xlsxFilename:a,xlsxSheetname:n,topPlacement:o,...e}},In=({host:i,selectedItems:e,data:t,sortAndGroupOptions:a,collapsedColumns:n,settings:o,filterFunctions:r,settingS:l,filters:s,...u})=>{const c=t&&t.length>0&&e.length===t.length,m=h=>{h.target.checked?i.shadowRoot.querySelector("#groupedList").selectAll():i.shadowRoot.querySelector("#groupedList").deselectAll()},{groupOnColumn:b}=a,p=F(()=>[b,...n,...o.columns.filter(h=>h.disabled)].some(h=>h&&Object.keys(r).includes(h.name)),[r,o,n]),z=F(()=>({...l,collapsed:n,badge:p,filters:s}),[l,n,p,s]);return M(()=>{const h=i.shadowRoot.querySelector("#tableContent"),y=new ResizeObserver(k=>requestAnimationFrame(()=>{i.style.setProperty("--ot-height",k[0]?.contentRect.height+"px")}));return y.observe(h),()=>y.unobserve(h)},[]),{allSelected:c,onAllCheckboxChange:m,data:t,settingsConfig:z,filters:s,groupOnColumn:b,sortAndGroup:a.sortAndGroup,...u}},Pt=d`
	<svg
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
...
`,Mn=i=>i?"groupRow groupRow-folded":"groupRow",On=({item:i,index:e})=>t=>_(t?.length>0,()=>d`
			...
			`),Ln=({columns:i,collapsedColumns:e,miniColumns:t,onItemClick:a,onCheckboxChange:n,dataIsValid:o,groupOnColumn:r,onItemChange:l,rowPartFn:s})=>(u,c,{selected:m,expanded:b,toggleCollapse:p})=>d`
		<div
			?selected=${m}
			part="${["itemRow",`itemRow-${u[ve]}`,s?.(u,c)].filter(Boolean).join(" ")}"
			.dataIndex=${u[ve]}
			.dataItem=${u}
			class="itemRow"
			@click=${a}
