...
`,customElements.define(`cosmoz-clear-button`,m(pt))})),N,ht,gt,_t,vt,P,F=e((()=>{D(),N=({valuePath:e},t)=>j(t,e),ht=N,gt=N,_t=({valuePath:e},t)=>n=>{let r=j(n,e);return r==null?!1:r.toString().toLowerCase().trim().includes(t.toLowerCase().trim())},vt=(e,t)=>t===``||t==null?null:t,P=e=>class extends e{static get properties(){return{isOmnitableColumn:{type:Boolean,value:!0},title:{type:String},valuePath:{type:String,notify:!0},values:{type:Array,notify:!0},filter:{type:Object},noLocalFilter:{type:Boolean},disabled:{type:Boolean,value:!1,notify:!0},editable:{type:Boolean,notify:!0},loading:{type:Boolean,value:!1,notify:!0},externalValues:{type:Boolean,value:!1,notify:!0},name:{type:String},sortOn:{type:String},groupOn:{type:String},noSort:{type:Boolean,value:!1},disabledFiltering:{type:Boolean,value:!1},width:{type:String,value:`75px`},minWidth:{type:String,value:`40px`},flex:{type:String,value:`1`},cellClass:{type:String,value:`default-cell`},headerCellClass:{type:String,value:`default-header-cell`},priority:{type:Number,value:0},hidden:{type:Boolean,notify:!0},preferredDropdownHorizontalAlign:{type:String,value:`right`},renderHeader:{type:Function},renderCell:{type:Function},renderEditCell:{type:Function},renderGroup:{type:Function},mini:{type:Number,value:null},renderMini:{type:Function}}}static get observers(){return[`notifyFilterChange(filter)`]}notifyFilterChange(e){this.__ownChange||this.dispatchEvent(new CustomEvent(`legacy-filter-changed`,{detail:{name:this.name,state:this.legacyFilterToState(e)},bubbles:!0}))}legacyFilterToState(e){return{filter:e}}getFilterFn(){}getString(e,t){return N(e,t)}toXlsxValue(e,t){return ht(e,t)}cellTitleFn(e,t){return this.getString(e,t)}headerTitleFn(e){return e.title}serializeFilter(e,t){return vt(e,t)}deserializeFilter(e,t){if(t==null)return null;if(typeof t==`string`)try{return window.decodeURIComponent(t)}catch{return null}return t}getComparableValue(e,t){return gt(e,t)}computeSource(e,t){return t}_propertiesChanged(e,t,n){super._propertiesChanged(e,t,n),this.dispatchEvent(new CustomEvent(`cosmoz-column-prop-changed`,{bubbles:!0}))}}})),yt,bt,xt,St,Ct,wt,Tt,Et=e((()=>{C(),mt(),E(),i(),k(),F(),yt=e=>t=>e(n=>{if(n.inputValue===void 0&&t.target.value===``)return n;clearTimeout(n.t);let r=setTimeout(()=>e(e=>({...e,filter:e.inputValue})),1e3);return{...n,inputValue:t.target.value,t:r}}),bt=e=>()=>e(e=>({...e,filter:e.inputValue})),xt=e=>t=>{t.keyCode===13&&(t.preventDefault(),e(e=>({...e,filter:e.inputValue})))},St=e=>t=>e(e=>({...e,headerFocused:t.detail.value})),Ct=e=>()=>e(e=>({...e,filter:null,inputValue:null})),wt=e=>e!=null&&e!==``,Tt=class extends P(O){static get properties(){return{minWidth:{type:String,value:`55px`},editMinWidth:{type:String,value:`55px`},inputValue:{type:Object,notify:!0}}}getFilterFn(e,t){if(!(t==null||t===``))return _t(e,t)}renderCell(e,{item:t}){return o`<span class="default-column">${N(e,t)}</span>`}renderEditCell(e,{item:t},n){return o`<cosmoz-input
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,inputValue:n,headerFocused:r},i){return o`<cosmoz-input
			...
			@blur=${bt(i)}
		>
			${A(!e.disabledFiltering,()=>o`<cosmoz-clear-button
						suffix
						slot="suffix"
						?visible=${wt(t)}
						light
						@click=${Ct(i)}
					></cosmoz-clear-button>`)}
		</cosmoz-input>`}legacyFilterToState(e){return{filter:e,inputValue:e}}},customElements.define(`cosmoz-omnitable-column`,Tt)})),Dt,Ot,kt,At=e((()=>{C(),g(),i(),Dt=[`label`,`value`,`slot`,`always-float-label`,`disabled`],Ot=Ze`
	${me}
...
`,kt=e=>{let{label:t,value:n,slot:r}=e;return Ge(o`<div
		id="input"
		part="input"
		role="button"
		class="control"
	...
	>
		${n||``}
	</div>`,{label:t})},customElements.define(`cosmoz-omnitable-dropdown-input`,m(kt,{observedAttributes:Dt,styleSheets:[Ot]}))})),jt,Mt=e((()=>{xe(),i(),te(),At(),jt=({title:e,tooltip:t=``,filterText:n=``,onOpenedChanged:r,content:i,horizontalAlign:a=`left`,externalValues:s=null})=>o`
		<style>
			.dropdown {
				outline: none;
			}
	...
	`})),Nt,Pt,Ft=e((()=>{Ue(),De(),_(),ne(),Nt=e=>e?typeof e.close==`function`?e:Nt(e.parentElement):null,Pt=e=>class extends e{static get properties(){return{disabled:{type:Boolean,value:!1},filter:{type:Object,notify:!0},values:{type:Array,value(){return[]}},headerFocused:{type:Boolean,notify:!0},min:{type:Number,value:null},max:{type:Number,value:null},limits:{type:Function},autoupdate:{type:String,value:!0},locale:{type:String,value:null},_filterInput:{type:Object,value(){return{min:null,max:null}}},_range:{type:Object,computed:`_computeRange(values.*)`},_limit:{type:Object,computed:`_computeLimit(_range, _filterInput.*, min, max)`,value(){return{}}},_tooltip:{type:String,computed:`_computeTooltip(title, _filterText)`},_fromClasses:{type:String,computed:`_computeInputClasses(_filterInput.min)`},_toClasses:{type:String,computed:`_computeInputClasses(_filterInput.max)`}}}static get observers(){return[`_filterInputChanged(_filterInput.*, autoupdate)`,`_filterChanged(filter.*)`,`_updateLimits(limits, headerFocused)`]}disconnectedCallback(){this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),super.disconnectedCallback()}_computeInputClasses(e){return e!=null&&e!==``?`has-value`:``}toNumber(e,t,n){if(e==null||e===``)return;let r=typeof e==`number`?e:Number(e);if(Number.isNaN(r))return;if(n==null||t==null)return r;let i=this.toNumber(t);return i==null?r:n(r,i)}toValue(){return this.toNumber.apply(this,arguments)}getComparableValue(e,t){if(e==null)return;let n=e;return t!=null&&(n=this.get(t,e)),this.toValue(n)}renderValue(){}getInputString(e,t=this.valuePath){let n=this.toValue(this.get(t,e));return this._toInputString(n)}_computeRange(e){let t=e.base,n=Array.isArray(t)&&t.length&&t.map(e=>this.toValue(e)).filter(e=>e!=null);return!n||n.length<1?{min:null,max:null}:n.reduce((e,t)=>({min:this.toValue(t,e.min,Math.min),max:this.toValue(t,e.max,Math.max)}),{})}_computeLimit(e,t,n,r){if(!e)return;let i=t.base,a=this.toValue(n),o=this.toValue(r),s=a??this.toValue(e.min),c=o??this.toValue(e.max);return{fromMin:s,fromMax:this.toValue(c,this._fromInputString(i.max,`max`),Math.min),toMin:this.toValue(s,this._fromInputString(i.min,`min`),Math.max),toMax:c}}_computeFilterText(e){if(e.base==null)return;let t=e.base,n=this.toValue(t.min),r=this.toValue(t.max),i=[];return n!=null&&i.push(this.renderValue(n)),i.push(` - `),r!=null&&i.push(this.renderValue(r)),i.length>1?i.join(``):void 0}_computeTooltip(e,t){return t==null?e:`${e}: ${t}`}_fromInputString(e){return this.toValue(e)}_toInputString(e){return this.toValue(e)??null}_getDefaultFilter(){return{min:null,max:null}}_filterInputChanged(e,t){let n=e.path.split(`.`)[1];this.__inputChangePath=n||null,t&&(this._limitInputDebouncer=re.debounce(this._limitInputDebouncer,He.after(600),()=>{this._limitInput(),this._updateFilter()}),se(this._limitInputDebouncer))}_clearFrom(){this.set(`_filterInput.min`,null),this._updateFilter()}_clearTo(){this.set(`_filterInput.max`,null),this._updateFilter()}_onBlur(){this._limitInput(),this._updateFilter()}_onKeyDown(e){let t=e.currentTarget,n=Array.from(t.parentElement.querySelectorAll(`cosmoz-input`)),r=n[n.findIndex(e=>e===t)+1],i=!r,a=n[0]===t;switch(e.keyCode){case 13:if(e.preventDefault(),!i)r.focus();else{let e=this._limitInput();this._updateFilter(),e||this._closeParent(t)}break;case 9:(i&&!e.shiftKey||a&&e.shiftKey)&&this._closeParent(t)}}_closeParent(e){let t=Nt(e);t&&t.close()}_onDropdownOpenedChanged({currentTarget:e,type:t,detail:n}){(t===`focus`||n?.value===!0)&&setTimeout(()=>{e.querySelector(`cosmoz-input:focus`)||e.querySelector(`cosmoz-input`)?.focus()},100)}_limitInput(){let e=this._filterInput,t=this.__inputChangePath,n=t?this._fromInputString(this.get(t,e),t):null;if(this.__inputChangePath=null,n==null)return!1;let r=this._limit,i=t===`min`?`from`:`to`,a=this.get(i+`Min`,r),o=this.get(i+`Max`,r),s=this.toValue(n,a,Math.max),c=this.toValue(s,o,Math.min);return this.getComparableValue(n)===this.getComparableValue(c)?!1:(this.set([`_filterInput`,t],this._toInputString(c,t)),this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),!0)}_updateFilter(){let e=this._filterInput,t=this.filter,n=this._fromInputString(e.min,`min`),r=this._fromInputString(e.max,`max`);this.getComparableValue(n)===this.getComparableValue(t,`min`)&&this.getComparableValue(r)===this.getComparableValue(t,`max`)||this.set(`filter`,{min:n,max:r})}_filterChanged(e){if(this._filterInput==null)return;let t=this._filterInput,n=e.base,r=this._fromInputString(t.min,`min`),i=this._fromInputString(t.max,`max`);this.getComparableValue(r)===this.getComparableValue(n,`min`)&&this.getComparableValue(i)===this.getComparableValue(n,`max`)||(this.set(`_filterInput`,{min:this._toInputString(n.min),max:this._toInputString(n.max)}),this._limitInputDebouncer&&this._limitInputDebouncer.cancel())}hasFilter(){let e=this.filter;return e==null?!1:this.toValue(e.min)!=null||this.toValue(e.max)!=null}resetFilter(){this.filter=this._getDefaultFilter()}_updateLimits(e,t){e&&Promise.resolve(Ie(e,{active:t})).then(e=>{let{min:t,max:n}=e??{};Object.assign(this,{...t==null?{}:{min:t},...n==null?{}:{max:n}})})}}})),It,Lt=e((()=>{E(),i(),It=e=>class extends e{static get template(){return qe`<div id="output" style="position:relative;"></div>`}connectedCallback(){super.connectedCallback();let e=this;t(e.render(),e.$.output)}_propertiesChanged(e,n,r){super._propertiesChanged(e,n,r);let i=this;requestAnimationFrame(()=>t(i.render(),i.$.output))}}})),Rt,zt=e((()=>{C(),E(),a(),i(),k(),Mt(),At(),Ft(),Lt(),Rt=class extends Pt(It(O)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:`_computeFilterText(filter.*, _formatters)`},headerFocused:{type:Boolean,value:!1}}}static get observers(){return[`_valuesChanged(autodetect, currency, values)`]}render(){let e=e=>{this.headerFocused=e.type===`focus`,this._onDropdownOpenedChanged(e)};return o`
			...
			${A(this.disabled,()=>o`
				...
				`,()=>o`
					...
					></cosmoz-clear-button>
					${jt({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:o`
		...
		></cosmoz-omnitable-amount-range-input>`}computeSource(e,t){return dn(e,t)}},customElements.define(`cosmoz-omnitable-column-amount`,pn)})),hn,gn,_n,vn,yn,bn,xn,Sn,Cn,wn,Tn,En,Dn=e((()=>{we(),Ue(),ct(),D(),H(),hn=(e,t)=>{if(!Array.isArray(e))return;let n=[];return e.reduce((e,t)=>Array.isArray(t)?(t.forEach(t=>{e.push(t)}),e):(e.push(t),e),[]).filter((e,r,i)=>{if(i.indexOf(e)!==r)return!1;if(t){let r=j(e,t);if(n.indexOf(r)!==-1)return!1;n.push(r)}return!0})},gn=(e,t,n)=>{if(e==null)return[];if(Array.isArray(e)){let r=hn(e,t);if(!r?.length)return r;let i=n??`label`,a=e=>String(typeof e==`object`&&e?j(e,i)??``:e??``);return r.sort((e,t)=>a(e).localeCompare(a(t)))}if(typeof e==`object`){let r=t??`id`,i=n??`label`;return Object.entries(e).map(([e,t])=>({[r]:e,[i]:t})).sort((e,t)=>String(e[i]??``).localeCompare(String(t[i]??``)))}return[]},_n=(e,t,n)=>M(t&&j(e,t)).map(w(n)),vn=({valuePath:e,textProperty:t},n)=>_n(n,e,t).filter(e=>e!=null).join(`, `),yn=vn,bn=({valueProperty:e,valuePath:t,emptyValue:n,emptyProperty:r},i)=>a=>{let o=w(e),s=M(j(a,t));return i.some(t=>s.length===0&&w(r||e)(t)===n||s.some(e=>o(e)===o(t)))},xn=e=>t=>e(e=>({...e,filter:t})),Sn=e=>t=>e(e=>({...e,headerFocused:t})),Cn=e=>t=>e(e=>({...e,query:t})),wn=({emptyValue:e,emptyLabel:t,emptyProperty:n,textProperty:r,valueProperty:i},a)=>{let o=gn(a,i,r);return!t||e===void 0||!r||!(n||i)||!o?o:[{[r]:t,[n||i]:e},...o]},Tn=(e,t)=>wn(e,un(t,e.valuePath)),En=e=>class extends e{static get properties(){return{textProperty:{type:String},valueProperty:{type:String},emptyLabel:{type:String},emptyValue:{type:Object},emptyProperty:{type:String}}}getConfig(e){return{emptyProperty:e.emptyProperty}}getString(e,t){return vn(e,t)}toXlsxValue(e,t){return yn(e,t)}getComparableValue({valuePath:e,valueProperty:t},n){let r=j(n,e);return t==null?r:M(r).map(w(t)).sort().join(` `)}getFilterFn(e,t){if(!(!t||!Array.isArray(t)||t.length===0))return bn(e,t)}serializeFilter(e,t){return t.length===0?null:JSON.stringify(t)}deserializeFilter(e,t){if(t==null)return null;try{return JSON.parse(decodeURIComponent(t))}catch(e){return console.error(`Failed to deserialize filter value:`,{error:e?.name,message:e?.message,filterLength:typeof t==`string`?t.length:null}),null}}computeSource(e,t){return e.externalValues||typeof e.values==`function`?async(...t)=>wn(e,await Promise.resolve(Ie(e.values,...t))):Tn(e,t)}}})),On,kn,An,jn=e((()=>{it(),be(),E(),i(),k(),we(),ct(),Dn(),F(),g(),D(),V(),On=({valuePath:e,textProperty:t,valueProperty:n},r)=>{let i=t?ot(t):w(n),a=M(e&&j(r,e)).map(i);return a.length>1?a.filter(Boolean).join(`,`):a[0]},kn=({valueProperty:e,valuePath:t,emptyValue:n,emptyProperty:r},i)=>{let a=w(e),o=w(r||e),s=new Set(i.filter(e=>e.excluded).map(e=>a(e.item))),c=new Set(i.filter(e=>!e.excluded).map(e=>a(e.item))),l=i.some(e=>e.excluded&&o(e.item)===n),u=i.some(e=>!e.excluded&&o(e.item)===n);return e=>{let n=M(j(e,t)).map(a);return n.length===0?!l&&(u||c.size===0):!n.some(e=>s.has(e))&&(c.size===0||n.some(e=>c.has(e)))}},An=class extends En(P(O)){static get properties(){return{headerCellClass:{type:String,value:`autocomplete-header-cell`},minWidth:{type:String,value:`55px`},editMinWidth:{type:String,value:`55px`},keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},showSingle:{type:Boolean},preserveOrder:{type:Boolean},limit:{type:Number},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,showSingle:e.showSingle,preserveOrder:e.preserveOrder,limit:e.limit,textual:e.textual}}renderCell(e,{item:t}){return o`<span class="default-column"
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:n},r,i){return o`<cosmoz-autocomplete-excluding
			...
			@value-changed=${ie(xn(r))}
			@text-changed=${ie(Cn(r))}
			>${A(e.loading,()=>o`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-excluding
		>`}getComparableValue(e,t){return On(e,t)}getFilterFn(e,t){if(!(!t||!Array.isArray(t)||t.length===0))return kn(e,t)}},customElements.define(`cosmoz-omnitable-column-autocomplete-excluding`,An)})),Mn,Nn,Pn=e((()=>{it(),be(),E(),i(),k(),we(),ct(),Dn(),F(),D(),V(),Mn=({valuePath:e,textProperty:t,valueProperty:n},r)=>{let i=t?ot(t):w(n),a=M(e&&j(r,e)).map(i);return a.length>1?a.filter(Boolean).join(`,`):a[0]},Nn=class extends En(P(O)){static get properties(){return{headerCellClass:{type:String,value:`autocomplete-header-cell`},minWidth:{type:String,value:`55px`},editMinWidth:{type:String,value:`55px`},keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},showSingle:{type:Boolean},preserveOrder:{type:Boolean},limit:{type:Number},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,showSingle:e.showSingle,preserveOrder:e.preserveOrder,limit:e.limit,textual:e.textual}}renderCell(e,{item:t}){return o`<span class="default-column"
			>${e.getString(e,t)}</span
		>`}renderEditCell(e,{item:t},n){return o`<cosmoz-input
			no-label-float
			type="text"
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:n},r,i){return o`<cosmoz-autocomplete-ui
			...
			@opened-changed=${e=>Sn(r)(e.detail.value)}
			.onText=${Cn(r)}
			>${A(e.loading,()=>o`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}getComparableValue(e,t){return Mn(e,t)}},customElements.define(`cosmoz-omnitable-column-autocomplete`,Nn)})),Fn,In,Ln,Rn,zn,Bn,Vn,Hn,Un,Wn,Gn,Kn,qn,Jn,Yn=e((()=>{E(),F(),it(),Be(),D(),i(),k(),Fn=(e,t)=>t.find(({value:t})=>e===t),In=(e,t,n)=>{let r=Fn(t,n);return r?r.text:e},Ln=(e,t,n,r)=>In(e,j(t,n),r),Rn=({valuePath:e},t,n)=>Fn(j(t,e),n),zn=e=>t=>{e(e=>({...e,filter:t?.[0]?.value??null}))},Bn=e=>t=>{e(e=>({...e,headerFocused:t}))},Vn=e=>t=>{e(e=>({...e,query:t}))},Hn=e=>t=>e(t?.[0]?.value),Un=({valuePath:e,trueLabel:t,falseLabel:n},r)=>j(r,e)?t:n,Wn=({valuePath:e},t)=>n=>j(n,e)===t,Gn=c((e,t)=>[{text:e,value:!0},{text:t,value:!1}]),Kn=({valuePath:e,trueLabel:t,falseLabel:n},r)=>e?j(r,e)?t:n:``,qn=(e,t)=>{try{return JSON.parse(t)}catch{return null}},Jn=class extends P(O){static get properties(){return{trueLabel:{type:String,value:`True`},falseLabel:{type:String,value:`False`},flex:{type:String,value:`0`},cellClass:{type:String,value:`boolean-cell`}}}getString(e,t){return Un(e,t)}renderCell(e,{item:t}){return Un(e,t)}renderEditCell(e,{item:t},n){let{trueLabel:r,falseLabel:i}=e;return o`<cosmoz-autocomplete
			no-label-float
			...
			.onChange=${Hn(n)}
			.limit=${1}
			>${A(e.loading,()=>o`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete
			...
			${A(this.disabled,()=>o`
				...
				`,()=>o`
					...
					${jt({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:o`
						...
						`})}
				`)}
		`}_fromInputString(e,t){let n=this.toDate(e);if(n!=null)return t===`min`&&n.setHours(0,0,0,0),t===`max`&&n.setHours(23,59,59),n}_filterInputChanged(e,t){let n=e.path.split(`.`)[1]&&e.value;if(n&&n.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}},customElements.define(`cosmoz-omnitable-date-range-input`,Qn)})),er,tr,nr,U,W,rr,ir,ar,or,sr,cr,lr,ur,dr,fr,pr=e((()=>{ye(),D(),Kt(),er=e=>{let t=-new Date(e).getTimezoneOffset()/60;return(t<0?`-`:`+`)+[`0`,Math.abs(t)].join(``).substr(-2)+`:00`},tr=e=>e.length===19?e+er(e):e,nr=e=>{if(e==null||e===``)return;let t=e;return!(t instanceof Date)&&(typeof e==`string`&&(t=tr(t)),t=ge(t),!t)||Number.isNaN(t.getTime())?null:t},U=({valuePath:e},t)=>{if(t==null)return;let n=t;e!=null&&(n=j(t,e));let r=nr(n);if(r!=null)return I(r.getTime())},W=(e,t,n)=>{let r=nr(e);if(r==null)return null;if(n==null||t==null)return r;let i=W(t);if(i==null)return r;let a=U({},r),o=U({},i);return a==null||o==null||n(a,o)===a?r:i},rr=(e,t)=>{if(t==null)return;let n=W(e);if(n!=null)return t.format(n)},ir={},ar=e=>{let t=e||``;return ir[t]||(ir[t]=new Intl.DateTimeFormat(e||void 0)),ir[t]},or=({valuePath:e,locale:t},n)=>{let r=j(n,e||``);return r===void 0?``:(r=W(r),r===null?`Invalid Date`:rr(r,ar(t)))},sr=e=>{let t=W(e);if(t==null)return null;let n=le(t);return n==null?null:n.slice(0,10)},cr=({valuePath:e},t)=>sr(j(t,e||``)),lr=(e,t)=>{let n=W(e);if(n!=null)return t===`min`&&n.setHours(0,0,0,0),t===`max`&&n.setHours(23,59,59),n},ur=e=>sr(e)??``,dr=({valuePath:e},t)=>{if(!e)return``;let n=W(j(t,e));if(!n)return``;let r=W(le(n));return r?(r.setHours(0,0,0,0),r):``},fr=(e,t)=>n=>{let r=U(e,n);if(r==null)return!1;let i=U({...e,valuePath:`min`},t),a=U({...e,valuePath:`max`},t);return!(r<(i??-1/0)||r>(a??1/0))}})),mr,hr=e((()=>{C(),E(),i(),F(),$n(),H(),pr(),mt(),mr=class extends P(O){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:`date-header-cell`},width:{type:String,value:`100px`},minWidth:{type:String,value:`82px`},flex:{type:String,value:`0`}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){let n=U({...e,valuePath:`min`},t),r=U({...e,valuePath:`max`},t);if(!(n==null&&r==null))return fr(e,t)}getString(e,t){return or(e,t)}toXlsxValue(e,t){return dr(e,t)}getComparableValue(e,t){return U(e,t)}serializeFilter(e,t){if(t==null)return;let n=W(t.min),r=W(t.max);if(!(n==null&&r==null))return ur(n)+`~`+ur(r)}deserializeFilter(e,t){if(typeof t!=`string`||t===``)return null;let n=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(n)?{min:W(n[1]),max:W(n[2])}:null}renderCell(e,{item:t}){return o`<div class="omnitable-cell-date">
			${or(e,t)}
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return dn(e,t)}},customElements.define(`cosmoz-omnitable-column-date`,mr)})),gr,_r=e((()=>{E(),a(),i(),k(),Zn(),Mt(),At(),Lt(),gr=class extends Xn(It(O)){render(){let e=e=>{this.headerFocused=e.type===`focus`};return o`
			<style>
		...
		></cosmoz-omnitable-datetime-range-input>`}computeSource(e,t){return dn(e,t)}},customElements.define(Tr.is,Tr)})),Dr,Or=e((()=>{it(),be(),E(),i(),k(),Dn(),F(),Dr=class extends En(P(O)){renderCell({valuePath:e,textProperty:t},{item:n}){return o`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		`}renderEditCell(){return`not implemented`}renderHeader(e,{filter:t,query:n},r,i){return o`<cosmoz-autocomplete-ui
			...
			.onText=${Cn(r)}
			>${A(e.loading,()=>o`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}},customElements.define(`cosmoz-omnitable-column-list-horizontal`,Dr)})),kr,Ar,jr=e((()=>{v(),g(),a(),kr=T`
	:host {
		display: block;
	}
...
`,Ar=({items:e})=>{let[t,n]=x(!1),i=Array.isArray(e)?e:[],a=b(()=>Math.max(0,i.length-1),[i]);if(i.length===0)return null;let s=i.length>2,c=i[0],l=s&&!t?[]:i.slice(1),u=e=>{e.stopPropagation(),e.preventDefault(),n(e=>!e)};return o`
	...
	`},customElements.define(`cosmoz-omnitable-column-list-data`,m(Ar,{styleSheets:[Xe(kr)]}))})),Mr,Nr=e((()=>{jr(),E(),i(),k(),it(),Dn(),F(),V(),Mr=class extends En(P(O)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:n}){return o`<cosmoz-omnitable-column-list-data
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:n},r,i){return o`<cosmoz-autocomplete-ui
			...
			.onText=${Cn(r)}
			>${A(e.loading,()=>o`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}},customElements.define(`cosmoz-omnitable-column-list`,Mr)})),Pr,Fr=e((()=>{C(),E(),a(),i(),k(),Mt(),At(),Ft(),Lt(),Pr=class extends Pt(It(O)){static get properties(){return{maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null},formatter:{type:Object,computed:`_computeFormatter(locale, minimumFractionDigits, maximumFractionDigits)`},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:`_computeFilterText(filter.*, formatter)`},headerFocused:{type:Boolean,value:!1}}}render(){let e=e=>{this.headerFocused=e.type===`focus`,this._onDropdownOpenedChanged(e)};return o`
			<style>
				cosmoz-input[type='number'] {
					background: var(--cosmoz-omnitable-amount-input-background, #ffffff);
					border-radius: 6px;
			...
			${A(this.disabled,()=>o`
				...
				`,()=>o`
					<cosmoz-clear-button
						...
						?visible=${this.hasFilter()}
					></cosmoz-clear-button>
					${jt({title:this.title,tooltip:this._tooltip,filterText:this._filterText,horizontalAlign:`right`,externalValues:this.externalValues,onOpenedChanged:e,content:o`
							<h3>${this.title}</h3>
							<cosmoz-input
								class=${this._fromClasses}
								type="number"
		...
		></cosmoz-omnitable-number-range-input>`}computeSource(e,t){return dn(e,t)}},customElements.define(`cosmoz-omnitable-column-number`,Ir)})),Rr,zr=e((()=>{C(),E(),a(),i(),k(),Zn(),Mt(),At(),Lt(),Rr=class extends Xn(It(O)){render(){let e=e=>{this.headerFocused=e.type===`focus`};return o`
			${A(this.disabled,()=>o`
					<cosmoz-omnitable-dropdown-input
						disabled
						.label=${this.title}
...
>
	...
	/>
</svg> `})),si,ci,li,ui,di=e((()=>{g(),Le(),oi(),si=({column:e,on:t,descending:n,setOn:r,setDescending:i})=>{let{name:a,title:s}=e??{};return o`<button
		class="sg"
		title=${Ce(s)}
		data-on=${Ce(a===t&&(n?`desc`:`asc`)||void 0)}
...
`}));function fi(e,t,{suffix:n=``,read:r,write:i,ready:a=!0,multi:o}={}){let s=ut({param:t,suffix:n,link:o?gi:hi,write:i??Ye}),c=b(()=>{if(t==null)return!1;if(o){let e=Oe(t+n);return Object.keys(e).length>0}return je(t+n)!==void 0},[]),[l,d]=x(()=>{if(t==null)return e;if(o){let i=Oe(t+n,r);return Object.keys(i).length>0?i:e}return je(t+n,r)??e}),f=u(e=>d(t=>{let n=Ie(e,t);return s.param!=null&&Fe(s.link(s.param+s.suffix,n,s.write),null,{notify:!1}),n}),[]);return S(()=>{s.param==null||!a||c||e!=null&&f(e)},[a]),[l,f]}var pi,mi,hi,gi,_i=e((()=>{Je(),Ue(),at(),rt(),g(),pi=e=>(t,n,r=Ye)=>{let i=Ve(),a=new URLSearchParams(i.hash.replace(`#`,``));return e(t,n,r,a),`#!`+Object.assign(i,{hash:a}).href.replace(location.origin,``)},mi=e=>e==null||e===``,hi=pi((e,t,n,r)=>mi(n(t))?r.delete(e):r.set(e,n(t))),gi=pi((e,t,n,r)=>{let i=Object.entries(t),a=i.map(n).filter(([,e])=>e!==void 0);if(a.length===0&&i.length>0)return;let o=e;Array.from(r.keys()).filter(e=>e.startsWith(o)).forEach(e=>r.delete(e)),a.forEach(([t,n])=>mi(n)?r.delete(e+t):r.set(e+t,n))})})),vi,yi,bi,xi,Si,Ci=e((()=>{g(),_i(),vi=e=>[!0,`true`,1,`yes`,`on`].includes(e),yi=e=>e===``||(e==null?void 0:vi(e)),bi=(e,t,n)=>u(r=>{e(r),n(e=>({...e,[t]:r}))},[e,t,n]),xi=(e,t,{settings:n,setSettings:r,resetRef:i,ready:a=!0})=>{let[o,s]=fi(n.sortOn,t,{suffix:`-sortOn`,ready:a}),[c,l]=fi(yi(n.descending),t,{suffix:`-descending`,read:yi,ready:a}),[d,f]=fi(n.groupOn,t,{suffix:`-groupOn`,ready:a}),[p,m]=fi(yi(n.groupOnDescending),t,{suffix:`-groupOnDescending`,read:yi,ready:a}),h=b(()=>e.find(e=>e.name===o),[e,o]),g=b(()=>e.find(e=>e.name===d),[e,d]),_={groupOn:d,setGroupOn:bi(f,`groupOn`,r),groupOnDescending:p,setGroupOnDescending:bi(m,`groupOnDescending`,r),sortOn:o,setSortOn:bi(s,`sortOn`,r),descending:c,setDescending:bi(l,`descending`,r),columns:e},v=b(()=>_,Object.values(_)),y=u(e=>{s(e.sortOn),f(e.groupOn),l(e.descending),m(e.groupOnDescending)},[]);return S(()=>void(i.current=y),[]),{...v,sortAndGroup:v,groupOnColumn:g,sortOnColumn:h}},Si=oe(),customElements.define(`sort-and-group-provider`,Si.Provider),customElements.define(`sort-and-group-consumer`,m(({render:e})=>e(he(Si)),{useShadowDOM:!1}))})),wi,Ti,Ei=e((()=>{g(),ae(),ti(),di(),k(),Ci(),wi=({data:e,columns:t,groupOnColumn:n,filters:r,setFilterState:i,sortAndGroup:{sortOn:a,setSortOn:s,descending:c,setDescending:l}={}})=>p(t,e=>e.name,t=>[o`<div
			...
			>
				...
				${A(!t.noSort,()=>si({on:a,setOn:s,descending:c,setDescending:l,column:t}))}
			</div>`,o`<cosmoz-omnitable-resize-nub
				.column="${t}"
				name="${t.name}"
			></cosmoz-omnitable-resize-nub>`]),Ti=({columns:e,settingsConfig:t,hideSelectAll:n,...r})=>{let i=he(Si);return o`
		${A(e,e=>wi({columns:e,sortAndGroup:i,...r}))}
		${A(!n,()=>o` <cosmoz-omnitable-settings
					.config=${t}
					part="settings"
				></cosmoz-omnitable-settings>`)}
	`},customElements.define(`cosmoz-omnitable-header-row`,m(Ti,{useShadowDOM:!1}))})),Di,Oi,ki=e((()=>{v(),g(),Di=T`
	:host {
		display: flex;
		align-items: center;
		flex-wrap: wrap;
...
`,customElements.define(`cosmoz-omnitable-item-expand-line`,m(Oi,{styleSheets:[Xe(Di)]}))})),Ai,ji=e((()=>{g(),i(),et(),ki(),Ai=({columns:e,item:t,selected:n,expanded:r,groupOnColumn:i})=>Ee(e,e=>o`<cosmoz-omnitable-item-expand-line
				.column=${e}
				?hidden=${e===i}
				exportparts="item-expand-label, item-expand-value"
				>${e.renderCell(e,{item:t,selected:n,expanded:r})}</cosmoz-omnitable-item-expand-line
			>`),customElements.define(`cosmoz-omnitable-item-expand`,m(Ai,{useShadowDOM:!1}))})),Mi,Ni,Pi=e((()=>{g(),ae(),Mi=(e,t,n)=>e.editable?e.renderEditCell(e,t,n(e,t.item)):e.renderCell(e,t),Ni=({columns:e,groupOnColumn:t,item:n,index:r,selected:i,expanded:a,onItemChange:s})=>p(e,e=>e.name,e=>o`<div
			...
			</div>`),customElements.define(`cosmoz-omnitable-item-row`,m(Ni,{useShadowDOM:!1}))})),Fi,Ii,Li=e((()=>{v(),Fi=T`
	.checkbox {
		box-sizing: border-box;
		width: 18px;
		height: 18px;
...
`})),Ri,zi,Bi=e((()=>{Se(),Ri=e=>{let t=e.replace(/"/gu,`""`);return t.search(/("|,|\n)/gu)>=0?`"`+t+`"`:e},zi=(e,t,n)=>{let r=e.map(e=>Ri(e.title)).join(`;`)+`
`,i=t.map(t=>e.map(e=>{let n=e.getString(e,t);return n==null?``:Ri(String(n))}).join(`;`)+`
`);i.unshift(r),Ke(new File(i,n,{type:`text/csv;charset=utf-8`}))}})),Vi,Hi,Ui=e((()=>{We(),Se(),Vi=(e,t)=>{let n=e.map(e=>e.title),r=t.map(t=>e.map(e=>e.toXlsxValue(e,t)??``));return r.unshift(n),r},Hi=(e,t,n,r)=>{let i=Vi(e,t),a=new Qe(n).addSheetFromData(i,r).generate();Ke(new File([a],n,{type:`application/vnd.openxmlformats-officedocument.spreadsheetml.sheet`}))}})),Wi,Gi=e((()=>{s(),a(),i(),Bi(),Ui(),Wi=({columns:e,selectedItems:t,csvFilename:n,xlsxFilename:i,xlsxSheetname:a,topPlacement:s})=>o`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!Ae(t.length)}
		part="bottomBar"
	...
	>
	...
	</cosmoz-bottom-bar>`})),Ki,qi=e((()=>{i(),k(),Ki=({allSelected:e,onAllCheckboxChange:t,sortAndGroup:n,dataIsValid:r,data:i,columns:a,filters:s,groupOnColumn:c,setFilterState:l,settingsConfig:u,hideSelectAll:d})=>o`<sort-and-group-provider .value=${n}>
		<div class="header" id="header" part="header">
			${A(!d,()=>o`<input
						...
						part="all"
					/>`)}
			${A(d,()=>o` <cosmoz-omnitable-settings
						.newLayout="${!0}"
						.config=${u}
					></cosmoz-omnitable-settings>`)}
	...
	</sort-and-group-provider>`})),Ji,Yi,Xi=e((()=>{g(),Ji=Ze`
	:host {
		max-width: 100%;
		overflow-x: hidden;
		padding: 0 12px;
...
`,Yi=({settingsConfig:e})=>{let{columns:t,collapsed:n}=e,r=t.filter(e=>!n.some(t=>t.name===e.name));return o`<div class="skeleton">
	...
	</div>`},customElements.define(`cosmoz-omnitable-skeleton`,m(Yi,{styleSheets:[Ji]}))})),Zi,Qi=e((()=>{g(),Xi(),ve(),a(),i(),k(),Zi=(e,t)=>{let{settingsConfig:n}=e,{processedItems:i,dataIsValid:a,filterIsTooStrict:s,loading:c,displayEmptyGroups:l,compareItemsFn:u,selectedItems:d,setSelectedItems:f,renderItem:p,renderGroup:m,error:h}=t;return o`${A(!c&&!a&&!h,()=>o`<div class="tableContent-empty">
		...
		${A(s,()=>o`<div class="tableContent-empty">
					${ke({width:`96px`,height:`96px`,styles:`margin-right: 24px; fill: currentColor;`})}
					<div>
		...
		${A(c&&!i.length,()=>o`<div class="tableContent-empty overlay">
					<cosmoz-omnitable-skeleton
						.settingsConfig=${n}
					></cosmoz-omnitable-skeleton>
				</div>`)}
		${A(c&&i.length,()=>o`<div class="tableContent-empty overlay spinner">
					<cz-spinner></cz-spinner>
				</div>`)}
		${A(h,()=>o`<div class="tableContent-empty overlay">
...
`})),na,ra,ia=e((()=>{at(),g(),na=e=>{let t=parseInt(e,10);return isFinite(t)?t:void 0},ra=e=>{let{config:t}=e,{settings:n,setSettings:r,collapsed:i,requestTween:a}=t,o=ut({collapsed:i,settings:n.columns,requestTween:a,setSettings:u(e=>r(t=>({...t,columns:e})),[r])});return{...t,onDown:u(e=>{e.target.closest(`.pull`)&&(o.handle=e.currentTarget)},[o]),onDragStart:u(e=>{let{target:t}=e,n=na(t.dataset.index);if(!o.handle?.contains(t)||n==null)return e.preventDefault();o.handle=null,e.dataTransfer.effectAllowed=`move`,e.dataTransfer.setData(`omnitable/sort-index`,n),e.dataTransfer.setData(`text/plain`,n),setTimeout(()=>t.classList.add(`drag`),0),t.addEventListener(`dragend`,e=>e.target.classList.remove(`drag`),{once:!0})},[o]),onDragEnter:u(e=>{let t=e.currentTarget;t===e.target&&(e.preventDefault(),e.dataTransfer.dropEffect=`move`,t.classList.add(`dragover`))},[]),onDragOver:u(e=>{e.preventDefault(),e.currentTarget.classList.add(`dragover`)},[]),onDragLeave:u(e=>{let t=e.currentTarget;t.contains(e.relatedTarget)||t.classList.remove(`dragover`)},[]),onDrop:u(e=>{let t=na(e.dataTransfer.getData(`omnitable/sort-index`)),n=na(e.currentTarget.dataset.index),{settings:r,setSettings:i,requestTween:a}=o;e.currentTarget.classList.remove(`dragover`),e.preventDefault();let s=r.slice();s.splice(n+(t>=n?0:-1),0,s.splice(t,1)[0]),a?.(),i(s)},[o]),onToggle:u(e=>{let{settings:t,setSettings:n,requestTween:r}=o,i=t.map(e=>({...e,disabled:e.disabled||o.collapsed?.some(t=>t.name===e.name)})),a=na(e.target.closest(`[data-index]`)?.dataset.index);i.splice(a,1,{...t[a],disabled:!e.target.checked,priority:e.target.checked?t.reduce((e,t)=>Math.max(e,t.priority),0)+1:t[a].priority}),r?.(),n(i)},[o])}}})),aa,oa,sa,ca,la=e((()=>{nt(),lt(),v(),s(),g(),a(),k(),oi(),di(),ta(),ia(),aa=[f({apply({availableHeight:e,elements:t}){Object.assign(t.floating.style,{maxHeight:`${Math.max(0,e)}px`})}}),...Te],oa=({onDragStart:e,onDragEnter:t,onDragOver:n,onDragLeave:r,onDrop:i,onDown:a,onToggle:s,collapsed:c,filters:l})=>(u,d)=>{let f=!!c?.find(e=>e.name===u.name),p=!u.disabled&&!f;return o` <div
		...
		${A(n,()=>o`<div class="buttons">
				...
				</div>`)}`},customElements.define(`cosmoz-omnitable-settings-ui`,m(sa,{styleSheets:[Xe($i)]})),ca=({config:e,newLayout:t})=>o`
	<cosmoz-dropdown
		.placement="${t?`bottom-start`:`bottom-end`}"
		.middleware="${aa}"
	>
		<div title="${r(`Sort and filter`)}" slot="button">
			${A(t,()=>o`<div class="headerDots">...</div>`,()=>o` <svg viewBox="0 0 24 24" width="24" fill="currentColor">
						<circle cx="10" cy="18" r="2"></circle>
						<circle cx="10" cy="12" r="2"></circle>
						<circle cx="10" cy="6" r="2"></circle>
					</svg>`)}
			${A(e?.badge,()=>o`<div class="badge"></div>`)}
		</div>
		<cosmoz-omnitable-settings-ui
...
`,ao=e=>e?`groupRow groupRow-folded`:`groupRow`,oo=({item:e,index:t})=>n=>A(n?.length>0,()=>o`
