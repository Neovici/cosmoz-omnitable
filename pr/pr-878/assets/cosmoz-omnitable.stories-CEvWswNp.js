import{b as d,D as ke,A as xt}from"./iframe-BZbhRvSM.js";import{t as K,c as O,g as S,P as I,u as T,a as yt,m as vt,s as Bt,D as Ht,b as Gt,e as Wt,i as $e,h as Oe,d as jt,f as $t,r as Ut,j as Kt,k as q,l as Jt,n as Ce,p as he,o as k,q as Xt,v as we,w as Qt,x as Yt,y as Zt,T as ei,z as M,A as Ye,B as F,C,E as ti,F as ii,G as ai,H as ni,I as oi,J as Ct,K as Le,L as wt,M as De,N as ri,O as St,Q as li,R as Te,S as Ze,U as si,V as Ve,W as ui,X as ci,Y as Ee,Z as Re,_ as di,$ as Ie,a0 as N,a1 as mi,a2 as ze,a3 as pi}from"./cosmoz-collapse-DNiDnQvi.js";import"./preload-helper-PPVm8Dsz.js";const gi=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,Di=i=>{const{label:e,value:t,slot:a}=i,n=d`<div
	...
	`};class Ti extends Ne(ae(I)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return d`
			<style>
		...
		>`}getComparableValue(e,t){return Yi(e,t)}}customElements.define("cosmoz-omnitable-column-autocomplete",Zi);const Ue=(i,e)=>e.find(({value:t})=>i===t),ea=(i,e,t)=>{const a=Ue(e,t);return a?a.text:i},ot=(i,e,t,a)=>ea(i,S(e,t),a),ta=({valuePath:i},e,t)=>Ue(S(e,i),t),ia=i=>e=>{i(t=>({...t,filter:e?.[0]?.value??null}))},aa=i=>e=>{i(t=>({...t,headerFocused:e}))},na=i=>e=>{i(t=>({...t,query:e}))},oa=i=>e=>i(e?.[0]?.value),rt=({valuePath:i,trueLabel:e,falseLabel:t},a)=>S(a,i)?e:t,ra=({valuePath:i},e)=>t=>S(t,i)===e,le=vt((i,e)=>[{text:i,value:!0},{text:e,value:!1}]),la=({valuePath:i,trueLabel:e,falseLabel:t},a)=>i?S(a,i)?e:t:"",sa=(i,e)=>{try{return JSON.parse(e)}catch{return null}};class ua extends V(I){static get properties(){return{trueLabel:{type:String,value:"True"},falseLabel:{type:String,value:"False"},flex:{type:String,value:"0"},cellClass:{type:String,value:"boolean-cell"}}}getString(e,t){return rt(e,t)}renderCell(e,{item:t}){return rt(e,t)}renderEditCell(e,{item:t},a){const{trueLabel:n,falseLabel:o}=e;return d`<cosmoz-autocomplete
			no-label-float
		...
		>`}computeSource({trueLabel:e,falseLabel:t}){return le(e,t)}getFilterFn(e,t){if(t!=null)return ra(e,t)}toXlsxValue(e,t){return la(e,t)}deserializeFilter(e,t){return sa(e,t)}}customElements.define("cosmoz-omnitable-column-boolean",ua);const Ke=i=>class extends Ne(i){static get properties(){return{max:{type:Date,value:null},min:{type:Date,value:null},_filterText:{type:String,computed:"_computeFilterText(filter.*, formatter)"},formatter:{type:Object,computed:"_computeFormatter(locale)"}}}toDate(e,t,a){if(e==null||e==="")return;let n=e;if(n instanceof Date||(typeof e=="string"&&(n=this.getAbsoluteISOString(n)),n=new Date(n)),Number.isNaN(n.getTime()))return null;if(a==null||t==null)return n;const o=this.toDate(t);if(o==null)return n;const r=this.getComparableValue(n),l=this.getComparableValue(o);return a(r,l)===r?n:o}toValue(){return this.toDate.apply(this,arguments)}getComparableValue(e,t){const a=super.getComparableValue(e,t);if(a!=null)return this.toNumber(a.getTime())}getString(e,t=this.valuePath,a=this.formatter){const n=this.toValue(this.get(t,e));return n===void 0?"":n===null?"Invalid Date":this.renderValue(n,a)}getAbsoluteISOString(e){return e.length===19?e+this._getTimezoneString(e):e}_getTimezoneString(e){const t=-new Date(e).getTimezoneOffset()/60;return(t<0?"-":"+")+["0",Math.abs(t)].join("").substr(-2)+":00"}renderValue(e,t=this.formatter){if(t==null)return;const a=this.toValue(e);if(a!=null)return t.format(a)}_computeFormatter(e){return new Intl.DateTimeFormat(e||void 0)}_toInputString(e){const t=this.toValue(e);return t==null?null:this._toLocalISOString(t).slice(0,10)}_dateValueChanged(e){const t=e.currentTarget,a=t.value,n=e.model.item,o=this.get(this.valuePath,n),r=this._fromInputString(a);this.set(this.valuePath,r,n),this._fireItemChangeEvent(n,this.valuePath,o,this.renderValue.bind(this))}_toLocalISOString(e){return we(e)}};class ca extends Ke(ae(I)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return d`
			...
			${ne({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:d`
					...
					></cosmoz-input>
				`})}
		`}_fromInputString(e,t){const a=this.toDate(e);if(a!=null)return t==="min"&&a.setHours(0,0,0,0),t==="max"&&a.setHours(23,59,59),a}_filterInputChanged(e,t){const a=e.path.split(".")[1],n=a&&e.value;if(n&&n.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}}customElements.define("cosmoz-omnitable-date-range-input",ca);const da=i=>{const e=-new Date(i).getTimezoneOffset()/60;return(e<0?"-":"+")+["0",Math.abs(e)].join("").substr(-2)+":00"},Je=i=>i.length===19?i+da(i):i,_t=i=>{if(i==null||i==="")return;let e=i;return!(e instanceof Date)&&(typeof i=="string"&&(e=Je(e)),e=Qt(e),!e)||Number.isNaN(e.getTime())?null:e},R=({valuePath:i},e)=>{if(e==null)return;let t=e;i!=null&&(t=S(e,i));const a=_t(t);if(a!=null)return L(a.getTime())},E=(i,e,t)=>{const a=_t(i);return a??null},Xe=(i,e)=>{if(e==null)return;const t=E(i);if(t!=null)return e.format(t)},se={},ma=i=>{const e=i||"";return se[e]||(se[e]=new Intl.DateTimeFormat(i||void 0)),se[e]},lt=({valuePath:i,locale:e},t)=>{let a=S(t,i||"");return a===void 0?"":(a=E(a),a===null?"Invalid Date":Xe(a,ma(e)))},kt=i=>{const e=E(i);if(e==null)return null;const t=we(e);return t==null?null:t.slice(0,10)},pa=({valuePath:i},e)=>kt(S(e,i||"")),Et=(i,e)=>{const t=E(i);if(t!=null)return t},st=i=>{const e=kt(i);return e??""},ga=({valuePath:i},e)=>{if(!i)return"";const t=E(S(e,i));if(!t)return"";const a=E(we(t));return a?(a.setHours(0,0,0,0),a):""},It=(i,e)=>t=>{const a=R(i,t);if(a==null)return!1;const n=R({...i,valuePath:"min"},e),o=R({...i,valuePath:"max"},e);return!(a<(n??-1/0)||a>(o??1/0))};class ba extends V(I){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"date-header-cell"},width:{type:String,value:"100px"},minWidth:{type:String,value:"82px"},flex:{type:String,value:"0"}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const a=R({...e,valuePath:"min"},t),n=R({...e,valuePath:"max"},t);if(!(a==null&&n==null))return It(e,t)}getString(e,t){return lt(e,t)}toXlsxValue(e,t){return ga(e,t)}getComparableValue(e,t){return R(e,t)}serializeFilter(e,t){if(t==null)return;const a=E(t.min),n=E(t.max);if(!(a==null&&n==null))return st(a)+"~"+st(n)}deserializeFilter(e,t){if(t==null||t==="")return null;const a=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(a)?{min:E(a[1]),max:E(a[2])}:null}renderCell(e,{item:t}){return d`<div class="omnitable-cell-date">
			${lt(e,t)}
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return ie(e,t)}}customElements.define("cosmoz-omnitable-column-date",ba);class fa extends je(V(I)){renderCell({valuePath:e,textProperty:t},{item:a}){const n=Pe(a,e,t).map(o=>d`<li>${o}</li>`);return d`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		></cosmoz-omnitable-number-range-input>`}computeSource(e,t){return ie(e,t)}}customElements.define("cosmoz-omnitable-column-number",ya);const Mt="1970-01-01",B=(i,e,t)=>{const a=typeof i=="string"&&i.length>3&&i.length<=9?Je(Mt+"T"+i):i;return E(a)},ue={},va=i=>{const e=i||"";if(ue[e])return ue[e];const t={hour:"numeric",minute:"numeric",second:"numeric"};return ue[e]=new Intl.DateTimeFormat(i||void 0,t),ue[e]},fe=({valuePath:i,locale:e},t)=>{const a=B(S(t,i||""));return a===void 0?"":a===null?"Invalid Date":Xe(a,va(e))},$a=(i,e)=>i.valuePath?fe(i,e):"",Ca=i=>{const e=B(i);if(e==null)return null;const t=we(e);return t&&t.slice(11,19)},j=({valuePath:i},e)=>{if(e==null)return;const t=Ca(i==null?e:S(e,i));if(t==null)return;const a=B(Je(Mt+"T"+t));return a==null?a:L(a.getTime())},wa=(i,e)=>t=>{const a=j(i,t);if(a==null)return!1;const n=j({...i,valuePath:"min"},e),o=j({...i,valuePath:"max"},e);return n==null||o==null?!1:!(a<n||a>o)},ct=i=>{const e=B(i);return e==null?"":e.toISOString().slice(11,19).replace(/:/gu,".")},dt=i=>{if(!(i==null||i===""))return B(typeof i=="string"?i.replace(/\./gu,":")+"Z":i)};class Sa extends Ke(ae(I)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return d`
			<cosmoz-clear-button
				@click=${()=>this.resetFilter()}
				?visible=${this.hasFilter()}
			></cosmoz-clear-button>
		...
		></cosmoz-input>`}renderHeader({title:e,min:t,max:a,locale:n,filterStep:o},{filter:r},l,u){return d`<cosmoz-omnitable-time-range-input
			...
			@filter-changed=${({detail:{value:s}})=>l(c=>({...c,filter:s}))}
			@header-focused-changed=${({detail:{value:s}})=>l(c=>({...c,headerFocused:s}))}
		></cosmoz-omnitable-time-range-input>`}computeSource(e,t){return ie(e,t)}}customElements.define("cosmoz-omnitable-column-time",za);const ce={},qa=i=>{const e=i||"";if(ce[e])return ce[e];const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return ce[e]=new Intl.DateTimeFormat(i||void 0,t),ce[e]},qe=({valuePath:i,locale:e},t)=>{const a=E(S(t,i||""));return a===void 0?"":a===null?"Invalid Date":Xe(a,qa(e))},Aa=({valuePath:i},e)=>i?S(e,i):"",mt=i=>{const e=E(i);return e==null?"":e.toISOString().slice(0,19).replace(/:/gu,".")},pt=i=>{if(!(i==null||i==="")&&typeof i=="string")return E(i.replace(/\./gu,":")+"Z")};class Fa extends Ke(ae(I)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return d`
			<style>
			...
			${ne({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:d`
					...
					></cosmoz-datetime-input>
				`})}
		`}_toInputString(e){const t=this.toValue(e);if(t!=null)return this._toLocalISOString(t).slice(0,19)}_computeFormatter(e){const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return new Intl.DateTimeFormat(e||void 0,t)}}customElements.define("cosmoz-omnitable-datetime-range-input",Fa);class gt extends V(I){static get is(){return"cosmoz-omnitable-column-datetime"}static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"datetime-header-cell"},width:{type:String,value:"210px"},minWidth:{type:String,value:"128px"},flex:{type:String,value:"0"},filterStep:{type:Number,value:1}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const a=R({...e,valuePath:"min"},t),n=R({...e,valuePath:"max"},t);if(!(a==null&&n==null))return It(e,t)}getString(e,t){return qe(e,t)}toXlsxValue(e,t){return Aa(e,t)}getComparableValue(e,t){return R(e,t)}serializeFilter(e,t){if(t==null)return;const a=E(t.min),n=E(t.max);if(!(a==null&&n==null))return mt(a)+"~"+mt(n)}deserializeFilter(e,t){if(t==null||t==="")return null;const a=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(a)?{min:pt(a[1]),max:pt(a[2])}:null}renderCell(e,{item:t}){return qe(e,t)}renderEditCell(e,{item:t},a){return d`<cosmoz-input
			no-label-float
			type="text"
			@change=${o=>a(Et(o.target.value))}
			.value=${qe(e,t)}
...
`,Dt=i=>(e,t,a=ni)=>{const n=oi(),o=new URLSearchParams(n.hash.replace("#",""));return i(e,t,a,o),"#!"+Object.assign(n,{hash:o}).href.replace(location.origin,"")},Tt=i=>i==null||i==="",Da=Dt((i,e,t,a)=>Tt(t(e))?a.delete(i):a.set(i,t(e))),Ta=Dt((i,e,t,a)=>Object.entries(e).map(t).forEach(([n,o])=>Tt(o)?a.delete(i+n):a.set(i+n,o))),J=(i,e,{suffix:t="",read:a,write:n,multi:o}={})=>{const[r,l]=o?[Ta,ti]:[Da,ii],u=F(()=>e!=null&&l(e+t,a)!=null,[]),[s,c]=T(()=>e==null?i:l(e+t,a)??i),m=C(b=>c(p=>{const x=$e(b,p);return e!=null&&ai(r(e+t,x,n),null,{notify:!1}),x}),[e,t,r,n]);return M(()=>{e!=null&&(u||i!=null&&m(i))},[i,e,u,m]),[s,m]},Va=i=>[!0,"true",1,"yes","on"].includes(i),de=i=>i===""||(i==null?void 0:Va(i)),me=(i,e,t)=>C(a=>{i(a),t(n=>({...n,[e]:a}))},[i,e,t]),Ra=(i,e,t,a,n)=>{const[o,r]=J(t.sortOn,e,{suffix:"-sortOn"}),[l,u]=J(de(t.descending),e,{suffix:"-descending",read:de}),[s,c]=J(t.groupOn,e,{suffix:"-groupOn"}),[m,b]=J(de(t.groupOnDescending),e,{suffix:"-groupOnDescending",read:de}),p=F(()=>i.find(g=>g.name===o),[i,o]),x=F(()=>i.find(g=>g.name===s),[i,s]),h={groupOn:s,setGroupOn:me(c,"groupOn",a),groupOnDescending:m,setGroupOnDescending:me(b,"groupOnDescending",a),sortOn:o,setSortOn:me(r,"sortOn",a),descending:l,setDescending:me(u,"descending",a),columns:i},$=F(()=>h,Object.values(h)),_=C(g=>{r(g.sortOn),c(g.groupOn),u(g.descending),b(g.groupOnDescending)},[]);return M(()=>{n.current=_},[]),{...$,sortAndGroup:$,groupOnColumn:x,sortOnColumn:p}},Qe=Ct();customElements.define("sort-and-group-provider",Qe.Provider);customElements.define("sort-and-group-consumer",O(({render:i})=>i(Le(Qe)),{useShadowDOM:!1}));const Na=({data:i,columns:e,groupOnColumn:t,filters:a,setFilterState:n,sortAndGroup:{sortOn:o,setSortOn:r,descending:l,setDescending:u}={}})=>wt(e,s=>s.name,s=>[d`<div
