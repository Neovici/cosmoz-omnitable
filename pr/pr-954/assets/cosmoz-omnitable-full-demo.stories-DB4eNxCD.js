import{n as e}from"./chunk-BneVvdWh.js";import{J as t,Q as n,Y as r,Z as i}from"./iframe-DKwpdlRm.js";import{$ as a,A as o,At as s,B as c,Bt as l,C as u,Ct as d,D as f,Dt as p,E as m,Et as h,F as g,Ft as _,G as v,Gt as ee,H as te,Ht as y,I as ne,It as b,J as re,K as ie,L as ae,Lt as oe,M as se,Mt as ce,N as le,Nt as x,O as ue,Ot as de,P as fe,Pt as S,Q as pe,R as C,Rt as me,S as w,St as he,T as ge,Tt as _e,U as T,Ut as E,V as ve,Vt as ye,W as be,Wt as xe,X as D,Y as Se,Z as Ce,_ as we,_t as Te,a as Ee,at as O,b as De,bt as Oe,c as ke,ct as Ae,d as je,dt as k,et as Me,f as Ne,ft as A,g as Pe,gt as Fe,h as Ie,ht as Le,i as Re,it as ze,j as Be,jt as j,k as Ve,kt as He,l as Ue,lt as We,m as Ge,mt as Ke,n as qe,nt as Je,o as Ye,ot as M,p as Xe,pt as Ze,q as Qe,r as $e,rt as et,s as tt,st as nt,t as rt,tt as it,u as at,ut as ot,v as st,vt as ct,w as lt,wt as ut,x as dt,xt as ft,y as N,yt as pt,z as P,zt as mt}from"./dist-dY9S6b-1.js";var ht,gt=e((()=>{h(),ht=()=>i`<style>
	@keyframes rotating {
		100% {
...
`,customElements.define(`cosmoz-clear-button`,p(vt))})),I,yt,bt,xt,St,L,R=e((()=>{A(),I=({valuePath:e},t)=>k(t,e),yt=I,bt=I,xt=({valuePath:e},t)=>n=>{let r=k(n,e);return r==null?!1:r.toString().toLowerCase().trim().includes(t.toLowerCase().trim())},St=(e,t)=>t===``||t==null?null:t,L=e=>class extends e{static get properties(){return{isOmnitableColumn:{type:Boolean,value:!0},title:{type:String},valuePath:{type:String,notify:!0},values:{type:Array,notify:!0},filter:{type:Object},noLocalFilter:{type:Boolean},disabled:{type:Boolean,value:!1,notify:!0},editable:{type:Boolean,notify:!0},loading:{type:Boolean,value:!1,notify:!0},externalValues:{type:Boolean,value:!1,notify:!0},name:{type:String},sortOn:{type:String},groupOn:{type:String},noSort:{type:Boolean,value:!1},disabledFiltering:{type:Boolean,value:!1},width:{type:String,value:`75px`},minWidth:{type:String,value:`40px`},flex:{type:String,value:`1`},cellClass:{type:String,value:`default-cell`},headerCellClass:{type:String,value:`default-header-cell`},priority:{type:Number,value:0},hidden:{type:Boolean,notify:!0},preferredDropdownHorizontalAlign:{type:String,value:`right`},renderHeader:{type:Function},renderCell:{type:Function},renderEditCell:{type:Function},renderGroup:{type:Function},mini:{type:Number,value:null},renderMini:{type:Function}}}static get observers(){return[`notifyFilterChange(filter)`]}notifyFilterChange(e){this.__ownChange||this.dispatchEvent(new CustomEvent(`legacy-filter-changed`,{detail:{name:this.name,state:this.legacyFilterToState(e)},bubbles:!0}))}legacyFilterToState(e){return{filter:e}}getFilterFn(){}getString(e,t){return I(e,t)}toXlsxValue(e,t){return yt(e,t)}cellTitleFn(e,t){return this.getString(e,t)}headerTitleFn(e){return e.title}serializeFilter(e,t){return St(e,t)}deserializeFilter(e,t){return t==null?null:typeof t==`string`?window.decodeURIComponent(t):t}getComparableValue(e,t){return bt(e,t)}computeSource(e,t){return t}_propertiesChanged(e,t,n){super._propertiesChanged(e,t,n),this.dispatchEvent(new CustomEvent(`cosmoz-column-prop-changed`,{bubbles:!0}))}}})),Ct,wt,Tt,Et,Dt,Ot,kt,At=e((()=>{c(),F(),M(),n(),y(),R(),Ct=e=>t=>e(n=>{if(n.inputValue===void 0&&t.target.value===``)return n;clearTimeout(n.t);let r=setTimeout(()=>e(e=>({...e,filter:e.inputValue})),1e3);return{...n,inputValue:t.target.value,t:r}}),wt=e=>()=>e(e=>({...e,filter:e.inputValue})),Tt=e=>t=>{t.keyCode===13&&(t.preventDefault(),e(e=>({...e,filter:e.inputValue})))},Et=e=>t=>e(e=>({...e,headerFocused:t.detail.value})),Dt=e=>()=>e(e=>({...e,filter:null,inputValue:null})),Ot=e=>e!=null&&e!==``,kt=class extends L(O){static get properties(){return{minWidth:{type:String,value:`55px`},editMinWidth:{type:String,value:`55px`},inputValue:{type:Object,notify:!0}}}getFilterFn(e,t){if(!(t==null||t===``))return xt(e,t)}renderCell(e,{item:t}){return i`<span class="default-column">${I(e,t)}</span>`}renderEditCell(e,{item:t},n){return i`<cosmoz-input
		...
		>
			${E(!e.disabledFiltering,()=>i`<cosmoz-clear-button
						...
						@click=${Dt(a)}
					></cosmoz-clear-button>`)}
		</cosmoz-input>`}legacyFilterToState(e){return{filter:e,inputValue:e}}},customElements.define(`cosmoz-omnitable-column`,kt)})),jt,Mt,Nt,Pt=e((()=>{c(),h(),n(),jt=[`label`,`value`,`slot`,`always-float-label`,`disabled`],Mt=oe`
	${ie}
...
`,Nt=e=>{let{label:t,value:n,slot:r}=e;return et(i`<div
	...
	>
		${n||``}
	</div>`,{label:t})},customElements.define(`cosmoz-omnitable-dropdown-input`,p(Nt,{observedAttributes:jt,styleSheets:[Mt]}))})),z,Ft=e((()=>{ct(),n(),ae(),Pt(),z=({title:e,tooltip:t=``,filterText:n=``,disabled:r=!1,onOpenedChanged:a,content:o,horizontalAlign:s=`left`,externalValues:c=null})=>i`
		<style>
			.dropdown-wrapper {
				display: block;
			}
	...
	`})),It,Lt,Rt=e((()=>{Le(),We(),g(),se(),It=e=>e?typeof e.close==`function`?e:It(e.parentElement):null,Lt=e=>class extends e{static get properties(){return{disabled:{type:Boolean,value:!1},filter:{type:Object,notify:!0},values:{type:Array,value(){return[]}},headerFocused:{type:Boolean,notify:!0},min:{type:Number,value:null},max:{type:Number,value:null},limits:{type:Function},autoupdate:{type:String,value:!0},locale:{type:String,value:null},_filterInput:{type:Object,value(){return{min:null,max:null}}},_range:{type:Object,computed:`_computeRange(values.*)`},_limit:{type:Object,computed:`_computeLimit(_range, _filterInput.*, min, max)`,value(){return{}}},_tooltip:{type:String,computed:`_computeTooltip(title, _filterText)`},_fromClasses:{type:String,computed:`_computeInputClasses(_filterInput.min)`},_toClasses:{type:String,computed:`_computeInputClasses(_filterInput.max)`}}}static get observers(){return[`_filterInputChanged(_filterInput.*, autoupdate)`,`_filterChanged(filter.*)`,`_updateLimits(limits, headerFocused)`]}disconnectedCallback(){this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),super.disconnectedCallback()}_computeInputClasses(e){return e!=null&&e!==``?`has-value`:``}toNumber(e,t,n){if(e==null||e===``)return;let r=typeof e==`number`?e:Number(e);if(Number.isNaN(r))return;if(n==null||t==null)return r;let i=this.toNumber(t);return i==null?r:n(r,i)}toValue(){return this.toNumber.apply(this,arguments)}getComparableValue(e,t){if(e==null)return;let n=e;return t!=null&&(n=this.get(t,e)),this.toValue(n)}renderValue(){}getInputString(e,t=this.valuePath){let n=this.toValue(this.get(t,e));return this._toInputString(n)}_computeRange(e){let t=e.base,n=Array.isArray(t)&&t.length&&t.map(e=>this.toValue(e)).filter(e=>e!=null);return!n||n.length<1?{min:null,max:null}:n.reduce((e,t)=>({min:this.toValue(t,e.min,Math.min),max:this.toValue(t,e.max,Math.max)}),{})}_computeLimit(e,t,n,r){if(!e)return;let i=t.base,a=this.toValue(n),o=this.toValue(r),s=a??this.toValue(e.min),c=o??this.toValue(e.max);return{fromMin:s,fromMax:this.toValue(c,this._fromInputString(i.max,`max`),Math.min),toMin:this.toValue(s,this._fromInputString(i.min,`min`),Math.max),toMax:c}}_computeFilterText(e){if(e.base==null)return;let t=e.base,n=this.toValue(t.min),r=this.toValue(t.max),i=[];return n!=null&&i.push(this.renderValue(n)),i.push(` - `),r!=null&&i.push(this.renderValue(r)),i.length>1?i.join(``):void 0}_computeTooltip(e,t){return t==null?e:`${e}: ${t}`}_fromInputString(e){return this.toValue(e)}_toInputString(e){return this.toValue(e)??null}_getDefaultFilter(){return{min:null,max:null}}_filterInputChanged(e,t){this.__inputChangePath=e.path.split(`.`)[1]||null,t&&(this._limitInputDebouncer=le.debounce(this._limitInputDebouncer,ot.after(600),()=>{this._limitInput(),this._updateFilter()}),fe(this._limitInputDebouncer))}_clearFrom(){this.set(`_filterInput.min`,null),this._updateFilter()}_clearTo(){this.set(`_filterInput.max`,null),this._updateFilter()}_onBlur(){this._limitInput(),this._updateFilter()}_onKeyDown(e){let t=e.currentTarget,n=Array.from(t.parentElement.querySelectorAll(`cosmoz-input`)),r=n[n.findIndex(e=>e===t)+1],i=!r,a=n[0]===t;switch(e.keyCode){case 13:if(e.preventDefault(),!i)r.focus();else{let e=this._limitInput();this._updateFilter(),e||this._closeParent(t)}break;case 9:(i&&!e.shiftKey||a&&e.shiftKey)&&this._closeParent(t)}}_closeParent(e){let t=It(e);t&&t.close()}_onDropdownOpenedChanged({currentTarget:e,type:t,detail:n}){(t===`focus`||n?.value===!0)&&setTimeout(()=>{e.querySelector(`cosmoz-input:focus`)||e.querySelector(`cosmoz-input`)?.focus()},100)}_limitInput(){let e=this._filterInput,t=this.__inputChangePath,n=t?this._fromInputString(this.get(t,e),t):null;if(this.__inputChangePath=null,n==null)return!1;let r=this._limit,i=t===`min`?`from`:`to`,a=this.get(i+`Min`,r),o=this.get(i+`Max`,r),s=this.toValue(n,a,Math.max),c=this.toValue(s,o,Math.min);return this.getComparableValue(n)===this.getComparableValue(c)?!1:(this.set([`_filterInput`,t],this._toInputString(c,t)),this._limitInputDebouncer&&this._limitInputDebouncer.cancel(),!0)}_updateFilter(){let e=this._filterInput,t=this.filter,n=this._fromInputString(e.min,`min`),r=this._fromInputString(e.max,`max`);this.getComparableValue(n)===this.getComparableValue(t,`min`)&&this.getComparableValue(r)===this.getComparableValue(t,`max`)||this.set(`filter`,{min:n,max:r})}_filterChanged(e){if(this._filterInput==null)return;let t=this._filterInput,n=e.base,r=this._fromInputString(t.min,`min`),i=this._fromInputString(t.max,`max`);this.getComparableValue(r)===this.getComparableValue(n,`min`)&&this.getComparableValue(i)===this.getComparableValue(n,`max`)||(this.set(`_filterInput`,{min:this._toInputString(n.min),max:this._toInputString(n.max)}),this._limitInputDebouncer&&this._limitInputDebouncer.cancel())}hasFilter(){let e=this.filter;return e==null?!1:this.toValue(e.min)!=null||this.toValue(e.max)!=null}resetFilter(){this.filter=this._getDefaultFilter()}_updateLimits(e,t){e&&Promise.resolve(Fe(e,{active:t})).then(e=>{let{min:t,max:n}=e??{};Object.assign(this,{...t==null?{}:{min:t},...n==null?{}:{max:n}})})}}})),B,zt=e((()=>{M(),n(),B=e=>class extends e{static get template(){return nt`<div id="output" style="position:relative;"></div>`}connectedCallback(){super.connectedCallback(),r(this.render(),this.$.output)}_propertiesChanged(e,t,n){super._propertiesChanged(e,t,n),requestAnimationFrame(()=>r(this.render(),this.$.output))}}})),Bt,Vt=e((()=>{c(),M(),C(),n(),y(),Ft(),Rt(),zt(),Bt=class extends Lt(B(O)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:`_computeFilterText(filter.*, _formatters)`},headerFocused:{type:Boolean,value:!1}}}static get observers(){return[`_valuesChanged(autodetect, currency, values)`]}render(){return i`
			...
			${E(!this.disabled,()=>i`<cosmoz-clear-button
					...
					></cosmoz-clear-button>`)}
			${z({title:this.title,tooltip:this._tooltip,filterText:this._filterText,disabled:this.disabled,externalValues:this.externalValues,onOpenedChanged:e=>{this.headerFocused=e.type===`focus`,this._onDropdownOpenedChanged(e)},content:i`
		...
		>`}getComparableValue(e,t){return kn(e,t)}getFilterFn(e,t){if(!(!t||!Array.isArray(t)||t.length===0))return An(e,t)}},customElements.define(`cosmoz-omnitable-column-autocomplete-excluding`,jn)})),Nn,Pn,Fn=e((()=>{st(),we(),M(),n(),y(),De(),dt(),On(),R(),A(),K(),Nn=({valuePath:e,textProperty:t,valueProperty:n},r)=>{let i=t?lt(t):w(n),a=N(e&&k(r,e)).map(i);return a.length>1?a.filter(Boolean).join(`,`):a[0]},Pn=class extends Dn(L(O)){static get properties(){return{headerCellClass:{type:String,value:`autocomplete-header-cell`},minWidth:{type:String,value:`55px`},editMinWidth:{type:String,value:`55px`},keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},showSingle:{type:Boolean},preserveOrder:{type:Boolean},limit:{type:Number},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,showSingle:e.showSingle,preserveOrder:e.preserveOrder,limit:e.limit,textual:e.textual}}renderCell(e,{item:t}){return i`<span class="default-column"
			>${e.getString(e,t)}</span
		>`}renderEditCell(e,{item:t},n){return i`<cosmoz-input
			no-label-float
			type="text"
		...
		>`}getComparableValue(e,t){return Nn(e,t)}},customElements.define(`cosmoz-omnitable-column-autocomplete`,Pn)})),In,Ln,Rn,zn,Bn,Vn,Hn,Un,Wn,Gn,Kn,qn,Jn,Yn,Xn=e((()=>{M(),R(),st(),Ve(),A(),n(),y(),In=(e,t)=>t.find(({value:t})=>e===t),Ln=(e,t,n)=>{let r=In(t,n);return r?r.text:e},Rn=(e,t,n,r)=>Ln(e,k(t,n),r),zn=({valuePath:e},t,n)=>In(k(t,e),n),Bn=e=>t=>{e(e=>({...e,filter:t?.[0]?.value??null}))},Vn=e=>t=>{e(e=>({...e,headerFocused:t}))},Hn=e=>t=>{e(e=>({...e,query:t}))},Un=e=>t=>e(t?.[0]?.value),Wn=({valuePath:e,trueLabel:t,falseLabel:n},r)=>k(r,e)?t:n,Gn=({valuePath:e},t)=>n=>k(n,e)===t,Kn=o((e,t)=>[{text:e,value:!0},{text:t,value:!1}]),qn=({valuePath:e,trueLabel:t,falseLabel:n},r)=>e?k(r,e)?t:n:``,Jn=(e,t)=>{try{return JSON.parse(t)}catch{return null}},Yn=class extends L(O){static get properties(){return{trueLabel:{type:String,value:`True`},falseLabel:{type:String,value:`False`},flex:{type:String,value:`0`},cellClass:{type:String,value:`boolean-cell`}}}getString(e,t){return Wn(e,t)}renderCell(e,{item:t}){return Wn(e,t)}renderEditCell(e,{item:t},n){let{trueLabel:r,falseLabel:a}=e;return i`<cosmoz-autocomplete
			no-label-float
		...
		>`}computeSource({trueLabel:e,falseLabel:t}){return Kn(e,t)}getFilterFn(e,t){if(t!=null)return Gn(e,t)}toXlsxValue(e,t){return qn(e,t)}deserializeFilter(e,t){return Jn(e,t)}},customElements.define(`cosmoz-omnitable-column-boolean`,Yn)})),Zn,Qn=e((()=>{pe(),Rt(),Zn=e=>class extends Lt(e){static get properties(){return{max:{type:Date,value:null},min:{type:Date,value:null},_filterText:{type:String,computed:`_computeFilterText(filter.*, formatter)`},formatter:{type:Object,computed:`_computeFormatter(locale)`}}}toDate(e,t,n){if(e==null||e===``)return;let r=e;if(r instanceof Date||(typeof e==`string`&&(r=this.getAbsoluteISOString(r)),r=new Date(r)),Number.isNaN(r.getTime()))return null;if(n==null||t==null)return r;let i=this.toDate(t);if(i==null)return r;let a=this.getComparableValue(r);return n(a,this.getComparableValue(i))===a?r:i}toValue(){return this.toDate.apply(this,arguments)}getComparableValue(e,t){let n=super.getComparableValue(e,t);if(n!=null)return this.toNumber(n.getTime())}getString(e,t=this.valuePath,n=this.formatter){let r=this.toValue(this.get(t,e));return r===void 0?``:r===null?`Invalid Date`:this.renderValue(r,n)}getAbsoluteISOString(e){return e.length===19?e+this._getTimezoneString(e):e}_getTimezoneString(e){let t=-new Date(e).getTimezoneOffset()/60;return(t<0?`-`:`+`)+[`0`,Math.abs(t)].join(``).substr(-2)+`:00`}renderValue(e,t=this.formatter){if(t==null)return;let n=this.toValue(e);if(n!=null)return t.format(n)}_computeFormatter(e){return new Intl.DateTimeFormat(e||void 0)}_toInputString(e){let t=this.toValue(e);return t==null?null:this._toLocalISOString(t).slice(0,10)}_dateValueChanged(e){let t=e.currentTarget.value,n=e.model.item,r=this.get(this.valuePath,n),i=this._fromInputString(t);this.set(this.valuePath,i,n),this._fireItemChangeEvent(n,this.valuePath,r,this.renderValue.bind(this))}_toLocalISOString(e){return a(e)}}})),$n,er=e((()=>{c(),M(),C(),n(),y(),Qn(),Ft(),zt(),$n=class extends Zn(B(O)){render(){return i`
			...
			${E(!this.disabled,()=>i`<cosmoz-clear-button
						...
						?visible=${this.hasFilter()}
					></cosmoz-clear-button>`)}
			${z({title:this.title,tooltip:this._tooltip,filterText:this._filterText,disabled:this.disabled,externalValues:this.externalValues,onOpenedChanged:e=>{this.headerFocused=e.type===`focus`},content:i`
					<h3 style="margin: 0;">${this.title}</h3>
					<cosmoz-input
						type="date"
						label=${P(`From date`)}
					...
					></cosmoz-input>
				`})}
		`}_fromInputString(e,t){let n=this.toDate(e);if(n!=null)return t===`min`&&n.setHours(0,0,0,0),t===`max`&&n.setHours(23,59,59),n}_filterInputChanged(e,t){let n=e.path.split(`.`)[1]&&e.value;if(n&&n.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}},customElements.define(`cosmoz-omnitable-date-range-input`,$n)})),tr,nr,rr,Y,X,ir,ar,or,sr,cr,lr,ur,dr,fr,pr,mr=e((()=>{pe(),A(),Jt(),tr=e=>{let t=-new Date(e).getTimezoneOffset()/60;return(t<0?`-`:`+`)+[`0`,Math.abs(t)].join(``).substr(-2)+`:00`},nr=e=>e.length===19?e+tr(e):e,rr=e=>{if(e==null||e===``)return;let t=e;return!(t instanceof Date)&&(typeof e==`string`&&(t=nr(t)),t=Ce(t),!t)||Number.isNaN(t.getTime())?null:t},Y=({valuePath:e},t)=>{if(t==null)return;let n=t;e!=null&&(n=k(t,e));let r=rr(n);if(r!=null)return V(r.getTime())},X=(e,t,n)=>{let r=rr(e);if(r==null)return null;if(n==null||t==null)return r;let i=X(t);if(i==null)return r;let a=Y({},r),o=Y({},i);return a==null||o==null||n(a,o)===a?r:i},ir=(e,t)=>{if(t==null)return;let n=X(e);if(n!=null)return t.format(n)},ar={},or=e=>{let t=e||``;return ar[t]||(ar[t]=new Intl.DateTimeFormat(e||void 0)),ar[t]},sr=({valuePath:e,locale:t},n)=>{let r=k(n,e||``);return r===void 0?``:(r=X(r),r===null?`Invalid Date`:ir(r,or(t)))},cr=e=>{let t=X(e);if(t==null)return null;let n=a(t);return n==null?null:n.slice(0,10)},lr=({valuePath:e},t)=>cr(k(t,e||``)),ur=(e,t)=>{let n=X(e);if(n!=null)return t===`min`&&n.setHours(0,0,0,0),t===`max`&&n.setHours(23,59,59),n},dr=e=>cr(e)??``,fr=({valuePath:e},t)=>{if(!e)return``;let n=X(k(t,e));if(!n)return``;let r=X(a(n));return r?(r.setHours(0,0,0,0),r):``},pr=(e,t)=>n=>{let r=Y(e,n);if(r==null)return!1;let i=Y({...e,valuePath:`min`},t),a=Y({...e,valuePath:`max`},t);return!(r<(i??-1/0)||r>(a??1/0))}})),hr,gr=e((()=>{c(),M(),n(),R(),er(),J(),mr(),F(),hr=class extends L(O){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:`date-header-cell`},width:{type:String,value:`100px`},minWidth:{type:String,value:`82px`},flex:{type:String,value:`0`}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){let n=Y({...e,valuePath:`min`},t),r=Y({...e,valuePath:`max`},t);if(!(n==null&&r==null))return pr(e,t)}getString(e,t){return sr(e,t)}toXlsxValue(e,t){return fr(e,t)}getComparableValue(e,t){return Y(e,t)}serializeFilter(e,t){if(t==null)return;let n=X(t.min),r=X(t.max);if(!(n==null&&r==null))return dr(n)+`~`+dr(r)}deserializeFilter(e,t){if(t==null||t===``)return null;let n=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(n)?{min:X(n[1]),max:X(n[2])}:null}renderCell(e,{item:t}){return i`<div class="omnitable-cell-date">
			${sr(e,t)}
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return q(e,t)}},customElements.define(`cosmoz-omnitable-column-date`,hr)})),_r,vr=e((()=>{M(),C(),n(),y(),Qn(),Ft(),zt(),_r=class extends Zn(B(O)){render(){return i`
			<style>
		...
		></cosmoz-omnitable-datetime-range-input>`}computeSource(e,t){return q(e,t)}},customElements.define(Er.is,Er)})),Or,kr=e((()=>{st(),we(),M(),n(),y(),On(),R(),Or=class extends Dn(L(O)){renderCell({valuePath:e,textProperty:t},{item:n}){return i`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		`}renderEditCell(){return`not implemented`}renderHeader(e,{filter:t,query:n},r,a){return i`<cosmoz-autocomplete-ui
			...
			.onText=${wn(r)}
			>${E(e.loading,()=>i`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}},customElements.define(`cosmoz-omnitable-column-list-horizontal`,Or)})),Ar,jr=e((()=>{Ge(),Qe(),M(),Ae(),window.Cosmoz=window.Cosmoz||{},Ar=class extends Ie(re(Je,O)){static get template(){return nt`
			<style>
				:host {
					display: block;
				}
		...
		`}static get is(){return`cosmoz-omnitable-column-list-data`}static get properties(){return{items:{type:Array},_expanded:{type:Boolean,value:!1},_othersCount:{type:Number,computed:`_computeOthersCount(items)`}}}static get observers(){return[`_itemsLengthChanged(items.length)`]}_itemsLengthChanged(){requestAnimationFrame(()=>this.dispatchEvent(new CustomEvent(`expand`,{bubbles:!0})))}_firstItem(e){if(e!=null&&e.length>0)return e[0]}_hideExpand(e,t){return e!==void 0&&e.length!==null?e.length<=2||t:!0}_hideCollapse(e,t){return e!==void 0&&e.length!==null?e.length<=2||!t:!0}_otherItems(e,t){if(e!=null&&(e.length<=2||t))return e.slice(1)}_computeOthersCount(e){if(e!=null)return e.length-1}_toggleExpand(e){this._expanded=!this._expanded,e.stopPropagation(),e.preventDefault()}},customElements.define(Ar.is,Ar)})),Mr,Nr=e((()=>{jr(),M(),n(),y(),st(),On(),R(),K(),Mr=class extends Dn(L(O)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:n}){return i`<cosmoz-omnitable-column-list-data
			.items=${vn(n,e,t)}
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:n},r,a){return i`<cosmoz-autocomplete-ui
			...
			.onText=${wn(r)}
			>${E(e.loading,()=>i`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}},customElements.define(`cosmoz-omnitable-column-list`,Mr)})),Pr,Fr=e((()=>{c(),M(),C(),n(),y(),Ft(),Rt(),zt(),Pr=class extends Lt(B(O)){static get properties(){return{maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null},formatter:{type:Object,computed:`_computeFormatter(locale, minimumFractionDigits, maximumFractionDigits)`},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:`_computeFilterText(filter.*, formatter)`},headerFocused:{type:Boolean,value:!1}}}render(){return i`
			<style>
				cosmoz-input[type='number'] {
					background: var(--cosmoz-omnitable-amount-input-background, #ffffff);
					border-radius: 6px;
			...
			${E(!this.disabled,()=>i`<cosmoz-clear-button
						...
						?visible=${this.hasFilter()}
					></cosmoz-clear-button>`)}
			${z({title:this.title,tooltip:this._tooltip,filterText:this._filterText,disabled:this.disabled,horizontalAlign:`right`,externalValues:this.externalValues,onOpenedChanged:e=>{this.headerFocused=e.type===`focus`,this._onDropdownOpenedChanged(e)},content:i`
					<h3>${this.title}</h3>
					<cosmoz-input
						class=${this._fromClasses}
						type="number"
		...
		></cosmoz-omnitable-number-range-input>`}computeSource(e,t){return q(e,t)}},customElements.define(`cosmoz-omnitable-column-number`,Ir)})),Rr,zr=e((()=>{c(),M(),C(),n(),y(),Qn(),Ft(),zt(),Rr=class extends Zn(B(O)){render(){return i`
			${E(!this.disabled,()=>i`<cosmoz-clear-button
						@click=${()=>this.resetFilter()}
						?visible=${this.hasFilter()}
					></cosmoz-clear-button>`)}
		...
		></cosmoz-input>`}renderHeader({title:e,min:t,max:n,locale:r,filterStep:a,disabledFiltering:o},{filter:s},c,l){return i`<cosmoz-omnitable-time-range-input
			...
			@filter-changed=${({detail:{value:e}})=>c(t=>({...t,filter:e}))}
			@header-focused-changed=${({detail:{value:e}})=>c(t=>({...t,headerFocused:e}))}
		></cosmoz-omnitable-time-range-input>`}computeSource(e,t){return q(e,t)}},customElements.define(`cosmoz-omnitable-column-time`,Xr)})),Qr=e((()=>{hn(),Mn(),Fn(),Xn(),gr(),Dr(),kr(),Nr(),Lr(),Zr()})),$r,ei=e((()=>{h(),n(),$r=({column:e,item:n,selected:r,folded:i,group:a})=>e?(e.renderGroup??e.renderCell)(e,{item:n,selected:r,folded:i,group:a}):t,customElements.define(`cosmoz-omnitable-group-row`,p($r,{useShadowDOM:!1}))})),ti,ni=e((()=>{h(),n(),ti=e=>{let{column:n}=e;return b(()=>{let t=0,r=0,i=i=>{e.dispatchEvent(new CustomEvent(`column-resize`,{bubbles:!0,composed:!0,detail:{newWidth:Math.ceil(r+i.pageX-t),column:n}}))},a=()=>{document.removeEventListener(`pointermove`,i),document.removeEventListener(`pointerup`,a)},o=n=>{t=n.pageX,r=e.previousElementSibling.getBoundingClientRect().width,document.addEventListener(`pointermove`,i),document.addEventListener(`pointerup`,a)};return e.addEventListener(`pointerdown`,o),()=>e.removeEventListener(`pointerdown`,o)},[n]),t},customElements.define(`cosmoz-omnitable-resize-nub`,p(ti))})),ri,ii,ai,oi,si=e((()=>{n(),ri=i`<svg
	width="10"
	height="9"
	viewBox="0 0 10 9"
	stroke="currentColor"
...
>
	...
	/>
</svg> `})),ci,li,ui,di,fi=e((()=>{h(),xe(),si(),ci=({column:e,on:t,descending:n,setOn:r,setDescending:a})=>{let{name:o,title:s}=e??{};return i`<button
		class="sg"
		title=${ee(s)}
...
`})),pi,mi,hi,gi,_i,vi=e((()=>{h(),Ne(),Le(),Ue(),pi=e=>(t,n,r=Ke)=>{let i=ke(),a=new URLSearchParams(i.hash.replace(`#`,``));return e(t,n,r,a),`#!`+Object.assign(i,{hash:a}).href.replace(location.origin,``)},mi=e=>e==null||e===``,hi=pi((e,t,n,r)=>mi(n(t))?r.delete(e):r.set(e,n(t))),gi=pi((e,t,n,r)=>Object.entries(t).map(n).forEach(([t,n])=>mi(n)?r.delete(e+t):r.set(e+t,n))),_i=(e,t,{suffix:n=``,read:r,write:i,multi:a}={})=>{let[o,s]=a?[gi,at]:[hi,je],c=S(()=>t!=null&&s(t+n,r)!=null,[]),[l,u]=j(()=>t==null?e:s(t+n,r)??e),d=x(e=>u(r=>{let a=Fe(e,r);return t!=null&&Xe(o(t+n,a,i),null,{notify:!1}),a}),[t,n,o,i]);return b(()=>{t!=null&&(c||e!=null&&d(e))},[e,t,c,d]),[l,d]}})),yi,bi,xi,Si,Ci,wi=e((()=>{h(),vi(),yi=e=>[!0,`true`,1,`yes`,`on`].includes(e),bi=e=>e===``||(e==null?void 0:yi(e)),xi=(e,t,n)=>x(r=>{e(r),n(e=>({...e,[t]:r}))},[e,t,n]),Si=(e,t,n,r,i)=>{let[a,o]=_i(n.sortOn,t,{suffix:`-sortOn`}),[s,c]=_i(bi(n.descending),t,{suffix:`-descending`,read:bi}),[l,u]=_i(n.groupOn,t,{suffix:`-groupOn`}),[d,f]=_i(bi(n.groupOnDescending),t,{suffix:`-groupOnDescending`,read:bi}),p=S(()=>e.find(e=>e.name===a),[e,a]),m=S(()=>e.find(e=>e.name===l),[e,l]),h={groupOn:l,setGroupOn:xi(u,`groupOn`,r),groupOnDescending:d,setGroupOnDescending:xi(f,`groupOnDescending`,r),sortOn:a,setSortOn:xi(o,`sortOn`,r),descending:s,setDescending:xi(c,`descending`,r),columns:e},g=S(()=>h,Object.values(h)),_=x(e=>{o(e.sortOn),u(e.groupOn),c(e.descending),f(e.groupOnDescending)},[]);return b(()=>void(i.current=_),[]),{...g,sortAndGroup:g,groupOnColumn:m,sortOnColumn:p}},Ci=de(),customElements.define(`sort-and-group-provider`,Ci.Provider),customElements.define(`sort-and-group-consumer`,p(({render:e})=>e(_(Ci)),{useShadowDOM:!1}))})),Ti,Ei,Di=e((()=>{h(),ue(),ni(),fi(),y(),wi(),Ti=({data:e,columns:t,groupOnColumn:n,filters:r,setFilterState:a,sortAndGroup:{sortOn:o,setSortOn:s,descending:c,setDescending:l}={}})=>f(t,e=>e.name,t=>[i`<div
		...
		${E(e,e=>Ti({columns:e,sortAndGroup:a,...r}))}
		${E(!n,()=>i` <cosmoz-omnitable-settings
					.config=${t}
					part="settings"
				></cosmoz-omnitable-settings>`)}
	`},customElements.define(`cosmoz-omnitable-header-row`,p(Ei,{useShadowDOM:!1}))})),Oi,ki,Ai=e((()=>{h(),Qe(),Oi=D`
	:host {
		display: flex;
		align-items: center;
		flex-wrap: wrap;
...
`,customElements.define(`cosmoz-omnitable-item-expand-line`,p(ki,{styleSheets:[Se(Oi)]}))})),ji,Mi=e((()=>{h(),n(),Ye(),Ai(),ji=({columns:e,item:t,selected:n,expanded:r,groupOnColumn:a})=>tt(e,e=>i`<cosmoz-omnitable-item-expand-line
				.column=${e}
				?hidden=${e===a}
				exportparts="item-expand-label, item-expand-value"
				>${e.renderCell(e,{item:t,selected:n,expanded:r})}</cosmoz-omnitable-item-expand-line
			>`),customElements.define(`cosmoz-omnitable-item-expand`,p(ji,{useShadowDOM:!1}))})),Ni,Pi,Fi=e((()=>{h(),ue(),Ni=(e,t,n)=>e.editable?e.renderEditCell(e,t,n(e,t.item)):e.renderCell(e,t),Pi=({columns:e,groupOnColumn:t,item:n,index:r,selected:a,expanded:o,onItemChange:s})=>f(e,e=>e.name,e=>i`<div
			...
			</div>`),customElements.define(`cosmoz-omnitable-item-row`,p(Pi,{useShadowDOM:!1}))})),Ii,Li,Ri=e((()=>{Qe(),Ii=D`
	.checkbox {
		box-sizing: border-box;
		width: 18px;
		height: 18px;
...
`})),zi,Bi,Vi=e((()=>{Re(),zi=e=>{let t=e.replace(/"/gu,`""`);return t.search(/("|,|\n)/gu)>=0?`"`+t+`"`:e},Bi=(e,t,n)=>{let r=e.map(e=>zi(e.title)).join(`;`)+`
`,i=t.map(t=>e.map(e=>{let n=e.getString(e,t);return n==null?``:zi(String(n))}).join(`;`)+`
`);i.unshift(r),Ee(new File(i,n,{type:`text/csv;charset=utf-8`}))}})),Hi,Ui,Wi=e((()=>{Re(),qe(),Hi=(e,t)=>{let n=e.map(e=>e.title),r=t.map(t=>e.map(e=>e.toXlsxValue(e,t)??``));return r.unshift(n),r},Ui=(e,t,n,r)=>{let i=Hi(e,t),a=new $e(n).addSheetFromData(i,r).generate();Ee(new File([a],n,{type:`application/vnd.openxmlformats-officedocument.spreadsheetml.sheet`}))}})),Gi,Ki=e((()=>{Me(),C(),n(),Vi(),Wi(),Gi=({columns:e,selectedItems:t,csvFilename:n,xlsxFilename:r,xlsxSheetname:a,topPlacement:o})=>i`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!it(t.length)}
		part="bottomBar"
	...
	</cosmoz-bottom-bar>`})),qi,Ji=e((()=>{n(),y(),qi=({allSelected:e,onAllCheckboxChange:t,sortAndGroup:n,dataIsValid:r,data:a,columns:o,filters:s,groupOnColumn:c,setFilterState:l,settingsConfig:u,hideSelectAll:d})=>i`<sort-and-group-provider .value=${n}>
	...
	</sort-and-group-provider>`})),Yi,Xi,Zi=e((()=>{h(),Yi=oe`
	:host {
		max-width: 100%;
		overflow-x: hidden;
		padding: 0 12px;
...
`})),ra,ia,aa=e((()=>{h(),pt(),ra=e=>{let t=parseInt(e,10);return isFinite(t)?t:void 0},ia=e=>{let{config:t}=e,{settings:n,setSettings:r,collapsed:i}=t,a=Oe({collapsed:i,settings:n.columns,setSettings:x(e=>r(t=>({...t,columns:e})),[r])});return{...t,onDown:x(e=>{e.target.closest(`.pull`)&&(a.handle=e.currentTarget)},[a]),onDragStart:x(e=>{let{target:t}=e,n=ra(t.dataset.index);if(!a.handle?.contains(t)||n==null)return e.preventDefault();a.handle=null,e.dataTransfer.effectAllowed=`move`,e.dataTransfer.setData(`omnitable/sort-index`,n),e.dataTransfer.setData(`text/plain`,n),setTimeout(()=>t.classList.add(`drag`),0),t.addEventListener(`dragend`,e=>e.target.classList.remove(`drag`),{once:!0})},[a]),onDragEnter:x(e=>{let t=e.currentTarget;t===e.target&&(e.preventDefault(),e.dataTransfer.dropEffect=`move`,t.classList.add(`dragover`))},[]),onDragOver:x(e=>{e.preventDefault(),e.currentTarget.classList.add(`dragover`)},[]),onDragLeave:x(e=>{let t=e.currentTarget;t.contains(e.relatedTarget)||t.classList.remove(`dragover`)},[]),onDrop:x(e=>{let t=ra(e.dataTransfer.getData(`omnitable/sort-index`)),n=ra(e.currentTarget.dataset.index),{settings:r,setSettings:i}=a;e.currentTarget.classList.remove(`dragover`),e.preventDefault();let o=r.slice();o.splice(n+(t>=n?0:-1),0,o.splice(t,1)[0]),i(o)},[a]),onToggle:x(e=>{let{settings:t,setSettings:n}=a,r=t.map(e=>({...e,disabled:e.disabled||a.collapsed?.some(t=>t.name===e.name)})),i=ra(e.target.closest(`[data-index]`)?.dataset.index);r.splice(i,1,{...t[i],disabled:!e.target.checked,priority:e.target.checked?t.reduce((e,t)=>Math.max(e,t.priority),0)+1:t[i].priority}),n(r)},[a])}}})),oa,sa,ca,la,ua=e((()=>{rt(),he(),Qe(),Me(),h(),C(),y(),si(),fi(),na(),aa(),oa=[d({apply({availableHeight:e,elements:t}){Object.assign(t.floating.style,{maxHeight:`${Math.max(0,e)}px`})}}),...ft],sa=({onDragStart:e,onDragEnter:t,onDragOver:n,onDragLeave:r,onDrop:a,onDown:o,onToggle:s,collapsed:c,filters:l})=>(u,d)=>{let f=!!c?.find(e=>e.name===u.name),p=!u.disabled&&!f;return i` <div
		...
		${E(n,()=>i`<div class="buttons">
				...
				</div>`)}`},customElements.define(`cosmoz-omnitable-settings-ui`,p(ca,{styleSheets:[Se(ea)]})),la=({config:e,newLayout:t})=>i`
	<cosmoz-dropdown
...
`,customElements.define(`cosmoz-omnitable-settings`,p(la,{styleSheets:[Se(ta)]}))})),da,fa,pa,ma,ha,ga=e((()=>{dt(),da=[`sortOn`,`descending`,`groupOn`,`groupOnDescending`],fa=e=>t=>typeof t==`object`&&!!t&&`name`in t&&t.name===e,pa=(e=[],t=[],n=[])=>{let r=t.filter(t=>e.some(fa(t.name))),i=e.filter(e=>e.name!=null&&!t.some(fa(e.name))&&!n.some(fa(e.name))),a=n.filter(e=>!t.some(fa(e.name)));return[...r,...a.flatMap(t=>{let n=e.find(e=>e.name===t.name);return n?{...t,title:n.title??t.title??``,minWidth:parseInt(n.minWidth??`0`,10)}:[]}),...i.map(e=>{let{name:t,title:n,priority:r,minWidth:i,width:a,flex:o}=e;return{name:t??``,title:n??``,priority:r??0,minWidth:parseInt(i??`0`,10),width:parseInt(a??`0`,10),flex:parseInt(o??`0`,10)}})]},ma=(e,t)=>({...t,...u(Array.from(da))(e),columns:e.columns?.map(u([`name`,`priority`,`width`,`flex`,`disabled`]))}),ha=({columns:e,settings:t,savedSettings:n,initial:r})=>({...Object.fromEntries(da.flatMap(e=>r?.[e]==null?[]:[[e,r[e]]])),...n?u(Array.from(da))(n):{},...t,columns:pa(e,t?.columns,n?.columns)})})),_a,va=e((()=>{_a=({prefix:e=`omnitable-`}={})=>({write:async(t,n)=>{let r=e+t;try{n?localStorage.setItem(r,JSON.stringify(n)):localStorage.removeItem(r)}catch(e){console.error(e)}},read:async t=>{if(t)try{let n=localStorage.getItem(e+t);return n==null?void 0:JSON.parse(n)}catch(e){console.error(e)}}})})),ya,ba,xa=e((()=>{h(),va(),ya=de(_a),ba=()=>{let e=_(ya);return S(()=>e(),[e])}})),Sa=e((()=>{xa()})),Ca,wa=e((()=>{h(),ga(),Sa(),Ca=(e,t,n,r)=>{let[i,a]=j(),{read:o,write:s}=ba();return b(async()=>{e&&a(await o(e))},[e,o]),{settingsId:e,savedSettings:i,onSave:x(async()=>{if(!e)return;let r=ma(t,i);await s(e,r),n(),a(r)},[t,i]),onReset:x(async t=>{n(),t.shiftKey&&(await s(e),a()),r?.()},[r]),hasChanges:t!=null}}})),Ta,Ea=e((()=>{h(),K(),ga(),wa(),Ta=({settingsId:e,host:t})=>{let n=S(()=>Object.fromEntries(da.map(e=>[e,t[e]])),[]),r=He(),i=x(()=>{r.current?.(n)},[n]),[a,o]=j(),[s,c]=j({columns:!0,sort:!0}),{savedSettings:l,...u}=Ca(e,a,o,i),{enabledColumns:d,disabledFiltering:f}=t,p=dn(t,{enabledColumns:d,disabledFiltering:f}),m=S(()=>ha({columns:p,settings:a,savedSettings:l,initial:n}),[p,a,l]),h=S(()=>m.columns.map(e=>p.find(t=>t.name===e.name)).filter(Boolean),[p,...m.columns.map(e=>e.name)]);return{...u,opened:s,setOpened:c,settings:m,columns:h,setSettings:o,resetRef:r}}})),Da=e((()=>{ua(),Ea()})),Oa,ka,Aa=e((()=>{Oa=e=>Number.isFinite(e)?e:0,ka=(e,t)=>{let n=[],[r,i]=e.reduce(([e,t],{width:n,flex:r})=>[e+n,t+r],[0,0]),a=t-r,o=Oa(a/i),s=0,c=0,l=0;for(let t=0;t<e.length;t++){let{width:i,minWidth:u,flex:d}=e[t];if(u>i+(a>=0?o*d:i*a/r)){s+=i,c+=u,l+=d,n[t]=u;continue}if(d===0){s+=i,c+=i,n[t]=i;continue}}r-=s,a=t-c-r,i-=l,o=Oa(a/i);for(let t=0;t<e.length;t++){if(n[t]!=null)continue;let{width:i,flex:s}=e[t];n[t]=i+(a>=0?o*s:i*a/r)}return n}})),ja,Ma,Na=e((()=>{ja=Symbol(`index`),Ma=(e,t)=>{if(typeof e.findLastIndex==`function`)return e.findLastIndex(t);for(let n=e.length-1;n>=0;n--)if(t(e[n],n,e))return n;return-1}})),Pa,Fa,Ia,La=e((()=>{Aa(),Na(),Pa=(e,t)=>{let n=Ma(e,e=>e!=null&&e>0),r=(e,t)=>`.cell[name="${e}"], cosmoz-omnitable-skeleton::part(cell-${e}){width: ${Math.floor(t)}px;padding: 0 min(3px, ${t/2}px)}`,i=e=>`cosmoz-omnitable-resize-nub[name="${e}"]{display:none}`,a=e=>`cosmoz-omnitable-resize-nub[name="${e}"], .cell[name="${e}"]{display:none}`;return t.map((t,o)=>{let s=e[o];if(s==null||s===0)return a(t.name);let c=r(t.name,s);return o===n?`${c}\n${i(t.name)}`:c}).join(`
`)},Fa=(e,t,n)=>{let r=e.filter(e=>!e.hidden),i=r.reduce((e,{width:t})=>e+t,0);if(r.length>1&&i>t)return Fa(r.slice(1),t,n);let a=r.reduce(([e,t],n,r)=>[Math.max(e,n.index),n.index>e?r:t],[-1,-1])[1];return a!==-1&&(r[a].flex=1),ka(r,t).reduce((e,t,n)=>(e[r[n].index]=t,e),Array(n).fill(void 0))},Ia=(e,t)=>e.length===0?`.cell {display: none;}`:Pa(e,t)})),Ra,za=e((()=>{h(),Ra=({host:e,canvasWidth:t,layout:n,setSettings:r})=>{let i=He();i.current=e=>r(r=>{let i=r.columns,{detail:{newWidth:a,column:o}}=e,s=i.findIndex(e=>e.name===o.name),c=[],l=i.reduce((e,t)=>Math.max(e,t.priority),-1/0);for(let e=0;e<n.length;e++)if(c[e]={...i[e]},e<s&&n[e]&&(c[e].width=n[e],c[e].flex=0,c[e].priority=l),e===s){let r=n.reduce((e,t,n)=>n<s&&t?e-t:e,t);c[e].width=Math.min(r,Math.max(a,i[e].minWidth)),c[e].flex=0,c[e].priority=l}return{...r,columns:c}}),b(()=>{let t=e=>i.current?.(e);return e.addEventListener(`column-resize`,t),()=>e.removeEventListener(`column-resize`,t)},[])}})),Ba,Va,Ha=e((()=>{h(),Ba=88,Va=(e,t)=>b(()=>{let n=new ResizeObserver(([e])=>{e.contentRect?.width!==0&&requestAnimationFrame(()=>t(e.contentRect?.width-Ba))});return n.observe(e),()=>n.unobserve(e)},[])})),Ua,Wa=e((()=>{h(),Ha(),Ua=e=>{let[t,n]=j(()=>e.getBoundingClientRect().width-Ba);return Va(e,n),t}})),Ga,Ka,qa,Ja=e((()=>{h(),pt(),Le(),Ga=(e,t)=>{let n=S(()=>{let t=!1,n,r=()=>{t&&(n=requestAnimationFrame(r),e()&&(t=!1))};return{start:()=>{t=!0,cancelAnimationFrame(n),n=requestAnimationFrame(r)},stop:()=>{t=!1,cancelAnimationFrame(n)}}},[]);b(()=>{n.start()},t),b(()=>()=>n.stop(),[])},Ka=(e=0,t=0)=>Math.abs(e-t)<.1,qa=(e,t=1.9,n=Te)=>{let r=Oe({target:e});Ga(x(()=>{if(!r.tween)return r.tween=r.target,n(r.tween),!0;if(r.target.every((e,t)=>r.tween[t]===e))return n(r.tween),!0;r.tween=r.target.map((e,n)=>Ka(r.tween[n],e)?e:(r.tween[n]??0)+((e??0)-(r.tween[n]??0))/t||0),n(r.tween)},[]),[e])}})),Ya,Xa=e((()=>{h(),La(),Ya=({canvasWidth:e,groupOnColumn:t,config:n,miniColumn:r})=>S(()=>{if(!Array.isArray(n)||e==null||e===0)return[];let i=n.map((e,n)=>({minWidth:e.minWidth,width:e.width,flex:e.flex,priority:e.priority,name:e.name,index:n,hidden:e.name===t?.name||e.disabled})).map(e=>r?{...e,hidden:r.name!==e.name}:e).sort(({index:e,priority:t},{index:n,priority:r})=>t===r?n-e:t-r);return Fa(i,e,i.length)},[e,t,n])})),Za,Qa=e((()=>{h(),Za=({host:e,canvasWidth:t,columns:n})=>{let r=e.miniBreakpoint??480,i=S(()=>t<=r,[t,r]),[a,...o]=S(()=>i?n?.filter(e=>e.mini!=null).sort((e,t)=>(e.mini??0)-(t.mini??0)):[],[n,i])??[],s=!!a;return b(()=>{e.toggleAttribute(`mini`,s)},[s]),{isMini:s&&i,miniColumn:a,miniColumns:o}}})),$a,eo,to=e((()=>{h(),La(),za(),Wa(),Ja(),Xa(),Qa(),pt(),$a=e=>{let t=S(()=>new CSSStyleSheet,[]);return b(()=>{e.shadowRoot.adoptedStyleSheets=[...e.shadowRoot.adoptedStyleSheets,t]},[]),t},eo=({host:e,columns:t,settings:n,setSettings:r,resizeSpeedFactor:i,sortAndGroupOptions:a})=>{let o=Ua(e),{isMini:s,miniColumn:c,miniColumns:l}=Za({host:e,canvasWidth:o,columns:t}),{groupOnColumn:u}=a,d=Ya({canvasWidth:o,groupOnColumn:u,miniColumn:c,config:n.columns}),f=$a(e),p=S(()=>n.columns.reduce((e,n,r)=>d[r]!=null||n.name===u?.name||n.disabled?e:[...e,t.find(e=>e.name===n.name)],[]),[t,n,d]),m=Oe({columns:n.columns});return qa(d,i,e=>{let t=Ia(e,m.columns);f.replace(t)}),Ra({host:e,canvasWidth:o,layout:d,setSettings:e=>r(e(n))}),{isMini:s,collapsedColumns:p,miniColumns:l}}})),no,ro=e((()=>{no=({host:e,...t})=>{let{csvFilename:n=`omnitable.csv`,xlsxFilename:r=`omnitable.xlsx`,xlsxSheetname:i=`Omnitable`,topPlacement:a=`top-end`}=e;return{csvFilename:n,xlsxFilename:r,xlsxSheetname:i,topPlacement:a,...t}}})),io,ao=e((()=>{h(),io=({host:e,selectedItems:t,data:n,sortAndGroupOptions:r,collapsedColumns:i,settings:a,filterFunctions:o,settingS:s,filters:c,...l})=>{let u=n&&n.length>0&&t.length===n.length,d=t=>{t.target.checked?e.shadowRoot.querySelector(`#groupedList`).selectAll():e.shadowRoot.querySelector(`#groupedList`).deselectAll()},{groupOnColumn:f}=r,p=S(()=>[f,...i,...a.columns.filter(e=>e.disabled)].some(e=>e&&Object.keys(o).includes(e.name)),[o,a,i]),m=S(()=>({...s,collapsed:i,badge:p,filters:c}),[s,i,p,c]);return b(()=>{let t=e.shadowRoot.querySelector(`#tableContent`),n=new ResizeObserver(t=>requestAnimationFrame(()=>{e.style.setProperty(`--ot-height`,t[0]?.contentRect.height+`px`)}));return n.observe(t),()=>n.unobserve(t)},[]),{allSelected:u,onAllCheckboxChange:d,data:n,settingsConfig:m,filters:c,groupOnColumn:f,sortAndGroup:r.sortAndGroup,...l}}})),oo,so,co,lo,uo,fo,po=e((()=>{h(),y(),Me(),Na(),J(),oo=i`
	<svg
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
...
`,so=e=>e?`groupRow groupRow-folded`:`groupRow`,co=({item:e,index:t})=>n=>E(n?.length>0,()=>i`
	...
	`,uo=({onCheckboxChange:e,dataIsValid:t,groupOnColumn:n})=>(r,a,{selected:o,folded:s,toggleFold:c})=>i` <div
		...
		</div>`,fo=({host:e,error:t,dataIsValid:n,processedItems:r,columns:i,collapsedColumns:a,miniColumns:o,sortAndGroupOptions:s,rowPartFn:c,...l})=>{let{loading:u=!1,displayEmptyGroups:d=!1,compareItemsFn:f}=e,p=He({shiftKey:!1,ctrlKey:!1}),m=x(t=>{let n=t.target.dataItem,r=t.target.checked;p.current.shiftKey?e.shadowRoot.querySelector(`#groupedList`).toggleSelectTo(n,r):p.current.ctrlKey?(t.target.checked=!0,e.shadowRoot.querySelector(`#groupedList`).selectOnly(n)):e.shadowRoot.querySelector(`#groupedList`).toggleSelect(n,r),t.preventDefault(),t.stopPropagation()},[]);b(()=>{let e=({shiftKey:e,ctrlKey:t})=>{p.current={shiftKey:e,ctrlKey:t}};return window.addEventListener(`keydown`,e),window.addEventListener(`keyup`,e),()=>{window.removeEventListener(`keydown`,e),window.removeEventListener(`keyup`,e)}},[]);let h=x(t=>{let n=t.composedPath();n.slice(0,n.indexOf(t.currentTarget)).find(e=>e.matches?.(`a, .checkbox, .expand`))||e.dispatchEvent(new window.CustomEvent(`omnitable-item-click`,{bubbles:!0,composed:!0,detail:{item:t.currentTarget.dataItem,index:t.currentTarget.dataIndex}}))},[]),{groupOnColumn:g}=s,_=x((t,n)=>r=>pn(e,t,n,r),[]);return{...l,processedItems:r,dataIsValid:n,filterIsTooStrict:n&&r.length<1,loading:u,compareItemsFn:f,displayEmptyGroups:d,error:t,renderItem:S(()=>lo({columns:i,collapsedColumns:a,miniColumns:o,onItemClick:h,onCheckboxChange:m,dataIsValid:n,groupOnColumn:g,onItemChange:_,rowPartFn:c}),[i,a,h,m,n,g,_,c]),renderGroup:S(()=>uo({onCheckboxChange:m,dataIsValid:n,groupOnColumn:g}),[m,n,g])}}})),mo,ho=e((()=>{mo=(e,t)=>{if(e===t)return 0;if(e==null)return-1;if(t==null)return 1;let n=typeof e,r=typeof t;return n===`object`&&r===`object`?e.toString()<t.toString()?-1:1:n===`number`&&r===`number`?e-t:n===`string`&&r===`string`?e<t?-1:1:n===`boolean`&&r===`boolean`?e?-1:1:(console.warn(`unsupported sort`,n,e,r,t),0)}})),go,_o,vo,yo,bo,xo,So=e((()=>{h(),Le(),ho(),K(),vi(),Na(),go=(e,t)=>(n,r)=>mo(e(n),e(r))*(t?-1:1),_o=e=>e.replace(/([a-z0-9])([A-Z])/gu,`$1-$2`).toLowerCase(),vo=(e,t)=>{!e||!t||Object.entries(t).forEach(([t,n])=>{e[G].__ownChange=!0,e[G][t]=n,e[G].__ownChange=!1,e[G].dispatchEvent(new CustomEvent(`${_o(t)}-changed`,{bubbles:!0,detail:{value:n}}))})},yo=(e,t)=>Object.assign(e,{[ja]:t}),bo=Symbol(`unparsed`),xo=({data:e,columns:t,hashParam:n,sortAndGroupOptions:r,noLocalSort:i,noLocalFilter:a})=>{let{groupOnColumn:o,groupOnDescending:s,sortOnColumn:c,descending:l}=r,u=x(([e,n])=>{let r=t.find(({name:t})=>t===e);return r==null?[e,void 0]:[e,n.filter&&r.serializeFilter(r,n.filter)]},[t]),d=x(([e,n])=>{let r=t.find(({name:t})=>t===e);if(r==null)return[e,{[bo]:n}];let i={filter:r.deserializeFilter(r,n)};return vo(r,i),[e,i]},[t]),[f,p]=_i({},n,{multi:!0,suffix:`-filter--`,write:u,read:d}),m=x((e,n)=>p(r=>{let i=Fe(n,r[e]);return vo(t.find(t=>t.name===e),i),{...r,[e]:{...r[e],...i}}}),[t,p]),h=S(()=>Object.fromEntries(t.map(e=>[e.name,!e.noLocalFilter&&e.getFilterFn(e,f[e.name]?.filter)]).filter(([,e])=>!!e)),[t,...S(()=>Object.values(f).map(e=>e.filter),[f])]),g=S(()=>!Array.isArray(e)||e.length===0?[]:Object.entries(h).length===0||a?e.slice():e.filter(e=>Object.values(h).every(t=>t(e))),[e,h,a]),_=S(()=>{if(!i&&!o&&c!=null&&c.sortOn!=null)return g.slice().sort(go(e=>c.getComparableValue({...c,valuePath:c.sortOn},e),l));if(o!=null&&o.groupOn!=null){let e=g.reduce((e,t)=>{let n=o.getComparableValue({...o,valuePath:o.groupOn},t);if(n===void 0)return e;let r=e.find(e=>e.id===n);return r?(r.items.push(t),e):(r={id:n,name:n,items:[t]},[...e,r])},[]);return e.sort(go(e=>o.getComparableValue({...o,valuePath:o.groupOn},e.items[0]),s)),!c||i?e:e.filter(e=>Array.isArray(e.items)).map(e=>(e.items.sort(go(e=>c.getComparableValue({...c,valuePath:c.sortOn},e),l)),e))}return g},[g,o,s,c,l,i]),v=S(()=>{let e=0,t=0,n=[];return _.forEach(r=>{if(Array.isArray(r.items)){yo(r,t++),r.items.forEach(t=>{yo(t,e++),n.push(t)});return}return yo(r,e++),n.push(r)},[]),n},[_]);return b(()=>{p(e=>Object.values(e).some(e=>e[bo]!=null)?Object.fromEntries(Object.entries(e).map(([e,t])=>t[bo]==null?[e,t]:d([e,t[bo]]))):e)},[d]),{processedItems:_,visibleData:v,filters:f,filterFunctions:h,setFilterState:m}}})),Co,wo,To=e((()=>{be(),h(),ve(),Co=e=>{let t=t=>{let n=e.data.indexOf(t);if(n<0)return null;let r=e.data.splice(n,1);if(e.data=e.data.slice(),Array.isArray(r)&&r.length>0)return r[0]},n=(t,n)=>{e.data.splice(t,1,n),e.data=e.data.slice()};return{removeItem:t,removeItems(t){let n=[];for(let r=t.length-1;r>=0;--r){let i=e.removeItem(t[r]);i!=null&&n.push(i)}return n},replaceItemAtIndex:n,replaceItem(t,r){let i=e.data.indexOf(t);if(i>-1)return n(i,r)},selectItem(t){e.shadowRoot.querySelector(`#groupedList`).select(t)},selectAll(){e.shadowRoot.querySelector(`#groupedList`).selectAll()},deselectAll(){e.shadowRoot.querySelector(`#groupedList`).deselectAll()},deselectItem(t){e.shadowRoot.querySelector(`#groupedList`).deselect(t)},isItemSelected(t){return e.shadowRoot.querySelector(`#groupedList`).isItemSelected(t)}}},wo=({host:e,visibleData:t,filters:n,...r})=>{let{setFilterState:i}=r,a=S(()=>Co(e),[]);v(r,Object.values(r)),v(a,Object.values(a)),b(()=>{let t=e=>i(e.detail.name,t=>({...t,...e.detail.state}));return e.addEventListener(`legacy-filter-changed`,t),()=>e.removeEventListener(`legacy-filter-changed`,t)},[]),T(`visibleData`,t),T(`sortedFilteredGroupedItems`,r.sortedFilteredGroupedItems),T(`selectedItems`,r.selectedItems),T(`sortOn`,r.sortOn),T(`descending`,r.descending),T(`isMini`,r.isMini);let o=S(()=>Object.fromEntries(Object.entries(n).filter(([,{filter:e}])=>e!==void 0).map(([e,{filter:t}])=>[e,t])),[n]);T(`filters`,o,Object.values(o))}})),Eo,Do=e((()=>{h(),Da(),to(),ro(),ao(),po(),So(),To(),wi(),Eo=e=>{let{hashParam:t,settingsId:n,data:r,resizeSpeedFactor:i,noLocal:a,noLocalSort:o=a,noLocalFilter:s=a,error:c,rowPartFn:l}=e,u=Ta({settingsId:n,host:e}),{settings:d,setSettings:f,columns:p,resetRef:m}=u,h=Si(p,t,d,f,m),{processedItems:g,visibleData:_,filters:v,setFilterState:ee,filterFunctions:te}=xo({data:r,columns:p,hashParam:t,sortAndGroupOptions:h,noLocalSort:o,noLocalFilter:s}),{isMini:y,collapsedColumns:ne,miniColumns:b}=eo({host:e,columns:p,settings:d,setSettings:f,resizeSpeedFactor:i,sortAndGroupOptions:h}),re=r&&Array.isArray(r)&&r.length>0,[ie,ae]=j([]);return wo({host:e,visibleData:_,sortedFilteredGroupedItems:g,columns:p,filters:v,setFilterState:ee,selectedItems:ie,isMini:y,...h}),{header:io({host:e,selectedItems:ie,sortAndGroupOptions:h,dataIsValid:re,data:r,columns:p,filters:v,collapsedColumns:ne,settings:d,filterFunctions:te,settingS:u,setFilterState:ee,hideSelectAll:e.hideSelectAll===!0}),list:fo({host:e,error:c,dataIsValid:re,processedItems:g,setSelectedItems:ae,columns:p,collapsedColumns:ne,miniColumns:b,sortAndGroupOptions:h,rowPartFn:l}),footer:no({host:e,selectedItems:ie,columns:p})}}})),Oo=e((()=>{n(),customElements.define(`cosmoz-grouped-list-row`,class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||r(this._renderFn(this._item,this._index),this)}})})),ko,Ao,jo,Mo,No,Po,Fo,Io,Lo,Ro=e((()=>{ko={group:Symbol(`group`)},Ao=(e,t)=>(t.has(e)||t.set(e,{}),t.get(e)),jo=(e,t)=>!!Ao(e,t).expanded,Mo=(e,t)=>!!Ao(e,t).folded,No=e=>e?e.items instanceof Array:!1,Po=e=>{if(!Array.isArray(e)||e.length===0)return;let t=Array.isArray(e[0]?.items);if(!e.every(e=>Array.isArray(e.items)===t))throw Error(`Data must be homogeneous.`)},Fo=(e,t,n)=>{if(Array.isArray(e))return Po(e),e.reduce((e,r)=>{let i=r;return i.items?i.items.length?Ao(r,n).folded?e.concat(r):e.concat(r,i.items.map(e=>Object.assign(e,{[ko.group]:r}))):t?e.concat(r):e:e.concat(r)},[])},Io=(e,...t)=>typeof e==`function`?e(...t):e,Lo=(e,t)=>e===t})),zo,Bo=e((()=>{h(),Ro(),zo=()=>{let[e,t]=j(()=>[new WeakMap]);return{setItemState:x((e,n)=>t(([t])=>{let r=Ao(e,t);return Object.assign(r,Io(n,r)),[t]}),[]),state:e[0],signal:e}}})),Vo,Ho=e((()=>{h(),Bo(),Ro(),Vo=()=>{let{setItemState:e,state:t,signal:n}=zo();return{state:t,signal:n,toggleFold:x((t,n)=>{No(t)&&e(t,e=>({folded:n===void 0?!e.folded:n}))},[]),toggleCollapse:x((t,n)=>{No(t)||e(t,e=>({expanded:n===void 0?!e.expanded:!n}))},[])}}})),Uo,Wo=e((()=>{h(),Ro(),Uo=({initial:e,compareItemsFn:t,data:n,flatData:r})=>{let[i,a]=j(e),[o,s]=j(),c=x(e=>i.includes(e),[i]),l=x(e=>e?.items?.every(c)??!1,[c]),u=x(e=>c(e)||l(e),[c,l]),d=x(e=>{let t=e.items??[e];a(e=>[...e,...t.filter(t=>!e.includes(t))]),s(e)},[]),f=x(e=>{let t=e.items??[e];a(e=>e.filter(e=>!t.includes(e))),s(e)},[]),p=x(e=>{a(e.items?.slice()||[e]),s(e)},[]),m=x(()=>{a(n.flatMap(e=>e.items||e)),s(void 0)},[n]),h=x(()=>{a([]),s(void 0)},[]),g=x((e,t=!u(e))=>t?d(e):f(e),[u]),_=x((e,n)=>{if(!r)return;let i=o?r.findIndex(e=>t(e,o)):-1;if(i<0)return g(e,n);let[a,c]=[i,r.indexOf(e)].sort((e,t)=>e-t);r.slice(a,c+1).forEach((e,t,r)=>{t>0&&t<r.length-1&&No(e)||g(e,n)}),s(e)},[r,t,g]);return b(()=>a(e=>e.length>0&&r?r.filter(n=>e.find(e=>t(n,e))):e),[r]),{selectedItems:i,isItemSelected:c,isGroupSelected:l,isSelected:u,select:d,deselect:f,selectOnly:p,selectAll:m,deselectAll:h,toggleSelect:g,toggleSelectTo:_}}})),Go,Ko,qo,Jo=e((()=>{be(),ve(),h(),n(),Oo(),Ho(),Wo(),Ro(),ge(),Go={host:{position:`relative`,display:`flex`,flexDirection:`column`}},Ko=e=>{let{data:t,renderItem:n,renderGroup:r,displayEmptyGroups:i,compareItemsFn:a=Lo}=e,{toggleFold:o,toggleCollapse:s,state:c,signal:l}=Vo(),u=S(()=>Fo(t,i,c),[t,i,l]),{selectedItems:d,isItemSelected:f,isGroupSelected:p,isSelected:m,select:h,deselect:g,selectOnly:_,selectAll:ee,deselectAll:te,toggleSelect:y,toggleSelectTo:ne}=Uo({initial:[],compareItemsFn:a,data:t,flatData:u}),b=x((e,t)=>Array.isArray(e.items)?r(e,t,{selected:p(e),folded:Mo(e,c),toggleSelect:t=>y(e,typeof t==`boolean`?t:void 0),toggleFold:()=>o(e)}):n(e,t,{selected:d.includes(e),expanded:jo(e,c),toggleSelect:t=>y(e,typeof t==`boolean`?t:void 0),toggleCollapse:()=>s(e)}),[n,r,d,y,l]);ce(()=>{Object.assign(e.style,Go.host)},[]),T(`selectedItems`,d);let re={toggleFold:o,toggleCollapse:s,isItemSelected:f,isGroupSelected:p,isSelected:m,select:h,deselect:g,selectOnly:_,selectAll:ee,deselectAll:te,toggleSelect:y,toggleSelectTo:ne};return v(re,Object.values(re)),{renderRow:b,flatData:u}},qo=({renderRow:e,flatData:t})=>m({items:t,renderItem:(t,n)=>i`<cosmoz-grouped-list-row
				.item=${t}
				.index=${n}
				.renderFn=${e}
			></cosmoz-grouped-list-row>`})})),Yo,Xo=e((()=>{Jo(),h(),Yo=e=>qo(Ko(e)),customElements.define(`cosmoz-grouped-list`,p(Yo,{useShadowDOM:!1}))})),Zo=e((()=>{Xo()})),Qo,$o,es,ts=e((()=>{ze(),At(),Qr(),ei(),Di(),Mi(),Fi(),ve(),h(),Ae(),n(),_e(),Ri(),Ki(),Ji(),$i(),Do(),Zo(),Qo=e=>window.ShadyCSS?.ApplyShim?.transformCssText?.(e)||e,$o=e=>{let{header:t,list:n,footer:r}=Eo(e);return i`
		<style>
			${ut([],()=>Qo(Li))}
		</style>
