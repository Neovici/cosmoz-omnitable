 ...
 * @mixinFunction
 */
export const templatizeMixin = dedupingMixin(base => class extends base { // eslint-disable-line max-lines-per-function
	constructor() {
		super();
...
export const CELL_TEMPLATE = 'cell';
export const EDIT_TEMPLATE = 'edit-cell';
