...
`,Pn=e=>{let{placement:t=`bottom span-right`,disabled:n,passthrough:r,openOnHover:i,openOnFocus:a}=e,o=nn(),[s,c]=Qt(`opened`,!1),l=V(()=>{n||(c(!0),o.current?.showPopover?.())},[n]),u=V(()=>{c(!1),o.current?.hidePopover?.()},[]),d=V(()=>{n||(o.current?.matches(`:popover-open`)?u():l())},[n]);z(()=>{let e=o.current;e&&(s?e.showPopover?.():e.hidePopover?.())},[s]),z(()=>{e.toggleAttribute(`opened`,!!s)},[s]);let{scheduleClose:f,cancelClose:p}=An({host:e,popoverRef:o,disabled:n,openOnHover:i,openOnFocus:a,open:l,close:u}),m=a?l:d,h=V(t=>{Mn(t),c(t.newState===`open`),e.dispatchEvent(new ToggleEvent(`dropdown-toggle`,{newState:t.newState,oldState:t.oldState,composed:!0}))},[]);return j`
...
`)})))()}var Lw;function Rw(){return(Rw=e((()=>{Iw(),G(),F(),Lw=L`
	:host {
		display: flex;
...
`,customElements.define(`cosmoz-tooltip-content`,W(()=>j`
			...
			<slot></slot>
		`,{styleSheets:[Fw,Lw]}))})))()}var zw;function Bw(){return(Bw=e((()=>{G(),zw=I(L`
...
`)})))()}var Vw,Hw;function Uw(){return(Uw=e((()=>{G(),F(),Rw(),Bw(),Vw=(e,t,n)=>Pe(j`<cosmoz-tooltip-content>
		...
		</cosmoz-tooltip-content>`,e),Hw=(e,t)=>{let{for:n,heading:r,description:i,placement:a=`top`,delay:o=300,disabled:s=!1}=t,c=nn(),l=!!(r||i)&&!s;z(()=>{if(!n||!l)return;let t=e.getRootNode(),u=t.adoptedStyleSheets??[];u.includes(zw)||(t.adoptedStyleSheets=[...u,zw]);let d=document.createElement(`div`);d.setAttribute(`popover`,`manual`),d.setAttribute(`role`,`tooltip`),d.classList.add(`cosmoz-tooltip-popover`),e.after(d),c.current=d,Vw(d,r,i);let f=`[name="${n}"]`,p=`--tooltip-anchor-${n}`,m,h=e=>{s||(clearTimeout(m),e.style.anchorName=p,d.style.positionAnchor=p,d.style.positionArea=a,m=window.setTimeout(()=>d.showPopover(),o))},g=()=>{clearTimeout(m),d.hidePopover()},_=e=>{let t=e.target.closest?.(f);t&&h(t)},v=e=>{let t=e.target.closest?.(f);if(!t)return;let n=e.relatedTarget;n&&t.contains(n)||g()},y=e=>{let t=e.target.closest?.(f);t&&h(t)},b=e=>{e.target.closest?.(f)&&g()};return t.addEventListener(`pointerover`,_),t.addEventListener(`pointerout`,v),t.addEventListener(`focusin`,y),t.addEventListener(`focusout`,b),()=>{clearTimeout(m),t.removeEventListener(`pointerover`,_),t.removeEventListener(`pointerout`,v),t.removeEventListener(`focusin`,y),t.removeEventListener(`focusout`,b),d.hidePopover(),d.remove(),c.current=void 0}},[n,a,o,l]),z(()=>{n&&c.current&&Vw(c.current,r,i)},[r,i,n]),z(()=>{s&&c.current&&c.current.hidePopover()},[s])}})))()}var Ww;function Gw(){return(Gw=e((()=>{G(),Ww=e=>{let[t,n]=qt(!1);return z(()=>{let t=e.current;if(!t)return;let r=()=>{n(t.assignedElements().length>0)};return r(),t.addEventListener(`slotchange`,r),()=>t.removeEventListener(`slotchange`,r)},[e.current]),t}})))()}var Kw,qw;function Jw(){return(Jw=e((()=>{Iw(),G(),F(),kn(),Rw(),Bw(),Uw(),Gw(),Kw=L`
	:host {
		display: inline-block;
...
`})))()}var tT;function nT(){return(nT=e((()=>{G(),tT=e=>B(()=>{if(e==null)return;let t=new RegExp(e,`u`);return e=>{!e.defaultPrevented&&e.data&&!t.test(e.data)&&e.preventDefault()}},[e])})))()}var rT;function iT(){return(iT=e((()=>{G(),rT=jt(class extends R{values;constructor(e,t,n,r){super(e,t),Object.assign(t.host,n),this.values=r}update(e,t){this.hasChanged(t)&&(this.values=t,Object.assign(this.state.host,e))}hasChanged(e=[]){return e.some((e,t)=>this.values[t]!==e)}})})))()}var aT;function oT(){return(oT=e((()=>{G(),aT=jt(class extends R{update(){return this.state.host}})})))()}var sT,cT,lT;function uT(){return(uT=e((()=>{G(),oT(),sT=/([A-Z])/gu,cT=(e,t,n)=>{e[t]=n,e.dispatchEvent(new CustomEvent(t.replace(sT,`-$1`).toLowerCase()+`-changed`,{detail:{value:n}}))},lT=(e,t,n=[t])=>{let r=aT();z(()=>{cT(r,e,t)},n)}})))()}var dT;function fT(){return(fT=e((()=>{iT(),uT(),G(),dT=e=>{let t=nn(void 0),n=V(e=>t.current=e,[]),r=e.shadowRoot,i=V(t=>e.dispatchEvent(new Event(t.type,{bubbles:t.bubbles})),[]),a=V(t=>cT(e,`value`,t.target.value),[]),o=V(t=>cT(e,`focused`,t.type===`focus`),[]),s=V(()=>{let n=t.current?.checkValidity();return e.toggleAttribute(`invalid`,!n),n},[]);return rT({validate:s},[s]),z(()=>{let e=e=>{e.composedPath()[0]?.closest?.(`input, textarea, label`)||(e.preventDefault(),t.current?.focus())};return r.addEventListener(`mousedown`,e),()=>r.removeEventListener(`mousedown`,e)},[]),{onChange:i,onFocus:o,onInput:a,onRef:n}}})))()}var pT,mT;function hT(){return(hT=e((()=>{pT=({placeholder:e})=>e||` `,mT=(e,t)=>t??(e===`date`?`9999-12-31`:void 0)})))()}var gT,_T;function vT(){return(vT=e((()=>{G(),F(),q(),Pw(),kn(),Qw(),eT(),nT(),fT(),hT(),gT=[`type`,`variant`,`hint`,`compact`,`required`,`pattern`,`allowed-pattern`,`min`,`max`,`step`,`autosize`,`label`,`placeholder`,...Zw],_T=e=>{let{type:t=`text`,pattern:n,allowedPattern:r,autocomplete:i,value:a,readonly:o,disabled:s,min:c,max:l,step:u,maxlength:d,required:f}=e,{onChange:p,onFocus:m,onInput:h,onRef:g}=dT(e),_=tT(r);return e.toggleAttribute(`has-value`,!!a),Xw(j`
			<input
				${On(g)}
		...
		`,e)},customElements.define(`cosmoz-input`,W(_T,{observedAttributes:gT,styleSheets:[I($w)],shadowRootInit:{mode:`open`,delegatesFocus:!0}}))})))()}var yT,bT,xT;function ST(){return(ST=e((()=>{G(),yT=e=>{e.style.height=``,e.style.height=`${e.scrollHeight}px`},bT=(e,t=0)=>{if(t>0){let n=e.getAttribute(`rows`)??``,r=e.style.height;e.style.height=``,e.setAttribute(`rows`,t),e.style.maxHeight=e.getBoundingClientRect().height+`px`,e.style.height=r,e.setAttribute(`rows`,n)}},xT=e=>{let{value:t,maxRows:n}=e,r=B(()=>()=>e.shadowRoot.querySelector(`#input`),[]);z(()=>bT(r(),n),[n,r]),z(()=>yT(r()),[r,t]),z(()=>{let e=r(),t=new ResizeObserver(()=>requestAnimationFrame(()=>yT(e)));return t.observe(e),()=>t.unobserve(e)},[r])}})))()}var CT,wT;function TT(){return(TT=e((()=>{F(),q(),Pw(),kn(),G(),Qw(),eT(),ST(),fT(),CT=[`rows`,`placeholder`,`label`,`hint`,`required`,...Zw],wT=e=>{let{autocomplete:t,value:n,placeholder:r,readonly:i,disabled:a,rows:o,cols:s,maxlength:c}=e,{onChange:l,onFocus:u,onInput:d,onRef:f}=dT(e);return xT(e),Xw(j`
			<textarea id="input" part="input"
				...
				@change=${l} @focus=${u} @blur=${u}>`,e)},customElements.define(`cosmoz-textarea`,W(wT,{observedAttributes:CT,styleSheets:[I($w)],shadowRootInit:{mode:`open`,delegatesFocus:!0}}))})))()}var ET,DT,OT;function kT(){return(kT=e((()=>{G(),Pw(),ET=e=>{let{label:t,value:n,disabled:r,error:i}=e,a=V(t=>e.dispatchEvent(new CustomEvent(`change`,{detail:t.target.checked})),[]);return j`<input
			id="toggle"
			class="toggle"
			part="toggle"
			type="checkbox"
		...
		<slot name="suffix"></slot>
		${J(i,e=>j`<div class="failure">${e}</div>`)} `},DT=L`
	.toggle {
		appearance: none;
...
`,kD=({index:e,itemHeight:t,auto:n})=>L`
	${J(!n,()=>L`
			.item {
				line-height: ${t}px;
				height: ${t}px;
...
`})))()}var jD;function MD(){return(MD=e((()=>{G(),jD=e=>{let t=e===`auto`,[n,r]=qt(t?40:e);return[n,e=>t?r(e):void 0]}})))()}var ND;function PD(){return(PD=e((()=>{ND=Symbol(`any key`)})))()}var FD;function ID(){return(ID=e((()=>{G(),xD(),FD=yn(()=>vD),customElements.define(`cosmoz-keybinding-provider`,FD.Provider)})))()}var LD;function RD(){return(RD=e((()=>{G(),LD=e=>{let t=B(()=>({}),[]);return B(()=>Object.assign(t,e),[t,...Object.values(e)])}})))()}var zD;function BD(){return(BD=e((()=>{G(),ID(),RD(),zD=(e,t)=>{let n=Rt(FD),r=LD(e);z(()=>n(r),t)}})))()}var VD,HD,UD,WD;function GD(){return(GD=e((()=>{PD(),VD=e=>([t])=>Object.entries(t).every(([t,n])=>e[t]===n||n===ND),HD=e=>{if(e==null)return!1;let t=e.getBoundingClientRect(),n=e.getRootNode().elementFromPoint(t.x+t.width/2,t.y+t.height/2);return n!=null&&(e===n||e.contains(n))},UD=(e=document)=>{let t=e.activeElement;return t?t.shadowRoot?UD(t.shadowRoot):t:null},WD=()=>{let e=UD(document);return e?!!(e.matches(`input:not([type="checkbox"]), textarea`)||`isContentEditable`in e&&e.isContentEditable):!1}})))()}var KD;function qD(){return(qD=e((()=>{G(),RD(),GD(),KD=e=>{let t=LD({bindings:e});return z(()=>{let e=e=>{if(e.defaultPrevented)return;let n=t.bindings.find(VD(e));if(!n)return;let[,r,,i]=n;if(!i?.allowInEditable&&WD())return;let a=r.flatMap(e=>t[e]??[]);if(a.length===0)return;let o=a.find(e=>e.check&&!e.check()||e.element&&!HD(e.element())?!1:e);o&&(o.allowDefault||e.preventDefault(),o.callback(e))};return document.addEventListener(`keydown`,e,!0),()=>document.removeEventListener(`keydown`,e,!0)},[]),V(e=>(t[e.activity]=[e,...t[e.activity]??[]],()=>{t[e.activity]=t[e.activity]?.filter(t=>t!==e)}),[])}})))()}function JD(){return(JD=e((()=>{PD(),ID(),BD(),qD()})))()}var YD,XD,ZD,QD;function $D(){return($D=e((()=>{YD=Symbol(`listbox.navigate.up`),XD=Symbol(`listbox.navigate.down`),ZD=Symbol(`listbox.select`),QD=[[{key:`ArrowUp`},[YD],{title:`Navigate up`,description:`Move to previous listbox item`},{allowInEditable:!0}],[{key:`ArrowDown`},[XD],{title:`Navigate down`,description:`Move to next listbox item`},{allowInEditable:!0}],[{key:`Enter`},[ZD],{title:`Select`,description:`Select current listbox item`},{allowInEditable:!0}]]})))()}var eO;function tO(){return(tO=e((()=>{oT(),JD(),$D(),eO=({onUp:e,onDown:t,onEnter:n})=>{let r=aT();zD({activity:YD,callback:e,element:()=>r},[]),zD({activity:XD,callback:t,element:()=>r},[]),zD({activity:ZD,callback:n,element:()=>r},[])}})))()}var nO;function rO(){return(rO=e((()=>{G(),tO(),nO=({items:e,onSelect:t,defaultIndex:n=0})=>{let[r,i]=qt({index:n}),{index:a}=r,{length:o}=e;return z(()=>{i({index:r.index<0?n:Math.min(r.index,e.length-1),scroll:!0})},[e,n]),eO({onUp:V(()=>i(e=>({index:e.index>0?e.index-1:o-1,scroll:!0})),[o]),onDown:V(()=>i(e=>({index:e.index<o-1?e.index+1:0,scroll:!0})),[o]),onEnter:V(()=>a>-1&&a<o&&t?.(e[a],a),[a,e,t])}),{position:r,highlight:V(e=>i({index:e}),[]),select:V(e=>t?.(e),[t])}}})))()}function iO(e){return e==null?[]:Array.isArray(e)?e:typeof e==`string`?[e]:aO(e)?Array.from(e):[e]}var aO,oO;function sO(){return(sO=e((()=>{xD(),aO=e=>typeof e==`object`&&!!e&&Symbol.iterator in e,oO=(e,t=yD)=>n=>{let r=iO(e).map(t);return iO(n).filter(e=>!r.includes(t(e)))}})))()}var cO,lO;function uO(){return(uO=e((()=>{sO(),F(),cO=(e,t)=>t?n=>n!=null&&iO(e).find(e=>e[t]===n[t]):t=>t!=null&&iO(e).includes(t),lO=(e,t)=>{if(!t||!e)return e;let n=e.toLowerCase().indexOf(t.toLowerCase());if(n<0)return e;let r=n+t.length;return[e.slice(0,n),j`<mark>${e.slice(n,r)}</mark>`,e.slice(r)]}})))()}var dO;function fO(){return(fO=e((()=>{xD(),F(),uO(),dO=(e=yD)=>(t,n,{highlight:r,select:i,textual:a=yD,query:o,isSelected:s})=>{let c=a(t),l=e(lO(c,o),t,n);return j`<div
				class="item"
				role="option"
				part="option"
				?aria-selected=${s(t)}
			...
			<div class="sizer" virtualizer-sizer>${l}</div>`},dO()})))()}var pO;function mO(){return(mO=e((()=>{RD(),G(),fO(),pO=({itemRenderer:e=dO(),...t})=>{let n=LD(t);return V((t,r)=>e(t,r,n),[n,e])}})))()}var hO,gO;function _O(){return(_O=e((()=>{G(),MD(),rO(),mO(),uO(),hO=[`query`,`items`,`onSelect`,`textual`,`anchor`,`itemHeight`,`itemLimit`,`itemRenderer`,`defaultIndex`,`value`,`valueProperty`,`loading`],gO=({value:e,valueProperty:t,items:n,onSelect:r,defaultIndex:i,query:a,textual:o,itemRenderer:s,itemHeight:c=40,itemLimit:l=5})=>{let u=B(()=>cO(e,t),[e,t]),d=B(()=>n.slice(),[n,u]),{position:f,highlight:p,select:m}=nO({items:d,onSelect:r,defaultIndex:isNaN(i)?void 0:Number(i)}),[h,g]=jD(c);return{position:f,items:d,height:Math.min(l,d.length)*h,highlight:p,select:m,itemHeight:h,setItemHeight:g,renderItem:pO({itemRenderer:s,items:d,position:f,highlight:p,select:m,textual:o,query:a,isSelected:u})}}})))()}var vO,yO,bO;function xO(){return(xO=e((()=>{dD(),En(),hD(),xD(),CD(),DD(),G(),kn(),AD(),_O(),vO=vD,yO=e=>{let t=nn(void 0),{position:n,items:r,renderItem:i,height:a,itemHeight:o,setItemHeight:s}=gO(e);return z(()=>{let n=t.current?.[nD];n&&n.layoutComplete.then(()=>{e.dispatchEvent(new CustomEvent(`layout-complete`));let{averageChildSize:t,averageMarginSize:r}=n._layout._metricsCache;return s(t+r*2)},vO)},[r]),z(()=>{if(!n.scroll)return;let e=t.current?.[nD];if(e){if(!e?._layout){e.layoutComplete.then(()=>e.element(n.index)?.scrollIntoView({block:`nearest`}),vO);return}e.element(n.index)?.scrollIntoView({block:`nearest`})}},[n]),SD(kD({...n,itemHeight:o,auto:e.itemHeight===`auto`})),j`<div
			class="items"
		...
		...=${mD(ED(hO)(t))}
		>${n}</cosmoz-listbox
	>`})))()}var SO;function CO(){return(CO=e((()=>{G(),SO=I(L`
	/*
	 * Use border-box sizing for all elements.
	 * This is safe and doesn't conflict with child component styles.
	 */
...
`)})))()}var $,wO;function TO(){return(TO=e((()=>{G(),$=e=>`calc(var(--cz-spacing) * ${e})`,wO=L`
	/* =========================================
	 * HOST
	 * ========================================= */
	:host {
...
`})))()}var EO;function DO(){return(DO=e((()=>{CO(),G(),TO(),EO=()=>j`<span class="badge" part="badge" role="status">
		<span class="dot" part="dot"></span>
		<slot name="prefix"></slot>
		<span class="content"><slot></slot></span>
		<slot name="suffix"></slot>
	</span>`,customElements.define(`cosmoz-badge`,W(EO,{styleSheets:[SO,wO]}))})))()}function OO(){return(OO=e((()=>{DO()})))()}var kO;function AO(){return(AO=e((()=>{G(),kO=I(L`
	/*
	 * Use border-box sizing for all elements.
	 * This is safe and doesn't conflict with child component styles.
	 */
...
`)})))()}var jO,MO;function NO(){return(NO=e((()=>{G(),jO=e=>`calc(var(--cz-spacing) * ${e})`,MO=L`
	/* =========================================
	 * HOST
	 * ========================================= */
	:host {
...
`})))()}var PO;function FO(){return(FO=e((()=>{OO(),Mw(),AO(),G(),q(),NO(),PO=e=>{let{color:t,size:n,disabled:r,removable:i}=e,a=()=>{r||e.dispatchEvent(new CustomEvent(`remove`))};return j`<cosmoz-badge
		color=${K(t)}
		size=${K(n)}
		?disabled=${r}
		type="color"
	>
	...
	</cosmoz-badge>`},customElements.define(`cosmoz-tag`,W(PO,{observedAttributes:[`color`,`size`,`disabled`,`removable`],styleSheets:[kO,MO]}))})))()}function IO(){return(IO=e((()=>{FO()})))()}var LO;function RO(){return(RO=e((()=>{IO(),G(),q(),LO=({content:e,onClear:t,disabled:n,className:r=`chip`,hidden:i,slot:a})=>j`<cosmoz-tag
		class=${K(r)}
		slot=${K(a)}
		...
		>${e}</cosmoz-tag
	>`})))()}var zO;function BO(){return(BO=e((()=>{F(),RO(),zO=({value:e,min:t=0,onDeselect:n,textual:r,disabled:i,chipRenderer:a=LO})=>[...e.filter(Boolean).map(o=>a({item:o,content:r(o),onClear:e.length>t&&(()=>n(o)),disabled:i,slot:`control`})),a({item:null,content:j`<span></span>`,className:`badge`,disabled:!0,slot:`control`,hidden:!0})]})))()}var VO;function HO(){return(HO=e((()=>{G(),F(),VO=L`
	:host {
		display: inline-block;
		vertical-align: middle;
...
`,customElements.define(`cosmoz-autocomplete-skeleton-span`,W(()=>P,{styleSheets:[VO]}))})))()}var UO;function WO(){return(WO=e((()=>{En(),UO=Sn`
	:host {
		display: block;
		position: relative;
...
`})))()}var Pk,Fk;function Ik(){return(Ik=e((()=>{Pk=e=>({item:e,excluded:!1}),Fk=e=>e.item})))()}var Lk;function Rk(){return(Rk=e((()=>{xD(),G(),jk(),Ik(),Lk=e=>{let[t,n]=Qt(e);return{value:t,setExcludingValue:V(e=>n(t=>{let n=bD(e,t?.map(Fk));if(!n)return;if(!t)return n.map(Pk);let r=t.reduce((e,t)=>n.includes(t.item)?[...e,t]:t.excluded?e:[...e,{...t,excluded:!0}],[]),i=n.filter(e=>!t.some(t=>t.item===e)).map(Pk);return[...r,...i]}),[]),setValue:n}}})))()}var zk,Bk,Vk,Hk,Uk;function Wk(){return(Wk=e((()=>{IO(),G(),q(),jk(),Dk(),Nk(),Rk(),Ik(),zk=(e,t)=>e?.some(e=>e.item===t&&e.excluded),Bk=(e,t)=>t&&zk(e,t)?`error`:`gray`,Vk=e=>(t,n,{highlight:r,select:i,textual:a,isSelected:o})=>{let s=a(t);return j`<div
				class="item"
				role="option"
				part="option ${Bk(e,t)}"
				?aria-selected=${o(t)}
			...
			<div class="sizer" virtualizer-sizer>${s}</div>`},Hk=(e,t)=>({item:n,content:r,disabled:i,hidden:a,className:o=`chip`,slot:s})=>j`<cosmoz-tag
			class=${K(o)}
			slot=${K(s)}
			exportparts="chip-text, chip-clear"
			color=${Bk(e,n)}
		...
		>
			${r}
		</cosmoz-tag>`,Uk=e=>{let{value:t,setValue:n,setExcludingValue:r}=Lk(`value`),[i,a]=Qt(`text`),o=V(e=>n(t=>t?.filter(t=>t.item!==e)),[]);return Tk({...e,value:B(()=>t?.map(Fk),[t]),onChange:V(e=>{r(e)},[]),text:i,onText:V(e=>{a(e)},[]),itemRenderer:B(()=>Vk(t),[t]),chipRenderer:B(()=>Hk(t,o),[t,o])})},customElements.define(`cosmoz-autocomplete-excluding`,W(Uk,{observedAttributes:Ek,styleSheets:[UO,Mk],shadowRootInit:{mode:`open`,delegatesFocus:!0}}))})))()}function Gk(){return(Gk=e((()=>{jk(),Wk(),ck()})))()}export{as as $,Q as A,Kt as At,Qw as B,L as Bt,BE as C,rn as Ct,OE as D,Qt as Dt,IE as E,$t as Et,lT as F,B as Ft,bw as G,ze as Gt,Mw as H,I as Ht,iT as I,zt as It,Iu as J,N as Jt,yw as K,P as Kt,rT as L,Rt as Lt,AT as M,Ut as Mt,uT as N,V as Nt,kE as O,Jt as Ot,cT as P,Ht as Pt,_u as Q,eT as R,It as Rt,uD as S,H as St,LE as T,en as Tt,Sw as U,Qe as Ut,Xw as V,Et as Vt,xw as W,Ue as Wt,yu as X,F as Xt,vu as Y,j as Yt,gu as Z,M as Zt,yD as _,yn as _t,sO as a,q as at,vD as b,ln as bt,KD as c,kn as ct,RD as d,Tn as dt,os as et,LD as f,wn as ft,TD as g,W as gt,ED as h,G as ht,iO as i,J as it,TE as j,Gt as jt,EE as k,qt as kt,BD as l,On as lt,wD as m,Sn as mt,sk as n,Qo as nt,JD as o,K as ot,DD as p,Cn as pt,Fu as q,Pe as qt,ck as r,In as rt,qD as s,Fn as st,Gk as t,Zo as tt,zD as u,En as ut,xD as v,bn as vt,VE as w,nn as wt,dD as x,U as xt,bD as y,cn as yt,$w as z,z as zt};