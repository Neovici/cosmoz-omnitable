import{d as m,D as Oe,A as yt}from"./iframe-BbxhXiMK.js";import{t as J,c as O,g as w,P as E,u as V,a as vt,m as $t,s as Gt,D as Wt,b as jt,e as Ut,i as Ce,h as Ve,d as Kt,f as Ct,r as Jt,j as Xt,k as q,l as Qt,n as X,p as G,o as Ye,q as _,v as wt,w as we,x as Yt,y as Zt,z as ei,T as ti,A as M,B as Ze,C as F,E as C,F as ii,G as ai,H as ni,I as oi,J as ri,K as St,L as Re,M as zt,N as Ne,O as li,Q as qt,R as si,S as Pe,U as et,V as ui,W as Be,X as di,Y as ci,Z as Le,_ as He,$ as mi,a0 as De,a1 as P,a2 as pi,a3 as ke,a4 as gi}from"./cosmoz-collapse-1AqLBkxW.js";import"./preload-helper-PPVm8Dsz.js";const bi=J`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`,Ti=i=>{const{label:e,value:t,slot:a}=i,n=m`<div
		id="input"
		part="input"
		role="button"
		class="control"
	...
	>
		${t||""}
	</div>`;return Jt(n,{label:e})};customElements.define("cosmoz-omnitable-dropdown-input",O(Ti,{observedAttributes:Li,styleSheets:[Di]}));const re=({title:i,tooltip:e="",filterText:t="",onOpenedChanged:a,content:n,horizontalAlign:o="left",externalValues:r=null})=>{const l={filtered:!!t,...r!=null&&{[`external-values-${r}`]:!0}};return m`
		<style>
			.dropdown {
				outline: none;
			}
	...
	`};class Vi extends Ge(oe(E)){static get properties(){return{currency:{type:String},autodetect:{type:Boolean,value:!1},rates:{type:Object},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, _formatters)"},headerFocused:{type:Boolean,value:!1}}}static get observers(){return["_valuesChanged(autodetect, currency, values)"]}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return m`
			<style>
			...
			${re({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:m`
		...
		`}_fromInputString(e,t){const a=this.toDate(e);if(a!=null)return t==="min"&&a.setHours(0,0,0,0),t==="max"&&a.setHours(23,59,59),a}_filterInputChanged(e,t){const a=e.path.split(".")[1],n=a&&e.value;if(n&&n.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}}customElements.define("cosmoz-omnitable-date-range-input",ga);const ba=i=>{const e=-new Date(i).getTimezoneOffset()/60;return(e<0?"-":"+")+["0",Math.abs(e)].join("").substr(-2)+":00"},Je=i=>i.length===19?i+ba(i):i,Et=i=>{if(i==null||i==="")return;let e=i;return!(e instanceof Date)&&(typeof i=="string"&&(e=Je(e)),e=Yt(e),!e)||Number.isNaN(e.getTime())?null:e},N=({valuePath:i},e)=>{if(e==null)return;let t=e;i!=null&&(t=w(e,i));const a=Et(t);if(a!=null)return L(a.getTime())},I=(i,e,t)=>{const a=Et(i);return a??null},Xe=(i,e)=>{if(e==null)return;const t=I(i);if(t!=null)return e.format(t)},de={},fa=i=>{const e=i||"";return de[e]||(de[e]=new Intl.DateTimeFormat(i||void 0)),de[e]},st=({valuePath:i,locale:e},t)=>{let a=w(t,i||"");return a===void 0?"":(a=I(a),a===null?"Invalid Date":Xe(a,fa(e)))},It=i=>{const e=I(i);if(e==null)return null;const t=we(e);return t==null?null:t.slice(0,10)},ha=({valuePath:i},e)=>It(w(e,i||"")),Mt=(i,e)=>{const t=I(i);if(t!=null)return t},ut=i=>{const e=It(i);return e??""},xa=({valuePath:i},e)=>{if(!i)return"";const t=I(w(e,i));if(!t)return"";const a=I(we(t));return a?(a.setHours(0,0,0,0),a):""},Ot=(i,e)=>t=>{const a=N(i,t);if(a==null)return!1;const n=N({...i,valuePath:"min"},e),o=N({...i,valuePath:"max"},e);return!(a<(n??-1/0)||a>(o??1/0))};class ya extends D(E){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"date-header-cell"},width:{type:String,value:"100px"},minWidth:{type:String,value:"82px"},flex:{type:String,value:"0"}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const a=N({...e,valuePath:"min"},t),n=N({...e,valuePath:"max"},t);if(!(a==null&&n==null))return Ot(e,t)}getString(e,t){return st(e,t)}toXlsxValue(e,t){return xa(e,t)}getComparableValue(e,t){return N(e,t)}serializeFilter(e,t){if(t==null)return;const a=I(t.min),n=I(t.max);if(!(a==null&&n==null))return ut(a)+"~"+ut(n)}deserializeFilter(e,t){if(t==null||t==="")return null;const a=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(a)?{min:I(a[1]),max:I(a[2])}:null}renderCell(e,{item:t}){return m`<div class="omnitable-cell-date">
			...
			.value=${ha(e,t)}
		></cosmoz-input>`}renderHeader({title:e,min:t,max:a,limits:n,locale:o},{filter:r},l,u){return m`<cosmoz-omnitable-date-range-input
			.title=${e}
			.filter=${r}
			.values=${u}
			.min=${t}
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return ne(e,t)}}customElements.define("cosmoz-omnitable-column-date",ya);const ce={},va=i=>{const e=i||"";if(ce[e])return ce[e];const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return ce[e]=new Intl.DateTimeFormat(i||void 0,t),ce[e]},_e=({valuePath:i,locale:e},t)=>{const a=I(w(t,i||""));return a===void 0?"":a===null?"Invalid Date":Xe(a,va(e))},$a=({valuePath:i},e)=>i?w(e,i):"",dt=i=>{const e=I(i);return e==null?"":e.toISOString().slice(0,19).replace(/:/gu,".")},ct=i=>{if(!(i==null||i==="")&&typeof i=="string")return I(i.replace(/\./gu,":")+"Z")};class Ca extends Ke(oe(E)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return m`
			<style>
			...
			${re({title:this.title,tooltip:this._tooltip,filterText:this._filterText,externalValues:this.externalValues,onOpenedChanged:e,content:m`
					...
					></cosmoz-datetime-input>
				`})}
		`}_toInputString(e){const t=this.toValue(e);if(t!=null)return this._toLocalISOString(t).slice(0,19)}_computeFormatter(e){const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return new Intl.DateTimeFormat(e||void 0,t)}}customElements.define("cosmoz-omnitable-datetime-range-input",Ca);class mt extends D(E){static get is(){return"cosmoz-omnitable-column-datetime"}static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"datetime-header-cell"},width:{type:String,value:"210px"},minWidth:{type:String,value:"128px"},flex:{type:String,value:"0"},filterStep:{type:Number,value:1}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const a=N({...e,valuePath:"min"},t),n=N({...e,valuePath:"max"},t);if(!(a==null&&n==null))return Ot(e,t)}getString(e,t){return _e(e,t)}toXlsxValue(e,t){return $a(e,t)}getComparableValue(e,t){return N(e,t)}serializeFilter(e,t){if(t==null)return;const a=I(t.min),n=I(t.max);if(!(a==null&&n==null))return dt(a)+"~"+dt(n)}deserializeFilter(e,t){if(t==null||t==="")return null;const a=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(a)?{min:ct(a[1]),max:ct(a[2])}:null}renderCell(e,{item:t}){return _e(e,t)}renderEditCell(e,{item:t},a){return m`<cosmoz-input
			no-label-float
			type="text"
			@change=${o=>a(Mt(o.target.value))}
			.value=${_e(e,t)}
		></cosmoz-input>`}renderHeader({title:e,min:t,max:a,limits:n,locale:o,filterStep:r},{filter:l},u,s){return m`<cosmoz-omnitable-datetime-range-input
			.title=${e}
			.filter=${l}
			.values=${s}
			.min=${t}
		...
		></cosmoz-omnitable-datetime-range-input>`}computeSource(e,t){return ne(e,t)}}customElements.define(mt.is,mt);class wa extends Ae(D(E)){renderCell({valuePath:e,textProperty:t},{item:a}){const n=We(a,e,t).map(o=>m`<li>${o}</li>`);return m`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		>`}}customElements.define("cosmoz-omnitable-column-list",Sa);class za extends Ge(oe(E)){static get properties(){return{maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null},formatter:{type:Object,computed:"_computeFormatter(locale, minimumFractionDigits, maximumFractionDigits)"},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, formatter)"},headerFocused:{type:Boolean,value:!1}}}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return m`
			...
			${re({title:this.title,tooltip:this._tooltip,filterText:this._filterText,horizontalAlign:"right",externalValues:this.externalValues,onOpenedChanged:e,content:m`
					<h3>${this.title}</h3>
					<cosmoz-input
						class=${this._fromClasses}
						type="number"
		...
		`}_computeFormatter(e,t,a){const n={localeMatcher:"best fit"};return t!==null&&(n.minimumFractionDigits=t),a!==null&&(n.maximumFractionDigits=a),new Intl.NumberFormat(e||void 0,n)}getComparableValue(e,t){if(e==null)return;let a=e;if(t!=null&&(a=this.get(t,e)),a=this.toValue(a),a==null)return;const n=this.maximumFractionDigits;return n!==null?this.toValue(a.toFixed(n)):a}renderValue(e,t=this.formatter){const a=this.toNumber(e);if(a!=null)return t.format(a)}}customElements.define("cosmoz-omnitable-number-range-input",za);class qa extends D(E){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},autoupdate:{type:Boolean,value:!1,notify:!0},cellClass:{type:String,value:"number-cell align-right"},width:{type:String,value:"30px"},minWidth:{type:String,value:"30px"},headerCellClass:{type:String,value:"number-header-cell"},maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const a=j({...e,valuePath:"min"},t),n=j({...e,valuePath:"max"},t);if(!(a==null&&n==null))return Pi(e,t)}getString(e,t){return it(e,t)}toXlsxValue({valuePath:e},t){return w(t,e)}getComparableValue(e,t){return j(e,t)}serializeFilter(e,t){if(t==null)return;const a=L(t.min),n=L(t.max);if(!(a==null&&n==null))return tt(a)+"~"+tt(n)}deserializeFilter(e,t){if(t==null||t==="")return null;const a=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(a)?{min:L(a[1]),max:L(a[2])}:null}renderCell(e,{item:t}){return m`<div class="omnitable-cell-number">
			...
			@change=${o=>a(o.target.value)}
			.value=${Ri(e,t)}
		></cosmoz-input>`}renderHeader({title:e,min:t,max:a,limits:n,locale:o,maximumFractionDigits:r,minimumFractionDigits:l,autoupdate:u},{filter:s},c,d){return m`<cosmoz-omnitable-number-range-input
			.title=${e}
			.filter=${s}
			.values=${d}
			.min=${t}
		...
		></cosmoz-omnitable-number-range-input>`}computeSource(e,t){return ne(e,t)}}customElements.define("cosmoz-omnitable-column-number",qa);const Lt="1970-01-01",B=(i,e,t)=>{const a=typeof i=="string"&&i.length>3&&i.length<=9?Je(Lt+"T"+i):i;return I(a)},me={},Aa=i=>{const e=i||"";if(me[e])return me[e];const t={hour:"numeric",minute:"numeric",second:"numeric"};return me[e]=new Intl.DateTimeFormat(i||void 0,t),me[e]},xe=({valuePath:i,locale:e},t)=>{const a=B(w(t,i||""));return a===void 0?"":a===null?"Invalid Date":Xe(a,Aa(e))},Fa=(i,e)=>i.valuePath?xe(i,e):"",ka=i=>{const e=B(i);if(e==null)return null;const t=we(e);return t&&t.slice(11,19)},K=({valuePath:i},e)=>{if(e==null)return;const t=ka(i==null?e:w(e,i));if(t==null)return;const a=B(Je(Lt+"T"+t));return a==null?a:L(a.getTime())},_a=(i,e)=>t=>{const a=K(i,t);if(a==null)return!1;const n=K({...i,valuePath:"min"},e),o=K({...i,valuePath:"max"},e);return n==null||o==null?!1:!(a<n||a>o)},gt=i=>{const e=B(i);return e==null?"":e.toISOString().slice(11,19).replace(/:/gu,".")},bt=i=>{if(!(i==null||i===""))return B(typeof i=="string"?i.replace(/\./gu,":")+"Z":i)};class Ea extends Ke(oe(E)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return m`
			<cosmoz-clear-button
				@click=${()=>this.resetFilter()}
				?visible=${this.hasFilter()}
			></cosmoz-clear-button>
...
`,Pn=i=>i?"groupRow groupRow-folded":"groupRow",Bn=({item:i,index:e})=>t=>_(t?.length>0,()=>m`
	...
	`,Gn=({onCheckboxChange:i,dataIsValid:e,groupOnColumn:t})=>(a,n,{selected:o,folded:r,toggleFold:l})=>m` <div
		...
		</div>`,Wn=({host:i,error:e,dataIsValid:t,processedItems:a,columns:n,collapsedColumns:o,miniColumns:r,sortAndGroupOptions:l,rowPartFn:u,...s})=>{const{loading:c=!1,displayEmptyGroups:d=!1,compareItemsFn:b}=i,p=He({shiftKey:!1,ctrlKey:!1}),x=C(g=>{const A=g.target.dataItem,f=g.target.checked;p.current.shiftKey?i.shadowRoot.querySelector("#groupedList").toggleSelectTo(A,f):p.current.ctrlKey?(g.target.checked=!0,i.shadowRoot.querySelector("#groupedList").selectOnly(A)):i.shadowRoot.querySelector("#groupedList").toggleSelect(A,f),g.preventDefault(),g.stopPropagation()},[]);M(()=>{const g=({shiftKey:A,ctrlKey:f})=>{p.current={shiftKey:A,ctrlKey:f}};return window.addEventListener("keydown",g),window.addEventListener("keyup",g),()=>{window.removeEventListener("keydown",g),window.removeEventListener("keyup",g)}},[]);const h=C(g=>{const A=g.composedPath();A.slice(0,A.indexOf(g.currentTarget)).find(v=>v.matches?.("a, .checkbox, .expand"))||i.dispatchEvent(new window.CustomEvent("omnitable-item-click",{bubbles:!0,composed:!0,detail:{item:g.currentTarget.dataItem,index:g.currentTarget.dataIndex}}))},[]),{groupOnColumn:$}=l,k=C((g,A)=>f=>Oi(i,g,A,f),[]);return{...s,processedItems:a,dataIsValid:t,filterIsTooStrict:t&&a.length<1,loading:c,compareItemsFn:b,displayEmptyGroups:d,error:e,renderItem:F(()=>Hn({columns:n,collapsedColumns:o,miniColumns:r,onItemClick:h,onCheckboxChange:x,dataIsValid:t,groupOnColumn:$,onItemChange:k,rowPartFn:u}),[n,o,h,x,t,$,k,u]),renderGroup:F(()=>Gn({onCheckboxChange:x,dataIsValid:t,groupOnColumn:$}),[x,t,$])}},jn=(i,e)=>{if(i===e)return 0;if(i==null)return-1;if(e==null)return 1;const t=typeof i,a=typeof e;return t==="object"&&a==="object"?i.toString()<e.toString()?-1:1:t==="number"&&a==="number"?i-e:t==="string"&&a==="string"?i<e?-1:1:t==="boolean"&&a==="boolean"?i?-1:1:(console.warn("unsupported sort",t,i,a,e),0)},Ie=(i,e)=>(t,a)=>jn(i(t),i(a))*(e?-1:1),Un=i=>i.replace(/([a-z0-9])([A-Z])/gu,"$1-$2").toLowerCase(),xt=(i,e)=>{!i||!e||Object.entries(e).forEach(([t,a])=>{i[R].__ownChange=!0,i[R][t]=a,i[R].__ownChange=!1,i[R].dispatchEvent(new CustomEvent(`${Un(t)}-changed`,{bubbles:!0,detail:{value:a}}))})},Me=(i,e)=>Object.assign(i,{[ve]:e}),he=Symbol("unparsed"),Kn=({data:i,columns:e,hashParam:t,sortAndGroupOptions:a,noLocalSort:n,noLocalFilter:o})=>{const{groupOnColumn:r,groupOnDescending:l,sortOnColumn:u,descending:s}=a,c=C(([f,v])=>{const y=e.find(({name:S})=>S===f);return y==null?[f,void 0]:[f,v.filter&&y.serializeFilter(y,v.filter)]},[e]),d=C(([f,v])=>{const y=e.find(({name:z})=>z===f);if(y==null)return[f,{[he]:v}];const S={filter:y.deserializeFilter(y,v)};return xt(y,S),[f,S]},[e]),[b,p]=Q({},t,{multi:!0,suffix:"-filter--",write:c,read:d}),x=C((f,v)=>p(y=>{const S=Ce(v,y[f]);return xt(e.find(z=>z.name===f),S),{...y,[f]:{...y[f],...S}}}),[e,p]),h=F(()=>Object.values(b).map(f=>f.filter),[b]),$=F(()=>Object.fromEntries(e.map(f=>[f.name,!f.noLocalFilter&&f.getFilterFn(f,b[f.name]?.filter)]).filter(([,f])=>!!f)),[e,...h]),k=F(()=>!Array.isArray(i)||i.length===0?[]:Object.entries($).length===0||o?i.slice():i.filter(f=>Object.values($).every(v=>v(f))),[i,$,o]),g=F(()=>{if(!n&&!r&&u!=null&&u.sortOn!=null)return k.slice().sort(Ie(f=>u.getComparableValue({...u,valuePath:u.sortOn},f),s));if(r!=null&&r.groupOn!=null){const f=k.reduce((v,y)=>{const S=r.getComparableValue({...r,valuePath:r.groupOn},y);if(S===void 0)return v;let z=v.find(T=>T.id===S);return z?(z.items.push(y),v):(z={id:S,name:S,items:[y]},[...v,z])},[]);return f.sort(Ie(v=>r.getComparableValue({...r,valuePath:r.groupOn},v.items[0]),l)),!u||n?f:f.filter(v=>Array.isArray(v.items)).map(v=>(v.items.sort(Ie(y=>u.getComparableValue({...u,valuePath:u.sortOn},y),s)),v))}return k},[k,r,l,u,s,n]),A=F(()=>{let f=0,v=0;const y=[];return g.forEach(S=>{if(Array.isArray(S.items)){Me(S,v++),S.items.forEach(z=>{Me(z,f++),y.push(z)});return}return Me(S,f++),y.push(S)},[]),y},[g]);return M(()=>{p(f=>Object.values(f).some(y=>y[he]!=null)?Object.fromEntries(Object.entries(f).map(([y,S])=>S[he]==null?[y,S]:d([y,S[he]]))):f)},[d]),{processedItems:g,visibleData:A,filters:b,filterFunctions:$,setFilterState:x}},Jn=i=>{const e=a=>{const n=i.data.indexOf(a);if(n<0)return null;const o=i.data.splice(n,1);if(i.data=i.data.slice(),Array.isArray(o)&&o.length>0)return o[0]},t=(a,n)=>{i.data.splice(a,1,n),i.data=i.data.slice()};return{removeItem:e,removeItems(a){const n=[];for(let o=a.length-1;o>=0;o-=1){const r=i.removeItem(a[o]);r!=null&&n.push(r)}return n},replaceItemAtIndex:t,replaceItem(a,n){const o=i.data.indexOf(a);if(o>-1)return t(o,n)},selectItem(a){i.shadowRoot.querySelector("#groupedList").select(a)},selectAll(){i.shadowRoot.querySelector("#groupedList").selectAll()},deselectAll(){i.shadowRoot.querySelector("#groupedList").deselectAll()},deselectItem(a){i.shadowRoot.querySelector("#groupedList").deselect(a)},isItemSelected(a){return i.shadowRoot.querySelector("#groupedList").isItemSelected(a)}}},Xn=({host:i,visibleData:e,filters:t,...a})=>{const{setFilterState:n}=a,o=F(()=>Jn(i),[]);De(a,Object.values(a)),De(o,Object.values(o)),M(()=>{const l=u=>n(u.detail.name,s=>({...s,...u.detail.state}));return i.addEventListener("legacy-filter-changed",l),()=>i.removeEventListener("legacy-filter-changed",l)},[]),P("visibleData",e),P("sortedFilteredGroupedItems",a.sortedFilteredGroupedItems),P("selectedItems",a.selectedItems),P("sortOn",a.sortOn),P("descending",a.descending),P("isMini",a.isMini);const r=F(()=>Object.fromEntries(Object.entries(t).filter(([,{filter:l}])=>l!==void 0).map(([l,{filter:u}])=>[l,u])),[t]);P("filters",r,Object.values(r))},Qn=i=>{const{hashParam:e,settingsId:t,data:a,resizeSpeedFactor:n,noLocal:o,noLocalSort:r=o,noLocalFilter:l=o,error:u,rowPartFn:s}=i,c=$n({settingsId:t,host:i}),{settings:d,setSettings:b,columns:p,resetRef:x}=c,h=Ha(p,e,d,b,x),{processedItems:$,visibleData:k,filters:g,setFilterState:A,filterFunctions:f}=Kn({data:a,columns:p,hashParam:e,sortAndGroupOptions:h,noLocalSort:r,noLocalFilter:l}),{isMini:v,collapsedColumns:y,miniColumns:S}=Vn({host:i,columns:p,settings:d,setSettings:b,resizeSpeedFactor:n,sortAndGroupOptions:h}),z=a&&Array.isArray(a)&&a.length>0,[T,H]=V([]);return Xn({host:i,visibleData:k,sortedFilteredGroupedItems:$,columns:p,filters:g,setFilterState:A,selectedItems:T,isMini:v,...h}),{header:Nn({host:i,selectedItems:T,sortAndGroupOptions:h,dataIsValid:z,data:a,columns:p,filters:g,collapsedColumns:y,settings:d,filterFunctions:f,settingS:c,setFilterState:A,hideSelectAll:i.hideSelectAll===!0}),list:Wn({host:i,error:u,dataIsValid:z,processedItems:$,setSelectedItems:H,columns:p,collapsedColumns:y,miniColumns:S,sortAndGroupOptions:h,rowPartFn:s}),footer:Rn({host:i,selectedItems:T,columns:p})}};customElements.define("cosmoz-grouped-list-row",class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||Oe(this._renderFn(this._item,this._index),this)}});const Yn={group:Symbol("group")},Fe=(i,e)=>(e.has(i)||e.set(i,{}),e.get(i)),Zn=(i,e)=>!!Fe(i,e).expanded,eo=(i,e)=>!!Fe(i,e).folded,Te=i=>i?i.items instanceof Array:!1,to=i=>{if(!Array.isArray(i)||i.length===0)return;const e=Array.isArray(i[0]?.items);if(!i.every(a=>Array.isArray(a.items)===e))throw new Error("Data must be homogeneous.")},io=(i,e,t)=>Array.isArray(i)?(to(i),i.reduce((n,o)=>{const r=o;return r.items?r.items.length?Fe(o,t).folded?n.concat(o):n.concat(o,r.items.map(l=>Object.assign(l,{[Yn.group]:o}))):e?n.concat(o):n:n.concat(o)},[])):void 0,ao=(i,...e)=>typeof i=="function"?i(...e):i,no=(i,e)=>i===e,oo=()=>{const[i,e]=V(()=>[new WeakMap]);return{setItemState:C((a,n)=>e(([o])=>{const r=Fe(a,o);return Object.assign(r,ao(n,r)),[o]}),[]),state:i[0],signal:i}},ro=()=>{const{setItemState:i,state:e,signal:t}=oo(),a=C((o,r)=>{Te(o)&&i(o,l=>({folded:r!==void 0?r:!l.folded}))},[]),n=C((o,r)=>{Te(o)||i(o,l=>({expanded:r!==void 0?!r:!l.expanded}))},[]);return{state:e,signal:t,toggleFold:a,toggleCollapse:n}},lo=({initial:i,compareItemsFn:e,data:t,flatData:a})=>{const[n,o]=V(i),[r,l]=V(),u=C(g=>n.includes(g),[n]),s=C(g=>g?.items?.every(u)??!1,[u]),c=C(g=>u(g)||s(g),[u,s]),d=C(g=>{const f=g.items??[g];o(v=>[...v,...f.filter(y=>!v.includes(y))]),l(g)},[]),b=C(g=>{const f=g.items??[g];o(v=>v.filter(y=>!f.includes(y))),l(g)},[]),p=C(g=>{o(g.items?.slice()||[g]),l(g)},[]),x=C(()=>{o(t.flatMap(g=>g.items||g)),l(void 0)},[t]),h=C(()=>{o([]),l(void 0)},[]),$=C((g,A=!c(g))=>A?d(g):b(g),[c]),k=C((g,A)=>{if(!a)return;const f=r?a.findIndex(S=>e(S,r)):-1;if(f<0)return $(g,A);const[v,y]=[f,a.indexOf(g)].sort((S,z)=>S-z);a.slice(v,y+1).forEach((S,z,T)=>{z>0&&z<T.length-1&&Te(S)||$(S,A)}),l(g)},[a,e,$]);return M(()=>o(g=>g.length>0&&a?a.filter(A=>g.find(f=>e(A,f))):g),[a]),{selectedItems:n,isItemSelected:u,isGroupSelected:s,isSelected:c,select:d,deselect:b,selectOnly:p,selectAll:x,deselectAll:h,toggleSelect:$,toggleSelectTo:k}},so={host:{position:"relative",display:"flex",flexDirection:"column"}},uo=i=>{const{data:e,renderItem:t,renderGroup:a,displayEmptyGroups:n,compareItemsFn:o=no}=i,{toggleFold:r,toggleCollapse:l,state:u,signal:s}=ro(),c=F(()=>io(e,n,u),[e,n,s]),{selectedItems:d,isItemSelected:b,isGroupSelected:p,isSelected:x,select:h,deselect:$,selectOnly:k,selectAll:g,deselectAll:A,toggleSelect:f,toggleSelectTo:v}=lo({initial:[],compareItemsFn:o,data:e,flatData:c}),y=C((z,T)=>Array.isArray(z.items)?a(z,T,{selected:p(z),folded:eo(z,u),toggleSelect:H=>f(z,typeof H=="boolean"?H:void 0),toggleFold:()=>r(z)}):t(z,T,{selected:d.includes(z),expanded:Zn(z,u),toggleSelect:H=>f(z,typeof H=="boolean"?H:void 0),toggleCollapse:()=>l(z)}),[t,a,d,f,s]);vt(()=>{Object.assign(i.style,so.host)},[]),P("selectedItems",d);const S={toggleFold:r,toggleCollapse:l,isItemSelected:b,isGroupSelected:p,isSelected:x,select:h,deselect:$,selectOnly:k,selectAll:g,deselectAll:A,toggleSelect:f,toggleSelectTo:v};return De(S,Object.values(S)),{renderRow:y,flatData:c}},co=({renderRow:i,flatData:e})=>pi({items:e,renderItem:(t,a)=>m`<cosmoz-grouped-list-row
				.item=${t}
				.index=${a}
				.renderFn=${i}
	...
	`};customElements.define("cosmoz-omnitable",class extends O(go,{observedAttributes:["hash-param","sort-on","group-on","descending","group-on-descending","hide-select-all","settings-id","no-local","no-local-sort","no-local-filter","loading","mini-breakpoint"]}){connectedCallback(){super.connectedCallback(),ke(this,"selectedItems",[]),ke(this,"visibleData",[]),ke(this,"sortedFilteredGroupedItems",[])}});const $e=`
