import{x as c,B as _e,E as Le}from"./iframe-Cl57MTEj.js";import{t as K,c as O,g as C,P as I,u as T,a as ht,m as xt,s as Vt,D as Pt,b as Nt,e as Rt,i as $e,h as Oe,o as ie,d as A,f as Bt,j as we,p as he,n as _,k as Gt,l as Ce,q as Ht,r as jt,v as Wt,T as Ut,w as Kt,x as M,y as Jt,z as Xt,A as Qt,B as $,C as Yt,E as Zt,F as vt,G as De,H as F,I as yt,J as Te,K as ei,L as $t,N as ti,M as ii,O as Ve,Q as ai,R as Pe,S as ni,U as oi,V as Ee,W as Ne,X as ri,Y as Ie,Z as N,_ as li,$ as ze,a0 as si}from"./cosmoz-collapse-zXwYfyZk.js";import"./preload-helper-PPVm8Dsz.js";const ui=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`;customElements.define("cosmoz-clear-button",O(di));const U=({valuePath:i},e)=>C(e,i),ci=U,mi=U,pi=({valuePath:i},e)=>t=>{const a=C(t,i);return a==null?!1:a.toString().toLowerCase().trim().includes(e.toLowerCase().trim())},gi=(i,e)=>e===""||e==null?null:e,V=i=>class extends i{static get properties(){return{isOmnitableColumn:{type:Boolean,value:!0},title:{type:String},valuePath:{type:String,notify:!0},values:{type:Array,notify:!0},filter:{type:Object},noLocalFilter:{type:Boolean},disabled:{type:Boolean,value:!1,notify:!0},editable:{type:Boolean,notify:!0},loading:{type:Boolean,value:!1,notify:!0},externalValues:{type:Boolean,value:!1,notify:!0},name:{type:String},sortOn:{type:String},groupOn:{type:String},width:{type:String,value:"75px"},minWidth:{type:String,value:"40px"},flex:{type:String,value:"1"},cellClass:{type:String,value:"default-cell"},headerCellClass:{type:String,value:"default-header-cell"},priority:{type:Number,value:0},hidden:{type:Boolean,notify:!0},preferredDropdownHorizontalAlign:{type:String,value:"right"},renderHeader:{type:Function},renderCell:{type:Function},renderEditCell:{type:Function},renderGroup:{type:Function},mini:{type:Number,value:null},renderMini:{type:Function}}}static get observers(){return["notifyFilterChange(filter)"]}notifyFilterChange(e){this.__ownChange||this.dispatchEvent(new CustomEvent("legacy-filter-changed",{detail:{name:this.name,state:this.legacyFilterToState(e)},bubbles:!0}))}legacyFilterToState(e){return{filter:e}}getFilterFn(){}getString(e,t){return U(e,t)}toXlsxValue(e,t){return ci(e,t)}cellTitleFn(e,t){return this.getString(e,t)}headerTitleFn(e){return e.title}serializeFilter(e,t){return gi(e,t)}deserializeFilter(e,t){return t==null?null:typeof t=="string"?window.decodeURIComponent(t):t}getComparableValue(e,t){return mi(e,t)}computeSource(e,t){return t}_propertiesChanged(e,t,a){super._propertiesChanged(e,t,a),this.dispatchEvent(new CustomEvent("cosmoz-column-prop-changed",{bubbles:!0}))}},bi=i=>e=>i(t=>{if(t.inputValue===void 0&&e.target.value==="")return t;clearTimeout(t.t);const a=setTimeout(()=>i(n=>({...n,filter:n.inputValue})),1e3);return{...t,inputValue:e.target.value,t:a}}),fi=i=>()=>i(e=>({...e,filter:e.inputValue})),hi=i=>e=>{e.keyCode===13&&(e.preventDefault(),i(t=>({...t,filter:t.inputValue})))},xi=i=>e=>i(t=>({...t,headerFocused:e.detail.value})),vi=i=>()=>i(e=>({...e,filter:null,inputValue:null})),yi=i=>i!=null&&i!=="";class $i extends V(I){static get properties(){return{minWidth:{type:String,value:"55px"},editMinWidth:{type:String,value:"55px"},inputValue:{type:Object,notify:!0}}}getFilterFn(e,t){if(!(t==null||t===""))return pi(e,t)}renderCell(e,{item:t}){return c`<span class="default-column">${U(e,t)}</span>`}renderEditCell(e,{item:t},a){return c`<cosmoz-input
		...
		>`}getComparableValue(e,t){return Hi(e,t)}}customElements.define("cosmoz-omnitable-column-autocomplete",ji);const Ke=(i,e)=>e.find(({value:t})=>i===t),Wi=(i,e,t)=>{const a=Ke(e,t);return a?a.text:i},nt=(i,e,t,a)=>Wi(i,C(e,t),a),Ui=({valuePath:i},e,t)=>Ke(C(e,i),t),Ki=i=>e=>{i(t=>({...t,filter:e?.[0]?.value??null}))},Ji=i=>e=>{i(t=>({...t,headerFocused:e}))},Xi=i=>e=>{i(t=>({...t,query:e}))},Qi=i=>e=>i(e?.[0]?.value),ot=({valuePath:i,trueLabel:e,falseLabel:t},a)=>C(a,i)?e:t,Yi=({valuePath:i},e)=>t=>C(t,i)===e,le=xt((i,e)=>[{text:i,value:!0},{text:e,value:!1}]),Zi=({valuePath:i,trueLabel:e,falseLabel:t},a)=>i?C(a,i)?e:t:"",ea=(i,e)=>{try{return JSON.parse(e)}catch{return null}};class ta extends V(I){static get properties(){return{trueLabel:{type:String,value:"True"},falseLabel:{type:String,value:"False"},flex:{type:String,value:"0"},cellClass:{type:String,value:"boolean-cell"}}}getString(e,t){return ot(e,t)}renderCell(e,{item:t}){return ot(e,t)}renderEditCell(e,{item:t},a){const{trueLabel:n,falseLabel:o}=e;return c`<cosmoz-autocomplete
			no-label-float
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return ae(e,t)}}customElements.define("cosmoz-omnitable-column-date",la);class sa extends Ue(V(I)){renderCell({valuePath:e,textProperty:t},{item:a}){const n=Be(a,e,t).map(o=>c`<li>${o}</li>`);return c`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		`}renderEditCell(){return"not implemented"}renderHeader(e,{filter:t,query:a},n,o){return c`<cosmoz-autocomplete-ui
			...
			.onText=${We(n)}
			>${_(e.loading,()=>c`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}}customElements.define("cosmoz-omnitable-column-list-horizontal",sa);window.Cosmoz=window.Cosmoz||{};class st extends jt(Wt(Ut,I)){static get template(){return Oe`
			<style>
				:host {
					display: block;
				}
		...
		`}static get is(){return"cosmoz-omnitable-column-list-data"}static get properties(){return{items:{type:Array},_expanded:{type:Boolean,value:!1},_othersCount:{type:Number,computed:"_computeOthersCount(items)"}}}static get observers(){return["_itemsLengthChanged(items.length)"]}_itemsLengthChanged(){requestAnimationFrame(()=>this.dispatchEvent(new CustomEvent("expand",{bubbles:!0})))}_firstItem(e){if(e!=null&&e.length>0)return e[0]}_hideExpand(e,t){return e!==void 0&&e.length!==null?e.length<=2||t:!0}_hideCollapse(e,t){return e!==void 0&&e.length!==null?e.length<=2||!t:!0}_otherItems(e,t){if(e!=null&&(e.length<=2||t))return e.slice(1)}_computeOthersCount(e){if(e!=null)return e.length-1}_toggleExpand(e){this._expanded=!this._expanded,e.stopPropagation(),e.preventDefault()}}customElements.define(st.is,st);class ua extends Ue(V(I)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:a}){return c`<cosmoz-omnitable-column-list-data
			.items=${Be(a,e,t)}
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:a},n,o){return c`<cosmoz-autocomplete-ui
			...
			.onText=${We(n)}
			>${_(e.loading,()=>c`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}}customElements.define("cosmoz-omnitable-column-list",ua);const da=({title:i,tooltip:e="",filterText:t="",headerFocused:a=!1,onOpenedChanged:n,content:o,horizontalAlign:r="left",externalValues:l=null})=>{const s={focused:a,filtered:!!t,left:r==="left",right:r==="right",center:r==="center",...l!=null&&{[`external-values-${l}`]:!0}};return c`
		<style>
			.dropdown-content h3 {
				font-weight: 500;
				font-size: 13px;
	...
	`};class ca extends Re(ne(I)){static get properties(){return{maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null},formatter:{type:Object,computed:"_computeFormatter(locale, minimumFractionDigits, maximumFractionDigits)"},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, formatter)"},headerFocused:{type:Boolean,value:!1}}}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return c`
			<style>
				cosmoz-input[type='number'] {
					background: var(--cosmoz-omnitable-amount-input-background, #ffffff);
					border-radius: 6px;
			...
			${da({title:this.title,tooltip:this._tooltip,filterText:this._filterText,headerFocused:this.headerFocused,horizontalAlign:"right",externalValues:this.externalValues,onOpenedChanged:e,content:c`
					<h3>${this.title}</h3>
					<cosmoz-input
						class=${this._fromClasses}
						type="number"
