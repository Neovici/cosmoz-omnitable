import{x as d,B as _e,E as De}from"./iframe-VwaSW24Z.js";import{t as K,c as T,g as C,P as A,u as M,a as bt,m as xt,s as Nt,D as jt,b as Pt,e as Bt,i as xe,h as Ve,o as Ae,d as _,f as Gt,j as ve,p as ge,n as D,k as Ht,l as ye,q as Wt,r as qt,v as Xt,w as Ut,T as Kt,x as E,y as Jt,z as Yt,A as Qt,B as $,C as Zt,E as en,F as vt,G as Ee,H as I,I as yt,J as Te,K as tn,L as $t,N as nn,M as on,O as Le,Q as rn,R as Re,S as an,U as ln,V as Ie,W as Me,X as sn,Y as Fe,Z as P,_ as un,$ as we,a0 as cn}from"./cosmoz-collapse-DlvlgFj8.js";import"./preload-helper-PPVm8Dsz.js";const dn=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`;customElements.define("cosmoz-clear-button",T(mn));const U=({valuePath:n},e)=>C(e,n),pn=U,gn=U,hn=({valuePath:n},e)=>t=>{const o=C(t,n);return o==null?!1:o.toString().toLowerCase().trim().includes(e.toLowerCase().trim())},fn=(n,e)=>e===""||e==null?null:e,N=n=>class extends n{static get properties(){return{isOmnitableColumn:{type:Boolean,value:!0},title:{type:String},valuePath:{type:String,notify:!0},values:{type:Array,notify:!0},filter:{type:Object},noLocalFilter:{type:Boolean},disabled:{type:Boolean,value:!1,notify:!0},editable:{type:Boolean,notify:!0},loading:{type:Boolean,value:!1,notify:!0},externalValues:{type:Boolean,value:!1,notify:!0},name:{type:String},sortOn:{type:String},groupOn:{type:String},width:{type:String,value:"75px"},minWidth:{type:String,value:"40px"},flex:{type:String,value:"1"},cellClass:{type:String,value:"default-cell"},headerCellClass:{type:String,value:"default-header-cell"},priority:{type:Number,value:0},hidden:{type:Boolean,notify:!0},preferredDropdownHorizontalAlign:{type:String,value:"right"},renderHeader:{type:Function},renderCell:{type:Function},renderEditCell:{type:Function},renderGroup:{type:Function},mini:{type:Number,value:null},renderMini:{type:Function}}}static get observers(){return["notifyFilterChange(filter)"]}notifyFilterChange(e){this.__ownChange||this.dispatchEvent(new CustomEvent("legacy-filter-changed",{detail:{name:this.name,state:this.legacyFilterToState(e)},bubbles:!0}))}legacyFilterToState(e){return{filter:e}}getFilterFn(){}getString(e,t){return U(e,t)}toXlsxValue(e,t){return pn(e,t)}cellTitleFn(e,t){return this.getString(e,t)}headerTitleFn(e){return e.title}serializeFilter(e,t){return fn(e,t)}deserializeFilter(e,t){return t==null?null:typeof t=="string"?window.decodeURIComponent(t):t}getComparableValue(e,t){return gn(e,t)}computeSource(e,t){return t}_propertiesChanged(e,t,o){super._propertiesChanged(e,t,o),this.dispatchEvent(new CustomEvent("cosmoz-column-prop-changed",{bubbles:!0}))}},bn=n=>e=>n(t=>{if(t.inputValue===void 0&&e.target.value==="")return t;clearTimeout(t.t);const o=setTimeout(()=>n(r=>({...r,filter:r.inputValue})),1e3);return{...t,inputValue:e.target.value,t:o}}),xn=n=>()=>n(e=>({...e,filter:e.inputValue})),vn=n=>e=>{e.keyCode===13&&(e.preventDefault(),n(t=>({...t,filter:t.inputValue})))},yn=n=>e=>n(t=>({...t,headerFocused:e.detail.value})),$n=n=>()=>n(e=>({...e,filter:null,inputValue:null})),wn=n=>n!=null&&n!=="";class zn extends N(A){static get properties(){return{minWidth:{type:String,value:"55px"},editMinWidth:{type:String,value:"55px"},inputValue:{type:Object,notify:!0}}}getFilterFn(e,t){if(!(t==null||t===""))return hn(e,t)}renderCell(e,{item:t}){return d`<span class="default-column">${U(e,t)}</span>`}renderEditCell(e,{item:t},o){return d`<cosmoz-input
			no-label-float
			type="text"
		...
		>
			...
			<paper-dropdown-menu
				label=${this.title}
				placeholder=${Ae(this._filterText)}
		...
		></cosmoz-omnitable-amount-range-input>`}computeSource(e,t){return Q(e,t)}}customElements.define("cosmoz-omnitable-column-amount",jn);const Pn=(n,e)=>{if(!Array.isArray(n))return;const t=[];return n.reduce((o,r)=>Array.isArray(r)?(r.forEach(i=>{o.push(i)}),o):(o.push(r),o),[]).filter((o,r,i)=>{if(i.indexOf(o)!==r)return!1;if(e){const a=C(o,e);if(t.indexOf(a)!==-1)return!1;t.push(a)}return!0})},Bn=(n,e,t)=>{if(n==null)return[];if(Array.isArray(n))return Pn(n,e);if(typeof n=="object"){const o=e??"id",r=t??"label";return Object.entries(n).map(([i,a])=>({[o]:i,[r]:a})).sort((i,a)=>i[r]<a[r]?-1:i[r]>a[r]?1:0)}return[]},je=(n,e,t)=>ve(e&&C(n,e)).map(ge(t)),Pe=({valuePath:n,textProperty:e},t)=>je(t,n,e).filter(o=>o!=null).join(", "),Gn=Pe,Hn=({valueProperty:n,valuePath:e,emptyValue:t,emptyProperty:o},r)=>i=>{const a=ge(n),l=ve(C(i,e));return r.some(s=>l.length===0&&ge(o||n)(s)===t||l.some(u=>a(u)===a(s)))},Be=n=>e=>n(t=>({...t,filter:e})),Ge=n=>e=>n(t=>({...t,headerFocused:e})),He=n=>e=>n(t=>({...t,query:e})),St=({emptyValue:n,emptyLabel:e,emptyProperty:t,textProperty:o,valueProperty:r},i)=>{const a=Bn(i,r,o);return!e||n===void 0||!o||!(t||r)||!a?a:[{[o]:e,[t||r]:n},...a]},Wn=(n,e)=>St(n,wt(e,n.valuePath)),We=n=>class extends n{static get properties(){return{textProperty:{type:String},valueProperty:{type:String},emptyLabel:{type:String},emptyValue:{type:Object},emptyProperty:{type:String}}}getConfig(e){return{emptyProperty:e.emptyProperty}}getString(e,t){return Pe(e,t)}toXlsxValue(e,t){return Gn(e,t)}getComparableValue({valuePath:e,valueProperty:t},o){const r=C(o,e);return t==null?r:ve(r).reduce((a,l)=>(a.push(C(l,t)),a),[]).sort().join(" ")}getFilterFn(e,t){if(!(!t||!Array.isArray(t)||t.length===0))return Hn(e,t)}serializeFilter(e,t){return t.length===0?null:JSON.stringify(t)}deserializeFilter(e,t){return JSON.parse(decodeURIComponent(t))}computeSource(e,t){return e.externalValues||typeof e.values=="function"?async(...o)=>St(e,await Promise.resolve(xe(e.values,...o))):Wn(e,t)}},qn=({valuePath:n,textProperty:e,valueProperty:t},o)=>{const r=e?Ht(e):ge(t),i=ve(n&&C(o,n)).map(r);return i.length>1?i.filter(Boolean).join(","):i[0]};class Xn extends We(N(A)){static get properties(){return{headerCellClass:{type:String,value:"autocomplete-header-cell"},minWidth:{type:String,value:"55px"},editMinWidth:{type:String,value:"55px"},keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},showSingle:{type:Boolean},preserveOrder:{type:Boolean},limit:{type:Number},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,showSingle:e.showSingle,preserveOrder:e.preserveOrder,limit:e.limit,textual:e.textual}}renderCell(e,{item:t}){return d`<span class="default-column"
		...
		>`}getComparableValue(e,t){return qn(e,t)}}customElements.define("cosmoz-omnitable-column-autocomplete",Xn);const qe=(n,e)=>e.find(({value:t})=>n===t),Un=(n,e,t)=>{const o=qe(e,t);return o?o.text:n},ot=(n,e,t,o)=>Un(n,C(e,t),o),Kn=({valuePath:n},e,t)=>qe(C(e,n),t),Jn=n=>e=>{n(t=>({...t,filter:e?.[0]?.value??null}))},Yn=n=>e=>{n(t=>({...t,headerFocused:e}))},Qn=n=>e=>{n(t=>({...t,query:e}))},Zn=n=>e=>n(e?.[0]?.value),rt=({valuePath:n,trueLabel:e,falseLabel:t},o)=>C(o,n)?e:t,eo=({valuePath:n},e)=>t=>C(t,n)===e,te=xt((n,e)=>[{text:n,value:!0},{text:e,value:!1}]),to=({valuePath:n,trueLabel:e,falseLabel:t},o)=>n?C(o,n)?e:t:"",no=(n,e)=>{try{return JSON.parse(e)}catch{return null}};class oo extends N(A){static get properties(){return{trueLabel:{type:String,value:"True"},falseLabel:{type:String,value:"False"},flex:{type:String,value:"0"},cellClass:{type:String,value:"boolean-cell"}}}getString(e,t){return rt(e,t)}renderCell(e,{item:t}){return rt(e,t)}renderEditCell(e,{item:t},o){const{trueLabel:r,falseLabel:i}=e;return d`<cosmoz-autocomplete
			no-label-float
			.title=${ot(e.title,t,e.valuePath,te(r,i))}
			.source=${te(r,i)}
			.textProperty=${"text"}
			.value=${Kn(e,t,te(r,i))}
			.onChange=${Zn(o)}
		...
		>
			...
			${t?d`<div slot="button" class="filter-value">${t}</div>`:De}

			<div class="dropdown-content" @mousedown=${u=>u.stopPropagation()}>
				${i}
			</div>
		</cosmoz-dropdown>
	`};class ro extends Xe(Z(A)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return d`
			<style>
			...
			${Ue({title:this.title,tooltip:this._tooltip,filterText:this._filterText,headerFocused:this.headerFocused,horizontalAlign:"right",externalValues:this.externalValues,onOpenedChanged:e,content:d`
					<h3 style="margin: 0;">${this.title}</h3>
					<cosmoz-input
						type="date"
						label=${_("From date")}
					...
					></cosmoz-input>
				`})}
		`}_fromInputString(e,t){const o=this.toDate(e);if(o!=null)return t==="min"&&o.setHours(0,0,0,0),t==="max"&&o.setHours(23,59,59),o}_filterInputChanged(e,t){const o=e.path.split(".")[1],r=o&&e.value;if(r&&r.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}}customElements.define("cosmoz-omnitable-date-range-input",ro);const io=n=>{const e=-new Date(n).getTimezoneOffset()/60;return(e<0?"-":"+")+["0",Math.abs(e)].join("").substr(-2)+":00"},Ke=n=>n.length===19?n+io(n):n,kt=n=>{if(n==null||n==="")return;let e=n;return!(e instanceof Date)&&(typeof n=="string"&&(e=Ke(e)),e=qt(e),!e)||Number.isNaN(e.getTime())?null:e},j=({valuePath:n},e)=>{if(e==null)return;let t=e;n!=null&&(t=C(e,n));const o=kt(t);if(o!=null)return L(o.getTime())},V=(n,e,t)=>{const o=kt(n);return o??null},Je=(n,e)=>{if(e==null)return;const t=V(n);if(t!=null)return e.format(t)},ne={},ao=n=>{const e=n||"";return ne[e]||(ne[e]=new Intl.DateTimeFormat(n||void 0)),ne[e]},it=({valuePath:n,locale:e},t)=>{let o=C(t,n||"");return o===void 0?"":(o=V(o),o===null?"Invalid Date":Je(o,ao(e)))},_t=n=>{const e=V(n);if(e==null)return null;const t=ye(e);return t==null?null:t.slice(0,10)},lo=({valuePath:n},e)=>_t(C(e,n||"")),It=(n,e)=>{const t=V(n);if(t!=null)return t},at=n=>{const e=_t(n);return e??""},so=({valuePath:n},e)=>{if(!n)return"";const t=V(C(e,n));if(!t)return"";const o=V(ye(t));return o?(o.setHours(0,0,0,0),o):""},Ft=(n,e)=>t=>{const o=j(n,t);if(o==null)return!1;const r=j({...n,valuePath:"min"},e),i=j({...n,valuePath:"max"},e);return!(o<(r??-1/0)||o>(i??1/0))};class uo extends N(A){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"date-header-cell"},width:{type:String,value:"100px"},minWidth:{type:String,value:"82px"},flex:{type:String,value:"0"}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const o=j({...e,valuePath:"min"},t),r=j({...e,valuePath:"max"},t);if(!(o==null&&r==null))return Ft(e,t)}getString(e,t){return it(e,t)}toXlsxValue(e,t){return so(e,t)}getComparableValue(e,t){return j(e,t)}serializeFilter(e,t){if(t==null)return;const o=V(t.min),r=V(t.max);if(!(o==null&&r==null))return at(o)+"~"+at(r)}deserializeFilter(e,t){if(t==null||t==="")return null;const o=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(o)?{min:V(o[1]),max:V(o[2])}:null}renderCell(e,{item:t}){return d`<div class="omnitable-cell-date">
			${it(e,t)}
		</div>`}renderEditCell(e,{item:t},o){return d`<cosmoz-input
			no-label-float
			type="date"
			@change=${i=>o(It(i.target.value))}
			.value=${lo(e,t)}
		...
		></cosmoz-omnitable-date-range-input>`}computeSource(e,t){return Q(e,t)}}customElements.define("cosmoz-omnitable-column-date",uo);class co extends We(N(A)){renderCell({valuePath:e,textProperty:t},{item:o}){const r=je(o,e,t).map(i=>d`<li>${i}</li>`);return d`
			<style>
				ul {
					padding: 0;
					display: inline;
		...
		`}renderEditCell(){return"not implemented"}renderHeader(e,{filter:t,query:o},r,i){return d`<cosmoz-autocomplete-ui
			...
			.onText=${He(r)}
			>${D(e.loading,()=>d`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}}customElements.define("cosmoz-omnitable-column-list-horizontal",co);window.Cosmoz=window.Cosmoz||{};class lt extends Xt(Ut(Kt,A)){static get template(){return Ve`
			<style>
				:host {
					display: block;
				}
		...
		`}static get is(){return"cosmoz-omnitable-column-list-data"}static get properties(){return{items:{type:Array},_expanded:{type:Boolean,value:!1},_othersCount:{type:Number,computed:"_computeOthersCount(items)"}}}static get observers(){return["_itemsLengthChanged(items.length)"]}_itemsLengthChanged(){requestAnimationFrame(()=>this.dispatchEvent(new CustomEvent("expand",{bubbles:!0})))}_firstItem(e){if(e!=null&&e.length>0)return e[0]}_hideExpand(e,t){return e!==void 0&&e.length!==null?e.length<=2||t:!0}_hideCollapse(e,t){return e!==void 0&&e.length!==null?e.length<=2||!t:!0}_otherItems(e,t){if(e!=null&&(e.length<=2||t))return e.slice(1)}_computeOthersCount(e){if(e!=null)return e.length-1}_toggleExpand(e){this._expanded=!this._expanded,e.stopPropagation(),e.preventDefault()}}customElements.define(lt.is,lt);class mo extends We(N(A)){static get properties(){return{keepOpened:{type:Boolean,value:!0},keepQuery:{type:Boolean},textual:{type:Function}}}getConfig(e){return{...super.getConfig?.(e),keepOpened:e.keepOpened,keepQuery:e.keepQuery,textual:e.textual}}renderCell({valuePath:e,textProperty:t},{item:o}){return d`<cosmoz-omnitable-column-list-data
			.items=${je(o,e,t)}
		...
		></cosmoz-input>`}renderHeader(e,{filter:t,query:o},r,i){return d`<cosmoz-autocomplete-ui
			...
			.onText=${He(r)}
			>${D(e.loading,()=>d`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		>`}}customElements.define("cosmoz-omnitable-column-list",mo);class po extends Ne(Z(A)){static get properties(){return{maximumFractionDigits:{type:Number,value:null},minimumFractionDigits:{type:Number,value:null},formatter:{type:Object,computed:"_computeFormatter(locale, minimumFractionDigits, maximumFractionDigits)"},autoupdate:{type:String,value:!1},_filterText:{type:String,computed:"_computeFilterText(filter.*, formatter)"},headerFocused:{type:Boolean,value:!1}}}render(){const e=t=>{this.headerFocused=t.type==="focus",this._onDropdownOpenedChanged(t)};return d`
			<style>
				cosmoz-input[type='number'] {
					background: var(--cosmoz-omnitable-amount-input-background, #ffffff);
					border-radius: 6px;
		...
		></cosmoz-omnitable-number-range-input>`}computeSource(e,t){return Q(e,t)}}customElements.define("cosmoz-omnitable-column-number",go);const Ot="1970-01-01",G=(n,e,t)=>{const o=typeof n=="string"&&n.length>3&&n.length<=9?Ke(Ot+"T"+n):n;return V(o)},oe={},ho=n=>{const e=n||"";if(oe[e])return oe[e];const t={hour:"numeric",minute:"numeric",second:"numeric"};return oe[e]=new Intl.DateTimeFormat(n||void 0,t),oe[e]},pe=({valuePath:n,locale:e},t)=>{const o=G(C(t,n||""));return o===void 0?"":o===null?"Invalid Date":Je(o,ho(e))},fo=(n,e)=>n.valuePath?pe(n,e):"",bo=n=>{const e=G(n);if(e==null)return null;const t=ye(e);return t&&t.slice(11,19)},X=({valuePath:n},e)=>{if(e==null)return;const t=bo(n==null?e:C(e,n));if(t==null)return;const o=G(Ke(Ot+"T"+t));return o==null?o:L(o.getTime())},xo=(n,e)=>t=>{const o=X(n,t);if(o==null)return!1;const r=X({...n,valuePath:"min"},e),i=X({...n,valuePath:"max"},e);return r==null||i==null?!1:!(o<r||o>i)},st=n=>{const e=G(n);return e==null?"":e.toISOString().slice(11,19).replace(/:/gu,".")},ut=n=>{if(!(n==null||n===""))return G(typeof n=="string"?n.replace(/\./gu,":")+"Z":n)};class vo extends Xe(Z(A)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return d`
			<cosmoz-clear-button
				@click=${()=>this.resetFilter()}
				?visible=${this.hasFilter()}
			></cosmoz-clear-button>
		...
		></cosmoz-input>`}renderHeader({title:e,min:t,max:o,locale:r,filterStep:i},{filter:a},l,s){return d`<cosmoz-omnitable-time-range-input
			...
			@filter-changed=${({detail:{value:u}})=>l(c=>({...c,filter:u}))}
			@header-focused-changed=${({detail:{value:u}})=>l(c=>({...c,headerFocused:u}))}
		></cosmoz-omnitable-time-range-input>`}computeSource(e,t){return Q(e,t)}}customElements.define("cosmoz-omnitable-column-time",yo);const re={},$o=n=>{const e=n||"";if(re[e])return re[e];const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return re[e]=new Intl.DateTimeFormat(n||void 0,t),re[e]},ze=({valuePath:n,locale:e},t)=>{const o=V(C(t,n||""));return o===void 0?"":o===null?"Invalid Date":Je(o,$o(e))},wo=({valuePath:n},e)=>n?C(e,n):"",ct=n=>{const e=V(n);return e==null?"":e.toISOString().slice(0,19).replace(/:/gu,".")},dt=n=>{if(!(n==null||n==="")&&typeof n=="string")return V(n.replace(/\./gu,":")+"Z")};class zo extends Xe(Z(A)){render(){return d`
			<style>
				paper-dropdown-menu {
					--iron-icon-width: 0;
					display: block;
		...
		`}_toInputString(e){const t=this.toValue(e);if(t!=null)return this._toLocalISOString(t).slice(0,19)}_computeFormatter(e){const t={year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"numeric"};return new Intl.DateTimeFormat(e||void 0,t)}}customElements.define("cosmoz-omnitable-datetime-range-input",zo);class mt extends N(A){static get is(){return"cosmoz-omnitable-column-datetime"}static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"datetime-header-cell"},width:{type:String,value:"210px"},minWidth:{type:String,value:"128px"},flex:{type:String,value:"0"},filterStep:{type:Number,value:1}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const o=j({...e,valuePath:"min"},t),r=j({...e,valuePath:"max"},t);if(!(o==null&&r==null))return Ft(e,t)}getString(e,t){return ze(e,t)}toXlsxValue(e,t){return wo(e,t)}getComparableValue(e,t){return j(e,t)}serializeFilter(e,t){if(t==null)return;const o=V(t.min),r=V(t.max);if(!(o==null&&r==null))return ct(o)+"~"+ct(r)}deserializeFilter(e,t){if(t==null||t==="")return null;const o=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(o)?{min:dt(o[1]),max:dt(o[2])}:null}renderCell(e,{item:t}){return ze(e,t)}renderEditCell(e,{item:t},o){return d`<cosmoz-input
			no-label-float
			type="text"
			@change=${i=>o(It(i.target.value))}
			.value=${ze(e,t)}
...
>
	...
	/>
		...
		class="sg"
		title=${a}
		data-on=${Ae(i===e&&(t?"desc":"asc")||void 0)}
		@click=${l=>{const s=l.currentTarget?.dataset.on;s||(o(i),r(!1)),s==="asc"?r(!0):s==="desc"&&(o(),r(!1))}}
	>
		<span>${a}</span> ${Io}
	</button>`},Vt=({columns:n,...e})=>n?.map(t=>Dt({column:t,...e})),Fo=()=>d`
...
`,Oo=()=>d`
	<sort-and-group-consumer
		class="sgs"
		.render=${({columns:n,sortOn:e,setSortOn:t,descending:o,setDescending:r}={})=>Vt({columns:n?.filter?.(i=>i.sortOn),on:e,setOn:t,descending:o,setDescending:r})}
	>
	</sort-and-group-consumer>
`,At=n=>(e,t,o=Jt)=>{const r=en(),i=new URLSearchParams(r.hash.replace("#",""));return n(e,t,o,i),"#!"+Object.assign(r,{hash:i}).href.replace(location.origin,"")},Et=n=>n==null||n==="",Do=At((n,e,t,o)=>Et(t(e))?o.delete(n):o.set(n,t(e))),Vo=At((n,e,t,o)=>Object.entries(e).map(t).forEach(([r,i])=>Et(i)?o.delete(n+r):o.set(n+r,i))),J=(n,e,{suffix:t="",read:o,write:r,multi:i}={})=>{const[a,l]=i?[Vo,Yt]:[Do,Qt],[s,u]=M(()=>e==null?n:l(e+t,o)??n),c=$(m=>u(h=>{const p=xe(m,h);return e!=null&&Zt(a(e+t,p,r),null,{notify:!1}),p}),[e,t,a,r]);return[s,c]},Ao=n=>[!0,"true",1,"yes","on"].includes(n),ie=n=>n===""||(n==null?void 0:Ao(n)),ae=(n,e,t)=>$(o=>{n(o),t(r=>({...r,[e]:o}))},[n,e,t]),Eo=(n,e,t,o,r)=>{const[i,a]=J(t.sortOn,e,{suffix:"-sortOn"}),[l,s]=J(ie(t.descending),e,{suffix:"-descending",read:ie}),[u,c]=J(t.groupOn,e,{suffix:"-groupOn"}),[m,h]=J(ie(t.groupOnDescending),e,{suffix:"-groupOnDescending",read:ie}),p=I(()=>n.find(g=>g.name===i),[n,i]),z=I(()=>n.find(g=>g.name===u),[n,u]),b={groupOn:u,setGroupOn:ae(c,"groupOn",o),groupOnDescending:m,setGroupOnDescending:ae(h,"groupOnDescending",o),sortOn:i,setSortOn:ae(a,"sortOn",o),descending:l,setDescending:ae(s,"descending",o),columns:n},y=I(()=>b,Object.values(b)),F=$(g=>{a(g.sortOn),c(g.groupOn),s(g.descending),h(g.groupOnDescending)},[]);return E(()=>void(r.current=F),[]),{...y,sortAndGroup:y,groupOnColumn:z,sortOnColumn:p}},Ye=vt();customElements.define("sort-and-group-provider",Ye.Provider);customElements.define("sort-and-group-consumer",T(({render:n})=>n(Ee(Ye)),{useShadowDOM:!1}));const To=({data:n,columns:e,groupOnColumn:t,filters:o,setFilterState:r,sortAndGroup:{sortOn:i,setSortOn:a,descending:l,setDescending:s}={}})=>yt(e,u=>u.name,u=>[d`<div
			...
			>
				...
				.column="${u}"
				name="${u.name}"
			></cosmoz-omnitable-resize-nub>`]),Lo=({columns:n,settingsConfig:e,hideSelectAll:t,...o})=>{const r=Ee(Ye);return d`
		${D(n,i=>To({columns:i,sortAndGroup:r,...o}))}
		${D(!t,()=>d` <cosmoz-omnitable-settings
					.config=${e}
					part="settings"
				></cosmoz-omnitable-settings>`)}
	`};customElements.define("cosmoz-omnitable-header-row",T(Lo,{useShadowDOM:!1}));const Ro=K`
	:host {
		display: flex;
		align-items: center;
		flex-wrap: wrap;
...
`;customElements.define("cosmoz-omnitable-item-expand-line",T(Mo,{styleSheets:[Te(Ro)]}));const No=({columns:n,item:e,selected:t,expanded:o,groupOnColumn:r})=>tn(n,i=>d`<cosmoz-omnitable-item-expand-line
				.column=${i}
				?hidden=${i===r}
				exportparts="item-expand-label, item-expand-value"
				>${i.renderCell(i,{item:e,selected:t,expanded:o})}</cosmoz-omnitable-item-expand-line
			>`);customElements.define("cosmoz-omnitable-item-expand",T(No,{useShadowDOM:!1}));const jo=(n,e,t)=>n.editable?n.renderEditCell(n,e,t(n,e.item)):n.renderCell(n,e),Po=({columns:n,groupOnColumn:e,item:t,index:o,selected:r,expanded:i,onItemChange:a})=>yt(n,l=>l.name,l=>d`<div
			...
			</div>`);customElements.define("cosmoz-omnitable-item-row",T(Po,{useShadowDOM:!1}));const Tt=K`
	.checkbox {
		box-sizing: border-box;
		width: 18px;
		height: 18px;
...
`,pt=n=>{const e=n.replace(/"/gu,'""');return e.search(/("|,|\n)/gu)>=0?'"'+e+'"':n},Go=(n,e,t)=>{const i=n.map(l=>pt(l.title)).join(";")+`
`,a=e.map(l=>n.map(s=>{const u=s.getString(s,l);return u==null?"":pt(String(u))}).join(";")+`
`);a.unshift(i),$t(new File(a,t,{type:"text/csv;charset=utf-8"}))},Ho=(n,e)=>{const t=n.map(r=>r.title),o=e.map(r=>n.map(i=>{const a=i.toXlsxValue(i,r);return a??""}));return o.unshift(t),o},Wo=(n,e,t,o)=>{const r=Ho(n,e),i=new nn(t).addSheetFromData(r,o).generate();$t(new File([i],t,{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}))},qo=({columns:n,selectedItems:e,csvFilename:t,xlsxFilename:o,xlsxSheetname:r,topPlacement:i})=>d`<cosmoz-bottom-bar
		id="bottomBar"
		?active=${!Le(e.length)}
		part="bottomBar"
	...
	>
		<slot name="info" slot="info">
			${on("{0} selected item","{0} selected items",e.length)}
		</slot>
	...
	</cosmoz-bottom-bar>`,Xo=({allSelected:n,onAllCheckboxChange:e,sortAndGroup:t,dataIsValid:o,data:r,columns:i,filters:a,groupOnColumn:l,setFilterState:s,settingsConfig:u,hideSelectAll:c})=>d`<sort-and-group-provider .value=${t}>
...
`,Ko=({settingsConfig:n})=>{const{columns:e,collapsed:t}=n,o=e.filter(r=>!t.some(i=>i.name===r.name));return d`<div class="skeleton">
	...
	</div>`};customElements.define("cosmoz-omnitable-skeleton",T(Ko,{styleSheets:[Uo]}));const Jo=(n,e)=>{const{settingsConfig:t}=n,{processedItems:o,dataIsValid:r,filterIsTooStrict:i,loading:a,displayEmptyGroups:l,compareItemsFn:s,setSelectedItems:u,renderItem:c,renderGroup:m,error:h}=e;return d`${D(!a&&!r&&!h,()=>d`<div class="tableContent-empty">
...
`,le=n=>{const e=parseInt(n,10);return isFinite(e)?e:void 0},Zo=n=>{const{config:e}=n,{settings:t,setSettings:o,collapsed:r}=e,i=Re({collapsed:r,settings:t.columns,setSettings:$(a=>o(l=>({...l,columns:a})),[o])});return{...e,onDown:$(a=>{a.target.closest(".pull")&&(i.handle=a.currentTarget)},[i]),onDragStart:$(a=>{const{target:l}=a,s=le(l.dataset.index);if(!i.handle?.contains(l)||s==null)return a.preventDefault();i.handle=null,a.dataTransfer.effectAllowed="move",a.dataTransfer.setData("omnitable/sort-index",s),a.dataTransfer.setData("text/plain",s),setTimeout(()=>l.classList.add("drag"),0),l.addEventListener("dragend",u=>u.target.classList.remove("drag"),{once:!0})},[i]),onDragEnter:$(a=>{const l=a.currentTarget;l===a.target&&(a.preventDefault(),a.dataTransfer.dropEffect="move",l.classList.add("dragover"))},[]),onDragOver:$(a=>{a.preventDefault(),a.currentTarget.classList.add("dragover")},[]),onDragLeave:$(a=>{const l=a.currentTarget;l.contains(a.relatedTarget)||l.classList.remove("dragover")},[]),onDrop:$(a=>{const l=le(a.dataTransfer.getData("omnitable/sort-index")),s=le(a.currentTarget.dataset.index),{settings:u,setSettings:c}=i;a.currentTarget.classList.remove("dragover"),a.preventDefault();const m=u.slice();m.splice(s+(l>=s?0:-1),0,m.splice(l,1)[0]),c(m)},[i]),onToggle:$(a=>{const{settings:l,setSettings:s}=i,u=l.map(m=>({...m,disabled:m.disabled||i.collapsed?.some(h=>h.name===m.name)})),c=le(a.target.closest("[data-index]")?.dataset.index);u.splice(c,1,{...l[c],disabled:!a.target.checked,priority:a.target.checked?l.reduce((m,h)=>Math.max(m,h.priority),0)+1:l[c].priority}),s(u)},[i])}},er=[an({apply({availableHeight:n,elements:e}){Object.assign(e.floating.style,{maxHeight:`${Math.max(0,n)}px`})}}),...ln],tr=({onDragStart:n,onDragEnter:e,onDragOver:t,onDragLeave:o,onDrop:r,onDown:i,onToggle:a,collapsed:l,filters:s})=>(u,c)=>{const m=!!l?.find(p=>p.name===u.name),h=!u.disabled&&!m;return d` <div
			class="item"
			data-index=${c}
			@mousedown=${i}
			draggable="true"
		...
		>
			...
			<input
				...
				.indeterminate=${m}
			/>
		</div>`},nr=n=>{const{settings:e,settingsId:t,onSave:o,onReset:r,hasChanges:i,opened:a,setOpened:l,...s}=Zo(n);return d` <div class="headline">
			${_("Sort and filter")}
			<button
				class="close"
		...
		${D(t,()=>d`<div class="buttons">
				...
				</div>`)}`};customElements.define("cosmoz-omnitable-settings-ui",T(nr,{styleSheets:[Te(Yo)]}));const or=({config:n,newLayout:e})=>d`
	<cosmoz-dropdown
...
`;customElements.define("cosmoz-omnitable-settings",T(or,{styleSheets:[Te(Qo)]}));const he=["sortOn","descending","groupOn","groupOnDescending"],se=n=>e=>typeof e=="object"&&e!==null&&"name"in e&&e.name===n,rr=(n=[],e=[],t=[])=>{const o=e.filter(a=>n.some(se(a.name))),r=n.filter(a=>a.name!=null&&!e.some(se(a.name))&&!t.some(se(a.name))),i=t.filter(a=>!e.some(se(a.name)));return[...o,...i.flatMap(a=>{const l=n.find(s=>s.name===a.name);return l?{...a,title:l.title??a.title??"",minWidth:parseInt(l.minWidth??"0",10)}:[]}),...r.map(a=>{const{name:l,title:s,priority:u,minWidth:c,width:m,flex:h}=a;return{name:l??"",title:s??"",priority:u??0,minWidth:parseInt(c??"0",10),width:parseInt(m??"0",10),flex:parseInt(h??"0",10)}})]},ir=(n,e)=>({...e,...Ie(Array.from(he))(n),columns:n.columns?.map(Ie(["name","priority","width","flex","disabled"]))}),ar=({columns:n,settings:e,savedSettings:t,initial:o})=>({...Object.fromEntries(he.flatMap(i=>o?.[i]!=null?[[i,o[i]]]:[])),...t?Ie(Array.from(he))(t):{},...e,columns:rr(n,e?.columns,t?.columns)}),lr=({prefix:n="omnitable-"}={})=>({write:async(t,o)=>{const r=n+t;try{o?localStorage.setItem(r,JSON.stringify(o)):localStorage.removeItem(r)}catch(i){console.error(i)}},read:async t=>{if(t)try{const o=localStorage.getItem(n+t);return o==null?void 0:JSON.parse(o)}catch(o){console.error(o)}}}),sr=vt(lr),ur=()=>{const n=Ee(sr);return I(()=>n(),[n])},cr=(n,e,t,o)=>{const[r,i]=M(),{read:a,write:l}=ur();return E(async()=>{n&&i(await a(n))},[n,a]),{settingsId:n,savedSettings:r,onSave:$(async()=>{if(!n)return;const s=ir(e,r);await l(n,s),t(),i(s)},[e,r]),onReset:$(async s=>{t(),s.shiftKey&&(await l(n),i()),o?.()},[o]),hasChanges:e!=null}},dr=({settingsId:n,host:e})=>{const t=I(()=>Object.fromEntries(he.map(b=>[b,e[b]])),[]),o=Me(),r=$(()=>{o.current?.(t)},[t]),[i,a]=M(),[l,s]=M({columns:!0,sort:!0}),{savedSettings:u,...c}=cr(n,i,a,r),{enabledColumns:m}=e,h=Fn(e,{enabledColumns:m}),p=I(()=>ar({columns:h,settings:i,savedSettings:u,initial:t}),[h,i,u]),z=I(()=>p.columns.map(b=>h.find(y=>y.name===b.name)).filter(Boolean),[h,...p.columns.map(b=>b.name)]);return{...c,opened:l,setOpened:s,settings:p,columns:z,setSettings:a,resetRef:o}},gt=n=>Number.isFinite(n)?n:0,mr=(n,e)=>{const t=[];let[o,r]=n.reduce(([c,m],{width:h,flex:p})=>[c+h,m+p],[0,0]),i=e-o,a=gt(i/r),l=0,s=0,u=0;for(let c=0;c<n.length;c++){const{width:m,minWidth:h,flex:p}=n[c],z=i>=0?a*p:m*i/o;if(h>m+z){l+=m,s+=h,u+=p,t[c]=h;continue}if(p===0){l+=m,s+=m,t[c]=m;continue}}o-=l,i=e-s-o,r-=u,a=gt(i/r);for(let c=0;c<n.length;c++){if(t[c]!=null)continue;const{width:m,flex:h}=n[c],p=i>=0?a*h:m*i/o;t[c]=m+p}return t},fe=Symbol("index"),pr=(n,e)=>{if(typeof n.findLastIndex=="function")return n.findLastIndex(e);for(let t=n.length-1;t>=0;t--)if(e(n[t],t,n))return t;return-1},gr=(n,e)=>{const t=pr(n,a=>a!=null&&a>0),o=(a,l)=>`.cell[name="${a}"], cosmoz-omnitable-skeleton::part(cell-${a}){width: ${Math.floor(l)}px;padding: 0 min(3px, ${l/2}px)}`,r=a=>`cosmoz-omnitable-resize-nub[name="${a}"]{display:none}`,i=a=>`cosmoz-omnitable-resize-nub[name="${a}"], .cell[name="${a}"]{display:none}`;return e.map((a,l)=>{const s=n[l];if(s==null||s===0)return i(a.name);const u=o(a.name,s);return l===t?`${u}
${r(a.name)}`:u}).join(`
`)},Lt=(n,e,t)=>{const o=n.filter(l=>!l.hidden),r=o.reduce((l,{width:s})=>l+s,0);if(o.length>1&&r>e)return Lt(o.slice(1),e,t);const i=o.reduce(([l,s],u,c)=>[Math.max(l,u.index),u.index>l?c:s],[-1,-1])[1];return i!==-1&&(o[i].flex=1),mr(o,e).reduce((l,s,u)=>(l[o[u].index]=s,l),new Array(t).fill(void 0))},hr=(n,e)=>n.length===0?".cell {display: none;}":gr(n,e),fr=({host:n,canvasWidth:e,layout:t,setSettings:o})=>{const r=Me();r.current=i=>o(a=>{const l=a.columns,{detail:{newWidth:s,column:u}}=i,c=l.findIndex(p=>p.name===u.name),m=[],h=l.reduce((p,z)=>Math.max(p,z.priority),-1/0);for(let p=0;p<t.length;p++)if(m[p]={...l[p]},p<c&&t[p]&&(m[p].width=t[p],m[p].flex=0,m[p].priority=h),p===c){const z=t.reduce((b,y,F)=>F<c&&y?b-y:b,e);m[p].width=Math.min(z,Math.max(s,l[p].minWidth)),m[p].flex=0,m[p].priority=h}return{...a,columns:m}}),E(()=>{const i=a=>r.current(a);return n.addEventListener("column-resize",i),()=>n.removeEventListener("column-resize",i)},[])},br=(n,e)=>E(()=>{const t=([r])=>{r.contentRect?.width!==0&&requestAnimationFrame(()=>e(r.contentRect?.width-20-44-24))},o=new ResizeObserver(t);return o.observe(n),()=>o.unobserve(n)},[]),xr=n=>{const[e,t]=M(()=>n.getBoundingClientRect().width);return br(n,t),e},vr=(n,e)=>{const t=I(()=>{let o=!1,r;const i=()=>{if(!o)return;r=requestAnimationFrame(i),n()&&(o=!1)};return{start:()=>{o=!0,cancelAnimationFrame(r),r=requestAnimationFrame(i)},stop:()=>{o=!1,cancelAnimationFrame(r)}}},[]);E(()=>{t.start()},e),E(()=>()=>t.stop(),[])},yr=(n=0,e=0)=>Math.abs(n-e)<.1,$r=(n,e=1.9,t=sn)=>{const o=Re({target:n}),r=$(()=>{if(o.tween||(o.tween=o.target),o.target.every((i,a)=>o.tween[a]===i))return t(o.tween),!0;o.tween=o.target.map((i,a)=>yr(o.tween[a],i)?i:(o.tween[a]??0)+((i??0)-(o.tween[a]??0))/e||0),t(o.tween)},[]);vr(r,[n])},wr=({canvasWidth:n,groupOnColumn:e,config:t,miniColumn:o})=>I(()=>{if(!Array.isArray(t)||n==null||n===0)return[];const r=t.map((i,a)=>({minWidth:i.minWidth,width:i.width,flex:i.flex,priority:i.priority,name:i.name,index:a,hidden:i.name===e?.name||i.disabled})).map(i=>o?{...i,hidden:o.name!==i.name}:i).sort(({index:i,priority:a},{index:l,priority:s})=>a===s?l-i:a-s);return Lt(r,n,r.length)},[n,e,t]),zr=({host:n,canvasWidth:e,columns:t})=>{const o=n.miniBreakpoint??480,r=I(()=>e<=o,[e,o]),i=I(()=>r?t?.filter(u=>u.mini!=null).sort((u,c)=>(u.mini??0)-(c.mini??0)):[],[t,r]),[a,...l]=i??[],s=!!a;return E(()=>{n.toggleAttribute("mini",s)},[s]),{isMini:s&&r,miniColumn:a,miniColumns:l}},Cr=n=>{const e=I(()=>new CSSStyleSheet,[]);return E(()=>{n.shadowRoot.adoptedStyleSheets=[...n.shadowRoot.adoptedStyleSheets,e]},[]),e},Sr=({host:n,columns:e,settings:t,setSettings:o,resizeSpeedFactor:r,sortAndGroupOptions:i})=>{const a=xr(n),{isMini:l,miniColumn:s,miniColumns:u}=zr({host:n,canvasWidth:a,columns:e}),{groupOnColumn:c}=i,m=wr({canvasWidth:a,groupOnColumn:c,miniColumn:s,config:t.columns}),h=Cr(n),p=I(()=>t.columns.reduce((b,y,F)=>m[F]!=null||y.name===c?.name||y.disabled?b:[...b,e.find(g=>g.name===y.name)],[]),[e,t,m]),z=Re({columns:t.columns});return $r(m,r,b=>{const y=hr(b,z.columns);h.replace(y)}),fr({host:n,canvasWidth:a,layout:m,setSettings:b=>o(b(t))}),{isMini:l,collapsedColumns:p,miniColumns:u}},kr=({host:n,...e})=>{const{csvFilename:t="omnitable.csv",xlsxFilename:o="omnitable.xlsx",xlsxSheetname:r="Omnitable",topPlacement:i="top-end"}=n;return{csvFilename:t,xlsxFilename:o,xlsxSheetname:r,topPlacement:i,...e}},_r=({host:n,selectedItems:e,data:t,sortAndGroupOptions:o,collapsedColumns:r,settings:i,filterFunctions:a,settingS:l,filters:s,...u})=>{const c=t&&t.length>0&&e.length===t.length,m=b=>{b.target.checked?n.shadowRoot.querySelector("#groupedList").selectAll():n.shadowRoot.querySelector("#groupedList").deselectAll()},{groupOnColumn:h}=o,p=I(()=>[h,...r,...i.columns.filter(b=>b.disabled)].some(b=>b&&Object.keys(a).includes(b.name)),[a,i,r]),z=I(()=>({...l,collapsed:r,badge:p,filters:s}),[l,r,p,s]);return E(()=>{const b=n.shadowRoot.querySelector("#tableContent"),y=new ResizeObserver(F=>requestAnimationFrame(()=>{n.style.setProperty("--ot-height",F[0]?.contentRect.height+"px")}));return y.observe(b),()=>y.unobserve(b)},[]),{allSelected:c,onAllCheckboxChange:m,data:t,settingsConfig:z,filters:s,groupOnColumn:h,sortAndGroup:o.sortAndGroup,...u}},Rt=d`
	<svg
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
...
`,Ir=n=>n?"groupRow groupRow-folded":"groupRow",Fr=({item:n,index:e})=>t=>D(t?.length>0,()=>d`
			...
			`),Or=({columns:n,collapsedColumns:e,miniColumns:t,onItemClick:o,onCheckboxChange:r,dataIsValid:i,groupOnColumn:a,onItemChange:l,rowPartFn:s})=>(u,c,{selected:m,expanded:h,toggleCollapse:p})=>d`
		<div
			?selected=${m}
			part="${["itemRow",`itemRow-${u[fe]}`,s?.(u,c)].filter(Boolean).join(" ")}"
			.dataIndex=${u[fe]}
			.dataItem=${u}
			class="itemRow"
			@click=${o}
	...
	`,Dr=({onCheckboxChange:n,dataIsValid:e,groupOnColumn:t})=>(o,r,{selected:i,folded:a,toggleFold:l})=>d` <div
			class="${Ir(a)}"
		...
		</div>`,Vr=({host:n,error:e,dataIsValid:t,processedItems:o,columns:r,collapsedColumns:i,miniColumns:a,sortAndGroupOptions:l,rowPartFn:s,...u})=>{const{loading:c=!1,displayEmptyGroups:m=!1,compareItemsFn:h}=n,p=Me({shiftKey:!1,ctrlKey:!1}),z=$(g=>{const k=g.target.dataItem,f=g.target.checked;p.current.shiftKey?n.shadowRoot.querySelector("#groupedList").toggleSelectTo(k,f):p.current.ctrlKey?(g.target.checked=!0,n.shadowRoot.querySelector("#groupedList").selectOnly(k)):n.shadowRoot.querySelector("#groupedList").toggleSelect(k,f),g.preventDefault(),g.stopPropagation()},[]);E(()=>{const g=({shiftKey:k,ctrlKey:f})=>{p.current={shiftKey:k,ctrlKey:f}};return window.addEventListener("keydown",g),window.addEventListener("keyup",g),()=>{window.removeEventListener("keydown",g),window.removeEventListener("keyup",g)}},[]);const b=$(g=>{const k=g.composedPath();k.slice(0,k.indexOf(g.currentTarget)).find(v=>v.matches?.("a, .checkbox, .expand"))||n.dispatchEvent(new window.CustomEvent("omnitable-item-click",{bubbles:!0,composed:!0,detail:{item:g.currentTarget.dataItem,index:g.currentTarget.dataIndex}}))},[]),{groupOnColumn:y}=l,F=$((g,k)=>f=>On(n,g,k,f),[]);return{...u,processedItems:o,dataIsValid:t,filterIsTooStrict:t&&o.length<1,loading:c,compareItemsFn:h,displayEmptyGroups:m,error:e,renderItem:I(()=>Or({columns:r,collapsedColumns:i,miniColumns:a,onItemClick:b,onCheckboxChange:z,dataIsValid:t,groupOnColumn:y,onItemChange:F,rowPartFn:s}),[r,i,b,z,t,y,F,s]),renderGroup:I(()=>Dr({onCheckboxChange:z,dataIsValid:t,groupOnColumn:y}),[z,t,y])}},Ar=(n,e)=>{if(n===e)return 0;if(n==null)return-1;if(e==null)return 1;const t=typeof n,o=typeof e;return t==="object"&&o==="object"?n.toString()<e.toString()?-1:1:t==="number"&&o==="number"?n-e:t==="string"&&o==="string"?n<e?-1:1:t==="boolean"&&o==="boolean"?n?-1:1:(console.warn("unsupported sort",t,n,o,e),0)},Se=(n,e)=>(t,o)=>Ar(n(t),n(o))*(e?-1:1),Er=n=>n.replace(/([a-z0-9])([A-Z])/gu,"$1-$2").toLowerCase(),ht=(n,e)=>{!n||!e||Object.entries(e).forEach(([t,o])=>{n[B].__ownChange=!0,n[B][t]=o,n[B].__ownChange=!1,n[B].dispatchEvent(new CustomEvent(`${Er(t)}-changed`,{bubbles:!0,detail:{value:o}}))})},ke=(n,e)=>Object.assign(n,{[fe]:e}),ue=Symbol("unparsed"),Tr=({data:n,columns:e,hashParam:t,sortAndGroupOptions:o,noLocalSort:r,noLocalFilter:i})=>{const{groupOnColumn:a,groupOnDescending:l,sortOnColumn:s,descending:u}=o,c=$(([f,v])=>{const x=e.find(({name:w})=>w===f);return x==null?[f,void 0]:[f,v.filter&&x.serializeFilter(x,v.filter)]},[e]),m=$(([f,v])=>{const x=e.find(({name:S})=>S===f);if(x==null)return[f,{[ue]:v}];const w={filter:x.deserializeFilter(x,v)};return ht(x,w),[f,w]},[e]),[h,p]=J({},t,{multi:!0,suffix:"-filter--",write:c,read:m}),z=$((f,v)=>p(x=>{const w=xe(v,x[f]);return ht(e.find(S=>S.name===f),w),{...x,[f]:{...x[f],...w}}}),[e,p]),b=I(()=>Object.values(h).map(f=>f.filter),[h]),y=I(()=>Object.fromEntries(e.map(f=>[f.name,!f.noLocalFilter&&f.getFilterFn(f,h[f.name]?.filter)]).filter(([,f])=>!!f)),[e,...b]),F=I(()=>!Array.isArray(n)||n.length===0?[]:Object.entries(y).length===0||i?n.slice():n.filter(f=>Object.values(y).every(v=>v(f))),[n,y,i]),g=I(()=>{if(!r&&!a&&s!=null&&s.sortOn!=null)return F.slice().sort(Se(f=>s.getComparableValue({...s,valuePath:s.sortOn},f),u));if(a!=null&&a.groupOn!=null){const f=F.reduce((v,x)=>{const w=a.getComparableValue({...a,valuePath:a.groupOn},x);if(w===void 0)return v;let S=v.find(R=>R.id===w);return S?(S.items.push(x),v):(S={id:w,name:w,items:[x]},[...v,S])},[]);return f.sort(Se(v=>a.getComparableValue({...a,valuePath:a.groupOn},v.items[0]),l)),!s||r?f:f.filter(v=>Array.isArray(v.items)).map(v=>(v.items.sort(Se(x=>s.getComparableValue({...s,valuePath:s.sortOn},x),u)),v))}return F},[F,a,l,s,u,r]),k=I(()=>{let f=0,v=0;const x=[];return g.forEach(w=>{if(Array.isArray(w.items)){ke(w,v++),w.items.forEach(S=>{ke(S,f++),x.push(S)});return}return ke(w,f++),x.push(w)},[]),x},[g]);return E(()=>{p(f=>Object.values(f).some(x=>x[ue]!=null)?Object.fromEntries(Object.entries(f).map(([x,w])=>w[ue]==null?[x,w]:m([x,w[ue]]))):f)},[m]),{processedItems:g,visibleData:k,filters:h,filterFunctions:y,setFilterState:z}},Lr=n=>{const e=o=>{const r=n.data.indexOf(o);if(r<0)return null;const i=n.data.splice(r,1);if(n.data=n.data.slice(),Array.isArray(i)&&i.length>0)return i[0]},t=(o,r)=>{n.data.splice(o,1,r),n.data=n.data.slice()};return{removeItem:e,removeItems(o){const r=[];for(let i=o.length-1;i>=0;i-=1){const a=n.removeItem(o[i]);a!=null&&r.push(a)}return r},replaceItemAtIndex:t,replaceItem(o,r){const i=n.data.indexOf(o);if(i>-1)return t(i,r)},selectItem(o){n.shadowRoot.querySelector("#groupedList").select(o)},selectAll(){n.shadowRoot.querySelector("#groupedList").selectAll()},deselectAll(){n.shadowRoot.querySelector("#groupedList").deselectAll()},deselectItem(o){n.shadowRoot.querySelector("#groupedList").deselect(o)},isItemSelected(o){return n.shadowRoot.querySelector("#groupedList").isItemSelected(o)}}},Rr=({host:n,visibleData:e,filters:t,...o})=>{const{setFilterState:r}=o,i=I(()=>Lr(n),[]);Fe(o,Object.values(o)),Fe(i,Object.values(i)),E(()=>{const l=s=>r(s.detail.name,u=>({...u,...s.detail.state}));return n.addEventListener("legacy-filter-changed",l),()=>n.removeEventListener("legacy-filter-changed",l)},[]),P("visibleData",e),P("sortedFilteredGroupedItems",o.sortedFilteredGroupedItems),P("selectedItems",o.selectedItems),P("sortOn",o.sortOn),P("descending",o.descending),P("isMini",o.isMini);const a=I(()=>Object.fromEntries(Object.entries(t).filter(([,{filter:l}])=>l!==void 0).map(([l,{filter:s}])=>[l,s])),[t]);P("filters",a,Object.values(a))},Mr=n=>{const{hashParam:e,settingsId:t,data:o,resizeSpeedFactor:r,noLocal:i,noLocalSort:a=i,noLocalFilter:l=i,error:s,rowPartFn:u}=n,c=dr({settingsId:t,host:n}),{settings:m,setSettings:h,columns:p,resetRef:z}=c,b=Eo(p,e,m,h,z),{processedItems:y,visibleData:F,filters:g,setFilterState:k,filterFunctions:f}=Tr({data:o,columns:p,hashParam:e,sortAndGroupOptions:b,noLocalSort:a,noLocalFilter:l}),{isMini:v,collapsedColumns:x,miniColumns:w}=Sr({host:n,columns:p,settings:m,setSettings:h,resizeSpeedFactor:r,sortAndGroupOptions:b}),S=o&&Array.isArray(o)&&o.length>0,[R,H]=M([]);return Rr({host:n,visibleData:F,sortedFilteredGroupedItems:y,columns:p,filters:g,setFilterState:k,selectedItems:R,isMini:v,...b}),{header:_r({host:n,selectedItems:R,sortAndGroupOptions:b,dataIsValid:S,data:o,columns:p,filters:g,collapsedColumns:x,settings:m,filterFunctions:f,settingS:c,setFilterState:k,hideSelectAll:n.hideSelectAll===!0}),list:Vr({host:n,error:s,dataIsValid:S,processedItems:y,setSelectedItems:H,columns:p,collapsedColumns:x,miniColumns:w,sortAndGroupOptions:b,rowPartFn:u}),footer:kr({host:n,selectedItems:R,columns:p})}};customElements.define("cosmoz-grouped-list-row",class extends HTMLElement{get item(){return this._item}set item(e){this._item=e,this._render()}get index(){return this._index}set index(e){this._index=e,this._render()}get renderFn(){return this._renderFn}set renderFn(e){this._renderFn=e,this._render()}_render(){this._item==null||this._index==null||this._renderFn==null||_e(this._renderFn(this._item,this._index),this)}});const Nr={group:Symbol("group")},$e=(n,e)=>(e.has(n)||e.set(n,{}),e.get(n)),jr=(n,e)=>!!$e(n,e).expanded,Pr=(n,e)=>!!$e(n,e).folded,Oe=n=>n?n.items instanceof Array:!1,Br=n=>{if(!Array.isArray(n)||n.length===0)return;const e=Array.isArray(n[0]?.items);if(!n.every(o=>Array.isArray(o.items)===e))throw new Error("Data must be homogeneous.")},Gr=(n,e,t)=>Array.isArray(n)?(Br(n),n.reduce((r,i)=>{const a=i;return a.items?a.items.length?$e(i,t).folded?r.concat(i):r.concat(i,a.items.map(l=>Object.assign(l,{[Nr.group]:i}))):e?r.concat(i):r:r.concat(i)},[])):void 0,Hr=(n,...e)=>typeof n=="function"?n(...e):n,Wr=(n,e)=>n===e,qr=()=>{const[n,e]=M(()=>[new WeakMap]);return{setItemState:$((o,r)=>e(([i])=>{const a=$e(o,i);return Object.assign(a,Hr(r,a)),[i]}),[]),state:n[0],signal:n}},Xr=()=>{const{setItemState:n,state:e,signal:t}=qr(),o=$((i,a)=>{Oe(i)&&n(i,l=>({folded:a!==void 0?a:!l.folded}))},[]),r=$((i,a)=>{Oe(i)||n(i,l=>({expanded:a!==void 0?!a:!l.expanded}))},[]);return{state:e,signal:t,toggleFold:o,toggleCollapse:r}},Ur=({initial:n,compareItemsFn:e,data:t,flatData:o})=>{const[r,i]=M(n),[a,l]=M(),s=$(g=>r.includes(g),[r]),u=$(g=>g?.items?.every(s)??!1,[s]),c=$(g=>s(g)||u(g),[s,u]),m=$(g=>{const f=g.items??[g];i(v=>[...v,...f.filter(x=>!v.includes(x))]),l(g)},[]),h=$(g=>{const f=g.items??[g];i(v=>v.filter(x=>!f.includes(x))),l(g)},[]),p=$(g=>{i(g.items?.slice()||[g]),l(g)},[]),z=$(()=>{i(t.flatMap(g=>g.items||g)),l(void 0)},[t]),b=$(()=>{i([]),l(void 0)},[]),y=$((g,k=!c(g))=>k?m(g):h(g),[c]),F=$((g,k)=>{if(!o)return;const f=a?o.findIndex(w=>e(w,a)):-1;if(f<0)return y(g,k);const[v,x]=[f,o.indexOf(g)].sort((w,S)=>w-S);o.slice(v,x+1).forEach((w,S,R)=>{S>0&&S<R.length-1&&Oe(w)||y(w,k)}),l(g)},[o,e,y]);return E(()=>i(g=>g.length>0&&o?o.filter(k=>g.find(f=>e(k,f))):g),[o]),{selectedItems:r,isItemSelected:s,isGroupSelected:u,isSelected:c,select:m,deselect:h,selectOnly:p,selectAll:z,deselectAll:b,toggleSelect:y,toggleSelectTo:F}},Kr={host:{position:"relative",display:"flex",flexDirection:"column"}},Jr=n=>{const{data:e,renderItem:t,renderGroup:o,displayEmptyGroups:r,compareItemsFn:i=Wr}=n,{toggleFold:a,toggleCollapse:l,state:s,signal:u}=Xr(),c=I(()=>Gr(e,r,s),[e,r,u]),{selectedItems:m,isItemSelected:h,isGroupSelected:p,isSelected:z,select:b,deselect:y,selectOnly:F,selectAll:g,deselectAll:k,toggleSelect:f,toggleSelectTo:v}=Ur({initial:[],compareItemsFn:i,data:e,flatData:c}),x=$((S,R)=>Array.isArray(S.items)?o(S,R,{selected:p(S,m),folded:Pr(S,s),toggleSelect:H=>f(S,typeof H=="boolean"?H:void 0),toggleFold:()=>a(S)}):t(S,R,{selected:m.includes(S),expanded:jr(S,s),toggleSelect:H=>f(S,typeof H=="boolean"?H:void 0),toggleCollapse:()=>l(S)}),[t,o,m,f,u]);bt(()=>Object.assign(n.style,Kr.host),[]),P("selectedItems",m);const w={toggleFold:a,toggleCollapse:l,isItemSelected:h,isGroupSelected:p,isSelected:z,select:b,deselect:y,selectOnly:F,selectAll:g,deselectAll:k,toggleSelect:f,toggleSelectTo:v};return Fe(w,Object.values(w)),{renderRow:x,flatData:c}},Yr=({renderRow:n,flatData:e})=>un({items:e,renderItem:(t,o)=>d`<cosmoz-grouped-list-row
				.item=${t}
				.index=${o}
				.renderFn=${n}
			></cosmoz-grouped-list-row>`}),Qr=n=>Yr(Jr(n));customElements.define("cosmoz-grouped-list",T(Qr,{useShadowDOM:!1}));const Zr=n=>window.ShadyCSS?.ApplyShim?.transformCssText?.(n)||n,ei=n=>{const{header:e,list:t,footer:o}=Mr(n);return d`
		<style>
			${cn([],()=>Zr(Bo))}
		</style>
...
`;d(Object.assign([be],{raw:[be]}));Ve(Object.assign([be],{raw:[be]}));const ti=()=>d`<style>
	...
	:host {
        ...
        `,play:async()=>{console.log("Current hash:",window.location.hash)}},ce={args:{data:Mt(10,10,10)}},de={args:{data:Mt(2,2,10)}},me={args:{data:[]}};ce.parameters={...ce.parameters,docs:{...ce.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...me.parameters?.docs?.source}}};const ui=["TableWithLargeData","TableWithSmallData","TableWithNoData"];export{ce as TableWithLargeData,me as TableWithNoData,de as TableWithSmallData,ui as __namedExportsOrder,si as default};
