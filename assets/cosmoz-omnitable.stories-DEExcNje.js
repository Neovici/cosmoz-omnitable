import{n as e}from"./chunk-BneVvdWh.js";import{$ as t,X as n,Z as r,et as i,n as a,t as o}from"./iframe-CnRZ0tCG.js";import{$ as s,A as c,At as l,B as u,C as d,Ct as f,D as p,Dt as m,E as h,Et as g,F as _,Ft as v,G as y,H as b,I as x,It as S,J as C,K as ee,L as te,Lt as w,M as ne,Mt as re,N as ie,Nt as ae,O as oe,Ot as T,P as se,Q as E,R as ce,Rt as le,S as ue,St as de,T as fe,Tt as D,U as pe,V as me,W as O,X as he,Y as ge,Z as _e,_ as ve,_t as ye,a as be,at as k,b as A,bt as j,c as xe,ct as Se,d as Ce,dt as we,et as Te,f as Ee,ft as De,g as Oe,gt as ke,h as Ae,ht as je,i as Me,it as M,j as Ne,jt as Pe,k as Fe,kt as Ie,l as Le,lt as Re,m as ze,mt as Be,n as Ve,nt as He,o as Ue,ot as We,p as Ge,pt as Ke,q as qe,r as Je,rt as Ye,s as Xe,st as Ze,t as Qe,tt as $e,u as et,ut as tt,v as nt,vt as rt,w as it,wt as at,x as ot,xt as st,y as ct,yt as N,z as lt,zt as ut}from"./dist-N9T6vPGV.js";var dt,ft,pt=e((()=>{b(),N(),dt=O`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`)},Fa=(e,t,n)=>{let r=e.filter(e=>!e.hidden),i=r.reduce((e,{width:t})=>e+t,0);if(r.length>1&&i>t)return Fa(r.slice(1),t,n);let a=r.reduce(([e,t],n,r)=>[Math.max(e,n.index),n.index>e?r:t],[-1,-1])[1];return a!==-1&&(r[a].flex=1),ka(r,t).reduce((e,t,n)=>(e[r[n].index]=t,e),Array(n).fill(void 0))},Ia=(e,t)=>e.length===0?`.cell {display: none;}`:Pa(e,t)})),Ra,za,Ba=e((()=>{N(),Ra=88,za=(e,t)=>l(()=>{let n=new ResizeObserver(([e])=>{e.contentRect?.width!==0&&t(e.contentRect.width-Ra)});return n.observe(e),()=>n.unobserve(e)},[])})),Va,Ha=e((()=>{N(),Ba(),Va=e=>{let[t,n]=D(()=>e.getBoundingClientRect().width-Ra);return za(e,n),t}})),Ua,Wa=e((()=>{N(),La(),Ua=({canvasWidth:e,groupOnColumn:t,config:n,miniColumn:r})=>T(()=>{if(!Array.isArray(n)||e==null||e===0)return[];let i=n.map((e,n)=>({minWidth:e.minWidth,width:e.width,flex:e.flex,priority:e.priority,name:e.name,index:n,hidden:e.name===t?.name||e.disabled})).map(e=>r?{...e,hidden:r.name!==e.name}:e).sort(({index:e,priority:t},{index:n,priority:r})=>t===r?n-e:t-r);return Fa(i,e,i.length)},[e,t,n])})),Ga,Ka=e((()=>{N(),Ga=({host:e,canvasWidth:t,columns:n})=>{let r=e.miniBreakpoint??480,i=T(()=>t<=r,[t,r]),[a,...o]=T(()=>i?n?.filter(e=>e.mini!=null).sort((e,t)=>(e.mini??0)-(t.mini??0)):[],[n,i])??[],s=!!a;return l(()=>{e.toggleAttribute(`mini`,s)},[s]),{isMini:s&&i,miniColumn:a,miniColumns:o}}})),qa,Ja=e((()=>{N(),qa=({host:e,canvasWidth:t,layout:n,setSettings:r,requestTween:i})=>{let a=de();a.current=e=>{i(),r(r=>{let i=r.columns,{detail:{newWidth:a,column:o}}=e,s=i.findIndex(e=>e.name===o.name),c=[],l=i.reduce((e,t)=>Math.max(e,t.priority),-1/0);for(let e=0;e<n.length;e++)if(c[e]={...i[e]},e<s&&n[e]&&(c[e].width=n[e],c[e].flex=0,c[e].priority=l),e===s){let r=n.reduce((e,t,n)=>n<s&&t?e-t:e,t);c[e].width=Math.min(r,Math.max(a,i[e].minWidth)),c[e].flex=0,c[e].priority=l}return{...r,columns:c}})},l(()=>{let t=e=>a.current?.(e);return e.addEventListener(`column-resize`,t),()=>e.removeEventListener(`column-resize`,t)},[])}})),Ya,Xa,Za,Qa=e((()=>{Se(),De(),N(),Ya=(e,t)=>{let n=T(()=>{let t=!1,n,r=()=>{t&&(n=requestAnimationFrame(r),e()&&(t=!1))};return{start:()=>{t=!0,cancelAnimationFrame(n),n=requestAnimationFrame(r)},stop:()=>{t=!1,cancelAnimationFrame(n)}}},[]);l(()=>{n.start()},t),l(()=>()=>n.stop(),[])},Xa=(e=0,t=0)=>Math.abs(e-t)<.1,Za=(e,t=1.9,n=tt,r)=>{let i=Ke({target:e,speedFactor:t,onConverge:r});Ya(m(()=>{if(!i.tween)return i.tween=i.target,n(i.tween),i.onConverge?.(),!0;if(i.target.every((e,t)=>i.tween[t]===e))return n(i.tween),i.onConverge?.(),!0;if(i.tween=i.target.map((e,t)=>Xa(i.tween[t],e)?e:(i.tween[t]??0)+((e??0)-(i.tween[t]??0))/i.speedFactor||0),n(i.tween),i.tween.every((e,t)=>e===i.target[t]))return i.onConverge?.(),!0},[]),[e])}})),$a,eo,to=e((()=>{De(),N(),La(),Ha(),Wa(),Ka(),Ja(),Qa(),$a=e=>{let t=T(()=>new CSSStyleSheet,[]);return l(()=>{e.shadowRoot.adoptedStyleSheets=[...e.shadowRoot.adoptedStyleSheets,t]},[]),t},eo=({host:e,columns:t,settings:n,setSettings:r,resizeSpeedFactor:i,sortAndGroupOptions:a})=>{let o=Va(e),{isMini:s,miniColumn:c,miniColumns:l}=Ga({host:e,canvasWidth:o,columns:t}),{groupOnColumn:u}=a,d=Ua({canvasWidth:o,groupOnColumn:u,miniColumn:c,config:n.columns}),f=$a(e),p=T(()=>n.columns.reduce((e,n,r)=>d[r]!=null||n.name===u?.name||n.disabled?e:[...e,t.find(e=>e.name===n.name)],[]),[t,n,d]),[h,g]=D(1),_=m(()=>g(i??1.9),[i]),v=m(()=>g(1),[]),y=Ke({columns:n.columns});return Za(d,h,e=>{let t=Ia(e,y.columns);f.replace(t)},v),qa({host:e,canvasWidth:o,layout:d,setSettings:e=>r(e(n)),requestTween:_}),{isMini:s,collapsedColumns:p,miniColumns:l,requestTween:_}}})),no,ro=e((()=>{no=({host:e,...t})=>{let{csvFilename:n=`omnitable.csv`,xlsxFilename:r=`omnitable.xlsx`,xlsxSheetname:i=`Omnitable`,topPlacement:a=`top-end`}=e;return{csvFilename:n,xlsxFilename:r,xlsxSheetname:i,topPlacement:a,...t}}})),io,ao=e((()=>{N(),io=({host:e,selectedItems:t,data:n,sortAndGroupOptions:r,collapsedColumns:i,settings:a,filterFunctions:o,settingS:s,filters:c,requestTween:u,...d})=>{let f=n&&n.length>0&&t.length===n.length,p=t=>{t.target.checked?e.shadowRoot.querySelector(`#groupedList`).selectAll():e.shadowRoot.querySelector(`#groupedList`).deselectAll()},{groupOnColumn:m}=r,h=T(()=>[m,...i,...a.columns.filter(e=>e.disabled)].some(e=>e&&Object.keys(o).includes(e.name)),[o,a,i]),g=T(()=>({...s,collapsed:i,badge:h,filters:c,requestTween:u}),[s,i,h,c,u]);return l(()=>{let t=e.shadowRoot.querySelector(`#tableContent`),n=new ResizeObserver(t=>requestAnimationFrame(()=>{e.style.setProperty(`--ot-height`,t[0]?.contentRect.height+`px`)}));return n.observe(t),()=>n.unobserve(t)},[]),{allSelected:f,onAllCheckboxChange:p,data:n,settingsConfig:g,filters:c,groupOnColumn:m,sortAndGroup:r.sortAndGroup,...d}}})),oo,so,co,lo,uo,fo,po=e((()=>{N(),S(),C(),Na(),H(),oo=t`
	<svg
		viewBox="0 0 24 24"
		preserveAspectRatio="xMidYMid meet"
		focusable="false"
