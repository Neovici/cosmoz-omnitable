import{x as c,B as _e,E as Oe}from"./iframe-BVF7Lxjs.js";import{t as K,c as L,g as C,P as I,u as T,a as ht,m as xt,s as Pt,D as Nt,b as Rt,e as Bt,i as ye,h as Le,o as vt,d as A,f as Gt,j as $e,p as fe,n as _,k as Ht,l as we,q as jt,r as Wt,v as Ut,w as Kt,T as Jt,x as M,y as Xt,z as Qt,A as Yt,B as $,C as Zt,E as ei,F as yt,G as De,H as F,I as $t,J as Te,K as ti,L as wt,N as ii,M as ai,O as Ve,Q as ni,R as Pe,S as oi,U as ri,V as Ee,W as Ne,X as li,Y as Ie,Z as N,_ as si,$ as ze,a0 as ui}from"./cosmoz-collapse-DMO3epGP.js";import"./preload-helper-PPVm8Dsz.js";const di=K`
	:host {
		display: flex;
	}
	:host(:not([light])) {
...
`;customElements.define("cosmoz-clear-button",L(ci));const U=({valuePath:i},e)=>C(e,i),mi=U,pi=U,gi=({valuePath:i},e)=>t=>{const a=C(t,i);return a==null?!1:a.toString().toLowerCase().trim().includes(e.toLowerCase().trim())},bi=(i,e)=>e===""||e==null?null:e,V=i=>class extends i{static get properties(){return{isOmnitableColumn:{type:Boolean,value:!0},title:{type:String},valuePath:{type:String,notify:!0},values:{type:Array,notify:!0},filter:{type:Object},noLocalFilter:{type:Boolean},disabled:{type:Boolean,value:!1,notify:!0},editable:{type:Boolean,notify:!0},loading:{type:Boolean,value:!1,notify:!0},externalValues:{type:Boolean,value:!1,notify:!0},name:{type:String},sortOn:{type:String},groupOn:{type:String},width:{type:String,value:"75px"},minWidth:{type:String,value:"40px"},flex:{type:String,value:"1"},cellClass:{type:String,value:"default-cell"},headerCellClass:{type:String,value:"default-header-cell"},priority:{type:Number,value:0},hidden:{type:Boolean,notify:!0},preferredDropdownHorizontalAlign:{type:String,value:"right"},renderHeader:{type:Function},renderCell:{type:Function},renderEditCell:{type:Function},renderGroup:{type:Function},mini:{type:Number,value:null},renderMini:{type:Function}}}static get observers(){return["notifyFilterChange(filter)"]}notifyFilterChange(e){this.__ownChange||this.dispatchEvent(new CustomEvent("legacy-filter-changed",{detail:{name:this.name,state:this.legacyFilterToState(e)},bubbles:!0}))}legacyFilterToState(e){return{filter:e}}getFilterFn(){}getString(e,t){return U(e,t)}toXlsxValue(e,t){return mi(e,t)}cellTitleFn(e,t){return this.getString(e,t)}headerTitleFn(e){return e.title}serializeFilter(e,t){return bi(e,t)}deserializeFilter(e,t){return t==null?null:typeof t=="string"?window.decodeURIComponent(t):t}getComparableValue(e,t){return pi(e,t)}computeSource(e,t){return t}_propertiesChanged(e,t,a){super._propertiesChanged(e,t,a),this.dispatchEvent(new CustomEvent("cosmoz-column-prop-changed",{bubbles:!0}))}},fi=i=>e=>i(t=>{if(t.inputValue===void 0&&e.target.value==="")return t;clearTimeout(t.t);const a=setTimeout(()=>i(n=>({...n,filter:n.inputValue})),1e3);return{...t,inputValue:e.target.value,t:a}}),hi=i=>()=>i(e=>({...e,filter:e.inputValue})),xi=i=>e=>{e.keyCode===13&&(e.preventDefault(),i(t=>({...t,filter:t.inputValue})))},vi=i=>e=>i(t=>({...t,headerFocused:e.detail.value})),yi=i=>()=>i(e=>({...e,filter:null,inputValue:null})),$i=i=>i!=null&&i!=="";class wi extends V(I){static get properties(){return{minWidth:{type:String,value:"55px"},editMinWidth:{type:String,value:"55px"},inputValue:{type:Object,notify:!0}}}getFilterFn(e,t){if(!(t==null||t===""))return gi(e,t)}renderCell(e,{item:t}){return c`<span class="default-column">${U(e,t)}</span>`}renderEditCell(e,{item:t},a){return c`<cosmoz-input
		...
		>
			...
			<paper-dropdown-menu
				label=${this.title}
				placeholder=${vt(this._filterText)}
		...
		>
			...
			${t?c`<div slot="button" class="filter-value">${t}</div>`:Oe}
	...
	`};class aa extends Je(ae(I)){render(){const e=t=>{this.headerFocused=t.type==="focus"};return c`
			...
			${Ce({title:this.title,tooltip:this._tooltip,filterText:this._filterText,headerFocused:this.headerFocused,horizontalAlign:"right",externalValues:this.externalValues,onOpenedChanged:e,content:c`
					<h3 style="margin: 0;">${this.title}</h3>
					<cosmoz-input
						type="date"
						label=${A("From date")}
					...
					></cosmoz-input>
				`})}
		`}_fromInputString(e,t){const a=this.toDate(e);if(a!=null)return t==="min"&&a.setHours(0,0,0,0),t==="max"&&a.setHours(23,59,59),a}_filterInputChanged(e,t){const a=e.path.split(".")[1],n=a&&e.value;if(n&&n.match(/^0+/u)){this._limitInputDebouncer.cancel();return}super._filterInputChanged(e,t)}}customElements.define("cosmoz-omnitable-date-range-input",aa);const na=i=>{const e=-new Date(i).getTimezoneOffset()/60;return(e<0?"-":"+")+["0",Math.abs(e)].join("").substr(-2)+":00"},Xe=i=>i.length===19?i+na(i):i,At=i=>{if(i==null||i==="")return;let e=i;return!(e instanceof Date)&&(typeof i=="string"&&(e=Xe(e)),e=Wt(e),!e)||Number.isNaN(e.getTime())?null:e},P=({valuePath:i},e)=>{if(e==null)return;let t=e;i!=null&&(t=C(e,i));const a=At(t);if(a!=null)return O(a.getTime())},E=(i,e,t)=>{const a=At(i);return a??null},Qe=(i,e)=>{if(e==null)return;const t=E(i);if(t!=null)return e.format(t)},le={},oa=i=>{const e=i||"";return le[e]||(le[e]=new Intl.DateTimeFormat(i||void 0)),le[e]},rt=({valuePath:i,locale:e},t)=>{let a=C(t,i||"");return a===void 0?"":(a=E(a),a===null?"Invalid Date":Qe(a,oa(e)))},Ft=i=>{const e=E(i);if(e==null)return null;const t=we(e);return t==null?null:t.slice(0,10)},ra=({valuePath:i},e)=>Ft(C(e,i||"")),kt=(i,e)=>{const t=E(i);if(t!=null)return t},lt=i=>{const e=Ft(i);return e??""},la=({valuePath:i},e)=>{if(!i)return"";const t=E(C(e,i));if(!t)return"";const a=E(we(t));return a?(a.setHours(0,0,0,0),a):""},_t=(i,e)=>t=>{const a=P(i,t);if(a==null)return!1;const n=P({...i,valuePath:"min"},e),o=P({...i,valuePath:"max"},e);return!(a<(n??-1/0)||a>(o??1/0))};class sa extends V(I){static get properties(){return{min:{type:Number,value:null,notify:!0},max:{type:Number,value:null,notify:!0},limits:{type:Function},locale:{type:String,value:null,notify:!0},headerCellClass:{type:String,value:"date-header-cell"},width:{type:String,value:"100px"},minWidth:{type:String,value:"82px"},flex:{type:String,value:"0"}}}getConfig(e){return{limits:e.limits}}getFilterFn(e,t){const a=P({...e,valuePath:"min"},t),n=P({...e,valuePath:"max"},t);if(!(a==null&&n==null))return _t(e,t)}getString(e,t){return rt(e,t)}toXlsxValue(e,t){return la(e,t)}getComparableValue(e,t){return P(e,t)}serializeFilter(e,t){if(t==null)return;const a=E(t.min),n=E(t.max);if(!(a==null&&n==null))return lt(a)+"~"+lt(n)}deserializeFilter(e,t){if(t==null||t==="")return null;const a=t.match(/^([^~]+)?~([^~]+)?/iu);return Array.isArray(a)?{min:E(a[1]),max:E(a[2])}:null}renderCell(e,{item:t}){return c`<div class="omnitable-cell-date">
			${rt(e,t)}
		...
		`}renderEditCell(){return"not implemented"}renderHeader(e,{filter:t,query:a},n,o){return c`<cosmoz-autocomplete-ui
			...
			.onText=${We(n)}
			>${_(e.loading,()=>c`<cosmoz-spinner slot="suffix"></cosmoz-spinner>`)}</cosmoz-autocomplete-ui
		> `}}customElements.define("cosmoz-omnitable-column-list-horizontal",ua);window.Cosmoz=window.Cosmoz||{};class st extends Ut(Kt(Jt,I)){static get template(){return Le`
			<style>
				:host {
					display: block;
				}
...
>
	...
	/>
		...
		class="sg"
		title=${r}
		data-on=${vt(o===e&&(t?"desc":"asc")||void 0)}
...
`,Ot=i=>(e,t,a=Xt)=>{const n=ei(),o=new URLSearchParams(n.hash.replace("#",""));return i(e,t,a,o),"#!"+Object.assign(n,{hash:o}).href.replace(location.origin,"")},Lt=i=>i==null||i==="",ka=Ot((i,e,t,a)=>Lt(t(e))?a.delete(i):a.set(i,t(e))),_a=Ot((i,e,t,a)=>Object.entries(e).map(t).forEach(([n,o])=>Lt(o)?a.delete(i+n):a.set(i+n,o))),J=(i,e,{suffix:t="",read:a,write:n,multi:o}={})=>{const[r,l]=o?[_a,Qt]:[ka,Yt],[s,u]=T(()=>e==null?i:l(e+t,a)??i),d=$(m=>u(b=>{const p=ye(m,b);return e!=null&&Zt(r(e+t,p,n),null,{notify:!1}),p}),[e,t,r,n]);return[s,d]},Ea=i=>[!0,"true",1,"yes","on"].includes(i),de=i=>i===""||(i==null?void 0:Ea(i)),ce=(i,e,t)=>$(a=>{i(a),t(n=>({...n,[e]:a}))},[i,e,t]),Ia=(i,e,t,a,n)=>{const[o,r]=J(t.sortOn,e,{suffix:"-sortOn"}),[l,s]=J(de(t.descending),e,{suffix:"-descending",read:de}),[u,d]=J(t.groupOn,e,{suffix:"-groupOn"}),[m,b]=J(de(t.groupOnDescending),e,{suffix:"-groupOnDescending",read:de}),p=F(()=>i.find(g=>g.name===o),[i,o]),z=F(()=>i.find(g=>g.name===u),[i,u]),h={groupOn:u,setGroupOn:ce(d,"groupOn",a),groupOnDescending:m,setGroupOnDescending:ce(b,"groupOnDescending",a),sortOn:o,setSortOn:ce(r,"sortOn",a),descending:l,setDescending:ce(s,"descending",a),columns:i},y=F(()=>h,Object.values(h)),k=$(g=>{r(g.sortOn),d(g.groupOn),s(g.descending),b(g.groupOnDescending)},[]);return M(()=>void(n.current=k),[]),{...y,sortAndGroup:y,groupOnColumn:z,sortOnColumn:p}},Ye=yt();customElements.define("sort-and-group-provider",Ye.Provider);customElements.define("sort-and-group-consumer",L(({render:i})=>i(De(Ye)),{useShadowDOM:!1}));const Ma=({data:i,columns:e,groupOnColumn:t,filters:a,setFilterState:n,sortAndGroup:{sortOn:o,setSortOn:r,descending:l,setDescending:s}={}})=>$t(e,u=>u.name,u=>[c`<div
			...
			>
				...
				.column="${u}"
				name="${u.name}"
			></cosmoz-omnitable-resize-nub>`]),Oa=({columns:i,settingsConfig:e,hideSelectAll:t,...a})=>{const n=De(Ye);return c`
		${_(i,o=>Ma({columns:o,sortAndGroup:n,...a}))}
		${_(!t,()=>c` <cosmoz-omnitable-settings
					.config=${e}
					part="settings"
				></cosmoz-omnitable-settings>`)}
	`};customElements.define("cosmoz-omnitable-header-row",L(Oa,{useShadowDOM:!1}));const La=K`
	:host {
		display: flex;
		align-items: center;
		flex-wrap: wrap;
...
`;customElements.define("cosmoz-omnitable-item-expand-line",L(Da,{styleSheets:[Te(La)]}));const Ta=({columns:i,item:e,selected:t,expanded:a,groupOnColumn:n})=>ti(i,o=>c`<cosmoz-omnitable-item-expand-line
				.column=${o}
				?hidden=${o===n}
				exportparts="item-expand-label, item-expand-value"
				>${o.renderCell(o,{item:e,selected:t,expanded:a})}</cosmoz-omnitable-item-expand-line
			>`);customElements.define("cosmoz-omnitable-item-expand",L(Ta,{useShadowDOM:!1}));const Va=(i,e,t)=>i.editable?i.renderEditCell(i,e,t(i,e.item)):i.renderCell(i,e),Pa=({columns:i,groupOnColumn:e,item:t,index:a,selected:n,expanded:o,onItemChange:r})=>$t(i,l=>l.name,l=>c`<div
			...
			</div>`);customElements.define("cosmoz-omnitable-item-row",L(Pa,{useShadowDOM:!1}));const Dt=K`
	.checkbox {
		box-sizing: border-box;
		width: 18px;
		height: 18px;
...
`,Ua=({settingsConfig:i})=>{const{columns:e,collapsed:t}=i,a=e.filter(n=>!t.some(o=>o.name===n.name));return c`<div class="skeleton">
	...
	</div>`};customElements.define("cosmoz-omnitable-skeleton",L(Ua,{styleSheets:[Wa]}));const Ka=(i,e)=>{const{settingsConfig:t}=i,{processedItems:a,dataIsValid:n,filterIsTooStrict:o,loading:r,displayEmptyGroups:l,compareItemsFn:s,setSelectedItems:u,renderItem:d,renderGroup:m,error:b}=e;return c`${_(!r&&!n&&!b,()=>c`<div class="tableContent-empty">
...
`,me=i=>{const e=parseInt(i,10);return isFinite(e)?e:void 0},Qa=i=>{const{config:e}=i,{settings:t,setSettings:a,collapsed:n}=e,o=Pe({collapsed:n,settings:t.columns,setSettings:$(r=>a(l=>({...l,columns:r})),[a])});return{...e,onDown:$(r=>{r.target.closest(".pull")&&(o.handle=r.currentTarget)},[o]),onDragStart:$(r=>{const{target:l}=r,s=me(l.dataset.index);if(!o.handle?.contains(l)||s==null)return r.preventDefault();o.handle=null,r.dataTransfer.effectAllowed="move",r.dataTransfer.setData("omnitable/sort-index",s),r.dataTransfer.setData("text/plain",s),setTimeout(()=>l.classList.add("drag"),0),l.addEventListener("dragend",u=>u.target.classList.remove("drag"),{once:!0})},[o]),onDragEnter:$(r=>{const l=r.currentTarget;l===r.target&&(r.preventDefault(),r.dataTransfer.dropEffect="move",l.classList.add("dragover"))},[]),onDragOver:$(r=>{r.preventDefault(),r.currentTarget.classList.add("dragover")},[]),onDragLeave:$(r=>{const l=r.currentTarget;l.contains(r.relatedTarget)||l.classList.remove("dragover")},[]),onDrop:$(r=>{const l=me(r.dataTransfer.getData("omnitable/sort-index")),s=me(r.currentTarget.dataset.index),{settings:u,setSettings:d}=o;r.currentTarget.classList.remove("dragover"),r.preventDefault();const m=u.slice();m.splice(s+(l>=s?0:-1),0,m.splice(l,1)[0]),d(m)},[o]),onToggle:$(r=>{const{settings:l,setSettings:s}=o,u=l.map(m=>({...m,disabled:m.disabled||o.collapsed?.some(b=>b.name===m.name)})),d=me(r.target.closest("[data-index]")?.dataset.index);u.splice(d,1,{...l[d],disabled:!r.target.checked,priority:r.target.checked?l.reduce((m,b)=>Math.max(m,b.priority),0)+1:l[d].priority}),s(u)},[o])}},Ya=[oi({apply({availableHeight:i,elements:e}){Object.assign(e.floating.style,{maxHeight:`${Math.max(0,i)}px`})}}),...ri],Za=({onDragStart:i,onDragEnter:e,onDragOver:t,onDragLeave:a,onDrop:n,onDown:o,onToggle:r,collapsed:l,filters:s})=>(u,d)=>{const m=!!l?.find(p=>p.name===u.name),b=!u.disabled&&!m;return c` <div
		...
		${_(t,()=>c`<div class="buttons">
				...
				</div>`)}`};customElements.define("cosmoz-omnitable-settings-ui",L(en,{styleSheets:[Te(Ja)]}));const tn=({config:i,newLayout:e})=>c`
	<cosmoz-dropdown
